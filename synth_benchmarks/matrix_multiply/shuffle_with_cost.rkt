...
(define v1_2 (bv #xeff77c0a6d866c62 64))
(define v2_2 (bv #x5a60266fe557866b6331559f073653ddb38943ff5edbfca7 192))
(define env2 (vector v1_2 v2_2))
...
(optimize
  ...
  #:guarantee (begin
               ...
               (assert (equal? (interpret sketch-grammar env2) (tensor-matmul v1_2 v2_2)))
               ;(assert (equal? (interpret sketch-grammar env3) (tensor-matmul v1_3 v2_3)))
               ;(assert (equal? (interpret sketch-grammar env4) (tensor-matmul v1_4 v2_4)))
               ;(assert (equal? (interpret sketch-grammar env5) (tensor-matmul v1_5 v2_5)))
               ;(assert (equal? (interpret sketch-grammar env6) (tensor-matmul v1_6 v2_6)))
               )
)))
