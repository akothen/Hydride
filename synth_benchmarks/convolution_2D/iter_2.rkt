...
(define sol
     (synthesize
     ;(optimize
      #:forall (list cex_arg0 cex_arg1 e_0_0 e_0_1 e_1_0 e_1_1 e_0_1 e_2_0 e_2_1 v0_0 v1_0) ;forall-list ; (list  env )
...
(with-output-to-file "./body_2.txt" (lambda() (print-prog synth_res)))
