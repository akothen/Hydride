...
(define v0_0 (bv #xffff3f7fffffff777fffffff7fff7f7f 128))
(define v1_0 (bv #xffffffff 32))
(define env_0 (vector v0_0 v1_0))
(define v0_1 (bv #xa33cf79f2755d0e4ff665f01bbffa53f 128))
(define v1_1 (bv #x9bfefa3f 32))
...
(define sol
     (synthesize
     ;(optimize
      #:forall (list cex_arg0 cex_arg1 e_0_0 e_0_1 e_1_0 e_1_1 e_0_1 e_2_0 e_2_1 v0_0 v1_0 v0_1 v1_1) ;forall-list ; (list  env )
      ...
      #:guarantee 
                                                     (begin 
                                                       ...
                                                       (assert (equal? (interpret sketch-grammar env_0) (tensor-conv2D v0_0 v1_0 4 4 2 2 8)))
(assert (equal? (interpret sketch-grammar env_1) (tensor-conv2D v0_1 v1_1 4 4 2 2 8)))
...
(with-output-to-file "./body_3.txt" (lambda() (print-prog synth_res)))
