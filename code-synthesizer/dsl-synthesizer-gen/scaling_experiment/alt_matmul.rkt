...
(define (tensor-matmul arg1 arg2)  (apply  concat  (for/list ([i (reverse (range bound1))])  (apply concat  (for/list ([j (reverse (range bound3))])  (apply bvadd (for/list ([k (reverse (range bound2))])  (define idx_left (+ (* i bound2) k)) (define idx_right (+ (* k bound3) j))(define value1 (ext-bv arg1 idx_left 8)) (define value2 (ext-bv arg2 idx_right 8))  (bvmul value1 value2)  )  )  )  )  )  ) );; DSL Specification
...
(define left_size (* (* bound1 bound2) 8))
(define right_size (* (* bound3 bound2) 8))


(define-symbolic _arg0 (bitvector left_size))
(define-symbolic _arg1 (bitvector right_size))
...
(println "InputA:")
(print-mat cex_arg0 bound1 bound2 8)


(println "InputB:")
(print-mat cex_arg1 bound2 bound3 8)
...
(print-mat gen_res bound1 bound3 8)


(println "rolled_impl_res::")
(print-mat rolled_res bound1 bound3 8)
