...
@str.171 = private constant [18 x i8] c"input1_multiplier\00", align 32
@1 = private constant [4 x i64*] zeroinitializer
@str.172 = private constant [7 x i8] c"input2\00", align 32
@str.173 = private constant [12 x i8] c"input2_zero\00", align 32
@str.174 = private constant [18 x i8] c"input2_multiplier\00", align 32
@str.175 = private constant [12 x i8] c"output_zero\00", align 32
...
@str.180 = private constant [4 x i8] c"add\00", align 32
...
; Function Attrs: nounwind
define i32 @add_par_for_output_s0_x_x_x(i8* nocapture readnone %__user_context, i32 %output.s0.x.x.x, i8* readonly %closure_arg) #11 {
entry:
  ...
  %t6 = load i32, i32* %20, align 4
  %21 = getelementptr inbounds i8, i8* %closure_arg, i64 56
  %22 = bitcast i8* %21 to i32*
  %t7 = load i32, i32* %22, align 4
  %23 = getelementptr inbounds i8, i8* %closure_arg, i64 60
  %24 = bitcast i8* %23 to i32*
  %t8 = load i32, i32* %24, align 4
  %25 = getelementptr inbounds i8, i8* %closure_arg, i64 64
  %26 = bitcast i8* %25 to i32*
  %t9 = load i32, i32* %26, align 4
  %27 = getelementptr inbounds i8, i8* %closure_arg, i64 68
  %28 = bitcast i8* %27 to i16*
  %input1_multiplier = load i16, i16* %28, align 2
  %29 = getelementptr inbounds i8, i8* %closure_arg, i64 70
  %30 = bitcast i8* %29 to i16*
  %input2_multiplier = load i16, i16* %30, align 2
  %31 = getelementptr inbounds i8, i8* %closure_arg, i64 72
  %input1_zero = load i8, i8* %31, align 1
  %32 = getelementptr inbounds i8, i8* %closure_arg, i64 73
  %input2_zero = load i8, i8* %32, align 1
  %33 = getelementptr inbounds i8, i8* %closure_arg, i64 74
  %output_max = load i8, i8* %33, align 1
  %34 = getelementptr inbounds i8, i8* %closure_arg, i64 75
  ...
  %61 = insertelement <16 x i16> undef, i16 %60, i32 0
  %62 = shufflevector <16 x i16> %61, <16 x i16> undef, <16 x i32> zeroinitializer
  %63 = insertelement <16 x i16> undef, i16 %input1_multiplier, i32 0
  %64 = shufflevector <16 x i16> %63, <16 x i16> undef, <16 x i32> zeroinitializer
  %65 = insertelement <16 x i16> undef, i16 %input2_multiplier, i32 0
  %66 = shufflevector <16 x i16> %65, <16 x i16> undef, <16 x i32> zeroinitializer
  %67 = shufflevector <16 x i16> %64, <16 x i16> %66, <32 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23, i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
  %68 = zext i8 %output_zero to i16
  %69 = insertelement <16 x i16> undef, i16 %68, i32 0
  %70 = shufflevector <16 x i16> %69, <16 x i16> undef, <16 x i32> zeroinitializer
  %71 = insertelement <16 x i8> undef, i8 %output_max, i32 0
  %b3 = shufflevector <16 x i8> %71, <16 x i8> undef, <16 x i32> zeroinitializer
  %72 = insertelement <16 x i8> undef, i8 %output_min, i32 0
  %b2 = shufflevector <16 x i8> %72, <16 x i8> undef, <16 x i32> zeroinitializer
  %73 = sext i32 %t10 to i64
  %74 = sext i32 %t11 to i64
  %75 = sext i32 %output.stride.1 to i64
  %76 = sext i32 %t9 to i64
  %77 = sext i32 %input2.stride.1 to i64
  %78 = sext i32 %t8 to i64
  %79 = sext i32 %input1.stride.1 to i64
  %80 = sext i32 %t7 to i64
  br label %"for output.s0.y.yi"

"for output.s0.y.yi":                             ; preds = %entry, %"end for output.s0.x.xi.xi"
  %indvars.iv52 = phi i64 [ 0, %entry ], [ %indvars.iv.next53, %"end for output.s0.x.xi.xi" ]
  %81 = add nsw i64 %indvars.iv52, %74
  %82 = mul nsw i64 %81, %75
  %83 = sub nsw i64 %82, %76
  %84 = mul nsw i64 %81, %77
  %85 = sub nsw i64 %84, %78
  %86 = mul nsw i64 %81, %79
  %87 = sub nsw i64 %86, %80
...
"end for output.s0.y.yi":                         ; preds = %"end for output.s0.x.xi.xi"
  ...
  %t612 = load i32, i32* %20, align 4
  %t713 = load i32, i32* %22, align 4
  %t814 = load i32, i32* %24, align 4
  %t915 = load i32, i32* %26, align 4
  %input1_multiplier16 = load i16, i16* %28, align 2
  %input2_multiplier17 = load i16, i16* %30, align 2
  ...
  %88 = icmp eq i32 %t612, 0
  %t79 = sext i1 %88 to i32
  %t612.lobit = ashr i32 %t612, 31
  %89 = or i32 %t612, %t79
  %90 = srem i32 %37, %89
  %91 = xor i32 %t612.lobit, %t612
  %92 = xor i32 %t612.lobit, -1
  %93 = add nsw i32 %91, %92
  %94 = and i32 %93, %output.s0.x.x.x.lobit
  %95 = add nsw i32 %90, %94
  %96 = xor i32 %t79, -1
  %97 = and i32 %95, %96
  %a4 = mul nsw i32 %97, 960
  %b4 = add nsw i32 %output.extent.07, -960
  %98 = icmp sgt i32 %b4, %a4
  %output.s0.x.xi.base.s23 = select i1 %98, i32 %a4, i32 %b4
  %99 = sub nsw i32 %t612, %t79
  %100 = sdiv i32 %37, %99
  %101 = sub nsw i32 %92, %t612.lobit
  %102 = and i32 %101, %output.s0.x.x.x.lobit
  %103 = add nsw i32 %100, %102
  %104 = and i32 %103, %96
  %a5 = mul nsw i32 %104, 34
  %b5 = add nsw i32 %output.extent.18, -34
  %105 = icmp sgt i32 %b5, %a5
  %output.s0.y.yi.base.s24 = select i1 %105, i32 %a5, i32 %b5
  %t1125 = add nsw i32 %output.s0.y.yi.base.s24, %output.min.110
  %t1026 = add nsw i32 %output.s0.x.xi.base.s23, %output.min.09
  %106 = zext i8 %input1_zero18 to i16
  %107 = mul nsw i16 %106, -64
  %108 = zext i8 %input2_zero19 to i16
  %109 = mul nsw i16 %108, -64
  %110 = zext i8 %output_zero22 to i16
  %111 = sext i32 %t1026 to i64
  %112 = sext i32 %t1125 to i64
  %113 = sext i32 %output.stride.111 to i64
  %114 = sext i32 %t915 to i64
  %115 = sext i32 %input2.stride.16 to i64
  %116 = sext i32 %t814 to i64
  %117 = sext i32 %input1.stride.15 to i64
  %118 = sext i32 %t713 to i64
...
"for output.s0.x.xi.xi":                          ; preds = %"for output.s0.y.yi", %"for output.s0.x.xi.xi"
  ...
  %119 = shl i64 %indvars.iv, 5
  %120 = shl nsw i64 %indvars.iv, 5
  %121 = add nsw i64 %120, %73
  %122 = add nsw i64 %121, %87
  %123 = getelementptr inbounds i8, i8* %input1, i64 %122
  %124 = bitcast i8* %123 to <16 x i8>*
  %125 = load <16 x i8>, <16 x i8>* %124, align 1, !tbaa !234
  %126 = zext <16 x i8> %125 to <16 x i16>
  %127 = shl nuw nsw <16 x i16> %126, <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>
  %128 = add <16 x i16> %127, %58
  %129 = add nsw i64 %121, %85
  %130 = getelementptr inbounds i8, i8* %input2, i64 %129
  %131 = bitcast i8* %130 to <16 x i8>*
  %132 = load <16 x i8>, <16 x i8>* %131, align 1, !tbaa !237
  %133 = zext <16 x i8> %132 to <16 x i16>
  %134 = shl nuw nsw <16 x i16> %133, <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>
  %135 = add <16 x i16> %134, %62
  %136 = shufflevector <16 x i16> %128, <16 x i16> %135, <32 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23, i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
  %137 = tail call <16 x i32> @llvm.x86.avx512.pmaddw.d.512(<32 x i16> %136, <32 x i16> %67)
  %138 = ashr <16 x i32> %137, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %139 = add nsw <16 x i32> %138, <i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384>
  %140 = ashr <16 x i32> %139, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %141 = shufflevector <16 x i32> %140, <16 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %142 = shufflevector <16 x i32> %140, <16 x i32> undef, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15>
  %143 = tail call <16 x i16> @llvm.x86.avx2.packssdw(<8 x i32> %141, <8 x i32> %142) #12
  %144 = tail call <16 x i16> @llvm.sadd.sat.v16i16(<16 x i16> %143, <16 x i16> %70)
  %145 = shufflevector <16 x i16> %144, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %146 = shufflevector <16 x i16> %144, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %147 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %145, <8 x i16> %146) #12
  %148 = icmp ugt <16 x i8> %b3, %147
  %a2 = select <16 x i1> %148, <16 x i8> %147, <16 x i8> %b3
  %149 = icmp ugt <16 x i8> %a2, %b2
  %150 = select <16 x i1> %149, <16 x i8> %a2, <16 x i8> %b2
  %151 = add nsw i64 %121, %83
  %152 = getelementptr inbounds i8, i8* %output, i64 %151
  %153 = bitcast i8* %152 to <16 x i8>*
  store <16 x i8> %150, <16 x i8>* %153, align 1, !tbaa !239
  %154 = or i64 %119, 16
  %155 = add nsw i64 %154, %73
  %156 = add nsw i64 %155, %87
  %157 = getelementptr inbounds i8, i8* %input1, i64 %156
  %158 = bitcast i8* %157 to <16 x i8>*
  %159 = load <16 x i8>, <16 x i8>* %158, align 1, !tbaa !234
  %160 = zext <16 x i8> %159 to <16 x i16>
  %161 = shl nuw nsw <16 x i16> %160, <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>
  %162 = add <16 x i16> %161, %58
  %163 = add nsw i64 %155, %85
  %164 = getelementptr inbounds i8, i8* %input2, i64 %163
  %165 = bitcast i8* %164 to <16 x i8>*
  %166 = load <16 x i8>, <16 x i8>* %165, align 1, !tbaa !237
  %167 = zext <16 x i8> %166 to <16 x i16>
  %168 = shl nuw nsw <16 x i16> %167, <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>
  %169 = add <16 x i16> %168, %62
  %170 = shufflevector <16 x i16> %162, <16 x i16> %169, <32 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23, i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
  %171 = tail call <16 x i32> @llvm.x86.avx512.pmaddw.d.512(<32 x i16> %170, <32 x i16> %67)
  %172 = ashr <16 x i32> %171, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %173 = add nsw <16 x i32> %172, <i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384, i32 16384>
  %174 = ashr <16 x i32> %173, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %175 = shufflevector <16 x i32> %174, <16 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %176 = shufflevector <16 x i32> %174, <16 x i32> undef, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15>
  %177 = tail call <16 x i16> @llvm.x86.avx2.packssdw(<8 x i32> %175, <8 x i32> %176) #12
  %178 = tail call <16 x i16> @llvm.sadd.sat.v16i16(<16 x i16> %177, <16 x i16> %70)
  %179 = shufflevector <16 x i16> %178, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %180 = shufflevector <16 x i16> %178, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %181 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %179, <8 x i16> %180) #12
  %182 = icmp ugt <16 x i8> %b3, %181
  %a2.1 = select <16 x i1> %182, <16 x i8> %181, <16 x i8> %b3
  %183 = icmp ugt <16 x i8> %a2.1, %b2
  %184 = select <16 x i1> %183, <16 x i8> %a2.1, <16 x i8> %b2
  %185 = add nsw i64 %155, %83
  %186 = getelementptr inbounds i8, i8* %output, i64 %185
  %187 = bitcast i8* %186 to <16 x i8>*
  store <16 x i8> %184, <16 x i8>* %187, align 1, !tbaa !239
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.not45 = icmp eq i64 %indvars.iv.next, 30
  br i1 %.not45, label %"end for output.s0.x.xi.xi", label %"for output.s0.x.xi.xi"

"end for output.s0.x.xi.xi":                      ; preds = %"for output.s0.x.xi.xi"
  %indvars.iv.next53 = add nuw nsw i64 %indvars.iv52, 1
  %.not46 = icmp eq i64 %indvars.iv.next53, 34
  br i1 %.not46, label %"end for output.s0.y.yi", label %"for output.s0.y.yi"

"for output.s0.y.yi27":                           ; preds = %"end for output.s0.y.yi", %"end for output.s0.x.xi.xi32"
  %indvars.iv64 = phi i64 [ 0, %"end for output.s0.y.yi" ], [ %indvars.iv.next65, %"end for output.s0.x.xi.xi32" ]
  %188 = add nsw i64 %indvars.iv64, %112
  %189 = mul nsw i64 %188, %113
  %190 = sub nsw i64 %189, %114
  %191 = mul nsw i64 %188, %115
  %192 = sub nsw i64 %191, %116
  %193 = mul nsw i64 %188, %117
  %194 = sub nsw i64 %193, %118
  br label %"for output.s0.x.xi.xi31"

"for output.s0.x.xi.xi31":                        ; preds = %"for output.s0.y.yi27", %"for output.s0.x.xi.xi31"
  %indvars.iv61 = phi i64 [ 0, %"for output.s0.y.yi27" ], [ %indvars.iv.next62, %"for output.s0.x.xi.xi31" ]
  %195 = shl i64 %indvars.iv61, 5
  %196 = shl nsw i64 %indvars.iv61, 5
  %197 = add nsw i64 %196, %111
  %198 = add nsw i64 %197, %194
  %199 = getelementptr inbounds i8, i8* %input12, i64 %198
  %200 = bitcast i8* %199 to <16 x i8>*
  %201 = load <16 x i8>, <16 x i8>* %200, align 1, !tbaa !234
  %202 = add nsw i64 %197, %192
  %203 = getelementptr inbounds i8, i8* %input23, i64 %202
  %204 = bitcast i8* %203 to <16 x i8>*
  %205 = load <16 x i8>, <16 x i8>* %204, align 1, !tbaa !237
  %206 = tail call <16 x i8> @hydride.node.0(<16 x i8> %201, i16 %107, i16 %input1_multiplier16, <16 x i8> %205, i16 %109, i16 %input2_multiplier17, <16 x i8> %201, i16 %107, <16 x i8> %205, i16 %109, i16 %110, i8 %output_max20, i8 %output_min21) #12
  %207 = add nsw i64 %197, %190
  %208 = getelementptr inbounds i8, i8* %output4, i64 %207
  %209 = bitcast i8* %208 to <16 x i8>*
  store <16 x i8> %206, <16 x i8>* %209, align 1, !tbaa !239
  %210 = or i64 %195, 16
  %211 = add nsw i64 %210, %111
  %212 = add nsw i64 %211, %194
  %213 = getelementptr inbounds i8, i8* %input12, i64 %212
  %214 = bitcast i8* %213 to <16 x i8>*
  %215 = load <16 x i8>, <16 x i8>* %214, align 1, !tbaa !234
  %216 = add nsw i64 %211, %192
  %217 = getelementptr inbounds i8, i8* %input23, i64 %216
  %218 = bitcast i8* %217 to <16 x i8>*
  %219 = load <16 x i8>, <16 x i8>* %218, align 1, !tbaa !237
  %220 = tail call <16 x i8> @hydride.node.0(<16 x i8> %215, i16 %107, i16 %input1_multiplier16, <16 x i8> %219, i16 %109, i16 %input2_multiplier17, <16 x i8> %215, i16 %107, <16 x i8> %219, i16 %109, i16 %110, i8 %output_max20, i8 %output_min21) #12
  %221 = add nsw i64 %211, %190
  %222 = getelementptr inbounds i8, i8* %output4, i64 %221
  %223 = bitcast i8* %222 to <16 x i8>*
  store <16 x i8> %220, <16 x i8>* %223, align 1, !tbaa !239
  %indvars.iv.next62 = add nuw nsw i64 %indvars.iv61, 1
  %.not48 = icmp eq i64 %indvars.iv.next62, 30
  br i1 %.not48, label %"end for output.s0.x.xi.xi32", label %"for output.s0.x.xi.xi31"

"end for output.s0.x.xi.xi32":                    ; preds = %"for output.s0.x.xi.xi31"
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1
  %.not49 = icmp eq i64 %indvars.iv.next65, 34
  br i1 %.not49, label %destructor_block, label %"for output.s0.y.yi27"
...
; Function Attrs: nounwind
define i32 @add(%struct.halide_buffer_t* noalias nocapture readonly %input1.buffer, i8 %input1_zero, i16 %input1_multiplier, %struct.halide_buffer_t* noalias nocapture readonly %input2.buffer, i8 %input2_zero, i16 %input2_multiplier, i8 %output_zero, i8 %output_min, i8 %output_max, %struct.halide_buffer_t* noalias nocapture readonly %output.buffer) local_unnamed_addr #11 {
entry:
  %parallel_closure24 = alloca { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, align 8
  %parallel_closure = alloca { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, align 8
  ...
  %min.i28 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %1, i64 1, i32 0
  %3 = load i32, i32* %min.i28, align 4, !tbaa !76
  %stride.i30 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %1, i64 1, i32 2
  %4 = load i32, i32* %stride.i30, align 4, !tbaa !77
  %host.i31 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input2.buffer, i64 0, i32 2
  %5 = load i8*, i8** %host.i31, align 8, !tbaa !67
  %dim.i32 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input2.buffer, i64 0, i32 6
  %6 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %dim.i32, align 8, !tbaa !71
  %min.i33 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %6, i64 0, i32 0
  %7 = load i32, i32* %min.i33, align 4, !tbaa !76
  %min.i37 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %6, i64 1, i32 0
  %8 = load i32, i32* %min.i37, align 4, !tbaa !76
  %stride.i39 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %6, i64 1, i32 2
  %9 = load i32, i32* %stride.i39, align 4, !tbaa !77
  %host.i40 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 2
  %10 = load i8*, i8** %host.i40, align 8, !tbaa !67
  %dim.i41 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 6
  %11 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %dim.i41, align 8, !tbaa !71
  %min.i42 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %11, i64 0, i32 0
  %12 = load i32, i32* %min.i42, align 4, !tbaa !76
  ...
  %min.i47 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %11, i64 1, i32 0
  %14 = load i32, i32* %min.i47, align 4, !tbaa !76
  %extent.i49 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %11, i64 1, i32 1
  %15 = load i32, i32* %extent.i49, align 4, !tbaa !73
  %stride.i51 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %11, i64 1, i32 2
  %16 = load i32, i32* %stride.i51, align 4, !tbaa !77
  %17 = icmp slt i32 %13, -959
  %t84.neg83 = zext i1 %17 to i32
  %t84 = sext i1 %17 to i32
  %18 = add i32 %13, 959
  %19 = add i32 %18, %t84.neg83
  %20 = sdiv i32 %19, 960
  %21 = add nsw i32 %20, %t84
  %22 = add nsw i32 %15, 33
  %23 = ashr i32 %22, 31
  %24 = xor i32 %23, %22
  ...
  %t9 = add nsw i32 %30, %12
  %31 = mul nsw i32 %9, %8
  %t8 = add nsw i32 %31, %7
  %32 = mul nsw i32 %4, %3
  %t7 = add nsw i32 %32, %2
  %33 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 0
  store i8* %0, i8** %33, align 8
  %34 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 1
  store i8* %5, i8** %34, align 8
  %35 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 2
  store i8* %10, i8** %35, align 8
  %36 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 3
  store i32 %4, i32* %36, align 8
  %37 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 4
  store i32 %9, i32* %37, align 4
  %38 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 5
  store i32 %13, i32* %38, align 8
  %39 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 6
  store i32 %15, i32* %39, align 4
  %40 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 7
  store i32 %12, i32* %40, align 8
  %41 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 8
  store i32 %14, i32* %41, align 4
  %42 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 9
  store i32 %16, i32* %42, align 8
  %43 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 10
  store i32 %21, i32* %43, align 4
  %44 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 11
  store i32 %t7, i32* %44, align 8
  %45 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 12
  store i32 %t8, i32* %45, align 4
  %46 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 13
  store i32 %t9, i32* %46, align 8
  %47 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 14
  store i16 %input1_multiplier, i16* %47, align 4
  %48 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 15
  store i16 %input2_multiplier, i16* %48, align 2
  %49 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 16
  store i8 %input1_zero, i8* %49, align 8
  %50 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 17
  store i8 %input2_zero, i8* %50, align 1
  %51 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 18
  store i8 %output_max, i8* %51, align 2
  %52 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 19
  store i8 %output_min, i8* %52, align 1
  %53 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 20
  store i8 %output_zero, i8* %53, align 4
  %54 = bitcast { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure to i8*
  %closure_result = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @add_par_for_output_s0_x_x_x, i32 0, i32 %output.s0.x.x.x.loop_extent, i8* nonnull %54) #12
  %55 = load i32, i32* %min.i, align 4, !tbaa !76
  %56 = load i32, i32* %min.i28, align 4, !tbaa !76
  %57 = load i32, i32* %stride.i30, align 4, !tbaa !77
  %58 = load i32, i32* %min.i33, align 4, !tbaa !76
  %59 = load i32, i32* %min.i37, align 4, !tbaa !76
  %60 = load i32, i32* %stride.i39, align 4, !tbaa !77
  %61 = load i32, i32* %min.i42, align 4, !tbaa !76
  %62 = load i32, i32* %extent.i, align 4, !tbaa !73
  %63 = load i32, i32* %min.i47, align 4, !tbaa !76
  %64 = load i32, i32* %extent.i49, align 4, !tbaa !73
  %65 = load i32, i32* %stride.i51, align 4, !tbaa !77
  %66 = icmp slt i32 %62, -959
  %t121.neg84 = zext i1 %66 to i32
  %t121 = sext i1 %66 to i32
  %67 = add i32 %62, 959
  %68 = add i32 %67, %t121.neg84
  %69 = sdiv i32 %68, 960
  %70 = add nsw i32 %69, %t121
  %71 = add nsw i32 %64, 33
  %72 = ashr i32 %71, 31
  %73 = xor i32 %72, %71
  %74 = zext i32 %73 to i64
  %75 = mul nuw i64 %74, 4042322161
  %76 = lshr i64 %75, 37
  %77 = trunc i64 %76 to i32
  %78 = xor i32 %72, %77
  %output.s0.x.x.x.loop_extent18 = mul nsw i32 %78, %70
  %79 = mul nsw i32 %65, %63
  %t921 = add nsw i32 %79, %61
  %80 = mul nsw i32 %60, %59
  %t822 = add nsw i32 %80, %58
  %81 = mul nsw i32 %57, %56
  %t723 = add nsw i32 %81, %55
  %82 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 0
  store i8* %0, i8** %82, align 8
  %83 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 1
  store i8* %5, i8** %83, align 8
  %84 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 2
  store i8* %10, i8** %84, align 8
  %85 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 3
  store i32 %57, i32* %85, align 8
  %86 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 4
  store i32 %60, i32* %86, align 4
  %87 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 5
  store i32 %62, i32* %87, align 8
  %88 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 6
  store i32 %64, i32* %88, align 4
  %89 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 7
  store i32 %61, i32* %89, align 8
  %90 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 8
  store i32 %63, i32* %90, align 4
  %91 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 9
  store i32 %65, i32* %91, align 8
  %92 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 10
  store i32 %70, i32* %92, align 4
  %93 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 11
  store i32 %t723, i32* %93, align 8
  %94 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 12
  store i32 %t822, i32* %94, align 4
  %95 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 13
  store i32 %t921, i32* %95, align 8
  %96 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 14
  store i16 %input1_multiplier, i16* %96, align 4
  %97 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 15
  store i16 %input2_multiplier, i16* %97, align 2
  %98 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 16
  store i8 %input1_zero, i8* %98, align 8
  %99 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 17
  store i8 %input2_zero, i8* %99, align 1
  %100 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 18
  store i8 %output_max, i8* %100, align 2
  %101 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 19
  store i8 %output_min, i8* %101, align 1
  %102 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24, i64 0, i32 20
  store i8 %output_zero, i8* %102, align 4
  %103 = bitcast { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i8, i8, i8, i8, i8 }* %parallel_closure24 to i8*
  %closure_result25 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @add_par_for_output_s0_x_x_x, i32 0, i32 %output.s0.x.x.x.loop_extent18, i8* nonnull %103) #12
  ret i32 0
}

; Function Attrs: nounwind
define i32 @add_argv(i8** nocapture readonly %0) local_unnamed_addr #12 {
entry:
  ...
  %32 = tail call i32 @add(%struct.halide_buffer_t* %2, i8 %5, i16 %9, %struct.halide_buffer_t* %12, i8 %15, i16 %19, i8 %22, i8 %25, i8 %28, %struct.halide_buffer_t* %31) #19
  ret i32 0
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @add_metadata() local_unnamed_addr #13 {
entry:
  ret %struct.halide_filter_metadata_t* @add_metadata_storage
}

declare <16 x i8> @hydride.node.0(<16 x i8>, i16, i16, <16 x i8>, i16, i16, <16 x i8>, i16, <16 x i8>, i16, i16, i8, i8) local_unnamed_addr
