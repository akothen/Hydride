...
@str.170 = private constant [12 x i8] c"input1_zero\00", align 32
@1 = private constant [4 x i64*] zeroinitializer
@str.171 = private constant [7 x i8] c"input2\00", align 32
@str.172 = private constant [12 x i8] c"input2_zero\00", align 32
@str.173 = private constant [12 x i8] c"output_zero\00", align 32
@str.174 = private constant [18 x i8] c"output_multiplier\00", align 32
@str.175 = private constant [13 x i8] c"output_shift\00", align 32
@str.176 = private constant [11 x i8] c"output_min\00", align 32
@str.177 = private constant [11 x i8] c"output_max\00", align 32
@2 = private constant [4 x i64*] zeroinitializer
@str.178 = private constant [7 x i8] c"output\00", align 32
@3 = private constant [10 x %struct.halide_filter_argument_t] [%struct.halide_filter_argument_t { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i32 0, i32 0), i32 1, i32 2, %struct.halide_type_t { i8 1, i8 8, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** getelementptr inbounds ([4 x i64*], [4 x i64*]* @0, i32 0, i32 0) }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([12 x i8], [12 x i8]* @str.170, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 1, i8 8, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str.171, i32 0, i32 0), i32 1, i32 2, %struct.halide_type_t { i8 1, i8 8, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** getelementptr inbounds ([4 x i64*], [4 x i64*]* @1, i32 0, i32 0) }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([12 x i8], [12 x i8]* @str.172, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 1, i8 8, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([12 x i8], [12 x i8]* @str.173, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 1, i8 8, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([18 x i8], [18 x i8]* @str.174, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 0, i8 32, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([13 x i8], [13 x i8]* @str.175, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 1, i8 32, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @str.176, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 1, i8 8, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @str.177, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 1, i8 8, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str.178, i32 0, i32 0), i32 2, i32 2, %struct.halide_type_t { i8 1, i8 8, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** getelementptr inbounds ([4 x i64*], [4 x i64*]* @2, i32 0, i32 0) }]
@str.179 = private constant [85 x i8] c"x86-64-noos-avx-avx2-avx512-avx512_skylake-f16c-fma-no_asserts-no_bounds_query-sse41\00", align 64
@str.180 = private constant [4 x i8] c"mul\00", align 32
@mul_metadata_storage = private constant %struct.halide_filter_metadata_t { i32 1, i32 10, %struct.halide_filter_argument_t* getelementptr inbounds ([10 x %struct.halide_filter_argument_t], [10 x %struct.halide_filter_argument_t]* @3, i32 0, i32 0), i8* getelementptr inbounds ([85 x i8], [85 x i8]* @str.179, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.180, i32 0, i32 0) }
...
; Function Attrs: nounwind
define i32 @mul_par_for_output_s0_x_x_x(i8* nocapture readnone %__user_context, i32 %output.s0.x.x.x, i8* readonly %closure_arg) #11 {
entry:
  %0 = bitcast i8* %closure_arg to i8**
  %input1 = load i8*, i8** %0, align 8
  %1 = getelementptr inbounds i8, i8* %closure_arg, i64 8
  %2 = bitcast i8* %1 to i8**
  %input2 = load i8*, i8** %2, align 8
  %3 = getelementptr inbounds i8, i8* %closure_arg, i64 16
  %4 = bitcast i8* %3 to i8**
  %output = load i8*, i8** %4, align 8
  %5 = getelementptr inbounds i8, i8* %closure_arg, i64 24
  %6 = bitcast i8* %5 to i32*
  %input1.stride.1 = load i32, i32* %6, align 4
  %7 = getelementptr inbounds i8, i8* %closure_arg, i64 28
  %8 = bitcast i8* %7 to i32*
  %input2.stride.1 = load i32, i32* %8, align 4
  %9 = getelementptr inbounds i8, i8* %closure_arg, i64 32
  %10 = bitcast i8* %9 to i32*
  %output.extent.0 = load i32, i32* %10, align 4
  %11 = getelementptr inbounds i8, i8* %closure_arg, i64 36
  %12 = bitcast i8* %11 to i32*
  %output.extent.1 = load i32, i32* %12, align 4
  %13 = getelementptr inbounds i8, i8* %closure_arg, i64 40
  %14 = bitcast i8* %13 to i32*
  %output.min.0 = load i32, i32* %14, align 4
  %15 = getelementptr inbounds i8, i8* %closure_arg, i64 44
  %16 = bitcast i8* %15 to i32*
  %output.min.1 = load i32, i32* %16, align 4
  %17 = getelementptr inbounds i8, i8* %closure_arg, i64 48
  %18 = bitcast i8* %17 to i32*
  %output.stride.1 = load i32, i32* %18, align 4
  %19 = getelementptr inbounds i8, i8* %closure_arg, i64 52
  %20 = bitcast i8* %19 to i32*
  %output_multiplier = load i32, i32* %20, align 4
  %21 = getelementptr inbounds i8, i8* %closure_arg, i64 56
  %22 = bitcast i8* %21 to i32*
  %t10 = load i32, i32* %22, align 4
  %23 = getelementptr inbounds i8, i8* %closure_arg, i64 60
  %24 = bitcast i8* %23 to i32*
  %t6 = load i32, i32* %24, align 4
  %25 = getelementptr inbounds i8, i8* %closure_arg, i64 64
  %26 = bitcast i8* %25 to i32*
  %t7 = load i32, i32* %26, align 4
  %27 = getelementptr inbounds i8, i8* %closure_arg, i64 68
  %28 = bitcast i8* %27 to i32*
  %t8 = load i32, i32* %28, align 4
  %29 = getelementptr inbounds i8, i8* %closure_arg, i64 72
  %30 = bitcast i8* %29 to i32*
  %t9 = load i32, i32* %30, align 4
  %31 = getelementptr inbounds i8, i8* %closure_arg, i64 76
  %input1_zero = load i8, i8* %31, align 1
  %32 = getelementptr inbounds i8, i8* %closure_arg, i64 77
  %input2_zero = load i8, i8* %32, align 1
  %33 = getelementptr inbounds i8, i8* %closure_arg, i64 78
  %output_max = load i8, i8* %33, align 1
  %34 = getelementptr inbounds i8, i8* %closure_arg, i64 79
  %output_min = load i8, i8* %34, align 1
  %35 = getelementptr inbounds i8, i8* %closure_arg, i64 80
  %output_zero = load i8, i8* %35, align 1
  %output.s0.x.x.x.lobit = ashr i32 %output.s0.x.x.x, 31
  %36 = icmp eq i32 %t6, 0
  %t19 = sext i1 %36 to i32
  %t6.lobit = ashr i32 %t6, 31
  %37 = sub nsw i32 %output.s0.x.x.x, %output.s0.x.x.x.lobit
  %38 = or i32 %t6, %t19
  %39 = srem i32 %37, %38
  %40 = xor i32 %t6.lobit, %t6
  %41 = xor i32 %t6.lobit, -1
  %42 = add nsw i32 %40, %41
  %43 = and i32 %42, %output.s0.x.x.x.lobit
  %44 = add nsw i32 %39, %43
  %45 = xor i32 %t19, -1
  %46 = and i32 %44, %45
  %a0 = mul nsw i32 %46, 960
  %b0 = add nsw i32 %output.extent.0, -960
  %47 = icmp sgt i32 %b0, %a0
  %output.s0.x.xi.base.s = select i1 %47, i32 %a0, i32 %b0
  %48 = sub nsw i32 %t6, %t19
  %49 = sdiv i32 %37, %48
  %50 = sub nsw i32 %41, %t6.lobit
  %51 = and i32 %50, %output.s0.x.x.x.lobit
  %52 = add nsw i32 %49, %51
  %53 = and i32 %52, %45
  %a1 = mul nsw i32 %53, 68
  %b1 = add nsw i32 %output.extent.1, -68
  %54 = icmp sgt i32 %b1, %a1
  %output.s0.y.yi.base.s = select i1 %54, i32 %a1, i32 %b1
  %t12 = add nsw i32 %output.s0.y.yi.base.s, %output.min.1
  %t11 = add nsw i32 %output.s0.x.xi.base.s, %output.min.0
  %55 = zext i8 %input1_zero to i16
  %56 = mul nsw i16 %55, -64
  %57 = insertelement <8 x i16> undef, i16 %56, i32 0
  %58 = shufflevector <8 x i16> %57, <8 x i16> undef, <8 x i32> zeroinitializer
  %59 = zext i8 %input2_zero to i16
  %60 = mul nsw i16 %59, -64
  %61 = insertelement <8 x i16> undef, i16 %60, i32 0
  %62 = shufflevector <8 x i16> %61, <8 x i16> undef, <8 x i32> zeroinitializer
  %63 = insertelement <8 x i32> undef, i32 %output_multiplier, i32 0
  %64 = shufflevector <8 x i32> %63, <8 x i32> undef, <8 x i32> zeroinitializer
  %65 = sext <8 x i32> %64 to <8 x i64>
  %66 = insertelement <8 x i32> undef, i32 %t9, i32 0
  %67 = shufflevector <8 x i32> %66, <8 x i32> undef, <8 x i32> zeroinitializer
  %.not = icmp eq i32 %t9, 0
  %68 = select i1 %.not, <8 x i32> zeroinitializer, <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %69 = add i32 %t9, -1
  %70 = insertelement <8 x i32> undef, i32 %69, i32 0
  %71 = shufflevector <8 x i32> %70, <8 x i32> undef, <8 x i32> zeroinitializer
  %72 = zext i8 %output_zero to i16
  %73 = insertelement <8 x i16> undef, i16 %72, i32 0
  %74 = shufflevector <8 x i16> %73, <8 x i16> undef, <8 x i32> zeroinitializer
  %75 = insertelement <8 x i8> undef, i8 %output_max, i32 0
  %76 = shufflevector <8 x i8> %75, <8 x i8> undef, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %77 = insertelement <8 x i8> undef, i8 %output_min, i32 0
  %78 = shufflevector <8 x i8> %77, <8 x i8> undef, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %79 = sext i32 %t11 to i64
  %80 = sext i32 %t12 to i64
  %81 = sext i32 %output.stride.1 to i64
  %82 = sext i32 %t10 to i64
  %83 = sext i32 %input2.stride.1 to i64
  %84 = sext i32 %t8 to i64
  %85 = sext i32 %input1.stride.1 to i64
  %86 = sext i32 %t7 to i64
  br label %"for output.s0.y.yi"

"for output.s0.y.yi":                             ; preds = %entry, %"end for output.s0.x.xi.xi"
  %indvars.iv53 = phi i64 [ 0, %entry ], [ %indvars.iv.next54, %"end for output.s0.x.xi.xi" ]
  %87 = add nsw i64 %indvars.iv53, %80
  %88 = mul nsw i64 %87, %81
  %89 = sub nsw i64 %88, %82
  %90 = mul nsw i64 %87, %83
  %91 = sub nsw i64 %90, %84
  %92 = mul nsw i64 %87, %85
  %93 = sub nsw i64 %92, %86
  br label %"for output.s0.x.xi.xi"

"end for output.s0.y.yi":                         ; preds = %"end for output.s0.x.xi.xi"
  %input12 = load i8*, i8** %0, align 8
  %input23 = load i8*, i8** %2, align 8
  %output4 = load i8*, i8** %4, align 8
  %input1.stride.15 = load i32, i32* %6, align 4
  %input2.stride.16 = load i32, i32* %8, align 4
  %output.extent.07 = load i32, i32* %10, align 4
  %output.extent.18 = load i32, i32* %12, align 4
  %output.min.09 = load i32, i32* %14, align 4
  %output.min.110 = load i32, i32* %16, align 4
  %output.stride.111 = load i32, i32* %18, align 4
  %output_multiplier12 = load i32, i32* %20, align 4
  %t1013 = load i32, i32* %22, align 4
  %t614 = load i32, i32* %24, align 4
  %t715 = load i32, i32* %26, align 4
  %t816 = load i32, i32* %28, align 4
  %t917 = load i32, i32* %30, align 4
  %input1_zero18 = load i8, i8* %31, align 1
  %input2_zero19 = load i8, i8* %32, align 1
  %output_max20 = load i8, i8* %33, align 1
  %output_min21 = load i8, i8* %34, align 1
  %output_zero22 = load i8, i8* %35, align 1
  %94 = icmp eq i32 %t614, 0
  %t94 = sext i1 %94 to i32
  %t614.lobit = ashr i32 %t614, 31
  %95 = or i32 %t614, %t94
  %96 = srem i32 %37, %95
  %97 = xor i32 %t614.lobit, %t614
  %98 = xor i32 %t614.lobit, -1
  %99 = add nsw i32 %97, %98
  %100 = and i32 %99, %output.s0.x.x.x.lobit
  %101 = add nsw i32 %96, %100
  %102 = xor i32 %t94, -1
  %103 = and i32 %101, %102
  %a8 = mul nsw i32 %103, 960
  %b8 = add nsw i32 %output.extent.07, -960
  %104 = icmp sgt i32 %b8, %a8
  %output.s0.x.xi.base.s23 = select i1 %104, i32 %a8, i32 %b8
  %105 = sub nsw i32 %t614, %t94
  %106 = sdiv i32 %37, %105
  %107 = sub nsw i32 %98, %t614.lobit
  %108 = and i32 %107, %output.s0.x.x.x.lobit
  %109 = add nsw i32 %106, %108
  %110 = and i32 %109, %102
  %a9 = mul nsw i32 %110, 68
  %b9 = add nsw i32 %output.extent.18, -68
  %111 = icmp sgt i32 %b9, %a9
  %output.s0.y.yi.base.s24 = select i1 %111, i32 %a9, i32 %b9
  %t1225 = add nsw i32 %output.s0.y.yi.base.s24, %output.min.110
  %t1126 = add nsw i32 %output.s0.x.xi.base.s23, %output.min.09
  %112 = zext i8 %input1_zero18 to i16
  %113 = mul nsw i16 %112, -64
  %114 = zext i8 %input2_zero19 to i16
  %115 = mul nsw i16 %114, -64
  %116 = icmp ne i32 %t917, 0
  %117 = add i32 %t917, -1
  %118 = zext i8 %output_zero22 to i16
  %119 = insertelement <8 x i8> undef, i8 %output_max20, i32 0
  %120 = shufflevector <8 x i8> %119, <8 x i8> undef, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %121 = insertelement <8 x i8> undef, i8 %output_min21, i32 0
  %122 = shufflevector <8 x i8> %121, <8 x i8> undef, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %123 = sext i32 %t1126 to i64
  %124 = sext i32 %t1225 to i64
  %125 = sext i32 %output.stride.111 to i64
  %126 = sext i32 %t1013 to i64
  %127 = sext i32 %input2.stride.16 to i64
  %128 = sext i32 %t816 to i64
  %129 = sext i32 %input1.stride.15 to i64
  %130 = sext i32 %t715 to i64
  br label %"for output.s0.y.yi27"

"for output.s0.x.xi.xi":                          ; preds = %"for output.s0.y.yi", %"for output.s0.x.xi.xi"
  %indvars.iv = phi i64 [ 0, %"for output.s0.y.yi" ], [ %indvars.iv.next, %"for output.s0.x.xi.xi" ]
  %131 = shl i64 %indvars.iv, 5
  %132 = shl nsw i64 %indvars.iv, 5
  %133 = add nsw i64 %132, %79
  %134 = add nsw i64 %133, %93
  %135 = getelementptr inbounds i8, i8* %input1, i64 %134
  %136 = bitcast i8* %135 to <8 x i8>*
  %137 = load <8 x i8>, <8 x i8>* %136, align 1, !tbaa !234
  %138 = zext <8 x i8> %137 to <8 x i16>
  %139 = shl nuw nsw <8 x i16> %138, <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>
  %140 = add <8 x i16> %139, %58
  %141 = sext <8 x i16> %140 to <8 x i32>
  %142 = add nsw i64 %133, %91
  %143 = getelementptr inbounds i8, i8* %input2, i64 %142
  %144 = bitcast i8* %143 to <8 x i8>*
  %145 = load <8 x i8>, <8 x i8>* %144, align 1, !tbaa !237
  %146 = zext <8 x i8> %145 to <8 x i16>
  %147 = shl nuw nsw <8 x i16> %146, <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>
  %148 = add <8 x i16> %147, %62
  %149 = sext <8 x i16> %148 to <8 x i32>
  %150 = mul nsw <8 x i32> %149, %141
  %151 = sext <8 x i32> %150 to <8 x i64>
  %152 = mul nsw <8 x i64> %151, %65
  %153 = ashr <8 x i64> %152, <i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1>
  %154 = add nsw <8 x i64> %153, <i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912>
  %a5 = ashr <8 x i64> %154, <i64 30, i64 30, i64 30, i64 30, i64 30, i64 30, i64 30, i64 30>
  %155 = icmp slt <8 x i64> %a5, <i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647>
  %a4 = select <8 x i1> %155, <8 x i64> %a5, <8 x i64> <i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647>
  %156 = icmp sgt <8 x i64> %a4, <i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648>
  %157 = select <8 x i1> %156, <8 x i64> %a4, <8 x i64> <i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648>
  %158 = trunc <8 x i64> %157 to <8 x i32>
  %159 = ashr <8 x i32> %158, %67
  %160 = lshr <8 x i32> %158, %71
  %161 = and <8 x i32> %160, %68
  %162 = add nsw <8 x i32> %161, %159
  %163 = shufflevector <8 x i32> %162, <8 x i32> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %164 = shufflevector <8 x i32> %162, <8 x i32> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %165 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %163, <4 x i32> %164) #12
  %166 = tail call <8 x i16> @llvm.sadd.sat.v8i16(<8 x i16> %165, <8 x i16> %74)
  %167 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %166, <8 x i16> undef) #12
  %168 = shufflevector <16 x i8> %167, <16 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %169 = icmp ugt <16 x i8> %76, %168
  %170 = select <16 x i1> %169, <16 x i8> %168, <16 x i8> %76
  %171 = shufflevector <16 x i8> %170, <16 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %172 = icmp ugt <16 x i8> %171, %78
  %173 = select <16 x i1> %172, <16 x i8> %171, <16 x i8> %78
  %174 = shufflevector <16 x i8> %173, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %175 = add nsw i64 %133, %89
  %176 = getelementptr inbounds i8, i8* %output, i64 %175
  %177 = bitcast i8* %176 to <8 x i8>*
  store <8 x i8> %174, <8 x i8>* %177, align 1, !tbaa !239
  %178 = shl i64 %indvars.iv, 5
  %179 = or i64 %178, 8
  %180 = add nsw i64 %179, %79
  %181 = add nsw i64 %180, %93
  %182 = getelementptr inbounds i8, i8* %input1, i64 %181
  %183 = bitcast i8* %182 to <8 x i8>*
  %184 = load <8 x i8>, <8 x i8>* %183, align 1, !tbaa !234
  %185 = zext <8 x i8> %184 to <8 x i16>
  %186 = shl nuw nsw <8 x i16> %185, <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>
  %187 = add <8 x i16> %186, %58
  %188 = sext <8 x i16> %187 to <8 x i32>
  %189 = add nsw i64 %180, %91
  %190 = getelementptr inbounds i8, i8* %input2, i64 %189
  %191 = bitcast i8* %190 to <8 x i8>*
  %192 = load <8 x i8>, <8 x i8>* %191, align 1, !tbaa !237
  %193 = zext <8 x i8> %192 to <8 x i16>
  %194 = shl nuw nsw <8 x i16> %193, <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>
  %195 = add <8 x i16> %194, %62
  %196 = sext <8 x i16> %195 to <8 x i32>
  %197 = mul nsw <8 x i32> %196, %188
  %198 = sext <8 x i32> %197 to <8 x i64>
  %199 = mul nsw <8 x i64> %198, %65
  %200 = ashr <8 x i64> %199, <i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1>
  %201 = add nsw <8 x i64> %200, <i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912>
  %a5.1 = ashr <8 x i64> %201, <i64 30, i64 30, i64 30, i64 30, i64 30, i64 30, i64 30, i64 30>
  %202 = icmp slt <8 x i64> %a5.1, <i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647>
  %a4.1 = select <8 x i1> %202, <8 x i64> %a5.1, <8 x i64> <i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647>
  %203 = icmp sgt <8 x i64> %a4.1, <i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648>
  %204 = select <8 x i1> %203, <8 x i64> %a4.1, <8 x i64> <i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648>
  %205 = trunc <8 x i64> %204 to <8 x i32>
  %206 = ashr <8 x i32> %205, %67
  %207 = lshr <8 x i32> %205, %71
  %208 = and <8 x i32> %207, %68
  %209 = add nsw <8 x i32> %208, %206
  %210 = shufflevector <8 x i32> %209, <8 x i32> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %211 = shufflevector <8 x i32> %209, <8 x i32> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %212 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %210, <4 x i32> %211) #12
  %213 = tail call <8 x i16> @llvm.sadd.sat.v8i16(<8 x i16> %212, <8 x i16> %74)
  %214 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %213, <8 x i16> undef) #12
  %215 = shufflevector <16 x i8> %214, <16 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %216 = icmp ugt <16 x i8> %76, %215
  %217 = select <16 x i1> %216, <16 x i8> %215, <16 x i8> %76
  %218 = shufflevector <16 x i8> %217, <16 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %219 = icmp ugt <16 x i8> %218, %78
  %220 = select <16 x i1> %219, <16 x i8> %218, <16 x i8> %78
  %221 = shufflevector <16 x i8> %220, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %222 = add nsw i64 %180, %89
  %223 = getelementptr inbounds i8, i8* %output, i64 %222
  %224 = bitcast i8* %223 to <8 x i8>*
  store <8 x i8> %221, <8 x i8>* %224, align 1, !tbaa !239
  %225 = shl i64 %indvars.iv, 5
  %226 = or i64 %225, 16
  %227 = add nsw i64 %226, %79
  %228 = add nsw i64 %227, %93
  %229 = getelementptr inbounds i8, i8* %input1, i64 %228
  %230 = bitcast i8* %229 to <8 x i8>*
  %231 = load <8 x i8>, <8 x i8>* %230, align 1, !tbaa !234
  %232 = zext <8 x i8> %231 to <8 x i16>
  %233 = shl nuw nsw <8 x i16> %232, <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>
  %234 = add <8 x i16> %233, %58
  %235 = sext <8 x i16> %234 to <8 x i32>
  %236 = add nsw i64 %227, %91
  %237 = getelementptr inbounds i8, i8* %input2, i64 %236
  %238 = bitcast i8* %237 to <8 x i8>*
  %239 = load <8 x i8>, <8 x i8>* %238, align 1, !tbaa !237
  %240 = zext <8 x i8> %239 to <8 x i16>
  %241 = shl nuw nsw <8 x i16> %240, <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>
  %242 = add <8 x i16> %241, %62
  %243 = sext <8 x i16> %242 to <8 x i32>
  %244 = mul nsw <8 x i32> %243, %235
  %245 = sext <8 x i32> %244 to <8 x i64>
  %246 = mul nsw <8 x i64> %245, %65
  %247 = ashr <8 x i64> %246, <i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1>
  %248 = add nsw <8 x i64> %247, <i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912>
  %a5.2 = ashr <8 x i64> %248, <i64 30, i64 30, i64 30, i64 30, i64 30, i64 30, i64 30, i64 30>
  %249 = icmp slt <8 x i64> %a5.2, <i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647>
  %a4.2 = select <8 x i1> %249, <8 x i64> %a5.2, <8 x i64> <i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647>
  %250 = icmp sgt <8 x i64> %a4.2, <i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648>
  %251 = select <8 x i1> %250, <8 x i64> %a4.2, <8 x i64> <i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648>
  %252 = trunc <8 x i64> %251 to <8 x i32>
  %253 = ashr <8 x i32> %252, %67
  %254 = lshr <8 x i32> %252, %71
  %255 = and <8 x i32> %254, %68
  %256 = add nsw <8 x i32> %255, %253
  %257 = shufflevector <8 x i32> %256, <8 x i32> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %258 = shufflevector <8 x i32> %256, <8 x i32> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %259 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %257, <4 x i32> %258) #12
  %260 = tail call <8 x i16> @llvm.sadd.sat.v8i16(<8 x i16> %259, <8 x i16> %74)
  %261 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %260, <8 x i16> undef) #12
  %262 = shufflevector <16 x i8> %261, <16 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %263 = icmp ugt <16 x i8> %76, %262
  %264 = select <16 x i1> %263, <16 x i8> %262, <16 x i8> %76
  %265 = shufflevector <16 x i8> %264, <16 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %266 = icmp ugt <16 x i8> %265, %78
  %267 = select <16 x i1> %266, <16 x i8> %265, <16 x i8> %78
  %268 = shufflevector <16 x i8> %267, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %269 = add nsw i64 %227, %89
  %270 = getelementptr inbounds i8, i8* %output, i64 %269
  %271 = bitcast i8* %270 to <8 x i8>*
  store <8 x i8> %268, <8 x i8>* %271, align 1, !tbaa !239
  %272 = or i64 %131, 24
  %273 = add nsw i64 %272, %79
  %274 = add nsw i64 %273, %93
  %275 = getelementptr inbounds i8, i8* %input1, i64 %274
  %276 = bitcast i8* %275 to <8 x i8>*
  %277 = load <8 x i8>, <8 x i8>* %276, align 1, !tbaa !234
  %278 = zext <8 x i8> %277 to <8 x i16>
  %279 = shl nuw nsw <8 x i16> %278, <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>
  %280 = add <8 x i16> %279, %58
  %281 = sext <8 x i16> %280 to <8 x i32>
  %282 = add nsw i64 %273, %91
  %283 = getelementptr inbounds i8, i8* %input2, i64 %282
  %284 = bitcast i8* %283 to <8 x i8>*
  %285 = load <8 x i8>, <8 x i8>* %284, align 1, !tbaa !237
  %286 = zext <8 x i8> %285 to <8 x i16>
  %287 = shl nuw nsw <8 x i16> %286, <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>
  %288 = add <8 x i16> %287, %62
  %289 = sext <8 x i16> %288 to <8 x i32>
  %290 = mul nsw <8 x i32> %289, %281
  %291 = sext <8 x i32> %290 to <8 x i64>
  %292 = mul nsw <8 x i64> %291, %65
  %293 = ashr <8 x i64> %292, <i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1>
  %294 = add nsw <8 x i64> %293, <i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912, i64 536870912>
  %a5.3 = ashr <8 x i64> %294, <i64 30, i64 30, i64 30, i64 30, i64 30, i64 30, i64 30, i64 30>
  %295 = icmp slt <8 x i64> %a5.3, <i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647>
  %a4.3 = select <8 x i1> %295, <8 x i64> %a5.3, <8 x i64> <i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647, i64 2147483647>
  %296 = icmp sgt <8 x i64> %a4.3, <i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648>
  %297 = select <8 x i1> %296, <8 x i64> %a4.3, <8 x i64> <i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648, i64 -2147483648>
  %298 = trunc <8 x i64> %297 to <8 x i32>
  %299 = ashr <8 x i32> %298, %67
  %300 = lshr <8 x i32> %298, %71
  %301 = and <8 x i32> %300, %68
  %302 = add nsw <8 x i32> %301, %299
  %303 = shufflevector <8 x i32> %302, <8 x i32> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %304 = shufflevector <8 x i32> %302, <8 x i32> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %305 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %303, <4 x i32> %304) #12
  %306 = tail call <8 x i16> @llvm.sadd.sat.v8i16(<8 x i16> %305, <8 x i16> %74)
  %307 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %306, <8 x i16> undef) #12
  %308 = shufflevector <16 x i8> %307, <16 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %309 = icmp ugt <16 x i8> %76, %308
  %310 = select <16 x i1> %309, <16 x i8> %308, <16 x i8> %76
  %311 = shufflevector <16 x i8> %310, <16 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %312 = icmp ugt <16 x i8> %311, %78
  %313 = select <16 x i1> %312, <16 x i8> %311, <16 x i8> %78
  %314 = shufflevector <16 x i8> %313, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %315 = add nsw i64 %273, %89
  %316 = getelementptr inbounds i8, i8* %output, i64 %315
  %317 = bitcast i8* %316 to <8 x i8>*
  store <8 x i8> %314, <8 x i8>* %317, align 1, !tbaa !239
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.not46 = icmp eq i64 %indvars.iv.next, 30
  br i1 %.not46, label %"end for output.s0.x.xi.xi", label %"for output.s0.x.xi.xi"

"end for output.s0.x.xi.xi":                      ; preds = %"for output.s0.x.xi.xi"
  %indvars.iv.next54 = add nuw nsw i64 %indvars.iv53, 1
  %.not47 = icmp eq i64 %indvars.iv.next54, 68
  br i1 %.not47, label %"end for output.s0.y.yi", label %"for output.s0.y.yi"

"for output.s0.y.yi27":                           ; preds = %"end for output.s0.y.yi", %"end for output.s0.x.xi.xi32"
  %indvars.iv65 = phi i64 [ 0, %"end for output.s0.y.yi" ], [ %indvars.iv.next66, %"end for output.s0.x.xi.xi32" ]
  %318 = add nsw i64 %indvars.iv65, %124
  %319 = mul nsw i64 %318, %125
  %320 = sub nsw i64 %319, %126
  %321 = mul nsw i64 %318, %127
  %322 = sub nsw i64 %321, %128
  %323 = mul nsw i64 %318, %129
  %324 = sub nsw i64 %323, %130
  br label %"for output.s0.x.xi.xi31"

"for output.s0.x.xi.xi31":                        ; preds = %"for output.s0.y.yi27", %"for output.s0.x.xi.xi31"
  %indvars.iv62 = phi i64 [ 0, %"for output.s0.y.yi27" ], [ %indvars.iv.next63, %"for output.s0.x.xi.xi31" ]
  %325 = shl i64 %indvars.iv62, 5
  %326 = shl nsw i64 %indvars.iv62, 5
  %327 = add nsw i64 %326, %123
  %328 = add nsw i64 %327, %324
  %329 = getelementptr inbounds i8, i8* %input12, i64 %328
  %330 = bitcast i8* %329 to <8 x i8>*
  %331 = load <8 x i8>, <8 x i8>* %330, align 1, !tbaa !234
  %332 = add nsw i64 %327, %322
  %333 = getelementptr inbounds i8, i8* %input23, i64 %332
  %334 = bitcast i8* %333 to <8 x i8>*
  %335 = load <8 x i8>, <8 x i8>* %334, align 1, !tbaa !237
  %336 = tail call <8 x i16> @hydride.node.0(<8 x i8> %331, i16 %113, <8 x i8> %335, i16 %115, i32 %output_multiplier12, <8 x i8> %331, i16 %113, <8 x i8> %335, i16 %115, i32 %t917, i1 %116, <8 x i8> %331, i16 %113, <8 x i8> %335, i16 %115, <8 x i8> %331, i16 %113, <8 x i8> %335, i16 %115, i32 %117, i16 %118) #12
  %a11 = trunc <8 x i16> %336 to <8 x i8>
  %337 = shufflevector <8 x i8> %a11, <8 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %338 = icmp ugt <16 x i8> %120, %337
  %339 = select <16 x i1> %338, <16 x i8> %337, <16 x i8> %120
  %340 = shufflevector <16 x i8> %339, <16 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %341 = icmp ugt <16 x i8> %340, %122
  %342 = select <16 x i1> %341, <16 x i8> %340, <16 x i8> %122
  %343 = shufflevector <16 x i8> %342, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %344 = add nsw i64 %327, %320
  %345 = getelementptr inbounds i8, i8* %output4, i64 %344
  %346 = bitcast i8* %345 to <8 x i8>*
  store <8 x i8> %343, <8 x i8>* %346, align 1, !tbaa !239
  %347 = shl i64 %indvars.iv62, 5
  %348 = or i64 %347, 8
  %349 = add nsw i64 %348, %123
  %350 = add nsw i64 %349, %324
  %351 = getelementptr inbounds i8, i8* %input12, i64 %350
  %352 = bitcast i8* %351 to <8 x i8>*
  %353 = load <8 x i8>, <8 x i8>* %352, align 1, !tbaa !234
  %354 = add nsw i64 %349, %322
  %355 = getelementptr inbounds i8, i8* %input23, i64 %354
  %356 = bitcast i8* %355 to <8 x i8>*
  %357 = load <8 x i8>, <8 x i8>* %356, align 1, !tbaa !237
  %358 = tail call <8 x i16> @hydride.node.0(<8 x i8> %353, i16 %113, <8 x i8> %357, i16 %115, i32 %output_multiplier12, <8 x i8> %353, i16 %113, <8 x i8> %357, i16 %115, i32 %t917, i1 %116, <8 x i8> %353, i16 %113, <8 x i8> %357, i16 %115, <8 x i8> %353, i16 %113, <8 x i8> %357, i16 %115, i32 %117, i16 %118) #12
  %a11.1 = trunc <8 x i16> %358 to <8 x i8>
  %359 = shufflevector <8 x i8> %a11.1, <8 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %360 = icmp ugt <16 x i8> %120, %359
  %361 = select <16 x i1> %360, <16 x i8> %359, <16 x i8> %120
  %362 = shufflevector <16 x i8> %361, <16 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %363 = icmp ugt <16 x i8> %362, %122
  %364 = select <16 x i1> %363, <16 x i8> %362, <16 x i8> %122
  %365 = shufflevector <16 x i8> %364, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %366 = add nsw i64 %349, %320
  %367 = getelementptr inbounds i8, i8* %output4, i64 %366
  %368 = bitcast i8* %367 to <8 x i8>*
  store <8 x i8> %365, <8 x i8>* %368, align 1, !tbaa !239
  %369 = shl i64 %indvars.iv62, 5
  %370 = or i64 %369, 16
  %371 = add nsw i64 %370, %123
  %372 = add nsw i64 %371, %324
  %373 = getelementptr inbounds i8, i8* %input12, i64 %372
  %374 = bitcast i8* %373 to <8 x i8>*
  %375 = load <8 x i8>, <8 x i8>* %374, align 1, !tbaa !234
  %376 = add nsw i64 %371, %322
  %377 = getelementptr inbounds i8, i8* %input23, i64 %376
  %378 = bitcast i8* %377 to <8 x i8>*
  %379 = load <8 x i8>, <8 x i8>* %378, align 1, !tbaa !237
  %380 = tail call <8 x i16> @hydride.node.0(<8 x i8> %375, i16 %113, <8 x i8> %379, i16 %115, i32 %output_multiplier12, <8 x i8> %375, i16 %113, <8 x i8> %379, i16 %115, i32 %t917, i1 %116, <8 x i8> %375, i16 %113, <8 x i8> %379, i16 %115, <8 x i8> %375, i16 %113, <8 x i8> %379, i16 %115, i32 %117, i16 %118) #12
  %a11.2 = trunc <8 x i16> %380 to <8 x i8>
  %381 = shufflevector <8 x i8> %a11.2, <8 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %382 = icmp ugt <16 x i8> %120, %381
  %383 = select <16 x i1> %382, <16 x i8> %381, <16 x i8> %120
  %384 = shufflevector <16 x i8> %383, <16 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %385 = icmp ugt <16 x i8> %384, %122
  %386 = select <16 x i1> %385, <16 x i8> %384, <16 x i8> %122
  %387 = shufflevector <16 x i8> %386, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %388 = add nsw i64 %371, %320
  %389 = getelementptr inbounds i8, i8* %output4, i64 %388
  %390 = bitcast i8* %389 to <8 x i8>*
  store <8 x i8> %387, <8 x i8>* %390, align 1, !tbaa !239
  %391 = or i64 %325, 24
  %392 = add nsw i64 %391, %123
  %393 = add nsw i64 %392, %324
  %394 = getelementptr inbounds i8, i8* %input12, i64 %393
  %395 = bitcast i8* %394 to <8 x i8>*
  %396 = load <8 x i8>, <8 x i8>* %395, align 1, !tbaa !234
  %397 = add nsw i64 %392, %322
  %398 = getelementptr inbounds i8, i8* %input23, i64 %397
  %399 = bitcast i8* %398 to <8 x i8>*
  %400 = load <8 x i8>, <8 x i8>* %399, align 1, !tbaa !237
  %401 = tail call <8 x i16> @hydride.node.0(<8 x i8> %396, i16 %113, <8 x i8> %400, i16 %115, i32 %output_multiplier12, <8 x i8> %396, i16 %113, <8 x i8> %400, i16 %115, i32 %t917, i1 %116, <8 x i8> %396, i16 %113, <8 x i8> %400, i16 %115, <8 x i8> %396, i16 %113, <8 x i8> %400, i16 %115, i32 %117, i16 %118) #12
  %a11.3 = trunc <8 x i16> %401 to <8 x i8>
  %402 = shufflevector <8 x i8> %a11.3, <8 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %403 = icmp ugt <16 x i8> %120, %402
  %404 = select <16 x i1> %403, <16 x i8> %402, <16 x i8> %120
  %405 = shufflevector <16 x i8> %404, <16 x i8> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %406 = icmp ugt <16 x i8> %405, %122
  %407 = select <16 x i1> %406, <16 x i8> %405, <16 x i8> %122
  %408 = shufflevector <16 x i8> %407, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %409 = add nsw i64 %392, %320
  %410 = getelementptr inbounds i8, i8* %output4, i64 %409
  %411 = bitcast i8* %410 to <8 x i8>*
  store <8 x i8> %408, <8 x i8>* %411, align 1, !tbaa !239
  %indvars.iv.next63 = add nuw nsw i64 %indvars.iv62, 1
  %.not49 = icmp eq i64 %indvars.iv.next63, 30
  br i1 %.not49, label %"end for output.s0.x.xi.xi32", label %"for output.s0.x.xi.xi31"

"end for output.s0.x.xi.xi32":                    ; preds = %"for output.s0.x.xi.xi31"
  %indvars.iv.next66 = add nuw nsw i64 %indvars.iv65, 1
  %.not50 = icmp eq i64 %indvars.iv.next66, 68
  br i1 %.not50, label %destructor_block, label %"for output.s0.y.yi27"

destructor_block:                                 ; preds = %"end for output.s0.x.xi.xi32"
  ret i32 0
}

; Function Attrs: nounwind
define i32 @mul(%struct.halide_buffer_t* noalias nocapture readonly %input1.buffer, i8 %input1_zero, %struct.halide_buffer_t* noalias nocapture readonly %input2.buffer, i8 %input2_zero, i8 %output_zero, i32 %output_multiplier, i32 %a13, i8 %output_min, i8 %output_max, %struct.halide_buffer_t* noalias nocapture readonly %output.buffer) local_unnamed_addr #11 {
entry:
  %parallel_closure25 = alloca { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, align 8
  %parallel_closure = alloca { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, align 8
  ...
  %min.i29 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %1, i64 1, i32 0
  %3 = load i32, i32* %min.i29, align 4, !tbaa !76
  %stride.i31 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %1, i64 1, i32 2
  %4 = load i32, i32* %stride.i31, align 4, !tbaa !77
  %host.i32 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input2.buffer, i64 0, i32 2
  %5 = load i8*, i8** %host.i32, align 8, !tbaa !67
  %dim.i33 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input2.buffer, i64 0, i32 6
  %6 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %dim.i33, align 8, !tbaa !71
  %min.i34 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %6, i64 0, i32 0
  %7 = load i32, i32* %min.i34, align 4, !tbaa !76
  %min.i38 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %6, i64 1, i32 0
  %8 = load i32, i32* %min.i38, align 4, !tbaa !76
  %stride.i40 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %6, i64 1, i32 2
  %9 = load i32, i32* %stride.i40, align 4, !tbaa !77
  %host.i41 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 2
  %10 = load i8*, i8** %host.i41, align 8, !tbaa !67
  %dim.i42 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 6
  %11 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %dim.i42, align 8, !tbaa !71
  %min.i43 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %11, i64 0, i32 0
  %12 = load i32, i32* %min.i43, align 4, !tbaa !76
  %extent.i = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %11, i64 0, i32 1
  %13 = load i32, i32* %extent.i, align 4, !tbaa !73
  %min.i48 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %11, i64 1, i32 0
  %14 = load i32, i32* %min.i48, align 4, !tbaa !76
  %extent.i50 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %11, i64 1, i32 1
  %15 = load i32, i32* %extent.i50, align 4, !tbaa !73
  %stride.i52 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %11, i64 1, i32 2
  %16 = load i32, i32* %stride.i52, align 4, !tbaa !77
  %17 = icmp slt i32 %13, -959
  %t99.neg84 = zext i1 %17 to i32
  %t99 = sext i1 %17 to i32
  %18 = add i32 %13, 959
  %19 = add i32 %18, %t99.neg84
  %20 = sdiv i32 %19, 960
  %21 = add nsw i32 %20, %t99
  %22 = add nsw i32 %15, 67
  %23 = ashr i32 %22, 31
  %24 = xor i32 %23, %22
  %25 = zext i32 %24 to i64
  %26 = mul nuw i64 %25, 4042322161
  %27 = lshr i64 %26, 38
  %28 = trunc i64 %27 to i32
  %29 = xor i32 %23, %28
  %output.s0.x.x.x.loop_extent = mul nsw i32 %29, %21
  %30 = icmp ult i32 %a13, 15
  %t9 = select i1 %30, i32 %a13, i32 15
  %31 = mul nsw i32 %16, %14
  %t10 = add nsw i32 %31, %12
  %32 = mul nsw i32 %9, %8
  %t8 = add nsw i32 %32, %7
  %33 = mul nsw i32 %4, %3
  %t7 = add nsw i32 %33, %2
  %34 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 0
  store i8* %0, i8** %34, align 8
  %35 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 1
  store i8* %5, i8** %35, align 8
  %36 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 2
  store i8* %10, i8** %36, align 8
  %37 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 3
  store i32 %4, i32* %37, align 8
  %38 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 4
  store i32 %9, i32* %38, align 4
  %39 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 5
  store i32 %13, i32* %39, align 8
  %40 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 6
  store i32 %15, i32* %40, align 4
  %41 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 7
  store i32 %12, i32* %41, align 8
  %42 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 8
  store i32 %14, i32* %42, align 4
  %43 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 9
  store i32 %16, i32* %43, align 8
  %44 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 10
  store i32 %output_multiplier, i32* %44, align 4
  %45 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 11
  store i32 %t10, i32* %45, align 8
  %46 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 12
  store i32 %21, i32* %46, align 4
  %47 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 13
  store i32 %t7, i32* %47, align 8
  %48 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 14
  store i32 %t8, i32* %48, align 4
  %49 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 15
  store i32 %t9, i32* %49, align 8
  %50 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 16
  store i8 %input1_zero, i8* %50, align 4
  %51 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 17
  store i8 %input2_zero, i8* %51, align 1
  %52 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 18
  store i8 %output_max, i8* %52, align 2
  %53 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 19
  store i8 %output_min, i8* %53, align 1
  %54 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure, i64 0, i32 20
  store i8 %output_zero, i8* %54, align 8
  %55 = bitcast { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure to i8*
  %closure_result = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @mul_par_for_output_s0_x_x_x, i32 0, i32 %output.s0.x.x.x.loop_extent, i8* nonnull %55) #12
  %56 = load i32, i32* %min.i, align 4, !tbaa !76
  %57 = load i32, i32* %min.i29, align 4, !tbaa !76
  %58 = load i32, i32* %stride.i31, align 4, !tbaa !77
  %59 = load i32, i32* %min.i34, align 4, !tbaa !76
  %60 = load i32, i32* %min.i38, align 4, !tbaa !76
  %61 = load i32, i32* %stride.i40, align 4, !tbaa !77
  %62 = load i32, i32* %min.i43, align 4, !tbaa !76
  %63 = load i32, i32* %extent.i, align 4, !tbaa !73
  %64 = load i32, i32* %min.i48, align 4, !tbaa !76
  %65 = load i32, i32* %extent.i50, align 4, !tbaa !73
  %66 = load i32, i32* %stride.i52, align 4, !tbaa !77
  %67 = icmp slt i32 %63, -959
  %t137.neg85 = zext i1 %67 to i32
  %t137 = sext i1 %67 to i32
  %68 = add i32 %63, 959
  %69 = add i32 %68, %t137.neg85
  %70 = sdiv i32 %69, 960
  %71 = add nsw i32 %70, %t137
  %72 = add nsw i32 %65, 67
  %73 = ashr i32 %72, 31
  %74 = xor i32 %73, %72
  %75 = zext i32 %74 to i64
  %76 = mul nuw i64 %75, 4042322161
  %77 = lshr i64 %76, 38
  %78 = trunc i64 %77 to i32
  %79 = xor i32 %73, %78
  %output.s0.x.x.x.loop_extent18 = mul nsw i32 %79, %71
  %80 = mul nsw i32 %66, %64
  %t1022 = add nsw i32 %80, %62
  %81 = mul nsw i32 %61, %60
  %t823 = add nsw i32 %81, %59
  %82 = mul nsw i32 %58, %57
  %t724 = add nsw i32 %82, %56
  %83 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 0
  store i8* %0, i8** %83, align 8
  %84 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 1
  store i8* %5, i8** %84, align 8
  %85 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 2
  store i8* %10, i8** %85, align 8
  %86 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 3
  store i32 %58, i32* %86, align 8
  %87 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 4
  store i32 %61, i32* %87, align 4
  %88 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 5
  store i32 %63, i32* %88, align 8
  %89 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 6
  store i32 %65, i32* %89, align 4
  %90 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 7
  store i32 %62, i32* %90, align 8
  %91 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 8
  store i32 %64, i32* %91, align 4
  %92 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 9
  store i32 %66, i32* %92, align 8
  %93 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 10
  store i32 %output_multiplier, i32* %93, align 4
  %94 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 11
  store i32 %t1022, i32* %94, align 8
  %95 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 12
  store i32 %71, i32* %95, align 4
  %96 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 13
  store i32 %t724, i32* %96, align 8
  %97 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 14
  store i32 %t823, i32* %97, align 4
  %98 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 15
  store i32 %t9, i32* %98, align 8
  %99 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 16
  store i8 %input1_zero, i8* %99, align 4
  %100 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 17
  store i8 %input2_zero, i8* %100, align 1
  %101 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 18
  store i8 %output_max, i8* %101, align 2
  %102 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 19
  store i8 %output_min, i8* %102, align 1
  %103 = getelementptr inbounds { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }, { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25, i64 0, i32 20
  store i8 %output_zero, i8* %103, align 8
  %104 = bitcast { i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i8, i8, i8 }* %parallel_closure25 to i8*
  %closure_result26 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @mul_par_for_output_s0_x_x_x, i32 0, i32 %output.s0.x.x.x.loop_extent18, i8* nonnull %104) #12
  ret i32 0
}

; Function Attrs: nounwind
define i32 @mul_argv(i8** nocapture readonly %0) local_unnamed_addr #12 {
entry:
  ...
  %32 = tail call i32 @mul(%struct.halide_buffer_t* %2, i8 %5, %struct.halide_buffer_t* %8, i8 %11, i8 %14, i32 %18, i32 %22, i8 %25, i8 %28, %struct.halide_buffer_t* %31) #19
  ret i32 0
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @mul_metadata() local_unnamed_addr #13 {
entry:
  ret %struct.halide_filter_metadata_t* @mul_metadata_storage
}

declare <8 x i16> @hydride.node.0(<8 x i8>, i16, <8 x i8>, i16, i32, <8 x i8>, i16, <8 x i8>, i16, i32, i1, <8 x i8>, i16, <8 x i8>, i16, <8 x i8>, i16, <8 x i8>, i16, i32, i16) local_unnamed_addr
...
!233 = !{i32 22, i32 33}
!234 = !{!235, !235, i64 0}
!235 = !{!"input1", !236, i64 0}
!236 = !{!"Halide buffer"}
!237 = !{!238, !238, i64 0}
!238 = !{!"input2", !236, i64 0}
!239 = !{!240, !240, i64 0}
!240 = !{!"output", !236, i64 0}
