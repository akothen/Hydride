...
@str.170 = private constant [7 x i8] c"blur_y\00", align 32
...
@str.172 = private constant [8 x i8] c"blur3x3\00", align 32
...
; Function Attrs: nounwind
define i32 @blur3x3_par_for_blur_y_s0_y_y(i8* %__user_context, i32 %blur_y.s0.y.y, i8* nocapture readonly %closure_arg) #11 {
entry:
  %blur_x.pseudostack_slot = alloca %struct.halide_pseudostack_slot_t, align 8
  %.fca.0.gep = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot, i64 0, i32 0
  %.fca.1.gep = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot, i64 0, i32 1
  %.fca.2.gep = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot, i64 0, i32 2
  %0 = bitcast i8* %closure_arg to i16**
  %1 = bitcast %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(24) %1, i8 0, i64 24, i1 false)
  %blur_y58 = load i16*, i16** %0, align 8
  %2 = getelementptr inbounds i8, i8* %closure_arg, i64 8
  %3 = bitcast i8* %2 to i16**
  %input59 = load i16*, i16** %3, align 8
  %4 = getelementptr inbounds i8, i8* %closure_arg, i64 16
  %5 = bitcast i8* %4 to i32*
  %blur_y.extent.0 = load i32, i32* %5, align 4
  %6 = getelementptr inbounds i8, i8* %closure_arg, i64 20
  %7 = bitcast i8* %6 to i32*
  %blur_y.extent.1 = load i32, i32* %7, align 4
  %8 = getelementptr inbounds i8, i8* %closure_arg, i64 24
  %9 = bitcast i8* %8 to i32*
  %blur_y.min.0 = load i32, i32* %9, align 4
  %10 = getelementptr inbounds i8, i8* %closure_arg, i64 28
  %11 = bitcast i8* %10 to i32*
  %blur_y.min.1 = load i32, i32* %11, align 4
  %12 = getelementptr inbounds i8, i8* %closure_arg, i64 32
  %13 = bitcast i8* %12 to i32*
  %blur_y.stride.1 = load i32, i32* %13, align 4
  %14 = getelementptr inbounds i8, i8* %closure_arg, i64 36
  %15 = bitcast i8* %14 to i32*
  %input.stride.1 = load i32, i32* %15, align 4
  %16 = getelementptr inbounds i8, i8* %closure_arg, i64 40
  %17 = bitcast i8* %16 to i32*
  %t13 = load i32, i32* %17, align 4
  %18 = getelementptr inbounds i8, i8* %closure_arg, i64 44
  %19 = bitcast i8* %18 to i32*
  %t14 = load i32, i32* %19, align 4
  %20 = getelementptr inbounds i8, i8* %closure_arg, i64 48
  %21 = bitcast i8* %20 to i32*
  %t15 = load i32, i32* %21, align 4
  %a0 = mul nsw i32 %blur_y.s0.y.y, 34
  %b1 = add nsw i32 %blur_y.extent.1, -34
  %22 = icmp sgt i32 %b1, %a0
  %blur_y.s0.y.yi.base.s = select i1 %22, i32 %a0, i32 %b1
  %t16 = add nsw i32 %blur_y.s0.y.yi.base.s, %blur_y.min.1
  %23 = icmp sgt i32 %t13, 0
  %b2 = add nsw i32 %blur_y.extent.0, -480
  %24 = bitcast %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot to [18246 x i8*]**
  %t18 = sub i32 %blur_y.min.0, %t14
  %25 = bitcast %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot to i8*
  br i1 %23, label %"for blur_y.s0.y.yi.yi.us.preheader", label %call_destructor.exit, !prof !234

"for blur_y.s0.y.yi.yi.us.preheader":             ; preds = %entry
  %.fca.2.gep.promoted = load i64, i64* %.fca.2.gep, align 8
  %.fca.1.gep.promoted = load i64, i64* %.fca.1.gep, align 8, !tbaa !235
  br label %"for blur_y.s0.x.x.us"

"for blur_y.s0.x.x.us":                           ; preds = %"for blur_y.s0.y.yi.yi.us.preheader", %"end for blur_y.s0.y.yi.yii.us"
  %26 = phi i64 [ %32, %"end for blur_y.s0.y.yi.yii.us" ], [ %.fca.1.gep.promoted, %"for blur_y.s0.y.yi.yi.us.preheader" ]
  %.pre170 = phi i64 [ %.pre169, %"end for blur_y.s0.y.yi.yii.us" ], [ %.fca.2.gep.promoted, %"for blur_y.s0.y.yi.yi.us.preheader" ]
  %27 = phi i8* [ %41, %"end for blur_y.s0.y.yi.yii.us" ], [ null, %"for blur_y.s0.y.yi.yi.us.preheader" ]
  %28 = phi i8* [ %42, %"end for blur_y.s0.y.yi.yii.us" ], [ null, %"for blur_y.s0.y.yi.yi.us.preheader" ]
  %29 = phi i8* [ %43, %"end for blur_y.s0.y.yi.yii.us" ], [ null, %"for blur_y.s0.y.yi.yi.us.preheader" ]
  %30 = phi i64 [ %35, %"end for blur_y.s0.y.yi.yii.us" ], [ 0, %"for blur_y.s0.y.yi.yi.us.preheader" ]
  %blur_y.s0.x.x.us = phi i32 [ %167, %"end for blur_y.s0.y.yi.yii.us" ], [ 0, %"for blur_y.s0.y.yi.yi.us.preheader" ]
  %a1.us = mul nsw i32 %blur_y.s0.x.x.us, 480
  %31 = icmp sgt i32 %b2, %a1.us
  %blur_y.s0.x.xi.base.s.us = select i1 %31, i32 %a1.us, i32 %b2
  %cmp.i.us = icmp ult i64 %30, 18246
  br i1 %cmp.i.us, label %if.then.i.us, label %pseudostack_alloc.exit.us, !prof !237

if.then.i.us:                                     ; preds = %"for blur_y.s0.x.x.us"
  %tobool1.not.i.us = icmp ne i8* %29, null
  %cmp2.i.us = icmp ugt i64 %.pre170, 16384
  %or.cond.us = and i1 %tobool1.not.i.us, %cmp2.i.us
  br i1 %or.cond.us, label %if.then3.i.us, label %if.end.i.us

if.then3.i.us:                                    ; preds = %if.then.i.us
  call void @halide_free(i8* %__user_context, i8* nonnull %29) #17
  br label %if.end.i.us

if.end.i.us:                                      ; preds = %if.then3.i.us, %if.then.i.us
  %add.i.us = add i64 %.pre170, 18246
  %cmp7.i.us = icmp ugt i64 %add.i.us, 16384
  br i1 %cmp7.i.us, label %if.then8.i.us, label %if.end11.i.us

if.then8.i.us:                                    ; preds = %if.end.i.us
  %call.i.us = call i8* @halide_malloc(i8* %__user_context, i64 18246) #17
  br label %if.end11.i.us

if.end11.i.us:                                    ; preds = %if.then8.i.us, %if.end.i.us
  %storemerge.i.us = phi i8* [ %call.i.us, %if.then8.i.us ], [ null, %if.end.i.us ]
  store i8* %storemerge.i.us, i8** %.fca.0.gep, align 8, !tbaa !238
  br label %pseudostack_alloc.exit.us

pseudostack_alloc.exit.us:                        ; preds = %if.end11.i.us, %"for blur_y.s0.x.x.us"
  %32 = phi i64 [ 18246, %if.end11.i.us ], [ %26, %"for blur_y.s0.x.x.us" ]
  %.pre169 = phi i64 [ %add.i.us, %if.end11.i.us ], [ %.pre170, %"for blur_y.s0.x.x.us" ]
  %33 = phi i8* [ %storemerge.i.us, %if.end11.i.us ], [ %27, %"for blur_y.s0.x.x.us" ]
  %34 = phi i8* [ %storemerge.i.us, %if.end11.i.us ], [ %28, %"for blur_y.s0.x.x.us" ]
  %35 = phi i64 [ 18246, %if.end11.i.us ], [ %30, %"for blur_y.s0.x.x.us" ]
  %36 = phi i8* [ %storemerge.i.us, %if.end11.i.us ], [ %29, %"for blur_y.s0.x.x.us" ]
  %37 = bitcast i8* %36 to i16*
  %.not69.us = icmp eq i8* %36, null
  br i1 %.not69.us, label %then_bb.us, label %"produce blur_x.us", !prof !239

then_bb.us:                                       ; preds = %pseudostack_alloc.exit.us
  %38 = alloca [18246 x i8*], align 64
  %39 = bitcast [18246 x i8*]* %38 to i16*
  store [18246 x i8*]* %38, [18246 x i8*]** %24, align 8
  %40 = bitcast [18246 x i8*]* %38 to i8*
  br label %"produce blur_x.us"

"produce blur_x.us":                              ; preds = %then_bb.us, %pseudostack_alloc.exit.us
  %41 = phi i8* [ %40, %then_bb.us ], [ %33, %pseudostack_alloc.exit.us ]
  %42 = phi i8* [ %40, %then_bb.us ], [ %34, %pseudostack_alloc.exit.us ]
  %43 = phi i8* [ %40, %then_bb.us ], [ %36, %pseudostack_alloc.exit.us ]
  %blur_x.us = phi i16* [ %39, %then_bb.us ], [ %37, %pseudostack_alloc.exit.us ]
  %blur_x.s0.x.xi.base.us = add i32 %t18, %blur_y.s0.x.xi.base.s.us
  br label %"for blur_x.s0.y.rebased.us"

"for blur_x.s0.y.rebased.us":                     ; preds = %"end for blur_x.s0.x.x.us", %"produce blur_x.us"
  %indvars.iv108 = phi i64 [ %indvars.iv.next109, %"end for blur_x.s0.x.x.us" ], [ 0, %"produce blur_x.us" ]
  %44 = mul nuw nsw i64 %indvars.iv108, 30
  %45 = trunc i64 %indvars.iv108 to i32
  %46 = add nsw i32 %t16, %45
  %47 = mul nsw i32 %46, %input.stride.1
  %t19.us = add i32 %blur_x.s0.x.xi.base.us, %47
  br label %"for blur_x.s0.x.x.us"

"for blur_x.s0.x.x.us":                           ; preds = %"for blur_x.s0.x.x.us", %"for blur_x.s0.y.rebased.us"
  %indvars.iv = phi i64 [ 0, %"for blur_x.s0.y.rebased.us" ], [ %indvars.iv.next.2, %"for blur_x.s0.x.x.us" ]
  %indvars.iv.tr = trunc i64 %indvars.iv to i32
  %48 = shl i32 %indvars.iv.tr, 4
  %t9.us = add i32 %t19.us, %48
  %49 = sext i32 %t9.us to i64
  %50 = getelementptr inbounds i16, i16* %input59, i64 %49
  %51 = getelementptr inbounds i16, i16* %50, i64 1
  %52 = bitcast i16* %51 to <16 x i16>*
  %53 = load <16 x i16>, <16 x i16>* %52, align 2, !tbaa !240
  %54 = getelementptr inbounds i16, i16* %50, i64 2
  %55 = bitcast i16* %54 to <16 x i16>*
  %56 = load <16 x i16>, <16 x i16>* %55, align 2, !tbaa !240
  %57 = bitcast i16* %50 to <16 x i16>*
  %58 = load <16 x i16>, <16 x i16>* %57, align 2, !tbaa !240
  %59 = add <16 x i16> %56, %53
  %60 = add <16 x i16> %59, %58
  %61 = call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %60, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %62 = lshr <16 x i16> %61, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %63 = add nuw nsw i64 %indvars.iv, %44
  %64 = shl nuw nsw i64 %63, 4
  %65 = getelementptr inbounds i16, i16* %blur_x.us, i64 %64
  %66 = bitcast i16* %65 to <16 x i16>*
  store <16 x i16> %62, <16 x i16>* %66, align 32, !tbaa !243
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %indvars.iv.tr.1 = trunc i64 %indvars.iv.next to i32
  %67 = shl i32 %indvars.iv.tr.1, 4
  %t9.us.1203 = add i32 %t19.us, %67
  %68 = sext i32 %t9.us.1203 to i64
  %69 = getelementptr inbounds i16, i16* %input59, i64 %68
  %70 = getelementptr inbounds i16, i16* %69, i64 1
  %71 = bitcast i16* %70 to <16 x i16>*
  %72 = load <16 x i16>, <16 x i16>* %71, align 2, !tbaa !240
  %73 = getelementptr inbounds i16, i16* %69, i64 2
  %74 = bitcast i16* %73 to <16 x i16>*
  %75 = load <16 x i16>, <16 x i16>* %74, align 2, !tbaa !240
  %76 = bitcast i16* %69 to <16 x i16>*
  %77 = load <16 x i16>, <16 x i16>* %76, align 2, !tbaa !240
  %78 = add <16 x i16> %75, %72
  %79 = add <16 x i16> %78, %77
  %80 = call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %79, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %81 = lshr <16 x i16> %80, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %82 = add nuw nsw i64 %indvars.iv.next, %44
  %83 = shl nuw nsw i64 %82, 4
  %84 = getelementptr inbounds i16, i16* %blur_x.us, i64 %83
  %85 = bitcast i16* %84 to <16 x i16>*
  store <16 x i16> %81, <16 x i16>* %85, align 32, !tbaa !243
  %indvars.iv.next.1204 = add nuw nsw i64 %indvars.iv, 2
  %indvars.iv.tr.2 = trunc i64 %indvars.iv.next.1204 to i32
  %86 = shl i32 %indvars.iv.tr.2, 4
  %t9.us.2 = add i32 %t19.us, %86
  %87 = sext i32 %t9.us.2 to i64
  %88 = getelementptr inbounds i16, i16* %input59, i64 %87
  %89 = getelementptr inbounds i16, i16* %88, i64 1
  %90 = bitcast i16* %89 to <16 x i16>*
  %91 = load <16 x i16>, <16 x i16>* %90, align 2, !tbaa !240
  %92 = getelementptr inbounds i16, i16* %88, i64 2
  %93 = bitcast i16* %92 to <16 x i16>*
  %94 = load <16 x i16>, <16 x i16>* %93, align 2, !tbaa !240
  %95 = bitcast i16* %88 to <16 x i16>*
  %96 = load <16 x i16>, <16 x i16>* %95, align 2, !tbaa !240
  %97 = add <16 x i16> %94, %91
  %98 = add <16 x i16> %97, %96
  %99 = call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %98, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %100 = lshr <16 x i16> %99, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %101 = add nuw nsw i64 %indvars.iv.next.1204, %44
  %102 = shl nuw nsw i64 %101, 4
  %103 = getelementptr inbounds i16, i16* %blur_x.us, i64 %102
  %104 = bitcast i16* %103 to <16 x i16>*
  store <16 x i16> %100, <16 x i16>* %104, align 32, !tbaa !243
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %.not71.us.2 = icmp eq i64 %indvars.iv.next.2, 30
  br i1 %.not71.us.2, label %"end for blur_x.s0.x.x.us", label %"for blur_x.s0.x.x.us"

"end for blur_x.s0.x.x.us":                       ; preds = %"for blur_x.s0.x.x.us"
  %indvars.iv.next109 = add nuw nsw i64 %indvars.iv108, 1
  %.not72.us = icmp eq i64 %indvars.iv.next109, 19
  br i1 %.not72.us, label %"consume blur_x.us", label %"for blur_x.s0.y.rebased.us"

"consume blur_x.us":                              ; preds = %"end for blur_x.s0.x.x.us"
  %t21.us = add nsw i32 %blur_y.s0.x.xi.base.s.us, %t15
  br label %"for blur_y.s0.y.yi.yii.us"

"for blur_y.s0.y.yi.yii.us":                      ; preds = %"end for blur_y.s0.x.xi.xi.us", %"consume blur_x.us"
  %indvars.iv114 = phi i64 [ %indvars.iv.next115, %"end for blur_y.s0.x.xi.xi.us" ], [ 0, %"consume blur_x.us" ]
  %105 = mul nuw nsw i64 %indvars.iv114, 30
  %106 = trunc i64 %indvars.iv114 to i32
  %107 = add nsw i32 %t16, %106
  %108 = mul nsw i32 %107, %blur_y.stride.1
  %t23.us = add nsw i32 %t21.us, %108
  %109 = sext i32 %t23.us to i64
  br label %"for blur_y.s0.x.xi.xi.us"

"for blur_y.s0.x.xi.xi.us":                       ; preds = %"for blur_y.s0.x.xi.xi.us", %"for blur_y.s0.y.yi.yii.us"
  %indvars.iv111 = phi i64 [ 0, %"for blur_y.s0.y.yi.yii.us" ], [ %indvars.iv.next112.2, %"for blur_y.s0.x.xi.xi.us" ]
  %110 = add nuw nsw i64 %indvars.iv111, %105
  %111 = shl nuw nsw i64 %110, 4
  %112 = getelementptr inbounds i16, i16* %blur_x.us, i64 %111
  %113 = getelementptr inbounds i16, i16* %112, i64 480
  %114 = bitcast i16* %113 to <16 x i16>*
  %115 = load <16 x i16>, <16 x i16>* %114, align 32, !tbaa !243
  %116 = getelementptr inbounds i16, i16* %112, i64 960
  %117 = bitcast i16* %116 to <16 x i16>*
  %118 = load <16 x i16>, <16 x i16>* %117, align 32, !tbaa !243
  %119 = bitcast i16* %112 to <16 x i16>*
  %120 = load <16 x i16>, <16 x i16>* %119, align 32, !tbaa !243
  %121 = add <16 x i16> %118, %115
  %122 = add <16 x i16> %121, %120
  %123 = call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %122, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %124 = lshr <16 x i16> %123, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %125 = shl nuw nsw i64 %indvars.iv111, 4
  %126 = add nsw i64 %125, %109
  %127 = getelementptr inbounds i16, i16* %blur_y58, i64 %126
  %128 = bitcast i16* %127 to <16 x i16>*
  store <16 x i16> %124, <16 x i16>* %128, align 2, !tbaa !245
  %indvars.iv.next112 = add nuw nsw i64 %indvars.iv111, 1
  %129 = add nuw nsw i64 %indvars.iv.next112, %105
  %130 = shl nuw nsw i64 %129, 4
  %131 = getelementptr inbounds i16, i16* %blur_x.us, i64 %130
  %132 = getelementptr inbounds i16, i16* %131, i64 480
  %133 = bitcast i16* %132 to <16 x i16>*
  %134 = load <16 x i16>, <16 x i16>* %133, align 32, !tbaa !243
  %135 = getelementptr inbounds i16, i16* %131, i64 960
  %136 = bitcast i16* %135 to <16 x i16>*
  %137 = load <16 x i16>, <16 x i16>* %136, align 32, !tbaa !243
  %138 = bitcast i16* %131 to <16 x i16>*
  %139 = load <16 x i16>, <16 x i16>* %138, align 32, !tbaa !243
  %140 = add <16 x i16> %137, %134
  %141 = add <16 x i16> %140, %139
  %142 = call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %141, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %143 = lshr <16 x i16> %142, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %144 = shl nuw nsw i64 %indvars.iv.next112, 4
  %145 = add nsw i64 %144, %109
  %146 = getelementptr inbounds i16, i16* %blur_y58, i64 %145
  %147 = bitcast i16* %146 to <16 x i16>*
  store <16 x i16> %143, <16 x i16>* %147, align 2, !tbaa !245
  %indvars.iv.next112.1208 = add nuw nsw i64 %indvars.iv111, 2
  %148 = add nuw nsw i64 %indvars.iv.next112.1208, %105
  %149 = shl nuw nsw i64 %148, 4
  %150 = getelementptr inbounds i16, i16* %blur_x.us, i64 %149
  %151 = getelementptr inbounds i16, i16* %150, i64 480
  %152 = bitcast i16* %151 to <16 x i16>*
  %153 = load <16 x i16>, <16 x i16>* %152, align 32, !tbaa !243
  %154 = getelementptr inbounds i16, i16* %150, i64 960
  %155 = bitcast i16* %154 to <16 x i16>*
  %156 = load <16 x i16>, <16 x i16>* %155, align 32, !tbaa !243
  %157 = bitcast i16* %150 to <16 x i16>*
  %158 = load <16 x i16>, <16 x i16>* %157, align 32, !tbaa !243
  %159 = add <16 x i16> %156, %153
  %160 = add <16 x i16> %159, %158
  %161 = call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %160, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %162 = lshr <16 x i16> %161, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %163 = shl nuw nsw i64 %indvars.iv.next112.1208, 4
  %164 = add nsw i64 %163, %109
  %165 = getelementptr inbounds i16, i16* %blur_y58, i64 %164
  %166 = bitcast i16* %165 to <16 x i16>*
  store <16 x i16> %162, <16 x i16>* %166, align 2, !tbaa !245
  %indvars.iv.next112.2 = add nuw nsw i64 %indvars.iv111, 3
  %.not73.us.2 = icmp eq i64 %indvars.iv.next112.2, 30
  br i1 %.not73.us.2, label %"end for blur_y.s0.x.xi.xi.us", label %"for blur_y.s0.x.xi.xi.us"

"end for blur_y.s0.x.xi.xi.us":                   ; preds = %"for blur_y.s0.x.xi.xi.us"
  %indvars.iv.next115 = add nuw nsw i64 %indvars.iv114, 1
  %.not74.us = icmp eq i64 %indvars.iv.next115, 17
  br i1 %.not74.us, label %"end for blur_y.s0.y.yi.yii.us", label %"for blur_y.s0.y.yi.yii.us"

"end for blur_y.s0.y.yi.yii.us":                  ; preds = %"end for blur_y.s0.x.xi.xi.us"
  %167 = add nuw nsw i32 %blur_y.s0.x.x.us, 1
  %.not75.us = icmp eq i32 %167, %t13
  br i1 %.not75.us, label %"end for blur_y.s0.x.x.loopexit.us", label %"for blur_y.s0.x.x.us"

"end for blur_y.s0.x.x.loopexit.us":              ; preds = %"end for blur_y.s0.y.yi.yii.us"
  store i64 %.pre169, i64* %.fca.2.gep, align 8
  store i64 %32, i64* %.fca.1.gep, align 8, !tbaa !235
  %t17.us.1 = add nsw i32 %t16, 17
  br label %"for blur_y.s0.x.x.us.1"

"end for blur_y.s0.y.yi.yi":                      ; preds = %"end for blur_y.s0.y.yi.yii.us.1"
  store i64 %.pre129173, i64* %.fca.2.gep, align 8
  store i64 %226, i64* %.fca.1.gep, align 8, !tbaa !235
  %blur_y260.pre = load i16*, i16** %0, align 8
  %input361.pre = load i16*, i16** %3, align 8
  %blur_y.extent.04.pre = load i32, i32* %5, align 4
  %blur_y.extent.15.pre = load i32, i32* %7, align 4
  %blur_y.min.06.pre = load i32, i32* %9, align 4
  %blur_y.min.17.pre = load i32, i32* %11, align 4
  %blur_y.stride.18.pre = load i32, i32* %13, align 4
  %input.stride.19.pre = load i32, i32* %15, align 4
  %t1310.pre = load i32, i32* %17, align 4
  %t1411.pre = load i32, i32* %19, align 4
  %t1512.pre = load i32, i32* %21, align 4
  %.pre145 = add nsw i32 %blur_y.extent.15.pre, -34
  %.pre146 = add nsw i32 %blur_y.extent.04.pre, -480
  %.pre147 = sub i32 %blur_y.min.06.pre, %t1411.pre
  %168 = icmp sgt i32 %.pre145, %a0
  %blur_y.s0.y.yi.base.s13 = select i1 %168, i32 %a0, i32 %.pre145
  %t1614 = add nsw i32 %blur_y.s0.y.yi.base.s13, %blur_y.min.17.pre
  %169 = icmp sgt i32 %t1310.pre, 0
  br i1 %169, label %"for blur_y.s0.y.yi.yi15.us.preheader", label %if.then.i76, !prof !234

"for blur_y.s0.y.yi.yi15.us.preheader":           ; preds = %"end for blur_y.s0.y.yi.yi"
  %.fca.2.gep.promoted177 = load i64, i64* %.fca.2.gep, align 8
  %.fca.1.gep.promoted180 = load i64, i64* %.fca.1.gep, align 8, !tbaa !235
  br label %"for blur_y.s0.x.x19.us"

"for blur_y.s0.x.x19.us":                         ; preds = %"end for blur_y.s0.y.yi.yii41.us.for blur_y.s0.x.x19.us_crit_edge", %"for blur_y.s0.y.yi.yi15.us.preheader"
  %.pre141181 = phi i64 [ %.pre141182, %"end for blur_y.s0.y.yi.yii41.us.for blur_y.s0.x.x19.us_crit_edge" ], [ %.fca.1.gep.promoted180, %"for blur_y.s0.y.yi.yi15.us.preheader" ]
  %.pre143179 = phi i64 [ %.pre143178, %"end for blur_y.s0.y.yi.yii41.us.for blur_y.s0.x.x19.us_crit_edge" ], [ %.fca.2.gep.promoted177, %"for blur_y.s0.y.yi.yi15.us.preheader" ]
  %170 = phi i8* [ %.pre142, %"end for blur_y.s0.y.yi.yii41.us.for blur_y.s0.x.x19.us_crit_edge" ], [ %234, %"for blur_y.s0.y.yi.yi15.us.preheader" ]
  %171 = phi i64 [ %.pre141182, %"end for blur_y.s0.y.yi.yii41.us.for blur_y.s0.x.x19.us_crit_edge" ], [ %228, %"for blur_y.s0.y.yi.yi15.us.preheader" ]
  %blur_y.s0.x.x21.us = phi i32 [ %218, %"end for blur_y.s0.y.yi.yii41.us.for blur_y.s0.x.x19.us_crit_edge" ], [ 0, %"for blur_y.s0.y.yi.yi15.us.preheader" ]
  %a3.us = mul nsw i32 %blur_y.s0.x.x21.us, 480
  %172 = icmp sgt i32 %.pre146, %a3.us
  %blur_y.s0.x.xi.base.s22.us = select i1 %172, i32 %a3.us, i32 %.pre146
  %cmp.i79.us = icmp ult i64 %171, 18246
  br i1 %cmp.i79.us, label %if.then.i82.us, label %pseudostack_alloc.exit95.us, !prof !237

if.then.i82.us:                                   ; preds = %"for blur_y.s0.x.x19.us"
  %tobool1.not.i81.us = icmp ne i8* %170, null
  %cmp2.i84.us = icmp ugt i64 %.pre143179, 16384
  %or.cond103.us = and i1 %tobool1.not.i81.us, %cmp2.i84.us
  br i1 %or.cond103.us, label %if.then3.i86.us, label %if.end.i90.us

if.then3.i86.us:                                  ; preds = %if.then.i82.us
  call void @halide_free(i8* %__user_context, i8* nonnull %170) #17
  br label %if.end.i90.us

if.end.i90.us:                                    ; preds = %if.then3.i86.us, %if.then.i82.us
  %add.i88.us = add i64 %.pre143179, 18246
  %cmp7.i89.us = icmp ugt i64 %add.i88.us, 16384
  br i1 %cmp7.i89.us, label %if.then8.i92.us, label %if.end11.i94.us

if.then8.i92.us:                                  ; preds = %if.end.i90.us
  %call.i91.us = call i8* @halide_malloc(i8* %__user_context, i64 18246) #17
  br label %if.end11.i94.us

if.end11.i94.us:                                  ; preds = %if.then8.i92.us, %if.end.i90.us
  %storemerge.i93.us = phi i8* [ %call.i91.us, %if.then8.i92.us ], [ null, %if.end.i90.us ]
  store i8* %storemerge.i93.us, i8** %.fca.0.gep, align 8, !tbaa !238
  br label %pseudostack_alloc.exit95.us

pseudostack_alloc.exit95.us:                      ; preds = %if.end11.i94.us, %"for blur_y.s0.x.x19.us"
  %.pre141182 = phi i64 [ 18246, %if.end11.i94.us ], [ %.pre141181, %"for blur_y.s0.x.x19.us" ]
  %.pre143178 = phi i64 [ %add.i88.us, %if.end11.i94.us ], [ %.pre143179, %"for blur_y.s0.x.x19.us" ]
  %173 = phi i8* [ %storemerge.i93.us, %if.end11.i94.us ], [ %170, %"for blur_y.s0.x.x19.us" ]
  %174 = bitcast i8* %173 to i16*
  %.not63.us = icmp eq i8* %173, null
  br i1 %.not63.us, label %then_bb24.us, label %"produce blur_x26.us", !prof !239

then_bb24.us:                                     ; preds = %pseudostack_alloc.exit95.us
  %175 = alloca [18246 x i8*], align 64
  %176 = bitcast [18246 x i8*]* %175 to i16*
  store [18246 x i8*]* %175, [18246 x i8*]** %24, align 8
  br label %"produce blur_x26.us"

"produce blur_x26.us":                            ; preds = %then_bb24.us, %pseudostack_alloc.exit95.us
  %blur_x25.us = phi i16* [ %176, %then_bb24.us ], [ %174, %pseudostack_alloc.exit95.us ]
  %blur_x.s0.x.xi.base36.us = add i32 %.pre147, %blur_y.s0.x.xi.base.s22.us
  br label %"for blur_x.s0.y.rebased28.us"

"for blur_x.s0.y.rebased28.us":                   ; preds = %"end for blur_x.s0.x.x34.us", %"produce blur_x26.us"
  %indvars.iv120 = phi i64 [ %indvars.iv.next121, %"end for blur_x.s0.x.x34.us" ], [ 0, %"produce blur_x26.us" ]
  %177 = mul nuw nsw i64 %indvars.iv120, 30
  %178 = trunc i64 %indvars.iv120 to i32
  %179 = add nsw i32 %t1614, %178
  %180 = mul nsw i32 %179, %input.stride.19.pre
  %t1932.us = add i32 %blur_x.s0.x.xi.base36.us, %180
  br label %"for blur_x.s0.x.x33.us"

"for blur_x.s0.x.x33.us":                         ; preds = %"for blur_x.s0.x.x33.us", %"for blur_x.s0.y.rebased28.us"
  %indvars.iv117 = phi i64 [ %indvars.iv.next118, %"for blur_x.s0.x.x33.us" ], [ 0, %"for blur_x.s0.y.rebased28.us" ]
  %indvars.iv117.tr = trunc i64 %indvars.iv117 to i32
  %181 = shl i32 %indvars.iv117.tr, 4
  %t937.us = add i32 %t1932.us, %181
  %182 = sext i32 %t937.us to i64
  %183 = getelementptr inbounds i16, i16* %input361.pre, i64 %182
  %184 = getelementptr inbounds i16, i16* %183, i64 1
  %185 = bitcast i16* %184 to <16 x i16>*
  %186 = load <16 x i16>, <16 x i16>* %185, align 2, !tbaa !240
  %187 = getelementptr inbounds i16, i16* %183, i64 2
  %188 = bitcast i16* %187 to <16 x i16>*
  %189 = load <16 x i16>, <16 x i16>* %188, align 2, !tbaa !240
  %190 = bitcast i16* %183 to <16 x i16>*
  %191 = load <16 x i16>, <16 x i16>* %190, align 2, !tbaa !240
  %192 = call <16 x i16> @hydride.node.0(<16 x i16> %186, <16 x i16> %189, <16 x i16> %191) #12
  %193 = add nuw nsw i64 %indvars.iv117, %177
  %194 = shl nuw nsw i64 %193, 4
  %195 = getelementptr inbounds i16, i16* %blur_x25.us, i64 %194
  %196 = bitcast i16* %195 to <16 x i16>*
  store <16 x i16> %192, <16 x i16>* %196, align 32, !tbaa !243
  %indvars.iv.next118 = add nuw nsw i64 %indvars.iv117, 1
  %.not64.us = icmp eq i64 %indvars.iv.next118, 30
  br i1 %.not64.us, label %"end for blur_x.s0.x.x34.us", label %"for blur_x.s0.x.x33.us"

"end for blur_x.s0.x.x34.us":                     ; preds = %"for blur_x.s0.x.x33.us"
  %indvars.iv.next121 = add nuw nsw i64 %indvars.iv120, 1
  %.not65.us = icmp eq i64 %indvars.iv.next121, 19
  br i1 %.not65.us, label %"consume blur_x38.us", label %"for blur_x.s0.y.rebased28.us"

"consume blur_x38.us":                            ; preds = %"end for blur_x.s0.x.x34.us"
  %t2139.us = add nsw i32 %blur_y.s0.x.xi.base.s22.us, %t1512.pre
  br label %"for blur_y.s0.y.yi.yii40.us"

"for blur_y.s0.y.yi.yii40.us":                    ; preds = %"end for blur_y.s0.x.xi.xi46.us", %"consume blur_x38.us"
  %indvars.iv126 = phi i64 [ %indvars.iv.next127, %"end for blur_y.s0.x.xi.xi46.us" ], [ 0, %"consume blur_x38.us" ]
  %197 = mul nuw nsw i64 %indvars.iv126, 30
  %198 = trunc i64 %indvars.iv126 to i32
  %199 = add nsw i32 %t1614, %198
  %200 = mul nsw i32 %199, %blur_y.stride.18.pre
  %t2344.us = add nsw i32 %t2139.us, %200
  %201 = sext i32 %t2344.us to i64
  br label %"for blur_y.s0.x.xi.xi45.us"

"for blur_y.s0.x.xi.xi45.us":                     ; preds = %"for blur_y.s0.x.xi.xi45.us", %"for blur_y.s0.y.yi.yii40.us"
  %indvars.iv123 = phi i64 [ %indvars.iv.next124, %"for blur_y.s0.x.xi.xi45.us" ], [ 0, %"for blur_y.s0.y.yi.yii40.us" ]
  %202 = add nuw nsw i64 %indvars.iv123, %197
  %203 = shl nuw nsw i64 %202, 4
  %204 = getelementptr inbounds i16, i16* %blur_x25.us, i64 %203
  %205 = getelementptr inbounds i16, i16* %204, i64 480
  %206 = bitcast i16* %205 to <16 x i16>*
  %207 = load <16 x i16>, <16 x i16>* %206, align 32, !tbaa !243
  %208 = getelementptr inbounds i16, i16* %204, i64 960
  %209 = bitcast i16* %208 to <16 x i16>*
  %210 = load <16 x i16>, <16 x i16>* %209, align 32, !tbaa !243
  %211 = bitcast i16* %204 to <16 x i16>*
  %212 = load <16 x i16>, <16 x i16>* %211, align 32, !tbaa !243
  %213 = call <16 x i16> @hydride.node.1(<16 x i16> %207, <16 x i16> %210, <16 x i16> %212) #12
  %214 = shl nuw nsw i64 %indvars.iv123, 4
  %215 = add nsw i64 %214, %201
  %216 = getelementptr inbounds i16, i16* %blur_y260.pre, i64 %215
  %217 = bitcast i16* %216 to <16 x i16>*
  store <16 x i16> %213, <16 x i16>* %217, align 2, !tbaa !245
  %indvars.iv.next124 = add nuw nsw i64 %indvars.iv123, 1
  %.not66.us = icmp eq i64 %indvars.iv.next124, 30
  br i1 %.not66.us, label %"end for blur_y.s0.x.xi.xi46.us", label %"for blur_y.s0.x.xi.xi45.us"

"end for blur_y.s0.x.xi.xi46.us":                 ; preds = %"for blur_y.s0.x.xi.xi45.us"
  %indvars.iv.next127 = add nuw nsw i64 %indvars.iv126, 1
  %.not67.us = icmp eq i64 %indvars.iv.next127, 17
  br i1 %.not67.us, label %"end for blur_y.s0.y.yi.yii41.us", label %"for blur_y.s0.y.yi.yii40.us"

"end for blur_y.s0.y.yi.yii41.us":                ; preds = %"end for blur_y.s0.x.xi.xi46.us"
  %218 = add nuw nsw i32 %blur_y.s0.x.x21.us, 1
  %.not68.us = icmp eq i32 %218, %t1310.pre
  br i1 %.not68.us, label %"end for blur_y.s0.x.x20.loopexit.us", label %"end for blur_y.s0.y.yi.yii41.us.for blur_y.s0.x.x19.us_crit_edge"

"end for blur_y.s0.y.yi.yii41.us.for blur_y.s0.x.x19.us_crit_edge": ; preds = %"end for blur_y.s0.y.yi.yii41.us"
  %.pre142 = load i8*, i8** %.fca.0.gep, align 8, !tbaa !238
  br label %"for blur_y.s0.x.x19.us"

"end for blur_y.s0.x.x20.loopexit.us":            ; preds = %"end for blur_y.s0.y.yi.yii41.us"
  store i64 %.pre143178, i64* %.fca.2.gep, align 8
  store i64 %.pre141182, i64* %.fca.1.gep, align 8, !tbaa !235
  %t1718.us.1 = add nsw i32 %t1614, 17
  br label %"for blur_y.s0.x.x19.us.1"

if.then.i76.loopexit:                             ; preds = %"end for blur_y.s0.y.yi.yii41.us.1"
  store i64 %363, i64* %.fca.1.gep, align 8, !tbaa !235
  store i64 %.pre144186, i64* %.fca.2.gep, align 8
  br label %if.then.i76

if.then.i76:                                      ; preds = %if.then.i76.loopexit, %"end for blur_y.s0.y.yi.yi"
  %ptr1.i = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot, i64 0, i32 0
  %219 = load i8*, i8** %ptr1.i, align 8, !tbaa !238
  %tobool.not.i96 = icmp eq i8* %219, null
  br i1 %tobool.not.i96, label %pseudostack_free.exit, label %land.lhs.true.i99

land.lhs.true.i99:                                ; preds = %if.then.i76
  %cumulative_size.i97 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot, i64 0, i32 2
  %220 = load i64, i64* %cumulative_size.i97, align 8, !tbaa !247
  %cmp.i98 = icmp ugt i64 %220, 16384
  br i1 %cmp.i98, label %if.then.i100, label %pseudostack_free.exit

if.then.i100:                                     ; preds = %land.lhs.true.i99
  call void @halide_free(i8* %__user_context, i8* nonnull %219) #17
  br label %pseudostack_free.exit

pseudostack_free.exit:                            ; preds = %if.then.i76, %land.lhs.true.i99, %if.then.i100
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(24) %25, i8 0, i64 24, i1 false)
  br label %call_destructor.exit

call_destructor.exit:                             ; preds = %entry, %pseudostack_free.exit
  ret i32 0

"for blur_y.s0.x.x.us.1":                         ; preds = %"end for blur_y.s0.y.yi.yii.us.1", %"end for blur_y.s0.x.x.loopexit.us"
  %221 = phi i64 [ %226, %"end for blur_y.s0.y.yi.yii.us.1" ], [ %32, %"end for blur_y.s0.x.x.loopexit.us" ]
  %.pre129174 = phi i64 [ %.pre129173, %"end for blur_y.s0.y.yi.yii.us.1" ], [ %.pre169, %"end for blur_y.s0.x.x.loopexit.us" ]
  %222 = phi i8* [ %234, %"end for blur_y.s0.y.yi.yii.us.1" ], [ %41, %"end for blur_y.s0.x.x.loopexit.us" ]
  %223 = phi i8* [ %235, %"end for blur_y.s0.y.yi.yii.us.1" ], [ %42, %"end for blur_y.s0.x.x.loopexit.us" ]
  %224 = phi i64 [ %228, %"end for blur_y.s0.y.yi.yii.us.1" ], [ %35, %"end for blur_y.s0.x.x.loopexit.us" ]
  %blur_y.s0.x.x.us.1 = phi i32 [ %359, %"end for blur_y.s0.y.yi.yii.us.1" ], [ 0, %"end for blur_y.s0.x.x.loopexit.us" ]
  %a1.us.1 = mul nsw i32 %blur_y.s0.x.x.us.1, 480
  %225 = icmp sgt i32 %b2, %a1.us.1
  %blur_y.s0.x.xi.base.s.us.1 = select i1 %225, i32 %a1.us.1, i32 %b2
  %cmp.i.us.1 = icmp ult i64 %224, 18246
  br i1 %cmp.i.us.1, label %if.then.i.us.1, label %pseudostack_alloc.exit.us.1, !prof !237

if.then.i.us.1:                                   ; preds = %"for blur_y.s0.x.x.us.1"
  %tobool1.not.i.us.1 = icmp ne i8* %223, null
  %cmp2.i.us.1 = icmp ugt i64 %.pre129174, 16384
  %or.cond.us.1 = and i1 %tobool1.not.i.us.1, %cmp2.i.us.1
  br i1 %or.cond.us.1, label %if.then3.i.us.1, label %if.end.i.us.1

if.then3.i.us.1:                                  ; preds = %if.then.i.us.1
  call void @halide_free(i8* %__user_context, i8* nonnull %223) #17
  br label %if.end.i.us.1

if.end.i.us.1:                                    ; preds = %if.then3.i.us.1, %if.then.i.us.1
  %add.i.us.1 = add i64 %.pre129174, 18246
  %cmp7.i.us.1 = icmp ugt i64 %add.i.us.1, 16384
  br i1 %cmp7.i.us.1, label %if.then8.i.us.1, label %if.end11.i.us.1

if.then8.i.us.1:                                  ; preds = %if.end.i.us.1
  %call.i.us.1 = call i8* @halide_malloc(i8* %__user_context, i64 18246) #17
  br label %if.end11.i.us.1

if.end11.i.us.1:                                  ; preds = %if.then8.i.us.1, %if.end.i.us.1
  %storemerge.i.us.1 = phi i8* [ %call.i.us.1, %if.then8.i.us.1 ], [ null, %if.end.i.us.1 ]
  store i8* %storemerge.i.us.1, i8** %.fca.0.gep, align 8, !tbaa !238
  br label %pseudostack_alloc.exit.us.1

pseudostack_alloc.exit.us.1:                      ; preds = %if.end11.i.us.1, %"for blur_y.s0.x.x.us.1"
  %226 = phi i64 [ 18246, %if.end11.i.us.1 ], [ %221, %"for blur_y.s0.x.x.us.1" ]
  %.pre129173 = phi i64 [ %add.i.us.1, %if.end11.i.us.1 ], [ %.pre129174, %"for blur_y.s0.x.x.us.1" ]
  %227 = phi i8* [ %storemerge.i.us.1, %if.end11.i.us.1 ], [ %222, %"for blur_y.s0.x.x.us.1" ]
  %228 = phi i64 [ 18246, %if.end11.i.us.1 ], [ %224, %"for blur_y.s0.x.x.us.1" ]
  %229 = phi i8* [ %storemerge.i.us.1, %if.end11.i.us.1 ], [ %223, %"for blur_y.s0.x.x.us.1" ]
  %230 = bitcast i8* %229 to i16*
  %.not69.us.1 = icmp eq i8* %229, null
  br i1 %.not69.us.1, label %then_bb.us.1, label %"produce blur_x.us.1", !prof !239

then_bb.us.1:                                     ; preds = %pseudostack_alloc.exit.us.1
  %231 = alloca [18246 x i8*], align 64
  %232 = bitcast [18246 x i8*]* %231 to i16*
  store [18246 x i8*]* %231, [18246 x i8*]** %24, align 8
  %233 = bitcast [18246 x i8*]* %231 to i8*
  br label %"produce blur_x.us.1"

"produce blur_x.us.1":                            ; preds = %then_bb.us.1, %pseudostack_alloc.exit.us.1
  %234 = phi i8* [ %233, %then_bb.us.1 ], [ %227, %pseudostack_alloc.exit.us.1 ]
  %235 = phi i8* [ %233, %then_bb.us.1 ], [ %229, %pseudostack_alloc.exit.us.1 ]
  %blur_x.us.1 = phi i16* [ %232, %then_bb.us.1 ], [ %230, %pseudostack_alloc.exit.us.1 ]
  %blur_x.s0.x.xi.base.us.1 = add i32 %t18, %blur_y.s0.x.xi.base.s.us.1
  br label %"for blur_x.s0.y.rebased.us.1"

"for blur_x.s0.y.rebased.us.1":                   ; preds = %"end for blur_x.s0.x.x.us.1", %"produce blur_x.us.1"
  %indvars.iv108.1 = phi i64 [ %indvars.iv.next109.1, %"end for blur_x.s0.x.x.us.1" ], [ 0, %"produce blur_x.us.1" ]
  %236 = mul nuw nsw i64 %indvars.iv108.1, 30
  %237 = trunc i64 %indvars.iv108.1 to i32
  %238 = add nsw i32 %t17.us.1, %237
  %239 = mul nsw i32 %238, %input.stride.1
  %t19.us.1 = add i32 %blur_x.s0.x.xi.base.us.1, %239
  br label %"for blur_x.s0.x.x.us.1"

"for blur_x.s0.x.x.us.1":                         ; preds = %"for blur_x.s0.x.x.us.1", %"for blur_x.s0.y.rebased.us.1"
  %indvars.iv.1 = phi i64 [ 0, %"for blur_x.s0.y.rebased.us.1" ], [ %indvars.iv.next.1.2, %"for blur_x.s0.x.x.us.1" ]
  %indvars.iv.1.tr = trunc i64 %indvars.iv.1 to i32
  %240 = shl i32 %indvars.iv.1.tr, 4
  %t9.us.1 = add i32 %t19.us.1, %240
  %241 = sext i32 %t9.us.1 to i64
  %242 = getelementptr inbounds i16, i16* %input59, i64 %241
  %243 = getelementptr inbounds i16, i16* %242, i64 1
  %244 = bitcast i16* %243 to <16 x i16>*
  %245 = load <16 x i16>, <16 x i16>* %244, align 2, !tbaa !240
  %246 = getelementptr inbounds i16, i16* %242, i64 2
  %247 = bitcast i16* %246 to <16 x i16>*
  %248 = load <16 x i16>, <16 x i16>* %247, align 2, !tbaa !240
  %249 = bitcast i16* %242 to <16 x i16>*
  %250 = load <16 x i16>, <16 x i16>* %249, align 2, !tbaa !240
  %251 = add <16 x i16> %248, %245
  %252 = add <16 x i16> %251, %250
  %253 = call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %252, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %254 = lshr <16 x i16> %253, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %255 = add nuw nsw i64 %indvars.iv.1, %236
  %256 = shl nuw nsw i64 %255, 4
  %257 = getelementptr inbounds i16, i16* %blur_x.us.1, i64 %256
  %258 = bitcast i16* %257 to <16 x i16>*
  store <16 x i16> %254, <16 x i16>* %258, align 32, !tbaa !243
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv.1, 1
  %indvars.iv.1.tr.1 = trunc i64 %indvars.iv.next.1 to i32
  %259 = shl i32 %indvars.iv.1.tr.1, 4
  %t9.us.1.1 = add i32 %t19.us.1, %259
  %260 = sext i32 %t9.us.1.1 to i64
  %261 = getelementptr inbounds i16, i16* %input59, i64 %260
  %262 = getelementptr inbounds i16, i16* %261, i64 1
  %263 = bitcast i16* %262 to <16 x i16>*
  %264 = load <16 x i16>, <16 x i16>* %263, align 2, !tbaa !240
  %265 = getelementptr inbounds i16, i16* %261, i64 2
  %266 = bitcast i16* %265 to <16 x i16>*
  %267 = load <16 x i16>, <16 x i16>* %266, align 2, !tbaa !240
  %268 = bitcast i16* %261 to <16 x i16>*
  %269 = load <16 x i16>, <16 x i16>* %268, align 2, !tbaa !240
  %270 = add <16 x i16> %267, %264
  %271 = add <16 x i16> %270, %269
  %272 = call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %271, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %273 = lshr <16 x i16> %272, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %274 = add nuw nsw i64 %indvars.iv.next.1, %236
  %275 = shl nuw nsw i64 %274, 4
  %276 = getelementptr inbounds i16, i16* %blur_x.us.1, i64 %275
  %277 = bitcast i16* %276 to <16 x i16>*
  store <16 x i16> %273, <16 x i16>* %277, align 32, !tbaa !243
  %indvars.iv.next.1.1 = add nuw nsw i64 %indvars.iv.1, 2
  %indvars.iv.1.tr.2 = trunc i64 %indvars.iv.next.1.1 to i32
  %278 = shl i32 %indvars.iv.1.tr.2, 4
  %t9.us.1.2 = add i32 %t19.us.1, %278
  %279 = sext i32 %t9.us.1.2 to i64
  %280 = getelementptr inbounds i16, i16* %input59, i64 %279
  %281 = getelementptr inbounds i16, i16* %280, i64 1
  %282 = bitcast i16* %281 to <16 x i16>*
  %283 = load <16 x i16>, <16 x i16>* %282, align 2, !tbaa !240
  %284 = getelementptr inbounds i16, i16* %280, i64 2
  %285 = bitcast i16* %284 to <16 x i16>*
  %286 = load <16 x i16>, <16 x i16>* %285, align 2, !tbaa !240
  %287 = bitcast i16* %280 to <16 x i16>*
  %288 = load <16 x i16>, <16 x i16>* %287, align 2, !tbaa !240
  %289 = add <16 x i16> %286, %283
  %290 = add <16 x i16> %289, %288
  %291 = call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %290, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %292 = lshr <16 x i16> %291, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %293 = add nuw nsw i64 %indvars.iv.next.1.1, %236
  %294 = shl nuw nsw i64 %293, 4
  %295 = getelementptr inbounds i16, i16* %blur_x.us.1, i64 %294
  %296 = bitcast i16* %295 to <16 x i16>*
  store <16 x i16> %292, <16 x i16>* %296, align 32, !tbaa !243
  %indvars.iv.next.1.2 = add nuw nsw i64 %indvars.iv.1, 3
  %.not71.us.1.2 = icmp eq i64 %indvars.iv.next.1.2, 30
  br i1 %.not71.us.1.2, label %"end for blur_x.s0.x.x.us.1", label %"for blur_x.s0.x.x.us.1"

"end for blur_x.s0.x.x.us.1":                     ; preds = %"for blur_x.s0.x.x.us.1"
  %indvars.iv.next109.1 = add nuw nsw i64 %indvars.iv108.1, 1
  %.not72.us.1 = icmp eq i64 %indvars.iv.next109.1, 19
  br i1 %.not72.us.1, label %"consume blur_x.us.1", label %"for blur_x.s0.y.rebased.us.1"

"consume blur_x.us.1":                            ; preds = %"end for blur_x.s0.x.x.us.1"
  %t21.us.1 = add nsw i32 %blur_y.s0.x.xi.base.s.us.1, %t15
  br label %"for blur_y.s0.y.yi.yii.us.1"

"for blur_y.s0.y.yi.yii.us.1":                    ; preds = %"end for blur_y.s0.x.xi.xi.us.1", %"consume blur_x.us.1"
  %indvars.iv114.1 = phi i64 [ %indvars.iv.next115.1, %"end for blur_y.s0.x.xi.xi.us.1" ], [ 0, %"consume blur_x.us.1" ]
  %297 = mul nuw nsw i64 %indvars.iv114.1, 30
  %298 = trunc i64 %indvars.iv114.1 to i32
  %299 = add nsw i32 %t17.us.1, %298
  %300 = mul nsw i32 %299, %blur_y.stride.1
  %t23.us.1 = add nsw i32 %t21.us.1, %300
  %301 = sext i32 %t23.us.1 to i64
  br label %"for blur_y.s0.x.xi.xi.us.1"

"for blur_y.s0.x.xi.xi.us.1":                     ; preds = %"for blur_y.s0.x.xi.xi.us.1", %"for blur_y.s0.y.yi.yii.us.1"
  %indvars.iv111.1 = phi i64 [ 0, %"for blur_y.s0.y.yi.yii.us.1" ], [ %indvars.iv.next112.1.2, %"for blur_y.s0.x.xi.xi.us.1" ]
  %302 = add nuw nsw i64 %indvars.iv111.1, %297
  %303 = shl nuw nsw i64 %302, 4
  %304 = getelementptr inbounds i16, i16* %blur_x.us.1, i64 %303
  %305 = getelementptr inbounds i16, i16* %304, i64 480
  %306 = bitcast i16* %305 to <16 x i16>*
  %307 = load <16 x i16>, <16 x i16>* %306, align 32, !tbaa !243
  %308 = getelementptr inbounds i16, i16* %304, i64 960
  %309 = bitcast i16* %308 to <16 x i16>*
  %310 = load <16 x i16>, <16 x i16>* %309, align 32, !tbaa !243
  %311 = bitcast i16* %304 to <16 x i16>*
  %312 = load <16 x i16>, <16 x i16>* %311, align 32, !tbaa !243
  %313 = add <16 x i16> %310, %307
  %314 = add <16 x i16> %313, %312
  %315 = call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %314, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %316 = lshr <16 x i16> %315, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %317 = shl nuw nsw i64 %indvars.iv111.1, 4
  %318 = add nsw i64 %317, %301
  %319 = getelementptr inbounds i16, i16* %blur_y58, i64 %318
  %320 = bitcast i16* %319 to <16 x i16>*
  store <16 x i16> %316, <16 x i16>* %320, align 2, !tbaa !245
  %indvars.iv.next112.1 = add nuw nsw i64 %indvars.iv111.1, 1
  %321 = add nuw nsw i64 %indvars.iv.next112.1, %297
  %322 = shl nuw nsw i64 %321, 4
  %323 = getelementptr inbounds i16, i16* %blur_x.us.1, i64 %322
  %324 = getelementptr inbounds i16, i16* %323, i64 480
  %325 = bitcast i16* %324 to <16 x i16>*
  %326 = load <16 x i16>, <16 x i16>* %325, align 32, !tbaa !243
  %327 = getelementptr inbounds i16, i16* %323, i64 960
  %328 = bitcast i16* %327 to <16 x i16>*
  %329 = load <16 x i16>, <16 x i16>* %328, align 32, !tbaa !243
  %330 = bitcast i16* %323 to <16 x i16>*
  %331 = load <16 x i16>, <16 x i16>* %330, align 32, !tbaa !243
  %332 = add <16 x i16> %329, %326
  %333 = add <16 x i16> %332, %331
  %334 = call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %333, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %335 = lshr <16 x i16> %334, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %336 = shl nuw nsw i64 %indvars.iv.next112.1, 4
  %337 = add nsw i64 %336, %301
  %338 = getelementptr inbounds i16, i16* %blur_y58, i64 %337
  %339 = bitcast i16* %338 to <16 x i16>*
  store <16 x i16> %335, <16 x i16>* %339, align 2, !tbaa !245
  %indvars.iv.next112.1.1 = add nuw nsw i64 %indvars.iv111.1, 2
  %340 = add nuw nsw i64 %indvars.iv.next112.1.1, %297
  %341 = shl nuw nsw i64 %340, 4
  %342 = getelementptr inbounds i16, i16* %blur_x.us.1, i64 %341
  %343 = getelementptr inbounds i16, i16* %342, i64 480
  %344 = bitcast i16* %343 to <16 x i16>*
  %345 = load <16 x i16>, <16 x i16>* %344, align 32, !tbaa !243
  %346 = getelementptr inbounds i16, i16* %342, i64 960
  %347 = bitcast i16* %346 to <16 x i16>*
  %348 = load <16 x i16>, <16 x i16>* %347, align 32, !tbaa !243
  %349 = bitcast i16* %342 to <16 x i16>*
  %350 = load <16 x i16>, <16 x i16>* %349, align 32, !tbaa !243
  %351 = add <16 x i16> %348, %345
  %352 = add <16 x i16> %351, %350
  %353 = call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %352, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %354 = lshr <16 x i16> %353, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %355 = shl nuw nsw i64 %indvars.iv.next112.1.1, 4
  %356 = add nsw i64 %355, %301
  %357 = getelementptr inbounds i16, i16* %blur_y58, i64 %356
  %358 = bitcast i16* %357 to <16 x i16>*
  store <16 x i16> %354, <16 x i16>* %358, align 2, !tbaa !245
  %indvars.iv.next112.1.2 = add nuw nsw i64 %indvars.iv111.1, 3
  %.not73.us.1.2 = icmp eq i64 %indvars.iv.next112.1.2, 30
  br i1 %.not73.us.1.2, label %"end for blur_y.s0.x.xi.xi.us.1", label %"for blur_y.s0.x.xi.xi.us.1"

"end for blur_y.s0.x.xi.xi.us.1":                 ; preds = %"for blur_y.s0.x.xi.xi.us.1"
  %indvars.iv.next115.1 = add nuw nsw i64 %indvars.iv114.1, 1
  %.not74.us.1 = icmp eq i64 %indvars.iv.next115.1, 17
  br i1 %.not74.us.1, label %"end for blur_y.s0.y.yi.yii.us.1", label %"for blur_y.s0.y.yi.yii.us.1"

"end for blur_y.s0.y.yi.yii.us.1":                ; preds = %"end for blur_y.s0.x.xi.xi.us.1"
  %359 = add nuw nsw i32 %blur_y.s0.x.x.us.1, 1
  %.not75.us.1 = icmp eq i32 %359, %t13
  br i1 %.not75.us.1, label %"end for blur_y.s0.y.yi.yi", label %"for blur_y.s0.x.x.us.1"

"for blur_y.s0.x.x19.us.1":                       ; preds = %"end for blur_y.s0.y.yi.yii41.us.1", %"end for blur_y.s0.x.x20.loopexit.us"
  %.pre144187 = phi i64 [ %.pre144186, %"end for blur_y.s0.y.yi.yii41.us.1" ], [ %.pre143178, %"end for blur_y.s0.x.x20.loopexit.us" ]
  %360 = phi i64 [ %363, %"end for blur_y.s0.y.yi.yii41.us.1" ], [ %.pre141182, %"end for blur_y.s0.x.x20.loopexit.us" ]
  %blur_y.s0.x.x21.us.1 = phi i32 [ %409, %"end for blur_y.s0.y.yi.yii41.us.1" ], [ 0, %"end for blur_y.s0.x.x20.loopexit.us" ]
  %a3.us.1 = mul nsw i32 %blur_y.s0.x.x21.us.1, 480
  %361 = icmp sgt i32 %.pre146, %a3.us.1
  %blur_y.s0.x.xi.base.s22.us.1 = select i1 %361, i32 %a3.us.1, i32 %.pre146
  %cmp.i79.us.1 = icmp ult i64 %360, 18246
  %362 = load i8*, i8** %.fca.0.gep, align 8, !tbaa !238
  br i1 %cmp.i79.us.1, label %if.then.i82.us.1, label %pseudostack_alloc.exit95.us.1, !prof !237

if.then.i82.us.1:                                 ; preds = %"for blur_y.s0.x.x19.us.1"
  %tobool1.not.i81.us.1 = icmp ne i8* %362, null
  %cmp2.i84.us.1 = icmp ugt i64 %.pre144187, 16384
  %or.cond103.us.1 = and i1 %tobool1.not.i81.us.1, %cmp2.i84.us.1
  br i1 %or.cond103.us.1, label %if.then3.i86.us.1, label %if.end.i90.us.1

if.then3.i86.us.1:                                ; preds = %if.then.i82.us.1
  call void @halide_free(i8* %__user_context, i8* nonnull %362) #17
  br label %if.end.i90.us.1

if.end.i90.us.1:                                  ; preds = %if.then3.i86.us.1, %if.then.i82.us.1
  %add.i88.us.1 = add i64 %.pre144187, 18246
  %cmp7.i89.us.1 = icmp ugt i64 %add.i88.us.1, 16384
  br i1 %cmp7.i89.us.1, label %if.then8.i92.us.1, label %if.end11.i94.us.1

if.then8.i92.us.1:                                ; preds = %if.end.i90.us.1
  %call.i91.us.1 = call i8* @halide_malloc(i8* %__user_context, i64 18246) #17
  br label %if.end11.i94.us.1

if.end11.i94.us.1:                                ; preds = %if.then8.i92.us.1, %if.end.i90.us.1
  %storemerge.i93.us.1 = phi i8* [ %call.i91.us.1, %if.then8.i92.us.1 ], [ null, %if.end.i90.us.1 ]
  store i8* %storemerge.i93.us.1, i8** %.fca.0.gep, align 8, !tbaa !238
  br label %pseudostack_alloc.exit95.us.1

pseudostack_alloc.exit95.us.1:                    ; preds = %if.end11.i94.us.1, %"for blur_y.s0.x.x19.us.1"
  %.pre144186 = phi i64 [ %add.i88.us.1, %if.end11.i94.us.1 ], [ %.pre144187, %"for blur_y.s0.x.x19.us.1" ]
  %363 = phi i64 [ 18246, %if.end11.i94.us.1 ], [ %360, %"for blur_y.s0.x.x19.us.1" ]
  %364 = phi i8* [ %storemerge.i93.us.1, %if.end11.i94.us.1 ], [ %362, %"for blur_y.s0.x.x19.us.1" ]
  %365 = bitcast i8* %364 to i16*
  %.not63.us.1 = icmp eq i8* %364, null
  br i1 %.not63.us.1, label %then_bb24.us.1, label %"produce blur_x26.us.1", !prof !239

then_bb24.us.1:                                   ; preds = %pseudostack_alloc.exit95.us.1
  %366 = alloca [18246 x i8*], align 64
  %367 = bitcast [18246 x i8*]* %366 to i16*
  store [18246 x i8*]* %366, [18246 x i8*]** %24, align 8
  br label %"produce blur_x26.us.1"

"produce blur_x26.us.1":                          ; preds = %then_bb24.us.1, %pseudostack_alloc.exit95.us.1
  %blur_x25.us.1 = phi i16* [ %367, %then_bb24.us.1 ], [ %365, %pseudostack_alloc.exit95.us.1 ]
  %blur_x.s0.x.xi.base36.us.1 = add i32 %.pre147, %blur_y.s0.x.xi.base.s22.us.1
  br label %"for blur_x.s0.y.rebased28.us.1"

"for blur_x.s0.y.rebased28.us.1":                 ; preds = %"end for blur_x.s0.x.x34.us.1", %"produce blur_x26.us.1"
  %indvars.iv120.1 = phi i64 [ %indvars.iv.next121.1, %"end for blur_x.s0.x.x34.us.1" ], [ 0, %"produce blur_x26.us.1" ]
  %368 = mul nuw nsw i64 %indvars.iv120.1, 30
  %369 = trunc i64 %indvars.iv120.1 to i32
  %370 = add nsw i32 %t1718.us.1, %369
  %371 = mul nsw i32 %370, %input.stride.19.pre
  %t1932.us.1 = add i32 %blur_x.s0.x.xi.base36.us.1, %371
  br label %"for blur_x.s0.x.x33.us.1"

"for blur_x.s0.x.x33.us.1":                       ; preds = %"for blur_x.s0.x.x33.us.1", %"for blur_x.s0.y.rebased28.us.1"
  %indvars.iv117.1 = phi i64 [ %indvars.iv.next118.1, %"for blur_x.s0.x.x33.us.1" ], [ 0, %"for blur_x.s0.y.rebased28.us.1" ]
  %indvars.iv117.1.tr = trunc i64 %indvars.iv117.1 to i32
  %372 = shl i32 %indvars.iv117.1.tr, 4
  %t937.us.1 = add i32 %t1932.us.1, %372
  %373 = sext i32 %t937.us.1 to i64
  %374 = getelementptr inbounds i16, i16* %input361.pre, i64 %373
  %375 = getelementptr inbounds i16, i16* %374, i64 1
  %376 = bitcast i16* %375 to <16 x i16>*
  %377 = load <16 x i16>, <16 x i16>* %376, align 2, !tbaa !240
  %378 = getelementptr inbounds i16, i16* %374, i64 2
  %379 = bitcast i16* %378 to <16 x i16>*
  %380 = load <16 x i16>, <16 x i16>* %379, align 2, !tbaa !240
  %381 = bitcast i16* %374 to <16 x i16>*
  %382 = load <16 x i16>, <16 x i16>* %381, align 2, !tbaa !240
  %383 = call <16 x i16> @hydride.node.0(<16 x i16> %377, <16 x i16> %380, <16 x i16> %382) #12
  %384 = add nuw nsw i64 %indvars.iv117.1, %368
  %385 = shl nuw nsw i64 %384, 4
  %386 = getelementptr inbounds i16, i16* %blur_x25.us.1, i64 %385
  %387 = bitcast i16* %386 to <16 x i16>*
  store <16 x i16> %383, <16 x i16>* %387, align 32, !tbaa !243
  %indvars.iv.next118.1 = add nuw nsw i64 %indvars.iv117.1, 1
  %.not64.us.1 = icmp eq i64 %indvars.iv.next118.1, 30
  br i1 %.not64.us.1, label %"end for blur_x.s0.x.x34.us.1", label %"for blur_x.s0.x.x33.us.1"

"end for blur_x.s0.x.x34.us.1":                   ; preds = %"for blur_x.s0.x.x33.us.1"
  %indvars.iv.next121.1 = add nuw nsw i64 %indvars.iv120.1, 1
  %.not65.us.1 = icmp eq i64 %indvars.iv.next121.1, 19
  br i1 %.not65.us.1, label %"consume blur_x38.us.1", label %"for blur_x.s0.y.rebased28.us.1"

"consume blur_x38.us.1":                          ; preds = %"end for blur_x.s0.x.x34.us.1"
  %t2139.us.1 = add nsw i32 %blur_y.s0.x.xi.base.s22.us.1, %t1512.pre
  br label %"for blur_y.s0.y.yi.yii40.us.1"

"for blur_y.s0.y.yi.yii40.us.1":                  ; preds = %"end for blur_y.s0.x.xi.xi46.us.1", %"consume blur_x38.us.1"
  %indvars.iv126.1 = phi i64 [ %indvars.iv.next127.1, %"end for blur_y.s0.x.xi.xi46.us.1" ], [ 0, %"consume blur_x38.us.1" ]
  %388 = mul nuw nsw i64 %indvars.iv126.1, 30
  %389 = trunc i64 %indvars.iv126.1 to i32
  %390 = add nsw i32 %t1718.us.1, %389
  %391 = mul nsw i32 %390, %blur_y.stride.18.pre
  %t2344.us.1 = add nsw i32 %t2139.us.1, %391
  %392 = sext i32 %t2344.us.1 to i64
  br label %"for blur_y.s0.x.xi.xi45.us.1"

"for blur_y.s0.x.xi.xi45.us.1":                   ; preds = %"for blur_y.s0.x.xi.xi45.us.1", %"for blur_y.s0.y.yi.yii40.us.1"
  %indvars.iv123.1 = phi i64 [ %indvars.iv.next124.1, %"for blur_y.s0.x.xi.xi45.us.1" ], [ 0, %"for blur_y.s0.y.yi.yii40.us.1" ]
  %393 = add nuw nsw i64 %indvars.iv123.1, %388
  %394 = shl nuw nsw i64 %393, 4
  %395 = getelementptr inbounds i16, i16* %blur_x25.us.1, i64 %394
  %396 = getelementptr inbounds i16, i16* %395, i64 480
  %397 = bitcast i16* %396 to <16 x i16>*
  %398 = load <16 x i16>, <16 x i16>* %397, align 32, !tbaa !243
  %399 = getelementptr inbounds i16, i16* %395, i64 960
  %400 = bitcast i16* %399 to <16 x i16>*
  %401 = load <16 x i16>, <16 x i16>* %400, align 32, !tbaa !243
  %402 = bitcast i16* %395 to <16 x i16>*
  %403 = load <16 x i16>, <16 x i16>* %402, align 32, !tbaa !243
  %404 = call <16 x i16> @hydride.node.1(<16 x i16> %398, <16 x i16> %401, <16 x i16> %403) #12
  %405 = shl nuw nsw i64 %indvars.iv123.1, 4
  %406 = add nsw i64 %405, %392
  %407 = getelementptr inbounds i16, i16* %blur_y260.pre, i64 %406
  %408 = bitcast i16* %407 to <16 x i16>*
  store <16 x i16> %404, <16 x i16>* %408, align 2, !tbaa !245
  %indvars.iv.next124.1 = add nuw nsw i64 %indvars.iv123.1, 1
  %.not66.us.1 = icmp eq i64 %indvars.iv.next124.1, 30
  br i1 %.not66.us.1, label %"end for blur_y.s0.x.xi.xi46.us.1", label %"for blur_y.s0.x.xi.xi45.us.1"

"end for blur_y.s0.x.xi.xi46.us.1":               ; preds = %"for blur_y.s0.x.xi.xi45.us.1"
  %indvars.iv.next127.1 = add nuw nsw i64 %indvars.iv126.1, 1
  %.not67.us.1 = icmp eq i64 %indvars.iv.next127.1, 17
  br i1 %.not67.us.1, label %"end for blur_y.s0.y.yi.yii41.us.1", label %"for blur_y.s0.y.yi.yii40.us.1"

"end for blur_y.s0.y.yi.yii41.us.1":              ; preds = %"end for blur_y.s0.x.xi.xi46.us.1"
  %409 = add nuw nsw i32 %blur_y.s0.x.x21.us.1, 1
  %.not68.us.1 = icmp eq i32 %409, %t1310.pre
  br i1 %.not68.us.1, label %if.then.i76.loopexit, label %"for blur_y.s0.x.x19.us.1"
}

; Function Attrs: nounwind
define i32 @blur3x3(%struct.halide_buffer_t* noalias nocapture readonly %input.buffer, %struct.halide_buffer_t* noalias nocapture readonly %blur_y.buffer) local_unnamed_addr #11 {
entry:
  %parallel_closure18 = alloca { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, align 8
  %parallel_closure = alloca { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, align 8
  ...
  %min.i23 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %1, i64 1, i32 0
  %4 = load i32, i32* %min.i23, align 4, !tbaa !76
  %extent.i25 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %1, i64 1, i32 1
  %5 = load i32, i32* %extent.i25, align 4, !tbaa !73
  %stride.i27 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %1, i64 1, i32 2
  %6 = load i32, i32* %stride.i27, align 4, !tbaa !77
  %host.i28 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 2
  %7 = load i8*, i8** %host.i28, align 8, !tbaa !67
  %dim.i29 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 6
  %8 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %dim.i29, align 8, !tbaa !71
  %min.i30 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %8, i64 0, i32 0
  %9 = load i32, i32* %min.i30, align 4, !tbaa !76
  %min.i34 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %8, i64 1, i32 0
  %10 = load i32, i32* %min.i34, align 4, !tbaa !76
  %stride.i36 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %8, i64 1, i32 2
  %11 = load i32, i32* %stride.i36, align 4, !tbaa !77
  %12 = add nsw i32 %5, 33
  %13 = ashr i32 %12, 31
  %14 = xor i32 %13, %12
  %15 = zext i32 %14 to i64
  %16 = mul nuw i64 %15, 4042322161
  %17 = lshr i64 %16, 37
  %18 = trunc i64 %17 to i32
  %t12 = xor i32 %13, %18
  %19 = icmp slt i32 %3, -479
  %t66.neg59 = zext i1 %19 to i32
  %t66 = sext i1 %19 to i32
  %20 = add i32 %3, 479
  %21 = add i32 %20, %t66.neg59
  %22 = sdiv i32 %21, 480
  %t13 = add nsw i32 %22, %t66
  %23 = mul i32 %4, %6
  %t15 = sub i32 0, %23
  %24 = mul nsw i32 %11, %10
  %t14 = add nsw i32 %24, %9
  %25 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure, i64 0, i32 0
  store i8* %0, i8** %25, align 8
  %26 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure, i64 0, i32 1
  store i8* %7, i8** %26, align 8
  %27 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure, i64 0, i32 2
  store i32 %3, i32* %27, align 8
  %28 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure, i64 0, i32 3
  store i32 %5, i32* %28, align 4
  %29 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure, i64 0, i32 4
  store i32 %2, i32* %29, align 8
  %30 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure, i64 0, i32 5
  store i32 %4, i32* %30, align 4
  %31 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure, i64 0, i32 6
  store i32 %6, i32* %31, align 8
  %32 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure, i64 0, i32 7
  store i32 %11, i32* %32, align 4
  %33 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure, i64 0, i32 8
  store i32 %t13, i32* %33, align 8
  %34 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure, i64 0, i32 9
  store i32 %t14, i32* %34, align 4
  %35 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure, i64 0, i32 10
  store i32 %t15, i32* %35, align 8
  %36 = bitcast { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure to i8*
  %closure_result = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @blur3x3_par_for_blur_y_s0_y_y, i32 0, i32 %t12, i8* nonnull %36) #12
  %37 = load i32, i32* %min.i, align 4, !tbaa !76
  %38 = load i32, i32* %extent.i, align 4, !tbaa !73
  %39 = load i32, i32* %min.i23, align 4, !tbaa !76
  %40 = load i32, i32* %extent.i25, align 4, !tbaa !73
  %41 = load i32, i32* %stride.i27, align 4, !tbaa !77
  %42 = load i32, i32* %min.i30, align 4, !tbaa !76
  %43 = load i32, i32* %min.i34, align 4, !tbaa !76
  %44 = load i32, i32* %stride.i36, align 4, !tbaa !77
  %45 = add nsw i32 %40, 33
  %46 = ashr i32 %45, 31
  %47 = xor i32 %46, %45
  %48 = zext i32 %47 to i64
  %49 = mul nuw i64 %48, 4042322161
  %50 = lshr i64 %49, 37
  %51 = trunc i64 %50 to i32
  %t1214 = xor i32 %46, %51
  %52 = icmp slt i32 %38, -479
  %t91.neg60 = zext i1 %52 to i32
  %t91 = sext i1 %52 to i32
  %53 = add i32 %38, 479
  %54 = add i32 %53, %t91.neg60
  %55 = sdiv i32 %54, 480
  %t1315 = add nsw i32 %55, %t91
  %56 = mul i32 %39, %41
  %t1516 = sub i32 0, %56
  %57 = mul nsw i32 %44, %43
  %t1417 = add nsw i32 %57, %42
  %58 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure18, i64 0, i32 0
  store i8* %0, i8** %58, align 8
  %59 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure18, i64 0, i32 1
  store i8* %7, i8** %59, align 8
  %60 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure18, i64 0, i32 2
  store i32 %38, i32* %60, align 8
  %61 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure18, i64 0, i32 3
  store i32 %40, i32* %61, align 4
  %62 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure18, i64 0, i32 4
  store i32 %37, i32* %62, align 8
  %63 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure18, i64 0, i32 5
  store i32 %39, i32* %63, align 4
  %64 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure18, i64 0, i32 6
  store i32 %41, i32* %64, align 8
  %65 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure18, i64 0, i32 7
  store i32 %44, i32* %65, align 4
  %66 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure18, i64 0, i32 8
  store i32 %t1315, i32* %66, align 8
  %67 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure18, i64 0, i32 9
  store i32 %t1417, i32* %67, align 4
  %68 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure18, i64 0, i32 10
  store i32 %t1516, i32* %68, align 8
  %69 = bitcast { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32 }* %parallel_closure18 to i8*
  %closure_result19 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @blur3x3_par_for_blur_y_s0_y_y, i32 0, i32 %t1214, i8* nonnull %69) #12
  ret i32 0
}

; Function Attrs: nounwind
define i32 @blur3x3_argv(i8** nocapture readonly %0) local_unnamed_addr #12 {
entry:
  ...
  %6 = tail call i32 @blur3x3(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #19
  ret i32 0
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @blur3x3_metadata() local_unnamed_addr #13 {
entry:
  ret %struct.halide_filter_metadata_t* @blur3x3_metadata_storage
}

declare <16 x i16> @hydride.node.0(<16 x i16>, <16 x i16>, <16 x i16>) local_unnamed_addr

declare <16 x i16> @hydride.node.1(<16 x i16>, <16 x i16>, <16 x i16>) local_unnamed_addr
...
!235 = !{!236, !124, i64 8}
!236 = !{!"_ZTS25halide_pseudostack_slot_t", !13, i64 0, !124, i64 8, !124, i64 16}
!237 = !{!"branch_weights", i32 1, i32 2000}
!238 = !{!236, !13, i64 0}
!239 = !{!"branch_weights", i32 0, i32 1073741824}
!240 = !{!241, !241, i64 0}
!241 = !{!"input", !242, i64 0}
!242 = !{!"Halide buffer"}
!243 = !{!244, !244, i64 0}
!244 = !{!"blur_x", !242, i64 0}
!245 = !{!246, !246, i64 0}
!246 = !{!"blur_y", !242, i64 0}
!247 = !{!236, !124, i64 16}
