...
(define (get-prec prog env)
 (destruct prog
	...
	[(_mm_cvtepi64_epi32_dsl v0 num_1 prec_o prec_i num_4)
		...
		[(and  (equal? num_1 32) (equal? prec_o 8) (equal? prec_i 32) (equal? num_4 96)) 8]
		[(and  (equal? num_1 64) (equal? prec_o 8) (equal? prec_i 16) (equal? num_4 64)) 8]
		[(and  (equal? num_1 64) (equal? prec_o 8) (equal? prec_i 64) (equal? num_4 112)) 8]
		[(and  (equal? num_1 256) (equal? prec_o 8) (equal? prec_i 16) (equal? num_4 0)) 8]
		[(and  (equal? num_1 64) (equal? prec_o 16) (equal? prec_i 64) (equal? num_4 64)) 16]
		[(and  (equal? num_1 128) (equal? prec_o 8) (equal? prec_i 32) (equal? num_4 0)) 8]
		[(and  (equal? num_1 128) (equal? prec_o 8) (equal? prec_i 16) (equal? num_4 0)) 8]
		[(and  (equal? num_1 32) (equal? prec_o 16) (equal? prec_i 64) (equal? num_4 96)) 16]
		[(and  (equal? num_1 128) (equal? prec_o 32) (equal? prec_i 64) (equal? num_4 0)) 32]
		[(and  (equal? num_1 32) (equal? prec_o 8) (equal? prec_i 64) (equal? num_4 104)) 8]
)
	...
	[(_mm256_unpacklo_epi64_dsl v0 v1 num_2 num_3)
		(cond 
		[(and  (equal? num_2 128) (equal? num_3 0)) 64]
		[(and  (equal? num_2 256) (equal? num_3 0)) 64]
		[(and  (equal? num_2 256) (equal? num_3 64)) 64]
		[(and  (equal? num_2 128) (equal? num_3 64)) 64]
)
	...
	[(_m_punpckhdq_dsl v0 v1 num_2 prec_i_o num_4 num_5)
		(cond 
		[(and  (equal? num_2 32) (equal? prec_i_o 32) (equal? num_4 0) (equal? num_5 32)) 32]
		[(and  (equal? num_2 64) (equal? prec_i_o 64) (equal? num_4 0) (equal? num_5 64)) 64]
		[(and  (equal? num_2 32) (equal? prec_i_o 32) (equal? num_4 32) (equal? num_5 0)) 32]
		[(and  (equal? num_2 64) (equal? prec_i_o 64) (equal? num_4 64) (equal? num_5 0)) 64]
		[(and  (equal? num_2 32) (equal? prec_i_o 32) (equal? num_4 0) (equal? num_5 32)) 32]
		[(and  (equal? num_2 32) (equal? prec_i_o 32) (equal? num_4 32) (equal? num_5 0)) 32]
)
