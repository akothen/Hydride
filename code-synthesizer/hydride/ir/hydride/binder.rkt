...
(define (bind-expr prog env)
  (destruct prog
            ...
            [ (_mm_hsub_pi32_dsl v0 v1 num_2 prec_i_o num_4 num_5 num_6 num_7 num_8 num_9 num_10)
             (_mm_hsub_pi32_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
            ...
            [ (_mm512_broadcastw_epi16_dsl v0 num_1 prec_i_o)
             (_mm512_broadcastw_epi16_dsl (bind-expr v0 env) (bind-expr num_1 env) (bind-expr prec_i_o env))
             ]
            [ (_mm_hadds_pi16_dsl v0 v1 num_2 num_3 num_4 num_5 num_6)
             (_mm_hadds_pi16_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
            ...
            [ (_mm256_maskz_madd52lo_epu64_dsl v0 vc_1 v2 v3 v4 num_5 num_6)
             (_mm256_maskz_madd52lo_epu64_dsl (bind-expr v0 env) (bind-expr vc_1 env) (bind-expr v2 env) 
                                              (bind-expr v3 env) (bind-expr v4 env) (bind-expr num_5 env) 
                                              (bind-expr num_6 env))
             ]
            [ (_mm256_mask_adds_epu8_dsl v0 v1 v2 v3 num_4 prec_i_o)
             (_mm256_mask_adds_epu8_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr v2 env) 
                                        (bind-expr v3 env) (bind-expr num_4 env) (bind-expr prec_i_o env))
             ]
            [ (_mm512_mask_rem_epi32_dsl v0 v1 v2 v3)
             (_mm512_mask_rem_epi32_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr v2 env) 
                                        (bind-expr v3 env))
             ]
            [ (_mm512_unpacklo_epi64_dsl v0 v1 num_2)
             (_mm512_unpacklo_epi64_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env))
             ]
            [ (_mm256_dpbusds_epi32_dsl v0 v1 v2 size_i_o)
             (_mm256_dpbusds_epi32_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr v2 env) 
                                       (bind-expr size_i_o env))
             ]
            [ (_mm_unpackhi_epi64_dsl v0 v1 num_2 num_3)
             (_mm_unpackhi_epi64_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
                                     (bind-expr num_3 env))
             ]
            [ (_mm512_maskz_dpwssds_epi32_dsl v0 vc_1 v2 v3 v4 size_i_o)
             (_mm512_maskz_dpwssds_epi32_dsl (bind-expr v0 env) (bind-expr vc_1 env) (bind-expr v2 env) 
                                             (bind-expr v3 env) (bind-expr v4 env) (bind-expr size_i_o env))
             ]
            [ (_mm256_unpacklo_epi16_dsl v0 v1 size_i_o lane_size num_4 num_5 prec_i_o num_7 num_8 num_9)
             (_mm256_unpacklo_epi16_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr size_i_o env) 
                                        (bind-expr lane_size env) (bind-expr num_4 env) (bind-expr num_5 env) 
                                        (bind-expr prec_i_o env) (bind-expr num_7 env) (bind-expr num_8 env) 
                                        (bind-expr num_9 env))
             ]
            ...
            [ (_mm_hadd_pi16_dsl v0 v1 num_2 num_3 num_4 num_5 prec_i_o num_7 num_8 num_9)
             (_mm_hadd_pi16_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
                                (bind-expr num_3 env) (bind-expr num_4 env) (bind-expr num_5 env) 
                                (bind-expr prec_i_o env) (bind-expr num_7 env) (bind-expr num_8 env) 
                                (bind-expr num_9 env))
             ]
            ...
            [ (_mm256_subs_epi8_dsl v0 v1 num_2 prec_i_o)
             (_mm256_subs_epi8_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
                                   (bind-expr prec_i_o env))
             ]
            [ (_mm512_unpacklo_epi16_dsl v0 v1 prec_i_o num_3)
             (_mm512_unpacklo_epi16_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr prec_i_o env) 
                                        (bind-expr num_3 env))
             ]
            [ (_mm256_maskz_broadcast_i32x2_dsl v0 vc_1 v2 num_3 prec_i_o num_5)
             (_mm256_maskz_broadcast_i32x2_dsl (bind-expr v0 env) (bind-expr vc_1 env) (bind-expr v2 env) 
                                               (bind-expr num_3 env) (bind-expr prec_i_o env) (bind-expr num_5 env))
             ]
            [ (_mm512_mask_madd_epi16_dsl v0 v1 v2 v3 num_4)
             (_mm512_mask_madd_epi16_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr v2 env) 
            ...
            [ (_mm256_hadds_epi16_dsl v0 v1 size_i_o lane_size num_4 num_5 num_6 num_7 num_8 prec_i_o num_10 num_11 num_12 num_13 num_14 num_15)
             (_mm256_hadds_epi16_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr size_i_o env) 
                                     (bind-expr lane_size env) (bind-expr num_4 env) (bind-expr num_5 env) 
                                     (bind-expr num_6 env) (bind-expr num_7 env) (bind-expr num_8 env) 
                                     (bind-expr prec_i_o env) (bind-expr num_10 env) (bind-expr num_11 env) 
                                     (bind-expr num_12 env) (bind-expr num_13 env) (bind-expr num_14 env) 
            ...
            [ (_mm_rem_epi32_dsl v0 v1 num_2 prec_i_o)
             (_mm_rem_epi32_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
                                (bind-expr prec_i_o env))
             ]
            ...
            [ (_mm256_maskz_unpackhi_epi8_dsl v0 vc_1 v2 v3 num_4 num_5 num_6 prec_i_o num_8 num_9 num_10)
             (_mm256_maskz_unpackhi_epi8_dsl (bind-expr v0 env) (bind-expr vc_1 env) (bind-expr v2 env) 
                                             (bind-expr v3 env) (bind-expr num_4 env) (bind-expr num_5 env) 
                                             (bind-expr num_6 env) (bind-expr prec_i_o env) (bind-expr num_8 env) 
                                             (bind-expr num_9 env) (bind-expr num_10 env))
             ]
            ...
            [ (_mm512_rem_epi8_dsl v0 v1 prec_i_o)
             (_mm512_rem_epi8_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr prec_i_o env))
             ]
            [ (_mm_maskz_unpacklo_epi8_dsl v0 vc_1 v2 v3 num_4 prec_i_o num_6 num_7 num_8 num_9)
             (_mm_maskz_unpacklo_epi8_dsl (bind-expr v0 env) (bind-expr vc_1 env) (bind-expr v2 env) 
                                          (bind-expr v3 env) (bind-expr num_4 env) (bind-expr prec_i_o env) 
                                          (bind-expr num_6 env) (bind-expr num_7 env) (bind-expr num_8 env) 
                                          (bind-expr num_9 env))
             ]
            [ (_mm256_hsub_epi16_dsl v0 v1 num_2 prec_i_o num_4 num_5)
             (_mm256_hsub_epi16_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
                                    (bind-expr prec_i_o env) (bind-expr num_4 env) (bind-expr num_5 env))
             ]
            [ (_mm256_maskz_adds_epi8_dsl v0 vc_1 v2 v3 num_4 prec_i_o)
             (_mm256_maskz_adds_epi8_dsl (bind-expr v0 env) (bind-expr vc_1 env) (bind-expr v2 env) 
                                         (bind-expr v3 env) (bind-expr num_4 env) (bind-expr prec_i_o env))
             ]
            [ (_mm_div_epu64_dsl v0 v1 num_2 prec_i_o num_4)
             (_mm_div_epu64_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
                                (bind-expr prec_i_o env) (bind-expr num_4 env))
             ]
            [ (_mm256_unpackhi_epi64_dsl v0 v1 num_2 num_3 prec_i_o num_5 num_6 num_7 num_8 num_9)
             (_mm256_unpackhi_epi64_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
                                        (bind-expr num_3 env) (bind-expr prec_i_o env) (bind-expr num_5 env) 
                                        (bind-expr num_6 env) (bind-expr num_7 env) (bind-expr num_8 env) 
                                        (bind-expr num_9 env))
             ]
            [ (_mm512_maskz_unpacklo_epi16_dsl v0 vc_1 v2 v3 num_4 num_5 num_6 prec_i_o num_8 num_9 num_10)
             (_mm512_maskz_unpacklo_epi16_dsl (bind-expr v0 env) (bind-expr vc_1 env) (bind-expr v2 env) 
                                              (bind-expr v3 env) (bind-expr num_4 env) (bind-expr num_5 env) 
                                              (bind-expr num_6 env) (bind-expr prec_i_o env) (bind-expr num_8 env) 
                                              (bind-expr num_9 env) (bind-expr num_10 env))
             ]
            ...
            [ (_mm256_maskz_subs_epi8_dsl v0 vc_1 v2 v3 num_4 prec_i_o)
             (_mm256_maskz_subs_epi8_dsl (bind-expr v0 env) (bind-expr vc_1 env) (bind-expr v2 env) 
                                         (bind-expr v3 env) (bind-expr num_4 env) (bind-expr prec_i_o env))
             ]
            [ (_mm_adds_epi8_dsl v0 v1 num_2 prec_i_o)
             (_mm_adds_epi8_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
                                (bind-expr prec_i_o env))
             ]
            [ (_mm_mask_unpacklo_epi64_dsl v0 v1 v2 v3 num_4 num_5)
             (_mm_mask_unpacklo_epi64_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr v2 env) 
                                          (bind-expr v3 env) (bind-expr num_4 env) (bind-expr num_5 env))
             ]
            ...
            [ (_mm_subs_pu8_dsl v0 v1 num_2 prec_i_o)
             (_mm_subs_pu8_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
                               (bind-expr prec_i_o env))
             ]
            [ (_mm256_mask_madd52hi_epu64_dsl v0 v1 v2 v3 num_4 num_5)
             (_mm256_mask_madd52hi_epu64_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr v2 env) 
                                             (bind-expr v3 env) (bind-expr num_4 env) (bind-expr num_5 env))
             ]
            [ (_mm512_adds_epu16_dsl v0 v1 num_2 prec_i_o)
             (_mm512_adds_epu16_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
                                    (bind-expr prec_i_o env))
             ]
            [ (_mm256_maskz_cvtusepi64_epi32_dsl v0 vc_1 v2 num_3 prec_i_o num_5 num_6)
             (_mm256_maskz_cvtusepi64_epi32_dsl (bind-expr v0 env) (bind-expr vc_1 env) (bind-expr v2 env) 
                                                (bind-expr num_3 env) (bind-expr prec_i_o env) (bind-expr num_5 env) 
                                                (bind-expr num_6 env))
             ]
            [ (_mm256_unpacklo_epi8_dsl v0 v1 size_i_o lane_size num_4 num_5 prec_i_o num_7 num_8 num_9)
             (_mm256_unpacklo_epi8_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr size_i_o env) 
                                       (bind-expr lane_size env) (bind-expr num_4 env) (bind-expr num_5 env) 
                                       (bind-expr prec_i_o env) (bind-expr num_7 env) (bind-expr num_8 env) 
                                       (bind-expr num_9 env))
             ]
            [ (_mm_broadcastmw_epi32_dsl v0 num_1 prec_i prec_o)
             (_mm_broadcastmw_epi32_dsl (bind-expr v0 env) (bind-expr num_1 env) (bind-expr prec_i env) 
                                        (bind-expr prec_o env))
             ]
            [ (_mm256_maskz_broadcastq_epi64_dsl v0 vc_1 v2 num_3 prec_i_o)
             (_mm256_maskz_broadcastq_epi64_dsl (bind-expr v0 env) (bind-expr vc_1 env) (bind-expr v2 env) 
                                                (bind-expr num_3 env) (bind-expr prec_i_o env))
             ]
            ...
            [ (_mm256_broadcast_i32x4_dsl v0 num_1 prec_i_o num_3)
             (_mm256_broadcast_i32x4_dsl (bind-expr v0 env) (bind-expr num_1 env) (bind-expr prec_i_o env) 
                                         (bind-expr num_3 env))
             ]
            ...
            [ (_mm512_div_epi8_dsl v0 v1 num_2 prec_i_o num_4)
             (_mm512_div_epi8_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
                                  (bind-expr prec_i_o env) (bind-expr num_4 env))
             ]
            [ (_mm256_maskz_unpacklo_epi64_dsl v0 vc_1 v2 v3 num_4 num_5 num_6)
             (_mm256_maskz_unpacklo_epi64_dsl (bind-expr v0 env) (bind-expr vc_1 env) (bind-expr v2 env) 
                                              (bind-expr v3 env) (bind-expr num_4 env) (bind-expr num_5 env) 
                                              (bind-expr num_6 env))
             ]
            [ (_mm_hadd_pi32_dsl v0 v1 num_2 prec_i_o num_4 num_5 num_6 num_7 num_8 num_9 num_10)
             (_mm_hadd_pi32_dsl (bind-expr v0 env) (bind-expr v1 env) (bind-expr num_2 env) 
                                (bind-expr prec_i_o env) (bind-expr num_4 env) (bind-expr num_5 env) 
                                (bind-expr num_6 env) (bind-expr num_7 env) (bind-expr num_8 env) 
                                (bind-expr num_9 env) (bind-expr num_10 env))
             ]
            [ (_mm_maskz_cvtsepi64_epi32_dsl v0 vc_1 v2 num_3 prec_i_o num_5 num_6)
             (_mm_maskz_cvtsepi64_epi32_dsl (bind-expr v0 env) (bind-expr vc_1 env) (bind-expr v2 env) 
                                            (bind-expr num_3 env) (bind-expr prec_i_o env) (bind-expr num_5 env) 
                                            (bind-expr num_6 env))
             ]
