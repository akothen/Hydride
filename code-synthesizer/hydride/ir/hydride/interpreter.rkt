...
(define (hydride:interpret prog env)
  (destruct prog
            ...
            [ (_mm512_mask_unpackhi_epi8_dsl v0 v1 v2 v3 num_4 num_5 num_6 prec_i_o num_8 num_9 num_10)
             (_mm512_mask_unpackhi_epi8 (hydride:interpret v0 env) (hydride:interpret v1 env) (hydride:interpret v2 env) 
                                        (hydride:interpret v3 env) num_4 num_5 
                                        num_6 prec_i_o num_8 
                                        num_9 num_10)
             ]
            ...
            [ (_mm256_maskz_unpacklo_epi8_dsl v0 vc_1 v2 v3 num_4 num_5 num_6 prec_i_o num_8 num_9 num_10)
             (_mm256_maskz_unpacklo_epi8 (hydride:interpret v0 env) (hydride:interpret vc_1 env) (hydride:interpret v2 env) 
                                         (hydride:interpret v3 env) num_4 num_5 
                                         num_6 prec_i_o num_8 
                                         num_9 num_10)
             ]
            ...
            [ (_mm512_maskz_packs_epi16_dsl v0 vc_1 v2 v3 num_4 num_5 num_6 num_7 prec_i_o num_9 num_10)
             (_mm512_maskz_packs_epi16 (hydride:interpret v0 env) (hydride:interpret vc_1 env) (hydride:interpret v2 env) 
                                       (hydride:interpret v3 env) num_4 num_5 
