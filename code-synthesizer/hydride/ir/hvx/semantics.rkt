...
(define (hexagon_V6_vgtb_and_128B  %arg0.norm Vv.norm Vu.norm %arg1.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
...
(define (hexagon_V6_vgtuw_xor_128B  %arg0.norm Vv.norm Vu.norm %arg1.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vmpyuhv_acc_128B  Vxx Vu Vv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg2 %arg3 %arg4 )
  (define %dst0
    (apply
      concat
...
(define (hexagon_V6_veqh_128B  Vv.norm Vu.norm %arg1.norm %arg0.norm %elemsize0.norm %arg2.norm )
  (define QdV.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vsb_128B  Vu %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
...
(define (hexagon_V6_vminub_128B  Vu.norm Vv.norm %elemsize0.norm )
  (define Vd.norm
    (apply
      concat
...
(define (hexagon_V6_vavgb_128B  %arg0 Vu Vv %elemsize0 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vgtw_or_128B  %arg1.norm Vv.norm Vu.norm %arg0.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vabsb_128B  Vu %elemsize0 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_veqw_or_128B  %arg0.norm Vv.norm Vu.norm %arg1.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vgtuh_or_128B  %arg0.norm Vv.norm Vu.norm %arg1.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vpackhb_sat_128B  Vu Vv %arg1 %arg5 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vgtub_and_128B  %arg0.norm Vu.norm Vv.norm %arg1.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vmaxuh_128B  Vu.norm Vv.norm %elemsize0.norm )
  (define Vd.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vgtub_128B  Vv.norm %arg1.norm %arg0.norm Vu.norm %elemsize0.norm %arg2.norm )
  (define QdV.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vdmpyhsuisat_128B  %arg0 Vuu Rt %arg2 )
  (define Vd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 1024 32))])
...
(define (hexagon_V6_vsubuhsat_dv_128B  Vuu Vvv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg1 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
...
(define (hexagon_V6_veqh_xor_128B  %arg1.norm Vv.norm %arg0.norm Vu.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vgth_128B  Vv.norm %arg0.norm Vu.norm %arg1.norm %elemsize0.norm %arg2.norm )
  (define QdV.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 1024 8))])
                            ...
                            (define %2 (extract  %1 i.new Vu))
                            (define %5 (extract  %1 i.new Vv))
                            (define %6.ab0 (bvsubnw %2 %5 8 -1 ))
                            (define %7 (bvudiv  %6.ab0  (bv 2 8)))
                            %7
                            )
                  )
                )
...
(define (hexagon_V6_vmpyihb_128B  Vu Rt %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 %arg4 %arg5 )
  (define Vd
    (apply
      concat
...
(define (hexagon_V6_veqh_and_128B  %arg1.norm Vu.norm Vv.norm %arg0.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vrmpyub_128B  Vu Rt %arg2 %arg3 )
  (define Vd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 1024 32))])
                ...
                (define %13.ext0.red
                  (apply
                    ...
                    (for/list ([iterator.0.new (reverse (range 0 32 8))])
                              ...
                              (define %7 (extract  %6 iterator.0.new Rt))
                              (define %8.ab0 (bvsizeext  %4 16 0))
                              (define %9.ab0 (bvsizeext  %7 16 %arg3))
                              (define %10 (bvmul  %8.ab0  %9.ab0))
                              (define %13.ab0 (bvsizeext  %10 32 %arg2))
                              %13.ab0
                              )
                    ))
                (define %67.clone.2 (+  i.new  31))
                (define %13.acc0.ab0 (bvaddnw %13.ext0.red Vd 32 -1))
                %13.acc0.ab0
                )
      )
    )
...
(define (hexagon_V6_vdmpyhvsat_128B  %arg0 Vu Vv )
  (define Vd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 1024 32))])
...
(define (hexagon_V6_vgtw_xor_128B  Vv.norm %arg0.norm %arg1.norm Vu.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vsubwq_128B  Vx.norm Vu.norm QvV.norm %elemsize0.norm %arg3.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vaddwq_128B  Vu.norm QvV.norm Vx.norm %elemsize0.norm %arg3.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
      ...
      (for/list ([i.new (reverse (range 0 1024 32))])
                (apply
                  ...
                  (for/list ([iterator.0.new (reverse (range 0 16 8))])
                            ...
                            (define %15.ab0 (bvsizeext  %7 32 1))
                            (define %16.ab0 (bvsizeext  %13 32 1))
                            (define %17 (bvmul  %15.ab0  %16.ab0))
                            (define %18.ab0 (bvaddnw %2 %17 32 -1 ))
                            %18.ab0
                            )
                  )
                )
      ...
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 1024 %elemsize0))])
                            ...
                            (define %5 (extract  %1 i.new Vv))
                            (define %6.ab0 (bvaddnw %2 %5 %elemsize0 -1 ))
                            (define %7.ab0 (bvaddnw %6.ab0 %arg1 %elemsize0 -1 ))
                            (define %8 (bvsdiv  %7.ab0  %arg0))
                            %8
                            )
                  )
                )
...
(define (hexagon_V6_vandvqv_128B  Vu.norm QvV.norm )
  (define Vd.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1 1))])
...
(define (hexagon_V6_vaddbsat_dv_128B  Vuu Vvv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg1 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
...
(define (hexagon_V6_vaddubh_acc_128B  Vxx Vu Vv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg4 )
  (define %dst0
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
...
(define (hexagon_V6_vsububh_128B  Vu Vv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
...
(define (hexagon_V6_vnavgw_128B  %arg0 Vu Vv %elemsize0 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
      ...
      (for/list ([i.new (reverse (range 0 1024 16))])
                (apply
                  ...
                  (for/list ([iterator.0.new (reverse (range 0 16 8))])
                            ...
                            (define %15 (bvmul  %13.ab0  %14.ab0))
                            (define %16.ab0 (bvaddnw %2 %15 16 -1 ))
                            %16.ab0
                            )
                  )
                )
...
(define (hexagon_V6_vrmpyubv_128B  Vu Vv %arg2 %arg3 %arg5 )
  (define Vd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 1024 32))])
...
(define (hexagon_V6_vavguhrnd_128B  %arg1 %arg0 Vu Vv %elemsize0 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vswap_128B  QtV.norm Vv.norm Vu.norm )
  (define Vdd.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1 1))])
...
(define (hexagon_V6_vaddhw_128B  Vu Vv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
...
(define (hexagon_V6_vmpyiewh_acc_128B  Vx Vu Vv )
  (define %dst0
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vunpackuh_128B  Vu %elemsize0 %arg0 %arg1 )
  (define Vdd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
      ...
      (for/list ([i.new (reverse (range 0 1024 32))])
                (apply
                  ...
                  (for/list ([iterator.0.new (reverse (range 0 32 8))])
                            ...
                            (define %15.ab0 (bvaddnw %2 %14.ab0 32 -1 ))
                            %15.ab0
                            )
                  )
                )
...
(define (hexagon_V6_vrmpybv_acc_128B  Vx Vu Vv %arg1 %arg2 %arg4 )
  (define %dst0
    (apply
      concat
      (for/list ([i.new (reverse (range 0 1024 32))])
                (apply
                  ...
                  (for/list ([iterator.0.new (reverse (range 0 32 8))])
                            ...
                            (define %17.ab0 (bvaddnw %2 %16.ab0 32 -1 ))
                            %17.ab0
                            )
                  )
                )
