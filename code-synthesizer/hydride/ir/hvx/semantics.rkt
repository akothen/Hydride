...
(define (hexagon_V6_vavgub_128B  %arg0 Vu Vv %elemsize0 %arg1 )
  (define Vd
    (apply
      concat
...
(define (hexagon_V6_vaddwq_128B  QvV.norm Vx.norm Vu.norm %elemsize0.norm %arg3.norm )
  (define %dst0.norm
    (apply
      concat
...
(define (hexagon_V6_vsubbnq_128B  Vu.norm QvV.norm Vx.norm %elemsize0.norm %arg3.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vmaxw_128B  Vv.norm Vu.norm %elemsize0.norm )
  (define Vd.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vgtw_xor_128B  %arg0.norm %arg1.norm Vv.norm Vu.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vroundhub_128B  Vu Vv %arg1 %arg6 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_veqw_128B  Vv.norm %arg1.norm %arg0.norm Vu.norm %elemsize0.norm %arg2.norm )
  (define QdV.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vsubb_128B  Vu Vv %elemsize0 %arg0 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vdmpyhsuisat_acc_128B  Vx Vuu Rt %arg1 )
  (define %dst0
    (apply
      concat
      (for/list ([i.new (reverse (range 0 1024 32))])
...
(define (hexagon_V6_veqb_and_128B  %arg1.norm Vu.norm %arg0.norm Vv.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vrmpybusv_128B  %arg0 Vu Vv %arg2 %arg3 %arg5 )
  (define Vd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 1024 32))])
...
(define (hexagon_V6_vabsdiffub_128B  Vu.norm Vv.norm %elemsize0.norm )
  (define Vd.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vmpyh_128B  Vu Rt %arg2 %arg3 )
  (define Vdd
    (apply
      concat
...
(define (hexagon_V6_vgtuh_or_128B  %arg1.norm Vv.norm %arg0.norm Vu.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vsubh_dv_128B  Vuu Vvv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg1 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
...
(define (hexagon_V6_vunpackob_128B  %arg2 Vxx Vu %elemsize0 %arg0 )
  (define %dst0
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_veqb_xor_128B  %arg0.norm Vu.norm Vv.norm %arg1.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vgtub_and_128B  Vv.norm %arg0.norm %arg1.norm Vu.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vaddhw_acc_128B  Vxx Vu Vv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg4 )
  (define %dst0
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
...
(define (hexagon_V6_vmpahb_acc_128B  Vxx Vuu Rt )
  (define %dst0
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 64))])
...
(define (hexagon_V6_vgth_128B  %arg0.norm Vv.norm Vu.norm %arg1.norm %elemsize0.norm %arg2.norm )
  (define QdV.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vsathub_128B  Vu Vv %elemsize0 %arg0 %arg1 %arg2 %arg3 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vgth_or_128B  %arg0.norm Vu.norm %arg1.norm Vv.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_hi_128B  Vxx %elemsize0 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vgth_and_128B  Vu.norm Vv.norm %arg0.norm %arg1.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vmpyub_128B  Vu Rt %arg2 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 32))])
...
(define (hexagon_V6_vminw_128B  Vu.norm Vv.norm %elemsize0.norm )
  (define Vd.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vroundwh_128B  Vu Vv %arg1 %arg6 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vgtuw_xor_128B  %arg1.norm %arg0.norm Vu.norm Vv.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vnavgw_128B  %arg0 Vu Vv %elemsize0 %arg1 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vor_128B  Vu Vv %innerlanesize0 %elemsize0 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1 1))])
