...
(define (hexagon_V6_vrmpyubv_acc_128B  Vx Vu Vv %arg1 %arg2 %arg4 )
  (define %dst0
    (apply
      concat
                ...
                (define %16.ext0.red
                  (apply
                    ...
                    (for/list ([iterator.0.new (reverse (range 0 32 8))])
                              ...
                              (define %13.ab0 (bvsizeext  %7 16 %arg4))
                              (define %14.ab0 (bvsizeext  %12 16 %arg2))
                              (define %15 (bvmul  %13.ab0  %14.ab0))
                              (define %16.ab0 (bvsizeext  %15 32 %arg1))
                              %16.ab0
                              )
                    ))
                (define %79.clone.4 (+  i.new  31))
                ;(define %16.acc0.ab0 (bvaddnw %16.ext0.red %dst0 32 -1))
                (define %16.acc0.ab0 (bvadd %16.ext0.red %dst0   ))
                %16.acc0.ab0
                )
      )
    )
  ;(bvpadhighbits  %dst0 0)
  %dst0
  )
...
(define (hexagon_V6_vsatuwuh_128B  Vu Vv %elemsize0 %arg0 %arg1 %arg2 %arg3 )
  (define Vd
    (apply
      concat
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 512 16))])
                            ...
                            (define %9.ab0 (sign-extend %2 (bitvector 64)  ))
                            ;(define %10.ab0 (bvsizeext  %7 64 1))
                            (define %10.ab0 (sign-extend %7 (bitvector 64)  ))
                            (define %11 (bvmul  %9.ab0  %10.ab0))
                            (define %14.high.idx (- 32 1))
                            (define %14.low.idx 0)
...
(define (hexagon_V6_veqh_or_128B  %arg0.norm Vu.norm Vv.norm %arg1.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
...
(define (hexagon_V6_vgtub_or_128B  %arg1.norm %arg0.norm Vv.norm Vu.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vmpybv_acc_128B  Vxx Vu Vv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg2 %arg3 %arg4 )
  (define %dst0
    (apply
      concat
...
(define (hexagon_V6_vgtb_and_128B  Vv.norm %arg0.norm Vu.norm %arg1.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vmpyowh_rnd_sacc_128B  Vx Vu Vv )
  (define %dst0
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 512 16))])
                            ...
                            (define %12.ab0 (sign-extend %5 (bitvector 64)  ))
                            ;(define %13.ab0 (bvsizeext  %10 64 1))
                            (define %13.ab0 (sign-extend %10 (bitvector 64)  ))
                            (define %14 (bvmul  %12.ab0  %13.ab0))
                            ;(define %15.ab0 (bvsizeext  %2 64 1))
                            (define %15.ab0 (sign-extend %2 (bitvector 64)  ))
                            ;(define %16.ab0 (bvaddnw %15.ab0 %14 64 -1 ))
                            (define %16.ab0 (bvadd %15.ab0 %14   )) 
...
(define (hexagon_V6_vandqrt_128B  Rt.norm QuV.norm )
  (define Vd.norm
    (apply
      concat
  ...
  ;(bvpadhighbits  Vd.norm 0)
  Vd.norm
  )

(define (hexagon_V6_vsubwq_128B  QvV.norm Vu.norm Vx.norm %elemsize0.norm %arg3.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
                (apply
                  ...
                  (for/list ([i.new.norm (reverse (range 0 1024 %elemsize0.norm))])
                            ...
                            (define %10.ab0.norm (bvsub %3.norm %9.norm   )) 
                            (define %cond0.norm (bveq  %0.norm  (bv 1 1)))
...
(define (hexagon_V6_vmux_128B  Vv.norm QtV.norm Vu.norm )
  (define Vd.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1 1))])
...
(define (hexagon_V6_vswap_128B  Vv.norm QtV.norm Vu.norm )
  (define Vdd.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1 1))])
  ...
  ;(bvpadhighbits  Vdd.norm 0)
  Vdd.norm
  )

(define (hexagon_V6_vadduwsat_dv_128B  Vuu Vvv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg1 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
                ...
                (concat
                  (apply
                    ...
                    (for/list ([%iterator1.new (reverse (range 0 512 16))])
                              ...
                              (define %27.ab0 (sign-extend %20 (bitvector 64)  ))
                              ;(define %28.ab0 (bvsizeext  %25 64 1))
                              (define %28.ab0 (sign-extend %25 (bitvector 64)  ))
                              (define %29 (bvmul  %27.ab0  %28.ab0))
                              (define %30 (bvlshr  %29  (bv 16 64)))
                              (define %35.high.idx (- 32 1))
                              (define %35.low.idx 0)
...
(define (hexagon_V6_veqb_and_128B  Vv.norm %arg1.norm Vu.norm %arg0.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vgtub_and_128B  %arg0.norm %arg1.norm Vv.norm Vu.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vsubwsat_dv_128B  Vuu Vvv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg1 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
...
(define (hexagon_V6_vandqrt_acc_128B  QuV.norm Rt.norm Vx.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1 1))])
      ...
      (for/list ([i.new (reverse (range 0 2048 32))])
                (apply
                  ...
                  (for/list ([iterator.0.new (reverse (range 0 16 8))])
                            ...
                            (define %14.ab0 (zero-extend %6 (bitvector 16)  ))
                            ;(define %15.ab0 (bvsizeext  %13 16 0))
                            (define %15.ab0 (zero-extend %13 (bitvector 16)  ))
                            ...
                            (define %31.ab0 (zero-extend %23 (bitvector 16)  ))
                            ;(define %32.ab0 (bvsizeext  %30 16 0))
                            (define %32.ab0 (zero-extend %30 (bitvector 16)  ))
                            (define %33 (bvmul  %31.ab0  %32.ab0))
                            ;(define %34.ab0 (bvaddnw %16 %33 16 -1 ))
                            (define %34.ab0 (bvadd %16 %33   )) 
                            %34.ab0
                            )
                  )
                )
...
(define (hexagon_V6_vaddwq_128B  Vx.norm Vu.norm QvV.norm %elemsize0.norm %arg3.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
                (apply
                  ...
                  (for/list ([i.new.norm (reverse (range 0 1024 %elemsize0.norm))])
                            ...
                            (define %10.ab0.norm (bvadd %3.norm %9.norm   )) 
                            (define %cond0.norm (bveq  %0.norm  (bv 1 1)))
                            (define %11.norm (if (equal? %cond0.norm #t) %3.norm %10.ab0.norm))
                            %11.norm
                            )
...
(define (hexagon_V6_lvsplatb_128B  Rt %elemsize0 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 512 16))])
                            ...
                            (define %11.ab0 (zero-extend %7 (bitvector 32)  ))
                            ;(define %12.ab0 (bvsizeext  %10 32 0))
                            (define %12.ab0 (zero-extend %10 (bitvector 32)  ))
                            (define %13 (bvmul  %11.ab0  %12.ab0))
                            ;(define %14.ab0 (bvaddnw %2 %13 32 -1 ))
                            (define %14.ab0 (bvadd %2 %13   )) 
                            %14.ab0
                            )
                  )
                )
      ...
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 1024 %elemsize0))])
                            ...
                            (define %7.ab0 (zero-extend %6 (bitvector %arg0)  ))
...
(define (hexagon_V6_vminuh_128B  Vu.norm Vv.norm %elemsize0.norm )
  (define Vd.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 1024 16))])
                            ...
                            (define %4.ab0 (sign-extend %2 (bitvector 32)  ))
                            (define %5 (bvshl  %4.ab0  %3))
                            (define %8.high.idx (- 16 1))
                            (define %8.low.idx 0)
...
(define (hexagon_V6_vabsdiffh_128B  Vu.norm Vv.norm %elemsize0.norm )
  (define Vd.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
                (apply
                  ...
                  (for/list ([i.new.norm (reverse (range 0 1024 %elemsize0.norm))])
                            ...
                            (define %13.ab0.norm (bvsub %2.norm %5.norm   )) 
                            ;(define %20.ab0.norm (bvsubnw %5.norm %2.norm %elemsize0.norm -1 ))
                            (define %20.ab0.norm (bvsub %5.norm %2.norm   )) 
...
(define (hexagon_V6_vmpyiwb_128B  Vu Rt %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 %arg4 %arg5 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 32 32))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 %innerlanesize0 %elemsize0))])
                            ...
                            (define %8.ab0 (sign-extend %2 (bitvector %arg2)  ))
...
(define (hexagon_V6_vrmpyub_acc_128B  Vx Vu Rt %arg1 %arg2 )
  (define %dst0
    (apply
      concat
      (for/list ([i.new (reverse (range 0 1024 32))])
                ...
                (define %14.ext0.red
                  (apply
                    ...
                    (for/list ([iterator.0.new (reverse (range 0 32 8))])
                              ...
                              (define %11.ab0 (zero-extend %7 (bitvector 16)  ))
                ...
                (define %14.acc0.ab0 (bvadd %14.ext0.red %dst0   ))
                %14.acc0.ab0
                )
      )
    )
...
(define (hexagon_V6_vavgh_128B  %arg0 Vu Vv %elemsize0 %arg1 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 1024 16))])
                            ...
                            (define %4.ab0 (zero-extend %2 (bitvector 32)  ))
...
(define (hexagon_V6_vsubuhw_128B  Vu Vv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
...
(define (hexagon_V6_vzb_128B  Vu %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
...
(define (hexagon_V6_vdmpyhsusat_acc_128B  Vx Vu Rt %arg1 )
  (define %dst0
    (apply
      concat
      (for/list ([i.new (reverse (range 0 1024 32))])
                ...
                (define %13.ext0.red
                  (apply
                    ...
                    (for/list ([iterator.0.new (reverse (range 0 32 16))])
                              ...
                              (define %10 (extract  %9 iterator.0.new Rt))
                              ;(define %11.ab0 (bvsizeext  %7 32 1))
                              (define %11.ab0 (sign-extend %7 (bitvector 32)  ))
                              (define %12.ab0 (bvsizeext  %10 32 %arg1))
                              (define %13 (bvmul  %11.ab0  %12.ab0))
                              %13
                              )
                    ))
                (define %29.clone.2 (+  i.new  31))
                ;(define %13.acc0.ab0 (bvaddnw %13.ext0.red %dst0 32 1))
                (define %13.acc0.ab0 (bvaddnsw %13.ext0.red %dst0 32  ))
                %13.acc0.ab0
                )
      )
    )
...
(define (hexagon_V6_vunpackh_128B  Vu %elemsize0 %arg0 %arg1 )
  (define Vdd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 1024 16))])
                            ...
                            (define %9.ab0 (sign-extend %5 (bitvector 32)  ))
                            ;(define %10.ab0 (bvsizeext  %8 32 1))
                            (define %10.ab0 (sign-extend %8 (bitvector 32)  ))
                            (define %11 (bvmul  %9.ab0  %10.ab0))
                            ;(define %12.ab0 (bvsizeext  %2 32 1))
                            (define %12.ab0 (sign-extend %2 (bitvector 32)  ))
                            ;(define %13.ab0 (bvaddnw %12.ab0 %11 32 -1 ))
                            (define %13.ab0 (bvadd %12.ab0 %11   )) 
                            (define %16.high.idx (- 16 1))
                            (define %16.low.idx 0)
...
(define (hexagon_V6_vmpabus_acc_128B  Vxx Vuu Rt %arg3 %arg8 )
  (define %dst0
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 32))])
                (apply
                  ...
                  (for/list ([iterator.0.new (reverse (range 0 16 8))])
                            ...
                            (define %15.ab0 (zero-extend %11 (bitvector 16)  ))
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 512 16))])
                            ...
                            (define %10.ab0 (sign-extend %4 (bitvector 32)  ))
                            ;(define %11.ab0 (bvsizeext  %9 32 1))
                            (define %11.ab0 (sign-extend %9 (bitvector 32)  ))
...
(define (hexagon_V6_vmpybusv_128B  Vu Vv %outerlanesize0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 %arg3 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
  ...
  (define Vd
    (apply
      ...
      (for/list ([i.new (reverse (range 0 1024 32))])
                ...
                (define %14.ext0.red
                  (apply
                    ...
                    (for/list ([iterator.0.new (reverse (range 0 16 8))])
                              ...
                              (define %12.ab0 (sign-extend %4 (bitvector 32)  ))
                              ;(define %13.ab0 (bvsizeext  %10 32 1))
                              (define %13.ab0 (sign-extend %10 (bitvector 32)  ))
                              (define %14 (bvmul  %12.ab0  %13.ab0))
                              %14
                              )
                    ))
                ...
                (define %14.acc0.ab0 (bvadd %14.ext0.red Vd   ))
                %14.acc0.ab0
                )
      )
    )
...
(define (hexagon_V6_vdmpyhisat_acc_128B  Vx Vuu Rt %arg1 )
  (define %dst0
    (apply
      concat
      (for/list ([i.new (reverse (range 0 1024 32))])
                ...
                (define %15.ext0.red
                  (apply
                    ...
                    (for/list ([iterator.0.new (reverse (range 0 32 16))])
                              ...
                              (define %11 (+  iterator.0.new  15))
                              (define %12 (extract  %11 iterator.0.new Rt))
                              ;(define %13.ab0 (bvsizeext  %9 32 1))
                              (define %13.ab0 (sign-extend %9 (bitvector 32)  ))
                              (define %14.ab0 (bvsizeext  %12 32 %arg1))
                              (define %15 (bvmul  %13.ab0  %14.ab0))
                              %15
                              )
                    ))
                (define %33.clone.2 (+  i.new  31))
                ;(define %15.acc0.ab0 (bvaddnw %15.ext0.red %dst0 32 1))
                (define %15.acc0.ab0 (bvaddnsw %15.ext0.red %dst0 32  ))
                %15.acc0.ab0
                )
      )
    )
...
(define (hexagon_V6_vabsb_sat_128B  Vu %elemsize0 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 1024 %elemsize0))])
                            ...
                            (define %4.ab0 (bvssat %3 %elemsize0 %elemsize0  ))
                            %4.ab0
                            )
                  )
                )
...
(define (hexagon_V6_vroundwuh_128B  Vu Vv %arg1 %arg6 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 1024 16))])
                            ...
                            (define %7.ab0 (sign-extend %5 (bitvector 32)  ))
                            (define %8 (bvshl  %7.ab0  %6))
                            ;(define %9.ab0 (bvsizeext  %2 32 1))
                            (define %9.ab0 (sign-extend %2 (bitvector 32)  ))
                            ;(define %10.ab0 (bvaddnw %9.ab0 %8 32 -1 ))
                            (define %10.ab0 (bvadd %9.ab0 %8   )) 
                            (define %13.high.idx (- 16 1))
                            (define %13.low.idx 0)
...
(define (hexagon_V6_vgtw_or_128B  Vu.norm Vv.norm %arg1.norm %arg0.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vasrhbrndsat_128B  Vu Vv Rt %arg1 %arg3 %arg6 %arg8 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
      ...
      (for/list ([i.new (reverse (range 0 2048 %outerlanesize0))])
                (apply
                  ...
                  (for/list ([iterator.0.new (reverse (range 0 %innerlanesize0 %elemsize0))])
                            ...
                            (define %15.ab0 (bvadd %9 %14   )) 
                            ;(define %16.ab0 (bvsizeext  %15.ab0 %arg0 1))
                            (define %16.ab0 (sign-extend %15.ab0 (bitvector %arg0)  ))
                            ;(define %17.ab0 (bvaddnw %4 %16.ab0 %arg0 -1 ))
                            (define %17.ab0 (bvadd %4 %16.ab0   )) 
                            %17.ab0
                            )
                  )
                )
...
(define (hexagon_V6_vlsrhv_128B  %arg0.norm VvV.norm VuV.norm %elemsize0.norm )
  (define VdV.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
  ...
  ;(bvpadhighbits  VdV.norm 0)
  VdV.norm
  )

(define (hexagon_V6_vaslwv_128B  VvV.norm %arg0.norm VuV.norm %elemsize0.norm )
  (define VdV.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i (reverse (range 0 32 1))])
                            ...
                            (define %9.ab0 (sign-extend %8 (bitvector 32)  ))
                            ;(define %10.ab0 (bvaddnw %6.ab0 %9.ab0 32 1 ))
                            (define %10.ab0 (bvaddnsw %6.ab0 %9.ab0 32  )) 
                            %10.ab0
                            )
                  )
                )
  ...
  (define %dst0
    (apply
      ...
      (for/list ([i.new (reverse (range 0 1024 32))])
                ...
                (define %12.acc0.ab0 (bvaddnsw %12.ext0.red %dst0 32  ))
                %12.acc0.ab0
                )
      )
    )
...
(define (hexagon_V6_veqb_128B  Vu.norm Vv.norm %arg0.norm %arg1.norm %elemsize0.norm %arg2.norm )
  (define QdV.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 512 16))])
                            ...
                            (define %5.ab0 (bvssat %4 32 16  ))
                            (define %12 (extract  %2 %1.new0 VuV))
                            (define %13 (bvashr  %12  %0))
                            ;(define %14.ab0 (bvsaturate  %13 32 16 1))
                            (define %14.ab0 (bvssat %13 32 16  ))
                            (concat %14.ab0 %5.ab0)
                            )
                  )
                )
...
(define (hexagon_V6_vgtub_128B  Vv.norm Vu.norm %arg0.norm %arg1.norm %elemsize0.norm %arg2.norm )
  (define QdV.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vdmpybus_128B  %arg0 Vu Rt )
  (define Vd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 1024 16))])
                (define %34.0 (+  i.new  15))
                ...
                (define %12.ext0.red
                  (apply
                    ...
                    (for/list ([iterator.0.new (reverse (range 0 16 8))])
                              ...
                              ;(define %10.ab0 (bvsizeext  %4 16 0))
                              (define %10.ab0 (zero-extend %4 (bitvector 16)  ))
                              ;(define %11.ab0 (bvsizeext  %9 16 1))
                              (define %11.ab0 (sign-extend %9 (bitvector 16)  ))
                              (define %12 (bvmul  %10.ab0  %11.ab0))
                              %12
                              )
                    ))
                (define %34.clone.0 (+  i.new  15))
                ;(define %12.acc0.ab0 (bvaddnw %12.ext0.red Vd 16 -1))
                (define %12.acc0.ab0 (bvadd %12.ext0.red Vd   ))
                %12.acc0.ab0
                )
      )
    )
...
(define (hexagon_V6_vmaxb_128B  Vu.norm Vv.norm %elemsize0.norm )
  (define Vd.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vmpyiwb_acc_128B  Vx Vu Rt %innerlanesize0 %elemsize0 %arg0 %arg3 %arg4 %arg5 %arg7 %arg8 )
  (define %dst0
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 32 32))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 %innerlanesize0 %elemsize0))])
                            ...
                            (define %8 (+  %7  %lastidx1))
                            (define %9 (extract  %8 %7 Rt))
                            ;(define %11.ab0 (bvsizeext  %5 %arg5 1))
                            (define %11.ab0 (sign-extend %5 (bitvector %arg5)  ))
                            (define %12.ab0 (bvsizeext  %9 %arg5 %arg4))
                            (define %13 (bvmul  %11.ab0  %12.ab0))
                            ;(define %14.ab0 (bvsizeext  %2 %arg3 1))
                            (define %14.ab0 (sign-extend %2 (bitvector %arg3)  ))
                            ;(define %15.ab0 (bvaddnw %14.ab0 %13 %arg3 -1 ))
                            (define %15.ab0 (bvadd %14.ab0 %13   )) 
      ...
      (for/list ([i.new (reverse (range 0 2048 32))])
                (apply
                  ...
                  (for/list ([iterator.0.new (reverse (range 0 16 8))])
                            ...
                            (define %11.ab0 (zero-extend %4 (bitvector 16)  ))
                            (define %12.ab0 (bvsizeext  %10 16 %arg2))
                            (define %13 (bvmul  %11.ab0  %12.ab0))
                            %13
                            )
...
(define (hexagon_V6_vmpabuu_128B  Vuu Rt %arg3 %arg8 )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 32))])
                (apply
                  ...
                  (for/list ([iterator.0.new (reverse (range 0 16 8))])
                            ...
                            (define %10.ab0 (zero-extend %6 (bitvector 16)  ))
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 512 8))])
                            ...
                            (define %6.ab0 (bvssat %5 32 8  ))
                            (define %13 (extract  %2 %1.new0 VuV))
                            ;(define %14.ab0 (bvsizeext  %13 32 1))
                            (define %14.ab0 (sign-extend %13 (bitvector 32)  ))
                            (define %15 (bvashr  %14.ab0  %0))
                            ;(define %16.ab0 (bvsaturate  %15 32 8 1))
                            (define %16.ab0 (bvssat %15 32 8  ))
                            (concat %16.ab0 %6.ab0)
                            )
                  )
                )
...
(define (hexagon_V6_vasrwhrndsat_128B  Vu Vv Rt %arg1 %arg4 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_veqb_xor_128B  Vu.norm %arg1.norm %arg0.norm Vv.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
      ...
      (for/list ([i.new (reverse (range 0 2048 64))])
                (apply
                  ...
                  (for/list ([iterator.0.new (reverse (range 0 16 8))])
                            ...
                            (define %16.ab0 (sign-extend %11 (bitvector 32)  ))
                            ;(define %17.ab0 (bvsizeext  %14 32 1))
                            (define %17.ab0 (sign-extend %14 (bitvector 32)  ))
                            (define %18 (bvmul  %16.ab0  %17.ab0))
                            (define %23 (+  %8  1024))
                            (define %24 (+  %23  15))
                            ...
                            (define %30.ab0 (sign-extend %25 (bitvector 32)  ))
                            ;(define %31.ab0 (bvsizeext  %28 32 1))
                            (define %31.ab0 (sign-extend %28 (bitvector 32)  ))
                            (define %32 (bvmul  %30.ab0  %31.ab0))
                            ;(define %33.ab0 (bvaddnw %18 %32 32 -1 ))
                            (define %33.ab0 (bvadd %18 %32   )) 
                            ;(define %34.ab0 (bvaddnw %4 %33.ab0 32 -1 ))
                            (define %34.ab0 (bvadd %4 %33.ab0   )) 
                            %34.ab0
                            )
                  )
                )
...
(define (hexagon_V6_vavgwrnd_128B  %arg2 %arg0 Vu Vv %elemsize0 %arg1 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vadduwsat_128B  Vu Vv %elemsize0 %arg0 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vgtuw_xor_128B  Vv.norm Vu.norm %arg0.norm %arg1.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vnavgb_128B  %arg0 Vu Vv %elemsize0 %arg1 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vabsw_128B  Vu %elemsize0 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
...
(define (hexagon_V6_vgtb_xor_128B  %arg1.norm Vv.norm %arg0.norm Vu.norm QxV.norm %elemsize0.norm %arg2.norm )
  (define %dst0.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vsububsat_128B  Vu Vv %elemsize0 %arg0 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 512 16))])
                            ...
                            (define %3 (extract  %2 %1.new0 VvV))
                            (define %4 (bvashr  %3  %0))
                            (define %9.high.idx (- 16 1))
                            (define %9.low.idx 0)
                            (define %9 (extract  %9.high.idx %9.low.idx %4))
                            (define %12 (extract  %2 %1.new0 VuV))
                            (define %13 (bvashr  %12  %0))
                            (define %18.high.idx (- 16 1))
                            (define %18.low.idx 0)
...
(define (hexagon_V6_vgtb_128B  %arg0.norm Vv.norm Vu.norm %arg1.norm %elemsize0.norm %arg2.norm )
  (define QdV.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 128 128))])
...
(define (hexagon_V6_vmpahb_128B  Vuu Rt )
  (define Vdd
    (apply
      concat
      (for/list ([i.new (reverse (range 0 2048 64))])
                (apply
                  ...
                  (for/list ([iterator.0.new (reverse (range 0 16 8))])
                            ...
                            (define %11.ab0 (sign-extend %6 (bitvector 32)  ))
                            ;(define %12.ab0 (bvsizeext  %9 32 1))
                            (define %12.ab0 (sign-extend %9 (bitvector 32)  ))
                            (define %13 (bvmul  %11.ab0  %12.ab0))
                            (define %18 (+  %3  1024))
                            (define %19 (+  %18  15))
                            ...
                            (define %25.ab0 (sign-extend %20 (bitvector 32)  ))
                            ;(define %26.ab0 (bvsizeext  %23 32 1))
                            (define %26.ab0 (sign-extend %23 (bitvector 32)  ))
                            (define %27 (bvmul  %25.ab0  %26.ab0))
                            ;(define %28.ab0 (bvaddnw %13 %27 32 -1 ))
                            (define %28.ab0 (bvadd %13 %27   )) 
                            %28.ab0
                            )
                  )
                )
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 1024 16))])
                            ...
                            (define %6.ab0 (sign-extend %2 (bitvector 32)  ))
                            ;(define %7.ab0 (bvsizeext  %5 32 1))
                            (define %7.ab0 (sign-extend %5 (bitvector 32)  ))
                            (define %8 (bvmul  %6.ab0  %7.ab0))
                            (define %11.high.idx (- 16 1))
                            (define %11.low.idx 0)
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 512 8))])
                            ...
                            (define %4.ab0 (zero-extend %3 (bitvector 32)  ))
                            (define %5 (bvashr  %4.ab0  %0))
                            ;(define %6.ab0 (bvsaturate  %5 32 8 0))
                            (define %6.ab0 (bvusat %5 32 8  ))
                            (define %13 (extract  %2 %1.new0 VuV))
                            ;(define %14.ab0 (bvsizeext  %13 32 0))
                            (define %14.ab0 (zero-extend %13 (bitvector 32)  ))
                            (define %15 (bvashr  %14.ab0  %0))
                            ;(define %16.ab0 (bvsaturate  %15 32 8 0))
                            (define %16.ab0 (bvusat %15 32 8  ))
                            (concat %16.ab0 %6.ab0)
...
(define (hexagon_V6_vasrwv_128B  VvV.norm %arg0.norm VuV.norm %elemsize0.norm )
  (define VdV.norm
    (apply
      concat
      (for/list ([%outer.it.norm (reverse (range 0 1024 1024))])
      ...
      (for/list ([%outer.it (reverse (range 0 1 1))])
                (apply
                  ...
                  (for/list ([i.new (reverse (range 0 512 16))])
                            ...
                            (define %8.ab0 (zero-extend %4 (bitvector 32)  ))
                            ;(define %9.ab0 (bvsizeext  %7 32 0))
                            (define %9.ab0 (zero-extend %7 (bitvector 32)  ))
                            (define %10 (bvmul  %8.ab0  %9.ab0))
                            %10
                            )
                  )
...
(define (hexagon_V6_vpackwuh_sat_128B  Vu Vv %arg0 %arg3 )
  (define Vd
    (apply
      concat
      (for/list ([%outer.it (reverse (range 0 1024 1024))])
