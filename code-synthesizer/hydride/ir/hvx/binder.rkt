...
(define (hvx:bind-expr prog env)
  (destruct prog
            ...
            [ (hexagon_V6_vgtb_and_128B_dsl vc_0 v1 v2 vc_3 v4 prec_o prec_i)
             (hexagon_V6_vgtb_and_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr v2 env) 
            ...
            [ (hexagon_V6_vgtuw_xor_128B_dsl vc_0 v1 v2 vc_3 v4 prec_i_o num_6)
             (hexagon_V6_vgtuw_xor_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr v2 env) 
            ...
            [ (hexagon_V6_veqh_128B_dsl v0 v1 vc_2 vc_3 prec_o prec_i)
             (hexagon_V6_veqh_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr vc_2 env) 
            ...
            [ (hexagon_V6_vsb_128B_dsl v0 lane_size num_2 prec_i prec_o num_5 num_6)
             (hexagon_V6_vsb_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr lane_size env) (hvx:bind-expr num_2 env) 
                                      (hvx:bind-expr prec_i env) (hvx:bind-expr prec_o env) (hvx:bind-expr num_5 env) 
                                      (hvx:bind-expr num_6 env))
             ]
            [ (hexagon_V6_vminub_128B_dsl v0 v1 prec_i_o)
             (hexagon_V6_vminub_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr prec_i_o env))
             ]
            ...
            [ (hexagon_V6_vgtw_or_128B_dsl vc_0 v1 v2 vc_3 v4 prec_i_o num_6)
             (hexagon_V6_vgtw_or_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr v2 env) 
                                          (hvx:bind-expr vc_3 env) (hvx:bind-expr v4 env) (hvx:bind-expr prec_i_o env) 
                                          (hvx:bind-expr num_6 env))
             ]
            [ (hexagon_V6_vabsb_128B_dsl v0 prec_i_o)
             (hexagon_V6_vabsb_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr prec_i_o env))
             ]
            [ (hexagon_V6_veqw_or_128B_dsl vc_0 v1 v2 vc_3 v4 prec_i_o num_6)
             (hexagon_V6_veqw_or_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr v2 env) 
                                          (hvx:bind-expr vc_3 env) (hvx:bind-expr v4 env) (hvx:bind-expr prec_i_o env) 
                                          (hvx:bind-expr num_6 env))
             ]
            ...
            [ (hexagon_V6_vgtuh_or_128B_dsl vc_0 v1 v2 vc_3 v4 prec_i_o num_6)
             (hexagon_V6_vgtuh_or_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr v2 env) 
                                           (hvx:bind-expr vc_3 env) (hvx:bind-expr v4 env) (hvx:bind-expr prec_i_o env) 
                                           (hvx:bind-expr num_6 env))
             ]
            [ (hexagon_V6_vpackhb_sat_128B_dsl v0 v1 num_2 num_3)
             (hexagon_V6_vpackhb_sat_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr num_2 env) 
                                              (hvx:bind-expr num_3 env))
             ]
            ...
            [ (hexagon_V6_vgtub_and_128B_dsl vc_0 v1 v2 vc_3 v4 prec_o prec_i)
             (hexagon_V6_vgtub_and_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr v2 env) 
                                            (hvx:bind-expr vc_3 env) (hvx:bind-expr v4 env) (hvx:bind-expr prec_o env) 
                                            (hvx:bind-expr prec_i env))
             ]
            ...
            [ (hexagon_V6_vgtub_128B_dsl v0 vc_1 vc_2 v3 prec_o prec_i)
             (hexagon_V6_vgtub_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr vc_1 env) (hvx:bind-expr vc_2 env) 
            ...
            [ (hexagon_V6_vsubuhsat_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5 num_6)
             (hexagon_V6_vsubuhsat_dv_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr lane_size env) 
            ...
            [ (hexagon_V6_veqh_xor_128B_dsl vc_0 v1 vc_2 v3 v4 prec_i_o num_6)
             (hexagon_V6_veqh_xor_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr vc_2 env) 
            ...
            [ (hexagon_V6_vgth_128B_dsl v0 vc_1 v2 vc_3 prec_o prec_i)
             (hexagon_V6_vgth_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr vc_1 env) (hvx:bind-expr v2 env) 
                                       (hvx:bind-expr vc_3 env) (hvx:bind-expr prec_o env) (hvx:bind-expr prec_i env))
             ]
            ...
            [ (hexagon_V6_vmpyihb_128B_dsl v0 v1 num_2 num_3 prec_i_o num_5 num_6 num_7 num_8)
             (hexagon_V6_vmpyihb_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr num_2 env) 
                                          (hvx:bind-expr num_3 env) (hvx:bind-expr prec_i_o env) (hvx:bind-expr num_5 env) 
                                          (hvx:bind-expr num_6 env) (hvx:bind-expr num_7 env) (hvx:bind-expr num_8 env))
             ]
            ...
            [ (hexagon_V6_veqh_and_128B_dsl vc_0 v1 v2 vc_3 v4 prec_i_o num_6)
             (hexagon_V6_veqh_and_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr v2 env) 
                                           (hvx:bind-expr vc_3 env) (hvx:bind-expr v4 env) (hvx:bind-expr prec_i_o env) 
                                           (hvx:bind-expr num_6 env))
             ]
            ...
            [ (hexagon_V6_vrmpyub_128B_dsl v0 v1 num_2 num_3)
             (hexagon_V6_vrmpyub_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr num_2 env) 
                                          (hvx:bind-expr num_3 env))
             ]
            ...
            [ (hexagon_V6_vgtw_xor_128B_dsl v0 vc_1 vc_2 v3 v4 prec_i_o num_6)
             (hexagon_V6_vgtw_xor_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr vc_1 env) (hvx:bind-expr vc_2 env) 
                                           (hvx:bind-expr v3 env) (hvx:bind-expr v4 env) (hvx:bind-expr prec_i_o env) 
                                           (hvx:bind-expr num_6 env))
             ]
            ...
            [ (hexagon_V6_vaddbsat_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5 num_6)
             (hexagon_V6_vaddbsat_dv_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr lane_size env) 
                                              (hvx:bind-expr num_3 env) (hvx:bind-expr prec_i_o env) (hvx:bind-expr num_5 env) 
                                              (hvx:bind-expr num_6 env))
             ]
            ...
            [ (hexagon_V6_vsububh_128B_dsl v0 v1 lane_size num_3 prec_i prec_o num_6 num_7)
             (hexagon_V6_vsububh_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr lane_size env) 
                                          (hvx:bind-expr num_3 env) (hvx:bind-expr prec_i env) (hvx:bind-expr prec_o env) 
                                          (hvx:bind-expr num_6 env) (hvx:bind-expr num_7 env))
             ]
            ...
            [ (hexagon_V6_vrmpyubv_128B_dsl v0 v1 num_2 num_3 num_4)
             (hexagon_V6_vrmpyubv_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr num_2 env) 
                                           (hvx:bind-expr num_3 env) (hvx:bind-expr num_4 env))
             ]
            ...
            [ (hexagon_V6_vaddhw_128B_dsl v0 v1 lane_size num_3 prec_i prec_o num_6 num_7)
             (hexagon_V6_vaddhw_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr lane_size env) 
                                         (hvx:bind-expr num_3 env) (hvx:bind-expr prec_i env) (hvx:bind-expr prec_o env) 
                                         (hvx:bind-expr num_6 env) (hvx:bind-expr num_7 env))
             ]
            ...
            [ (hexagon_V6_vunpackuh_128B_dsl v0 prec_i prec_o num_3)
             (hexagon_V6_vunpackuh_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr prec_i env) (hvx:bind-expr prec_o env) 
                                            (hvx:bind-expr num_3 env))
             ]
