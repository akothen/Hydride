...
(define (hvx:bind-expr prog env)
 (destruct prog
	...
	[ (hexagon_V6_vgtw_xor_128B_dsl vc_0 vc_1 v2 v3 v4 prec_i_o num_6)
		(hexagon_V6_vgtw_xor_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr vc_1 env) (hvx:bind-expr v2 env) 
		 (hvx:bind-expr v3 env) (hvx:bind-expr v4 env) (hvx:bind-expr prec_i_o env) 
		 (hvx:bind-expr num_6 env))
	]
	[ (hexagon_V6_vroundhub_128B_dsl v0 v1 num_2 num_3)
		(hexagon_V6_vroundhub_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr num_2 env) 
		 (hvx:bind-expr num_3 env))
	]
	...
	[ (hexagon_V6_veqw_128B_dsl v0 vc_1 vc_2 v3 prec_o prec_i)
		(hexagon_V6_veqw_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr vc_1 env) (hvx:bind-expr vc_2 env) 
	...
	[ (hexagon_V6_vsubb_128B_dsl v0 v1 prec_i_o num_3)
		(hexagon_V6_vsubb_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr prec_i_o env) 
		 (hvx:bind-expr num_3 env))
	]
	...
	[ (hexagon_V6_veqb_and_128B_dsl vc_0 v1 vc_2 v3 v4 prec_o prec_i)
		(hexagon_V6_veqb_and_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr vc_2 env) 
	...
	[ (hexagon_V6_vmpyh_128B_dsl v0 v1 num_2 num_3)
		(hexagon_V6_vmpyh_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr num_2 env) 
		 (hvx:bind-expr num_3 env))
	]
	[ (hexagon_V6_vgtuh_or_128B_dsl vc_0 v1 vc_2 v3 v4 prec_i_o num_6)
		(hexagon_V6_vgtuh_or_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr vc_2 env) 
		 (hvx:bind-expr v3 env) (hvx:bind-expr v4 env) (hvx:bind-expr prec_i_o env) 
		 (hvx:bind-expr num_6 env))
	]
	...
	[ (hexagon_V6_vsubh_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5 num_6)
		(hexagon_V6_vsubh_dv_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr lane_size env) 
		 (hvx:bind-expr num_3 env) (hvx:bind-expr prec_i_o env) (hvx:bind-expr num_5 env) 
		 (hvx:bind-expr num_6 env))
	]
	...
	[ (hexagon_V6_veqb_xor_128B_dsl vc_0 v1 v2 vc_3 v4 prec_o prec_i)
		(hexagon_V6_veqb_xor_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr v2 env) 
		 (hvx:bind-expr vc_3 env) (hvx:bind-expr v4 env) (hvx:bind-expr prec_o env) 
		 (hvx:bind-expr prec_i env))
	]
	...
	[ (hexagon_V6_vgtub_and_128B_dsl v0 vc_1 vc_2 v3 v4 prec_o prec_i)
		(hexagon_V6_vgtub_and_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr vc_1 env) (hvx:bind-expr vc_2 env) 
		 (hvx:bind-expr v3 env) (hvx:bind-expr v4 env) (hvx:bind-expr prec_o env) 
		 (hvx:bind-expr prec_i env))
	]
	...
	[ (hexagon_V6_vgth_128B_dsl vc_0 v1 v2 vc_3 prec_o prec_i)
		(hexagon_V6_vgth_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr v2 env) 
	...
	[ (hexagon_V6_vsathub_128B_dsl v0 v1 prec_o num_3 num_4 prec_i num_6)
		(hexagon_V6_vsathub_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr prec_o env) 
	...
	[ (hexagon_V6_vgth_or_128B_dsl vc_0 v1 vc_2 v3 v4 prec_i_o num_6)
		(hexagon_V6_vgth_or_128B_dsl (hvx:bind-expr vc_0 env) (hvx:bind-expr v1 env) (hvx:bind-expr vc_2 env) 
		 (hvx:bind-expr v3 env) (hvx:bind-expr v4 env) (hvx:bind-expr prec_i_o env) 
		 (hvx:bind-expr num_6 env))
	]
	...
	[ (hexagon_V6_hi_128B_dsl v0 prec_i_o)
		(hexagon_V6_hi_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr prec_i_o env))
	]
	[ (hexagon_V6_vgth_and_128B_dsl v0 v1 vc_2 vc_3 v4 prec_i_o num_6)
		(hexagon_V6_vgth_and_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr vc_2 env) 
	...
	[ (hexagon_V6_vmpyub_128B_dsl v0 v1 num_2)
		(hexagon_V6_vmpyub_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr num_2 env))
	]
	[ (hexagon_V6_vminw_128B_dsl v0 v1 prec_i_o)
		(hexagon_V6_vminw_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr prec_i_o env))
	]
	...
	[ (hexagon_V6_vroundwh_128B_dsl v0 v1 num_2 num_3)
		(hexagon_V6_vroundwh_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr num_2 env) 
		 (hvx:bind-expr num_3 env))
	]
	...
	[ (hexagon_V6_vor_128B_dsl v0 v1 num_2 prec_i_o)
		(hexagon_V6_vor_128B_dsl (hvx:bind-expr v0 env) (hvx:bind-expr v1 env) (hvx:bind-expr num_2 env) 
		 (hvx:bind-expr prec_i_o env))
	]
