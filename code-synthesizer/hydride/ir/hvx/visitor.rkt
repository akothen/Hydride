...
(define (hvx:visitor prog fn)
 (destruct prog
	...
	[ (hexagon_V6_vrmpyubv_acc_128B_dsl v0 v1 v2 num_3 num_4 num_5)
		...
		(fn ( hexagon_V6_vrmpyubv_acc_128B_dsl v0-visited v1-visited v2-visited num_3 num_4 num_5 ))
	]
	...
	[ (hexagon_V6_veqh_or_128B_dsl vc_0 v1 v2 vc_3 v4 prec_i_o num_6)
		...
		(define v4-visited (hvx:visitor v4 fn))
		(fn ( hexagon_V6_veqh_or_128B_dsl vc_0-visited v1-visited v2-visited vc_3-visited v4-visited prec_i_o num_6 ))
	]
	[ (hexagon_V6_vshufoh_128B_dsl v0 v1 prec_i_o num_3)
		(define v0-visited (hvx:visitor v0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(fn ( hexagon_V6_vshufoh_128B_dsl v0-visited v1-visited prec_i_o num_3 ))
	]
	[ (hexagon_V6_vgtub_or_128B_dsl vc_0 vc_1 v2 v3 v4 prec_o prec_i)
		...
		(define v4-visited (hvx:visitor v4 fn))
		(fn ( hexagon_V6_vgtub_or_128B_dsl vc_0-visited vc_1-visited v2-visited v3-visited v4-visited prec_o prec_i ))
	]
	[ (hexagon_V6_vmpybv_acc_128B_dsl v0 v1 v2 lane_size num_4 num_5 prec_i_o num_7 num_8 num_9)
		(define v0-visited (hvx:visitor v0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(define v2-visited (hvx:visitor v2 fn))
		(fn ( hexagon_V6_vmpybv_acc_128B_dsl v0-visited v1-visited v2-visited lane_size num_4 num_5 prec_i_o num_7 num_8 num_9 ))
	]
	[ (hexagon_V6_vgtb_and_128B_dsl v0 vc_1 v2 vc_3 v4 prec_o prec_i)
		...
		(define vc_3-visited (hvx:visitor vc_3 fn))
		(define v4-visited (hvx:visitor v4 fn))
		(fn ( hexagon_V6_vgtb_and_128B_dsl v0-visited vc_1-visited v2-visited vc_3-visited v4-visited prec_o prec_i ))
	]
	...
	[ (hexagon_V6_veqb_and_128B_dsl v0 vc_1 v2 vc_3 v4 prec_o prec_i)
		...
		(define vc_3-visited (hvx:visitor vc_3 fn))
		(define v4-visited (hvx:visitor v4 fn))
		(fn ( hexagon_V6_veqb_and_128B_dsl v0-visited vc_1-visited v2-visited vc_3-visited v4-visited prec_o prec_i ))
	]
	[ (hexagon_V6_vgtub_and_128B_dsl vc_0 vc_1 v2 v3 v4 prec_o prec_i)
		...
		(define v3-visited (hvx:visitor v3 fn))
		(define v4-visited (hvx:visitor v4 fn))
		(fn ( hexagon_V6_vgtub_and_128B_dsl vc_0-visited vc_1-visited v2-visited v3-visited v4-visited prec_o prec_i ))
	]
	...
	[ (hexagon_V6_vsubwsat_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5 num_6)
		(define v0-visited (hvx:visitor v0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(fn ( hexagon_V6_vsubwsat_dv_128B_dsl v0-visited v1-visited lane_size num_3 prec_i_o num_5 num_6 ))
	]
	...
	[ (hexagon_V6_vrmpyub_acc_128B_dsl v0 v1 v2 num_3 num_4)
		...
		(define v1-visited (hvx:visitor v1 fn))
		(define v2-visited (hvx:visitor v2 fn))
		(fn ( hexagon_V6_vrmpyub_acc_128B_dsl v0-visited v1-visited v2-visited num_3 num_4 ))
	]
	[ (hexagon_V6_vavgh_128B_dsl vc_0 v1 v2 prec_i_o num_4)
		(define vc_0-visited (hvx:visitor vc_0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(define v2-visited (hvx:visitor v2 fn))
		(fn ( hexagon_V6_vavgh_128B_dsl vc_0-visited v1-visited v2-visited prec_i_o num_4 ))
	]
	...
	[ (hexagon_V6_vzb_128B_dsl v0 lane_size num_2 prec_i prec_o num_5 num_6)
		(define v0-visited (hvx:visitor v0 fn))
		(fn ( hexagon_V6_vzb_128B_dsl v0-visited lane_size num_2 prec_i prec_o num_5 num_6 ))
	]
	[ (hexagon_V6_vrounduhub_128B_dsl v0 v1 num_2 num_3)
		(define v0-visited (hvx:visitor v0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(fn ( hexagon_V6_vrounduhub_128B_dsl v0-visited v1-visited num_2 num_3 ))
	]
	...
	[ (hexagon_V6_vdmpyhisat_acc_128B_dsl v0 v1 v2 num_3)
		...
		(define v1-visited (hvx:visitor v1 fn))
		(define v2-visited (hvx:visitor v2 fn))
		(fn ( hexagon_V6_vdmpyhisat_acc_128B_dsl v0-visited v1-visited v2-visited num_3 ))
	]
	...
	[ (hexagon_V6_vroundwuh_128B_dsl v0 v1 num_2 num_3)
		(define v0-visited (hvx:visitor v0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(fn ( hexagon_V6_vroundwuh_128B_dsl v0-visited v1-visited num_2 num_3 ))
	]
	[ (hexagon_V6_vpackhub_sat_128B_dsl v0 v1 num_2 num_3)
		(define v0-visited (hvx:visitor v0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(fn ( hexagon_V6_vpackhub_sat_128B_dsl v0-visited v1-visited num_2 num_3 ))
	]
	...
	[ (hexagon_V6_vgtw_or_128B_dsl v0 v1 vc_2 vc_3 v4 prec_i_o num_6)
		...
		(define vc_3-visited (hvx:visitor vc_3 fn))
		(define v4-visited (hvx:visitor v4 fn))
		(fn ( hexagon_V6_vgtw_or_128B_dsl v0-visited v1-visited vc_2-visited vc_3-visited v4-visited prec_i_o num_6 ))
	]
	[ (hexagon_V6_vasrhbrndsat_128B_dsl v0 v1 v2 num_3 num_4 num_5 num_6)
		(define v0-visited (hvx:visitor v0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(define v2-visited (hvx:visitor v2 fn))
		(fn ( hexagon_V6_vasrhbrndsat_128B_dsl v0-visited v1-visited v2-visited num_3 num_4 num_5 num_6 ))
	]
	[ (hexagon_V6_vadduhw_acc_128B_dsl v0 v1 v2 lane_size num_4 num_5 prec_i_o num_7)
		(define v0-visited (hvx:visitor v0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(define v2-visited (hvx:visitor v2 fn))
		(fn ( hexagon_V6_vadduhw_acc_128B_dsl v0-visited v1-visited v2-visited lane_size num_4 num_5 prec_i_o num_7 ))
	]
	[ (hexagon_V6_vlsrhv_128B_dsl vc_0 v1 v2 prec_i_o)
		(define vc_0-visited (hvx:visitor vc_0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(define v2-visited (hvx:visitor v2 fn))
		(fn ( hexagon_V6_vlsrhv_128B_dsl vc_0-visited v1-visited v2-visited prec_i_o ))
	]
	[ (hexagon_V6_vaslwv_128B_dsl v0 vc_1 v2 prec_i_o)
		(define v0-visited (hvx:visitor v0 fn))
		(define vc_1-visited (hvx:visitor vc_1 fn))
		(define v2-visited (hvx:visitor v2 fn))
		(fn ( hexagon_V6_vaslwv_128B_dsl v0-visited vc_1-visited v2-visited prec_i_o ))
	]
	...
	[ (hexagon_V6_veqb_128B_dsl v0 v1 vc_2 vc_3 prec_o prec_i)
		...
		(define vc_2-visited (hvx:visitor vc_2 fn))
		(define vc_3-visited (hvx:visitor vc_3 fn))
		(fn ( hexagon_V6_veqb_128B_dsl v0-visited v1-visited vc_2-visited vc_3-visited prec_o prec_i ))
	]
	...
	[ (hexagon_V6_vgtub_128B_dsl v0 v1 vc_2 vc_3 prec_o prec_i)
		...
		(define vc_2-visited (hvx:visitor vc_2 fn))
		(define vc_3-visited (hvx:visitor vc_3 fn))
		(fn ( hexagon_V6_vgtub_128B_dsl v0-visited v1-visited vc_2-visited vc_3-visited prec_o prec_i ))
	]
	...
	[ (hexagon_V6_vdmpybus_128B_dsl vc_0 v1 v2)
		...
		(define v1-visited (hvx:visitor v1 fn))
		(define v2-visited (hvx:visitor v2 fn))
		(fn ( hexagon_V6_vdmpybus_128B_dsl vc_0-visited v1-visited v2-visited ))
	]
	...
	[ (hexagon_V6_vadduhw_128B_dsl v0 v1 lane_size num_3 prec_i prec_o num_6 num_7)
		(define v0-visited (hvx:visitor v0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(fn ( hexagon_V6_vadduhw_128B_dsl v0-visited v1-visited lane_size num_3 prec_i prec_o num_6 num_7 ))
	]
	...
	[ (hexagon_V6_vmaxb_128B_dsl v0 v1 prec_i_o)
		(define v0-visited (hvx:visitor v0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(fn ( hexagon_V6_vmaxb_128B_dsl v0-visited v1-visited prec_i_o ))
	]
	...
	[ (hexagon_V6_vasrwhrndsat_128B_dsl v0 v1 v2 num_3 num_4)
		...
		(define v1-visited (hvx:visitor v1 fn))
		(define v2-visited (hvx:visitor v2 fn))
		(fn ( hexagon_V6_vasrwhrndsat_128B_dsl v0-visited v1-visited v2-visited num_3 num_4 ))
	]
	[ (hexagon_V6_veqb_xor_128B_dsl v0 vc_1 vc_2 v3 v4 prec_o prec_i)
		...
		(define v3-visited (hvx:visitor v3 fn))
		(define v4-visited (hvx:visitor v4 fn))
		(fn ( hexagon_V6_veqb_xor_128B_dsl v0-visited vc_1-visited vc_2-visited v3-visited v4-visited prec_o prec_i ))
	]
	...
	[ (hexagon_V6_vavgwrnd_128B_dsl vc_0 vc_1 v2 v3 prec_i_o num_5)
		...
		(define v2-visited (hvx:visitor v2 fn))
		(define v3-visited (hvx:visitor v3 fn))
		(fn ( hexagon_V6_vavgwrnd_128B_dsl vc_0-visited vc_1-visited v2-visited v3-visited prec_i_o num_5 ))
	]
	...
	[ (hexagon_V6_vadduwsat_128B_dsl v0 v1 prec_i_o num_3)
		(define v0-visited (hvx:visitor v0 fn))
		(define v1-visited (hvx:visitor v1 fn))
		(fn ( hexagon_V6_vadduwsat_128B_dsl v0-visited v1-visited prec_i_o num_3 ))
	]
	...
	[ (hexagon_V6_vgtuw_xor_128B_dsl v0 v1 vc_2 vc_3 v4 prec_i_o num_6)
		...
		(define vc_3-visited (hvx:visitor vc_3 fn))
		(define v4-visited (hvx:visitor v4 fn))
		(fn ( hexagon_V6_vgtuw_xor_128B_dsl v0-visited v1-visited vc_2-visited vc_3-visited v4-visited prec_i_o num_6 ))
	]
	...
	[ (hexagon_V6_vnavgb_128B_dsl vc_0 v1 v2 prec_i_o num_4)
		...
		(define v1-visited (hvx:visitor v1 fn))
		(define v2-visited (hvx:visitor v2 fn))
		(fn ( hexagon_V6_vnavgb_128B_dsl vc_0-visited v1-visited v2-visited prec_i_o num_4 ))
	]
	...
	[ (hexagon_V6_vgtb_xor_128B_dsl vc_0 v1 vc_2 v3 v4 prec_o prec_i)
		...
		(define v3-visited (hvx:visitor v3 fn))
		(define v4-visited (hvx:visitor v4 fn))
		(fn ( hexagon_V6_vgtb_xor_128B_dsl vc_0-visited v1-visited vc_2-visited v3-visited v4-visited prec_o prec_i ))
	]
	...
	[ (hexagon_V6_vgtb_128B_dsl vc_0 v1 v2 vc_3 prec_o prec_i)
		...
		(define v2-visited (hvx:visitor v2 fn))
		(define vc_3-visited (hvx:visitor vc_3 fn))
		(fn ( hexagon_V6_vgtb_128B_dsl vc_0-visited v1-visited v2-visited vc_3-visited prec_o prec_i ))
	]
	...
	[ (hexagon_V6_vasrwv_128B_dsl v0 vc_1 v2 prec_i_o)
		...
		(define vc_1-visited (hvx:visitor vc_1 fn))
		(define v2-visited (hvx:visitor v2 fn))
		(fn ( hexagon_V6_vasrwv_128B_dsl v0-visited vc_1-visited v2-visited prec_i_o ))
	]
