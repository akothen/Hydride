...
(define (hvx:visitor prog fn)
  (destruct prog
            ...
            [ (hexagon_V6_vrmpybv_128B_dsl vc_0 v1 v2 num_3 num_4 num_5)
             ...
             (define v1-visited (hvx:visitor v1 fn))
             (define v2-visited (hvx:visitor v2 fn))
             (fn ( hexagon_V6_vrmpybv_128B_dsl vc_0-visited v1-visited v2-visited num_3 num_4 num_5 ))
             ]
            ...
            [ (hexagon_V6_vmaxh_128B_dsl v0 v1 prec_i_o)
             (define v0-visited (hvx:visitor v0 fn))
             (define v1-visited (hvx:visitor v1 fn))
             (fn ( hexagon_V6_vmaxh_128B_dsl v0-visited v1-visited prec_i_o ))
             ]
            ...
            [ (hexagon_V6_vgtw_128B_dsl v0 vc_1 v2 vc_3 prec_o prec_i)
             ...
             (fn ( hexagon_V6_vgtw_128B_dsl v0-visited vc_1-visited v2-visited vc_3-visited prec_o prec_i ))
             ]
            ...
            [ (hexagon_V6_vunpackub_128B_dsl v0 prec_i prec_o num_3)
             (define v0-visited (hvx:visitor v0 fn))
             (fn ( hexagon_V6_vunpackub_128B_dsl v0-visited prec_i prec_o num_3 ))
             ]
            ...
            [ (hexagon_V6_veqh_xor_128B_dsl v0 v1 vc_2 vc_3 v4 prec_i_o num_6)
             ...
             (define vc_3-visited (hvx:visitor vc_3 fn))
             (define v4-visited (hvx:visitor v4 fn))
             (fn ( hexagon_V6_veqh_xor_128B_dsl v0-visited v1-visited vc_2-visited vc_3-visited v4-visited prec_i_o num_6 ))
             ]
            ...
            [ (hexagon_V6_vrounduwuh_128B_dsl v0 v1 num_2 num_3)
             (define v0-visited (hvx:visitor v0 fn))
             (define v1-visited (hvx:visitor v1 fn))
             (fn ( hexagon_V6_vrounduwuh_128B_dsl v0-visited v1-visited num_2 num_3 ))
             ]
            [ (hexagon_V6_vmpabus_128B_dsl v0 v1 num_2 num_3)
             (define v0-visited (hvx:visitor v0 fn))
             (define v1-visited (hvx:visitor v1 fn))
             (fn ( hexagon_V6_vmpabus_128B_dsl v0-visited v1-visited num_2 num_3 ))
             ]
            ...
            [ (hexagon_V6_vavguh_128B_dsl vc_0 v1 v2 prec_i_o num_4)
             ...
             (define v1-visited (hvx:visitor v1 fn))
             (define v2-visited (hvx:visitor v2 fn))
             (fn ( hexagon_V6_vavguh_128B_dsl vc_0-visited v1-visited v2-visited prec_i_o num_4 ))
             ]
            ...
            [ (hexagon_V6_vshuffeb_128B_dsl v0 v1 prec_i_o num_3)
             (define v0-visited (hvx:visitor v0 fn))
             (define v1-visited (hvx:visitor v1 fn))
             (fn ( hexagon_V6_vshuffeb_128B_dsl v0-visited v1-visited prec_i_o num_3 ))
             ]
            ...
            [ (hexagon_V6_vdmpyhisat_128B_dsl vc_0 v1 v2 num_3)
             ...
             (define v1-visited (hvx:visitor v1 fn))
             (define v2-visited (hvx:visitor v2 fn))
             (fn ( hexagon_V6_vdmpyhisat_128B_dsl vc_0-visited v1-visited v2-visited num_3 ))
             ]
            [ (hexagon_V6_vsatwh_128B_dsl v0 v1 prec_o num_3 num_4 prec_i num_6)
             (define v0-visited (hvx:visitor v0 fn))
             (define v1-visited (hvx:visitor v1 fn))
             (fn ( hexagon_V6_vsatwh_128B_dsl v0-visited v1-visited prec_o num_3 num_4 prec_i num_6 ))
             ]
            [ (hexagon_V6_vnavgub_128B_dsl vc_0 v1 v2 prec_i_o num_4)
             (define vc_0-visited (hvx:visitor vc_0 fn))
             (define v1-visited (hvx:visitor v1 fn))
             (define v2-visited (hvx:visitor v2 fn))
             (fn ( hexagon_V6_vnavgub_128B_dsl vc_0-visited v1-visited v2-visited prec_i_o num_4 ))
             ]
            ...
            [ (hexagon_V6_veqw_and_128B_dsl v0 v1 vc_2 vc_3 v4 prec_i_o num_6)
             ...
             (define vc_3-visited (hvx:visitor vc_3 fn))
             (define v4-visited (hvx:visitor v4 fn))
             (fn ( hexagon_V6_veqw_and_128B_dsl v0-visited v1-visited vc_2-visited vc_3-visited v4-visited prec_i_o num_6 ))
             ]
            ...
            [ (hexagon_V6_vaddw_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5 num_6)
             (define v0-visited (hvx:visitor v0 fn))
             (define v1-visited (hvx:visitor v1 fn))
             (fn ( hexagon_V6_vaddw_dv_128B_dsl v0-visited v1-visited lane_size num_3 prec_i_o num_5 num_6 ))
             ]
            ...
            [ (hexagon_V6_vgtub_xor_128B_dsl v0 vc_1 vc_2 v3 v4 prec_o prec_i)
             ...
             (define v4-visited (hvx:visitor v4 fn))
             (fn ( hexagon_V6_vgtub_xor_128B_dsl v0-visited vc_1-visited vc_2-visited v3-visited v4-visited prec_o prec_i ))
             ]
            [ (hexagon_V6_vaddwnq_128B_dsl v0 v1 v2 prec_i_o num_4)
             (define v0-visited (hvx:visitor v0 fn))
             (define v1-visited (hvx:visitor v1 fn))
             (define v2-visited (hvx:visitor v2 fn))
             (fn ( hexagon_V6_vaddwnq_128B_dsl v0-visited v1-visited v2-visited prec_i_o num_4 ))
             ]
            ...
            [ (hexagon_V6_vgtw_xor_128B_dsl vc_0 v1 v2 vc_3 v4 prec_i_o num_6)
             ...
             (define vc_3-visited (hvx:visitor vc_3 fn))
             (define v4-visited (hvx:visitor v4 fn))
             (fn ( hexagon_V6_vgtw_xor_128B_dsl vc_0-visited v1-visited v2-visited vc_3-visited v4-visited prec_i_o num_6 ))
             ]
            ...
            [ (hexagon_V6_vsubb_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5 num_6)
             (define v0-visited (hvx:visitor v0 fn))
             (define v1-visited (hvx:visitor v1 fn))
             (fn ( hexagon_V6_vsubb_dv_128B_dsl v0-visited v1-visited lane_size num_3 prec_i_o num_5 num_6 ))
             ]
            ...
            [ (hexagon_V6_vsubhw_128B_dsl v0 v1 lane_size num_3 prec_i prec_o num_6 num_7)
             (define v0-visited (hvx:visitor v0 fn))
             (define v1-visited (hvx:visitor v1 fn))
             (fn ( hexagon_V6_vsubhw_128B_dsl v0-visited v1-visited lane_size num_3 prec_i prec_o num_6 num_7 ))
             ]
            ...
            [ (hexagon_V6_vabsh_128B_dsl v0 prec_i_o)
             (define v0-visited (hvx:visitor v0 fn))
             (fn ( hexagon_V6_vabsh_128B_dsl v0-visited prec_i_o ))
             ]
            ...
            [ (hexagon_V6_vdmpyhsat_128B_dsl vc_0 v1 v2 num_3)
             ...
             (define v1-visited (hvx:visitor v1 fn))
             (define v2-visited (hvx:visitor v2 fn))
             (fn ( hexagon_V6_vdmpyhsat_128B_dsl vc_0-visited v1-visited v2-visited num_3 ))
             ]
            [ (hexagon_V6_vmpyiwh_128B_dsl v0 v1 num_2 num_3 prec_i_o num_5 num_6 num_7 num_8)
             (define v0-visited (hvx:visitor v0 fn))
             (define v1-visited (hvx:visitor v1 fn))
             (fn ( hexagon_V6_vmpyiwh_128B_dsl v0-visited v1-visited num_2 num_3 prec_i_o num_5 num_6 num_7 num_8 ))
             ]
            [ (hexagon_V6_vgtub_and_128B_dsl vc_0 v1 vc_2 v3 v4 prec_o prec_i)
             ...
             (define v3-visited (hvx:visitor v3 fn))
             (define v4-visited (hvx:visitor v4 fn))
             (fn ( hexagon_V6_vgtub_and_128B_dsl vc_0-visited v1-visited vc_2-visited v3-visited v4-visited prec_o prec_i ))
             ]
            ...
            [ (hexagon_V6_vgtub_or_128B_dsl v0 vc_1 v2 vc_3 v4 prec_o prec_i)
             ...
             (define vc_3-visited (hvx:visitor vc_3 fn))
             (define v4-visited (hvx:visitor v4 fn))
             (fn ( hexagon_V6_vgtub_or_128B_dsl v0-visited vc_1-visited v2-visited vc_3-visited v4-visited prec_o prec_i ))
             ]
            ...
            [ (hexagon_V6_veqw_or_128B_dsl vc_0 v1 vc_2 v3 v4 prec_i_o num_6)
             ...
             (define v3-visited (hvx:visitor v3 fn))
             (define v4-visited (hvx:visitor v4 fn))
             (fn ( hexagon_V6_veqw_or_128B_dsl vc_0-visited v1-visited vc_2-visited v3-visited v4-visited prec_i_o num_6 ))
             ]
            ...
            [ (hexagon_V6_vsubuwsat_128B_dsl v0 v1 prec_i_o num_3)
             (define v0-visited (hvx:visitor v0 fn))
             (define v1-visited (hvx:visitor v1 fn))
             (fn ( hexagon_V6_vsubuwsat_128B_dsl v0-visited v1-visited prec_i_o num_3 ))
             ]
            ...
            [ (hexagon_V6_veqb_128B_dsl vc_0 v1 v2 vc_3 prec_o prec_i)
             ...
             (define v2-visited (hvx:visitor v2 fn))
             (define vc_3-visited (hvx:visitor vc_3 fn))
             (fn ( hexagon_V6_veqb_128B_dsl vc_0-visited v1-visited v2-visited vc_3-visited prec_o prec_i ))
             ]
