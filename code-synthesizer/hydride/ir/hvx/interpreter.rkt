...
(define (hvx:interpret prog env)
 (destruct prog
	...
	[ (hexagon_V6_vabsdiffuh_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10)
		(hexagon_V6_vabsdiffuh_128B (hvx:interpret v0 env) (hvx:interpret v1 env) size_i_o 
		 num_3 num_4 num_5 
	...
	[ (hexagon_V6_vgtuw_128B_dsl vc_0 vc_1 v2 v3 size_i_o num_5 num_6 num_7 prec_o num_9 prec_i num_11 num_12)
		(hexagon_V6_vgtuw_128B (hvx:interpret vc_0 env) (hvx:interpret vc_1 env) (hvx:interpret v2 env) 
		 (hvx:interpret v3 env) size_i_o num_5 
		 num_6 num_7 prec_o 
		 num_9 prec_i num_11 
		 num_12)
	...
	[ (hexagon_V6_veqh_and_128B_dsl v0 vc_1 vc_2 v3 v4 size_i_o num_6 num_7 num_8 prec_i_o num_10 num_11 num_12)
		(hexagon_V6_veqh_and_128B (hvx:interpret v0 env) (hvx:interpret vc_1 env) (hvx:interpret vc_2 env) 
		 (hvx:interpret v3 env) (hvx:interpret v4 env) size_i_o 
		 num_6 num_7 num_8 
		 prec_i_o num_10 num_11 
		 num_12)
	...
	[ (hexagon_V6_vaddwsat_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(hexagon_V6_vaddwsat_128B (hvx:interpret v0 env) (hvx:interpret v1 env) size_i_o 
		 num_3 num_4 num_5 
		 prec_i_o num_7 num_8)
	]
	...
	[ (hexagon_V6_vmaxh_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(hexagon_V6_vmaxh_128B (hvx:interpret v0 env) (hvx:interpret v1 env) size_i_o 
		 num_3 num_4 num_5 
		 prec_i_o num_7 num_8)
	]
	...
	[ (hexagon_V6_vminub_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(hexagon_V6_vminub_128B (hvx:interpret v0 env) (hvx:interpret v1 env) size_i_o 
		 num_3 num_4 num_5 
		 prec_i_o num_7 num_8)
	]
	...
	[ (hexagon_V6_pred_not_128B_dsl v0 size_o num_2 num_3 num_4 prec_o num_6)
		(hexagon_V6_pred_not_128B (hvx:interpret v0 env) size_o num_2 
		 num_3 num_4 prec_o 
		 num_6)
	]
	...
	[ (hexagon_V6_vsubbsat_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(hexagon_V6_vsubbsat_128B (hvx:interpret v0 env) (hvx:interpret v1 env) size_i_o 
		 num_3 num_4 num_5 
		 prec_i_o num_7 num_8)
	]
	...
	[ (hexagon_V6_veqw_128B_dsl vc_0 v1 v2 vc_3 size_i_o num_5 num_6 num_7 prec_o prec_i num_10 num_11)
		(hexagon_V6_veqw_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
	...
	[ (hexagon_V6_vandvrt_acc_128B_dsl vc_0 vc_1 vc_2 v3 v4 v5 size_i_o num_7 num_8 num_9 prec_o prec_i num_12 num_13 num_14)
		(hexagon_V6_vandvrt_acc_128B (hvx:interpret vc_0 env) (hvx:interpret vc_1 env) (hvx:interpret vc_2 env) 
		 (hvx:interpret v3 env) (hvx:interpret v4 env) (hvx:interpret v5 env) 
		 size_i_o num_7 num_8 
		 num_9 prec_o prec_i 
		 num_12 num_13 num_14)
	...
	[ (hexagon_V6_vrmpybus_128B_dsl vc_0 v1 v2 size_i prec_o num_5 num_6 prec_i num_8 num_9 num_10 num_11 num_12 num_13)
		(hexagon_V6_vrmpybus_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
		 size_i prec_o num_5 
		 num_6 prec_i num_8 
		 num_9 num_10 num_11 
		 num_12 num_13)
	...
	[ (hexagon_V6_vmpyiwh_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 num_6 prec_i_o num_8 num_9 num_10 num_11 num_12 num_13 num_14)
		(hexagon_V6_vmpyiwh_128B (hvx:interpret v0 env) (hvx:interpret v1 env) size_i_o 
		 num_3 num_4 num_5 
		 num_6 prec_i_o num_8 
		 num_9 num_10 num_11 
		 num_12 num_13 num_14)
	...
	[ (hexagon_V6_vaddwq_128B_dsl v0 vc_1 v2 v3 size_i_o num_5 num_6 num_7 prec_i_o num_9 num_10 num_11 num_12)
		(hexagon_V6_vaddwq_128B (hvx:interpret v0 env) (hvx:interpret vc_1 env) (hvx:interpret v2 env) 
		 (hvx:interpret v3 env) size_i_o num_5 
		 num_6 num_7 prec_i_o 
		 num_9 num_10 num_11 
		 num_12)
	...
	[ (hexagon_V6_vandqrt_acc_128B_dsl vc_0 vc_1 v2 v3 v4 size_i_o num_6 num_7 num_8 prec_i_o num_10 num_11 num_12 num_13)
		(hexagon_V6_vandqrt_acc_128B (hvx:interpret vc_0 env) (hvx:interpret vc_1 env) (hvx:interpret v2 env) 
		 (hvx:interpret v3 env) (hvx:interpret v4 env) size_i_o 
		 num_6 num_7 num_8 
		 prec_i_o num_10 num_11 
		 num_12 num_13)
	...
	[ (hexagon_V6_vand_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7)
		(hexagon_V6_vand_128B (hvx:interpret v0 env) (hvx:interpret v1 env) size_i_o 
		 num_3 num_4 num_5 
		 prec_i_o num_7)
	]
