...
(define (hvx:interpret prog env)
  (destruct prog
            ...
            [ (hexagon_V6_vrmpyubv_acc_128B_dsl v0 v1 v2)
             (hexagon_V6_vrmpyubv_acc_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret v2 env))
             ]
            [ (hexagon_V6_vmpyowh_128B_dsl v0 v1)
             (hexagon_V6_vmpyowh_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            ...
            [ (hexagon_V6_veqh_xor_128B_dsl vc_0 v1 v2 vc_3 v4 prec_i_o num_6)
             (hexagon_V6_veqh_xor_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
                                       (hvx:interpret vc_3 env) (hvx:interpret v4 env) prec_i_o 
                                       num_6)
             ]
            [ (hexagon_V6_vrmpyub_acc_128B_dsl v0 v1 v2)
             (hexagon_V6_vrmpyub_acc_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret v2 env))
             ]
            [ (hexagon_V6_vaddhsat_128B_dsl v0 v1 prec_i_o)
             (hexagon_V6_vaddhsat_128B (hvx:interpret v0 env) (hvx:interpret v1 env) prec_i_o)
             ]
            ...
            [ (hexagon_V6_vzb_128B_dsl v0 lane_size num_2 prec_i prec_o num_5)
             (hexagon_V6_vzb_128B (hvx:interpret v0 env) lane_size num_2 
                                  prec_i prec_o num_5)
             ]
            ...
            [ (hexagon_V6_veqw_and_128B_dsl vc_0 vc_1 v2 v3 v4 prec_i_o num_6)
             (hexagon_V6_veqw_and_128B (hvx:interpret vc_0 env) (hvx:interpret vc_1 env) (hvx:interpret v2 env) 
                                       (hvx:interpret v3 env) (hvx:interpret v4 env) prec_i_o 
                                       num_6)
             ]
            [ (hexagon_V6_vpackhub_sat_128B_dsl v0 v1)
             (hexagon_V6_vpackhub_sat_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            [ (hexagon_V6_vavguwrnd_128B_dsl vc_0 vc_1 v2 v3 prec_i_o)
             (hexagon_V6_vavguwrnd_128B (hvx:interpret vc_0 env) (hvx:interpret vc_1 env) (hvx:interpret v2 env) 
                                        (hvx:interpret v3 env) prec_i_o)
             ]
            [ (hexagon_V6_vmpyhv_acc_128B_dsl v0 v1 v2 lane_size num_4 num_5 prec_i_o num_7)
             (hexagon_V6_vmpyhv_acc_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
                                         lane_size num_4 num_5 
                                         prec_i_o num_7)
             ]
            ...
            [ (hexagon_V6_vdmpyhisat_acc_128B_dsl v0 v1 v2)
             (hexagon_V6_vdmpyhisat_acc_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret v2 env))
             ]
            [ (hexagon_V6_vassign_128B_dsl v0)
             (hexagon_V6_vassign_128B (hvx:interpret v0 env))
             ]
            ...
            [ (hexagon_V6_vaddhw_128B_dsl v0 v1)
             (hexagon_V6_vaddhw_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            [ (hexagon_V6_vgtuh_xor_128B_dsl v0 vc_1 v2 vc_3 v4 prec_i_o num_6)
             (hexagon_V6_vgtuh_xor_128B (hvx:interpret v0 env) (hvx:interpret vc_1 env) (hvx:interpret v2 env) 
                                        (hvx:interpret vc_3 env) (hvx:interpret v4 env) prec_i_o 
                                        num_6)
             ]
            ...
            [ (hexagon_V6_vrmpyubv_128B_dsl v0 v1)
             (hexagon_V6_vrmpyubv_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            [ (hexagon_V6_vshuffb_128B_dsl v0 lane_size num_2 prec_i_o num_4 num_5)
             (hexagon_V6_vshuffb_128B (hvx:interpret v0 env) lane_size num_2 
            ...
            [ (hexagon_V6_vsubw_128B_dsl v0 v1 prec_i_o)
             (hexagon_V6_vsubw_128B (hvx:interpret v0 env) (hvx:interpret v1 env) prec_i_o)
             ]
            [ (hexagon_V6_pred_not_128B_dsl v0 num_1 prec_o)
             (hexagon_V6_pred_not_128B (hvx:interpret v0 env) num_1 prec_o)
             ]
            [ (hexagon_V6_vmpybv_128B_dsl v0 v1 lane_size num_3 prec_i prec_o num_6)
             (hexagon_V6_vmpybv_128B (hvx:interpret v0 env) (hvx:interpret v1 env) lane_size 
                                     num_3 prec_i prec_o 
                                     num_6)
             ]
            [ (hexagon_V6_vmaxub_128B_dsl v0 v1 prec_i_o)
             (hexagon_V6_vmaxub_128B (hvx:interpret v0 env) (hvx:interpret v1 env) prec_i_o)
             ]
            ...
            [ (hexagon_V6_vgtuw_or_128B_dsl vc_0 v1 v2 vc_3 v4 prec_i_o num_6)
             (hexagon_V6_vgtuw_or_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
                                       (hvx:interpret vc_3 env) (hvx:interpret v4 env) prec_i_o 
                                       num_6)
             ]
            ...
            [ (hexagon_V6_vsububsat_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5)
             (hexagon_V6_vsububsat_dv_128B (hvx:interpret v0 env) (hvx:interpret v1 env) lane_size 
                                           num_3 prec_i_o num_5)
             ]
            ...
            [ (hexagon_V6_vrmpybv_128B_dsl v0 v1)
             (hexagon_V6_vrmpybv_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            [ (hexagon_V6_vmpyub_128B_dsl v0 v1)
             (hexagon_V6_vmpyub_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            ...
            [ (hexagon_V6_vmpyiwub_acc_128B_dsl v0 v1 v2)
             (hexagon_V6_vmpyiwub_acc_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret v2 env))
             ]
            [ (hexagon_V6_vmpyiwub_128B_dsl v0 v1)
             (hexagon_V6_vmpyiwub_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            ...
            [ (hexagon_V6_vgtb_or_128B_dsl vc_0 v1 v2 vc_3 v4 prec_o prec_i)
             (hexagon_V6_vgtb_or_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
                                      (hvx:interpret vc_3 env) (hvx:interpret v4 env) prec_o 
                                      prec_i)
             ]
            [ (hexagon_V6_vpackwh_sat_128B_dsl v0 v1)
             (hexagon_V6_vpackwh_sat_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            [ (hexagon_V6_vrmpybusv_128B_dsl v0 v1)
             (hexagon_V6_vrmpybusv_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            ...
            [ (hexagon_V6_vmpabuu_128B_dsl v0 v1)
             (hexagon_V6_vmpabuu_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            [ (hexagon_V6_vrmpybus_128B_dsl v0 v1)
             (hexagon_V6_vrmpybus_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            ...
            [ (hexagon_V6_vgtuh_128B_dsl vc_0 vc_1 v2 v3 prec_o prec_i)
             (hexagon_V6_vgtuh_128B (hvx:interpret vc_0 env) (hvx:interpret vc_1 env) (hvx:interpret v2 env) 
            ...
            [ (hexagon_V6_vgth_xor_128B_dsl v0 v1 vc_2 vc_3 v4 prec_i_o num_6)
             (hexagon_V6_vgth_xor_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret vc_2 env) 
                                       (hvx:interpret vc_3 env) (hvx:interpret v4 env) prec_i_o 
                                       num_6)
             ]
            ...
            [ (hexagon_V6_vgtuw_and_128B_dsl v0 v1 vc_2 vc_3 v4 prec_i_o num_6)
             (hexagon_V6_vgtuw_and_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret vc_2 env) 
                                        (hvx:interpret vc_3 env) (hvx:interpret v4 env) prec_i_o 
                                        num_6)
             ]
            ...
            [ (hexagon_V6_vaddwsat_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5)
             (hexagon_V6_vaddwsat_dv_128B (hvx:interpret v0 env) (hvx:interpret v1 env) lane_size 
                                          num_3 prec_i_o num_5)
             ]
            [ (hexagon_V6_vgth_and_128B_dsl vc_0 v1 v2 vc_3 v4 prec_i_o num_6)
             (hexagon_V6_vgth_and_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
                                       (hvx:interpret vc_3 env) (hvx:interpret v4 env) prec_i_o 
                                       num_6)
             ]
            ...
            [ (hexagon_V6_veqw_128B_dsl v0 vc_1 v2 vc_3 prec_o prec_i)
             (hexagon_V6_veqw_128B (hvx:interpret v0 env) (hvx:interpret vc_1 env) (hvx:interpret v2 env) 
                                   (hvx:interpret vc_3 env) prec_o prec_i)
             ]
            [ (hexagon_V6_vmpyh_128B_dsl v0 v1)
             (hexagon_V6_vmpyh_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            ...
            [ (hexagon_V6_vaddb_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5)
             (hexagon_V6_vaddb_dv_128B (hvx:interpret v0 env) (hvx:interpret v1 env) lane_size 
                                       num_3 prec_i_o num_5)
             ]
            [ (hexagon_V6_vsubbsat_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5)
             (hexagon_V6_vsubbsat_dv_128B (hvx:interpret v0 env) (hvx:interpret v1 env) lane_size 
                                          num_3 prec_i_o num_5)
             ]
            ...
            [ (hexagon_V6_vabsw_sat_128B_dsl v0 prec_i_o)
             (hexagon_V6_vabsw_sat_128B (hvx:interpret v0 env) prec_i_o)
             ]
            ...
            [ (hexagon_V6_vaddh_128B_dsl v0 v1 prec_i_o)
             (hexagon_V6_vaddh_128B (hvx:interpret v0 env) (hvx:interpret v1 env) prec_i_o)
             ]
            [ (hexagon_V6_vrmpybusv_acc_128B_dsl v0 v1 v2)
             (hexagon_V6_vrmpybusv_acc_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret v2 env))
             ]
            ...
            [ (hexagon_V6_vnavgb_128B_dsl vc_0 v1 v2 prec_i_o)
             (hexagon_V6_vnavgb_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
                                     prec_i_o)
             ]
            ...
            [ (hexagon_V6_vsubhsat_128B_dsl v0 v1 prec_i_o)
             (hexagon_V6_vsubhsat_128B (hvx:interpret v0 env) (hvx:interpret v1 env) prec_i_o)
             ]
            [ (hexagon_V6_vmpyuh_acc_128B_dsl v0 v1 v2)
             (hexagon_V6_vmpyuh_acc_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret v2 env))
             ]
            ...
            [ (hexagon_V6_vpackwuh_sat_128B_dsl v0 v1)
             (hexagon_V6_vpackwuh_sat_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            ...
            [ (hexagon_V6_vavgh_128B_dsl vc_0 v1 v2 prec_i_o)
             (hexagon_V6_vavgh_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
                                    prec_i_o)
             ]
            ...
            [ (hexagon_V6_vpackhb_sat_128B_dsl v0 v1)
             (hexagon_V6_vpackhb_sat_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            ...
            [ (hexagon_V6_vsubhw_128B_dsl v0 v1)
             (hexagon_V6_vsubhw_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            [ (hexagon_V6_vadduwsat_128B_dsl v0 v1 prec_i_o)
             (hexagon_V6_vadduwsat_128B (hvx:interpret v0 env) (hvx:interpret v1 env) prec_i_o)
             ]
            ...
            [ (hexagon_V6_vaddubh_128B_dsl v0 v1 lane_size num_3 prec_i prec_o num_6)
             (hexagon_V6_vaddubh_128B (hvx:interpret v0 env) (hvx:interpret v1 env) lane_size 
                                      num_3 prec_i prec_o 
                                      num_6)
             ]
            ...
            [ (hexagon_V6_vrmpyub_128B_dsl v0 v1)
             (hexagon_V6_vrmpyub_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            [ (hexagon_V6_vmpybus_128B_dsl v0 v1)
             (hexagon_V6_vmpybus_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            [ (hexagon_V6_vmpabus_128B_dsl v0 v1)
             (hexagon_V6_vmpabus_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            ...
            [ (hexagon_V6_vgtw_128B_dsl vc_0 v1 v2 vc_3 prec_o prec_i)
             (hexagon_V6_vgtw_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
                                   (hvx:interpret vc_3 env) prec_o prec_i)
             ]
            ...
            [ (hexagon_V6_vsatwh_128B_dsl v0 v1)
             (hexagon_V6_vsatwh_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
            ...
            [ (hexagon_V6_vmpyuh_128B_dsl v0 v1)
             (hexagon_V6_vmpyuh_128B (hvx:interpret v0 env) (hvx:interpret v1 env))
             ]
