...
(define (hvx:interpret prog env)
 (destruct prog
	...
	[ (hexagon_V6_veqh_or_128B_dsl vc_0 v1 v2 vc_3 v4 prec_i_o num_6)
		(hexagon_V6_veqh_or_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
	...
	[ (hexagon_V6_vgtub_or_128B_dsl vc_0 vc_1 v2 v3 v4 prec_o prec_i)
		(hexagon_V6_vgtub_or_128B (hvx:interpret vc_0 env) (hvx:interpret vc_1 env) (hvx:interpret v2 env) 
	...
	[ (hexagon_V6_vgtub_and_128B_dsl vc_0 vc_1 v2 v3 v4 prec_o prec_i)
		(hexagon_V6_vgtub_and_128B (hvx:interpret vc_0 env) (hvx:interpret vc_1 env) (hvx:interpret v2 env) 
		 (hvx:interpret v3 env) (hvx:interpret v4 env) prec_o 
		 prec_i)
	]
	...
	[ (hexagon_V6_vsubwsat_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5 num_6)
		(hexagon_V6_vsubwsat_dv_128B (hvx:interpret v0 env) (hvx:interpret v1 env) lane_size 
		 num_3 prec_i_o num_5 
		 num_6)
	]
	...
	[ (hexagon_V6_vroundwuh_128B_dsl v0 v1 num_2 num_3)
		(hexagon_V6_vroundwuh_128B (hvx:interpret v0 env) (hvx:interpret v1 env) num_2 
		 num_3)
	]
	...
	[ (hexagon_V6_vasrhbrndsat_128B_dsl v0 v1 v2 num_3 num_4 num_5 num_6)
		(hexagon_V6_vasrhbrndsat_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
		 num_3 num_4 num_5 
		 num_6)
	]
	...
	[ (hexagon_V6_vlsrhv_128B_dsl vc_0 v1 v2 prec_i_o)
		(hexagon_V6_vlsrhv_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
		 prec_i_o)
	]
	...
	[ (hexagon_V6_vgtub_128B_dsl v0 v1 vc_2 vc_3 prec_o prec_i)
		(hexagon_V6_vgtub_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret vc_2 env) 
		 (hvx:interpret vc_3 env) prec_o prec_i)
	]
	...
	[ (hexagon_V6_vmaxb_128B_dsl v0 v1 prec_i_o)
		(hexagon_V6_vmaxb_128B (hvx:interpret v0 env) (hvx:interpret v1 env) prec_i_o)
	]
	...
	[ (hexagon_V6_vasrwhrndsat_128B_dsl v0 v1 v2 num_3 num_4)
		(hexagon_V6_vasrwhrndsat_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
		 num_3 num_4)
	]
	[ (hexagon_V6_veqb_xor_128B_dsl v0 vc_1 vc_2 v3 v4 prec_o prec_i)
		(hexagon_V6_veqb_xor_128B (hvx:interpret v0 env) (hvx:interpret vc_1 env) (hvx:interpret vc_2 env) 
		 (hvx:interpret v3 env) (hvx:interpret v4 env) prec_o 
		 prec_i)
	]
	...
	[ (hexagon_V6_vgtuw_xor_128B_dsl v0 v1 vc_2 vc_3 v4 prec_i_o num_6)
		(hexagon_V6_vgtuw_xor_128B (hvx:interpret v0 env) (hvx:interpret v1 env) (hvx:interpret vc_2 env) 
		 (hvx:interpret vc_3 env) (hvx:interpret v4 env) prec_i_o 
		 num_6)
	]
	...
	[ (hexagon_V6_vgtb_xor_128B_dsl vc_0 v1 vc_2 v3 v4 prec_o prec_i)
		(hexagon_V6_vgtb_xor_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret vc_2 env) 
		 (hvx:interpret v3 env) (hvx:interpret v4 env) prec_o 
		 prec_i)
	]
	...
	[ (hexagon_V6_vgtb_128B_dsl vc_0 v1 v2 vc_3 prec_o prec_i)
		(hexagon_V6_vgtb_128B (hvx:interpret vc_0 env) (hvx:interpret v1 env) (hvx:interpret v2 env) 
		 (hvx:interpret vc_3 env) prec_o prec_i)
	]
