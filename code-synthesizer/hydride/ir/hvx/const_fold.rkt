...
(lit (hvx:interpret ( hexagon_V6_vavgub_128B_dsl vc_0-folded v1-folded v2-folded prec_i_o num_4 ) (vector)))
]
		[else ( hexagon_V6_vavgub_128B_dsl vc_0-folded v1-folded v2-folded prec_i_o num_4 )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vgtw_xor_128B_dsl vc_0-folded vc_1-folded v2-folded v3-folded v4-folded prec_i_o num_6 ) (vector)))
]
		[else ( hexagon_V6_vgtw_xor_128B_dsl vc_0-folded vc_1-folded v2-folded v3-folded v4-folded prec_i_o num_6 )]
		)
	]
	[ (hexagon_V6_vroundhub_128B_dsl v0 v1 num_2 num_3)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (hvx:interpret ( hexagon_V6_vroundhub_128B_dsl v0-folded v1-folded num_2 num_3 ) (vector)))
]
		[else ( hexagon_V6_vroundhub_128B_dsl v0-folded v1-folded num_2 num_3 )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_veqw_128B_dsl v0-folded vc_1-folded vc_2-folded v3-folded prec_o prec_i ) (vector)))
]
		[else ( hexagon_V6_veqw_128B_dsl v0-folded vc_1-folded vc_2-folded v3-folded prec_o prec_i )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vmpabuu_acc_128B_dsl v0-folded v1-folded v2-folded num_3 num_4 ) (vector)))
	...
	[ (hexagon_V6_vsubb_128B_dsl v0 v1 prec_i_o num_3)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (hvx:interpret ( hexagon_V6_vsubb_128B_dsl v0-folded v1-folded prec_i_o num_3 ) (vector)))
]
		[else ( hexagon_V6_vsubb_128B_dsl v0-folded v1-folded prec_i_o num_3 )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vmpabuuv_128B_dsl v0-folded v1-folded ) (vector)))
	...
	[ (hexagon_V6_vdmpyhsuisat_acc_128B_dsl v0 v1 v2 num_3)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded) (lit? v2-folded))
(lit (hvx:interpret ( hexagon_V6_vdmpyhsuisat_acc_128B_dsl v0-folded v1-folded v2-folded num_3 ) (vector)))
]
		[else ( hexagon_V6_vdmpyhsuisat_acc_128B_dsl v0-folded v1-folded v2-folded num_3 )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_veqb_and_128B_dsl vc_0-folded v1-folded vc_2-folded v3-folded v4-folded prec_o prec_i ) (vector)))
]
		[else ( hexagon_V6_veqb_and_128B_dsl vc_0-folded v1-folded vc_2-folded v3-folded v4-folded prec_o prec_i )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_pred_xor_128B_dsl v0-folded v1-folded num_2 prec_o ) (vector)))
	...
	[ (hexagon_V6_vrmpybusv_128B_dsl vc_0 v1 v2 num_3 num_4 num_5)
		...
		(cond
		[(and (lit? vc_0-folded) (lit? v1-folded) (lit? v2-folded))
(lit (hvx:interpret ( hexagon_V6_vrmpybusv_128B_dsl vc_0-folded v1-folded v2-folded num_3 num_4 num_5 ) (vector)))
]
		[else ( hexagon_V6_vrmpybusv_128B_dsl vc_0-folded v1-folded v2-folded num_3 num_4 num_5 )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vabsdiffub_128B_dsl v0-folded v1-folded prec_i_o ) (vector)))
	...
	[ (hexagon_V6_vmpyh_128B_dsl v0 v1 num_2 num_3)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (hvx:interpret ( hexagon_V6_vmpyh_128B_dsl v0-folded v1-folded num_2 num_3 ) (vector)))
]
		[else ( hexagon_V6_vmpyh_128B_dsl v0-folded v1-folded num_2 num_3 )]
		)
	]
	[ (hexagon_V6_vgtuh_or_128B_dsl vc_0 v1 vc_2 v3 v4 prec_i_o num_6)
		...
		(cond
		[(and (lit? vc_0-folded) (lit? v1-folded) (lit? vc_2-folded) (lit? v3-folded) (lit? v4-folded))
(lit (hvx:interpret ( hexagon_V6_vgtuh_or_128B_dsl vc_0-folded v1-folded vc_2-folded v3-folded v4-folded prec_i_o num_6 ) (vector)))
]
		[else ( hexagon_V6_vgtuh_or_128B_dsl vc_0-folded v1-folded vc_2-folded v3-folded v4-folded prec_i_o num_6 )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vmpybusv_acc_128B_dsl v0-folded v1-folded v2-folded lane_size num_4 num_5 prec_i_o num_7 num_8 num_9 ) (vector)))
	...
	[ (hexagon_V6_vsubh_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5 num_6)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (hvx:interpret ( hexagon_V6_vsubh_dv_128B_dsl v0-folded v1-folded lane_size num_3 prec_i_o num_5 num_6 ) (vector)))
]
		[else ( hexagon_V6_vsubh_dv_128B_dsl v0-folded v1-folded lane_size num_3 prec_i_o num_5 num_6 )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vasruhubsat_128B_dsl v0-folded v1-folded v2-folded ) (vector)))
	...
	[ (hexagon_V6_veqb_xor_128B_dsl vc_0 v1 v2 vc_3 v4 prec_o prec_i)
		...
		(cond
		[(and (lit? vc_0-folded) (lit? v1-folded) (lit? v2-folded) (lit? vc_3-folded) (lit? v4-folded))
(lit (hvx:interpret ( hexagon_V6_veqb_xor_128B_dsl vc_0-folded v1-folded v2-folded vc_3-folded v4-folded prec_o prec_i ) (vector)))
]
		[else ( hexagon_V6_veqb_xor_128B_dsl vc_0-folded v1-folded v2-folded vc_3-folded v4-folded prec_o prec_i )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vgtub_and_128B_dsl v0-folded vc_1-folded vc_2-folded v3-folded v4-folded prec_o prec_i ) (vector)))
]
		[else ( hexagon_V6_vgtub_and_128B_dsl v0-folded vc_1-folded vc_2-folded v3-folded v4-folded prec_o prec_i )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vrmpybus_acc_128B_dsl v0-folded v1-folded v2-folded num_3 num_4 ) (vector)))
	...
	[ (hexagon_V6_vmpahb_acc_128B_dsl v0 v1 v2)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded) (lit? v2-folded))
(lit (hvx:interpret ( hexagon_V6_vmpahb_acc_128B_dsl v0-folded v1-folded v2-folded ) (vector)))
]
		[else ( hexagon_V6_vmpahb_acc_128B_dsl v0-folded v1-folded v2-folded )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vgth_128B_dsl vc_0-folded v1-folded v2-folded vc_3-folded prec_o prec_i ) (vector)))
]
		[else ( hexagon_V6_vgth_128B_dsl vc_0-folded v1-folded v2-folded vc_3-folded prec_o prec_i )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vshufoeh_128B_dsl v0-folded v1-folded lane_size num_3 prec_i_o num_5 num_6 ) (vector)))
	...
	[ (hexagon_V6_vsathub_128B_dsl v0 v1 prec_o num_3 num_4 prec_i num_6)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (hvx:interpret ( hexagon_V6_vsathub_128B_dsl v0-folded v1-folded prec_o num_3 num_4 prec_i num_6 ) (vector)))
]
		[else ( hexagon_V6_vsathub_128B_dsl v0-folded v1-folded prec_o num_3 num_4 prec_i num_6 )]
		)
	]
	[ (hexagon_V6_vgth_or_128B_dsl vc_0 v1 vc_2 v3 v4 prec_i_o num_6)
		...
		(cond
		[(and (lit? vc_0-folded) (lit? v1-folded) (lit? vc_2-folded) (lit? v3-folded) (lit? v4-folded))
(lit (hvx:interpret ( hexagon_V6_vgth_or_128B_dsl vc_0-folded v1-folded vc_2-folded v3-folded v4-folded prec_i_o num_6 ) (vector)))
]
		[else ( hexagon_V6_vgth_or_128B_dsl vc_0-folded v1-folded vc_2-folded v3-folded v4-folded prec_i_o num_6 )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vandvnqv_128B_dsl v0-folded v1-folded ) (vector)))
	...
	[ (hexagon_V6_hi_128B_dsl v0 prec_i_o)
		...
		(cond
		[(and (lit? v0-folded))
(lit (hvx:interpret ( hexagon_V6_hi_128B_dsl v0-folded prec_i_o ) (vector)))
]
		[else ( hexagon_V6_hi_128B_dsl v0-folded prec_i_o )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vgth_and_128B_dsl v0-folded v1-folded vc_2-folded vc_3-folded v4-folded prec_i_o num_6 ) (vector)))
]
		[else ( hexagon_V6_vgth_and_128B_dsl v0-folded v1-folded vc_2-folded vc_3-folded v4-folded prec_i_o num_6 )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vlsrh_128B_dsl v0-folded v1-folded ) (vector)))
	...
	[ (hexagon_V6_vmpyub_128B_dsl v0 v1 num_2)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (hvx:interpret ( hexagon_V6_vmpyub_128B_dsl v0-folded v1-folded num_2 ) (vector)))
]
		[else ( hexagon_V6_vmpyub_128B_dsl v0-folded v1-folded num_2 )]
		)
	]
	[ (hexagon_V6_vminw_128B_dsl v0 v1 prec_i_o)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (hvx:interpret ( hexagon_V6_vminw_128B_dsl v0-folded v1-folded prec_i_o ) (vector)))
]
		[else ( hexagon_V6_vminw_128B_dsl v0-folded v1-folded prec_i_o )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vandqrt_acc_128B_dsl v0-folded v1-folded v2-folded ) (vector)))
	...
	[ (hexagon_V6_vroundwh_128B_dsl v0 v1 num_2 num_3)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (hvx:interpret ( hexagon_V6_vroundwh_128B_dsl v0-folded v1-folded num_2 num_3 ) (vector)))
]
		[else ( hexagon_V6_vroundwh_128B_dsl v0-folded v1-folded num_2 num_3 )]
		)
	]
	[ (hexagon_V6_vgtuw_xor_128B_dsl vc_0 vc_1 v2 v3 v4 prec_i_o num_6)
		...
		(cond
		[(and (lit? vc_0-folded) (lit? vc_1-folded) (lit? v2-folded) (lit? v3-folded) (lit? v4-folded))
(lit (hvx:interpret ( hexagon_V6_vgtuw_xor_128B_dsl vc_0-folded vc_1-folded v2-folded v3-folded v4-folded prec_i_o num_6 ) (vector)))
]
		[else ( hexagon_V6_vgtuw_xor_128B_dsl vc_0-folded vc_1-folded v2-folded v3-folded v4-folded prec_i_o num_6 )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vdmpybus_acc_128B_dsl v0-folded v1-folded v2-folded ) (vector)))
	...
	[ (hexagon_V6_vnavgw_128B_dsl vc_0 v1 v2 prec_i_o num_4)
		...
		(cond
		[(and (lit? vc_0-folded) (lit? v1-folded) (lit? v2-folded))
(lit (hvx:interpret ( hexagon_V6_vnavgw_128B_dsl vc_0-folded v1-folded v2-folded prec_i_o num_4 ) (vector)))
]
		[else ( hexagon_V6_vnavgw_128B_dsl vc_0-folded v1-folded v2-folded prec_i_o num_4 )]
		)
	]
...
(lit (hvx:interpret ( hexagon_V6_vasrwuhrndsat_128B_dsl v0-folded v1-folded v2-folded num_3 num_4 ) (vector)))
	...
	[ (hexagon_V6_vor_128B_dsl v0 v1 num_2 prec_i_o)
		...
		(cond
		[(and (lit? v0-folded) (lit? v1-folded))
(lit (hvx:interpret ( hexagon_V6_vor_128B_dsl v0-folded v1-folded num_2 prec_i_o ) (vector)))
]
		[else ( hexagon_V6_vor_128B_dsl v0-folded v1-folded num_2 prec_i_o )]
		)
	]
