...
(define cost_hexagon_V6_vdealh_128B_dsl 1)
...
(define cost_hexagon_V6_vaddbsat_128B_dsl 1)
(define cost_hexagon_V6_vasrwhrndsat_128B_dsl 1)
(define cost_hexagon_V6_vrmpyub_acc_128B_dsl 2)
(define cost_hexagon_V6_vaddhnq_dsl 1)
(define cost_hexagon_V6_vadduhsat_dv_128B_dsl 1)
(define cost_hexagon_V6_vsubhw_128B_dsl 1)
(define cost_hexagon_V6_vmpyhv_128B_dsl 2)
...
(define cost_hexagon_V6_vmpyubv_acc_128B_dsl 2)
(define cost_hexagon_V6_vlsrw_128B_dsl 1)
(define cost_hexagon_V6_vsubw_dv_128B_dsl 1)
(define cost_hexagon_V6_vdmpyhb_128B_dsl 2)
(define cost_hexagon_V6_vgtb_or_128B_dsl 1)
...
(define cost_hexagon_V6_vrmpyubv_128B_dsl 2)
...
(define cost_hexagon_V6_vsubwnq_128B_dsl 1)
...
(define cost_hexagon_V6_vmpyiwub_128B_dsl 2)
(define cost_hexagon_V6_vaslw_128B_dsl 1)
(define cost_hexagon_V6_vabsw_sat_128B_dsl 1)
(define cost_hexagon_V6_vmpyowh_rnd_128B_dsl 2)
...
(define cost_hexagon_V6_vgtuh_and_128B_dsl 1)
...
(define (hvx:cost prog)
  (destruct prog
            ...
            [ (hexagon_V6_vdealh_128B_dsl v0 size_i_o num_2 num_3 num_4 prec_i_o num_6 num_7 num_8)
             (+ cost_hexagon_V6_vdealh_128B_dsl (hvx:cost  v0)  
            ...
            [ (hexagon_V6_vandnqrt_128B_dsl vc_0 v1 v2 size_i_o num_4 num_5 num_6 num_7 prec_i_o num_9 num_10 num_11)
             (+ cost_hexagon_V6_vandnqrt_128B_dsl (hvx:cost  vc_0)  (hvx:cost  v1)  (hvx:cost  v2)  
            ...
            [ (hexagon_V6_vasrwhsat_128B_dsl vc_0 v1 v2 v3 size_i_o num_5 num_6 num_7 prec_o num_9 num_10 prec_i num_12 num_13 num_14)
             (+ cost_hexagon_V6_vasrwhsat_128B_dsl (hvx:cost  vc_0)  (hvx:cost  v1)  (hvx:cost  v2)  
                (hvx:cost  v3)  
            ...
            [ (hexagon_V6_vaddbsat_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
             (+ cost_hexagon_V6_vaddbsat_128B_dsl (hvx:cost  v0)  (hvx:cost  v1)  
            ...
            [ (hexagon_V6_vaddhnq_dsl vc_0 v1 v2 v3 size_i_o num_5 num_6 num_7 prec_i_o num_9 num_10 num_11 num_12)
             (+ cost_hexagon_V6_vaddhnq_dsl (hvx:cost  vc_0)  (hvx:cost  v1)  (hvx:cost  v2)  
                (hvx:cost  v3)  
            ...
            [ (hexagon_V6_vadduhsat_dv_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10)
             (+ cost_hexagon_V6_vadduhsat_dv_128B_dsl (hvx:cost  v0)  (hvx:cost  v1)  
            ...
            [ (hexagon_V6_vmpyhv_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i prec_o num_8 num_9 num_10 num_11 num_12)
             (+ cost_hexagon_V6_vmpyhv_128B_dsl (hvx:cost  v0)  (hvx:cost  v1)  
            ...
            [ (hexagon_V6_vlsrb_128B_dsl vc_0 v1 v2 size_i_o num_4 num_5 num_6 prec_i_o num_8 num_9 num_10)
             (+ cost_hexagon_V6_vlsrb_128B_dsl (hvx:cost  vc_0)  (hvx:cost  v1)  (hvx:cost  v2)  
            ...
            [ (hexagon_V6_vmpyubv_acc_128B_dsl v0 v1 v2 size_i_o num_4 num_5 num_6 num_7 prec_i_o num_9 num_10 num_11 num_12 num_13 num_14)
             (+ cost_hexagon_V6_vmpyubv_acc_128B_dsl (hvx:cost  v0)  (hvx:cost  v1)  (hvx:cost  v2)  
            ...
            [ (hexagon_V6_vsubw_dv_128B_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10)
             (+ cost_hexagon_V6_vsubw_dv_128B_dsl (hvx:cost  v0)  (hvx:cost  v1)  
            ...
            [ (hexagon_V6_vgtb_or_128B_dsl vc_0 vc_1 v2 v3 v4 size_i_o num_6 num_7 num_8 prec_o num_10 prec_i num_12 num_13)
             (+ cost_hexagon_V6_vgtb_or_128B_dsl (hvx:cost  vc_0)  (hvx:cost  vc_1)  (hvx:cost  v2)  
                (hvx:cost  v3)  (hvx:cost  v4)  
            ...
            [ (hexagon_V6_vrmpyubv_128B_dsl vc_0 v1 v2 size_i prec_o num_5 num_6 prec_i num_8 num_9 num_10 num_11 num_12 num_13)
             (+ cost_hexagon_V6_vrmpyubv_128B_dsl (hvx:cost  vc_0)  (hvx:cost  v1)  (hvx:cost  v2)  
            ...
            [ (hexagon_V6_veqb_and_128B_dsl vc_0 v1 v2 vc_3 v4 size_i_o num_6 num_7 num_8 prec_o prec_i num_11 num_12)
             (+ cost_hexagon_V6_veqb_and_128B_dsl (hvx:cost  vc_0)  (hvx:cost  v1)  (hvx:cost  v2)  
                (hvx:cost  vc_3)  (hvx:cost  v4)  
            ...
            [ (hexagon_V6_vsubwnq_128B_dsl v0 v1 v2 vc_3 size_i_o num_5 num_6 num_7 prec_i_o num_9 num_10 num_11 num_12)
             (+ cost_hexagon_V6_vsubwnq_128B_dsl (hvx:cost  v0)  (hvx:cost  v1)  (hvx:cost  v2)  
                (hvx:cost  vc_3)  
            ...
            [ (hexagon_V6_vandvqv_128B_dsl vc_0 vc_1 v2 v3 size_i_o num_5 num_6 num_7 prec_i_o num_9 num_10 num_11)
             (+ cost_hexagon_V6_vandvqv_128B_dsl (hvx:cost  vc_0)  (hvx:cost  vc_1)  (hvx:cost  v2)  
                (hvx:cost  v3)  
            ...
            [ (hexagon_V6_vmpyowh_rnd_128B_dsl vc_0 vc_1 vc_2 v3 v4 size_i_o num_6 num_7 num_8 num_9 prec_i_o num_11 num_12 num_13 num_14 num_15 num_16 num_17 num_18)
             (+ cost_hexagon_V6_vmpyowh_rnd_128B_dsl (hvx:cost  vc_0)  (hvx:cost  vc_1)  (hvx:cost  vc_2)  
                (hvx:cost  v3)  (hvx:cost  v4)  
            ...
            [ (hexagon_V6_vandqrt_128B_dsl v0 v1 vc_2 vc_3 size_i_o num_5 num_6 num_7 prec_i_o num_9 num_10 num_11 num_12)
             (+ cost_hexagon_V6_vandqrt_128B_dsl (hvx:cost  v0)  (hvx:cost  v1)  (hvx:cost  vc_2)  
                (hvx:cost  vc_3)  
            ...
            [ (hexagon_V6_vgtuh_and_128B_dsl vc_0 vc_1 v2 v3 v4 size_i_o num_6 num_7 num_8 prec_i_o num_10 num_11 num_12 num_13)
             (+ cost_hexagon_V6_vgtuh_and_128B_dsl (hvx:cost  vc_0)  (hvx:cost  vc_1)  (hvx:cost  v2)  
                (hvx:cost  v3)  (hvx:cost  v4)  
            ...
            [ (hexagon_V6_veqw_xor_128B_dsl v0 vc_1 vc_2 v3 v4 size_i_o num_6 num_7 num_8 prec_i_o num_10 num_11 num_12)
             (+ cost_hexagon_V6_veqw_xor_128B_dsl (hvx:cost  v0)  (hvx:cost  vc_1)  (hvx:cost  vc_2)  
                (hvx:cost  v3)  (hvx:cost  v4)  
            ...
            [ (hexagon_V6_vgtub_128B_dsl vc_0 vc_1 v2 v3 size_i_o num_5 num_6 num_7 prec_o num_9 prec_i num_11 num_12)
             (+ cost_hexagon_V6_vgtub_128B_dsl (hvx:cost  vc_0)  (hvx:cost  vc_1)  (hvx:cost  v2)  
                (hvx:cost  v3)  
            ...
            [ (hexagon_V6_vswap_128B_dsl v0 vc_1 v2 v3 size_i_o num_5 num_6 num_7 num_8 num_9 num_10 num_11 num_12 num_13 prec_i_o num_15 num_16 num_17)
             (+ cost_hexagon_V6_vswap_128B_dsl (hvx:cost  v0)  (hvx:cost  vc_1)  (hvx:cost  v2)  
                (hvx:cost  v3)  
            ...
            [ (hexagon_V6_vasrhbsat_128B_dsl vc_0 v1 v2 v3 size_i_o num_5 num_6 num_7 prec_o num_9 num_10 num_11 num_12 prec_i num_14 num_15 num_16 num_17)
             (+ cost_hexagon_V6_vasrhbsat_128B_dsl (hvx:cost  vc_0)  (hvx:cost  v1)  (hvx:cost  v2)  
                (hvx:cost  v3)  
