...
[(llvm-vect-add_dsl v0 v1 num_2 prec_i_o)
		...
		(remove-duplicates (append (list  'bvmul) (hvx:get-bv-ops v0) (hvx:get-bv-ops v1)))
	]
		[(llvm-vect-sdiv_dsl v0 v1 num_2 prec_i_o)
		(remove-duplicates (append (list  'bvsdiv) (hvx:get-bv-ops v0) (hvx:get-bv-ops v1)))
	]
		[(llvm-vect-udiv_dsl v0 v1 num_2 prec_i_o)
		(remove-duplicates (append (list  'bvudiv) (hvx:get-bv-ops v0) (hvx:get-bv-ops v1)))
	]
...
[(hexagon_V6_vmpyhvsrs_128B_dsl vc_0 vc_1 vc_2 vc_3 v4 v5 size_i_o num_7 num_8 num_9 prec_i_o num_11 num_12 num_13 num_14 num_15 num_16 num_17 num_18 num_19 num_20 num_21 num_22 num_23)
  ...
  (remove-duplicates (append (list  'bvmul 'bvashr 'bvsdiv 'sign-extend 'bvadd 'bvshl 'bvssat) (hvx:get-bv-ops v4) (hvx:get-bv-ops v5)))]
		[else (error "Unable to get ops  for hexagon_V6_vmpyhvsrs_128B")]
)
