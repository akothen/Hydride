...
(define (hvx:get-length prog env)
  (destruct prog
            ...
            [(hexagon_V6_vrmpyubv_128B_dsl v0 v1 num_2 num_3 num_4)
             (cond 
               [(and  (equal? num_2 0) (equal? num_3 0) (equal? num_4 0)) 1024]
               [(and  (equal? num_2 1) (equal? num_3 1) (equal? num_4 0)) 1024]
               [(and  (equal? num_2 1) (equal? num_3 1) (equal? num_4 1)) 1024]
               )
