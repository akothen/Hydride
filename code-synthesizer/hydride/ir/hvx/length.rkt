...
(define (hvx:get-length prog env)
 (destruct prog
	...
	[(hexagon_V6_vmpyiwb_acc_128B_dsl v0 v1 v2 num_3 num_4 prec_i_o num_6 num_7 num_8 num_9 num_10)
		(cond 
		[(and  (equal? num_3 256) (equal? num_4 8) (equal? prec_i_o 32) (equal? num_6 64) (equal? num_7 1) (equal? num_8 64) (equal? num_9 4) (equal? num_10 8)) 1024]
		[(and  (equal? num_3 256) (equal? num_4 8) (equal? prec_i_o 32) (equal? num_6 64) (equal? num_7 0) (equal? num_8 64) (equal? num_9 4) (equal? num_10 8)) 1024]
		[(and  (equal? num_3 512) (equal? num_4 16) (equal? prec_i_o 32) (equal? num_6 64) (equal? num_7 1) (equal? num_8 64) (equal? num_9 2) (equal? num_10 16)) 1024]
		[(and  (equal? num_3 512) (equal? num_4 8) (equal? prec_i_o 16) (equal? num_6 32) (equal? num_7 1) (equal? num_8 32) (equal? num_9 4) (equal? num_10 8)) 1024]
)
