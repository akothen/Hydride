...
(define (hvx:get-length prog env)
  (destruct prog
            ...
            [(hexagon_V6_vmpybusv_128B_dsl v0 v1 lane_size num_3 prec_i prec_o num_6)
             (cond 
               [(and  (equal? lane_size 32) (equal? num_3 16) (equal? prec_i 8) (equal? prec_o 16) (equal? num_6 128)) 2048]
               [(and  (equal? lane_size 64) (equal? num_3 32) (equal? prec_i 16) (equal? prec_o 32) (equal? num_6 64)) 2048]
               )
            ...
            [(hexagon_V6_vzb_128B_dsl v0 lane_size num_2 prec_i prec_o num_5)
             (cond 
               [(and  (equal? lane_size 32) (equal? num_2 16) (equal? prec_i 8) (equal? prec_o 16) (equal? num_5 128)) 2048]
               [(and  (equal? lane_size 64) (equal? num_2 32) (equal? prec_i 16) (equal? prec_o 32) (equal? num_5 64)) 2048]
               )
            ...
            [(hexagon_V6_pred_not_128B_dsl v0 num_1 prec_o)
             (cond 
               [(and  (equal? num_1 128) (equal? prec_o 1)) 128]
               [(and  (equal? num_1 1024) (equal? prec_o 16)) 1024]
               )
            ...
            [(hexagon_V6_vadduwsat_dv_128B_dsl v0 v1 lane_size num_3 prec_i_o num_5)
             (cond 
               [(and  (equal? lane_size 64) (equal? num_3 64) (equal? prec_i_o 32) (equal? num_5 32)) 2048]
               [(and  (equal? lane_size 32) (equal? num_3 32) (equal? prec_i_o 16) (equal? num_5 64)) 2048]
               [(and  (equal? lane_size 16) (equal? num_3 16) (equal? prec_i_o 8) (equal? num_5 128)) 2048]
               )
            ...
            [(hexagon_V6_vmpyihb_acc_128B_dsl v0 v1 v2 num_3 num_4 prec_i_o num_6 num_7 num_8)
             (cond 
               [(and  (equal? num_3 512) (equal? num_4 8) (equal? prec_i_o 16) (equal? num_6 32) (equal? num_7 4) (equal? num_8 8)) 1024]
               [(and  (equal? num_3 512) (equal? num_4 16) (equal? prec_i_o 32) (equal? num_6 64) (equal? num_7 2) (equal? num_8 16)) 1024]
               [(and  (equal? num_3 256) (equal? num_4 8) (equal? prec_i_o 32) (equal? num_6 64) (equal? num_7 4) (equal? num_8 8)) 1024]
               )
            ...
            [(hexagon_V6_vand_128B_dsl v0 v1 num_2 prec_i_o)
             (cond 
               [(and  (equal? num_2 1024) (equal? prec_i_o 16)) 1024]
               [(and  (equal? num_2 128) (equal? prec_i_o 1)) 128]
               )
            ...
            [(hexagon_V6_vsatuwuh_128B_dsl v0 v1 prec_o num_3 prec_i)
             (cond 
               [(and  (equal? prec_o 16) (equal? num_3 16) (equal? prec_i 32)) 1024]
               [(and  (equal? prec_o 8) (equal? num_3 8) (equal? prec_i 16)) 1024]
               )
            ...
            [(hexagon_V6_vunpackub_128B_dsl v0 prec_i prec_o)
             (cond 
               [(and  (equal? prec_i 8) (equal? prec_o 16)) 1024]
               [(and  (equal? prec_i 16) (equal? prec_o 32)) 1024]
               )
            ...
            [(hexagon_V6_vmpyiwb_128B_dsl v0 v1 num_2 num_3 prec_i_o num_5 num_6 num_7)
             (cond 
               [(and  (equal? num_2 256) (equal? num_3 8) (equal? prec_i_o 32) (equal? num_5 64) (equal? num_6 4) (equal? num_7 8)) 1024]
               [(and  (equal? num_2 512) (equal? num_3 16) (equal? prec_i_o 32) (equal? num_5 64) (equal? num_6 2) (equal? num_7 16)) 1024]
               [(and  (equal? num_2 512) (equal? num_3 8) (equal? prec_i_o 16) (equal? num_5 32) (equal? num_6 4) (equal? num_7 8)) 1024]
               )
