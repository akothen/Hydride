...
(define (vshll_high_n_u8  a n %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 %arg3 )
(define %2 (extract  127 64 a))
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
 ...
 concat
 (for/list ([e0.new (reverse (range %innerlaneoffset0 %innerlanesize0 %elemsize0))])
  (define %5.new0 (/  e0.new  %arg3))
  (define %lastidx2 (-  %arg2  1))
  (define %8 (+  %5.new0  %lastidx2))
  (define %9 (extract  %8 %5.new0 %2))
  (define %10.ab0 (bvsizeext  %9 192 %arg1))
  (define %11 (armshl  %10.ab0  n))
  (define %lastidx1 (-  %elemsize0  1))
  (define %highidx0 (+  %lastidx1  %arg0))
...
(define (vqshlq_s64  %arg2 a b %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg3 %arg4 %arg5 %arg6 )
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
...
(define (vmovl_high_u16  %arg1 a %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg0 %arg2 %arg3 %arg4 )
(define %2 (extract  127 64 a))
(define result
(apply
concat
...
(define (vrsra_n_s8  %arg1 %arg0 a b n %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg2 %arg3 %arg4 %arg5 %arg6 )
(define %0.ab0 (bvsubnw n %arg1 192 %arg2 ))
(define %1 (armshl  %arg0  %0.ab0))
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
 ...
 (for/list ([e0.new (reverse (range %innerlaneoffset0 %innerlanesize0 %elemsize0))])
  ...
  (define %9.ab0 (bvaddnw %8.ab0 %1 192 %arg5 ))
  (define %10 (bvashr  %9.ab0  n))
  (define %19 (extract  %6 e0.new a))
  (define %lastidx1 (-  %elemsize0  1))
  (define %highidx0 (+  %lastidx1  %arg4))
  (define %21 (extract  %highidx0 %arg4 %10))
  (define %22.ab0 (bvaddnw %19 %21 %elemsize0 %arg3 ))
  %22.ab0
 )
 )
)
...
(define (vrshl_s32  %arg5 %arg4 a b %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 %arg3 %arg6 %arg7 %arg8 )
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
...
(define (vshll_n_u16  a n %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 %arg3 )
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
...
(define (vqrshlq_s16  %arg5 %arg4 a b %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 %arg3 %arg6 %arg7 %arg8 )
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
...
(define (vshl_u16  %arg2 a b %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg3 %arg4 %arg5 %arg6 )
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
...
(define (vrsra_n_u8  %arg1 %arg0 a b n %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg2 %arg3 %arg4 %arg5 %arg6 )
(define %0.ab0 (bvsubnw n %arg1 192 %arg2 ))
(define %1 (armshl  %arg0  %0.ab0))
(define result
(apply
...
(define (vqshlb_n_s8  a n %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg0 %arg1 )
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
