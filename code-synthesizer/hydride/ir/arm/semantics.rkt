...
<<<<<<< HEAD
=======
(define (vabdl_high_s32  %arg0 a b %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg1 %arg2 %arg3 %arg4 %arg5 %arg6 %arg7 )
...
(define (vabd_s16  %arg0 a b %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg1 %arg2 %arg3 %arg4 %arg5 )
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
...
(define (vshrn_n_u64__n_29  %arg2 %arg1 a %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg0 %arg3 %arg4 %arg5 %arg6 )
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
 ...
 concat
 (for/list ([e0.new (reverse (range %innerlaneoffset0 %innerlanesize0 %elemsize0))])
  (define %3.new0 (*  e0.new  %arg6))
  (define %lastidx2 (-  %arg5  1))
  (define %8 (+  %3.new0  %lastidx2))
  (define %10 (extract  %8 %3.new0 a))
  (define %11.ab0 (bvsizeext  %10 192 %arg4))
  (define %12.ab0 (bvaddnw %11.ab0 %arg2 192 %arg3 ))
  (define %13 (bvashr  %12.ab0  %arg1))
  (define %lastidx1 (-  %elemsize0  1))
  (define %highidx0 (+  %lastidx1  %arg0))
  (define %19 (extract  %highidx0 %arg0 %13))
  %19
 )
 )
)
...
(define (vshrq_n_s32__n_6  %arg4 %arg3 %arg0 a %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg1 %arg2 %arg5 %arg6 )
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
 ...
 (for/list ([e0.new (reverse (range %innerlaneoffset0 %innerlanesize0 %elemsize0))])
  ...
  (define %8.ab0 (bvaddnw %7.ab0 %arg4 192 %arg5 ))
  (define %9 (bvashr  %8.ab0  %arg3))
  (define %lastidx1 (-  %elemsize0  1))
  (define %highidx0 (+  %lastidx1  %arg2))
  (define %20 (extract  %highidx0 %arg2 %9))
  (define %21.ab0 (bvaddnw %arg0 %20 %elemsize0 %arg1 ))
  %21.ab0
 )
 )
)
