...
(define (vpadal_s8  a b %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 %arg3 %arg4 %arg5 %arg6 %arg7 %arg8 %arg9 )
(define result2
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
...
(define (vdotq_s32  r a b %vectsize0 %outerlanesize0 %innerlaneoffset0 %innerlanesize0 %elemsize0 %arg0 %arg1 %arg2 %arg3 %arg4 %arg5 %arg6 %arg7 %arg8 %arg9 %arg10 %arg11 %arg12 %arg13 %arg14 %arg15 %arg16 %arg17 %arg18 %arg19 %arg20 %arg21 %arg22 )
(define result2
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize0 %outerlanesize0))])
 ...
 concat
 (for/list ([e0.new (reverse (range %innerlaneoffset0 %innerlanesize0 %elemsize0))])
  (define %4.new0 (*  e0.new  %arg22))
  (define %lastidx5 (-  %elemsize0  1))
  (define %11 (+  %4.new0  %lastidx5))
  (define %13 (extract  %11 %4.new0 a))
  (define %14.ab0 (bvsizeext  %13 192 %arg21))
  (define %27 (extract  %11 %4.new0 b))
  (define %28.ab0 (bvsizeext  %27 192 %arg20))
  (define %29.new0 (/  e0.new  %arg19))
  (define %30 (+  %29.new0  %arg18))
  (define %32 (*  %30  %arg17))
  (define %lastidx4 (-  %elemsize0  1))
  (define %39 (+  %32  %lastidx4))
  (define %41 (extract  %39 %32 a))
  (define %42.ab0 (bvsizeext  %41 192 %arg16))
  (define %55 (extract  %39 %32 b))
  (define %56.ab0 (bvsizeext  %55 192 %arg15))
  (define %58 (+  %29.new0  %arg14))
  (define %60 (*  %58  %arg13))
  (define %lastidx3 (-  %elemsize0  1))
  (define %67 (+  %60  %lastidx3))
  (define %69 (extract  %67 %60 a))
  (define %70.ab0 (bvsizeext  %69 192 %arg12))
  (define %83 (extract  %67 %60 b))
  (define %84.ab0 (bvsizeext  %83 192 %arg11))
  (define %86 (+  %29.new0  %arg10))
  (define %88 (*  %86  %arg9))
  (define %lastidx2 (-  %elemsize0  1))
  (define %95 (+  %88  %lastidx2))
  (define %97 (extract  %95 %88 a))
  (define %98.ab0 (bvsizeext  %97 192 %arg8))
  (define %111 (extract  %95 %88 b))
  (define %112.ab0 (bvsizeext  %111 192 %arg7))
  (define %lastidx0 (-  %arg0  1))
  (define %116 (+  %4.new0  %lastidx0))
  (define %117 (extract  %116 %4.new0 r))
  (define %118.ab0 (bvsizeext  %117 192 %arg6))
  (define %119 (bvmul  %14.ab0  %28.ab0))
  (define %120 (bvmul  %42.ab0  %56.ab0))
  (define %121.ab0 (bvaddnw %119 %120 192 %arg5 ))
  (define %122 (bvmul  %70.ab0  %84.ab0))
  (define %123.ab0 (bvaddnw %121.ab0 %122 192 %arg4 ))
  (define %124 (bvmul  %98.ab0  %112.ab0))
  (define %125.ab0 (bvaddnw %123.ab0 %124 192 %arg3 ))
  (define %131.ab0 (bvaddnw %118.ab0 %125.ab0 192 %arg2 ))
  (define %lastidx1 (-  %arg0  1))
  (define %highidx0 (+  %lastidx1  %arg1))
  (define %132 (extract  %highidx0 %arg1 %131.ab0))
  %132
 )
 )
)
