...
(define (arm:get-bv-ops prog)
 (destruct prog
  ...
  (remove-duplicates (append (list  'bvssat 'bvsub 'bvmul 'sign-extend) (arm:get-bv-ops v1) (arm:get-bv-ops v2) (arm:get-bv-ops v3)))]
  ...
  (remove-duplicates (append (list  'bvneg 'bvsub 'zero-extend 'bvadd 'bvusat 'sign-extend) (arm:get-bv-ops v2) (arm:get-bv-ops v3)))]
  ...
  (remove-duplicates (append (list  'bvneg 'bvssat 'bvsub 'bvadd 'sign-extend) (arm:get-bv-ops v2) (arm:get-bv-ops v3)))]
  ...
  (remove-duplicates (append (list  'bvssat 'bvadd 'bvmul 'sign-extend) (arm:get-bv-ops v1) (arm:get-bv-ops v2) (arm:get-bv-ops v3)))]
