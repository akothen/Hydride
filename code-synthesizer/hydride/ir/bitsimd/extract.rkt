...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimMax_v2048_e8__v2048_e8__v2048_e8_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimMax_v2048_e8__v2048_e8__v2048_e8_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 ) num-consumed-1)]
		[else (error "Unable to extract  for pimMax_v2048_e8__v2048_e8__v2048_e8")]
)
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimOr_v2048_e32__v2048_e32__v2048_e32_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimOr_v2048_e32__v2048_e32__v2048_e32_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 ) num-consumed-1)]
		[else (error "Unable to extract  for pimOr_v2048_e32__v2048_e32__v2048_e32")]
)
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimAnd_v32_e8__v32_e8__v32_e8_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimAnd_v32_e8__v32_e8__v32_e8_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 ) num-consumed-1)]
		[else (error "Unable to extract  for pimAnd_v32_e8__v32_e8__v32_e8")]
)
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v3 num-consumed-0 (- depth 1)))
 ...
 (values (pimGT_v512_e32__v512_e32__v512_e32_dsl vc_0 vc_1 expr-0 expr-1 size_i_o num_5 num_6 num_7 prec_i_o num_9 num_10 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v3 num-consumed-0 (- depth 1)))
 ...
 (values (pimGT_v512_e32__v512_e32__v512_e32_dsl vc_0 vc_1 expr-0 expr-1 size_i_o num_5 num_6 num_7 prec_i_o num_9 num_10 ) num-consumed-1)]
		[else (error "Unable to extract  for pimGT_v512_e32__v512_e32__v512_e32")]
)
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v2 num-consumed-0 (- depth 1)))
 ...
 (values (pimEQ_v512_e32__v512_e32__v512_e32_dsl expr-0 vc_1 expr-1 vc_3 size_i_o num_5 num_6 num_7 prec_i_o num_9 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v2 num-consumed-0 (- depth 1)))
 ...
 (values (pimEQ_v512_e32__v512_e32__v512_e32_dsl expr-0 vc_1 expr-1 vc_3 size_i_o num_5 num_6 num_7 prec_i_o num_9 ) num-consumed-1)]
		[else (error "Unable to extract  for pimEQ_v512_e32__v512_e32__v512_e32")]
)
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimMin_v8192_e8__v8192_e8__v8192_e8_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimMin_v8192_e8__v8192_e8__v8192_e8_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 ) num-consumed-1)]
		[else (error "Unable to extract  for pimMin_v8192_e8__v8192_e8__v8192_e8")]
)
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimDiv_v2048_e16__v2048_e16__v2048_e16_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 num_11 num_12 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimDiv_v2048_e16__v2048_e16__v2048_e16_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 num_11 num_12 ) num-consumed-1)]
		[else (error "Unable to extract  for pimDiv_v2048_e16__v2048_e16__v2048_e16")]
)
 ...
 (values (pimBroadCast_v512_e32__v32_e32_dsl expr-0 size_o num_2 num_3 num_4 prec_i_o num_6 num_7 ) num-consumed-0)]
 ...
 (values (pimBroadCast_v512_e32__v32_e32_dsl expr-0 size_o num_2 num_3 num_4 prec_i_o num_6 num_7 ) num-consumed-0)]
		[else (error "Unable to extract  for pimBroadCast_v512_e32__v32_e32")]
)
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimDiv_v2048_e32__v2048_e32__v2048_e32_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 num_11 num_12 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimDiv_v2048_e32__v2048_e32__v2048_e32_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 num_11 num_12 ) num-consumed-1)]
		[else (error "Unable to extract  for pimDiv_v2048_e32__v2048_e32__v2048_e32")]
)
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimDiv_v16384_e8__v16384_e8__v16384_e8_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 num_11 num_12 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimDiv_v16384_e8__v16384_e8__v16384_e8_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 num_11 num_12 ) num-consumed-1)]
		[else (error "Unable to extract  for pimDiv_v16384_e8__v16384_e8__v16384_e8")]
)
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimAdd_v16384_e8__v16384_e8__v16384_e8_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimAdd_v16384_e8__v16384_e8__v16384_e8_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 ) num-consumed-1)]
		[else (error "Unable to extract  for pimAdd_v16384_e8__v16384_e8__v16384_e8")]
)
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimSub_v256_e16__v256_e16__v256_e16_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimSub_v256_e16__v256_e16__v256_e16_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 ) num-consumed-1)]
		[else (error "Unable to extract  for pimSub_v256_e16__v256_e16__v256_e16")]
)
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimMul_v16_e8__v16_e8__v16_e8_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimMul_v16_e8__v16_e8__v16_e8_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 ) num-consumed-1)]
		[else (error "Unable to extract  for pimMul_v16_e8__v16_e8__v16_e8")]
)
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimXor_v8_e16__v8_e16__v8_e16_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 ) num-consumed-1)]
...
(define-values (expr-1 num-consumed-1) (bitsimd:extract-expr v1 num-consumed-0 (- depth 1)))
 ...
 (values (pimXor_v8_e16__v8_e16__v8_e16_dsl expr-0 expr-1 size_i_o num_3 num_4 num_5 prec_i_o num_7 ) num-consumed-1)]
		[else (error "Unable to extract  for pimXor_v8_e16__v8_e16__v8_e16")]
)
