...
(define (bitsimd:bind-expr prog env)
 (destruct prog
	...
	[ (pimMax_v16384_e8__v16384_e8__v16384_e8_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(pimMax_v16384_e8__v16384_e8__v16384_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
	...
	[ (pimXor_v16384_e8__v16384_e8__v16384_e8_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7)
		(pimXor_v16384_e8__v16384_e8__v16384_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
	...
	[ (pimDiv_v512_e16__v512_e16__v512_e16_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 num_11 num_12)
		(pimDiv_v512_e16__v512_e16__v512_e16_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env) 
	...
	[ (pimEQ_v512_e8__v512_e8__v512_e8_dsl vc_0 vc_1 v2 v3 size_i_o num_5 num_6 num_7 prec_i_o num_9)
		(pimEQ_v512_e8__v512_e8__v512_e8_dsl (bitsimd:bind-expr vc_0 env) (bitsimd:bind-expr vc_1 env) (bitsimd:bind-expr v2 env) 
	...
	[ (pimMin_v512_e8__v512_e8__v512_e8_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(pimMin_v512_e8__v512_e8__v512_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env))
	]
	[ (pimDiv_v512_e8__v512_e8__v512_e8_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 num_11 num_12)
		(pimDiv_v512_e8__v512_e8__v512_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env) 
		 (bitsimd:bind-expr num_9 env) (bitsimd:bind-expr num_10 env) (bitsimd:bind-expr num_11 env) 
		 (bitsimd:bind-expr num_12 env))
	...
	[ (pimOr_v1024_e32__v1024_e32__v1024_e32_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7)
		(pimOr_v1024_e32__v1024_e32__v1024_e32_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env))
	]
	[ (pimSub_v512_e8__v512_e8__v512_e8_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(pimSub_v512_e8__v512_e8__v512_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env))
	]
	[ (pimMul_v1024_e16__v1024_e16__v1024_e16_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10)
		(pimMul_v1024_e16__v1024_e16__v1024_e16_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env) 
	...
	[ (pimDiv_v1024_e32__v1024_e32__v1024_e32_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 num_11 num_12)
		(pimDiv_v1024_e32__v1024_e32__v1024_e32_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env) 
		 (bitsimd:bind-expr num_9 env) (bitsimd:bind-expr num_10 env) (bitsimd:bind-expr num_11 env) 
		 (bitsimd:bind-expr num_12 env))
	...
	[ (pimGT_v1024_e8__v1024_e8__v1024_e8_dsl vc_0 vc_1 v2 v3 size_i_o num_5 num_6 num_7 prec_i_o num_9 num_10)
		(pimGT_v1024_e8__v1024_e8__v1024_e8_dsl (bitsimd:bind-expr vc_0 env) (bitsimd:bind-expr vc_1 env) (bitsimd:bind-expr v2 env) 
		 (bitsimd:bind-expr v3 env) (bitsimd:bind-expr size_i_o env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr num_6 env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr prec_i_o env) 
		 (bitsimd:bind-expr num_9 env) (bitsimd:bind-expr num_10 env))
	]
	[ (pimAdd_v1024_e16__v1024_e16__v1024_e16_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(pimAdd_v1024_e16__v1024_e16__v1024_e16_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env))
	]
	[ (pimBroadCast_v512_e8__v8_e8_dsl v0 size_o num_2 num_3 num_4 prec_i_o num_6 num_7)
		(pimBroadCast_v512_e8__v8_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr size_o env) (bitsimd:bind-expr num_2 env) 
	...
	[ (pimAnd_v16384_e8__v16384_e8__v16384_e8_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7)
		(pimAnd_v16384_e8__v16384_e8__v16384_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env))
	]
	[v v]
