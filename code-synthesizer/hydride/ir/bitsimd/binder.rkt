...
(define (bitsimd:bind-expr prog env)
 (destruct prog
	...
	[ (pimBroadCast_v1024_e16__v16_e16_dsl v0 num_1 num_2 num_3 size_o prec_i_o num_6 num_7)
		(pimBroadCast_v1024_e16__v16_e16_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr num_1 env) (bitsimd:bind-expr num_2 env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr size_o env) (bitsimd:bind-expr prec_i_o env) 
