...
(define (bitsimd:bind-expr prog env)
 (destruct prog
	...
	[ (pimMax_v2048_e8__v2048_e8__v2048_e8_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(pimMax_v2048_e8__v2048_e8__v2048_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
	...
	[ (pimOr_v2048_e32__v2048_e32__v2048_e32_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7)
		(pimOr_v2048_e32__v2048_e32__v2048_e32_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
	...
	[ (pimAnd_v32_e8__v32_e8__v32_e8_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7)
		(pimAnd_v32_e8__v32_e8__v32_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env))
	]
	[ (pimGT_v512_e32__v512_e32__v512_e32_dsl vc_0 vc_1 v2 v3 size_i_o num_5 num_6 num_7 prec_i_o num_9 num_10)
		(pimGT_v512_e32__v512_e32__v512_e32_dsl (bitsimd:bind-expr vc_0 env) (bitsimd:bind-expr vc_1 env) (bitsimd:bind-expr v2 env) 
	...
	[ (pimEQ_v512_e32__v512_e32__v512_e32_dsl v0 vc_1 v2 vc_3 size_i_o num_5 num_6 num_7 prec_i_o num_9)
		(pimEQ_v512_e32__v512_e32__v512_e32_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr vc_1 env) (bitsimd:bind-expr v2 env) 
		 (bitsimd:bind-expr vc_3 env) (bitsimd:bind-expr size_i_o env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr num_6 env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr prec_i_o env) 
		 (bitsimd:bind-expr num_9 env))
	]
	[ (pimMin_v8192_e8__v8192_e8__v8192_e8_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(pimMin_v8192_e8__v8192_e8__v8192_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env))
	]
	[ (pimDiv_v2048_e16__v2048_e16__v2048_e16_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 num_11 num_12)
		(pimDiv_v2048_e16__v2048_e16__v2048_e16_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env) 
	...
	[ (pimBroadCast_v512_e32__v32_e32_dsl v0 size_o num_2 num_3 num_4 prec_i_o num_6 num_7)
		(pimBroadCast_v512_e32__v32_e32_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr size_o env) (bitsimd:bind-expr num_2 env) 
	...
	[ (pimDiv_v2048_e32__v2048_e32__v2048_e32_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 num_11 num_12)
		(pimDiv_v2048_e32__v2048_e32__v2048_e32_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env) 
		 (bitsimd:bind-expr num_9 env) (bitsimd:bind-expr num_10 env) (bitsimd:bind-expr num_11 env) 
		 (bitsimd:bind-expr num_12 env))
	...
	[ (pimDiv_v16384_e8__v16384_e8__v16384_e8_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10 num_11 num_12)
		(pimDiv_v16384_e8__v16384_e8__v16384_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env) 
		 (bitsimd:bind-expr num_9 env) (bitsimd:bind-expr num_10 env) (bitsimd:bind-expr num_11 env) 
		 (bitsimd:bind-expr num_12 env))
	...
	[ (pimAdd_v16384_e8__v16384_e8__v16384_e8_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(pimAdd_v16384_e8__v16384_e8__v16384_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env))
	]
	[ (pimSub_v256_e16__v256_e16__v256_e16_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8)
		(pimSub_v256_e16__v256_e16__v256_e16_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env))
	]
	[ (pimMul_v16_e8__v16_e8__v16_e8_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7 num_8 num_9 num_10)
		(pimMul_v16_e8__v16_e8__v16_e8_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env) (bitsimd:bind-expr num_8 env) 
		 (bitsimd:bind-expr num_9 env) (bitsimd:bind-expr num_10 env))
	]
	[ (pimXor_v8_e16__v8_e16__v8_e16_dsl v0 v1 size_i_o num_3 num_4 num_5 prec_i_o num_7)
		(pimXor_v8_e16__v8_e16__v8_e16_dsl (bitsimd:bind-expr v0 env) (bitsimd:bind-expr v1 env) (bitsimd:bind-expr size_i_o env) 
		 (bitsimd:bind-expr num_3 env) (bitsimd:bind-expr num_4 env) (bitsimd:bind-expr num_5 env) 
		 (bitsimd:bind-expr prec_i_o env) (bitsimd:bind-expr num_7 env))
	]
	[v v]
