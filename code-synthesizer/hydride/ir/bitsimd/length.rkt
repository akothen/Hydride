...
(define (bitsimd:get-length prog env)
 (destruct prog
	...
	[(pimScaledAdd_v256_e8__v256_e8__v256_e8_dsl v0 v1 v2 size_i_o num_4 num_5 num_6 prec_i_o num_8 num_9)
		...
		[(and  (equal? size_i_o 1024) (equal? num_4 1024) (equal? num_5 0) (equal? num_6 1024) (equal? prec_i_o 8) (equal? num_8 -1) (equal? num_9 0)) 1024]
		[(and  (equal? size_i_o 524288) (equal? num_4 524288) (equal? num_5 0) (equal? num_6 524288) (equal? prec_i_o 32) (equal? num_8 -1) (equal? num_9 0)) 524288]
		[(and  (equal? size_i_o 65536) (equal? num_4 65536) (equal? num_5 0) (equal? num_6 65536) (equal? prec_i_o 32) (equal? num_8 -1) (equal? num_9 0)) 65536]
		[(and  (equal? size_i_o 32768) (equal? num_4 32768) (equal? num_5 0) (equal? num_6 32768) (equal? prec_i_o 32) (equal? num_8 -1) (equal? num_9 0)) 32768]
		[(and  (equal? size_i_o 512) (equal? num_4 512) (equal? num_5 0) (equal? num_6 512) (equal? prec_i_o 32) (equal? num_8 -1) (equal? num_9 0)) 512]
		...
		[(and  (equal? size_i_o 8192) (equal? num_4 8192) (equal? num_5 0) (equal? num_6 8192) (equal? prec_i_o 8) (equal? num_8 -1) (equal? num_9 0)) 8192]
		[(and  (equal? size_i_o 256) (equal? num_4 256) (equal? num_5 0) (equal? num_6 256) (equal? prec_i_o 8) (equal? num_8 -1) (equal? num_9 0)) 256]
		...
		[(and  (equal? size_i_o 512) (equal? num_4 512) (equal? num_5 0) (equal? num_6 512) (equal? prec_i_o 16) (equal? num_8 -1) (equal? num_9 0)) 512]
		[(and  (equal? size_i_o 64) (equal? num_4 64) (equal? num_5 0) (equal? num_6 64) (equal? prec_i_o 8) (equal? num_8 -1) (equal? num_9 0)) 64]
		[(and  (equal? size_i_o 2048) (equal? num_4 2048) (equal? num_5 0) (equal? num_6 2048) (equal? prec_i_o 32) (equal? num_8 -1) (equal? num_9 0)) 2048]
		[(and  (equal? size_i_o 256) (equal? num_4 256) (equal? num_5 0) (equal? num_6 256) (equal? prec_i_o 16) (equal? num_8 -1) (equal? num_9 0)) 256]
		[(and  (equal? size_i_o 131072) (equal? num_4 131072) (equal? num_5 0) (equal? num_6 131072) (equal? prec_i_o 16) (equal? num_8 -1) (equal? num_9 0)) 131072]
		[(and  (equal? size_i_o 8192) (equal? num_4 8192) (equal? num_5 0) (equal? num_6 8192) (equal? prec_i_o 16) (equal? num_8 -1) (equal? num_9 0)) 8192]
		[(and  (equal? size_i_o 256) (equal? num_4 256) (equal? num_5 0) (equal? num_6 256) (equal? prec_i_o 32) (equal? num_8 -1) (equal? num_9 0)) 256]
		[(and  (equal? size_i_o 131072) (equal? num_4 131072) (equal? num_5 0) (equal? num_6 131072) (equal? prec_i_o 32) (equal? num_8 -1) (equal? num_9 0)) 131072]
		[(and  (equal? size_i_o 4098) (equal? num_4 4098) (equal? num_5 0) (equal? num_6 4096) (equal? prec_i_o 16) (equal? num_8 -1) (equal? num_9 0)) 4098]
		...
		[(and  (equal? size_i_o 65536) (equal? num_4 65536) (equal? num_5 0) (equal? num_6 65536) (equal? prec_i_o 8) (equal? num_8 -1) (equal? num_9 0)) 65536]
		[(and  (equal? size_i_o 2048) (equal? num_4 2048) (equal? num_5 0) (equal? num_6 2048) (equal? prec_i_o 16) (equal? num_8 -1) (equal? num_9 0)) 2048]
		[(and  (equal? size_i_o 128) (equal? num_4 128) (equal? num_5 0) (equal? num_6 128) (equal? prec_i_o 8) (equal? num_8 -1) (equal? num_9 0)) 128]
		[(and  (equal? size_i_o 16384) (equal? num_4 16384) (equal? num_5 0) (equal? num_6 16384) (equal? prec_i_o 32) (equal? num_8 -1) (equal? num_9 0)) 16384]
		[(and  (equal? size_i_o 4098) (equal? num_4 4098) (equal? num_5 0) (equal? num_6 4096) (equal? prec_i_o 32) (equal? num_8 -1) (equal? num_9 0)) 4098]
		[(and  (equal? size_i_o 512) (equal? num_4 512) (equal? num_5 0) (equal? num_6 512) (equal? prec_i_o 8) (equal? num_8 -1) (equal? num_9 0)) 512]
		[(and  (equal? size_i_o 128) (equal? num_4 128) (equal? num_5 0) (equal? num_6 128) (equal? prec_i_o 16) (equal? num_8 -1) (equal? num_9 0)) 128]
		[(and  (equal? size_i_o 16384) (equal? num_4 16384) (equal? num_5 0) (equal? num_6 16384) (equal? prec_i_o 16) (equal? num_8 -1) (equal? num_9 0)) 16384]
		[(and  (equal? size_i_o 65536) (equal? num_4 65536) (equal? num_5 0) (equal? num_6 65536) (equal? prec_i_o 16) (equal? num_8 -1) (equal? num_9 0)) 65536]
		[(and  (equal? size_i_o 262144) (equal? num_4 262144) (equal? num_5 0) (equal? num_6 262144) (equal? prec_i_o 32) (equal? num_8 -1) (equal? num_9 0)) 262144]
		[(and  (equal? size_i_o 32768) (equal? num_4 32768) (equal? num_5 0) (equal? num_6 32768) (equal? prec_i_o 8) (equal? num_8 -1) (equal? num_9 0)) 32768]
		...
		[(and  (equal? size_i_o 4098) (equal? num_4 4098) (equal? num_5 0) (equal? num_6 4096) (equal? prec_i_o 8) (equal? num_8 -1) (equal? num_9 0)) 4098]
