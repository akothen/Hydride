...
(define (bitsimd:get-bv-ops prog)
 (destruct prog
  ...
  (remove-duplicates (append (list  'bvsmax) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v1)))]
		[else (error "Unable to get ops  for pimMax_v2048_e8__v2048_e8__v2048_e8")]
)
  ...
  (remove-duplicates (append (list  'bvor) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v1)))]
		[else (error "Unable to get ops  for pimOr_v2048_e32__v2048_e32__v2048_e32")]
)
  ...
  (remove-duplicates (append (list  'bvand) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v1)))]
		[else (error "Unable to get ops  for pimAnd_v32_e8__v32_e8__v32_e8")]
)
  ...
  (remove-duplicates (append (list  'if 'bvsgt) (bitsimd:get-bv-ops v2) (bitsimd:get-bv-ops v3)))]
		[else (error "Unable to get ops  for pimGT_v512_e32__v512_e32__v512_e32")]
)
  ...
  (remove-duplicates (append (list  'if 'bveq) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v2)))]
  ...
  (remove-duplicates (append (list  'if 'bveq) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v2)))]
		[else (error "Unable to get ops  for pimEQ_v512_e32__v512_e32__v512_e32")]
)
  ...
  (remove-duplicates (append (list  'bvsmin) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v1)))]
		[else (error "Unable to get ops  for pimMin_v8192_e8__v8192_e8__v8192_e8")]
)
  ...
  (remove-duplicates (append (list  'sign-extend 'bvsdiv) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v1)))]
		[else (error "Unable to get ops  for pimDiv_v2048_e16__v2048_e16__v2048_e16")]
)
  ...
  (remove-duplicates (append (list  ) (bitsimd:get-bv-ops v0)))]
		[else (error "Unable to get ops  for pimBroadCast_v512_e32__v32_e32")]
)
  ...
  (remove-duplicates (append (list  'sign-extend 'bvsdiv) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v1)))]
		[else (error "Unable to get ops  for pimDiv_v2048_e32__v2048_e32__v2048_e32")]
)
  ...
  (remove-duplicates (append (list  'sign-extend 'bvsdiv) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v1)))]
		[else (error "Unable to get ops  for pimDiv_v16384_e8__v16384_e8__v16384_e8")]
)
  ...
  (remove-duplicates (append (list  'bvadd) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v1)))]
		[else (error "Unable to get ops  for pimAdd_v16384_e8__v16384_e8__v16384_e8")]
)
  ...
  (remove-duplicates (append (list  'bvsub) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v1)))]
		[else (error "Unable to get ops  for pimSub_v256_e16__v256_e16__v256_e16")]
)
  ...
  (remove-duplicates (append (list  'sign-extend 'bvmul) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v1)))]
		[else (error "Unable to get ops  for pimMul_v16_e8__v16_e8__v16_e8")]
)
  ...
  (remove-duplicates (append (list  'bvxor) (bitsimd:get-bv-ops v0) (bitsimd:get-bv-ops v1)))]
		[else (error "Unable to get ops  for pimXor_v8_e16__v8_e16__v8_e16")]
)
