...
(scalar_splat_dsl (reg (bv 0 8)) 16 32 ) 
	...
	[(equal? prog add_v64uint8_dsl)
		...
		(define variants (list (add_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 16 64 ) 
(add_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 16 32 ) 
(add_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 16 32 ) 
(add_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 32 32 ) 
(add_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 32 16 ) 
(add_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 32 16 ) 
(add_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 64 8 ) 
(add_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 64 8 ) 
))
	...
	[(equal? prog mul_elem_32_v32acc32_dsl)
		(define input-precs-dsl (list  16 8 16  ))
		(define input-size-dsl (list   (list 512 512 ) (list 512 512 ) (list 512 512 ) ) )
		(define variants (list (mul_elem_32_v32acc32_dsl (reg (bv 0 8)) (reg (bv 1 8)) 16 16 64 ) 
(mul_elem_32_v32acc32_dsl (reg (bv 0 8)) (reg (bv 1 8)) 32 8 32 ) 
(mul_elem_32_v32acc32_dsl (reg (bv 0 8)) (reg (bv 1 8)) 32 16 32 ) 
))
	...
	[(equal? prog mul_elem_32_conf_v32acc32_dsl)
		(define input-precs-dsl (list  16 8 16  ))
		(define input-size-dsl (list   (list 512 512 32 ) (list 512 512 32 ) (list 512 512 32 ) ) )
		(define variants (list (mul_elem_32_conf_v32acc32_dsl (reg (bv 0 8)) (reg (bv 1 8)) (reg (bv 2 8)) 16 16 64 ) 
(mul_elem_32_conf_v32acc32_dsl (reg (bv 0 8)) (reg (bv 1 8)) (reg (bv 2 8)) 32 8 32 ) 
(mul_elem_32_conf_v32acc32_dsl (reg (bv 0 8)) (reg (bv 1 8)) (reg (bv 2 8)) 32 16 32 ) 
))
	...
	[(equal? prog sub_v64uint8_dsl)
		(define input-precs-dsl (list  64 32 32 32 16 16 8 8  ))
		(define input-size-dsl (list   (list 1024 1024 ) (list 512 512 ) (list 512 512 ) (list 1024 1024 ) (list 512 512 ) (list 512 512 ) (list 512 512 ) (list 512 512 ) ) )
		(define variants (list (sub_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 16 64 ) 
(sub_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 16 32 ) 
(sub_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 16 32 ) 
(sub_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 32 32 ) 
(sub_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 32 16 ) 
(sub_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 32 16 ) 
(sub_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 64 8 ) 
(sub_v64uint8_dsl (reg (bv 0 8)) (reg (bv 1 8)) 64 8 ) 
))
