...
(define (aie:get-length prog env)
 (destruct prog
	...
	[(shuffle_v128int4_lo_dsl v0 v1 size_i_o prec_i_o)
		(cond 
		[(and  (equal? size_i_o 128) (equal? prec_i_o 4)) 512]
		[(and  (equal? size_i_o 128) (equal? prec_i_o 4)) 512]
		...
		[(and  (equal? size_i_o 64) (equal? prec_i_o 8)) 512]
		[else (error "Unable to infer length for shuffle_v128int4_lo: "  prog)]
)
	...
	[(shuffle_v128int4_hi_dsl v0 v1 size_i_o prec_i_o)
		...
		[(and  (equal? size_i_o 64) (equal? prec_i_o 8)) 512]
		[(and  (equal? size_i_o 64) (equal? prec_i_o 8)) 512]
		[else (error "Unable to infer length for shuffle_v128int4_hi: "  prog)]
)
	...
	[(mul_elem_16_2_v16acc64_dsl v0 v1 size_i_o prec_i prec_o)
		...
		[else (error "Unable to infer length for mul_elem_16_2_v16acc64: "  prog)]
)
	...
	[(mul_elem_16_2_conf_v16acc64_dsl v0 v1 v2 prec_i prec_o num_5)
		...
		[else (error "Unable to infer length for mul_elem_16_2_conf_v16acc64: "  prog)]
)
