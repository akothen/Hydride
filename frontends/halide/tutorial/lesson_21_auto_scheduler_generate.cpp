...
// g++ lesson_21_auto_scheduler_generate.cpp ../distrib/tools/GenGen.cpp -g -std=c++17 -fno-rtti -I ../distrib/include -L ../distrib/lib -lHalide -lpthread -ldl -o lesson_21_generate
// export LD_LIBRARY_PATH=../distrib/lib   # For linux
...
// ./lesson_21_generate -o . -g auto_schedule_gen -f auto_schedule_true -e static_library,h,schedule -p ../bin/libautoschedule_mullapudi2016.dylib -s Mullapudi2016 target=host auto_schedule=true machine_params=32,16777216,40
// g++ lesson_21_auto_scheduler_run.cpp -std=c++17 -I ../distrib/include -I ../distrib/tools/ auto_schedule_false.a auto_schedule_true.a -ldl -lpthread -o lesson_21_run
// ./lesson_21_run
