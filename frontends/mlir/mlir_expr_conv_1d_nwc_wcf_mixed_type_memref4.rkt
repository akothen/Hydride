...
(clear-vc!)
(define synth-res (synthesize-mlir-expr mlir-expr id-map 2 0 'z3 #t #f  "hydride_hash_3.rkt"  "synth_hash_3"  "x86"))
(dump-synth-res-with-typeinfo synth-res id-map)
; Translate synthesized hydride-expression into LLVM-IR
(compile-to-llvm synth-res id-map "hydride.node.conv_1d_nwc_wcf_mixed_type_memref.4" "conv_1d_nwc_wcf_mixed_type_memref")
(save-synth-map "/tmp/hydride_hash_4.rkt" "synth_hash_4" synth-log)