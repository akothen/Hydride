...
(define mlir-expr 
(vector:extract_strided_slice reg_0 (vector 0 0 0) (vector 4 1 3) (vector 1 1 1) )
)

(clear-vc!)
(define synth-res (synthesize-mlir-expr mlir-expr id-map 2 0 'z3 #t #f  "hydride_hash_6.rkt"  "synth_hash_6"  "X86"))
(dump-synth-res-with-typeinfo synth-res id-map)
; Translate synthesized hydride-expression into LLVM-IR
(compile-to-llvm synth-res id-map "hydride.node.benchmark.7" "benchmark")
(save-synth-map "/tmp/hydride_hash_7.rkt" "synth_hash_7" synth-log)