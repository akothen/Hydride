...
(hash-set! id-map reg_0 (bv 0 (bitvector 16)))
(hash-set! id-map reg_1 (bv 1 (bitvector 16)))
...
(compile-to-llvm synth-res id-map "hydride.node.single_loop_nothing_invariant.0" "single_loop_nothing_invariant")
