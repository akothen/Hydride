...
(define reg_1_tensor (bv 0 (bitvector 64)))
(define reg_1 (arith:create-tensor reg_1_tensor (vector 8) (vector 0) 'int8 1))
(define reg_0_tensor (bv 0 (bitvector 64)))
(define reg_0 (arith:create-tensor reg_0_tensor (vector 8) (vector 0) 'int8 0))
(define reg_2_tensor (bv 0 (bitvector 64)))
(define reg_2 (arith:create-tensor reg_2_tensor (vector 8) (vector 0) 'int8 2))
...
(compile-to-llvm synth-res id-map "hydride.node.conv2d.0" "conv2d")
