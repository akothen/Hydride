...
(define (_m_pmaxub  a b %vectsize %lanesize %elemsize %laneoffset )
(apply
concat
...
(verify (assert (equal? (_m_pmaxub a_1 b_1 %vectsize_1 %lanesize_1 %elemsize_1 %laneoffset_1 ) (_mm512_min_epu64 a_1 b_1 %vectsize_1 %lanesize_1 %elemsize_1 %laneoffset_1 ))))
...
(verify (assert (equal? (_m_pmaxub a_2 b_2 %vectsize_2 %lanesize_2 %elemsize_2 %laneoffset_2 ) (_mm512_min_epu64 a_2 b_2 %vectsize_2 %lanesize_2 %elemsize_2 %laneoffset_2 ))))
