...
(define (_mm_maskz_mov_epi16  k a %vectsize %lanesize %elemsize %laneoffset %arg0 )
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize %lanesize))])
 (apply
...
(verify (assert (equal? (_mm256_maskz_mov_epi8 k_1 a_1 %vectsize_1 %lanesize_1 %elemsize_1 %laneoffset_1 %arg0_1 ) (_mm_maskz_mov_epi16 k_1 a_1 %vectsize_1 %lanesize_1 %elemsize_1 %laneoffset_1 %arg0_1 ))))
...
(verify (assert (equal? (_mm256_maskz_mov_epi8 k_2 a_2 %vectsize_2 %lanesize_2 %elemsize_2 %laneoffset_2 %arg0_2 ) (_mm_maskz_mov_epi16 k_2 a_2 %vectsize_2 %lanesize_2 %elemsize_2 %laneoffset_2 %arg0_2 ))))
