...
(define (_mm_min_pi16  a b %vectsize %lanesize %elemsize %laneoffset )
(apply
concat
...
(verify (assert (equal? (_mm_min_pi16 a_1 b_1 %vectsize_1 %lanesize_1 %elemsize_1 %laneoffset_1 ) (_mm256_max_epi16 a_1 b_1 %vectsize_1 %lanesize_1 %elemsize_1 %laneoffset_1 ))))
...
(verify (assert (equal? (_mm_min_pi16 a_2 b_2 %vectsize_2 %lanesize_2 %elemsize_2 %laneoffset_2 ) (_mm256_max_epi16 a_2 b_2 %vectsize_2 %lanesize_2 %elemsize_2 %laneoffset_2 ))))
