...
(define (_mm512_mask_add_epi8  src k a b %vectsize %lanesize %elemsize %laneoffset )
(apply
concat
...
(define %lanesize_1 512)
(define %elemsize_1 8)
(define %laneoffset_1 0)

(verify (assert (equal? (_mm512_mask_add_epi8 src_1 k_1 a_1 b_1 %vectsize_1 %lanesize_1 %elemsize_1 %laneoffset_1 ) (_mm256_mask_add_epi8 src_1 k_1 a_1 b_1 %vectsize_1 %lanesize_1 %elemsize_1 %laneoffset_1 ))))
...
(verify (assert (equal? (_mm512_mask_add_epi8 src_2 k_2 a_2 b_2 %vectsize_2 %lanesize_2 %elemsize_2 %laneoffset_2 ) (_mm256_mask_add_epi8 src_2 k_2 a_2 b_2 %vectsize_2 %lanesize_2 %elemsize_2 %laneoffset_2 ))))
