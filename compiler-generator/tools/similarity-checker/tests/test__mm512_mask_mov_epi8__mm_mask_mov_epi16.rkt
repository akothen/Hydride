...
(define (_mm_mask_mov_epi16  src k a %vectsize %lanesize %elemsize %laneoffset )
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize %lanesize))])
 (apply
...
(verify (assert (equal? (_mm512_mask_mov_epi8 src_1 k_1 a_1 %vectsize_1 %lanesize_1 %elemsize_1 %laneoffset_1 ) (_mm_mask_mov_epi16 src_1 k_1 a_1 %vectsize_1 %lanesize_1 %elemsize_1 %laneoffset_1 ))))
...
(verify (assert (equal? (_mm512_mask_mov_epi8 src_2 k_2 a_2 %vectsize_2 %lanesize_2 %elemsize_2 %laneoffset_2 ) (_mm_mask_mov_epi16 src_2 k_2 a_2 %vectsize_2 %lanesize_2 %elemsize_2 %laneoffset_2 ))))
