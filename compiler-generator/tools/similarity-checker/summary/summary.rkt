(define (_mm_maskz_mov_epi16  k a %vectsize %lanesize %elemsize %laneoffset %arg0 %arg1 )
(apply
concat
...
(define (_mm256_mask_mov_epi8  src k a %vectsize %lanesize %elemsize %laneoffset %arg0 )
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize %lanesize))])
 (apply
...
(define (_mm256_mask_abs_epi8  src k a %vectsize %lanesize %elemsize %laneoffset %arg0 )
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize %lanesize))])
 (apply
...
(define (_mm256_maskz_abs_epi8  k a %vectsize %lanesize %elemsize %laneoffset %arg0 %arg1 )
(apply
concat
(for/list ([%outer.it (reverse (range 0 %vectsize %lanesize))])
 (apply
