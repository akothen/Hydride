#ifndef HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___max_pool___samples___batch_86_0___2___max_pool_batch_0086_sample_0002_h
#define HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___max_pool___samples___batch_86_0___2___max_pool_batch_0086_sample_0002_h
#include <stdint.h>
...
int max_pool_batch_0086_sample_0002(struct halide_buffer_t *_input_buffer, int32_t _stride_x, int32_t _stride_y, int32_t _filter_width, int32_t _filter_height, uint8_t _output_min, uint8_t _output_max, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int max_pool_batch_0086_sample_0002_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *max_pool_batch_0086_sample_0002_metadata();
