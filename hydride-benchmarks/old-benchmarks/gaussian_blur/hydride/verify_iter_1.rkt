...
(bv #x010201020402010201000000 96)
1
12
8
8
...
(define (wrapper arg0) 
(apply concat (for/list ([i (range 4)])
(apply concat (for/list ([j (range 4)])(synth_check arg0 i j)
)))))

(define-symbolic sym_arg0 (bitvector 288))
(define spec-res (gaussian_blur sym_arg0 6 6  8))
