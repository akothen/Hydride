...
__m256i a = _mm256_set_epi64x((__int64_t)0x605f5e5d5c5b5a59,(__int64_t)0x5857565554535251,(__int64_t)0x504f4e4d4c4b4a49,(__int64_t)0x4847464544434241);
  __m512i ret = _mm512_mask_broadcast_i64x4(src, k, a);
  hex_out(&ret, 64);
  return 0;
}