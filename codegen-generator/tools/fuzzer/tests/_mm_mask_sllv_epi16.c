...
__m128i count = _mm_set_epi16((short)0x302f,(short)0x2e2d,(short)0x2c2b,(short)0x2a29,(short)0x2827,(short)0x2625,(short)0x2423,(short)0x2221);
  __m128i ret = _mm_mask_sllv_epi16(src, k, a, count);
  hex_out(&ret, 16);
  return 0;
}