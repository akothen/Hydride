...
__m256i a = _mm256_set_epi32((int)0x61605f5e,(int)0x5d5c5b5a,(int)0x59585756,(int)0x55545352,(int)0x51504f4e,(int)0x4d4c4b4a,(int)0x49484746,(int)0x45444342);
  __m512i ret = _mm512_mask_broadcast_i32x8(src, k, a);
  hex_out(&ret, 64);
  return 0;
}