...
__m512i count = _mm512_set_epi32((int)0xc1c0bfbe,(int)0xbdbcbbba,(int)0xb9b8b7b6,(int)0xb5b4b3b2,(int)0xb1b0afae,(int)0xadacabaa,(int)0xa9a8a7a6,(int)0xa5a4a3a2,(int)0xa1a09f9e,(int)0x9d9c9b9a,(int)0x99989796,(int)0x95949392,(int)0x91908f8e,(int)0x8d8c8b8a,(int)0x89888786,(int)0x85848382);
  __m512i ret = _mm512_mask_srlv_epi32(src, k, a, count);
  hex_out(&ret, 64);
  return 0;
}