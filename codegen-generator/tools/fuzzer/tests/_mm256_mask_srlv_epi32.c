...
__m256i count = _mm256_set_epi32((int)0x605f5e5d,(int)0x5c5b5a59,(int)0x58575655,(int)0x54535251,(int)0x504f4e4d,(int)0x4c4b4a49,(int)0x48474645,(int)0x44434241);
  __m256i ret = _mm256_mask_srlv_epi32(src, k, a, count);
  hex_out(&ret, 32);
  return 0;
}