...
__m128i a = _mm_set_epi16((short)0x3130,(short)0x2f2e,(short)0x2d2c,(short)0x2b2a,(short)0x2928,(short)0x2726,(short)0x2524,(short)0x2322);
  __m256i ret = _mm256_mask_broadcastw_epi16(src, k, a);
  hex_out(&ret, 32);
  return 0;
}