...
__m128i a = _mm_set_epi16((short)0x302f,(short)0x2e2d,(short)0x2c2b,(short)0x2a29,(short)0x2827,(short)0x2625,(short)0x2423,(short)0x2221);
  __m256i ret = _mm256_mask_cvtepi16_epi32(src, k, a);
  hex_out(&ret, 32);
  return 0;
}