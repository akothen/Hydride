...
__m256i c = _mm256_set_epi64x((__int64_t)0x5f5e5d5c5b5a5958,(__int64_t)0x5756555453525150,(__int64_t)0x4f4e4d4c4b4a4948,(__int64_t)0x4746454443424140);
  __m256i ret = _mm256_madd52lo_epu64(a, b, c);
  hex_out(&ret, 32);
  return 0;
}