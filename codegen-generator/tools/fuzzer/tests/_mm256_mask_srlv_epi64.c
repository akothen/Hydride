...
__m256i count = _mm256_set_epi64x((__int64_t)0x605f5e5d5c5b5a59,(__int64_t)0x5857565554535251,(__int64_t)0x504f4e4d4c4b4a49,(__int64_t)0x4847464544434241);
  __m256i ret = _mm256_mask_srlv_epi64(src, k, a, count);
  hex_out(&ret, 32);
  return 0;
}