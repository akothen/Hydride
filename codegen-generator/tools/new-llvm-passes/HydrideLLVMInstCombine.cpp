...
static llvm::cl::opt<unsigned> InstCombineDepth(
    "instcombine-depth", llvm::cl::init(3), llvm::cl::Hidden,
...
\n\n";
  ...
  std::string OutputExprString = 
        "(define output-expr (inst-combine hydride-expr #t #f 'z3 input-sizes input-precs \"hvx\"" + "\"regular\"" +
  ...
  errs() << *SynthFunction << "\n";
  auto SynthFuncName = SynthFunction->getName();
