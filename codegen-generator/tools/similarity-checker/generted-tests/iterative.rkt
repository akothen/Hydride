...
;(define-symbolic a_1 (bitvector %vectsize_1))
;(define-symbolic b_1 (bitvector %vectsize_1))
...
;(println (_mm256_packs_epi32 a_1 b_1 %vectsize_1 %lanesize1_1 %lanesize2_1 %lanesize3_1 %elemsize_1
;                                           %elemsize1_1 %laneoffset_1 %laneoffset1_1 %arg0_1 %arg1_1 %arg2_1 %arg3_1 %arg4_1 %arg5_1)
;         )
;(println (_mm_packs_epi16 a_1 b_1 %vectsize_1 %lanesize1_1 %lanesize2_1 %lanesize3_1 %elemsize_1
;                        %elemsize1_1 %laneoffset_1 %laneoffset1_1 %arg0_1 %arg1_1 %arg2_1 %arg3_1 %arg4_1 %arg5_1)
;         )
...
(define (generate-params env)
  (vector (vector-ref env 0) (vector-ref env 1)  %vectsize_1 %lanesize1_1 %lanesize2_1 %lanesize3_1 %elemsize_1 %elemsize1_1 %laneoffset_1 %laneoffset1_1 %arg0_1 %arg1_1 %arg2_1 %arg3_1 %arg4_1 %arg5_1
          )
  )

(define bitwidth-list (list %vectsize_1 %vectsize_1))

(define solver 'z3)

(define (invoke_f1 k)

  (define (_mm_packs_epi16_synth  a b %vectsize %lanesize1 %lanesize2 %lanesize3 %elemsize %elemsize1 %laneoffset %laneoffset1 %arg0 %arg1 %arg2 %arg3 %arg4 %arg5 )
    (define dst
      (apply
        concat
        (for/list ([iterator.lane (reverse (range 0 %vectsize %lanesize1))])
                  (concat 
                    (apply
                      ...
                      (for/list ([iterator.0 (reverse (range %laneoffset %lanesize2 %elemsize))])
                                (define %low.cofactor0 (*  iterator.0  %arg1))
                                (define %lastidx1 (-  %arg0  1))
                                (define %new_index1 (poly-grammar1 iterator.lane iterator.0 %low.cofactor0 #:depth k ) )
                                (define %high.offset0 (+  %new_index1  %lastidx1))
                                (define %0 (extract  %high.offset0 %new_index1 a))
                                (define %1 (bvssat %0 %arg0 %elemsize ))
                                %1
                    ...
                    (apply
                      ...
                      (for/list ([iterator.1 (reverse (range %laneoffset1 %lanesize3 %elemsize1))])
                                ...
                                (define %low.offset0.new0 (-  %low.cofactor1  %arg3))
                                (define %lastidx3 (-  %arg2  1))
                                (define %new_index2 (poly-grammar2 iterator.lane iterator.1 %low.offset0.new0 #:depth k ) )
                                (define %high.offset2 (+  %new_index2  %lastidx3))
                                (define %8 (extract  %high.offset2 %new_index2 b))
                                (define %9 (bvssat %8 %arg2 %elemsize1 ))
                                %9
  ...
  (define (invoke_synth params)
    (_mm_packs_epi16_synth 
      (vector-ref params 0) 
      (vector-ref params 1) 
      (vector-ref params 2) 
      (vector-ref params 3) 
      ...
      (vector-ref params 8) 
      (vector-ref params 9) 
      (vector-ref params 10) 
      (vector-ref params 11) 

      (vector-ref params 12) 
      (vector-ref params 13) 
      (vector-ref params 14) 
      (vector-ref params 15) 
      )
    )
  invoke_synth
  )
