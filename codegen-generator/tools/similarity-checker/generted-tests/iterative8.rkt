                ...
                (concat 
                  (apply
                    ...
                    (for/list ([iterator.0 (reverse (range %laneoffset %lanesize2 %elemsize))])
                              ...
                              (define %new_index1  (interpret (?hole_op iterator.lane iterator.0 %low.cofactor0 #:depth 1)))
                  ...
                  (apply
                    ...
                    (for/list ([iterator.1 (reverse (range %laneoffset1 %lanesize3 %elemsize1))])
                              ...
                              (define %new_index2 (interpret (?hole_op iterator.lane iterator.1 %low.offset0.new0 #:depth 1)))
