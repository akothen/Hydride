                ...
                (concat 
                  (apply
                    ...
                    (for/list ([iterator.0 (reverse (range %laneoffset %lanesize2 %elemsize))])
                              ...
                              (define %new_index1 (?hole_op iterator.lane iterator.0 %low.cofactor0 1))
                  ...
                  (apply
                    ...
                    (for/list ([iterator.1 (reverse (range %laneoffset1 %lanesize3 %elemsize1))])
                              ...
                              (define %new_index2 (?hole_op iterator.lane iterator.1 %low.offset0.new0 1))
...
(define-synthax (?hole_op x y z depth)
    #:base ((choose + - *) (choose x y z 0 1 2) (choose x y z 0 1 2))
    #:else ((choose + - *) (?hole_op x y z (- depth 1)) (?hole_op x y z (- depth 1)))
)
