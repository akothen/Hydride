...
#include "Legalizer.h"
    ...
    virtual bool legalize(Instruction *I) {
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vunpackuh_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vdmpyhisat_acc_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vsh_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vmpyowh_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vpackwh_sat_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vshufoeb_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vmpyubv_acc_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vsubb_dv_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_veqb_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vmpyiwb_acc_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vmpybusv_acc_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vand_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vaddubsat_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vabsdiffuh_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vsubwq_128B_dsl")) { 
          ...
          if(isAMatch(CI, 3, 32)) { 
            ...
            std::vector<int> Permutation = {1,2,0,-1}; 
            std::vector<Value *> Args = getArgsAfterPermutation(CI, InstFunction, Permutation, CI); 
            if (Args.size() != 0) {
              auto *NewCallInst = CallInst::Create(InstFunction, Args, "", CI); 
              errs() << "NEW INSTUCTION:" << *NewCallInst << "\n"; 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vmpyub_acc_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vavguwrnd_128B_dsl")) { 
       ...
       && isAMatch(CI, 4, 32)) { 
            ...
            std::vector<int> Permutation = {-1,-1,0,1,-1}; 
            std::vector<Value *> Args = getArgsAfterPermutation(CI, InstFunction, Permutation, CI); 
            if (Args.size() != 0) {
              auto *NewCallInst = CallInst::Create(InstFunction, Args, "", CI); 
              errs() << "NEW INSTUCTION:" << *NewCallInst << "\n"; 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vsatuwuh_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vadduwsat_dv_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vaddhsat_dv_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vsububsat_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vadduhw_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vsubuhsat_dv_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vrmpyubv_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vmpyubv_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_veqh_or_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vaddb_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vmpyiewh_acc_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vpackhb_sat_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vgth_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vunpackob_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vrmpybusv_acc_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vmaxw_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_pred_not_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vgtuw_xor_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vdmpyhsuisat_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vmpyuh_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vavgh_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vadduhw_acc_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vsububh_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vavgbrnd_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vmpyhv_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vsubhsat_dv_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vaddw_dv_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vgtuw_and_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vminuh_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vsubwsat_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vunpackb_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vxor_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vrmpybv_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vabsb_sat_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_veqb_xor_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vmpyuh_acc_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vavguw_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vaddwsat_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_veqb_and_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vaddwnq_128B_dsl")) { 
          ...
          if(isAMatch(CI, 3, 32)) { 
            ...
            std::vector<int> Permutation = {1,0,2,-1}; 
            std::vector<Value *> Args = getArgsAfterPermutation(CI, InstFunction, Permutation, CI); 
            if (Args.size() != 0) {
              auto *NewCallInst = CallInst::Create(InstFunction, Args, "", CI); 
              errs() << "NEW INSTUCTION:" << *NewCallInst << "\n"; 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vsubh_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vdmpyhsusat_acc_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vgtub_or_128B_dsl")) { 
