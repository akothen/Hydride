...
#include "Legalizer.h"
    ...
    virtual bool legalize(Instruction *I) {
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_veqh_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vaddububb_sat_128B_dsl")) { 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vaddwq_128B_dsl")) { 
       ...
       && isAMatch(CI, 4, 32)) { 
            ...
            std::vector<int> Permutation = {1,2,0,-1,-1}; 
            std::vector<Value *> Args = getArgsAfterPermutation(CI, InstFunction, Permutation, CI); 
            if (Args.size() != 0) {
              auto *NewCallInst = CallInst::Create(InstFunction, Args, "", CI); 
              errs() << "NEW INSTUCTION:" << *NewCallInst << "\n"; 
      ...
      if(CI->getCalledFunction()->getName().contains("llvm.hydride.hexagon_V6_vaddbsat_dv_128B_dsl")) { 
