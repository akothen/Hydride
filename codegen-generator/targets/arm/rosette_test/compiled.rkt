...
result)
(define (vaddv_s16  a )
(define %23 (extract  15 0 a))
(define %28 (extract  31 16 a))
(define %29 (bvadd  %23  %28))
(define %34 (extract  47 32 a))
(define %35 (bvadd  %29  %34))
(define %40 (extract  63 48 a))
(define %41 (bvadd  %35  %40))
(define %0.reduce3 %41)
%0.reduce3)
(define (vaddv_s32  a )
(define %15 (extract  31 0 a))
(define %20 (extract  63 32 a))
(define %21 (bvadd  %15  %20))
(define %0.reduce1 %21)
%0.reduce1)
(define (vaddv_s8  a )
(define %39 (extract  7 0 a))
(define %44 (extract  15 8 a))
(define %45 (bvadd  %39  %44))
(define %50 (extract  23 16 a))
(define %51 (bvadd  %45  %50))
(define %56 (extract  31 24 a))
(define %57 (bvadd  %51  %56))
(define %62 (extract  39 32 a))
(define %63 (bvadd  %57  %62))
(define %68 (extract  47 40 a))
(define %69 (bvadd  %63  %68))
(define %74 (extract  55 48 a))
(define %75 (bvadd  %69  %74))
(define %80 (extract  63 56 a))
(define %81 (bvadd  %75  %80))
(define %0.reduce7 %81)
%0.reduce7)
(define (vaddv_u16  a )
(define %23 (extract  15 0 a))
...
%0.reduce7)
(define (vaddvq_s16  a )
(define %39 (extract  15 0 a))
(define %44 (extract  31 16 a))
(define %45 (bvadd  %39  %44))
(define %50 (extract  47 32 a))
(define %51 (bvadd  %45  %50))
(define %56 (extract  63 48 a))
(define %57 (bvadd  %51  %56))
(define %62 (extract  79 64 a))
(define %63 (bvadd  %57  %62))
(define %68 (extract  95 80 a))
(define %69 (bvadd  %63  %68))
(define %74 (extract  111 96 a))
(define %75 (bvadd  %69  %74))
(define %80 (extract  127 112 a))
(define %81 (bvadd  %75  %80))
(define %0.reduce7 %81)
%0.reduce7)qmake simi   

(define (vaddvq_s32  a )
(define %23 (extract  31 0 a))
(define %28 (extract  63 32 a))
(define %29 (bvadd  %23  %28))
(define %34 (extract  95 64 a))
(define %35 (bvadd  %29  %34))
(define %40 (extract  127 96 a))
(define %41 (bvadd  %35  %40))
(define %0.reduce3 %41)
%0.reduce3)
(define (vaddvq_s64  a )
(define %15 (extract  63 0 a))
(define %20 (extract  127 64 a))
(define %21 (bvadd  %15  %20))
(define %0.reduce1 %21)
%0.reduce1)
(define (vaddvq_s8  a )
(define %71 (extract  7 0 a))
(define %76 (extract  15 8 a))
(define %77 (bvadd  %71  %76))
(define %82 (extract  23 16 a))
(define %83 (bvadd  %77  %82))
(define %88 (extract  31 24 a))
(define %89 (bvadd  %83  %88))
(define %94 (extract  39 32 a))
(define %95 (bvadd  %89  %94))
(define %100 (extract  47 40 a))
(define %101 (bvadd  %95  %100))
(define %106 (extract  55 48 a))
(define %107 (bvadd  %101  %106))
(define %112 (extract  63 56 a))
(define %113 (bvadd  %107  %112))
(define %118 (extract  71 64 a))
(define %119 (bvadd  %113  %118))
(define %124 (extract  79 72 a))
(define %125 (bvadd  %119  %124))
(define %130 (extract  87 80 a))
(define %131 (bvadd  %125  %130))
(define %136 (extract  95 88 a))
(define %137 (bvadd  %131  %136))
(define %142 (extract  103 96 a))
(define %143 (bvadd  %137  %142))
(define %148 (extract  111 104 a))
(define %149 (bvadd  %143  %148))
(define %154 (extract  119 112 a))
(define %155 (bvadd  %149  %154))
(define %160 (extract  127 120 a))
(define %161 (bvadd  %155  %160))
(define %0.reduce15 %161)
%0.reduce15)
(define (vaddvq_u16  a )
(define %39 (extract  15 0 a))
(define %44 (extract  31 16 a))
...
(for/list ([e0 (reverse (range 0 2 1))])
 ...
 (define %42 (sign-extend  %41 (bitvector 192)))
 (define %43 (*  4  e0))
 (define %44 (+  %43  1))
 (define %46 (*  %44  8))
 (define %47 (*  4  e0))
 ...
 (define %50 (*  %48  8))
 (define %53 (+  %50  7))
 (define %55 (extract  %53 %46 b))
 (define %56 (sign-extend  %55 (bitvector 192)))
 (define %57 (*  4  e0))
 (define %58 (+  %57  2))
 (define %60 (*  %58  8))
 (define %61 (*  4  e0))
 ...
 (define %70 (sign-extend  %69 (bitvector 192)))
 (define %71 (*  4  e0))
 (define %72 (+  %71  2))
 (define %74 (*  %72  8))
 (define %75 (*  4  e0))
 ...
 (define %78 (*  %76  8))
 (define %81 (+  %78  7))
 (define %83 (extract  %81 %74 b))
 (define %84 (sign-extend  %83 (bitvector 192)))
 (define %85 (*  4  e0))
 (define %86 (+  %85  3))
 (define %88 (*  %86  8))
 (define %89 (*  4  e0))
 ...
 (define %98 (sign-extend  %97 (bitvector 192)))
 (define %99 (*  4  e0))
 (define %100 (+  %99  3))
 (define %102 (*  %100  8))
 (define %103 (*  4  e0))
 ...
 (define %106 (*  %104  8))
 (define %109 (+  %106  7))
 (define %111 (extract  %109 %102 b))
 (define %112 (sign-extend  %111 (bitvector 192)))
 (define %113 (*  e0  32))
 (define %114 (*  e0  32))
 (define %116 (+  %114  31))
 (define %117 (extract  %116 %113 r))
 (define %118 (sign-extend  %117 (bitvector 192)))
 (define %119 (bvmul  %14  %28))
 (define %120 (bvmul  %42  %56))
 (define %121 (bvadd  %119  %120))
 (define %122 (bvmul  %70  %84))
 (define %123 (bvadd  %121  %122))
 (define %124 (bvmul  %98  %112))
 (define %125 (bvadd  %123  %124))
 (define %131 (bvadd  %118  %125))
 (define %132 (extract  31 0 %131))
 %132
)
)
)
...
(for/list ([e0 (reverse (range 0 2 1))])
 ...
 (define %25 (+  %22  7))
 (define %27 (extract  %25 %18 b))
 (define %28 (zero-extend  %27 (bitvector 192)))
 (define %29 (*  4  e0))
 (define %30 (+  %29  1))
 (define %32 (*  %30  8))
 (define %33 (*  4  e0))
 ...
 (define %39 (+  %36  7))
 (define %41 (extract  %39 %32 a))
 (define %42 (zero-extend  %41 (bitvector 192)))
 (define %43 (*  4  e0))
 (define %44 (+  %43  1))
 (define %46 (*  %44  8))
 (define %47 (*  4  e0))
 ...
 (define %53 (+  %50  7))
 (define %55 (extract  %53 %46 b))
 (define %56 (zero-extend  %55 (bitvector 192)))
 (define %57 (*  4  e0))
 (define %58 (+  %57  2))
 (define %60 (*  %58  8))
 (define %61 (*  4  e0))
 ...
 (define %67 (+  %64  7))
 (define %69 (extract  %67 %60 a))
 (define %70 (zero-extend  %69 (bitvector 192)))
 (define %71 (*  4  e0))
 (define %72 (+  %71  2))
 (define %74 (*  %72  8))
 (define %75 (*  4  e0))
 ...
 (define %81 (+  %78  7))
 (define %83 (extract  %81 %74 b))
 (define %84 (zero-extend  %83 (bitvector 192)))
 (define %85 (*  4  e0))
 (define %86 (+  %85  3))
 (define %88 (*  %86  8))
 (define %89 (*  4  e0))
 ...
 (define %95 (+  %92  7))
 (define %97 (extract  %95 %88 a))
 (define %98 (zero-extend  %97 (bitvector 192)))
 (define %99 (*  4  e0))
 (define %100 (+  %99  3))
 (define %102 (*  %100  8))
 (define %103 (*  4  e0))
 ...
 (define %109 (+  %106  7))
 (define %111 (extract  %109 %102 b))
 (define %112 (zero-extend  %111 (bitvector 192)))
 (define %113 (*  e0  32))
 (define %114 (*  e0  32))
 (define %116 (+  %114  31))
 (define %117 (extract  %116 %113 r))
 (define %118 (zero-extend  %117 (bitvector 192)))
 (define %119 (bvmul  %14  %28))
 (define %120 (bvmul  %42  %56))
 (define %121 (bvadd  %119  %120))
 (define %122 (bvmul  %70  %84))
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %10 (sign-extend  %9 (bitvector 192)))
 (define %12 (bvsgt  (bv 0 192)  (bv 0 192)))
 (define %13 (bvshl  %10  (bv 0 192)))
 (define %14 (bvsub  (bv 0 192)  (bv 0 192)))
 (define %15 (bvashr  %10  %14))
 (define %16 (if (equal? %12 #t) %13 %15))
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %6 (extract  %5 %2 a))
 (define %7 (sign-extend  %6 (bitvector 192)))
 (define %9 (bvsgt  (bv 0 192)  (bv 0 192)))
 (define %10 (bvshl  %7  (bv 0 192)))
 (define %11 (bvsub  (bv 0 192)  (bv 0 192)))
 (define %12 (bvashr  %7  %11))
 (define %13 (if (equal? %9 #t) %10 %12))
 (define %24 (extract  31 0 %13))
 %24
)
)
)
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %13 (sign-extend  %12 (bitvector 192)))
 (define %14 (bvadd  %13  (bv 0 192)))
 (define %16 (bvsgt  %7  (bv 0 192)))
 (define %17 (bvshl  %14  %7))
 (define %18 (bvsub  (bv 0 192)  %7))
 (define %19 (bvashr  %14  %18))
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %8 (sign-extend  %7 (bitvector 192)))
 (define %9 (bvadd  %8  (bv 0 192)))
 (define %10 (bvashr  %9  %1))
 (define %15 (*  e0  16))
 (define %16 (*  e0  16))
 (define %18 (+  %16  15))
