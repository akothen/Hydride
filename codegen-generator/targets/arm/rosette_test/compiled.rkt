...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %7 (sign-extend  %6 (bitvector 128)))
 (define %8 (*  e0  8))
 (define %9 (+  e0  1))
 (define %10 (*  %9  8))
 (define %11 (-  %10  1))
 (define %12 (extract  %11 %8 b))
 (define %13 (sign-extend  %12 (bitvector 128)))
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %5 (-  %4  1))
 (define %6 (extract  %5 %2 a))
 (define %7 (zero-extend  %6 (bitvector 128)))
 (define %8 (*  e0  8))
 (define %9 (+  e0  1))
 (define %10 (*  %9  8))
 (define %11 (-  %10  1))
 (define %12 (extract  %11 %8 b))
 (define %13 (zero-extend  %12 (bitvector 128)))
 (define %14 (bvadd  %7  %13))
 (define %24 (extract  15 0 %14))
 %24
)
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %6 (*  %4  16))
 (define %7 (-  %6  1))
 (define %9 (extract  %7 %3 a))
 (define %10 (sign-extend  %9 (bitvector 128)))
 (define %11 (*  e0  8))
 (define %12 (+  e0  1))
 (define %13 (*  %12  8))
 (define %14 (-  %13  1))
 (define %15 (extract  %14 %11 b))
 (define %16 (sign-extend  %15 (bitvector 128)))
 (define %17 (bvadd  %10  %16))
 (define %27 (extract  15 0 %17))
 %27
)
)
)
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %7 (-  %6  1))
 (define %9 (extract  %7 %3 a))
 (define %10 (zero-extend  %9 (bitvector 128)))
 (define %11 (*  e0  8))
 (define %12 (+  e0  1))
 (define %13 (*  %12  8))
 (define %14 (-  %13  1))
 (define %15 (extract  %14 %11 b))
 (define %16 (zero-extend  %15 (bitvector 128)))
 (define %17 (bvadd  %10  %16))
 (define %27 (extract  15 0 %17))
 %27
)
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %4 (-  %3  1))
 (define %5 (extract  %4 %1 a))
 (define %6 (zero-extend  %5 (bitvector 128)))
 (define %7 (*  e0  8))
 (define %8 (+  e0  1))
 (define %9 (*  %8  8))
 (define %10 (-  %9  1))
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %7 (zero-extend  %5 (bitvector 128)))
 (define %8 (*  e0  8))
 (define %9 (+  e0  1))
 (define %10 (*  %9  8))
 (define %11 (-  %10  1))
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %4 (-  %3  1))
 (define %5 (extract  %4 %1 b))
 (define %7 (sign-extend  %5 (bitvector 128)))
 (define %8 (*  e0  8))
 (define %9 (+  e0  1))
 (define %10 (*  %9  8))
 (define %11 (-  %10  1))
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %18 (*  %16  16))
 (define %19 (-  %18  1))
 (define %21 (extract  %19 %15 b))
 (define %22 (bvadd  %13  %21))
 (define %23 (bvadd  %22  (bv 0 16)))
 (define %30 (extract  15 8 %23))
 %30
)
)
)
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %21 (extract  %19 %15 b))
 (define %22 (bvadd  %13  %21))
 (define %23 (bvadd  %22  (bv 0 32)))
 (define %30 (extract  31 16 %23))
 %30
)
)
)
...
(for/list ([e0 (reverse (range 0 2 1))])
 ...
 (define %21 (extract  %19 %15 b))
 (define %22 (bvadd  %13  %21))
 (define %23 (bvadd  %22  (bv 0 64)))
 (define %30 (extract  63 32 %23))
 %30
)
)
)
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %21 (extract  %19 %15 b))
 (define %22 (bvadd  %13  %21))
 (define %23 (bvadd  %22  (bv 32768 32)))
 (define %30 (extract  31 16 %23))
 %30
)
)
...
(for/list ([e0 (reverse (range 0 2 1))])
 ...
 (define %21 (extract  %19 %15 b))
 (define %22 (bvadd  %13  %21))
 (define %23 (bvadd  %22  (bv 2147483648 64)))
 (define %30 (extract  63 32 %23))
 %30
)
)
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %9 (-  %8  1))
 (define %10 (extract  %9 %6 b))
 (define %12 (zero-extend  %5 (bitvector 128)))
 (define %13 (zero-extend  %10 (bitvector 128)))
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %9 (sign-extend  %8 (bitvector 128)))
 (define %10 (*  e0  8))
 (define %11 (+  e0  1))
 (define %12 (*  %11  8))
 (define %13 (-  %12  1))
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %7 (-  %6  1))
 (define %8 (extract  %7 %4 b))
 (define %9 (zero-extend  %8 (bitvector 128)))
 (define %10 (*  e0  8))
 (define %11 (+  e0  1))
 (define %12 (*  %11  8))
 (define %13 (-  %12  1))
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %15 (bvmul  (bv 2 128)  %8))
 (define %16 (bvmul  %15  %14))
 (define %17 (bvadd  %16  (bv 0 128)))
 (define %22 (bvashr  %17  (bv 16 128)))
 (define %23 (bvssat %22 128 16 ))
 %23
)
)
)
...
(for/list ([e0 (reverse (range 0 2 1))])
 ...
 (define %16 (bvmul  %15  %14))
 (define %17 (bvadd  %16  (bv 0 128)))
 (define %22 (bvashr  %17  (bv 32 128)))
 (define %23 (bvssat %22 128 32 ))
 %23
)
)
)
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %15 (bvmul  (bv 2 128)  %8))
 (define %16 (bvmul  %15  %14))
 (define %17 (bvadd  %16  (bv 32768 128)))
 (define %22 (bvashr  %17  (bv 16 128)))
 (define %23 (bvssat %22 128 16 ))
 %23
)
...
(for/list ([e0 (reverse (range 0 2 1))])
 ...
 (define %15 (bvmul  (bv 2 128)  %8))
 (define %16 (bvmul  %15  %14))
 (define %17 (bvadd  %16  (bv 2147483648 128)))
 (define %22 (bvashr  %17  (bv 32 128)))
 (define %23 (bvssat %22 128 32 ))
 %23
)
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %15 (bvmul  (bv 2 128)  %8))
 (define %16 (bvmul  %15  %14))
 (define %18 (bvssat %16 128 32 ))
 (define %20 (*  e0  32))
 (define %21 (+  e0  1))
 (define %23 (*  %21  32))
 (define %24 (-  %23  1))
 (define %26 (extract  %24 %20 a))
 (define %27 (sign-extend  %26 (bitvector 128)))
 (define %28 (sign-extend  %18 (bitvector 128)))
 (define %29 (bvadd  %27  %28))
 (define %38 (bvssat %29 128 32 ))
 %38
)
)
)
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %12 (-  %11  1))
 (define %13 (extract  %12 %9 a))
 (define %14 (zero-extend  %13 (bitvector 128)))
 (define %15 (bvadd  %14  (bv 0 128)))
 (define %16 (bvshl  %15  %8))
 (define %22 (extract  7 0 %16))
 %22
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %7 (-  %6  1))
 (define %9 (extract  %7 %3 a))
 (define %14 (sign-extend  %9 (bitvector 128)))
 (define %15 (bvssat %14 128 8 ))
 %15
)
)
)
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %7 (-  %6  1))
 (define %9 (extract  %7 %3 a))
 (define %14 (zero-extend  %9 (bitvector 128)))
 (define %15 (bvusat %14 128 8 ))
 %15
)
)
)
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %5 (extract  %4 %1 a))
 (define %6 (sign-extend  %5 (bitvector 128)))
 (define %7 (integer->bitvector (abs (bitvector->integer %6)) (bitvector 128)))
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %19 (*  %18  8))
 (define %20 (-  %19  1))
 (define %21 (extract  %20 %15 b))
 (define %22 (sign-extend  %21 (bitvector 128)))
 (define %25 (bvadd  %12  %22))
 (define %26 (extract  15 0 %25))
 (define %35 (*  e0  16))
 (define %36 (+  e0  1))
 (define %38 (*  %36  16))
 (define %39 (-  %38  1))
 (define %41 (extract  %39 %35 a))
 (define %42 (bvadd  %41  %26))
 %42
)
)
)
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %20 (-  %19  1))
 (define %21 (extract  %20 %15 b))
 (define %22 (zero-extend  %21 (bitvector 128)))
 (define %25 (bvadd  %12  %22))
 (define %26 (extract  15 0 %25))
 (define %35 (*  e0  16))
 (define %36 (+  e0  1))
...
(for/list ([e0 (reverse (range 0 16 1))])
 ...
 (define %16 (*  %15  8))
 (define %17 (-  %16  1))
 (define %18 (extract  %17 %12 %0))
 (define %19 (sign-extend  %18 (bitvector 128)))
 (define %20 (bvsmin  %9  %19))
 (define %21 (bvsmax  %9  %19))
...
(for/list ([e0 (reverse (range 0 16 1))])
 ...
 (define %17 (-  %16  1))
 (define %18 (extract  %17 %12 %0))
 (define %19 (zero-extend  %18 (bitvector 128)))
 (define %20 (bvsmin  %9  %19))
 (define %21 (bvsmax  %9  %19))
 (define %27 (extract  7 0 %21))
 %27
...
result)
(define (vrev64_s8  vec )
(define result
(apply
concat
(for/list ([c0 (reverse (range 0 1 1))])
 (apply
 concat
 (for/list ([e0 (reverse (range 0 8 1))])
  (define %13 (extract  7 0 vec))
  %13
 )
 )
)
...
result)
(define (vrev64q_s8  vec )
(define result
(apply
concat
(for/list ([c0 (reverse (range 0 2 1))])
 (apply
 concat
 (for/list ([e0 (reverse (range 0 8 1))])
  (define %13 (extract  7 0 vec))
...
result)
(define (vrev32q_s8  vec )
(define result
(apply
concat
(for/list ([c0 (reverse (range 0 4 1))])
 (apply
 concat
 (for/list ([e0 (reverse (range 0 4 1))])
  (define %13 (extract  7 0 vec))
...
result)
(define (vrev16q_s8  vec )
(define result
(apply
concat
(for/list ([c0 (reverse (range 0 8 1))])
 (apply
 concat
 (for/list ([e0 (reverse (range 0 2 1))])
  (define %13 (extract  7 0 vec))
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %20 (sign-extend  %19 (bitvector 128)))
 (define %21 (bvshl  %20  (bv 16 128)))
 (define %22 (bvmul  %8  %14))
 (define %23 (bvmul  (bv 2 128)  %22))
 (define %24 (bvadd  %21  %23))
 (define %25 (bvadd  %24  (bv 32768 128)))
 (define %30 (bvashr  %25  (bv 16 128)))
 (define %31 (bvssat %30 128 16 ))
 %31
)
)
)
...
(for/list ([e0 (reverse (range 0 2 1))])
 ...
 (define %19 (extract  %18 %15 a))
 (define %20 (sign-extend  %19 (bitvector 128)))
 (define %21 (bvshl  %20  (bv 32 128)))
 (define %22 (bvmul  %8  %14))
 (define %23 (bvmul  (bv 2 128)  %22))
 (define %24 (bvadd  %21  %23))
 (define %25 (bvadd  %24  (bv 2147483648 128)))
 (define %30 (bvashr  %25  (bv 32 128)))
 (define %31 (bvssat %30 128 32 ))
 %31
)
)
)
