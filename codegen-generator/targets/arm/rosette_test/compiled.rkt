...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %6 (extract  %5 %2 a))
 (define %7 (sign-extend  %6 (bitvector 192)))
 (define %8 (bvadd  %7  (bv 0 192)))
 (define %9 (bvashr  %8  n))
 (define %14 (*  e0  8))
 (define %15 (*  e0  8))
 (define %17 (+  %15  7))
 (define %18 (extract  %17 %14 (bv 0 64)))
 (define %20 (extract  7 0 %9))
 (define %21 (bvadd  %18  %20))
 %21
)
)
)
...
(for/list ([e0 (reverse (range 0 16 1))])
 ...
 (define %15 (*  e0  8))
 (define %17 (+  %15  7))
 (define %18 (extract  %17 %14 (bv 0 128)))
 (define %20 (extract  7 0 %9))
 (define %21 (bvadd  %18  %20))
 %21
)
...
(define %0 (bvsub  n  (bv 1 192)))
(define %1 (armshl  (bv 1 192)  %0))
(define result
(apply
concat
(for/list ([e0 (reverse (range 0 8 1))])
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %5 (extract  %4 %1 b))
 (define %6 (sign-extend  %5 (bitvector 192)))
 (define %7 (bvadd  %6  (bv 0 192)))
 (define %8 (bvashr  %7  n))
 (define %13 (*  e0  8))
 (define %14 (*  e0  8))
 (define %16 (+  %14  7))
 (define %17 (extract  %16 %13 a))
 (define %19 (extract  7 0 %8))
 (define %20 (bvadd  %17  %19))
 %20
)
)
)
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %5 (*  e0  16))
 (define %8 (+  %5  15))
 (define %10 (extract  %8 %3 a))
 (define %11 (zero-extend  %10 (bitvector 192)))
 (define %12 (bvadd  %11  (bv 0 192)))
 (define %13 (bvlshr  %12  n))
 (define %19 (extract  7 0 %13))
 %19
)
)
...
(define %1 (bvsub  n  (bv 1 192)))
(define %2 (armshl  (bv 1 192)  %1))
(define result
(apply
concat
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %13 (sign-extend  %12 (bitvector 192)))
 (define %14 (bvadd  %13  %2))
 (define %15 (bvashr  %14  n))
