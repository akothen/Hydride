...
(define %1 (extract  63 0 high))
(define %3 (extract  63 0 low))
(define %4 (concat %1 %3))
(define %15 (extract  63 0 high))
(define %17 (extract  63 0 low))
(define %18 (concat %15 %17))
(define %5fakeReturn %18)
%5fakeReturn)
...
(define %3 (extract  127 64 a))
(define %15 (extract  127 64 a))
(define %4fakeReturn %15)
%4fakeReturn)
...
(define %13 (extract  63 0 a))
(define %3fakeReturn %13)
%3fakeReturn)
...
(for/list ([e0 (reverse (range 0 2 1))])
 ...
 (define %38 (*  e0  32))
 (define %41 (+  %38  31))
 (define %43 (extract  %41 %36 (bv 0 64)))
 (define %44 (bvadd  %43  %26))
 %44
)
)
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %38 (*  e0  32))
 (define %41 (+  %38  31))
 (define %43 (extract  %41 %36 (bv 0 128)))
 (define %44 (bvadd  %43  %26))
 %44
)
)
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %10 (bvshl  (bv 1 192)  %9))
 (define %11 (*  e0  16))
 (define %12 (*  e0  16))
 (define %14 (+  %12  15))
 (define %15 (extract  %14 %11 a))
 (define %16 (sign-extend  %15 (bitvector 192)))
 (define %17 (bvadd  %16  %10))
 (define %18 (bvshl  %17  %7))
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %14 (extract  %12 %7 a))
 (define %15 (sign-extend  %14 (bitvector 192)))
 (define %16 (bvadd  %15  %4))
 (define %17 (bvashr  %16  %1))
 (define %22 (bvssat %17 192 8 ))
 %22
)
)
)
...
(for/list ([e0 (reverse (range 0 4 1))])
 ...
 (define %11 (sign-extend  %10 (bitvector 192)))
 (define %12 (bvadd  %11  %3))
 (define %13 (bvashr  %12  %1))
 (define %18 (*  e0  16))
 (define %19 (*  e0  16))
 (define %21 (+  %19  15))
 (define %22 (extract  %21 %18 (bv 0 64)))
 (define %24 (extract  15 0 %13))
 (define %25 (bvadd  %22  %24))
 %25
)
)
)
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %19 (*  e0  16))
 (define %21 (+  %19  15))
 (define %22 (extract  %21 %18 (bv 0 128)))
 (define %24 (extract  15 0 %13))
 (define %25 (bvadd  %22  %24))
 %25
)
