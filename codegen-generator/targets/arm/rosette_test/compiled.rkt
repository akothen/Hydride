...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %14 (sign-extend  %13 (bitvector 192)))
 (define %15 (bvadd  %14  (bv 0 192)))
 (define %17 (bvsgt  %8  (bv 0 192)))
 (define %18 (bvshl  %15  %8))
 (define %19 (bvsub  (bv 0 192)  %8))
 (define %20 (bvashr  %15  %19))
 (define %21 (if (equal? %17 #t) %18 %20))
...
(for/list ([e0 (reverse (range 0 8 1))])
 ...
 (define %12 (bvsgt  %10  (bv 0 192)))
 (define %13 (bvshl  (bv 1 192)  %10))
 (define %14 (bvsub  (bv 0 192)  %10))
 (define %15 (bvlshr  (bv 1 192)  %14))
 (define %16 (if (equal? %12 #t) %13 %15))
 (define %17 (*  e0  8))
 (define %18 (*  e0  8))
 (define %20 (+  %18  7))
 (define %21 (extract  %20 %17 a))
 (define %22 (sign-extend  %21 (bitvector 192)))
 (define %23 (bvadd  %22  %16))
 (define %25 (bvsgt  %8  (bv 0 192)))
 (define %26 (bvshl  %23  %8))
 (define %27 (bvsub  (bv 0 192)  %8))
 (define %28 (bvashr  %23  %27))
 (define %29 (if (equal? %25 #t) %26 %28))
 (define %35 (extract  7 0 %29))
 %35
)
)
)
