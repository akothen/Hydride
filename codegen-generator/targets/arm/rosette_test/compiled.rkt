...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  ...
  (define %12 (bvsub  %4  %10))
  (define %13 (integer->bitvector (abs (bitvector->integer %12)) (bitvector 16)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 32))])
  ...
  (define %10 (extract  %3 e0.new c))
  (define %12 (bvsub  %4  %10))
  (define %13 (integer->bitvector (abs (bitvector->integer %12)) (bitvector 32)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 8))])
  ...
  (define %10 (extract  %3 e0.new c))
  (define %12 (bvsub  %4  %10))
  (define %13 (integer->bitvector (abs (bitvector->integer %12)) (bitvector 8)))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 32))])
  ...
  (define %17 (sign-extend  %16 (bitvector 32)))
  (define %18 (bvsub  %11  %17))
  (define %19 (integer->bitvector (abs (bitvector->integer %18)) (bitvector 32)))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 64))])
  ...
  (define %9 (+  %6.new0  31))
  (define %10 (extract  %9 %6.new0 %2))
  (define %11 (sign-extend  %10 (bitvector 64)))
  (define %16 (extract  %9 %6.new0 %5))
  (define %17 (sign-extend  %16 (bitvector 64)))
  (define %18 (bvsub  %11  %17))
  (define %19 (integer->bitvector (abs (bitvector->integer %18)) (bitvector 64)))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 16))])
  ...
  (define %9 (+  %6.new0  7))
  (define %10 (extract  %9 %6.new0 %2))
  (define %11 (sign-extend  %10 (bitvector 16)))
  (define %16 (extract  %9 %6.new0 %5))
  (define %17 (sign-extend  %16 (bitvector 16)))
  (define %18 (bvsub  %11  %17))
  (define %19 (integer->bitvector (abs (bitvector->integer %18)) (bitvector 16)))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 32))])
  ...
  (define %9 (+  %6.new0  15))
  (define %10 (extract  %9 %6.new0 %2))
  (define %11 (zero-extend  %10 (bitvector 32)))
  (define %16 (extract  %9 %6.new0 %5))
  (define %17 (zero-extend  %16 (bitvector 32)))
  (define %18 (bvsub  %11  %17))
  (define %19 (integer->bitvector (abs (bitvector->integer %18)) (bitvector 32)))
  (define %20 (extract  31 0 %19))
  (define %24 (+  e0.new  31))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 64))])
  ...
  (define %16 (extract  %9 %6.new0 %5))
  (define %17 (zero-extend  %16 (bitvector 64)))
  (define %18 (bvsub  %11  %17))
  (define %19 (integer->bitvector (abs (bitvector->integer %18)) (bitvector 64)))
  (define %20 (extract  63 0 %19))
  (define %24 (+  e0.new  63))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 16))])
  ...
  (define %9 (+  %6.new0  7))
  (define %10 (extract  %9 %6.new0 %2))
  (define %11 (zero-extend  %10 (bitvector 16)))
  (define %16 (extract  %9 %6.new0 %5))
  (define %17 (zero-extend  %16 (bitvector 16)))
  (define %18 (bvsub  %11  %17))
  (define %19 (integer->bitvector (abs (bitvector->integer %18)) (bitvector 16)))
  (define %20 (extract  15 0 %19))
  (define %24 (+  e0.new  15))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  (define %3 (+  e0.new  15))
  (define %4 (extract  %3 e0.new b))
  (define %5 (sign-extend  %4 (bitvector 32)))
  (define %10 (extract  %3 e0.new c))
  (define %11 (sign-extend  %10 (bitvector 32)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 32))])
  (define %3 (+  e0.new  31))
  (define %4 (extract  %3 e0.new b))
  (define %5 (sign-extend  %4 (bitvector 64)))
  (define %10 (extract  %3 e0.new c))
  (define %11 (sign-extend  %10 (bitvector 64)))
  (define %12 (bvsub  %5  %11))
  (define %13 (integer->bitvector (abs (bitvector->integer %12)) (bitvector 64)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 8))])
  (define %3 (+  e0.new  7))
  (define %4 (extract  %3 e0.new b))
  (define %5 (sign-extend  %4 (bitvector 16)))
  (define %10 (extract  %3 e0.new c))
  (define %11 (sign-extend  %10 (bitvector 16)))
  (define %12 (bvsub  %5  %11))
  (define %13 (integer->bitvector (abs (bitvector->integer %12)) (bitvector 16)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  (define %3 (+  e0.new  15))
  (define %4 (extract  %3 e0.new b))
  (define %5 (zero-extend  %4 (bitvector 32)))
  (define %10 (extract  %3 e0.new c))
  (define %11 (zero-extend  %10 (bitvector 32)))
  (define %12 (bvsub  %5  %11))
  (define %13 (integer->bitvector (abs (bitvector->integer %12)) (bitvector 32)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 32))])
  (define %3 (+  e0.new  31))
  (define %4 (extract  %3 e0.new b))
  (define %5 (zero-extend  %4 (bitvector 64)))
  (define %10 (extract  %3 e0.new c))
  (define %11 (zero-extend  %10 (bitvector 64)))
  (define %12 (bvsub  %5  %11))
  (define %13 (integer->bitvector (abs (bitvector->integer %12)) (bitvector 64)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 8))])
  (define %3 (+  e0.new  7))
  (define %4 (extract  %3 e0.new b))
  (define %5 (zero-extend  %4 (bitvector 16)))
  (define %10 (extract  %3 e0.new c))
  (define %11 (zero-extend  %10 (bitvector 16)))
  (define %12 (bvsub  %5  %11))
  (define %13 (integer->bitvector (abs (bitvector->integer %12)) (bitvector 16)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  ...
  (define %13 (bvsub  %5  %11))
  (define %14 (integer->bitvector (abs (bitvector->integer %13)) (bitvector 16)))
  (define %15 (extract  15 0 %14))
  (define %25 (bvadd  (bv 0 16)  %15))
  %25
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 32))])
  ...
  (define %11 (extract  %4 e0.new b))
  (define %13 (bvsub  %5  %11))
  (define %14 (integer->bitvector (abs (bitvector->integer %13)) (bitvector 32)))
  (define %15 (extract  31 0 %14))
  (define %25 (bvadd  (bv 0 32)  %15))
  %25
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 8))])
  ...
  (define %11 (extract  %4 e0.new b))
  (define %13 (bvsub  %5  %11))
  (define %14 (integer->bitvector (abs (bitvector->integer %13)) (bitvector 8)))
  (define %15 (extract  7 0 %14))
  (define %25 (bvadd  (bv 0 8)  %15))
  %25
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 32))])
  ...
  (define %18 (sign-extend  %17 (bitvector 32)))
  (define %19 (bvsub  %12  %18))
  (define %20 (integer->bitvector (abs (bitvector->integer %19)) (bitvector 32)))
  (define %21 (extract  31 0 %20))
  (define %31 (bvadd  (bv 0 32)  %21))
  %31
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 64))])
  ...
  (define %17 (extract  %10 %7.new0 %5))
  (define %18 (sign-extend  %17 (bitvector 64)))
  (define %19 (bvsub  %12  %18))
  (define %20 (integer->bitvector (abs (bitvector->integer %19)) (bitvector 64)))
  (define %21 (extract  63 0 %20))
  (define %31 (bvadd  (bv 0 64)  %21))
  %31
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 16))])
  ...
  (define %17 (extract  %10 %7.new0 %5))
  (define %18 (sign-extend  %17 (bitvector 16)))
  (define %19 (bvsub  %12  %18))
  (define %20 (integer->bitvector (abs (bitvector->integer %19)) (bitvector 16)))
  (define %21 (extract  15 0 %20))
  (define %31 (bvadd  (bv 0 16)  %21))
  %31
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 32))])
  ...
  (define %17 (extract  %10 %7.new0 %5))
  (define %18 (zero-extend  %17 (bitvector 32)))
  (define %19 (bvsub  %12  %18))
  (define %20 (integer->bitvector (abs (bitvector->integer %19)) (bitvector 32)))
  (define %21 (extract  31 0 %20))
  (define %31 (bvadd  (bv 0 32)  %21))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 64))])
  ...
  (define %17 (extract  %10 %7.new0 %5))
  (define %18 (zero-extend  %17 (bitvector 64)))
  (define %19 (bvsub  %12  %18))
  (define %20 (integer->bitvector (abs (bitvector->integer %19)) (bitvector 64)))
  (define %21 (extract  63 0 %20))
  (define %31 (bvadd  (bv 0 64)  %21))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 16))])
  ...
  (define %17 (extract  %10 %7.new0 %5))
  (define %18 (zero-extend  %17 (bitvector 16)))
  (define %19 (bvsub  %12  %18))
  (define %20 (integer->bitvector (abs (bitvector->integer %19)) (bitvector 16)))
  (define %21 (extract  15 0 %20))
  (define %31 (bvadd  (bv 0 16)  %21))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 32))])
  ...
  (define %12 (sign-extend  %11 (bitvector 64)))
  (define %13 (bvsub  %6  %12))
  (define %14 (integer->bitvector (abs (bitvector->integer %13)) (bitvector 64)))
  (define %15 (extract  63 0 %14))
  (define %25 (bvadd  (bv 0 64)  %15))
  %25
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  (define %4 (+  e0.new  15))
  (define %5 (extract  %4 e0.new a))
  (define %6 (zero-extend  %5 (bitvector 32)))
  (define %11 (extract  %4 e0.new b))
  (define %12 (zero-extend  %11 (bitvector 32)))
  (define %13 (bvsub  %6  %12))
  (define %14 (integer->bitvector (abs (bitvector->integer %13)) (bitvector 32)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 32))])
  (define %4 (+  e0.new  31))
  (define %5 (extract  %4 e0.new a))
  (define %6 (zero-extend  %5 (bitvector 64)))
  (define %11 (extract  %4 e0.new b))
  (define %12 (zero-extend  %11 (bitvector 64)))
  (define %13 (bvsub  %6  %12))
  (define %14 (integer->bitvector (abs (bitvector->integer %13)) (bitvector 64)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 8))])
  (define %4 (+  e0.new  7))
  (define %5 (extract  %4 e0.new a))
  (define %6 (zero-extend  %5 (bitvector 16)))
  (define %11 (extract  %4 e0.new b))
  (define %12 (zero-extend  %11 (bitvector 16)))
  (define %13 (bvsub  %6  %12))
  (define %14 (integer->bitvector (abs (bitvector->integer %13)) (bitvector 16)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  ...
  (define %6 (integer->bitvector (abs (bitvector->integer %4)) (bitvector 16)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 32))])
  (define %3 (+  e0.new  31))
  (define %4 (extract  %3 e0.new a))
  (define %6 (integer->bitvector (abs (bitvector->integer %4)) (bitvector 32)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 64))])
  (define %3 (+  e0.new  63))
  (define %4 (extract  %3 e0.new a))
  (define %6 (integer->bitvector (abs (bitvector->integer %4)) (bitvector 64)))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 8))])
  (define %3 (+  e0.new  7))
  (define %4 (extract  %3 e0.new a))
  (define %6 (integer->bitvector (abs (bitvector->integer %4)) (bitvector 8)))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 64))])
  ...
  (define %12 (+  %9.new0  31))
  (define %13 (extract  %12 %9.new0 %2))
  (define %14 (sign-extend  %13 (bitvector 64)))
  (define %15 (bvadd  %7  %14))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 16))])
  ...
  (define %12 (+  %9.new0  7))
  (define %13 (extract  %12 %9.new0 %2))
  (define %14 (sign-extend  %13 (bitvector 16)))
  (define %15 (bvadd  %7  %14))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 64))])
  ...
  (define %12 (+  %9.new0  31))
  (define %13 (extract  %12 %9.new0 %2))
  (define %14 (zero-extend  %13 (bitvector 64)))
  (define %15 (bvadd  %7  %14))
  (define %20 (extract  63 0 %15))
  %20
 )
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 16))])
  ...
  (define %12 (+  %9.new0  7))
  (define %13 (extract  %12 %9.new0 %2))
  (define %14 (zero-extend  %13 (bitvector 16)))
  (define %15 (bvadd  %7  %14))
  (define %20 (extract  15 0 %15))
  %20
 )
...
(define %8 (sign-extend  %7 (bitvector 32)))
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 128 128))])
...
(define %8 (sign-extend  %7 (bitvector 64)))
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 128 128))])
...
(define %2 (extract  127 64 b))
(define %7 (extract  15 0 c))
(define %8 (zero-extend  %7 (bitvector 32)))
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 128 128))])
...
(define %2 (extract  127 64 b))
(define %7 (extract  31 0 c))
(define %8 (zero-extend  %7 (bitvector 64)))
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 128 128))])
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 16))])
  ...
  (define %6 (+  %3.new0  7))
  (define %7 (extract  %6 %3.new0 %2))
  (define %8 (sign-extend  %7 (bitvector 16)))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 16))])
  ...
  (define %6 (+  %3.new0  7))
  (define %7 (extract  %6 %3.new0 %2))
  (define %8 (zero-extend  %7 (bitvector 16)))
  (define %13 (extract  15 0 %8))
  %13
 )
 )
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 32 32))])
  ...
  (define %5 (+  %1.new0  31))
  (define %6 (extract  %5 %1.new0 b))
  (define %7 (zero-extend  %6 (bitvector 64)))
  (define %8.new0 (/  e0.new  16))
  (define %9 (+  %8.new0  1))
  (define %10 (*  %9  32))
  (define %15 (+  %10  31))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 32 8))])
  ...
  (define %5 (+  %1.new0  7))
  (define %6 (extract  %5 %1.new0 b))
  (define %7 (zero-extend  %6 (bitvector 16)))
  (define %8.new0 (/  e0.new  4))
  (define %9 (+  %8.new0  1))
  (define %10 (*  %9  8))
  (define %15 (+  %10  7))
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 32))])
  ...
  (define %13 (extract  %12 %9.new0 %2))
  (define %14 (sign-extend  %13 (bitvector 32)))
  (define %15 (bvmul  (bv 2 32)  %14))
  (define %16 (bvmulnsw  %15  %8 32))
  (define %21 (+  e0.new  31))
  (define %22 (extract  %21 e0.new a))
  (define %25 (bvaddnsw  %22  %16 32))
  %25
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 64))])
  ...
  (define %13 (extract  %12 %9.new0 %2))
  (define %14 (sign-extend  %13 (bitvector 64)))
  (define %15 (bvmul  (bv 2 64)  %14))
  (define %16 (bvmulnsw  %15  %8 64))
  (define %21 (+  e0.new  63))
  (define %22 (extract  %21 e0.new a))
  (define %25 (bvaddnsw  %22  %16 64))
  %25
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 32))])
  ...
  (define %16 (extract  %9 %6.new0 %5))
  (define %17 (sign-extend  %16 (bitvector 32)))
  (define %18 (bvmul  (bv 2 32)  %11))
  (define %19 (bvmulnsw  %18  %17 32))
  (define %24 (+  e0.new  31))
  (define %25 (extract  %24 e0.new a))
  (define %28 (bvaddnsw  %25  %19 32))
  %28
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 128 128))])
 ...
 (for/list ([e0.new (reverse (range 0 128 64))])
  ...
  (define %16 (extract  %9 %6.new0 %5))
  (define %17 (sign-extend  %16 (bitvector 64)))
  (define %18 (bvmul  (bv 2 64)  %11))
  (define %19 (bvmulnsw  %18  %17 64))
  (define %24 (+  e0.new  63))
  (define %25 (extract  %24 e0.new a))
  (define %28 (bvaddnsw  %25  %19 64))
  %28
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  ...
  (define %10 (extract  %9 e0.new b))
  (define %11 (sign-extend  %10 (bitvector 32)))
  (define %12 (bvmul  (bv 2 32)  %11))
  (define %13 (bvmulnsw  %12  %5 32))
  (define %15.new0 (*  e0.new  2))
  (define %18 (+  %15.new0  31))
  (define %19 (extract  %18 %15.new0 a))
  (define %22 (bvaddnsw  %19  %13 32))
  %22
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 32))])
  ...
  (define %10 (extract  %9 e0.new b))
  (define %11 (sign-extend  %10 (bitvector 64)))
  (define %12 (bvmul  (bv 2 64)  %11))
  (define %13 (bvmulnsw  %12  %5 64))
  (define %15.new0 (*  e0.new  2))
  (define %18 (+  %15.new0  63))
  (define %19 (extract  %18 %15.new0 a))
  (define %22 (bvaddnsw  %19  %13 64))
  %22
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  ...
  (define %10 (extract  %3 e0.new c))
  (define %11 (sign-extend  %10 (bitvector 32)))
  (define %12 (bvmul  (bv 2 32)  %5))
  (define %13 (bvmulnsw  %12  %11 32))
  (define %15.new0 (*  e0.new  2))
  (define %18 (+  %15.new0  31))
  (define %19 (extract  %18 %15.new0 a))
  (define %22 (bvaddnsw  %19  %13 32))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 32))])
  ...
  (define %10 (extract  %3 e0.new c))
  (define %11 (sign-extend  %10 (bitvector 64)))
  (define %12 (bvmul  (bv 2 64)  %5))
  (define %13 (bvmulnsw  %12  %11 64))
  (define %15.new0 (*  e0.new  2))
  (define %18 (+  %15.new0  63))
  (define %19 (extract  %18 %15.new0 a))
  (define %22 (bvaddnsw  %19  %13 64))
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  ...
  (define %12 (sign-extend  %11 (bitvector 32)))
  (define %13 (bvmulnsw  %12  %6 32))
  (define %20 (bvashr  %13  (bv 15 32)))
  (define %21 (extract  15 0 %20))
  %21
 )
 )
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 32))])
  ...
  (define %11 (extract  %10 e0.new a))
  (define %12 (sign-extend  %11 (bitvector 64)))
  (define %13 (bvmulnsw  %12  %6 64))
  (define %20 (bvashr  %13  (bv 31 64)))
  (define %21 (extract  31 0 %20))
  %21
 )
 )
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  ...
  (define %14 (bvaddnsw  %13  (bv 16384 32) 32))
  (define %20 (bvashr  %14  (bv 15 32)))
  (define %21 (extract  15 0 %20))
  %21
 )
 )
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 32))])
  ...
  (define %12 (sign-extend  %11 (bitvector 64)))
  (define %13 (bvmul  %12  %6))
  (define %14 (bvaddnsw  %13  (bv 1073741824 64) 64))
  (define %20 (bvashr  %14  (bv 31 64)))
  (define %21 (extract  31 0 %20))
  %21
 )
 )
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  ...
  (define %16 (bvadd  %14  %9))
  (define %17 (bvshl  %16  %5))
  (define %22 (bvssat %17 16 16 ))
  %22
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 8))])
  ...
  (define %5 (extract  %4 e0.new b))
  (define %7 (bvneg  %5))
  (define %8 (bvsub  %7  (bv 1 8)))
  (define %9 (bvshl  (bv 1 8)  %8))
  (define %14 (extract  %4 e0.new a))
  (define %16 (bvadd  %14  %9))
  (define %17 (bvshl  %16  %5))
  (define %22 (bvssat %17 8 8 ))
  %22
 )
 )
)
...
(define %0 (bvsub  n  (bv 1 64)))
(define %1 (bvshl  (bv 1 64)  %0))
(define result
(apply
concat
(for/list ([%outer.it (reverse (range 0 128 128))])
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  ...
  (define %14 (bvshl  %11  %5))
  (define %19 (bvssat %14 16 16 ))
  %19
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  ...
  (define %8 (sign-extend  %7 (bitvector 64)))
  (define %9 (bvadd  %8  %1))
  (define %10 (bvashr  %9  n))
  (define %20 (extract  15 0 %10))
  (define %21 (bvadd  (bv 0 16)  %20))
  %21
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  (define %5 (+  e0.new  15))
  (define %6 (extract  %5 e0.new b))
  (define %7 (sign-extend  %6 (bitvector 64)))
  (define %8 (bvadd  %7  %1))
  (define %9 (bvashr  %8  n))
  (define %18 (extract  %5 e0.new a))
  (define %19 (extract  15 0 %9))
  (define %20 (bvadd  %18  %19))
  %20
 )
 )
)
...
(for/list ([%outer.it (reverse (range 0 64 64))])
 ...
 (for/list ([e0.new (reverse (range 0 64 16))])
  ...
  (define %18 (extract  15 0 %8))
  (define %19 (bvadd  %17  %18))
  %19
 )
 )
)
