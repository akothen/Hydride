HexInsts = {'Qd4.b=vshuffe(Qs4.h,Qt4.h)': 'for (i = 0; i < VELEM(8); i++) {QdV[i]=(i & 1) '
 ...
 'Vd.h=vlut4(Vu.uh,Rtt.h)': 'for (i = 0; i < VELEM(16); i++) {Vd.h[i]= '
                            'Rtt.h[((Vu.h[i]>>14)&0x3)] ;}',
 ...
 'Vd.h=vmin(Vu.h,Vv.h)': 'for (i = 0; i < VELEM(16); i++) {Vd.h[i] = (Vu.h[i] '
                         '< Vv.h[i]) ? Vu.h[i] :Vv.h[i] ;}',
 'Vd.h=vmpy(Vu.h,Rt.h):<<1:rnd:sat': 'for (i = 0; i < VELEM(32); i++) '
 ...
 'Vd.h=vmpy(Vu.h,Rt.h):<<1:sat': 'for (i = 0; i < VELEM(32); i++) '
                                 ...
                                 '*Rt.h[1])<<1)).h[1]);}',
 'Vd.h=vmpy(Vu.h,Vv.h):<<1:rnd:sat': 'for (i = 0; i < VELEM(16); i++) {Vd.h[i] '
                                     '= sat16(sat32(round(((Vu.h[i] '
                                     '*Vv.h[i])<<1))).h[1]) ;}',
 'Vd.h=vmpyi(Vu.h,Rt.b)': 'for (i = 0; i < VELEM(16); i++) {Vd.h[i] = (Vu.h[i] '
                          '* Rt.b[i % 4]) ;}',
 'Vd.h=vmpyi(Vu.h,Vv.h)': 'for (i = 0; i < VELEM(16); i++) {Vd.h[i] = (Vu.h[i] '
                          '* Vv.h[i]) ;}',
 ...
 'Vd.w=vdmpy(Vu.h,Rt.h):sat': 'for (i = 0; i < VELEM(32); i++) {accum = '
                              '(Vu.w[i].h[0] * Rt.h[0]);accum += (Vu.w[i].h[1] '
                              '* Rt.h[1]);Vd.w[i] = sat32(accum) ;}',
 'Vd.w=vdmpy(Vu.h,Rt.uh):sat': 'for (i = 0; i < VELEM(32); i++) {accum = '
                               '(Vu.w[i].h[0] * Rt.uh[0]);accum += '
                               '(Vu.w[i].h[1] * Rt.uh[1]);Vd.w[i] = '
                               'sat32(accum) ;}',
 'Vd.w=vdmpy(Vu.h,Vv.h):sat': 'for (i = 0; i < VELEM(32); i++) {accum = '
                              '(Vu.w[i].h[0] * Vv.w[i].h[0]);accum += '
                              '(Vu.w[i].h[1] * Vv.w[i].h[1]);Vd.w[i] = '
                              'sat32(accum) ;}',
 'Vd.w=vdmpy(Vuu.h,Rt.h):sat': 'for (i = 0; i < VELEM(32); i++) {accum = '
                               '(Vuu.v[0].w[i].h[1] * Rt.h[0]);accum += '
                               '(Vuu.v[1].w[i].h[0] * Rt.h[1]);Vd.w[i] = '
                               'sat32(accum) ;}',
 'Vd.w=vdmpy(Vuu.h,Rt.uh,#1):sat': 'for (i = 0; i < VELEM(32); i++) {accum = '
 ...
 'Vd.w=vmin(Vu.w,Vv.w)': 'for (i = 0; i < VELEM(32); i++) {Vd.w[i] = (Vu.w[i] '
                         '< Vv.w[i]) ? Vu.w[i] :Vv.w[i] ;}',
 'Vd.w=vmpye(Vu.w,Vv.uh)': 'for (i = 0; i < VELEM(32); i++) {Vd.w[i] = '
                           '(Vu.w[i] * Vv.w[i].uh[0]) >> 16 ;}',
 'Vd.w=vmpyi(Vu.w,Rt.b)': 'for (i = 0; i < VELEM(32); i++) {Vd.w[i] = (Vu.w[i] '
                          '* Rt.b[i % 4]) ;}',
 'Vd.w=vmpyi(Vu.w,Rt.h)': 'for (i = 0; i < VELEM(32); i++) {Vd.w[i] = (Vu.w[i] '
                          '* Rt.h[i % 2]) ;}',
 'Vd.w=vmpyi(Vu.w,Rt.ub)': 'for (i = 0; i < VELEM(32); i++) {Vd.w[i] = '
                           '(Vu.w[i] * Rt.ub[i % 4]) ;}',
 'Vd.w=vmpyie(Vu.w,Vv.uh)': 'for (i = 0; i < VELEM(32); i++) {Vd.w[i] = '
                            '(Vu.w[i] * Vv.w[i].uh[0]) ;}',
 'Vd.w=vmpyieo(Vu.h,Vv.h)': 'for (i = 0; i < VELEM(32); i++) {Vd.w[i] = '
                            '(Vu.w[i].h[0]*Vv.w[i].h[1]) << 16;}',
 'Vd.w=vmpyio(Vu.w,Vv.h)': 'for (i = 0; i < VELEM(32); i++) {Vd.w[i] = '
                           '(Vu.w[i] * Vv.w[i].h[1]) ;}',
 'Vd.w=vmpyo(Vu.w,Vv.h):<<1:rnd:sat': 'for (i = 0; i < VELEM(32); i++) '
                                      '{Vd.w[i] = sat32(((((Vu.w[i] * '
                                      'Vv.w[i].h[1])>> 14) + 1) >> 1)) ;}',
 'Vd.w=vmpyo(Vu.w,Vv.h):<<1:sat': 'for (i = 0; i < VELEM(32); i++) {Vd.w[i] = '
 ...
 'Vdd.b=vsub(Vuu.b,Vvv.b):sat': 'for (i = 0; i < VELEM(8); i++) {Vdd.v[0].b[i] '
                                ...
                                'sat8(Vuu.v[0].b[i]-Vvv.v[0].b[i]);Vdd.v[1].b[i] '
                                '= sat8(Vuu.v[1].b[i]-Vvv.v[1].b[i]) ;}',
 'Vdd.h=vadd(Vu.ub,Vv.ub)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].h[i] = '
                            'Vu.uh[i].ub[0] +Vv.uh[i].ub[0];Vdd.v[1].h[i] = '
 ...
 'Vdd.h=vdmpy(Vuu.ub,Rt.b)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].h[i] = '
                             '(Vuu.v[0].uh[i].ub[0] *Rt.b[(2*i) % '
                             '4]);Vdd.v[0].h[i] += (Vuu.v[0].uh[i].ub[1] '
 ...
 'Vdd.h=vlut16(Vu.b,Vv.h,Rt):nomatch': 'for (i = 0; i < VELEM(16); i++) '
                                       ...
                                       '%VBITS/32].h[oddhalf] ;}',
 'Vdd.h=vmpa(Vuu.ub,Rt.b)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].h[i] = '
                            '(Vuu.v[0].uh[i].ub[0] *Rt.b[0]) + '
                            '(Vuu.v[1].uh[i].ub[0] * Rt.b[1]);Vdd.v[1].h[i] = '
                            '(Vuu.v[0].uh[i].ub[1] *Rt.b[2]) + '
                            '(Vuu.v[1].uh[i].ub[1] * Rt.b[3]) ;}',
 'Vdd.h=vmpa(Vuu.ub,Rt.ub)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].uh[i] '
                             '= (Vuu.v[0].uh[i].ub[0] *Rt.ub[0]) + '
                             '(Vuu.v[1].uh[i].ub[0] * Rt.ub[1]);Vdd.v[1].uh[i] '
                             '= (Vuu.v[0].uh[i].ub[1] *Rt.ub[2]) + '
                             '(Vuu.v[1].uh[i].ub[1] * Rt.ub[3]) ;}',
 'Vdd.h=vmpa(Vuu.ub,Vvv.b)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].h[i] = '
 ...
 'Vdd.h=vmpa(Vuu.ub,Vvv.ub)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].h[i] '
 ...
 'Vdd.h=vmpy(Vu.b,Vv.b)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].h[i] = '
                          '(Vu.h[i].b[0] *Vv.h[i].b[0]);Vdd.v[1].h[i] = '
                          '(Vu.h[i].b[1] *Vv.h[i].b[1]) ;}',
 'Vdd.h=vmpy(Vu.ub,Rt.b)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].h[i] = '
                           '(Vu.uh[i].ub[0] *Rt.b[(2*i+0)%4]);Vdd.v[1].h[i] = '
                           '(Vu.uh[i].ub[1] *Rt.b[(2*i+1)%4]) ;}',
 'Vdd.h=vmpy(Vu.ub,Vv.b)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].h[i] = '
                           '(Vu.uh[i].ub[0] *Vv.h[i].b[0]);Vdd.v[1].h[i] = '
 ...
 'Vdd.h=vshuffoe(Vu.h,Vv.h)': 'for (i = 0; i < VELEM(32); i++) '
                              ...
                              ';}',
 'Vdd.h=vsub(Vu.ub,Vv.ub)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].h[i] = '
                            'Vu.uh[i].ub[0] -Vv.uh[i].ub[0];Vdd.v[1].h[i] = '
                            'Vu.uh[i].ub[1] -Vv.uh[i].ub[1] ;}',
 ...
 'Vdd.h=vtmpy(Vuu.b,Rt.b)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].h[i] = '
                            ...
                            '*Rt.b[(2*i+1)%4]);Vdd.v[1].h[i] += '
                            'Vuu.v[1].h[i].b[1] ;}',
 'Vdd.h=vtmpy(Vuu.ub,Rt.b)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].h[i] = '
                             '(Vuu.v[0].uh[i].ub[0] *Rt.b[(2*i '
                             ')%4]);Vdd.v[0].h[i] += (Vuu.v[0].uh[i].ub[1] '
                             '*Rt.b[(2*i+1)%4]);Vdd.v[0].h[i] += '
 ...
 'Vdd.uh=vmpy(Vu.ub,Rt.ub)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].uh[i] '
                             '= (Vu.uh[i].ub[0] '
                             '*Rt.ub[(2*i+0)%4]);Vdd.v[1].uh[i] = '
                             '(Vu.uh[i].ub[1] *Rt.ub[(2*i+1)%4]) ;}',
 'Vdd.uh=vmpy(Vu.ub,Vv.ub)': 'for (i = 0; i < VELEM(16); i++) {Vdd.v[0].uh[i] '
                             '= (Vu.uh[i].ub[0] '
 ...
 'Vdd.uw=vmpy(Vu.uh,Rt.uh)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].uw[i] '
                             '= (Vu.uw[i].uh[0] *Rt.uh[0]);Vdd.v[1].uw[i] = '
                             '(Vu.uw[i].uh[1] * Rt.uh[1]);}',
 'Vdd.uw=vmpy(Vu.uh,Vv.uh)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].uw[i] '
                             '= (Vu.uw[i].uh[0] '
 ...
 'Vdd.w=vadd(Vu.h,Vv.h)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].w[i] = '
                          'Vu.w[i].h[0] + Vv.w[i].h[0];Vdd.v[1].w[i] = '
                          'Vu.w[i].h[1] + Vv.w[i].h[1];}',
 'Vdd.w=vadd(Vu.uh,Vv.uh)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].w[i] = '
                            'Vu.uw[i].uh[0] +Vv.uw[i].uh[0];Vdd.v[1].w[i] = '
                            'Vu.uw[i].uh[1] +Vv.uw[i].uh[1] ;}',
 ...
 'Vdd.w=vdmpy(Vuu.h,Rt.b)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].w[i] = '
                            '(Vuu.v[0].w[i].h[0] '
 ...
 'Vdd.w=vmpa(Vuu.h,Rt.b)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].w[i] = '
                           '(Vuu.v[0].w[i].h[0] *Rt.b[0]) + '
                           '(Vuu.v[1].w[i].h[0] * Rt.b[1]);Vdd.v[1].w[i] = '
                           '(Vuu.v[0].w[i].h[1] *Rt.b[2]) + '
                           '(Vuu.v[1].w[i].h[1] * Rt.b[3]) ;}',
 'Vdd.w=vmpa(Vuu.uh,Rt.b)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].w[i] = '
                            '(Vuu.v[0].w[i].uh[0] *Rt.b[0]) + '
                            '(Vuu.v[1].w[i].uh[0] * Rt.b[1]);Vdd.v[1].w[i] = '
                            '(Vuu.v[0].w[i].uh[1] *Rt.b[2]) + '
                            '(Vuu.v[1].w[i].uh[1] * Rt.b[3]) ;}',
 'Vdd.w=vmpy(Vu.h,Rt.h)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].w[i] = '
                          '(Vu.w[i].h[0] * Rt.h[0]);Vdd.v[1].w[i] = '
                          '(Vu.w[i].h[1] * Rt.h[1]) ;}',
 'Vdd.w=vmpy(Vu.h,Vv.h)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].w[i] = '
                          '(Vu.w[i].h[0] *Vv.w[i].h[0]);Vdd.v[1].w[i] = '
                          '(Vu.w[i].h[1] *Vv.w[i].h[1]) ;}',
 'Vdd.w=vmpy(Vu.h,Vv.uh)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].w[i] = '
                           '(Vu.w[i].h[0] *Vv.uw[i].uh[0]);Vdd.v[1].w[i] = '
 ...
 'Vdd.w=vrmpy(Vuu.ub,Rt.b,#u1)': 'for (i = 0; i < VELEM(32); i++) '
                                 ...
                                 '0x3]);Vdd.v[0].w[i] += (Vuu.v[0 '
                                 '].uw[i].ub[3] *Rt.b[(3-#u) & '
                                 '0x3]);Vdd.v[1].w[i] = (Vuu.v[1 ].uw[i].ub[0] '
                                 '*Rt.b[(2-#u) & 0x3]);Vdd.v[1].w[i] += '
                                 '(Vuu.v[1 ].uw[i].ub[1] *Rt.b[(3-#u) & '
                                 '0x3]);Vdd.v[1].w[i] += (Vuu.v[#u '
                                 '?1:0].uw[i].ub[2] * Rt.b[(0-#u) & '
                                 '0x3]);Vdd.v[1].w[i] += (Vuu.v[0 '
                                 '].uw[i].ub[3] *Rt.b[(1-#u) & 0x3]) ;}',
 'Vdd.w=vsub(Vu.h,Vv.h)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].w[i] = '
                          'Vu.w[i].h[0] - Vv.w[i].h[0];Vdd.v[1].w[i] = '
                          'Vu.w[i].h[1] - Vv.w[i].h[1];}',
 'Vdd.w=vsub(Vu.uh,Vv.uh)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].w[i] = '
                            'Vu.uw[i].uh[0] -Vv.uw[i].uh[0];Vdd.v[1].w[i] = '
                            'Vu.uw[i].uh[1] -Vv.uw[i].uh[1] ;}',
 ...
 'Vdd.w=vtmpy(Vuu.h,Rt.b)': 'for (i = 0; i < VELEM(32); i++) {Vdd.v[0].w[i] = '
                            '(Vuu.v[0].w[i].h[0] '
                            '*Rt.b[(2*i+0)%4]);Vdd.v[0].w[i]+= '
                            '(Vuu.v[0].w[i].h[1] '
 ...
 'Vdd=vmpye(Vu.w,Vv.uh)': 'for (i = 0; i < VELEM(32); i++) {prod = (Vu.w[i] * '
                          'Vv.w[i].uh[0]);Vdd.v[1].w[i] = prod >> '
                          '16;Vdd.v[0].w[i] = prod << 16 ;}',
 ...
 'Vx.h+=vmpyi(Vu.h,Rt.b)': 'for (i = 0; i < VELEM(16); i++) {Vx.h[i] += '
                           '(Vu.h[i] * Rt.b[i % 4]) ;}',
 'Vx.h+=vmpyi(Vu.h,Vv.h)': 'for (i = 0; i < VELEM(16); i++) {Vx.h[i] += '
                           '(Vu.h[i] * Vv.h[i]) ;}',
 'Vx.h=vmpa(Vx.h,Vu.h,Rtt.h):sat': 'for (i = 0; i < VELEM(16); i++) {Vx.h[i]= '
                                   'sat16(( ( (Vx.h[i] * Vu.h[i])<<1)+ '
 ...
 'Vx.uw+=vrmpy(Vu.ub,Rt.ub)': 'for (i = 0; i < VELEM(32); i++) {Vx.uw[i] += '
                              ...
                              '(Vu.uw[i].ub[3] * Rt.ub[3]) ;}',
 'Vx.uw+=vrmpy(Vu.ub,Vv.ub)': 'for (i = 0; i < VELEM(32); i++) {Vx.uw[i] += '
                              '(Vu.uw[i].ub[0] *Vv.uw[i].ub[0]);Vx.uw[i] += '
                              '(Vu.uw[i].ub[1] *Vv.uw[i].ub[1]);Vx.uw[i] += '
                              '(Vu.uw[i].ub[2] *Vv.uw[i].ub[2]);Vx.uw[i] += '
                              '(Vu.uw[i].ub[3] *Vv.uw[i].ub[3]) ;}',
 'Vx.w+=vdmpy(Vu.h,Rt.b)': 'for (i = 0; i < VELEM(32); i++) {Vx.w[i] += '
                           '(Vu.w[i].h[0] * Rt.b[(2*i+0)%4]);Vx.w[i] += '
                           '(Vu.w[i].h[1] * Rt.b[(2*i+1)%4]);}',
 'Vx.w+=vdmpy(Vu.h,Rt.h):sat': 'for (i = 0; i < VELEM(32); i++) {accum = '
 ...
 'Vx.w+=vdmpy(Vu.h,Vv.h):sat': 'for (i = 0; i < VELEM(32); i++) {accum = '
                               '(Vu.w[i].h[0] * Vv.w[i].h[0]);accum += '
                               '(Vu.w[i].h[1] * Vv.w[i].h[1]);Vx.w[i] = '
                               'sat32(Vx.w[i]+accum) ;}',
 'Vx.w+=vdmpy(Vuu.h,Rt.h):sat': 'for (i = 0; i < VELEM(32); i++) {accum = '
                                'Vx.w[i];accum += (Vuu.v[0].w[i].h[1] * '
                                'Rt.h[0]);accum += (Vuu.v[1].w[i].h[0] * '
                                'Rt.h[1]);Vx.w[i] = sat32(accum) ;}',
 'Vx.w+=vdmpy(Vuu.h,Rt.uh,#1):sat': 'for (i = 0; i < VELEM(32); i++) '
                                    '{accum=Vx.w[i];accum += '
                                    '(Vuu.v[0].w[i].h[1] * Rt.uh[0]);accum += '
                                    '(Vuu.v[1].w[i].h[0] * Rt.uh[1]);Vx.w[i] = '
                                    'sat32(accum) ;}',
 'Vx.w+=vmpyi(Vu.w,Rt.b)': 'for (i = 0; i < VELEM(32); i++) {Vx.w[i] += '
                           '(Vu.w[i] * Rt.b[i % 4]) ;}',
 'Vx.w+=vmpyi(Vu.w,Rt.h)': 'for (i = 0; i < VELEM(32); i++) {Vx.w[i] += '
                           '(Vu.w[i] * Rt.h[i % 2]) ;}',
 'Vx.w+=vmpyi(Vu.w,Rt.ub)': 'for (i = 0; i < VELEM(32); i++) {Vx.w[i] += '
                            '(Vu.w[i] * Rt.ub[i % 4]) ;}',
 'Vx.w+=vmpyie(Vu.w,Vv.h)': 'for (i = 0; i < VELEM(32); i++) {Vx.w[i] = '
                            'Vx.w[i] + (Vu.w[i] * Vv.w[i].h[0]);}',
 'Vx.w+=vmpyie(Vu.w,Vv.uh)': 'for (i = 0; i < VELEM(32); i++) {Vx.w[i] = '
                             'Vx.w[i] + (Vu.w[i] *Vv.w[i].uh[0]) ;}',
 'Vx.w+=vmpyo(Vu.w,Vv.h):<<1:rnd:sat:shift': 'for (i = 0; i < VELEM(32); i++) '
                                             '{Vx.w[i] = sat32(((((Vx.w[i] + '
                                             '(Vu.w[i] *Vv.w[i].h[1])) >> 14) '
                                             '+ 1) >> 1)) ;}',
 'Vx.w+=vmpyo(Vu.w,Vv.h):<<1:sat:shift': 'for (i = 0; i < VELEM(32); i++) '
                                         '{Vx.w[i] = sat32(((((Vx.w[i] + '
                                         '(Vu.w[i] *Vv.w[i].h[1])) >> 14) + 1) '
                                         '>> 1)) ;}',
 'Vx.w+=vrmpy(Vu.b,Vv.b)': 'for (i = 0; i < VELEM(32); i++) {Vx.w[i] += '
 ...
 'Vx.w+=vrmpy(Vu.ub,Rt.b)': 'for (i = 0; i < VELEM(32); i++) {Vx.w[i] += '
                            ...
                            '(Vu.uw[i].ub[3] * Rt.b[3]) ;}',
 'Vx.w+=vrmpy(Vu.ub,Vv.b)': 'for (i = 0; i < VELEM(32); i++) {Vx.w[i] += '
                            '(Vu.uw[i].ub[0] * Vv.w[i].b[0]);Vx.w[i] += '
                            '(Vu.uw[i].ub[1] * Vv.w[i].b[1]);Vx.w[i] += '
                            '(Vu.uw[i].ub[2] * Vv.w[i].b[2]);Vx.w[i] += '
                            '(Vu.uw[i].ub[3] * Vv.w[i].b[3]) ;}',
 'Vx.w=vinsert(Rt)': 'Vx.uw[0] = Rt;',
 'Vxx+=vmpyo(Vu.w,Vv.h)': 'for (i = 0; i < VELEM(32); i++) {prod = (Vu.w[i] * '
                          'Vv.w[i].h[1]) +Vxx.v[1].w[i];Vxx.v[1].w[i] = prod '
                          '>> 16;Vxx.v[0].w[i].h[0]=Vxx.v[0].w[i] >> '
                          '16;Vxx.v[0].w[i].h[1]=prod & 0x0000ffff ;}',
 'Vxx.h+=vadd(Vu.ub,Vv.ub)': 'for (i = 0; i < VELEM(16); i++) {Vxx.v[0].h[i] '
                             '+= Vu.h[i].ub[0] +Vv.h[i].ub[0];Vxx.v[1].h[i] += '
                             'Vu.h[i].ub[1] +Vv.h[i].ub[1] ;}',
 'Vxx.h+=vdmpy(Vuu.ub,Rt.b)': 'for (i = 0; i < VELEM(16); i++) {Vxx.v[0].h[i] '
                              '+= (Vuu.v[0].uh[i].ub[0] *Rt.b[(2*i) % '
                              '4]);Vxx.v[0].h[i] += (Vuu.v[0].uh[i].ub[1] '
                              '*Rt.b[(2*i+1)%4]);Vxx.v[1].h[i] += '
                              '(Vuu.v[0].uh[i].ub[1] *Rt.b[(2*i) % '
                              '4]);Vxx.v[1].h[i] += (Vuu.v[1].uh[i].ub[0] '
                              '*Rt.b[(2*i+1)%4]) ;}',
 'Vxx.h+=vmpa(Vuu.ub,Rt.b)': 'for (i = 0; i < VELEM(16); i++) {Vxx.v[0].h[i] '
                             '+= (Vuu.v[0].uh[i].ub[0] *Rt.b[0]) + '
                             '(Vuu.v[1].uh[i].ub[0] * Rt.b[1]);Vxx.v[1].h[i] '
                             '+= (Vuu.v[0].uh[i].ub[1] *Rt.b[2]) + '
                             '(Vuu.v[1].uh[i].ub[1] * Rt.b[3]) ;}',
 'Vxx.h+=vmpa(Vuu.ub,Rt.ub)': 'for (i = 0; i < VELEM(16); i++) {Vxx.v[0].uh[i] '
                              '+= (Vuu.v[0].uh[i].ub[0] *Rt.ub[0]) + '
                              '(Vuu.v[1].uh[i].ub[0] * '
                              'Rt.ub[1]);Vxx.v[1].uh[i] += '
                              '(Vuu.v[0].uh[i].ub[1] *Rt.ub[2]) + '
                              '(Vuu.v[1].uh[i].ub[1] * Rt.ub[3]) ;}',
 'Vxx.h+=vmpy(Vu.b,Vv.b)': 'for (i = 0; i < VELEM(16); i++) {Vxx.v[0].h[i] += '
                           '(Vu.h[i].b[0] *Vv.h[i].b[0]);Vxx.v[1].h[i] += '
                           '(Vu.h[i].b[1] *Vv.h[i].b[1]) ;}',
 'Vxx.h+=vmpy(Vu.ub,Rt.b)': 'for (i = 0; i < VELEM(16); i++) {Vxx.v[0].h[i] += '
                            '(Vu.uh[i].ub[0] *Rt.b[(2*i+0)%4]);Vxx.v[1].h[i] '
                            '+= (Vu.uh[i].ub[1] *Rt.b[(2*i+1)%4]) ;}',
 'Vxx.h+=vmpy(Vu.ub,Vv.b)': 'for (i = 0; i < VELEM(16); i++) {Vxx.v[0].h[i] += '
                            '(Vu.uh[i].ub[0] *Vv.h[i].b[0]);Vxx.v[1].h[i] += '
                            '(Vu.uh[i].ub[1] *Vv.h[i].b[1]) ;}',
 'Vxx.h+=vtmpy(Vuu.b,Rt.b)': 'for (i = 0; i < VELEM(16); i++) {Vxx.v[0].h[i] '
                             '+= (Vuu.v[0].h[i].b[0] *Rt.b[(2*i '
                             ')%4]);Vxx.v[0].h[i] += (Vuu.v[0].h[i].b[1] '
                             ...
                             '*Rt.b[(2*i+1)%4]);Vxx.v[1].h[i] += '
                             'Vuu.v[1].h[i].b[1] ;}',
 'Vxx.h+=vtmpy(Vuu.ub,Rt.b)': 'for (i = 0; i < VELEM(16); i++) {Vxx.v[0].h[i] '
                              '+= (Vuu.v[0].uh[i].ub[0] *Rt.b[(2*i '
                              ')%4]);Vxx.v[0].h[i] += (Vuu.v[0].uh[i].ub[1] '
                              '*Rt.b[(2*i+1)%4]);Vxx.v[0].h[i] += '
 ...
 'Vxx.h|=vunpacko(Vu.b)': 'for (i = 0; i < VELEM(8); i++) {Vxx.uh[i] |= '
                          'Vu.ub[i]<<8 ;}',
 'Vxx.uh+=vmpy(Vu.ub,Rt.ub)': 'for (i = 0; i < VELEM(16); i++) {Vxx.v[0].uh[i] '
                              '+= (Vu.uh[i].ub[0] '
                              '*Rt.ub[(2*i+0)%4]);Vxx.v[1].uh[i] += '
                              '(Vu.uh[i].ub[1] *Rt.ub[(2*i+1)%4]) ;}',
 'Vxx.uh+=vmpy(Vu.ub,Vv.ub)': 'for (i = 0; i < VELEM(16); i++) {Vxx.v[0].uh[i] '
                              '+= (Vu.uh[i].ub[0] '
 ...
 'Vxx.uw+=vdsad(Vuu.uh,Rt.uh)': 'for (i = 0; i < VELEM(32); i++) '
                                ...
                                'ABS(Vuu.v[1].uw[i].uh[0] -Rt.uh[1]) ;}',
 'Vxx.uw+=vmpy(Vu.uh,Rt.uh)': 'for (i = 0; i < VELEM(32); i++) {Vxx.v[0].uw[i] '
                              '+= (Vu.uw[i].uh[0] *Rt.uh[0]);Vxx.v[1].uw[i] += '
                              '(Vu.uw[i].uh[1] *Rt.uh[1]) ;}',
 'Vxx.uw+=vmpy(Vu.uh,Vv.uh)': 'for (i = 0; i < VELEM(32); i++) {Vxx.v[0].uw[i] '
                              '+= (Vu.uw[i].uh[0] '
 ...
 'Vxx.uw+=vrsad(Vuu.ub,Rt.ub,#u1)': 'for (i = 0; i < VELEM(32); i++) '
                                    ...
                                    'ABS(Vuu.v[0 ].uw[i].ub[3]- '
                                    'Rt.ub[(1-#u)&3]) ;}',
 'Vxx.w+=vadd(Vu.h,Vv.h)': 'for (i = 0; i < VELEM(32); i++) {Vxx.v[0].w[i] += '
                           'Vu.w[i].h[0] +Vv.w[i].h[0];Vxx.v[1].w[i] += '
                           'Vu.w[i].h[1] + Vv.w[i].h[1];}',
 'Vxx.w+=vadd(Vu.uh,Vv.uh)': 'for (i = 0; i < VELEM(32); i++) {Vxx.v[0].w[i] '
                             '+= Vu.w[i].uh[0] +Vv.w[i].uh[0];Vxx.v[1].w[i] += '
                             'Vu.w[i].uh[1] +Vv.w[i].uh[1] ;}',
 'Vxx.w+=vdmpy(Vuu.h,Rt.b)': 'for (i = 0; i < VELEM(32); i++) {Vxx.v[0].w[i] '
                             '+= (Vuu.v[0].w[i].h[0] '
                             ...
                             '(Vuu.v[1].w[i].h[0] *Rt.b[(2*i+1)%4]) ;}',
 'Vxx.w+=vmpa(Vuu.h,Rt.b)': 'for (i = 0; i < VELEM(32); i++) {Vxx.v[0].w[i] += '
                            '(Vuu.v[0].w[i].h[0] *Rt.b[0]) + '
                            '(Vuu.v[1].w[i].h[0] * Rt.b[1]);Vxx.v[1].w[i] += '
                            '(Vuu.v[0].w[i].h[1] *Rt.b[2]) + '
                            '(Vuu.v[1].w[i].h[1] * Rt.b[3]) ;}',
 'Vxx.w+=vmpa(Vuu.uh,Rt.b)': 'for (i = 0; i < VELEM(32); i++) {Vxx.v[0].w[i] '
                             '+= (Vuu.v[0].w[i].uh[0] *Rt.b[0]) + '
                             '(Vuu.v[1].w[i].uh[0] * Rt.b[1]);Vxx.v[1].w[i] += '
                             '(Vuu.v[0].w[i].uh[1] *Rt.b[2]) + '
                             '(Vuu.v[1].w[i].uh[1] * Rt.b[3]) ;}',
 'Vxx.w+=vmpy(Vu.h,Rt.h)': 'for (i = 0; i < VELEM(32); i++) {Vxx.v[0].w[i] = '
                           'Vxx.v[0].w[i].s64 +(Vu.w[i].h[0] * '
                           'Rt.h[0]);Vxx.v[1].w[i] = Vxx.v[1].w[i].s64 '
                           '+(Vu.w[i].h[1] * Rt.h[1]) ;}',
 'Vxx.w+=vmpy(Vu.h,Rt.h):sat': 'for (i = 0; i < VELEM(32); i++) {Vxx.v[0].w[i] '
                               '= sat32(Vxx.v[0].w[i].s64 +(Vu.w[i].h[0] * '
                               'Rt.h[0]));Vxx.v[1].w[i] = '
                               'sat32(Vxx.v[1].w[i].s64 +(Vu.w[i].h[1] * '
                               'Rt.h[1])) ;}',
 'Vxx.w+=vmpy(Vu.h,Vv.h)': 'for (i = 0; i < VELEM(32); i++) {Vxx.v[0].w[i] += '
                           '(Vu.w[i].h[0] *Vv.w[i].h[0]);Vxx.v[1].w[i] += '
                           '(Vu.w[i].h[1] *Vv.w[i].h[1]) ;}',
 'Vxx.w+=vmpy(Vu.h,Vv.uh)': 'for (i = 0; i < VELEM(32); i++) {Vxx.v[0].w[i] += '
                            '(Vu.w[i].h[0] *Vv.uw[i].uh[0]);Vxx.v[1].w[i] += '
                            '(Vu.w[i].h[1] *Vv.uw[i].uh[1]) ;}',
 'Vxx.w+=vrmpy(Vuu.ub,Rt.b,#u1)': 'for (i = 0; i < VELEM(32); i++) '
                                  ...
                                  '].uw[i].ub[3] *Rt.b[(1-#u) & 0x3]) ;}',
 'Vxx.w+=vtmpy(Vuu.h,Rt.b)': 'for (i = 0; i < VELEM(32); i++) {Vxx.v[0].w[i]+= '
                             '(Vuu.v[0].w[i].h[0] '
                             '*Rt.b[(2*i+0)%4]);Vxx.v[0].w[i]+= '
                             '(Vuu.v[0].w[i].h[1] '
