...
define i32 @matmul_hvx_hvx128(%struct.halide_buffer_t* noalias nocapture readonly %A.buffer, %struct.halide_buffer_t* noalias nocapture readonly %B.buffer, %struct.halide_buffer_t* noalias nocapture readonly %res.buffer) local_unnamed_addr #9 {
entry:
...
"for res.s0.y":                                   ; preds = %entry, %"end for res.s0.x.x"
  %res.s0.y = phi i32 [ 0, %entry ], [ %19, %"end for res.s0.x.x" ]
  %reass.add34 = sub i32 %res.s0.y, %4
  %reass.mul35 = mul i32 %reass.add34, %5
  %reass.add36 = sub i32 %res.s0.y, %16
  %reass.mul37 = mul i32 %reass.add36, %17
  br label %"for res.s0.x.x"

"for res.s0.x.x":                                 ; preds = %"for res.s0.y", %"consume matrix_mul"
  %res.s0.x.x = phi i32 [ 0, %"for res.s0.y" ], [ %84, %"consume matrix_mul" ]
  %18 = shl nsw i32 %res.s0.x.x, 6
  %t18 = sub i32 %18, %9
  br label %"for matrix_mul.s1.r8$x"

"end for res.s0.x.x":                             ; preds = %"consume matrix_mul"
  %19 = add nuw nsw i32 %res.s0.y, 1
  %.not4 = icmp eq i32 %19, 1024
  br i1 %.not4, label %destructor_block, label %"for res.s0.y"

"for matrix_mul.s1.r8$x":                         ; preds = %"for matrix_mul.s1.r8$x", %"for res.s0.x.x"
  %matrix_mul2.sroa.4.0 = phi <32 x i32> [ zeroinitializer, %"for res.s0.x.x" ], [ %77, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul2.sroa.0.0 = phi <32 x i32> [ zeroinitializer, %"for res.s0.x.x" ], [ %76, %"for matrix_mul.s1.r8$x" ]
  %"matrix_mul.s1.r8$x" = phi i32 [ 0, %"for res.s0.x.x" ], [ %78, %"for matrix_mul.s1.r8$x" ]
  %20 = shufflevector <32 x i32> %matrix_mul2.sroa.0.0, <32 x i32> %matrix_mul2.sroa.4.0, <64 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %reass.add = sub i32 %"matrix_mul.s1.r8$x", %10
  %reass.mul = mul i32 %reass.add, %11
  %21 = add i32 %t18, %reass.mul
  %22 = getelementptr inbounds i16, i16* %7, i32 %21
  %23 = bitcast i16* %22 to <64 x i16>*
  %24 = load <64 x i16>, <64 x i16>* %23, align 2, !tbaa !95
  %25 = sext <64 x i16> %24 to <64 x i32>
  %t16 = sub i32 %"matrix_mul.s1.r8$x", %3
  %26 = add i32 %t16, %reass.mul35
  %27 = getelementptr inbounds i16, i16* %1, i32 %26
  %28 = load i16, i16* %27, align 2, !tbaa !98
  %29 = insertelement <64 x i16> undef, i16 %28, i32 0
  %30 = shufflevector <64 x i16> %29, <64 x i16> undef, <64 x i32> zeroinitializer
  %31 = sext <64 x i16> %30 to <64 x i32>
  %32 = mul nsw <64 x i32> %31, %25
  %33 = tail call <64 x i32> @llvm.sadd.sat.v64i32(<64 x i32> %20, <64 x i32> %32)
  %34 = or i32 %"matrix_mul.s1.r8$x", 1
  %reass.add.1 = sub i32 %34, %10
  %reass.mul.1 = mul i32 %reass.add.1, %11
  %35 = add i32 %t18, %reass.mul.1
  %36 = getelementptr inbounds i16, i16* %7, i32 %35
  %37 = bitcast i16* %36 to <64 x i16>*
  %38 = load <64 x i16>, <64 x i16>* %37, align 2, !tbaa !95
  %39 = sext <64 x i16> %38 to <64 x i32>
  %t16.1 = sub i32 %34, %3
  %40 = add i32 %t16.1, %reass.mul35
  %41 = getelementptr inbounds i16, i16* %1, i32 %40
  %42 = load i16, i16* %41, align 2, !tbaa !98
  %43 = insertelement <64 x i16> undef, i16 %42, i32 0
  %44 = shufflevector <64 x i16> %43, <64 x i16> undef, <64 x i32> zeroinitializer
  %45 = sext <64 x i16> %44 to <64 x i32>
  %46 = mul nsw <64 x i32> %45, %39
  %47 = tail call <64 x i32> @llvm.sadd.sat.v64i32(<64 x i32> %33, <64 x i32> %46)
  %48 = or i32 %"matrix_mul.s1.r8$x", 2
  %reass.add.2 = sub i32 %48, %10
  %reass.mul.2 = mul i32 %reass.add.2, %11
  %49 = add i32 %t18, %reass.mul.2
  %50 = getelementptr inbounds i16, i16* %7, i32 %49
  %51 = bitcast i16* %50 to <64 x i16>*
  %52 = load <64 x i16>, <64 x i16>* %51, align 2, !tbaa !95
  %53 = sext <64 x i16> %52 to <64 x i32>
  %t16.2 = sub i32 %48, %3
  %54 = add i32 %t16.2, %reass.mul35
  %55 = getelementptr inbounds i16, i16* %1, i32 %54
  %56 = load i16, i16* %55, align 2, !tbaa !98
  %57 = insertelement <64 x i16> undef, i16 %56, i32 0
  %58 = shufflevector <64 x i16> %57, <64 x i16> undef, <64 x i32> zeroinitializer
  %59 = sext <64 x i16> %58 to <64 x i32>
  %60 = mul nsw <64 x i32> %59, %53
  %61 = tail call <64 x i32> @llvm.sadd.sat.v64i32(<64 x i32> %47, <64 x i32> %60)
  %62 = or i32 %"matrix_mul.s1.r8$x", 3
  %reass.add.3 = sub i32 %62, %10
  %reass.mul.3 = mul i32 %reass.add.3, %11
  %63 = add i32 %t18, %reass.mul.3
  %64 = getelementptr inbounds i16, i16* %7, i32 %63
  %65 = bitcast i16* %64 to <64 x i16>*
  %66 = load <64 x i16>, <64 x i16>* %65, align 2, !tbaa !95
  %67 = sext <64 x i16> %66 to <64 x i32>
  %t16.3 = sub i32 %62, %3
  %68 = add i32 %t16.3, %reass.mul35
  %69 = getelementptr inbounds i16, i16* %1, i32 %68
  %70 = load i16, i16* %69, align 2, !tbaa !98
  %71 = insertelement <64 x i16> undef, i16 %70, i32 0
  %72 = shufflevector <64 x i16> %71, <64 x i16> undef, <64 x i32> zeroinitializer
  %73 = sext <64 x i16> %72 to <64 x i32>
  %74 = mul nsw <64 x i32> %73, %67
  %75 = tail call <64 x i32> @llvm.sadd.sat.v64i32(<64 x i32> %61, <64 x i32> %74)
  %76 = shufflevector <64 x i32> %75, <64 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %77 = shufflevector <64 x i32> %75, <64 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %78 = add nuw nsw i32 %"matrix_mul.s1.r8$x", 4
  %.not.3 = icmp eq i32 %78, 1024
  br i1 %.not.3, label %"consume matrix_mul", label %"for matrix_mul.s1.r8$x"

"consume matrix_mul":                             ; preds = %"for matrix_mul.s1.r8$x"
  %t17 = sub i32 %18, %15
  %79 = add i32 %t17, %reass.mul37
  %80 = getelementptr inbounds i32, i32* %13, i32 %79
  %81 = bitcast i32* %80 to <32 x i32>*
  store <32 x i32> %76, <32 x i32>* %81, align 4, !tbaa !100
  %82 = getelementptr inbounds i32, i32* %80, i32 32
  %83 = bitcast i32* %82 to <32 x i32>*
  store <32 x i32> %77, <32 x i32>* %83, align 4, !tbaa !100
  %84 = add nuw nsw i32 %res.s0.x.x, 1
  %.not3 = icmp eq i32 %84, 16
...
; Function Attrs: nofree nounwind
define i32 @matmul_hvx_hvx128_argv(i8** nocapture readonly %0) local_unnamed_addr #10 {
entry:
...
define nonnull %struct.halide_filter_metadata_t* @matmul_hvx_hvx128_metadata() local_unnamed_addr #11 {
entry:
  ret %struct.halide_filter_metadata_t* @matmul_hvx_hvx128_metadata_storage
}

; Function Attrs: nofree nosync nounwind readnone speculatable willreturn
declare <64 x i32> @llvm.sadd.sat.v64i32(<64 x i32>, <64 x i32>) #8
...
attributes #9 = { nofree nounwind "reciprocal-estimates"="none" }
