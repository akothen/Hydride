...
.LBB131_1:                              // %"for res.s0.y"
	...
	{
		r11:10 = combine(r15,r28)
		r17:16 = combine(r9,r13)
		r18 = #0
		r1 = memw(r29+#4)
	}                                       // 4-byte Folded Reload
	{
...
.LBB131_3:                              // %"for matrix_mul.s1.r8$x"
	...
	{
		v12.w += vmpyie(v10.w,v14.uh)
		v11 = valign(v13,v11,r3)
		v13 = vmem(r1+#1)
	}
	{
		v13.w = vmpyieo(v10.h,v16.h)
		v3 = valign(v13,v3,r1)
		q0 = vcmp.gt(v0.w,v12.w)
		v12.w = vadd(v5.w,v12.w)
	}
	{
		v13.w += vmpyie(v10.w,v16.uh)
		v29:28.w = vunpack(v8.h)
	}
	{
		v8 = valign(v8,v8,r7)
		q1 = vcmp.gt(v0.w,v13.w)
		q3 = vcmp.gt(v0.w,v12.w)
		q0 ^= vcmp.gt(v5.w,v12.w)
	}
	{
		v31:30.w = vunpack(v6.h)
		v6.w = vadd(v4.w,v13.w)
		v13 = vmux(q3,v2,v1)
	}
	{
		v19:18.w = vunpack(v8.h)
		q2 = vcmp.gt(v0.w,v6.w)
		q1 ^= vcmp.gt(v4.w,v6.w)
	}
	{
		v23.w = vmpyieo(v30.h,v28.h)
		v5 = valign(v11,v11,r7)
		v4 = vmux(q2,v2,v1)
		v12 = vmux(q0,v13,v12)
	}
	{
		v23.w += vmpyie(v30.w,v28.uh)
		v21:20.w = vunpack(v11.h)
	}
	{
		v11.w = vmpyieo(v30.h,v18.h)
		v7:6.w = vunpack(v7.h)
		v15 = vmux(q1,v4,v6)
	}
	{
		v11.w += vmpyie(v30.w,v18.uh)
		v7.w = vadd(v12.w,v23.w)
		q0 = vcmp.gt(v0.w,v23.w)
	}
	{
		v23:22.w = vunpack(v5.h)
		v4.w = vadd(v15.w,v11.w)
		q3 = vcmp.gt(v0.w,v7.w)
	}
	{
		v5.w = vmpyieo(v6.h,v20.h)
		q1 = vcmp.gt(v0.w,v11.w)
		q2 = vcmp.gt(v0.w,v4.w)
		q0 ^= vcmp.gt(v12.w,v7.w)
	}
	{
		v25.w = vmpyieo(v6.h,v22.h)
		v29:28.w = vunpack(v3.h)
		v24 = vmux(q3,v2,v1)
	}
	{
		v3 = valign(v3,v3,r7)
		q1 ^= vcmp.gt(v15.w,v4.w)
		v12 = vmux(q2,v2,v1)
	}
	{
		v25.w += vmpyie(v6.w,v22.uh)
		v4 = vmux(q1,v12,v4)
	}
	{
		v5.w += vmpyie(v6.w,v20.uh)
		v6 = vmux(q0,v24,v7)
		v29.w = vadd(v4.w,v25.w)
	}
	{
		v27:26.w = vunpack(v27.h)
		v8.w = vadd(v6.w,v5.w)
		q0 = vcmp.gt(v0.w,v5.w)
	}
	{
		v31:30.w = vunpack(v3.h)
		q3 = vcmp.gt(v0.w,v8.w)
		q2 = vcmp.gt(v0.w,v25.w)
	}
	{
		v7.w = vmpyieo(v26.h,v28.h)
		v3 = vmux(q3,v2,v1)
		q0 ^= vcmp.gt(v6.w,v8.w)
		q3 = vcmp.gt(v0.w,v29.w)
	}
	{
		v5.w = vmpyieo(v26.h,v30.h)
		q2 ^= vcmp.gt(v4.w,v29.w)
		v4 = vmux(q3,v2,v1)
		v3 = vmux(q0,v3,v8)
	}
	{
		v7.w += vmpyie(v26.w,v28.uh)
		v4 = vmux(q2,v4,v29)
	}
	{
		v5.w += vmpyie(v26.w,v30.uh)
		v6.w = vadd(v3.w,v7.w)
		q0 = vcmp.gt(v0.w,v7.w)
	}
	{
		v7.w = vadd(v4.w,v5.w)
		q2 = vcmp.gt(v0.w,v6.w)
		q1 = vcmp.gt(v0.w,v5.w)
		q0 ^= vcmp.gt(v3.w,v6.w)
	}
	{
		v3 = vmux(q2,v2,v1)
		q3 = vcmp.gt(v0.w,v7.w)
		q1 ^= vcmp.gt(v4.w,v7.w)
	}
	{
		v5 = vmux(q0,v3,v6)
		v3 = vmux(q3,v2,v1)
