...
"for res.s0.y":                                   ; preds = %entry, %"end for res.s0.x.x"
  ...
  %20 = sub nsw i32 %res.s0.y, %4
  %21 = mul nsw i32 %20, %5
  %22 = sub i32 %21, %3
  %23 = sub nsw i32 %res.s0.y, %16
...
"for res.s0.x.x":                                 ; preds = %"for res.s0.y", %"consume matrix_mul"
  %res.s0.x.x = phi i32 [ 0, %"for res.s0.y" ], [ %88, %"consume matrix_mul" ]
...
"for matrix_mul.s1.r8$x":                         ; preds = %"for matrix_mul.s1.r8$x", %"for res.s0.x.x"
  %matrix_mul2.sroa.4.0 = phi <32 x i32> [ %19, %"for res.s0.x.x" ], [ %78, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul2.sroa.0.0 = phi <32 x i32> [ %18, %"for res.s0.x.x" ], [ %77, %"for matrix_mul.s1.r8$x" ]
  %"matrix_mul.s1.r8$x" = phi i32 [ 0, %"for res.s0.x.x" ], [ %79, %"for matrix_mul.s1.r8$x" ]
  ...
  %33 = add nsw i32 %22, %"matrix_mul.s1.r8$x"
  %34 = getelementptr inbounds i16, i16* %1, i32 %33
  %35 = load i16, i16* %34, align 2, !tbaa !98
  %arg_i32.i.i = zext i16 %35 to i32
  %arg_i32_s.i.i = shl nuw i32 %arg_i32.i.i, 16
  %r.i.i = or i32 %arg_i32_s.i.i, %arg_i32.i.i
  %36 = tail call <64 x i32> @llvm.hexagon.V6.vmpyh.128B(<32 x i32> %32, i32 %r.i.i) #11
  %37 = tail call <64 x i32> @llvm.hexagon.V6.vaddwsat.dv.128B(<64 x i32> %28, <64 x i32> %36) #11
  %38 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %37)
  %39 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %37)
  %40 = or i32 %"matrix_mul.s1.r8$x", 1
  %41 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %39, <32 x i32> %38)
  %reass.add.1 = sub i32 %40, %10
  %reass.mul.1 = mul i32 %reass.add.1, %11
  %42 = add i32 %t18, %reass.mul.1
  %43 = getelementptr inbounds i16, i16* %7, i32 %42
  %44 = bitcast i16* %43 to <32 x i32>*
  %45 = load <32 x i32>, <32 x i32>* %44, align 2, !tbaa !95
  %46 = add nsw i32 %22, %40
  %47 = getelementptr inbounds i16, i16* %1, i32 %46
  %48 = load i16, i16* %47, align 2, !tbaa !98
  %arg_i32.i.i.1 = zext i16 %48 to i32
  %arg_i32_s.i.i.1 = shl nuw i32 %arg_i32.i.i.1, 16
  %r.i.i.1 = or i32 %arg_i32_s.i.i.1, %arg_i32.i.i.1
  %49 = tail call <64 x i32> @llvm.hexagon.V6.vmpyh.128B(<32 x i32> %45, i32 %r.i.i.1) #11
  %50 = tail call <64 x i32> @llvm.hexagon.V6.vaddwsat.dv.128B(<64 x i32> %41, <64 x i32> %49) #11
  %51 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %50)
  %52 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %50)
  %53 = or i32 %"matrix_mul.s1.r8$x", 2
  %54 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %52, <32 x i32> %51)
  %reass.add.2 = sub i32 %53, %10
  %reass.mul.2 = mul i32 %reass.add.2, %11
  %55 = add i32 %t18, %reass.mul.2
  %56 = getelementptr inbounds i16, i16* %7, i32 %55
  %57 = bitcast i16* %56 to <32 x i32>*
  %58 = load <32 x i32>, <32 x i32>* %57, align 2, !tbaa !95
  %59 = add nsw i32 %22, %53
  %60 = getelementptr inbounds i16, i16* %1, i32 %59
  %61 = load i16, i16* %60, align 2, !tbaa !98
  %arg_i32.i.i.2 = zext i16 %61 to i32
  %arg_i32_s.i.i.2 = shl nuw i32 %arg_i32.i.i.2, 16
  %r.i.i.2 = or i32 %arg_i32_s.i.i.2, %arg_i32.i.i.2
  %62 = tail call <64 x i32> @llvm.hexagon.V6.vmpyh.128B(<32 x i32> %58, i32 %r.i.i.2) #11
  %63 = tail call <64 x i32> @llvm.hexagon.V6.vaddwsat.dv.128B(<64 x i32> %54, <64 x i32> %62) #11
  %64 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %63)
  %65 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %63)
  %66 = or i32 %"matrix_mul.s1.r8$x", 3
  %67 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %65, <32 x i32> %64)
  %reass.add.3 = sub i32 %66, %10
  %reass.mul.3 = mul i32 %reass.add.3, %11
  %68 = add i32 %t18, %reass.mul.3
  %69 = getelementptr inbounds i16, i16* %7, i32 %68
  %70 = bitcast i16* %69 to <32 x i32>*
  %71 = load <32 x i32>, <32 x i32>* %70, align 2, !tbaa !95
  %72 = add nsw i32 %22, %66
  %73 = getelementptr inbounds i16, i16* %1, i32 %72
  %74 = load i16, i16* %73, align 2, !tbaa !98
  %arg_i32.i.i.3 = zext i16 %74 to i32
  %arg_i32_s.i.i.3 = shl nuw i32 %arg_i32.i.i.3, 16
  %r.i.i.3 = or i32 %arg_i32_s.i.i.3, %arg_i32.i.i.3
  %75 = tail call <64 x i32> @llvm.hexagon.V6.vmpyh.128B(<32 x i32> %71, i32 %r.i.i.3) #11
  %76 = tail call <64 x i32> @llvm.hexagon.V6.vaddwsat.dv.128B(<64 x i32> %67, <64 x i32> %75) #11
  %77 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %76)
  %78 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %76)
  %79 = add nuw nsw i32 %"matrix_mul.s1.r8$x", 4
  %.not.3 = icmp eq i32 %79, 1024
  br i1 %.not.3, label %"consume matrix_mul", label %"for matrix_mul.s1.r8$x"

"consume matrix_mul":                             ; preds = %"for matrix_mul.s1.r8$x"
  %80 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %78, <32 x i32> %77)
  %e.i = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %80) #11
  %o.i = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %80) #11
  %r.i = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i, <32 x i32> %e.i, i32 -4) #11
  %81 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r.i)
  %82 = add nsw i32 %25, %26
  %83 = getelementptr inbounds i32, i32* %13, i32 %82
  %84 = bitcast i32* %83 to <32 x i32>*
  store <32 x i32> %81, <32 x i32>* %84, align 4, !tbaa !100
  %85 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r.i)
  %86 = getelementptr inbounds i32, i32* %83, i32 32
  %87 = bitcast i32* %86 to <32 x i32>*
  store <32 x i32> %85, <32 x i32>* %87, align 4, !tbaa !100
  %88 = add nuw nsw i32 %res.s0.x.x, 1
  %.not3 = icmp eq i32 %88, 16
