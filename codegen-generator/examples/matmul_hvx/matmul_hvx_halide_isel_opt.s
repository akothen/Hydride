...
.LBB131_3:                              // %"for matrix_mul.s1.r8$x"
	...
	{
		r7 = combine(r27.l,r27.l)
		v6 = valign(v8,v6,r7)
		v8.cur = vmem(r7+#1)
	}
	{
		v31:30.w = vmpy(v3.h,r7.h)
		r7 = combine(r9.l,r9.l)
		v3 = v4
		v7 = vmem(r5+#0)
	}
	{
		v7 = valign(v8,v7,r5)
		v3:2.w = vadd(v3:2.w,v31:30.w):sat
		r5 = memuh(r22+#2)
		v8.cur = vmem(r5+#1)
	}
	{
		v5:4.w = vmpy(v5.h,r4.h)
		r22 = add(r22,#8)
	}
	{
		v5:4.w = vmpy(v6.h,r7.h)
		r4 = combine(r5.l,r5.l)
		v3:2.w = vadd(v3:2.w,v5:4.w):sat
	}
	{
		v5:4.w = vmpy(v7.h,r4.h)
		v3:2.w = vadd(v3:2.w,v5:4.w):sat
	}
	{
		v3:2.w = vadd(v3:2.w,v5:4.w):sat
