...
(define sol 
                            ...
                            #:forall (list v0_0  env_0_i0_j0 env_0_i0_j1 env_0_i0_j2 env_0_i0_j3 env_0_i1_j0 env_0_i1_j1 env_0_i1_j2 env_0_i1_j3 env_0_i2_j0 env_0_i2_j1 env_0_i2_j2 env_0_i2_j3 env_0_i3_j0 env_0_i3_j1 env_0_i3_j2 env_0_i3_j3)
                             #:guarantee 
                            (begin
                             (assert (equal? (interpret sketch-grammar env_0_i0_j0) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 0 0) ))
(assert (equal? (interpret sketch-grammar env_0_i0_j1) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 0 1) ))
(assert (equal? (interpret sketch-grammar env_0_i0_j2) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 0 2) ))
(assert (equal? (interpret sketch-grammar env_0_i0_j3) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 0 3) ))
(assert (equal? (interpret sketch-grammar env_0_i1_j0) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 1 0) ))
(assert (equal? (interpret sketch-grammar env_0_i1_j1) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 1 1) ))
(assert (equal? (interpret sketch-grammar env_0_i1_j2) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 1 2) ))
(assert (equal? (interpret sketch-grammar env_0_i1_j3) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 1 3) ))
(assert (equal? (interpret sketch-grammar env_0_i2_j0) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 2 0) ))
(assert (equal? (interpret sketch-grammar env_0_i2_j1) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 2 1) ))
(assert (equal? (interpret sketch-grammar env_0_i2_j2) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 2 2) ))
(assert (equal? (interpret sketch-grammar env_0_i2_j3) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 2 3) ))
(assert (equal? (interpret sketch-grammar env_0_i3_j0) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 3 0) ))
(assert (equal? (interpret sketch-grammar env_0_i3_j1) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 3 1) ))
(assert (equal? (interpret sketch-grammar env_0_i3_j2) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 3 2) ))
(assert (equal? (interpret sketch-grammar env_0_i3_j3) (index-into-mat (blur v0_0  6 6 3 3 8) 4 4 8 3 3) ))
