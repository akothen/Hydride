...
.LBB214_9:                              # %after_bb
	...
	testq	%rdx, %rdx
	jne	.LBB214_11
.LBB214_10:                             # %_halide_buffer_is_bounds_query.exit228
	cmpq	$0, (%rbx)
	jne	.LBB214_11
# %bb.142:                              # %_halide_buffer_init.exit262
	cmpl	$64, %r14d
	movl	$64, %eax
	cmovgl	40(%rsp), %eax                  # 4-byte Folded Reload
	movq	40(%rbx), %rdx
	movl	%ecx, 296(%rsp)
	movl	%eax, 300(%rsp)
	movq	$1, 304(%rsp)
	...
	movq	$0, 24(%rbx)
	jmp	.LBB214_11
.LBB214_141:                            # %_halide_buffer_init.exit
	movl	%ebp, %edx
	subl	%r13d, %edx
	movl	%r13d, 264(%rsp)
	movl	%edx, 268(%rsp)
...
.LBB214_18:                             # %then_bb7
	...
	cmpl	%r11d, 72(%rsp)                 # 4-byte Folded Reload
	setl	%al
	xorl	%edi, %edi
	cmpl	$64, %r14d
	setl	%dil
	movq	48(%rsp), %rsi                  # 8-byte Reload
	xorl	%edx, %edx
	cmpl	$67585, %r15d                   # imm = 0x10801
	setne	%dl
	movq	%rdx, 240(%rsp)                 # 8-byte Spill
	xorl	%edx, %edx
	cmpl	$67585, %r9d                    # imm = 0x10801
	setne	%dl
	shlq	$2, %rdx
	xorl	%r13d, %r13d
	...
	leaq	2(%rcx), %r14
	cmoveq	%rcx, %r14
	addq	240(%rsp), %r14                 # 8-byte Folded Reload
	orq	%r9, %r14
	orq	%rax, %r14
	orq	%r15, %r14
	leaq	(%r14,%r13,8), %rax
...
.LBB214_57:                             # %"for sum_input_sq.s1.r8$x.r8$x"
	...
	vpaddd	%xmm6, %xmm5, %xmm5
	vmovd	%xmm5, %edx
	vpmovzxbw	(%r11), %zmm5           # zmm5 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	vpmovzxbw	32(%r11), %zmm6         # zmm6 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	addl	%r14d, %edx
	vpsubw	%zmm0, %zmm6, %zmm6
	vpsubw	%zmm0, %zmm5, %zmm5
...
# %bb.59:                               # %"for sum_input_sq.s1.r8$x.r8$x.epil"
	...
	addq	%rdx, %rcx
	movq	56(%rsp), %rax                  # 8-byte Reload
	vpmovzxbw	(%rax,%rcx), %zmm5      # zmm5 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	vpmovzxbw	32(%rax,%rcx), %zmm6    # zmm6 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	vpsubw	%zmm0, %zmm6, %zmm6
	vpsubw	%zmm0, %zmm5, %zmm5
	vpmaddwd	%zmm5, %zmm5, %zmm5
	vpdpwssd	%zmm6, %zmm6, %zmm5
...
.LBB214_66:                             # %vector.body
                                        #   Parent Loop BB214_53 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vpmovzxbd	-24(%rdi,%rcx), %ymm6   # ymm6 = mem[0],zero,zero,zero,mem[1],zero,zero,zero,mem[2],zero,zero,zero,mem[3],zero,zero,zero,mem[4],zero,zero,zero,mem[5],zero,zero,zero,mem[6],zero,zero,zero,mem[7],zero,zero,zero
	vpsubd	%ymm1, %ymm6, %ymm6
	vpmulld	%ymm6, %ymm6, %ymm6
	vpaddd	%ymm5, %ymm6, %ymm5
	vpmovzxbd	-16(%rdi,%rcx), %ymm6   # ymm6 = mem[0],zero,zero,zero,mem[1],zero,zero,zero,mem[2],zero,zero,zero,mem[3],zero,zero,zero,mem[4],zero,zero,zero,mem[5],zero,zero,zero,mem[6],zero,zero,zero,mem[7],zero,zero,zero
	vpsubd	%ymm1, %ymm6, %ymm6
	vpmulld	%ymm6, %ymm6, %ymm6
	vpmovzxbd	-8(%rdi,%rcx), %ymm7    # ymm7 = mem[0],zero,zero,zero,mem[1],zero,zero,zero,mem[2],zero,zero,zero,mem[3],zero,zero,zero,mem[4],zero,zero,zero,mem[5],zero,zero,zero,mem[6],zero,zero,zero,mem[7],zero,zero,zero
	vpsubd	%ymm1, %ymm7, %ymm7
	vpmulld	%ymm7, %ymm7, %ymm7
	vpaddd	%ymm7, %ymm6, %ymm6
	vpaddd	%ymm6, %ymm5, %ymm5
	vpmovzxbd	(%rdi,%rcx), %ymm6      # ymm6 = mem[0],zero,zero,zero,mem[1],zero,zero,zero,mem[2],zero,zero,zero,mem[3],zero,zero,zero,mem[4],zero,zero,zero,mem[5],zero,zero,zero,mem[6],zero,zero,zero,mem[7],zero,zero,zero
	vpsubd	%ymm1, %ymm6, %ymm6
	vpmulld	%ymm6, %ymm6, %ymm6
	vpaddd	%ymm5, %ymm6, %ymm5
	addq	$32, %rcx
...
.LBB214_74:                             # %"for output.s0.x.x"
	...
	vpmovzxbw	32(%r10,%rcx), %zmm7    # zmm7 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	...
	vpaddsw	%ymm3, %ymm9, %ymm9
	vpaddsw	%ymm3, %ymm7, %ymm7
	vinserti64x4	$1, %ymm6, %zmm8, %zmm6
	vinserti64x4	$1, %ymm7, %zmm9, %zmm7
	vpmaxsw	%zmm4, %zmm6, %zmm6
	vpmovuswb	%zmm6, %ymm6
	vpmaxsw	%zmm4, %zmm7, %zmm7
	vpmovuswb	%zmm7, %ymm7
	vinserti64x4	$1, %ymm7, %zmm6, %zmm6
	vmovdqu64	%zmm6, (%rbx,%rcx)
	addq	$64, %rcx
	decq	%rsi
	jne	.LBB214_74
.LBB214_75:                             # %"end for output.s0.x.x"
                                        #   in Loop: Header=BB214_53 Depth=1
	testb	$63, 104(%rsp)                  # 1-byte Folded Reload
...
# %bb.143:                              # %then_bb35
	...
	movq	56(%rsp), %rax                  # 8-byte Reload
	vpmovzxbw	-64(%rax,%rdx), %zmm6   # zmm6 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	vpmovzxbw	-32(%rax,%rdx), %zmm7   # zmm7 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	vpsubw	%zmm0, %zmm7, %zmm7
	vpsubw	%zmm0, %zmm6, %zmm6
	vpmovsxwd	%ymm6, %zmm8
	vextracti64x4	$1, %zmm6, %ymm6
	...
	vinserti64x4	$1, %ymm7, %zmm8, %zmm6
	vpmaxsw	%zmm4, %zmm5, %zmm5
	vpmovuswb	%zmm5, %ymm5
	vpmaxsw	%zmm4, %zmm6, %zmm6
	vpmovuswb	%zmm6, %ymm6
	vinserti64x4	$1, %ymm6, %zmm5, %zmm5
...
.LBB214_78:                             # %"assert succeeded40"
	...
	jne	.LBB214_80
# %bb.79:                               # %_halide_buffer_is_bounds_query.exit322
	cmpq	$0, (%rdi)
	movq	128(%rsp), %rax                 # 8-byte Reload
	je	.LBB214_144
.LBB214_80:                             # %after_bb60
	testq	%rax, %rax
	jne	.LBB214_82
.LBB214_81:                             # %_halide_buffer_is_bounds_query.exit328
	cmpq	$0, (%rbx)
	jne	.LBB214_82
# %bb.145:                              # %_halide_buffer_init.exit380
	cmpl	$64, %r9d
	movl	$64, %eax
	cmovgl	48(%rsp), %eax                  # 4-byte Folded Reload
	...
	movq	$0, 24(%rbx)
	jmp	.LBB214_82
.LBB214_144:                            # %_halide_buffer_init.exit348
	movl	%r8d, %eax
	subl	%ebp, %eax
	movl	%ebp, 328(%rsp)
	movl	%eax, 332(%rsp)
...
# %bb.83:
	xorl	%eax, %eax
	jmp	.LBB214_85
.LBB214_84:                             # %land.rhs.i353
	cmpq	$0, (%rdi)
	sete	%al
.LBB214_85:                             # %_halide_buffer_is_bounds_query.exit354
...
# %bb.86:
	xorl	%ecx, %ecx
	jmp	.LBB214_88
.LBB214_87:                             # %land.rhs.i359
	cmpq	$0, (%rbx)
	sete	%cl
.LBB214_88:                             # %_halide_buffer_is_bounds_query.exit360
...
.LBB214_89:                             # %then_bb68
	...
	setne	%r14b
	shlq	$11, %r14
	cmpl	$2, 72(%rsp)                    # 4-byte Folded Reload
...
# %bb.114:                              # %"produce output97"
	...
	jle	.LBB214_3
# %bb.115:                              # %"for output.s0.y.rebased108.preheader"
	movslq	%r14d, %r15
	imull	%ebp, %eax
	movq	%r9, %rdi
	imulq	%r15, %rdi
	...
	jmp	.LBB214_116
	.p2align	4, 0x90
.LBB214_139:                            # %after_bb143
                                        #   in Loop: Header=BB214_116 Depth=1
	incq	%rcx
	...
	movq	160(%rsp), %rbx                 # 8-byte Reload
	je	.LBB214_3
.LBB214_116:                            # %"for output.s0.y.rebased108"
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB214_120 Depth 2
                                        #     Child Loop BB214_129 Depth 2
                                        #     Child Loop BB214_132 Depth 2
                                        #     Child Loop BB214_134 Depth 2
	...
	cmpl	$64, %ebx
	jl	.LBB214_123
# %bb.117:                              # %"for sum_input_sq.s1.r8$x.r8$x113.preheader"
                                        #   in Loop: Header=BB214_116 Depth=1
	xorl	%ecx, %ecx
	cmpl	$1, %r11d
	jne	.LBB214_119
# %bb.118:                              #   in Loop: Header=BB214_116 Depth=1
	xorl	%r10d, %r10d
	jmp	.LBB214_121
	.p2align	4, 0x90
.LBB214_119:                            # %"for sum_input_sq.s1.r8$x.r8$x113.preheader1"
                                        #   in Loop: Header=BB214_116 Depth=1
	movq	24(%rsp), %r8                   # 8-byte Reload
	xorl	%r10d, %r10d
	.p2align	4, 0x90
.LBB214_120:                            # %"for sum_input_sq.s1.r8$x.r8$x113"
                                        #   Parent Loop BB214_116 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vpmovzxbw	-64(%r8), %zmm5         # zmm5 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	vpmovzxbw	-32(%r8), %zmm6         # zmm6 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	vpsubw	%zmm0, %zmm6, %zmm6
	vpsubw	%zmm0, %zmm5, %zmm5
	vpmaddwd	%zmm5, %zmm5, %zmm5
	vpdpwssd	%zmm6, %zmm6, %zmm5
	...
	vpaddd	%xmm6, %xmm5, %xmm5
	vmovd	%xmm5, %eax
	vpmovzxbw	(%r8), %zmm5            # zmm5 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	vpmovzxbw	32(%r8), %zmm6          # zmm6 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	addl	%r10d, %eax
	vpsubw	%zmm0, %zmm6, %zmm6
	vpsubw	%zmm0, %zmm5, %zmm5
	...
	cmpq	%rcx, %rdx
	jne	.LBB214_120
.LBB214_121:                            # %"end for sum_input_sq.s1.r8$x.r8$x114.loopexit.unr-lcssa"
                                        #   in Loop: Header=BB214_116 Depth=1
	testb	$1, %r11b
	je	.LBB214_123
# %bb.122:                              # %"for sum_input_sq.s1.r8$x.r8$x113.epil"
                                        #   in Loop: Header=BB214_116 Depth=1
	movq	16(%rsp), %rax                  # 8-byte Reload
	...
	vmovd	%xmm5, %eax
	addl	%eax, %r10d
.LBB214_123:                            # %"end for sum_input_sq.s1.r8$x.r8$x114"
                                        #   in Loop: Header=BB214_116 Depth=1
	movq	%rsi, %r8
	testl	%r12d, %r12d
	je	.LBB214_135
# %bb.124:                              # %then_bb119
	...
	cmpl	$8, %r12d
	jae	.LBB214_126
# %bb.125:                              #   in Loop: Header=BB214_116 Depth=1
	xorl	%eax, %eax
	jmp	.LBB214_134
	.p2align	4, 0x90
.LBB214_126:                            # %vector.ph429
                                        #   in Loop: Header=BB214_116 Depth=1
	vmovd	%r10d, %xmm5
	cmpq	$24, 80(%rsp)                   # 8-byte Folded Reload
	jae	.LBB214_128
# %bb.127:                              #   in Loop: Header=BB214_116 Depth=1
	xorl	%ecx, %ecx
	movq	72(%rsp), %rsi                  # 8-byte Reload
	jmp	.LBB214_130
.LBB214_128:                            # %vector.body427.preheader
                                        #   in Loop: Header=BB214_116 Depth=1
	movq	232(%rsp), %rax                 # 8-byte Reload
	xorl	%ecx, %ecx
	movq	72(%rsp), %rsi                  # 8-byte Reload
	.p2align	4, 0x90
.LBB214_129:                            # %vector.body427
                                        #   Parent Loop BB214_116 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vpmovzxbd	-24(%r9,%rcx), %ymm6    # ymm6 = mem[0],zero,zero,zero,mem[1],zero,zero,zero,mem[2],zero,zero,zero,mem[3],zero,zero,zero,mem[4],zero,zero,zero,mem[5],zero,zero,zero,mem[6],zero,zero,zero,mem[7],zero,zero,zero
	vpsubd	%ymm1, %ymm6, %ymm6
	vpmulld	%ymm6, %ymm6, %ymm6
	vpaddd	%ymm5, %ymm6, %ymm5
	vpmovzxbd	-16(%r9,%rcx), %ymm6    # ymm6 = mem[0],zero,zero,zero,mem[1],zero,zero,zero,mem[2],zero,zero,zero,mem[3],zero,zero,zero,mem[4],zero,zero,zero,mem[5],zero,zero,zero,mem[6],zero,zero,zero,mem[7],zero,zero,zero
	vpsubd	%ymm1, %ymm6, %ymm6
	vpmulld	%ymm6, %ymm6, %ymm6
	vpmovzxbd	-8(%r9,%rcx), %ymm7     # ymm7 = mem[0],zero,zero,zero,mem[1],zero,zero,zero,mem[2],zero,zero,zero,mem[3],zero,zero,zero,mem[4],zero,zero,zero,mem[5],zero,zero,zero,mem[6],zero,zero,zero,mem[7],zero,zero,zero
	vpsubd	%ymm1, %ymm7, %ymm7
	vpmulld	%ymm7, %ymm7, %ymm7
	vpaddd	%ymm7, %ymm6, %ymm6
	vpaddd	%ymm6, %ymm5, %ymm5
	vpmovzxbd	(%r9,%rcx), %ymm6       # ymm6 = mem[0],zero,zero,zero,mem[1],zero,zero,zero,mem[2],zero,zero,zero,mem[3],zero,zero,zero,mem[4],zero,zero,zero,mem[5],zero,zero,zero,mem[6],zero,zero,zero,mem[7],zero,zero,zero
	vpsubd	%ymm1, %ymm6, %ymm6
	vpmulld	%ymm6, %ymm6, %ymm6
	vpaddd	%ymm5, %ymm6, %ymm5
	addq	$32, %rcx
	addq	$4, %rax
	jne	.LBB214_129
.LBB214_130:                            # %middle.block425.unr-lcssa
                                        #   in Loop: Header=BB214_116 Depth=1
	testq	%rsi, %rsi
	je	.LBB214_133
# %bb.131:                              # %vector.body427.epil.preheader
                                        #   in Loop: Header=BB214_116 Depth=1
	addq	%r14, %rcx
	xorl	%eax, %eax
	.p2align	4, 0x90
.LBB214_132:                            # %vector.body427.epil
                                        #   Parent Loop BB214_116 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vpmovzxbd	(%rcx,%rax,8), %ymm6    # ymm6 = mem[0],zero,zero,zero,mem[1],zero,zero,zero,mem[2],zero,zero,zero,mem[3],zero,zero,zero,mem[4],zero,zero,zero,mem[5],zero,zero,zero,mem[6],zero,zero,zero,mem[7],zero,zero,zero
	vpsubd	%ymm1, %ymm6, %ymm6
	vpmulld	%ymm6, %ymm6, %ymm6
	vpaddd	%ymm5, %ymm6, %ymm5
	incq	%rax
...
.LBB214_133:                            # %middle.block425
	...
	je	.LBB214_135
	.p2align	4, 0x90
.LBB214_134:                            # %"for sum_input_sq.s1.r8$x.r21122"
                                        #   Parent Loop BB214_116 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movzbl	(%r14,%rax), %ecx
	subl	%r13d, %ecx
	...
	cmpq	%rax, %r12
	jne	.LBB214_134
.LBB214_135:                            # %"consume sum_input_sq128"
                                        #   in Loop: Header=BB214_116 Depth=1
	lzcntl	%r10d, %ecx
	leal	-16(%rcx), %eax
	vmovd	%eax, %xmm5
	...
	cmpl	$64, 48(%rsp)                   # 4-byte Folded Reload
	jl	.LBB214_138
# %bb.136:                              # %"for output.s0.x.x140.preheader"
                                        #   in Loop: Header=BB214_116 Depth=1
	xorl	%eax, %eax
	movq	136(%rsp), %rcx                 # 8-byte Reload
	.p2align	4, 0x90
.LBB214_137:                            # %"for output.s0.x.x140"
                                        #   Parent Loop BB214_116 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vpmovzxbw	(%r15,%rax), %zmm6      # zmm6 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	vpmovzxbw	32(%r15,%rax), %zmm7    # zmm7 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	vpsubw	%zmm0, %zmm7, %zmm7
	vpsubw	%zmm0, %zmm6, %zmm6
	vpmovsxwd	%ymm6, %zmm8
	vextracti64x4	$1, %zmm6, %ymm6
	...
	vpmovuswb	%zmm7, %ymm7
	vinserti64x4	$1, %ymm7, %zmm6, %zmm6
	vmovdqu64	%zmm6, (%rdi,%rax)
	addq	$64, %rax
	decq	%rcx
	jne	.LBB214_137
.LBB214_138:                            # %"end for output.s0.x.x141"
                                        #   in Loop: Header=BB214_116 Depth=1
	testb	$63, 104(%rsp)                  # 1-byte Folded Reload
	movq	56(%rsp), %r10                  # 8-byte Reload
...
# %bb.140:                              # %then_bb144
	...
	movq	152(%rsp), %rax                 # 8-byte Reload
	vpmovzxbw	-64(%rax,%rbx), %zmm6   # zmm6 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	vpmovzxbw	-32(%rax,%rbx), %zmm7   # zmm7 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero,mem[16],zero,mem[17],zero,mem[18],zero,mem[19],zero,mem[20],zero,mem[21],zero,mem[22],zero,mem[23],zero,mem[24],zero,mem[25],zero,mem[26],zero,mem[27],zero,mem[28],zero,mem[29],zero,mem[30],zero,mem[31],zero
	vpsubw	%zmm0, %zmm7, %zmm7
	vpsubw	%zmm0, %zmm6, %zmm6
	vpmovsxwd	%ymm6, %zmm8
	vextracti64x4	$1, %zmm6, %ymm6
...
.LBB214_45:                             # %assert_failed25
	...
	movq	%r10, %rdx
	jmp	.LBB214_42
.LBB214_107:                            # %assert_failed89
	leaq	.Lstr(%rip), %rsi
	movl	$2147483647, %ecx               # imm = 0x7FFFFFFF
	xorl	%edi, %edi
	movq	%r12, %rdx
	jmp	.LBB214_111
.LBB214_109:                            # %assert_failed91
	leaq	.Lstr.201(%rip), %rsi
	movl	$2147483647, %ecx               # imm = 0x7FFFFFFF
	xorl	%edi, %edi
	movq	%r11, %rdx
...
.LBB214_110:                            # %assert_failed92
	leaq	.Lstr.201(%rip), %rsi
	movl	$2147483647, %ecx               # imm = 0x7FFFFFFF
	xorl	%edi, %edi
.LBB214_111:                            # %assert_failed92
	addq	$392, %rsp                      # imm = 0x188
	popq	%rbx
	popq	%r12
	popq	%r13
...
.LBB214_25:                             # %assert_failed9
	...
	jmp	.LBB214_26
.LBB214_27:                             # %assert_failed10
	leaq	.Lstr.205(%rip), %rsi
	xorl	%edi, %edi
	movl	104(%rsp), %edx                 # 4-byte Reload
	jmp	.LBB214_24
.LBB214_28:                             # %assert_failed11
	leaq	.Lstr.205(%rip), %rsi
	xorl	%edi, %edi
...
.LBB214_97:                             # %assert_failed75
	...
	callq	halide_error_access_out_of_bounds@PLT
	jmp	.LBB214_4
.LBB214_99:                             # %assert_failed76
	leaq	.Lstr.204(%rip), %rsi
	xorl	%edi, %edi
	xorl	%edx, %edx
	movq	160(%rsp), %rcx                 # 8-byte Reload
	jmp	.LBB214_33
.LBB214_100:                            # %assert_failed77
	movl	%esi, %r8d
	decl	%r8d
	decl	%edi
	movl	%edi, (%rsp)
...
.LBB214_103:                            # %assert_failed82
	leaq	.Lstr.206(%rip), %rsi
	leaq	.Lstr.207(%rip), %rcx
	xorl	%edi, %edi
	movl	80(%rsp), %edx                  # 4-byte Reload
	jmp	.LBB214_39
.LBB214_104:                            # %assert_failed83
	leaq	.Lstr.208(%rip), %rsi
.LBB214_38:                             # %assert_failed18
	leaq	.Lstr.207(%rip), %rcx
	xorl	%edi, %edi
	movl	96(%rsp), %edx                  # 4-byte Reload
.LBB214_39:                             # %assert_failed18
	movl	$1, %r8d
	addq	$392, %rsp                      # imm = 0x188
	popq	%rbx
	popq	%r12
