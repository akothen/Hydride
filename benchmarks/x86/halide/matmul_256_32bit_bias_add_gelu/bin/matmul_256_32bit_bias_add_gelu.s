...
.Lfunc_end213:
	.size	halide_release_jit_module, .Lfunc_end213-halide_release_jit_module
                                        # -- End function
	.section	.text.matmul_256_32bit_bias_add_gelu,"ax",@progbits
	.globl	matmul_256_32bit_bias_add_gelu  # -- Begin function matmul_256_32bit_bias_add_gelu
	.p2align	4, 0x90
	.type	matmul_256_32bit_bias_add_gelu,@function
matmul_256_32bit_bias_add_gelu:         # @matmul_256_32bit_bias_add_gelu
# %bb.0:                                # %entry
	pushq	%rbp
	pushq	%r15
	pushq	%r14
...
# %bb.2:                                # %"for output.s0.c.rebased.preheader"
	...
	testl	%r13d, %r13d
	jle	.LBB214_21
# %bb.3:                                # %"for output.s0.c.rebased.us.us.preheader"
	movslq	%eax, %r8
	movslq	%esi, %rdi
	movl	%edi, %eax
	imull	%r8d, %eax
	...
	.p2align	4, 0x90
.LBB214_4:                              # %"for output.s0.c.rebased.us.us"
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB214_5 Depth 2
                                        #       Child Loop BB214_6 Depth 3
	movl	%eax, -44(%rsp)                 # 4-byte Spill
	subl	-52(%rsp), %eax                 # 4-byte Folded Reload
	movl	%eax, -16(%rsp)                 # 4-byte Spill
	xorl	%eax, %eax
	.p2align	4, 0x90
.LBB214_5:                              # %"for output.s0.y.y.us.us.us"
	...
	.p2align	4, 0x90
.LBB214_6:                              # %"for output.s0.x.x.us.us.us"
                                        #   Parent Loop BB214_4 Depth=1
                                        #     Parent Loop BB214_5 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	cmpl	%r13d, %r10d
	movl	%r13d, %eax
	cmovll	%r10d, %eax
	...
	decl	%r11d
	jne	.LBB214_6
# %bb.7:                                # %"end for output.s0.x.x.loopexit.us.us.us"
                                        #   in Loop: Header=BB214_5 Depth=2
	movq	-64(%rsp), %rax                 # 8-byte Reload
	incl	%eax
	cmpl	-36(%rsp), %eax                 # 4-byte Folded Reload
	movq	-8(%rsp), %rbp                  # 8-byte Reload
	jne	.LBB214_5
# %bb.8:                                # %"end for output.s0.y.y.loopexit.split.us.us.us"
                                        #   in Loop: Header=BB214_4 Depth=1
	movl	-44(%rsp), %eax                 # 4-byte Reload
	incl	%eax
	cmpl	-48(%rsp), %eax                 # 4-byte Folded Reload
	jne	.LBB214_4
# %bb.9:                                # %"end for output.s0.c.rebased"
...
# %bb.10:
	...
	testl	%ebp, %ebp
	jle	.LBB214_19
.LBB214_12:                             # %"for output.s0.c.rebased35.preheader"
	cmpl	$0, -64(%rsp)                   # 4-byte Folded Reload
	jle	.LBB214_19
# %bb.13:                               # %"for output.s0.c.rebased35.us.us.preheader"
	movslq	%esi, %rcx
	imull	%eax, %esi
	...
	movq	%rbp, -8(%rsp)                  # 8-byte Spill
	.p2align	4, 0x90
.LBB214_14:                             # %"for output.s0.c.rebased35.us.us"
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB214_15 Depth 2
	...
	xorl	%eax, %eax
	.p2align	4, 0x90
.LBB214_15:                             # %"for output.s0.y.y46.us.us.us"
                                        #   Parent Loop BB214_14 Depth=1
                                        # =>  This Loop Header: Depth=2
                                        #       Child Loop BB214_16 Depth 3
	movq	%rax, -16(%rsp)                 # 8-byte Spill
	leal	(,%rax,4), %eax
	...
	.p2align	4, 0x90
.LBB214_16:                             # %"for output.s0.x.x74.us.us.us"
                                        #   Parent Loop BB214_14 Depth=1
                                        #     Parent Loop BB214_15 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	movq	-64(%rsp), %rax                 # 8-byte Reload
	cmpl	%eax, %r9d
	movl	%eax, %esi
	...
	decl	%r10d
	jne	.LBB214_16
# %bb.17:                               # %"end for output.s0.x.x75.loopexit.us.us.us"
                                        #   in Loop: Header=BB214_15 Depth=2
	movq	-16(%rsp), %rax                 # 8-byte Reload
	incl	%eax
	cmpl	-36(%rsp), %eax                 # 4-byte Folded Reload
	movq	-8(%rsp), %rbp                  # 8-byte Reload
	jne	.LBB214_15
# %bb.18:                               # %"end for output.s0.y.y47.loopexit.split.us.us.us"
                                        #   in Loop: Header=BB214_14 Depth=1
	movl	-52(%rsp), %eax                 # 4-byte Reload
	incl	%eax
	cmpl	-48(%rsp), %eax                 # 4-byte Folded Reload
	jne	.LBB214_14
.LBB214_19:                             # %destructor_block
	xorl	%eax, %eax
	popq	%rbx
	popq	%r12
	popq	%r13
...
.LBB214_21:
	...
	jmp	.LBB214_19
.Lfunc_end214:
	.size	matmul_256_32bit_bias_add_gelu, .Lfunc_end214-matmul_256_32bit_bias_add_gelu
                                        # -- End function
	.section	.text.matmul_256_32bit_bias_add_gelu_argv,"ax",@progbits
	.globl	matmul_256_32bit_bias_add_gelu_argv # -- Begin function matmul_256_32bit_bias_add_gelu_argv
	.p2align	4, 0x90
	.type	matmul_256_32bit_bias_add_gelu_argv,@function
matmul_256_32bit_bias_add_gelu_argv:    # @matmul_256_32bit_bias_add_gelu_argv
# %bb.0:                                # %entry
	pushq	%rax
	movq	(%rdi), %rax
	movq	8(%rdi), %rsi
	...
	movq	24(%rdi), %rcx
	movq	%rax, %rdi
	callq	matmul_256_32bit_bias_add_gelu@PLT
	xorl	%eax, %eax
	popq	%rcx
	retq
.Lfunc_end215:
	.size	matmul_256_32bit_bias_add_gelu_argv, .Lfunc_end215-matmul_256_32bit_bias_add_gelu_argv
                                        # -- End function
	.section	.text.matmul_256_32bit_bias_add_gelu_metadata,"ax",@progbits
	.globl	matmul_256_32bit_bias_add_gelu_metadata # -- Begin function matmul_256_32bit_bias_add_gelu_metadata
	.p2align	4, 0x90
	.type	matmul_256_32bit_bias_add_gelu_metadata,@function
matmul_256_32bit_bias_add_gelu_metadata: # @matmul_256_32bit_bias_add_gelu_metadata
# %bb.0:                                # %entry
	leaq	.Lmatmul_256_32bit_bias_add_gelu_metadata_storage(%rip), %rax
	retq
.Lfunc_end216:
	.size	matmul_256_32bit_bias_add_gelu_metadata, .Lfunc_end216-matmul_256_32bit_bias_add_gelu_metadata
                                        # -- End function
...
.Lstr.203:
	...
	.p2align	5
.Lstr.204:
	.asciz	"matmul_256_32bit_bias_add_gelu"
	.size	.Lstr.204, 31

	.type	.Lmatmul_256_32bit_bias_add_gelu_metadata_storage,@object # @matmul_256_32bit_bias_add_gelu_metadata_storage
	.section	.data.rel.ro,"aw",@progbits
	.p2align	4
.Lmatmul_256_32bit_bias_add_gelu_metadata_storage:
	.long	1                               # 0x1
	.long	4                               # 0x4
	.quad	.L__unnamed_5
	.quad	.Lstr.203
	.quad	.Lstr.204
	.size	.Lmatmul_256_32bit_bias_add_gelu_metadata_storage, 32
