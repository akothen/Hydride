...
(define v0_1 (bv #xe060c2000000e060c0000000000204000000600020000000000000000000000000000000 288))
(define env_1 (vector v0_1   0 0))
(define sol 
                             (synthesize 
                            #:forall (list v0_0  v0_1  env_0 env_1)
                             #:guarantee 
                            (begin
                             (assert (equal? (interpret sketch-grammar env_0) (index-into-mat (sum v0_0  6 6 3 3 8) 4 4 8 0 0) ))
(assert (equal? (interpret sketch-grammar env_1) (index-into-mat (sum v0_1  6 6 3 3 8) 4 4 8 0 0) ))
