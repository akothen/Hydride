...
entry:
  %call = tail call i8* @halide_default_malloc(i8* %user_context, i32 %x) #12
  ret i8* %call
}
...
entry:
  %call = tail call i32 %f(i8* %user_context, i32 %min, i32 %extent, i8* %closure, i8* %task_parent) #11
  ret i32 %call
}
...
for.body:                                         ; preds = %entry, %for.cond
  ...
  %call = tail call i32 @halide_do_task(i8* %user_context, i32 (i8*, i32, i8*)* %f, i32 %x.012, i8* %closure) #12
...
entry:
  ...
  %call = tail call i32 %0(i8* %user_context, i32 (i8*, i32, i32, i8*, i8*)* %f, i32 %min, i32 %size, i8* %closure, i8* %task_parent) #11
  ret i32 %call
}
...
entry:
  ...
  %call = tail call i32 %0(i8* %user_context, i32 %num_tasks, %struct.halide_parallel_task_t* %tasks, i8* %task_parent) #11
  ret i32 %call
}
...
entry:
  ...
  %call = tail call i32 %0(%struct.halide_semaphore_t* %sema, i32 %count) #11
  ret i32 %call
}
...
entry:
  ...
  %call = tail call zeroext i1 %0(%struct.halide_semaphore_t* %sema, i32 %count) #11
  ret i1 %call
}
...
if.then:                                          ; preds = %_ZN6Halide7Runtime8Internal14ScopedSpinLockC2EPVc.exit
  %call = tail call i8* @getenv(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.7, i32 0, i32 0)) #11
...
if.then6:                                         ; preds = %if.then4
  %call7 = call i8* @halide_string_to_string(i8* %dst, i8* %end, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1.9, i32 0, i32 0)) #12
  br label %cleanup147

if.else:                                          ; preds = %if.then4
  %call8 = call i8* @halide_string_to_string(i8* %dst, i8* %end, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.10, i32 0, i32 0)) #12
  br label %cleanup147
...
if.then11:                                        ; preds = %if.else9
  %call12 = call i8* @halide_string_to_string(i8* %dst, i8* %end, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3.11, i32 0, i32 0)) #12
  br label %cleanup147

if.else13:                                        ; preds = %if.else9
  %call14 = call i8* @halide_string_to_string(i8* %dst, i8* %end, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4.12, i32 0, i32 0)) #12
  br label %cleanup147
...
if.then22:                                        ; preds = %if.then20
  %call23 = call i8* @halide_string_to_string(i8* %dst, i8* %end, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.5.13, i32 0, i32 0)) #12
  br label %cleanup147

if.else24:                                        ; preds = %if.then20
  %call25 = call i8* @halide_string_to_string(i8* %dst, i8* %end, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.6.14, i32 0, i32 0)) #12
  br label %cleanup147
...
if.then28:                                        ; preds = %if.else26
  %call29 = call i8* @halide_string_to_string(i8* %dst, i8* %end, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7.15, i32 0, i32 0)) #12
  br label %cleanup147

if.else30:                                        ; preds = %if.else26
  %call31 = call i8* @halide_string_to_string(i8* %dst, i8* %end, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.8.16, i32 0, i32 0)) #12
  br label %cleanup147
...
if.then34:                                        ; preds = %if.end32
  %call35 = call i8* @halide_string_to_string(i8* %dst, i8* %end, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i32 0, i32 0)) #12
...
while.end43:                                      ; preds = %while.cond40.while.end43_crit_edge, %while.cond40thread-pre-split
  ...
  %call49 = call i8* @halide_int64_to_string(i8* %dst.addr.0, i8* %end, i64 %div46, i32 1) #12
  %call50 = call i8* @halide_string_to_string(i8* %call49, i8* %end, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.30.66, i32 0, i32 0)) #12
  %call51 = call i8* @halide_int64_to_string(i8* %call50, i8* %end, i64 %sub48, i32 6) #12
  %cmp52 = icmp sgt i32 %exponent_base_10.1.lcssa, -1
  br i1 %cmp52, label %if.then53, label %if.else55

if.then53:                                        ; preds = %while.end43
  %call54 = call i8* @halide_string_to_string(i8* %call51, i8* %end, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i32 0, i32 0)) #12
  br label %if.end58

if.else55:                                        ; preds = %while.end43
  %call56 = call i8* @halide_string_to_string(i8* %call51, i8* %end, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.12, i32 0, i32 0)) #12
...
if.end58:                                         ; preds = %if.else55, %if.then53
  ...
  %call60 = call i8* @halide_int64_to_string(i8* %dst.addr.1, i8* %end, i64 %conv59261, i32 2) #12
  br label %cleanup147
...
if.then63:                                        ; preds = %if.else61
  %call64 = call i8* @halide_double_to_string(i8* %dst.addr.0, i8* %end, double 0.000000e+00, i32 0) #12
  br label %cleanup147
...
if.end104:                                        ; preds = %if.end83, %if.end65
  ...
  %call108 = call i8* @halide_int64_to_string(i8* nonnull %add.ptr105, i8* nonnull %add.ptr, i64 %integer_part.2, i32 1) #12
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit.unr-lcssa, %if.end137.epil, %if.end104
  ...
  %call141 = call i8* @halide_string_to_string(i8* %dst.addr.0, i8* %end, i8* %int_part_ptr.0.lcssa) #12
  %call142 = call i8* @halide_string_to_string(i8* %call141, i8* %end, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.30.66, i32 0, i32 0)) #12
  %call143 = call i8* @halide_int64_to_string(i8* %call142, i8* %end, i64 %fractional_part.2, i32 6) #12
...
if.then:                                          ; preds = %sw.epilog
  %call7 = tail call i8* @halide_string_to_string(i8* %call5, i8* %end, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.19, i32 0, i32 0)) #12
...
if.then:                                          ; preds = %entry
  %call = tail call i8* @halide_string_to_string(i8* %dst, i8* %end, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.20, i32 0, i32 0)) #12
  br label %return

if.end:                                           ; preds = %entry
  %call1 = tail call i8* @halide_string_to_string(i8* %dst, i8* %end, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.21, i32 0, i32 0)) #12
  ...
  %call3 = tail call i8* @halide_string_to_string(i8* %call2, i8* %end, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.55, i32 0, i32 0)) #12
  ...
  %call5 = tail call i8* @halide_string_to_string(i8* %call4, i8* %end, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.55, i32 0, i32 0)) #12
  ...
  %call7 = tail call i8* @halide_string_to_string(i8* %call6, i8* %end, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.55, i32 0, i32 0)) #12
  ...
  %call9 = tail call i8* @halide_string_to_string(i8* %call8, i8* %end, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.55, i32 0, i32 0)) #12
...
for.cond.cleanup:                                 ; preds = %for.body, %if.end
  ...
  %call25 = tail call i8* @halide_string_to_string(i8* %dst.addr.0.lcssa, i8* %end, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8.44, i32 0, i32 0)) #12
  br label %return

for.body:                                         ; preds = %for.body, %for.body.lr.ph
  %i.079 = phi i32 [ 0, %for.body.lr.ph ], [ %inc, %for.body ]
  %dst.addr.078 = phi i8* [ %call10, %for.body.lr.ph ], [ %call24, %for.body ]
  %call12 = tail call i8* @halide_string_to_string(i8* %dst.addr.078, i8* %end, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.23, i32 0, i32 0)) #12
  ...
  %call14 = tail call i8* @halide_string_to_string(i8* %call13, i8* %end, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.55, i32 0, i32 0)) #12
  ...
  %call19 = tail call i8* @halide_string_to_string(i8* %call18, i8* %end, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.55, i32 0, i32 0)) #12
  ...
  %call24 = tail call i8* @halide_string_to_string(i8* %call23, i8* %end, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.24, i32 0, i32 0)) #12
...
for.body:                                         ; preds = %if.then, %for.body
  ...
  %call = tail call i32 %0(i8* %user_context) #11
...
if.then:                                          ; preds = %while.body, %while.end
  ...
  %call = tail call i8* @memcpy(i8* %5, i8* %3, i32 %conv5) #11
  br label %if.end
...
for.body:                                         ; preds = %for.body.for.body_crit_edge, %for.body.lr.ph
  ...
  tail call void @_ZN6Halide7Runtime8Internal18copy_memory_helperERKNS1_11device_copyEixx(%"struct.Halide::Runtime::Internal::device_copy"* nonnull align 8 dereferenceable(416) %copy, i32 %sub, i64 %src_off.addr.037, i64 %dst_off.addr.036) #12
...
if.then:                                          ; preds = %entry
  ...
  tail call void @_ZN6Halide7Runtime8Internal18copy_memory_helperERKNS1_11device_copyEixx(%"struct.Halide::Runtime::Internal::device_copy"* nonnull align 8 dereferenceable(416) %copy, i32 15, i64 %2, i64 0) #12
  br label %if.end
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 416, i8* nonnull %0) #13
...
cleanup:                                          ; preds = %while.end, %if.then46, %if.then
  call void @llvm.lifetime.end.p0i8(i64 416, i8* nonnull %0) #13
  ret void
}
...
if.end23:                                         ; preds = %if.end15
  ...
  %call24 = tail call i32 @halide_msan_annotate_buffer_is_initialized(i8* %user_context, %struct.halide_buffer_t* nonnull %buf) #11
  br label %return
...
if.then.i:                                        ; preds = %entry
  %call.i = tail call i32 @halide_error_buffer_is_null(i8* %user_context, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.6.17, i32 0, i32 0)) #11
...
if.then.i:                                        ; preds = %entry
  %call.i = tail call i32 @halide_error_buffer_is_null(i8* %user_context, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.7.18, i32 0, i32 0)) #11
  br label %_ZN12_GLOBAL__N_126debug_log_and_validate_bufEPvPK15halide_buffer_tPKc.exit
...
if.then14:                                        ; preds = %land.lhs.true
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.9.19, i32 0, i32 0)) #11
  br label %cleanup
...
if.else:                                          ; preds = %if.then29
  ...
  %call44 = tail call i32 %9(i8* %user_context, %struct.halide_buffer_t* nonnull %buf) #11
...
if.then.i:                                        ; preds = %entry
  %call.i = tail call i32 @halide_error_buffer_is_null(i8* %user_context, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.17.20, i32 0, i32 0)) #11
  br label %_ZN12_GLOBAL__N_126debug_log_and_validate_bufEPvPK15halide_buffer_tPKc.exit
...
if.then6:                                         ; preds = %if.end
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.20.21, i32 0, i32 0)) #11
  br label %cleanup12
...
if.end7:                                          ; preds = %if.end
  ...
  %call9 = tail call i32 %8(i8* %user_context, %struct.halide_buffer_t* nonnull %buf) #11
...
if.then.i:                                        ; preds = %entry
  %call.i = tail call i32 @halide_error_buffer_is_null(i8* %user_context, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.16.22, i32 0, i32 0)) #11
  br label %_ZN12_GLOBAL__N_126debug_log_and_validate_bufEPvPK15halide_buffer_tPKc.exit
...
if.end5:                                          ; preds = %if.end
  ...
  %call6 = tail call i32 %6(i8* %user_context, %struct.halide_buffer_t* nonnull %buf) #11
...
if.then.i:                                        ; preds = %entry
  %call.i = tail call i32 @halide_error_buffer_is_null(i8* %user_context, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.21.23, i32 0, i32 0)) #11
  br label %_ZN12_GLOBAL__N_126debug_log_and_validate_bufEPvPK15halide_buffer_tPKc.exit
...
if.then3:                                         ; preds = %if.end
  ...
  %call5 = tail call i32 %8(i8* %user_context, %struct.halide_buffer_t* nonnull %buf) #11
  %9 = load %struct.halide_device_interface_impl_t*, %struct.halide_device_interface_impl_t** %impl, align 4, !tbaa !71
  %release_module = getelementptr inbounds %struct.halide_device_interface_impl_t, %struct.halide_device_interface_impl_t* %9, i32 0, i32 1
  %10 = load void ()*, void ()** %release_module, align 4, !tbaa !79
  tail call void %10() #11
...
if.then8:                                         ; preds = %if.then3
  tail call void @halide_print(i8* %user_context, i8* getelementptr inbounds ([157 x i8], [157 x i8]* @.str.22.24, i32 0, i32 0)) #11
...
if.then.i:                                        ; preds = %entry
  %call.i = tail call i32 @halide_error_buffer_is_null(i8* %user_context, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.23.25, i32 0, i32 0)) #11
  br label %_ZN12_GLOBAL__N_126debug_log_and_validate_bufEPvPK15halide_buffer_tPKc.exit
...
if.then6:                                         ; preds = %if.end
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([68 x i8], [68 x i8]* @.str.25.26, i32 0, i32 0)) #11
  br label %cleanup14
...
if.then8:                                         ; preds = %if.then3
  tail call void @halide_print(i8* %user_context, i8* getelementptr inbounds ([157 x i8], [157 x i8]* @.str.28, i32 0, i32 0)) #11
  tail call void @abort() #11
  br label %do.end
...
if.then13:                                        ; preds = %if.else11
  tail call void @halide_free(i8* %user_context, i8* nonnull %12) #11
...
_ZNK15halide_buffer_t13size_in_bytesEv.exit:      ; preds = %if.end._ZNK15halide_buffer_t13size_in_bytesEv.exit_crit_edge, %_ZNK15halide_buffer_t13size_in_bytesEv.exit.loopexit
  ...
  %call2 = tail call i8* @halide_malloc(i8* %user_context, i32 %mul.i) #11
  %host = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %buf, i32 0, i32 2
...
if.then9:                                         ; preds = %if.end6
  ...
  tail call void @halide_free(i8* %user_context, i8* %21) #11
  store i8* null, i8** %host, align 4, !tbaa !43
  br label %cleanup13
...
if.then2:                                         ; preds = %if.end
  tail call void @halide_free(i8* %user_context, i8* nonnull %4) #11
  store i8* null, i8** %host, align 4, !tbaa !43
  br label %if.end5
...
if.end5:                                          ; preds = %if.end
  ...
  %call8 = tail call i32 %8(i8* %user_context, %struct.halide_buffer_t* nonnull %buf, i64 %handle) #11
  %9 = load %struct.halide_device_interface_impl_t*, %struct.halide_device_interface_impl_t** %impl, align 4, !tbaa !71
  %release_module = getelementptr inbounds %struct.halide_device_interface_impl_t, %struct.halide_device_interface_impl_t* %9, i32 0, i32 1
  %10 = load void ()*, void ()** %release_module, align 4, !tbaa !79
  tail call void %10() #11
...
if.then8:                                         ; preds = %if.then3
  tail call void @halide_print(i8* %user_context, i8* getelementptr inbounds ([157 x i8], [157 x i8]* @.str.34, i32 0, i32 0)) #11
  tail call void @abort() #11
  br label %do.end
...
if.then.i:                                        ; preds = %entry
  %call.i = tail call i32 @halide_error_buffer_is_null(i8* %user_context, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.35, i32 0, i32 0)) #11
  br label %_ZN12_GLOBAL__N_126debug_log_and_validate_bufEPvPK15halide_buffer_tPKc.exit
...
if.then:                                          ; preds = %land.lhs.true
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([64 x i8], [64 x i8]* @.str.41, i32 0, i32 0)) #11
  br label %cleanup143
...
if.end49:                                         ; preds = %if.end41
  ...
  %call48 = tail call i32 %12(i8* %user_context, %struct.halide_buffer_t* nonnull %src, %struct.halide_device_interface_t* nonnull %dst_device_interface, %struct.halide_buffer_t* nonnull %dst) #11
...
if.end117.thread258:                              ; preds = %if.end58
  ...
  call void @llvm.lifetime.start.p0i8(i64 416, i8* nonnull %13) #13
  call void @_ZN6Halide7Runtime8Internal16make_buffer_copyEPK15halide_buffer_tbS4_b(%"struct.Halide::Runtime::Internal::device_copy"* nonnull sret(%"struct.Halide::Runtime::Internal::device_copy") align 8 %c, %struct.halide_buffer_t* nonnull %src, i1 zeroext true, %struct.halide_buffer_t* nonnull %dst, i1 zeroext true) #12
  call void @_ZN6Halide7Runtime8Internal11copy_memoryERKNS1_11device_copyEPv(%"struct.Halide::Runtime::Internal::device_copy"* nonnull align 8 dereferenceable(416) %c, i8* %user_context) #12
  call void @llvm.lifetime.end.p0i8(i64 416, i8* nonnull %13) #13
...
if.then66:                                        ; preds = %if.else
  ...
  %call72 = tail call i32 %16(i8* %user_context, %struct.halide_buffer_t* nonnull %src, %struct.halide_device_interface_t* null, %struct.halide_buffer_t* nonnull %dst) #11
  %cmp73 = icmp eq i32 %call72, -42
  br i1 %cmp73, label %if.then74, label %if.end117

if.then74:                                        ; preds = %if.then66
  %call75 = tail call i32 @_ZN6Halide7Runtime8Internal27copy_to_host_already_lockedEPvP15halide_buffer_t(i8* %user_context, %struct.halide_buffer_t* nonnull %src) #12
  %tobool76.not = icmp eq i32 %call75, 0
  br i1 %tobool76.not, label %if.then77, label %cleanup143

if.then77:                                        ; preds = %if.then74
  %call78 = tail call i32 @halide_buffer_copy_already_locked(i8* %user_context, %struct.halide_buffer_t* nonnull %src, %struct.halide_device_interface_t* null, %struct.halide_buffer_t* nonnull %dst) #12
  br label %if.end117
...
if.then85:                                        ; preds = %if.else81
  ...
  %call93 = tail call i32 %19(i8* %user_context, %struct.halide_buffer_t* nonnull %src, %struct.halide_device_interface_t* null, %struct.halide_buffer_t* nonnull %dst) #11
...
if.then95:                                        ; preds = %if.then85
  ...
  %call96 = tail call i32 @copy_to_device_already_locked(i8* %user_context, %struct.halide_buffer_t* nonnull %dst, %struct.halide_device_interface_t* %dst_device_interface) #12
  br label %if.end117
...
if.then100:                                       ; preds = %if.else98
  %call103 = tail call i32 @_ZN6Halide7Runtime8Internal27copy_to_host_already_lockedEPvP15halide_buffer_t(i8* %user_context, %struct.halide_buffer_t* nonnull %src) #12
...
if.then105:                                       ; preds = %if.then100
  ...
  %call108 = tail call i32 %22(i8* %user_context, %struct.halide_buffer_t* nonnull %src, %struct.halide_device_interface_t* nonnull %dst_device_interface, %struct.halide_buffer_t* nonnull %dst) #11
  br label %if.end117
...
entry:
  %call.i = tail call i8* @malloc(i32 1024) #11
  %tobool.not.i = icmp eq i8* %call.i, null
  br i1 %tobool.not.i, label %entry.split, label %if.then6.i

entry.split:                                      ; preds = %entry
  %call.i71 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.36, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i72 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.36, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  ...
  %call.i10 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.16.0, i8* %extern_stage_name) #11
  %call.i13 = tail call i8* @halide_string_to_string(i8* %call.i10, i8* %ref.tmp.sroa.16.0, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.1.37, i32 0, i32 0)) #11
  %conv.i = sext i32 %result to i64
  %call.i16 = tail call i8* @halide_int64_to_string(i8* %call.i13, i8* %ref.tmp.sroa.16.0, i64 %conv.i, i32 1) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i

if.then.i:                                        ; preds = %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.7.92, i32 0, i32 0)) #11
...
if.else.i:                                        ; preds = %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit
  ...
  %call.i.i = tail call i32 @halide_msan_annotate_memory_is_initialized(i8* %user_context, i8* nonnull %call.i, i64 %conv.i.i) #11
  tail call void @halide_error(i8* %user_context, i8* nonnull %call.i) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit: ; preds = %if.else.i, %if.then.i
  tail call void @free(i8* %call.i) #11
  ret i32 %result
}
...
entry.split:                                      ; preds = %entry
  %call.i71 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2.38, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i72 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2.38, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit
...
entry.split:                                      ; preds = %entry
  %call.i151 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.3.39, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i152 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.3.39, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i151, %entry.split ], [ %call.i152, %if.then6.i ]
  %ref.tmp.sroa.34.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i18 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.34.0, i8* %var_name) #11
  %call.i21 = tail call i8* @halide_string_to_string(i8* %call.i18, i8* %ref.tmp.sroa.34.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4.40, i32 0, i32 0)) #11
  %call.i24 = tail call i8* @halide_string_to_string(i8* %call.i21, i8* %ref.tmp.sroa.34.0, i8* %func_name) #11
  %call.i27 = tail call i8* @halide_string_to_string(i8* %call.i24, i8* %ref.tmp.sroa.34.0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5.41, i32 0, i32 0)) #11
  %conv.i = sext i32 %min_bound to i64
  %call.i30 = tail call i8* @halide_int64_to_string(i8* %call.i27, i8* %ref.tmp.sroa.34.0, i64 %conv.i, i32 1) #11
  %call.i33 = tail call i8* @halide_string_to_string(i8* %call.i30, i8* %ref.tmp.sroa.34.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6.42, i32 0, i32 0)) #11
  %conv.i36 = sext i32 %max_bound to i64
  %call.i37 = tail call i8* @halide_int64_to_string(i8* %call.i33, i8* %ref.tmp.sroa.34.0, i64 %conv.i36, i32 1) #11
  %call.i40 = tail call i8* @halide_string_to_string(i8* %call.i37, i8* %ref.tmp.sroa.34.0, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.7.43, i32 0, i32 0)) #11
  %conv.i43 = sext i32 %min_required to i64
  %call.i44 = tail call i8* @halide_int64_to_string(i8* %call.i40, i8* %ref.tmp.sroa.34.0, i64 %conv.i43, i32 1) #11
  %call.i47 = tail call i8* @halide_string_to_string(i8* %call.i44, i8* %ref.tmp.sroa.34.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6.42, i32 0, i32 0)) #11
  %conv.i50 = sext i32 %max_required to i64
  %call.i51 = tail call i8* @halide_int64_to_string(i8* %call.i47, i8* %ref.tmp.sroa.34.0, i64 %conv.i50, i32 1) #11
  %call.i54 = tail call i8* @halide_string_to_string(i8* %call.i51, i8* %ref.tmp.sroa.34.0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8.44, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry:
  ...
  %call = call i8* @memcpy(i8* nonnull %0, i8* nonnull %2, i32 4) #11
  %3 = bitcast i32* %type_given_bits.addr to i8*
  %call1 = call i8* @memcpy(i8* nonnull %1, i8* nonnull %3, i32 4) #11
  %call.i = call i8* @malloc(i32 1024) #11
  %tobool.not.i12 = icmp eq i8* %call.i, null
  br i1 %tobool.not.i12, label %entry.split, label %if.then6.i

entry.split:                                      ; preds = %entry
  %call.i151 = call i8* @halide_string_to_string(i8* null, i8* null, i8* %func_name) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i152 = call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* %func_name) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i151, %entry.split ], [ %call.i152, %if.then6.i ]
  %ref.tmp.sroa.18.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i18 = call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.18.0, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.9.45, i32 0, i32 0)) #11
  %call.i21 = call i8* @halide_type_to_string(i8* %call.i18, i8* %ref.tmp.sroa.18.0, %struct.halide_type_t* nonnull %correct_type) #11
  %call.i24 = call i8* @halide_string_to_string(i8* %call.i21, i8* %ref.tmp.sroa.18.0, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.10.46, i32 0, i32 0)) #11
  %call.i27 = call i8* @halide_type_to_string(i8* %call.i24, i8* %ref.tmp.sroa.18.0, %struct.halide_type_t* nonnull %type_given) #11
  br i1 %tobool.not.i12, label %if.then.i, label %if.else.i

if.then.i:                                        ; preds = %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit
  call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.7.92, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit
...
if.else.i:                                        ; preds = %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit
  ...
  %add.i.i = add i32 %sub.ptr.sub.i.i, %sub.ptr.lhs.cast.i.i
  %conv.i.i = sext i32 %add.i.i to i64
  %call.i.i = call i32 @halide_msan_annotate_memory_is_initialized(i8* %user_context, i8* nonnull %call.i, i64 %conv.i.i) #11
  call void @halide_error(i8* %user_context, i8* nonnull %call.i) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit: ; preds = %if.else.i, %if.then.i
  call void @free(i8* %call.i) #11
...
entry.split:                                      ; preds = %entry
  %call.i81 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* %func_name) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i82 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* %func_name) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i81, %entry.split ], [ %call.i82, %if.then6.i ]
  %ref.tmp.sroa.20.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i11 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.11.47, i32 0, i32 0)) #11
  %conv.i = sext i32 %correct_dimensions to i64
  %call.i14 = tail call i8* @halide_int64_to_string(i8* %call.i11, i8* %ref.tmp.sroa.20.0, i64 %conv.i, i32 1) #11
  %call.i17 = tail call i8* @halide_string_to_string(i8* %call.i14, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.12.48, i32 0, i32 0)) #11
  %conv.i20 = sext i32 %dimensions_given to i64
  %call.i21 = tail call i8* @halide_int64_to_string(i8* %call.i17, i8* %ref.tmp.sroa.20.0, i64 %conv.i20, i32 1) #11
  %call.i24 = tail call i8* @halide_string_to_string(i8* %call.i21, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.13.49, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
if.then.split:                                    ; preds = %if.then
  %call.i271 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* %func_name) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %if.then
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i272 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* %func_name) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %if.then.split, %if.then6.i
  ...
  %call.i30 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.22.0, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.14.50, i32 0, i32 0)) #11
  %conv.i = sext i32 %min_touched to i64
  %call.i33 = tail call i8* @halide_int64_to_string(i8* %call.i30, i8* %ref.tmp.sroa.22.0, i64 %conv.i, i32 1) #11
  %call.i36 = tail call i8* @halide_string_to_string(i8* %call.i33, i8* %ref.tmp.sroa.22.0, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.15.51, i32 0, i32 0)) #11
  %conv.i39 = sext i32 %min_valid to i64
  %call.i40 = tail call i8* @halide_int64_to_string(i8* %call.i36, i8* %ref.tmp.sroa.22.0, i64 %conv.i39, i32 1) #11
  %call.i43 = tail call i8* @halide_string_to_string(i8* %call.i40, i8* %ref.tmp.sroa.22.0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.16.52, i32 0, i32 0)) #11
  %conv.i46 = sext i32 %dimension to i64
  %call.i47 = tail call i8* @halide_int64_to_string(i8* %call.i43, i8* %ref.tmp.sroa.22.0, i64 %conv.i46, i32 1) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
if.then8:                                         ; preds = %if.else
  %call.i53 = tail call i8* @malloc(i32 1024) #11
  %tobool.not.i56 = icmp eq i8* %call.i53, null
  br i1 %tobool.not.i56, label %if.then8.split, label %if.then6.i59

if.then8.split:                                   ; preds = %if.then8
  %call.i653 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* %func_name) #11
...
if.then6.i59:                                     ; preds = %if.then8
  ...
  %call.i654 = tail call i8* @halide_string_to_string(i8* nonnull %call.i53, i8* nonnull %add.ptr.i57, i8* %func_name) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit62
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit62: ; preds = %if.then8.split, %if.then6.i59
  ...
  %call.i68 = tail call i8* @halide_string_to_string(i8* %phi.call5, i8* %ref.tmp9.sroa.22.0, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.14.50, i32 0, i32 0)) #11
  %conv.i71 = sext i32 %max_touched to i64
  %call.i72 = tail call i8* @halide_int64_to_string(i8* %call.i68, i8* %ref.tmp9.sroa.22.0, i64 %conv.i71, i32 1) #11
  %call.i75 = tail call i8* @halide_string_to_string(i8* %call.i72, i8* %ref.tmp9.sroa.22.0, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.17.53, i32 0, i32 0)) #11
  %conv.i78 = sext i32 %max_valid to i64
  %call.i79 = tail call i8* @halide_int64_to_string(i8* %call.i75, i8* %ref.tmp9.sroa.22.0, i64 %conv.i78, i32 1) #11
  %call.i82 = tail call i8* @halide_string_to_string(i8* %call.i79, i8* %ref.tmp9.sroa.22.0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.16.52, i32 0, i32 0)) #11
  %conv.i85 = sext i32 %dimension to i64
  %call.i86 = tail call i8* @halide_int64_to_string(i8* %call.i82, i8* %ref.tmp9.sroa.22.0, i64 %conv.i85, i32 1) #11
...
if.else.i101:                                     ; preds = %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit62
  ...
  %call.i.i100 = tail call i32 @halide_msan_annotate_memory_is_initialized(i8* %user_context, i8* nonnull %call.i53, i64 %conv.i.i99) #11
  tail call void @halide_error(i8* %user_context, i8* nonnull %call.i53) #11
  br label %if.end17.sink.split
...
if.end17.sink.split:                              ; preds = %if.else.i101, %if.then.i90, %if.else.i, %if.then.i
  ...
  tail call void @free(i8* %call.i53.sink) #11
  br label %if.end17
...
entry.split:                                      ; preds = %entry
  %call.i81 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.18.54, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i82 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.18.54, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i81, %entry.split ], [ %call.i82, %if.then6.i ]
  %ref.tmp.sroa.20.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i11 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.20.0, i8* %buffer_name) #11
  %call.i14 = tail call i8* @halide_string_to_string(i8* %call.i11, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.19.55, i32 0, i32 0)) #11
  %call.i17 = tail call i8* @halide_uint64_to_string(i8* %call.i14, i8* %ref.tmp.sroa.20.0, i64 %allocation_size, i32 1) #11
  %call.i20 = tail call i8* @halide_string_to_string(i8* %call.i17, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.20.56, i32 0, i32 0)) #11
  %call.i23 = tail call i8* @halide_uint64_to_string(i8* %call.i20, i8* %ref.tmp.sroa.20.0, i64 %max_size, i32 1) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry.split:                                      ; preds = %entry
  %call.i91 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.21.57, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i92 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.21.57, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i91, %entry.split ], [ %call.i92, %if.then6.i ]
  %ref.tmp.sroa.22.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i12 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.22.0, i8* %buffer_name) #11
  %call.i15 = tail call i8* @halide_string_to_string(i8* %call.i12, i8* %ref.tmp.sroa.22.0, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.22.58, i32 0, i32 0)) #11
  %conv.i = sext i32 %dimension to i64
  %call.i18 = tail call i8* @halide_int64_to_string(i8* %call.i15, i8* %ref.tmp.sroa.22.0, i64 %conv.i, i32 1) #11
  %call.i21 = tail call i8* @halide_string_to_string(i8* %call.i18, i8* %ref.tmp.sroa.22.0, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.23.59, i32 0, i32 0)) #11
  %conv.i24 = sext i32 %extent to i64
  %call.i25 = tail call i8* @halide_int64_to_string(i8* %call.i21, i8* %ref.tmp.sroa.22.0, i64 %conv.i24, i32 1) #11
  %call.i28 = tail call i8* @halide_string_to_string(i8* %call.i25, i8* %ref.tmp.sroa.22.0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8.44, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry.split:                                      ; preds = %entry
  %call.i81 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.24.60, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i82 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.24.60, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  ...
  %call.i11 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.20.0, i8* %buffer_name) #11
  %call.i14 = tail call i8* @halide_string_to_string(i8* %call.i11, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.19.55, i32 0, i32 0)) #11
  %call.i17 = tail call i8* @halide_int64_to_string(i8* %call.i14, i8* %ref.tmp.sroa.20.0, i64 %actual_size, i32 1) #11
  %call.i20 = tail call i8* @halide_string_to_string(i8* %call.i17, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.20.56, i32 0, i32 0)) #11
  %call.i23 = tail call i8* @halide_int64_to_string(i8* %call.i20, i8* %ref.tmp.sroa.20.0, i64 %max_size, i32 1) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry.split:                                      ; preds = %entry
  %call.i231 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.25.61, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i232 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.25.61, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i231, %entry.split ], [ %call.i232, %if.then6.i ]
  %ref.tmp.sroa.38.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i26 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.38.0, i8* %buffer_name) #11
  %call.i29 = tail call i8* @halide_string_to_string(i8* %call.i26, i8* %ref.tmp.sroa.38.0, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.26.62, i32 0, i32 0)) #11
  %conv.i = sext i32 %dimension to i64
  %call.i32 = tail call i8* @halide_int64_to_string(i8* %call.i29, i8* %ref.tmp.sroa.38.0, i64 %conv.i, i32 1) #11
  %call.i35 = tail call i8* @halide_string_to_string(i8* %call.i32, i8* %ref.tmp.sroa.38.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.27.63, i32 0, i32 0)) #11
  %call.i38 = tail call i8* @halide_string_to_string(i8* %call.i35, i8* %ref.tmp.sroa.38.0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.28.64, i32 0, i32 0)) #11
  %conv.i41 = sext i32 %required_min to i64
  %call.i42 = tail call i8* @halide_int64_to_string(i8* %call.i38, i8* %ref.tmp.sroa.38.0, i64 %conv.i41, i32 1) #11
  %call.i45 = tail call i8* @halide_string_to_string(i8* %call.i42, i8* %ref.tmp.sroa.38.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6.42, i32 0, i32 0)) #11
  %conv.i48 = sext i32 %sub to i64
  %call.i49 = tail call i8* @halide_int64_to_string(i8* %call.i45, i8* %ref.tmp.sroa.38.0, i64 %conv.i48, i32 1) #11
  %call.i52 = tail call i8* @halide_string_to_string(i8* %call.i49, i8* %ref.tmp.sroa.38.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.27.63, i32 0, i32 0)) #11
  %call.i55 = tail call i8* @halide_string_to_string(i8* %call.i52, i8* %ref.tmp.sroa.38.0, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.29.65, i32 0, i32 0)) #11
  %conv.i58 = sext i32 %constrained_min to i64
  %call.i59 = tail call i8* @halide_int64_to_string(i8* %call.i55, i8* %ref.tmp.sroa.38.0, i64 %conv.i58, i32 1) #11
  %call.i62 = tail call i8* @halide_string_to_string(i8* %call.i59, i8* %ref.tmp.sroa.38.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6.42, i32 0, i32 0)) #11
  %conv.i65 = sext i32 %sub2 to i64
  %call.i66 = tail call i8* @halide_int64_to_string(i8* %call.i62, i8* %ref.tmp.sroa.38.0, i64 %conv.i65, i32 1) #11
  %call.i69 = tail call i8* @halide_string_to_string(i8* %call.i66, i8* %ref.tmp.sroa.38.0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.30.66, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry.split:                                      ; preds = %entry
  %call.i111 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.31.67, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i112 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.31.67, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i111, %entry.split ], [ %call.i112, %if.then6.i ]
  %ref.tmp.sroa.26.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i14 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.26.0, i8* %var) #11
  %call.i17 = tail call i8* @halide_string_to_string(i8* %call.i14, i8* %ref.tmp.sroa.26.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.32.68, i32 0, i32 0)) #11
  %conv.i = sext i32 %val to i64
  %call.i20 = tail call i8* @halide_int64_to_string(i8* %call.i17, i8* %ref.tmp.sroa.26.0, i64 %conv.i, i32 1) #11
  %call.i23 = tail call i8* @halide_string_to_string(i8* %call.i20, i8* %ref.tmp.sroa.26.0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.33.69, i32 0, i32 0)) #11
  %call.i26 = tail call i8* @halide_string_to_string(i8* %call.i23, i8* %ref.tmp.sroa.26.0, i8* %constrained_var) #11
  %call.i29 = tail call i8* @halide_string_to_string(i8* %call.i26, i8* %ref.tmp.sroa.26.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.32.68, i32 0, i32 0)) #11
  %conv.i32 = sext i32 %constrained_val to i64
  %call.i33 = tail call i8* @halide_int64_to_string(i8* %call.i29, i8* %ref.tmp.sroa.26.0, i64 %conv.i32, i32 1) #11
  %call.i36 = tail call i8* @halide_string_to_string(i8* %call.i33, i8* %ref.tmp.sroa.26.0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8.44, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry.split:                                      ; preds = %entry
  %call.i81 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.34.70, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i82 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.34.70, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i81, %entry.split ], [ %call.i82, %if.then6.i ]
  %ref.tmp.sroa.20.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i11 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.20.0, i8* %param_name) #11
  %call.i14 = tail call i8* @halide_string_to_string(i8* %call.i11, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.19.55, i32 0, i32 0)) #11
  %call.i17 = tail call i8* @halide_int64_to_string(i8* %call.i14, i8* %ref.tmp.sroa.20.0, i64 %val, i32 1) #11
  %call.i20 = tail call i8* @halide_string_to_string(i8* %call.i17, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.35.71, i32 0, i32 0)) #11
  %call.i23 = tail call i8* @halide_int64_to_string(i8* %call.i20, i8* %ref.tmp.sroa.20.0, i64 %min_val, i32 1) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  ...
  %call.i11 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.20.0, i8* %param_name) #11
  %call.i14 = tail call i8* @halide_string_to_string(i8* %call.i11, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.19.55, i32 0, i32 0)) #11
  %call.i17 = tail call i8* @halide_uint64_to_string(i8* %call.i14, i8* %ref.tmp.sroa.20.0, i64 %val, i32 1) #11
  %call.i20 = tail call i8* @halide_string_to_string(i8* %call.i17, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.35.71, i32 0, i32 0)) #11
  %call.i23 = tail call i8* @halide_uint64_to_string(i8* %call.i20, i8* %ref.tmp.sroa.20.0, i64 %min_val, i32 1) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  ...
  %call.i11 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.20.0, i8* %param_name) #11
  %call.i14 = tail call i8* @halide_string_to_string(i8* %call.i11, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.19.55, i32 0, i32 0)) #11
  %call.i17 = tail call i8* @halide_double_to_string(i8* %call.i14, i8* %ref.tmp.sroa.20.0, double %val, i32 1) #11
  %call.i20 = tail call i8* @halide_string_to_string(i8* %call.i17, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.35.71, i32 0, i32 0)) #11
  %call.i23 = tail call i8* @halide_double_to_string(i8* %call.i20, i8* %ref.tmp.sroa.20.0, double %min_val, i32 1) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  ...
  %call.i14 = tail call i8* @halide_string_to_string(i8* %call.i11, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.19.55, i32 0, i32 0)) #11
  %call.i17 = tail call i8* @halide_int64_to_string(i8* %call.i14, i8* %ref.tmp.sroa.20.0, i64 %val, i32 1) #11
  %call.i20 = tail call i8* @halide_string_to_string(i8* %call.i17, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.36.72, i32 0, i32 0)) #11
  %call.i23 = tail call i8* @halide_int64_to_string(i8* %call.i20, i8* %ref.tmp.sroa.20.0, i64 %max_val, i32 1) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  ...
  %call.i17 = tail call i8* @halide_uint64_to_string(i8* %call.i14, i8* %ref.tmp.sroa.20.0, i64 %val, i32 1) #11
  %call.i20 = tail call i8* @halide_string_to_string(i8* %call.i17, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.36.72, i32 0, i32 0)) #11
  %call.i23 = tail call i8* @halide_uint64_to_string(i8* %call.i20, i8* %ref.tmp.sroa.20.0, i64 %max_val, i32 1) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  ...
  %call.i17 = tail call i8* @halide_double_to_string(i8* %call.i14, i8* %ref.tmp.sroa.20.0, double %val, i32 1) #11
  %call.i20 = tail call i8* @halide_string_to_string(i8* %call.i17, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.36.72, i32 0, i32 0)) #11
  %call.i23 = tail call i8* @halide_double_to_string(i8* %call.i20, i8* %ref.tmp.sroa.20.0, double %max_val, i32 1) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry:
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.37, i32 0, i32 0)) #11
  ret i32 -11
}
...
entry.split:                                      ; preds = %entry
  %call.i51 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.38, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i52 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.38, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i51, %entry.split ], [ %call.i52, %if.then6.i ]
  %ref.tmp.sroa.14.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i8 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.14.0, i8* %buffer_name) #11
  %call.i11 = tail call i8* @halide_string_to_string(i8* %call.i8, i8* %ref.tmp.sroa.14.0, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.39, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry.split:                                      ; preds = %entry
  %call.i81 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.40, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i82 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.40, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i81, %entry.split ], [ %call.i82, %if.then6.i ]
  %ref.tmp.sroa.20.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i11 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.20.0, i8* %func) #11
  %call.i14 = tail call i8* @halide_string_to_string(i8* %call.i11, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.41.73, i32 0, i32 0)) #11
  %call.i17 = tail call i8* @halide_string_to_string(i8* %call.i14, i8* %ref.tmp.sroa.20.0, i8* %filename) #11
  %call.i20 = tail call i8* @halide_string_to_string(i8* %call.i17, i8* %ref.tmp.sroa.20.0, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.42, i32 0, i32 0)) #11
  %conv.i = sext i32 %error_code to i64
  %call.i23 = tail call i8* @halide_int64_to_string(i8* %call.i20, i8* %ref.tmp.sroa.20.0, i64 %conv.i, i32 1) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry.split:                                      ; preds = %entry
  %call.i71 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.43, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i72 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.43, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i71, %entry.split ], [ %call.i72, %if.then6.i ]
  %ref.tmp.sroa.18.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i10 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.18.0, i8* %func) #11
  %call.i13 = tail call i8* @halide_string_to_string(i8* %call.i10, i8* %ref.tmp.sroa.18.0, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.44, i32 0, i32 0)) #11
  %conv.i = sext i32 %alignment to i64
  %call.i16 = tail call i8* @halide_int64_to_string(i8* %call.i13, i8* %ref.tmp.sroa.18.0, i64 %conv.i, i32 1) #11
  %call.i19 = tail call i8* @halide_string_to_string(i8* %call.i16, i8* %ref.tmp.sroa.18.0, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.45, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry.split:                                      ; preds = %entry
  %call.i61 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.46, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i62 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.46, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i61, %entry.split ], [ %call.i62, %if.then6.i ]
  %ref.tmp.sroa.16.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i9 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.16.0, i8* %func) #11
  %call.i12 = tail call i8* @halide_string_to_string(i8* %call.i9, i8* %ref.tmp.sroa.16.0, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.47, i32 0, i32 0)) #11
  %call.i15 = tail call i8* @halide_string_to_string(i8* %call.i12, i8* %ref.tmp.sroa.16.0, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.48, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry.split:                                      ; preds = %entry
  %call.i51 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.43, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i52 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.43, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i51, %entry.split ], [ %call.i52, %if.then6.i ]
  %ref.tmp.sroa.14.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i8 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.14.0, i8* %func) #11
  %call.i11 = tail call i8* @halide_string_to_string(i8* %call.i8, i8* %ref.tmp.sroa.14.0, i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.49, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry.split:                                      ; preds = %entry
  %call.i91 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.50, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i92 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.50, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i91, %entry.split ], [ %call.i92, %if.then6.i ]
  %ref.tmp.sroa.22.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i12 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.22.0, i8* %var_name) #11
  %call.i15 = tail call i8* @halide_string_to_string(i8* %call.i12, i8* %ref.tmp.sroa.22.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.51, i32 0, i32 0)) #11
  %call.i18 = tail call i8* @halide_string_to_string(i8* %call.i15, i8* %ref.tmp.sroa.22.0, i8* %func_name) #11
  %call.i21 = tail call i8* @halide_string_to_string(i8* %call.i18, i8* %ref.tmp.sroa.22.0, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.52, i32 0, i32 0)) #11
  %call.i24 = tail call i8* @halide_string_to_string(i8* %call.i21, i8* %ref.tmp.sroa.22.0, i8* %loop_name) #11
  %call.i27 = tail call i8* @halide_string_to_string(i8* %call.i24, i8* %ref.tmp.sroa.22.0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.30.66, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
if.then.split:                                    ; preds = %if.then
  %call.i521 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.53, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %if.then
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i522 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.53, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %if.then.split, %if.then6.i
  ...
  %call.i55 = tail call i8* @halide_int64_to_string(i8* %phi.call, i8* %ref.tmp.sroa.36.0, i64 %conv.i, i32 1) #11
  %call.i58 = tail call i8* @halide_string_to_string(i8* %call.i55, i8* %ref.tmp.sroa.36.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.51, i32 0, i32 0)) #11
  %call.i61 = tail call i8* @halide_string_to_string(i8* %call.i58, i8* %ref.tmp.sroa.36.0, i8* %func_name) #11
  %call.i64 = tail call i8* @halide_string_to_string(i8* %call.i61, i8* %ref.tmp.sroa.36.0, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.54, i32 0, i32 0)) #11
  %conv.i67 = sext i32 %min to i64
  %call.i68 = tail call i8* @halide_int64_to_string(i8* %call.i64, i8* %ref.tmp.sroa.36.0, i64 %conv.i67, i32 1) #11
  %call.i71 = tail call i8* @halide_string_to_string(i8* %call.i68, i8* %ref.tmp.sroa.36.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.55, i32 0, i32 0)) #11
  %add9 = add nsw i32 %extent, %min
  %sub = add nsw i32 %add9, -1
  %conv.i74 = sext i32 %sub to i64
  %call.i75 = tail call i8* @halide_int64_to_string(i8* %call.i71, i8* %ref.tmp.sroa.36.0, i64 %conv.i74, i32 1) #11
  %call.i78 = tail call i8* @halide_string_to_string(i8* %call.i75, i8* %ref.tmp.sroa.36.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.56, i32 0, i32 0)) #11
  %call.i81 = tail call i8* @halide_string_to_string(i8* %call.i78, i8* %ref.tmp.sroa.36.0, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.57, i32 0, i32 0)) #11
  %conv.i84 = sext i32 %valid_min to i64
  %call.i85 = tail call i8* @halide_int64_to_string(i8* %call.i81, i8* %ref.tmp.sroa.36.0, i64 %conv.i84, i32 1) #11
  %call.i88 = tail call i8* @halide_string_to_string(i8* %call.i85, i8* %ref.tmp.sroa.36.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.55, i32 0, i32 0)) #11
  %add15 = add nsw i32 %fold_factor, %valid_min
  %sub16 = add nsw i32 %add15, -1
  %conv.i91 = sext i32 %sub16 to i64
  %call.i92 = tail call i8* @halide_int64_to_string(i8* %call.i88, i8* %ref.tmp.sroa.36.0, i64 %conv.i91, i32 1) #11
  %call.i95 = tail call i8* @halide_string_to_string(i8* %call.i92, i8* %ref.tmp.sroa.36.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.58.74, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
if.else:                                          ; preds = %lor.lhs.false
  %call.i101 = tail call i8* @malloc(i32 1024) #11
  %tobool.not.i104 = icmp eq i8* %call.i101, null
  br i1 %tobool.not.i104, label %if.else.split, label %if.then6.i107

if.else.split:                                    ; preds = %if.else
  %call.i1133 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.53, i32 0, i32 0)) #11
...
if.then6.i107:                                    ; preds = %if.else
  ...
  %call.i1134 = tail call i8* @halide_string_to_string(i8* nonnull %call.i101, i8* nonnull %add.ptr.i105, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.53, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit110
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit110: ; preds = %if.else.split, %if.then6.i107
  ...
  %call.i117 = tail call i8* @halide_int64_to_string(i8* %phi.call5, i8* %ref.tmp19.sroa.34.0, i64 %conv.i116, i32 1) #11
  %call.i120 = tail call i8* @halide_string_to_string(i8* %call.i117, i8* %ref.tmp19.sroa.34.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.51, i32 0, i32 0)) #11
  %call.i123 = tail call i8* @halide_string_to_string(i8* %call.i120, i8* %ref.tmp19.sroa.34.0, i8* %func_name) #11
  %call.i126 = tail call i8* @halide_string_to_string(i8* %call.i123, i8* %ref.tmp19.sroa.34.0, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.54, i32 0, i32 0)) #11
  %conv.i129 = sext i32 %min to i64
  %call.i130 = tail call i8* @halide_int64_to_string(i8* %call.i126, i8* %ref.tmp19.sroa.34.0, i64 %conv.i129, i32 1) #11
  %call.i133 = tail call i8* @halide_string_to_string(i8* %call.i130, i8* %ref.tmp19.sroa.34.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.55, i32 0, i32 0)) #11
  %sub28 = add nsw i32 %add, -1
  %conv.i136 = sext i32 %sub28 to i64
  %call.i137 = tail call i8* @halide_int64_to_string(i8* %call.i133, i8* %ref.tmp19.sroa.34.0, i64 %conv.i136, i32 1) #11
  %call.i140 = tail call i8* @halide_string_to_string(i8* %call.i137, i8* %ref.tmp19.sroa.34.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.56, i32 0, i32 0)) #11
  %call.i143 = tail call i8* @halide_string_to_string(i8* %call.i140, i8* %ref.tmp19.sroa.34.0, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.59.75, i32 0, i32 0)) #11
  %call.i146 = tail call i8* @halide_string_to_string(i8* %call.i143, i8* %ref.tmp19.sroa.34.0, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.60.76, i32 0, i32 0)) #11
  %conv.i149 = sext i32 %fold_factor to i64
  %call.i150 = tail call i8* @halide_int64_to_string(i8* %call.i146, i8* %ref.tmp19.sroa.34.0, i64 %conv.i149, i32 1) #11
  %call.i153 = tail call i8* @halide_string_to_string(i8* %call.i150, i8* %ref.tmp19.sroa.34.0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.30.66, i32 0, i32 0)) #11
...
if.else.i168:                                     ; preds = %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit110
  ...
  %call.i.i167 = tail call i32 @halide_msan_annotate_memory_is_initialized(i8* %user_context, i8* nonnull %call.i101, i64 %conv.i.i166) #11
  tail call void @halide_error(i8* %user_context, i8* nonnull %call.i101) #11
  br label %if.end
...
if.end:                                           ; preds = %if.else.i168, %if.then.i157, %if.else.i, %if.then.i
  ...
  tail call void @free(i8* %call.i101.sink) #11
  ret i32 -35
}
...
entry.split:                                      ; preds = %entry
  %call.i131 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.61.77, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i132 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.61.77, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  ...
  %call.i16 = tail call i8* @halide_int64_to_string(i8* %phi.call, i8* %ref.tmp.sroa.30.0, i64 %conv.i, i32 1) #11
  %call.i19 = tail call i8* @halide_string_to_string(i8* %call.i16, i8* %ref.tmp.sroa.30.0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.62, i32 0, i32 0)) #11
  %call.i22 = tail call i8* @halide_string_to_string(i8* %call.i19, i8* %ref.tmp.sroa.30.0, i8* %var_name) #11
  %call.i25 = tail call i8* @halide_string_to_string(i8* %call.i22, i8* %ref.tmp.sroa.30.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.51, i32 0, i32 0)) #11
  %call.i28 = tail call i8* @halide_string_to_string(i8* %call.i25, i8* %ref.tmp.sroa.30.0, i8* %func_name) #11
  %call.i31 = tail call i8* @halide_string_to_string(i8* %call.i28, i8* %ref.tmp.sroa.30.0, i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.63, i32 0, i32 0)) #11
  %call.i34 = tail call i8* @halide_string_to_string(i8* %call.i31, i8* %ref.tmp.sroa.30.0, i8* %loop_name) #11
  %call.i37 = tail call i8* @halide_string_to_string(i8* %call.i34, i8* %ref.tmp.sroa.30.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.32.68, i32 0, i32 0)) #11
  %conv.i40 = sext i32 %required_extent to i64
  %call.i41 = tail call i8* @halide_int64_to_string(i8* %call.i37, i8* %ref.tmp.sroa.30.0, i64 %conv.i40, i32 1) #11
  %call.i44 = tail call i8* @halide_string_to_string(i8* %call.i41, i8* %ref.tmp.sroa.30.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.64.78, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry.split:                                      ; preds = %entry
  %call.i61 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.65, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i62 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.65, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i61, %entry.split ], [ %call.i62, %if.then6.i ]
  %ref.tmp.sroa.16.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i9 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.16.0, i8* %condition) #11
  %call.i12 = tail call i8* @halide_string_to_string(i8* %call.i9, i8* %ref.tmp.sroa.16.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.66, i32 0, i32 0)) #11
  %call.i15 = tail call i8* @halide_string_to_string(i8* %call.i12, i8* %ref.tmp.sroa.16.0, i8* %message) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
if.then.i:                                        ; preds = %entry
  %call.i41 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.67, i32 0, i32 0)) #11
  %call.i75 = tail call i8* @halide_string_to_string(i8* %call.i41, i8* null, i8* %message) #11
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.7.92, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit
...
if.else.i:                                        ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i42 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.67, i32 0, i32 0)) #11
  %call.i7 = tail call i8* @halide_string_to_string(i8* %call.i42, i8* nonnull %add.ptr.i, i8* %message) #11
...
if.then.i:                                        ; preds = %entry
  %call.i316 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.68, i32 0, i32 0)) #11
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.7.92, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit
...
if.else.i:                                        ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i3 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.68, i32 0, i32 0)) #11
...
if.then.i:                                        ; preds = %entry
  %call.i316 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @.str.69, i32 0, i32 0)) #11
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.7.92, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit
...
if.else.i:                                        ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i3 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @.str.69, i32 0, i32 0)) #11
  %sub.ptr.lhs.cast.i.i = ptrtoint i8* %call.i3 to i32
  %sub.ptr.rhs.cast.i.i = ptrtoint i8* %call.i to i32
  %sub.ptr.sub.i.i = sub i32 1, %sub.ptr.rhs.cast.i.i
  %add.i.i = add i32 %sub.ptr.sub.i.i, %sub.ptr.lhs.cast.i.i
...
if.then.i:                                        ; preds = %entry
  %call.i316 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.70, i32 0, i32 0)) #11
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.7.92, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit
...
if.else.i:                                        ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i3 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.70, i32 0, i32 0)) #11
  %sub.ptr.lhs.cast.i.i = ptrtoint i8* %call.i3 to i32
  %sub.ptr.rhs.cast.i.i = ptrtoint i8* %call.i to i32
  %sub.ptr.sub.i.i = sub i32 1, %sub.ptr.rhs.cast.i.i
  %add.i.i = add i32 %sub.ptr.sub.i.i, %sub.ptr.lhs.cast.i.i
...
entry.split:                                      ; preds = %entry
  %call.i51 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.71, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i52 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.71, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  %phi.call = phi i8* [ %call.i51, %entry.split ], [ %call.i52, %if.then6.i ]
  %ref.tmp.sroa.14.0 = phi i8* [ null, %entry.split ], [ %add.ptr.i, %if.then6.i ]
  %call.i8 = tail call i8* @halide_string_to_string(i8* %phi.call, i8* %ref.tmp.sroa.14.0, i8* %routine) #11
  %call.i11 = tail call i8* @halide_string_to_string(i8* %call.i8, i8* %ref.tmp.sroa.14.0, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.72, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
entry.split:                                      ; preds = %entry
  %call.i111 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.73, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit

if.then6.i:                                       ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i112 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.73, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit
...
_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EEC2EPvPc.exit: ; preds = %entry.split, %if.then6.i
  ...
  %call.i14 = tail call i8* @halide_int64_to_string(i8* %phi.call, i8* %ref.tmp.sroa.26.0, i64 %conv.i, i32 1) #11
  %call.i17 = tail call i8* @halide_string_to_string(i8* %call.i14, i8* %ref.tmp.sroa.26.0, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.62, i32 0, i32 0)) #11
  %call.i20 = tail call i8* @halide_string_to_string(i8* %call.i17, i8* %ref.tmp.sroa.26.0, i8* %var_name) #11
  %call.i23 = tail call i8* @halide_string_to_string(i8* %call.i20, i8* %ref.tmp.sroa.26.0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.51, i32 0, i32 0)) #11
  %call.i26 = tail call i8* @halide_string_to_string(i8* %call.i23, i8* %ref.tmp.sroa.26.0, i8* %func_name) #11
  %call.i29 = tail call i8* @halide_string_to_string(i8* %call.i26, i8* %ref.tmp.sroa.26.0, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.74, i32 0, i32 0)) #11
  %conv.i32 = sext i32 %required_size to i64
  %call.i33 = tail call i8* @halide_int64_to_string(i8* %call.i29, i8* %ref.tmp.sroa.26.0, i64 %conv.i32, i32 1) #11
  %call.i36 = tail call i8* @halide_string_to_string(i8* %call.i33, i8* %ref.tmp.sroa.26.0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.64.78, i32 0, i32 0)) #11
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i
...
if.then.i:                                        ; preds = %entry
  %call.i316 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([77 x i8], [77 x i8]* @.str.75, i32 0, i32 0)) #11
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.7.92, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit
...
if.else.i:                                        ; preds = %entry
  %add.ptr.i = getelementptr inbounds i8, i8* %call.i, i32 1023
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i3 = tail call i8* @halide_string_to_string(i8* nonnull %call.i, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([77 x i8], [77 x i8]* @.str.75, i32 0, i32 0)) #11
  %sub.ptr.lhs.cast.i.i = ptrtoint i8* %call.i3 to i32
  %sub.ptr.rhs.cast.i.i = ptrtoint i8* %call.i to i32
  %sub.ptr.sub.i.i = sub i32 1, %sub.ptr.rhs.cast.i.i
  %add.i.i = add i32 %sub.ptr.sub.i.i, %sub.ptr.lhs.cast.i.i
...
entry:
  %call = tail call i32 @qurt_hvx_lock(i32 1) #11
  %cmp.not = icmp eq i32 %call, 0
  br i1 %cmp.not, label %cleanup, label %if.then

if.then:                                          ; preds = %entry
  %call.i17 = tail call i8* @malloc(i32 1024) #11
  %tobool.not.i19 = icmp eq i8* %call.i17, null
  br i1 %tobool.not.i19, label %if.then.i, label %if.else.i

if.then.i:                                        ; preds = %if.then
  %call.i30 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.4.91, i32 0, i32 0)) #11
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.7.92, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit
...
if.else.i:                                        ; preds = %if.then
  ...
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i = tail call i8* @halide_string_to_string(i8* nonnull %call.i17, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.4.91, i32 0, i32 0)) #11
  %sub.ptr.lhs.cast.i.i = ptrtoint i8* %call.i to i32
  %sub.ptr.rhs.cast.i.i = ptrtoint i8* %call.i17 to i32
  %sub.ptr.sub.i.i = sub i32 1, %sub.ptr.rhs.cast.i.i
  %add.i.i = add i32 %sub.ptr.sub.i.i, %sub.ptr.lhs.cast.i.i
  %conv.i.i = sext i32 %add.i.i to i64
  %call.i.i = tail call i32 @halide_msan_annotate_memory_is_initialized(i8* %user_context, i8* nonnull %call.i17, i64 %conv.i.i) #11
  tail call void @halide_error(i8* %user_context, i8* nonnull %call.i17) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit: ; preds = %if.else.i, %if.then.i
  tail call void @free(i8* %call.i17) #11
  br label %cleanup
...
if.then:                                          ; preds = %entry
  %call.i13 = tail call i8* @malloc(i32 1024) #11
  %tobool.not.i15 = icmp eq i8* %call.i13, null
  br i1 %tobool.not.i15, label %if.then.i, label %if.else.i

if.then.i:                                        ; preds = %if.then
  %call.i26 = tail call i8* @halide_string_to_string(i8* null, i8* null, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.6.93, i32 0, i32 0)) #11
  tail call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.7.92, i32 0, i32 0)) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit
...
if.else.i:                                        ; preds = %if.then
  ...
  store i8 0, i8* %add.ptr.i, align 1, !tbaa !22
  %call.i = tail call i8* @halide_string_to_string(i8* nonnull %call.i13, i8* nonnull %add.ptr.i, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.6.93, i32 0, i32 0)) #11
  %sub.ptr.lhs.cast.i.i = ptrtoint i8* %call.i to i32
  %sub.ptr.rhs.cast.i.i = ptrtoint i8* %call.i13 to i32
  %sub.ptr.sub.i.i = sub i32 1, %sub.ptr.rhs.cast.i.i
  %add.i.i = add i32 %sub.ptr.sub.i.i, %sub.ptr.lhs.cast.i.i
  %conv.i.i = sext i32 %add.i.i to i64
  %call.i.i = tail call i32 @halide_msan_annotate_memory_is_initialized(i8* %user_context, i8* nonnull %call.i13, i64 %conv.i.i) #11
  tail call void @halide_error(i8* %user_context, i8* nonnull %call.i13) #11
  br label %_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit

_ZN6Halide7Runtime8Internal12_GLOBAL__N_17PrinterILNS1_11PrinterTypeE1ELy1024EED2Ev.exit: ; preds = %if.else.i, %if.then.i
  tail call void @free(i8* %call.i13) #11
  br label %cleanup
...
entry:
  %call = tail call i8* @HAP_request_VTCM(i32 %size, i32 1) #11
  ret i8* %call
}
...
entry:
  %call = tail call i32 @HAP_release_VTCM(i8* %addr) #11
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  call void @_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv(%"struct.Halide::Runtime::Internal::CpuFeatures"* nonnull sret(%"struct.Halide::Runtime::Internal::CpuFeatures") align 8 %tmp) #11
  %call = call i8* @memcpy(i8* bitcast ([4 x i64]* @_ZN6Halide7Runtime8Internal27halide_cpu_features_storageE to i8*), i8* nonnull %1, i32 32) #11
...
if.then1:                                         ; preds = %if.end
  call void @halide_error(i8* null, i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str.94, i32 0, i32 0)) #11
  br label %if.end2
...
define i32 @gaussian3x3_hvx128(%struct.halide_buffer_t* noalias nocapture readonly %input.buffer, %struct.halide_buffer_t* noalias nocapture readonly %output.buffer) local_unnamed_addr #9 {
entry:
  %hvx_lock_result = tail call i32 @halide_qurt_hvx_lock(i8* null) #13
...
"for output.s0.y.y.us":                           ; preds = %"for output.s0.y.y.preheader", %"end for output.s0.x.x.loopexit.us"
  %output.s0.y.y.us = phi i32 [ %541, %"end for output.s0.x.x.loopexit.us" ], [ 0, %"for output.s0.y.y.preheader" ]
  %21 = mul nsw i32 %output.s0.y.y.us, %2
  %22 = shl nsw i32 %21, 2
  %23 = add nsw i32 %22, %11
  %24 = getelementptr inbounds i8, i8* %18, i32 %23
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %24, i64 %or6.i) #13, !srcloc !96
...
"for output.s0.x.x.us":                           ; preds = %"for output.s0.y.y.us", %"for output.s0.x.x.us"
  %output.s0.x.x.us = phi i32 [ %540, %"for output.s0.x.x.us" ], [ 0, %"for output.s0.y.y.us" ]
  ...
  %40 = bitcast i8* %39 to <128 x i8>*
  %41 = load <128 x i8>, <128 x i8>* %40, align 1, !tbaa !97
  %42 = bitcast i8* %38 to <128 x i8>*
  %43 = load <128 x i8>, <128 x i8>* %42, align 1, !tbaa !97
  %44 = sub nsw i32 %37, %2
  %45 = getelementptr inbounds i8, i8* %0, i32 %44
  %46 = bitcast i8* %45 to <128 x i8>*
  %47 = load <128 x i8>, <128 x i8>* %46, align 1, !tbaa !97
  %48 = add nsw i32 %37, %2
  %49 = getelementptr inbounds i8, i8* %0, i32 %48
  %50 = bitcast i8* %49 to <128 x i8>*
  %51 = load <128 x i8>, <128 x i8>* %50, align 1, !tbaa !97
  %52 = getelementptr inbounds i8, i8* %38, i32 -1
  %53 = bitcast i8* %52 to <128 x i8>*
  %54 = load <128 x i8>, <128 x i8>* %53, align 1, !tbaa !97
  %55 = getelementptr inbounds i8, i8* %45, i32 -1
  %56 = bitcast i8* %55 to <128 x i8>*
  %57 = load <128 x i8>, <128 x i8>* %56, align 1, !tbaa !97
  %58 = getelementptr inbounds i8, i8* %49, i32 -1
  %59 = bitcast i8* %58 to <128 x i8>*
  %60 = load <128 x i8>, <128 x i8>* %59, align 1, !tbaa !97
  %61 = getelementptr inbounds i8, i8* %45, i32 1
  %62 = bitcast i8* %61 to <128 x i8>*
  %63 = load <128 x i8>, <128 x i8>* %62, align 1, !tbaa !97
  %64 = getelementptr inbounds i8, i8* %49, i32 1
  %65 = bitcast i8* %64 to <128 x i8>*
  %66 = load <128 x i8>, <128 x i8>* %65, align 1, !tbaa !97
  %67 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %66, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %68 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %47, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %69 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %43, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %70 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %69, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %71 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %70, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %72 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %43, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %73 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %72, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %74 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %73, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %75 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %71, <64 x i16> %74, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %76 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %68, <256 x i8> %75, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %77 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %51, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %78 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %76, <128 x i16> %77, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %79 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %47, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %80 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %43, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %81 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %80, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %82 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %81, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %83 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %43, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %84 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %83, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %85 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %84, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %86 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %82, <64 x i16> %85, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %87 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %79, <256 x i8> %86, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %88 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %51, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %89 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %87, <128 x i16> %88, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %90 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %78, <128 x i16> %89, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %91 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %54, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %92 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %54, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %93 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %91, <128 x i16> %92, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %94 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %90, <128 x i16> %93, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %95 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %57, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %96 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %94, <128 x i16> %95, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %97 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %60, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %98 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %96, <128 x i16> %97, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %99 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %41, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %100 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %99, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %101 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %100, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %102 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %41, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %103 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %102, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %104 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %103, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %105 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %101, <64 x i16> %104, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %106 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %98, <256 x i8> %105, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %107 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %63, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %108 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %106, <128 x i16> %107, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %109 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %67, <128 x i16> %108, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %110 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %109, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %111 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16> <i16 1>, <1 x i16> <i16 2>, <128 x i8> %110, <64 x i16> <i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 -1, i32 -1, i32 0) #13
  %112 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>, <1 x i16> zeroinitializer, <64 x i16> %111, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #13
  %113 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %66, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %114 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %47, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %115 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %43, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %116 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %115, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %117 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %116, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %118 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %43, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %119 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %118, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %120 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %119, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %121 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %117, <64 x i16> %120, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %122 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %114, <256 x i8> %121, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %123 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %51, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %124 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %122, <128 x i16> %123, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %125 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %47, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %126 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %43, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %127 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %126, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %128 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %127, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %129 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %43, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %130 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %129, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %131 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %130, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %132 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %128, <64 x i16> %131, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %133 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %125, <256 x i8> %132, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %134 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %51, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %135 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %133, <128 x i16> %134, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %136 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %124, <128 x i16> %135, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %137 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %54, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %138 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %54, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %139 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %137, <128 x i16> %138, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %140 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %136, <128 x i16> %139, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %141 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %57, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %142 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %140, <128 x i16> %141, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %143 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %60, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %144 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %142, <128 x i16> %143, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %145 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %41, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %146 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %145, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %147 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %146, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %148 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %41, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %149 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %148, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %150 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %149, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %151 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %147, <64 x i16> %150, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %152 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %144, <256 x i8> %151, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %153 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %63, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %154 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %152, <128 x i16> %153, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %155 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %113, <128 x i16> %154, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %156 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %155, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %157 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16> <i16 1>, <1 x i16> <i16 2>, <128 x i8> %156, <64 x i16> <i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 -1, i32 -1, i32 0) #13
  %158 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>, <1 x i16> zeroinitializer, <64 x i16> %157, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #13
  %159 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vpackeh_128B_dsl(<64 x i16> %112, <64 x i16> %158, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 2, i32 64, i32 2, i32 8, i32 0) #13
  %160 = add nsw i32 %36, %25
  %161 = shl nsw i32 %160, 2
  %162 = getelementptr inbounds i8, i8* %3, i32 %161
  %163 = bitcast i8* %162 to <128 x i8>*
  store <128 x i8> %159, <128 x i8>* %163, align 1, !tbaa !100
  %164 = shl nsw i32 %output.s0.x.x.us, 7
  %t9.us = add nsw i32 %164, %28
  %165 = getelementptr inbounds i8, i8* %0, i32 %t9.us
  %166 = getelementptr inbounds i8, i8* %165, i32 1
  %167 = bitcast i8* %166 to <128 x i8>*
  %168 = load <128 x i8>, <128 x i8>* %167, align 1, !tbaa !97
  %169 = bitcast i8* %165 to <128 x i8>*
  %170 = load <128 x i8>, <128 x i8>* %169, align 1, !tbaa !97
  %171 = sub nsw i32 %t9.us, %2
  %172 = getelementptr inbounds i8, i8* %0, i32 %171
  %173 = bitcast i8* %172 to <128 x i8>*
  %174 = load <128 x i8>, <128 x i8>* %173, align 1, !tbaa !97
  %175 = add nsw i32 %t9.us, %2
  %176 = getelementptr inbounds i8, i8* %0, i32 %175
  %177 = bitcast i8* %176 to <128 x i8>*
  %178 = load <128 x i8>, <128 x i8>* %177, align 1, !tbaa !97
  %179 = getelementptr inbounds i8, i8* %165, i32 -1
  %180 = bitcast i8* %179 to <128 x i8>*
  %181 = load <128 x i8>, <128 x i8>* %180, align 1, !tbaa !97
  %182 = getelementptr inbounds i8, i8* %172, i32 -1
  %183 = bitcast i8* %182 to <128 x i8>*
  %184 = load <128 x i8>, <128 x i8>* %183, align 1, !tbaa !97
  %185 = getelementptr inbounds i8, i8* %176, i32 -1
  %186 = bitcast i8* %185 to <128 x i8>*
  %187 = load <128 x i8>, <128 x i8>* %186, align 1, !tbaa !97
  %188 = getelementptr inbounds i8, i8* %172, i32 1
  %189 = bitcast i8* %188 to <128 x i8>*
  %190 = load <128 x i8>, <128 x i8>* %189, align 1, !tbaa !97
  %191 = getelementptr inbounds i8, i8* %176, i32 1
  %192 = bitcast i8* %191 to <128 x i8>*
  %193 = load <128 x i8>, <128 x i8>* %192, align 1, !tbaa !97
  %194 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %193, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %195 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %174, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %196 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %170, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %197 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %196, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %198 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %197, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %199 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %170, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %200 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %199, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %201 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %200, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %202 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %198, <64 x i16> %201, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %203 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %195, <256 x i8> %202, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %204 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %178, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %205 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %203, <128 x i16> %204, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %206 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %174, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %207 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %170, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %208 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %207, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %209 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %208, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %210 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %170, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %211 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %210, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %212 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %211, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %213 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %209, <64 x i16> %212, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %214 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %206, <256 x i8> %213, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %215 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %178, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %216 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %214, <128 x i16> %215, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %217 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %205, <128 x i16> %216, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %218 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %181, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %219 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %181, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %220 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %218, <128 x i16> %219, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %221 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %217, <128 x i16> %220, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %222 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %184, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %223 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %221, <128 x i16> %222, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %224 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %187, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %225 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %223, <128 x i16> %224, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %226 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %168, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %227 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %226, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %228 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %227, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %229 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %168, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %230 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %229, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %231 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %230, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %232 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %228, <64 x i16> %231, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %233 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %225, <256 x i8> %232, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %234 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %190, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %235 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %233, <128 x i16> %234, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %236 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %194, <128 x i16> %235, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %237 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %236, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %238 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16> <i16 1>, <1 x i16> <i16 2>, <128 x i8> %237, <64 x i16> <i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 -1, i32 -1, i32 0) #13
  %239 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>, <1 x i16> zeroinitializer, <64 x i16> %238, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #13
  %240 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %193, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %241 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %174, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %242 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %170, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %243 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %242, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %244 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %243, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %245 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %170, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %246 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %245, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %247 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %246, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %248 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %244, <64 x i16> %247, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %249 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %241, <256 x i8> %248, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %250 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %178, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %251 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %249, <128 x i16> %250, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %252 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %174, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %253 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %170, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %254 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %253, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %255 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %254, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %256 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %170, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %257 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %256, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %258 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %257, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %259 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %255, <64 x i16> %258, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %260 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %252, <256 x i8> %259, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %261 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %178, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %262 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %260, <128 x i16> %261, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %263 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %251, <128 x i16> %262, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %264 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %181, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %265 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %181, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %266 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %264, <128 x i16> %265, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %267 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %263, <128 x i16> %266, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %268 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %184, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %269 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %267, <128 x i16> %268, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %270 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %187, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %271 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %269, <128 x i16> %270, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %272 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %168, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %273 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %272, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %274 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %273, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %275 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %168, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %276 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %275, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %277 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %276, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %278 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %274, <64 x i16> %277, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %279 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %271, <256 x i8> %278, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %280 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %190, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %281 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %279, <128 x i16> %280, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %282 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %240, <128 x i16> %281, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %283 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %282, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %284 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16> <i16 1>, <1 x i16> <i16 2>, <128 x i8> %283, <64 x i16> <i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 -1, i32 -1, i32 0) #13
  %285 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>, <1 x i16> zeroinitializer, <64 x i16> %284, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #13
  %286 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vpackeh_128B_dsl(<64 x i16> %239, <64 x i16> %285, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 2, i32 64, i32 2, i32 8, i32 0) #13
  %287 = add nsw i32 %164, %29
  %288 = getelementptr inbounds i8, i8* %3, i32 %287
  %289 = bitcast i8* %288 to <128 x i8>*
  store <128 x i8> %286, <128 x i8>* %289, align 1, !tbaa !100
  %t12.us = add nsw i32 %164, %31
  %290 = getelementptr inbounds i8, i8* %0, i32 %t12.us
  %291 = getelementptr inbounds i8, i8* %290, i32 1
  %292 = bitcast i8* %291 to <128 x i8>*
  %293 = load <128 x i8>, <128 x i8>* %292, align 1, !tbaa !97
  %294 = bitcast i8* %290 to <128 x i8>*
  %295 = load <128 x i8>, <128 x i8>* %294, align 1, !tbaa !97
  %296 = sub nsw i32 %t12.us, %2
  %297 = getelementptr inbounds i8, i8* %0, i32 %296
  %298 = bitcast i8* %297 to <128 x i8>*
  %299 = load <128 x i8>, <128 x i8>* %298, align 1, !tbaa !97
  %300 = add nsw i32 %t12.us, %2
  %301 = getelementptr inbounds i8, i8* %0, i32 %300
  %302 = bitcast i8* %301 to <128 x i8>*
  %303 = load <128 x i8>, <128 x i8>* %302, align 1, !tbaa !97
  %304 = getelementptr inbounds i8, i8* %290, i32 -1
  %305 = bitcast i8* %304 to <128 x i8>*
  %306 = load <128 x i8>, <128 x i8>* %305, align 1, !tbaa !97
  %307 = getelementptr inbounds i8, i8* %297, i32 -1
  %308 = bitcast i8* %307 to <128 x i8>*
  %309 = load <128 x i8>, <128 x i8>* %308, align 1, !tbaa !97
  %310 = getelementptr inbounds i8, i8* %301, i32 -1
  %311 = bitcast i8* %310 to <128 x i8>*
  %312 = load <128 x i8>, <128 x i8>* %311, align 1, !tbaa !97
  %313 = getelementptr inbounds i8, i8* %297, i32 1
  %314 = bitcast i8* %313 to <128 x i8>*
  %315 = load <128 x i8>, <128 x i8>* %314, align 1, !tbaa !97
  %316 = getelementptr inbounds i8, i8* %301, i32 1
  %317 = bitcast i8* %316 to <128 x i8>*
  %318 = load <128 x i8>, <128 x i8>* %317, align 1, !tbaa !97
  %319 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %318, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %320 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %299, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %321 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %295, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %322 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %321, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %323 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %322, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %324 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %295, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %325 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %324, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %326 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %325, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %327 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %323, <64 x i16> %326, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %328 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %320, <256 x i8> %327, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %329 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %303, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %330 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %328, <128 x i16> %329, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %331 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %299, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %332 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %295, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %333 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %332, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %334 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %333, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %335 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %295, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %336 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %335, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %337 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %336, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %338 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %334, <64 x i16> %337, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %339 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %331, <256 x i8> %338, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %340 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %303, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %341 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %339, <128 x i16> %340, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %342 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %330, <128 x i16> %341, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %343 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %306, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %344 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %306, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %345 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %343, <128 x i16> %344, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %346 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %342, <128 x i16> %345, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %347 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %309, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %348 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %346, <128 x i16> %347, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %349 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %312, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %350 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %348, <128 x i16> %349, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %351 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %293, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %352 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %351, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %353 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %352, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %354 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %293, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %355 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %354, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %356 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %355, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %357 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %353, <64 x i16> %356, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %358 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %350, <256 x i8> %357, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %359 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %315, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %360 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %358, <128 x i16> %359, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %361 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %319, <128 x i16> %360, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %362 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %361, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %363 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16> <i16 1>, <1 x i16> <i16 2>, <128 x i8> %362, <64 x i16> <i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 -1, i32 -1, i32 0) #13
  %364 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>, <1 x i16> zeroinitializer, <64 x i16> %363, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #13
  %365 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %318, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %366 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %299, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %367 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %295, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %368 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %367, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %369 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %368, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %370 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %295, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %371 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %370, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %372 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %371, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %373 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %369, <64 x i16> %372, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %374 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %366, <256 x i8> %373, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %375 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %303, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %376 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %374, <128 x i16> %375, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %377 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %299, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %378 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %295, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %379 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %378, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %380 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %379, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %381 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %295, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %382 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %381, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %383 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %382, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %384 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %380, <64 x i16> %383, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %385 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %377, <256 x i8> %384, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %386 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %303, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %387 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %385, <128 x i16> %386, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %388 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %376, <128 x i16> %387, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %389 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %306, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %390 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %306, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %391 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %389, <128 x i16> %390, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %392 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %388, <128 x i16> %391, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %393 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %309, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %394 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %392, <128 x i16> %393, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %395 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %312, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %396 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %394, <128 x i16> %395, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %397 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %293, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %398 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %397, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %399 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %398, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %400 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %293, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %401 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %400, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %402 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %401, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %403 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %399, <64 x i16> %402, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %404 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %396, <256 x i8> %403, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %405 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %315, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %406 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %404, <128 x i16> %405, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %407 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %365, <128 x i16> %406, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %408 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %407, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %409 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16> <i16 1>, <1 x i16> <i16 2>, <128 x i8> %408, <64 x i16> <i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 -1, i32 -1, i32 0) #13
  %410 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>, <1 x i16> zeroinitializer, <64 x i16> %409, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #13
  %411 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vpackeh_128B_dsl(<64 x i16> %364, <64 x i16> %410, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 2, i32 64, i32 2, i32 8, i32 0) #13
  %412 = add nsw i32 %164, %32
  %413 = getelementptr inbounds i8, i8* %3, i32 %412
  %414 = bitcast i8* %413 to <128 x i8>*
  store <128 x i8> %411, <128 x i8>* %414, align 1, !tbaa !100
  %t15.us = add nsw i32 %164, %34
  %415 = getelementptr inbounds i8, i8* %0, i32 %t15.us
  %416 = getelementptr inbounds i8, i8* %415, i32 1
  %417 = bitcast i8* %416 to <128 x i8>*
  %418 = load <128 x i8>, <128 x i8>* %417, align 1, !tbaa !97
  %419 = bitcast i8* %415 to <128 x i8>*
  %420 = load <128 x i8>, <128 x i8>* %419, align 1, !tbaa !97
  %421 = sub nsw i32 %t15.us, %2
  %422 = getelementptr inbounds i8, i8* %0, i32 %421
  %423 = bitcast i8* %422 to <128 x i8>*
  %424 = load <128 x i8>, <128 x i8>* %423, align 1, !tbaa !97
  %425 = add nsw i32 %t15.us, %2
  %426 = getelementptr inbounds i8, i8* %0, i32 %425
  %427 = bitcast i8* %426 to <128 x i8>*
  %428 = load <128 x i8>, <128 x i8>* %427, align 1, !tbaa !97
  %429 = getelementptr inbounds i8, i8* %415, i32 -1
  %430 = bitcast i8* %429 to <128 x i8>*
  %431 = load <128 x i8>, <128 x i8>* %430, align 1, !tbaa !97
  %432 = getelementptr inbounds i8, i8* %422, i32 -1
  %433 = bitcast i8* %432 to <128 x i8>*
  %434 = load <128 x i8>, <128 x i8>* %433, align 1, !tbaa !97
  %435 = getelementptr inbounds i8, i8* %426, i32 -1
  %436 = bitcast i8* %435 to <128 x i8>*
  %437 = load <128 x i8>, <128 x i8>* %436, align 1, !tbaa !97
  %438 = getelementptr inbounds i8, i8* %422, i32 1
  %439 = bitcast i8* %438 to <128 x i8>*
  %440 = load <128 x i8>, <128 x i8>* %439, align 1, !tbaa !97
  %441 = getelementptr inbounds i8, i8* %426, i32 1
  %442 = bitcast i8* %441 to <128 x i8>*
  %443 = load <128 x i8>, <128 x i8>* %442, align 1, !tbaa !97
  %444 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %443, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %445 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %424, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %446 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %420, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %447 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %446, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %448 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %447, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %449 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %420, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %450 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %449, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %451 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %450, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %452 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %448, <64 x i16> %451, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %453 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %445, <256 x i8> %452, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %454 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %428, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %455 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %453, <128 x i16> %454, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %456 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %424, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %457 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %420, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %458 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %457, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %459 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %458, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %460 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %420, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %461 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %460, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %462 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %461, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %463 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %459, <64 x i16> %462, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %464 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %456, <256 x i8> %463, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %465 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %428, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %466 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %464, <128 x i16> %465, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %467 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %455, <128 x i16> %466, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %468 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %431, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %469 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %431, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %470 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %468, <128 x i16> %469, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %471 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %467, <128 x i16> %470, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %472 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %434, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %473 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %471, <128 x i16> %472, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %474 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %437, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %475 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %473, <128 x i16> %474, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %476 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %418, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %477 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %476, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %478 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %477, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %479 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %418, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %480 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %479, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %481 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %480, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %482 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %478, <64 x i16> %481, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %483 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %475, <256 x i8> %482, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %484 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %440, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %485 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %483, <128 x i16> %484, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %486 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %444, <128 x i16> %485, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %487 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %486, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %488 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16> <i16 1>, <1 x i16> <i16 2>, <128 x i8> %487, <64 x i16> <i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 -1, i32 -1, i32 0) #13
  %489 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>, <1 x i16> zeroinitializer, <64 x i16> %488, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #13
  %490 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %443, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %491 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %424, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %492 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %420, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %493 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %492, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %494 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %493, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %495 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %420, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %496 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %495, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %497 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %496, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %498 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %494, <64 x i16> %497, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %499 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %491, <256 x i8> %498, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %500 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %428, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %501 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %499, <128 x i16> %500, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %502 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %424, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %503 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %420, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %504 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %503, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %505 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %504, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %506 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %420, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %507 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %506, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %508 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %507, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %509 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %505, <64 x i16> %508, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %510 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %502, <256 x i8> %509, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %511 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %428, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %512 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %510, <128 x i16> %511, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %513 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %501, <128 x i16> %512, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %514 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %431, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %515 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %431, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %516 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %514, <128 x i16> %515, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %517 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %513, <128 x i16> %516, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %518 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %434, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %519 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %517, <128 x i16> %518, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %520 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %437, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %521 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %519, <128 x i16> %520, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %522 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %418, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %523 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %522, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %524 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %523, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %525 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %418, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %526 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %525, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %527 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %526, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #13
  %528 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %524, <64 x i16> %527, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #13
  %529 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %521, <256 x i8> %528, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %530 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %440, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #13
  %531 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %529, <128 x i16> %530, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %532 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %490, <128 x i16> %531, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #13
  %533 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %532, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #13
  %534 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16> <i16 1>, <1 x i16> <i16 2>, <128 x i8> %533, <64 x i16> <i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 -1, i32 -1, i32 0) #13
  %535 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>, <1 x i16> zeroinitializer, <64 x i16> %534, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #13
  %536 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vpackeh_128B_dsl(<64 x i16> %489, <64 x i16> %535, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 2, i32 64, i32 2, i32 8, i32 0) #13
  %537 = add nsw i32 %164, %35
  %538 = getelementptr inbounds i8, i8* %3, i32 %537
  %539 = bitcast i8* %538 to <128 x i8>*
  store <128 x i8> %536, <128 x i8>* %539, align 1, !tbaa !100
  %540 = add nuw nsw i32 %output.s0.x.x.us, 1
  %.not2.us = icmp eq i32 %540, %16
...
"end for output.s0.x.x.loopexit.us":              ; preds = %"for output.s0.x.x.us"
  %541 = add nuw nsw i32 %output.s0.y.y.us, 1
  %.not.us = icmp eq i32 %541, %9
...
"for output.s0.y.y":                              ; preds = %"for output.s0.y.y", %"for output.s0.y.y.preheader24.new"
  %output.s0.y.y = phi i32 [ 0, %"for output.s0.y.y.preheader24.new" ], [ %581, %"for output.s0.y.y" ]
  %niter = phi i32 [ %unroll_iter, %"for output.s0.y.y.preheader24.new" ], [ %niter.nsub.7, %"for output.s0.y.y" ]
  %542 = mul nsw i32 %output.s0.y.y, %2
  %543 = shl nsw i32 %542, 2
  %544 = add nsw i32 %543, %11
  %545 = getelementptr inbounds i8, i8* %18, i32 %544
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %545, i64 %or6.i) #13, !srcloc !96
  %546 = or i32 %output.s0.y.y, 1
  %547 = mul nsw i32 %546, %2
  %548 = shl nsw i32 %547, 2
  %549 = add nsw i32 %548, %11
  %550 = getelementptr inbounds i8, i8* %18, i32 %549
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %550, i64 %or6.i) #13, !srcloc !96
  %551 = or i32 %output.s0.y.y, 2
  %552 = mul nsw i32 %551, %2
  %553 = shl nsw i32 %552, 2
  %554 = add nsw i32 %553, %11
  %555 = getelementptr inbounds i8, i8* %18, i32 %554
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %555, i64 %or6.i) #13, !srcloc !96
  %556 = or i32 %output.s0.y.y, 3
  %557 = mul nsw i32 %556, %2
  %558 = shl nsw i32 %557, 2
  %559 = add nsw i32 %558, %11
  %560 = getelementptr inbounds i8, i8* %18, i32 %559
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %560, i64 %or6.i) #13, !srcloc !96
  %561 = or i32 %output.s0.y.y, 4
  %562 = mul nsw i32 %561, %2
  %563 = shl nsw i32 %562, 2
  %564 = add nsw i32 %563, %11
  %565 = getelementptr inbounds i8, i8* %18, i32 %564
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %565, i64 %or6.i) #13, !srcloc !96
  %566 = or i32 %output.s0.y.y, 5
  %567 = mul nsw i32 %566, %2
  %568 = shl nsw i32 %567, 2
  %569 = add nsw i32 %568, %11
  %570 = getelementptr inbounds i8, i8* %18, i32 %569
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %570, i64 %or6.i) #13, !srcloc !96
  %571 = or i32 %output.s0.y.y, 6
  %572 = mul nsw i32 %571, %2
  %573 = shl nsw i32 %572, 2
  %574 = add nsw i32 %573, %11
  %575 = getelementptr inbounds i8, i8* %18, i32 %574
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %575, i64 %or6.i) #13, !srcloc !96
  %576 = or i32 %output.s0.y.y, 7
  %577 = mul nsw i32 %576, %2
  %578 = shl nsw i32 %577, 2
  %579 = add nsw i32 %578, %11
  %580 = getelementptr inbounds i8, i8* %18, i32 %579
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %580, i64 %or6.i) #13, !srcloc !96
  %581 = add nuw nsw i32 %output.s0.y.y, 8
  %niter.nsub.7 = add i32 %niter, -8
  %niter.ncmp.7 = icmp eq i32 %niter.nsub.7, 0
...
call_destructor.exit.loopexit25.unr-lcssa:        ; preds = %"for output.s0.y.y", %"for output.s0.y.y.preheader24"
  %output.s0.y.y.unr = phi i32 [ 0, %"for output.s0.y.y.preheader24" ], [ %581, %"for output.s0.y.y" ]
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
...
"for output.s0.y.y.epil":                         ; preds = %call_destructor.exit.loopexit25.unr-lcssa, %"for output.s0.y.y.epil"
  %output.s0.y.y.epil = phi i32 [ %586, %"for output.s0.y.y.epil" ], [ %output.s0.y.y.unr, %call_destructor.exit.loopexit25.unr-lcssa ]
  %epil.iter = phi i32 [ %epil.iter.sub, %"for output.s0.y.y.epil" ], [ %xtraiter, %call_destructor.exit.loopexit25.unr-lcssa ]
  %582 = mul nsw i32 %output.s0.y.y.epil, %2
  %583 = shl nsw i32 %582, 2
  %584 = add nsw i32 %583, %11
  %585 = getelementptr inbounds i8, i8* %18, i32 %584
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %585, i64 %or6.i) #13, !srcloc !96
  %586 = add nuw nsw i32 %output.s0.y.y.epil, 1
  %epil.iter.sub = add i32 %epil.iter, -1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.sub, 0
...
entry:
  ...
  %6 = tail call i32 @gaussian3x3_hvx128(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #14
  ret i32 0
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @gaussian3x3_hvx128_metadata() local_unnamed_addr #10 {
entry:
  ret %struct.halide_filter_metadata_t* @gaussian3x3_hvx128_metadata_storage
}

define <128 x i8> @hydride.node.gaussian3x3_hvx_depth3.0(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8, <128 x i8> %arg.9, <128 x i8> %arg.10, <128 x i8> %arg.11, <128 x i8> %arg.12, <128 x i8> %arg.13, <128 x i8> %arg.14, <128 x i8> %arg.15, <128 x i8> %arg.16, <128 x i8> %arg.17) local_unnamed_addr {
entry:
  %0 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.8, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %1 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.2, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %2 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %3 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %2, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %4 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %3, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %5 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %6 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %5, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %7 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %6, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %8 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %4, <64 x i16> %7, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %9 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %1, <256 x i8> %8, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %10 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.3, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %11 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %9, <128 x i16> %10, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %12 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.2, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %13 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %14 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %13, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %15 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %14, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %16 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %17 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %16, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %18 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %17, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %19 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %15, <64 x i16> %18, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %20 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %12, <256 x i8> %19, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %21 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.3, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %22 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %20, <128 x i16> %21, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %23 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %11, <128 x i16> %22, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %24 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.4, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %25 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.4, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %26 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %24, <128 x i16> %25, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %27 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %23, <128 x i16> %26, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %28 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.5, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %29 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %27, <128 x i16> %28, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %30 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.6, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %31 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %29, <128 x i16> %30, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %32 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  ...
  %34 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %33, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %35 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %36 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %35, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %37 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %36, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %38 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %34, <64 x i16> %37, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %39 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %31, <256 x i8> %38, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %40 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.7, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %41 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %39, <128 x i16> %40, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %42 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %0, <128 x i16> %41, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %43 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %42, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %44 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16> <i16 1>, <1 x i16> <i16 2>, <128 x i8> %43, <64 x i16> <i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 -1, i32 -1, i32 0)
  %45 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>, <1 x i16> zeroinitializer, <64 x i16> %44, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0)
  %46 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.17, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %47 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.11, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %48 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.10, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %49 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %48, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %50 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %49, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %51 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.10, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %52 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %51, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %53 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %52, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %54 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %50, <64 x i16> %53, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %55 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %47, <256 x i8> %54, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %56 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.12, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %57 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %55, <128 x i16> %56, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %58 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.11, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %59 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.10, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %60 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %59, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %61 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %60, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %62 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.10, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %63 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %62, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %64 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %63, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %65 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %61, <64 x i16> %64, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %66 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %58, <256 x i8> %65, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %67 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.12, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %68 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %66, <128 x i16> %67, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %69 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %57, <128 x i16> %68, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %70 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.13, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %71 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.13, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %72 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %70, <128 x i16> %71, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %73 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %69, <128 x i16> %72, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %74 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.14, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %75 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %73, <128 x i16> %74, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %76 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.15, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %77 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %75, <128 x i16> %76, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %78 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.9, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %79 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %78, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %80 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %79, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %81 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.9, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %82 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %81, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %83 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %82, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %84 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %80, <64 x i16> %83, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %85 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %77, <256 x i8> %84, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %86 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.16, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %87 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %85, <128 x i16> %86, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %88 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %46, <128 x i16> %87, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %89 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %88, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %90 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16> <i16 1>, <1 x i16> <i16 2>, <128 x i8> %89, <64 x i16> <i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 -1, i32 -1, i32 0)
  %91 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>, <1 x i16> zeroinitializer, <64 x i16> %90, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0)
  %92 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vpackeh_128B_dsl(<64 x i16> %45, <64 x i16> %91, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 2, i32 64, i32 2, i32 8, i32 0)
  ret <128 x i8> %92
}
...
declare <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16>, <64 x i16>, <128 x i8>, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)
...
declare <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16>, <256 x i8>, i32, i32, i32, i32, i32, i32, i32)

declare <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16>, <128 x i16>, i32, i32, i32, i32, i32, i32, i32)

declare <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16>, <1 x i16>, <128 x i8>, <64 x i16>, i32, i32, i32, i32, i32, i32, i32, i32, i32)

declare <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16>, <1 x i16>, <64 x i16>, i32, i32, i32, i32, i32, i32, i32)
...
entry:
  ...
  %44 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16> <i16 1>, <1 x i16> <i16 2>, <128 x i8> %43, <64 x i16> <i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 -1, i32 -1, i32 0)
  %45 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>, <1 x i16> zeroinitializer, <64 x i16> %44, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0)
  %46 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.16, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %47 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.10, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %48 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %49 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %48, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %50 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %49, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %51 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %52 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %51, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %53 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %52, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %54 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %50, <64 x i16> %53, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %55 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %47, <256 x i8> %54, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %56 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.11, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %57 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %55, <128 x i16> %56, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %58 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.10, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %59 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %60 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %59, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %61 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %60, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %62 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %63 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %62, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %64 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %63, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %65 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %61, <64 x i16> %64, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %66 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %58, <256 x i8> %65, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %67 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.11, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %68 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %66, <128 x i16> %67, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %69 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %57, <128 x i16> %68, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %70 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.12, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %71 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.12, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %72 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %70, <128 x i16> %71, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %73 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %69, <128 x i16> %72, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %74 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.13, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %75 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %73, <128 x i16> %74, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %76 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.14, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %77 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %75, <128 x i16> %76, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %78 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.9, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %79 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %78, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %80 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>, <128 x i8> %79, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  ...
  %84 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %80, <64 x i16> %83, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %85 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %77, <256 x i8> %84, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %86 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.15, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %87 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %85, <128 x i16> %86, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %88 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<128 x i16> %46, <128 x i16> %87, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %89 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %88, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %90 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vavgwrnd_128B_dsl(<1 x i16> <i16 1>, <1 x i16> <i16 2>, <128 x i8> %89, <64 x i16> <i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7, i16 7>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 -1, i32 -1, i32 0)
