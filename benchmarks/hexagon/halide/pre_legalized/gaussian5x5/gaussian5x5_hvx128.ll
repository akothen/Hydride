...
@str.104 = private constant [19 x i8] c"gaussian5x5_hvx128\00", align 32
...
define i32 @gaussian5x5_hvx128_par_for_output_s0_y_y_v1(i8* %__user_context, i32 %output.s0.y.y.v1, i8* nocapture readonly %closure_arg) #10 {
entry:
  ...
  %b3 = load i32, i32* %12, align 4
  %13 = getelementptr inbounds i8, i8* %closure_arg, i32 28
  %14 = bitcast i8* %13 to i32*
  %t158 = load i32, i32* %14, align 4
  %15 = getelementptr inbounds i8, i8* %closure_arg, i32 32
  %16 = bitcast i8* %15 to i32*
  %a11 = load i32, i32* %16, align 4
  %17 = getelementptr inbounds i8, i8* %closure_arg, i32 36
  %18 = bitcast i8* %17 to i32*
  %t171 = load i32, i32* %18, align 4
  %19 = getelementptr inbounds i8, i8* %closure_arg, i32 40
  %20 = bitcast i8* %19 to i32*
  %t172 = load i32, i32* %20, align 4
  %21 = getelementptr inbounds i8, i8* %closure_arg, i32 44
  %22 = bitcast i8* %21 to i32*
  %t174 = load i32, i32* %22, align 4
  %23 = getelementptr inbounds i8, i8* %closure_arg, i32 48
  %24 = bitcast i8* %23 to i32*
  %a50 = load i32, i32* %24, align 4
  %25 = getelementptr inbounds i8, i8* %closure_arg, i32 52
  %26 = bitcast i8* %25 to i1*
  %t154 = load i1, i1* %26, align 1
  %27 = getelementptr inbounds i8, i8* %closure_arg, i32 53
  %28 = bitcast i8* %27 to i1*
  %t159 = load i1, i1* %28, align 1
  %a0 = shl nsw i32 %output.s0.y.y.v1, 7
  %29 = icmp slt i32 %a0, %b3
  %output.s0.y.y.y.base = select i1 %29, i32 %a0, i32 %b3
  %conv9.i = zext i32 %input.stride.1 to i64
  %shl.i = shl nuw i64 %conv9.i, 32
  %conv1.i = sext i32 %t174 to i64
  %shl2.i = shl nsw i64 %conv1.i, 16
  %or.i = or i64 %shl.i, %shl2.i
  %30 = icmp sgt i32 %a11, 0
  %a11.op = shl i32 %a11, 10
  %a11.op.op = or i32 %a11.op, 131
  %31 = select i1 %30, i32 %a11.op.op, i32 131
  %a20 = add nsw i32 %b44, 1
  %b23 = add nsw i32 %input.extent.0, 1
  %32 = add nsw i32 %input.extent.0, -1
  %33 = insertelement <128 x i32> undef, i32 %32, i32 0
  %34 = shufflevector <128 x i32> %33, <128 x i32> undef, <32 x i32> zeroinitializer
  %35 = shl i32 %a11, 7
  %36 = icmp sgt i32 %t158, %t172
  %37 = icmp sgt i32 %a11, %t158
  %a40 = add nsw i32 %b44, -1
  %38 = icmp sgt i32 %a50, 0
  %t291 = select i1 %38, i32 %a50, i32 0
  %39 = shl i32 %t291, 10
  %40 = or i32 %39, 134
  %41 = shl nsw i32 %a11, 1
  %42 = mul nsw i32 %a11, 3
  %43 = shl nsw i32 %a11, 2
  %44 = mul nsw i32 %a11, 5
  %45 = mul nsw i32 %a11, 6
  %46 = shl nsw i32 %a50, 1
  %47 = mul nsw i32 %a11, 7
  %48 = mul nsw i32 %a50, 3
  %49 = icmp sgt i32 %t171, 0
  %50 = getelementptr inbounds i8, i8* %input, i32 -2
  %51 = getelementptr inbounds i8, i8* %input, i32 -2
  %52 = getelementptr inbounds i8, i8* %input, i32 -2
  %53 = getelementptr inbounds i8, i8* %input, i32 -2
  %54 = add i32 %a11, -1
  %55 = sub i32 %t158, %t172
  %56 = xor i32 %t172, -1
  %57 = add i32 %t158, %56
  %58 = sub i32 %a11, %t158
  %xtraiter = and i32 %a11, 1
  %59 = icmp eq i32 %54, 0
  %unroll_iter = and i32 %a11, -2
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  %xtraiter58 = and i32 %55, 7
  %60 = icmp ult i32 %57, 7
  %unroll_iter60 = and i32 %55, -8
  %lcmp.mod59.not = icmp eq i32 %xtraiter58, 0
  %xtraiter62 = and i32 %58, 1
  %61 = icmp eq i32 %54, %t158
  %unroll_iter64 = and i32 %58, -2
  %lcmp.mod63.not = icmp eq i32 %xtraiter62, 0
  %xtraiter66 = and i32 %a11, 1
  %62 = icmp eq i32 %54, 0
  %unroll_iter68 = and i32 %a11, -2
  %lcmp.mod67.not = icmp eq i32 %xtraiter66, 0
  br label %"for output.s0.y.y.y"

"for output.s0.y.y.y":                            ; preds = %entry, %call_destructor.exit39
  %output.s0.y.y.y = phi i32 [ 0, %entry ], [ %1146, %call_destructor.exit39 ]
  %63 = add nsw i32 %output.s0.y.y.y, %output.s0.y.y.y.base
  %64 = shl nsw i32 %63, 2
  %a3 = add nsw i32 %64, 14
  %65 = icmp slt i32 %a3, %b44
  %a2 = select i1 %65, i32 %a3, i32 %b44
  %66 = icmp sgt i32 %a2, 1
  %67 = select i1 %66, i32 %a2, i32 1
  %68 = icmp sle i32 %67, %b44
  %69 = and i1 %t154, %68
  br i1 %69, label %then_bb, label %after_bb

call_destructor.exit:                             ; preds = %call_destructor.exit39
...
after_bb:                                         ; preds = %"for output.s0.y.y.y", %then_bb
  %bounded_input = tail call i8* @halide_malloc(i8* %__user_context, i32 %31)
  %70 = icmp sgt i32 %64, 2
  %a12 = select i1 %70, i32 %64, i32 2
  %b14 = add nsw i32 %64, 8
  %71 = icmp slt i32 %a12, %b14
  %bounded_input.s0.y.prologue.s = select i1 %71, i32 %a12, i32 %b14
  %a15 = add nsw i32 %64, 6
  %72 = icmp slt i32 %a15, %b44
  %a14 = select i1 %72, i32 %a15, i32 %b44
  %b16 = add i32 %bounded_input.s0.y.prologue.s, -2
  %73 = icmp sgt i32 %a14, %b16
  %bounded_input.s0.y.epilogue = select i1 %73, i32 %a14, i32 %b16
  %74 = icmp slt i32 %64, 2
  %a18 = select i1 %74, i32 %64, i32 2
  %75 = icmp sgt i32 %a18, -6
  %76 = select i1 %75, i32 %a18, i32 -6
  %77 = sub nsw i32 2, %76
  %78 = icmp slt i32 %76, 2
  %79 = and i1 %30, %78
  br i1 %79, label %"for bounded_input.s0.y.rebased.us", label %"end for bounded_input.s0.y.rebased", !prof !95

"for bounded_input.s0.y.rebased.us":              ; preds = %after_bb, %"end for bounded_input.s0.x.x.loopexit.us"
  %bounded_input.s0.y.rebased.us = phi i32 [ %208, %"end for bounded_input.s0.x.x.loopexit.us" ], [ 0, %after_bb ]
  %b22.us = add nsw i32 %bounded_input.s0.y.rebased.us, %64
  %80 = icmp slt i32 %a20, %b22.us
  %a23.us = select i1 %80, i32 %a20, i32 %b22.us
  %81 = icmp sgt i32 %a23.us, 2
  %82 = select i1 %81, i32 %a23.us, i32 2
  %83 = add nsw i32 %82, -2
  %84 = mul nsw i32 %83, %input.stride.1
  %85 = mul nsw i32 %bounded_input.s0.y.rebased.us, %a11
  br i1 %59, label %"end for bounded_input.s0.x.x.loopexit.us.unr-lcssa", label %"for bounded_input.s0.x.x.us"

"for bounded_input.s0.x.x.us":                    ; preds = %"for bounded_input.s0.y.rebased.us", %"for bounded_input.s0.x.x.us"
  %bounded_input.s0.x.x.us = phi i32 [ %167, %"for bounded_input.s0.x.x.us" ], [ 0, %"for bounded_input.s0.y.rebased.us" ]
  %niter = phi i32 [ %niter.nsub.1, %"for bounded_input.s0.x.x.us" ], [ %unroll_iter, %"for bounded_input.s0.y.rebased.us" ]
  %a21.us = shl nsw i32 %bounded_input.s0.x.x.us, 7
  %.not30.us = icmp sgt i32 %a21.us, %input.extent.0
  %a24.us = select i1 %.not30.us, i32 %b23, i32 %a21.us
  %86 = icmp sgt i32 %a24.us, 2
  %87 = select i1 %86, i32 %a24.us, i32 2
  %88 = add nsw i32 %87, %84
  %89 = getelementptr inbounds i8, i8* %50, i32 %88
  %90 = bitcast i8* %89 to <32 x i32>*
  %91 = load <32 x i32>, <32 x i32>* %90, align 1, !tbaa !96
  %92 = add nsw i32 %a21.us, -2
  %93 = insertelement <128 x i32> undef, i32 %92, i32 0
  %94 = shufflevector <128 x i32> %93, <128 x i32> undef, <128 x i32> zeroinitializer
  %95 = add nsw <128 x i32> %94, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %96 = shufflevector <128 x i32> %95, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %97 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %96, <32 x i32> %34) #12
  %98 = shufflevector <128 x i32> %95, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %99 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %98, <32 x i32> %34) #12
  %100 = shufflevector <128 x i32> %95, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %101 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %100, <32 x i32> %34) #12
  %102 = shufflevector <128 x i32> %95, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %103 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %102, <32 x i32> %34) #12
  %104 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %97, <32 x i32> zeroinitializer) #12
  %105 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %99, <32 x i32> zeroinitializer) #12
  %106 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %101, <32 x i32> zeroinitializer) #12
  %107 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %103, <32 x i32> zeroinitializer) #12
  %108 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %105, <32 x i32> %104)
  %109 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %107, <32 x i32> %106)
  %110 = shufflevector <64 x i32> %108, <64 x i32> %109, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %111 = sub nsw i32 2, %87
  %112 = insertelement <128 x i32> undef, i32 %111, i32 0
  %113 = shufflevector <128 x i32> %112, <128 x i32> undef, <128 x i32> zeroinitializer
  %114 = add nsw <128 x i32> %110, %113
  %115 = trunc <128 x i32> %114 to <128 x i8>
  %116 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %91)
  %117 = bitcast <128 x i8> %115 to <32 x i32>
  %118 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %117, <32 x i32> %116, i32 0)
  %119 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %118, <32 x i32> %117, <32 x i32> %116, i32 1)
  %120 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %119, <32 x i32> %117, <32 x i32> %116, i32 2)
  %121 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %120, <32 x i32> %117, <32 x i32> %116, i32 3)
  %122 = add nsw i32 %bounded_input.s0.x.x.us, %85
  %123 = shl nsw i32 %122, 7
  %124 = getelementptr inbounds i8, i8* %bounded_input, i32 %123
  %125 = bitcast i8* %124 to <32 x i32>*
  store <32 x i32> %121, <32 x i32>* %125, align 128, !tbaa !99
  %126 = or i32 %bounded_input.s0.x.x.us, 1
  %a21.us.1 = shl nsw i32 %126, 7
  %.not30.us.1 = icmp sgt i32 %a21.us.1, %input.extent.0
  %a24.us.1 = select i1 %.not30.us.1, i32 %b23, i32 %a21.us.1
  %127 = icmp sgt i32 %a24.us.1, 2
  %128 = select i1 %127, i32 %a24.us.1, i32 2
  %129 = add nsw i32 %128, %84
  %130 = getelementptr inbounds i8, i8* %50, i32 %129
  %131 = bitcast i8* %130 to <32 x i32>*
  %132 = load <32 x i32>, <32 x i32>* %131, align 1, !tbaa !96
  %133 = add nsw i32 %a21.us.1, -2
  %134 = insertelement <128 x i32> undef, i32 %133, i32 0
  %135 = shufflevector <128 x i32> %134, <128 x i32> undef, <128 x i32> zeroinitializer
  %136 = add nuw nsw <128 x i32> %135, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  ...
  %138 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %137, <32 x i32> %34) #12
  ...
  %140 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %139, <32 x i32> %34) #12
  ...
  %142 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %141, <32 x i32> %34) #12
  ...
  %144 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %143, <32 x i32> %34) #12
  %145 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %138, <32 x i32> zeroinitializer) #12
  %146 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %140, <32 x i32> zeroinitializer) #12
  %147 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %142, <32 x i32> zeroinitializer) #12
  %148 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %144, <32 x i32> zeroinitializer) #12
  ...
  %152 = sub nsw i32 2, %128
  %153 = insertelement <128 x i32> undef, i32 %152, i32 0
  %154 = shufflevector <128 x i32> %153, <128 x i32> undef, <128 x i32> zeroinitializer
  %155 = add nsw <128 x i32> %151, %154
  %156 = trunc <128 x i32> %155 to <128 x i8>
  %157 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %132)
  %158 = bitcast <128 x i8> %156 to <32 x i32>
  %159 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %158, <32 x i32> %157, i32 0)
  %160 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %159, <32 x i32> %158, <32 x i32> %157, i32 1)
  %161 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %160, <32 x i32> %158, <32 x i32> %157, i32 2)
  %162 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %161, <32 x i32> %158, <32 x i32> %157, i32 3)
  %163 = add nsw i32 %126, %85
  %164 = shl nsw i32 %163, 7
  %165 = getelementptr inbounds i8, i8* %bounded_input, i32 %164
  %166 = bitcast i8* %165 to <32 x i32>*
  store <32 x i32> %162, <32 x i32>* %166, align 128, !tbaa !99
  %167 = add nuw nsw i32 %bounded_input.s0.x.x.us, 2
  %niter.nsub.1 = add i32 %niter, -2
  %niter.ncmp.1 = icmp eq i32 %niter.nsub.1, 0
  br i1 %niter.ncmp.1, label %"end for bounded_input.s0.x.x.loopexit.us.unr-lcssa", label %"for bounded_input.s0.x.x.us"

"end for bounded_input.s0.x.x.loopexit.us.unr-lcssa": ; preds = %"for bounded_input.s0.x.x.us", %"for bounded_input.s0.y.rebased.us"
  %bounded_input.s0.x.x.us.unr = phi i32 [ 0, %"for bounded_input.s0.y.rebased.us" ], [ %167, %"for bounded_input.s0.x.x.us" ]
  br i1 %lcmp.mod.not, label %"end for bounded_input.s0.x.x.loopexit.us", label %"for bounded_input.s0.x.x.us.epil"

"for bounded_input.s0.x.x.us.epil":               ; preds = %"end for bounded_input.s0.x.x.loopexit.us.unr-lcssa"
  %a21.us.epil = shl nsw i32 %bounded_input.s0.x.x.us.unr, 7
  %.not30.us.epil = icmp sgt i32 %a21.us.epil, %input.extent.0
  %a24.us.epil = select i1 %.not30.us.epil, i32 %b23, i32 %a21.us.epil
  %168 = icmp sgt i32 %a24.us.epil, 2
  %169 = select i1 %168, i32 %a24.us.epil, i32 2
  %170 = add nsw i32 %169, %84
  %171 = getelementptr inbounds i8, i8* %50, i32 %170
  %172 = bitcast i8* %171 to <32 x i32>*
  %173 = load <32 x i32>, <32 x i32>* %172, align 1, !tbaa !96
  %174 = add nsw i32 %a21.us.epil, -2
  %175 = insertelement <128 x i32> undef, i32 %174, i32 0
  %176 = shufflevector <128 x i32> %175, <128 x i32> undef, <128 x i32> zeroinitializer
  %177 = add nsw <128 x i32> %176, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %178 = shufflevector <128 x i32> %177, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %179 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %178, <32 x i32> %34) #12
  %180 = shufflevector <128 x i32> %177, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %181 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %180, <32 x i32> %34) #12
  %182 = shufflevector <128 x i32> %177, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %183 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %182, <32 x i32> %34) #12
  %184 = shufflevector <128 x i32> %177, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %185 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %184, <32 x i32> %34) #12
  %186 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %179, <32 x i32> zeroinitializer) #12
  %187 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %181, <32 x i32> zeroinitializer) #12
  %188 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %183, <32 x i32> zeroinitializer) #12
  %189 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %185, <32 x i32> zeroinitializer) #12
  %190 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %187, <32 x i32> %186)
  %191 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %189, <32 x i32> %188)
  %192 = shufflevector <64 x i32> %190, <64 x i32> %191, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %193 = sub nsw i32 2, %169
  %194 = insertelement <128 x i32> undef, i32 %193, i32 0
  %195 = shufflevector <128 x i32> %194, <128 x i32> undef, <128 x i32> zeroinitializer
  %196 = add nsw <128 x i32> %192, %195
  %197 = trunc <128 x i32> %196 to <128 x i8>
  %198 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %173)
  %199 = bitcast <128 x i8> %197 to <32 x i32>
  %200 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %199, <32 x i32> %198, i32 0)
  %201 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %200, <32 x i32> %199, <32 x i32> %198, i32 1)
  %202 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %201, <32 x i32> %199, <32 x i32> %198, i32 2)
  %203 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %202, <32 x i32> %199, <32 x i32> %198, i32 3)
  %204 = add nsw i32 %bounded_input.s0.x.x.us.unr, %85
  %205 = shl nsw i32 %204, 7
  %206 = getelementptr inbounds i8, i8* %bounded_input, i32 %205
  %207 = bitcast i8* %206 to <32 x i32>*
  store <32 x i32> %203, <32 x i32>* %207, align 128, !tbaa !99
  br label %"end for bounded_input.s0.x.x.loopexit.us"

"end for bounded_input.s0.x.x.loopexit.us":       ; preds = %"end for bounded_input.s0.x.x.loopexit.us.unr-lcssa", %"for bounded_input.s0.x.x.us.epil"
  %208 = add nuw nsw i32 %bounded_input.s0.y.rebased.us, 1
  %.not29.us = icmp eq i32 %208, %77
  br i1 %.not29.us, label %"end for bounded_input.s0.y.rebased", label %"for bounded_input.s0.y.rebased.us"

then_bb:                                          ; preds = %"for output.s0.y.y.y"
  %a5 = add nsw i32 %64, 7
  %209 = icmp slt i32 %a5, %b44
  %a4 = select i1 %209, i32 %a5, i32 %b44
  %210 = icmp sgt i32 %a4, 1
  %211 = select i1 %210, i32 %a4, i32 1
  %212 = add nsw i32 %211, -1
  %213 = mul nsw i32 %212, %input.stride.1
  %214 = getelementptr inbounds i8, i8* %input, i32 %213
  %a6 = sub nsw i32 %a2, %211
  %215 = icmp sgt i32 %a6, 0
  %216 = select i1 %215, i32 %a6, i32 0
  %217 = add nuw nsw i32 %216, 1
  %conv4.i = zext i32 %217 to i64
  %or3.i = or i64 %or.i, %conv4.i
  %or6.i = or i64 %or3.i, 281474976710656
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* %214, i64 %or6.i) #12, !srcloc !101
  br label %after_bb

"end for bounded_input.s0.y.rebased":             ; preds = %"end for bounded_input.s0.x.x.loopexit.us", %after_bb
  %a28 = sub nsw i32 %a14, %bounded_input.s0.y.prologue.s
  %218 = icmp sgt i32 %a28, -2
  br i1 %218, label %"for bounded_input.s0.y.rebased1.preheader", label %"end for bounded_input.s0.y.rebased2", !prof !102

"for bounded_input.s0.y.rebased1.preheader":      ; preds = %"end for bounded_input.s0.y.rebased"
  %a28.op = add i32 %a28, 1
...
"for bounded_input.s0.y.rebased1":                ; preds = %"for bounded_input.s0.y.rebased1.preheader", %"end for bounded_input.s0.x.x.rebased8"
  %bounded_input.s0.y.rebased3 = phi i32 [ %610, %"end for bounded_input.s0.x.x.rebased8" ], [ 0, %"for bounded_input.s0.y.rebased1.preheader" ]
  br i1 %t159, label %then_bb5, label %after_bb4

"end for bounded_input.s0.y.rebased2":            ; preds = %"end for bounded_input.s0.x.x.rebased8", %"end for bounded_input.s0.y.rebased"
  %t218.s = sub nsw i32 %64, %bounded_input.s0.y.epilogue
  %219 = icmp sgt i32 %t218.s, -6
  br i1 %219, label %"for bounded_input.s0.y.rebased10.preheader", label %"end for bounded_input.s0.y.rebased11", !prof !102

"for bounded_input.s0.y.rebased10.preheader":     ; preds = %"end for bounded_input.s0.y.rebased2"
  %t223.s = sub i32 2, %64
  %220 = add i32 %t223.s, %bounded_input.s0.y.epilogue
  %221 = add nsw i32 %t218.s, 5
  br i1 %30, label %"for bounded_input.s0.y.rebased10.us", label %"end for bounded_input.s0.y.rebased11.thread", !prof !102

"end for bounded_input.s0.y.rebased11.thread":    ; preds = %"for bounded_input.s0.y.rebased10.preheader"
  %222 = tail call i8* @halide_malloc(i8* %__user_context, i32 %40)
  %rows51 = bitcast i8* %222 to i16*
  br label %"end for rows.s0.x.x"

"for bounded_input.s0.y.rebased10.us":            ; preds = %"for bounded_input.s0.y.rebased10.preheader", %"end for bounded_input.s0.x.x14.loopexit.us"
  %bounded_input.s0.y.rebased12.us = phi i32 [ %350, %"end for bounded_input.s0.x.x14.loopexit.us" ], [ 0, %"for bounded_input.s0.y.rebased10.preheader" ]
  %b42.us = add nsw i32 %bounded_input.s0.y.rebased12.us, %bounded_input.s0.y.epilogue
  %.not21.us = icmp sgt i32 %b44, %b42.us
  %a47.us = select i1 %.not21.us, i32 %b42.us, i32 %a40
  %223 = icmp sgt i32 %a47.us, 0
  %224 = select i1 %223, i32 %a47.us, i32 0
  %225 = mul nsw i32 %224, %input.stride.1
  %226 = add i32 %220, %bounded_input.s0.y.rebased12.us
  %227 = mul nsw i32 %226, %a11
  br i1 %62, label %"end for bounded_input.s0.x.x14.loopexit.us.unr-lcssa", label %"for bounded_input.s0.x.x13.us"

"for bounded_input.s0.x.x13.us":                  ; preds = %"for bounded_input.s0.y.rebased10.us", %"for bounded_input.s0.x.x13.us"
  %bounded_input.s0.x.x15.us = phi i32 [ %309, %"for bounded_input.s0.x.x13.us" ], [ 0, %"for bounded_input.s0.y.rebased10.us" ]
  %niter69 = phi i32 [ %niter69.nsub.1, %"for bounded_input.s0.x.x13.us" ], [ %unroll_iter68, %"for bounded_input.s0.y.rebased10.us" ]
  %a45.us = shl nsw i32 %bounded_input.s0.x.x15.us, 7
  %.not23.us = icmp sgt i32 %a45.us, %input.extent.0
  %a48.us = select i1 %.not23.us, i32 %b23, i32 %a45.us
  %228 = icmp sgt i32 %a48.us, 2
  %229 = select i1 %228, i32 %a48.us, i32 2
  %230 = add nsw i32 %229, %225
  %231 = getelementptr inbounds i8, i8* %53, i32 %230
  %232 = bitcast i8* %231 to <32 x i32>*
  %233 = load <32 x i32>, <32 x i32>* %232, align 1, !tbaa !96
  %234 = add nsw i32 %a45.us, -2
  %235 = insertelement <128 x i32> undef, i32 %234, i32 0
  %236 = shufflevector <128 x i32> %235, <128 x i32> undef, <128 x i32> zeroinitializer
  %237 = add nsw <128 x i32> %236, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %238 = shufflevector <128 x i32> %237, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %239 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %238, <32 x i32> %34) #12
  %240 = shufflevector <128 x i32> %237, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %241 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %240, <32 x i32> %34) #12
  %242 = shufflevector <128 x i32> %237, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %243 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %242, <32 x i32> %34) #12
  %244 = shufflevector <128 x i32> %237, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %245 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %244, <32 x i32> %34) #12
  %246 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %239, <32 x i32> zeroinitializer) #12
  %247 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %241, <32 x i32> zeroinitializer) #12
  %248 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %243, <32 x i32> zeroinitializer) #12
  %249 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %245, <32 x i32> zeroinitializer) #12
  %250 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %247, <32 x i32> %246)
  %251 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %249, <32 x i32> %248)
  %252 = shufflevector <64 x i32> %250, <64 x i32> %251, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %253 = sub nsw i32 2, %229
  %254 = insertelement <128 x i32> undef, i32 %253, i32 0
  %255 = shufflevector <128 x i32> %254, <128 x i32> undef, <128 x i32> zeroinitializer
  %256 = add nsw <128 x i32> %252, %255
  %257 = trunc <128 x i32> %256 to <128 x i8>
  %258 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %233)
  %259 = bitcast <128 x i8> %257 to <32 x i32>
  %260 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %259, <32 x i32> %258, i32 0)
  %261 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %260, <32 x i32> %259, <32 x i32> %258, i32 1)
  %262 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %261, <32 x i32> %259, <32 x i32> %258, i32 2)
  %263 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %262, <32 x i32> %259, <32 x i32> %258, i32 3)
  %264 = add nsw i32 %bounded_input.s0.x.x15.us, %227
  %265 = shl nsw i32 %264, 7
  %266 = getelementptr inbounds i8, i8* %bounded_input, i32 %265
  %267 = bitcast i8* %266 to <32 x i32>*
  store <32 x i32> %263, <32 x i32>* %267, align 128, !tbaa !99
  %268 = or i32 %bounded_input.s0.x.x15.us, 1
  %a45.us.1 = shl nsw i32 %268, 7
  %.not23.us.1 = icmp sgt i32 %a45.us.1, %input.extent.0
  %a48.us.1 = select i1 %.not23.us.1, i32 %b23, i32 %a45.us.1
  %269 = icmp sgt i32 %a48.us.1, 2
  %270 = select i1 %269, i32 %a48.us.1, i32 2
  %271 = add nsw i32 %270, %225
  %272 = getelementptr inbounds i8, i8* %53, i32 %271
  %273 = bitcast i8* %272 to <32 x i32>*
  %274 = load <32 x i32>, <32 x i32>* %273, align 1, !tbaa !96
  %275 = add nsw i32 %a45.us.1, -2
  %276 = insertelement <128 x i32> undef, i32 %275, i32 0
  %277 = shufflevector <128 x i32> %276, <128 x i32> undef, <128 x i32> zeroinitializer
  %278 = add nuw nsw <128 x i32> %277, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %279 = shufflevector <128 x i32> %278, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %280 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %279, <32 x i32> %34) #12
  %281 = shufflevector <128 x i32> %278, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %282 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %281, <32 x i32> %34) #12
  %283 = shufflevector <128 x i32> %278, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %284 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %283, <32 x i32> %34) #12
  %285 = shufflevector <128 x i32> %278, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %286 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %285, <32 x i32> %34) #12
  %287 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %280, <32 x i32> zeroinitializer) #12
  %288 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %282, <32 x i32> zeroinitializer) #12
  %289 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %284, <32 x i32> zeroinitializer) #12
  %290 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %286, <32 x i32> zeroinitializer) #12
  %291 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %288, <32 x i32> %287)
  %292 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %290, <32 x i32> %289)
  %293 = shufflevector <64 x i32> %291, <64 x i32> %292, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %294 = sub nsw i32 2, %270
  %295 = insertelement <128 x i32> undef, i32 %294, i32 0
  %296 = shufflevector <128 x i32> %295, <128 x i32> undef, <128 x i32> zeroinitializer
  %297 = add nsw <128 x i32> %293, %296
  %298 = trunc <128 x i32> %297 to <128 x i8>
  %299 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %274)
  %300 = bitcast <128 x i8> %298 to <32 x i32>
  %301 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %300, <32 x i32> %299, i32 0)
  %302 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %301, <32 x i32> %300, <32 x i32> %299, i32 1)
  %303 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %302, <32 x i32> %300, <32 x i32> %299, i32 2)
  %304 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %303, <32 x i32> %300, <32 x i32> %299, i32 3)
  %305 = add nsw i32 %268, %227
  %306 = shl nsw i32 %305, 7
  %307 = getelementptr inbounds i8, i8* %bounded_input, i32 %306
  %308 = bitcast i8* %307 to <32 x i32>*
  store <32 x i32> %304, <32 x i32>* %308, align 128, !tbaa !99
  %309 = add nuw nsw i32 %bounded_input.s0.x.x15.us, 2
  %niter69.nsub.1 = add i32 %niter69, -2
  %niter69.ncmp.1 = icmp eq i32 %niter69.nsub.1, 0
  br i1 %niter69.ncmp.1, label %"end for bounded_input.s0.x.x14.loopexit.us.unr-lcssa", label %"for bounded_input.s0.x.x13.us"

"end for bounded_input.s0.x.x14.loopexit.us.unr-lcssa": ; preds = %"for bounded_input.s0.x.x13.us", %"for bounded_input.s0.y.rebased10.us"
  %bounded_input.s0.x.x15.us.unr = phi i32 [ 0, %"for bounded_input.s0.y.rebased10.us" ], [ %309, %"for bounded_input.s0.x.x13.us" ]
  br i1 %lcmp.mod67.not, label %"end for bounded_input.s0.x.x14.loopexit.us", label %"for bounded_input.s0.x.x13.us.epil"

"for bounded_input.s0.x.x13.us.epil":             ; preds = %"end for bounded_input.s0.x.x14.loopexit.us.unr-lcssa"
  %a45.us.epil = shl nsw i32 %bounded_input.s0.x.x15.us.unr, 7
  %.not23.us.epil = icmp sgt i32 %a45.us.epil, %input.extent.0
  %a48.us.epil = select i1 %.not23.us.epil, i32 %b23, i32 %a45.us.epil
  %310 = icmp sgt i32 %a48.us.epil, 2
  %311 = select i1 %310, i32 %a48.us.epil, i32 2
  %312 = add nsw i32 %311, %225
  %313 = getelementptr inbounds i8, i8* %53, i32 %312
  %314 = bitcast i8* %313 to <32 x i32>*
  %315 = load <32 x i32>, <32 x i32>* %314, align 1, !tbaa !96
  %316 = add nsw i32 %a45.us.epil, -2
  %317 = insertelement <128 x i32> undef, i32 %316, i32 0
  %318 = shufflevector <128 x i32> %317, <128 x i32> undef, <128 x i32> zeroinitializer
  %319 = add nsw <128 x i32> %318, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %320 = shufflevector <128 x i32> %319, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %321 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %320, <32 x i32> %34) #12
  %322 = shufflevector <128 x i32> %319, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %323 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %322, <32 x i32> %34) #12
  %324 = shufflevector <128 x i32> %319, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %325 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %324, <32 x i32> %34) #12
  %326 = shufflevector <128 x i32> %319, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %327 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %326, <32 x i32> %34) #12
  %328 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %321, <32 x i32> zeroinitializer) #12
  %329 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %323, <32 x i32> zeroinitializer) #12
  %330 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %325, <32 x i32> zeroinitializer) #12
  %331 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %327, <32 x i32> zeroinitializer) #12
  %332 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %329, <32 x i32> %328)
  %333 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %331, <32 x i32> %330)
  %334 = shufflevector <64 x i32> %332, <64 x i32> %333, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %335 = sub nsw i32 2, %311
  %336 = insertelement <128 x i32> undef, i32 %335, i32 0
  %337 = shufflevector <128 x i32> %336, <128 x i32> undef, <128 x i32> zeroinitializer
  %338 = add nsw <128 x i32> %334, %337
  %339 = trunc <128 x i32> %338 to <128 x i8>
  %340 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %315)
  %341 = bitcast <128 x i8> %339 to <32 x i32>
  %342 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %341, <32 x i32> %340, i32 0)
  %343 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %342, <32 x i32> %341, <32 x i32> %340, i32 1)
  %344 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %343, <32 x i32> %341, <32 x i32> %340, i32 2)
  %345 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %344, <32 x i32> %341, <32 x i32> %340, i32 3)
  %346 = add nsw i32 %bounded_input.s0.x.x15.us.unr, %227
  %347 = shl nsw i32 %346, 7
  %348 = getelementptr inbounds i8, i8* %bounded_input, i32 %347
  %349 = bitcast i8* %348 to <32 x i32>*
  store <32 x i32> %345, <32 x i32>* %349, align 128, !tbaa !99
  br label %"end for bounded_input.s0.x.x14.loopexit.us"

"end for bounded_input.s0.x.x14.loopexit.us":     ; preds = %"end for bounded_input.s0.x.x14.loopexit.us.unr-lcssa", %"for bounded_input.s0.x.x13.us.epil"
  %350 = add nuw nsw i32 %bounded_input.s0.y.rebased12.us, 1
  %.not22.us = icmp eq i32 %bounded_input.s0.y.rebased12.us, %221
  br i1 %.not22.us, label %"end for bounded_input.s0.y.rebased11", label %"for bounded_input.s0.y.rebased10.us"

after_bb4:                                        ; preds = %"for bounded_input.s0.y.rebased1", %then_bb5
  %t277 = sub nsw i32 %bounded_input.s0.y.rebased3, %76
  br i1 %36, label %"for bounded_input.s0.x.x.rebased.preheader", label %"end for bounded_input.s0.x.x.rebased", !prof !102

"for bounded_input.s0.x.x.rebased.preheader":     ; preds = %after_bb4
  %351 = add i32 %b16, %bounded_input.s0.y.rebased3
  %352 = mul nsw i32 %351, %input.stride.1
  %353 = add nsw i32 %t277, 2
  %354 = mul nsw i32 %353, %a11
  br i1 %60, label %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa", label %"for bounded_input.s0.x.x.rebased"

then_bb5:                                         ; preds = %"for bounded_input.s0.y.rebased1"
  %355 = add i32 %b16, %bounded_input.s0.y.rebased3
  %356 = mul nsw i32 %355, %input.stride.1
  %357 = getelementptr inbounds i8, i8* %input, i32 %356
  %358 = bitcast i8* %357 to <32 x i32>*
  %359 = load <32 x i32>, <32 x i32>* %358, align 1, !tbaa !96
  %360 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> <i32 -2, i32 -1, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29>, <32 x i32> %34) #12
  %361 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> <i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61>, <32 x i32> %34) #12
  %362 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> <i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93>, <32 x i32> %34) #12
  %363 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> <i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125>, <32 x i32> %34) #12
  %364 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %360, <32 x i32> zeroinitializer) #12
  %365 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %361, <32 x i32> zeroinitializer) #12
  %366 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %362, <32 x i32> zeroinitializer) #12
  %367 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %363, <32 x i32> zeroinitializer) #12
  %368 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %365, <32 x i32> %364)
  %369 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %367, <32 x i32> %366)
  %370 = shufflevector <64 x i32> %368, <64 x i32> %369, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %371 = trunc <128 x i32> %370 to <128 x i8>
  %372 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %359)
  %373 = bitcast <128 x i8> %371 to <32 x i32>
  %374 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %373, <32 x i32> %372, i32 0)
  %375 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %374, <32 x i32> %373, <32 x i32> %372, i32 1)
  %376 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %375, <32 x i32> %373, <32 x i32> %372, i32 2)
  %377 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %376, <32 x i32> %373, <32 x i32> %372, i32 3)
  %378 = add i32 %77, %bounded_input.s0.y.rebased3
  %379 = mul i32 %35, %378
  %380 = getelementptr inbounds i8, i8* %bounded_input, i32 %379
  %381 = bitcast i8* %380 to <32 x i32>*
  store <32 x i32> %377, <32 x i32>* %381, align 128, !tbaa !99
  br label %after_bb4

"for bounded_input.s0.x.x.rebased":               ; preds = %"for bounded_input.s0.x.x.rebased.preheader", %"for bounded_input.s0.x.x.rebased"
  %bounded_input.s0.x.x.rebased = phi i32 [ %469, %"for bounded_input.s0.x.x.rebased" ], [ 0, %"for bounded_input.s0.x.x.rebased.preheader" ]
  %niter61 = phi i32 [ %niter61.nsub.7, %"for bounded_input.s0.x.x.rebased" ], [ %unroll_iter60, %"for bounded_input.s0.x.x.rebased.preheader" ]
  %382 = add nsw i32 %bounded_input.s0.x.x.rebased, %t172
  %383 = shl nsw i32 %382, 7
  %384 = add nsw i32 %383, %352
  %385 = getelementptr inbounds i8, i8* %51, i32 %384
  %386 = bitcast i8* %385 to <128 x i8>*
  %387 = load <128 x i8>, <128 x i8>* %386, align 1, !tbaa !96
  %388 = add i32 %382, %354
  %389 = shl nsw i32 %388, 7
  %390 = getelementptr inbounds i8, i8* %bounded_input, i32 %389
  %391 = bitcast i8* %390 to <128 x i8>*
  store <128 x i8> %387, <128 x i8>* %391, align 128, !tbaa !99
  %392 = or i32 %bounded_input.s0.x.x.rebased, 1
  %393 = add nsw i32 %392, %t172
  %394 = shl nsw i32 %393, 7
  %395 = add nsw i32 %394, %352
  %396 = getelementptr inbounds i8, i8* %51, i32 %395
  %397 = bitcast i8* %396 to <128 x i8>*
  %398 = load <128 x i8>, <128 x i8>* %397, align 1, !tbaa !96
  %399 = add i32 %393, %354
  %400 = shl nsw i32 %399, 7
  %401 = getelementptr inbounds i8, i8* %bounded_input, i32 %400
  %402 = bitcast i8* %401 to <128 x i8>*
  store <128 x i8> %398, <128 x i8>* %402, align 128, !tbaa !99
  %403 = or i32 %bounded_input.s0.x.x.rebased, 2
  %404 = add nsw i32 %403, %t172
  %405 = shl nsw i32 %404, 7
  %406 = add nsw i32 %405, %352
  %407 = getelementptr inbounds i8, i8* %51, i32 %406
  %408 = bitcast i8* %407 to <128 x i8>*
  %409 = load <128 x i8>, <128 x i8>* %408, align 1, !tbaa !96
  %410 = add i32 %404, %354
  %411 = shl nsw i32 %410, 7
  %412 = getelementptr inbounds i8, i8* %bounded_input, i32 %411
  %413 = bitcast i8* %412 to <128 x i8>*
  store <128 x i8> %409, <128 x i8>* %413, align 128, !tbaa !99
  %414 = or i32 %bounded_input.s0.x.x.rebased, 3
  %415 = add nsw i32 %414, %t172
  %416 = shl nsw i32 %415, 7
  %417 = add nsw i32 %416, %352
  %418 = getelementptr inbounds i8, i8* %51, i32 %417
  %419 = bitcast i8* %418 to <128 x i8>*
  %420 = load <128 x i8>, <128 x i8>* %419, align 1, !tbaa !96
  %421 = add i32 %415, %354
  %422 = shl nsw i32 %421, 7
  %423 = getelementptr inbounds i8, i8* %bounded_input, i32 %422
  %424 = bitcast i8* %423 to <128 x i8>*
  store <128 x i8> %420, <128 x i8>* %424, align 128, !tbaa !99
  %425 = or i32 %bounded_input.s0.x.x.rebased, 4
  %426 = add nsw i32 %425, %t172
  %427 = shl nsw i32 %426, 7
  %428 = add nsw i32 %427, %352
  %429 = getelementptr inbounds i8, i8* %51, i32 %428
  %430 = bitcast i8* %429 to <128 x i8>*
  %431 = load <128 x i8>, <128 x i8>* %430, align 1, !tbaa !96
  %432 = add i32 %426, %354
  %433 = shl nsw i32 %432, 7
  %434 = getelementptr inbounds i8, i8* %bounded_input, i32 %433
  %435 = bitcast i8* %434 to <128 x i8>*
  store <128 x i8> %431, <128 x i8>* %435, align 128, !tbaa !99
  %436 = or i32 %bounded_input.s0.x.x.rebased, 5
  %437 = add nsw i32 %436, %t172
  %438 = shl nsw i32 %437, 7
  %439 = add nsw i32 %438, %352
  %440 = getelementptr inbounds i8, i8* %51, i32 %439
  %441 = bitcast i8* %440 to <128 x i8>*
  %442 = load <128 x i8>, <128 x i8>* %441, align 1, !tbaa !96
  %443 = add i32 %437, %354
  %444 = shl nsw i32 %443, 7
  %445 = getelementptr inbounds i8, i8* %bounded_input, i32 %444
  %446 = bitcast i8* %445 to <128 x i8>*
  store <128 x i8> %442, <128 x i8>* %446, align 128, !tbaa !99
  %447 = or i32 %bounded_input.s0.x.x.rebased, 6
  %448 = add nsw i32 %447, %t172
  %449 = shl nsw i32 %448, 7
  %450 = add nsw i32 %449, %352
  %451 = getelementptr inbounds i8, i8* %51, i32 %450
  %452 = bitcast i8* %451 to <128 x i8>*
  %453 = load <128 x i8>, <128 x i8>* %452, align 1, !tbaa !96
  %454 = add i32 %448, %354
  %455 = shl nsw i32 %454, 7
  %456 = getelementptr inbounds i8, i8* %bounded_input, i32 %455
  %457 = bitcast i8* %456 to <128 x i8>*
  store <128 x i8> %453, <128 x i8>* %457, align 128, !tbaa !99
  %458 = or i32 %bounded_input.s0.x.x.rebased, 7
  %459 = add nsw i32 %458, %t172
  %460 = shl nsw i32 %459, 7
  %461 = add nsw i32 %460, %352
  %462 = getelementptr inbounds i8, i8* %51, i32 %461
  %463 = bitcast i8* %462 to <128 x i8>*
  %464 = load <128 x i8>, <128 x i8>* %463, align 1, !tbaa !96
  %465 = add i32 %459, %354
  %466 = shl nsw i32 %465, 7
  %467 = getelementptr inbounds i8, i8* %bounded_input, i32 %466
  %468 = bitcast i8* %467 to <128 x i8>*
  store <128 x i8> %464, <128 x i8>* %468, align 128, !tbaa !99
  %469 = add nuw nsw i32 %bounded_input.s0.x.x.rebased, 8
  %niter61.nsub.7 = add i32 %niter61, -8
  %niter61.ncmp.7 = icmp eq i32 %niter61.nsub.7, 0
  br i1 %niter61.ncmp.7, label %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa", label %"for bounded_input.s0.x.x.rebased"
...
"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa": ; preds = %"for bounded_input.s0.x.x.rebased", %"for bounded_input.s0.x.x.rebased.preheader"
  %bounded_input.s0.x.x.rebased.unr = phi i32 [ 0, %"for bounded_input.s0.x.x.rebased.preheader" ], [ %469, %"for bounded_input.s0.x.x.rebased" ]
  br i1 %lcmp.mod59.not, label %"end for bounded_input.s0.x.x.rebased", label %"for bounded_input.s0.x.x.rebased.epil"
...
"for bounded_input.s0.x.x.rebased.epil":          ; preds = %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa", %"for bounded_input.s0.x.x.rebased.epil"
  %bounded_input.s0.x.x.rebased.epil = phi i32 [ %480, %"for bounded_input.s0.x.x.rebased.epil" ], [ %bounded_input.s0.x.x.rebased.unr, %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa" ]
  %epil.iter = phi i32 [ %epil.iter.sub, %"for bounded_input.s0.x.x.rebased.epil" ], [ %xtraiter58, %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa" ]
  %470 = add nsw i32 %bounded_input.s0.x.x.rebased.epil, %t172
  %471 = shl nsw i32 %470, 7
  %472 = add nsw i32 %471, %352
  %473 = getelementptr inbounds i8, i8* %51, i32 %472
  %474 = bitcast i8* %473 to <128 x i8>*
  %475 = load <128 x i8>, <128 x i8>* %474, align 1, !tbaa !96
  %476 = add i32 %470, %354
  %477 = shl nsw i32 %476, 7
  %478 = getelementptr inbounds i8, i8* %bounded_input, i32 %477
  %479 = bitcast i8* %478 to <128 x i8>*
  store <128 x i8> %475, <128 x i8>* %479, align 128, !tbaa !99
  %480 = add nuw nsw i32 %bounded_input.s0.x.x.rebased.epil, 1
  %epil.iter.sub = add i32 %epil.iter, -1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.sub, 0
  br i1 %epil.iter.cmp.not, label %"end for bounded_input.s0.x.x.rebased", label %"for bounded_input.s0.x.x.rebased.epil", !llvm.loop !103

"end for bounded_input.s0.x.x.rebased":           ; preds = %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa", %"for bounded_input.s0.x.x.rebased.epil", %after_bb4
  br i1 %37, label %"for bounded_input.s0.x.x.rebased7.preheader", label %"end for bounded_input.s0.x.x.rebased8", !prof !102

"for bounded_input.s0.x.x.rebased7.preheader":    ; preds = %"end for bounded_input.s0.x.x.rebased"
  %481 = add i32 %b16, %bounded_input.s0.y.rebased3
  %482 = mul nsw i32 %481, %input.stride.1
  %483 = add nsw i32 %t277, 2
  %484 = mul nsw i32 %483, %a11
  br i1 %61, label %"end for bounded_input.s0.x.x.rebased8.loopexit.unr-lcssa", label %"for bounded_input.s0.x.x.rebased7"

"for bounded_input.s0.x.x.rebased7":              ; preds = %"for bounded_input.s0.x.x.rebased7.preheader", %"for bounded_input.s0.x.x.rebased7"
  %bounded_input.s0.x.x.rebased9 = phi i32 [ %568, %"for bounded_input.s0.x.x.rebased7" ], [ 0, %"for bounded_input.s0.x.x.rebased7.preheader" ]
  %niter65 = phi i32 [ %niter65.nsub.1, %"for bounded_input.s0.x.x.rebased7" ], [ %unroll_iter64, %"for bounded_input.s0.x.x.rebased7.preheader" ]
  %485 = add i32 %bounded_input.s0.x.x.rebased9, %t158
  %a33 = shl nsw i32 %485, 7
  %.not26 = icmp sgt i32 %a33, %input.extent.0
  %a35 = select i1 %.not26, i32 %b23, i32 %a33
  %486 = icmp sgt i32 %a35, 2
  %487 = select i1 %486, i32 %a35, i32 2
  %488 = add nsw i32 %487, %482
  %489 = getelementptr inbounds i8, i8* %52, i32 %488
  %490 = bitcast i8* %489 to <32 x i32>*
  %491 = load <32 x i32>, <32 x i32>* %490, align 1, !tbaa !96
  %492 = add nsw i32 %a33, -2
  %493 = insertelement <128 x i32> undef, i32 %492, i32 0
  %494 = shufflevector <128 x i32> %493, <128 x i32> undef, <128 x i32> zeroinitializer
  %495 = add nsw <128 x i32> %494, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %496 = shufflevector <128 x i32> %495, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %497 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %496, <32 x i32> %34) #12
  %498 = shufflevector <128 x i32> %495, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %499 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %498, <32 x i32> %34) #12
  %500 = shufflevector <128 x i32> %495, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %501 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %500, <32 x i32> %34) #12
  %502 = shufflevector <128 x i32> %495, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %503 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %502, <32 x i32> %34) #12
  %504 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %497, <32 x i32> zeroinitializer) #12
  %505 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %499, <32 x i32> zeroinitializer) #12
  %506 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %501, <32 x i32> zeroinitializer) #12
  %507 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %503, <32 x i32> zeroinitializer) #12
  %508 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %505, <32 x i32> %504)
  %509 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %507, <32 x i32> %506)
  %510 = shufflevector <64 x i32> %508, <64 x i32> %509, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %511 = sub nsw i32 2, %487
  %512 = insertelement <128 x i32> undef, i32 %511, i32 0
  %513 = shufflevector <128 x i32> %512, <128 x i32> undef, <128 x i32> zeroinitializer
  %514 = add nsw <128 x i32> %510, %513
  %515 = trunc <128 x i32> %514 to <128 x i8>
  %516 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %491)
  %517 = bitcast <128 x i8> %515 to <32 x i32>
  %518 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %517, <32 x i32> %516, i32 0)
  %519 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %518, <32 x i32> %517, <32 x i32> %516, i32 1)
  %520 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %519, <32 x i32> %517, <32 x i32> %516, i32 2)
  %521 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %520, <32 x i32> %517, <32 x i32> %516, i32 3)
  %522 = add i32 %485, %484
  %523 = shl nsw i32 %522, 7
  %524 = getelementptr inbounds i8, i8* %bounded_input, i32 %523
  %525 = bitcast i8* %524 to <32 x i32>*
  store <32 x i32> %521, <32 x i32>* %525, align 128, !tbaa !99
  %526 = or i32 %bounded_input.s0.x.x.rebased9, 1
  %527 = add i32 %526, %t158
  %a33.1 = shl nsw i32 %527, 7
  %.not26.1 = icmp sgt i32 %a33.1, %input.extent.0
  %a35.1 = select i1 %.not26.1, i32 %b23, i32 %a33.1
  %528 = icmp sgt i32 %a35.1, 2
  %529 = select i1 %528, i32 %a35.1, i32 2
  %530 = add nsw i32 %529, %482
  %531 = getelementptr inbounds i8, i8* %52, i32 %530
  %532 = bitcast i8* %531 to <32 x i32>*
  %533 = load <32 x i32>, <32 x i32>* %532, align 1, !tbaa !96
  %534 = add nsw i32 %a33.1, -2
  %535 = insertelement <128 x i32> undef, i32 %534, i32 0
  %536 = shufflevector <128 x i32> %535, <128 x i32> undef, <128 x i32> zeroinitializer
  %537 = add nsw <128 x i32> %536, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %538 = shufflevector <128 x i32> %537, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %539 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %538, <32 x i32> %34) #12
  %540 = shufflevector <128 x i32> %537, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %541 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %540, <32 x i32> %34) #12
  %542 = shufflevector <128 x i32> %537, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %543 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %542, <32 x i32> %34) #12
  %544 = shufflevector <128 x i32> %537, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %545 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %544, <32 x i32> %34) #12
  %546 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %539, <32 x i32> zeroinitializer) #12
  %547 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %541, <32 x i32> zeroinitializer) #12
  %548 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %543, <32 x i32> zeroinitializer) #12
  %549 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %545, <32 x i32> zeroinitializer) #12
  %550 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %547, <32 x i32> %546)
  %551 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %549, <32 x i32> %548)
  %552 = shufflevector <64 x i32> %550, <64 x i32> %551, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %553 = sub nsw i32 2, %529
  %554 = insertelement <128 x i32> undef, i32 %553, i32 0
  %555 = shufflevector <128 x i32> %554, <128 x i32> undef, <128 x i32> zeroinitializer
  %556 = add nsw <128 x i32> %552, %555
  %557 = trunc <128 x i32> %556 to <128 x i8>
  %558 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %533)
  %559 = bitcast <128 x i8> %557 to <32 x i32>
  %560 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %559, <32 x i32> %558, i32 0)
  %561 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %560, <32 x i32> %559, <32 x i32> %558, i32 1)
  %562 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %561, <32 x i32> %559, <32 x i32> %558, i32 2)
  %563 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %562, <32 x i32> %559, <32 x i32> %558, i32 3)
  %564 = add i32 %527, %484
  %565 = shl nsw i32 %564, 7
  %566 = getelementptr inbounds i8, i8* %bounded_input, i32 %565
  %567 = bitcast i8* %566 to <32 x i32>*
  store <32 x i32> %563, <32 x i32>* %567, align 128, !tbaa !99
  %568 = add nuw nsw i32 %bounded_input.s0.x.x.rebased9, 2
  %niter65.nsub.1 = add i32 %niter65, -2
  %niter65.ncmp.1 = icmp eq i32 %niter65.nsub.1, 0
  br i1 %niter65.ncmp.1, label %"end for bounded_input.s0.x.x.rebased8.loopexit.unr-lcssa", label %"for bounded_input.s0.x.x.rebased7"

"end for bounded_input.s0.x.x.rebased8.loopexit.unr-lcssa": ; preds = %"for bounded_input.s0.x.x.rebased7", %"for bounded_input.s0.x.x.rebased7.preheader"
  %bounded_input.s0.x.x.rebased9.unr = phi i32 [ 0, %"for bounded_input.s0.x.x.rebased7.preheader" ], [ %568, %"for bounded_input.s0.x.x.rebased7" ]
  br i1 %lcmp.mod63.not, label %"end for bounded_input.s0.x.x.rebased8", label %"for bounded_input.s0.x.x.rebased7.epil"

"for bounded_input.s0.x.x.rebased7.epil":         ; preds = %"end for bounded_input.s0.x.x.rebased8.loopexit.unr-lcssa"
  %569 = add i32 %bounded_input.s0.x.x.rebased9.unr, %t158
  %a33.epil = shl nsw i32 %569, 7
  %.not26.epil = icmp sgt i32 %a33.epil, %input.extent.0
  %a35.epil = select i1 %.not26.epil, i32 %b23, i32 %a33.epil
  %570 = icmp sgt i32 %a35.epil, 2
  %571 = select i1 %570, i32 %a35.epil, i32 2
  %572 = add nsw i32 %571, %482
  %573 = getelementptr inbounds i8, i8* %52, i32 %572
  %574 = bitcast i8* %573 to <32 x i32>*
  %575 = load <32 x i32>, <32 x i32>* %574, align 1, !tbaa !96
  %576 = add nsw i32 %a33.epil, -2
  %577 = insertelement <128 x i32> undef, i32 %576, i32 0
  %578 = shufflevector <128 x i32> %577, <128 x i32> undef, <128 x i32> zeroinitializer
  %579 = add nsw <128 x i32> %578, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %580 = shufflevector <128 x i32> %579, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %581 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %580, <32 x i32> %34) #12
  %582 = shufflevector <128 x i32> %579, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %583 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %582, <32 x i32> %34) #12
  %584 = shufflevector <128 x i32> %579, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %585 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %584, <32 x i32> %34) #12
  %586 = shufflevector <128 x i32> %579, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %587 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %586, <32 x i32> %34) #12
  %588 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %581, <32 x i32> zeroinitializer) #12
  %589 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %583, <32 x i32> zeroinitializer) #12
  %590 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %585, <32 x i32> zeroinitializer) #12
  %591 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %587, <32 x i32> zeroinitializer) #12
  %592 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %589, <32 x i32> %588)
  %593 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %591, <32 x i32> %590)
  %594 = shufflevector <64 x i32> %592, <64 x i32> %593, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %595 = sub nsw i32 2, %571
  %596 = insertelement <128 x i32> undef, i32 %595, i32 0
  %597 = shufflevector <128 x i32> %596, <128 x i32> undef, <128 x i32> zeroinitializer
  %598 = add nsw <128 x i32> %594, %597
  %599 = trunc <128 x i32> %598 to <128 x i8>
  %600 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %575)
  %601 = bitcast <128 x i8> %599 to <32 x i32>
  %602 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %601, <32 x i32> %600, i32 0)
  %603 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %602, <32 x i32> %601, <32 x i32> %600, i32 1)
  %604 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %603, <32 x i32> %601, <32 x i32> %600, i32 2)
  %605 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %604, <32 x i32> %601, <32 x i32> %600, i32 3)
  %606 = add i32 %569, %484
  %607 = shl nsw i32 %606, 7
  %608 = getelementptr inbounds i8, i8* %bounded_input, i32 %607
  %609 = bitcast i8* %608 to <32 x i32>*
  store <32 x i32> %605, <32 x i32>* %609, align 128, !tbaa !99
  br label %"end for bounded_input.s0.x.x.rebased8"

"end for bounded_input.s0.x.x.rebased8":          ; preds = %"for bounded_input.s0.x.x.rebased7.epil", %"end for bounded_input.s0.x.x.rebased8.loopexit.unr-lcssa", %"end for bounded_input.s0.x.x.rebased"
  %610 = add nuw nsw i32 %bounded_input.s0.y.rebased3, 1
  %.not25 = icmp eq i32 %bounded_input.s0.y.rebased3, %a28.op
  br i1 %.not25, label %"end for bounded_input.s0.y.rebased2", label %"for bounded_input.s0.y.rebased1"

"end for bounded_input.s0.y.rebased11":           ; preds = %"end for bounded_input.s0.x.x14.loopexit.us", %"end for bounded_input.s0.y.rebased2"
  %611 = tail call i8* @halide_malloc(i8* %__user_context, i32 %40)
  %rows = bitcast i8* %611 to i16*
  br i1 %30, label %"for rows.s0.x.x", label %"end for rows.s0.x.x", !prof !102

"for rows.s0.x.x":                                ; preds = %"end for bounded_input.s0.y.rebased11", %"for rows.s0.x.x"
  %rows.s0.x.x = phi i32 [ %741, %"for rows.s0.x.x" ], [ 0, %"end for bounded_input.s0.y.rebased11" ]
  %612 = add nsw i32 %rows.s0.x.x, %a11
  %613 = shl nsw i32 %612, 7
  %614 = getelementptr inbounds i8, i8* %bounded_input, i32 %613
  %615 = bitcast i8* %614 to <128 x i8>*
  %616 = load <128 x i8>, <128 x i8>* %615, align 128, !tbaa !99
  %617 = add nsw i32 %rows.s0.x.x, %41
  %618 = shl nsw i32 %617, 7
  %619 = getelementptr inbounds i8, i8* %bounded_input, i32 %618
  %620 = bitcast i8* %619 to <128 x i8>*
  %621 = load <128 x i8>, <128 x i8>* %620, align 128, !tbaa !99
  %622 = add nsw i32 %rows.s0.x.x, %42
  %623 = shl nsw i32 %622, 7
  %624 = getelementptr inbounds i8, i8* %bounded_input, i32 %623
  %625 = bitcast i8* %624 to <128 x i8>*
  %626 = load <128 x i8>, <128 x i8>* %625, align 128, !tbaa !99
  %627 = shl nsw i32 %rows.s0.x.x, 7
  %628 = getelementptr inbounds i8, i8* %bounded_input, i32 %627
  %629 = bitcast i8* %628 to <128 x i8>*
  %630 = load <128 x i8>, <128 x i8>* %629, align 128, !tbaa !99
  %631 = add nsw i32 %rows.s0.x.x, %43
  %632 = shl nsw i32 %631, 7
  %633 = getelementptr inbounds i8, i8* %bounded_input, i32 %632
  %634 = bitcast i8* %633 to <128 x i8>*
  %635 = load <128 x i8>, <128 x i8>* %634, align 128, !tbaa !99
  %636 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %635, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #12
  %637 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %621, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0) #12
  %638 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl(<128 x i16> zeroinitializer, <64 x i16> <i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542>, <128 x i8> %637, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0) #12
  %639 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %626, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0) #12
  %640 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl.1(<128 x i16> %638, <128 x i8> %639, <64 x i16> <i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028>, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0) #12
  %641 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %616, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0) #12
  %642 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_128B_dsl(<128 x i8> %641, <128 x i8> <i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4>, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 1, i32 0, i32 16, i32 1024, i32 1, i32 0, i32 8, i32 2, i32 0) #12
  %643 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %640, <128 x i16> %642, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %644 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %636, <128 x i16> %643, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %645 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %630, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #12
  %646 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %644, <128 x i16> %645, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %647 = bitcast <128 x i16> %646 to <64 x i32>
  %648 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %647)
  %649 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %647)
  %650 = getelementptr inbounds i16, i16* %rows, i32 %627
  %651 = bitcast i16* %650 to <32 x i32>*
  store <32 x i32> %649, <32 x i32>* %651, align 128, !tbaa !104
  %652 = getelementptr inbounds i16, i16* %650, i32 64
  %653 = bitcast i16* %652 to <32 x i32>*
  store <32 x i32> %648, <32 x i32>* %653, align 128, !tbaa !104
  %654 = load <128 x i8>, <128 x i8>* %620, align 128, !tbaa !99
  %655 = load <128 x i8>, <128 x i8>* %625, align 128, !tbaa !99
  %656 = load <128 x i8>, <128 x i8>* %634, align 128, !tbaa !99
  %657 = load <128 x i8>, <128 x i8>* %615, align 128, !tbaa !99
  %658 = add nsw i32 %rows.s0.x.x, %44
  %659 = shl nsw i32 %658, 7
  %660 = getelementptr inbounds i8, i8* %bounded_input, i32 %659
  %661 = bitcast i8* %660 to <128 x i8>*
  %662 = load <128 x i8>, <128 x i8>* %661, align 128, !tbaa !99
  %663 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %662, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #12
  %664 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %655, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0) #12
  %665 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl(<128 x i16> zeroinitializer, <64 x i16> <i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542>, <128 x i8> %664, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0) #12
  %666 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %656, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0) #12
  %667 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl.1(<128 x i16> %665, <128 x i8> %666, <64 x i16> <i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028>, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0) #12
  %668 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %654, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0) #12
  %669 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_128B_dsl(<128 x i8> %668, <128 x i8> <i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4>, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 1, i32 0, i32 16, i32 1024, i32 1, i32 0, i32 8, i32 2, i32 0) #12
  %670 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %667, <128 x i16> %669, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %671 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %663, <128 x i16> %670, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %672 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %657, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #12
  %673 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %671, <128 x i16> %672, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %674 = bitcast <128 x i16> %673 to <64 x i32>
  %675 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %674)
  %676 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %674)
  %677 = add nsw i32 %rows.s0.x.x, %a50
  %678 = shl nsw i32 %677, 7
  %679 = getelementptr inbounds i16, i16* %rows, i32 %678
  %680 = bitcast i16* %679 to <32 x i32>*
  store <32 x i32> %676, <32 x i32>* %680, align 128, !tbaa !104
  %681 = getelementptr inbounds i16, i16* %679, i32 64
  %682 = bitcast i16* %681 to <32 x i32>*
  store <32 x i32> %675, <32 x i32>* %682, align 128, !tbaa !104
  %683 = load <128 x i8>, <128 x i8>* %625, align 128, !tbaa !99
  %684 = load <128 x i8>, <128 x i8>* %634, align 128, !tbaa !99
  %685 = load <128 x i8>, <128 x i8>* %661, align 128, !tbaa !99
  %686 = load <128 x i8>, <128 x i8>* %620, align 128, !tbaa !99
  %687 = add nsw i32 %rows.s0.x.x, %45
  %688 = shl nsw i32 %687, 7
  %689 = getelementptr inbounds i8, i8* %bounded_input, i32 %688
  %690 = bitcast i8* %689 to <128 x i8>*
  %691 = load <128 x i8>, <128 x i8>* %690, align 128, !tbaa !99
  %692 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %691, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #12
  %693 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %684, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0) #12
  %694 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl(<128 x i16> zeroinitializer, <64 x i16> <i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542>, <128 x i8> %693, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0) #12
  %695 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %685, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0) #12
  %696 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl.1(<128 x i16> %694, <128 x i8> %695, <64 x i16> <i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028>, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0) #12
  %697 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %683, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0) #12
  %698 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_128B_dsl(<128 x i8> %697, <128 x i8> <i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4>, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 1, i32 0, i32 16, i32 1024, i32 1, i32 0, i32 8, i32 2, i32 0) #12
  %699 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %696, <128 x i16> %698, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %700 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %692, <128 x i16> %699, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %701 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %686, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #12
  %702 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %700, <128 x i16> %701, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %703 = bitcast <128 x i16> %702 to <64 x i32>
  %704 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %703)
  %705 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %703)
  %706 = add nsw i32 %rows.s0.x.x, %46
  %707 = shl nsw i32 %706, 7
  %708 = getelementptr inbounds i16, i16* %rows, i32 %707
  %709 = bitcast i16* %708 to <32 x i32>*
  store <32 x i32> %705, <32 x i32>* %709, align 128, !tbaa !104
  %710 = getelementptr inbounds i16, i16* %708, i32 64
  %711 = bitcast i16* %710 to <32 x i32>*
  store <32 x i32> %704, <32 x i32>* %711, align 128, !tbaa !104
  %712 = load <128 x i8>, <128 x i8>* %634, align 128, !tbaa !99
  %713 = load <128 x i8>, <128 x i8>* %661, align 128, !tbaa !99
  %714 = load <128 x i8>, <128 x i8>* %690, align 128, !tbaa !99
  %715 = load <128 x i8>, <128 x i8>* %625, align 128, !tbaa !99
  %716 = add nsw i32 %rows.s0.x.x, %47
  %717 = shl nsw i32 %716, 7
  %718 = getelementptr inbounds i8, i8* %bounded_input, i32 %717
  %719 = bitcast i8* %718 to <128 x i8>*
  %720 = load <128 x i8>, <128 x i8>* %719, align 128, !tbaa !99
  %721 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %720, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #12
  %722 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %713, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0) #12
  %723 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl(<128 x i16> zeroinitializer, <64 x i16> <i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542>, <128 x i8> %722, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0) #12
  %724 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %714, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0) #12
  %725 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl.1(<128 x i16> %723, <128 x i8> %724, <64 x i16> <i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028>, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0) #12
  %726 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %712, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0) #12
  %727 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_128B_dsl(<128 x i8> %726, <128 x i8> <i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4>, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 1, i32 0, i32 16, i32 1024, i32 1, i32 0, i32 8, i32 2, i32 0) #12
  %728 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %725, <128 x i16> %727, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %729 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %721, <128 x i16> %728, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %730 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %715, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0) #12
  %731 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %729, <128 x i16> %730, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %732 = bitcast <128 x i16> %731 to <64 x i32>
  %733 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %732)
  %734 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %732)
  %735 = add nsw i32 %rows.s0.x.x, %48
  %736 = shl nsw i32 %735, 7
  %737 = getelementptr inbounds i16, i16* %rows, i32 %736
  %738 = bitcast i16* %737 to <32 x i32>*
  store <32 x i32> %734, <32 x i32>* %738, align 128, !tbaa !104
  %739 = getelementptr inbounds i16, i16* %737, i32 64
  %740 = bitcast i16* %739 to <32 x i32>*
  store <32 x i32> %733, <32 x i32>* %740, align 128, !tbaa !104
  %741 = add nuw nsw i32 %rows.s0.x.x, 1
  %.not20 = icmp eq i32 %741, %a11
  br i1 %.not20, label %if.then.i35, label %"for rows.s0.x.x"

"end for rows.s0.x.x":                            ; preds = %"end for bounded_input.s0.y.rebased11.thread", %"end for bounded_input.s0.y.rebased11"
  %rows54 = phi i16* [ %rows51, %"end for bounded_input.s0.y.rebased11.thread" ], [ %rows, %"end for bounded_input.s0.y.rebased11" ]
  %742 = phi i8* [ %222, %"end for bounded_input.s0.y.rebased11.thread" ], [ %611, %"end for bounded_input.s0.y.rebased11" ]
  %tobool.not.i34.not = icmp eq i8* %bounded_input, null
  br i1 %tobool.not.i34.not, label %call_destructor.exit36, label %if.then.i35

if.then.i35:                                      ; preds = %"for rows.s0.x.x", %"end for rows.s0.x.x"
  %rows53 = phi i16* [ %rows54, %"end for rows.s0.x.x" ], [ %rows, %"for rows.s0.x.x" ]
  %743 = phi i8* [ %742, %"end for rows.s0.x.x" ], [ %611, %"for rows.s0.x.x" ]
  tail call void @halide_free(i8* %__user_context, i8* nonnull %bounded_input) #14
  br label %call_destructor.exit36

call_destructor.exit36:                           ; preds = %"end for rows.s0.x.x", %if.then.i35
  %rows52 = phi i16* [ %rows54, %"end for rows.s0.x.x" ], [ %rows53, %if.then.i35 ]
  %744 = phi i8* [ %742, %"end for rows.s0.x.x" ], [ %743, %if.then.i35 ]
  br i1 %49, label %"for output.s0.x.x.preheader", label %"end for output.s0.x.x", !prof !102

"for output.s0.x.x.preheader":                    ; preds = %call_destructor.exit36
  %745 = mul nsw i32 %63, %output.stride.1
  %746 = or i32 %64, 1
  %747 = mul nsw i32 %746, %output.stride.1
  %748 = or i32 %64, 2
  %749 = mul nsw i32 %748, %output.stride.1
  %750 = or i32 %64, 3
  %751 = mul nsw i32 %750, %output.stride.1
  br label %"for output.s0.x.x"

"for output.s0.x.x":                              ; preds = %"for output.s0.x.x.preheader", %"for output.s0.x.x"
  %output.s0.x.x = phi i32 [ %1145, %"for output.s0.x.x" ], [ 0, %"for output.s0.x.x.preheader" ]
  %752 = shl nsw i32 %output.s0.x.x, 7
  %753 = getelementptr inbounds i16, i16* %rows52, i32 %752
  %754 = getelementptr inbounds i16, i16* %753, i32 64
  %755 = bitcast i16* %754 to <64 x i16>*
  %t265 = load <64 x i16>, <64 x i16>* %755, align 128, !tbaa !104
  %756 = bitcast i16* %753 to <64 x i16>*
  %t266.s = load <64 x i16>, <64 x i16>* %756, align 128, !tbaa !104
  %757 = getelementptr inbounds i16, i16* %753, i32 128
  %758 = bitcast i16* %757 to <64 x i16>*
  %t267.s = load <64 x i16>, <64 x i16>* %758, align 128, !tbaa !104
  %759 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t266.s, <64 x i16> %t265, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %760 = bitcast <256 x i8> %759 to <64 x i32>
  %761 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %760)
  %762 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %760)
  %763 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %761, <32 x i32> %762, i32 2)
  %764 = bitcast <32 x i32> %763 to <64 x i16>
  %765 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t265, <64 x i16> %t267.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %766 = bitcast <256 x i8> %765 to <64 x i32>
  %767 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %766)
  %768 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %766)
  %769 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %767, <32 x i32> %768, i32 2)
  %770 = bitcast <32 x i32> %769 to <64 x i16>
  %771 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t266.s, <64 x i16> %t265, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %772 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t266.s, <64 x i16> %t265, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %773 = bitcast <256 x i8> %772 to <64 x i32>
  %774 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %773)
  %775 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %773)
  %776 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %774, <32 x i32> %775, i32 4)
  %777 = bitcast <32 x i32> %776 to <64 x i16>
  %778 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t265, <64 x i16> %t267.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %779 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t265, <64 x i16> %t267.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %780 = bitcast <256 x i8> %779 to <64 x i32>
  %781 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %780)
  %782 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %780)
  %783 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %781, <32 x i32> %782, i32 4)
  %784 = bitcast <32 x i32> %783 to <64 x i16>
  %785 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t266.s, <64 x i16> %t265, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %786 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t266.s, <64 x i16> %t265, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %787 = bitcast <256 x i8> %786 to <64 x i32>
  %788 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %787)
  %789 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %787)
  %790 = tail call <32 x i32> @llvm.hexagon.V6.valignb.128B(<32 x i32> %788, <32 x i32> %789, i32 8)
  %791 = bitcast <32 x i32> %790 to <64 x i16>
  %792 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t265, <64 x i16> %t267.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %793 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t265, <64 x i16> %t267.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %794 = bitcast <256 x i8> %793 to <64 x i32>
  %795 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %794)
  %796 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %794)
  %797 = tail call <32 x i32> @llvm.hexagon.V6.valignb.128B(<32 x i32> %795, <32 x i32> %796, i32 8)
  %798 = bitcast <32 x i32> %797 to <64 x i16>
  %799 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t266.s, <64 x i16> %t265, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %800 = bitcast <256 x i8> %799 to <64 x i32>
  %801 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %800)
  %802 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %800)
  %803 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %801, <32 x i32> %802, i32 6)
  %804 = bitcast <32 x i32> %803 to <64 x i16>
  %805 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t265, <64 x i16> %t267.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %806 = bitcast <256 x i8> %805 to <64 x i32>
  %807 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %806)
  %808 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %806)
  %809 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %807, <32 x i32> %808, i32 6)
  %810 = bitcast <32 x i32> %809 to <64 x i16>
  %811 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %764, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %812 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %770, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %813 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %811, <64 x i16> %812, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %814 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t266.s, <64 x i16> %t265, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %815 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %791, <64 x i16> %798, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %816 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %804, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %817 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %810, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %818 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %816, <64 x i16> %817, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %819 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<256 x i8> %815, <256 x i8> %818, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %820 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %784, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %821 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %777, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %822 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %820, <64 x i16> %821, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %823 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.2(<128 x i16> %819, <256 x i8> %822, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %824 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %814, <128 x i16> %823, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %825 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %813, <128 x i16> %824, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %826 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %825, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %827 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8>, <1 x i16> zeroinitializer, <128 x i8> %826, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #12
  %828 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %764, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %829 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %770, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %830 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %828, <64 x i16> %829, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %831 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t266.s, <64 x i16> %t265, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %832 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %791, <64 x i16> %798, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %833 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %804, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %834 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %810, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %835 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %833, <64 x i16> %834, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %836 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<256 x i8> %832, <256 x i8> %835, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %837 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %784, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %838 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %777, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %839 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %837, <64 x i16> %838, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %840 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.2(<128 x i16> %836, <256 x i8> %839, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %841 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %831, <128 x i16> %840, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %842 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %830, <128 x i16> %841, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %843 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %842, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #12
  %844 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8>, <1 x i16> zeroinitializer, <128 x i8> %843, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #12
  %845 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vpackeh_128B_dsl(<64 x i16> %827, <64 x i16> %844, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 2, i32 64, i32 2, i32 8, i32 0) #12
  %846 = shl nsw i32 %output.s0.x.x, 5
  %847 = add nsw i32 %846, %745
  %848 = shl nsw i32 %847, 2
  %849 = getelementptr inbounds i8, i8* %output, i32 %848
  %850 = bitcast i8* %849 to <128 x i8>*
  store <128 x i8> %845, <128 x i8>* %850, align 1, !tbaa !106
  %851 = add nsw i32 %output.s0.x.x, %a50
  %852 = shl nsw i32 %851, 7
  %853 = getelementptr inbounds i16, i16* %rows52, i32 %852
  %854 = getelementptr inbounds i16, i16* %853, i32 64
  %855 = bitcast i16* %854 to <64 x i16>*
  %t268 = load <64 x i16>, <64 x i16>* %855, align 128, !tbaa !104
  %856 = bitcast i16* %853 to <64 x i16>*
  %t269.s = load <64 x i16>, <64 x i16>* %856, align 128, !tbaa !104
  %857 = getelementptr inbounds i16, i16* %853, i32 128
  %858 = bitcast i16* %857 to <64 x i16>*
  %t270.s = load <64 x i16>, <64 x i16>* %858, align 128, !tbaa !104
  %859 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t269.s, <64 x i16> %t268, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %860 = bitcast <256 x i8> %859 to <64 x i32>
  %861 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %860)
  %862 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %860)
  %863 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %861, <32 x i32> %862, i32 2)
  %864 = bitcast <32 x i32> %863 to <64 x i16>
  %865 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t268, <64 x i16> %t270.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %866 = bitcast <256 x i8> %865 to <64 x i32>
  %867 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %866)
  %868 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %866)
  %869 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %867, <32 x i32> %868, i32 2)
  %870 = bitcast <32 x i32> %869 to <64 x i16>
  %871 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t269.s, <64 x i16> %t268, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %872 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t269.s, <64 x i16> %t268, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %873 = bitcast <256 x i8> %872 to <64 x i32>
  %874 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %873)
  %875 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %873)
  %876 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %874, <32 x i32> %875, i32 4)
  %877 = bitcast <32 x i32> %876 to <64 x i16>
  %878 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t268, <64 x i16> %t270.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %879 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t268, <64 x i16> %t270.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %880 = bitcast <256 x i8> %879 to <64 x i32>
  %881 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %880)
  %882 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %880)
  %883 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %881, <32 x i32> %882, i32 4)
  %884 = bitcast <32 x i32> %883 to <64 x i16>
  %885 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t269.s, <64 x i16> %t268, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %886 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t269.s, <64 x i16> %t268, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %887 = bitcast <256 x i8> %886 to <64 x i32>
  %888 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %887)
  %889 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %887)
  %890 = tail call <32 x i32> @llvm.hexagon.V6.valignb.128B(<32 x i32> %888, <32 x i32> %889, i32 8)
  %891 = bitcast <32 x i32> %890 to <64 x i16>
  %892 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t268, <64 x i16> %t270.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %893 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t268, <64 x i16> %t270.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %894 = bitcast <256 x i8> %893 to <64 x i32>
  %895 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %894)
  %896 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %894)
  %897 = tail call <32 x i32> @llvm.hexagon.V6.valignb.128B(<32 x i32> %895, <32 x i32> %896, i32 8)
  %898 = bitcast <32 x i32> %897 to <64 x i16>
  %899 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t269.s, <64 x i16> %t268, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %900 = bitcast <256 x i8> %899 to <64 x i32>
  %901 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %900)
  %902 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %900)
  %903 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %901, <32 x i32> %902, i32 6)
  %904 = bitcast <32 x i32> %903 to <64 x i16>
  %905 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t268, <64 x i16> %t270.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %906 = bitcast <256 x i8> %905 to <64 x i32>
  %907 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %906)
  %908 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %906)
  %909 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %907, <32 x i32> %908, i32 6)
  %910 = bitcast <32 x i32> %909 to <64 x i16>
  %911 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %864, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %912 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %870, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %913 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %911, <64 x i16> %912, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %914 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t269.s, <64 x i16> %t268, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %915 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %891, <64 x i16> %898, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %916 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %904, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %917 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %910, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %918 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %916, <64 x i16> %917, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %919 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<256 x i8> %915, <256 x i8> %918, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %920 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %884, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %921 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %877, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %922 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %920, <64 x i16> %921, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %923 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.2(<128 x i16> %919, <256 x i8> %922, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %924 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %914, <128 x i16> %923, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %925 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %913, <128 x i16> %924, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %926 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %925, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %927 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8>, <1 x i16> zeroinitializer, <128 x i8> %926, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #12
  %928 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %864, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %929 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %870, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %930 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %928, <64 x i16> %929, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %931 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t269.s, <64 x i16> %t268, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %932 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %891, <64 x i16> %898, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %933 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %904, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %934 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %910, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %935 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %933, <64 x i16> %934, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %936 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<256 x i8> %932, <256 x i8> %935, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %937 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %884, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %938 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %877, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %939 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %937, <64 x i16> %938, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %940 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.2(<128 x i16> %936, <256 x i8> %939, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %941 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %931, <128 x i16> %940, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %942 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %930, <128 x i16> %941, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %943 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %942, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #12
  %944 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8>, <1 x i16> zeroinitializer, <128 x i8> %943, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #12
  %945 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vpackeh_128B_dsl(<64 x i16> %927, <64 x i16> %944, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 2, i32 64, i32 2, i32 8, i32 0) #12
  %946 = add nsw i32 %752, %747
  %947 = getelementptr inbounds i8, i8* %output, i32 %946
  %948 = bitcast i8* %947 to <128 x i8>*
  store <128 x i8> %945, <128 x i8>* %948, align 1, !tbaa !106
  %949 = add nsw i32 %output.s0.x.x, %46
  %950 = shl nsw i32 %949, 7
  %951 = getelementptr inbounds i16, i16* %rows52, i32 %950
  %952 = getelementptr inbounds i16, i16* %951, i32 64
  %953 = bitcast i16* %952 to <64 x i16>*
  %t271 = load <64 x i16>, <64 x i16>* %953, align 128, !tbaa !104
  %954 = bitcast i16* %951 to <64 x i16>*
  %t272.s = load <64 x i16>, <64 x i16>* %954, align 128, !tbaa !104
  %955 = getelementptr inbounds i16, i16* %951, i32 128
  %956 = bitcast i16* %955 to <64 x i16>*
  %t273.s = load <64 x i16>, <64 x i16>* %956, align 128, !tbaa !104
  %957 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t272.s, <64 x i16> %t271, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %958 = bitcast <256 x i8> %957 to <64 x i32>
  %959 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %958)
  %960 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %958)
  %961 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %959, <32 x i32> %960, i32 2)
  %962 = bitcast <32 x i32> %961 to <64 x i16>
  %963 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t271, <64 x i16> %t273.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %964 = bitcast <256 x i8> %963 to <64 x i32>
  %965 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %964)
  %966 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %964)
  %967 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %965, <32 x i32> %966, i32 2)
  %968 = bitcast <32 x i32> %967 to <64 x i16>
  %969 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t272.s, <64 x i16> %t271, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %970 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t272.s, <64 x i16> %t271, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %971 = bitcast <256 x i8> %970 to <64 x i32>
  %972 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %971)
  %973 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %971)
  %974 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %972, <32 x i32> %973, i32 4)
  %975 = bitcast <32 x i32> %974 to <64 x i16>
  %976 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t271, <64 x i16> %t273.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %977 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t271, <64 x i16> %t273.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %978 = bitcast <256 x i8> %977 to <64 x i32>
  %979 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %978)
  %980 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %978)
  %981 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %979, <32 x i32> %980, i32 4)
  %982 = bitcast <32 x i32> %981 to <64 x i16>
  %983 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t272.s, <64 x i16> %t271, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %984 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t272.s, <64 x i16> %t271, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %985 = bitcast <256 x i8> %984 to <64 x i32>
  %986 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %985)
  %987 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %985)
  %988 = tail call <32 x i32> @llvm.hexagon.V6.valignb.128B(<32 x i32> %986, <32 x i32> %987, i32 8)
  %989 = bitcast <32 x i32> %988 to <64 x i16>
  %990 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t271, <64 x i16> %t273.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %991 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t271, <64 x i16> %t273.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %992 = bitcast <256 x i8> %991 to <64 x i32>
  %993 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %992)
  %994 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %992)
  %995 = tail call <32 x i32> @llvm.hexagon.V6.valignb.128B(<32 x i32> %993, <32 x i32> %994, i32 8)
  %996 = bitcast <32 x i32> %995 to <64 x i16>
  %997 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t272.s, <64 x i16> %t271, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %998 = bitcast <256 x i8> %997 to <64 x i32>
  %999 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %998)
  %1000 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %998)
  %1001 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %999, <32 x i32> %1000, i32 6)
  %1002 = bitcast <32 x i32> %1001 to <64 x i16>
  %1003 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t271, <64 x i16> %t273.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1004 = bitcast <256 x i8> %1003 to <64 x i32>
  %1005 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1004)
  %1006 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1004)
  %1007 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %1005, <32 x i32> %1006, i32 6)
  %1008 = bitcast <32 x i32> %1007 to <64 x i16>
  %1009 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %962, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1010 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %968, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1011 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1009, <64 x i16> %1010, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1012 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t272.s, <64 x i16> %t271, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1013 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %989, <64 x i16> %996, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1014 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %1002, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1015 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %1008, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1016 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1014, <64 x i16> %1015, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1017 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<256 x i8> %1013, <256 x i8> %1016, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1018 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %982, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1019 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %975, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1020 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1018, <64 x i16> %1019, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1021 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.2(<128 x i16> %1017, <256 x i8> %1020, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1022 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %1012, <128 x i16> %1021, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1023 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %1011, <128 x i16> %1022, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1024 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %1023, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1025 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8>, <1 x i16> zeroinitializer, <128 x i8> %1024, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #12
  %1026 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %962, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1027 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %968, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1028 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1026, <64 x i16> %1027, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1029 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t272.s, <64 x i16> %t271, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1030 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %989, <64 x i16> %996, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1031 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %1002, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1032 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %1008, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1033 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1031, <64 x i16> %1032, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1034 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<256 x i8> %1030, <256 x i8> %1033, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1035 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %982, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1036 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %975, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1037 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1035, <64 x i16> %1036, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1038 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.2(<128 x i16> %1034, <256 x i8> %1037, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1039 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %1029, <128 x i16> %1038, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1040 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %1028, <128 x i16> %1039, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1041 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %1040, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #12
  %1042 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8>, <1 x i16> zeroinitializer, <128 x i8> %1041, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #12
  %1043 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vpackeh_128B_dsl(<64 x i16> %1025, <64 x i16> %1042, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 2, i32 64, i32 2, i32 8, i32 0) #12
  %1044 = add nsw i32 %752, %749
  %1045 = getelementptr inbounds i8, i8* %output, i32 %1044
  %1046 = bitcast i8* %1045 to <128 x i8>*
  store <128 x i8> %1043, <128 x i8>* %1046, align 1, !tbaa !106
  %1047 = add nsw i32 %output.s0.x.x, %48
  %1048 = shl nsw i32 %1047, 7
  %1049 = getelementptr inbounds i16, i16* %rows52, i32 %1048
  %1050 = getelementptr inbounds i16, i16* %1049, i32 64
  %1051 = bitcast i16* %1050 to <64 x i16>*
  %t274 = load <64 x i16>, <64 x i16>* %1051, align 128, !tbaa !104
  %1052 = bitcast i16* %1049 to <64 x i16>*
  %t275.s = load <64 x i16>, <64 x i16>* %1052, align 128, !tbaa !104
  %1053 = getelementptr inbounds i16, i16* %1049, i32 128
  %1054 = bitcast i16* %1053 to <64 x i16>*
  %t276.s = load <64 x i16>, <64 x i16>* %1054, align 128, !tbaa !104
  %1055 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t275.s, <64 x i16> %t274, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1056 = bitcast <256 x i8> %1055 to <64 x i32>
  %1057 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1056)
  %1058 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1056)
  %1059 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %1057, <32 x i32> %1058, i32 2)
  %1060 = bitcast <32 x i32> %1059 to <64 x i16>
  %1061 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t274, <64 x i16> %t276.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1062 = bitcast <256 x i8> %1061 to <64 x i32>
  %1063 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1062)
  %1064 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1062)
  %1065 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %1063, <32 x i32> %1064, i32 2)
  %1066 = bitcast <32 x i32> %1065 to <64 x i16>
  %1067 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t275.s, <64 x i16> %t274, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1068 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t275.s, <64 x i16> %t274, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1069 = bitcast <256 x i8> %1068 to <64 x i32>
  %1070 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1069)
  %1071 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1069)
  %1072 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %1070, <32 x i32> %1071, i32 4)
  %1073 = bitcast <32 x i32> %1072 to <64 x i16>
  %1074 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t274, <64 x i16> %t276.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1075 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t274, <64 x i16> %t276.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1076 = bitcast <256 x i8> %1075 to <64 x i32>
  %1077 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1076)
  %1078 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1076)
  %1079 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %1077, <32 x i32> %1078, i32 4)
  %1080 = bitcast <32 x i32> %1079 to <64 x i16>
  %1081 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t275.s, <64 x i16> %t274, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1082 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t275.s, <64 x i16> %t274, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1083 = bitcast <256 x i8> %1082 to <64 x i32>
  %1084 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1083)
  %1085 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1083)
  %1086 = tail call <32 x i32> @llvm.hexagon.V6.valignb.128B(<32 x i32> %1084, <32 x i32> %1085, i32 8)
  %1087 = bitcast <32 x i32> %1086 to <64 x i16>
  %1088 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t274, <64 x i16> %t276.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1089 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t274, <64 x i16> %t276.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1090 = bitcast <256 x i8> %1089 to <64 x i32>
  %1091 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1090)
  %1092 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1090)
  %1093 = tail call <32 x i32> @llvm.hexagon.V6.valignb.128B(<32 x i32> %1091, <32 x i32> %1092, i32 8)
  %1094 = bitcast <32 x i32> %1093 to <64 x i16>
  %1095 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t275.s, <64 x i16> %t274, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1096 = bitcast <256 x i8> %1095 to <64 x i32>
  %1097 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1096)
  %1098 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1096)
  %1099 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %1097, <32 x i32> %1098, i32 6)
  %1100 = bitcast <32 x i32> %1099 to <64 x i16>
  %1101 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t274, <64 x i16> %t276.s, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1102 = bitcast <256 x i8> %1101 to <64 x i32>
  %1103 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1102)
  %1104 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1102)
  %1105 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %1103, <32 x i32> %1104, i32 6)
  %1106 = bitcast <32 x i32> %1105 to <64 x i16>
  %1107 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %1060, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1108 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %1066, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1109 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1107, <64 x i16> %1108, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1110 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t275.s, <64 x i16> %t274, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1111 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1087, <64 x i16> %1094, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1112 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %1100, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1113 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %1106, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1114 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1112, <64 x i16> %1113, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1115 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<256 x i8> %1111, <256 x i8> %1114, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1116 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %1080, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1117 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %1073, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1118 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1116, <64 x i16> %1117, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1119 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.2(<128 x i16> %1115, <256 x i8> %1118, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1120 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %1110, <128 x i16> %1119, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1121 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %1109, <128 x i16> %1120, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1122 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %1121, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1123 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8>, <1 x i16> zeroinitializer, <128 x i8> %1122, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #12
  %1124 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %1060, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1125 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %1066, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1126 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1124, <64 x i16> %1125, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1127 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %t275.s, <64 x i16> %t274, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1128 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1087, <64 x i16> %1094, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1129 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %1100, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1130 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %1106, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1131 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1129, <64 x i16> %1130, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1132 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<256 x i8> %1128, <256 x i8> %1131, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1133 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %1080, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1134 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %1073, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0) #12
  %1135 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %1133, <64 x i16> %1134, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %1136 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.2(<128 x i16> %1132, <256 x i8> %1135, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1137 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %1127, <128 x i16> %1136, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1138 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %1126, <128 x i16> %1137, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0) #12
  %1139 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %1138, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #12
  %1140 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8>, <1 x i16> zeroinitializer, <128 x i8> %1139, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0) #12
  %1141 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vpackeh_128B_dsl(<64 x i16> %1123, <64 x i16> %1140, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 2, i32 64, i32 2, i32 8, i32 0) #12
  %1142 = add nsw i32 %752, %751
  %1143 = getelementptr inbounds i8, i8* %output, i32 %1142
  %1144 = bitcast i8* %1143 to <128 x i8>*
  store <128 x i8> %1141, <128 x i8>* %1144, align 1, !tbaa !106
  %1145 = add nuw nsw i32 %output.s0.x.x, 1
  %.not19 = icmp eq i32 %1145, %t171
  br i1 %.not19, label %if.then.i38, label %"for output.s0.x.x"

"end for output.s0.x.x":                          ; preds = %call_destructor.exit36
  %tobool.not.i37.not = icmp eq i8* %744, null
  br i1 %tobool.not.i37.not, label %call_destructor.exit39, label %if.then.i38

if.then.i38:                                      ; preds = %"for output.s0.x.x", %"end for output.s0.x.x"
  tail call void @halide_free(i8* %__user_context, i8* nonnull %744) #14
  br label %call_destructor.exit39

call_destructor.exit39:                           ; preds = %"end for output.s0.x.x", %if.then.i38
  %1146 = add nuw nsw i32 %output.s0.y.y.y, 1
  %.not = icmp eq i32 %1146, 128
  br i1 %.not, label %call_destructor.exit, label %"for output.s0.y.y.y"
}

; Function Attrs: nounwind
define i32 @gaussian5x5_hvx128(%struct.halide_buffer_t* noalias nocapture readonly %input.buffer, %struct.halide_buffer_t* noalias nocapture readonly %output.buffer) local_unnamed_addr #11 {
entry:
  ...
  %11 = and i32 %10, -128
  %a51 = or i32 %11, 126
  %12 = icmp slt i32 %a51, %2
  %a58 = select i1 %12, i32 %a51, i32 %2
  %13 = icmp sgt i32 %a58, 1
  %14 = select i1 %13, i32 %a58, i32 1
  %15 = add nsw i32 %7, 255
  %a54 = ashr i32 %15, 7
  %16 = icmp slt i32 %a54, 1
  %a53 = select i1 %16, i32 %a54, i32 1
  %a55 = add nsw i32 %7, 253
  %17 = icmp slt i32 %a55, %2
  %18 = select i1 %17, i32 %a55, i32 %2
  %19 = add nsw i32 %18, 2
  %b55 = ashr i32 %19, 7
  %20 = add nsw i32 %7, -1
  %21 = and i32 %20, -128
  %b58 = or i32 %21, 4
  %22 = icmp sgt i32 %11, %b58
  %t161 = select i1 %22, i32 %11, i32 %b58
  %23 = icmp sgt i32 %a53, %b55
  %t158 = select i1 %23, i32 %a53, i32 %b55
  %t159 = icmp sgt i32 %7, -128
  %t154 = icmp sle i32 %14, %2
  %24 = ashr i32 %10, 7
  %25 = add nsw i32 %8, -509
  %26 = ashr i32 %25, 2
  %27 = add nsw i32 %t161, 255
  %28 = ashr i32 %27, 7
  %29 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 0
  store i8* %0, i8** %29, align 4
  %30 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 1
  store i8* %5, i8** %30, align 4
  %31 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 2
  store i32 %2, i32* %31, align 4
  %32 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 3
  store i32 %3, i32* %32, align 4
  %33 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 4
  store i32 %4, i32* %33, align 4
  %34 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 5
  store i32 %9, i32* %34, align 4
  %35 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 6
  store i32 %26, i32* %35, align 4
  %36 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 7
  store i32 %t158, i32* %36, align 4
  %37 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 8
  store i32 %a54, i32* %37, align 4
  %38 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 9
  store i32 %24, i32* %38, align 4
  %39 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 10
  store i32 %a53, i32* %39, align 4
  %40 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 11
  store i32 %14, i32* %40, align 4
  %41 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 12
  store i32 %28, i32* %41, align 4
  %42 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 13
  store i1 %t154, i1* %42, align 4
  %43 = getelementptr inbounds { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }, { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure, i32 0, i32 14
  store i1 %t159, i1* %43, align 1
  %44 = add nsw i32 %8, 511
  %45 = ashr i32 %44, 9
  %46 = bitcast { i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i1 }* %parallel_closure to i8*
  %call4.i = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @gaussian5x5_hvx128_par_for_output_s0_y_y_v1, i32 0, i32 %45, i8* nonnull %46) #14
  ret i32 0
}

; Function Attrs: nounwind
define i32 @gaussian5x5_hvx128_argv(i8** nocapture readonly %0) local_unnamed_addr #12 {
entry:
  ...
  %6 = tail call i32 @gaussian5x5_hvx128(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #16
  ret i32 0
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @gaussian5x5_hvx128_metadata() local_unnamed_addr #13 {
entry:
...
; Function Attrs: nounwind readnone
declare <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32>, <32 x i32>, i32 immarg) #9

; Function Attrs: nounwind readnone
declare <32 x i32> @llvm.hexagon.V6.valignb.128B(<32 x i32>, <32 x i32>, i32) #9

define <128 x i16> @hydride.node.gaussian5x5_hvx_depth3.0(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4) local_unnamed_addr {
entry:
  %0 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.4, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %1 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %arg.1, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0)
  %2 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl(<128 x i16> zeroinitializer, <64 x i16> <i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542>, <128 x i8> %1, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0)
  %3 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %arg.2, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0)
  %4 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl.1(<128 x i16> %2, <128 x i8> %3, <64 x i16> <i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028, i16 1028>, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0)
  %5 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %arg, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0)
  %6 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_128B_dsl(<128 x i8> %5, <128 x i8> <i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4>, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 1, i32 0, i32 16, i32 1024, i32 1, i32 0, i32 8, i32 2, i32 0)
  %7 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %4, <128 x i16> %6, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %8 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %0, <128 x i16> %7, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %9 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.3, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %10 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16> %8, <128 x i16> %9, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  ret <128 x i16> %10
}

declare <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8>, i32, i32, i32, i32, i32, i32, i32, i32, i32)

declare <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8>, i32, i32, i32, i32, i32, i32, i32, i32)

declare <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl(<128 x i16>, <64 x i16>, <128 x i8>, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)

declare <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl.1(<128 x i16>, <128 x i8>, <64 x i16>, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)

declare <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_128B_dsl(<128 x i8>, <128 x i8>, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)

declare <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl(<128 x i16>, <128 x i16>, i32, i32, i32, i32, i32, i32, i32)

define <128 x i16> @hydride.node.gaussian5x5_hvx_depth3.1(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4) local_unnamed_addr {
entry:
  %0 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.4, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %1 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %arg.1, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0)
  %2 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl(<128 x i16> zeroinitializer, <64 x i16> <i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542>, <128 x i8> %1, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0)
...
define <128 x i16> @hydride.node.gaussian5x5_hvx_depth3.2(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4) local_unnamed_addr {
entry:
  %0 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.4, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %1 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %arg.1, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0)
  %2 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl(<128 x i16> zeroinitializer, <64 x i16> <i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542>, <128 x i8> %1, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0)
...
define <128 x i16> @hydride.node.gaussian5x5_hvx_depth3.3(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4) local_unnamed_addr {
entry:
  %0 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vunpackh_128B_dsl(<128 x i8> %arg.4, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 16, i32 1, i32 0, i32 0)
  %1 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vshuffh_128B_dsl(<128 x i8> %arg.1, i32 1024, i32 16, i32 0, i32 16, i32 8, i32 16, i32 8, i32 0)
  %2 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vmpybv_acc_128B_dsl(<128 x i16> zeroinitializer, <64 x i16> <i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542, i16 1542>, <128 x i8> %1, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 16, i32 1, i32 -1, i32 1, i32 0, i32 16, i32 -1, i32 1, i32 0, i32 8, i32 1024, i32 2, i32 0)
...
define <128 x i8> @hydride.node.gaussian5x5_hvx_depth3.4(<64 x i16> %arg, <64 x i16> %arg.1, <64 x i16> %arg.2, <64 x i16> %arg.3, <64 x i16> %arg.4, <64 x i16> %arg.5, <64 x i16> %arg.6, <64 x i16> %arg.7, <64 x i16> %arg.8, <64 x i16> %arg.9) local_unnamed_addr {
entry:
  %0 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %arg, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %1 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %2 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %0, <64 x i16> %1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %3 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg.2, <64 x i16> %arg.3, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %4 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg.6, <64 x i16> %arg.7, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %5 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %arg.8, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %6 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %arg.9, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %7 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %5, <64 x i16> %6, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %8 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<256 x i8> %4, <256 x i8> %7, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %9 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %arg.5, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %10 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %arg.4, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %11 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %9, <64 x i16> %10, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %12 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.2(<128 x i16> %8, <256 x i8> %11, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %13 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %3, <128 x i16> %12, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %14 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %2, <128 x i16> %13, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %15 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16> %14, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %16 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8>, <1 x i16> zeroinitializer, <128 x i8> %15, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0)
  %17 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %arg, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %18 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %19 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %17, <64 x i16> %18, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %20 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg.2, <64 x i16> %arg.3, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %21 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg.6, <64 x i16> %arg.7, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %22 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %arg.8, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %23 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %arg.9, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %24 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %22, <64 x i16> %23, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %25 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<256 x i8> %21, <256 x i8> %24, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %26 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %arg.5, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %27 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6, i16 6>, <64 x i16> %arg.4, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %28 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %26, <64 x i16> %27, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %29 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.2(<128 x i16> %25, <256 x i8> %28, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %30 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %20, <128 x i16> %29, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %31 = tail call <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8> %19, <128 x i16> %30, i32 2048, i32 2048, i32 0, i32 2048, i32 16, i32 -1, i32 0)
  %32 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16> %31, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %33 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16> <i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8, i16 8>, <1 x i16> zeroinitializer, <128 x i8> %32, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 1, i32 0)
  %34 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vpackeh_128B_dsl(<64 x i16> %16, <64 x i16> %33, i32 1024, i32 1024, i32 0, i32 512, i32 8, i32 0, i32 512, i32 8, i32 2, i32 64, i32 2, i32 8, i32 0)
  ret <128 x i8> %34
}

declare <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16>, <64 x i16>, <64 x i16>, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)

declare <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16>, <64 x i16>, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)

declare <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.1(<256 x i8>, <256 x i8>, i32, i32, i32, i32, i32, i32, i32)

declare <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.2(<128 x i16>, <256 x i8>, i32, i32, i32, i32, i32, i32, i32)

declare <128 x i16> @llvm.hydride.hexagon_V6_vaddhsat_128B_dsl.3(<256 x i8>, <128 x i16>, i32, i32, i32, i32, i32, i32, i32)

declare <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<128 x i16>, i32, i32, i32, i32, i32, i32, i32)

declare <64 x i16> @llvm.hydride.hexagon_V6_vasrhv_128B_dsl(<64 x i16>, <1 x i16>, <128 x i8>, i32, i32, i32, i32, i32, i32, i32)

declare <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<128 x i16>, i32, i32, i32, i32, i32, i32)

declare <128 x i8> @llvm.hydride.hexagon_V6_vpackeh_128B_dsl(<64 x i16>, <64 x i16>, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.5(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.6(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.7(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.8(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.9(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.10(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.11(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.12(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <128 x i8> @hydride.node.gaussian5x5_hvx_depth3.13(<64 x i16> %arg, <64 x i16> %arg.1, <64 x i16> %arg.2, <64 x i16> %arg.3, <64 x i16> %arg.4, <64 x i16> %arg.5, <64 x i16> %arg.6, <64 x i16> %arg.7, <64 x i16> %arg.8, <64 x i16> %arg.9) local_unnamed_addr {
entry:
  %0 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %arg, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %1 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %2 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %0, <64 x i16> %1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
...
define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.14(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.15(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.16(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.17(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.18(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.19(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.20(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.21(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <128 x i8> @hydride.node.gaussian5x5_hvx_depth3.22(<64 x i16> %arg, <64 x i16> %arg.1, <64 x i16> %arg.2, <64 x i16> %arg.3, <64 x i16> %arg.4, <64 x i16> %arg.5, <64 x i16> %arg.6, <64 x i16> %arg.7, <64 x i16> %arg.8, <64 x i16> %arg.9) local_unnamed_addr {
entry:
  %0 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %arg, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %1 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %2 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %0, <64 x i16> %1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
...
define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.23(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.24(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.25(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.26(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.27(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.28(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.29(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.30(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <128 x i8> @hydride.node.gaussian5x5_hvx_depth3.31(<64 x i16> %arg, <64 x i16> %arg.1, <64 x i16> %arg.2, <64 x i16> %arg.3, <64 x i16> %arg.4, <64 x i16> %arg.5, <64 x i16> %arg.6, <64 x i16> %arg.7, <64 x i16> %arg.8, <64 x i16> %arg.9) local_unnamed_addr {
entry:
  %0 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> %arg, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %1 = tail call <64 x i16> @llvm.hydride.hexagon_V6_vmpyih_acc_128B_dsl(<64 x i16> zeroinitializer, <64 x i16> <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 16, i32 -1, i32 1, i32 32, i32 1, i32 32, i32 1, i32 0)
  %2 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %0, <64 x i16> %1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
...
define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.32(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.33(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.34(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.35(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.36(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.37(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.38(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}

define <256 x i8> @hydride.node.gaussian5x5_hvx_depth3.39(<64 x i16> %arg, <64 x i16> %arg.1) local_unnamed_addr {
entry:
  %0 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<64 x i16> %arg, <64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %0
}
...
!98 = !{!"Halide buffer"}
!99 = !{!100, !100, i64 0}
!100 = !{!"bounded_input", !98, i64 0}
!101 = !{i32 1974}
!102 = !{!"branch_weights", i32 1073741824, i32 0}
!103 = distinct !{!103, !32}
!104 = !{!105, !105, i64 0}
!105 = !{!"rows", !98, i64 0}
!106 = !{!107, !107, i64 0}
