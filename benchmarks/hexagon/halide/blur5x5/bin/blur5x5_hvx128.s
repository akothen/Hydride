...
.Lfunc_end130:
	...
	.p2align	7                               // -- Begin function blur5x5_hvx128_par_for_blur_y_s0_y_y
.LCPI131_0:
	.word	0                               // 0x0
	.word	1                               // 0x1
	.word	2                               // 0x2
...
.LCPI131_1:
	...
	.word	62                              // 0x3e
	.word	63                              // 0x3f
	.section	.text.blur5x5_hvx128_par_for_blur_y_s0_y_y,"ax",@progbits
	.globl	blur5x5_hvx128_par_for_blur_y_s0_y_y
	.p2align	4
	.type	blur5x5_hvx128_par_for_blur_y_s0_y_y,@function
blur5x5_hvx128_par_for_blur_y_s0_y_y:   // @blur5x5_hvx128_par_for_blur_y_s0_y_y
	.cfi_startproc
// %bb.0:                               // %entry
	.cfi_def_cfa r30, 8
	.cfi_offset r31, -4
...
.LBB131_5:                              // %"for blur_y.s0.y.yi.$n.rebased"
                                        // =>This Loop Header: Depth=1
	...
	{
		r14 += add(r7,r0)
		if (!p2) jump:nt .LBB131_8
		memw(r29+#180) = r7
	}                                       // 4-byte Folded Spill
// %bb.6:                               // %"for blur_x.s0.x.x.preheader"
                                        //   in Loop: Header=BB131_5 Depth=1
	{
		r1 = and(r14,#7)
		r0 = memw(r29+#192)
...
.LBB131_7:                              // %"for blur_x.s0.x.x"
	...
	}
	{
		r15 = max(r15,r23)
		v9.w = vmax(v9.w,v0.w)
		v12.w = vmin(v12.w,v1.w)
		v13.w = vmin(v13.w,v1.w)
	}
	{
		r1 = sub(#0,r15)
		v9:8.w = vadd(v9:8.w,v11:10.w)
		v17.w = vmin(v19.w,v1.w)
		v15 = vmem(r7+#1)
	}
	{
		v11 = vsplat(r5)
		v14 = valign(v15,v14,r7)
		v15.w = vmin(v18.w,v1.w)
		v6 = v7
	}
	{
		r6 = addasl(r21,r3,#1)
		...
		v12.w = vmax(v12.w,v0.w)
	}
	{
		v18.w = vmax(v15.w,v0.w)
		v13.w = vmax(v13.w,v0.w)
		v10 = v11
		v19.w = vmax(v17.w,v0.w)
	}
	{
		r7 = addasl(r21,r0,#1)
	...
	}
	{
		v21 = vsplat(r1)
		r4 = add(r15,r20)
		v19:18.w = vadd(v19:18.w,v21:20.w)
		v3.w = vmin(v3.w,v1.w)
	}
	{
		v4.h = vpacke(v5.w,v4.w)
		v2.w = vmax(v2.w,v0.w)
		v20 = v21
		v3.w = vmax(v3.w,v0.w)
	}
	...
	{
		v8.b = vpacke(v0.h,v8.h)
		v9 = vmem(r5+#1)
	}
	{
		v13.h = vpacke(v3.w,v2.w)
	}
	{
		v12 = valign(v12,v7,r7)
		v7 = vmem(r5+#0)
	}
	{
		v6 = valign(v5,v6,r6)
	...
	{
		v10.b = vpacke(v0.h,v10.h)
	}
	{
		v17.b = vshuff(v4.b)
	}
	{
		v11.b = vpacke(v0.h,v11.h)
	}
	{
		v18.h = vshuff(v14.h)
	}
	...
	{
		v13.b = vpacke(v0.h,v13.h)
	}
	{
		v3:2.h = vlut16(v17.b,v16.h,r1)
	}
	{
		v5:4.h = vlut16(v19.b,v18.h,r1)
	}
	{
		v15.b = vshuff(v11.b)
	}
	...
	{
		v3:2.h |= vlut16(v17.b,v16.h,r0)
	}
	{
		v5:4.h |= vlut16(v19.b,v18.h,r0)
	}
	{
		v7:6.h = vlut16(v22.b,v21.h,r1)
	}
	{
		v10.h = vshuff(v20.h)
	}
	...
	{
		v3:2.h |= vlut16(v17.b,v16.h,r3)
	}
	{
		v5:4.h |= vlut16(v19.b,v18.h,r3)
	}
	{
		v7:6.h |= vlut16(v22.b,v21.h,r0)
	}
	{
		v9:8.h = vlut16(v15.b,v14.h,r1)
	}
	{
		v7:6.h |= vlut16(v22.b,v21.h,r3)
	}
	{
		v9:8.h |= vlut16(v15.b,v14.h,r0)
	}
	{
		v13:12.h = vlut16(v11.b,v10.h,r1)
	}
	{
		v3:2.h |= vlut16(v17.b,v16.h,r2)
	}
	{
		v5:4.h |= vlut16(v19.b,v18.h,r2)
	}
	{
		v9:8.h |= vlut16(v15.b,v14.h,r3)
		v2.h = vadd(v4.h,v2.h)
	}
	{
		v13:12.h |= vlut16(v11.b,v10.h,r0)
	}
	{
		v7:6.h |= vlut16(v22.b,v21.h,r2)
	}
	{
		v13:12.h |= vlut16(v11.b,v10.h,r3)
		v2.h = vadd(v2.h,v6.h)
	}
	{
		v9:8.h |= vlut16(v15.b,v14.h,r2)
	}
	{
		r2 = add(r16,r9)
		v13:12.h |= vlut16(v11.b,v10.h,r2)
		v2.h = vadd(v2.h,v8.h)
	}
	{
		r0 = addasl(r12,r2,#1)
		v2.h = vadd(v2.h,v12.h)
	}
	{
		v3:2.uw = vmpy(v2.uh,r22.uh)
	}
	{
		v2.h = vshuffo(v3.h,v2.h)
	}
	{
		v2.uh = vlsr(v2.uh,r3)
	}
...
.LBB131_8:                              // %"end for blur_x.s0.x.x"
                                        //   in Loop: Header=BB131_5 Depth=1
	{
		r4 = and(r25,#7)
		r1 = memw(r29+#76)
	...
	{
		r15 = mpyi(r1,r4)
		if (!p0) jump:nt .LBB131_16
	}
// %bb.9:                               // %"for blur_x.s0.x.x.rebased.preheader"
                                        //   in Loop: Header=BB131_5 Depth=1
	{
		r9 = #0
		if (!p1) jump:nt .LBB131_12
	}
...
.LBB131_11:                             // %"for blur_x.s0.x.x.rebased"
                                        //   Parent Loop BB131_5 Depth=1
                                        // =>  This Inner Loop Header: Depth=2
	{
		r20 = r2
	...
	{
		v9:8.uw = vmpy(v3.uh,r22.uh)
		v2.h = vadd(v5.h,v8.h)
		v18 = vmem(r2+#0)
	}
	{
		v3.h = vshuffo(v9.h,v8.h)
		v7 = vmem(r7+#1)
	}
	{
		r7 = add(r7,#512)
	...
	{
		v5:4.uw = vmpy(v4.uh,r22.uh)
		r6 = add(r6,#512)
		v6.uh = vlsr(v6.uh,r3)
		memw(r29+#248) = r6.new
	}                                       // 4-byte Folded Spill
	{
		v9:8.uw = vmpy(v2.uh,r22.uh)
		v2.uh = vlsr(v3.uh,r3)
		v4.h = vshuffo(v5.h,v4.h)
		r6 = memw(r29+#252)
	}                                       // 4-byte Folded Reload
	{
		r6 = add(r6,#512)
...
.LBB131_12:                             // %"end for blur_x.s0.x.x.rebased.loopexit.unr-lcssa"
                                        //   in Loop: Header=BB131_5 Depth=1
	{
		r0 = memw(r29+#68)
		if (cmp.eq(r0.new,#0)) jump:nt .LBB131_16
	}                                       // 4-byte Folded Reload
// %bb.13:                              // %"for blur_x.s0.x.x.rebased.epil.preheader"
                                        //   in Loop: Header=BB131_5 Depth=1
	{
		r0 = memw(r29+#72)
		r1 = memw(r29+#176)
	...
	{
		r3 = add(r16,#128)
		if (!p3) jump:nt .LBB131_15
		v2 = valign(v2,v6,r3)
		v3.h = vadd(v3.h,v5.h)
	}
	.p2align	4
.LBB131_14:                             // %"for blur_x.s0.x.x.rebased.epil"
                                        //   Parent Loop BB131_5 Depth=1
                                        // =>  This Inner Loop Header: Depth=2
	{
		v2.h = vadd(v3.h,v2.h)
...
.LBB131_16:                             // %"end for blur_x.s0.x.x.rebased"
                                        //   in Loop: Header=BB131_5 Depth=1
	{
		r0 = memw(r29+#88)
		memw(r29+#252) = r15
	...
	{
		p3 = cmp.gt(r0,#0)
		if (!p3.new) jump:nt .LBB131_19
	}
// %bb.17:                              // %"for blur_x.s0.x.x.rebased4.preheader"
                                        //   in Loop: Header=BB131_5 Depth=1
	{
		r1 = and(r14,#7)
		r0 = memw(r29+#192)
...
.LBB131_18:                             // %"for blur_x.s0.x.x.rebased4"
                                        //   Parent Loop BB131_5 Depth=1
                                        // =>  This Inner Loop Header: Depth=2
	{
		r0 = add(pc,##.LCPI131_0@PCREL)
...
// %bb.24:                              // %then_bb8
	...
	{
		r16 = memw(r29+#44)
		if (!cmp.gt(r16.new,#0)) jump:nt .LBB131_31
	}                                       // 4-byte Folded Reload
// %bb.25:                              // %"for blur_y.s0.x.x.preheader"
                                        //   in Loop: Header=BB131_5 Depth=1
	{
		p3 = cmp.eq(r16,#1)
		r26 = #0
		if (p3.new) jump:t .LBB131_29
	}
// %bb.26:                              //   in Loop: Header=BB131_5 Depth=1
	...
	{
		if (!p3) jump:nt .LBB131_28
		v2.h = vadd(v2.h,v3.h)
		vmemu(r28+#0) = v4
	}
	.p2align	4
.LBB131_27:                             // %"for blur_y.s0.x.x"
                                        //   Parent Loop BB131_5 Depth=1
                                        // =>  This Inner Loop Header: Depth=2
	{
		v5:4.uw = vmpy(v2.uh,r22.uh)
		r2 = #2
		r26 = add(r26,#2)
		v2 = vmem(r3+#1)
	}
	...
	{
		v11 = valign(v11,v7,r6)
		v3 = vmem(r7+#0)
	}
	{
		v2.h = vadd(v2.h,v11.h)
		v9 = vmem(r4+#1)
	}
	{
		v9 = valign(v9,v10,r4)
...
.LBB131_29:                             // %"end for blur_y.s0.x.x.loopexit.unr-lcssa"
                                        //   in Loop: Header=BB131_5 Depth=1
	{
		r0 = memw(r29+#24)
		if (cmp.eq(r0.new,#0)) jump:t .LBB131_31
	}                                       // 4-byte Folded Reload
// %bb.30:                              // %"for blur_y.s0.x.x.epil"
                                        //   in Loop: Header=BB131_5 Depth=1
	{
		r4 = asl(r26,#6)
		r0 = add(r14,#5)
...
.LBB131_31:                             // %"end for blur_y.s0.x.x"
                                        //   in Loop: Header=BB131_5 Depth=1
	{
		r0 = memw(r29+#48)
		if (!cmp.gt(r0.new,r16)) jump:nt ##.LBB131_20
	}                                       // 4-byte Folded Reload
// %bb.32:                              // %"for blur_y.s0.x.x10.preheader"
                                        //   in Loop: Header=BB131_5 Depth=1
	{
		r0 = add(r14,#5)
		r1 = add(r14,#4)
...
.LBB131_33:                             // %next_bb3
	...
	.p2align	4
.LBB131_42:                             // %after_bb23
                                        //   in Loop: Header=BB131_34 Depth=1
	{
		r5 = add(r5,#1)
		r28 = ##-858927923
	} :endloop1
...
.LBB131_34:                             // %"for blur_y.s0.y.yi.$n.rebased15"
                                        // =>This Loop Header: Depth=1
	...
	{
		r0 = and(r11,#7)
		if (!p0) jump:nt .LBB131_37
		memw(r29+#248) = r0.new
	}                                       // 4-byte Folded Spill
// %bb.35:                              // %"for blur_x.s0.x.x19.preheader"
                                        //   in Loop: Header=BB131_34 Depth=1
	{
		r0 = memw(r29+#192)
		r3 = memw(r29+#248)
...
.LBB131_36:                             // %"for blur_x.s0.x.x19"
                                        //   Parent Loop BB131_34 Depth=1
                                        // =>  This Inner Loop Header: Depth=2
	{
		r20 = min(r10,r27)
		r10 = add(r10,#64)
	...
	}
	{
		...
		v7 = vsplat(r5)
		r3 = add(r20,#-60)
		v10 = valign(v11,v10,r6)
	}
	{
		v15 = vsplat(r3)
		r3 = add(r20,#-61)
		v5:4.w = vadd(v5:4.w,v9:8.w)
		v6 = v7
	}
	{
		v17 = vsplat(r3)
	...
	}
	{
		r13 = min(r8,r20)
		v4.h = vpacke(v5.w,v4.w)
		v11:10.w = vadd(v11:10.w,v3:2.w)
		v16 = v17
	}
	{
		r13 = add(r13,#-60)
		v15:14.w = vadd(v15:14.w,v3:2.w)
		v5.w = vmin(v10.w,v1.w)
		v10.w = vmin(v11.w,v1.w)
	}
	{
		r13 = max(r13,r23)
		v7:6.w = vadd(v7:6.w,v3:2.w)
		v18.w = vmax(v5.w,v0.w)
		v5.w = vmin(v14.w,v1.w)
	}
	{
		r6 = addasl(r21,r15,#1)
		v17:16.w = vadd(v17:16.w,v3:2.w)
		v6.w = vmin(v6.w,v1.w)
		v7.w = vmin(v7.w,v1.w)
	}
	{
		v17 = vsplat(r1)
		r4 = add(r13,r19)
		v14.w = vmax(v5.w,v0.w)
		v5.w = vmin(v17.w,v1.w)
	}
	{
		r3 = sub(#0,r24)
		v19.w = vmax(v10.w,v0.w)
		v10.w = vmin(v16.w,v1.w)
		v6.w = vmax(v6.w,v0.w)
	}
	{
		r13 = sub(#0,r13)
		v7.w = vmax(v7.w,v0.w)
		v16 = v17
		v11.w = vmin(v15.w,v1.w)
	}
	{
		v21 = vsplat(r3)
		v17 = vsplat(r13)
		r15 = sub(#0,r18)
		v7:6.w = vadd(v7:6.w,v17:16.w)
	}
	{
		v15.w = vmax(v11.w,v0.w)
		v20 = v21
		v16 = v17
		v8 = vmem(r6+#0)
	}
	{
		r0 = addasl(r21,r25,#1)
		r5 = add(r18,r19)
		v15:14.w = vadd(v15:14.w,v17:16.w)
		v19:18.w = vadd(v19:18.w,v21:20.w)
	}
	{
		v17 = vsplat(r15)
		v6.h = vpacke(v7.w,v6.w)
		v11.w = vmax(v5.w,v0.w)
		v9 = vmem(r6+#1)
	}
	{
		r5 = addasl(r21,r5,#1)
		v13.h = vpacke(v19.w,v18.w)
		v10.w = vmax(v10.w,v0.w)
		v16 = v17
	}
	{
		r6 = addasl(r21,r4,#1)
		v5 = valign(v9,v8,r6)
		v11:10.w = vadd(v11:10.w,v17:16.w)
		v8 = vmem(r0+#0)
	}
	{
		r4 = add(r17,r20)
	...
	{
		v14.h = vpacke(v15.w,v14.w)
		v7 = vmem(r6+#0)
	}
	{
		v6.b = vpacke(v0.h,v6.h)
		v16 = vmem(r5+#0)
	}
	{
		r0 = #1
	...
	{
		v14.b = vpacke(v0.h,v14.h)
	}
	{
		v5:4.h = vlut16(v15.b,v12.h,r6)
	}
	{
		v20 = valign(v17,v16,r5)
	}
	{
		v21.b = vpacke(v0.h,v10.h)
	}
	{
		v22.h = vshuff(v8.h)
	}
	...
	{
		v7:6.h = vlut16(v19.b,v18.h,r6)
	}
	{
		v5:4.h |= vlut16(v15.b,v12.h,r0)
	}
	{
		v16.h = vshuff(v11.h)
	}
	...
	{
		v7:6.h |= vlut16(v19.b,v18.h,r0)
	}
	{
		v9:8.h = vlut16(v23.b,v22.h,r6)
	}
	{
		v5:4.h |= vlut16(v15.b,v12.h,r7)
	}
	{
		v10.h = vshuff(v20.h)
	}
	...
	{
		v7:6.h |= vlut16(v19.b,v18.h,r7)
	}
	{
		v9:8.h |= vlut16(v23.b,v22.h,r0)
	}
	{
		v5:4.h |= vlut16(v15.b,v12.h,r2)
	}
	{
		v13:12.h = vlut16(v17.b,v16.h,r6)
	}
	{
		v9:8.h |= vlut16(v23.b,v22.h,r7)
	}
	{
		v13:12.h |= vlut16(v17.b,v16.h,r0)
	}
	{
		v15:14.h = vlut16(v11.b,v10.h,r6)
	}
	{
		v7:6.h |= vlut16(v19.b,v18.h,r2)
	}
	{
		r0 = addasl(r12,r4,#1)
		v15:14.h |= vlut16(v11.b,v10.h,r0)
		v4.h = vadd(v6.h,v4.h)
	}
	{
		v13:12.h |= vlut16(v17.b,v16.h,r7)
	}
	{
		v9:8.h |= vlut16(v23.b,v22.h,r2)
	}
	{
		v15:14.h |= vlut16(v11.b,v10.h,r7)
		v4.h = vadd(v4.h,v8.h)
	}
	{
		v13:12.h |= vlut16(v17.b,v16.h,r2)
	}
	{
		v15:14.h |= vlut16(v11.b,v10.h,r2)
		v4.h = vadd(v4.h,v12.h)
	}
	{
		v4.h = vadd(v4.h,v14.h)
	}
	{
		v5:4.uw = vmpy(v4.uh,r28.uh)
	}
	{
		v4.h = vshuffo(v5.h,v4.h)
	}
...
.LBB131_37:                             // %"consume blur_x22"
                                        //   in Loop: Header=BB131_34 Depth=1
	{
		r17 = ##-858927923
		if (!p1) jump:nt .LBB131_42
		r5 = memw(r29+#228)
	}                                       // 4-byte Folded Reload
// %bb.38:                              // %"consume blur_x22"
                                        //   in Loop: Header=BB131_34 Depth=1
	{
		p3 = cmp.gtu(r5,#3)
		if (!p3.new) jump:nt .LBB131_42
	}
// %bb.39:                              // %"for blur_y.s0.x.x26.preheader"
                                        //   in Loop: Header=BB131_34 Depth=1
	{
		r0 = add(r11,#5)
		r1 = add(r11,#4)
	...
	}                                       // 4-byte Folded Reload
	{
		r28 += mpyi(r5,r0)
		r5 = #64
		if (p2) jump:nt .LBB131_40
	}
// %bb.43:                              //   in Loop: Header=BB131_34 Depth=1
	{
		r14 = #64
		r22 = add(r22,#2)
		r0 = memw(r29+#180)
	...
	{
		if (!p3) jump:nt .LBB131_45
		v6 = vmem(r4+#0)
	}
	.p2align	4
.LBB131_44:                             // %"for blur_y.s0.x.x26"
                                        //   Parent Loop BB131_34 Depth=1
                                        // =>  This Inner Loop Header: Depth=2
	{
		r3 = addasl(r17,r15,#1)
		v13 = valign(v13,v14,r3)
		r11 = memw(r29+#204)
		v14.cur = vmem(r3+#0)
	}                                       // 4-byte Folded Reload
	{
		r15 = ##-858927923
		v11 = valign(v11,v12,r5)
		v14 = vmem(r1+#0)
	}
	{
		r0 = add(r28,r24)
	...
	{
		v9.h = vadd(v9.h,v11.h)
		r27 = memw(r29+#232)
		v10 = vmem(r1+#1)
	}                                       // 4-byte Folded Reload
	{
		r24 = min(r13,r14)
		v10 = valign(v10,v14,r1)
		v7.h = vadd(v9.h,v7.h)
		v11 = vmem(r3+#1)
	}
	{
		v11 = valign(v11,v12,r3)
		v9.h = vadd(v10.h,v13.h)
		v5.h = vadd(v7.h,v5.h)
		v14 = vmem(r7+#1)
	}
	{
		v4 = valign(v14,v4,r7)
		v7.h = vadd(v9.h,v11.h)
		v10 = vmem(r2+#1)
	}
	{
		v8 = valign(v10,v8,r2)
	...
	}                                       // 4-byte Folded Reload
	{
		r3 = add(r6,r10)
		r1 = add(r6,r27)
		v6.h = vshuffo(v7.h,v6.h)
		r26 = memw(r29+#200)
	}                                       // 4-byte Folded Reload
	{
		v5:4.uw = vmpy(v5.uh,r15.uh)
		r15 = add(r28,r25)
		r25 = add(r13,#-64)
		r19 = memw(r29+#248)
	}                                       // 4-byte Folded Reload
	{
		r25 = min(r25,r14)
		r15 = addasl(r26,r15,#1)
		v5.h = vshuffo(v5.h,v4.h)
		r18 = memw(r29+#240)
	}                                       // 4-byte Folded Reload
	{
		r7 = addasl(r17,r1,#1)
...
.LBB131_45:                             //   in Loop: Header=BB131_34 Depth=1
	{
		r5 = addasl(r17,r15,#1)
		r0 = add(r28,r25)
		v11 = valign(v11,v12,r5)
	...
	{
		v10.h = vadd(v10.h,v12.h)
		v12 = vmem(r5+#1)
	}
	{
		v12 = valign(v12,v13,r5)
		v7.h = vadd(v9.h,v7.h)
		v13 = vmem(r2+#1)
	}
	{
	...
	{
		r1 = addasl(r3,r4,#1)
		v7:6.uw = vmpy(v6.uh,r5.uh)
		r11 = memw(r29+#240)
		r27 = memw(r29+#8)
	}                                       // 4-byte Folded Reload
	{
		v5:4.uw = vmpy(v4.uh,r5.uh)
		v6.h = vshuffo(v7.h,v6.h)
		r15 = memw(r29+#248)
		r14 = memw(r29+#176)
	}                                       // 4-byte Folded Reload
...
.LBB131_40:                             // %after_bb23.loopexit.unr-lcssa
                                        //   in Loop: Header=BB131_34 Depth=1
	{
		r6 = #0
		r0 = memw(r29+#216)
	...
	{
		p3 = cmp.eq(r0,#0)
		if (p3.new) jump:t .LBB131_42
	}
// %bb.41:                              // %"for blur_y.s0.x.x26.epil"
                                        //   in Loop: Header=BB131_34 Depth=1
	{
		r0 = asl(r22,#6)
		r1 = memw(r29+#252)
...
.LBB131_21:                             // %"end for blur_y.s0.y.yi.$n.rebased"
	{
		p0 = cmp.eq(r12,#0)
		if (p0.new) jump:nt .LBB131_23
		r16 = memw(r29+#4)
	}                                       // 4-byte Folded Reload
// %bb.22:                              // %if.then.i42
	{
		call ##halide_free
		r1:0 = combine(r12,r16)
	}
.LBB131_23:                             // %call_destructor.exit
	{
...
.Lfunc_end131:
	.size	blur5x5_hvx128_par_for_blur_y_s0_y_y, .Lfunc_end131-blur5x5_hvx128_par_for_blur_y_s0_y_y
	.cfi_endproc
                                        // -- End function
	.section	.text.blur5x5_hvx128,"ax",@progbits
	.globl	blur5x5_hvx128                  // -- Begin function blur5x5_hvx128
	.p2align	4
	.type	blur5x5_hvx128,@function
blur5x5_hvx128:                         // @blur5x5_hvx128
// %bb.0:                               // %entry
	{
		r13 = #64
		r3 = memw(r1+#32)
	...
	{
		r0 = #0
		r1 = memw(r0+##blur5x5_hvx128_par_for_blur_y_s0_y_y@GOT)
	}
	{
...
.Lfunc_end132:
	.size	blur5x5_hvx128, .Lfunc_end132-blur5x5_hvx128
                                        // -- End function
	.section	.text.blur5x5_hvx128_argv,"ax",@progbits
	.globl	blur5x5_hvx128_argv             // -- Begin function blur5x5_hvx128_argv
	.p2align	4
	.type	blur5x5_hvx128_argv,@function
blur5x5_hvx128_argv:                    // @blur5x5_hvx128_argv
// %bb.0:                               // %entry
	{
		allocframe(r29,#0):raw
	}
...
.Lfunc_end133:
	.size	blur5x5_hvx128_argv, .Lfunc_end133-blur5x5_hvx128_argv
                                        // -- End function
	.section	.text.blur5x5_hvx128_metadata,"ax",@progbits
	.globl	blur5x5_hvx128_metadata         // -- Begin function blur5x5_hvx128_metadata
	.p2align	4
	.type	blur5x5_hvx128_metadata,@function
blur5x5_hvx128_metadata:                // @blur5x5_hvx128_metadata
// %bb.0:                               // %entry
	{
		r0 = add(pc,##.Lblur5x5_hvx128_metadata_storage@PCREL)
		jumpr r31
	}
.Lfunc_end134:
	.size	blur5x5_hvx128_metadata, .Lfunc_end134-blur5x5_hvx128_metadata
                                        // -- End function
...
.Lstr.103:
	...
	.p2align	5
.Lstr.104:
	.string	"blur5x5_hvx128"
	.size	.Lstr.104, 15

	.type	.Lblur5x5_hvx128_metadata_storage,@object // @blur5x5_hvx128_metadata_storage
	.section	.data.rel.ro,"aw",@progbits
	.p2align	4
.Lblur5x5_hvx128_metadata_storage:
	.word	1                               // 0x1
	.word	2                               // 0x2
	.word	.L__unnamed_3
	.word	.Lstr.103
	.word	.Lstr.104
	.size	.Lblur5x5_hvx128_metadata_storage, 20
