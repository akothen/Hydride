...
; Function Attrs: nounwind readnone
declare <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32>, i32) #9
...
"for blur_y.s0.y.yi.$n.rebased":                  ; preds = %then_bb2, %after_bb7
  %"blur_y.s0.y.yi.$n.rebased" = phi i32 [ 0, %then_bb2 ], [ %742, %after_bb7 ]
...
"for blur_x.s0.x.x":                              ; preds = %"for blur_x.s0.x.x.preheader", %"for blur_x.s0.x.x"
  %blur_x.s0.x.x = phi i32 [ %358, %"for blur_x.s0.x.x" ], [ 0, %"for blur_x.s0.x.x.preheader" ]
  ...
  %212 = bitcast <32 x i32> %211 to <64 x i16>
  %213 = getelementptr inbounds i16, i16* %87, i32 %t396
  %214 = bitcast i16* %213 to <32 x i32>*
  %215 = load <32 x i32>, <32 x i32>* %214, align 2, !tbaa !97
  %216 = add nsw i32 %b23, -64
  %217 = insertelement <64 x i32> undef, i32 %216, i32 0
  %218 = shufflevector <64 x i32> %217, <64 x i32> undef, <64 x i32> zeroinitializer
  %219 = add nsw <64 x i32> %218, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %220 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %219)
  %221 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %220, <32 x i32> %151) #12
  %222 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %219)
  %223 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %222, <32 x i32> %152) #12
  %224 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %221, <32 x i32> %153) #12
  %225 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %223, <32 x i32> %154) #12
  %226 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %225, <32 x i32> %224)
  %227 = sub i32 0, %167
  %228 = insertelement <64 x i32> undef, i32 %227, i32 0
  %229 = shufflevector <64 x i32> %228, <64 x i32> undef, <64 x i32> zeroinitializer
  %230 = add nsw <64 x i32> %226, %229
  ...
  %238 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %215)
  %239 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %237)
  %240 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %239, <32 x i32> %238, i32 0)
  %241 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %240, <32 x i32> %239, <32 x i32> %238, i32 1)
  %242 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %241, <32 x i32> %239, <32 x i32> %238, i32 2)
  %243 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %242, <32 x i32> %239, <32 x i32> %238, i32 3)
  %244 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %243)
  %245 = bitcast <32 x i32> %244 to <64 x i16>
  %246 = getelementptr inbounds i16, i16* %87, i32 %t397
  %247 = bitcast i16* %246 to <32 x i32>*
  %248 = load <32 x i32>, <32 x i32>* %247, align 2, !tbaa !97
  %249 = add nsw i32 %b23, -62
  %250 = insertelement <64 x i32> undef, i32 %249, i32 0
  %251 = shufflevector <64 x i32> %250, <64 x i32> undef, <64 x i32> zeroinitializer
  %252 = add nsw <64 x i32> %251, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %253 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %252)
  %254 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %253, <32 x i32> %151) #12
  %255 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %252)
  %256 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %255, <32 x i32> %152) #12
  %257 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %254, <32 x i32> %153) #12
  %258 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %256, <32 x i32> %154) #12
  %259 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %258, <32 x i32> %257)
  %260 = sub i32 0, %171
  %261 = insertelement <64 x i32> undef, i32 %260, i32 0
  %262 = shufflevector <64 x i32> %261, <64 x i32> undef, <64 x i32> zeroinitializer
  %263 = add nsw <64 x i32> %259, %262
  %264 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %263) #12
  %265 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %263) #12
  %266 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %265, <32 x i32> %264) #12
  %267 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %266)
  %268 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %267) #12
  %269 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %267) #12
  %270 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %268, <32 x i32> %269) #12
  %271 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %248)
  %272 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %270)
  %273 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %272, <32 x i32> %271, i32 0)
  %274 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %273, <32 x i32> %272, <32 x i32> %271, i32 1)
  %275 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %274, <32 x i32> %272, <32 x i32> %271, i32 2)
  %276 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %275, <32 x i32> %272, <32 x i32> %271, i32 3)
  %277 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %276)
  %278 = bitcast <32 x i32> %277 to <64 x i16>
  %279 = getelementptr inbounds i16, i16* %87, i32 %t398
  %280 = bitcast i16* %279 to <32 x i32>*
  %281 = load <32 x i32>, <32 x i32>* %280, align 2, !tbaa !97
  %282 = add nsw i32 %b23, -60
  %283 = insertelement <64 x i32> undef, i32 %282, i32 0
  %284 = shufflevector <64 x i32> %283, <64 x i32> undef, <64 x i32> zeroinitializer
  %285 = add nsw <64 x i32> %284, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %286 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %285)
  %287 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %286, <32 x i32> %151) #12
  %288 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %285)
  %289 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %288, <32 x i32> %152) #12
  %290 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %287, <32 x i32> %153) #12
  %291 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %289, <32 x i32> %154) #12
  %292 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %291, <32 x i32> %290)
  %293 = sub i32 0, %175
  %294 = insertelement <64 x i32> undef, i32 %293, i32 0
  %295 = shufflevector <64 x i32> %294, <64 x i32> undef, <64 x i32> zeroinitializer
  %296 = add nsw <64 x i32> %292, %295
  %297 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %296) #12
  %298 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %296) #12
  %299 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %298, <32 x i32> %297) #12
  %300 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %299)
  %301 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %300) #12
  %302 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %300) #12
  %303 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %301, <32 x i32> %302) #12
  %304 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %281)
  %305 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %303)
  %306 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %305, <32 x i32> %304, i32 0)
  %307 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %306, <32 x i32> %305, <32 x i32> %304, i32 1)
  %308 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %307, <32 x i32> %305, <32 x i32> %304, i32 2)
  %309 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %308, <32 x i32> %305, <32 x i32> %304, i32 3)
  %310 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %309)
  %311 = bitcast <32 x i32> %310 to <64 x i16>
  %312 = getelementptr inbounds i16, i16* %87, i32 %t399
  %313 = bitcast i16* %312 to <32 x i32>*
  %314 = load <32 x i32>, <32 x i32>* %313, align 2, !tbaa !97
  %315 = add nsw i32 %b23, -61
  %316 = insertelement <64 x i32> undef, i32 %315, i32 0
  %317 = shufflevector <64 x i32> %316, <64 x i32> undef, <64 x i32> zeroinitializer
  %318 = add nsw <64 x i32> %317, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %319 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %318)
  %320 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %319, <32 x i32> %151) #12
  %321 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %318)
  %322 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %321, <32 x i32> %152) #12
  %323 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %320, <32 x i32> %153) #12
  %324 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %322, <32 x i32> %154) #12
  ...
  %329 = add nsw <64 x i32> %325, %328
  %330 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %329) #12
  %331 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %329) #12
  %332 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %331, <32 x i32> %330) #12
  %333 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %332)
  %334 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %333) #12
  %335 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %333) #12
  %336 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %334, <32 x i32> %335) #12
  %337 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %314)
  %338 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %336)
  %339 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %338, <32 x i32> %337, i32 0)
  %340 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %339, <32 x i32> %338, <32 x i32> %337, i32 1)
  %341 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %340, <32 x i32> %338, <32 x i32> %337, i32 2)
  %342 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %341, <32 x i32> %338, <32 x i32> %337, i32 3)
  %343 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %342)
  %344 = bitcast <32 x i32> %343 to <64 x i16>
  %345 = add <64 x i16> %245, %212
  %346 = add <64 x i16> %345, %278
  %347 = add <64 x i16> %346, %311
  %348 = add <64 x i16> %347, %344
  %349 = bitcast <64 x i16> %348 to <32 x i32>
  %350 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %349, i32 -858927923) #12
  %351 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %350) #12
  %352 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %350) #12
  %353 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %352, <32 x i32> %351) #12
  %354 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %353, i32 2) #12
  %355 = add nsw i32 %157, %b23
  %356 = getelementptr inbounds i16, i16* %blur_x, i32 %355
  %357 = bitcast i16* %356 to <32 x i32>*
  store <32 x i32> %354, <32 x i32>* %357, align 2, !tbaa !100
  %358 = add nuw nsw i32 %blur_x.s0.x.x, 1
  %.not38 = icmp eq i32 %358, %t331
...
"for blur_x.s0.x.x.rebased.preheader":            ; preds = %"end for blur_x.s0.x.x"
  %359 = add i32 %"blur_y.s0.y.yi.$n.rebased", %blur_y.s0.y.yi.base.s
  %360 = add i32 %359, %blur_y.min.1
  %361 = sub i32 %360, %b6
  %362 = mul nsw i32 %361, %input.stride.1
  %363 = sub i32 %362, %b52
  %364 = add i32 %363, %t322
  %365 = and i32 %360, 7
  %366 = mul nsw i32 %a35, %365
...
"for blur_x.s0.x.x.rebased":                      ; preds = %"for blur_x.s0.x.x.rebased.preheader", %"for blur_x.s0.x.x.rebased"
  %blur_x.s0.x.x.rebased = phi i32 [ %494, %"for blur_x.s0.x.x.rebased" ], [ 0, %"for blur_x.s0.x.x.rebased.preheader" ]
  %niter55 = phi i32 [ %niter55.nsub.3, %"for blur_x.s0.x.x.rebased" ], [ %unroll_iter54, %"for blur_x.s0.x.x.rebased.preheader" ]
  %367 = add nsw i32 %blur_x.s0.x.x.rebased, %t331
  %368 = shl nsw i32 %367, 6
  %t286 = add i32 %364, %368
  %369 = getelementptr inbounds i16, i16* %87, i32 %t286
  %370 = getelementptr inbounds i16, i16* %369, i32 -63
  %371 = bitcast i16* %370 to <64 x i16>*
  %372 = load <64 x i16>, <64 x i16>* %371, align 2, !tbaa !97
  %373 = getelementptr inbounds i16, i16* %369, i32 -64
  %374 = bitcast i16* %373 to <64 x i16>*
  %375 = load <64 x i16>, <64 x i16>* %374, align 2, !tbaa !97
  %376 = getelementptr inbounds i16, i16* %369, i32 -62
  %377 = bitcast i16* %376 to <64 x i16>*
  %378 = load <64 x i16>, <64 x i16>* %377, align 2, !tbaa !97
  %379 = getelementptr inbounds i16, i16* %369, i32 -60
  %380 = bitcast i16* %379 to <64 x i16>*
  %381 = load <64 x i16>, <64 x i16>* %380, align 2, !tbaa !97
  %382 = getelementptr inbounds i16, i16* %369, i32 -61
  %383 = bitcast i16* %382 to <64 x i16>*
  %384 = load <64 x i16>, <64 x i16>* %383, align 2, !tbaa !97
  %385 = add <64 x i16> %375, %372
  %386 = add <64 x i16> %385, %378
  %387 = add <64 x i16> %386, %381
  %388 = add <64 x i16> %387, %384
  %389 = bitcast <64 x i16> %388 to <32 x i32>
  %390 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %389, i32 -858927923) #12
  %391 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %390) #12
  %392 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %390) #12
  %393 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %392, <32 x i32> %391) #12
  %394 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %393, i32 2) #12
  %395 = add nsw i32 %368, %366
  %396 = getelementptr inbounds i16, i16* %blur_x, i32 %395
  %397 = bitcast i16* %396 to <32 x i32>*
  store <32 x i32> %394, <32 x i32>* %397, align 2, !tbaa !100
  %398 = or i32 %blur_x.s0.x.x.rebased, 1
  %399 = add nsw i32 %398, %t331
  %400 = shl nsw i32 %399, 6
  %t286.1 = add i32 %364, %400
  %401 = getelementptr inbounds i16, i16* %87, i32 %t286.1
  %402 = getelementptr inbounds i16, i16* %401, i32 -63
  %403 = bitcast i16* %402 to <64 x i16>*
  %404 = load <64 x i16>, <64 x i16>* %403, align 2, !tbaa !97
  %405 = getelementptr inbounds i16, i16* %401, i32 -64
  %406 = bitcast i16* %405 to <64 x i16>*
  %407 = load <64 x i16>, <64 x i16>* %406, align 2, !tbaa !97
  %408 = getelementptr inbounds i16, i16* %401, i32 -62
  %409 = bitcast i16* %408 to <64 x i16>*
  %410 = load <64 x i16>, <64 x i16>* %409, align 2, !tbaa !97
  %411 = getelementptr inbounds i16, i16* %401, i32 -60
  %412 = bitcast i16* %411 to <64 x i16>*
  %413 = load <64 x i16>, <64 x i16>* %412, align 2, !tbaa !97
  %414 = getelementptr inbounds i16, i16* %401, i32 -61
  %415 = bitcast i16* %414 to <64 x i16>*
  %416 = load <64 x i16>, <64 x i16>* %415, align 2, !tbaa !97
  %417 = add <64 x i16> %407, %404
  %418 = add <64 x i16> %417, %410
  %419 = add <64 x i16> %418, %413
  %420 = add <64 x i16> %419, %416
  %421 = bitcast <64 x i16> %420 to <32 x i32>
  %422 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %421, i32 -858927923) #12
  ...
  %425 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %424, <32 x i32> %423) #12
  %426 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %425, i32 2) #12
  %427 = add nsw i32 %400, %366
  %428 = getelementptr inbounds i16, i16* %blur_x, i32 %427
  %429 = bitcast i16* %428 to <32 x i32>*
  store <32 x i32> %426, <32 x i32>* %429, align 2, !tbaa !100
  %430 = or i32 %blur_x.s0.x.x.rebased, 2
  %431 = add nsw i32 %430, %t331
  %432 = shl nsw i32 %431, 6
  %t286.2 = add i32 %364, %432
  %433 = getelementptr inbounds i16, i16* %87, i32 %t286.2
  %434 = getelementptr inbounds i16, i16* %433, i32 -63
  %435 = bitcast i16* %434 to <64 x i16>*
  %436 = load <64 x i16>, <64 x i16>* %435, align 2, !tbaa !97
  %437 = getelementptr inbounds i16, i16* %433, i32 -64
  %438 = bitcast i16* %437 to <64 x i16>*
  %439 = load <64 x i16>, <64 x i16>* %438, align 2, !tbaa !97
  %440 = getelementptr inbounds i16, i16* %433, i32 -62
  %441 = bitcast i16* %440 to <64 x i16>*
  %442 = load <64 x i16>, <64 x i16>* %441, align 2, !tbaa !97
  %443 = getelementptr inbounds i16, i16* %433, i32 -60
  %444 = bitcast i16* %443 to <64 x i16>*
  %445 = load <64 x i16>, <64 x i16>* %444, align 2, !tbaa !97
  %446 = getelementptr inbounds i16, i16* %433, i32 -61
  %447 = bitcast i16* %446 to <64 x i16>*
  %448 = load <64 x i16>, <64 x i16>* %447, align 2, !tbaa !97
  %449 = add <64 x i16> %439, %436
  %450 = add <64 x i16> %449, %442
  %451 = add <64 x i16> %450, %445
  %452 = add <64 x i16> %451, %448
  %453 = bitcast <64 x i16> %452 to <32 x i32>
  %454 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %453, i32 -858927923) #12
  %455 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %454) #12
  %456 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %454) #12
  %457 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %456, <32 x i32> %455) #12
  %458 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %457, i32 2) #12
  %459 = add nsw i32 %432, %366
  %460 = getelementptr inbounds i16, i16* %blur_x, i32 %459
  %461 = bitcast i16* %460 to <32 x i32>*
  store <32 x i32> %458, <32 x i32>* %461, align 2, !tbaa !100
  %462 = or i32 %blur_x.s0.x.x.rebased, 3
  %463 = add nsw i32 %462, %t331
  %464 = shl nsw i32 %463, 6
  %t286.3 = add i32 %364, %464
  %465 = getelementptr inbounds i16, i16* %87, i32 %t286.3
  %466 = getelementptr inbounds i16, i16* %465, i32 -63
  %467 = bitcast i16* %466 to <64 x i16>*
  %468 = load <64 x i16>, <64 x i16>* %467, align 2, !tbaa !97
  %469 = getelementptr inbounds i16, i16* %465, i32 -64
  %470 = bitcast i16* %469 to <64 x i16>*
  %471 = load <64 x i16>, <64 x i16>* %470, align 2, !tbaa !97
  %472 = getelementptr inbounds i16, i16* %465, i32 -62
  %473 = bitcast i16* %472 to <64 x i16>*
  %474 = load <64 x i16>, <64 x i16>* %473, align 2, !tbaa !97
  %475 = getelementptr inbounds i16, i16* %465, i32 -60
  %476 = bitcast i16* %475 to <64 x i16>*
  %477 = load <64 x i16>, <64 x i16>* %476, align 2, !tbaa !97
  %478 = getelementptr inbounds i16, i16* %465, i32 -61
  %479 = bitcast i16* %478 to <64 x i16>*
  %480 = load <64 x i16>, <64 x i16>* %479, align 2, !tbaa !97
  %481 = add <64 x i16> %471, %468
  %482 = add <64 x i16> %481, %474
  %483 = add <64 x i16> %482, %477
  %484 = add <64 x i16> %483, %480
  %485 = bitcast <64 x i16> %484 to <32 x i32>
  %486 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %485, i32 -858927923) #12
  %487 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %486) #12
  %488 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %486) #12
  %489 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %488, <32 x i32> %487) #12
  %490 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %489, i32 2) #12
  %491 = add nsw i32 %464, %366
  %492 = getelementptr inbounds i16, i16* %blur_x, i32 %491
  %493 = bitcast i16* %492 to <32 x i32>*
  store <32 x i32> %490, <32 x i32>* %493, align 2, !tbaa !100
  %494 = add nuw nsw i32 %blur_x.s0.x.x.rebased, 4
...
"end for blur_x.s0.x.x.rebased.loopexit.unr-lcssa": ; preds = %"for blur_x.s0.x.x.rebased", %"for blur_x.s0.x.x.rebased.preheader"
  %blur_x.s0.x.x.rebased.unr = phi i32 [ 0, %"for blur_x.s0.x.x.rebased.preheader" ], [ %494, %"for blur_x.s0.x.x.rebased" ]
...
"for blur_x.s0.x.x.rebased.epil":                 ; preds = %"end for blur_x.s0.x.x.rebased.loopexit.unr-lcssa", %"for blur_x.s0.x.x.rebased.epil"
  %blur_x.s0.x.x.rebased.epil = phi i32 [ %526, %"for blur_x.s0.x.x.rebased.epil" ], [ %blur_x.s0.x.x.rebased.unr, %"end for blur_x.s0.x.x.rebased.loopexit.unr-lcssa" ]
  ...
  %495 = add nsw i32 %blur_x.s0.x.x.rebased.epil, %t331
  %496 = shl nsw i32 %495, 6
  %t286.epil = add i32 %364, %496
  %497 = getelementptr inbounds i16, i16* %87, i32 %t286.epil
  %498 = getelementptr inbounds i16, i16* %497, i32 -63
  %499 = bitcast i16* %498 to <64 x i16>*
  %500 = load <64 x i16>, <64 x i16>* %499, align 2, !tbaa !97
  %501 = getelementptr inbounds i16, i16* %497, i32 -64
  %502 = bitcast i16* %501 to <64 x i16>*
  %503 = load <64 x i16>, <64 x i16>* %502, align 2, !tbaa !97
  %504 = getelementptr inbounds i16, i16* %497, i32 -62
  %505 = bitcast i16* %504 to <64 x i16>*
  %506 = load <64 x i16>, <64 x i16>* %505, align 2, !tbaa !97
  %507 = getelementptr inbounds i16, i16* %497, i32 -60
  %508 = bitcast i16* %507 to <64 x i16>*
  %509 = load <64 x i16>, <64 x i16>* %508, align 2, !tbaa !97
  %510 = getelementptr inbounds i16, i16* %497, i32 -61
  %511 = bitcast i16* %510 to <64 x i16>*
  %512 = load <64 x i16>, <64 x i16>* %511, align 2, !tbaa !97
  %513 = add <64 x i16> %503, %500
  %514 = add <64 x i16> %513, %506
  %515 = add <64 x i16> %514, %509
  %516 = add <64 x i16> %515, %512
  %517 = bitcast <64 x i16> %516 to <32 x i32>
  %518 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %517, i32 -858927923) #12
  %519 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %518) #12
  %520 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %518) #12
  %521 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %520, <32 x i32> %519) #12
  %522 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %521, i32 2) #12
  %523 = add nsw i32 %496, %366
  %524 = getelementptr inbounds i16, i16* %blur_x, i32 %523
  %525 = bitcast i16* %524 to <32 x i32>*
  store <32 x i32> %522, <32 x i32>* %525, align 2, !tbaa !100
  %526 = add nuw nsw i32 %blur_x.s0.x.x.rebased.epil, 1
  %epil.iter.sub = add i32 %epil.iter, -1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.sub, 0
...
"for blur_x.s0.x.x.rebased4.preheader":           ; preds = %"end for blur_x.s0.x.x.rebased"
  %527 = add i32 %"blur_y.s0.y.yi.$n.rebased", %blur_y.s0.y.yi.base.s
  %528 = add i32 %527, %blur_y.min.1
  %529 = sub i32 %528, %b6
  %530 = mul nsw i32 %529, %input.stride.1
  %531 = sub nsw i32 %530, %b52
  %532 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %90)
  %533 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %90)
  %534 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %92)
  %535 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %92)
  %536 = and i32 %528, 7
  %537 = mul nsw i32 %a35, %536
  %538 = sub i32 %537, %t322
...
"for blur_x.s0.x.x.rebased4":                     ; preds = %"for blur_x.s0.x.x.rebased4.preheader", %"for blur_x.s0.x.x.rebased4"
  %blur_x.s0.x.x.rebased6 = phi i32 [ %740, %"for blur_x.s0.x.x.rebased4" ], [ 0, %"for blur_x.s0.x.x.rebased4.preheader" ]
  %539 = add nsw i32 %blur_x.s0.x.x.rebased6, %t307
  %540 = shl nsw i32 %539, 6
  %a22 = add nsw i32 %540, %t322
  %541 = icmp slt i32 %a22, %b39
  %b34 = select i1 %541, i32 %a22, i32 %b39
  %542 = icmp slt i32 %a13, %b34
  %543 = select i1 %542, i32 %a13, i32 %b34
  %a23 = add nsw i32 %543, -63
  %544 = icmp sgt i32 %a23, %b52
  %545 = select i1 %544, i32 %a23, i32 %b52
  %t400 = add nsw i32 %545, %531
  %546 = icmp slt i32 %a15, %b34
  %547 = select i1 %546, i32 %a15, i32 %b34
  %a25 = add nsw i32 %547, -64
  %548 = icmp sgt i32 %a25, %b52
  %549 = select i1 %548, i32 %a25, i32 %b52
  %t401 = add nsw i32 %549, %531
  %550 = icmp slt i32 %a17, %b34
  %551 = select i1 %550, i32 %a17, i32 %b34
  %a27 = add nsw i32 %551, -62
  %552 = icmp sgt i32 %a27, %b52
  %553 = select i1 %552, i32 %a27, i32 %b52
  %t402 = add nsw i32 %553, %531
  %554 = icmp slt i32 %a19, %b34
  %555 = select i1 %554, i32 %a19, i32 %b34
  %a29 = add nsw i32 %555, -60
  %556 = icmp sgt i32 %a29, %b52
  %557 = select i1 %556, i32 %a29, i32 %b52
  %t403 = add nsw i32 %557, %531
  %558 = icmp slt i32 %a21, %b34
  %559 = select i1 %558, i32 %a21, i32 %b34
  %a31 = add nsw i32 %559, -61
  %560 = icmp sgt i32 %a31, %b52
  %561 = select i1 %560, i32 %a31, i32 %b52
  %t404 = add nsw i32 %561, %531
  %562 = getelementptr inbounds i16, i16* %87, i32 %t400
  %563 = bitcast i16* %562 to <32 x i32>*
  %564 = load <32 x i32>, <32 x i32>* %563, align 2, !tbaa !97
  %565 = add nsw i32 %b34, -63
  %566 = insertelement <64 x i32> undef, i32 %565, i32 0
  %567 = shufflevector <64 x i32> %566, <64 x i32> undef, <64 x i32> zeroinitializer
  %568 = add nsw <64 x i32> %567, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %569 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %568)
  %570 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %569, <32 x i32> %532) #12
  %571 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %568)
  %572 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %571, <32 x i32> %533) #12
  %573 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %570, <32 x i32> %534) #12
  %574 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %572, <32 x i32> %535) #12
  %575 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %574, <32 x i32> %573)
  %576 = sub i32 0, %545
  %577 = insertelement <64 x i32> undef, i32 %576, i32 0
  %578 = shufflevector <64 x i32> %577, <64 x i32> undef, <64 x i32> zeroinitializer
  %579 = add nsw <64 x i32> %575, %578
  %580 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %579) #12
  %581 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %579) #12
  %582 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %581, <32 x i32> %580) #12
  %583 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %582)
  %584 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %583) #12
  %585 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %583) #12
  %586 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %584, <32 x i32> %585) #12
  %587 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %564)
  %588 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %586)
  %589 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %588, <32 x i32> %587, i32 0)
  %590 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %589, <32 x i32> %588, <32 x i32> %587, i32 1)
  %591 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %590, <32 x i32> %588, <32 x i32> %587, i32 2)
  %592 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %591, <32 x i32> %588, <32 x i32> %587, i32 3)
  %593 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %592)
  %594 = bitcast <32 x i32> %593 to <64 x i16>
  %595 = getelementptr inbounds i16, i16* %87, i32 %t401
  %596 = bitcast i16* %595 to <32 x i32>*
  %597 = load <32 x i32>, <32 x i32>* %596, align 2, !tbaa !97
  %598 = add nsw i32 %b34, -64
  %599 = insertelement <64 x i32> undef, i32 %598, i32 0
  %600 = shufflevector <64 x i32> %599, <64 x i32> undef, <64 x i32> zeroinitializer
  %601 = add nsw <64 x i32> %600, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %602 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %601)
  %603 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %602, <32 x i32> %532) #12
  %604 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %601)
  %605 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %604, <32 x i32> %533) #12
  %606 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %603, <32 x i32> %534) #12
  %607 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %605, <32 x i32> %535) #12
  %608 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %607, <32 x i32> %606)
  %609 = sub i32 0, %549
  %610 = insertelement <64 x i32> undef, i32 %609, i32 0
  %611 = shufflevector <64 x i32> %610, <64 x i32> undef, <64 x i32> zeroinitializer
  %612 = add nsw <64 x i32> %608, %611
  %613 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %612) #12
  %614 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %612) #12
  %615 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %614, <32 x i32> %613) #12
  %616 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %615)
  %617 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %616) #12
  %618 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %616) #12
  %619 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %617, <32 x i32> %618) #12
  %620 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %597)
  ...
  %627 = bitcast <32 x i32> %626 to <64 x i16>
  %628 = getelementptr inbounds i16, i16* %87, i32 %t402
  %629 = bitcast i16* %628 to <32 x i32>*
  %630 = load <32 x i32>, <32 x i32>* %629, align 2, !tbaa !97
  %631 = add nsw i32 %b34, -62
  %632 = insertelement <64 x i32> undef, i32 %631, i32 0
  %633 = shufflevector <64 x i32> %632, <64 x i32> undef, <64 x i32> zeroinitializer
  %634 = add nsw <64 x i32> %633, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %635 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %634)
  %636 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %635, <32 x i32> %532) #12
  %637 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %634)
  %638 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %637, <32 x i32> %533) #12
  %639 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %636, <32 x i32> %534) #12
  %640 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %638, <32 x i32> %535) #12
  %641 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %640, <32 x i32> %639)
  %642 = sub i32 0, %553
  %643 = insertelement <64 x i32> undef, i32 %642, i32 0
  %644 = shufflevector <64 x i32> %643, <64 x i32> undef, <64 x i32> zeroinitializer
  %645 = add nsw <64 x i32> %641, %644
  %646 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %645) #12
  %647 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %645) #12
  %648 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %647, <32 x i32> %646) #12
  %649 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %648)
  %650 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %649) #12
  %651 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %649) #12
  %652 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %650, <32 x i32> %651) #12
  %653 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %630)
  %654 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %652)
  %655 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %654, <32 x i32> %653, i32 0)
  %656 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %655, <32 x i32> %654, <32 x i32> %653, i32 1)
  %657 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %656, <32 x i32> %654, <32 x i32> %653, i32 2)
  %658 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %657, <32 x i32> %654, <32 x i32> %653, i32 3)
  %659 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %658)
  %660 = bitcast <32 x i32> %659 to <64 x i16>
  %661 = getelementptr inbounds i16, i16* %87, i32 %t403
  %662 = bitcast i16* %661 to <32 x i32>*
  %663 = load <32 x i32>, <32 x i32>* %662, align 2, !tbaa !97
  %664 = add nsw i32 %b34, -60
  %665 = insertelement <64 x i32> undef, i32 %664, i32 0
  %666 = shufflevector <64 x i32> %665, <64 x i32> undef, <64 x i32> zeroinitializer
  %667 = add nsw <64 x i32> %666, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %668 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %667)
  %669 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %668, <32 x i32> %532) #12
  %670 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %667)
  %671 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %670, <32 x i32> %533) #12
  %672 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %669, <32 x i32> %534) #12
  %673 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %671, <32 x i32> %535) #12
  %674 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %673, <32 x i32> %672)
  %675 = sub i32 0, %557
  %676 = insertelement <64 x i32> undef, i32 %675, i32 0
  %677 = shufflevector <64 x i32> %676, <64 x i32> undef, <64 x i32> zeroinitializer
  %678 = add nsw <64 x i32> %674, %677
  %679 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %678) #12
  %680 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %678) #12
  %681 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %680, <32 x i32> %679) #12
  %682 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %681)
  %683 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %682) #12
  %684 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %682) #12
  %685 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %683, <32 x i32> %684) #12
  %686 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %663)
  %687 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %685)
  %688 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %687, <32 x i32> %686, i32 0)
  %689 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %688, <32 x i32> %687, <32 x i32> %686, i32 1)
  %690 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %689, <32 x i32> %687, <32 x i32> %686, i32 2)
  %691 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %690, <32 x i32> %687, <32 x i32> %686, i32 3)
  %692 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %691)
  %693 = bitcast <32 x i32> %692 to <64 x i16>
  %694 = getelementptr inbounds i16, i16* %87, i32 %t404
  %695 = bitcast i16* %694 to <32 x i32>*
  %696 = load <32 x i32>, <32 x i32>* %695, align 2, !tbaa !97
  %697 = add nsw i32 %b34, -61
  %698 = insertelement <64 x i32> undef, i32 %697, i32 0
  %699 = shufflevector <64 x i32> %698, <64 x i32> undef, <64 x i32> zeroinitializer
  %700 = add nsw <64 x i32> %699, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %701 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %700)
  %702 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %701, <32 x i32> %532) #12
  %703 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %700)
  %704 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %703, <32 x i32> %533) #12
  %705 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %702, <32 x i32> %534) #12
  %706 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %704, <32 x i32> %535) #12
  %707 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %706, <32 x i32> %705)
  %708 = sub i32 0, %561
  %709 = insertelement <64 x i32> undef, i32 %708, i32 0
  %710 = shufflevector <64 x i32> %709, <64 x i32> undef, <64 x i32> zeroinitializer
  %711 = add nsw <64 x i32> %707, %710
  %712 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %711) #12
  %713 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %711) #12
  %714 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %713, <32 x i32> %712) #12
  %715 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %714)
  %716 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %715) #12
  %717 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %715) #12
  %718 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %716, <32 x i32> %717) #12
  %719 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %696)
  %720 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %718)
  %721 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %720, <32 x i32> %719, i32 0)
  %722 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %721, <32 x i32> %720, <32 x i32> %719, i32 1)
  %723 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %722, <32 x i32> %720, <32 x i32> %719, i32 2)
  %724 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %723, <32 x i32> %720, <32 x i32> %719, i32 3)
  %725 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %724)
  %726 = bitcast <32 x i32> %725 to <64 x i16>
  %727 = add <64 x i16> %627, %594
  %728 = add <64 x i16> %727, %660
  %729 = add <64 x i16> %728, %693
  %730 = add <64 x i16> %729, %726
  %731 = bitcast <64 x i16> %730 to <32 x i32>
  %732 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %731, i32 -858927923) #12
  %733 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %732) #12
  %734 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %732) #12
  %735 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %734, <32 x i32> %733) #12
  %736 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %735, i32 2) #12
  %737 = add nsw i32 %538, %b34
  %738 = getelementptr inbounds i16, i16* %blur_x, i32 %737
  %739 = bitcast i16* %738 to <32 x i32>*
  store <32 x i32> %736, <32 x i32>* %739, align 2, !tbaa !100
  %740 = add nuw nsw i32 %blur_x.s0.x.x.rebased6, 1
  %.not36 = icmp eq i32 %740, %94
...
"consume blur_x":                                 ; preds = %"for blur_x.s0.x.x.rebased4", %"end for blur_x.s0.x.x.rebased"
  %741 = icmp ugt i32 %"blur_y.s0.y.yi.$n.rebased", 3
  br i1 %741, label %then_bb8, label %after_bb7

after_bb7:                                        ; preds = %"for blur_y.s0.x.x10.preheader", %"end for blur_y.s0.x.x", %"consume blur_x"
  %742 = add nuw nsw i32 %"blur_y.s0.y.yi.$n.rebased", 1
  %.not33 = icmp eq i32 %742, 132
...
"for blur_y.s0.x.x.preheader":                    ; preds = %then_bb8
  %743 = add i32 %"blur_y.s0.y.yi.$n.rebased", %blur_y.s0.y.yi.base.s
  %744 = add i32 %743, %blur_y.min.1
  %745 = add nsw i32 %744, 5
  %746 = and i32 %745, 7
  %747 = mul nsw i32 %a35, %746
  %748 = add nsw i32 %744, 4
  %749 = and i32 %748, 7
  %750 = mul nsw i32 %a35, %749
  %751 = add nsw i32 %744, 6
  %752 = and i32 %751, 7
  %753 = mul nsw i32 %a35, %752
  %754 = and i32 %744, 7
  %755 = mul nsw i32 %a35, %754
  %756 = add nsw i32 %744, 7
  %757 = and i32 %756, 7
  %758 = mul nsw i32 %a35, %757
  %759 = add nsw i32 %744, -4
  %760 = mul nsw i32 %759, %blur_y.stride.1
  %761 = add nsw i32 %t314, %760
...
"for blur_y.s0.x.x":                              ; preds = %"for blur_y.s0.x.x.preheader", %"for blur_y.s0.x.x"
  %blur_y.s0.x.x = phi i32 [ %833, %"for blur_y.s0.x.x" ], [ 0, %"for blur_y.s0.x.x.preheader" ]
  %niter59 = phi i32 [ %niter59.nsub.1, %"for blur_y.s0.x.x" ], [ %unroll_iter58, %"for blur_y.s0.x.x.preheader" ]
  %762 = shl nsw i32 %blur_y.s0.x.x, 6
  %763 = sub nsw i32 %762, %t321
  %764 = add nsw i32 %763, %747
  %765 = getelementptr inbounds i16, i16* %100, i32 %764
  %766 = bitcast i16* %765 to <64 x i16>*
  %767 = load <64 x i16>, <64 x i16>* %766, align 2, !tbaa !100
  %768 = add nsw i32 %763, %750
  %769 = getelementptr inbounds i16, i16* %102, i32 %768
  %770 = bitcast i16* %769 to <64 x i16>*
  %771 = load <64 x i16>, <64 x i16>* %770, align 2, !tbaa !100
  %772 = add nsw i32 %763, %753
  %773 = getelementptr inbounds i16, i16* %104, i32 %772
  %774 = bitcast i16* %773 to <64 x i16>*
  %775 = load <64 x i16>, <64 x i16>* %774, align 2, !tbaa !100
  %776 = add nsw i32 %763, %755
  %777 = getelementptr inbounds i16, i16* %106, i32 %776
  %778 = bitcast i16* %777 to <64 x i16>*
  %779 = load <64 x i16>, <64 x i16>* %778, align 2, !tbaa !100
  %780 = add nsw i32 %763, %758
  %781 = getelementptr inbounds i16, i16* %108, i32 %780
  %782 = bitcast i16* %781 to <64 x i16>*
  %783 = load <64 x i16>, <64 x i16>* %782, align 2, !tbaa !100
  %784 = add <64 x i16> %771, %767
  %785 = add <64 x i16> %784, %775
  %786 = add <64 x i16> %785, %779
  %787 = add <64 x i16> %786, %783
  %788 = bitcast <64 x i16> %787 to <32 x i32>
  %789 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %788, i32 -858927923) #12
  %790 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %789) #12
  %791 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %789) #12
  %792 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %791, <32 x i32> %790) #12
  %793 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %792, i32 2) #12
  %794 = add nsw i32 %761, %762
  ...
  %797 = shl i32 %blur_y.s0.x.x, 6
  %798 = or i32 %797, 64
  %799 = sub nsw i32 %798, %t321
  %800 = add nsw i32 %799, %747
  %801 = getelementptr inbounds i16, i16* %100, i32 %800
  %802 = bitcast i16* %801 to <64 x i16>*
  %803 = load <64 x i16>, <64 x i16>* %802, align 2, !tbaa !100
  %804 = add nsw i32 %799, %750
  %805 = getelementptr inbounds i16, i16* %102, i32 %804
  %806 = bitcast i16* %805 to <64 x i16>*
  %807 = load <64 x i16>, <64 x i16>* %806, align 2, !tbaa !100
  %808 = add nsw i32 %799, %753
  %809 = getelementptr inbounds i16, i16* %104, i32 %808
  %810 = bitcast i16* %809 to <64 x i16>*
  %811 = load <64 x i16>, <64 x i16>* %810, align 2, !tbaa !100
  %812 = add nsw i32 %799, %755
  %813 = getelementptr inbounds i16, i16* %106, i32 %812
  %814 = bitcast i16* %813 to <64 x i16>*
  %815 = load <64 x i16>, <64 x i16>* %814, align 2, !tbaa !100
  %816 = add nsw i32 %799, %758
  %817 = getelementptr inbounds i16, i16* %108, i32 %816
  %818 = bitcast i16* %817 to <64 x i16>*
  %819 = load <64 x i16>, <64 x i16>* %818, align 2, !tbaa !100
  %820 = add <64 x i16> %807, %803
  %821 = add <64 x i16> %820, %811
  %822 = add <64 x i16> %821, %815
  %823 = add <64 x i16> %822, %819
  %824 = bitcast <64 x i16> %823 to <32 x i32>
  %825 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %824, i32 -858927923) #12
  %826 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %825) #12
  %827 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %825) #12
  %828 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %827, <32 x i32> %826) #12
  %829 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %828, i32 2) #12
  %830 = add nsw i32 %761, %798
  %831 = getelementptr inbounds i16, i16* %97, i32 %830
  %832 = bitcast i16* %831 to <32 x i32>*
  store <32 x i32> %829, <32 x i32>* %832, align 2, !tbaa !103
  %833 = add nuw nsw i32 %blur_y.s0.x.x, 2
...
"end for blur_y.s0.x.x.loopexit.unr-lcssa":       ; preds = %"for blur_y.s0.x.x", %"for blur_y.s0.x.x.preheader"
  %blur_y.s0.x.x.unr = phi i32 [ 0, %"for blur_y.s0.x.x.preheader" ], [ %833, %"for blur_y.s0.x.x" ]
...
"for blur_y.s0.x.x.epil":                         ; preds = %"end for blur_y.s0.x.x.loopexit.unr-lcssa"
  %834 = shl nsw i32 %blur_y.s0.x.x.unr, 6
  %835 = sub nsw i32 %834, %t321
  %836 = add nsw i32 %835, %747
  %837 = getelementptr inbounds i16, i16* %100, i32 %836
  %838 = bitcast i16* %837 to <64 x i16>*
  %839 = load <64 x i16>, <64 x i16>* %838, align 2, !tbaa !100
  %840 = add nsw i32 %835, %750
  %841 = getelementptr inbounds i16, i16* %102, i32 %840
  %842 = bitcast i16* %841 to <64 x i16>*
  %843 = load <64 x i16>, <64 x i16>* %842, align 2, !tbaa !100
  %844 = add nsw i32 %835, %753
  %845 = getelementptr inbounds i16, i16* %104, i32 %844
  %846 = bitcast i16* %845 to <64 x i16>*
  %847 = load <64 x i16>, <64 x i16>* %846, align 2, !tbaa !100
  %848 = add nsw i32 %835, %755
  %849 = getelementptr inbounds i16, i16* %106, i32 %848
  %850 = bitcast i16* %849 to <64 x i16>*
  %851 = load <64 x i16>, <64 x i16>* %850, align 2, !tbaa !100
  %852 = add nsw i32 %835, %758
  %853 = getelementptr inbounds i16, i16* %108, i32 %852
  %854 = bitcast i16* %853 to <64 x i16>*
  %855 = load <64 x i16>, <64 x i16>* %854, align 2, !tbaa !100
  %856 = add <64 x i16> %843, %839
  %857 = add <64 x i16> %856, %847
  %858 = add <64 x i16> %857, %851
  %859 = add <64 x i16> %858, %855
  %860 = bitcast <64 x i16> %859 to <32 x i32>
  %861 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %860, i32 -858927923) #12
  %862 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %861) #12
  %863 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %861) #12
  %864 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %863, <32 x i32> %862) #12
  %865 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %864, i32 2) #12
  %866 = add nsw i32 %761, %834
  %867 = getelementptr inbounds i16, i16* %97, i32 %866
  %868 = bitcast i16* %867 to <32 x i32>*
  store <32 x i32> %865, <32 x i32>* %868, align 2, !tbaa !103
...
"for blur_y.s0.x.x10.preheader":                  ; preds = %"end for blur_y.s0.x.x"
  %869 = add i32 %"blur_y.s0.y.yi.$n.rebased", %blur_y.s0.y.yi.base.s
  %870 = add i32 %869, %blur_y.min.1
  %871 = add nsw i32 %870, 5
  %872 = and i32 %871, 7
  %873 = add nuw nsw i32 %872, 1
  %874 = mul nsw i32 %a35, %873
  %875 = getelementptr inbounds i16, i16* %110, i32 %874
  %876 = bitcast i16* %875 to <64 x i16>*
  %877 = load <64 x i16>, <64 x i16>* %876, align 2, !tbaa !100
  %878 = add nsw i32 %870, 4
  %879 = and i32 %878, 7
  %880 = add nuw nsw i32 %879, 1
  %881 = mul nsw i32 %a35, %880
  %882 = getelementptr inbounds i16, i16* %112, i32 %881
  %883 = bitcast i16* %882 to <64 x i16>*
  %884 = load <64 x i16>, <64 x i16>* %883, align 2, !tbaa !100
  %885 = add nsw i32 %870, 6
  %886 = and i32 %885, 7
  %887 = add nuw nsw i32 %886, 1
  %888 = mul nsw i32 %a35, %887
  %889 = getelementptr inbounds i16, i16* %114, i32 %888
  %890 = bitcast i16* %889 to <64 x i16>*
  %891 = load <64 x i16>, <64 x i16>* %890, align 2, !tbaa !100
  %892 = and i32 %870, 7
  %893 = add nuw nsw i32 %892, 1
  %894 = mul nsw i32 %a35, %893
  %895 = getelementptr inbounds i16, i16* %116, i32 %894
  %896 = bitcast i16* %895 to <64 x i16>*
  %897 = load <64 x i16>, <64 x i16>* %896, align 2, !tbaa !100
  %898 = add nsw i32 %870, 7
  %899 = and i32 %898, 7
  %900 = add nuw nsw i32 %899, 1
  %901 = mul nsw i32 %a35, %900
  %902 = getelementptr inbounds i16, i16* %118, i32 %901
  %903 = bitcast i16* %902 to <64 x i16>*
  %904 = load <64 x i16>, <64 x i16>* %903, align 2, !tbaa !100
  %905 = add <64 x i16> %884, %877
  %906 = add <64 x i16> %905, %891
  %907 = add <64 x i16> %906, %897
  %908 = add <64 x i16> %907, %904
  %909 = bitcast <64 x i16> %908 to <32 x i32>
  %910 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %909, i32 -858927923) #12
  %911 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %910) #12
  %912 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %910) #12
  %913 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %912, <32 x i32> %911) #12
  %914 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %913, i32 2) #12
  %915 = add nsw i32 %870, -4
  %916 = mul nsw i32 %915, %blur_y.stride.1
  %917 = add nsw i32 %t316, %916
  %918 = getelementptr inbounds i16, i16* %120, i32 %917
  %919 = bitcast i16* %918 to <32 x i32>*
  store <32 x i32> %914, <32 x i32>* %919, align 2, !tbaa !103
  br label %after_bb7

"for blur_y.s0.y.yi.$n.rebased15":                ; preds = %next_bb3, %after_bb23
  %"blur_y.s0.y.yi.$n.rebased17" = phi i32 [ 0, %next_bb3 ], [ %1188, %after_bb23 ]
  %920 = add i32 %"blur_y.s0.y.yi.$n.rebased17", %blur_y.s0.y.yi.base.s
  %921 = add i32 %920, %blur_y.min.1
  %a36 = sub i32 %921, %b6
  %922 = icmp slt i32 %a36, %b38
  %a57 = select i1 %922, i32 %a36, i32 %b38
...
"for blur_x.s0.x.x19.preheader":                  ; preds = %"for blur_y.s0.y.yi.$n.rebased15"
  %923 = icmp sgt i32 %a57, 0
  %924 = select i1 %923, i32 %a57, i32 0
  %925 = mul nsw i32 %924, %input.stride.1
  %926 = sub nsw i32 %925, %b52
  %927 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %130)
  %928 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %130)
  %929 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %132)
  %930 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %132)
  %931 = and i32 %921, 7
  %932 = mul nsw i32 %a35, %931
  %933 = sub i32 %932, %t322
...
"for blur_x.s0.x.x19":                            ; preds = %"for blur_x.s0.x.x19.preheader", %"for blur_x.s0.x.x19"
  %blur_x.s0.x.x21 = phi i32 [ %1134, %"for blur_x.s0.x.x19" ], [ 0, %"for blur_x.s0.x.x19.preheader" ]
  %934 = shl nsw i32 %blur_x.s0.x.x21, 6
  %a37 = add nsw i32 %934, %t322
  %935 = icmp slt i32 %a37, %b39
  %b53 = select i1 %935, i32 %a37, i32 %b39
  %936 = icmp slt i32 %a39, %b53
  %937 = select i1 %936, i32 %a39, i32 %b53
  %a38 = add nsw i32 %937, -63
  %938 = icmp sgt i32 %a38, %b52
  %939 = select i1 %938, i32 %a38, i32 %b52
  %t406 = add nsw i32 %939, %926
  %940 = icmp slt i32 %a42, %b53
  %941 = select i1 %940, i32 %a42, i32 %b53
  %a41 = add nsw i32 %941, -64
  %942 = icmp sgt i32 %a41, %b52
  %943 = select i1 %942, i32 %a41, i32 %b52
  %t407 = add nsw i32 %943, %926
  %944 = icmp slt i32 %a45, %b53
  %945 = select i1 %944, i32 %a45, i32 %b53
  %a44 = add nsw i32 %945, -62
  %946 = icmp sgt i32 %a44, %b52
  %947 = select i1 %946, i32 %a44, i32 %b52
  %t408 = add nsw i32 %947, %926
  %948 = icmp slt i32 %a48, %b53
  %949 = select i1 %948, i32 %a48, i32 %b53
  %a47 = add nsw i32 %949, -60
  %950 = icmp sgt i32 %a47, %b52
  %951 = select i1 %950, i32 %a47, i32 %b52
  %t409 = add nsw i32 %951, %926
  %952 = icmp slt i32 %a51, %b53
  %953 = select i1 %952, i32 %a51, i32 %b53
  %a50 = add nsw i32 %953, -61
  %954 = icmp sgt i32 %a50, %b52
  %955 = select i1 %954, i32 %a50, i32 %b52
  %t410 = add nsw i32 %955, %926
  %956 = getelementptr inbounds i16, i16* %127, i32 %t406
  %957 = bitcast i16* %956 to <32 x i32>*
  %958 = load <32 x i32>, <32 x i32>* %957, align 2, !tbaa !97
  %959 = add nsw i32 %b53, -63
  %960 = insertelement <64 x i32> undef, i32 %959, i32 0
  %961 = shufflevector <64 x i32> %960, <64 x i32> undef, <64 x i32> zeroinitializer
  %962 = add nsw <64 x i32> %961, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %963 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %962)
  %964 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %963, <32 x i32> %927) #12
  %965 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %962)
  %966 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %965, <32 x i32> %928) #12
  %967 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %964, <32 x i32> %929) #12
  %968 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %966, <32 x i32> %930) #12
  %969 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %968, <32 x i32> %967)
  %970 = sub i32 0, %939
  %971 = insertelement <64 x i32> undef, i32 %970, i32 0
  %972 = shufflevector <64 x i32> %971, <64 x i32> undef, <64 x i32> zeroinitializer
  %973 = add nsw <64 x i32> %969, %972
  %974 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %973) #12
  %975 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %973) #12
  %976 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %975, <32 x i32> %974) #12
  %977 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %976)
  %978 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %977) #12
  %979 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %977) #12
  %980 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %978, <32 x i32> %979) #12
  %981 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %958)
  %982 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %980)
  %983 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %982, <32 x i32> %981, i32 0)
  %984 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %983, <32 x i32> %982, <32 x i32> %981, i32 1)
  %985 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %984, <32 x i32> %982, <32 x i32> %981, i32 2)
  %986 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %985, <32 x i32> %982, <32 x i32> %981, i32 3)
  %987 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %986)
  %988 = bitcast <32 x i32> %987 to <64 x i16>
  %989 = getelementptr inbounds i16, i16* %127, i32 %t407
  %990 = bitcast i16* %989 to <32 x i32>*
  %991 = load <32 x i32>, <32 x i32>* %990, align 2, !tbaa !97
  %992 = add nsw i32 %b53, -64
  %993 = insertelement <64 x i32> undef, i32 %992, i32 0
  %994 = shufflevector <64 x i32> %993, <64 x i32> undef, <64 x i32> zeroinitializer
  %995 = add nsw <64 x i32> %994, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %996 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %995)
  %997 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %996, <32 x i32> %927) #12
  %998 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %995)
  %999 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %998, <32 x i32> %928) #12
  %1000 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %997, <32 x i32> %929) #12
  %1001 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %999, <32 x i32> %930) #12
  %1002 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1001, <32 x i32> %1000)
  %1003 = sub i32 0, %943
  %1004 = insertelement <64 x i32> undef, i32 %1003, i32 0
  %1005 = shufflevector <64 x i32> %1004, <64 x i32> undef, <64 x i32> zeroinitializer
  %1006 = add nsw <64 x i32> %1002, %1005
  %1007 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1006) #12
  %1008 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1006) #12
  %1009 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %1008, <32 x i32> %1007) #12
  %1010 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %1009)
  %1011 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1010) #12
  %1012 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1010) #12
  %1013 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %1011, <32 x i32> %1012) #12
  %1014 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %991)
  %1015 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %1013)
  %1016 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %1015, <32 x i32> %1014, i32 0)
  %1017 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %1016, <32 x i32> %1015, <32 x i32> %1014, i32 1)
  %1018 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %1017, <32 x i32> %1015, <32 x i32> %1014, i32 2)
  %1019 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %1018, <32 x i32> %1015, <32 x i32> %1014, i32 3)
  %1020 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1019)
  %1021 = bitcast <32 x i32> %1020 to <64 x i16>
  %1022 = getelementptr inbounds i16, i16* %127, i32 %t408
  %1023 = bitcast i16* %1022 to <32 x i32>*
  %1024 = load <32 x i32>, <32 x i32>* %1023, align 2, !tbaa !97
  %1025 = add nsw i32 %b53, -62
  %1026 = insertelement <64 x i32> undef, i32 %1025, i32 0
  %1027 = shufflevector <64 x i32> %1026, <64 x i32> undef, <64 x i32> zeroinitializer
  %1028 = add nsw <64 x i32> %1027, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %1029 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1028)
  %1030 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %1029, <32 x i32> %927) #12
  %1031 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1028)
  %1032 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %1031, <32 x i32> %928) #12
  %1033 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %1030, <32 x i32> %929) #12
  %1034 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %1032, <32 x i32> %930) #12
  %1035 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1034, <32 x i32> %1033)
  %1036 = sub i32 0, %947
  %1037 = insertelement <64 x i32> undef, i32 %1036, i32 0
  %1038 = shufflevector <64 x i32> %1037, <64 x i32> undef, <64 x i32> zeroinitializer
  %1039 = add nsw <64 x i32> %1035, %1038
  %1040 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1039) #12
  %1041 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1039) #12
  %1042 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %1041, <32 x i32> %1040) #12
  %1043 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %1042)
  %1044 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1043) #12
  %1045 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1043) #12
  %1046 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %1044, <32 x i32> %1045) #12
  %1047 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %1024)
  %1048 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %1046)
  %1049 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %1048, <32 x i32> %1047, i32 0)
  %1050 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %1049, <32 x i32> %1048, <32 x i32> %1047, i32 1)
  %1051 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %1050, <32 x i32> %1048, <32 x i32> %1047, i32 2)
  %1052 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %1051, <32 x i32> %1048, <32 x i32> %1047, i32 3)
  %1053 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1052)
  %1054 = bitcast <32 x i32> %1053 to <64 x i16>
  %1055 = getelementptr inbounds i16, i16* %127, i32 %t409
  %1056 = bitcast i16* %1055 to <32 x i32>*
  %1057 = load <32 x i32>, <32 x i32>* %1056, align 2, !tbaa !97
  %1058 = add nsw i32 %b53, -60
  %1059 = insertelement <64 x i32> undef, i32 %1058, i32 0
  %1060 = shufflevector <64 x i32> %1059, <64 x i32> undef, <64 x i32> zeroinitializer
  %1061 = add nsw <64 x i32> %1060, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %1062 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1061)
  %1063 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %1062, <32 x i32> %927) #12
  %1064 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1061)
  %1065 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %1064, <32 x i32> %928) #12
  %1066 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %1063, <32 x i32> %929) #12
  %1067 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %1065, <32 x i32> %930) #12
  %1068 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1067, <32 x i32> %1066)
  %1069 = sub i32 0, %951
  %1070 = insertelement <64 x i32> undef, i32 %1069, i32 0
  %1071 = shufflevector <64 x i32> %1070, <64 x i32> undef, <64 x i32> zeroinitializer
  %1072 = add nsw <64 x i32> %1068, %1071
  %1073 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1072) #12
  %1074 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1072) #12
  %1075 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %1074, <32 x i32> %1073) #12
  %1076 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %1075)
  %1077 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1076) #12
  %1078 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1076) #12
  %1079 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %1077, <32 x i32> %1078) #12
  %1080 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %1057)
  %1081 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %1079)
  %1082 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %1081, <32 x i32> %1080, i32 0)
  %1083 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %1082, <32 x i32> %1081, <32 x i32> %1080, i32 1)
  %1084 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %1083, <32 x i32> %1081, <32 x i32> %1080, i32 2)
  %1085 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %1084, <32 x i32> %1081, <32 x i32> %1080, i32 3)
  %1086 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1085)
  %1087 = bitcast <32 x i32> %1086 to <64 x i16>
  %1088 = getelementptr inbounds i16, i16* %127, i32 %t410
  %1089 = bitcast i16* %1088 to <32 x i32>*
  %1090 = load <32 x i32>, <32 x i32>* %1089, align 2, !tbaa !97
  %1091 = add nsw i32 %b53, -61
  %1092 = insertelement <64 x i32> undef, i32 %1091, i32 0
  %1093 = shufflevector <64 x i32> %1092, <64 x i32> undef, <64 x i32> zeroinitializer
  %1094 = add nsw <64 x i32> %1093, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %1095 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1094)
  %1096 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %1095, <32 x i32> %927) #12
  %1097 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1094)
  %1098 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %1097, <32 x i32> %928) #12
  %1099 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %1096, <32 x i32> %929) #12
  %1100 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %1098, <32 x i32> %930) #12
  %1101 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1100, <32 x i32> %1099)
  %1102 = sub i32 0, %955
  %1103 = insertelement <64 x i32> undef, i32 %1102, i32 0
  %1104 = shufflevector <64 x i32> %1103, <64 x i32> undef, <64 x i32> zeroinitializer
  %1105 = add nsw <64 x i32> %1101, %1104
  %1106 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1105) #12
  %1107 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1105) #12
  %1108 = tail call <32 x i32> @llvm.hexagon.V6.vpackeh.128B(<32 x i32> %1107, <32 x i32> %1106) #12
  %1109 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> undef, <32 x i32> %1108)
  %1110 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1109) #12
  %1111 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1109) #12
  %1112 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %1110, <32 x i32> %1111) #12
  %1113 = tail call <32 x i32> @llvm.hexagon.V6.vshuffh.128B(<32 x i32> %1090)
  %1114 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %1112)
  %1115 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.128B(<32 x i32> %1114, <32 x i32> %1113, i32 0)
  %1116 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %1115, <32 x i32> %1114, <32 x i32> %1113, i32 1)
  %1117 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %1116, <32 x i32> %1114, <32 x i32> %1113, i32 2)
  %1118 = tail call <64 x i32> @llvm.hexagon.V6.vlutvwh.oracc.128B(<64 x i32> %1117, <32 x i32> %1114, <32 x i32> %1113, i32 3)
  %1119 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1118)
  %1120 = bitcast <32 x i32> %1119 to <64 x i16>
  %1121 = add <64 x i16> %1021, %988
  %1122 = add <64 x i16> %1121, %1054
  %1123 = add <64 x i16> %1122, %1087
  %1124 = add <64 x i16> %1123, %1120
  %1125 = bitcast <64 x i16> %1124 to <32 x i32>
  %1126 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %1125, i32 -858927923) #12
  %1127 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1126) #12
  %1128 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1126) #12
  %1129 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %1128, <32 x i32> %1127) #12
  %1130 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %1129, i32 2) #12
  %1131 = add nsw i32 %933, %b53
  %1132 = getelementptr inbounds i16, i16* %blur_x, i32 %1131
  %1133 = bitcast i16* %1132 to <32 x i32>*
  store <32 x i32> %1130, <32 x i32>* %1133, align 2, !tbaa !100
  %1134 = add nuw nsw i32 %blur_x.s0.x.x21, 1
  %.not32 = icmp eq i32 %1134, %t329
...
"consume blur_x22":                               ; preds = %"for blur_x.s0.x.x19", %"for blur_y.s0.y.yi.$n.rebased15"
  %1135 = icmp ugt i32 %"blur_y.s0.y.yi.$n.rebased17", 3
  %or.cond = and i1 %133, %1135
...
"for blur_y.s0.x.x26.preheader":                  ; preds = %"consume blur_x22"
  %1136 = add nsw i32 %921, 5
  %1137 = and i32 %1136, 7
  %1138 = mul nsw i32 %a35, %1137
  %1139 = add nsw i32 %921, 4
  %1140 = and i32 %1139, 7
  %1141 = mul nsw i32 %a35, %1140
  %1142 = add nsw i32 %921, 6
  %1143 = and i32 %1142, 7
  %1144 = mul nsw i32 %a35, %1143
  %1145 = and i32 %921, 7
  %1146 = mul nsw i32 %a35, %1145
  %1147 = add nsw i32 %921, 7
  %1148 = and i32 %1147, 7
  %1149 = mul nsw i32 %a35, %1148
  %1150 = add nsw i32 %921, -4
  %1151 = mul nsw i32 %1150, %blur_y.stride.1
  %1152 = add nsw i32 %t314, %1151
...
after_bb23.loopexit.unr-lcssa:                    ; preds = %"for blur_y.s0.x.x26", %"for blur_y.s0.x.x26.preheader"
  %blur_y.s0.x.x28.unr = phi i32 [ 0, %"for blur_y.s0.x.x26.preheader" ], [ %1260, %"for blur_y.s0.x.x26" ]
...
"for blur_y.s0.x.x26.epil":                       ; preds = %after_bb23.loopexit.unr-lcssa
  ...
  %1153 = icmp slt i32 %a58.epil, %b60
  %blur_y.s0.x.v0.base.s.epil = select i1 %1153, i32 %a58.epil, i32 %b60
  %1154 = sub nsw i32 %blur_y.s0.x.v0.base.s.epil, %t321
  %1155 = add nsw i32 %1154, %1138
  %1156 = getelementptr inbounds i16, i16* %136, i32 %1155
  %1157 = bitcast i16* %1156 to <64 x i16>*
  %1158 = load <64 x i16>, <64 x i16>* %1157, align 2, !tbaa !100
  %1159 = add nsw i32 %1154, %1141
  %1160 = getelementptr inbounds i16, i16* %138, i32 %1159
  %1161 = bitcast i16* %1160 to <64 x i16>*
  %1162 = load <64 x i16>, <64 x i16>* %1161, align 2, !tbaa !100
  %1163 = add nsw i32 %1154, %1144
  %1164 = getelementptr inbounds i16, i16* %140, i32 %1163
  %1165 = bitcast i16* %1164 to <64 x i16>*
  %1166 = load <64 x i16>, <64 x i16>* %1165, align 2, !tbaa !100
  %1167 = add nsw i32 %1154, %1146
  %1168 = getelementptr inbounds i16, i16* %142, i32 %1167
  %1169 = bitcast i16* %1168 to <64 x i16>*
  %1170 = load <64 x i16>, <64 x i16>* %1169, align 2, !tbaa !100
  %1171 = add nsw i32 %1154, %1149
  %1172 = getelementptr inbounds i16, i16* %144, i32 %1171
  %1173 = bitcast i16* %1172 to <64 x i16>*
  %1174 = load <64 x i16>, <64 x i16>* %1173, align 2, !tbaa !100
  %1175 = add <64 x i16> %1162, %1158
  %1176 = add <64 x i16> %1175, %1166
  %1177 = add <64 x i16> %1176, %1170
  %1178 = add <64 x i16> %1177, %1174
  %1179 = bitcast <64 x i16> %1178 to <32 x i32>
  %1180 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %1179, i32 -858927923) #12
  %1181 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1180) #12
  %1182 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1180) #12
  %1183 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %1182, <32 x i32> %1181) #12
  %1184 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %1183, i32 2) #12
  %1185 = add nsw i32 %1152, %blur_y.s0.x.v0.base.s.epil
  %1186 = getelementptr inbounds i16, i16* %134, i32 %1185
  %1187 = bitcast i16* %1186 to <32 x i32>*
  store <32 x i32> %1184, <32 x i32>* %1187, align 2, !tbaa !103
  br label %after_bb23

after_bb23:                                       ; preds = %"for blur_y.s0.x.x26.epil", %after_bb23.loopexit.unr-lcssa, %"consume blur_x22"
  %1188 = add nuw nsw i32 %"blur_y.s0.y.yi.$n.rebased17", 1
  %.not = icmp eq i32 %1188, 132
...
"for blur_y.s0.x.x26":                            ; preds = %"for blur_y.s0.x.x26.preheader", %"for blur_y.s0.x.x26"
  %blur_y.s0.x.x28 = phi i32 [ %1260, %"for blur_y.s0.x.x26" ], [ 0, %"for blur_y.s0.x.x26.preheader" ]
  ...
  %1189 = icmp slt i32 %a58, %b60
  %blur_y.s0.x.v0.base.s = select i1 %1189, i32 %a58, i32 %b60
  %1190 = sub nsw i32 %blur_y.s0.x.v0.base.s, %t321
  %1191 = add nsw i32 %1190, %1138
  %1192 = getelementptr inbounds i16, i16* %136, i32 %1191
  %1193 = bitcast i16* %1192 to <64 x i16>*
  %1194 = load <64 x i16>, <64 x i16>* %1193, align 2, !tbaa !100
  %1195 = add nsw i32 %1190, %1141
  %1196 = getelementptr inbounds i16, i16* %138, i32 %1195
  %1197 = bitcast i16* %1196 to <64 x i16>*
  %1198 = load <64 x i16>, <64 x i16>* %1197, align 2, !tbaa !100
  %1199 = add nsw i32 %1190, %1144
  %1200 = getelementptr inbounds i16, i16* %140, i32 %1199
  %1201 = bitcast i16* %1200 to <64 x i16>*
  %1202 = load <64 x i16>, <64 x i16>* %1201, align 2, !tbaa !100
  %1203 = add nsw i32 %1190, %1146
  %1204 = getelementptr inbounds i16, i16* %142, i32 %1203
  %1205 = bitcast i16* %1204 to <64 x i16>*
  %1206 = load <64 x i16>, <64 x i16>* %1205, align 2, !tbaa !100
  %1207 = add nsw i32 %1190, %1149
  %1208 = getelementptr inbounds i16, i16* %144, i32 %1207
  %1209 = bitcast i16* %1208 to <64 x i16>*
  %1210 = load <64 x i16>, <64 x i16>* %1209, align 2, !tbaa !100
  %1211 = add <64 x i16> %1198, %1194
  %1212 = add <64 x i16> %1211, %1202
  %1213 = add <64 x i16> %1212, %1206
  %1214 = add <64 x i16> %1213, %1210
  %1215 = bitcast <64 x i16> %1214 to <32 x i32>
  %1216 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %1215, i32 -858927923) #12
  %1217 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1216) #12
  %1218 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1216) #12
  %1219 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %1218, <32 x i32> %1217) #12
  %1220 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %1219, i32 2) #12
  %1221 = add nsw i32 %1152, %blur_y.s0.x.v0.base.s
  %1222 = getelementptr inbounds i16, i16* %134, i32 %1221
  %1223 = bitcast i16* %1222 to <32 x i32>*
  store <32 x i32> %1220, <32 x i32>* %1223, align 2, !tbaa !103
  %1224 = shl i32 %blur_y.s0.x.x28, 6
  %a58.1 = or i32 %1224, 64
  %1225 = icmp slt i32 %a58.1, %b60
  %blur_y.s0.x.v0.base.s.1 = select i1 %1225, i32 %a58.1, i32 %b60
  %1226 = sub nsw i32 %blur_y.s0.x.v0.base.s.1, %t321
  %1227 = add nsw i32 %1226, %1138
  %1228 = getelementptr inbounds i16, i16* %136, i32 %1227
  %1229 = bitcast i16* %1228 to <64 x i16>*
  %1230 = load <64 x i16>, <64 x i16>* %1229, align 2, !tbaa !100
  %1231 = add nsw i32 %1226, %1141
  %1232 = getelementptr inbounds i16, i16* %138, i32 %1231
  %1233 = bitcast i16* %1232 to <64 x i16>*
  %1234 = load <64 x i16>, <64 x i16>* %1233, align 2, !tbaa !100
  %1235 = add nsw i32 %1226, %1144
  %1236 = getelementptr inbounds i16, i16* %140, i32 %1235
  %1237 = bitcast i16* %1236 to <64 x i16>*
  %1238 = load <64 x i16>, <64 x i16>* %1237, align 2, !tbaa !100
  %1239 = add nsw i32 %1226, %1146
  %1240 = getelementptr inbounds i16, i16* %142, i32 %1239
  %1241 = bitcast i16* %1240 to <64 x i16>*
  %1242 = load <64 x i16>, <64 x i16>* %1241, align 2, !tbaa !100
  %1243 = add nsw i32 %1226, %1149
  %1244 = getelementptr inbounds i16, i16* %144, i32 %1243
  %1245 = bitcast i16* %1244 to <64 x i16>*
  %1246 = load <64 x i16>, <64 x i16>* %1245, align 2, !tbaa !100
  %1247 = add <64 x i16> %1234, %1230
  %1248 = add <64 x i16> %1247, %1238
  %1249 = add <64 x i16> %1248, %1242
  %1250 = add <64 x i16> %1249, %1246
  %1251 = bitcast <64 x i16> %1250 to <32 x i32>
  %1252 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %1251, i32 -858927923) #12
  %1253 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1252) #12
  %1254 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1252) #12
  %1255 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %1254, <32 x i32> %1253) #12
  %1256 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %1255, i32 2) #12
  %1257 = add nsw i32 %1152, %blur_y.s0.x.v0.base.s.1
  %1258 = getelementptr inbounds i16, i16* %134, i32 %1257
  %1259 = bitcast i16* %1258 to <32 x i32>*
  store <32 x i32> %1256, <32 x i32>* %1259, align 2, !tbaa !103
  %1260 = add nuw nsw i32 %blur_y.s0.x.x28, 2
