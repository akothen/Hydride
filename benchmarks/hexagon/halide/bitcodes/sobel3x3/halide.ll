...
entry:
  ...
  %t323 = select i1 %41, i32 %a11, i32 0
  %42 = mul i32 %t323, 768
  %43 = or i32 %42, 131
...
"for output.s0.y.y.y":                            ; preds = %entry, %call_destructor.exit36
  %output.s0.y.y.y = phi i32 [ 0, %entry ], [ %755, %call_destructor.exit36 ]
...
"for output.s0.x.x.preheader":                    ; preds = %"consume bounded_input"
  %751 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>)
  %752 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>)
  br label %"for output.s0.x.x"

"for output.s0.x.x":                              ; preds = %"for output.s0.x.x.preheader", %"end for output.s0.y.yi"
  %output.s0.x.x = phi i32 [ %865, %"end for output.s0.y.yi" ], [ 0, %"for output.s0.x.x.preheader" ]
  %753 = shl nsw i32 %output.s0.x.x, 7
  %754 = add nsw i32 %753, %t228
...
call_destructor.exit36:                           ; preds = %"end for output.s0.x.x", %if.then.i35
  %755 = add nuw nsw i32 %output.s0.y.y.y, 1
  %.not21 = icmp eq i32 %755, 128
...
"for output.s0.y.yi":                             ; preds = %"for output.s0.x.x", %"for output.s0.y.yi"
  %output.s0.y.yi = phi i32 [ 0, %"for output.s0.x.x" ], [ %756, %"for output.s0.y.yi" ]
  %756 = add nuw nsw i32 %output.s0.y.yi, 1
  %757 = mul nsw i32 %756, %a11
  %758 = add nsw i32 %757, %output.s0.x.x
  %t185 = sub i32 %758, %a11
  %759 = shl nsw i32 %t185, 7
  %760 = getelementptr inbounds i8, i8* %bounded_input, i32 %759
  %761 = bitcast i8* %760 to <128 x i8>*
  %t186.s = load <128 x i8>, <128 x i8>* %761, align 128, !tbaa !99
  %762 = getelementptr inbounds i8, i8* %760, i32 2
  %763 = bitcast i8* %762 to <128 x i8>*
  %t187.s = load <128 x i8>, <128 x i8>* %763, align 2, !tbaa !99
  %t188 = add i32 %758, %a11
  %764 = shl nsw i32 %t188, 7
  %765 = getelementptr inbounds i8, i8* %bounded_input, i32 %764
  %766 = bitcast i8* %765 to <128 x i8>*
  %t189.s = load <128 x i8>, <128 x i8>* %766, align 128, !tbaa !99
  %767 = getelementptr inbounds i8, i8* %765, i32 2
  %768 = bitcast i8* %767 to <128 x i8>*
  %t190.s = load <128 x i8>, <128 x i8>* %768, align 2, !tbaa !99
  %769 = shl nsw i32 %758, 7
  %770 = getelementptr inbounds i8, i8* %bounded_input, i32 %769
  %771 = bitcast i8* %770 to <128 x i8>*
  %t319 = load <128 x i8>, <128 x i8>* %771, align 128, !tbaa !99
  %772 = getelementptr inbounds i8, i8* %760, i32 1
  %773 = bitcast i8* %772 to <128 x i8>*
  %774 = load <128 x i8>, <128 x i8>* %773, align 1, !tbaa !99
  %775 = zext <128 x i8> %774 to <128 x i16>
  %776 = bitcast <128 x i16> %775 to <64 x i32>
  %777 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %776)
  %778 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %776)
  %779 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %778, i32 1) #12
  %780 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %777, i32 1) #12
  %781 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %780, <32 x i32> %779)
  %782 = bitcast <64 x i32> %781 to <128 x i16>
  %783 = zext <128 x i8> %t186.s to <128 x i16>
  %784 = zext <128 x i8> %t187.s to <128 x i16>
  %785 = add nuw nsw <128 x i16> %784, %783
  %786 = add <128 x i16> %785, %782
  %787 = getelementptr inbounds i8, i8* %765, i32 1
  %788 = bitcast i8* %787 to <128 x i8>*
  %789 = load <128 x i8>, <128 x i8>* %788, align 1, !tbaa !99
  %790 = zext <128 x i8> %789 to <128 x i16>
  %791 = bitcast <128 x i16> %790 to <64 x i32>
  %792 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %791)
  %793 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %791)
  %794 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %793, i32 1) #12
  %795 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %792, i32 1) #12
  %796 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %795, <32 x i32> %794)
  %797 = bitcast <64 x i32> %796 to <128 x i16>
  %798 = zext <128 x i8> %t189.s to <128 x i16>
  %799 = zext <128 x i8> %t190.s to <128 x i16>
  %800 = add nuw nsw <128 x i16> %799, %798
  %801 = add <128 x i16> %800, %797
  %802 = bitcast <128 x i16> %786 to <64 x i32>
  %803 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %802)
  %804 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %802)
  %805 = bitcast <128 x i16> %801 to <64 x i32>
  %806 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %805)
  %807 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %805)
  %808 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %804, <32 x i32> %807) #12
  %809 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %803, <32 x i32> %806) #12
  %810 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %809, <32 x i32> %808)
  %811 = bitcast <64 x i32> %810 to <128 x i16>
  %812 = zext <128 x i8> %t319 to <128 x i16>
  ...
  %820 = add nuw nsw <128 x i16> %798, %783
  %821 = add <128 x i16> %820, %819
  %822 = getelementptr inbounds i8, i8* %770, i32 128
  %823 = bitcast i8* %822 to <32 x i32>*
  %824 = load <32 x i32>, <32 x i32>* %823, align 128, !tbaa !99
  %825 = bitcast <128 x i8> %t319 to <32 x i32>
  %826 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %824, <32 x i32> %825)
  ...
  %830 = bitcast <32 x i32> %829 to <128 x i8>
  %831 = zext <128 x i8> %830 to <128 x i16>
  %832 = bitcast <128 x i16> %831 to <64 x i32>
  %833 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %832)
  %834 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %832)
  %835 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %834, i32 1) #12
  %836 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %833, i32 1) #12
  %837 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %836, <32 x i32> %835)
  %838 = bitcast <64 x i32> %837 to <128 x i16>
  %839 = add nuw nsw <128 x i16> %799, %784
  %840 = add <128 x i16> %839, %838
  %841 = bitcast <128 x i16> %821 to <64 x i32>
  %842 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %841)
  %843 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %841)
  %844 = bitcast <128 x i16> %840 to <64 x i32>
  %845 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %844)
  %846 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %844)
  %847 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %843, <32 x i32> %846) #12
  %848 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %842, <32 x i32> %845) #12
  %849 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %848, <32 x i32> %847)
  %850 = bitcast <64 x i32> %849 to <128 x i16>
  %851 = add <128 x i16> %850, %811
  %852 = bitcast <128 x i16> %851 to <64 x i32>
  %853 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %852)
  %854 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %852)
  %855 = tail call <32 x i32> @llvm.hexagon.V6.vminuh.128B(<32 x i32> %854, <32 x i32> %752) #12
  %856 = tail call <32 x i32> @llvm.hexagon.V6.vminuh.128B(<32 x i32> %853, <32 x i32> %751) #12
  %857 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %856, <32 x i32> %855)
  %858 = bitcast <64 x i32> %857 to <128 x i16>
  %859 = trunc <128 x i16> %858 to <128 x i8>
  %860 = add nsw i32 %output.s0.y.yi, %70
  %861 = mul nsw i32 %860, %output.stride.1
  %862 = add nsw i32 %754, %861
  %863 = getelementptr inbounds i8, i8* %output, i32 %862
  %864 = bitcast i8* %863 to <128 x i8>*
  store <128 x i8> %859, <128 x i8>* %864, align 1, !tbaa !104
  %.not22 = icmp eq i32 %756, 4
  br i1 %.not22, label %"end for output.s0.y.yi", label %"for output.s0.y.yi"

"end for output.s0.y.yi":                         ; preds = %"for output.s0.y.yi"
  %865 = add nuw nsw i32 %output.s0.x.x, 1
  %.not23 = icmp eq i32 %865, %t229
