...
; Function Attrs: nounwind readnone
declare <64 x i32> @llvm.hexagon.V6.vmpabus.acc.128B(<64 x i32>, <64 x i32>, i32) #9
...
entry:
  %hvx_lock_result = tail call i32 @halide_qurt_hvx_lock(i8* null) #14
...
"for output.s0.y.y.preheader":                    ; preds = %entry
  ...
  br i1 %17, label %"for output.s0.y.y.us", label %"for output.s0.y.y.preheader81", !prof !95

"for output.s0.y.y.preheader81":                  ; preds = %"for output.s0.y.y.preheader"
  %19 = add nsw i32 %9, -1
  %xtraiter = and i32 %9, 7
  %20 = icmp ult i32 %19, 7
  br i1 %20, label %call_destructor.exit.loopexit82.unr-lcssa, label %"for output.s0.y.y.preheader81.new"

"for output.s0.y.y.preheader81.new":              ; preds = %"for output.s0.y.y.preheader81"
...
"for output.s0.y.y.us":                           ; preds = %"for output.s0.y.y.preheader", %"end for output.s0.x.x.loopexit.us"
  %output.s0.y.y.us = phi i32 [ %247, %"end for output.s0.x.x.loopexit.us" ], [ 0, %"for output.s0.y.y.preheader" ]
  %21 = mul nsw i32 %output.s0.y.y.us, %2
  %22 = shl nsw i32 %21, 2
  %23 = add nsw i32 %22, %11
  %24 = getelementptr inbounds i8, i8* %18, i32 %23
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %24, i64 %or6.i) #14, !srcloc !96
  %25 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> <i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759>)
  %26 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> <i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759, i32 458759>)
  %27 = mul nsw i32 %output.s0.y.y.us, %7
  %28 = shl nsw i32 %output.s0.y.y.us, 2
  %29 = or i32 %28, 1
  %30 = mul nsw i32 %29, %2
  %31 = mul nsw i32 %29, %7
  %32 = or i32 %28, 2
...
"for output.s0.x.x.us":                           ; preds = %"for output.s0.y.y.us", %"for output.s0.x.x.us"
  %output.s0.x.x.us = phi i32 [ %246, %"for output.s0.x.x.us" ], [ 0, %"for output.s0.y.y.us" ]
  %38 = shl nsw i32 %output.s0.x.x.us, 5
  %t6.us = add nsw i32 %38, %21
  %39 = shl nsw i32 %t6.us, 2
  %40 = add nsw i32 %39, %2
  %41 = getelementptr inbounds i8, i8* %0, i32 %40
  %42 = getelementptr inbounds i8, i8* %41, i32 1
  %43 = bitcast i8* %42 to <32 x i32>*
  %44 = load <32 x i32>, <32 x i32>* %43, align 1, !tbaa !97
  %45 = tail call <64 x i32> @llvm.hexagon.V6.vzb.128B(<32 x i32> %44) #14
  %46 = bitcast <64 x i32> %45 to <128 x i16>
  %47 = sub nsw i32 %39, %2
  %48 = getelementptr inbounds i8, i8* %0, i32 %47
  %49 = getelementptr inbounds i8, i8* %48, i32 1
  %50 = bitcast i8* %49 to <32 x i32>*
  %51 = load <32 x i32>, <32 x i32>* %50, align 1, !tbaa !97
  %52 = tail call <64 x i32> @llvm.hexagon.V6.vzb.128B(<32 x i32> %51) #14
  %53 = bitcast <64 x i32> %52 to <128 x i16>
  %54 = bitcast i8* %48 to <32 x i32>*
  %55 = load <32 x i32>, <32 x i32>* %54, align 1, !tbaa !97
  %56 = bitcast i8* %41 to <32 x i32>*
  %57 = load <32 x i32>, <32 x i32>* %56, align 1, !tbaa !97
  %dv.i.us = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %57, <32 x i32> %55) #14
  %res.i.us = tail call <64 x i32> @llvm.hexagon.V6.vmpabus.128B(<64 x i32> %dv.i.us, i32 33686018) #14
  %58 = getelementptr inbounds i8, i8* %0, i32 %39
  ...
  %dv1.i.us = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %63, <32 x i32> %60) #14
  %res.i22.us = tail call <64 x i32> @llvm.hexagon.V6.vmpabus.acc.128B(<64 x i32> %res.i.us, <64 x i32> %dv1.i.us, i32 33817092) #14
  %ret_val.i23.us = bitcast <64 x i32> %res.i22.us to <128 x i16>
  %64 = getelementptr inbounds i8, i8* %41, i32 -1
  %65 = bitcast i8* %64 to <32 x i32>*
  %66 = load <32 x i32>, <32 x i32>* %65, align 1, !tbaa !97
  %67 = tail call <64 x i32> @llvm.hexagon.V6.vzb.128B(<32 x i32> %66) #14
  %68 = bitcast <64 x i32> %67 to <128 x i16>
  %69 = add <128 x i16> %53, %46
  %70 = add <128 x i16> %69, %ret_val.i23.us
  %71 = add <128 x i16> %70, %68
  %72 = getelementptr inbounds i8, i8* %58, i32 -1
  %73 = bitcast i8* %72 to <32 x i32>*
  %74 = load <32 x i32>, <32 x i32>* %73, align 1, !tbaa !97
  %75 = getelementptr inbounds i8, i8* %48, i32 -1
  %76 = bitcast i8* %75 to <32 x i32>*
  %77 = load <32 x i32>, <32 x i32>* %76, align 1, !tbaa !97
  %dv0.i.us = bitcast <128 x i16> %71 to <64 x i32>
  %dv1.i26.us = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %77, <32 x i32> %74) #14
  %res.i27.us = tail call <64 x i32> @llvm.hexagon.V6.vmpabus.acc.128B(<64 x i32> %dv0.i.us, <64 x i32> %dv1.i26.us, i32 16908546) #14
  %78 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %res.i27.us)
  %79 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %res.i27.us)
  %80 = tail call <32 x i32> @llvm.hexagon.V6.vavghrnd.128B(<32 x i32> %79, <32 x i32> %26) #14
  %81 = tail call <32 x i32> @llvm.hexagon.V6.vavghrnd.128B(<32 x i32> %78, <32 x i32> %25) #14
  %82 = tail call <32 x i32> @llvm.hexagon.V6.vasrh.128B(<32 x i32> %80, i32 3) #14
  %83 = tail call <32 x i32> @llvm.hexagon.V6.vasrh.128B(<32 x i32> %81, i32 3) #14
  %84 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %83, <32 x i32> %82)
  %85 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %84) #14
  %86 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %84) #14
  %87 = tail call <32 x i32> @llvm.hexagon.V6.vshuffeb.128B(<32 x i32> %85, <32 x i32> %86) #14
  %88 = add nsw i32 %38, %27
  %89 = shl nsw i32 %88, 2
  %90 = getelementptr inbounds i8, i8* %3, i32 %89
  %91 = bitcast i8* %90 to <32 x i32>*
  store <32 x i32> %87, <32 x i32>* %91, align 1, !tbaa !100
  %92 = shl nsw i32 %output.s0.x.x.us, 7
  %t9.us = add nsw i32 %92, %30
  %93 = add nsw i32 %t9.us, %2
  %94 = getelementptr inbounds i8, i8* %0, i32 %93
  %95 = getelementptr inbounds i8, i8* %94, i32 1
  %96 = bitcast i8* %95 to <32 x i32>*
  %97 = load <32 x i32>, <32 x i32>* %96, align 1, !tbaa !97
  %98 = tail call <64 x i32> @llvm.hexagon.V6.vzb.128B(<32 x i32> %97) #14
  %99 = bitcast <64 x i32> %98 to <128 x i16>
  %100 = sub nsw i32 %t9.us, %2
  %101 = getelementptr inbounds i8, i8* %0, i32 %100
  %102 = getelementptr inbounds i8, i8* %101, i32 1
  %103 = bitcast i8* %102 to <32 x i32>*
  %104 = load <32 x i32>, <32 x i32>* %103, align 1, !tbaa !97
  %105 = tail call <64 x i32> @llvm.hexagon.V6.vzb.128B(<32 x i32> %104) #14
  %106 = bitcast <64 x i32> %105 to <128 x i16>
  %107 = bitcast i8* %101 to <32 x i32>*
  %108 = load <32 x i32>, <32 x i32>* %107, align 1, !tbaa !97
  %109 = bitcast i8* %94 to <32 x i32>*
  %110 = load <32 x i32>, <32 x i32>* %109, align 1, !tbaa !97
  %dv.i31.us = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %110, <32 x i32> %108) #14
  %res.i32.us = tail call <64 x i32> @llvm.hexagon.V6.vmpabus.128B(<64 x i32> %dv.i31.us, i32 33686018) #14
  %111 = getelementptr inbounds i8, i8* %0, i32 %t9.us
  %112 = bitcast i8* %111 to <32 x i32>*
  %113 = load <32 x i32>, <32 x i32>* %112, align 1, !tbaa !97
  %114 = getelementptr inbounds i8, i8* %111, i32 1
  %115 = bitcast i8* %114 to <32 x i32>*
  %116 = load <32 x i32>, <32 x i32>* %115, align 1, !tbaa !97
  %dv1.i36.us = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %116, <32 x i32> %113) #14
  %res.i37.us = tail call <64 x i32> @llvm.hexagon.V6.vmpabus.acc.128B(<64 x i32> %res.i32.us, <64 x i32> %dv1.i36.us, i32 33817092) #14
  %ret_val.i38.us = bitcast <64 x i32> %res.i37.us to <128 x i16>
  %117 = getelementptr inbounds i8, i8* %94, i32 -1
  %118 = bitcast i8* %117 to <32 x i32>*
  %119 = load <32 x i32>, <32 x i32>* %118, align 1, !tbaa !97
  %120 = tail call <64 x i32> @llvm.hexagon.V6.vzb.128B(<32 x i32> %119) #14
  %121 = bitcast <64 x i32> %120 to <128 x i16>
  %122 = add <128 x i16> %106, %99
  %123 = add <128 x i16> %122, %ret_val.i38.us
  %124 = add <128 x i16> %123, %121
  %125 = getelementptr inbounds i8, i8* %111, i32 -1
  %126 = bitcast i8* %125 to <32 x i32>*
  %127 = load <32 x i32>, <32 x i32>* %126, align 1, !tbaa !97
  %128 = getelementptr inbounds i8, i8* %101, i32 -1
  %129 = bitcast i8* %128 to <32 x i32>*
  %130 = load <32 x i32>, <32 x i32>* %129, align 1, !tbaa !97
  %dv0.i39.us = bitcast <128 x i16> %124 to <64 x i32>
  %dv1.i42.us = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %130, <32 x i32> %127) #14
  %res.i43.us = tail call <64 x i32> @llvm.hexagon.V6.vmpabus.acc.128B(<64 x i32> %dv0.i39.us, <64 x i32> %dv1.i42.us, i32 16908546) #14
  %131 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %res.i43.us)
  %132 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %res.i43.us)
  %133 = tail call <32 x i32> @llvm.hexagon.V6.vavghrnd.128B(<32 x i32> %132, <32 x i32> %26) #14
  %134 = tail call <32 x i32> @llvm.hexagon.V6.vavghrnd.128B(<32 x i32> %131, <32 x i32> %25) #14
  %135 = tail call <32 x i32> @llvm.hexagon.V6.vasrh.128B(<32 x i32> %133, i32 3) #14
  %136 = tail call <32 x i32> @llvm.hexagon.V6.vasrh.128B(<32 x i32> %134, i32 3) #14
  %137 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %136, <32 x i32> %135)
  %138 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %137) #14
  %139 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %137) #14
  %140 = tail call <32 x i32> @llvm.hexagon.V6.vshuffeb.128B(<32 x i32> %138, <32 x i32> %139) #14
  %141 = add nsw i32 %92, %31
  %142 = getelementptr inbounds i8, i8* %3, i32 %141
  %143 = bitcast i8* %142 to <32 x i32>*
  store <32 x i32> %140, <32 x i32>* %143, align 1, !tbaa !100
  %t12.us = add nsw i32 %92, %33
  %144 = add nsw i32 %t12.us, %2
  %145 = getelementptr inbounds i8, i8* %0, i32 %144
  %146 = getelementptr inbounds i8, i8* %145, i32 1
  %147 = bitcast i8* %146 to <32 x i32>*
  %148 = load <32 x i32>, <32 x i32>* %147, align 1, !tbaa !97
  %149 = tail call <64 x i32> @llvm.hexagon.V6.vzb.128B(<32 x i32> %148) #14
  %150 = bitcast <64 x i32> %149 to <128 x i16>
  %151 = sub nsw i32 %t12.us, %2
  %152 = getelementptr inbounds i8, i8* %0, i32 %151
  %153 = getelementptr inbounds i8, i8* %152, i32 1
  %154 = bitcast i8* %153 to <32 x i32>*
  %155 = load <32 x i32>, <32 x i32>* %154, align 1, !tbaa !97
  %156 = tail call <64 x i32> @llvm.hexagon.V6.vzb.128B(<32 x i32> %155) #14
  %157 = bitcast <64 x i32> %156 to <128 x i16>
  %158 = bitcast i8* %152 to <32 x i32>*
  %159 = load <32 x i32>, <32 x i32>* %158, align 1, !tbaa !97
  %160 = bitcast i8* %145 to <32 x i32>*
  %161 = load <32 x i32>, <32 x i32>* %160, align 1, !tbaa !97
  %dv.i47.us = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %161, <32 x i32> %159) #14
  %res.i48.us = tail call <64 x i32> @llvm.hexagon.V6.vmpabus.128B(<64 x i32> %dv.i47.us, i32 33686018) #14
  %162 = getelementptr inbounds i8, i8* %0, i32 %t12.us
  %163 = bitcast i8* %162 to <32 x i32>*
  %164 = load <32 x i32>, <32 x i32>* %163, align 1, !tbaa !97
  %165 = getelementptr inbounds i8, i8* %162, i32 1
  %166 = bitcast i8* %165 to <32 x i32>*
  %167 = load <32 x i32>, <32 x i32>* %166, align 1, !tbaa !97
  %dv1.i52.us = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %167, <32 x i32> %164) #14
  %res.i53.us = tail call <64 x i32> @llvm.hexagon.V6.vmpabus.acc.128B(<64 x i32> %res.i48.us, <64 x i32> %dv1.i52.us, i32 33817092) #14
  %ret_val.i54.us = bitcast <64 x i32> %res.i53.us to <128 x i16>
  %168 = getelementptr inbounds i8, i8* %145, i32 -1
  %169 = bitcast i8* %168 to <32 x i32>*
  %170 = load <32 x i32>, <32 x i32>* %169, align 1, !tbaa !97
  %171 = tail call <64 x i32> @llvm.hexagon.V6.vzb.128B(<32 x i32> %170) #14
  %172 = bitcast <64 x i32> %171 to <128 x i16>
  %173 = add <128 x i16> %157, %150
  %174 = add <128 x i16> %173, %ret_val.i54.us
  %175 = add <128 x i16> %174, %172
  %176 = getelementptr inbounds i8, i8* %162, i32 -1
  %177 = bitcast i8* %176 to <32 x i32>*
  %178 = load <32 x i32>, <32 x i32>* %177, align 1, !tbaa !97
  %179 = getelementptr inbounds i8, i8* %152, i32 -1
  %180 = bitcast i8* %179 to <32 x i32>*
  %181 = load <32 x i32>, <32 x i32>* %180, align 1, !tbaa !97
  %dv0.i55.us = bitcast <128 x i16> %175 to <64 x i32>
  %dv1.i58.us = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %181, <32 x i32> %178) #14
  %res.i59.us = tail call <64 x i32> @llvm.hexagon.V6.vmpabus.acc.128B(<64 x i32> %dv0.i55.us, <64 x i32> %dv1.i58.us, i32 16908546) #14
  %182 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %res.i59.us)
  %183 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %res.i59.us)
  %184 = tail call <32 x i32> @llvm.hexagon.V6.vavghrnd.128B(<32 x i32> %183, <32 x i32> %26) #14
  %185 = tail call <32 x i32> @llvm.hexagon.V6.vavghrnd.128B(<32 x i32> %182, <32 x i32> %25) #14
  %186 = tail call <32 x i32> @llvm.hexagon.V6.vasrh.128B(<32 x i32> %184, i32 3) #14
  %187 = tail call <32 x i32> @llvm.hexagon.V6.vasrh.128B(<32 x i32> %185, i32 3) #14
  %188 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %187, <32 x i32> %186)
  %189 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %188) #14
  %190 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %188) #14
  %191 = tail call <32 x i32> @llvm.hexagon.V6.vshuffeb.128B(<32 x i32> %189, <32 x i32> %190) #14
  %192 = add nsw i32 %92, %34
  %193 = getelementptr inbounds i8, i8* %3, i32 %192
  %194 = bitcast i8* %193 to <32 x i32>*
  store <32 x i32> %191, <32 x i32>* %194, align 1, !tbaa !100
  %t15.us = add nsw i32 %92, %36
  %195 = add nsw i32 %t15.us, %2
  %196 = getelementptr inbounds i8, i8* %0, i32 %195
  %197 = getelementptr inbounds i8, i8* %196, i32 1
  %198 = bitcast i8* %197 to <32 x i32>*
  %199 = load <32 x i32>, <32 x i32>* %198, align 1, !tbaa !97
  %200 = tail call <64 x i32> @llvm.hexagon.V6.vzb.128B(<32 x i32> %199) #14
  %201 = bitcast <64 x i32> %200 to <128 x i16>
  %202 = sub nsw i32 %t15.us, %2
  ...
  %207 = tail call <64 x i32> @llvm.hexagon.V6.vzb.128B(<32 x i32> %206) #14
  %208 = bitcast <64 x i32> %207 to <128 x i16>
  %209 = bitcast i8* %203 to <32 x i32>*
  %210 = load <32 x i32>, <32 x i32>* %209, align 1, !tbaa !97
  %211 = bitcast i8* %196 to <32 x i32>*
  %212 = load <32 x i32>, <32 x i32>* %211, align 1, !tbaa !97
  %dv.i63.us = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %212, <32 x i32> %210) #14
  %res.i64.us = tail call <64 x i32> @llvm.hexagon.V6.vmpabus.128B(<64 x i32> %dv.i63.us, i32 33686018) #14
  %213 = getelementptr inbounds i8, i8* %0, i32 %t15.us
  %214 = bitcast i8* %213 to <32 x i32>*
  %215 = load <32 x i32>, <32 x i32>* %214, align 1, !tbaa !97
  %216 = getelementptr inbounds i8, i8* %213, i32 1
  %217 = bitcast i8* %216 to <32 x i32>*
  %218 = load <32 x i32>, <32 x i32>* %217, align 1, !tbaa !97
  %dv1.i68.us = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %218, <32 x i32> %215) #14
  %res.i69.us = tail call <64 x i32> @llvm.hexagon.V6.vmpabus.acc.128B(<64 x i32> %res.i64.us, <64 x i32> %dv1.i68.us, i32 33817092) #14
  %ret_val.i70.us = bitcast <64 x i32> %res.i69.us to <128 x i16>
  %219 = getelementptr inbounds i8, i8* %196, i32 -1
  %220 = bitcast i8* %219 to <32 x i32>*
  %221 = load <32 x i32>, <32 x i32>* %220, align 1, !tbaa !97
  %222 = tail call <64 x i32> @llvm.hexagon.V6.vzb.128B(<32 x i32> %221) #14
  %223 = bitcast <64 x i32> %222 to <128 x i16>
  %224 = add <128 x i16> %208, %201
  %225 = add <128 x i16> %224, %ret_val.i70.us
  %226 = add <128 x i16> %225, %223
  %227 = getelementptr inbounds i8, i8* %213, i32 -1
  %228 = bitcast i8* %227 to <32 x i32>*
  %229 = load <32 x i32>, <32 x i32>* %228, align 1, !tbaa !97
  %230 = getelementptr inbounds i8, i8* %203, i32 -1
  %231 = bitcast i8* %230 to <32 x i32>*
  %232 = load <32 x i32>, <32 x i32>* %231, align 1, !tbaa !97
  %dv0.i71.us = bitcast <128 x i16> %226 to <64 x i32>
  %dv1.i74.us = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %232, <32 x i32> %229) #14
  %res.i75.us = tail call <64 x i32> @llvm.hexagon.V6.vmpabus.acc.128B(<64 x i32> %dv0.i71.us, <64 x i32> %dv1.i74.us, i32 16908546) #14
  %233 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %res.i75.us)
  %234 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %res.i75.us)
  %235 = tail call <32 x i32> @llvm.hexagon.V6.vavghrnd.128B(<32 x i32> %234, <32 x i32> %26) #14
  %236 = tail call <32 x i32> @llvm.hexagon.V6.vavghrnd.128B(<32 x i32> %233, <32 x i32> %25) #14
  %237 = tail call <32 x i32> @llvm.hexagon.V6.vasrh.128B(<32 x i32> %235, i32 3) #14
  %238 = tail call <32 x i32> @llvm.hexagon.V6.vasrh.128B(<32 x i32> %236, i32 3) #14
  %239 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %238, <32 x i32> %237)
  %240 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %239) #14
  %241 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %239) #14
  %242 = tail call <32 x i32> @llvm.hexagon.V6.vshuffeb.128B(<32 x i32> %240, <32 x i32> %241) #14
  %243 = add nsw i32 %92, %37
  %244 = getelementptr inbounds i8, i8* %3, i32 %243
  %245 = bitcast i8* %244 to <32 x i32>*
  store <32 x i32> %242, <32 x i32>* %245, align 1, !tbaa !100
  %246 = add nuw nsw i32 %output.s0.x.x.us, 1
  %.not2.us = icmp eq i32 %246, %16
...
"end for output.s0.x.x.loopexit.us":              ; preds = %"for output.s0.x.x.us"
  %247 = add nuw nsw i32 %output.s0.y.y.us, 1
  %.not.us = icmp eq i32 %247, %9
  br i1 %.not.us, label %call_destructor.exit, label %"for output.s0.y.y.us"

"for output.s0.y.y":                              ; preds = %"for output.s0.y.y", %"for output.s0.y.y.preheader81.new"
  %output.s0.y.y = phi i32 [ 0, %"for output.s0.y.y.preheader81.new" ], [ %287, %"for output.s0.y.y" ]
  %niter = phi i32 [ %unroll_iter, %"for output.s0.y.y.preheader81.new" ], [ %niter.nsub.7, %"for output.s0.y.y" ]
  %248 = mul nsw i32 %output.s0.y.y, %2
  %249 = shl nsw i32 %248, 2
  %250 = add nsw i32 %249, %11
  %251 = getelementptr inbounds i8, i8* %18, i32 %250
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %251, i64 %or6.i) #14, !srcloc !96
  %252 = or i32 %output.s0.y.y, 1
  %253 = mul nsw i32 %252, %2
  %254 = shl nsw i32 %253, 2
  %255 = add nsw i32 %254, %11
  %256 = getelementptr inbounds i8, i8* %18, i32 %255
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %256, i64 %or6.i) #14, !srcloc !96
  %257 = or i32 %output.s0.y.y, 2
  %258 = mul nsw i32 %257, %2
  %259 = shl nsw i32 %258, 2
  %260 = add nsw i32 %259, %11
  %261 = getelementptr inbounds i8, i8* %18, i32 %260
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %261, i64 %or6.i) #14, !srcloc !96
  %262 = or i32 %output.s0.y.y, 3
  %263 = mul nsw i32 %262, %2
  %264 = shl nsw i32 %263, 2
  %265 = add nsw i32 %264, %11
  %266 = getelementptr inbounds i8, i8* %18, i32 %265
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %266, i64 %or6.i) #14, !srcloc !96
  %267 = or i32 %output.s0.y.y, 4
  %268 = mul nsw i32 %267, %2
  %269 = shl nsw i32 %268, 2
  %270 = add nsw i32 %269, %11
  %271 = getelementptr inbounds i8, i8* %18, i32 %270
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %271, i64 %or6.i) #14, !srcloc !96
  %272 = or i32 %output.s0.y.y, 5
  %273 = mul nsw i32 %272, %2
  %274 = shl nsw i32 %273, 2
  %275 = add nsw i32 %274, %11
  %276 = getelementptr inbounds i8, i8* %18, i32 %275
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %276, i64 %or6.i) #14, !srcloc !96
  %277 = or i32 %output.s0.y.y, 6
  %278 = mul nsw i32 %277, %2
  %279 = shl nsw i32 %278, 2
  %280 = add nsw i32 %279, %11
  %281 = getelementptr inbounds i8, i8* %18, i32 %280
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %281, i64 %or6.i) #14, !srcloc !96
  %282 = or i32 %output.s0.y.y, 7
  %283 = mul nsw i32 %282, %2
  %284 = shl nsw i32 %283, 2
  %285 = add nsw i32 %284, %11
  %286 = getelementptr inbounds i8, i8* %18, i32 %285
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %286, i64 %or6.i) #14, !srcloc !96
  %287 = add nuw nsw i32 %output.s0.y.y, 8
  %niter.nsub.7 = add i32 %niter, -8
  %niter.ncmp.7 = icmp eq i32 %niter.nsub.7, 0
  br i1 %niter.ncmp.7, label %call_destructor.exit.loopexit82.unr-lcssa, label %"for output.s0.y.y"

call_destructor.exit.loopexit82.unr-lcssa:        ; preds = %"for output.s0.y.y", %"for output.s0.y.y.preheader81"
  %output.s0.y.y.unr = phi i32 [ 0, %"for output.s0.y.y.preheader81" ], [ %287, %"for output.s0.y.y" ]
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %call_destructor.exit, label %"for output.s0.y.y.epil"

"for output.s0.y.y.epil":                         ; preds = %call_destructor.exit.loopexit82.unr-lcssa, %"for output.s0.y.y.epil"
  %output.s0.y.y.epil = phi i32 [ %292, %"for output.s0.y.y.epil" ], [ %output.s0.y.y.unr, %call_destructor.exit.loopexit82.unr-lcssa ]
  %epil.iter = phi i32 [ %epil.iter.sub, %"for output.s0.y.y.epil" ], [ %xtraiter, %call_destructor.exit.loopexit82.unr-lcssa ]
  %288 = mul nsw i32 %output.s0.y.y.epil, %2
  %289 = shl nsw i32 %288, 2
  %290 = add nsw i32 %289, %11
  %291 = getelementptr inbounds i8, i8* %18, i32 %290
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %291, i64 %or6.i) #14, !srcloc !96
  %292 = add nuw nsw i32 %output.s0.y.y.epil, 1
  %epil.iter.sub = add i32 %epil.iter, -1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.sub, 0
  br i1 %epil.iter.cmp.not, label %call_destructor.exit, label %"for output.s0.y.y.epil", !llvm.loop !102

call_destructor.exit:                             ; preds = %call_destructor.exit.loopexit82.unr-lcssa, %"for output.s0.y.y.epil", %"end for output.s0.x.x.loopexit.us", %entry
  tail call void @halide_qurt_hvx_unlock_as_destructor(i8* null, i8* nonnull inttoptr (i32 1 to i8*)) #12
  ret i32 0
}
...
entry:
  ...
  %6 = tail call i32 @gaussian3x3_hvx128(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #15
  ret i32 0
}
