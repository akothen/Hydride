...
"for output.s0.y.y.us":                           ; preds = %"for output.s0.y.y.preheader", %"end for output.s0.x.x.loopexit.us"
  %output.s0.y.y.us = phi i32 [ %545, %"end for output.s0.x.x.loopexit.us" ], [ 0, %"for output.s0.y.y.preheader" ]
...
"for output.s0.x.x.us":                           ; preds = %"for output.s0.y.y.us", %"for output.s0.x.x.us"
  %output.s0.x.x.us = phi i32 [ %544, %"for output.s0.x.x.us" ], [ 0, %"for output.s0.y.y.us" ]
  ...
  %40 = bitcast i8* %39 to <64 x i8>*
  %41 = load <64 x i8>, <64 x i8>* %40, align 1, !tbaa !97
  %42 = zext <64 x i8> %41 to <64 x i16>
  %43 = bitcast i8* %38 to <64 x i8>*
  %44 = load <64 x i8>, <64 x i8>* %43, align 1, !tbaa !97
  %45 = zext <64 x i8> %44 to <64 x i16>
  %46 = sub nsw i32 %37, %2
  %47 = getelementptr inbounds i8, i8* %0, i32 %46
  %48 = bitcast i8* %47 to <64 x i8>*
  %49 = load <64 x i8>, <64 x i8>* %48, align 1, !tbaa !97
  %50 = zext <64 x i8> %49 to <64 x i16>
  %51 = add nsw i32 %37, %2
  %52 = getelementptr inbounds i8, i8* %0, i32 %51
  %53 = bitcast i8* %52 to <64 x i8>*
  %54 = load <64 x i8>, <64 x i8>* %53, align 1, !tbaa !97
  %55 = zext <64 x i8> %54 to <64 x i16>
  %56 = getelementptr inbounds i8, i8* %38, i32 -1
  %57 = bitcast i8* %56 to <64 x i8>*
  %58 = load <64 x i8>, <64 x i8>* %57, align 1, !tbaa !97
  %59 = zext <64 x i8> %58 to <64 x i16>
  %60 = getelementptr inbounds i8, i8* %47, i32 -1
  %61 = bitcast i8* %60 to <64 x i8>*
  %62 = load <64 x i8>, <64 x i8>* %61, align 1, !tbaa !97
  %63 = zext <64 x i8> %62 to <64 x i16>
  %64 = getelementptr inbounds i8, i8* %52, i32 -1
  %65 = bitcast i8* %64 to <64 x i8>*
  %66 = load <64 x i8>, <64 x i8>* %65, align 1, !tbaa !97
  %67 = zext <64 x i8> %66 to <64 x i16>
  %68 = getelementptr inbounds i8, i8* %47, i32 1
  %69 = bitcast i8* %68 to <64 x i8>*
  %70 = load <64 x i8>, <64 x i8>* %69, align 1, !tbaa !97
  %71 = zext <64 x i8> %70 to <64 x i16>
  %72 = getelementptr inbounds i8, i8* %52, i32 1
  %73 = bitcast i8* %72 to <64 x i8>*
  %74 = load <64 x i8>, <64 x i8>* %73, align 1, !tbaa !97
  %75 = zext <64 x i8> %74 to <64 x i16>
  %76 = getelementptr inbounds i8, i8* %38, i32 65
  %77 = bitcast i8* %76 to <64 x i8>*
  %78 = load <64 x i8>, <64 x i8>* %77, align 1, !tbaa !97
  %79 = zext <64 x i8> %78 to <64 x i16>
  %80 = getelementptr inbounds i8, i8* %38, i32 64
  %81 = bitcast i8* %80 to <64 x i8>*
  %82 = load <64 x i8>, <64 x i8>* %81, align 1, !tbaa !97
  %83 = zext <64 x i8> %82 to <64 x i16>
  %84 = getelementptr inbounds i8, i8* %47, i32 64
  %85 = bitcast i8* %84 to <64 x i8>*
  %86 = load <64 x i8>, <64 x i8>* %85, align 1, !tbaa !97
  %87 = zext <64 x i8> %86 to <64 x i16>
  %88 = getelementptr inbounds i8, i8* %52, i32 64
  %89 = bitcast i8* %88 to <64 x i8>*
  %90 = load <64 x i8>, <64 x i8>* %89, align 1, !tbaa !97
  %91 = zext <64 x i8> %90 to <64 x i16>
  %92 = getelementptr inbounds i8, i8* %38, i32 63
  %93 = bitcast i8* %92 to <64 x i8>*
  %94 = load <64 x i8>, <64 x i8>* %93, align 1, !tbaa !97
  %95 = zext <64 x i8> %94 to <64 x i16>
  %96 = getelementptr inbounds i8, i8* %47, i32 63
  %97 = bitcast i8* %96 to <64 x i8>*
  %98 = load <64 x i8>, <64 x i8>* %97, align 1, !tbaa !97
  %99 = zext <64 x i8> %98 to <64 x i16>
  %100 = getelementptr inbounds i8, i8* %52, i32 63
  %101 = bitcast i8* %100 to <64 x i8>*
  %102 = load <64 x i8>, <64 x i8>* %101, align 1, !tbaa !97
  %103 = zext <64 x i8> %102 to <64 x i16>
  %104 = getelementptr inbounds i8, i8* %47, i32 65
  %105 = bitcast i8* %104 to <64 x i8>*
  %106 = load <64 x i8>, <64 x i8>* %105, align 1, !tbaa !97
  %107 = zext <64 x i8> %106 to <64 x i16>
  %108 = getelementptr inbounds i8, i8* %52, i32 65
  %109 = bitcast i8* %108 to <64 x i8>*
  %110 = load <64 x i8>, <64 x i8>* %109, align 1, !tbaa !97
  %111 = zext <64 x i8> %110 to <64 x i16>
  %112 = bitcast <64 x i16> %45 to <32 x i32>
  %113 = bitcast <64 x i16> %50 to <32 x i32>
  %114 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %112, <32 x i32> %113) #15
  %115 = bitcast <64 x i16> %59 to <32 x i32>
  %116 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %115, <32 x i32> %115) #15
  %117 = bitcast <64 x i16> %63 to <32 x i32>
  %118 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %117, <32 x i32> %117) #15
  %119 = bitcast <64 x i16> %67 to <32 x i32>
  %120 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %118, <32 x i32> %119) #15
  %121 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %116, <32 x i32> %120) #15
  %122 = bitcast <64 x i16> %71 to <32 x i32>
  %123 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %122, <32 x i32> %122) #15
  %124 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %120, <32 x i32> %123) #15
  %125 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %121, <32 x i32> %124) #15
  %126 = bitcast <64 x i16> %55 to <32 x i32>
  %127 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %126, <32 x i32> %125) #15
  %128 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %114, <32 x i32> %127) #15
  %129 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %128, <32 x i32> %113) #15
  %130 = bitcast <64 x i16> %42 to <32 x i32>
  %131 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %130, <32 x i32> %129) #15
  %132 = bitcast <64 x i16> %75 to <32 x i32>
  %133 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %131, <32 x i32> %132) #15
  %134 = tail call <32 x i32> @llvm.hexagon.V6.vaddhsat.128B(<32 x i32> <i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296>, <32 x i32> %133) #15
  %135 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %134, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #15
  %136 = bitcast <64 x i16> %83 to <32 x i32>
  %137 = bitcast <64 x i16> %87 to <32 x i32>
  %138 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %136, <32 x i32> %137) #15
  %139 = bitcast <64 x i16> %95 to <32 x i32>
  %140 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %139, <32 x i32> %139) #15
  %141 = bitcast <64 x i16> %99 to <32 x i32>
  %142 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %141, <32 x i32> %141) #15
  %143 = bitcast <64 x i16> %103 to <32 x i32>
  %144 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %142, <32 x i32> %143) #15
  %145 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %140, <32 x i32> %144) #15
  %146 = bitcast <64 x i16> %107 to <32 x i32>
  %147 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %146, <32 x i32> %146) #15
  %148 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %144, <32 x i32> %147) #15
  %149 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %145, <32 x i32> %148) #15
  %150 = bitcast <64 x i16> %91 to <32 x i32>
  %151 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %150, <32 x i32> %149) #15
  %152 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %138, <32 x i32> %151) #15
  %153 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %152, <32 x i32> %137) #15
  %154 = bitcast <64 x i16> %79 to <32 x i32>
  %155 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %154, <32 x i32> %153) #15
  %156 = bitcast <64 x i16> %111 to <32 x i32>
  %157 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %155, <32 x i32> %156) #15
  %158 = tail call <32 x i32> @llvm.hexagon.V6.vaddhsat.128B(<32 x i32> <i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296>, <32 x i32> %157) #15
  %159 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %158, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #15
  %160 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %135, <32 x i32> %159) #15
  %161 = add nsw i32 %36, %25
  %162 = shl nsw i32 %161, 2
  %163 = getelementptr inbounds i8, i8* %3, i32 %162
  %164 = bitcast i8* %163 to <32 x i32>*
  store <32 x i32> %160, <32 x i32>* %164, align 1, !tbaa !100
  %165 = shl nsw i32 %output.s0.x.x.us, 7
  %t9.us = add nsw i32 %165, %28
  %166 = getelementptr inbounds i8, i8* %0, i32 %t9.us
  %167 = getelementptr inbounds i8, i8* %166, i32 1
  %168 = bitcast i8* %167 to <64 x i8>*
  %169 = load <64 x i8>, <64 x i8>* %168, align 1, !tbaa !97
  %170 = zext <64 x i8> %169 to <64 x i16>
  %171 = bitcast i8* %166 to <64 x i8>*
  %172 = load <64 x i8>, <64 x i8>* %171, align 1, !tbaa !97
  %173 = zext <64 x i8> %172 to <64 x i16>
  %174 = sub nsw i32 %t9.us, %2
  %175 = getelementptr inbounds i8, i8* %0, i32 %174
  %176 = bitcast i8* %175 to <64 x i8>*
  %177 = load <64 x i8>, <64 x i8>* %176, align 1, !tbaa !97
  %178 = zext <64 x i8> %177 to <64 x i16>
  %179 = add nsw i32 %t9.us, %2
  %180 = getelementptr inbounds i8, i8* %0, i32 %179
  %181 = bitcast i8* %180 to <64 x i8>*
  %182 = load <64 x i8>, <64 x i8>* %181, align 1, !tbaa !97
  %183 = zext <64 x i8> %182 to <64 x i16>
  %184 = getelementptr inbounds i8, i8* %166, i32 -1
  %185 = bitcast i8* %184 to <64 x i8>*
  %186 = load <64 x i8>, <64 x i8>* %185, align 1, !tbaa !97
  %187 = zext <64 x i8> %186 to <64 x i16>
  %188 = getelementptr inbounds i8, i8* %175, i32 -1
  %189 = bitcast i8* %188 to <64 x i8>*
  %190 = load <64 x i8>, <64 x i8>* %189, align 1, !tbaa !97
  %191 = zext <64 x i8> %190 to <64 x i16>
  %192 = getelementptr inbounds i8, i8* %180, i32 -1
  %193 = bitcast i8* %192 to <64 x i8>*
  %194 = load <64 x i8>, <64 x i8>* %193, align 1, !tbaa !97
  %195 = zext <64 x i8> %194 to <64 x i16>
  %196 = getelementptr inbounds i8, i8* %175, i32 1
  %197 = bitcast i8* %196 to <64 x i8>*
  %198 = load <64 x i8>, <64 x i8>* %197, align 1, !tbaa !97
  %199 = zext <64 x i8> %198 to <64 x i16>
  %200 = getelementptr inbounds i8, i8* %180, i32 1
  %201 = bitcast i8* %200 to <64 x i8>*
  %202 = load <64 x i8>, <64 x i8>* %201, align 1, !tbaa !97
  %203 = zext <64 x i8> %202 to <64 x i16>
  %204 = getelementptr inbounds i8, i8* %166, i32 65
  %205 = bitcast i8* %204 to <64 x i8>*
  %206 = load <64 x i8>, <64 x i8>* %205, align 1, !tbaa !97
  %207 = zext <64 x i8> %206 to <64 x i16>
  %208 = getelementptr inbounds i8, i8* %166, i32 64
  %209 = bitcast i8* %208 to <64 x i8>*
  %210 = load <64 x i8>, <64 x i8>* %209, align 1, !tbaa !97
  %211 = zext <64 x i8> %210 to <64 x i16>
  %212 = getelementptr inbounds i8, i8* %175, i32 64
  %213 = bitcast i8* %212 to <64 x i8>*
  %214 = load <64 x i8>, <64 x i8>* %213, align 1, !tbaa !97
  %215 = zext <64 x i8> %214 to <64 x i16>
  %216 = getelementptr inbounds i8, i8* %180, i32 64
  %217 = bitcast i8* %216 to <64 x i8>*
  %218 = load <64 x i8>, <64 x i8>* %217, align 1, !tbaa !97
  %219 = zext <64 x i8> %218 to <64 x i16>
  %220 = getelementptr inbounds i8, i8* %166, i32 63
  %221 = bitcast i8* %220 to <64 x i8>*
  %222 = load <64 x i8>, <64 x i8>* %221, align 1, !tbaa !97
  %223 = zext <64 x i8> %222 to <64 x i16>
  %224 = getelementptr inbounds i8, i8* %175, i32 63
  %225 = bitcast i8* %224 to <64 x i8>*
  %226 = load <64 x i8>, <64 x i8>* %225, align 1, !tbaa !97
  %227 = zext <64 x i8> %226 to <64 x i16>
  %228 = getelementptr inbounds i8, i8* %180, i32 63
  %229 = bitcast i8* %228 to <64 x i8>*
  %230 = load <64 x i8>, <64 x i8>* %229, align 1, !tbaa !97
  %231 = zext <64 x i8> %230 to <64 x i16>
  %232 = getelementptr inbounds i8, i8* %175, i32 65
  %233 = bitcast i8* %232 to <64 x i8>*
  %234 = load <64 x i8>, <64 x i8>* %233, align 1, !tbaa !97
  %235 = zext <64 x i8> %234 to <64 x i16>
  %236 = getelementptr inbounds i8, i8* %180, i32 65
  %237 = bitcast i8* %236 to <64 x i8>*
  %238 = load <64 x i8>, <64 x i8>* %237, align 1, !tbaa !97
  %239 = zext <64 x i8> %238 to <64 x i16>
  %240 = bitcast <64 x i16> %173 to <32 x i32>
  %241 = bitcast <64 x i16> %178 to <32 x i32>
  %242 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %240, <32 x i32> %241) #15
  %243 = bitcast <64 x i16> %187 to <32 x i32>
  %244 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %243, <32 x i32> %243) #15
  %245 = bitcast <64 x i16> %191 to <32 x i32>
  %246 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %245, <32 x i32> %245) #15
  %247 = bitcast <64 x i16> %195 to <32 x i32>
  %248 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %246, <32 x i32> %247) #15
  %249 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %244, <32 x i32> %248) #15
  %250 = bitcast <64 x i16> %199 to <32 x i32>
  %251 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %250, <32 x i32> %250) #15
  %252 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %248, <32 x i32> %251) #15
  %253 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %249, <32 x i32> %252) #15
  %254 = bitcast <64 x i16> %183 to <32 x i32>
  %255 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %254, <32 x i32> %253) #15
  %256 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %242, <32 x i32> %255) #15
  %257 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %256, <32 x i32> %241) #15
  %258 = bitcast <64 x i16> %170 to <32 x i32>
  %259 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %258, <32 x i32> %257) #15
  %260 = bitcast <64 x i16> %203 to <32 x i32>
  %261 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %259, <32 x i32> %260) #15
  %262 = tail call <32 x i32> @llvm.hexagon.V6.vaddhsat.128B(<32 x i32> <i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296>, <32 x i32> %261) #15
  %263 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %262, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #15
  %264 = bitcast <64 x i16> %211 to <32 x i32>
  %265 = bitcast <64 x i16> %215 to <32 x i32>
  %266 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %264, <32 x i32> %265) #15
  %267 = bitcast <64 x i16> %223 to <32 x i32>
  %268 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %267, <32 x i32> %267) #15
  %269 = bitcast <64 x i16> %227 to <32 x i32>
  %270 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %269, <32 x i32> %269) #15
  %271 = bitcast <64 x i16> %231 to <32 x i32>
  %272 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %270, <32 x i32> %271) #15
  %273 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %268, <32 x i32> %272) #15
  %274 = bitcast <64 x i16> %235 to <32 x i32>
  %275 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %274, <32 x i32> %274) #15
  %276 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %272, <32 x i32> %275) #15
  %277 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %273, <32 x i32> %276) #15
  %278 = bitcast <64 x i16> %219 to <32 x i32>
  %279 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %278, <32 x i32> %277) #15
  %280 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %266, <32 x i32> %279) #15
  %281 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %280, <32 x i32> %265) #15
  %282 = bitcast <64 x i16> %207 to <32 x i32>
  %283 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %282, <32 x i32> %281) #15
  %284 = bitcast <64 x i16> %239 to <32 x i32>
  %285 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %283, <32 x i32> %284) #15
  %286 = tail call <32 x i32> @llvm.hexagon.V6.vaddhsat.128B(<32 x i32> <i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296>, <32 x i32> %285) #15
  %287 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %286, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #15
  %288 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %263, <32 x i32> %287) #15
  %289 = add nsw i32 %165, %29
  %290 = getelementptr inbounds i8, i8* %3, i32 %289
  %291 = bitcast i8* %290 to <32 x i32>*
  store <32 x i32> %288, <32 x i32>* %291, align 1, !tbaa !100
  %t12.us = add nsw i32 %165, %31
  %292 = getelementptr inbounds i8, i8* %0, i32 %t12.us
  %293 = getelementptr inbounds i8, i8* %292, i32 1
  %294 = bitcast i8* %293 to <64 x i8>*
  %295 = load <64 x i8>, <64 x i8>* %294, align 1, !tbaa !97
  %296 = zext <64 x i8> %295 to <64 x i16>
  %297 = bitcast i8* %292 to <64 x i8>*
  %298 = load <64 x i8>, <64 x i8>* %297, align 1, !tbaa !97
  %299 = zext <64 x i8> %298 to <64 x i16>
  %300 = sub nsw i32 %t12.us, %2
  %301 = getelementptr inbounds i8, i8* %0, i32 %300
  %302 = bitcast i8* %301 to <64 x i8>*
  %303 = load <64 x i8>, <64 x i8>* %302, align 1, !tbaa !97
  %304 = zext <64 x i8> %303 to <64 x i16>
  %305 = add nsw i32 %t12.us, %2
  %306 = getelementptr inbounds i8, i8* %0, i32 %305
  %307 = bitcast i8* %306 to <64 x i8>*
  %308 = load <64 x i8>, <64 x i8>* %307, align 1, !tbaa !97
  %309 = zext <64 x i8> %308 to <64 x i16>
  %310 = getelementptr inbounds i8, i8* %292, i32 -1
  %311 = bitcast i8* %310 to <64 x i8>*
  %312 = load <64 x i8>, <64 x i8>* %311, align 1, !tbaa !97
  %313 = zext <64 x i8> %312 to <64 x i16>
  %314 = getelementptr inbounds i8, i8* %301, i32 -1
  %315 = bitcast i8* %314 to <64 x i8>*
  %316 = load <64 x i8>, <64 x i8>* %315, align 1, !tbaa !97
  %317 = zext <64 x i8> %316 to <64 x i16>
  %318 = getelementptr inbounds i8, i8* %306, i32 -1
  %319 = bitcast i8* %318 to <64 x i8>*
  %320 = load <64 x i8>, <64 x i8>* %319, align 1, !tbaa !97
  %321 = zext <64 x i8> %320 to <64 x i16>
  %322 = getelementptr inbounds i8, i8* %301, i32 1
  %323 = bitcast i8* %322 to <64 x i8>*
  %324 = load <64 x i8>, <64 x i8>* %323, align 1, !tbaa !97
  %325 = zext <64 x i8> %324 to <64 x i16>
  %326 = getelementptr inbounds i8, i8* %306, i32 1
  %327 = bitcast i8* %326 to <64 x i8>*
  %328 = load <64 x i8>, <64 x i8>* %327, align 1, !tbaa !97
  %329 = zext <64 x i8> %328 to <64 x i16>
  %330 = getelementptr inbounds i8, i8* %292, i32 65
  %331 = bitcast i8* %330 to <64 x i8>*
  %332 = load <64 x i8>, <64 x i8>* %331, align 1, !tbaa !97
  %333 = zext <64 x i8> %332 to <64 x i16>
  %334 = getelementptr inbounds i8, i8* %292, i32 64
  %335 = bitcast i8* %334 to <64 x i8>*
  %336 = load <64 x i8>, <64 x i8>* %335, align 1, !tbaa !97
  %337 = zext <64 x i8> %336 to <64 x i16>
  %338 = getelementptr inbounds i8, i8* %301, i32 64
  %339 = bitcast i8* %338 to <64 x i8>*
  %340 = load <64 x i8>, <64 x i8>* %339, align 1, !tbaa !97
  %341 = zext <64 x i8> %340 to <64 x i16>
  %342 = getelementptr inbounds i8, i8* %306, i32 64
  %343 = bitcast i8* %342 to <64 x i8>*
  %344 = load <64 x i8>, <64 x i8>* %343, align 1, !tbaa !97
  %345 = zext <64 x i8> %344 to <64 x i16>
  %346 = getelementptr inbounds i8, i8* %292, i32 63
  %347 = bitcast i8* %346 to <64 x i8>*
  %348 = load <64 x i8>, <64 x i8>* %347, align 1, !tbaa !97
  %349 = zext <64 x i8> %348 to <64 x i16>
  %350 = getelementptr inbounds i8, i8* %301, i32 63
  %351 = bitcast i8* %350 to <64 x i8>*
  %352 = load <64 x i8>, <64 x i8>* %351, align 1, !tbaa !97
  %353 = zext <64 x i8> %352 to <64 x i16>
  %354 = getelementptr inbounds i8, i8* %306, i32 63
  %355 = bitcast i8* %354 to <64 x i8>*
  %356 = load <64 x i8>, <64 x i8>* %355, align 1, !tbaa !97
  %357 = zext <64 x i8> %356 to <64 x i16>
  %358 = getelementptr inbounds i8, i8* %301, i32 65
  %359 = bitcast i8* %358 to <64 x i8>*
  %360 = load <64 x i8>, <64 x i8>* %359, align 1, !tbaa !97
  %361 = zext <64 x i8> %360 to <64 x i16>
  %362 = getelementptr inbounds i8, i8* %306, i32 65
  %363 = bitcast i8* %362 to <64 x i8>*
  %364 = load <64 x i8>, <64 x i8>* %363, align 1, !tbaa !97
  %365 = zext <64 x i8> %364 to <64 x i16>
  %366 = bitcast <64 x i16> %299 to <32 x i32>
  %367 = bitcast <64 x i16> %304 to <32 x i32>
  %368 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %366, <32 x i32> %367) #15
  %369 = bitcast <64 x i16> %313 to <32 x i32>
  %370 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %369, <32 x i32> %369) #15
  %371 = bitcast <64 x i16> %317 to <32 x i32>
  %372 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %371, <32 x i32> %371) #15
  %373 = bitcast <64 x i16> %321 to <32 x i32>
  %374 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %372, <32 x i32> %373) #15
  %375 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %370, <32 x i32> %374) #15
  %376 = bitcast <64 x i16> %325 to <32 x i32>
  %377 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %376, <32 x i32> %376) #15
  %378 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %374, <32 x i32> %377) #15
  %379 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %375, <32 x i32> %378) #15
  %380 = bitcast <64 x i16> %309 to <32 x i32>
  %381 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %380, <32 x i32> %379) #15
  %382 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %368, <32 x i32> %381) #15
  %383 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %382, <32 x i32> %367) #15
  %384 = bitcast <64 x i16> %296 to <32 x i32>
  %385 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %384, <32 x i32> %383) #15
  %386 = bitcast <64 x i16> %329 to <32 x i32>
  %387 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %385, <32 x i32> %386) #15
  %388 = tail call <32 x i32> @llvm.hexagon.V6.vaddhsat.128B(<32 x i32> <i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296>, <32 x i32> %387) #15
  %389 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %388, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #15
  %390 = bitcast <64 x i16> %337 to <32 x i32>
  %391 = bitcast <64 x i16> %341 to <32 x i32>
  %392 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %390, <32 x i32> %391) #15
  %393 = bitcast <64 x i16> %349 to <32 x i32>
  %394 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %393, <32 x i32> %393) #15
  %395 = bitcast <64 x i16> %353 to <32 x i32>
  %396 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %395, <32 x i32> %395) #15
  %397 = bitcast <64 x i16> %357 to <32 x i32>
  %398 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %396, <32 x i32> %397) #15
  %399 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %394, <32 x i32> %398) #15
  %400 = bitcast <64 x i16> %361 to <32 x i32>
  %401 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %400, <32 x i32> %400) #15
  %402 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %398, <32 x i32> %401) #15
  %403 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %399, <32 x i32> %402) #15
  %404 = bitcast <64 x i16> %345 to <32 x i32>
  %405 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %404, <32 x i32> %403) #15
  %406 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %392, <32 x i32> %405) #15
  %407 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %406, <32 x i32> %391) #15
  %408 = bitcast <64 x i16> %333 to <32 x i32>
  %409 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %408, <32 x i32> %407) #15
  %410 = bitcast <64 x i16> %365 to <32 x i32>
  %411 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %409, <32 x i32> %410) #15
  %412 = tail call <32 x i32> @llvm.hexagon.V6.vaddhsat.128B(<32 x i32> <i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296>, <32 x i32> %411) #15
  %413 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %412, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #15
  %414 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %389, <32 x i32> %413) #15
  %415 = add nsw i32 %165, %32
  %416 = getelementptr inbounds i8, i8* %3, i32 %415
  %417 = bitcast i8* %416 to <32 x i32>*
  store <32 x i32> %414, <32 x i32>* %417, align 1, !tbaa !100
  %t15.us = add nsw i32 %165, %34
  %418 = getelementptr inbounds i8, i8* %0, i32 %t15.us
  %419 = getelementptr inbounds i8, i8* %418, i32 1
  %420 = bitcast i8* %419 to <64 x i8>*
  %421 = load <64 x i8>, <64 x i8>* %420, align 1, !tbaa !97
  %422 = zext <64 x i8> %421 to <64 x i16>
  %423 = bitcast i8* %418 to <64 x i8>*
  %424 = load <64 x i8>, <64 x i8>* %423, align 1, !tbaa !97
  %425 = zext <64 x i8> %424 to <64 x i16>
  %426 = sub nsw i32 %t15.us, %2
  %427 = getelementptr inbounds i8, i8* %0, i32 %426
  %428 = bitcast i8* %427 to <64 x i8>*
  %429 = load <64 x i8>, <64 x i8>* %428, align 1, !tbaa !97
  %430 = zext <64 x i8> %429 to <64 x i16>
  %431 = add nsw i32 %t15.us, %2
  %432 = getelementptr inbounds i8, i8* %0, i32 %431
  %433 = bitcast i8* %432 to <64 x i8>*
  %434 = load <64 x i8>, <64 x i8>* %433, align 1, !tbaa !97
  %435 = zext <64 x i8> %434 to <64 x i16>
  %436 = getelementptr inbounds i8, i8* %418, i32 -1
  %437 = bitcast i8* %436 to <64 x i8>*
  %438 = load <64 x i8>, <64 x i8>* %437, align 1, !tbaa !97
  %439 = zext <64 x i8> %438 to <64 x i16>
  %440 = getelementptr inbounds i8, i8* %427, i32 -1
  %441 = bitcast i8* %440 to <64 x i8>*
  %442 = load <64 x i8>, <64 x i8>* %441, align 1, !tbaa !97
  %443 = zext <64 x i8> %442 to <64 x i16>
  %444 = getelementptr inbounds i8, i8* %432, i32 -1
  %445 = bitcast i8* %444 to <64 x i8>*
  %446 = load <64 x i8>, <64 x i8>* %445, align 1, !tbaa !97
  %447 = zext <64 x i8> %446 to <64 x i16>
  %448 = getelementptr inbounds i8, i8* %427, i32 1
  %449 = bitcast i8* %448 to <64 x i8>*
  %450 = load <64 x i8>, <64 x i8>* %449, align 1, !tbaa !97
  %451 = zext <64 x i8> %450 to <64 x i16>
  %452 = getelementptr inbounds i8, i8* %432, i32 1
  %453 = bitcast i8* %452 to <64 x i8>*
  %454 = load <64 x i8>, <64 x i8>* %453, align 1, !tbaa !97
  %455 = zext <64 x i8> %454 to <64 x i16>
  %456 = getelementptr inbounds i8, i8* %418, i32 65
  %457 = bitcast i8* %456 to <64 x i8>*
  %458 = load <64 x i8>, <64 x i8>* %457, align 1, !tbaa !97
  %459 = zext <64 x i8> %458 to <64 x i16>
  %460 = getelementptr inbounds i8, i8* %418, i32 64
  %461 = bitcast i8* %460 to <64 x i8>*
  %462 = load <64 x i8>, <64 x i8>* %461, align 1, !tbaa !97
  %463 = zext <64 x i8> %462 to <64 x i16>
  %464 = getelementptr inbounds i8, i8* %427, i32 64
  %465 = bitcast i8* %464 to <64 x i8>*
  %466 = load <64 x i8>, <64 x i8>* %465, align 1, !tbaa !97
  %467 = zext <64 x i8> %466 to <64 x i16>
  %468 = getelementptr inbounds i8, i8* %432, i32 64
  %469 = bitcast i8* %468 to <64 x i8>*
  %470 = load <64 x i8>, <64 x i8>* %469, align 1, !tbaa !97
  %471 = zext <64 x i8> %470 to <64 x i16>
  %472 = getelementptr inbounds i8, i8* %418, i32 63
  %473 = bitcast i8* %472 to <64 x i8>*
  %474 = load <64 x i8>, <64 x i8>* %473, align 1, !tbaa !97
  %475 = zext <64 x i8> %474 to <64 x i16>
  %476 = getelementptr inbounds i8, i8* %427, i32 63
  %477 = bitcast i8* %476 to <64 x i8>*
  %478 = load <64 x i8>, <64 x i8>* %477, align 1, !tbaa !97
  %479 = zext <64 x i8> %478 to <64 x i16>
  %480 = getelementptr inbounds i8, i8* %432, i32 63
  %481 = bitcast i8* %480 to <64 x i8>*
  %482 = load <64 x i8>, <64 x i8>* %481, align 1, !tbaa !97
  %483 = zext <64 x i8> %482 to <64 x i16>
  %484 = getelementptr inbounds i8, i8* %427, i32 65
  %485 = bitcast i8* %484 to <64 x i8>*
  %486 = load <64 x i8>, <64 x i8>* %485, align 1, !tbaa !97
  %487 = zext <64 x i8> %486 to <64 x i16>
  %488 = getelementptr inbounds i8, i8* %432, i32 65
  %489 = bitcast i8* %488 to <64 x i8>*
  %490 = load <64 x i8>, <64 x i8>* %489, align 1, !tbaa !97
  %491 = zext <64 x i8> %490 to <64 x i16>
  %492 = bitcast <64 x i16> %425 to <32 x i32>
  %493 = bitcast <64 x i16> %430 to <32 x i32>
  %494 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %492, <32 x i32> %493) #15
  %495 = bitcast <64 x i16> %439 to <32 x i32>
  %496 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %495, <32 x i32> %495) #15
  %497 = bitcast <64 x i16> %443 to <32 x i32>
  %498 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %497, <32 x i32> %497) #15
  %499 = bitcast <64 x i16> %447 to <32 x i32>
  %500 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %498, <32 x i32> %499) #15
  %501 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %496, <32 x i32> %500) #15
  %502 = bitcast <64 x i16> %451 to <32 x i32>
  %503 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %502, <32 x i32> %502) #15
  %504 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %500, <32 x i32> %503) #15
  %505 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %501, <32 x i32> %504) #15
  %506 = bitcast <64 x i16> %435 to <32 x i32>
  %507 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %506, <32 x i32> %505) #15
  %508 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %494, <32 x i32> %507) #15
  %509 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %508, <32 x i32> %493) #15
  %510 = bitcast <64 x i16> %422 to <32 x i32>
  %511 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %510, <32 x i32> %509) #15
  %512 = bitcast <64 x i16> %455 to <32 x i32>
  %513 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %511, <32 x i32> %512) #15
  %514 = tail call <32 x i32> @llvm.hexagon.V6.vaddhsat.128B(<32 x i32> <i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296>, <32 x i32> %513) #15
  %515 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %514, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #15
  %516 = bitcast <64 x i16> %463 to <32 x i32>
  %517 = bitcast <64 x i16> %467 to <32 x i32>
  %518 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %516, <32 x i32> %517) #15
  %519 = bitcast <64 x i16> %475 to <32 x i32>
  %520 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %519, <32 x i32> %519) #15
  %521 = bitcast <64 x i16> %479 to <32 x i32>
  %522 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %521, <32 x i32> %521) #15
  %523 = bitcast <64 x i16> %483 to <32 x i32>
  %524 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %522, <32 x i32> %523) #15
  %525 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %520, <32 x i32> %524) #15
  %526 = bitcast <64 x i16> %487 to <32 x i32>
  %527 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %526, <32 x i32> %526) #15
  %528 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %524, <32 x i32> %527) #15
  %529 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %525, <32 x i32> %528) #15
  %530 = bitcast <64 x i16> %471 to <32 x i32>
  %531 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %530, <32 x i32> %529) #15
  %532 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %518, <32 x i32> %531) #15
  %533 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %532, <32 x i32> %517) #15
  %534 = bitcast <64 x i16> %459 to <32 x i32>
  %535 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %534, <32 x i32> %533) #15
  %536 = bitcast <64 x i16> %491 to <32 x i32>
  %537 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %535, <32 x i32> %536) #15
  %538 = tail call <32 x i32> @llvm.hexagon.V6.vaddhsat.128B(<32 x i32> <i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296>, <32 x i32> %537) #15
  %539 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %538, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #15
  %540 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %515, <32 x i32> %539) #15
  %541 = add nsw i32 %165, %35
  %542 = getelementptr inbounds i8, i8* %3, i32 %541
  %543 = bitcast i8* %542 to <32 x i32>*
  store <32 x i32> %540, <32 x i32>* %543, align 1, !tbaa !100
  %544 = add nuw nsw i32 %output.s0.x.x.us, 1
  %.not2.us = icmp eq i32 %544, %16
...
"end for output.s0.x.x.loopexit.us":              ; preds = %"for output.s0.x.x.us"
  %545 = add nuw nsw i32 %output.s0.y.y.us, 1
  %.not.us = icmp eq i32 %545, %9
...
"for output.s0.y.y":                              ; preds = %"for output.s0.y.y", %"for output.s0.y.y.preheader24.new"
  %output.s0.y.y = phi i32 [ 0, %"for output.s0.y.y.preheader24.new" ], [ %585, %"for output.s0.y.y" ]
  %niter = phi i32 [ %unroll_iter, %"for output.s0.y.y.preheader24.new" ], [ %niter.nsub.7, %"for output.s0.y.y" ]
  %546 = mul nsw i32 %output.s0.y.y, %2
  %547 = shl nsw i32 %546, 2
  %548 = add nsw i32 %547, %11
  %549 = getelementptr inbounds i8, i8* %18, i32 %548
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %549, i64 %or6.i) #15, !srcloc !96
  %550 = or i32 %output.s0.y.y, 1
  %551 = mul nsw i32 %550, %2
  %552 = shl nsw i32 %551, 2
  %553 = add nsw i32 %552, %11
  %554 = getelementptr inbounds i8, i8* %18, i32 %553
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %554, i64 %or6.i) #15, !srcloc !96
  %555 = or i32 %output.s0.y.y, 2
  %556 = mul nsw i32 %555, %2
  %557 = shl nsw i32 %556, 2
  %558 = add nsw i32 %557, %11
  %559 = getelementptr inbounds i8, i8* %18, i32 %558
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %559, i64 %or6.i) #15, !srcloc !96
  %560 = or i32 %output.s0.y.y, 3
  %561 = mul nsw i32 %560, %2
  %562 = shl nsw i32 %561, 2
  %563 = add nsw i32 %562, %11
  %564 = getelementptr inbounds i8, i8* %18, i32 %563
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %564, i64 %or6.i) #15, !srcloc !96
  %565 = or i32 %output.s0.y.y, 4
  %566 = mul nsw i32 %565, %2
  %567 = shl nsw i32 %566, 2
  %568 = add nsw i32 %567, %11
  %569 = getelementptr inbounds i8, i8* %18, i32 %568
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %569, i64 %or6.i) #15, !srcloc !96
  %570 = or i32 %output.s0.y.y, 5
  %571 = mul nsw i32 %570, %2
  %572 = shl nsw i32 %571, 2
  %573 = add nsw i32 %572, %11
  %574 = getelementptr inbounds i8, i8* %18, i32 %573
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %574, i64 %or6.i) #15, !srcloc !96
  %575 = or i32 %output.s0.y.y, 6
  %576 = mul nsw i32 %575, %2
  %577 = shl nsw i32 %576, 2
  %578 = add nsw i32 %577, %11
  %579 = getelementptr inbounds i8, i8* %18, i32 %578
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %579, i64 %or6.i) #15, !srcloc !96
  %580 = or i32 %output.s0.y.y, 7
  %581 = mul nsw i32 %580, %2
  %582 = shl nsw i32 %581, 2
  %583 = add nsw i32 %582, %11
  %584 = getelementptr inbounds i8, i8* %18, i32 %583
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %584, i64 %or6.i) #15, !srcloc !96
  %585 = add nuw nsw i32 %output.s0.y.y, 8
  %niter.nsub.7 = add i32 %niter, -8
  %niter.ncmp.7 = icmp eq i32 %niter.nsub.7, 0
...
call_destructor.exit.loopexit25.unr-lcssa:        ; preds = %"for output.s0.y.y", %"for output.s0.y.y.preheader24"
  %output.s0.y.y.unr = phi i32 [ 0, %"for output.s0.y.y.preheader24" ], [ %585, %"for output.s0.y.y" ]
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
...
"for output.s0.y.y.epil":                         ; preds = %call_destructor.exit.loopexit25.unr-lcssa, %"for output.s0.y.y.epil"
  %output.s0.y.y.epil = phi i32 [ %590, %"for output.s0.y.y.epil" ], [ %output.s0.y.y.unr, %call_destructor.exit.loopexit25.unr-lcssa ]
  %epil.iter = phi i32 [ %epil.iter.sub, %"for output.s0.y.y.epil" ], [ %xtraiter, %call_destructor.exit.loopexit25.unr-lcssa ]
  %586 = mul nsw i32 %output.s0.y.y.epil, %2
  %587 = shl nsw i32 %586, 2
  %588 = add nsw i32 %587, %11
  %589 = getelementptr inbounds i8, i8* %18, i32 %588
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* nonnull %589, i64 %or6.i) #15, !srcloc !96
  %590 = add nuw nsw i32 %output.s0.y.y.epil, 1
  %epil.iter.sub = add i32 %epil.iter, -1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.sub, 0
...
define <128 x i8> @hydride.node.gaussian3x3_hvx_depth3.0(<64 x i16> %arg, <64 x i16> %arg.1, <64 x i16> %arg.2, <64 x i16> %arg.3, <64 x i16> %arg.4, <64 x i16> %arg.5, <64 x i16> %arg.6, <64 x i16> %arg.7, <64 x i16> %arg.8, <64 x i16> %arg.9, <64 x i16> %arg.10, <64 x i16> %arg.11, <64 x i16> %arg.12, <64 x i16> %arg.13, <64 x i16> %arg.14, <64 x i16> %arg.15, <64 x i16> %arg.16, <64 x i16> %arg.17) local_unnamed_addr #12 {
entry:
  ...
  %4 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %3, <32 x i32> %3)
  %5 = bitcast <64 x i16> %arg.5 to <32 x i32>
  %6 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %5, <32 x i32> %5)
  %7 = bitcast <64 x i16> %arg.6 to <32 x i32>
  %8 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %6, <32 x i32> %7)
  %9 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %4, <32 x i32> %8)
  %10 = bitcast <64 x i16> %arg.7 to <32 x i32>
  %11 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %10, <32 x i32> %10)
  %12 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %8, <32 x i32> %11)
  %13 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %9, <32 x i32> %12)
  %14 = bitcast <64 x i16> %arg.3 to <32 x i32>
  %15 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %14, <32 x i32> %13)
  %16 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %2, <32 x i32> %15)
  %17 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %16, <32 x i32> %1)
  %18 = bitcast <64 x i16> %arg to <32 x i32>
  %19 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %18, <32 x i32> %17)
  %20 = bitcast <64 x i16> %arg.8 to <32 x i32>
  %21 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %19, <32 x i32> %20)
  %22 = tail call <32 x i32> @llvm.hexagon.V6.vaddhsat.128B(<32 x i32> <i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296>, <32 x i32> %21)
  %23 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %22, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>)
  %24 = bitcast <64 x i16> %arg.10 to <32 x i32>
  %25 = bitcast <64 x i16> %arg.11 to <32 x i32>
  %26 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %24, <32 x i32> %25)
  %27 = bitcast <64 x i16> %arg.13 to <32 x i32>
  %28 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %27, <32 x i32> %27)
  %29 = bitcast <64 x i16> %arg.14 to <32 x i32>
  %30 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %29, <32 x i32> %29)
  %31 = bitcast <64 x i16> %arg.15 to <32 x i32>
  %32 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %30, <32 x i32> %31)
  %33 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %28, <32 x i32> %32)
  %34 = bitcast <64 x i16> %arg.16 to <32 x i32>
  %35 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %34, <32 x i32> %34)
  %36 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %32, <32 x i32> %35)
  %37 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %33, <32 x i32> %36)
  %38 = bitcast <64 x i16> %arg.12 to <32 x i32>
  %39 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %38, <32 x i32> %37)
  %40 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %26, <32 x i32> %39)
  %41 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %40, <32 x i32> %25)
  %42 = bitcast <64 x i16> %arg.9 to <32 x i32>
  %43 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %42, <32 x i32> %41)
  %44 = bitcast <64 x i16> %arg.17 to <32 x i32>
  %45 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %43, <32 x i32> %44)
  %46 = tail call <32 x i32> @llvm.hexagon.V6.vaddhsat.128B(<32 x i32> <i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296, i32 524296>, <32 x i32> %45)
  %47 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %46, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>)
  %48 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %23, <32 x i32> %47)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.gaussian3x3_hvx_depth3.1(<64 x i16> %arg, <64 x i16> %arg.1, <64 x i16> %arg.2, <64 x i16> %arg.3, <64 x i16> %arg.4, <64 x i16> %arg.5, <64 x i16> %arg.6, <64 x i16> %arg.7, <64 x i16> %arg.8, <64 x i16> %arg.9, <64 x i16> %arg.10, <64 x i16> %arg.11, <64 x i16> %arg.12, <64 x i16> %arg.13, <64 x i16> %arg.14, <64 x i16> %arg.15, <64 x i16> %arg.16, <64 x i16> %arg.17) local_unnamed_addr #12 {
entry:
  %0 = bitcast <64 x i16> %arg.1 to <32 x i32>
  %1 = bitcast <64 x i16> %arg.2 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.gaussian3x3_hvx_depth3.2(<64 x i16> %arg, <64 x i16> %arg.1, <64 x i16> %arg.2, <64 x i16> %arg.3, <64 x i16> %arg.4, <64 x i16> %arg.5, <64 x i16> %arg.6, <64 x i16> %arg.7, <64 x i16> %arg.8, <64 x i16> %arg.9, <64 x i16> %arg.10, <64 x i16> %arg.11, <64 x i16> %arg.12, <64 x i16> %arg.13, <64 x i16> %arg.14, <64 x i16> %arg.15, <64 x i16> %arg.16, <64 x i16> %arg.17) local_unnamed_addr #12 {
entry:
  %0 = bitcast <64 x i16> %arg.1 to <32 x i32>
  %1 = bitcast <64 x i16> %arg.2 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.gaussian3x3_hvx_depth3.3(<64 x i16> %arg, <64 x i16> %arg.1, <64 x i16> %arg.2, <64 x i16> %arg.3, <64 x i16> %arg.4, <64 x i16> %arg.5, <64 x i16> %arg.6, <64 x i16> %arg.7, <64 x i16> %arg.8, <64 x i16> %arg.9, <64 x i16> %arg.10, <64 x i16> %arg.11, <64 x i16> %arg.12, <64 x i16> %arg.13, <64 x i16> %arg.14, <64 x i16> %arg.15, <64 x i16> %arg.16, <64 x i16> %arg.17) local_unnamed_addr #12 {
entry:
  %0 = bitcast <64 x i16> %arg.1 to <32 x i32>
  %1 = bitcast <64 x i16> %arg.2 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vaddh.128B(<32 x i32> %0, <32 x i32> %1)
