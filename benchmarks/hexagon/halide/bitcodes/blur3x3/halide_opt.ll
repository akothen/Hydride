...
"for blur_x.s0.x.x":                              ; preds = %"for blur_x.s0.x.x.preheader", %"for blur_x.s0.x.x"
  ...
  %89 = bitcast i16* %88 to <64 x i16>*
  %90 = load <64 x i16>, <64 x i16>* %89, align 2, !tbaa !97
  %91 = add <64 x i16> %87, %84
  %92 = add <64 x i16> %91, %90
  %93 = bitcast <64 x i16> %92 to <32 x i32>
  %94 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %93, i32 -1431590229) #12
  %95 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %94) #12
  %96 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %94) #12
  %97 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %96, <32 x i32> %95) #12
  %98 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %97, i32 1) #12
  ...
  %106 = bitcast i16* %105 to <64 x i16>*
  %107 = load <64 x i16>, <64 x i16>* %106, align 2, !tbaa !97
  %108 = getelementptr inbounds i16, i16* %104, i32 -62
  %109 = bitcast i16* %108 to <64 x i16>*
  %110 = load <64 x i16>, <64 x i16>* %109, align 2, !tbaa !97
  %111 = getelementptr inbounds i16, i16* %104, i32 -64
  %112 = bitcast i16* %111 to <64 x i16>*
  %113 = load <64 x i16>, <64 x i16>* %112, align 2, !tbaa !97
  %114 = add <64 x i16> %110, %107
  %115 = add <64 x i16> %114, %113
  %116 = bitcast <64 x i16> %115 to <32 x i32>
  %117 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %116, i32 -1431590229) #12
  %118 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %117) #12
  %119 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %117) #12
  %120 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %119, <32 x i32> %118) #12
  %121 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %120, i32 1) #12
  ...
  %129 = bitcast i16* %128 to <64 x i16>*
  %130 = load <64 x i16>, <64 x i16>* %129, align 2, !tbaa !97
  %131 = getelementptr inbounds i16, i16* %127, i32 -62
  %132 = bitcast i16* %131 to <64 x i16>*
  %133 = load <64 x i16>, <64 x i16>* %132, align 2, !tbaa !97
  %134 = getelementptr inbounds i16, i16* %127, i32 -64
  %135 = bitcast i16* %134 to <64 x i16>*
  %136 = load <64 x i16>, <64 x i16>* %135, align 2, !tbaa !97
  %137 = add <64 x i16> %133, %130
  %138 = add <64 x i16> %137, %136
  %139 = bitcast <64 x i16> %138 to <32 x i32>
  %140 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %139, i32 -1431590229) #12
  %141 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %140) #12
  %142 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %140) #12
  %143 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %142, <32 x i32> %141) #12
  %144 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %143, i32 1) #12
  ...
  %152 = bitcast i16* %151 to <64 x i16>*
  %153 = load <64 x i16>, <64 x i16>* %152, align 2, !tbaa !97
  %154 = getelementptr inbounds i16, i16* %150, i32 -62
  %155 = bitcast i16* %154 to <64 x i16>*
  %156 = load <64 x i16>, <64 x i16>* %155, align 2, !tbaa !97
  %157 = getelementptr inbounds i16, i16* %150, i32 -64
  %158 = bitcast i16* %157 to <64 x i16>*
  %159 = load <64 x i16>, <64 x i16>* %158, align 2, !tbaa !97
  %160 = add <64 x i16> %156, %153
  %161 = add <64 x i16> %160, %159
  %162 = bitcast <64 x i16> %161 to <32 x i32>
  %163 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %162, i32 -1431590229) #12
  %164 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %163) #12
  %165 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %163) #12
  %166 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %165, <32 x i32> %164) #12
  %167 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %166, i32 1) #12
...
"for blur_x.s0.x.x.epil":                         ; preds = %"end for blur_x.s0.x.x.loopexit.unr-lcssa", %"for blur_x.s0.x.x.epil"
  ...
  %175 = bitcast i16* %174 to <64 x i16>*
  %176 = load <64 x i16>, <64 x i16>* %175, align 2, !tbaa !97
  %177 = getelementptr inbounds i16, i16* %173, i32 -62
  %178 = bitcast i16* %177 to <64 x i16>*
  %179 = load <64 x i16>, <64 x i16>* %178, align 2, !tbaa !97
  %180 = getelementptr inbounds i16, i16* %173, i32 -64
  %181 = bitcast i16* %180 to <64 x i16>*
  %182 = load <64 x i16>, <64 x i16>* %181, align 2, !tbaa !97
  %183 = add <64 x i16> %179, %176
  %184 = add <64 x i16> %183, %182
  %185 = bitcast <64 x i16> %184 to <32 x i32>
  %186 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %185, i32 -1431590229) #12
  %187 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %186) #12
  %188 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %186) #12
  %189 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %188, <32 x i32> %187) #12
  %190 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %189, i32 1) #12
...
then_bb2:                                         ; preds = %"end for blur_x.s0.x.x"
  ...
  %200 = bitcast i16* %199 to <64 x i16>*
  %201 = load <64 x i16>, <64 x i16>* %200, align 2, !tbaa !97
  %202 = getelementptr inbounds i16, i16* %198, i32 -62
  %203 = bitcast i16* %202 to <64 x i16>*
  %204 = load <64 x i16>, <64 x i16>* %203, align 2, !tbaa !97
  %205 = getelementptr inbounds i16, i16* %198, i32 -64
  %206 = bitcast i16* %205 to <64 x i16>*
  %207 = load <64 x i16>, <64 x i16>* %206, align 2, !tbaa !97
  %208 = add <64 x i16> %204, %201
  %209 = add <64 x i16> %208, %207
  %210 = bitcast <64 x i16> %209 to <32 x i32>
  %211 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %210, i32 -1431590229) #12
  %212 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %211) #12
  %213 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %211) #12
  %214 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %213, <32 x i32> %212) #12
  %215 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %214, i32 1) #12
  %216 = and i32 %195, 3
...
"for blur_y.s0.x.x":                              ; preds = %"for blur_y.s0.x.x.preheader", %"for blur_y.s0.x.x"
  ...
  %242 = bitcast i16* %241 to <64 x i16>*
  %243 = load <64 x i16>, <64 x i16>* %242, align 2, !tbaa !100
  %244 = add nsw i32 %235, %231
  %245 = getelementptr inbounds i16, i16* %54, i32 %244
  %246 = bitcast i16* %245 to <64 x i16>*
  %247 = load <64 x i16>, <64 x i16>* %246, align 2, !tbaa !100
  %248 = add <64 x i16> %243, %239
  %249 = add <64 x i16> %248, %247
  %250 = bitcast <64 x i16> %249 to <32 x i32>
  %251 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %250, i32 -1431590229) #12
  %252 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %251) #12
  %253 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %251) #12
  %254 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %253, <32 x i32> %252) #12
  %255 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %254, i32 1) #12
  ...
  %264 = bitcast i16* %263 to <64 x i16>*
  %265 = load <64 x i16>, <64 x i16>* %264, align 2, !tbaa !100
  %266 = add nsw i32 %261, %228
  %267 = getelementptr inbounds i16, i16* %52, i32 %266
  %268 = bitcast i16* %267 to <64 x i16>*
  %269 = load <64 x i16>, <64 x i16>* %268, align 2, !tbaa !100
  %270 = add nsw i32 %261, %231
  %271 = getelementptr inbounds i16, i16* %54, i32 %270
  %272 = bitcast i16* %271 to <64 x i16>*
  %273 = load <64 x i16>, <64 x i16>* %272, align 2, !tbaa !100
  %274 = add <64 x i16> %269, %265
  %275 = add <64 x i16> %274, %273
  %276 = bitcast <64 x i16> %275 to <32 x i32>
  %277 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %276, i32 -1431590229) #12
  %278 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %277) #12
  %279 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %277) #12
  %280 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %279, <32 x i32> %278) #12
  %281 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %280, i32 1) #12
  ...
  %290 = bitcast i16* %289 to <64 x i16>*
  %291 = load <64 x i16>, <64 x i16>* %290, align 2, !tbaa !100
  %292 = add nsw i32 %287, %228
  %293 = getelementptr inbounds i16, i16* %52, i32 %292
  %294 = bitcast i16* %293 to <64 x i16>*
  %295 = load <64 x i16>, <64 x i16>* %294, align 2, !tbaa !100
  %296 = add nsw i32 %287, %231
  %297 = getelementptr inbounds i16, i16* %54, i32 %296
  %298 = bitcast i16* %297 to <64 x i16>*
  %299 = load <64 x i16>, <64 x i16>* %298, align 2, !tbaa !100
  %300 = add <64 x i16> %295, %291
  %301 = add <64 x i16> %300, %299
  %302 = bitcast <64 x i16> %301 to <32 x i32>
  %303 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %302, i32 -1431590229) #12
  %304 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %303) #12
  %305 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %303) #12
  %306 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %305, <32 x i32> %304) #12
  %307 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %306, i32 1) #12
  ...
  %317 = load <64 x i16>, <64 x i16>* %316, align 2, !tbaa !100
  %318 = add nsw i32 %313, %228
  %319 = getelementptr inbounds i16, i16* %52, i32 %318
  %320 = bitcast i16* %319 to <64 x i16>*
  %321 = load <64 x i16>, <64 x i16>* %320, align 2, !tbaa !100
  %322 = add nsw i32 %313, %231
  %323 = getelementptr inbounds i16, i16* %54, i32 %322
  %324 = bitcast i16* %323 to <64 x i16>*
  %325 = load <64 x i16>, <64 x i16>* %324, align 2, !tbaa !100
  %326 = add <64 x i16> %321, %317
  %327 = add <64 x i16> %326, %325
  %328 = bitcast <64 x i16> %327 to <32 x i32>
  %329 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %328, i32 -1431590229) #12
  ...
  %332 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %331, <32 x i32> %330) #12
  %333 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %332, i32 1) #12
...
"for blur_y.s0.x.x.epil":                         ; preds = %"end for blur_y.s0.x.x.loopexit.unr-lcssa", %"for blur_y.s0.x.x.epil"
  ...
  %342 = bitcast i16* %341 to <64 x i16>*
  %343 = load <64 x i16>, <64 x i16>* %342, align 2, !tbaa !100
  %344 = add nsw i32 %339, %228
  %345 = getelementptr inbounds i16, i16* %52, i32 %344
  %346 = bitcast i16* %345 to <64 x i16>*
  %347 = load <64 x i16>, <64 x i16>* %346, align 2, !tbaa !100
  %348 = add nsw i32 %339, %231
  %349 = getelementptr inbounds i16, i16* %54, i32 %348
  %350 = bitcast i16* %349 to <64 x i16>*
  %351 = load <64 x i16>, <64 x i16>* %350, align 2, !tbaa !100
  %352 = add <64 x i16> %347, %343
  %353 = add <64 x i16> %352, %351
  %354 = bitcast <64 x i16> %353 to <32 x i32>
  %355 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %354, i32 -1431590229) #12
  %356 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %355) #12
  %357 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %355) #12
  %358 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %357, <32 x i32> %356) #12
  %359 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %358, i32 1) #12
...
"for blur_y.s0.x.x7.preheader":                   ; preds = %"end for blur_y.s0.x.x"
  ...
  %370 = bitcast i16* %369 to <64 x i16>*
  %371 = load <64 x i16>, <64 x i16>* %370, align 2, !tbaa !100
  %372 = and i32 %364, 3
  %373 = add nuw nsw i32 %372, 1
  %374 = mul nsw i32 %373, %a4
  %375 = getelementptr inbounds i16, i16* %58, i32 %374
  %376 = bitcast i16* %375 to <64 x i16>*
  %377 = load <64 x i16>, <64 x i16>* %376, align 2, !tbaa !100
  ...
  %384 = load <64 x i16>, <64 x i16>* %383, align 2, !tbaa !100
  %385 = add <64 x i16> %377, %371
  %386 = add <64 x i16> %385, %384
  %387 = bitcast <64 x i16> %386 to <32 x i32>
  %388 = tail call <64 x i32> @llvm.hexagon.V6.vmpyuh.128B(<32 x i32> %387, i32 -1431590229) #12
  %389 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %388) #12
  %390 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %388) #12
  %391 = tail call <32 x i32> @llvm.hexagon.V6.vshufoh.128B(<32 x i32> %390, <32 x i32> %389) #12
  %392 = tail call <32 x i32> @llvm.hexagon.V6.vlsrh.128B(<32 x i32> %391, i32 1) #12
