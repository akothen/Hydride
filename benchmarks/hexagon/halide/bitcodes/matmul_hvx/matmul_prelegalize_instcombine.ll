; ModuleID = 'matmul_prelegalize.ll'
...
; Function Attrs: nounwind readnone
declare <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32>, <32 x i32>) #10
...
; Function Attrs: nounwind
define i32 @matmul_hvx_hvx128(%struct.halide_buffer_t* noalias nocapture readonly %A.buffer, %struct.halide_buffer_t* noalias nocapture readonly %B.buffer, %struct.halide_buffer_t* noalias nocapture readonly %res.buffer) local_unnamed_addr #11 {
entry:
...
"for res.s0.y":                                   ; preds = %"end for res.s0.x.x", %entry
...
"for res.s0.x.x":                                 ; preds = %"consume matrix_mul", %"for res.s0.y"
  %res.s0.x.x = phi i32 [ 0, %"for res.s0.y" ], [ %58, %"consume matrix_mul" ]
...
"for matrix_mul.s1.r8$x":                         ; preds = %"for matrix_mul.s1.r8$x", %"for res.s0.x.x"
  %matrix_mul2.sroa.4.0 = phi <32 x i32> [ %19, %"for res.s0.x.x" ], [ %51, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul2.sroa.0.0 = phi <32 x i32> [ %18, %"for res.s0.x.x" ], [ %50, %"for matrix_mul.s1.r8$x" ]
  %"matrix_mul.s1.r8$x" = phi i32 [ 0, %"for res.s0.x.x" ], [ %52, %"for matrix_mul.s1.r8$x" ]
  ...
  %38 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<64 x i32> %28, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %39 = tail call <64 x i32> @llvm.hydride.hexagon_V6_vsb_128B_dsl(<64 x i16> %32, i32 1024, i32 1024, i32 0, i32 512, i32 16, i32 0, i32 512, i32 16, i32 32, i32 1, i32 0, i32 32, i32 1024, i32 0, i32 16, i32 2, i32 0) #12
  %40 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<64 x i32> %39, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %41 = tail call <64 x i32> @llvm.hydride.hexagon_V6_vsb_128B_dsl(<64 x i16> %37, i32 1024, i32 1024, i32 0, i32 512, i32 16, i32 0, i32 512, i32 16, i32 32, i32 1, i32 0, i32 32, i32 1024, i32 0, i32 16, i32 2, i32 0) #12
  %42 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<64 x i32> %41, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %43 = tail call <32 x i32> @llvm.hydride.hexagon_V6_vdmpyhvsat_acc_128B_dsl(<128 x i8> %38, <128 x i8> %40, <128 x i8> %42, i32 1024, i32 32, i32 0, i32 32, i32 16, i32 1, i32 1, i32 1, i32 0) #12
  %44 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<64 x i32> %28, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #12
  %45 = tail call <64 x i32> @llvm.hydride.hexagon_V6_vsb_128B_dsl(<64 x i16> %32, i32 1024, i32 1024, i32 0, i32 512, i32 16, i32 0, i32 512, i32 16, i32 32, i32 1, i32 0, i32 32, i32 1024, i32 0, i32 16, i32 2, i32 0) #12
  %46 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<64 x i32> %45, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #12
  %47 = tail call <32 x i32> @llvm.hydride.hexagon_V6_vdmpyhvsat_acc_128B_dsl.1(<128 x i8> %44, <64 x i16> %37, <128 x i8> %46, i32 1024, i32 32, i32 0, i32 32, i32 16, i32 1, i32 1, i32 1, i32 0) #12
  %48 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<32 x i32> %43, <32 x i32> %47, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #12
  %49 = bitcast <256 x i8> %48 to <64 x i32>
  %50 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %49)
  %51 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %49)
  %52 = add nuw nsw i32 %"matrix_mul.s1.r8$x", 1
  %.not = icmp eq i32 %52, 1024
...
"consume matrix_mul":                             ; preds = %"for matrix_mul.s1.r8$x"
  ...
  %54 = getelementptr inbounds i32, i32* %13, i32 %53
  %55 = bitcast i32* %54 to <32 x i32>*
  store <32 x i32> %50, <32 x i32>* %55, align 4, !tbaa !100
  %56 = getelementptr inbounds i32, i32* %54, i32 32
  %57 = bitcast i32* %56 to <32 x i32>*
  store <32 x i32> %51, <32 x i32>* %57, align 4, !tbaa !100
  %58 = add nuw nsw i32 %res.s0.x.x, 1
  %.not3 = icmp eq i32 %58, 16
  br i1 %.not3, label %"end for res.s0.x.x", label %"for res.s0.x.x"
}

; Function Attrs: nounwind
define i32 @matmul_hvx_hvx128_argv(i8** nocapture readonly %0) local_unnamed_addr #12 {
entry:
...
define nonnull %struct.halide_filter_metadata_t* @matmul_hvx_hvx128_metadata() local_unnamed_addr #13 {
entry:
  ret %struct.halide_filter_metadata_t* @matmul_hvx_hvx128_metadata_storage
}

define <256 x i8> @hydride.node.matmul_hvx_hvx_depth5.0(<64 x i32> %arg, <64 x i16> %arg.1, <64 x i16> %arg.2, <64 x i16> %arg.3, <64 x i16> %arg.4) local_unnamed_addr {
entry:
  %0 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<64 x i32> %arg, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %1 = tail call <64 x i32> @llvm.hydride.hexagon_V6_vsb_128B_dsl(<64 x i16> %arg.1, i32 1024, i32 1024, i32 0, i32 512, i32 16, i32 0, i32 512, i32 16, i32 32, i32 1, i32 0, i32 32, i32 1024, i32 0, i32 16, i32 2, i32 0)
  %2 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<64 x i32> %1, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %3 = tail call <64 x i32> @llvm.hydride.hexagon_V6_vsb_128B_dsl(<64 x i16> %arg.2, i32 1024, i32 1024, i32 0, i32 512, i32 16, i32 0, i32 512, i32 16, i32 32, i32 1, i32 0, i32 32, i32 1024, i32 0, i32 16, i32 2, i32 0)
  %4 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<64 x i32> %3, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  %5 = tail call <32 x i32> @llvm.hydride.hexagon_V6_vdmpyhvsat_acc_128B_dsl(<128 x i8> %0, <128 x i8> %2, <128 x i8> %4, i32 1024, i32 32, i32 0, i32 32, i32 16, i32 1, i32 1, i32 1, i32 0)
  %6 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<64 x i32> %arg, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %7 = tail call <64 x i32> @llvm.hydride.hexagon_V6_vsb_128B_dsl(<64 x i16> %arg.3, i32 1024, i32 1024, i32 0, i32 512, i32 16, i32 0, i32 512, i32 16, i32 32, i32 1, i32 0, i32 32, i32 1024, i32 0, i32 16, i32 2, i32 0)
  %8 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<64 x i32> %7, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0)
  %9 = tail call <32 x i32> @llvm.hydride.hexagon_V6_vdmpyhvsat_acc_128B_dsl.1(<128 x i8> %6, <64 x i16> %arg.4, <128 x i8> %8, i32 1024, i32 32, i32 0, i32 32, i32 16, i32 1, i32 1, i32 1, i32 0)
  %10 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<32 x i32> %5, <32 x i32> %9, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0)
  ret <256 x i8> %10
}

declare <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<64 x i32>, i32, i32, i32, i32, i32, i32, i32)

declare <64 x i32> @llvm.hydride.hexagon_V6_vsb_128B_dsl(<64 x i16>, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32)

declare <32 x i32> @llvm.hydride.hexagon_V6_vdmpyhvsat_acc_128B_dsl(<128 x i8>, <128 x i8>, <128 x i8>, i32, i32, i32, i32, i32, i32, i32, i32, i32)

declare <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<64 x i32>, i32, i32, i32, i32, i32, i32)

declare <32 x i32> @llvm.hydride.hexagon_V6_vdmpyhvsat_acc_128B_dsl.1(<128 x i8>, <64 x i16>, <128 x i8>, i32, i32, i32, i32, i32, i32, i32, i32, i32)
