...
"for matrix_mul.s1.r8$x":                         ; preds = %"for res.s0.x.x", %"for matrix_mul.s1.r8$x"
  ...
  %38 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<64 x i32> %28, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #11
  %39 = tail call <64 x i32> @llvm.hydride.hexagon_V6_vsb_128B_dsl(<64 x i16> %32, i32 1024, i32 1024, i32 0, i32 512, i32 16, i32 0, i32 512, i32 16, i32 32, i32 1, i32 0, i32 32, i32 1024, i32 0, i32 16, i32 2, i32 0) #11
  %40 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<64 x i32> %39, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #11
  %41 = tail call <64 x i32> @llvm.hydride.hexagon_V6_vsb_128B_dsl(<64 x i16> %37, i32 1024, i32 1024, i32 0, i32 512, i32 16, i32 0, i32 512, i32 16, i32 32, i32 1, i32 0, i32 32, i32 1024, i32 0, i32 16, i32 2, i32 0) #11
  %42 = tail call <128 x i8> @llvm.hydride.hexagon_V6_lo_128B_dsl(<64 x i32> %41, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 1024, i32 0) #11
  %43 = tail call <32 x i32> @llvm.hydride.hexagon_V6_vdmpyhvsat_acc_128B_dsl(<128 x i8> %38, <128 x i8> %40, <128 x i8> %42, i32 1024, i32 32, i32 0, i32 32, i32 16, i32 1, i32 1, i32 1, i32 0) #11
  %44 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<64 x i32> %28, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #11
  %45 = tail call <64 x i32> @llvm.hydride.hexagon_V6_vsb_128B_dsl(<64 x i16> %32, i32 1024, i32 1024, i32 0, i32 512, i32 16, i32 0, i32 512, i32 16, i32 32, i32 1, i32 0, i32 32, i32 1024, i32 0, i32 16, i32 2, i32 0) #11
  %46 = tail call <128 x i8> @llvm.hydride.hexagon_V6_vassign_128B_dsl(<64 x i32> %45, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0) #11
  %47 = tail call <32 x i32> @llvm.hydride.hexagon_V6_vdmpyhvsat_acc_128B_dsl.1(<128 x i8> %44, <64 x i16> %37, <128 x i8> %46, i32 1024, i32 32, i32 0, i32 32, i32 16, i32 1, i32 1, i32 1, i32 0) #11
  %48 = tail call <256 x i8> @llvm.hydride.hexagon_V6_vcombine_128B_dsl(<32 x i32> %43, <32 x i32> %47, i32 1024, i32 1024, i32 0, i32 1024, i32 8, i32 0, i32 1024, i32 8, i32 1024, i32 0) #11
