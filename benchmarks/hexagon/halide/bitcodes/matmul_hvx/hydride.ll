...
"for res.s0.x.x":                                 ; preds = %"for res.s0.y", %"consume matrix_mul"
  %res.s0.x.x = phi i32 [ 0, %"for res.s0.y" ], [ %129, %"consume matrix_mul" ]
...
"for matrix_mul.s1.r8$x":                         ; preds = %"for matrix_mul.s1.r8$x", %"for res.s0.x.x"
  %matrix_mul2.sroa.4.0 = phi <32 x i32> [ %19, %"for res.s0.x.x" ], [ %122, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul2.sroa.0.0 = phi <32 x i32> [ %18, %"for res.s0.x.x" ], [ %121, %"for matrix_mul.s1.r8$x" ]
  %"matrix_mul.s1.r8$x" = phi i32 [ 0, %"for res.s0.x.x" ], [ %123, %"for matrix_mul.s1.r8$x" ]
  ...
  %31 = bitcast i16* %30 to <32 x i32>*
  %32 = load <32 x i32>, <32 x i32>* %31, align 2, !tbaa !95
  %33 = add nsw i32 %25, %"matrix_mul.s1.r8$x"
  %34 = getelementptr inbounds i16, i16* %1, i32 %33
  %35 = load i16, i16* %34, align 2, !tbaa !98
  %36 = insertelement <64 x i16> undef, i16 %35, i32 0
  %37 = shufflevector <64 x i16> %36, <64 x i16> undef, <64 x i32> zeroinitializer
  %38 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %28) #11
  %39 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %32) #11
  %40 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %39) #11
  %41 = bitcast <64 x i16> %37 to <32 x i32>
  %42 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %41) #11
  %43 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %42) #11
  %44 = tail call <32 x i32> @llvm.hexagon.V6.vdmpyhvsat.acc.128B(<32 x i32> %38, <32 x i32> %40, <32 x i32> %43) #11
  %45 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %28) #11
  %46 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %42) #11
  %47 = tail call <32 x i32> @llvm.hexagon.V6.vdmpyhvsat.acc.128B(<32 x i32> %45, <32 x i32> %32, <32 x i32> %46) #11
  %48 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %44, <32 x i32> %47) #11
  %49 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %48)
  %50 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %48)
  %51 = or i32 %"matrix_mul.s1.r8$x", 1
  %52 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %50, <32 x i32> %49)
  %reass.add.1 = sub i32 %51, %10
  %reass.mul.1 = mul i32 %reass.add.1, %11
  %53 = add i32 %t18, %reass.mul.1
  %54 = getelementptr inbounds i16, i16* %7, i32 %53
  %55 = bitcast i16* %54 to <32 x i32>*
  %56 = load <32 x i32>, <32 x i32>* %55, align 2, !tbaa !95
  %57 = add nsw i32 %25, %51
  %58 = getelementptr inbounds i16, i16* %1, i32 %57
  %59 = load i16, i16* %58, align 2, !tbaa !98
  %60 = insertelement <64 x i16> undef, i16 %59, i32 0
  %61 = shufflevector <64 x i16> %60, <64 x i16> undef, <64 x i32> zeroinitializer
  %62 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %52) #11
  %63 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %56) #11
  %64 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %63) #11
  %65 = bitcast <64 x i16> %61 to <32 x i32>
  %66 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %65) #11
  %67 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %66) #11
  %68 = tail call <32 x i32> @llvm.hexagon.V6.vdmpyhvsat.acc.128B(<32 x i32> %62, <32 x i32> %64, <32 x i32> %67) #11
  %69 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %52) #11
  %70 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %66) #11
  %71 = tail call <32 x i32> @llvm.hexagon.V6.vdmpyhvsat.acc.128B(<32 x i32> %69, <32 x i32> %56, <32 x i32> %70) #11
  %72 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %68, <32 x i32> %71) #11
  %73 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %72)
  %74 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %72)
  %75 = or i32 %"matrix_mul.s1.r8$x", 2
  %76 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %74, <32 x i32> %73)
  %reass.add.2 = sub i32 %75, %10
  %reass.mul.2 = mul i32 %reass.add.2, %11
  %77 = add i32 %t18, %reass.mul.2
  %78 = getelementptr inbounds i16, i16* %7, i32 %77
  %79 = bitcast i16* %78 to <32 x i32>*
  %80 = load <32 x i32>, <32 x i32>* %79, align 2, !tbaa !95
  %81 = add nsw i32 %25, %75
  %82 = getelementptr inbounds i16, i16* %1, i32 %81
  %83 = load i16, i16* %82, align 2, !tbaa !98
  %84 = insertelement <64 x i16> undef, i16 %83, i32 0
  %85 = shufflevector <64 x i16> %84, <64 x i16> undef, <64 x i32> zeroinitializer
  %86 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %76) #11
  %87 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %80) #11
  %88 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %87) #11
  %89 = bitcast <64 x i16> %85 to <32 x i32>
  %90 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %89) #11
  %91 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %90) #11
  %92 = tail call <32 x i32> @llvm.hexagon.V6.vdmpyhvsat.acc.128B(<32 x i32> %86, <32 x i32> %88, <32 x i32> %91) #11
  %93 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %76) #11
  %94 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %90) #11
  %95 = tail call <32 x i32> @llvm.hexagon.V6.vdmpyhvsat.acc.128B(<32 x i32> %93, <32 x i32> %80, <32 x i32> %94) #11
  %96 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %92, <32 x i32> %95) #11
  %97 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %96)
  %98 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %96)
  %99 = or i32 %"matrix_mul.s1.r8$x", 3
  %100 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %98, <32 x i32> %97)
  %reass.add.3 = sub i32 %99, %10
  %reass.mul.3 = mul i32 %reass.add.3, %11
  %101 = add i32 %t18, %reass.mul.3
  %102 = getelementptr inbounds i16, i16* %7, i32 %101
  %103 = bitcast i16* %102 to <32 x i32>*
  %104 = load <32 x i32>, <32 x i32>* %103, align 2, !tbaa !95
  %105 = add nsw i32 %25, %99
  %106 = getelementptr inbounds i16, i16* %1, i32 %105
  %107 = load i16, i16* %106, align 2, !tbaa !98
  %108 = insertelement <64 x i16> undef, i16 %107, i32 0
  %109 = shufflevector <64 x i16> %108, <64 x i16> undef, <64 x i32> zeroinitializer
  %110 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %100) #11
  %111 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %104) #11
  %112 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %111) #11
  %113 = bitcast <64 x i16> %109 to <32 x i32>
  %114 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %113) #11
  %115 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %114) #11
  %116 = tail call <32 x i32> @llvm.hexagon.V6.vdmpyhvsat.acc.128B(<32 x i32> %110, <32 x i32> %112, <32 x i32> %115) #11
  %117 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %100) #11
  %118 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %114) #11
  %119 = tail call <32 x i32> @llvm.hexagon.V6.vdmpyhvsat.acc.128B(<32 x i32> %117, <32 x i32> %104, <32 x i32> %118) #11
  %120 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %116, <32 x i32> %119) #11
  %121 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %120)
  %122 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %120)
  %123 = add nuw nsw i32 %"matrix_mul.s1.r8$x", 4
  %.not.3 = icmp eq i32 %123, 1024
  br i1 %.not.3, label %"consume matrix_mul", label %"for matrix_mul.s1.r8$x"

"consume matrix_mul":                             ; preds = %"for matrix_mul.s1.r8$x"
  %124 = add nsw i32 %22, %26
  %125 = getelementptr inbounds i32, i32* %13, i32 %124
  %126 = bitcast i32* %125 to <32 x i32>*
  store <32 x i32> %121, <32 x i32>* %126, align 4, !tbaa !100
  %127 = getelementptr inbounds i32, i32* %125, i32 32
  %128 = bitcast i32* %127 to <32 x i32>*
  store <32 x i32> %122, <32 x i32>* %128, align 4, !tbaa !100
  %129 = add nuw nsw i32 %res.s0.x.x, 1
  %.not3 = icmp eq i32 %129, 16
...
entry:
  ...
  %9 = tail call i32 @matmul_hvx_hvx128(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5, %struct.halide_buffer_t* %8) #16
  ret i32 0
}
...
define <256 x i8> @hydride.node.matmul_hvx_hvx_depth5.0(<64 x i32> %arg, <64 x i16> %arg.1, <64 x i16> %arg.2, <64 x i16> %arg.3, <64 x i16> %arg.4) local_unnamed_addr #13 {
entry:
...
; Function Attrs: nounwind readnone
declare <32 x i32> @llvm.hexagon.V6.vdmpyhvsat.acc.128B(<32 x i32>, <32 x i32>, <32 x i32>) #9
