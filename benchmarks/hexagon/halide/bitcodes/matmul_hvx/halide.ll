...
@5 = private constant i64 1024
@6 = private constant [4 x i64*] [i64* @2, i64* @3, i64* @4, i64* @5]
@str.103 = private constant [4 x i8] c"res\00", align 32
@7 = private constant [3 x %struct.halide_filter_argument_t] [%struct.halide_filter_argument_t { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str, i32 0, i32 0), i32 1, i32 2, %struct.halide_type_t { i8 0, i8 16, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** getelementptr inbounds ([4 x i64*], [4 x i64*]* @0, i32 0, i32 0) }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.102, i32 0, i32 0), i32 1, i32 2, %struct.halide_type_t { i8 0, i8 16, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** getelementptr inbounds ([4 x i64*], [4 x i64*]* @1, i32 0, i32 0) }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.103, i32 0, i32 0), i32 2, i32 2, %struct.halide_type_t { i8 0, i8 32, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** getelementptr inbounds ([4 x i64*], [4 x i64*]* @6, i32 0, i32 0) }]
@str.104 = private constant [63 x i8] c"hexagon-32-noos-hvx-hvx_128-hvx_v66-no_asserts-no_bounds_query\00", align 128
@str.105 = private constant [18 x i8] c"matmul_hvx_hvx128\00", align 32
@matmul_hvx_hvx128_metadata_storage = private constant %struct.halide_filter_metadata_t { i32 1, i32 3, %struct.halide_filter_argument_t* getelementptr inbounds ([3 x %struct.halide_filter_argument_t], [3 x %struct.halide_filter_argument_t]* @7, i32 0, i32 0), i8* getelementptr inbounds ([63 x i8], [63 x i8]* @str.104, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @str.105, i32 0, i32 0) }
...
; Function Attrs: nounwind
define i32 @matmul_hvx_hvx128(%struct.halide_buffer_t* noalias nocapture readonly %A.buffer, %struct.halide_buffer_t* noalias nocapture readonly %B.buffer, %struct.halide_buffer_t* noalias nocapture readonly %res.buffer) local_unnamed_addr #10 {
entry:
  ...
  %3 = load i32, i32* %min.i, align 4, !tbaa !47
  %min.i7 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %2, i32 1, i32 0
  %4 = load i32, i32* %min.i7, align 4, !tbaa !47
  %stride.i9 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %2, i32 1, i32 2
  %5 = load i32, i32* %stride.i9, align 4, !tbaa !50
  %host.i10 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %B.buffer, i32 0, i32 2
  %6 = bitcast i8** %host.i10 to i16**
  %7 = load i16*, i16** %6, align 4, !tbaa !43
  %dim.i11 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %B.buffer, i32 0, i32 6
  %8 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %dim.i11, align 8, !tbaa !46
  %min.i12 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %8, i32 0, i32 0
  %9 = load i32, i32* %min.i12, align 4, !tbaa !47
  %min.i16 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %8, i32 1, i32 0
  %10 = load i32, i32* %min.i16, align 4, !tbaa !47
  %stride.i18 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %8, i32 1, i32 2
  %11 = load i32, i32* %stride.i18, align 4, !tbaa !50
  %host.i19 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %res.buffer, i32 0, i32 2
  %12 = bitcast i8** %host.i19 to i32**
  %13 = load i32*, i32** %12, align 4, !tbaa !43
  %dim.i20 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %res.buffer, i32 0, i32 6
  %14 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %dim.i20, align 8, !tbaa !46
  %min.i21 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %14, i32 0, i32 0
  %15 = load i32, i32* %min.i21, align 4, !tbaa !47
  %min.i25 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %14, i32 1, i32 0
  %16 = load i32, i32* %min.i25, align 4, !tbaa !47
  %stride.i27 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %14, i32 1, i32 2
  %17 = load i32, i32* %stride.i27, align 4, !tbaa !50
  %18 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> zeroinitializer)
  %19 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> zeroinitializer)
  br label %"for res.s0.y"

"for res.s0.y":                                   ; preds = %entry, %"end for res.s0.x.x"
  %res.s0.y = phi i32 [ 0, %entry ], [ %27, %"end for res.s0.x.x" ]
  %20 = sub nsw i32 %res.s0.y, %16
  %21 = mul nsw i32 %20, %17
  %22 = sub i32 %21, %15
  %23 = sub nsw i32 %res.s0.y, %4
  %24 = mul nsw i32 %23, %5
  %25 = sub i32 %24, %3
  br label %"for res.s0.x.x"

call_destructor.exit:                             ; preds = %"end for res.s0.x.x"
  tail call void @halide_qurt_hvx_unlock_as_destructor(i8* null, i8* nonnull inttoptr (i32 1 to i8*)) #13
  ret i32 0

"for res.s0.x.x":                                 ; preds = %"for res.s0.y", %"consume matrix_mul"
  %res.s0.x.x = phi i32 [ 0, %"for res.s0.y" ], [ %117, %"consume matrix_mul" ]
  %26 = shl nsw i32 %res.s0.x.x, 6
  %t18 = sub i32 %26, %9
  br label %"for matrix_mul.s1.r8$x"

"end for res.s0.x.x":                             ; preds = %"consume matrix_mul"
  %27 = add nuw nsw i32 %res.s0.y, 1
  %.not4 = icmp eq i32 %27, 1024
  br i1 %.not4, label %call_destructor.exit, label %"for res.s0.y"

"for matrix_mul.s1.r8$x":                         ; preds = %"for matrix_mul.s1.r8$x", %"for res.s0.x.x"
  %matrix_mul2.sroa.4.0 = phi <32 x i32> [ %19, %"for res.s0.x.x" ], [ %110, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul2.sroa.0.0 = phi <32 x i32> [ %18, %"for res.s0.x.x" ], [ %109, %"for matrix_mul.s1.r8$x" ]
  %"matrix_mul.s1.r8$x" = phi i32 [ 0, %"for res.s0.x.x" ], [ %111, %"for matrix_mul.s1.r8$x" ]
  %28 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %matrix_mul2.sroa.4.0, <32 x i32> %matrix_mul2.sroa.0.0)
  %reass.add = sub i32 %"matrix_mul.s1.r8$x", %10
  %reass.mul = mul i32 %reass.add, %11
  %29 = add i32 %t18, %reass.mul
  %30 = getelementptr inbounds i16, i16* %7, i32 %29
  %31 = bitcast i16* %30 to <64 x i16>*
  %32 = load <64 x i16>, <64 x i16>* %31, align 2, !tbaa !95
  %33 = sext <64 x i16> %32 to <64 x i32>
  %34 = add nsw i32 %25, %"matrix_mul.s1.r8$x"
  %35 = getelementptr inbounds i16, i16* %1, i32 %34
  %36 = load i16, i16* %35, align 2, !tbaa !98
  %37 = insertelement <64 x i16> undef, i16 %36, i32 0
  %38 = shufflevector <64 x i16> %37, <64 x i16> undef, <64 x i32> zeroinitializer
  %39 = sext <64 x i16> %38 to <64 x i32>
  %40 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %33)
  %41 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %39)
  %ab1.i = tail call <32 x i32> @llvm.hexagon.V6.vmpyieoh.128B(<32 x i32> %40, <32 x i32> %41) #11
  %ab.i = tail call <32 x i32> @llvm.hexagon.V6.vmpyiewuh.acc.128B(<32 x i32> %ab1.i, <32 x i32> %40, <32 x i32> %41) #11
  %42 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %33)
  %43 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %39)
  %ab1.i28 = tail call <32 x i32> @llvm.hexagon.V6.vmpyieoh.128B(<32 x i32> %42, <32 x i32> %43) #11
  %ab.i29 = tail call <32 x i32> @llvm.hexagon.V6.vmpyiewuh.acc.128B(<32 x i32> %ab1.i28, <32 x i32> %42, <32 x i32> %43) #11
  %44 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %ab.i29, <32 x i32> %ab.i)
  %45 = tail call <64 x i32> @llvm.hexagon.V6.vaddwsat.dv.128B(<64 x i32> %28, <64 x i32> %44) #11
  %46 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %45)
  %47 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %45)
  %48 = or i32 %"matrix_mul.s1.r8$x", 1
  %49 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %47, <32 x i32> %46)
  %reass.add.1 = sub i32 %48, %10
  %reass.mul.1 = mul i32 %reass.add.1, %11
  %50 = add i32 %t18, %reass.mul.1
  %51 = getelementptr inbounds i16, i16* %7, i32 %50
  %52 = bitcast i16* %51 to <64 x i16>*
  %53 = load <64 x i16>, <64 x i16>* %52, align 2, !tbaa !95
  %54 = sext <64 x i16> %53 to <64 x i32>
  %55 = add nsw i32 %25, %48
  %56 = getelementptr inbounds i16, i16* %1, i32 %55
  %57 = load i16, i16* %56, align 2, !tbaa !98
  %58 = insertelement <64 x i16> undef, i16 %57, i32 0
  %59 = shufflevector <64 x i16> %58, <64 x i16> undef, <64 x i32> zeroinitializer
  %60 = sext <64 x i16> %59 to <64 x i32>
  %61 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %54)
  %62 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %60)
  %ab1.i.1 = tail call <32 x i32> @llvm.hexagon.V6.vmpyieoh.128B(<32 x i32> %61, <32 x i32> %62) #11
  %ab.i.1 = tail call <32 x i32> @llvm.hexagon.V6.vmpyiewuh.acc.128B(<32 x i32> %ab1.i.1, <32 x i32> %61, <32 x i32> %62) #11
  %63 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %54)
  %64 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %60)
  %ab1.i28.1 = tail call <32 x i32> @llvm.hexagon.V6.vmpyieoh.128B(<32 x i32> %63, <32 x i32> %64) #11
  %ab.i29.1 = tail call <32 x i32> @llvm.hexagon.V6.vmpyiewuh.acc.128B(<32 x i32> %ab1.i28.1, <32 x i32> %63, <32 x i32> %64) #11
  %65 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %ab.i29.1, <32 x i32> %ab.i.1)
  %66 = tail call <64 x i32> @llvm.hexagon.V6.vaddwsat.dv.128B(<64 x i32> %49, <64 x i32> %65) #11
  %67 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %66)
  %68 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %66)
  %69 = or i32 %"matrix_mul.s1.r8$x", 2
  %70 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %68, <32 x i32> %67)
  %reass.add.2 = sub i32 %69, %10
  %reass.mul.2 = mul i32 %reass.add.2, %11
  %71 = add i32 %t18, %reass.mul.2
  %72 = getelementptr inbounds i16, i16* %7, i32 %71
  %73 = bitcast i16* %72 to <64 x i16>*
  %74 = load <64 x i16>, <64 x i16>* %73, align 2, !tbaa !95
  %75 = sext <64 x i16> %74 to <64 x i32>
  %76 = add nsw i32 %25, %69
  %77 = getelementptr inbounds i16, i16* %1, i32 %76
  %78 = load i16, i16* %77, align 2, !tbaa !98
  %79 = insertelement <64 x i16> undef, i16 %78, i32 0
  %80 = shufflevector <64 x i16> %79, <64 x i16> undef, <64 x i32> zeroinitializer
  %81 = sext <64 x i16> %80 to <64 x i32>
  %82 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %75)
  %83 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %81)
  %ab1.i.2 = tail call <32 x i32> @llvm.hexagon.V6.vmpyieoh.128B(<32 x i32> %82, <32 x i32> %83) #11
  %ab.i.2 = tail call <32 x i32> @llvm.hexagon.V6.vmpyiewuh.acc.128B(<32 x i32> %ab1.i.2, <32 x i32> %82, <32 x i32> %83) #11
  %84 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %75)
  %85 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %81)
  %ab1.i28.2 = tail call <32 x i32> @llvm.hexagon.V6.vmpyieoh.128B(<32 x i32> %84, <32 x i32> %85) #11
  %ab.i29.2 = tail call <32 x i32> @llvm.hexagon.V6.vmpyiewuh.acc.128B(<32 x i32> %ab1.i28.2, <32 x i32> %84, <32 x i32> %85) #11
  %86 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %ab.i29.2, <32 x i32> %ab.i.2)
  %87 = tail call <64 x i32> @llvm.hexagon.V6.vaddwsat.dv.128B(<64 x i32> %70, <64 x i32> %86) #11
  %88 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %87)
  %89 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %87)
  %90 = or i32 %"matrix_mul.s1.r8$x", 3
  %91 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %89, <32 x i32> %88)
  %reass.add.3 = sub i32 %90, %10
  %reass.mul.3 = mul i32 %reass.add.3, %11
  %92 = add i32 %t18, %reass.mul.3
  %93 = getelementptr inbounds i16, i16* %7, i32 %92
  %94 = bitcast i16* %93 to <64 x i16>*
  %95 = load <64 x i16>, <64 x i16>* %94, align 2, !tbaa !95
  %96 = sext <64 x i16> %95 to <64 x i32>
  %97 = add nsw i32 %25, %90
  %98 = getelementptr inbounds i16, i16* %1, i32 %97
  %99 = load i16, i16* %98, align 2, !tbaa !98
  %100 = insertelement <64 x i16> undef, i16 %99, i32 0
  %101 = shufflevector <64 x i16> %100, <64 x i16> undef, <64 x i32> zeroinitializer
  %102 = sext <64 x i16> %101 to <64 x i32>
  %103 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %96)
  %104 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %102)
  %ab1.i.3 = tail call <32 x i32> @llvm.hexagon.V6.vmpyieoh.128B(<32 x i32> %103, <32 x i32> %104) #11
  %ab.i.3 = tail call <32 x i32> @llvm.hexagon.V6.vmpyiewuh.acc.128B(<32 x i32> %ab1.i.3, <32 x i32> %103, <32 x i32> %104) #11
  %105 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %96)
  %106 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %102)
  %ab1.i28.3 = tail call <32 x i32> @llvm.hexagon.V6.vmpyieoh.128B(<32 x i32> %105, <32 x i32> %106) #11
  %ab.i29.3 = tail call <32 x i32> @llvm.hexagon.V6.vmpyiewuh.acc.128B(<32 x i32> %ab1.i28.3, <32 x i32> %105, <32 x i32> %106) #11
  %107 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %ab.i29.3, <32 x i32> %ab.i.3)
  %108 = tail call <64 x i32> @llvm.hexagon.V6.vaddwsat.dv.128B(<64 x i32> %91, <64 x i32> %107) #11
  %109 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %108)
  %110 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %108)
  %111 = add nuw nsw i32 %"matrix_mul.s1.r8$x", 4
  %.not.3 = icmp eq i32 %111, 1024
  br i1 %.not.3, label %"consume matrix_mul", label %"for matrix_mul.s1.r8$x"

"consume matrix_mul":                             ; preds = %"for matrix_mul.s1.r8$x"
  %112 = add nsw i32 %22, %26
  %113 = getelementptr inbounds i32, i32* %13, i32 %112
  %114 = bitcast i32* %113 to <32 x i32>*
  store <32 x i32> %109, <32 x i32>* %114, align 4, !tbaa !100
  %115 = getelementptr inbounds i32, i32* %113, i32 32
  %116 = bitcast i32* %115 to <32 x i32>*
  store <32 x i32> %110, <32 x i32>* %116, align 4, !tbaa !100
  %117 = add nuw nsw i32 %res.s0.x.x, 1
  %.not3 = icmp eq i32 %117, 16
  br i1 %.not3, label %"end for res.s0.x.x", label %"for res.s0.x.x"
}

; Function Attrs: nounwind
define i32 @matmul_hvx_hvx128_argv(i8** nocapture readonly %0) local_unnamed_addr #11 {
entry:
  ...
  %9 = tail call i32 @matmul_hvx_hvx128(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5, %struct.halide_buffer_t* %8) #15
  ret i32 0
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @matmul_hvx_hvx128_metadata() local_unnamed_addr #12 {
entry:
  ret %struct.halide_filter_metadata_t* @matmul_hvx_hvx128_metadata_storage
}
