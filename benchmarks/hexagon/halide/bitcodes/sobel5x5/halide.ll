...
; Function Attrs: nounwind readnone
declare <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32>, i32) #9
...
entry:
  ...
  %t474 = select i1 %41, i32 %a11, i32 0
  %42 = shl i32 %t474, 10
  %43 = or i32 %42, 131
  ...
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  %xtraiter46 = and i32 %t343, 1
  %66 = icmp eq i32 %t343, 1
  %unroll_iter48 = and i32 %t343, -2
  %lcmp.mod47.not = icmp eq i32 %xtraiter46, 0
  %xtraiter50 = and i32 %61, 7
  %67 = icmp ult i32 %63, 7
  %unroll_iter52 = and i32 %61, -8
  %lcmp.mod51.not = icmp eq i32 %xtraiter50, 0
  %xtraiter54 = and i32 %64, 1
  %68 = icmp eq i32 %60, %t338
  %unroll_iter56 = and i32 %64, -2
  %lcmp.mod55.not = icmp eq i32 %xtraiter54, 0
  %xtraiter58 = and i32 %t342, 1
  %69 = icmp eq i32 %t342, 1
  %unroll_iter60 = and i32 %t342, -2
  %lcmp.mod59.not = icmp eq i32 %xtraiter58, 0
  br label %"for output.s0.y.y.y"

"for output.s0.y.y.y":                            ; preds = %entry, %call_destructor.exit34
  %output.s0.y.y.y = phi i32 [ 0, %entry ], [ %758, %call_destructor.exit34 ]
...
call_destructor.exit:                             ; preds = %call_destructor.exit34
...
"for bounded_input.s0.y.rebased10.us":            ; preds = %"for bounded_input.s0.y.rebased10.preheader", %"end for bounded_input.s0.x.x14.loopexit.us"
  ...
  %.not22.us = icmp sgt i32 %b45, %b43.us
  %a48.us = select i1 %.not22.us, i32 %b43.us, i32 %a41
...
"for bounded_input.s0.x.x13.us":                  ; preds = %"for bounded_input.s0.y.rebased10.us", %"for bounded_input.s0.x.x13.us"
  ...
  %niter61 = phi i32 [ %niter61.nsub.1, %"for bounded_input.s0.x.x13.us" ], [ %unroll_iter60, %"for bounded_input.s0.y.rebased10.us" ]
  ...
  %niter61.nsub.1 = add i32 %niter61, -2
  %niter61.ncmp.1 = icmp eq i32 %niter61.nsub.1, 0
  br i1 %niter61.ncmp.1, label %"end for bounded_input.s0.x.x14.loopexit.us.unr-lcssa", label %"for bounded_input.s0.x.x13.us"
...
"end for bounded_input.s0.x.x14.loopexit.us.unr-lcssa": ; preds = %"for bounded_input.s0.x.x13.us", %"for bounded_input.s0.y.rebased10.us"
  ...
  br i1 %lcmp.mod59.not, label %"end for bounded_input.s0.x.x14.loopexit.us", label %"for bounded_input.s0.x.x13.us.epil"
...
"end for bounded_input.s0.x.x14.loopexit.us":     ; preds = %"end for bounded_input.s0.x.x14.loopexit.us.unr-lcssa", %"for bounded_input.s0.x.x13.us.epil"
  ...
  %.not23.us = icmp eq i32 %bounded_input.s0.y.rebased12.us, %251
  br i1 %.not23.us, label %"consume bounded_input", label %"for bounded_input.s0.y.rebased10.us"
...
"for bounded_input.s0.x.x4":                      ; preds = %"for bounded_input.s0.x.x4.preheader", %"for bounded_input.s0.x.x4"
  ...
  %niter49 = phi i32 [ %niter49.nsub.1, %"for bounded_input.s0.x.x4" ], [ %unroll_iter48, %"for bounded_input.s0.x.x4.preheader" ]
  ...
  %niter49.nsub.1 = add i32 %niter49, -2
  %niter49.ncmp.1 = icmp eq i32 %niter49.nsub.1, 0
  br i1 %niter49.ncmp.1, label %"end for bounded_input.s0.x.x5.loopexit.unr-lcssa", label %"for bounded_input.s0.x.x4"
...
"end for bounded_input.s0.x.x5.loopexit.unr-lcssa": ; preds = %"for bounded_input.s0.x.x4", %"for bounded_input.s0.x.x4.preheader"
  ...
  br i1 %lcmp.mod47.not, label %"end for bounded_input.s0.x.x5", label %"for bounded_input.s0.x.x4.epil"
...
"for bounded_input.s0.x.x.rebased":               ; preds = %"for bounded_input.s0.x.x.rebased.preheader", %"for bounded_input.s0.x.x.rebased"
  ...
  %niter53 = phi i32 [ %niter53.nsub.7, %"for bounded_input.s0.x.x.rebased" ], [ %unroll_iter52, %"for bounded_input.s0.x.x.rebased.preheader" ]
  ...
  %niter53.nsub.7 = add i32 %niter53, -8
  %niter53.ncmp.7 = icmp eq i32 %niter53.nsub.7, 0
  br i1 %niter53.ncmp.7, label %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa", label %"for bounded_input.s0.x.x.rebased"
...
"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa": ; preds = %"for bounded_input.s0.x.x.rebased", %"for bounded_input.s0.x.x.rebased.preheader"
  ...
  br i1 %lcmp.mod51.not, label %"end for bounded_input.s0.x.x.rebased", label %"for bounded_input.s0.x.x.rebased.epil"
...
"for bounded_input.s0.x.x.rebased.epil":          ; preds = %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa", %"for bounded_input.s0.x.x.rebased.epil"
  ...
  %epil.iter = phi i32 [ %epil.iter.sub, %"for bounded_input.s0.x.x.rebased.epil" ], [ %xtraiter50, %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa" ]
...
"for bounded_input.s0.x.x.rebased7":              ; preds = %"for bounded_input.s0.x.x.rebased7.preheader", %"for bounded_input.s0.x.x.rebased7"
  ...
  %niter57 = phi i32 [ %niter57.nsub.1, %"for bounded_input.s0.x.x.rebased7" ], [ %unroll_iter56, %"for bounded_input.s0.x.x.rebased7.preheader" ]
  ...
  %niter57.nsub.1 = add i32 %niter57, -2
  %niter57.ncmp.1 = icmp eq i32 %niter57.nsub.1, 0
  br i1 %niter57.ncmp.1, label %"end for bounded_input.s0.x.x.rebased8.loopexit.unr-lcssa", label %"for bounded_input.s0.x.x.rebased7"
...
"end for bounded_input.s0.x.x.rebased8.loopexit.unr-lcssa": ; preds = %"for bounded_input.s0.x.x.rebased7", %"for bounded_input.s0.x.x.rebased7.preheader"
  ...
  br i1 %lcmp.mod55.not, label %"end for bounded_input.s0.x.x.rebased8", label %"for bounded_input.s0.x.x.rebased7.epil"
...
"for output.s0.x.x.preheader":                    ; preds = %"consume bounded_input"
  %754 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>)
  %755 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>)
  br label %"for output.s0.x.x"

"for output.s0.x.x":                              ; preds = %"for output.s0.x.x.preheader", %"end for output.s0.y.yi"
  %output.s0.x.x = phi i32 [ %1124, %"end for output.s0.y.yi" ], [ 0, %"for output.s0.x.x.preheader" ]
  %756 = shl nsw i32 %output.s0.x.x, 7
  %757 = add nsw i32 %756, %t340
  br label %"for output.s0.y.yi"

"end for output.s0.x.x":                          ; preds = %"consume bounded_input"
  %tobool.not.i32.not = icmp eq i8* %bounded_input, null
  br i1 %tobool.not.i32.not, label %call_destructor.exit34, label %if.then.i33

if.then.i33:                                      ; preds = %"end for output.s0.y.yi", %"end for output.s0.x.x"
  tail call void @halide_free(i8* %__user_context, i8* nonnull %bounded_input) #14
  br label %call_destructor.exit34

call_destructor.exit34:                           ; preds = %"end for output.s0.x.x", %if.then.i33
  %758 = add nuw nsw i32 %output.s0.y.y.y, 1
  %.not = icmp eq i32 %758, 128
...
"for output.s0.y.yi":                             ; preds = %"for output.s0.x.x", %"for output.s0.y.yi"
  %output.s0.y.yi = phi i32 [ 0, %"for output.s0.x.x" ], [ %1123, %"for output.s0.y.yi" ]
  %759 = add nuw nsw i32 %output.s0.y.yi, 2
  %760 = mul nsw i32 %759, %a11
  %761 = add nsw i32 %760, %output.s0.x.x
  %t286 = add i32 %761, %52
  %762 = shl nsw i32 %t286, 7
  %763 = getelementptr inbounds i8, i8* %bounded_input, i32 %762
  %764 = getelementptr inbounds i8, i8* %763, i32 1
  %765 = bitcast i8* %764 to <128 x i8>*
  %t287.s = load <128 x i8>, <128 x i8>* %765, align 1, !tbaa !99
  %766 = getelementptr inbounds i8, i8* %763, i32 5
  %767 = bitcast i8* %766 to <128 x i8>*
  %t288.s = load <128 x i8>, <128 x i8>* %767, align 1, !tbaa !99
  %t289 = add i32 %761, %53
  %768 = shl nsw i32 %t289, 7
  ...
  %t290.s = load <128 x i8>, <128 x i8>* %771, align 1, !tbaa !99
  %772 = getelementptr inbounds i8, i8* %769, i32 5
  %773 = bitcast i8* %772 to <128 x i8>*
  %t291.s = load <128 x i8>, <128 x i8>* %773, align 1, !tbaa !99
  %t292 = sub i32 %761, %a11
  %774 = shl nsw i32 %t292, 7
  %775 = getelementptr inbounds i8, i8* %bounded_input, i32 %774
  %776 = getelementptr inbounds i8, i8* %775, i32 1
  %777 = bitcast i8* %776 to <128 x i8>*
  %t293.s = load <128 x i8>, <128 x i8>* %777, align 1, !tbaa !99
  %778 = getelementptr inbounds i8, i8* %775, i32 5
  %779 = bitcast i8* %778 to <128 x i8>*
  %t294.s = load <128 x i8>, <128 x i8>* %779, align 1, !tbaa !99
  %t295 = add i32 %761, %a11
  %780 = shl nsw i32 %t295, 7
  %781 = getelementptr inbounds i8, i8* %bounded_input, i32 %780
  %782 = getelementptr inbounds i8, i8* %781, i32 1
  %783 = bitcast i8* %782 to <128 x i8>*
  %t296.s = load <128 x i8>, <128 x i8>* %783, align 1, !tbaa !99
  %784 = getelementptr inbounds i8, i8* %781, i32 5
  %785 = bitcast i8* %784 to <128 x i8>*
  %t297.s = load <128 x i8>, <128 x i8>* %785, align 1, !tbaa !99
  %786 = shl nsw i32 %761, 7
  %787 = getelementptr inbounds i8, i8* %bounded_input, i32 %786
  %788 = getelementptr inbounds i8, i8* %787, i32 1
  %789 = bitcast i8* %788 to <128 x i8>*
  %t298.s = load <128 x i8>, <128 x i8>* %789, align 1, !tbaa !99
  %790 = getelementptr inbounds i8, i8* %787, i32 5
  %791 = bitcast i8* %790 to <128 x i8>*
  %t299.s = load <128 x i8>, <128 x i8>* %791, align 1, !tbaa !99
  %792 = getelementptr inbounds i8, i8* %787, i32 2
  %793 = bitcast i8* %792 to <128 x i8>*
  %t300.s = load <128 x i8>, <128 x i8>* %793, align 2, !tbaa !99
  %794 = getelementptr inbounds i8, i8* %787, i32 3
  %795 = bitcast i8* %794 to <128 x i8>*
  %t301.s = load <128 x i8>, <128 x i8>* %795, align 1, !tbaa !99
  %796 = getelementptr inbounds i8, i8* %787, i32 4
  %797 = bitcast i8* %796 to <128 x i8>*
  %t302.s = load <128 x i8>, <128 x i8>* %797, align 4, !tbaa !99
  %798 = zext <128 x i8> %t287.s to <128 x i16>
  %799 = bitcast <128 x i16> %798 to <64 x i32>
  %800 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %799)
  %801 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %799)
  %802 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %801, i32 1) #12
  %803 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %800, i32 1) #12
  %804 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %803, <32 x i32> %802)
  %t401 = bitcast <64 x i32> %804 to <128 x i16>
  %805 = zext <128 x i8> %t288.s to <128 x i16>
  %806 = bitcast <128 x i16> %805 to <64 x i32>
  %807 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %806)
  %808 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %806)
  %809 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %808, i32 1) #12
  %810 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %807, i32 1) #12
  %811 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %810, <32 x i32> %809)
  %t402 = bitcast <64 x i32> %811 to <128 x i16>
  %812 = zext <128 x i8> %t290.s to <128 x i16>
  %813 = bitcast <128 x i16> %812 to <64 x i32>
  %814 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %813)
  %815 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %813)
  %816 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %815, i32 1) #12
  %817 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %814, i32 1) #12
  %818 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %817, <32 x i32> %816)
  %t403 = bitcast <64 x i32> %818 to <128 x i16>
  %819 = zext <128 x i8> %t291.s to <128 x i16>
  %820 = bitcast <128 x i16> %819 to <64 x i32>
  %821 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %820)
  %822 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %820)
  %823 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %822, i32 1) #12
  %824 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %821, i32 1) #12
  %825 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %824, <32 x i32> %823)
  %t404 = bitcast <64 x i32> %825 to <128 x i16>
  %826 = bitcast i8* %763 to <32 x i32>*
  %827 = load <32 x i32>, <32 x i32>* %826, align 128, !tbaa !99
  %828 = getelementptr inbounds i8, i8* %763, i32 128
  %829 = bitcast i8* %828 to <32 x i32>*
  %830 = load <32 x i32>, <32 x i32>* %829, align 128, !tbaa !99
  %831 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %830, <32 x i32> %827)
  %832 = bitcast i8* %769 to <32 x i32>*
  %833 = load <32 x i32>, <32 x i32>* %832, align 128, !tbaa !99
  %834 = getelementptr inbounds i8, i8* %769, i32 128
  %835 = bitcast i8* %834 to <32 x i32>*
  %836 = load <32 x i32>, <32 x i32>* %835, align 128, !tbaa !99
  %837 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %836, <32 x i32> %833)
  %838 = bitcast i8* %775 to <32 x i32>*
  %839 = load <32 x i32>, <32 x i32>* %838, align 128, !tbaa !99
  %840 = getelementptr inbounds i8, i8* %775, i32 128
  %841 = bitcast i8* %840 to <32 x i32>*
  %842 = load <32 x i32>, <32 x i32>* %841, align 128, !tbaa !99
  %843 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %842, <32 x i32> %839)
  %844 = bitcast i8* %781 to <32 x i32>*
  %845 = load <32 x i32>, <32 x i32>* %844, align 128, !tbaa !99
  %846 = getelementptr inbounds i8, i8* %781, i32 128
  %847 = bitcast i8* %846 to <32 x i32>*
  %848 = load <32 x i32>, <32 x i32>* %847, align 128, !tbaa !99
  %849 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %848, <32 x i32> %845)
  %850 = bitcast i8* %787 to <128 x i8>*
  %t470 = load <128 x i8>, <128 x i8>* %850, align 128, !tbaa !99
  %851 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %831)
  %852 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %831)
  %853 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %851, <32 x i32> %852, i32 4)
  %854 = bitcast <32 x i32> %853 to <128 x i8>
  %855 = zext <128 x i8> %854 to <128 x i16>
  %856 = bitcast <128 x i16> %855 to <64 x i32>
  %857 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %856)
  %858 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %856)
  %859 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %858, i32 1) #12
  %860 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %857, i32 1) #12
  %861 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %860, <32 x i32> %859)
  %862 = bitcast <64 x i32> %861 to <128 x i16>
  %863 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %851, <32 x i32> %852, i32 2)
  %864 = bitcast <32 x i32> %863 to <128 x i8>
  %865 = zext <128 x i8> %864 to <128 x i16>
  %866 = bitcast <128 x i16> %865 to <64 x i32>
  %867 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %866)
  %868 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %866)
  %869 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %868, i32 1) #12
  %870 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %867, i32 1) #12
  %871 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %870, <32 x i32> %869)
  %872 = bitcast <64 x i32> %871 to <128 x i16>
  %873 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %830, <32 x i32> %827, i32 3)
  %874 = bitcast <32 x i32> %873 to <128 x i8>
  %875 = zext <128 x i8> %874 to <128 x i16>
  %876 = bitcast <128 x i16> %875 to <64 x i32>
  %877 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %876)
  %878 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %876)
  %879 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %878, i32 2) #12
  %880 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %877, i32 2) #12
  %881 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %880, <32 x i32> %879)
  %882 = bitcast <64 x i32> %881 to <128 x i16>
  %883 = add <128 x i16> %t402, %t401
  %884 = add <128 x i16> %883, %862
  %885 = add <128 x i16> %884, %872
  %886 = add <128 x i16> %885, %882
  %887 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %837)
  %888 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %837)
  %889 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %887, <32 x i32> %888, i32 4)
  %890 = bitcast <32 x i32> %889 to <128 x i8>
  %891 = zext <128 x i8> %890 to <128 x i16>
  %892 = bitcast <128 x i16> %891 to <64 x i32>
  %893 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %892)
  %894 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %892)
  %895 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %894, i32 1) #12
  %896 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %893, i32 1) #12
  %897 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %896, <32 x i32> %895)
  %898 = bitcast <64 x i32> %897 to <128 x i16>
  %899 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %887, <32 x i32> %888, i32 2)
  %900 = bitcast <32 x i32> %899 to <128 x i8>
  %901 = zext <128 x i8> %900 to <128 x i16>
  %902 = bitcast <128 x i16> %901 to <64 x i32>
  %903 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %902)
  %904 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %902)
  %905 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %904, i32 1) #12
  %906 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %903, i32 1) #12
  %907 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %906, <32 x i32> %905)
  %908 = bitcast <64 x i32> %907 to <128 x i16>
  %909 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %836, <32 x i32> %833, i32 3)
  %910 = bitcast <32 x i32> %909 to <128 x i8>
  %911 = zext <128 x i8> %910 to <128 x i16>
  %912 = bitcast <128 x i16> %911 to <64 x i32>
  %913 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %912)
  %914 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %912)
  %915 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %914, i32 2) #12
  %916 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %913, i32 2) #12
  %917 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %916, <32 x i32> %915)
  %918 = bitcast <64 x i32> %917 to <128 x i16>
  %919 = add <128 x i16> %t404, %t403
  %920 = add <128 x i16> %919, %898
  %921 = add <128 x i16> %920, %908
  %922 = add <128 x i16> %921, %918
  %923 = bitcast <128 x i16> %886 to <64 x i32>
  %924 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %923)
  %925 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %923)
  %926 = bitcast <128 x i16> %922 to <64 x i32>
  %927 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %926)
  %928 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %926)
  %929 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %925, <32 x i32> %928) #12
  %930 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %924, <32 x i32> %927) #12
  %931 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %930, <32 x i32> %929)
  %932 = bitcast <64 x i32> %931 to <128 x i16>
  %933 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %842, <32 x i32> %839, i32 3)
  %934 = bitcast <32 x i32> %933 to <128 x i8>
  %935 = zext <128 x i8> %934 to <128 x i16>
  %936 = bitcast <128 x i16> %935 to <64 x i32>
  %937 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %936)
  %938 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %936)
  %939 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %938, i32 1) #12
  %940 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %937, i32 1) #12
  %941 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %940, <32 x i32> %939)
  %942 = bitcast <64 x i32> %941 to <128 x i16>
  %943 = zext <128 x i8> %t293.s to <128 x i16>
  %944 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %843)
  %945 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %843)
  %946 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %944, <32 x i32> %945, i32 2)
  %947 = bitcast <32 x i32> %946 to <128 x i8>
  %948 = zext <128 x i8> %947 to <128 x i16>
  %949 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %944, <32 x i32> %945, i32 4)
  %950 = bitcast <32 x i32> %949 to <128 x i8>
  %951 = zext <128 x i8> %950 to <128 x i16>
  %952 = zext <128 x i8> %t294.s to <128 x i16>
  %953 = add nuw nsw <128 x i16> %952, %943
  %954 = add <128 x i16> %953, %942
  %955 = add <128 x i16> %954, %948
  %956 = add <128 x i16> %955, %951
  %957 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %848, <32 x i32> %845, i32 3)
  %958 = bitcast <32 x i32> %957 to <128 x i8>
  %959 = zext <128 x i8> %958 to <128 x i16>
  %960 = bitcast <128 x i16> %959 to <64 x i32>
  %961 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %960)
  %962 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %960)
  %963 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %962, i32 1) #12
  %964 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %961, i32 1) #12
  %965 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %964, <32 x i32> %963)
  %966 = bitcast <64 x i32> %965 to <128 x i16>
  %967 = zext <128 x i8> %t296.s to <128 x i16>
  %968 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %849)
  %969 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %849)
  %970 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %968, <32 x i32> %969, i32 2)
  %971 = bitcast <32 x i32> %970 to <128 x i8>
  %972 = zext <128 x i8> %971 to <128 x i16>
  %973 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %968, <32 x i32> %969, i32 4)
  %974 = bitcast <32 x i32> %973 to <128 x i8>
  %975 = zext <128 x i8> %974 to <128 x i16>
  %976 = zext <128 x i8> %t297.s to <128 x i16>
  %977 = add nuw nsw <128 x i16> %976, %967
  %978 = add <128 x i16> %977, %966
  %979 = add <128 x i16> %978, %972
  %980 = add <128 x i16> %979, %975
  %981 = bitcast <128 x i16> %956 to <64 x i32>
  %982 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %981)
  %983 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %981)
  %984 = bitcast <128 x i16> %980 to <64 x i32>
  %985 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %984)
  %986 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %984)
  %987 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %983, <32 x i32> %986) #12
  %988 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %982, <32 x i32> %985) #12
  %989 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %988, <32 x i32> %987)
  %990 = bitcast <64 x i32> %989 to <128 x i16>
  %991 = add <128 x i16> %990, %932
  %992 = bitcast <128 x i16> %991 to <64 x i32>
  %993 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %992)
  %994 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %992)
  %995 = tail call <32 x i32> @llvm.hexagon.V6.vminuh.128B(<32 x i32> %994, <32 x i32> %755) #12
  %996 = tail call <32 x i32> @llvm.hexagon.V6.vminuh.128B(<32 x i32> %993, <32 x i32> %754) #12
  %997 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %996, <32 x i32> %995)
  %998 = bitcast <64 x i32> %997 to <128 x i16>
  %999 = trunc <128 x i16> %998 to <128 x i8>
  %1000 = bitcast <128 x i16> %967 to <64 x i32>
  %1001 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1000)
  %1002 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1000)
  %1003 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1002, i32 1) #12
  %1004 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1001, i32 1) #12
  %1005 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1004, <32 x i32> %1003)
  %1006 = bitcast <64 x i32> %1005 to <128 x i16>
  %1007 = bitcast <128 x i16> %943 to <64 x i32>
  %1008 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1007)
  %1009 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1007)
  %1010 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1009, i32 1) #12
  %1011 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1008, i32 1) #12
  %1012 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1011, <32 x i32> %1010)
  %1013 = bitcast <64 x i32> %1012 to <128 x i16>
  %1014 = zext <128 x i8> %t298.s to <128 x i16>
  %1015 = bitcast <128 x i16> %1014 to <64 x i32>
  %1016 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1015)
  %1017 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1015)
  %1018 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1017, i32 2) #12
  %1019 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1016, i32 2) #12
  %1020 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1019, <32 x i32> %1018)
  %1021 = bitcast <64 x i32> %1020 to <128 x i16>
  %1022 = add <128 x i16> %t403, %t401
  %1023 = add <128 x i16> %1022, %1006
  %1024 = add <128 x i16> %1023, %1013
  %1025 = add <128 x i16> %1024, %1021
  %1026 = bitcast <128 x i16> %976 to <64 x i32>
  %1027 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1026)
  %1028 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1026)
  %1029 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1028, i32 1) #12
  %1030 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1027, i32 1) #12
  %1031 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1030, <32 x i32> %1029)
  %1032 = bitcast <64 x i32> %1031 to <128 x i16>
  %1033 = bitcast <128 x i16> %952 to <64 x i32>
  %1034 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1033)
  %1035 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1033)
  %1036 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1035, i32 1) #12
  %1037 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1034, i32 1) #12
  %1038 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1037, <32 x i32> %1036)
  %1039 = bitcast <64 x i32> %1038 to <128 x i16>
  %1040 = zext <128 x i8> %t299.s to <128 x i16>
  %1041 = bitcast <128 x i16> %1040 to <64 x i32>
  %1042 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1041)
  %1043 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1041)
  %1044 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1043, i32 2) #12
  %1045 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1042, i32 2) #12
  %1046 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1045, <32 x i32> %1044)
  %1047 = bitcast <64 x i32> %1046 to <128 x i16>
  %1048 = add <128 x i16> %t404, %t402
  %1049 = add <128 x i16> %1048, %1032
  %1050 = add <128 x i16> %1049, %1039
  %1051 = add <128 x i16> %1050, %1047
  %1052 = bitcast <128 x i16> %1025 to <64 x i32>
  %1053 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1052)
  %1054 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1052)
  %1055 = bitcast <128 x i16> %1051 to <64 x i32>
  %1056 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1055)
  %1057 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1055)
  %1058 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %1054, <32 x i32> %1057) #12
  %1059 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %1053, <32 x i32> %1056) #12
  %1060 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1059, <32 x i32> %1058)
  %1061 = bitcast <64 x i32> %1060 to <128 x i16>
  %1062 = zext <128 x i8> %t300.s to <128 x i16>
  %1063 = bitcast <128 x i16> %1062 to <64 x i32>
  %1064 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1063)
  %1065 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1063)
  %1066 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1065, i32 1) #12
  %1067 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1064, i32 1) #12
  %1068 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1067, <32 x i32> %1066)
  %1069 = bitcast <64 x i32> %1068 to <128 x i16>
  %1070 = zext <128 x i8> %t470 to <128 x i16>
  %1071 = zext <128 x i8> %t301.s to <128 x i16>
  %1072 = zext <128 x i8> %t302.s to <128 x i16>
  %1073 = add nuw nsw <128 x i16> %1071, %1014
  %1074 = add nuw nsw <128 x i16> %1073, %1072
  %1075 = add nuw nsw <128 x i16> %1074, %1070
  %1076 = add <128 x i16> %1075, %1069
  %1077 = bitcast <128 x i16> %1072 to <64 x i32>
  %1078 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1077)
  %1079 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1077)
  %1080 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1079, i32 1) #12
  %1081 = tail call <32 x i32> @llvm.hexagon.V6.vaslh.128B(<32 x i32> %1078, i32 1) #12
  %1082 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1081, <32 x i32> %1080)
  %1083 = bitcast <64 x i32> %1082 to <128 x i16>
  %1084 = getelementptr inbounds i8, i8* %787, i32 128
  %1085 = bitcast i8* %1084 to <32 x i32>*
  %1086 = load <32 x i32>, <32 x i32>* %1085, align 128, !tbaa !99
  %1087 = bitcast <128 x i8> %t470 to <32 x i32>
  %1088 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1086, <32 x i32> %1087)
  ...
  %1091 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %1089, <32 x i32> %1090, i32 6)
  %1092 = bitcast <32 x i32> %1091 to <128 x i8>
  %1093 = zext <128 x i8> %1092 to <128 x i16>
  %1094 = add nuw nsw <128 x i16> %1062, %1040
  %1095 = add nuw nsw <128 x i16> %1094, %1071
  %1096 = add <128 x i16> %1095, %1083
  %1097 = add <128 x i16> %1096, %1093
  %1098 = bitcast <128 x i16> %1076 to <64 x i32>
  %1099 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1098)
  %1100 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1098)
  %1101 = bitcast <128 x i16> %1097 to <64 x i32>
  ...
  %1104 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %1100, <32 x i32> %1103) #12
  %1105 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %1099, <32 x i32> %1102) #12
  %1106 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1105, <32 x i32> %1104)
  %1107 = bitcast <64 x i32> %1106 to <128 x i16>
  %1108 = add <128 x i16> %1107, %1061
  %1109 = bitcast <128 x i16> %1108 to <64 x i32>
  %1110 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1109)
  %1111 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1109)
  %1112 = tail call <32 x i32> @llvm.hexagon.V6.vminuh.128B(<32 x i32> %1111, <32 x i32> %755) #12
  %1113 = tail call <32 x i32> @llvm.hexagon.V6.vminuh.128B(<32 x i32> %1110, <32 x i32> %754) #12
  %1114 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1113, <32 x i32> %1112)
  %1115 = bitcast <64 x i32> %1114 to <128 x i16>
  %1116 = trunc <128 x i16> %1115 to <128 x i8>
  %1117 = add <128 x i8> %1116, %999
  %1118 = add nsw i32 %output.s0.y.yi, %72
  %1119 = mul nsw i32 %1118, %output.stride.1
  %1120 = add nsw i32 %757, %1119
  %1121 = getelementptr inbounds i8, i8* %output, i32 %1120
  %1122 = bitcast i8* %1121 to <128 x i8>*
  store <128 x i8> %1117, <128 x i8>* %1122, align 1, !tbaa !104
  %1123 = add nuw nsw i32 %output.s0.y.yi, 1
  %.not20 = icmp eq i32 %1123, 4
  br i1 %.not20, label %"end for output.s0.y.yi", label %"for output.s0.y.yi"

"end for output.s0.y.yi":                         ; preds = %"for output.s0.y.yi"
  %1124 = add nuw nsw i32 %output.s0.x.x, 1
  %.not21 = icmp eq i32 %1124, %t341
  br i1 %.not21, label %if.then.i33, label %"for output.s0.x.x"
}
...
entry:
  ...
  %call4.i = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @sobel5x5_hvx128_par_for_output_s0_y_y_v1, i32 0, i32 %58, i8* nonnull %59) #14
  ret i32 0
}
...
entry:
  ...
  %6 = tail call i32 @sobel5x5_hvx128(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #16
  ret i32 0
}
