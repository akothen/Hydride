...
entry:
  ...
  %t2233 = select i1 %47, i32 %a30, i32 0
  %48 = shl nsw i32 %t2233, 7
  ...
  %72 = icmp eq i32 %t1346, 1
  %unroll_iter = and i32 %t1346, -2
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  %xtraiter95 = and i32 %67, 7
  %73 = icmp ult i32 %69, 7
  %unroll_iter97 = and i32 %67, -8
  %lcmp.mod96.not = icmp eq i32 %xtraiter95, 0
  %xtraiter99 = and i32 %70, 1
  %74 = icmp eq i32 %a30, %.neg
  %unroll_iter101 = and i32 %70, -2
  %lcmp.mod100.not = icmp eq i32 %xtraiter99, 0
  %xtraiter103 = and i32 %t1327, 7
  %75 = icmp ult i32 %71, 7
  %unroll_iter106 = and i32 %t1327, -8
  %lcmp.mod105.not = icmp eq i32 %xtraiter103, 0
  br label %"for output.s0.y.y.y"

"for output.s0.y.y.y":                            ; preds = %entry, %call_destructor.exit91
  %output.s0.y.y.y = phi i32 [ 0, %entry ], [ %1025, %call_destructor.exit91 ]
  %76 = add nsw i32 %output.s0.y.y.y, %output.s0.y.y.y.base
  %a2 = shl nsw i32 %76, 2
  %77 = icmp slt i32 %a2, %b4
  %b11 = select i1 %77, i32 %a2, i32 %b4
  %a3 = add nsw i32 %a2, 4
  %78 = icmp slt i32 %a3, %b36
  %output.s0.y.max_1.s = select i1 %78, i32 %a3, i32 %b36
  %a4 = add nsw i32 %output.s0.y.max_1.s, 1
  %79 = icmp slt i32 %a4, %b129
  %a10 = select i1 %79, i32 %a4, i32 %b129
  %.not = icmp sgt i32 %b129, %b11
  %a6 = select i1 %.not, i32 %b11, i32 %a7
  %80 = icmp sgt i32 %a6, 0
  %a5 = select i1 %80, i32 %a6, i32 0
  %81 = icmp slt i32 %b129, %b11
  %a8 = select i1 %81, i32 %b129, i32 %b11
  %82 = icmp sgt i32 %a8, 1
  %83 = select i1 %82, i32 %a8, i32 1
  %b7 = add nsw i32 %83, -1
  %84 = icmp slt i32 %a5, %b7
  %bounded_input.s0.y.min_1 = select i1 %84, i32 %a5, i32 %b7
  %85 = icmp sgt i32 %a10, 1
  %86 = select i1 %85, i32 %a10, i32 1
  %87 = icmp sle i32 %86, %b129
  %88 = and i1 %t1315, %87
  br i1 %88, label %then_bb, label %after_bb

call_destructor.exit:                             ; preds = %call_destructor.exit91
...
after_bb:                                         ; preds = %"for output.s0.y.y.y", %then_bb
  %89 = icmp slt i32 %a2, %b18
  %a24 = select i1 %89, i32 %a2, i32 %b18
  %90 = icmp sgt i32 %a24, 0
  %a23 = select i1 %90, i32 %a24, i32 0
  %91 = icmp slt i32 %a2, %b90
  %a26 = select i1 %91, i32 %a2, i32 %b90
  %92 = icmp sgt i32 %a26, 1
  %93 = select i1 %92, i32 %a26, i32 1
  %b25 = add nsw i32 %93, -1
  %94 = icmp slt i32 %a23, %b25
  %95 = select i1 %94, i32 %a23, i32 %b25
  %a31 = sub nsw i32 %86, %95
  %96 = icmp sgt i32 %a31, 0
  %97 = select i1 %96, i32 %a31, i32 0
  %98 = mul i32 %48, %97
  %99 = add i32 %98, 131
  %bounded_input = tail call i8* @halide_malloc(i8* %__user_context, i32 %99)
  br i1 %96, label %"for bounded_input.s0.y.rebased", label %"consume bounded_input", !prof !95

then_bb:                                          ; preds = %"for output.s0.y.y.y"
  %100 = mul nsw i32 %bounded_input.s0.y.min_1, %input.stride.1
  %101 = getelementptr inbounds i8, i8* %input, i32 %100
  %102 = icmp slt i32 %a2, %b18
  %a15 = select i1 %102, i32 %a2, i32 %b18
  %103 = icmp sgt i32 %a15, 0
  %a14 = select i1 %103, i32 %a15, i32 0
  %104 = icmp slt i32 %a2, %b90
  %a17 = select i1 %104, i32 %a2, i32 %b90
  %105 = icmp sgt i32 %a17, 1
  %106 = select i1 %105, i32 %a17, i32 1
  %b16 = add nsw i32 %106, -1
  %107 = icmp slt i32 %a14, %b16
  %108 = select i1 %107, i32 %a14, i32 %b16
  %109 = sub nsw i32 %86, %108
  %conv4.i = sext i32 %109 to i64
  %or3.i = or i64 %or.i, %conv4.i
  %or6.i = or i64 %or3.i, 281474976710656
  tail call void asm sideeffect "l2fetch($0,$1)", "r,r"(i8* %101, i64 %or6.i) #12, !srcloc !96
  br label %after_bb

"for bounded_input.s0.y.rebased":                 ; preds = %after_bb, %"end for bounded_input.s0.x.x.rebased2"
  %bounded_input.s0.y.rebased = phi i32 [ %478, %"end for bounded_input.s0.x.x.rebased2" ], [ 0, %after_bb ]
...
"for bounded_input.s0.x.x.preheader":             ; preds = %"for bounded_input.s0.y.rebased"
  %110 = add nsw i32 %bounded_input.s0.y.rebased, %bounded_input.s0.y.min_1
  %111 = mul nsw i32 %110, %input.stride.1
  %112 = mul nsw i32 %bounded_input.s0.y.rebased, %a30
  br i1 %72, label %"end for bounded_input.s0.x.x.loopexit.unr-lcssa", label %"for bounded_input.s0.x.x"

"for bounded_input.s0.x.x":                       ; preds = %"for bounded_input.s0.x.x.preheader", %"for bounded_input.s0.x.x"
  %bounded_input.s0.x.x = phi i32 [ %198, %"for bounded_input.s0.x.x" ], [ 0, %"for bounded_input.s0.x.x.preheader" ]
  %niter = phi i32 [ %niter.nsub.1, %"for bounded_input.s0.x.x" ], [ %unroll_iter, %"for bounded_input.s0.x.x.preheader" ]
  %113 = shl nsw i32 %bounded_input.s0.x.x, 7
  %b42 = add nsw i32 %113, %t1332
  %114 = icmp slt i32 %a40, %b42
  %a42 = select i1 %114, i32 %a40, i32 %b42
  %115 = icmp sgt i32 %a42, 129
  %116 = select i1 %115, i32 %a42, i32 129
  %117 = add nsw i32 %116, %111
  %118 = getelementptr inbounds i8, i8* %60, i32 %117
  %119 = bitcast i8* %118 to <32 x i32>*
  %120 = load <32 x i32>, <32 x i32>* %119, align 1, !tbaa !97
  %121 = add nsw i32 %b42, -129
  %122 = insertelement <128 x i32> undef, i32 %121, i32 0
  %123 = shufflevector <128 x i32> %122, <128 x i32> undef, <128 x i32> zeroinitializer
  %124 = add nsw <128 x i32> %123, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %125 = shufflevector <128 x i32> %124, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %126 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %125, <32 x i32> %52) #12
  %127 = shufflevector <128 x i32> %124, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %128 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %127, <32 x i32> %52) #12
  %129 = shufflevector <128 x i32> %124, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %130 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %129, <32 x i32> %52) #12
  %131 = shufflevector <128 x i32> %124, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %132 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %131, <32 x i32> %52) #12
  %133 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %126, <32 x i32> zeroinitializer) #12
  %134 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %128, <32 x i32> zeroinitializer) #12
  %135 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %130, <32 x i32> zeroinitializer) #12
  %136 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %132, <32 x i32> zeroinitializer) #12
  %137 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %134, <32 x i32> %133)
  %138 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %136, <32 x i32> %135)
  %139 = shufflevector <64 x i32> %137, <64 x i32> %138, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %140 = sub nsw i32 129, %116
  %141 = insertelement <128 x i32> undef, i32 %140, i32 0
  %142 = shufflevector <128 x i32> %141, <128 x i32> undef, <128 x i32> zeroinitializer
  %143 = add nsw <128 x i32> %139, %142
  %144 = trunc <128 x i32> %143 to <128 x i8>
  %145 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %120)
  %146 = bitcast <128 x i8> %144 to <32 x i32>
  %147 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %146, <32 x i32> %145, i32 0)
  %148 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %147, <32 x i32> %146, <32 x i32> %145, i32 1)
  %149 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %148, <32 x i32> %146, <32 x i32> %145, i32 2)
  %150 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %149, <32 x i32> %146, <32 x i32> %145, i32 3)
  %151 = add nsw i32 %bounded_input.s0.x.x, %112
  %152 = shl nsw i32 %151, 7
  %153 = getelementptr inbounds i8, i8* %bounded_input, i32 %152
  %154 = bitcast i8* %153 to <32 x i32>*
  store <32 x i32> %150, <32 x i32>* %154, align 128, !tbaa !100
  %155 = or i32 %bounded_input.s0.x.x, 1
  %156 = shl nsw i32 %155, 7
  %b42.1 = add nsw i32 %156, %t1332
  %157 = icmp slt i32 %a40, %b42.1
  %a42.1 = select i1 %157, i32 %a40, i32 %b42.1
  %158 = icmp sgt i32 %a42.1, 129
  %159 = select i1 %158, i32 %a42.1, i32 129
  %160 = add nsw i32 %159, %111
  %161 = getelementptr inbounds i8, i8* %60, i32 %160
  %162 = bitcast i8* %161 to <32 x i32>*
  %163 = load <32 x i32>, <32 x i32>* %162, align 1, !tbaa !97
  %164 = add nsw i32 %b42.1, -129
  %165 = insertelement <128 x i32> undef, i32 %164, i32 0
  %166 = shufflevector <128 x i32> %165, <128 x i32> undef, <128 x i32> zeroinitializer
  %167 = add nsw <128 x i32> %166, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %168 = shufflevector <128 x i32> %167, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %169 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %168, <32 x i32> %52) #12
  %170 = shufflevector <128 x i32> %167, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %171 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %170, <32 x i32> %52) #12
  %172 = shufflevector <128 x i32> %167, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %173 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %172, <32 x i32> %52) #12
  %174 = shufflevector <128 x i32> %167, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %175 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %174, <32 x i32> %52) #12
  %176 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %169, <32 x i32> zeroinitializer) #12
  %177 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %171, <32 x i32> zeroinitializer) #12
  %178 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %173, <32 x i32> zeroinitializer) #12
  %179 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %175, <32 x i32> zeroinitializer) #12
  %180 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %177, <32 x i32> %176)
  %181 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %179, <32 x i32> %178)
  %182 = shufflevector <64 x i32> %180, <64 x i32> %181, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %183 = sub nsw i32 129, %159
  %184 = insertelement <128 x i32> undef, i32 %183, i32 0
  %185 = shufflevector <128 x i32> %184, <128 x i32> undef, <128 x i32> zeroinitializer
  %186 = add nsw <128 x i32> %182, %185
  %187 = trunc <128 x i32> %186 to <128 x i8>
  %188 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %163)
  %189 = bitcast <128 x i8> %187 to <32 x i32>
  %190 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %189, <32 x i32> %188, i32 0)
  %191 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %190, <32 x i32> %189, <32 x i32> %188, i32 1)
  %192 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %191, <32 x i32> %189, <32 x i32> %188, i32 2)
  %193 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %192, <32 x i32> %189, <32 x i32> %188, i32 3)
  %194 = add nsw i32 %155, %112
  %195 = shl nsw i32 %194, 7
  %196 = getelementptr inbounds i8, i8* %bounded_input, i32 %195
  %197 = bitcast i8* %196 to <32 x i32>*
  store <32 x i32> %193, <32 x i32>* %197, align 128, !tbaa !100
  %198 = add nuw nsw i32 %bounded_input.s0.x.x, 2
...
"end for bounded_input.s0.x.x.loopexit.unr-lcssa": ; preds = %"for bounded_input.s0.x.x", %"for bounded_input.s0.x.x.preheader"
  %bounded_input.s0.x.x.unr = phi i32 [ 0, %"for bounded_input.s0.x.x.preheader" ], [ %198, %"for bounded_input.s0.x.x" ]
...
"for bounded_input.s0.x.x.epil":                  ; preds = %"end for bounded_input.s0.x.x.loopexit.unr-lcssa"
  %199 = shl nsw i32 %bounded_input.s0.x.x.unr, 7
  %b42.epil = add nsw i32 %199, %t1332
  %200 = icmp slt i32 %a40, %b42.epil
  %a42.epil = select i1 %200, i32 %a40, i32 %b42.epil
  %201 = icmp sgt i32 %a42.epil, 129
  %202 = select i1 %201, i32 %a42.epil, i32 129
  %203 = add nsw i32 %202, %111
  %204 = getelementptr inbounds i8, i8* %60, i32 %203
  %205 = bitcast i8* %204 to <32 x i32>*
  %206 = load <32 x i32>, <32 x i32>* %205, align 1, !tbaa !97
  %207 = add nsw i32 %b42.epil, -129
  %208 = insertelement <128 x i32> undef, i32 %207, i32 0
  %209 = shufflevector <128 x i32> %208, <128 x i32> undef, <128 x i32> zeroinitializer
  %210 = add nsw <128 x i32> %209, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %211 = shufflevector <128 x i32> %210, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %212 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %211, <32 x i32> %52) #12
  %213 = shufflevector <128 x i32> %210, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %214 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %213, <32 x i32> %52) #12
  %215 = shufflevector <128 x i32> %210, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %216 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %215, <32 x i32> %52) #12
  %217 = shufflevector <128 x i32> %210, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %218 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %217, <32 x i32> %52) #12
  %219 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %212, <32 x i32> zeroinitializer) #12
  %220 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %214, <32 x i32> zeroinitializer) #12
  %221 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %216, <32 x i32> zeroinitializer) #12
  %222 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %218, <32 x i32> zeroinitializer) #12
  %223 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %220, <32 x i32> %219)
  %224 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %222, <32 x i32> %221)
  %225 = shufflevector <64 x i32> %223, <64 x i32> %224, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %226 = sub nsw i32 129, %202
  %227 = insertelement <128 x i32> undef, i32 %226, i32 0
  %228 = shufflevector <128 x i32> %227, <128 x i32> undef, <128 x i32> zeroinitializer
  %229 = add nsw <128 x i32> %225, %228
  %230 = trunc <128 x i32> %229 to <128 x i8>
  %231 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %206)
  %232 = bitcast <128 x i8> %230 to <32 x i32>
  %233 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %232, <32 x i32> %231, i32 0)
  %234 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %233, <32 x i32> %232, <32 x i32> %231, i32 1)
  %235 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %234, <32 x i32> %232, <32 x i32> %231, i32 2)
  %236 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %235, <32 x i32> %232, <32 x i32> %231, i32 3)
  %237 = add nsw i32 %bounded_input.s0.x.x.unr, %112
  %238 = shl nsw i32 %237, 7
  %239 = getelementptr inbounds i8, i8* %bounded_input, i32 %238
  %240 = bitcast i8* %239 to <32 x i32>*
  store <32 x i32> %236, <32 x i32>* %240, align 128, !tbaa !100
...
"for bounded_input.s0.x.x.rebased.preheader":     ; preds = %"end for bounded_input.s0.x.x"
  %241 = add nsw i32 %bounded_input.s0.y.rebased, %bounded_input.s0.y.min_1
  %242 = mul nsw i32 %241, %input.stride.1
  %243 = add i32 %242, %t1332
  %244 = mul nsw i32 %bounded_input.s0.y.rebased, %a30
  br i1 %73, label %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa", label %"for bounded_input.s0.x.x.rebased"

"for bounded_input.s0.x.x.rebased":               ; preds = %"for bounded_input.s0.x.x.rebased.preheader", %"for bounded_input.s0.x.x.rebased"
  %bounded_input.s0.x.x.rebased = phi i32 [ %332, %"for bounded_input.s0.x.x.rebased" ], [ 0, %"for bounded_input.s0.x.x.rebased.preheader" ]
  %niter98 = phi i32 [ %niter98.nsub.7, %"for bounded_input.s0.x.x.rebased" ], [ %unroll_iter97, %"for bounded_input.s0.x.x.rebased.preheader" ]
  %245 = add nsw i32 %bounded_input.s0.x.x.rebased, %t1346
  %246 = shl nsw i32 %245, 7
  %247 = add i32 %243, %246
  %248 = getelementptr inbounds i8, i8* %61, i32 %247
  %249 = bitcast i8* %248 to <128 x i8>*
  %250 = load <128 x i8>, <128 x i8>* %249, align 1, !tbaa !97
  %251 = add nsw i32 %245, %244
  %252 = shl nsw i32 %251, 7
  %253 = getelementptr inbounds i8, i8* %bounded_input, i32 %252
  %254 = bitcast i8* %253 to <128 x i8>*
  store <128 x i8> %250, <128 x i8>* %254, align 128, !tbaa !100
  %255 = or i32 %bounded_input.s0.x.x.rebased, 1
  %256 = add nsw i32 %255, %t1346
  %257 = shl nsw i32 %256, 7
  %258 = add i32 %243, %257
  %259 = getelementptr inbounds i8, i8* %61, i32 %258
  %260 = bitcast i8* %259 to <128 x i8>*
  %261 = load <128 x i8>, <128 x i8>* %260, align 1, !tbaa !97
  %262 = add nsw i32 %256, %244
  %263 = shl nsw i32 %262, 7
  %264 = getelementptr inbounds i8, i8* %bounded_input, i32 %263
  %265 = bitcast i8* %264 to <128 x i8>*
  store <128 x i8> %261, <128 x i8>* %265, align 128, !tbaa !100
  %266 = or i32 %bounded_input.s0.x.x.rebased, 2
  %267 = add nsw i32 %266, %t1346
  %268 = shl nsw i32 %267, 7
  %269 = add i32 %243, %268
  %270 = getelementptr inbounds i8, i8* %61, i32 %269
  %271 = bitcast i8* %270 to <128 x i8>*
  %272 = load <128 x i8>, <128 x i8>* %271, align 1, !tbaa !97
  %273 = add nsw i32 %267, %244
  %274 = shl nsw i32 %273, 7
  %275 = getelementptr inbounds i8, i8* %bounded_input, i32 %274
  %276 = bitcast i8* %275 to <128 x i8>*
  store <128 x i8> %272, <128 x i8>* %276, align 128, !tbaa !100
  %277 = or i32 %bounded_input.s0.x.x.rebased, 3
  %278 = add nsw i32 %277, %t1346
  %279 = shl nsw i32 %278, 7
  %280 = add i32 %243, %279
  %281 = getelementptr inbounds i8, i8* %61, i32 %280
  %282 = bitcast i8* %281 to <128 x i8>*
  %283 = load <128 x i8>, <128 x i8>* %282, align 1, !tbaa !97
  %284 = add nsw i32 %278, %244
  %285 = shl nsw i32 %284, 7
  %286 = getelementptr inbounds i8, i8* %bounded_input, i32 %285
  %287 = bitcast i8* %286 to <128 x i8>*
  store <128 x i8> %283, <128 x i8>* %287, align 128, !tbaa !100
  %288 = or i32 %bounded_input.s0.x.x.rebased, 4
  %289 = add nsw i32 %288, %t1346
  %290 = shl nsw i32 %289, 7
  %291 = add i32 %243, %290
  %292 = getelementptr inbounds i8, i8* %61, i32 %291
  %293 = bitcast i8* %292 to <128 x i8>*
  %294 = load <128 x i8>, <128 x i8>* %293, align 1, !tbaa !97
  %295 = add nsw i32 %289, %244
  %296 = shl nsw i32 %295, 7
  %297 = getelementptr inbounds i8, i8* %bounded_input, i32 %296
  %298 = bitcast i8* %297 to <128 x i8>*
  store <128 x i8> %294, <128 x i8>* %298, align 128, !tbaa !100
  %299 = or i32 %bounded_input.s0.x.x.rebased, 5
  %300 = add nsw i32 %299, %t1346
  %301 = shl nsw i32 %300, 7
  %302 = add i32 %243, %301
  %303 = getelementptr inbounds i8, i8* %61, i32 %302
  %304 = bitcast i8* %303 to <128 x i8>*
  %305 = load <128 x i8>, <128 x i8>* %304, align 1, !tbaa !97
  %306 = add nsw i32 %300, %244
  %307 = shl nsw i32 %306, 7
  %308 = getelementptr inbounds i8, i8* %bounded_input, i32 %307
  %309 = bitcast i8* %308 to <128 x i8>*
  store <128 x i8> %305, <128 x i8>* %309, align 128, !tbaa !100
  %310 = or i32 %bounded_input.s0.x.x.rebased, 6
  %311 = add nsw i32 %310, %t1346
  %312 = shl nsw i32 %311, 7
  %313 = add i32 %243, %312
  %314 = getelementptr inbounds i8, i8* %61, i32 %313
  %315 = bitcast i8* %314 to <128 x i8>*
  %316 = load <128 x i8>, <128 x i8>* %315, align 1, !tbaa !97
  %317 = add nsw i32 %311, %244
  %318 = shl nsw i32 %317, 7
  %319 = getelementptr inbounds i8, i8* %bounded_input, i32 %318
  %320 = bitcast i8* %319 to <128 x i8>*
  store <128 x i8> %316, <128 x i8>* %320, align 128, !tbaa !100
  %321 = or i32 %bounded_input.s0.x.x.rebased, 7
  %322 = add nsw i32 %321, %t1346
  %323 = shl nsw i32 %322, 7
  %324 = add i32 %243, %323
  %325 = getelementptr inbounds i8, i8* %61, i32 %324
  %326 = bitcast i8* %325 to <128 x i8>*
  %327 = load <128 x i8>, <128 x i8>* %326, align 1, !tbaa !97
  %328 = add nsw i32 %322, %244
  %329 = shl nsw i32 %328, 7
  %330 = getelementptr inbounds i8, i8* %bounded_input, i32 %329
  %331 = bitcast i8* %330 to <128 x i8>*
  store <128 x i8> %327, <128 x i8>* %331, align 128, !tbaa !100
  %332 = add nuw nsw i32 %bounded_input.s0.x.x.rebased, 8
  %niter98.nsub.7 = add i32 %niter98, -8
  %niter98.ncmp.7 = icmp eq i32 %niter98.nsub.7, 0
  br i1 %niter98.ncmp.7, label %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa", label %"for bounded_input.s0.x.x.rebased"
...
"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa": ; preds = %"for bounded_input.s0.x.x.rebased", %"for bounded_input.s0.x.x.rebased.preheader"
  %bounded_input.s0.x.x.rebased.unr = phi i32 [ 0, %"for bounded_input.s0.x.x.rebased.preheader" ], [ %332, %"for bounded_input.s0.x.x.rebased" ]
  br i1 %lcmp.mod96.not, label %"end for bounded_input.s0.x.x.rebased", label %"for bounded_input.s0.x.x.rebased.epil"
...
"for bounded_input.s0.x.x.rebased.epil":          ; preds = %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa", %"for bounded_input.s0.x.x.rebased.epil"
  %bounded_input.s0.x.x.rebased.epil = phi i32 [ %343, %"for bounded_input.s0.x.x.rebased.epil" ], [ %bounded_input.s0.x.x.rebased.unr, %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa" ]
  %epil.iter = phi i32 [ %epil.iter.sub, %"for bounded_input.s0.x.x.rebased.epil" ], [ %xtraiter95, %"end for bounded_input.s0.x.x.rebased.loopexit.unr-lcssa" ]
  %333 = add nsw i32 %bounded_input.s0.x.x.rebased.epil, %t1346
  %334 = shl nsw i32 %333, 7
  %335 = add i32 %243, %334
  %336 = getelementptr inbounds i8, i8* %61, i32 %335
  %337 = bitcast i8* %336 to <128 x i8>*
  %338 = load <128 x i8>, <128 x i8>* %337, align 1, !tbaa !97
  %339 = add nsw i32 %333, %244
  %340 = shl nsw i32 %339, 7
  %341 = getelementptr inbounds i8, i8* %bounded_input, i32 %340
  %342 = bitcast i8* %341 to <128 x i8>*
  store <128 x i8> %338, <128 x i8>* %342, align 128, !tbaa !100
  %343 = add nuw nsw i32 %bounded_input.s0.x.x.rebased.epil, 1
  %epil.iter.sub = add i32 %epil.iter, -1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.sub, 0
...
"for bounded_input.s0.x.x.rebased1.preheader":    ; preds = %"end for bounded_input.s0.x.x.rebased"
  %344 = add nsw i32 %bounded_input.s0.y.rebased, %bounded_input.s0.y.min_1
  %345 = mul nsw i32 %344, %input.stride.1
  %346 = mul nsw i32 %bounded_input.s0.y.rebased, %a30
  br i1 %74, label %"end for bounded_input.s0.x.x.rebased2.loopexit.unr-lcssa", label %"for bounded_input.s0.x.x.rebased1"

"for bounded_input.s0.x.x.rebased1":              ; preds = %"for bounded_input.s0.x.x.rebased1.preheader", %"for bounded_input.s0.x.x.rebased1"
  %bounded_input.s0.x.x.rebased3 = phi i32 [ %434, %"for bounded_input.s0.x.x.rebased1" ], [ 0, %"for bounded_input.s0.x.x.rebased1.preheader" ]
  %niter102 = phi i32 [ %niter102.nsub.1, %"for bounded_input.s0.x.x.rebased1" ], [ %unroll_iter101, %"for bounded_input.s0.x.x.rebased1.preheader" ]
  %347 = add nsw i32 %bounded_input.s0.x.x.rebased3, %t1345
  %348 = shl nsw i32 %347, 7
  %b45 = add nsw i32 %348, %t1332
  %349 = icmp slt i32 %a40, %b45
  %a45 = select i1 %349, i32 %a40, i32 %b45
  %350 = icmp sgt i32 %a45, 129
  %351 = select i1 %350, i32 %a45, i32 129
  %352 = add nsw i32 %351, %345
  %353 = getelementptr inbounds i8, i8* %62, i32 %352
  %354 = bitcast i8* %353 to <32 x i32>*
  %355 = load <32 x i32>, <32 x i32>* %354, align 1, !tbaa !97
  %356 = add nsw i32 %b45, -129
  ...
  %367 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %366, <32 x i32> %52) #12
  ...
  %386 = add nsw i32 %347, %346
  %387 = shl nsw i32 %386, 7
  %388 = getelementptr inbounds i8, i8* %bounded_input, i32 %387
  %389 = bitcast i8* %388 to <32 x i32>*
  store <32 x i32> %385, <32 x i32>* %389, align 128, !tbaa !100
  %390 = or i32 %bounded_input.s0.x.x.rebased3, 1
  %391 = add nsw i32 %390, %t1345
  %392 = shl nsw i32 %391, 7
  %b45.1 = add nsw i32 %392, %t1332
  %393 = icmp slt i32 %a40, %b45.1
  %a45.1 = select i1 %393, i32 %a40, i32 %b45.1
  %394 = icmp sgt i32 %a45.1, 129
  %395 = select i1 %394, i32 %a45.1, i32 129
  %396 = add nsw i32 %395, %345
  %397 = getelementptr inbounds i8, i8* %62, i32 %396
  %398 = bitcast i8* %397 to <32 x i32>*
  %399 = load <32 x i32>, <32 x i32>* %398, align 1, !tbaa !97
  %400 = add nsw i32 %b45.1, -129
  %401 = insertelement <128 x i32> undef, i32 %400, i32 0
  %402 = shufflevector <128 x i32> %401, <128 x i32> undef, <128 x i32> zeroinitializer
  %403 = add nsw <128 x i32> %402, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %404 = shufflevector <128 x i32> %403, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %405 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %404, <32 x i32> %52) #12
  %406 = shufflevector <128 x i32> %403, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %407 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %406, <32 x i32> %52) #12
  %408 = shufflevector <128 x i32> %403, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %409 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %408, <32 x i32> %52) #12
  %410 = shufflevector <128 x i32> %403, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %411 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %410, <32 x i32> %52) #12
  %412 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %405, <32 x i32> zeroinitializer) #12
  %413 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %407, <32 x i32> zeroinitializer) #12
  %414 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %409, <32 x i32> zeroinitializer) #12
  %415 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %411, <32 x i32> zeroinitializer) #12
  %416 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %413, <32 x i32> %412)
  %417 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %415, <32 x i32> %414)
  %418 = shufflevector <64 x i32> %416, <64 x i32> %417, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %419 = sub nsw i32 129, %395
  %420 = insertelement <128 x i32> undef, i32 %419, i32 0
  %421 = shufflevector <128 x i32> %420, <128 x i32> undef, <128 x i32> zeroinitializer
  %422 = add nsw <128 x i32> %418, %421
  %423 = trunc <128 x i32> %422 to <128 x i8>
  %424 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %399)
  %425 = bitcast <128 x i8> %423 to <32 x i32>
  %426 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %425, <32 x i32> %424, i32 0)
  %427 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %426, <32 x i32> %425, <32 x i32> %424, i32 1)
  %428 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %427, <32 x i32> %425, <32 x i32> %424, i32 2)
  %429 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %428, <32 x i32> %425, <32 x i32> %424, i32 3)
  %430 = add nsw i32 %391, %346
  %431 = shl nsw i32 %430, 7
  %432 = getelementptr inbounds i8, i8* %bounded_input, i32 %431
  %433 = bitcast i8* %432 to <32 x i32>*
  store <32 x i32> %429, <32 x i32>* %433, align 128, !tbaa !100
  %434 = add nuw nsw i32 %bounded_input.s0.x.x.rebased3, 2
  %niter102.nsub.1 = add i32 %niter102, -2
  %niter102.ncmp.1 = icmp eq i32 %niter102.nsub.1, 0
  br i1 %niter102.ncmp.1, label %"end for bounded_input.s0.x.x.rebased2.loopexit.unr-lcssa", label %"for bounded_input.s0.x.x.rebased1"
...
"end for bounded_input.s0.x.x.rebased2.loopexit.unr-lcssa": ; preds = %"for bounded_input.s0.x.x.rebased1", %"for bounded_input.s0.x.x.rebased1.preheader"
  %bounded_input.s0.x.x.rebased3.unr = phi i32 [ 0, %"for bounded_input.s0.x.x.rebased1.preheader" ], [ %434, %"for bounded_input.s0.x.x.rebased1" ]
  br i1 %lcmp.mod100.not, label %"end for bounded_input.s0.x.x.rebased2", label %"for bounded_input.s0.x.x.rebased1.epil"

"for bounded_input.s0.x.x.rebased1.epil":         ; preds = %"end for bounded_input.s0.x.x.rebased2.loopexit.unr-lcssa"
  %435 = add nsw i32 %bounded_input.s0.x.x.rebased3.unr, %t1345
  %436 = shl nsw i32 %435, 7
  %b45.epil = add nsw i32 %436, %t1332
  %437 = icmp slt i32 %a40, %b45.epil
  %a45.epil = select i1 %437, i32 %a40, i32 %b45.epil
  %438 = icmp sgt i32 %a45.epil, 129
  %439 = select i1 %438, i32 %a45.epil, i32 129
  %440 = add nsw i32 %439, %345
  %441 = getelementptr inbounds i8, i8* %62, i32 %440
  %442 = bitcast i8* %441 to <32 x i32>*
  %443 = load <32 x i32>, <32 x i32>* %442, align 1, !tbaa !97
  %444 = add nsw i32 %b45.epil, -129
  %445 = insertelement <128 x i32> undef, i32 %444, i32 0
  %446 = shufflevector <128 x i32> %445, <128 x i32> undef, <128 x i32> zeroinitializer
  %447 = add nsw <128 x i32> %446, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %448 = shufflevector <128 x i32> %447, <128 x i32> undef, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %449 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %448, <32 x i32> %52) #12
  %450 = shufflevector <128 x i32> %447, <128 x i32> undef, <32 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %451 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %450, <32 x i32> %52) #12
  %452 = shufflevector <128 x i32> %447, <128 x i32> undef, <32 x i32> <i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95>
  %453 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %452, <32 x i32> %52) #12
  %454 = shufflevector <128 x i32> %447, <128 x i32> undef, <32 x i32> <i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %455 = tail call <32 x i32> @llvm.hexagon.V6.vminw.128B(<32 x i32> %454, <32 x i32> %52) #12
  %456 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %449, <32 x i32> zeroinitializer) #12
  %457 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %451, <32 x i32> zeroinitializer) #12
  %458 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %453, <32 x i32> zeroinitializer) #12
  %459 = tail call <32 x i32> @llvm.hexagon.V6.vmaxw.128B(<32 x i32> %455, <32 x i32> zeroinitializer) #12
  %460 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %457, <32 x i32> %456)
  %461 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %459, <32 x i32> %458)
  %462 = shufflevector <64 x i32> %460, <64 x i32> %461, <128 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63, i32 64, i32 65, i32 66, i32 67, i32 68, i32 69, i32 70, i32 71, i32 72, i32 73, i32 74, i32 75, i32 76, i32 77, i32 78, i32 79, i32 80, i32 81, i32 82, i32 83, i32 84, i32 85, i32 86, i32 87, i32 88, i32 89, i32 90, i32 91, i32 92, i32 93, i32 94, i32 95, i32 96, i32 97, i32 98, i32 99, i32 100, i32 101, i32 102, i32 103, i32 104, i32 105, i32 106, i32 107, i32 108, i32 109, i32 110, i32 111, i32 112, i32 113, i32 114, i32 115, i32 116, i32 117, i32 118, i32 119, i32 120, i32 121, i32 122, i32 123, i32 124, i32 125, i32 126, i32 127>
  %463 = sub nsw i32 129, %439
  %464 = insertelement <128 x i32> undef, i32 %463, i32 0
  %465 = shufflevector <128 x i32> %464, <128 x i32> undef, <128 x i32> zeroinitializer
  %466 = add nsw <128 x i32> %462, %465
  %467 = trunc <128 x i32> %466 to <128 x i8>
  %468 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %443)
  %469 = bitcast <128 x i8> %467 to <32 x i32>
  %470 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.128B(<32 x i32> %469, <32 x i32> %468, i32 0)
  %471 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %470, <32 x i32> %469, <32 x i32> %468, i32 1)
  %472 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %471, <32 x i32> %469, <32 x i32> %468, i32 2)
  %473 = tail call <32 x i32> @llvm.hexagon.V6.vlutvvb.oracc.128B(<32 x i32> %472, <32 x i32> %469, <32 x i32> %468, i32 3)
  %474 = add nsw i32 %435, %346
  %475 = shl nsw i32 %474, 7
  %476 = getelementptr inbounds i8, i8* %bounded_input, i32 %475
  %477 = bitcast i8* %476 to <32 x i32>*
  store <32 x i32> %473, <32 x i32>* %477, align 128, !tbaa !100
...
"end for bounded_input.s0.x.x.rebased2":          ; preds = %"for bounded_input.s0.x.x.rebased1.epil", %"end for bounded_input.s0.x.x.rebased2.loopexit.unr-lcssa", %"end for bounded_input.s0.x.x.rebased"
  %478 = add nuw nsw i32 %bounded_input.s0.y.rebased, 1
  %.not84 = icmp eq i32 %478, %a31
  br i1 %.not84, label %"consume bounded_input", label %"for bounded_input.s0.y.rebased"

"consume bounded_input":                          ; preds = %"end for bounded_input.s0.x.x.rebased2", %after_bb
  %a49 = add nsw i32 %b11, 2
  %479 = icmp slt i32 %a49, %b129
  %a57 = select i1 %479, i32 %a49, i32 %b129
  %480 = icmp slt i32 %a3, %b94
  %a87 = select i1 %480, i32 %a3, i32 %b94
...
"for output.s0.x.x.preheader":                    ; preds = %"consume bounded_input"
  %a65 = sub nsw i32 %a23, %93
  %481 = icmp sgt i32 %a65, -1
  %482 = select i1 %481, i32 %a65, i32 -1
  %483 = add nsw i32 %482, 1
  %484 = mul i32 %56, %483
  %485 = icmp sgt i32 %a57, 1
  %486 = select i1 %485, i32 %a57, i32 1
  %487 = sub nsw i32 %486, %95
  %488 = mul i32 %57, %487
  %a61 = sub nsw i32 %93, %a23
  %489 = icmp sgt i32 %a61, 1
  %490 = select i1 %489, i32 %a61, i32 1
  %491 = mul i32 %57, %490
  %492 = mul nsw i32 %b11, %output.stride.1
  %493 = add nsw i32 %487, -1
  %494 = mul i32 %56, %493
  %a69 = add nsw i32 %b11, 3
  %495 = icmp slt i32 %a69, %b129
  %a68 = select i1 %495, i32 %a69, i32 %b129
  %496 = icmp sgt i32 %a68, 1
  %497 = select i1 %496, i32 %a68, i32 1
  %498 = sub nsw i32 %497, %95
  %499 = mul i32 %57, %498
  %a71 = add nsw i32 %b11, 1
  %500 = icmp slt i32 %a71, %b129
  %a70 = select i1 %500, i32 %a71, i32 %b129
  %501 = icmp sgt i32 %a70, 1
  %502 = select i1 %501, i32 %a70, i32 1
  %503 = sub nsw i32 %502, %95
  %504 = mul i32 %57, %503
  %505 = mul nsw i32 %a71, %output.stride.1
  %506 = add nsw i32 %498, -1
  %507 = mul i32 %56, %506
  %508 = icmp sgt i32 %a87, 1
  %509 = select i1 %508, i32 %a87, i32 1
  %510 = sub nsw i32 %509, %95
  %511 = mul i32 %57, %510
  %512 = mul nsw i32 %a49, %output.stride.1
  %513 = add nsw i32 %510, -1
  %514 = mul i32 %56, %513
  %a83 = add nsw i32 %b11, 5
  %515 = icmp slt i32 %a83, %b129
  %a82 = select i1 %515, i32 %a83, i32 %b129
  %516 = icmp sgt i32 %a82, 1
  %517 = select i1 %516, i32 %a82, i32 1
  %518 = sub nsw i32 %517, %95
  %519 = mul i32 %57, %518
  %520 = mul nsw i32 %a69, %output.stride.1
  br label %"for output.s0.x.x"

"for output.s0.x.x":                              ; preds = %"for output.s0.x.x.preheader", %"for output.s0.x.x"
  %output.s0.x.x = phi i32 [ %754, %"for output.s0.x.x" ], [ 0, %"for output.s0.x.x.preheader" ]
  %521 = shl nsw i32 %output.s0.x.x, 7
  %522 = sub nsw i32 %521, %t1332
  %523 = add nsw i32 %522, %484
  %524 = getelementptr inbounds i8, i8* %bounded_input, i32 %523
  %525 = getelementptr inbounds i8, i8* %524, i32 128
  %526 = bitcast i8* %525 to <32 x i32>*
  %t111247 = load <32 x i32>, <32 x i32>* %526, align 1, !tbaa !100
  %527 = add i32 %522, %t1344
  %t1113 = add i32 %527, %488
  %528 = getelementptr inbounds i8, i8* %bounded_input, i32 %t1113
  %529 = getelementptr inbounds i8, i8* %528, i32 128
  %530 = bitcast i8* %529 to <32 x i32>*
  %t111448 = load <32 x i32>, <32 x i32>* %530, align 1, !tbaa !100
  %t1115 = add i32 %527, %491
  %531 = getelementptr inbounds i8, i8* %bounded_input, i32 %t1115
  %532 = getelementptr inbounds i8, i8* %531, i32 128
  %533 = bitcast i8* %532 to <32 x i32>*
  %t111649 = load <32 x i32>, <32 x i32>* %533, align 1, !tbaa !100
  %534 = getelementptr inbounds i8, i8* %524, i32 129
  %535 = bitcast i8* %534 to <32 x i32>*
  %t111750 = load <32 x i32>, <32 x i32>* %535, align 1, !tbaa !100
  %536 = getelementptr inbounds i8, i8* %528, i32 129
  %537 = bitcast i8* %536 to <32 x i32>*
  %t111851 = load <32 x i32>, <32 x i32>* %537, align 1, !tbaa !100
  %538 = getelementptr inbounds i8, i8* %531, i32 129
  %539 = bitcast i8* %538 to <32 x i32>*
  %t111952 = load <32 x i32>, <32 x i32>* %539, align 1, !tbaa !100
  %540 = getelementptr inbounds i8, i8* %524, i32 130
  %541 = bitcast i8* %540 to <32 x i32>*
  %t112053 = load <32 x i32>, <32 x i32>* %541, align 1, !tbaa !100
  %542 = getelementptr inbounds i8, i8* %528, i32 130
  %543 = bitcast i8* %542 to <32 x i32>*
  %t112154 = load <32 x i32>, <32 x i32>* %543, align 1, !tbaa !100
  %544 = getelementptr inbounds i8, i8* %531, i32 130
  %545 = bitcast i8* %544 to <32 x i32>*
  %t112255 = load <32 x i32>, <32 x i32>* %545, align 1, !tbaa !100
  %546 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t111247, <32 x i32> %t111448) #12
  %547 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %546, <32 x i32> %t111649) #12
  %548 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t112053, <32 x i32> %t112154) #12
  %549 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %548, <32 x i32> %t112255) #12
  %550 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t111750, <32 x i32> %t111851) #12
  %551 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t111952, <32 x i32> %550) #12
  %552 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %551, <32 x i32> %549) #12
  %553 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %552, <32 x i32> %547) #12
  %554 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t111448, <32 x i32> %t111649) #12
  %555 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t111247, <32 x i32> %554) #12
  %556 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t111851, <32 x i32> %t111750) #12
  %557 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %556, <32 x i32> %t111952) #12
  %558 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t112154, <32 x i32> %t112053) #12
  %559 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t112255, <32 x i32> %558) #12
  %560 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %557, <32 x i32> %559) #12
  %561 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %555, <32 x i32> %560) #12
  %562 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t111649, <32 x i32> %t111247) #12
  %563 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %562, <32 x i32> %t111448) #12
  %564 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t111649, <32 x i32> %t111247) #12
  %565 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %563, <32 x i32> %564) #12
  %566 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t111952, <32 x i32> %t111750) #12
  %567 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %566, <32 x i32> %t111851) #12
  %568 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t111952, <32 x i32> %t111750) #12
  %569 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %567, <32 x i32> %568) #12
  %570 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %553, <32 x i32> %561) #12
  %571 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %553, <32 x i32> %561) #12
  %572 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %569, <32 x i32> %565) #12
  %573 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t112053, <32 x i32> %t112255) #12
  %574 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t112053, <32 x i32> %t112255) #12
  %575 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t112154, <32 x i32> %574) #12
  %576 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %573, <32 x i32> %575) #12
  %577 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %565, <32 x i32> %569) #12
  %578 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %577, <32 x i32> %576) #12
  %579 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %572, <32 x i32> %578) #12
  %580 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %579, <32 x i32> %571) #12
  %581 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %570, <32 x i32> %580) #12
  %582 = add nsw i32 %521, %492
  %583 = getelementptr inbounds i8, i8* %output, i32 %582
  %584 = bitcast i8* %583 to <32 x i32>*
  store <32 x i32> %581, <32 x i32>* %584, align 1, !tbaa !103
  %585 = add nsw i32 %522, %494
  %586 = getelementptr inbounds i8, i8* %bounded_input, i32 %585
  %587 = getelementptr inbounds i8, i8* %586, i32 128
  %588 = bitcast i8* %587 to <32 x i32>*
  %t113356 = load <32 x i32>, <32 x i32>* %588, align 1, !tbaa !100
  %t1134 = add i32 %527, %499
  %589 = getelementptr inbounds i8, i8* %bounded_input, i32 %t1134
  %590 = getelementptr inbounds i8, i8* %589, i32 128
  %591 = bitcast i8* %590 to <32 x i32>*
  %t113557 = load <32 x i32>, <32 x i32>* %591, align 1, !tbaa !100
  %t1136 = add i32 %527, %504
  %592 = getelementptr inbounds i8, i8* %bounded_input, i32 %t1136
  %593 = getelementptr inbounds i8, i8* %592, i32 128
  %594 = bitcast i8* %593 to <32 x i32>*
  %t113758 = load <32 x i32>, <32 x i32>* %594, align 1, !tbaa !100
  %595 = getelementptr inbounds i8, i8* %586, i32 129
  %596 = bitcast i8* %595 to <32 x i32>*
  %t113859 = load <32 x i32>, <32 x i32>* %596, align 1, !tbaa !100
  %597 = getelementptr inbounds i8, i8* %589, i32 129
  %598 = bitcast i8* %597 to <32 x i32>*
  %t113960 = load <32 x i32>, <32 x i32>* %598, align 1, !tbaa !100
  %599 = getelementptr inbounds i8, i8* %592, i32 129
  %600 = bitcast i8* %599 to <32 x i32>*
  %t114061 = load <32 x i32>, <32 x i32>* %600, align 1, !tbaa !100
  %601 = getelementptr inbounds i8, i8* %586, i32 130
  %602 = bitcast i8* %601 to <32 x i32>*
  %t114162 = load <32 x i32>, <32 x i32>* %602, align 1, !tbaa !100
  %603 = getelementptr inbounds i8, i8* %589, i32 130
  %604 = bitcast i8* %603 to <32 x i32>*
  %t114263 = load <32 x i32>, <32 x i32>* %604, align 1, !tbaa !100
  %605 = getelementptr inbounds i8, i8* %592, i32 130
  %606 = bitcast i8* %605 to <32 x i32>*
  %t114364 = load <32 x i32>, <32 x i32>* %606, align 1, !tbaa !100
  %607 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t113356, <32 x i32> %t113557) #12
  %608 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %607, <32 x i32> %t113758) #12
  %609 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t114162, <32 x i32> %t114263) #12
  %610 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %609, <32 x i32> %t114364) #12
  %611 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t113859, <32 x i32> %t113960) #12
  %612 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t114061, <32 x i32> %611) #12
  %613 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %612, <32 x i32> %610) #12
  %614 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %613, <32 x i32> %608) #12
  %615 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t113557, <32 x i32> %t113758) #12
  %616 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t113356, <32 x i32> %615) #12
  %617 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t113960, <32 x i32> %t113859) #12
  %618 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %617, <32 x i32> %t114061) #12
  %619 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t114263, <32 x i32> %t114162) #12
  %620 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t114364, <32 x i32> %619) #12
  %621 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %618, <32 x i32> %620) #12
  %622 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %616, <32 x i32> %621) #12
  %623 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t113758, <32 x i32> %t113356) #12
  %624 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %623, <32 x i32> %t113557) #12
  %625 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t113758, <32 x i32> %t113356) #12
  %626 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %624, <32 x i32> %625) #12
  %627 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t114061, <32 x i32> %t113859) #12
  %628 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %627, <32 x i32> %t113960) #12
  %629 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t114061, <32 x i32> %t113859) #12
  %630 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %628, <32 x i32> %629) #12
  %631 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %614, <32 x i32> %622) #12
  %632 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %614, <32 x i32> %622) #12
  %633 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %630, <32 x i32> %626) #12
  %634 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t114162, <32 x i32> %t114364) #12
  %635 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t114162, <32 x i32> %t114364) #12
  %636 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t114263, <32 x i32> %635) #12
  %637 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %634, <32 x i32> %636) #12
  %638 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %626, <32 x i32> %630) #12
  %639 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %638, <32 x i32> %637) #12
  %640 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %633, <32 x i32> %639) #12
  %641 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %640, <32 x i32> %632) #12
  %642 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %631, <32 x i32> %641) #12
  %643 = add nsw i32 %521, %505
  %644 = getelementptr inbounds i8, i8* %output, i32 %643
  %645 = bitcast i8* %644 to <32 x i32>*
  store <32 x i32> %642, <32 x i32>* %645, align 1, !tbaa !103
  %646 = add nsw i32 %522, %507
  %647 = getelementptr inbounds i8, i8* %bounded_input, i32 %646
  %648 = getelementptr inbounds i8, i8* %647, i32 128
  %649 = bitcast i8* %648 to <32 x i32>*
  %t115465 = load <32 x i32>, <32 x i32>* %649, align 1, !tbaa !100
  %t1155 = add i32 %527, %511
  %650 = getelementptr inbounds i8, i8* %bounded_input, i32 %t1155
  %651 = getelementptr inbounds i8, i8* %650, i32 128
  %652 = bitcast i8* %651 to <32 x i32>*
  %t115666 = load <32 x i32>, <32 x i32>* %652, align 1, !tbaa !100
  %653 = getelementptr inbounds i8, i8* %647, i32 129
  %654 = bitcast i8* %653 to <32 x i32>*
  %t115968 = load <32 x i32>, <32 x i32>* %654, align 1, !tbaa !100
  %655 = getelementptr inbounds i8, i8* %650, i32 129
  %656 = bitcast i8* %655 to <32 x i32>*
  %t116069 = load <32 x i32>, <32 x i32>* %656, align 1, !tbaa !100
  %657 = getelementptr inbounds i8, i8* %647, i32 130
  %658 = bitcast i8* %657 to <32 x i32>*
  %t116271 = load <32 x i32>, <32 x i32>* %658, align 1, !tbaa !100
  %659 = getelementptr inbounds i8, i8* %650, i32 130
  %660 = bitcast i8* %659 to <32 x i32>*
  %t116372 = load <32 x i32>, <32 x i32>* %660, align 1, !tbaa !100
  %661 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t115465, <32 x i32> %t115666) #12
  %662 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %661, <32 x i32> %t111448) #12
  %663 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t116271, <32 x i32> %t116372) #12
  %664 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %663, <32 x i32> %t112154) #12
  %665 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t115968, <32 x i32> %t116069) #12
  %666 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t111851, <32 x i32> %665) #12
  %667 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %666, <32 x i32> %664) #12
  %668 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %667, <32 x i32> %662) #12
  %669 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t115666, <32 x i32> %t111448) #12
  %670 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t115465, <32 x i32> %669) #12
  %671 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t116069, <32 x i32> %t115968) #12
  %672 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %671, <32 x i32> %t111851) #12
  %673 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t116372, <32 x i32> %t116271) #12
  %674 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t112154, <32 x i32> %673) #12
  %675 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %672, <32 x i32> %674) #12
  %676 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %670, <32 x i32> %675) #12
  %677 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t111448, <32 x i32> %t115465) #12
  %678 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %677, <32 x i32> %t115666) #12
  %679 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t111448, <32 x i32> %t115465) #12
  %680 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %678, <32 x i32> %679) #12
  %681 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t111851, <32 x i32> %t115968) #12
  %682 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %681, <32 x i32> %t116069) #12
  %683 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t111851, <32 x i32> %t115968) #12
  %684 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %682, <32 x i32> %683) #12
  %685 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %668, <32 x i32> %676) #12
  %686 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %668, <32 x i32> %676) #12
  %687 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %684, <32 x i32> %680) #12
  %688 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t116271, <32 x i32> %t112154) #12
  %689 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t116271, <32 x i32> %t112154) #12
  %690 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t116372, <32 x i32> %689) #12
  %691 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %688, <32 x i32> %690) #12
  %692 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %680, <32 x i32> %684) #12
  %693 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %692, <32 x i32> %691) #12
  %694 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %687, <32 x i32> %693) #12
  %695 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %694, <32 x i32> %686) #12
  %696 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %685, <32 x i32> %695) #12
  %697 = add nsw i32 %521, %512
  %698 = getelementptr inbounds i8, i8* %output, i32 %697
  %699 = bitcast i8* %698 to <32 x i32>*
  store <32 x i32> %696, <32 x i32>* %699, align 1, !tbaa !103
  %700 = add nsw i32 %522, %514
  %701 = getelementptr inbounds i8, i8* %bounded_input, i32 %700
  %702 = getelementptr inbounds i8, i8* %701, i32 128
  %703 = bitcast i8* %702 to <32 x i32>*
  %t117474 = load <32 x i32>, <32 x i32>* %703, align 1, !tbaa !100
  %t1176 = add i32 %527, %519
  %704 = getelementptr inbounds i8, i8* %bounded_input, i32 %t1176
  %705 = getelementptr inbounds i8, i8* %704, i32 128
  %706 = bitcast i8* %705 to <32 x i32>*
  %t117775 = load <32 x i32>, <32 x i32>* %706, align 1, !tbaa !100
  %707 = getelementptr inbounds i8, i8* %701, i32 129
  %708 = bitcast i8* %707 to <32 x i32>*
  %t118077 = load <32 x i32>, <32 x i32>* %708, align 1, !tbaa !100
  %709 = getelementptr inbounds i8, i8* %704, i32 129
  %710 = bitcast i8* %709 to <32 x i32>*
  %t118178 = load <32 x i32>, <32 x i32>* %710, align 1, !tbaa !100
  %711 = getelementptr inbounds i8, i8* %701, i32 130
  %712 = bitcast i8* %711 to <32 x i32>*
  %t118380 = load <32 x i32>, <32 x i32>* %712, align 1, !tbaa !100
  %713 = getelementptr inbounds i8, i8* %704, i32 130
  %714 = bitcast i8* %713 to <32 x i32>*
  %t118481 = load <32 x i32>, <32 x i32>* %714, align 1, !tbaa !100
  %715 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t117474, <32 x i32> %t117775) #12
  %716 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %715, <32 x i32> %t113557) #12
  %717 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t118380, <32 x i32> %t118481) #12
  %718 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %717, <32 x i32> %t114263) #12
  %719 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t118077, <32 x i32> %t118178) #12
  %720 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t113960, <32 x i32> %719) #12
  %721 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %720, <32 x i32> %718) #12
  %722 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %721, <32 x i32> %716) #12
  %723 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t117775, <32 x i32> %t113557) #12
  %724 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t117474, <32 x i32> %723) #12
  %725 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t118178, <32 x i32> %t118077) #12
  %726 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %725, <32 x i32> %t113960) #12
  %727 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t118481, <32 x i32> %t118380) #12
  %728 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t114263, <32 x i32> %727) #12
  %729 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %726, <32 x i32> %728) #12
  %730 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %724, <32 x i32> %729) #12
  %731 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t113557, <32 x i32> %t117474) #12
  %732 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %731, <32 x i32> %t117775) #12
  %733 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t113557, <32 x i32> %t117474) #12
  %734 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %732, <32 x i32> %733) #12
  %735 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t113960, <32 x i32> %t118077) #12
  %736 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %735, <32 x i32> %t118178) #12
  %737 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t113960, <32 x i32> %t118077) #12
  %738 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %736, <32 x i32> %737) #12
  %739 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %722, <32 x i32> %730) #12
  %740 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %722, <32 x i32> %730) #12
  %741 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %738, <32 x i32> %734) #12
  %742 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t118380, <32 x i32> %t114263) #12
  %743 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t118380, <32 x i32> %t114263) #12
  %744 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t118481, <32 x i32> %743) #12
  %745 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %742, <32 x i32> %744) #12
  %746 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %734, <32 x i32> %738) #12
  %747 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %746, <32 x i32> %745) #12
  %748 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %741, <32 x i32> %747) #12
  %749 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %748, <32 x i32> %740) #12
  %750 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %739, <32 x i32> %749) #12
  %751 = add nsw i32 %521, %520
  %752 = getelementptr inbounds i8, i8* %output, i32 %751
  %753 = bitcast i8* %752 to <32 x i32>*
  store <32 x i32> %750, <32 x i32>* %753, align 1, !tbaa !103
  %754 = add nuw nsw i32 %output.s0.x.x, 1
  %.not83 = icmp eq i32 %754, %t1328
  br i1 %.not83, label %"end for output.s0.x.x", label %"for output.s0.x.x"
...
"for output.s0.x.x4.preheader":                   ; preds = %"end for output.s0.x.x"
  %a107 = sub nsw i32 %a23, %93
  %755 = icmp sgt i32 %a107, -1
  %756 = select i1 %755, i32 %a107, i32 -1
  %757 = add nsw i32 %756, 1
  %758 = mul i32 %57, %757
  %759 = add nsw i32 %758, %t1329
  %760 = getelementptr inbounds i8, i8* %bounded_input, i32 %759
  %761 = getelementptr inbounds i8, i8* %760, i32 -128
  %762 = bitcast i8* %761 to <32 x i32>*
  %t119510 = load <32 x i32>, <32 x i32>* %762, align 1, !tbaa !100
  %763 = icmp sgt i32 %a57, 1
  %764 = select i1 %763, i32 %a57, i32 1
  %765 = sub nsw i32 %764, %95
  %766 = mul i32 %57, %765
  %t1196 = add nsw i32 %766, %59
  %767 = getelementptr inbounds i8, i8* %bounded_input, i32 %t1196
  %768 = getelementptr inbounds i8, i8* %767, i32 -128
  %769 = bitcast i8* %768 to <32 x i32>*
  %t119711 = load <32 x i32>, <32 x i32>* %769, align 1, !tbaa !100
  %a103 = sub nsw i32 %93, %a23
  %770 = icmp sgt i32 %a103, 1
  %771 = select i1 %770, i32 %a103, i32 1
  %772 = mul i32 %57, %771
  %t1198 = add nsw i32 %772, %59
  %773 = getelementptr inbounds i8, i8* %bounded_input, i32 %t1198
  %774 = getelementptr inbounds i8, i8* %773, i32 -128
  %775 = bitcast i8* %774 to <32 x i32>*
  %t119912 = load <32 x i32>, <32 x i32>* %775, align 1, !tbaa !100
  %776 = getelementptr inbounds i8, i8* %760, i32 -127
  %777 = bitcast i8* %776 to <32 x i32>*
  %t120013 = load <32 x i32>, <32 x i32>* %777, align 1, !tbaa !100
  %778 = getelementptr inbounds i8, i8* %767, i32 -127
  %779 = bitcast i8* %778 to <32 x i32>*
  %t120114 = load <32 x i32>, <32 x i32>* %779, align 1, !tbaa !100
  %780 = getelementptr inbounds i8, i8* %773, i32 -127
  %781 = bitcast i8* %780 to <32 x i32>*
  %t120215 = load <32 x i32>, <32 x i32>* %781, align 1, !tbaa !100
  %782 = getelementptr inbounds i8, i8* %760, i32 -126
  %783 = bitcast i8* %782 to <32 x i32>*
  %t120316 = load <32 x i32>, <32 x i32>* %783, align 1, !tbaa !100
  %784 = getelementptr inbounds i8, i8* %767, i32 -126
  %785 = bitcast i8* %784 to <32 x i32>*
  %t120417 = load <32 x i32>, <32 x i32>* %785, align 1, !tbaa !100
  %786 = getelementptr inbounds i8, i8* %773, i32 -126
  %787 = bitcast i8* %786 to <32 x i32>*
  %t120518 = load <32 x i32>, <32 x i32>* %787, align 1, !tbaa !100
  %788 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t119510, <32 x i32> %t119711) #12
  %789 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %788, <32 x i32> %t119912) #12
  %790 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t120316, <32 x i32> %t120417) #12
  %791 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %790, <32 x i32> %t120518) #12
  %792 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t120013, <32 x i32> %t120114) #12
  %793 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t120215, <32 x i32> %792) #12
  %794 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %793, <32 x i32> %791) #12
  %795 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %794, <32 x i32> %789) #12
  %796 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t119711, <32 x i32> %t119912) #12
  %797 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t119510, <32 x i32> %796) #12
  %798 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t120114, <32 x i32> %t120013) #12
  %799 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %798, <32 x i32> %t120215) #12
  %800 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t120417, <32 x i32> %t120316) #12
  %801 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t120518, <32 x i32> %800) #12
  %802 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %799, <32 x i32> %801) #12
  %803 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %797, <32 x i32> %802) #12
  %804 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t119912, <32 x i32> %t119510) #12
  %805 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %804, <32 x i32> %t119711) #12
  %806 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t119912, <32 x i32> %t119510) #12
  %807 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %805, <32 x i32> %806) #12
  %808 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t120215, <32 x i32> %t120013) #12
  %809 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %808, <32 x i32> %t120114) #12
  %810 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t120215, <32 x i32> %t120013) #12
  %811 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %809, <32 x i32> %810) #12
  %812 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %795, <32 x i32> %803) #12
  %813 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %795, <32 x i32> %803) #12
  %814 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %811, <32 x i32> %807) #12
  %815 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t120316, <32 x i32> %t120518) #12
  %816 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t120316, <32 x i32> %t120518) #12
  %817 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t120417, <32 x i32> %816) #12
  %818 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %815, <32 x i32> %817) #12
  %819 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %807, <32 x i32> %811) #12
  %820 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %819, <32 x i32> %818) #12
  %821 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %814, <32 x i32> %820) #12
  %822 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %821, <32 x i32> %813) #12
  %823 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %812, <32 x i32> %822) #12
  %824 = mul nsw i32 %b11, %output.stride.1
  %825 = add nsw i32 %824, %output.extent.0
  %826 = getelementptr inbounds i8, i8* %63, i32 %825
  %827 = bitcast i8* %826 to <32 x i32>*
  %828 = add nsw i32 %765, -1
  %829 = mul i32 %57, %828
  ...
  %t121519 = load <32 x i32>, <32 x i32>* %833, align 1, !tbaa !100
  %a111 = add nsw i32 %b11, 3
  %834 = icmp slt i32 %a111, %b129
  %a110 = select i1 %834, i32 %a111, i32 %b129
  %835 = icmp sgt i32 %a110, 1
  %836 = select i1 %835, i32 %a110, i32 1
  %837 = sub nsw i32 %836, %95
  %838 = mul i32 %57, %837
  %t1216 = add nsw i32 %838, %59
  %839 = getelementptr inbounds i8, i8* %bounded_input, i32 %t1216
  %840 = getelementptr inbounds i8, i8* %839, i32 -128
  %841 = bitcast i8* %840 to <32 x i32>*
  %t121720 = load <32 x i32>, <32 x i32>* %841, align 1, !tbaa !100
  %a113 = add nsw i32 %b11, 1
  %842 = icmp slt i32 %a113, %b129
  %a112 = select i1 %842, i32 %a113, i32 %b129
  %843 = icmp sgt i32 %a112, 1
  %844 = select i1 %843, i32 %a112, i32 1
  %845 = sub nsw i32 %844, %95
  %846 = mul i32 %57, %845
  %t1218 = add nsw i32 %846, %59
  %847 = getelementptr inbounds i8, i8* %bounded_input, i32 %t1218
  %848 = getelementptr inbounds i8, i8* %847, i32 -128
  %849 = bitcast i8* %848 to <32 x i32>*
  %t121921 = load <32 x i32>, <32 x i32>* %849, align 1, !tbaa !100
  %850 = getelementptr inbounds i8, i8* %831, i32 -127
  %851 = bitcast i8* %850 to <32 x i32>*
  %t122022 = load <32 x i32>, <32 x i32>* %851, align 1, !tbaa !100
  %852 = getelementptr inbounds i8, i8* %839, i32 -127
  %853 = bitcast i8* %852 to <32 x i32>*
  %t122123 = load <32 x i32>, <32 x i32>* %853, align 1, !tbaa !100
  %854 = getelementptr inbounds i8, i8* %847, i32 -127
  %855 = bitcast i8* %854 to <32 x i32>*
  %t122224 = load <32 x i32>, <32 x i32>* %855, align 1, !tbaa !100
  %856 = getelementptr inbounds i8, i8* %831, i32 -126
  %857 = bitcast i8* %856 to <32 x i32>*
  %t122325 = load <32 x i32>, <32 x i32>* %857, align 1, !tbaa !100
  %858 = getelementptr inbounds i8, i8* %839, i32 -126
  %859 = bitcast i8* %858 to <32 x i32>*
  %t122426 = load <32 x i32>, <32 x i32>* %859, align 1, !tbaa !100
  %860 = getelementptr inbounds i8, i8* %847, i32 -126
  %861 = bitcast i8* %860 to <32 x i32>*
  %t122527 = load <32 x i32>, <32 x i32>* %861, align 1, !tbaa !100
  %862 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t121519, <32 x i32> %t121720) #12
  %863 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %862, <32 x i32> %t121921) #12
  %864 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t122325, <32 x i32> %t122426) #12
  %865 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %864, <32 x i32> %t122527) #12
  %866 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t122022, <32 x i32> %t122123) #12
  %867 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t122224, <32 x i32> %866) #12
  %868 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %867, <32 x i32> %865) #12
  %869 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %868, <32 x i32> %863) #12
  %870 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t121720, <32 x i32> %t121921) #12
  %871 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t121519, <32 x i32> %870) #12
  %872 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t122123, <32 x i32> %t122022) #12
  %873 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %872, <32 x i32> %t122224) #12
  %874 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t122426, <32 x i32> %t122325) #12
  %875 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t122527, <32 x i32> %874) #12
  %876 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %873, <32 x i32> %875) #12
  %877 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %871, <32 x i32> %876) #12
  %878 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t121921, <32 x i32> %t121519) #12
  %879 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %878, <32 x i32> %t121720) #12
  %880 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t121921, <32 x i32> %t121519) #12
  %881 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %879, <32 x i32> %880) #12
  %882 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t122224, <32 x i32> %t122022) #12
  %883 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %882, <32 x i32> %t122123) #12
  %884 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t122224, <32 x i32> %t122022) #12
  %885 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %883, <32 x i32> %884) #12
  %886 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %869, <32 x i32> %877) #12
  %887 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %869, <32 x i32> %877) #12
  %888 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %885, <32 x i32> %881) #12
  %889 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t122325, <32 x i32> %t122527) #12
  %890 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t122325, <32 x i32> %t122527) #12
  %891 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t122426, <32 x i32> %890) #12
  %892 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %889, <32 x i32> %891) #12
  %893 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %881, <32 x i32> %885) #12
  %894 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %893, <32 x i32> %892) #12
  %895 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %888, <32 x i32> %894) #12
  %896 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %895, <32 x i32> %887) #12
  %897 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %886, <32 x i32> %896) #12
  %898 = mul nsw i32 %a113, %output.stride.1
  %899 = add nsw i32 %898, %output.extent.0
  %900 = getelementptr inbounds i8, i8* %64, i32 %899
  %901 = bitcast i8* %900 to <32 x i32>*
  %902 = add nsw i32 %837, -1
  %903 = mul i32 %57, %902
  %904 = add nsw i32 %903, %t1329
  %905 = getelementptr inbounds i8, i8* %bounded_input, i32 %904
  %906 = getelementptr inbounds i8, i8* %905, i32 -128
  %907 = bitcast i8* %906 to <32 x i32>*
  %t123528 = load <32 x i32>, <32 x i32>* %907, align 1, !tbaa !100
  %908 = icmp sgt i32 %a87, 1
  %909 = select i1 %908, i32 %a87, i32 1
  %910 = sub nsw i32 %909, %95
  %911 = mul i32 %57, %910
  %t1236 = add nsw i32 %911, %59
  %912 = getelementptr inbounds i8, i8* %bounded_input, i32 %t1236
  %913 = getelementptr inbounds i8, i8* %912, i32 -128
  %914 = bitcast i8* %913 to <32 x i32>*
  %t123729 = load <32 x i32>, <32 x i32>* %914, align 1, !tbaa !100
  %915 = getelementptr inbounds i8, i8* %905, i32 -127
  %916 = bitcast i8* %915 to <32 x i32>*
  %t124031 = load <32 x i32>, <32 x i32>* %916, align 1, !tbaa !100
  %917 = getelementptr inbounds i8, i8* %912, i32 -127
  %918 = bitcast i8* %917 to <32 x i32>*
  %t124132 = load <32 x i32>, <32 x i32>* %918, align 1, !tbaa !100
  %919 = getelementptr inbounds i8, i8* %905, i32 -126
  %920 = bitcast i8* %919 to <32 x i32>*
  %t124334 = load <32 x i32>, <32 x i32>* %920, align 1, !tbaa !100
  %921 = getelementptr inbounds i8, i8* %912, i32 -126
  %922 = bitcast i8* %921 to <32 x i32>*
  %t124435 = load <32 x i32>, <32 x i32>* %922, align 1, !tbaa !100
  %923 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t123528, <32 x i32> %t123729) #12
  %924 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %923, <32 x i32> %t119711) #12
  %925 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t124334, <32 x i32> %t124435) #12
  %926 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %925, <32 x i32> %t120417) #12
  %927 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t124031, <32 x i32> %t124132) #12
  %928 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t120114, <32 x i32> %927) #12
  %929 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %928, <32 x i32> %926) #12
  %930 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %929, <32 x i32> %924) #12
  %931 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t123729, <32 x i32> %t119711) #12
  %932 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t123528, <32 x i32> %931) #12
  %933 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t124132, <32 x i32> %t124031) #12
  %934 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %933, <32 x i32> %t120114) #12
  %935 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t124435, <32 x i32> %t124334) #12
  %936 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t120417, <32 x i32> %935) #12
  %937 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %934, <32 x i32> %936) #12
  %938 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %932, <32 x i32> %937) #12
  %939 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t119711, <32 x i32> %t123528) #12
  %940 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %939, <32 x i32> %t123729) #12
  %941 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t119711, <32 x i32> %t123528) #12
  %942 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %940, <32 x i32> %941) #12
  %943 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t120114, <32 x i32> %t124031) #12
  %944 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %943, <32 x i32> %t124132) #12
  %945 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t120114, <32 x i32> %t124031) #12
  %946 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %944, <32 x i32> %945) #12
  %947 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %930, <32 x i32> %938) #12
  %948 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %930, <32 x i32> %938) #12
  %949 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %946, <32 x i32> %942) #12
  %950 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t124334, <32 x i32> %t120417) #12
  %951 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t124334, <32 x i32> %t120417) #12
  %952 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t124435, <32 x i32> %951) #12
  %953 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %950, <32 x i32> %952) #12
  %954 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %942, <32 x i32> %946) #12
  %955 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %954, <32 x i32> %953) #12
  %956 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %949, <32 x i32> %955) #12
  %957 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %956, <32 x i32> %948) #12
  %958 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %947, <32 x i32> %957) #12
  %959 = mul nsw i32 %a49, %output.stride.1
  %960 = add nsw i32 %959, %output.extent.0
  %961 = getelementptr inbounds i8, i8* %65, i32 %960
  %962 = bitcast i8* %961 to <32 x i32>*
  %963 = add nsw i32 %910, -1
  %964 = mul i32 %57, %963
  %965 = add nsw i32 %964, %t1329
  %966 = getelementptr inbounds i8, i8* %bounded_input, i32 %965
  %967 = getelementptr inbounds i8, i8* %966, i32 -128
  %968 = bitcast i8* %967 to <32 x i32>*
  %t125437 = load <32 x i32>, <32 x i32>* %968, align 1, !tbaa !100
  %a125 = add nsw i32 %b11, 5
  %969 = icmp slt i32 %a125, %b129
  %a124 = select i1 %969, i32 %a125, i32 %b129
  %970 = icmp sgt i32 %a124, 1
  %971 = select i1 %970, i32 %a124, i32 1
  %972 = sub nsw i32 %971, %95
  %973 = mul i32 %57, %972
  %t1256 = add nsw i32 %973, %59
  %974 = getelementptr inbounds i8, i8* %bounded_input, i32 %t1256
  %975 = getelementptr inbounds i8, i8* %974, i32 -128
  %976 = bitcast i8* %975 to <32 x i32>*
  %t125738 = load <32 x i32>, <32 x i32>* %976, align 1, !tbaa !100
  %977 = getelementptr inbounds i8, i8* %966, i32 -127
  %978 = bitcast i8* %977 to <32 x i32>*
  %t126040 = load <32 x i32>, <32 x i32>* %978, align 1, !tbaa !100
  %979 = getelementptr inbounds i8, i8* %974, i32 -127
  %980 = bitcast i8* %979 to <32 x i32>*
  %t126141 = load <32 x i32>, <32 x i32>* %980, align 1, !tbaa !100
  %981 = getelementptr inbounds i8, i8* %966, i32 -126
  %982 = bitcast i8* %981 to <32 x i32>*
  %t126343 = load <32 x i32>, <32 x i32>* %982, align 1, !tbaa !100
  %983 = getelementptr inbounds i8, i8* %974, i32 -126
  %984 = bitcast i8* %983 to <32 x i32>*
  %t126444 = load <32 x i32>, <32 x i32>* %984, align 1, !tbaa !100
  %985 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t125437, <32 x i32> %t125738) #12
  %986 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %985, <32 x i32> %t121720) #12
  %987 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t126343, <32 x i32> %t126444) #12
  %988 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %987, <32 x i32> %t122426) #12
  %989 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t126040, <32 x i32> %t126141) #12
  %990 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t122123, <32 x i32> %989) #12
  %991 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %990, <32 x i32> %988) #12
  %992 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %991, <32 x i32> %986) #12
  %993 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t125738, <32 x i32> %t121720) #12
  %994 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t125437, <32 x i32> %993) #12
  %995 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t126141, <32 x i32> %t126040) #12
  %996 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %995, <32 x i32> %t122123) #12
  %997 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t126444, <32 x i32> %t126343) #12
  %998 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t122426, <32 x i32> %997) #12
  %999 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %996, <32 x i32> %998) #12
  %1000 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %994, <32 x i32> %999) #12
  %1001 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t121720, <32 x i32> %t125437) #12
  %1002 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1001, <32 x i32> %t125738) #12
  %1003 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t121720, <32 x i32> %t125437) #12
  %1004 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %1002, <32 x i32> %1003) #12
  %1005 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t122123, <32 x i32> %t126040) #12
  %1006 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1005, <32 x i32> %t126141) #12
  %1007 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t122123, <32 x i32> %t126040) #12
  %1008 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %1006, <32 x i32> %1007) #12
  %1009 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %992, <32 x i32> %1000) #12
  %1010 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %992, <32 x i32> %1000) #12
  %1011 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1008, <32 x i32> %1004) #12
  %1012 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t126343, <32 x i32> %t122426) #12
  %1013 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %t126343, <32 x i32> %t122426) #12
  %1014 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %t126444, <32 x i32> %1013) #12
  %1015 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %1012, <32 x i32> %1014) #12
  %1016 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %1004, <32 x i32> %1008) #12
  %1017 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1016, <32 x i32> %1015) #12
  %1018 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %1011, <32 x i32> %1017) #12
  %1019 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1018, <32 x i32> %1010) #12
  %1020 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %1009, <32 x i32> %1019) #12
  %1021 = mul nsw i32 %a111, %output.stride.1
  %1022 = add nsw i32 %1021, %output.extent.0
  %1023 = getelementptr inbounds i8, i8* %66, i32 %1022
  %1024 = bitcast i8* %1023 to <32 x i32>*
  br i1 %75, label %if.then.i90.loopexit.unr-lcssa, label %"for output.s0.x.x4"

"for output.s0.x.x4":                             ; preds = %"for output.s0.x.x4.preheader", %"for output.s0.x.x4"
  %niter107 = phi i32 [ %niter107.nsub.7, %"for output.s0.x.x4" ], [ %unroll_iter106, %"for output.s0.x.x4.preheader" ]
  store <32 x i32> %823, <32 x i32>* %827, align 1, !tbaa !103
  store <32 x i32> %897, <32 x i32>* %901, align 1, !tbaa !103
  store <32 x i32> %958, <32 x i32>* %962, align 1, !tbaa !103
  store <32 x i32> %1020, <32 x i32>* %1024, align 1, !tbaa !103
  store <32 x i32> %823, <32 x i32>* %827, align 1, !tbaa !103
  store <32 x i32> %897, <32 x i32>* %901, align 1, !tbaa !103
  store <32 x i32> %958, <32 x i32>* %962, align 1, !tbaa !103
  store <32 x i32> %1020, <32 x i32>* %1024, align 1, !tbaa !103
  ...
  store <32 x i32> %958, <32 x i32>* %962, align 1, !tbaa !103
  store <32 x i32> %1020, <32 x i32>* %1024, align 1, !tbaa !103
  %niter107.nsub.7 = add i32 %niter107, -8
  %niter107.ncmp.7 = icmp eq i32 %niter107.nsub.7, 0
  br i1 %niter107.ncmp.7, label %if.then.i90.loopexit.unr-lcssa, label %"for output.s0.x.x4"

"end for output.s0.x.x5":                         ; preds = %"end for output.s0.x.x"
  %tobool.not.i89.not = icmp eq i8* %bounded_input, null
  br i1 %tobool.not.i89.not, label %call_destructor.exit91, label %if.then.i90

if.then.i90.loopexit.unr-lcssa:                   ; preds = %"for output.s0.x.x4", %"for output.s0.x.x4.preheader"
  br i1 %lcmp.mod105.not, label %if.then.i90, label %"for output.s0.x.x4.epil"

"for output.s0.x.x4.epil":                        ; preds = %if.then.i90.loopexit.unr-lcssa, %"for output.s0.x.x4.epil"
  %epil.iter104 = phi i32 [ %epil.iter104.sub, %"for output.s0.x.x4.epil" ], [ %xtraiter103, %if.then.i90.loopexit.unr-lcssa ]
  store <32 x i32> %823, <32 x i32>* %827, align 1, !tbaa !103
  store <32 x i32> %897, <32 x i32>* %901, align 1, !tbaa !103
  store <32 x i32> %958, <32 x i32>* %962, align 1, !tbaa !103
  store <32 x i32> %1020, <32 x i32>* %1024, align 1, !tbaa !103
  %epil.iter104.sub = add i32 %epil.iter104, -1
  %epil.iter104.cmp.not = icmp eq i32 %epil.iter104.sub, 0
  br i1 %epil.iter104.cmp.not, label %if.then.i90, label %"for output.s0.x.x4.epil", !llvm.loop !105

if.then.i90:                                      ; preds = %if.then.i90.loopexit.unr-lcssa, %"for output.s0.x.x4.epil", %"end for output.s0.x.x5"
  tail call void @halide_free(i8* %__user_context, i8* nonnull %bounded_input) #15
  br label %call_destructor.exit91

call_destructor.exit91:                           ; preds = %"end for output.s0.x.x5", %if.then.i90
  %1025 = add nuw nsw i32 %output.s0.y.y.y, 1
  %.not9 = icmp eq i32 %1025, 128
...
entry:
  ...
  %call4.i = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @median3x3_hvx128_par_for_output_s0_y_y_v1, i32 0, i32 %60, i8* nonnull %61) #15
  ret i32 0
}
...
entry:
  ...
  %6 = tail call i32 @median3x3_hvx128(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #17
  ret i32 0
}
...
define <128 x i8> @hydride.node.median3x3_hvx_depth3.0(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  ...
  %3 = bitcast <128 x i8> %arg.2 to <32 x i32>
  %4 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %2, <32 x i32> %3)
  %5 = bitcast <128 x i8> %arg.6 to <32 x i32>
  %6 = bitcast <128 x i8> %arg.7 to <32 x i32>
  %7 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %5, <32 x i32> %6)
  %8 = bitcast <128 x i8> %arg.8 to <32 x i32>
  %9 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %7, <32 x i32> %8)
  %10 = bitcast <128 x i8> %arg.3 to <32 x i32>
  %11 = bitcast <128 x i8> %arg.4 to <32 x i32>
  %12 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %10, <32 x i32> %11)
  %13 = bitcast <128 x i8> %arg.5 to <32 x i32>
  %14 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %13, <32 x i32> %12)
  %15 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %14, <32 x i32> %9)
  %16 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %15, <32 x i32> %4)
  %17 = bitcast <32 x i32> %16 to <128 x i8>
  ret <128 x i8> %17
}

; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.1(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.8 to <32 x i32>
  %1 = bitcast <128 x i8> %arg.7 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
  %3 = bitcast <128 x i8> %arg.6 to <32 x i32>
  %4 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %3, <32 x i32> %2)
  %5 = bitcast <128 x i8> %arg to <32 x i32>
  %6 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %7 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %6, <32 x i32> %5)
  %8 = bitcast <128 x i8> %arg.2 to <32 x i32>
  %9 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %7, <32 x i32> %8)
  %10 = bitcast <128 x i8> %arg.3 to <32 x i32>
  %11 = bitcast <128 x i8> %arg.4 to <32 x i32>
  %12 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %11, <32 x i32> %10)
  %13 = bitcast <128 x i8> %arg.5 to <32 x i32>
  %14 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %13, <32 x i32> %12)
  %15 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %9, <32 x i32> %14)
  %16 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %4, <32 x i32> %15)
  %17 = bitcast <32 x i32> %16 to <128 x i8>
  ret <128 x i8> %17
}

; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.2(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
  %3 = bitcast <128 x i8> %arg.2 to <32 x i32>
  %4 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %2, <32 x i32> %3)
  %5 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %0, <32 x i32> %1)
  %6 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %4, <32 x i32> %5)
  %7 = bitcast <32 x i32> %6 to <128 x i8>
  ret <128 x i8> %7
}

; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.3(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.4(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
  %3 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %1, <32 x i32> %0)
  %4 = bitcast <128 x i8> %arg.2 to <32 x i32>
  %5 = bitcast <128 x i8> %arg.3 to <32 x i32>
  %6 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %5, <32 x i32> %4)
  %7 = bitcast <128 x i8> %arg.5 to <32 x i32>
  %8 = bitcast <128 x i8> %arg.4 to <32 x i32>
  %9 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %8, <32 x i32> %7)
  %10 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %8, <32 x i32> %7)
  %11 = bitcast <128 x i8> %arg.6 to <32 x i32>
  %12 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %11, <32 x i32> %10)
  %13 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %9, <32 x i32> %12)
  %14 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %4, <32 x i32> %5)
  %15 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %14, <32 x i32> %13)
  %16 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %6, <32 x i32> %15)
  %17 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %16, <32 x i32> %3)
  %18 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %2, <32 x i32> %17)
  %19 = bitcast <32 x i32> %18 to <128 x i8>
  ret <128 x i8> %19
}

; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.5(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.6(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.8 to <32 x i32>
  %1 = bitcast <128 x i8> %arg.7 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.7(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.8(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.9(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.10(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.11(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.8 to <32 x i32>
  %1 = bitcast <128 x i8> %arg.7 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.12(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.13(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.14(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.15(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.16(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.8 to <32 x i32>
  %1 = bitcast <128 x i8> %arg.7 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.17(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.18(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.19(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.20(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.21(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.8 to <32 x i32>
  %1 = bitcast <128 x i8> %arg.7 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.22(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.23(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.24(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.25(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.26(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.8 to <32 x i32>
  %1 = bitcast <128 x i8> %arg.7 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.27(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.28(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.29(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.30(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.31(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.8 to <32 x i32>
  %1 = bitcast <128 x i8> %arg.7 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.32(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.33(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.34(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.35(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.36(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6, <128 x i8> %arg.7, <128 x i8> %arg.8) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.8 to <32 x i32>
  %1 = bitcast <128 x i8> %arg.7 to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.37(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.38(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vmaxub.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.median3x3_hvx_depth3.39(<128 x i8> %arg, <128 x i8> %arg.1, <128 x i8> %arg.2, <128 x i8> %arg.3, <128 x i8> %arg.4, <128 x i8> %arg.5, <128 x i8> %arg.6) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %1 = bitcast <128 x i8> %arg to <32 x i32>
  %2 = tail call <32 x i32> @llvm.hexagon.V6.vminub.128B(<32 x i32> %1, <32 x i32> %0)
