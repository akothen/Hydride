...
; Function Attrs: nounwind
define i32 @max_pool_hvx128(%struct.halide_buffer_t* noalias nocapture readonly %input.buffer, i32 %stride_x, i32 %stride_y, i32 %b48, i32 %b45, i8 %b57, i8 %a55, %struct.halide_buffer_t* noalias nocapture readonly %output.buffer) local_unnamed_addr #10 {
entry:
  ...
  %0 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %dim.i, align 8, !tbaa !46
  %extent.i = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %0, i32 0, i32 1
  %1 = load i32, i32* %extent.i, align 4, !tbaa !49
  %min.i108 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %0, i32 1, i32 0
  %2 = load i32, i32* %min.i108, align 4, !tbaa !47
  %extent.i110 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %0, i32 1, i32 1
  %3 = load i32, i32* %extent.i110, align 4, !tbaa !49
  %min.i114 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %0, i32 2, i32 0
  %4 = load i32, i32* %min.i114, align 4, !tbaa !47
  %extent.i116 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %0, i32 2, i32 1
  %5 = load i32, i32* %extent.i116, align 4, !tbaa !49
  %min.i120 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %0, i32 3, i32 0
  %6 = load i32, i32* %min.i120, align 4, !tbaa !47
  %extent.i122 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %0, i32 3, i32 1
  %7 = load i32, i32* %extent.i122, align 4, !tbaa !49
  %host.i125 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i32 0, i32 2
  %8 = load i8*, i8** %host.i125, align 4, !tbaa !43
  %dim.i126 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i32 0, i32 6
  %9 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %dim.i126, align 8, !tbaa !46
  %min.i133 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %9, i32 1, i32 0
  %10 = load i32, i32* %min.i133, align 4, !tbaa !47
  %extent.i135 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %9, i32 1, i32 1
  %11 = load i32, i32* %extent.i135, align 4, !tbaa !49
  %stride.i137 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %9, i32 1, i32 2
  %12 = load i32, i32* %stride.i137, align 4, !tbaa !50
  %min.i139 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %9, i32 2, i32 0
  %13 = load i32, i32* %min.i139, align 4, !tbaa !47
  %extent.i141 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %9, i32 2, i32 1
  %14 = load i32, i32* %extent.i141, align 4, !tbaa !49
  %stride.i143 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %9, i32 2, i32 2
  %15 = load i32, i32* %stride.i143, align 4, !tbaa !50
  %stride.i149 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %9, i32 3, i32 2
  %16 = load i32, i32* %stride.i149, align 4, !tbaa !50
  %17 = icmp sgt i32 %1, 255
  br i1 %17, label %then_bb, label %next_bb

call_destructor.exit:                             ; preds = %"end for output.s0.y.rebased49.loopexit.split.us.us.us.split.us.us", %"end for output.s0.y.rebased29.loopexit.split.us.us.us", %"end for output.s0.y.rebased7.loopexit.split.us.us.us", %"end for output.s0.y.rebased", %"for output.s0.b.rebased45.preheader", %"for output.s0.b.rebased25.preheader", %"for output.s0.b.rebased3.preheader", %next_bb24, %then_bb23, %then_bb1, %then_bb
  tail call void @halide_qurt_hvx_unlock_as_destructor(i8* null, i8* nonnull inttoptr (i32 1 to i8*)) #14
  ret i32 0

then_bb:                                          ; preds = %entry
  %18 = icmp sgt i32 %7, 0
  br i1 %18, label %"for output.s0.b.rebased.preheader", label %call_destructor.exit, !prof !95

"for output.s0.b.rebased.preheader":              ; preds = %then_bb
  %.neg218 = mul i32 %12, %10
  %.neg217 = mul i32 %15, %13
  %.neg216 = mul i32 %16, %6
  %19 = icmp slt i32 %14, 1
  %20 = add nsw i32 %5, %4
  %21 = icmp slt i32 %11, 1
  %22 = add nsw i32 %3, %2
  %23 = add nuw nsw i32 %1, 255
  %24 = ashr i32 %23, 8
  %b8 = add nsw i32 %1, -256
  %25 = icmp ult i8 %a55, %b57
  %26 = select i1 %25, i8 %a55, i8 %b57
  %27 = insertelement <256 x i8> undef, i8 %26, i32 0
  %28 = shufflevector <256 x i8> %27, <256 x i8> undef, <256 x i32> zeroinitializer
  %29 = bitcast <256 x i8> %28 to <64 x i32>
  %reass.add228 = add i32 %.neg217, %.neg218
  %reass.add229 = add i32 %reass.add228, %.neg216
  %30 = add nsw i32 %24, -1
  %31 = add nsw i32 %24, -1
  %32 = add i32 %3, %2
  %33 = mul i32 %10, %stride_x
  %34 = sub i32 %32, %33
  %35 = sub i32 %2, %33
  %36 = add i32 %5, %4
  %37 = mul i32 %13, %stride_y
  %38 = sub i32 %36, %37
  %39 = sub i32 %4, %37
  %brmerge = or i1 %19, %21
  %xtraiter549 = and i32 %24, 7
  %40 = icmp ult i32 %30, 7
  %unroll_iter552 = and i32 %24, -8
  %lcmp.mod551.not = icmp eq i32 %xtraiter549, 0
  %xtraiter554 = and i32 %24, 7
  %41 = icmp ult i32 %31, 7
  %unroll_iter557 = and i32 %24, -8
  %lcmp.mod556.not = icmp eq i32 %xtraiter554, 0
  br label %"for output.s0.b.rebased"

next_bb:                                          ; preds = %entry
  %42 = icmp sgt i32 %1, 127
  br i1 %42, label %then_bb1, label %next_bb2

"for output.s0.b.rebased":                        ; preds = %"for output.s0.b.rebased.preheader", %"end for output.s0.y.rebased"
  %output.s0.b.rebased = phi i32 [ %229, %"end for output.s0.y.rebased" ], [ 0, %"for output.s0.b.rebased.preheader" ]
  %43 = add nsw i32 %output.s0.b.rebased, %6
...
"for output.s0.y.rebased.us.preheader":           ; preds = %"for output.s0.b.rebased"
  %45 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %29)
  %46 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %29)
...
"for output.s0.y.rebased.us":                     ; preds = %"for output.s0.y.rebased.us.preheader", %"end for output.s0.x.rebased.loopexit.us"
  %output.s0.y.rebased.us = phi i32 [ %68, %"end for output.s0.x.rebased.loopexit.us" ], [ 0, %"for output.s0.y.rebased.us.preheader" ]
  %47 = mul i32 %output.s0.y.rebased.us, %stride_y
  %48 = sub i32 %38, %47
  %49 = icmp sgt i32 %48, %b45
  %smin569 = select i1 %49, i32 %b45, i32 %48
  %50 = sub i32 %39, %47
  %51 = icmp sgt i32 %50, %b45
  %smin570 = select i1 %51, i32 %b45, i32 %50
  %52 = icmp sgt i32 %smin569, %smin570
  %smax571 = select i1 %52, i32 %smin569, i32 %smin570
  %53 = icmp sgt i32 %smax571, 0
  %smax572 = select i1 %53, i32 %smax571, i32 0
  %54 = icmp sgt i32 %smin570, 0
  %smax573 = select i1 %54, i32 %smin570, i32 0
  %55 = sub nsw i32 %smax572, %smax573
  %.neg584 = add nuw i32 %smax573, 1
  %56 = add nsw i32 %output.s0.y.rebased.us, %13
  %57 = mul nsw i32 %56, %stride_y
  %a0.us = sub i32 %20, %57
  %58 = icmp slt i32 %a0.us, %b45
  %b4.us = select i1 %58, i32 %a0.us, i32 %b45
  %a1.us = sub nsw i32 %4, %57
  %59 = icmp slt i32 %a1.us, %b45
  %a9.us = select i1 %59, i32 %a1.us, i32 %b45
  %60 = icmp sgt i32 %a9.us, %b4.us
  %a8.us = select i1 %60, i32 %a9.us, i32 %b4.us
  %61 = icmp sgt i32 %a9.us, 0
  %62 = select i1 %61, i32 %a9.us, i32 0
  %63 = mul nsw i32 %56, %15
  %64 = icmp sgt i32 %a8.us, 0
  %65 = select i1 %64, i32 %a8.us, i32 0
  %66 = icmp sgt i32 %65, %62
  %t232.us = add i32 %63, %44
  %xtraiter574 = and i32 %55, 1
  %67 = icmp eq i32 %smax572, %.neg584
  %unroll_iter578 = and i32 %55, -2
  %lcmp.mod577.not = icmp eq i32 %xtraiter574, 0
  br label %"for output.s0.x.rebased.us.us"

"end for output.s0.x.rebased.loopexit.us":        ; preds = %"end for output.s0.c.c.loopexit.us.us"
  %68 = add nuw nsw i32 %output.s0.y.rebased.us, 1
  %.not100.us = icmp eq i32 %68, %14
...
"for output.s0.x.rebased.us.us":                  ; preds = %"end for output.s0.c.c.loopexit.us.us", %"for output.s0.y.rebased.us"
  %output.s0.x.rebased.us.us = phi i32 [ %157, %"end for output.s0.c.c.loopexit.us.us" ], [ 0, %"for output.s0.y.rebased.us" ]
  %69 = mul i32 %output.s0.x.rebased.us.us, %stride_x
  %70 = sub i32 %34, %69
  %71 = icmp sgt i32 %70, %b48
  %smin559 = select i1 %71, i32 %b48, i32 %70
  %72 = sub i32 %35, %69
  %73 = icmp sgt i32 %72, %b48
  %smin560 = select i1 %73, i32 %b48, i32 %72
  %74 = icmp sgt i32 %smin559, %smin560
  %smax561 = select i1 %74, i32 %smin559, i32 %smin560
  %75 = icmp sgt i32 %smax561, 0
  %smax562 = select i1 %75, i32 %smax561, i32 0
  %76 = icmp sgt i32 %smin560, 0
  %smax563 = select i1 %76, i32 %smin560, i32 0
  %77 = sub nsw i32 %smax562, %smax563
  %78 = xor i32 %smax563, -1
  %79 = add nsw i32 %smax562, %78
  %80 = add nsw i32 %output.s0.x.rebased.us.us, %10
  %81 = mul nsw i32 %80, %stride_x
  %a3.us.us = sub i32 %22, %81
  %82 = icmp slt i32 %a3.us.us, %b48
  %b9.us.us = select i1 %82, i32 %a3.us.us, i32 %b48
  %a4.us.us = sub nsw i32 %2, %81
  %83 = icmp slt i32 %a4.us.us, %b48
  %a12.us.us = select i1 %83, i32 %a4.us.us, i32 %b48
  %84 = mul nsw i32 %80, %12
  %85 = icmp sgt i32 %a12.us.us, %b9.us.us
  %a11.us.us = select i1 %85, i32 %a12.us.us, i32 %b9.us.us
  %86 = add i32 %t232.us, %84
  br i1 %66, label %"for output.s0.c.c.preheader.split.us.us.us", label %"for output.s0.c.c.us372.us.preheader", !prof !95

"for output.s0.c.c.us372.us.preheader":           ; preds = %"for output.s0.x.rebased.us.us"
  br i1 %40, label %"end for output.s0.c.c.loopexit.us.us.loopexit456.unr-lcssa", label %"for output.s0.c.c.us372.us"

"for output.s0.c.c.us372.us":                     ; preds = %"for output.s0.c.c.us372.us.preheader", %"for output.s0.c.c.us372.us"
  %output.s0.c.c.us373.us = phi i32 [ %142, %"for output.s0.c.c.us372.us" ], [ 0, %"for output.s0.c.c.us372.us.preheader" ]
  %niter553 = phi i32 [ %niter553.nsub.7, %"for output.s0.c.c.us372.us" ], [ %unroll_iter552, %"for output.s0.c.c.us372.us.preheader" ]
  %a6.us374.us = shl nsw i32 %output.s0.c.c.us373.us, 8
  %87 = icmp slt i32 %a6.us374.us, %b8
  %output.s0.c.v2.base.s.us375.us = select i1 %87, i32 %a6.us374.us, i32 %b8
  %t246.us376.us = add i32 %86, %output.s0.c.v2.base.s.us375.us
  %88 = sub i32 %t246.us376.us, %reass.add229
  %89 = getelementptr inbounds i8, i8* %8, i32 %88
  %90 = bitcast i8* %89 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %90, align 1, !tbaa !97
  %91 = getelementptr inbounds i8, i8* %89, i32 128
  %92 = bitcast i8* %91 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %92, align 1, !tbaa !97
  %93 = shl i32 %output.s0.c.c.us373.us, 8
  %a6.us374.us.1 = or i32 %93, 256
  %94 = icmp slt i32 %a6.us374.us.1, %b8
  %output.s0.c.v2.base.s.us375.us.1 = select i1 %94, i32 %a6.us374.us.1, i32 %b8
  %t246.us376.us.1 = add i32 %86, %output.s0.c.v2.base.s.us375.us.1
  %95 = sub i32 %t246.us376.us.1, %reass.add229
  %96 = getelementptr inbounds i8, i8* %8, i32 %95
  %97 = bitcast i8* %96 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %97, align 1, !tbaa !97
  %98 = getelementptr inbounds i8, i8* %96, i32 128
  %99 = bitcast i8* %98 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %99, align 1, !tbaa !97
  %100 = shl i32 %output.s0.c.c.us373.us, 8
  %a6.us374.us.2 = or i32 %100, 512
  %101 = icmp slt i32 %a6.us374.us.2, %b8
  %output.s0.c.v2.base.s.us375.us.2 = select i1 %101, i32 %a6.us374.us.2, i32 %b8
  %t246.us376.us.2 = add i32 %86, %output.s0.c.v2.base.s.us375.us.2
  %102 = sub i32 %t246.us376.us.2, %reass.add229
  %103 = getelementptr inbounds i8, i8* %8, i32 %102
  %104 = bitcast i8* %103 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %104, align 1, !tbaa !97
  %105 = getelementptr inbounds i8, i8* %103, i32 128
  %106 = bitcast i8* %105 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %106, align 1, !tbaa !97
  %107 = shl i32 %output.s0.c.c.us373.us, 8
  %a6.us374.us.3 = or i32 %107, 768
  %108 = icmp slt i32 %a6.us374.us.3, %b8
  %output.s0.c.v2.base.s.us375.us.3 = select i1 %108, i32 %a6.us374.us.3, i32 %b8
  %t246.us376.us.3 = add i32 %86, %output.s0.c.v2.base.s.us375.us.3
  %109 = sub i32 %t246.us376.us.3, %reass.add229
  %110 = getelementptr inbounds i8, i8* %8, i32 %109
  %111 = bitcast i8* %110 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %111, align 1, !tbaa !97
  %112 = getelementptr inbounds i8, i8* %110, i32 128
  %113 = bitcast i8* %112 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %113, align 1, !tbaa !97
  %114 = shl i32 %output.s0.c.c.us373.us, 8
  %a6.us374.us.4 = or i32 %114, 1024
  %115 = icmp slt i32 %a6.us374.us.4, %b8
  %output.s0.c.v2.base.s.us375.us.4 = select i1 %115, i32 %a6.us374.us.4, i32 %b8
  %t246.us376.us.4 = add i32 %86, %output.s0.c.v2.base.s.us375.us.4
  %116 = sub i32 %t246.us376.us.4, %reass.add229
  %117 = getelementptr inbounds i8, i8* %8, i32 %116
  %118 = bitcast i8* %117 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %118, align 1, !tbaa !97
  %119 = getelementptr inbounds i8, i8* %117, i32 128
  %120 = bitcast i8* %119 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %120, align 1, !tbaa !97
  %121 = shl i32 %output.s0.c.c.us373.us, 8
  %a6.us374.us.5 = or i32 %121, 1280
  %122 = icmp slt i32 %a6.us374.us.5, %b8
  %output.s0.c.v2.base.s.us375.us.5 = select i1 %122, i32 %a6.us374.us.5, i32 %b8
  %t246.us376.us.5 = add i32 %86, %output.s0.c.v2.base.s.us375.us.5
  %123 = sub i32 %t246.us376.us.5, %reass.add229
  %124 = getelementptr inbounds i8, i8* %8, i32 %123
  %125 = bitcast i8* %124 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %125, align 1, !tbaa !97
  %126 = getelementptr inbounds i8, i8* %124, i32 128
  %127 = bitcast i8* %126 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %127, align 1, !tbaa !97
  %128 = shl i32 %output.s0.c.c.us373.us, 8
  %a6.us374.us.6 = or i32 %128, 1536
  %129 = icmp slt i32 %a6.us374.us.6, %b8
  %output.s0.c.v2.base.s.us375.us.6 = select i1 %129, i32 %a6.us374.us.6, i32 %b8
  %t246.us376.us.6 = add i32 %86, %output.s0.c.v2.base.s.us375.us.6
  %130 = sub i32 %t246.us376.us.6, %reass.add229
  %131 = getelementptr inbounds i8, i8* %8, i32 %130
  %132 = bitcast i8* %131 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %132, align 1, !tbaa !97
  %133 = getelementptr inbounds i8, i8* %131, i32 128
  %134 = bitcast i8* %133 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %134, align 1, !tbaa !97
  %135 = shl i32 %output.s0.c.c.us373.us, 8
  %a6.us374.us.7 = or i32 %135, 1792
  %136 = icmp slt i32 %a6.us374.us.7, %b8
  %output.s0.c.v2.base.s.us375.us.7 = select i1 %136, i32 %a6.us374.us.7, i32 %b8
  %t246.us376.us.7 = add i32 %86, %output.s0.c.v2.base.s.us375.us.7
  %137 = sub i32 %t246.us376.us.7, %reass.add229
  %138 = getelementptr inbounds i8, i8* %8, i32 %137
  %139 = bitcast i8* %138 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %139, align 1, !tbaa !97
  %140 = getelementptr inbounds i8, i8* %138, i32 128
  %141 = bitcast i8* %140 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %141, align 1, !tbaa !97
  %142 = add nuw nsw i32 %output.s0.c.c.us373.us, 8
  %niter553.nsub.7 = add i32 %niter553, -8
  %niter553.ncmp.7 = icmp eq i32 %niter553.nsub.7, 0
  br i1 %niter553.ncmp.7, label %"end for output.s0.c.c.loopexit.us.us.loopexit456.unr-lcssa", label %"for output.s0.c.c.us372.us"

"end for output.s0.c.c.loopexit.us.us.loopexit455.unr-lcssa": ; preds = %"for output.s0.c.c.us.us380.us", %"for output.s0.c.c.us.us380.us.preheader"
  %output.s0.c.c.us.us381.us.unr = phi i32 [ 0, %"for output.s0.c.c.us.us380.us.preheader" ], [ %221, %"for output.s0.c.c.us.us380.us" ]
  br i1 %lcmp.mod556.not, label %"end for output.s0.c.c.loopexit.us.us", label %"for output.s0.c.c.us.us380.us.epil"

"for output.s0.c.c.us.us380.us.epil":             ; preds = %"end for output.s0.c.c.loopexit.us.us.loopexit455.unr-lcssa", %"for output.s0.c.c.us.us380.us.epil"
  %output.s0.c.c.us.us381.us.epil = phi i32 [ %149, %"for output.s0.c.c.us.us380.us.epil" ], [ %output.s0.c.c.us.us381.us.unr, %"end for output.s0.c.c.loopexit.us.us.loopexit455.unr-lcssa" ]
  %epil.iter555 = phi i32 [ %epil.iter555.sub, %"for output.s0.c.c.us.us380.us.epil" ], [ %xtraiter554, %"end for output.s0.c.c.loopexit.us.us.loopexit455.unr-lcssa" ]
  %a6.us.us382.us.epil = shl nsw i32 %output.s0.c.c.us.us381.us.epil, 8
  %143 = icmp slt i32 %a6.us.us382.us.epil, %b8
  %output.s0.c.v2.base.s.us.us383.us.epil = select i1 %143, i32 %a6.us.us382.us.epil, i32 %b8
  %t246.us.us384.us.epil = add i32 %86, %output.s0.c.v2.base.s.us.us383.us.epil
  %144 = sub i32 %t246.us.us384.us.epil, %reass.add229
  %145 = getelementptr inbounds i8, i8* %8, i32 %144
  %146 = bitcast i8* %145 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %146, align 1, !tbaa !97
  %147 = getelementptr inbounds i8, i8* %145, i32 128
  %148 = bitcast i8* %147 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %148, align 1, !tbaa !97
  %149 = add nuw nsw i32 %output.s0.c.c.us.us381.us.epil, 1
  %epil.iter555.sub = add i32 %epil.iter555, -1
  %epil.iter555.cmp.not = icmp eq i32 %epil.iter555.sub, 0
  br i1 %epil.iter555.cmp.not, label %"end for output.s0.c.c.loopexit.us.us", label %"for output.s0.c.c.us.us380.us.epil", !llvm.loop !100

"end for output.s0.c.c.loopexit.us.us.loopexit456.unr-lcssa": ; preds = %"for output.s0.c.c.us372.us", %"for output.s0.c.c.us372.us.preheader"
  %output.s0.c.c.us373.us.unr = phi i32 [ 0, %"for output.s0.c.c.us372.us.preheader" ], [ %142, %"for output.s0.c.c.us372.us" ]
  br i1 %lcmp.mod551.not, label %"end for output.s0.c.c.loopexit.us.us", label %"for output.s0.c.c.us372.us.epil"

"for output.s0.c.c.us372.us.epil":                ; preds = %"end for output.s0.c.c.loopexit.us.us.loopexit456.unr-lcssa", %"for output.s0.c.c.us372.us.epil"
  %output.s0.c.c.us373.us.epil = phi i32 [ %156, %"for output.s0.c.c.us372.us.epil" ], [ %output.s0.c.c.us373.us.unr, %"end for output.s0.c.c.loopexit.us.us.loopexit456.unr-lcssa" ]
  %epil.iter550 = phi i32 [ %epil.iter550.sub, %"for output.s0.c.c.us372.us.epil" ], [ %xtraiter549, %"end for output.s0.c.c.loopexit.us.us.loopexit456.unr-lcssa" ]
  %a6.us374.us.epil = shl nsw i32 %output.s0.c.c.us373.us.epil, 8
  %150 = icmp slt i32 %a6.us374.us.epil, %b8
  %output.s0.c.v2.base.s.us375.us.epil = select i1 %150, i32 %a6.us374.us.epil, i32 %b8
  %t246.us376.us.epil = add i32 %86, %output.s0.c.v2.base.s.us375.us.epil
  %151 = sub i32 %t246.us376.us.epil, %reass.add229
  %152 = getelementptr inbounds i8, i8* %8, i32 %151
  %153 = bitcast i8* %152 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %153, align 1, !tbaa !97
  %154 = getelementptr inbounds i8, i8* %152, i32 128
  %155 = bitcast i8* %154 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %155, align 1, !tbaa !97
  %156 = add nuw nsw i32 %output.s0.c.c.us373.us.epil, 1
  %epil.iter550.sub = add i32 %epil.iter550, -1
  %epil.iter550.cmp.not = icmp eq i32 %epil.iter550.sub, 0
  br i1 %epil.iter550.cmp.not, label %"end for output.s0.c.c.loopexit.us.us", label %"for output.s0.c.c.us372.us.epil", !llvm.loop !101

"end for output.s0.c.c.loopexit.us.us":           ; preds = %"end for output.s0.c.c.loopexit.us.us.loopexit456.unr-lcssa", %"for output.s0.c.c.us372.us.epil", %"end for output.s0.c.c.loopexit.us.us.loopexit455.unr-lcssa", %"for output.s0.c.c.us.us380.us.epil", %"consume maximum.loopexit.split.us.us.us.us.us"
  %157 = add nuw nsw i32 %output.s0.x.rebased.us.us, 1
  %.not101.us.us = icmp eq i32 %157, %11
  br i1 %.not101.us.us, label %"end for output.s0.x.rebased.loopexit.us", label %"for output.s0.x.rebased.us.us"

"for output.s0.c.c.preheader.split.us.us.us":     ; preds = %"for output.s0.x.rebased.us.us"
  %158 = icmp sgt i32 %a11.us.us, 0
  %159 = select i1 %158, i32 %a11.us.us, i32 0
  %160 = icmp sgt i32 %a12.us.us, 0
  %161 = select i1 %160, i32 %a12.us.us, i32 0
  %162 = icmp sgt i32 %159, %161
  br i1 %162, label %"for output.s0.c.c.us.us.us.us.preheader", label %"for output.s0.c.c.us.us380.us.preheader", !prof !95

"for output.s0.c.c.us.us380.us.preheader":        ; preds = %"for output.s0.c.c.preheader.split.us.us.us"
  br i1 %41, label %"end for output.s0.c.c.loopexit.us.us.loopexit455.unr-lcssa", label %"for output.s0.c.c.us.us380.us"

"for output.s0.c.c.us.us.us.us.preheader":        ; preds = %"for output.s0.c.c.preheader.split.us.us.us"
  %xtraiter564 = and i32 %77, 7
  %163 = icmp ult i32 %79, 7
  %unroll_iter567 = and i32 %77, -8
  %lcmp.mod566.not = icmp eq i32 %xtraiter564, 0
  %xtraiter564.1 = and i32 %77, 7
  %164 = icmp ult i32 %79, 7
  %unroll_iter567.1 = and i32 %77, -8
  %lcmp.mod566.1.not = icmp eq i32 %xtraiter564.1, 0
  %xtraiter564.epil = and i32 %77, 7
  %165 = icmp ult i32 %79, 7
  %unroll_iter567.epil = and i32 %77, -8
  %lcmp.mod566.epil.not = icmp eq i32 %xtraiter564.epil, 0
  br label %"for output.s0.c.c.us.us.us.us"

"for output.s0.c.c.us.us380.us":                  ; preds = %"for output.s0.c.c.us.us380.us.preheader", %"for output.s0.c.c.us.us380.us"
  %output.s0.c.c.us.us381.us = phi i32 [ %221, %"for output.s0.c.c.us.us380.us" ], [ 0, %"for output.s0.c.c.us.us380.us.preheader" ]
  %niter558 = phi i32 [ %niter558.nsub.7, %"for output.s0.c.c.us.us380.us" ], [ %unroll_iter557, %"for output.s0.c.c.us.us380.us.preheader" ]
  %a6.us.us382.us = shl nsw i32 %output.s0.c.c.us.us381.us, 8
  %166 = icmp slt i32 %a6.us.us382.us, %b8
  %output.s0.c.v2.base.s.us.us383.us = select i1 %166, i32 %a6.us.us382.us, i32 %b8
  %t246.us.us384.us = add i32 %86, %output.s0.c.v2.base.s.us.us383.us
  %167 = sub i32 %t246.us.us384.us, %reass.add229
  %168 = getelementptr inbounds i8, i8* %8, i32 %167
  %169 = bitcast i8* %168 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %169, align 1, !tbaa !97
  %170 = getelementptr inbounds i8, i8* %168, i32 128
  %171 = bitcast i8* %170 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %171, align 1, !tbaa !97
  %172 = shl i32 %output.s0.c.c.us.us381.us, 8
  %a6.us.us382.us.1 = or i32 %172, 256
  %173 = icmp slt i32 %a6.us.us382.us.1, %b8
  %output.s0.c.v2.base.s.us.us383.us.1 = select i1 %173, i32 %a6.us.us382.us.1, i32 %b8
  %t246.us.us384.us.1 = add i32 %86, %output.s0.c.v2.base.s.us.us383.us.1
  %174 = sub i32 %t246.us.us384.us.1, %reass.add229
  %175 = getelementptr inbounds i8, i8* %8, i32 %174
  %176 = bitcast i8* %175 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %176, align 1, !tbaa !97
  %177 = getelementptr inbounds i8, i8* %175, i32 128
  %178 = bitcast i8* %177 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %178, align 1, !tbaa !97
  %179 = shl i32 %output.s0.c.c.us.us381.us, 8
  %a6.us.us382.us.2 = or i32 %179, 512
  %180 = icmp slt i32 %a6.us.us382.us.2, %b8
  %output.s0.c.v2.base.s.us.us383.us.2 = select i1 %180, i32 %a6.us.us382.us.2, i32 %b8
  %t246.us.us384.us.2 = add i32 %86, %output.s0.c.v2.base.s.us.us383.us.2
  %181 = sub i32 %t246.us.us384.us.2, %reass.add229
  %182 = getelementptr inbounds i8, i8* %8, i32 %181
  %183 = bitcast i8* %182 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %183, align 1, !tbaa !97
  %184 = getelementptr inbounds i8, i8* %182, i32 128
  %185 = bitcast i8* %184 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %185, align 1, !tbaa !97
  %186 = shl i32 %output.s0.c.c.us.us381.us, 8
  %a6.us.us382.us.3 = or i32 %186, 768
  %187 = icmp slt i32 %a6.us.us382.us.3, %b8
  %output.s0.c.v2.base.s.us.us383.us.3 = select i1 %187, i32 %a6.us.us382.us.3, i32 %b8
  %t246.us.us384.us.3 = add i32 %86, %output.s0.c.v2.base.s.us.us383.us.3
  %188 = sub i32 %t246.us.us384.us.3, %reass.add229
  %189 = getelementptr inbounds i8, i8* %8, i32 %188
  %190 = bitcast i8* %189 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %190, align 1, !tbaa !97
  %191 = getelementptr inbounds i8, i8* %189, i32 128
  %192 = bitcast i8* %191 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %192, align 1, !tbaa !97
  %193 = shl i32 %output.s0.c.c.us.us381.us, 8
  %a6.us.us382.us.4 = or i32 %193, 1024
  %194 = icmp slt i32 %a6.us.us382.us.4, %b8
  %output.s0.c.v2.base.s.us.us383.us.4 = select i1 %194, i32 %a6.us.us382.us.4, i32 %b8
  %t246.us.us384.us.4 = add i32 %86, %output.s0.c.v2.base.s.us.us383.us.4
  %195 = sub i32 %t246.us.us384.us.4, %reass.add229
  %196 = getelementptr inbounds i8, i8* %8, i32 %195
  %197 = bitcast i8* %196 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %197, align 1, !tbaa !97
  %198 = getelementptr inbounds i8, i8* %196, i32 128
  %199 = bitcast i8* %198 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %199, align 1, !tbaa !97
  %200 = shl i32 %output.s0.c.c.us.us381.us, 8
  %a6.us.us382.us.5 = or i32 %200, 1280
  %201 = icmp slt i32 %a6.us.us382.us.5, %b8
  %output.s0.c.v2.base.s.us.us383.us.5 = select i1 %201, i32 %a6.us.us382.us.5, i32 %b8
  %t246.us.us384.us.5 = add i32 %86, %output.s0.c.v2.base.s.us.us383.us.5
  %202 = sub i32 %t246.us.us384.us.5, %reass.add229
  %203 = getelementptr inbounds i8, i8* %8, i32 %202
  %204 = bitcast i8* %203 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %204, align 1, !tbaa !97
  %205 = getelementptr inbounds i8, i8* %203, i32 128
  %206 = bitcast i8* %205 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %206, align 1, !tbaa !97
  %207 = shl i32 %output.s0.c.c.us.us381.us, 8
  %a6.us.us382.us.6 = or i32 %207, 1536
  %208 = icmp slt i32 %a6.us.us382.us.6, %b8
  %output.s0.c.v2.base.s.us.us383.us.6 = select i1 %208, i32 %a6.us.us382.us.6, i32 %b8
  %t246.us.us384.us.6 = add i32 %86, %output.s0.c.v2.base.s.us.us383.us.6
  %209 = sub i32 %t246.us.us384.us.6, %reass.add229
  %210 = getelementptr inbounds i8, i8* %8, i32 %209
  %211 = bitcast i8* %210 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %211, align 1, !tbaa !97
  %212 = getelementptr inbounds i8, i8* %210, i32 128
  %213 = bitcast i8* %212 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %213, align 1, !tbaa !97
  %214 = shl i32 %output.s0.c.c.us.us381.us, 8
  %a6.us.us382.us.7 = or i32 %214, 1792
  %215 = icmp slt i32 %a6.us.us382.us.7, %b8
  %output.s0.c.v2.base.s.us.us383.us.7 = select i1 %215, i32 %a6.us.us382.us.7, i32 %b8
  %t246.us.us384.us.7 = add i32 %86, %output.s0.c.v2.base.s.us.us383.us.7
  %216 = sub i32 %t246.us.us384.us.7, %reass.add229
  %217 = getelementptr inbounds i8, i8* %8, i32 %216
  %218 = bitcast i8* %217 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %218, align 1, !tbaa !97
  %219 = getelementptr inbounds i8, i8* %217, i32 128
  %220 = bitcast i8* %219 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %220, align 1, !tbaa !97
  %221 = add nuw nsw i32 %output.s0.c.c.us.us381.us, 8
  %niter558.nsub.7 = add i32 %niter558, -8
  %niter558.ncmp.7 = icmp eq i32 %niter558.nsub.7, 0
  br i1 %niter558.ncmp.7, label %"end for output.s0.c.c.loopexit.us.us.loopexit455.unr-lcssa", label %"for output.s0.c.c.us.us380.us"

"for output.s0.c.c.us.us.us.us":                  ; preds = %"for output.s0.c.c.us.us.us.us.preheader", %"consume maximum.loopexit.split.us.us.us.us.us"
  %output.s0.c.c.us.us.us.us = phi i32 [ %228, %"consume maximum.loopexit.split.us.us.us.us.us" ], [ 0, %"for output.s0.c.c.us.us.us.us.preheader" ]
  %a6.us.us.us.us = shl nsw i32 %output.s0.c.c.us.us.us.us, 8
  %222 = icmp slt i32 %a6.us.us.us.us, %b8
  %output.s0.c.v2.base.s.us.us.us.us = select i1 %222, i32 %a6.us.us.us.us, i32 %b8
  br i1 %67, label %"consume maximum.loopexit.split.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$y.rebased.us.us.us.us.us"

"for maximum.s1.r12$y.rebased.us.us.us.us.us":    ; preds = %"for output.s0.c.c.us.us.us.us", %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.1"
  %niter579 = phi i32 [ %niter579.nsub.1, %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.1" ], [ %unroll_iter578, %"for output.s0.c.c.us.us.us.us" ]
  br i1 %163, label %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$x.rebased.us.us.us.us.us"

"for maximum.s1.r12$x.rebased.us.us.us.us.us":    ; preds = %"for maximum.s1.r12$y.rebased.us.us.us.us.us", %"for maximum.s1.r12$x.rebased.us.us.us.us.us"
  %niter568 = phi i32 [ %niter568.nsub.7, %"for maximum.s1.r12$x.rebased.us.us.us.us.us" ], [ %unroll_iter567, %"for maximum.s1.r12$y.rebased.us.us.us.us.us" ]
  %niter568.nsub.7 = add i32 %niter568, -8
  %niter568.ncmp.7 = icmp eq i32 %niter568.nsub.7, 0
  br i1 %niter568.ncmp.7, label %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$x.rebased.us.us.us.us.us"

"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa": ; preds = %"for maximum.s1.r12$x.rebased.us.us.us.us.us", %"for maximum.s1.r12$y.rebased.us.us.us.us.us"
  br i1 %lcmp.mod566.not, label %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil"

"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil": ; preds = %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa", %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil"
  %epil.iter565 = phi i32 [ %epil.iter565.sub, %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil" ], [ %xtraiter564, %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa" ]
  %epil.iter565.sub = add i32 %epil.iter565, -1
  %epil.iter565.cmp.not = icmp eq i32 %epil.iter565.sub, 0
  br i1 %epil.iter565.cmp.not, label %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil", !llvm.loop !102

"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us": ; preds = %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil", %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa"
  br i1 %164, label %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa.1", label %"for maximum.s1.r12$x.rebased.us.us.us.us.us.1"

"consume maximum.loopexit.split.us.us.us.us.us.unr-lcssa": ; preds = %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.1", %"for output.s0.c.c.us.us.us.us"
  br i1 %lcmp.mod577.not, label %"consume maximum.loopexit.split.us.us.us.us.us", label %"for maximum.s1.r12$y.rebased.us.us.us.us.us.epil"

"for maximum.s1.r12$y.rebased.us.us.us.us.us.epil": ; preds = %"consume maximum.loopexit.split.us.us.us.us.us.unr-lcssa"
  br i1 %165, label %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa.epil", label %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil575"

"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil575": ; preds = %"for maximum.s1.r12$y.rebased.us.us.us.us.us.epil", %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil575"
  %niter568.epil = phi i32 [ %niter568.nsub.7.epil, %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil575" ], [ %unroll_iter567.epil, %"for maximum.s1.r12$y.rebased.us.us.us.us.us.epil" ]
  %niter568.nsub.7.epil = add i32 %niter568.epil, -8
  %niter568.ncmp.7.epil = icmp eq i32 %niter568.nsub.7.epil, 0
  br i1 %niter568.ncmp.7.epil, label %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa.epil", label %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil575"

"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa.epil": ; preds = %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil575", %"for maximum.s1.r12$y.rebased.us.us.us.us.us.epil"
  br i1 %lcmp.mod566.epil.not, label %"consume maximum.loopexit.split.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil.epil"

"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil.epil": ; preds = %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa.epil", %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil.epil"
  %epil.iter565.epil = phi i32 [ %epil.iter565.sub.epil, %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil.epil" ], [ %xtraiter564.epil, %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa.epil" ]
  %epil.iter565.sub.epil = add i32 %epil.iter565.epil, -1
  %epil.iter565.cmp.epil.not = icmp eq i32 %epil.iter565.sub.epil, 0
  br i1 %epil.iter565.cmp.epil.not, label %"consume maximum.loopexit.split.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil.epil", !llvm.loop !102

"consume maximum.loopexit.split.us.us.us.us.us":  ; preds = %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil.epil", %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa.epil", %"consume maximum.loopexit.split.us.us.us.us.us.unr-lcssa"
  %t246.us.us.us.us = add i32 %86, %output.s0.c.v2.base.s.us.us.us.us
  %223 = sub i32 %t246.us.us.us.us, %reass.add229
  %224 = getelementptr inbounds i8, i8* %8, i32 %223
  %225 = bitcast i8* %224 to <32 x i32>*
  store <32 x i32> %46, <32 x i32>* %225, align 1, !tbaa !97
  %226 = getelementptr inbounds i8, i8* %224, i32 128
  %227 = bitcast i8* %226 to <32 x i32>*
  store <32 x i32> %45, <32 x i32>* %227, align 1, !tbaa !97
  %228 = add nuw nsw i32 %output.s0.c.c.us.us.us.us, 1
  %.not102.us.us.us.us = icmp eq i32 %228, %24
  br i1 %.not102.us.us.us.us, label %"end for output.s0.c.c.loopexit.us.us", label %"for output.s0.c.c.us.us.us.us"

"end for output.s0.y.rebased":                    ; preds = %"end for output.s0.x.rebased.loopexit.us", %"for output.s0.b.rebased"
  %229 = add nuw nsw i32 %output.s0.b.rebased, 1
  %.not99 = icmp eq i32 %229, %7
  br i1 %.not99, label %call_destructor.exit, label %"for output.s0.b.rebased"

then_bb1:                                         ; preds = %next_bb
  %230 = icmp sgt i32 %7, 0
  br i1 %230, label %"for output.s0.b.rebased3.preheader", label %call_destructor.exit, !prof !95

"for output.s0.b.rebased3.preheader":             ; preds = %then_bb1
  %.neg203 = mul i32 %12, %10
  %.neg202 = mul i32 %15, %13
  %.neg201 = mul i32 %16, %6
  %231 = icmp sgt i32 %14, 0
  %232 = add nsw i32 %5, %4
  %233 = add nsw i32 %3, %2
  %234 = add nuw nsw i32 %1, 127
  %235 = ashr i32 %234, 7
  %b22 = add nsw i32 %1, -128
  %236 = icmp ult i8 %a55, %b57
  %237 = select i1 %236, i8 %a55, i8 %b57
  %238 = insertelement <128 x i8> undef, i8 %237, i32 0
  %239 = shufflevector <128 x i8> %238, <128 x i8> undef, <128 x i32> zeroinitializer
  %reass.add213 = add i32 %.neg202, %.neg203
  %reass.add214 = add i32 %reass.add213, %.neg201
  %240 = icmp sgt i32 %11, 0
  %or.cond = and i1 %231, %240
  br i1 %or.cond, label %"for output.s0.b.rebased3.us.us.preheader", label %call_destructor.exit, !prof !103

"for output.s0.b.rebased3.us.us.preheader":       ; preds = %"for output.s0.b.rebased3.preheader"
  %241 = add nsw i32 %235, -1
  %242 = add nsw i32 %235, -1
  %243 = add i32 %3, %2
  %244 = mul i32 %10, %stride_x
  %245 = sub i32 %243, %244
  %246 = sub i32 %2, %244
  %247 = add i32 %5, %4
  %248 = mul i32 %13, %stride_y
  %249 = sub i32 %247, %248
  %250 = sub i32 %4, %248
  %xtraiter517 = and i32 %235, 7
  %251 = icmp ult i32 %241, 7
  %unroll_iter520 = and i32 %235, -8
  %lcmp.mod519.not = icmp eq i32 %xtraiter517, 0
  %xtraiter522 = and i32 %235, 7
  %252 = icmp ult i32 %242, 7
  %unroll_iter525 = and i32 %235, -8
  %lcmp.mod524.not = icmp eq i32 %xtraiter522, 0
  br label %"for output.s0.b.rebased3.us.us"

"for output.s0.b.rebased3.us.us":                 ; preds = %"for output.s0.b.rebased3.us.us.preheader", %"end for output.s0.y.rebased7.loopexit.split.us.us.us"
  %output.s0.b.rebased5.us.us = phi i32 [ %403, %"end for output.s0.y.rebased7.loopexit.split.us.us.us" ], [ 0, %"for output.s0.b.rebased3.us.us.preheader" ]
  %253 = add nsw i32 %output.s0.b.rebased5.us.us, %6
  %254 = mul nsw i32 %253, %16
  br label %"for output.s0.y.rebased6.us.us.us"

"for output.s0.y.rebased6.us.us.us":              ; preds = %"end for output.s0.x.rebased10.loopexit.us.us.us", %"for output.s0.b.rebased3.us.us"
  %output.s0.y.rebased8.us.us.us = phi i32 [ %325, %"end for output.s0.x.rebased10.loopexit.us.us.us" ], [ 0, %"for output.s0.b.rebased3.us.us" ]
  %255 = mul i32 %output.s0.y.rebased8.us.us.us, %stride_y
  %256 = sub i32 %249, %255
  %257 = icmp sgt i32 %256, %b45
  %smin537 = select i1 %257, i32 %b45, i32 %256
  %258 = sub i32 %250, %255
  %259 = icmp sgt i32 %258, %b45
  %smin538 = select i1 %259, i32 %b45, i32 %258
  %260 = icmp sgt i32 %smin537, %smin538
  %smax539 = select i1 %260, i32 %smin537, i32 %smin538
  %261 = icmp sgt i32 %smax539, 0
  %smax540 = select i1 %261, i32 %smax539, i32 0
  %262 = icmp sgt i32 %smin538, 0
  %smax541 = select i1 %262, i32 %smin538, i32 0
  %263 = sub nsw i32 %smax540, %smax541
  %.neg583 = add nuw i32 %smax541, 1
  %264 = add nsw i32 %output.s0.y.rebased8.us.us.us, %13
  %265 = mul nsw i32 %264, %stride_y
  %a14.us.us.us = sub i32 %232, %265
  %266 = icmp slt i32 %a14.us.us.us, %b45
  %b18.us.us.us = select i1 %266, i32 %a14.us.us.us, i32 %b45
  %a15.us.us.us = sub nsw i32 %4, %265
  %267 = icmp slt i32 %a15.us.us.us, %b45
  %a23.us.us.us = select i1 %267, i32 %a15.us.us.us, i32 %b45
  %268 = icmp sgt i32 %a23.us.us.us, %b18.us.us.us
  %a22.us.us.us = select i1 %268, i32 %a23.us.us.us, i32 %b18.us.us.us
  %269 = icmp sgt i32 %a23.us.us.us, 0
  %270 = select i1 %269, i32 %a23.us.us.us, i32 0
  %271 = mul nsw i32 %264, %15
  %272 = icmp sgt i32 %a22.us.us.us, 0
  %273 = select i1 %272, i32 %a22.us.us.us, i32 0
  %274 = icmp sgt i32 %273, %270
  %t264.us.us.us = add i32 %271, %254
  br i1 %274, label %"for output.s0.x.rebased9.us.us.us.us.preheader", label %"for output.s0.x.rebased9.us346.us.us", !prof !95

"for output.s0.x.rebased9.us.us.us.us.preheader": ; preds = %"for output.s0.y.rebased6.us.us.us"
  %xtraiter542 = and i32 %263, 1
  %275 = icmp eq i32 %smax540, %.neg583
  %unroll_iter546 = and i32 %263, -2
  %lcmp.mod545.not = icmp eq i32 %xtraiter542, 0
  br label %"for output.s0.x.rebased9.us.us.us.us"

"for output.s0.x.rebased9.us346.us.us":           ; preds = %"for output.s0.y.rebased6.us.us.us", %"end for output.s0.c.c13.split.us.us.us"
  %output.s0.x.rebased11.us347.us.us = phi i32 [ %324, %"end for output.s0.c.c13.split.us.us.us" ], [ 0, %"for output.s0.y.rebased6.us.us.us" ]
  %276 = add nsw i32 %output.s0.x.rebased11.us347.us.us, %10
  %277 = mul nsw i32 %276, %12
  %278 = add i32 %t264.us.us.us, %277
  br i1 %251, label %"end for output.s0.c.c13.split.us.us.us.unr-lcssa", label %"for output.s0.c.c12.us.us.us"

"for output.s0.c.c12.us.us.us":                   ; preds = %"for output.s0.x.rebased9.us346.us.us", %"for output.s0.c.c12.us.us.us"
  %output.s0.c.c14.us.us.us = phi i32 [ %318, %"for output.s0.c.c12.us.us.us" ], [ 0, %"for output.s0.x.rebased9.us346.us.us" ]
  %niter521 = phi i32 [ %niter521.nsub.7, %"for output.s0.c.c12.us.us.us" ], [ %unroll_iter520, %"for output.s0.x.rebased9.us346.us.us" ]
  %a20.us.us.us = shl nsw i32 %output.s0.c.c14.us.us.us, 7
  %279 = icmp slt i32 %a20.us.us.us, %b22
  %output.s0.c.v3.base.s.us.us.us = select i1 %279, i32 %a20.us.us.us, i32 %b22
  %t278.us.us.us = add i32 %278, %output.s0.c.v3.base.s.us.us.us
  %280 = sub i32 %t278.us.us.us, %reass.add214
  %281 = getelementptr inbounds i8, i8* %8, i32 %280
  %282 = bitcast i8* %281 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %282, align 1, !tbaa !97
  %283 = shl i32 %output.s0.c.c14.us.us.us, 7
  %a20.us.us.us.1 = or i32 %283, 128
  %284 = icmp slt i32 %a20.us.us.us.1, %b22
  %output.s0.c.v3.base.s.us.us.us.1 = select i1 %284, i32 %a20.us.us.us.1, i32 %b22
  %t278.us.us.us.1 = add i32 %278, %output.s0.c.v3.base.s.us.us.us.1
  %285 = sub i32 %t278.us.us.us.1, %reass.add214
  %286 = getelementptr inbounds i8, i8* %8, i32 %285
  %287 = bitcast i8* %286 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %287, align 1, !tbaa !97
  %288 = shl i32 %output.s0.c.c14.us.us.us, 7
  %a20.us.us.us.2 = or i32 %288, 256
  %289 = icmp slt i32 %a20.us.us.us.2, %b22
  %output.s0.c.v3.base.s.us.us.us.2 = select i1 %289, i32 %a20.us.us.us.2, i32 %b22
  %t278.us.us.us.2 = add i32 %278, %output.s0.c.v3.base.s.us.us.us.2
  %290 = sub i32 %t278.us.us.us.2, %reass.add214
  %291 = getelementptr inbounds i8, i8* %8, i32 %290
  %292 = bitcast i8* %291 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %292, align 1, !tbaa !97
  %293 = shl i32 %output.s0.c.c14.us.us.us, 7
  %a20.us.us.us.3 = or i32 %293, 384
  %294 = icmp slt i32 %a20.us.us.us.3, %b22
  %output.s0.c.v3.base.s.us.us.us.3 = select i1 %294, i32 %a20.us.us.us.3, i32 %b22
  %t278.us.us.us.3 = add i32 %278, %output.s0.c.v3.base.s.us.us.us.3
  %295 = sub i32 %t278.us.us.us.3, %reass.add214
  %296 = getelementptr inbounds i8, i8* %8, i32 %295
  %297 = bitcast i8* %296 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %297, align 1, !tbaa !97
  %298 = shl i32 %output.s0.c.c14.us.us.us, 7
  %a20.us.us.us.4 = or i32 %298, 512
  %299 = icmp slt i32 %a20.us.us.us.4, %b22
  %output.s0.c.v3.base.s.us.us.us.4 = select i1 %299, i32 %a20.us.us.us.4, i32 %b22
  %t278.us.us.us.4 = add i32 %278, %output.s0.c.v3.base.s.us.us.us.4
  %300 = sub i32 %t278.us.us.us.4, %reass.add214
  %301 = getelementptr inbounds i8, i8* %8, i32 %300
  %302 = bitcast i8* %301 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %302, align 1, !tbaa !97
  %303 = shl i32 %output.s0.c.c14.us.us.us, 7
  %a20.us.us.us.5 = or i32 %303, 640
  %304 = icmp slt i32 %a20.us.us.us.5, %b22
  %output.s0.c.v3.base.s.us.us.us.5 = select i1 %304, i32 %a20.us.us.us.5, i32 %b22
  %t278.us.us.us.5 = add i32 %278, %output.s0.c.v3.base.s.us.us.us.5
  %305 = sub i32 %t278.us.us.us.5, %reass.add214
  %306 = getelementptr inbounds i8, i8* %8, i32 %305
  %307 = bitcast i8* %306 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %307, align 1, !tbaa !97
  %308 = shl i32 %output.s0.c.c14.us.us.us, 7
  %a20.us.us.us.6 = or i32 %308, 768
  %309 = icmp slt i32 %a20.us.us.us.6, %b22
  %output.s0.c.v3.base.s.us.us.us.6 = select i1 %309, i32 %a20.us.us.us.6, i32 %b22
  %t278.us.us.us.6 = add i32 %278, %output.s0.c.v3.base.s.us.us.us.6
  %310 = sub i32 %t278.us.us.us.6, %reass.add214
  %311 = getelementptr inbounds i8, i8* %8, i32 %310
  %312 = bitcast i8* %311 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %312, align 1, !tbaa !97
  %313 = shl i32 %output.s0.c.c14.us.us.us, 7
  %a20.us.us.us.7 = or i32 %313, 896
  %314 = icmp slt i32 %a20.us.us.us.7, %b22
  %output.s0.c.v3.base.s.us.us.us.7 = select i1 %314, i32 %a20.us.us.us.7, i32 %b22
  %t278.us.us.us.7 = add i32 %278, %output.s0.c.v3.base.s.us.us.us.7
  %315 = sub i32 %t278.us.us.us.7, %reass.add214
  %316 = getelementptr inbounds i8, i8* %8, i32 %315
  %317 = bitcast i8* %316 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %317, align 1, !tbaa !97
  %318 = add nuw nsw i32 %output.s0.c.c14.us.us.us, 8
  %niter521.nsub.7 = add i32 %niter521, -8
  %niter521.ncmp.7 = icmp eq i32 %niter521.nsub.7, 0
  br i1 %niter521.ncmp.7, label %"end for output.s0.c.c13.split.us.us.us.unr-lcssa", label %"for output.s0.c.c12.us.us.us"

"end for output.s0.c.c13.split.us.us.us.unr-lcssa": ; preds = %"for output.s0.c.c12.us.us.us", %"for output.s0.x.rebased9.us346.us.us"
  %output.s0.c.c14.us.us.us.unr = phi i32 [ 0, %"for output.s0.x.rebased9.us346.us.us" ], [ %318, %"for output.s0.c.c12.us.us.us" ]
  br i1 %lcmp.mod519.not, label %"end for output.s0.c.c13.split.us.us.us", label %"for output.s0.c.c12.us.us.us.epil"

"for output.s0.c.c12.us.us.us.epil":              ; preds = %"end for output.s0.c.c13.split.us.us.us.unr-lcssa", %"for output.s0.c.c12.us.us.us.epil"
  %output.s0.c.c14.us.us.us.epil = phi i32 [ %323, %"for output.s0.c.c12.us.us.us.epil" ], [ %output.s0.c.c14.us.us.us.unr, %"end for output.s0.c.c13.split.us.us.us.unr-lcssa" ]
  %epil.iter518 = phi i32 [ %epil.iter518.sub, %"for output.s0.c.c12.us.us.us.epil" ], [ %xtraiter517, %"end for output.s0.c.c13.split.us.us.us.unr-lcssa" ]
  %a20.us.us.us.epil = shl nsw i32 %output.s0.c.c14.us.us.us.epil, 7
  %319 = icmp slt i32 %a20.us.us.us.epil, %b22
  %output.s0.c.v3.base.s.us.us.us.epil = select i1 %319, i32 %a20.us.us.us.epil, i32 %b22
  %t278.us.us.us.epil = add i32 %278, %output.s0.c.v3.base.s.us.us.us.epil
  %320 = sub i32 %t278.us.us.us.epil, %reass.add214
  %321 = getelementptr inbounds i8, i8* %8, i32 %320
  %322 = bitcast i8* %321 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %322, align 1, !tbaa !97
  %323 = add nuw nsw i32 %output.s0.c.c14.us.us.us.epil, 1
  %epil.iter518.sub = add i32 %epil.iter518, -1
  %epil.iter518.cmp.not = icmp eq i32 %epil.iter518.sub, 0
  br i1 %epil.iter518.cmp.not, label %"end for output.s0.c.c13.split.us.us.us", label %"for output.s0.c.c12.us.us.us.epil", !llvm.loop !104

"end for output.s0.c.c13.split.us.us.us":         ; preds = %"for output.s0.c.c12.us.us.us.epil", %"end for output.s0.c.c13.split.us.us.us.unr-lcssa"
  %324 = add nuw nsw i32 %output.s0.x.rebased11.us347.us.us, 1
  %.not96.us348.us.us = icmp eq i32 %324, %11
  br i1 %.not96.us348.us.us, label %"end for output.s0.x.rebased10.loopexit.us.us.us", label %"for output.s0.x.rebased9.us346.us.us"

"end for output.s0.x.rebased10.loopexit.us.us.us": ; preds = %"end for output.s0.c.c13.split.us.us.us", %"end for output.s0.c.c13.split.us.us.us.us.us"
  %325 = add nuw nsw i32 %output.s0.y.rebased8.us.us.us, 1
  %.not94.us.us.us = icmp eq i32 %325, %14
  br i1 %.not94.us.us.us, label %"end for output.s0.y.rebased7.loopexit.split.us.us.us", label %"for output.s0.y.rebased6.us.us.us"

"for output.s0.x.rebased9.us.us.us.us":           ; preds = %"for output.s0.x.rebased9.us.us.us.us.preheader", %"end for output.s0.c.c13.split.us.us.us.us.us"
  %output.s0.x.rebased11.us.us.us.us = phi i32 [ %397, %"end for output.s0.c.c13.split.us.us.us.us.us" ], [ 0, %"for output.s0.x.rebased9.us.us.us.us.preheader" ]
  %326 = mul i32 %output.s0.x.rebased11.us.us.us.us, %stride_x
  %327 = sub i32 %245, %326
  %328 = icmp sgt i32 %327, %b48
  %smin527 = select i1 %328, i32 %b48, i32 %327
  %329 = sub i32 %246, %326
  %330 = icmp sgt i32 %329, %b48
  %smin528 = select i1 %330, i32 %b48, i32 %329
  %331 = icmp sgt i32 %smin527, %smin528
  %smax529 = select i1 %331, i32 %smin527, i32 %smin528
  %332 = icmp sgt i32 %smax529, 0
  %smax530 = select i1 %332, i32 %smax529, i32 0
  %333 = icmp sgt i32 %smin528, 0
  %smax531 = select i1 %333, i32 %smin528, i32 0
  %334 = sub nsw i32 %smax530, %smax531
  %335 = xor i32 %smax531, -1
  %336 = add nsw i32 %smax530, %335
  %337 = add nsw i32 %output.s0.x.rebased11.us.us.us.us, %10
  %338 = mul nsw i32 %337, %stride_x
  %a17.us.us.us.us = sub i32 %233, %338
  %339 = icmp slt i32 %a17.us.us.us.us, %b48
  %b23.us.us.us.us = select i1 %339, i32 %a17.us.us.us.us, i32 %b48
  %a18.us.us.us.us = sub nsw i32 %2, %338
  %340 = icmp slt i32 %a18.us.us.us.us, %b48
  %a26.us.us.us.us = select i1 %340, i32 %a18.us.us.us.us, i32 %b48
  %341 = mul nsw i32 %337, %12
  %342 = icmp sgt i32 %a26.us.us.us.us, %b23.us.us.us.us
  %a25.us.us.us.us = select i1 %342, i32 %a26.us.us.us.us, i32 %b23.us.us.us.us
  %343 = icmp sgt i32 %a26.us.us.us.us, 0
  %344 = select i1 %343, i32 %a26.us.us.us.us, i32 0
  %345 = icmp sgt i32 %a25.us.us.us.us, 0
  %346 = select i1 %345, i32 %a25.us.us.us.us, i32 0
  %347 = icmp sgt i32 %346, %344
  %348 = add i32 %t264.us.us.us, %341
  br i1 %347, label %"for output.s0.c.c12.us.us.us.us.us.us.preheader", label %"for output.s0.c.c12.us.us337.us.us.us.preheader", !prof !95

"for output.s0.c.c12.us.us337.us.us.us.preheader": ; preds = %"for output.s0.x.rebased9.us.us.us.us"
  br i1 %252, label %"end for output.s0.c.c13.split.us.us.us.us.us.loopexit457.unr-lcssa", label %"for output.s0.c.c12.us.us337.us.us.us"

"for output.s0.c.c12.us.us.us.us.us.us.preheader": ; preds = %"for output.s0.x.rebased9.us.us.us.us"
  %xtraiter532 = and i32 %334, 7
  %349 = icmp ult i32 %336, 7
  %unroll_iter535 = and i32 %334, -8
  %lcmp.mod534.not = icmp eq i32 %xtraiter532, 0
  %xtraiter532.1 = and i32 %334, 7
  %350 = icmp ult i32 %336, 7
  %unroll_iter535.1 = and i32 %334, -8
  %lcmp.mod534.1.not = icmp eq i32 %xtraiter532.1, 0
  %xtraiter532.epil = and i32 %334, 7
  %351 = icmp ult i32 %336, 7
  %unroll_iter535.epil = and i32 %334, -8
  %lcmp.mod534.epil.not = icmp eq i32 %xtraiter532.epil, 0
  br label %"for output.s0.c.c12.us.us.us.us.us.us"

"for output.s0.c.c12.us.us337.us.us.us":          ; preds = %"for output.s0.c.c12.us.us337.us.us.us.preheader", %"for output.s0.c.c12.us.us337.us.us.us"
  %output.s0.c.c14.us.us338.us.us.us = phi i32 [ %391, %"for output.s0.c.c12.us.us337.us.us.us" ], [ 0, %"for output.s0.c.c12.us.us337.us.us.us.preheader" ]
  %niter526 = phi i32 [ %niter526.nsub.7, %"for output.s0.c.c12.us.us337.us.us.us" ], [ %unroll_iter525, %"for output.s0.c.c12.us.us337.us.us.us.preheader" ]
  %a20.us.us339.us.us.us = shl nsw i32 %output.s0.c.c14.us.us338.us.us.us, 7
  %352 = icmp slt i32 %a20.us.us339.us.us.us, %b22
  %output.s0.c.v3.base.s.us.us340.us.us.us = select i1 %352, i32 %a20.us.us339.us.us.us, i32 %b22
  %t278.us.us342.us.us.us = add i32 %348, %output.s0.c.v3.base.s.us.us340.us.us.us
  %353 = sub i32 %t278.us.us342.us.us.us, %reass.add214
  %354 = getelementptr inbounds i8, i8* %8, i32 %353
  %355 = bitcast i8* %354 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %355, align 1, !tbaa !97
  %356 = shl i32 %output.s0.c.c14.us.us338.us.us.us, 7
  %a20.us.us339.us.us.us.1 = or i32 %356, 128
  %357 = icmp slt i32 %a20.us.us339.us.us.us.1, %b22
  %output.s0.c.v3.base.s.us.us340.us.us.us.1 = select i1 %357, i32 %a20.us.us339.us.us.us.1, i32 %b22
  %t278.us.us342.us.us.us.1 = add i32 %348, %output.s0.c.v3.base.s.us.us340.us.us.us.1
  %358 = sub i32 %t278.us.us342.us.us.us.1, %reass.add214
  %359 = getelementptr inbounds i8, i8* %8, i32 %358
  %360 = bitcast i8* %359 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %360, align 1, !tbaa !97
  %361 = shl i32 %output.s0.c.c14.us.us338.us.us.us, 7
  %a20.us.us339.us.us.us.2 = or i32 %361, 256
  %362 = icmp slt i32 %a20.us.us339.us.us.us.2, %b22
  %output.s0.c.v3.base.s.us.us340.us.us.us.2 = select i1 %362, i32 %a20.us.us339.us.us.us.2, i32 %b22
  %t278.us.us342.us.us.us.2 = add i32 %348, %output.s0.c.v3.base.s.us.us340.us.us.us.2
  %363 = sub i32 %t278.us.us342.us.us.us.2, %reass.add214
  %364 = getelementptr inbounds i8, i8* %8, i32 %363
  %365 = bitcast i8* %364 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %365, align 1, !tbaa !97
  %366 = shl i32 %output.s0.c.c14.us.us338.us.us.us, 7
  %a20.us.us339.us.us.us.3 = or i32 %366, 384
  %367 = icmp slt i32 %a20.us.us339.us.us.us.3, %b22
  %output.s0.c.v3.base.s.us.us340.us.us.us.3 = select i1 %367, i32 %a20.us.us339.us.us.us.3, i32 %b22
  %t278.us.us342.us.us.us.3 = add i32 %348, %output.s0.c.v3.base.s.us.us340.us.us.us.3
  %368 = sub i32 %t278.us.us342.us.us.us.3, %reass.add214
  %369 = getelementptr inbounds i8, i8* %8, i32 %368
  %370 = bitcast i8* %369 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %370, align 1, !tbaa !97
  %371 = shl i32 %output.s0.c.c14.us.us338.us.us.us, 7
  %a20.us.us339.us.us.us.4 = or i32 %371, 512
  %372 = icmp slt i32 %a20.us.us339.us.us.us.4, %b22
  %output.s0.c.v3.base.s.us.us340.us.us.us.4 = select i1 %372, i32 %a20.us.us339.us.us.us.4, i32 %b22
  %t278.us.us342.us.us.us.4 = add i32 %348, %output.s0.c.v3.base.s.us.us340.us.us.us.4
  %373 = sub i32 %t278.us.us342.us.us.us.4, %reass.add214
  %374 = getelementptr inbounds i8, i8* %8, i32 %373
  %375 = bitcast i8* %374 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %375, align 1, !tbaa !97
  %376 = shl i32 %output.s0.c.c14.us.us338.us.us.us, 7
  %a20.us.us339.us.us.us.5 = or i32 %376, 640
  %377 = icmp slt i32 %a20.us.us339.us.us.us.5, %b22
  %output.s0.c.v3.base.s.us.us340.us.us.us.5 = select i1 %377, i32 %a20.us.us339.us.us.us.5, i32 %b22
  %t278.us.us342.us.us.us.5 = add i32 %348, %output.s0.c.v3.base.s.us.us340.us.us.us.5
  %378 = sub i32 %t278.us.us342.us.us.us.5, %reass.add214
  %379 = getelementptr inbounds i8, i8* %8, i32 %378
  %380 = bitcast i8* %379 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %380, align 1, !tbaa !97
  %381 = shl i32 %output.s0.c.c14.us.us338.us.us.us, 7
  %a20.us.us339.us.us.us.6 = or i32 %381, 768
  %382 = icmp slt i32 %a20.us.us339.us.us.us.6, %b22
  %output.s0.c.v3.base.s.us.us340.us.us.us.6 = select i1 %382, i32 %a20.us.us339.us.us.us.6, i32 %b22
  %t278.us.us342.us.us.us.6 = add i32 %348, %output.s0.c.v3.base.s.us.us340.us.us.us.6
  %383 = sub i32 %t278.us.us342.us.us.us.6, %reass.add214
  %384 = getelementptr inbounds i8, i8* %8, i32 %383
  %385 = bitcast i8* %384 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %385, align 1, !tbaa !97
  %386 = shl i32 %output.s0.c.c14.us.us338.us.us.us, 7
  %a20.us.us339.us.us.us.7 = or i32 %386, 896
  %387 = icmp slt i32 %a20.us.us339.us.us.us.7, %b22
  %output.s0.c.v3.base.s.us.us340.us.us.us.7 = select i1 %387, i32 %a20.us.us339.us.us.us.7, i32 %b22
  %t278.us.us342.us.us.us.7 = add i32 %348, %output.s0.c.v3.base.s.us.us340.us.us.us.7
  %388 = sub i32 %t278.us.us342.us.us.us.7, %reass.add214
  %389 = getelementptr inbounds i8, i8* %8, i32 %388
  %390 = bitcast i8* %389 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %390, align 1, !tbaa !97
  %391 = add nuw nsw i32 %output.s0.c.c14.us.us338.us.us.us, 8
  %niter526.nsub.7 = add i32 %niter526, -8
  %niter526.ncmp.7 = icmp eq i32 %niter526.nsub.7, 0
  br i1 %niter526.ncmp.7, label %"end for output.s0.c.c13.split.us.us.us.us.us.loopexit457.unr-lcssa", label %"for output.s0.c.c12.us.us337.us.us.us"

"end for output.s0.c.c13.split.us.us.us.us.us.loopexit457.unr-lcssa": ; preds = %"for output.s0.c.c12.us.us337.us.us.us", %"for output.s0.c.c12.us.us337.us.us.us.preheader"
  %output.s0.c.c14.us.us338.us.us.us.unr = phi i32 [ 0, %"for output.s0.c.c12.us.us337.us.us.us.preheader" ], [ %391, %"for output.s0.c.c12.us.us337.us.us.us" ]
  br i1 %lcmp.mod524.not, label %"end for output.s0.c.c13.split.us.us.us.us.us", label %"for output.s0.c.c12.us.us337.us.us.us.epil"

"for output.s0.c.c12.us.us337.us.us.us.epil":     ; preds = %"end for output.s0.c.c13.split.us.us.us.us.us.loopexit457.unr-lcssa", %"for output.s0.c.c12.us.us337.us.us.us.epil"
  %output.s0.c.c14.us.us338.us.us.us.epil = phi i32 [ %396, %"for output.s0.c.c12.us.us337.us.us.us.epil" ], [ %output.s0.c.c14.us.us338.us.us.us.unr, %"end for output.s0.c.c13.split.us.us.us.us.us.loopexit457.unr-lcssa" ]
  %epil.iter523 = phi i32 [ %epil.iter523.sub, %"for output.s0.c.c12.us.us337.us.us.us.epil" ], [ %xtraiter522, %"end for output.s0.c.c13.split.us.us.us.us.us.loopexit457.unr-lcssa" ]
  %a20.us.us339.us.us.us.epil = shl nsw i32 %output.s0.c.c14.us.us338.us.us.us.epil, 7
  %392 = icmp slt i32 %a20.us.us339.us.us.us.epil, %b22
  %output.s0.c.v3.base.s.us.us340.us.us.us.epil = select i1 %392, i32 %a20.us.us339.us.us.us.epil, i32 %b22
  %t278.us.us342.us.us.us.epil = add i32 %348, %output.s0.c.v3.base.s.us.us340.us.us.us.epil
  %393 = sub i32 %t278.us.us342.us.us.us.epil, %reass.add214
  %394 = getelementptr inbounds i8, i8* %8, i32 %393
  %395 = bitcast i8* %394 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %395, align 1, !tbaa !97
  %396 = add nuw nsw i32 %output.s0.c.c14.us.us338.us.us.us.epil, 1
  %epil.iter523.sub = add i32 %epil.iter523, -1
  %epil.iter523.cmp.not = icmp eq i32 %epil.iter523.sub, 0
  br i1 %epil.iter523.cmp.not, label %"end for output.s0.c.c13.split.us.us.us.us.us", label %"for output.s0.c.c12.us.us337.us.us.us.epil", !llvm.loop !105

"end for output.s0.c.c13.split.us.us.us.us.us":   ; preds = %"end for output.s0.c.c13.split.us.us.us.us.us.loopexit457.unr-lcssa", %"for output.s0.c.c12.us.us337.us.us.us.epil", %"consume maximum22.loopexit.split.us.us.us.us.us.us.us"
  %397 = add nuw nsw i32 %output.s0.x.rebased11.us.us.us.us, 1
  %.not96.us.us.us.us = icmp eq i32 %397, %11
  br i1 %.not96.us.us.us.us, label %"end for output.s0.x.rebased10.loopexit.us.us.us", label %"for output.s0.x.rebased9.us.us.us.us"

"for output.s0.c.c12.us.us.us.us.us.us":          ; preds = %"for output.s0.c.c12.us.us.us.us.us.us.preheader", %"consume maximum22.loopexit.split.us.us.us.us.us.us.us"
  %output.s0.c.c14.us.us.us.us.us.us = phi i32 [ %402, %"consume maximum22.loopexit.split.us.us.us.us.us.us.us" ], [ 0, %"for output.s0.c.c12.us.us.us.us.us.us.preheader" ]
  %a20.us.us.us.us.us.us = shl nsw i32 %output.s0.c.c14.us.us.us.us.us.us, 7
  %398 = icmp slt i32 %a20.us.us.us.us.us.us, %b22
  %output.s0.c.v3.base.s.us.us.us.us.us.us = select i1 %398, i32 %a20.us.us.us.us.us.us, i32 %b22
  br i1 %275, label %"consume maximum22.loopexit.split.us.us.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$y.rebased16.us.us.us.us.us.us.us"

"for maximum.s1.r12$y.rebased16.us.us.us.us.us.us.us": ; preds = %"for output.s0.c.c12.us.us.us.us.us.us", %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.1"
  %niter547 = phi i32 [ %niter547.nsub.1, %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.1" ], [ %unroll_iter546, %"for output.s0.c.c12.us.us.us.us.us.us" ]
  br i1 %349, label %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us"

"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us": ; preds = %"for maximum.s1.r12$y.rebased16.us.us.us.us.us.us.us", %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us"
  %niter536 = phi i32 [ %niter536.nsub.7, %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us" ], [ %unroll_iter535, %"for maximum.s1.r12$y.rebased16.us.us.us.us.us.us.us" ]
  %niter536.nsub.7 = add i32 %niter536, -8
  %niter536.ncmp.7 = icmp eq i32 %niter536.nsub.7, 0
  br i1 %niter536.ncmp.7, label %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us"

"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa": ; preds = %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us", %"for maximum.s1.r12$y.rebased16.us.us.us.us.us.us.us"
  br i1 %lcmp.mod534.not, label %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil"

"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil": ; preds = %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa", %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil"
  %epil.iter533 = phi i32 [ %epil.iter533.sub, %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil" ], [ %xtraiter532, %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa" ]
  %epil.iter533.sub = add i32 %epil.iter533, -1
  %epil.iter533.cmp.not = icmp eq i32 %epil.iter533.sub, 0
  br i1 %epil.iter533.cmp.not, label %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil", !llvm.loop !106

"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us": ; preds = %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil", %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa"
  br i1 %350, label %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa.1", label %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.1"

"consume maximum22.loopexit.split.us.us.us.us.us.us.us.unr-lcssa": ; preds = %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.1", %"for output.s0.c.c12.us.us.us.us.us.us"
  br i1 %lcmp.mod545.not, label %"consume maximum22.loopexit.split.us.us.us.us.us.us.us", label %"for maximum.s1.r12$y.rebased16.us.us.us.us.us.us.us.epil"

"for maximum.s1.r12$y.rebased16.us.us.us.us.us.us.us.epil": ; preds = %"consume maximum22.loopexit.split.us.us.us.us.us.us.us.unr-lcssa"
  br i1 %351, label %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa.epil", label %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil543"

"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil543": ; preds = %"for maximum.s1.r12$y.rebased16.us.us.us.us.us.us.us.epil", %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil543"
  %niter536.epil = phi i32 [ %niter536.nsub.7.epil, %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil543" ], [ %unroll_iter535.epil, %"for maximum.s1.r12$y.rebased16.us.us.us.us.us.us.us.epil" ]
  %niter536.nsub.7.epil = add i32 %niter536.epil, -8
  %niter536.ncmp.7.epil = icmp eq i32 %niter536.nsub.7.epil, 0
  br i1 %niter536.ncmp.7.epil, label %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa.epil", label %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil543"

"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa.epil": ; preds = %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil543", %"for maximum.s1.r12$y.rebased16.us.us.us.us.us.us.us.epil"
  br i1 %lcmp.mod534.epil.not, label %"consume maximum22.loopexit.split.us.us.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil.epil"

"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil.epil": ; preds = %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa.epil", %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil.epil"
  %epil.iter533.epil = phi i32 [ %epil.iter533.sub.epil, %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil.epil" ], [ %xtraiter532.epil, %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa.epil" ]
  %epil.iter533.sub.epil = add i32 %epil.iter533.epil, -1
  %epil.iter533.cmp.epil.not = icmp eq i32 %epil.iter533.sub.epil, 0
  br i1 %epil.iter533.cmp.epil.not, label %"consume maximum22.loopexit.split.us.us.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil.epil", !llvm.loop !106

"consume maximum22.loopexit.split.us.us.us.us.us.us.us": ; preds = %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil.epil", %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa.epil", %"consume maximum22.loopexit.split.us.us.us.us.us.us.us.unr-lcssa"
  %t278.us.us.us.us.us.us = add i32 %348, %output.s0.c.v3.base.s.us.us.us.us.us.us
  %399 = sub i32 %t278.us.us.us.us.us.us, %reass.add214
  %400 = getelementptr inbounds i8, i8* %8, i32 %399
  %401 = bitcast i8* %400 to <128 x i8>*
  store <128 x i8> %239, <128 x i8>* %401, align 1, !tbaa !97
  %402 = add nuw nsw i32 %output.s0.c.c14.us.us.us.us.us.us, 1
  %.not95.us.us.us.us.us.us = icmp eq i32 %402, %235
  br i1 %.not95.us.us.us.us.us.us, label %"end for output.s0.c.c13.split.us.us.us.us.us", label %"for output.s0.c.c12.us.us.us.us.us.us"

"end for output.s0.y.rebased7.loopexit.split.us.us.us": ; preds = %"end for output.s0.x.rebased10.loopexit.us.us.us"
  %403 = add nuw nsw i32 %output.s0.b.rebased5.us.us, 1
  %.not93.us.us = icmp eq i32 %403, %7
  br i1 %.not93.us.us, label %call_destructor.exit, label %"for output.s0.b.rebased3.us.us"

next_bb2:                                         ; preds = %next_bb
  %404 = icmp sgt i32 %1, 63
  %405 = icmp sgt i32 %7, 0
  br i1 %404, label %then_bb23, label %next_bb24

then_bb23:                                        ; preds = %next_bb2
  br i1 %405, label %"for output.s0.b.rebased25.preheader", label %call_destructor.exit, !prof !95

"for output.s0.b.rebased25.preheader":            ; preds = %then_bb23
  %.neg188 = mul i32 %12, %10
  %.neg187 = mul i32 %15, %13
  %.neg186 = mul i32 %16, %6
  %406 = icmp sgt i32 %14, 0
  %407 = add nsw i32 %5, %4
  %408 = add nsw i32 %3, %2
  %409 = add nuw nsw i32 %1, 63
  %410 = ashr i32 %409, 6
  %b36 = add nsw i32 %1, -64
  %411 = icmp ult i8 %a55, %b57
  %412 = select i1 %411, i8 %a55, i8 %b57
  %413 = insertelement <64 x i8> undef, i8 %412, i32 0
  %414 = shufflevector <64 x i8> %413, <64 x i8> undef, <64 x i32> zeroinitializer
  %reass.add198 = add i32 %.neg187, %.neg188
  %reass.add199 = add i32 %reass.add198, %.neg186
  %415 = icmp sgt i32 %11, 0
  %or.cond441 = and i1 %406, %415
  br i1 %or.cond441, label %"for output.s0.b.rebased25.us.us.preheader", label %call_destructor.exit, !prof !103
...
"for output.s0.b.rebased25.us.us.preheader":      ; preds = %"for output.s0.b.rebased25.preheader"
  ...
  %418 = add i32 %3, %2
  %419 = mul i32 %10, %stride_x
  %420 = sub i32 %418, %419
  %421 = sub i32 %2, %419
  %422 = add i32 %5, %4
  %423 = mul i32 %13, %stride_y
  %424 = sub i32 %422, %423
  %425 = sub i32 %4, %423
  %xtraiter485 = and i32 %410, 7
  %426 = icmp ult i32 %416, 7
  %unroll_iter488 = and i32 %410, -8
  %lcmp.mod487.not = icmp eq i32 %xtraiter485, 0
  %xtraiter490 = and i32 %410, 7
  %427 = icmp ult i32 %417, 7
  %unroll_iter493 = and i32 %410, -8
  %lcmp.mod492.not = icmp eq i32 %xtraiter490, 0
...
"for output.s0.b.rebased25.us.us":                ; preds = %"for output.s0.b.rebased25.us.us.preheader", %"end for output.s0.y.rebased29.loopexit.split.us.us.us"
  %output.s0.b.rebased27.us.us = phi i32 [ %578, %"end for output.s0.y.rebased29.loopexit.split.us.us.us" ], [ 0, %"for output.s0.b.rebased25.us.us.preheader" ]
  %428 = add nsw i32 %output.s0.b.rebased27.us.us, %6
...
"for output.s0.y.rebased28.us.us.us":             ; preds = %"end for output.s0.x.rebased32.loopexit.us.us.us", %"for output.s0.b.rebased25.us.us"
  %output.s0.y.rebased30.us.us.us = phi i32 [ %500, %"end for output.s0.x.rebased32.loopexit.us.us.us" ], [ 0, %"for output.s0.b.rebased25.us.us" ]
  %430 = mul i32 %output.s0.y.rebased30.us.us.us, %stride_y
  %431 = sub i32 %424, %430
  %432 = icmp sgt i32 %431, %b45
  %smin505 = select i1 %432, i32 %b45, i32 %431
  %433 = sub i32 %425, %430
  %434 = icmp sgt i32 %433, %b45
  %smin506 = select i1 %434, i32 %b45, i32 %433
  %435 = icmp sgt i32 %smin505, %smin506
  %smax507 = select i1 %435, i32 %smin505, i32 %smin506
  %436 = icmp sgt i32 %smax507, 0
  %smax508 = select i1 %436, i32 %smax507, i32 0
  %437 = icmp sgt i32 %smin506, 0
  %smax509 = select i1 %437, i32 %smin506, i32 0
  %438 = sub nsw i32 %smax508, %smax509
  %.neg582 = add nuw i32 %smax509, 1
  %439 = add nsw i32 %output.s0.y.rebased30.us.us.us, %13
  %440 = mul nsw i32 %439, %stride_y
  %a28.us.us.us = sub i32 %407, %440
  %441 = icmp slt i32 %a28.us.us.us, %b45
  %b32.us.us.us = select i1 %441, i32 %a28.us.us.us, i32 %b45
  %a29.us.us.us = sub nsw i32 %4, %440
  %442 = icmp slt i32 %a29.us.us.us, %b45
  %a37.us.us.us = select i1 %442, i32 %a29.us.us.us, i32 %b45
  %443 = icmp sgt i32 %a37.us.us.us, %b32.us.us.us
  %a36.us.us.us = select i1 %443, i32 %a37.us.us.us, i32 %b32.us.us.us
  %444 = icmp sgt i32 %a37.us.us.us, 0
  %445 = select i1 %444, i32 %a37.us.us.us, i32 0
  %446 = mul nsw i32 %439, %15
  %447 = icmp sgt i32 %a36.us.us.us, 0
  %448 = select i1 %447, i32 %a36.us.us.us, i32 0
  %449 = icmp sgt i32 %448, %445
  %t296.us.us.us = add i32 %446, %429
  br i1 %449, label %"for output.s0.x.rebased31.us.us.us.us.preheader", label %"for output.s0.x.rebased31.us310.us.us", !prof !95

"for output.s0.x.rebased31.us.us.us.us.preheader": ; preds = %"for output.s0.y.rebased28.us.us.us"
  %xtraiter510 = and i32 %438, 1
  %450 = icmp eq i32 %smax508, %.neg582
  %unroll_iter514 = and i32 %438, -2
  %lcmp.mod513.not = icmp eq i32 %xtraiter510, 0
  br label %"for output.s0.x.rebased31.us.us.us.us"

"for output.s0.x.rebased31.us310.us.us":          ; preds = %"for output.s0.y.rebased28.us.us.us", %"end for output.s0.c.c35.split.us.us.us"
  %output.s0.x.rebased33.us311.us.us = phi i32 [ %499, %"end for output.s0.c.c35.split.us.us.us" ], [ 0, %"for output.s0.y.rebased28.us.us.us" ]
  %451 = add nsw i32 %output.s0.x.rebased33.us311.us.us, %10
  %452 = mul nsw i32 %451, %12
  %453 = add i32 %t296.us.us.us, %452
  br i1 %426, label %"end for output.s0.c.c35.split.us.us.us.unr-lcssa", label %"for output.s0.c.c34.us.us.us"

"for output.s0.c.c34.us.us.us":                   ; preds = %"for output.s0.x.rebased31.us310.us.us", %"for output.s0.c.c34.us.us.us"
  %output.s0.c.c36.us.us.us = phi i32 [ %493, %"for output.s0.c.c34.us.us.us" ], [ 0, %"for output.s0.x.rebased31.us310.us.us" ]
  %niter489 = phi i32 [ %niter489.nsub.7, %"for output.s0.c.c34.us.us.us" ], [ %unroll_iter488, %"for output.s0.x.rebased31.us310.us.us" ]
  %a34.us.us.us = shl nsw i32 %output.s0.c.c36.us.us.us, 6
  %454 = icmp slt i32 %a34.us.us.us, %b36
  %output.s0.c.v4.base.s.us.us.us = select i1 %454, i32 %a34.us.us.us, i32 %b36
  %t310.us.us.us = add i32 %453, %output.s0.c.v4.base.s.us.us.us
  %455 = sub i32 %t310.us.us.us, %reass.add199
  %456 = getelementptr inbounds i8, i8* %8, i32 %455
  %457 = bitcast i8* %456 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %457, align 1, !tbaa !97
  %458 = shl i32 %output.s0.c.c36.us.us.us, 6
  %a34.us.us.us.1 = or i32 %458, 64
  %459 = icmp slt i32 %a34.us.us.us.1, %b36
  %output.s0.c.v4.base.s.us.us.us.1 = select i1 %459, i32 %a34.us.us.us.1, i32 %b36
  %t310.us.us.us.1 = add i32 %453, %output.s0.c.v4.base.s.us.us.us.1
  %460 = sub i32 %t310.us.us.us.1, %reass.add199
  %461 = getelementptr inbounds i8, i8* %8, i32 %460
  %462 = bitcast i8* %461 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %462, align 1, !tbaa !97
  %463 = shl i32 %output.s0.c.c36.us.us.us, 6
  %a34.us.us.us.2 = or i32 %463, 128
  %464 = icmp slt i32 %a34.us.us.us.2, %b36
  %output.s0.c.v4.base.s.us.us.us.2 = select i1 %464, i32 %a34.us.us.us.2, i32 %b36
  %t310.us.us.us.2 = add i32 %453, %output.s0.c.v4.base.s.us.us.us.2
  %465 = sub i32 %t310.us.us.us.2, %reass.add199
  %466 = getelementptr inbounds i8, i8* %8, i32 %465
  %467 = bitcast i8* %466 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %467, align 1, !tbaa !97
  %468 = shl i32 %output.s0.c.c36.us.us.us, 6
  %a34.us.us.us.3 = or i32 %468, 192
  %469 = icmp slt i32 %a34.us.us.us.3, %b36
  %output.s0.c.v4.base.s.us.us.us.3 = select i1 %469, i32 %a34.us.us.us.3, i32 %b36
  %t310.us.us.us.3 = add i32 %453, %output.s0.c.v4.base.s.us.us.us.3
  %470 = sub i32 %t310.us.us.us.3, %reass.add199
  %471 = getelementptr inbounds i8, i8* %8, i32 %470
  %472 = bitcast i8* %471 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %472, align 1, !tbaa !97
  %473 = shl i32 %output.s0.c.c36.us.us.us, 6
  %a34.us.us.us.4 = or i32 %473, 256
  %474 = icmp slt i32 %a34.us.us.us.4, %b36
  %output.s0.c.v4.base.s.us.us.us.4 = select i1 %474, i32 %a34.us.us.us.4, i32 %b36
  %t310.us.us.us.4 = add i32 %453, %output.s0.c.v4.base.s.us.us.us.4
  %475 = sub i32 %t310.us.us.us.4, %reass.add199
  %476 = getelementptr inbounds i8, i8* %8, i32 %475
  %477 = bitcast i8* %476 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %477, align 1, !tbaa !97
  %478 = shl i32 %output.s0.c.c36.us.us.us, 6
  %a34.us.us.us.5 = or i32 %478, 320
  %479 = icmp slt i32 %a34.us.us.us.5, %b36
  %output.s0.c.v4.base.s.us.us.us.5 = select i1 %479, i32 %a34.us.us.us.5, i32 %b36
  %t310.us.us.us.5 = add i32 %453, %output.s0.c.v4.base.s.us.us.us.5
  %480 = sub i32 %t310.us.us.us.5, %reass.add199
  %481 = getelementptr inbounds i8, i8* %8, i32 %480
  %482 = bitcast i8* %481 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %482, align 1, !tbaa !97
  %483 = shl i32 %output.s0.c.c36.us.us.us, 6
  %a34.us.us.us.6 = or i32 %483, 384
  %484 = icmp slt i32 %a34.us.us.us.6, %b36
  %output.s0.c.v4.base.s.us.us.us.6 = select i1 %484, i32 %a34.us.us.us.6, i32 %b36
  %t310.us.us.us.6 = add i32 %453, %output.s0.c.v4.base.s.us.us.us.6
  %485 = sub i32 %t310.us.us.us.6, %reass.add199
  %486 = getelementptr inbounds i8, i8* %8, i32 %485
  %487 = bitcast i8* %486 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %487, align 1, !tbaa !97
  %488 = shl i32 %output.s0.c.c36.us.us.us, 6
  %a34.us.us.us.7 = or i32 %488, 448
  %489 = icmp slt i32 %a34.us.us.us.7, %b36
  %output.s0.c.v4.base.s.us.us.us.7 = select i1 %489, i32 %a34.us.us.us.7, i32 %b36
  %t310.us.us.us.7 = add i32 %453, %output.s0.c.v4.base.s.us.us.us.7
  %490 = sub i32 %t310.us.us.us.7, %reass.add199
  %491 = getelementptr inbounds i8, i8* %8, i32 %490
  %492 = bitcast i8* %491 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %492, align 1, !tbaa !97
  %493 = add nuw nsw i32 %output.s0.c.c36.us.us.us, 8
  %niter489.nsub.7 = add i32 %niter489, -8
  %niter489.ncmp.7 = icmp eq i32 %niter489.nsub.7, 0
  br i1 %niter489.ncmp.7, label %"end for output.s0.c.c35.split.us.us.us.unr-lcssa", label %"for output.s0.c.c34.us.us.us"

"end for output.s0.c.c35.split.us.us.us.unr-lcssa": ; preds = %"for output.s0.c.c34.us.us.us", %"for output.s0.x.rebased31.us310.us.us"
  %output.s0.c.c36.us.us.us.unr = phi i32 [ 0, %"for output.s0.x.rebased31.us310.us.us" ], [ %493, %"for output.s0.c.c34.us.us.us" ]
  br i1 %lcmp.mod487.not, label %"end for output.s0.c.c35.split.us.us.us", label %"for output.s0.c.c34.us.us.us.epil"
...
"for output.s0.c.c34.us.us.us.epil":              ; preds = %"end for output.s0.c.c35.split.us.us.us.unr-lcssa", %"for output.s0.c.c34.us.us.us.epil"
  %output.s0.c.c36.us.us.us.epil = phi i32 [ %498, %"for output.s0.c.c34.us.us.us.epil" ], [ %output.s0.c.c36.us.us.us.unr, %"end for output.s0.c.c35.split.us.us.us.unr-lcssa" ]
  %epil.iter486 = phi i32 [ %epil.iter486.sub, %"for output.s0.c.c34.us.us.us.epil" ], [ %xtraiter485, %"end for output.s0.c.c35.split.us.us.us.unr-lcssa" ]
  %a34.us.us.us.epil = shl nsw i32 %output.s0.c.c36.us.us.us.epil, 6
  %494 = icmp slt i32 %a34.us.us.us.epil, %b36
  %output.s0.c.v4.base.s.us.us.us.epil = select i1 %494, i32 %a34.us.us.us.epil, i32 %b36
  %t310.us.us.us.epil = add i32 %453, %output.s0.c.v4.base.s.us.us.us.epil
  %495 = sub i32 %t310.us.us.us.epil, %reass.add199
  %496 = getelementptr inbounds i8, i8* %8, i32 %495
  %497 = bitcast i8* %496 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %497, align 1, !tbaa !97
  %498 = add nuw nsw i32 %output.s0.c.c36.us.us.us.epil, 1
  %epil.iter486.sub = add i32 %epil.iter486, -1
  %epil.iter486.cmp.not = icmp eq i32 %epil.iter486.sub, 0
  br i1 %epil.iter486.cmp.not, label %"end for output.s0.c.c35.split.us.us.us", label %"for output.s0.c.c34.us.us.us.epil", !llvm.loop !107
...
"end for output.s0.c.c35.split.us.us.us":         ; preds = %"for output.s0.c.c34.us.us.us.epil", %"end for output.s0.c.c35.split.us.us.us.unr-lcssa"
  %499 = add nuw nsw i32 %output.s0.x.rebased33.us311.us.us, 1
  %.not90.us312.us.us = icmp eq i32 %499, %11
  br i1 %.not90.us312.us.us, label %"end for output.s0.x.rebased32.loopexit.us.us.us", label %"for output.s0.x.rebased31.us310.us.us"
...
"end for output.s0.x.rebased32.loopexit.us.us.us": ; preds = %"end for output.s0.c.c35.split.us.us.us", %"end for output.s0.c.c35.split.us.us.us.us.us"
  %500 = add nuw nsw i32 %output.s0.y.rebased30.us.us.us, 1
  %.not88.us.us.us = icmp eq i32 %500, %14
...
"for output.s0.x.rebased31.us.us.us.us":          ; preds = %"for output.s0.x.rebased31.us.us.us.us.preheader", %"end for output.s0.c.c35.split.us.us.us.us.us"
  %output.s0.x.rebased33.us.us.us.us = phi i32 [ %572, %"end for output.s0.c.c35.split.us.us.us.us.us" ], [ 0, %"for output.s0.x.rebased31.us.us.us.us.preheader" ]
  %501 = mul i32 %output.s0.x.rebased33.us.us.us.us, %stride_x
  %502 = sub i32 %420, %501
  %503 = icmp sgt i32 %502, %b48
  %smin495 = select i1 %503, i32 %b48, i32 %502
  %504 = sub i32 %421, %501
  %505 = icmp sgt i32 %504, %b48
  %smin496 = select i1 %505, i32 %b48, i32 %504
  %506 = icmp sgt i32 %smin495, %smin496
  %smax497 = select i1 %506, i32 %smin495, i32 %smin496
  %507 = icmp sgt i32 %smax497, 0
  %smax498 = select i1 %507, i32 %smax497, i32 0
  %508 = icmp sgt i32 %smin496, 0
  %smax499 = select i1 %508, i32 %smin496, i32 0
  %509 = sub nsw i32 %smax498, %smax499
  %510 = xor i32 %smax499, -1
  %511 = add nsw i32 %smax498, %510
  %512 = add nsw i32 %output.s0.x.rebased33.us.us.us.us, %10
  %513 = mul nsw i32 %512, %stride_x
  %a31.us.us.us.us = sub i32 %408, %513
  %514 = icmp slt i32 %a31.us.us.us.us, %b48
  %b37.us.us.us.us = select i1 %514, i32 %a31.us.us.us.us, i32 %b48
  %a32.us.us.us.us = sub nsw i32 %2, %513
  %515 = icmp slt i32 %a32.us.us.us.us, %b48
  %a40.us.us.us.us = select i1 %515, i32 %a32.us.us.us.us, i32 %b48
  %516 = mul nsw i32 %512, %12
  %517 = icmp sgt i32 %a40.us.us.us.us, %b37.us.us.us.us
  %a39.us.us.us.us = select i1 %517, i32 %a40.us.us.us.us, i32 %b37.us.us.us.us
  %518 = icmp sgt i32 %a40.us.us.us.us, 0
  %519 = select i1 %518, i32 %a40.us.us.us.us, i32 0
  %520 = icmp sgt i32 %a39.us.us.us.us, 0
  %521 = select i1 %520, i32 %a39.us.us.us.us, i32 0
  %522 = icmp sgt i32 %521, %519
  %523 = add i32 %t296.us.us.us, %516
  br i1 %522, label %"for output.s0.c.c34.us.us.us.us.us.us.preheader", label %"for output.s0.c.c34.us.us299.us.us.us.preheader", !prof !95

"for output.s0.c.c34.us.us299.us.us.us.preheader": ; preds = %"for output.s0.x.rebased31.us.us.us.us"
  br i1 %427, label %"end for output.s0.c.c35.split.us.us.us.us.us.loopexit460.unr-lcssa", label %"for output.s0.c.c34.us.us299.us.us.us"

"for output.s0.c.c34.us.us.us.us.us.us.preheader": ; preds = %"for output.s0.x.rebased31.us.us.us.us"
  %xtraiter500 = and i32 %509, 7
  %524 = icmp ult i32 %511, 7
  %unroll_iter503 = and i32 %509, -8
  %lcmp.mod502.not = icmp eq i32 %xtraiter500, 0
  %xtraiter500.1 = and i32 %509, 7
  %525 = icmp ult i32 %511, 7
  %unroll_iter503.1 = and i32 %509, -8
  %lcmp.mod502.1.not = icmp eq i32 %xtraiter500.1, 0
  %xtraiter500.epil = and i32 %509, 7
  %526 = icmp ult i32 %511, 7
  %unroll_iter503.epil = and i32 %509, -8
  %lcmp.mod502.epil.not = icmp eq i32 %xtraiter500.epil, 0
  br label %"for output.s0.c.c34.us.us.us.us.us.us"

"for output.s0.c.c34.us.us299.us.us.us":          ; preds = %"for output.s0.c.c34.us.us299.us.us.us.preheader", %"for output.s0.c.c34.us.us299.us.us.us"
  %output.s0.c.c36.us.us300.us.us.us = phi i32 [ %566, %"for output.s0.c.c34.us.us299.us.us.us" ], [ 0, %"for output.s0.c.c34.us.us299.us.us.us.preheader" ]
  %niter494 = phi i32 [ %niter494.nsub.7, %"for output.s0.c.c34.us.us299.us.us.us" ], [ %unroll_iter493, %"for output.s0.c.c34.us.us299.us.us.us.preheader" ]
  %a34.us.us301.us.us.us = shl nsw i32 %output.s0.c.c36.us.us300.us.us.us, 6
  %527 = icmp slt i32 %a34.us.us301.us.us.us, %b36
  %output.s0.c.v4.base.s.us.us302.us.us.us = select i1 %527, i32 %a34.us.us301.us.us.us, i32 %b36
  %t310.us.us303.us.us.us = add i32 %523, %output.s0.c.v4.base.s.us.us302.us.us.us
  %528 = sub i32 %t310.us.us303.us.us.us, %reass.add199
  %529 = getelementptr inbounds i8, i8* %8, i32 %528
  %530 = bitcast i8* %529 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %530, align 1, !tbaa !97
  %531 = shl i32 %output.s0.c.c36.us.us300.us.us.us, 6
  %a34.us.us301.us.us.us.1 = or i32 %531, 64
  %532 = icmp slt i32 %a34.us.us301.us.us.us.1, %b36
  %output.s0.c.v4.base.s.us.us302.us.us.us.1 = select i1 %532, i32 %a34.us.us301.us.us.us.1, i32 %b36
  %t310.us.us303.us.us.us.1 = add i32 %523, %output.s0.c.v4.base.s.us.us302.us.us.us.1
  %533 = sub i32 %t310.us.us303.us.us.us.1, %reass.add199
  %534 = getelementptr inbounds i8, i8* %8, i32 %533
  %535 = bitcast i8* %534 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %535, align 1, !tbaa !97
  %536 = shl i32 %output.s0.c.c36.us.us300.us.us.us, 6
  %a34.us.us301.us.us.us.2 = or i32 %536, 128
  %537 = icmp slt i32 %a34.us.us301.us.us.us.2, %b36
  %output.s0.c.v4.base.s.us.us302.us.us.us.2 = select i1 %537, i32 %a34.us.us301.us.us.us.2, i32 %b36
  %t310.us.us303.us.us.us.2 = add i32 %523, %output.s0.c.v4.base.s.us.us302.us.us.us.2
  %538 = sub i32 %t310.us.us303.us.us.us.2, %reass.add199
  %539 = getelementptr inbounds i8, i8* %8, i32 %538
  %540 = bitcast i8* %539 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %540, align 1, !tbaa !97
  %541 = shl i32 %output.s0.c.c36.us.us300.us.us.us, 6
  %a34.us.us301.us.us.us.3 = or i32 %541, 192
  %542 = icmp slt i32 %a34.us.us301.us.us.us.3, %b36
  %output.s0.c.v4.base.s.us.us302.us.us.us.3 = select i1 %542, i32 %a34.us.us301.us.us.us.3, i32 %b36
  %t310.us.us303.us.us.us.3 = add i32 %523, %output.s0.c.v4.base.s.us.us302.us.us.us.3
  %543 = sub i32 %t310.us.us303.us.us.us.3, %reass.add199
  %544 = getelementptr inbounds i8, i8* %8, i32 %543
  %545 = bitcast i8* %544 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %545, align 1, !tbaa !97
  %546 = shl i32 %output.s0.c.c36.us.us300.us.us.us, 6
  %a34.us.us301.us.us.us.4 = or i32 %546, 256
  %547 = icmp slt i32 %a34.us.us301.us.us.us.4, %b36
  %output.s0.c.v4.base.s.us.us302.us.us.us.4 = select i1 %547, i32 %a34.us.us301.us.us.us.4, i32 %b36
  %t310.us.us303.us.us.us.4 = add i32 %523, %output.s0.c.v4.base.s.us.us302.us.us.us.4
  %548 = sub i32 %t310.us.us303.us.us.us.4, %reass.add199
  %549 = getelementptr inbounds i8, i8* %8, i32 %548
  %550 = bitcast i8* %549 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %550, align 1, !tbaa !97
  %551 = shl i32 %output.s0.c.c36.us.us300.us.us.us, 6
  %a34.us.us301.us.us.us.5 = or i32 %551, 320
  %552 = icmp slt i32 %a34.us.us301.us.us.us.5, %b36
  %output.s0.c.v4.base.s.us.us302.us.us.us.5 = select i1 %552, i32 %a34.us.us301.us.us.us.5, i32 %b36
  %t310.us.us303.us.us.us.5 = add i32 %523, %output.s0.c.v4.base.s.us.us302.us.us.us.5
  %553 = sub i32 %t310.us.us303.us.us.us.5, %reass.add199
  %554 = getelementptr inbounds i8, i8* %8, i32 %553
  %555 = bitcast i8* %554 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %555, align 1, !tbaa !97
  %556 = shl i32 %output.s0.c.c36.us.us300.us.us.us, 6
  %a34.us.us301.us.us.us.6 = or i32 %556, 384
  %557 = icmp slt i32 %a34.us.us301.us.us.us.6, %b36
  %output.s0.c.v4.base.s.us.us302.us.us.us.6 = select i1 %557, i32 %a34.us.us301.us.us.us.6, i32 %b36
  %t310.us.us303.us.us.us.6 = add i32 %523, %output.s0.c.v4.base.s.us.us302.us.us.us.6
  %558 = sub i32 %t310.us.us303.us.us.us.6, %reass.add199
  %559 = getelementptr inbounds i8, i8* %8, i32 %558
  %560 = bitcast i8* %559 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %560, align 1, !tbaa !97
  %561 = shl i32 %output.s0.c.c36.us.us300.us.us.us, 6
  %a34.us.us301.us.us.us.7 = or i32 %561, 448
  %562 = icmp slt i32 %a34.us.us301.us.us.us.7, %b36
  %output.s0.c.v4.base.s.us.us302.us.us.us.7 = select i1 %562, i32 %a34.us.us301.us.us.us.7, i32 %b36
  %t310.us.us303.us.us.us.7 = add i32 %523, %output.s0.c.v4.base.s.us.us302.us.us.us.7
  %563 = sub i32 %t310.us.us303.us.us.us.7, %reass.add199
  %564 = getelementptr inbounds i8, i8* %8, i32 %563
  %565 = bitcast i8* %564 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %565, align 1, !tbaa !97
  %566 = add nuw nsw i32 %output.s0.c.c36.us.us300.us.us.us, 8
  %niter494.nsub.7 = add i32 %niter494, -8
  %niter494.ncmp.7 = icmp eq i32 %niter494.nsub.7, 0
  br i1 %niter494.ncmp.7, label %"end for output.s0.c.c35.split.us.us.us.us.us.loopexit460.unr-lcssa", label %"for output.s0.c.c34.us.us299.us.us.us"

"end for output.s0.c.c35.split.us.us.us.us.us.loopexit460.unr-lcssa": ; preds = %"for output.s0.c.c34.us.us299.us.us.us", %"for output.s0.c.c34.us.us299.us.us.us.preheader"
  %output.s0.c.c36.us.us300.us.us.us.unr = phi i32 [ 0, %"for output.s0.c.c34.us.us299.us.us.us.preheader" ], [ %566, %"for output.s0.c.c34.us.us299.us.us.us" ]
  br i1 %lcmp.mod492.not, label %"end for output.s0.c.c35.split.us.us.us.us.us", label %"for output.s0.c.c34.us.us299.us.us.us.epil"

"for output.s0.c.c34.us.us299.us.us.us.epil":     ; preds = %"end for output.s0.c.c35.split.us.us.us.us.us.loopexit460.unr-lcssa", %"for output.s0.c.c34.us.us299.us.us.us.epil"
  %output.s0.c.c36.us.us300.us.us.us.epil = phi i32 [ %571, %"for output.s0.c.c34.us.us299.us.us.us.epil" ], [ %output.s0.c.c36.us.us300.us.us.us.unr, %"end for output.s0.c.c35.split.us.us.us.us.us.loopexit460.unr-lcssa" ]
  %epil.iter491 = phi i32 [ %epil.iter491.sub, %"for output.s0.c.c34.us.us299.us.us.us.epil" ], [ %xtraiter490, %"end for output.s0.c.c35.split.us.us.us.us.us.loopexit460.unr-lcssa" ]
  %a34.us.us301.us.us.us.epil = shl nsw i32 %output.s0.c.c36.us.us300.us.us.us.epil, 6
  %567 = icmp slt i32 %a34.us.us301.us.us.us.epil, %b36
  %output.s0.c.v4.base.s.us.us302.us.us.us.epil = select i1 %567, i32 %a34.us.us301.us.us.us.epil, i32 %b36
  %t310.us.us303.us.us.us.epil = add i32 %523, %output.s0.c.v4.base.s.us.us302.us.us.us.epil
  %568 = sub i32 %t310.us.us303.us.us.us.epil, %reass.add199
  %569 = getelementptr inbounds i8, i8* %8, i32 %568
  %570 = bitcast i8* %569 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %570, align 1, !tbaa !97
  %571 = add nuw nsw i32 %output.s0.c.c36.us.us300.us.us.us.epil, 1
  %epil.iter491.sub = add i32 %epil.iter491, -1
  %epil.iter491.cmp.not = icmp eq i32 %epil.iter491.sub, 0
  br i1 %epil.iter491.cmp.not, label %"end for output.s0.c.c35.split.us.us.us.us.us", label %"for output.s0.c.c34.us.us299.us.us.us.epil", !llvm.loop !108

"end for output.s0.c.c35.split.us.us.us.us.us":   ; preds = %"end for output.s0.c.c35.split.us.us.us.us.us.loopexit460.unr-lcssa", %"for output.s0.c.c34.us.us299.us.us.us.epil", %"consume maximum44.loopexit.split.us.us.us.us.us.us.us"
  %572 = add nuw nsw i32 %output.s0.x.rebased33.us.us.us.us, 1
  %.not90.us.us.us.us = icmp eq i32 %572, %11
...
"for output.s0.c.c34.us.us.us.us.us.us":          ; preds = %"for output.s0.c.c34.us.us.us.us.us.us.preheader", %"consume maximum44.loopexit.split.us.us.us.us.us.us.us"
  %output.s0.c.c36.us.us.us.us.us.us = phi i32 [ %577, %"consume maximum44.loopexit.split.us.us.us.us.us.us.us" ], [ 0, %"for output.s0.c.c34.us.us.us.us.us.us.preheader" ]
  %a34.us.us.us.us.us.us = shl nsw i32 %output.s0.c.c36.us.us.us.us.us.us, 6
  %573 = icmp slt i32 %a34.us.us.us.us.us.us, %b36
  %output.s0.c.v4.base.s.us.us.us.us.us.us = select i1 %573, i32 %a34.us.us.us.us.us.us, i32 %b36
  br i1 %450, label %"consume maximum44.loopexit.split.us.us.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$y.rebased38.us.us.us.us.us.us.us"

"for maximum.s1.r12$y.rebased38.us.us.us.us.us.us.us": ; preds = %"for output.s0.c.c34.us.us.us.us.us.us", %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.1"
  %niter515 = phi i32 [ %niter515.nsub.1, %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.1" ], [ %unroll_iter514, %"for output.s0.c.c34.us.us.us.us.us.us" ]
  br i1 %524, label %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us"
...
"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us": ; preds = %"for maximum.s1.r12$y.rebased38.us.us.us.us.us.us.us", %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us"
  %niter504 = phi i32 [ %niter504.nsub.7, %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us" ], [ %unroll_iter503, %"for maximum.s1.r12$y.rebased38.us.us.us.us.us.us.us" ]
  %niter504.nsub.7 = add i32 %niter504, -8
  %niter504.ncmp.7 = icmp eq i32 %niter504.nsub.7, 0
  br i1 %niter504.ncmp.7, label %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us"
...
"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa": ; preds = %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us", %"for maximum.s1.r12$y.rebased38.us.us.us.us.us.us.us"
  br i1 %lcmp.mod502.not, label %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil"
...
"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil": ; preds = %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa", %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil"
  %epil.iter501 = phi i32 [ %epil.iter501.sub, %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil" ], [ %xtraiter500, %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa" ]
  %epil.iter501.sub = add i32 %epil.iter501, -1
  %epil.iter501.cmp.not = icmp eq i32 %epil.iter501.sub, 0
  br i1 %epil.iter501.cmp.not, label %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil", !llvm.loop !109
...
"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us": ; preds = %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil", %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa"
  br i1 %525, label %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa.1", label %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.1"

"consume maximum44.loopexit.split.us.us.us.us.us.us.us.unr-lcssa": ; preds = %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.1", %"for output.s0.c.c34.us.us.us.us.us.us"
  br i1 %lcmp.mod513.not, label %"consume maximum44.loopexit.split.us.us.us.us.us.us.us", label %"for maximum.s1.r12$y.rebased38.us.us.us.us.us.us.us.epil"

"for maximum.s1.r12$y.rebased38.us.us.us.us.us.us.us.epil": ; preds = %"consume maximum44.loopexit.split.us.us.us.us.us.us.us.unr-lcssa"
  br i1 %526, label %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa.epil", label %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil511"

"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil511": ; preds = %"for maximum.s1.r12$y.rebased38.us.us.us.us.us.us.us.epil", %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil511"
  %niter504.epil = phi i32 [ %niter504.nsub.7.epil, %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil511" ], [ %unroll_iter503.epil, %"for maximum.s1.r12$y.rebased38.us.us.us.us.us.us.us.epil" ]
  %niter504.nsub.7.epil = add i32 %niter504.epil, -8
  %niter504.ncmp.7.epil = icmp eq i32 %niter504.nsub.7.epil, 0
  br i1 %niter504.ncmp.7.epil, label %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa.epil", label %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil511"

"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa.epil": ; preds = %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil511", %"for maximum.s1.r12$y.rebased38.us.us.us.us.us.us.us.epil"
  br i1 %lcmp.mod502.epil.not, label %"consume maximum44.loopexit.split.us.us.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.epil"

"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.epil": ; preds = %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa.epil", %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.epil"
  %epil.iter501.epil = phi i32 [ %epil.iter501.sub.epil, %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.epil" ], [ %xtraiter500.epil, %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa.epil" ]
  %epil.iter501.sub.epil = add i32 %epil.iter501.epil, -1
  %epil.iter501.cmp.epil.not = icmp eq i32 %epil.iter501.sub.epil, 0
  br i1 %epil.iter501.cmp.epil.not, label %"consume maximum44.loopexit.split.us.us.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.epil", !llvm.loop !109

"consume maximum44.loopexit.split.us.us.us.us.us.us.us": ; preds = %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.epil", %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa.epil", %"consume maximum44.loopexit.split.us.us.us.us.us.us.us.unr-lcssa"
  %t310.us.us.us.us.us.us = add i32 %523, %output.s0.c.v4.base.s.us.us.us.us.us.us
  %574 = sub i32 %t310.us.us.us.us.us.us, %reass.add199
  %575 = getelementptr inbounds i8, i8* %8, i32 %574
  %576 = bitcast i8* %575 to <64 x i8>*
  store <64 x i8> %414, <64 x i8>* %576, align 1, !tbaa !97
  %577 = add nuw nsw i32 %output.s0.c.c36.us.us.us.us.us.us, 1
  %.not89.us.us.us.us.us.us = icmp eq i32 %577, %410
...
"end for output.s0.y.rebased29.loopexit.split.us.us.us": ; preds = %"end for output.s0.x.rebased32.loopexit.us.us.us"
  %578 = add nuw nsw i32 %output.s0.b.rebased27.us.us, 1
  %.not87.us.us = icmp eq i32 %578, %7
  br i1 %.not87.us.us, label %call_destructor.exit, label %"for output.s0.b.rebased25.us.us"

next_bb24:                                        ; preds = %next_bb2
  br i1 %405, label %"for output.s0.b.rebased45.preheader", label %call_destructor.exit, !prof !95

"for output.s0.b.rebased45.preheader":            ; preds = %next_bb24
  %.neg175 = mul i32 %12, %10
  %.neg174 = mul i32 %15, %13
  %.neg = mul i32 %16, %6
  %579 = icmp slt i32 %14, 1
  %580 = add nsw i32 %5, %4
  %581 = add nsw i32 %3, %2
  %582 = icmp slt i32 %1, 1
  %583 = icmp ult i8 %a55, %b57
  %584 = select i1 %583, i8 %a55, i8 %b57
  %reass.add183 = add i32 %.neg174, %.neg175
  %reass.add184 = add i32 %reass.add183, %.neg
  %585 = icmp slt i32 %11, 1
  %or.cond442.not = or i1 %579, %585
  %brmerge444 = or i1 %or.cond442.not, %582
  br i1 %brmerge444, label %call_destructor.exit, label %"for output.s0.b.rebased45.us.us.us.preheader", !prof !96

"for output.s0.b.rebased45.us.us.us.preheader":   ; preds = %"for output.s0.b.rebased45.preheader"
  %586 = add i32 %11, -1
  %587 = add i32 %3, %2
  %588 = mul i32 %10, %stride_x
  %589 = sub i32 %587, %588
  %590 = sub i32 %2, %588
  %591 = add i32 %5, %4
  %592 = mul i32 %13, %stride_y
  %593 = sub i32 %591, %592
  %594 = sub i32 %4, %592
  %xtraiter = and i32 %11, 7
  %595 = icmp ult i32 %586, 7
...
"for output.s0.b.rebased45.us.us.us":             ; preds = %"for output.s0.b.rebased45.us.us.us.preheader", %"end for output.s0.y.rebased49.loopexit.split.us.us.us.split.us.us"
  %output.s0.b.rebased47.us.us.us = phi i32 [ %646, %"end for output.s0.y.rebased49.loopexit.split.us.us.us.split.us.us" ], [ 0, %"for output.s0.b.rebased45.us.us.us.preheader" ]
  %596 = mul i32 %16, %output.s0.b.rebased47.us.us.us
  %597 = add nsw i32 %output.s0.b.rebased47.us.us.us, %6
...
"for output.s0.y.rebased48.us.us.us.us.us":       ; preds = %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us", %"for output.s0.b.rebased45.us.us.us"
  %output.s0.y.rebased50.us.us.us.us.us = phi i32 [ %650, %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us" ], [ 0, %"for output.s0.b.rebased45.us.us.us" ]
  %599 = mul i32 %output.s0.y.rebased50.us.us.us.us.us, %stride_y
  %600 = sub i32 %593, %599
  %601 = icmp sgt i32 %600, %b45
  %smin473 = select i1 %601, i32 %b45, i32 %600
  %602 = sub i32 %594, %599
  %603 = icmp sgt i32 %602, %b45
  %smin474 = select i1 %603, i32 %b45, i32 %602
  %604 = icmp sgt i32 %smin473, %smin474
  %smax475 = select i1 %604, i32 %smin473, i32 %smin474
  %605 = icmp sgt i32 %smax475, 0
  %smax476 = select i1 %605, i32 %smax475, i32 0
  %606 = icmp sgt i32 %smin474, 0
  %smax477 = select i1 %606, i32 %smin474, i32 0
  %607 = sub nsw i32 %smax476, %smax477
  %.neg581 = add nuw i32 %smax477, 1
  %608 = mul i32 %15, %output.s0.y.rebased50.us.us.us.us.us
  %609 = add i32 %596, %608
  %610 = add nsw i32 %output.s0.y.rebased50.us.us.us.us.us, %13
  %611 = mul nsw i32 %610, %stride_y
  %a42.us.us.us.us.us = sub i32 %580, %611
  %612 = icmp slt i32 %a42.us.us.us.us.us, %b45
  %b46.us.us.us.us.us = select i1 %612, i32 %a42.us.us.us.us.us, i32 %b45
  %a43.us.us.us.us.us = sub nsw i32 %4, %611
  %613 = icmp slt i32 %a43.us.us.us.us.us, %b45
  %a50.us.us.us.us.us = select i1 %613, i32 %a43.us.us.us.us.us, i32 %b45
  %614 = icmp sgt i32 %a50.us.us.us.us.us, %b46.us.us.us.us.us
  %a49.us.us.us.us.us = select i1 %614, i32 %a50.us.us.us.us.us, i32 %b46.us.us.us.us.us
  %615 = icmp sgt i32 %a50.us.us.us.us.us, 0
  %616 = select i1 %615, i32 %a50.us.us.us.us.us, i32 0
  %617 = mul nsw i32 %610, %15
  %618 = icmp sgt i32 %a49.us.us.us.us.us, 0
  %619 = select i1 %618, i32 %a49.us.us.us.us.us, i32 0
  %620 = icmp sgt i32 %619, %616
  %t327.us.us.us.us.us = add i32 %617, %598
  br i1 %620, label %"for output.s0.x.rebased51.us.us.us.us.us.us.us.preheader", label %"for output.s0.x.rebased51.us.us.us.us.us.us279.preheader", !prof !95

"for output.s0.x.rebased51.us.us.us.us.us.us279.preheader": ; preds = %"for output.s0.y.rebased48.us.us.us.us.us"
  br i1 %595, label %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us.loopexit463.unr-lcssa", label %"for output.s0.x.rebased51.us.us.us.us.us.us279"

"for output.s0.x.rebased51.us.us.us.us.us.us.us.preheader": ; preds = %"for output.s0.y.rebased48.us.us.us.us.us"
  %xtraiter478 = and i32 %607, 1
  %621 = icmp eq i32 %smax476, %.neg581
  %unroll_iter482 = and i32 %607, -2
  %lcmp.mod481.not = icmp eq i32 %xtraiter478, 0
  br label %"for output.s0.x.rebased51.us.us.us.us.us.us.us"

"for output.s0.x.rebased51.us.us.us.us.us.us279": ; preds = %"for output.s0.x.rebased51.us.us.us.us.us.us279.preheader", %"for output.s0.x.rebased51.us.us.us.us.us.us279"
  %output.s0.x.rebased53.us.us.us.us.us.us280 = phi i32 [ %645, %"for output.s0.x.rebased51.us.us.us.us.us.us279" ], [ 0, %"for output.s0.x.rebased51.us.us.us.us.us.us279.preheader" ]
  %niter = phi i32 [ %niter.nsub.7, %"for output.s0.x.rebased51.us.us.us.us.us.us279" ], [ %unroll_iter, %"for output.s0.x.rebased51.us.us.us.us.us.us279.preheader" ]
  %622 = mul i32 %12, %output.s0.x.rebased53.us.us.us.us.us.us280
  %623 = add i32 %609, %622
  %scevgep = getelementptr i8, i8* %8, i32 %623
  call void @llvm.memset.p0i8.i32(i8* align 1 %scevgep, i8 %584, i32 %1, i1 false)
  %624 = or i32 %output.s0.x.rebased53.us.us.us.us.us.us280, 1
  %625 = mul i32 %12, %624
  %626 = add i32 %609, %625
  %scevgep.1 = getelementptr i8, i8* %8, i32 %626
  call void @llvm.memset.p0i8.i32(i8* align 1 %scevgep.1, i8 %584, i32 %1, i1 false)
  %627 = or i32 %output.s0.x.rebased53.us.us.us.us.us.us280, 2
  %628 = mul i32 %12, %627
  %629 = add i32 %609, %628
  %scevgep.2 = getelementptr i8, i8* %8, i32 %629
  call void @llvm.memset.p0i8.i32(i8* align 1 %scevgep.2, i8 %584, i32 %1, i1 false)
  %630 = or i32 %output.s0.x.rebased53.us.us.us.us.us.us280, 3
  %631 = mul i32 %12, %630
  %632 = add i32 %609, %631
  %scevgep.3 = getelementptr i8, i8* %8, i32 %632
  call void @llvm.memset.p0i8.i32(i8* align 1 %scevgep.3, i8 %584, i32 %1, i1 false)
  %633 = or i32 %output.s0.x.rebased53.us.us.us.us.us.us280, 4
  %634 = mul i32 %12, %633
  %635 = add i32 %609, %634
  %scevgep.4 = getelementptr i8, i8* %8, i32 %635
  call void @llvm.memset.p0i8.i32(i8* align 1 %scevgep.4, i8 %584, i32 %1, i1 false)
  %636 = or i32 %output.s0.x.rebased53.us.us.us.us.us.us280, 5
  %637 = mul i32 %12, %636
  %638 = add i32 %609, %637
  %scevgep.5 = getelementptr i8, i8* %8, i32 %638
  call void @llvm.memset.p0i8.i32(i8* align 1 %scevgep.5, i8 %584, i32 %1, i1 false)
  %639 = or i32 %output.s0.x.rebased53.us.us.us.us.us.us280, 6
  %640 = mul i32 %12, %639
  %641 = add i32 %609, %640
  %scevgep.6 = getelementptr i8, i8* %8, i32 %641
  call void @llvm.memset.p0i8.i32(i8* align 1 %scevgep.6, i8 %584, i32 %1, i1 false)
  %642 = or i32 %output.s0.x.rebased53.us.us.us.us.us.us280, 7
  %643 = mul i32 %12, %642
  %644 = add i32 %609, %643
  %scevgep.7 = getelementptr i8, i8* %8, i32 %644
  call void @llvm.memset.p0i8.i32(i8* align 1 %scevgep.7, i8 %584, i32 %1, i1 false)
  %645 = add nuw nsw i32 %output.s0.x.rebased53.us.us.us.us.us.us280, 8
  %niter.nsub.7 = add i32 %niter, -8
  %niter.ncmp.7 = icmp eq i32 %niter.nsub.7, 0
  br i1 %niter.ncmp.7, label %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us.loopexit463.unr-lcssa", label %"for output.s0.x.rebased51.us.us.us.us.us.us279"
...
"end for output.s0.y.rebased49.loopexit.split.us.us.us.split.us.us": ; preds = %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us"
  %646 = add nuw nsw i32 %output.s0.b.rebased47.us.us.us, 1
  %.not.us.us.us = icmp eq i32 %646, %7
  br i1 %.not.us.us.us, label %call_destructor.exit, label %"for output.s0.b.rebased45.us.us.us"

"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us.loopexit463.unr-lcssa": ; preds = %"for output.s0.x.rebased51.us.us.us.us.us.us279", %"for output.s0.x.rebased51.us.us.us.us.us.us279.preheader"
  %output.s0.x.rebased53.us.us.us.us.us.us280.unr = phi i32 [ 0, %"for output.s0.x.rebased51.us.us.us.us.us.us279.preheader" ], [ %645, %"for output.s0.x.rebased51.us.us.us.us.us.us279" ]
  br i1 %lcmp.mod.not, label %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us", label %"for output.s0.x.rebased51.us.us.us.us.us.us279.epil"

"for output.s0.x.rebased51.us.us.us.us.us.us279.epil": ; preds = %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us.loopexit463.unr-lcssa", %"for output.s0.x.rebased51.us.us.us.us.us.us279.epil"
  %output.s0.x.rebased53.us.us.us.us.us.us280.epil = phi i32 [ %649, %"for output.s0.x.rebased51.us.us.us.us.us.us279.epil" ], [ %output.s0.x.rebased53.us.us.us.us.us.us280.unr, %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us.loopexit463.unr-lcssa" ]
  %epil.iter = phi i32 [ %epil.iter.sub, %"for output.s0.x.rebased51.us.us.us.us.us.us279.epil" ], [ %xtraiter, %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us.loopexit463.unr-lcssa" ]
  %647 = mul i32 %12, %output.s0.x.rebased53.us.us.us.us.us.us280.epil
  %648 = add i32 %609, %647
  %scevgep.epil = getelementptr i8, i8* %8, i32 %648
  call void @llvm.memset.p0i8.i32(i8* align 1 %scevgep.epil, i8 %584, i32 %1, i1 false)
  %649 = add nuw nsw i32 %output.s0.x.rebased53.us.us.us.us.us.us280.epil, 1
  %epil.iter.sub = add i32 %epil.iter, -1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.sub, 0
  br i1 %epil.iter.cmp.not, label %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us", label %"for output.s0.x.rebased51.us.us.us.us.us.us279.epil", !llvm.loop !110

"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us": ; preds = %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us.loopexit463.unr-lcssa", %"for output.s0.x.rebased51.us.us.us.us.us.us279.epil", %"end for output.s0.c.rebased.loopexit.split.us.us.us.us.us.us.us.us"
  %650 = add nuw nsw i32 %output.s0.y.rebased50.us.us.us.us.us, 1
  %.not82.us.us.us.us.us = icmp eq i32 %650, %14
...
"for output.s0.x.rebased51.us.us.us.us.us.us.us": ; preds = %"for output.s0.x.rebased51.us.us.us.us.us.us.us.preheader", %"end for output.s0.c.rebased.loopexit.split.us.us.us.us.us.us.us.us"
  %output.s0.x.rebased53.us.us.us.us.us.us.us = phi i32 [ %679, %"end for output.s0.c.rebased.loopexit.split.us.us.us.us.us.us.us.us" ], [ 0, %"for output.s0.x.rebased51.us.us.us.us.us.us.us.preheader" ]
  %651 = mul i32 %output.s0.x.rebased53.us.us.us.us.us.us.us, %stride_x
  %652 = sub i32 %589, %651
  %653 = icmp sgt i32 %652, %b48
  %smin = select i1 %653, i32 %b48, i32 %652
  %654 = sub i32 %590, %651
  %655 = icmp sgt i32 %654, %b48
  %smin465 = select i1 %655, i32 %b48, i32 %654
  %656 = icmp sgt i32 %smin, %smin465
  %smax = select i1 %656, i32 %smin, i32 %smin465
  %657 = icmp sgt i32 %smax, 0
  %smax466 = select i1 %657, i32 %smax, i32 0
  %658 = icmp sgt i32 %smin465, 0
  %smax467 = select i1 %658, i32 %smin465, i32 0
  %659 = sub nsw i32 %smax466, %smax467
  %660 = xor i32 %smax467, -1
  %661 = add nsw i32 %smax466, %660
  %662 = add nsw i32 %output.s0.x.rebased53.us.us.us.us.us.us.us, %10
  %663 = mul nsw i32 %662, %stride_x
  %a45.us.us.us.us.us.us.us = sub i32 %581, %663
  %664 = icmp slt i32 %a45.us.us.us.us.us.us.us, %b48
  %b50.us.us.us.us.us.us.us = select i1 %664, i32 %a45.us.us.us.us.us.us.us, i32 %b48
  %a46.us.us.us.us.us.us.us = sub nsw i32 %2, %663
  %665 = icmp slt i32 %a46.us.us.us.us.us.us.us, %b48
  %a53.us.us.us.us.us.us.us = select i1 %665, i32 %a46.us.us.us.us.us.us.us, i32 %b48
  %666 = mul nsw i32 %662, %12
  %667 = icmp sgt i32 %a53.us.us.us.us.us.us.us, %b50.us.us.us.us.us.us.us
  %a52.us.us.us.us.us.us.us = select i1 %667, i32 %a53.us.us.us.us.us.us.us, i32 %b50.us.us.us.us.us.us.us
  %668 = icmp sgt i32 %a53.us.us.us.us.us.us.us, 0
  %669 = select i1 %668, i32 %a53.us.us.us.us.us.us.us, i32 0
  %670 = icmp sgt i32 %a52.us.us.us.us.us.us.us, 0
  %671 = select i1 %670, i32 %a52.us.us.us.us.us.us.us, i32 0
  %672 = icmp sgt i32 %671, %669
  %673 = add i32 %t327.us.us.us.us.us, %666
  br i1 %672, label %"for output.s0.c.rebased.us.us.us.us.us.us.us.us.us.preheader", label %"for output.s0.c.rebased.us.us254.us.us.us.us.us.us.preheader", !prof !95

"for output.s0.c.rebased.us.us.us.us.us.us.us.us.us.preheader": ; preds = %"for output.s0.x.rebased51.us.us.us.us.us.us.us"
  %xtraiter468 = and i32 %659, 7
  %674 = icmp ult i32 %661, 7
  %unroll_iter471 = and i32 %659, -8
  %lcmp.mod470.not = icmp eq i32 %xtraiter468, 0
  %xtraiter468.1 = and i32 %659, 7
  %675 = icmp ult i32 %661, 7
  %unroll_iter471.1 = and i32 %659, -8
  %lcmp.mod470.1.not = icmp eq i32 %xtraiter468.1, 0
  %xtraiter468.epil = and i32 %659, 7
  %676 = icmp ult i32 %661, 7
  %unroll_iter471.epil = and i32 %659, -8
  %lcmp.mod470.epil.not = icmp eq i32 %xtraiter468.epil, 0
  br label %"for output.s0.c.rebased.us.us.us.us.us.us.us.us.us"

"for output.s0.c.rebased.us.us254.us.us.us.us.us.us.preheader": ; preds = %"for output.s0.x.rebased51.us.us.us.us.us.us.us"
  %677 = mul i32 %12, %output.s0.x.rebased53.us.us.us.us.us.us.us
  %678 = add i32 %609, %677
  %scevgep426 = getelementptr i8, i8* %8, i32 %678
  call void @llvm.memset.p0i8.i32(i8* align 1 %scevgep426, i8 %584, i32 %1, i1 false)
  br label %"end for output.s0.c.rebased.loopexit.split.us.us.us.us.us.us.us.us"

"end for output.s0.c.rebased.loopexit.split.us.us.us.us.us.us.us.us": ; preds = %"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us", %"for output.s0.c.rebased.us.us254.us.us.us.us.us.us.preheader"
  %679 = add nuw nsw i32 %output.s0.x.rebased53.us.us.us.us.us.us.us, 1
  %.not83.us.us.us.us.us.us.us = icmp eq i32 %679, %11
...
"for output.s0.c.rebased.us.us.us.us.us.us.us.us.us": ; preds = %"for output.s0.c.rebased.us.us.us.us.us.us.us.us.us.preheader", %"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us"
  %output.s0.c.rebased.us.us.us.us.us.us.us.us.us = phi i32 [ %682, %"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us" ], [ 0, %"for output.s0.c.rebased.us.us.us.us.us.us.us.us.us.preheader" ]
  br i1 %621, label %"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$y.rebased55.us.us.us.us.us.us.us.us.us.us"

"for maximum.s1.r12$y.rebased55.us.us.us.us.us.us.us.us.us.us": ; preds = %"for output.s0.c.rebased.us.us.us.us.us.us.us.us.us", %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.1"
  %niter483 = phi i32 [ %niter483.nsub.1, %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.1" ], [ %unroll_iter482, %"for output.s0.c.rebased.us.us.us.us.us.us.us.us.us" ]
  br i1 %674, label %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us"
...
"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us": ; preds = %"for maximum.s1.r12$y.rebased55.us.us.us.us.us.us.us.us.us.us", %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us"
  %niter472 = phi i32 [ %niter472.nsub.7, %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us" ], [ %unroll_iter471, %"for maximum.s1.r12$y.rebased55.us.us.us.us.us.us.us.us.us.us" ]
  %niter472.nsub.7 = add i32 %niter472, -8
  %niter472.ncmp.7 = icmp eq i32 %niter472.nsub.7, 0
  br i1 %niter472.ncmp.7, label %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us"
...
"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa": ; preds = %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us", %"for maximum.s1.r12$y.rebased55.us.us.us.us.us.us.us.us.us.us"
  br i1 %lcmp.mod470.not, label %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil"
...
"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil": ; preds = %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa", %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil"
  %epil.iter469 = phi i32 [ %epil.iter469.sub, %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil" ], [ %xtraiter468, %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa" ]
  %epil.iter469.sub = add i32 %epil.iter469, -1
  %epil.iter469.cmp.not = icmp eq i32 %epil.iter469.sub, 0
  br i1 %epil.iter469.cmp.not, label %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil", !llvm.loop !111
...
"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us": ; preds = %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil", %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa"
  br i1 %675, label %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa.1", label %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.1"

"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us.unr-lcssa": ; preds = %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.1", %"for output.s0.c.rebased.us.us.us.us.us.us.us.us.us"
  br i1 %lcmp.mod481.not, label %"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us", label %"for maximum.s1.r12$y.rebased55.us.us.us.us.us.us.us.us.us.us.epil"

"for maximum.s1.r12$y.rebased55.us.us.us.us.us.us.us.us.us.us.epil": ; preds = %"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us.unr-lcssa"
  br i1 %676, label %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa.epil", label %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil479"

"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil479": ; preds = %"for maximum.s1.r12$y.rebased55.us.us.us.us.us.us.us.us.us.us.epil", %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil479"
  %niter472.epil = phi i32 [ %niter472.nsub.7.epil, %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil479" ], [ %unroll_iter471.epil, %"for maximum.s1.r12$y.rebased55.us.us.us.us.us.us.us.us.us.us.epil" ]
  %niter472.nsub.7.epil = add i32 %niter472.epil, -8
  %niter472.ncmp.7.epil = icmp eq i32 %niter472.nsub.7.epil, 0
  br i1 %niter472.ncmp.7.epil, label %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa.epil", label %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil479"

"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa.epil": ; preds = %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil479", %"for maximum.s1.r12$y.rebased55.us.us.us.us.us.us.us.us.us.us.epil"
  br i1 %lcmp.mod470.epil.not, label %"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.epil"

"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.epil": ; preds = %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa.epil", %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.epil"
  %epil.iter469.epil = phi i32 [ %epil.iter469.sub.epil, %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.epil" ], [ %xtraiter468.epil, %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa.epil" ]
  %epil.iter469.sub.epil = add i32 %epil.iter469.epil, -1
  %epil.iter469.cmp.epil.not = icmp eq i32 %epil.iter469.sub.epil, 0
  br i1 %epil.iter469.cmp.epil.not, label %"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us", label %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.epil", !llvm.loop !111

"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us": ; preds = %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.epil", %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa.epil", %"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us.unr-lcssa"
  %t341.us.us.us.us.us.us.us.us.us = add i32 %673, %output.s0.c.rebased.us.us.us.us.us.us.us.us.us
  %680 = sub i32 %t341.us.us.us.us.us.us.us.us.us, %reass.add184
  %681 = getelementptr inbounds i8, i8* %8, i32 %680
  store i8 %584, i8* %681, align 1, !tbaa !97
  %682 = add nuw nsw i32 %output.s0.c.rebased.us.us.us.us.us.us.us.us.us, 1
  %.not84.us.us.us.us.us.us.us.us.us = icmp eq i32 %682, %1
...
"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.1": ; preds = %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us", %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.1"
  %niter472.1 = phi i32 [ %niter472.nsub.7.1, %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.1" ], [ %unroll_iter471.1, %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us" ]
  %niter472.nsub.7.1 = add i32 %niter472.1, -8
  %niter472.ncmp.7.1 = icmp eq i32 %niter472.nsub.7.1, 0
  br i1 %niter472.ncmp.7.1, label %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa.1", label %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.1"

"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa.1": ; preds = %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.1", %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us"
  br i1 %lcmp.mod470.1.not, label %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.1", label %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.1"

"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.1": ; preds = %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa.1", %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.1"
  %epil.iter469.1 = phi i32 [ %epil.iter469.sub.1, %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.1" ], [ %xtraiter468.1, %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa.1" ]
  %epil.iter469.sub.1 = add i32 %epil.iter469.1, -1
  %epil.iter469.cmp.1.not = icmp eq i32 %epil.iter469.sub.1, 0
  br i1 %epil.iter469.cmp.1.not, label %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.1", label %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.1", !llvm.loop !111

"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.1": ; preds = %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.1", %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa.1"
  %niter483.nsub.1 = add i32 %niter483, -2
  %niter483.ncmp.1 = icmp eq i32 %niter483.nsub.1, 0
  br i1 %niter483.ncmp.1, label %"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$y.rebased55.us.us.us.us.us.us.us.us.us.us"

"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.1": ; preds = %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us", %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.1"
  %niter504.1 = phi i32 [ %niter504.nsub.7.1, %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.1" ], [ %unroll_iter503.1, %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us" ]
  %niter504.nsub.7.1 = add i32 %niter504.1, -8
  %niter504.ncmp.7.1 = icmp eq i32 %niter504.nsub.7.1, 0
  br i1 %niter504.ncmp.7.1, label %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa.1", label %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.1"

"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa.1": ; preds = %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.1", %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us"
  br i1 %lcmp.mod502.1.not, label %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.1", label %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.1"

"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.1": ; preds = %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa.1", %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.1"
  %epil.iter501.1 = phi i32 [ %epil.iter501.sub.1, %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.1" ], [ %xtraiter500.1, %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa.1" ]
  %epil.iter501.sub.1 = add i32 %epil.iter501.1, -1
  %epil.iter501.cmp.1.not = icmp eq i32 %epil.iter501.sub.1, 0
  br i1 %epil.iter501.cmp.1.not, label %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.1", label %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.1", !llvm.loop !109

"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.1": ; preds = %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.1", %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa.1"
  %niter515.nsub.1 = add i32 %niter515, -2
  %niter515.ncmp.1 = icmp eq i32 %niter515.nsub.1, 0
  br i1 %niter515.ncmp.1, label %"consume maximum44.loopexit.split.us.us.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$y.rebased38.us.us.us.us.us.us.us"

"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.1": ; preds = %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us", %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.1"
  %niter536.1 = phi i32 [ %niter536.nsub.7.1, %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.1" ], [ %unroll_iter535.1, %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us" ]
  %niter536.nsub.7.1 = add i32 %niter536.1, -8
  %niter536.ncmp.7.1 = icmp eq i32 %niter536.nsub.7.1, 0
  br i1 %niter536.ncmp.7.1, label %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa.1", label %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.1"

"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa.1": ; preds = %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.1", %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us"
  br i1 %lcmp.mod534.1.not, label %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.1", label %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil.1"

"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil.1": ; preds = %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa.1", %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil.1"
  %epil.iter533.1 = phi i32 [ %epil.iter533.sub.1, %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil.1" ], [ %xtraiter532.1, %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa.1" ]
  %epil.iter533.sub.1 = add i32 %epil.iter533.1, -1
  %epil.iter533.cmp.1.not = icmp eq i32 %epil.iter533.sub.1, 0
  br i1 %epil.iter533.cmp.1.not, label %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.1", label %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil.1", !llvm.loop !106

"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.1": ; preds = %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.us.epil.1", %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.us.unr-lcssa.1"
  %niter547.nsub.1 = add i32 %niter547, -2
  %niter547.ncmp.1 = icmp eq i32 %niter547.nsub.1, 0
  br i1 %niter547.ncmp.1, label %"consume maximum22.loopexit.split.us.us.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$y.rebased16.us.us.us.us.us.us.us"

"for maximum.s1.r12$x.rebased.us.us.us.us.us.1":  ; preds = %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us", %"for maximum.s1.r12$x.rebased.us.us.us.us.us.1"
  %niter568.1 = phi i32 [ %niter568.nsub.7.1, %"for maximum.s1.r12$x.rebased.us.us.us.us.us.1" ], [ %unroll_iter567.1, %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us" ]
  %niter568.nsub.7.1 = add i32 %niter568.1, -8
  %niter568.ncmp.7.1 = icmp eq i32 %niter568.nsub.7.1, 0
  br i1 %niter568.ncmp.7.1, label %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa.1", label %"for maximum.s1.r12$x.rebased.us.us.us.us.us.1"

"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa.1": ; preds = %"for maximum.s1.r12$x.rebased.us.us.us.us.us.1", %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us"
  br i1 %lcmp.mod566.1.not, label %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.1", label %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil.1"

"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil.1": ; preds = %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa.1", %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil.1"
  %epil.iter565.1 = phi i32 [ %epil.iter565.sub.1, %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil.1" ], [ %xtraiter564.1, %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa.1" ]
  %epil.iter565.sub.1 = add i32 %epil.iter565.1, -1
  %epil.iter565.cmp.1.not = icmp eq i32 %epil.iter565.sub.1, 0
  br i1 %epil.iter565.cmp.1.not, label %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.1", label %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil.1", !llvm.loop !102

"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.1": ; preds = %"for maximum.s1.r12$x.rebased.us.us.us.us.us.epil.1", %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.us.unr-lcssa.1"
  %niter579.nsub.1 = add i32 %niter579, -2
  %niter579.ncmp.1 = icmp eq i32 %niter579.nsub.1, 0
  br i1 %niter579.ncmp.1, label %"consume maximum.loopexit.split.us.us.us.us.us.unr-lcssa", label %"for maximum.s1.r12$y.rebased.us.us.us.us.us"
}
...
entry:
  ...
  %5 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %0)
  %6 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %2)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.max_pool_hvx_depth3.1(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #13 {
entry:
