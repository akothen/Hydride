...
// %bb.0:                               // %entry
	...
	{
		if (!p0) jump:nt .LBB131_69
		r1 = memw(r4+#56)
		memw(r29+#28) = r1.new
	}                                       // 4-byte Folded Spill
// %bb.1:                               // %then_bb
	{
		p0 = cmp.gt(r5,#0); if (!p0.new) jump:nt .LBB131_142
		r7 = memw(r29+#144)
	}                                       // 4-byte Folded Reload
// %bb.2:                               // %"for output.s0.b.rebased.preheader"
	...
	.p2align	4
.LBB131_27:                             // %"end for output.s0.y.rebased"
...
.LBB131_3:                              // %"for output.s0.b.rebased"
                                        // =>This Loop Header: Depth=1
                                        //     Child Loop BB131_5 Depth 2
                                        //       Child Loop BB131_6 Depth 3
                                        //         Child Loop BB131_19 Depth 4
                                        //         Child Loop BB131_23 Depth 4
                                        //         Child Loop BB131_8 Depth 4
                                        //           Child Loop BB131_10 Depth 5
                                        //             Child Loop BB131_12 Depth 6
	{
		if (p0) jump:nt .LBB131_27
	}
// %bb.4:                               // %"for output.s0.y.rebased.us.preheader"
                                        //   in Loop: Header=BB131_3 Depth=1
	{
		r4 = #0
		r1 = memw(r29+#24)
	...
	.p2align	4
.LBB131_26:                             // %"end for output.s0.x.rebased.loopexit.us"
	...
	{
		r13 = add(r13,r25)
		if (p3) jump:nt .LBB131_27
	}
.LBB131_5:                              // %"for output.s0.y.rebased.us"
...
.LBB131_24:                             //   in Loop: Header=BB131_6 Depth=3
	{
		q2 = vand(v6,r21)
		v7 = vlalign(v4,v0,r7)
	}
	{
		v29 = vlalign(v5,v4,r7)
		if (q2) vmem(r2+#0) = v7
	}
	{
		v30 = vlalign(v4,v5,r7)
		if (q0) vmem(r5+#0) = v29
	}
	{
		v31 = vlalign(v0,v4,r7)
		if (q0) vmem(r12+#0) = v30
	}
	{
		if (q1) vmem(r8+#0) = v31
	}
	.p2align	4
.LBB131_25:                             // %"end for output.s0.c.c.loopexit.us.us"
	...
	}                                       // 4-byte Folded Reload
	{
		r5 = sub(r5,r7)
		r4 = add(r4,#1)
		if (cmp.eq(r4.new,r1)) jump:nt .LBB131_26
	}
.LBB131_6:                              // %"for output.s0.x.rebased.us.us"
                                        //   Parent Loop BB131_3 Depth=1
...
// %bb.7:                               // %"for output.s0.c.c.us.us.us.preheader"
	...
	.p2align	4
.LBB131_17:                             // %"consume maximum.loopexit.us.us.us"
                                        //   in Loop: Header=BB131_8 Depth=4
	{
		r2 = add(r1,r8)
		v7.ub = vmin(v1.ub,v7.ub)
		v5.ub = vmin(v5.ub,v1.ub)
		r4 = memw(r29+#160)
	}                                       // 4-byte Folded Reload
	{
		r2 = sub(r2,r4)
		v4.ub = vmin(v1.ub,v4.ub)
	...
	{
		v31 = vlalign(v0,v7,r7)
		r7 = memw(r29+#156)
		if (q1) vmem(r4+#0) = v5
	}                                       // 4-byte Folded Reload
	{
		p3 = cmp.eq(r24,r7)
		if (p3.new) jump:nt .LBB131_25
		if (q3) vmem(r2+#0) = v31
	}
.LBB131_8:                              // %"for output.s0.c.c.us.us.us"
                                        //   Parent Loop BB131_3 Depth=1
                                        //     Parent Loop BB131_5 Depth=2
	...
	{
		r8 = min(r2,r6)
		if (!p3) jump:nt .LBB131_17
	}
// %bb.9:                               //   in Loop: Header=BB131_8 Depth=4
	{
		r2 = min(r18,r6)
		v5:4 = vcombine(v0,v0)
		v7:6 = vcombine(v0,v0)
	...
	.p2align	4
.LBB131_16:                             // %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us"
                                        //   in Loop: Header=BB131_10 Depth=5
	{
		r26 = add(r26,#1)
		r25 = add(r25,r23)
		nop
...
.LBB131_10:                             // %"for maximum.s1.r12$y.rebased.us.us.us.us"
                                        //   Parent Loop BB131_3 Depth=1
                                        //     Parent Loop BB131_5 Depth=2
                                        //       Parent Loop BB131_6 Depth=3
                                        //         Parent Loop BB131_8 Depth=4
                                        // =>        This Loop Header: Depth=5
                                        //             Child Loop BB131_12 Depth 6
	{
		p3 = cmp.eq(r5,r11)
		r2 = #0
		if (!p3.new) jump:t .LBB131_11
	}
// %bb.14:                              // %"end for maximum.s1.r12$x.rebased.loopexit.us.us.us.us.unr-lcssa"
                                        //   in Loop: Header=BB131_10 Depth=5
	{
		p3 = cmp.eq(r12,#0)
		if (p3.new) jump:t .LBB131_16
	}
	{
		jump .LBB131_15
	}
	.p2align	4
.LBB131_11:                             //   in Loop: Header=BB131_10 Depth=5
	{
		r20 = lsr(r10,#1)
		r7 = add(r25,r16)
		r4 = add(r25,r22)
	...
	{
		v13 = valign(v8,v12,r7)
		v15 = vmem(r7+#1)
	}
	{
		v16 = valign(v15,v8,r7)
		v9 = vmem(r4+#-2)
	}
	{
		v11 = vmem(r4+#-1)
	...
	{
		if (!p3) jump:nt .LBB131_13
		v11 = valign(v11,v14,r4)
		v14 = vmem(r7+#-2)
	}
	.p2align	4
.LBB131_12:                             // %"for maximum.s1.r12$x.rebased.us.us.us.us"
                                        //   Parent Loop BB131_3 Depth=1
                                        //     Parent Loop BB131_5 Depth=2
                                        //       Parent Loop BB131_6 Depth=3
                                        //         Parent Loop BB131_8 Depth=4
                                        //           Parent Loop BB131_10 Depth=5
                                        // =>          This Inner Loop Header: Depth=6
	{
		r4 = add(r20,r22)
		v12 = valign(v12,v14,r7)
		v6.ub = vmax(v13.ub,v6.ub)
		v17 = vmem(r7+#2)
	}
	{
		r7 = add(r20,r16)
		v15 = valign(v17,v15,r7)
		v7.ub = vmax(v7.ub,v16.ub)
		v14 = vmem(r4+#-2)
	}
	{
		v6.ub = vmax(v6.ub,v10.ub)
		v4.ub = vmax(v4.ub,v12.ub)
		v5.ub = vmax(v15.ub,v5.ub)
		v16 = vmem(r4+#-1)
	}
	{
		v10 = valign(v16,v14,r4)
		v4.ub = vmax(v9.ub,v4.ub)
		v7.ub = vmax(v11.ub,v7.ub)
		v13 = vmem(r4+#0)
	}
	{
		r20 = add(r20,r28)
		v9 = valign(v13,v16,r4)
		v5.ub = vmax(v5.ub,v8.ub)
		v17 = vmem(r4+#1)
	}
	{
		r2 = add(r2,#2)
	...
	{
		v8 = valign(v17,v13,r4)
		v11 = vmem(r4+#2)
	}
	{
		v11 = valign(v11,v17,r4)
		v12 = vmem(r7+#-1)
	}
	{
		v13 = valign(v14,v12,r7)
		v15 = vmem(r7+#1)
	}
	{
		v16 = valign(v15,v14,r7)
		v14 = vmem(r7+#-2)
	} :endloop0
.LBB131_13:                             //   in Loop: Header=BB131_10 Depth=5
	{
		v13 = valign(v31,v15,r7)
		v6.ub = vmax(v13.ub,v6.ub)
		v7.ub = vmax(v7.ub,v16.ub)
		v31.cur = vmem(r7+#2)
	}
...
.LBB131_15:                             // %"for maximum.s1.r12$x.rebased.us.us.us.us.epil"
                                        //   in Loop: Header=BB131_10 Depth=5
	{
		r4 = r13
		r7 = add(r15,r26)
	...
	{
		v8 = valign(v11,v8,r7)
		v9.ub = vmax(v4.ub,v9.ub)
		v30 = vmem(r2+#0)
	}
	{
		v11 = valign(v10,v30,r4)
		v4 = vmem(r2+#2)
	}
	{
		v10 = valign(v4,v10,r4)
		v31.ub = vmax(v7.ub,v11.ub)
		v4.ub = vmax(v8.ub,v6.ub)
		v6 = v9
	}
	{
		jump .LBB131_16
		v7.ub = vmax(v10.ub,v5.ub)
		v5 = v31
	}
.LBB131_20:                             // %"for output.s0.c.c.preheader.split.us401.us"
                                        //   in Loop: Header=BB131_6 Depth=3
	{
		r5 = #3584
		r3 = #0
		v4.ub = vmin(v1.ub,v0.ub)
		v5.ub = vmin(v0.ub,v1.ub)
	}
	{
		if (!p1) jump:nt .LBB131_21
	}
// %bb.18:                              //   in Loop: Header=BB131_6 Depth=3
	{
		r2 = memw(r29+#4)
		r10 = memw(r29+#172)
	}                                       // 4-byte Folded Reload
...
.LBB131_19:                             // %"for output.s0.c.c.us394.us"
                                        //   Parent Loop BB131_3 Depth=1
                                        //     Parent Loop BB131_5 Depth=2
                                        //       Parent Loop BB131_6 Depth=3
	...
	{
		v12 = vlalign(v4,v5,r4)
		if (q0) vmem(r13+#0) = v9
	}
	{
		r4 = add(r12,#384)
		v6 = vlalign(v0,v4,r4)
		if (q0) vmem(r24+#0) = v12
	}
	{
		if (q3) vmem(r4+#0) = v6
	}
	...
	{
		q3 = vand(v6,r21)
		v13 = vlalign(v5,v4,r7)
	}
	{
		v7 = vlalign(v4,v5,r7)
		if (q2) vmem(r25+#0) = v13
	}
	{
		r7 = add(r10,r8)
		r8 = add(r5,#-1024)
		v15 = vlalign(v0,v4,r7)
		if (q2) vmem(r16+#0) = v7
	}
	{
		r4 = add(r5,#-1536)
	...
	{
		q3 = vand(v6,r21)
		v16 = vlalign(v5,v4,r7)
	}
	{
		v17 = vlalign(v4,v5,r7)
		if (q0) vmem(r18+#0) = v16
	}
	{
		r7 = add(r17,#384)
		v7 = vlalign(v0,v4,r7)
		if (q0) vmem(r19+#0) = v17
	}
	{
		r7 = min(r8,r6)
		if (q3) vmem(r7+#0) = v7
	...
	{
		q3 = vand(v6,r21)
		v18 = vlalign(v5,v4,r2)
	}
	{
		v19 = vlalign(v4,v5,r2)
		if (q0) vmem(r24+#0) = v18
	}
	{
		r2 = add(r8,#384)
		v7 = vlalign(v0,v4,r2)
		if (q0) vmem(r25+#0) = v19
	}
	{
		r2 = sub(r7,r11)
		if (q3) vmem(r2+#0) = v7
	...
	{
		v24 = vlalign(v3,v2,r7)
		if (q2) vmem(r4+#0) = v6
	}
	{
		q3 = vand(v24,r21)
		v22 = vlalign(v5,v4,r7)
	}
	{
		v10 = vlalign(v4,v5,r7)
		if (q0) vmem(r8+#0) = v22
	}
	{
		r7 = add(r4,#256)
		r4 = add(r4,#384)
		v11 = vlalign(v0,v4,r7)
	}
	{
		r7 = add(r10,r2)
		if (q0) vmem(r7+#0) = v10
	...
	{
		r2 = and(r7,#-128)
		v25 = vlalign(v2,v2,r7)
	}
	{
		q0 = vand(v25,r21)
		r4 = add(r2,#128)
		v26 = vlalign(v5,v4,r7)
	}
	{
		r4 = min(r5,r6)
		r5 = add(r5,#4096)
	...
	{
		r4 = sub(r4,r11)
		v28 = vlalign(v3,v2,r7)
		if (q2) vmem(r2+#0) = v6
	}
	{
		q3 = vand(v28,r21)
		v27 = vlalign(v4,v5,r7)
	}
	{
		r7 = add(r2,#256)
		r2 = add(r2,#384)
...
.LBB131_21:                             // %"end for output.s0.c.c.loopexit.us.us.loopexit481.unr-lcssa"
                                        //   in Loop: Header=BB131_6 Depth=3
	{
		if (p2) jump:nt .LBB131_25
	}
// %bb.22:                              // %"for output.s0.c.c.us394.us.epil.preheader"
                                        //   in Loop: Header=BB131_6 Depth=3
	{
		r2 = asl(r3,#9)
		r10 = memw(r29+#160)
	...
	}
	{
		q0 = vand(v7,r21)
		q1 = vand(v8,r21)
		if (!p3) jump:nt .LBB131_24
		v6 = vlalign(v2,v3,r7)
	}
.LBB131_23:                             // %"for output.s0.c.c.us394.us.epil"
                                        //   Parent Loop BB131_3 Depth=1
                                        //     Parent Loop BB131_5 Depth=2
                                        //       Parent Loop BB131_6 Depth=3
                                        // =>      This Inner Loop Header: Depth=4
...
// %bb.29:                              // %"for output.s0.b.rebased3.preheader"
	{
		r1 = memw(r29+#76)
		if (!cmp.gt(r1.new,#0)) jump:nt ##.LBB131_142
	}                                       // 4-byte Folded Reload
// %bb.30:                              // %"for output.s0.b.rebased3.us.preheader"
	{
		v0.b = vsplat(r21)
		v1.b = vsplat(r16)
		r6 = memw(r29+#84)
	...
	{
		v2.ub = vmin(v1.ub,v0.ub)
		v3.ub = vmin(v0.ub,v1.ub)
		r13 = memw(r29+#80)
		r9 = memw(r29+#36)
	}                                       // 4-byte Folded Reload
	{
	...
	.p2align	4
.LBB131_32:                             // %"end for output.s0.y.rebased7.loopexit.us"
...
.LBB131_31:                             // %"for output.s0.b.rebased3.us"
                                        // =>This Loop Header: Depth=1
                                        //     Child Loop BB131_34 Depth 2
                                        //       Child Loop BB131_50 Depth 3
                                        //         Child Loop BB131_52 Depth 4
                                        //         Child Loop BB131_56 Depth 4
                                        //       Child Loop BB131_36 Depth 3
                                        //         Child Loop BB131_61 Depth 4
                                        //         Child Loop BB131_66 Depth 4
                                        //         Child Loop BB131_38 Depth 4
                                        //           Child Loop BB131_39 Depth 5
                                        //             Child Loop BB131_41 Depth 6
                                        //             Child Loop BB131_45 Depth 6
	{
		if (!p1) jump:nt .LBB131_32
		r6 = memw(r29+#152)
	}                                       // 4-byte Folded Reload
// %bb.33:                              // %"for output.s0.y.rebased6.preheader.split.us.us"
                                        //   in Loop: Header=BB131_31 Depth=1
	{
		r2 = #0
		r0 = memw(r29+#24)
	...
	.p2align	4
.LBB131_59:                             // %"end for output.s0.x.rebased10.loopexit.us.us"
	...
	}                                       // 4-byte Folded Reload
	{
		r4 = add(r4,r25)
		r2 = add(r2,#1)
		if (cmp.eq(r2.new,r0)) jump:nt .LBB131_32
	}
.LBB131_34:                             // %"for output.s0.y.rebased6.us.us"
                                        //   Parent Loop BB131_31 Depth=1
                                        // =>  This Loop Header: Depth=2
                                        //       Child Loop BB131_50 Depth 3
                                        //         Child Loop BB131_52 Depth 4
                                        //         Child Loop BB131_56 Depth 4
	...
	{
		r12 += mpyi(r0,r2)
		if (!p3) jump:nt .LBB131_49
		memw(r29+#156) = r12.new
	}                                       // 4-byte Folded Spill
// %bb.35:                              // %"for output.s0.x.rebased9.us.us.us.preheader"
                                        //   in Loop: Header=BB131_34 Depth=2
	{
		r0 = min(r19,r8)
		r22 = #0
...
.LBB131_67:                             //   in Loop: Header=BB131_36 Depth=3
	{
		r0 = memw(r29+#172)
	}                                       // 4-byte Folded Reload
	{
	...
	.p2align	4
.LBB131_68:                             // %"end for output.s0.c.c13.split.us.us.us.us"
                                        //   in Loop: Header=BB131_36 Depth=3
	{
		r9 = #0
		r0 = memw(r29+#148)
		r4 = memw(r29+#168)
	...
	{
		r22 = add(r22,#1)
		if (cmp.eq(r22.new,r0)) jump:nt .LBB131_59
	}
.LBB131_36:                             // %"for output.s0.x.rebased9.us.us.us"
                                        //   Parent Loop BB131_31 Depth=1
                                        //     Parent Loop BB131_34 Depth=2
                                        // =>    This Loop Header: Depth=3
                                        //         Child Loop BB131_61 Depth 4
                                        //         Child Loop BB131_66 Depth 4
                                        //         Child Loop BB131_38 Depth 4
	...
	{
		r14 += mpyi(r0,r2)
		if (!p3) jump:nt .LBB131_63
	}
// %bb.37:                              // %"for output.s0.c.c12.us.us.us.us.us.preheader"
                                        //   in Loop: Header=BB131_36 Depth=3
	{
		r0 = mpyi(r22,r7)
		r2 = min(r6,r4)
	...
	.p2align	4
.LBB131_48:                             // %"consume maximum22.loopexit.split.us.us.us.us.us.us"
                                        //   in Loop: Header=BB131_38 Depth=4
	{
		r0 = add(r14,r12)
		r19 = add(r19,#1)
		v5.ub = vmin(v1.ub,v5.ub)
	...
	{
		if (p3) jump:nt .LBB131_68
		vmemu(r0+#1) = v5
	}
.LBB131_38:                             // %"for output.s0.c.c12.us.us.us.us.us"
                                        //   Parent Loop BB131_31 Depth=1
                                        //     Parent Loop BB131_34 Depth=2
                                        //       Parent Loop BB131_36 Depth=3
                                        // =>      This Loop Header: Depth=4
                                        //           Child Loop BB131_39 Depth 5
                                        //             Child Loop BB131_41 Depth 6
                                        //             Child Loop BB131_45 Depth 6
	...
	.p2align	4
.LBB131_46:                             //   in Loop: Header=BB131_39 Depth=5
	{
		v6 = valign(v7,v6,r7)
		v8 = vmem(r7+#2)
	}
	{
		v8 = valign(v8,v7,r7)
		v6.ub = vmax(v5.ub,v6.ub)
	}
	{
		v5.ub = vmax(v8.ub,v4.ub)
		v4 = v6
	}
.LBB131_47:                             // %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us"
                                        //   in Loop: Header=BB131_39 Depth=5
	{
		r3 = add(r3,r23)
		r13 = add(r13,r23)
		r25 = add(r25,#1)
		if (cmp.eq(r25.new,r18)) jump:nt .LBB131_48
	}
.LBB131_39:                             // %"for maximum.s1.r12$y.rebased16.us.us.us.us.us.us"
                                        //   Parent Loop BB131_31 Depth=1
                                        //     Parent Loop BB131_34 Depth=2
                                        //       Parent Loop BB131_36 Depth=3
                                        //         Parent Loop BB131_38 Depth=4
                                        // =>        This Loop Header: Depth=5
                                        //             Child Loop BB131_41 Depth 6
                                        //             Child Loop BB131_45 Depth 6
	{
		p3 = cmp.gtu(r21,#2)
		r9 = #0
		if (!p3.new) jump:t .LBB131_43
	}
// %bb.40:                              //   in Loop: Header=BB131_39 Depth=5
	{
		r1 = lsr(r20,#2)
		r7 = add(r3,r27)
		r9 = add(r9,#4)
	...
	{
		v13 = valign(v10,v6,r3)
		v10.ub = vmax(v5.ub,v7.ub)
		v5 = vmem(r6+#2)
	}
	{
		v7 = valign(v12,v11,r6)
		v11.ub = vmax(v13.ub,v4.ub)
		v6 = vmem(r0+#0)
	}
	{
		if (!p3) jump:nt .LBB131_42
		v5 = valign(v5,v12,r6)
		v4 = vmem(r0+#1)
	}
	.p2align	4
.LBB131_41:                             // %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us"
                                        //   Parent Loop BB131_31 Depth=1
                                        //     Parent Loop BB131_34 Depth=2
                                        //       Parent Loop BB131_36 Depth=3
                                        //         Parent Loop BB131_38 Depth=4
                                        //           Parent Loop BB131_39 Depth=5
                                        // =>          This Inner Loop Header: Depth=6
	{
		r1 = add(r7,r27)
		v9.ub = vmax(v9.ub,v10.ub)
		v8.ub = vmax(v11.ub,v8.ub)
		v12 = vmem(r7+#2)
	}
	{
		r6 = add(r1,r27)
		v14 = valign(v4,v6,r0)
		v7.ub = vmax(v9.ub,v7.ub)
		v10 = vmem(r7+#1)
	}
	{
		r9 = add(r9,#4)
		v12 = valign(v12,v10,r7)
		v5.ub = vmax(v5.ub,v8.ub)
		v11 = vmem(r1+#0)
	}
	{
	...
	{
		v8 = valign(v13,v11,r1)
		v11.ub = vmax(v5.ub,v14.ub)
		v7.ub = vmax(v4.ub,v7.ub)
		v15 = vmem(r6+#2)
	}
	{
		v11.ub = vmax(v12.ub,v11.ub)
		v16 = vmem(r6+#1)
	}
	{
		r7 = add(r7,r15)
		v10 = valign(v10,v6,r7)
		v6.cur = vmem(r7+#0)
	}
	{
		v9 = valign(v4,v13,r1)
		v10.ub = vmax(v7.ub,v10.ub)
		v4.cur = vmem(r1+#2)
	}
	{
		v5 = valign(v15,v16,r6)
		v7 = vmem(r6+#0)
	}
	{
		v7 = valign(v16,v7,r6)
...
.LBB131_42:                             //   in Loop: Header=BB131_39 Depth=5
	{
		v11 = valign(v31,v4,r0)
		v8.ub = vmax(v11.ub,v8.ub)
		v9.ub = vmax(v9.ub,v10.ub)
		v31.cur = vmem(r0+#2)
	}
	{
		v4 = valign(v4,v6,r0)
		v5.ub = vmax(v5.ub,v8.ub)
		v6.ub = vmax(v9.ub,v7.ub)
	}
	{
		v4.ub = vmax(v5.ub,v4.ub)
		v5.ub = vmax(v11.ub,v6.ub)
	}
.LBB131_43:                             // %"end for maximum.s1.r12$x.rebased20.loopexit.us.us.us.us.us.us.unr-lcssa"
                                        //   in Loop: Header=BB131_39 Depth=5
	{
		p3 = cmp.eq(r11,#0)
		if (p3.new) jump:nt .LBB131_47
	}
// %bb.44:                              // %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.epil.preheader"
                                        //   in Loop: Header=BB131_39 Depth=5
	{
		r0 = add(r2,r9)
		r1 = sub(#0,r10)
	...
	{
		if (!p3) jump:nt .LBB131_46
		v7 = vmem(r7+#1)
	}
	.p2align	4
.LBB131_45:                             // %"for maximum.s1.r12$x.rebased19.us.us.us.us.us.us.epil"
                                        //   Parent Loop BB131_31 Depth=1
                                        //     Parent Loop BB131_34 Depth=2
                                        //       Parent Loop BB131_36 Depth=3
                                        //         Parent Loop BB131_38 Depth=4
	...
	}
	{
		r7 = r6
		v7 = valign(v7,v6,r7)
		v8.ub = vmax(v8.ub,v4.ub)
		v6 = vmem(r6+#0)
	}
	{
		v4.ub = vmax(v5.ub,v7.ub)
		v5 = v8
		v7 = vmem(r6+#1)
	} :endloop0
	{
...
.LBB131_63:                             // %"for output.s0.x.rebased9.split.us.us.split.us365.us"
                                        //   in Loop: Header=BB131_36 Depth=3
	{
		r0 = #1792
		r2 = #0
...
// %bb.60:                              //   in Loop: Header=BB131_36 Depth=3
	{
		r3 = add(r0,#-1792)
		r6 = add(r0,#-1280)
		r1 = memw(r29+#52)
...
.LBB131_61:                             // %"for output.s0.c.c12.us.us.us358.us"
                                        //   Parent Loop BB131_31 Depth=1
                                        //     Parent Loop BB131_34 Depth=2
                                        //       Parent Loop BB131_36 Depth=3
                                        // =>      This Inner Loop Header: Depth=4
...
.LBB131_62:                             //   in Loop: Header=BB131_36 Depth=3
	{
		vmemu(r1+#0) = v3
	}
	{
...
.LBB131_64:                             // %"end for output.s0.c.c13.split.us.us.us.us.loopexit485.unr-lcssa"
                                        //   in Loop: Header=BB131_36 Depth=3
	{
		if (p2) jump:nt .LBB131_68
	}
// %bb.65:                              // %"for output.s0.c.c12.us.us.us358.us.epil.preheader"
                                        //   in Loop: Header=BB131_36 Depth=3
	{
		r0 = asl(r2,#8)
		r6 = memw(r29+#56)
	...
	{
		r1 = sub(r1,r28)
		if (!p3) jump:nt .LBB131_67
	}
.LBB131_66:                             // %"for output.s0.c.c12.us.us.us358.us.epil"
                                        //   Parent Loop BB131_31 Depth=1
                                        //     Parent Loop BB131_34 Depth=2
                                        //       Parent Loop BB131_36 Depth=3
                                        // =>      This Inner Loop Header: Depth=4
...
.LBB131_49:                             // %"for output.s0.x.rebased9.preheader.split.us357.us"
                                        //   in Loop: Header=BB131_34 Depth=2
	{
		r3:2 = combine(#0,#0)
		r0 = memw(r29+#148)
...
.LBB131_57:                             //   in Loop: Header=BB131_50 Depth=3
	{
		r0 = memw(r29+#172)
	}                                       // 4-byte Folded Reload
	{
...
.LBB131_58:                             // %"end for output.s0.c.c13.split.us.us"
...
.LBB131_50:                             // %"for output.s0.x.rebased9.us353.us"
                                        //   Parent Loop BB131_31 Depth=1
                                        //     Parent Loop BB131_34 Depth=2
                                        // =>    This Loop Header: Depth=3
                                        //         Child Loop BB131_52 Depth 4
	...
	}                                       // 4-byte Folded Reload
	{
		r4 += mpyi(r0,r1)
		r0 = #0
		if (!p0) jump:nt .LBB131_54
	}
// %bb.51:                              //   in Loop: Header=BB131_50 Depth=3
	{
		r1 = add(r7,#-1792)
		r6 = add(r7,#-1536)
		r0 = memw(r29+#52)
	...
	{
		r1 = add(r12,r1)
		if (!p3) jump:nt .LBB131_53
	}
.LBB131_52:                             // %"for output.s0.c.c12.us.us"
                                        //   Parent Loop BB131_31 Depth=1
                                        //     Parent Loop BB131_34 Depth=2
...
.LBB131_53:                             //   in Loop: Header=BB131_50 Depth=3
	{
		vmemu(r1+#0) = v3
	}
	{
...
.LBB131_54:                             // %"end for output.s0.c.c13.split.us.us.unr-lcssa"
                                        //   in Loop: Header=BB131_50 Depth=3
	{
		if (p2) jump:nt .LBB131_58
	}
// %bb.55:                              // %"for output.s0.c.c12.us.us.epil.preheader"
                                        //   in Loop: Header=BB131_50 Depth=3
	{
		r0 = asl(r0,#8)
		r6 = memw(r29+#56)
	...
	{
		r1 = sub(r1,r28)
		if (!p3) jump:nt .LBB131_57
	}
.LBB131_56:                             // %"for output.s0.c.c12.us.us.epil"
                                        //   Parent Loop BB131_31 Depth=1
                                        //     Parent Loop BB131_34 Depth=2
                                        //       Parent Loop BB131_50 Depth=3
                                        // =>      This Inner Loop Header: Depth=4
...
.LBB131_70:                             // %next_bb2
	{
		p0 = cmp.gt(r20,#127)
		if (!p0.new) jump:t .LBB131_116
	}
// %bb.71:                              // %then_bb23
	{
		p0 = cmp.gt(r5,#0); if (!p0.new) jump:nt .LBB131_142
	}
// %bb.72:                              // %"for output.s0.b.rebased25.preheader"
	{
		r1 = memw(r29+#76)
		if (!cmp.gt(r1.new,#0)) jump:nt ##.LBB131_142
	}                                       // 4-byte Folded Reload
...
// %bb.74:                              // %"for output.s0.b.rebased25.us.us.preheader"
	{
		v0.b = vsplat(r21)
		r4 = add(r20,#127)
		r6 = memw(r29+#84)
	...
	.p2align	4
.LBB131_104:                            // %"end for output.s0.y.rebased29.loopexit.split.us.us.us"
                                        //   in Loop: Header=BB131_75 Depth=1
	{
		r2 = memw(r29+#56)
		r0 = memw(r29+#20)
	}                                       // 4-byte Folded Reload
	...
	}                                       // 4-byte Folded Reload
	{
		p2 = cmp.eq(r2,r0)
		r1 = add(r1,r4)
		if (p2.new) jump:nt .LBB131_142
		memw(r29+#112) = r1.new
	}                                       // 4-byte Folded Spill
.LBB131_75:                             // %"for output.s0.b.rebased25.us.us"
                                        // =>This Loop Header: Depth=1
                                        //     Child Loop BB131_76 Depth 2
                                        //       Child Loop BB131_92 Depth 3
                                        //         Child Loop BB131_94 Depth 4
                                        //         Child Loop BB131_99 Depth 4
                                        //       Child Loop BB131_78 Depth 3
                                        //         Child Loop BB131_107 Depth 4
                                        //         Child Loop BB131_112 Depth 4
                                        //         Child Loop BB131_80 Depth 4
                                        //           Child Loop BB131_81 Depth 5
                                        //             Child Loop BB131_83 Depth 6
                                        //             Child Loop BB131_87 Depth 6
	{
		r0 = memw(r29+#24)
		memw(r29+#56) = r2
	}                                       // 4-byte Folded Reload
	...
	.p2align	4
.LBB131_103:                            // %"end for output.s0.x.rebased32.loopexit.us.us.us"
                                        //   in Loop: Header=BB131_76 Depth=2
	{
		r2 = memw(r29+#96)
		r0 = memw(r29+#76)
	}                                       // 4-byte Folded Reload
	...
	}                                       // 4-byte Folded Reload
	{
		r9 = sub(r9,r25)
		r2 = add(r2,#1)
		if (cmp.eq(r2.new,r0)) jump:nt .LBB131_104
	}
.LBB131_76:                             // %"for output.s0.y.rebased28.us.us.us"
                                        //   Parent Loop BB131_75 Depth=1
                                        // =>  This Loop Header: Depth=2
                                        //       Child Loop BB131_92 Depth 3
                                        //         Child Loop BB131_94 Depth 4
                                        //         Child Loop BB131_99 Depth 4
	...
	{
		r12 += mpyi(r0,r2)
		if (!p2) jump:nt .LBB131_91
		memw(r29+#120) = r12.new
	}                                       // 4-byte Folded Spill
// %bb.77:                              // %"for output.s0.x.rebased31.us.us.us.us.preheader"
                                        //   in Loop: Header=BB131_76 Depth=2
	{
		r0 = min(r19,r9)
		r9 = memw(r29+#124)
...
.LBB131_113:                            //   in Loop: Header=BB131_78 Depth=3
	{
		vmemu(r1+#0) = v2
	}
.LBB131_114:                            //   in Loop: Header=BB131_78 Depth=3
	{
		r0 = sub(r0,r28)
		r1 = memw(r29+#172)
	}                                       // 4-byte Folded Reload
	...
	.p2align	4
.LBB131_115:                            // %"end for output.s0.c.c35.split.us.us.us.us.us"
	...
	{
		r4 = add(r4,#1)
		if (cmp.eq(r4.new,r0)) jump:nt .LBB131_103
	}
.LBB131_78:                             // %"for output.s0.x.rebased31.us.us.us.us"
                                        //   Parent Loop BB131_75 Depth=1
                                        //     Parent Loop BB131_76 Depth=2
                                        // =>    This Loop Header: Depth=3
                                        //         Child Loop BB131_107 Depth 4
                                        //         Child Loop BB131_112 Depth 4
                                        //         Child Loop BB131_80 Depth 4
...
// %bb.79:                              // %"for output.s0.c.c34.us.us.us.us.us.us.preheader"
                                        //   in Loop: Header=BB131_78 Depth=3
	{
		r0 = mpyi(r4,r7)
		r1 = min(r5,r13)
	...
	.p2align	4
.LBB131_90:                             // %"consume maximum44.loopexit.split.us.us.us.us.us.us.us"
                                        //   in Loop: Header=BB131_80 Depth=4
	{
		r0 = add(r15,r13)
		r19 = add(r19,#1)
	...
	{
		if (p2) jump:nt .LBB131_115
		vmemu(r0+#0) = v3
	}
.LBB131_80:                             // %"for output.s0.c.c34.us.us.us.us.us.us"
                                        //   Parent Loop BB131_75 Depth=1
                                        //     Parent Loop BB131_76 Depth=2
                                        //       Parent Loop BB131_78 Depth=3
                                        // =>      This Loop Header: Depth=4
                                        //           Child Loop BB131_81 Depth 5
                                        //             Child Loop BB131_83 Depth 6
                                        //             Child Loop BB131_87 Depth 6
	...
	.p2align	4
.LBB131_88:                             //   in Loop: Header=BB131_81 Depth=5
	{
		v4 = valign(v5,v4,r7)
	}
	{
...
.LBB131_89:                             // %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us"
                                        //   in Loop: Header=BB131_81 Depth=5
	{
		r4 = add(r4,r23)
		r14 = add(r14,r23)
		r21 = add(r21,#1)
		if (cmp.eq(r21.new,r18)) jump:nt .LBB131_90
	}
.LBB131_81:                             // %"for maximum.s1.r12$y.rebased38.us.us.us.us.us.us.us"
                                        //   Parent Loop BB131_75 Depth=1
                                        //     Parent Loop BB131_76 Depth=2
                                        //       Parent Loop BB131_78 Depth=3
                                        //         Parent Loop BB131_80 Depth=4
                                        // =>        This Loop Header: Depth=5
                                        //             Child Loop BB131_83 Depth 6
                                        //             Child Loop BB131_87 Depth 6
	{
		p2 = cmp.gtu(r11,#6)
		r12 = #0
		if (!p2.new) jump:t .LBB131_85
	}
// %bb.82:                              //   in Loop: Header=BB131_81 Depth=5
	{
		r0 = lsr(r10,#3)
		r6 = add(r4,r27)
		r12 = add(r12,#8)
	...
	{
		if (!p2) jump:nt .LBB131_84
		v4 = valign(v6,v4,r2)
		v3.ub = vmax(v3.ub,v5.ub)
	}
	.p2align	4
.LBB131_83:                             // %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us"
                                        //   Parent Loop BB131_75 Depth=1
                                        //     Parent Loop BB131_76 Depth=2
                                        //       Parent Loop BB131_78 Depth=3
                                        //         Parent Loop BB131_80 Depth=4
                                        //           Parent Loop BB131_81 Depth=5
                                        // =>          This Inner Loop Header: Depth=6
	{
		r6 = add(r0,r27)
		r12 = add(r12,#8)
...
.LBB131_84:                             //   in Loop: Header=BB131_81 Depth=5
	{
		v3.ub = vmax(v3.ub,v4.ub)
	}
.LBB131_85:                             // %"end for maximum.s1.r12$x.rebased42.loopexit.us.us.us.us.us.us.us.unr-lcssa"
                                        //   in Loop: Header=BB131_81 Depth=5
	{
		p2 = cmp.eq(r20,#0)
		if (p2.new) jump:nt .LBB131_89
	}
// %bb.86:                              // %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil.preheader"
	...
	{
		if (!p2) jump:nt .LBB131_88
		v5 = vmem(r5+#1)
	}
	.p2align	4
.LBB131_87:                             // %"for maximum.s1.r12$x.rebased41.us.us.us.us.us.us.us.epil"
                                        //   Parent Loop BB131_75 Depth=1
                                        //     Parent Loop BB131_76 Depth=2
                                        //       Parent Loop BB131_78 Depth=3
                                        //         Parent Loop BB131_80 Depth=4
...
.LBB131_105:                            // %"for output.s0.c.c34.us.us315.us.us.us.preheader"
                                        //   in Loop: Header=BB131_78 Depth=3
	{
		r4 = #896
		r2 = #0
		if (!p0) jump:nt .LBB131_109
	}
// %bb.106:                             //   in Loop: Header=BB131_78 Depth=3
	{
		r1 = add(r4,#-768)
		r6 = add(r4,#-512)
		r5 = add(r4,#-640)
	...
	{
		r3 = add(r9,r0)
		if (!p2) jump:nt .LBB131_108
	}
.LBB131_107:                            // %"for output.s0.c.c34.us.us315.us.us.us"
                                        //   Parent Loop BB131_75 Depth=1
                                        //     Parent Loop BB131_76 Depth=2
                                        //       Parent Loop BB131_78 Depth=3
                                        // =>      This Inner Loop Header: Depth=4
...
.LBB131_108:                            //   in Loop: Header=BB131_78 Depth=3
	{
		vmemu(r3+#0) = v2
	}
.LBB131_109:                            // %"end for output.s0.c.c35.split.us.us.us.us.us.loopexit490.unr-lcssa"
                                        //   in Loop: Header=BB131_78 Depth=3
	{
		if (p1) jump:nt .LBB131_115
	}
// %bb.110:                             // %"for output.s0.c.c34.us.us315.us.us.us.epil.preheader"
                                        //   in Loop: Header=BB131_78 Depth=3
	{
		r0 = asl(r2,#7)
		r1 = memw(r29+#44)
	...
	{
		r0 = add(r15,r2)
		if (!p2) jump:nt .LBB131_114
	}
// %bb.111:                             // %"for output.s0.c.c34.us.us315.us.us.us.epil"
                                        //   in Loop: Header=BB131_78 Depth=3
	{
		r3 = min(r1,r24)
		r0 = sub(r0,r28)
	...
	}                                       // 4-byte Folded Reload
	{
		...
		r1 = add(r1,r0)
		r0 = add(r15,r3)
		if (!p2) jump:nt .LBB131_113
	}
.LBB131_112:                            // %"for output.s0.c.c34.us.us315.us.us.us.epil"
                                        //   Parent Loop BB131_75 Depth=1
                                        //     Parent Loop BB131_76 Depth=2
                                        //       Parent Loop BB131_78 Depth=3
                                        // =>      This Inner Loop Header: Depth=4
...
.LBB131_91:                             // %"for output.s0.x.rebased31.us325.us.us.preheader"
                                        //   in Loop: Header=BB131_76 Depth=2
	{
		r3:2 = combine(#0,#0)
		r0 = memw(r29+#148)
...
.LBB131_100:                            //   in Loop: Header=BB131_92 Depth=3
	{
		vmemu(r1+#0) = v2
	}
.LBB131_101:                            //   in Loop: Header=BB131_92 Depth=3
	{
		r0 = sub(r0,r28)
		r1 = memw(r29+#172)
	}                                       // 4-byte Folded Reload
...
.LBB131_102:                            // %"end for output.s0.c.c35.split.us.us.us"
                                        //   in Loop: Header=BB131_92 Depth=3
	{
		r3 = add(r3,#1)
		r6 = #0
		r5 = memw(r29+#152)
...
.LBB131_92:                             // %"for output.s0.x.rebased31.us325.us.us"
                                        //   Parent Loop BB131_75 Depth=1
                                        //     Parent Loop BB131_76 Depth=2
                                        // =>    This Loop Header: Depth=3
                                        //         Child Loop BB131_94 Depth 4
	...
	{
		r4 += mpyi(r0,r1)
		if (!p0) jump:nt .LBB131_96
	}
// %bb.93:                              //   in Loop: Header=BB131_92 Depth=3
	{
		r1 = add(r12,#-768)
		r7 = add(r12,#-512)
		r6 = add(r12,#-640)
	...
	{
		r9 = add(r13,r0)
		if (!p2) jump:nt .LBB131_95
	}
.LBB131_94:                             // %"for output.s0.c.c34.us.us.us"
                                        //   Parent Loop BB131_75 Depth=1
                                        //     Parent Loop BB131_76 Depth=2
                                        //       Parent Loop BB131_92 Depth=3
                                        // =>      This Inner Loop Header: Depth=4
	{
		r1 = add(r12,#-896)
		r0 = add(r12,#-768)
...
.LBB131_95:                             //   in Loop: Header=BB131_92 Depth=3
	{
		vmemu(r9+#0) = v2
	}
.LBB131_96:                             // %"end for output.s0.c.c35.split.us.us.us.unr-lcssa"
                                        //   in Loop: Header=BB131_92 Depth=3
	{
		if (p1) jump:nt .LBB131_102
	}
...
// %bb.98:                              // %"for output.s0.c.c34.us.us.us.epil"
	...
	}                                       // 4-byte Folded Reload
	{
		...
		r1 = add(r1,r0)
		r0 = add(r4,r6)
		if (!p2) jump:nt .LBB131_100
	}
.LBB131_99:                             // %"for output.s0.c.c34.us.us.us.epil"
                                        //   Parent Loop BB131_75 Depth=1
                                        //     Parent Loop BB131_76 Depth=2
                                        //       Parent Loop BB131_92 Depth=3
                                        // =>      This Inner Loop Header: Depth=4
...
// %bb.119:                             // %"for output.s0.b.rebased45.preheader"
	{
		p0 = cmp.gt(r20,#0); if (!p0.new) jump:nt .LBB131_142
	}
// %bb.120:                             // %"for output.s0.b.rebased45.us.us.us.preheader"
	...
	.p2align	4
.LBB131_141:                            // %"end for output.s0.y.rebased49.loopexit.split.us.us.us.split.us.us"
                                        //   in Loop: Header=BB131_121 Depth=1
	{
		r3 = memw(r29+#56)
		r4 = memw(r29+#36)
	}                                       // 4-byte Folded Reload
...
.LBB131_121:                            // %"for output.s0.b.rebased45.us.us.us"
                                        // =>This Loop Header: Depth=1
                                        //     Child Loop BB131_122 Depth 2
                                        //       Child Loop BB131_136 Depth 3
                                        //       Child Loop BB131_139 Depth 3
                                        //       Child Loop BB131_124 Depth 3
                                        //         Child Loop BB131_126 Depth 4
                                        //           Child Loop BB131_127 Depth 5
                                        //             Child Loop BB131_129 Depth 6
                                        //             Child Loop BB131_132 Depth 6
	{
		r6 = #0
		r0 = memw(r29+#24)
		r4 = memw(r29+#52)
	...
	.p2align	4
.LBB131_140:                            // %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us"
                                        //   in Loop: Header=BB131_122 Depth=2
	{
		r6 = memw(r29+#108)
		r2 = memw(r29+#112)
	}                                       // 4-byte Folded Reload
	...
	{
		r4 = add(r4,r25)
		if (p0) jump:nt .LBB131_141
	}
.LBB131_122:                            // %"for output.s0.y.rebased48.us.us.us.us.us"
                                        //   Parent Loop BB131_121 Depth=1
                                        // =>  This Loop Header: Depth=2
                                        //       Child Loop BB131_136 Depth 3
                                        //       Child Loop BB131_139 Depth 3
                                        //       Child Loop BB131_124 Depth 3
	...
	{
		r17 = sub(r2,r1)
		if (!cmp.gt(r17.new,#0)) jump:nt .LBB131_135
	}
...
.LBB131_143:                            // %"for output.s0.c.rebased.us.us273.us.us.us.us.us.us.preheader"
                                        //   in Loop: Header=BB131_124 Depth=3
	{
		r5 = p1
		r2 = r20
		r1 = memw(r29+#132)
	...
	.p2align	4
.LBB131_144:                            // %"end for output.s0.c.rebased.loopexit.split.us.us.us.us.us.us.us.us"
                                        //   in Loop: Header=BB131_124 Depth=3
	{
		r12 = #0
		r0 = memw(r29+#148)
	...
	{
		r19 = add(r19,#1)
		if (cmp.eq(r19.new,r0)) jump:nt .LBB131_140
	}
.LBB131_124:                            // %"for output.s0.x.rebased51.us.us.us.us.us.us.us"
                                        //   Parent Loop BB131_121 Depth=1
                                        //     Parent Loop BB131_122 Depth=2
                                        // =>    This Loop Header: Depth=3
                                        //         Child Loop BB131_126 Depth 4
                                        //           Child Loop BB131_127 Depth 5
                                        //             Child Loop BB131_129 Depth 6
	...
	{
		r1 = max(r1,r12)
		if (!cmp.gt(r1.new,r0)) jump:nt .LBB131_143
	}
// %bb.125:                             // %"for output.s0.c.rebased.us.us.us.us.us.us.us.us.us.preheader"
	...
	{
		r7 = #0 ; jump .LBB131_126
		r6 = add(r6,r11)
		r8 = and(r8,#7)
	}
	.p2align	4
.LBB131_134:                            // %"consume maximum61.loopexit.split.us.us.us.us.us.us.us.us.us.us"
                                        //   in Loop: Header=BB131_126 Depth=4
	{
		r9 = add(r0,r7)
		r7 = add(r7,#1)
		r12 = and(r13,#255)
	...
	}
	{
		...
		memb(r11+r9<<#0) = r12.new
	}
.LBB131_126:                            // %"for output.s0.c.rebased.us.us.us.us.us.us.us.us.us"
                                        //   Parent Loop BB131_121 Depth=1
                                        //     Parent Loop BB131_122 Depth=2
                                        //       Parent Loop BB131_124 Depth=3
                                        // =>      This Loop Header: Depth=4
                                        //           Child Loop BB131_127 Depth 5
                                        //             Child Loop BB131_129 Depth 6
                                        //             Child Loop BB131_132 Depth 6
	{
		loop1(.LBB131_127,r17)
		r9 = r1
		r13:12 = combine(r21,r3)
		jump .LBB131_127
	}
	.p2align	4
.LBB131_133:                            // %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us"
                                        //   in Loop: Header=BB131_127 Depth=5
	{
		r12 = add(r12,r23)
		r9 = add(r9,r23)
		nop
...
.LBB131_127:                            // %"for maximum.s1.r12$y.rebased55.us.us.us.us.us.us.us.us.us.us"
                                        //   Parent Loop BB131_121 Depth=1
                                        //     Parent Loop BB131_122 Depth=2
                                        //       Parent Loop BB131_124 Depth=3
                                        //         Parent Loop BB131_126 Depth=4
                                        // =>        This Loop Header: Depth=5
                                        //             Child Loop BB131_129 Depth 6
                                        //             Child Loop BB131_132 Depth 6
	{
		r14 = #0
		p0 = cmp.gtu(r6,#6); if (!p0.new) jump:t .LBB131_130
	}
// %bb.128:                             //   in Loop: Header=BB131_127 Depth=5
	{
		r28 = lsr(r5,#3)
		r15 = r12
	}
	{
		loop0(.LBB131_129,r28)
	}
	.p2align	4
.Ltmp24:                                // Block address taken
.LBB131_129:                            // %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us"
                                        //   Parent Loop BB131_121 Depth=1
                                        //     Parent Loop BB131_122 Depth=2
                                        //       Parent Loop BB131_124 Depth=3
                                        //         Parent Loop BB131_126 Depth=4
                                        //           Parent Loop BB131_127 Depth=5
                                        // =>          This Inner Loop Header: Depth=6
	{
		r13 = and(r13,#255)
		r28 = add(r15,r27)
...
.LBB131_130:                            // %"end for maximum.s1.r12$x.rebased59.loopexit.us.us.us.us.us.us.us.us.us.us.unr-lcssa"
                                        //   in Loop: Header=BB131_127 Depth=5
	{
		p0 = cmp.eq(r8,#0)
		if (p0.new) jump:nt .LBB131_133
	}
// %bb.131:                             // %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil.preheader"
	...
	{
		loop0(.LBB131_132,r15)
		r14 += mpyi(r27,r28)
	}
	.p2align	4
.Ltmp25:                                // Block address taken
.LBB131_132:                            // %"for maximum.s1.r12$x.rebased58.us.us.us.us.us.us.us.us.us.us.epil"
                                        //   Parent Loop BB131_121 Depth=1
                                        //     Parent Loop BB131_122 Depth=2
                                        //       Parent Loop BB131_124 Depth=3
                                        //         Parent Loop BB131_126 Depth=4
...
.LBB131_135:                            // %"for output.s0.x.rebased51.us.us.us.us.us.us298.preheader"
                                        //   in Loop: Header=BB131_122 Depth=2
	{
		r0 = p2
		r2 = p1
	...
	{
		if (!p1) jump:nt .LBB131_137
		memw(r29+#8) = r0
		memw(r29+#12) = r2
	}                                       // 4-byte Folded Spill
.LBB131_136:                            // %"for output.s0.x.rebased51.us.us.us.us.us.us298"
                                        //   Parent Loop BB131_121 Depth=1
                                        //     Parent Loop BB131_122 Depth=2
	...
	}                                       // 4-byte Folded Reload
	{
		r24 = add(r24,r2)
		r0 = memw(r29+#32)
		if (!cmp.eq(r0.new,r16)) jump:t .LBB131_136
	}                                       // 4-byte Folded Reload
.LBB131_137:                            // %"end for output.s0.x.rebased52.loopexit.split.us.us.us.us.us.us.loopexit494.unr-lcssa"
                                        //   in Loop: Header=BB131_122 Depth=2
	{
		r12 = #0
		r0 = memw(r29+#12)
	...
	{
		p2 = r2
		if (p2.new) jump:nt .LBB131_140
	}
// %bb.138:                             // %"for output.s0.x.rebased51.us.us.us.us.us.us298.epil.preheader"
                                        //   in Loop: Header=BB131_122 Depth=2
	{
		r0 = memw(r29+#132)
		r19 = memw(r29+#112)
...
.LBB131_139:                            // %"for output.s0.x.rebased51.us.us.us.us.us.us298.epil"
                                        //   Parent Loop BB131_121 Depth=1
                                        //     Parent Loop BB131_122 Depth=2
                                        // =>    This Inner Loop Header: Depth=3
	{
	...
	{
		r17 = add(r17,#-1)
		if (!cmp.eq(r17.new,#0)) jump:t .LBB131_139
	}
	{
		jump .LBB131_140
	}
.LBB131_142:                            // %call_destructor.exit
	{
...
.Ltmp26:                                // Address of block that was removed by CodeGen
.Ltmp27:                                // Address of block that was removed by CodeGen
...
.Lfunc_end131:
	.size	max_pool_hvx128, .Lfunc_end131-max_pool_hvx128
                                        // -- End function
...
.Lfunc_end132:
	.size	max_pool_hvx128_argv, .Lfunc_end132-max_pool_hvx128_argv
                                        // -- End function
...
.Lfunc_end133:
	.size	max_pool_hvx128_metadata, .Lfunc_end133-max_pool_hvx128_metadata
                                        // -- End function
	.section	.text.hydride.node.max_pool_hvx_depth3.0,"ax",@progbits
	.globl	hydride.node.max_pool_hvx_depth3.0 // -- Begin function hydride.node.max_pool_hvx_depth3.0
	.p2align	4
	.type	hydride.node.max_pool_hvx_depth3.0,@function
hydride.node.max_pool_hvx_depth3.0:     // @hydride.node.max_pool_hvx_depth3.0
// %bb.0:                               // %entry
	{
		v5.ub = vmax(v0.ub,v2.ub)
		v4.ub = vmax(v3.ub,v1.ub)
	}
	{
		v1:0 = vcombine(v5,v4)
		jumpr r31
...
.Lfunc_end134:
	.size	hydride.node.max_pool_hvx_depth3.0, .Lfunc_end134-hydride.node.max_pool_hvx_depth3.0
                                        // -- End function
	.section	.text.hydride.node.max_pool_hvx_depth3.1,"ax",@progbits
	.globl	hydride.node.max_pool_hvx_depth3.1 // -- Begin function hydride.node.max_pool_hvx_depth3.1
	.p2align	4
	.type	hydride.node.max_pool_hvx_depth3.1,@function
hydride.node.max_pool_hvx_depth3.1:     // @hydride.node.max_pool_hvx_depth3.1
// %bb.0:                               // %entry
	{
		v5.ub = vmax(v0.ub,v2.ub)
		v4.ub = vmax(v3.ub,v1.ub)
...
.Lfunc_end135:
	.size	hydride.node.max_pool_hvx_depth3.1, .Lfunc_end135-hydride.node.max_pool_hvx_depth3.1
                                        // -- End function
	.section	.text.hydride.node.max_pool_hvx_depth3.2,"ax",@progbits
	.globl	hydride.node.max_pool_hvx_depth3.2 // -- Begin function hydride.node.max_pool_hvx_depth3.2
	.p2align	4
	.type	hydride.node.max_pool_hvx_depth3.2,@function
hydride.node.max_pool_hvx_depth3.2:     // @hydride.node.max_pool_hvx_depth3.2
// %bb.0:                               // %entry
	{
		v5.ub = vmin(v2.ub,v0.ub)
		v4.ub = vmin(v1.ub,v3.ub)
	}
	{
		v1:0 = vcombine(v5,v4)
		jumpr r31
...
.Lfunc_end136:
	.size	hydride.node.max_pool_hvx_depth3.2, .Lfunc_end136-hydride.node.max_pool_hvx_depth3.2
                                        // -- End function
	.section	.text.hydride.node.max_pool_hvx_depth3.3,"ax",@progbits
	.globl	hydride.node.max_pool_hvx_depth3.3 // -- Begin function hydride.node.max_pool_hvx_depth3.3
	.p2align	4
	.type	hydride.node.max_pool_hvx_depth3.3,@function
hydride.node.max_pool_hvx_depth3.3:     // @hydride.node.max_pool_hvx_depth3.3
// %bb.0:                               // %entry
	{
		v5.ub = vmin(v2.ub,v0.ub)
		v4.ub = vmin(v1.ub,v3.ub)
...
.Lfunc_end137:
	.size	hydride.node.max_pool_hvx_depth3.3, .Lfunc_end137-hydride.node.max_pool_hvx_depth3.3
                                        // -- End function
	.section	.text.hydride.node.max_pool_hvx_depth3.4,"ax",@progbits
	.globl	hydride.node.max_pool_hvx_depth3.4 // -- Begin function hydride.node.max_pool_hvx_depth3.4
	.p2align	4
	.type	hydride.node.max_pool_hvx_depth3.4,@function
hydride.node.max_pool_hvx_depth3.4:     // @hydride.node.max_pool_hvx_depth3.4
// %bb.0:                               // %entry
	{
		v5.ub = vmax(v0.ub,v2.ub)
		v4.ub = vmax(v3.ub,v1.ub)
...
.Lfunc_end138:
	.size	hydride.node.max_pool_hvx_depth3.4, .Lfunc_end138-hydride.node.max_pool_hvx_depth3.4
                                        // -- End function
	.section	.text.hydride.node.max_pool_hvx_depth3.5,"ax",@progbits
	.globl	hydride.node.max_pool_hvx_depth3.5 // -- Begin function hydride.node.max_pool_hvx_depth3.5
	.p2align	4
	.type	hydride.node.max_pool_hvx_depth3.5,@function
hydride.node.max_pool_hvx_depth3.5:     // @hydride.node.max_pool_hvx_depth3.5
// %bb.0:                               // %entry
	{
		v5.ub = vmin(v2.ub,v0.ub)
		v4.ub = vmin(v1.ub,v3.ub)
...
.Lfunc_end139:
	.size	hydride.node.max_pool_hvx_depth3.5, .Lfunc_end139-hydride.node.max_pool_hvx_depth3.5
                                        // -- End function
	.section	.text.hydride.node.max_pool_hvx_depth3.6,"ax",@progbits
	.globl	hydride.node.max_pool_hvx_depth3.6 // -- Begin function hydride.node.max_pool_hvx_depth3.6
	.p2align	4
	.type	hydride.node.max_pool_hvx_depth3.6,@function
hydride.node.max_pool_hvx_depth3.6:     // @hydride.node.max_pool_hvx_depth3.6
// %bb.0:                               // %entry
	{
...
.Lfunc_end140:
	.size	hydride.node.max_pool_hvx_depth3.6, .Lfunc_end140-hydride.node.max_pool_hvx_depth3.6
                                        // -- End function
	.section	.text.hydride.node.max_pool_hvx_depth3.7,"ax",@progbits
	.globl	hydride.node.max_pool_hvx_depth3.7 // -- Begin function hydride.node.max_pool_hvx_depth3.7
	.p2align	4
	.type	hydride.node.max_pool_hvx_depth3.7,@function
hydride.node.max_pool_hvx_depth3.7:     // @hydride.node.max_pool_hvx_depth3.7
// %bb.0:                               // %entry
	{
...
.Lfunc_end141:
	.size	hydride.node.max_pool_hvx_depth3.7, .Lfunc_end141-hydride.node.max_pool_hvx_depth3.7
                                        // -- End function
