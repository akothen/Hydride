...
entry:
  ...
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  %xtraiter68 = and i32 %60, 7
  %65 = icmp ult i32 %62, 7
  %unroll_iter70 = and i32 %60, -8
  %lcmp.mod69.not = icmp eq i32 %xtraiter68, 0
  %xtraiter72 = and i32 %63, 1
  %66 = icmp eq i32 %59, %t168
  %unroll_iter74 = and i32 %63, -2
  %lcmp.mod73.not = icmp eq i32 %xtraiter72, 0
  %xtraiter76 = and i32 %t173, 1
  %67 = icmp eq i32 %59, 0
  %unroll_iter78 = and i32 %t173, -2
  %lcmp.mod77.not = icmp eq i32 %xtraiter76, 0
  br label %"for output.s0.y.y.y"

"for output.s0.y.y.y":                            ; preds = %entry, %call_destructor.exit56
  %output.s0.y.y.y = phi i32 [ 0, %entry ], [ %1019, %call_destructor.exit56 ]
...
call_destructor.exit:                             ; preds = %call_destructor.exit56
...
"end for input_bounded.s0.x.x.loopexit.us":       ; preds = %"end for input_bounded.s0.x.x.loopexit.us.unr-lcssa", %"for input_bounded.s0.x.x.us.epil"
  ...
  %.not51.us = icmp eq i32 %215, %81
  br i1 %.not51.us, label %"end for input_bounded.s0.y.rebased", label %"for input_bounded.s0.y.rebased.us"
...
"for input_bounded.s0.y.rebased10.us":            ; preds = %"for input_bounded.s0.y.rebased10.preheader", %"end for input_bounded.s0.x.x14.loopexit.us"
  ...
  %.not45.us = icmp sgt i32 %b44, %b42.us
  %a47.us = select i1 %.not45.us, i32 %b42.us, i32 %a40
...
"for input_bounded.s0.x.x13.us":                  ; preds = %"for input_bounded.s0.y.rebased10.us", %"for input_bounded.s0.x.x13.us"
  ...
  %niter79 = phi i32 [ %niter79.nsub.1, %"for input_bounded.s0.x.x13.us" ], [ %unroll_iter78, %"for input_bounded.s0.y.rebased10.us" ]
  ...
  %niter79.nsub.1 = add i32 %niter79, -2
  %niter79.ncmp.1 = icmp eq i32 %niter79.nsub.1, 0
  br i1 %niter79.ncmp.1, label %"end for input_bounded.s0.x.x14.loopexit.us.unr-lcssa", label %"for input_bounded.s0.x.x13.us"
...
"end for input_bounded.s0.x.x14.loopexit.us.unr-lcssa": ; preds = %"for input_bounded.s0.x.x13.us", %"for input_bounded.s0.y.rebased10.us"
  ...
  br i1 %lcmp.mod77.not, label %"end for input_bounded.s0.x.x14.loopexit.us", label %"for input_bounded.s0.x.x13.us.epil"
...
"end for input_bounded.s0.x.x14.loopexit.us":     ; preds = %"end for input_bounded.s0.x.x14.loopexit.us.unr-lcssa", %"for input_bounded.s0.x.x13.us.epil"
  %.not46.us = icmp eq i32 %input_bounded.s0.y.rebased12.us, %228
  br i1 %.not46.us, label %"consume input_bounded", label %"for input_bounded.s0.y.rebased10.us"
...
"for input_bounded.s0.x.x.rebased":               ; preds = %"for input_bounded.s0.x.x.rebased.preheader", %"for input_bounded.s0.x.x.rebased"
  ...
  %niter71 = phi i32 [ %niter71.nsub.7, %"for input_bounded.s0.x.x.rebased" ], [ %unroll_iter70, %"for input_bounded.s0.x.x.rebased.preheader" ]
  ...
  %niter71.nsub.7 = add i32 %niter71, -8
  %niter71.ncmp.7 = icmp eq i32 %niter71.nsub.7, 0
  br i1 %niter71.ncmp.7, label %"end for input_bounded.s0.x.x.rebased.loopexit.unr-lcssa", label %"for input_bounded.s0.x.x.rebased"
...
"end for input_bounded.s0.x.x.rebased.loopexit.unr-lcssa": ; preds = %"for input_bounded.s0.x.x.rebased", %"for input_bounded.s0.x.x.rebased.preheader"
  ...
  br i1 %lcmp.mod69.not, label %"end for input_bounded.s0.x.x.rebased", label %"for input_bounded.s0.x.x.rebased.epil"
...
"for input_bounded.s0.x.x.rebased.epil":          ; preds = %"end for input_bounded.s0.x.x.rebased.loopexit.unr-lcssa", %"for input_bounded.s0.x.x.rebased.epil"
  ...
  %epil.iter = phi i32 [ %epil.iter.sub, %"for input_bounded.s0.x.x.rebased.epil" ], [ %xtraiter68, %"end for input_bounded.s0.x.x.rebased.loopexit.unr-lcssa" ]
...
"for input_bounded.s0.x.x.rebased7":              ; preds = %"for input_bounded.s0.x.x.rebased7.preheader", %"for input_bounded.s0.x.x.rebased7"
  ...
  %niter75 = phi i32 [ %niter75.nsub.1, %"for input_bounded.s0.x.x.rebased7" ], [ %unroll_iter74, %"for input_bounded.s0.x.x.rebased7.preheader" ]
  ...
  br i1 %niter75.ncmp.1, label %"end for input_bounded.s0.x.x.rebased8.loopexit.unr-lcssa", label %"for input_bounded.s0.x.x.rebased7"
...
"end for input_bounded.s0.x.x.rebased8.loopexit.unr-lcssa": ; preds = %"for input_bounded.s0.x.x.rebased7", %"for input_bounded.s0.x.x.rebased7.preheader"
  ...
  br i1 %lcmp.mod73.not, label %"end for input_bounded.s0.x.x.rebased8", label %"for input_bounded.s0.x.x.rebased7.epil"
...
"end for input_bounded.s0.x.x.rebased8":          ; preds = %"for input_bounded.s0.x.x.rebased7.epil", %"end for input_bounded.s0.x.x.rebased8.loopexit.unr-lcssa", %"end for input_bounded.s0.x.x.rebased"
  ...
  %.not48 = icmp eq i32 %input_bounded.s0.y.rebased3, %226
  br i1 %.not48, label %"end for input_bounded.s0.y.rebased2", label %"for input_bounded.s0.y.rebased1"
...
"for output.s0.x.x.preheader":                    ; preds = %"consume input_bounded"
  %623 = load i8, i8* %44, align 1, !tbaa !104
  %624 = sext i8 %623 to i16
  %625 = insertelement <128 x i16> undef, i16 %624, i32 0
  %626 = shufflevector <128 x i16> %625, <128 x i16> undef, <128 x i32> zeroinitializer
  %627 = load i8, i8* %mask, align 1, !tbaa !117
  %628 = sext i8 %627 to i16
  %629 = insertelement <128 x i16> undef, i16 %628, i32 0
  %630 = shufflevector <128 x i16> %629, <128 x i16> undef, <128 x i32> zeroinitializer
  %631 = load i8, i8* %45, align 1, !tbaa !119
  %632 = sext i8 %631 to i16
  %633 = insertelement <128 x i16> undef, i16 %632, i32 0
  %634 = shufflevector <128 x i16> %633, <128 x i16> undef, <128 x i32> zeroinitializer
  %635 = load i8, i8* %46, align 1, !tbaa !122
  %636 = sext i8 %635 to i16
  %637 = insertelement <128 x i16> undef, i16 %636, i32 0
  %638 = shufflevector <128 x i16> %637, <128 x i16> undef, <128 x i32> zeroinitializer
  %639 = load i8, i8* %47, align 1, !tbaa !124
  %640 = sext i8 %639 to i16
  %641 = insertelement <128 x i16> undef, i16 %640, i32 0
  %642 = shufflevector <128 x i16> %641, <128 x i16> undef, <128 x i32> zeroinitializer
  %643 = load i8, i8* %48, align 1, !tbaa !128
  %644 = sext i8 %643 to i16
  %645 = insertelement <128 x i16> undef, i16 %644, i32 0
  %646 = shufflevector <128 x i16> %645, <128 x i16> undef, <128 x i32> zeroinitializer
  %647 = load i8, i8* %49, align 1, !tbaa !130
  %648 = sext i8 %647 to i16
  %649 = insertelement <128 x i16> undef, i16 %648, i32 0
  %650 = shufflevector <128 x i16> %649, <128 x i16> undef, <128 x i32> zeroinitializer
  %651 = load i8, i8* %50, align 1, !tbaa !133
  %652 = sext i8 %651 to i16
  %653 = insertelement <128 x i16> undef, i16 %652, i32 0
  %654 = shufflevector <128 x i16> %653, <128 x i16> undef, <128 x i32> zeroinitializer
  %655 = load i8, i8* %51, align 1, !tbaa !138
  %656 = sext i8 %655 to i16
  %657 = insertelement <128 x i16> undef, i16 %656, i32 0
  %658 = shufflevector <128 x i16> %657, <128 x i16> undef, <128 x i32> zeroinitializer
  %659 = bitcast <128 x i16> %626 to <64 x i32>
  %660 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %659) #12
  %661 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %659) #12
  %662 = bitcast <128 x i16> %630 to <64 x i32>
  %663 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %662) #12
  %664 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %662) #12
  %665 = bitcast <128 x i16> %634 to <64 x i32>
  %666 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %665) #12
  %667 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %665) #12
  %668 = bitcast <128 x i16> %638 to <64 x i32>
  %669 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %668) #12
  %670 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %668) #12
  %671 = bitcast <128 x i16> %642 to <64 x i32>
  %672 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %671) #12
  %673 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %671) #12
  %674 = bitcast <128 x i16> %646 to <64 x i32>
  %675 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %674) #12
  %676 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %674) #12
  %677 = bitcast <128 x i16> %650 to <64 x i32>
  %678 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %677) #12
  %679 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %677) #12
  %680 = bitcast <128 x i16> %654 to <64 x i32>
  %681 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %680) #12
  %682 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %680) #12
  %683 = bitcast <128 x i16> %658 to <64 x i32>
  %684 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %683) #12
  %685 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %683) #12
  %686 = mul nsw i32 %68, %output.stride.1
  %687 = or i32 %69, 1
  %688 = mul nsw i32 %687, %output.stride.1
  %689 = or i32 %69, 2
  %690 = mul nsw i32 %689, %output.stride.1
  %691 = or i32 %69, 3
  %692 = mul nsw i32 %691, %output.stride.1
  br label %"for output.s0.x.x"

"for output.s0.x.x":                              ; preds = %"for output.s0.x.x.preheader", %"for output.s0.x.x"
  %output.s0.x.x = phi i32 [ %1018, %"for output.s0.x.x" ], [ 0, %"for output.s0.x.x.preheader" ]
  %693 = shl nsw i32 %output.s0.x.x, 7
  %694 = getelementptr inbounds i8, i8* %input_bounded, i32 %693
  %695 = bitcast i8* %694 to <32 x i32>*
  %t25020 = load <32 x i32>, <32 x i32>* %695, align 128, !tbaa !99
  %696 = getelementptr inbounds i8, i8* %694, i32 128
  %697 = bitcast i8* %696 to <32 x i32>*
  %t251.s21 = load <32 x i32>, <32 x i32>* %697, align 128, !tbaa !99
  %698 = add nsw i32 %output.s0.x.x, %a11
  %699 = shl nsw i32 %698, 7
  %700 = getelementptr inbounds i8, i8* %input_bounded, i32 %699
  %701 = bitcast i8* %700 to <32 x i32>*
  %t25222 = load <32 x i32>, <32 x i32>* %701, align 128, !tbaa !99
  %702 = getelementptr inbounds i8, i8* %700, i32 128
  %703 = bitcast i8* %702 to <32 x i32>*
  %t253.s23 = load <32 x i32>, <32 x i32>* %703, align 128, !tbaa !99
  %704 = add nsw i32 %output.s0.x.x, %43
  %705 = shl nsw i32 %704, 7
  %706 = getelementptr inbounds i8, i8* %input_bounded, i32 %705
  %707 = bitcast i8* %706 to <32 x i32>*
  %t25424 = load <32 x i32>, <32 x i32>* %707, align 128, !tbaa !99
  %708 = getelementptr inbounds i8, i8* %706, i32 128
  %709 = bitcast i8* %708 to <32 x i32>*
  %t255.s25 = load <32 x i32>, <32 x i32>* %709, align 128, !tbaa !99
  %710 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %t25020, <32 x i32> %t251.s21) #12
  %711 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %710)
  %712 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %710)
  %713 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %711, <32 x i32> %712, i32 1)
  %714 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %711, <32 x i32> %712, i32 2)
  %715 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %t25222, <32 x i32> %t253.s23) #12
  %716 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %715)
  %717 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %715)
  %718 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %716, <32 x i32> %717, i32 1)
  %719 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %716, <32 x i32> %717, i32 2)
  %720 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %t25424, <32 x i32> %t255.s25) #12
  %721 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %720)
  %722 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %720)
  %723 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %721, <32 x i32> %722, i32 2)
  %724 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %721, <32 x i32> %722, i32 1)
  %725 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %713) #12
  %726 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %725) #12
  %727 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %660, <32 x i32> %726) #12
  %728 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %725) #12
  %729 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %661, <32 x i32> %728) #12
  %730 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %727, <32 x i32> %729) #12
  %731 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t25020) #12
  %732 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %731) #12
  %733 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %663, <32 x i32> %732) #12
  %734 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %731) #12
  %735 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %734, <32 x i32> %664) #12
  %736 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %733, <32 x i32> %735) #12
  %737 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %714) #12
  %738 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %737) #12
  %739 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %666, <32 x i32> %738) #12
  %740 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %737) #12
  %741 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %667, <32 x i32> %740) #12
  %742 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %739, <32 x i32> %741) #12
  %743 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t25222) #12
  %744 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %743) #12
  %745 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %669, <32 x i32> %744) #12
  %746 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %743) #12
  %747 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %670, <32 x i32> %746) #12
  %748 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %745, <32 x i32> %747) #12
  %749 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %718) #12
  %750 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %749) #12
  %751 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %672, <32 x i32> %750) #12
  %752 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %749) #12
  %753 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %752, <32 x i32> %673) #12
  %754 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %751, <32 x i32> %753) #12
  %755 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %719) #12
  %756 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %755) #12
  %757 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %675, <32 x i32> %756) #12
  %758 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %755) #12
  %759 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %676, <32 x i32> %758) #12
  %760 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %757, <32 x i32> %759) #12
  %761 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t25424) #12
  %762 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %761) #12
  %763 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %678, <32 x i32> %762) #12
  %764 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %761) #12
  %765 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %679, <32 x i32> %764) #12
  %766 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %763, <32 x i32> %765) #12
  %767 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %723) #12
  %768 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %767) #12
  %769 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %681, <32 x i32> %768) #12
  %770 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %767) #12
  %771 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %770, <32 x i32> %682) #12
  %772 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %769, <32 x i32> %771) #12
  %773 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %724) #12
  %774 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %773) #12
  %775 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %684, <32 x i32> %774) #12
  %776 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %773) #12
  %777 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %776, <32 x i32> %685) #12
  %778 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %775, <32 x i32> %777) #12
  %779 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %772, <64 x i32> %778) #12
  %780 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %766, <64 x i32> %779) #12
  %781 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %760, <64 x i32> %780) #12
  %782 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %754, <64 x i32> %781) #12
  %783 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %748, <64 x i32> %782) #12
  %784 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %742, <64 x i32> %783) #12
  %785 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %736, <64 x i32> %784) #12
  %786 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %730, <64 x i32> %785) #12
  %787 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %786) #12
  %788 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %787, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #12
  %789 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %785, <64 x i32> %730) #12
  %790 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %789) #12
  %791 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %790, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #12
  %792 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %788, <32 x i32> %791) #12
  %793 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %792) #12
  %794 = tail call <32 x i32> @llvm.hexagon.V6.vminh.128B(<32 x i32> %793, <32 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>) #12
  %795 = tail call <32 x i32> @llvm.hexagon.V6.vmaxh.128B(<32 x i32> %794, <32 x i32> zeroinitializer) #12
  %796 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %792) #12
  %797 = tail call <32 x i32> @llvm.hexagon.V6.vminh.128B(<32 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>, <32 x i32> %796) #12
  %798 = tail call <32 x i32> @llvm.hexagon.V6.vmaxh.128B(<32 x i32> zeroinitializer, <32 x i32> %797) #12
  %799 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %795, <32 x i32> %798) #12
  %800 = shl nsw i32 %output.s0.x.x, 5
  %801 = add nsw i32 %800, %686
  %802 = shl nsw i32 %801, 2
  %803 = getelementptr inbounds i8, i8* %output, i32 %802
  %804 = bitcast i8* %803 to <32 x i32>*
  store <32 x i32> %799, <32 x i32>* %804, align 1, !tbaa !140
  %805 = add nsw i32 %output.s0.x.x, %52
  %806 = shl nsw i32 %805, 7
  %807 = getelementptr inbounds i8, i8* %input_bounded, i32 %806
  %808 = bitcast i8* %807 to <32 x i32>*
  %t26030 = load <32 x i32>, <32 x i32>* %808, align 128, !tbaa !99
  %809 = getelementptr inbounds i8, i8* %807, i32 128
  %810 = bitcast i8* %809 to <32 x i32>*
  %t261.s31 = load <32 x i32>, <32 x i32>* %810, align 128, !tbaa !99
  %811 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %t26030, <32 x i32> %t261.s31) #12
  %812 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %811)
  %813 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %811)
  %814 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %812, <32 x i32> %813, i32 2)
  %815 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %812, <32 x i32> %813, i32 1)
  %816 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %660, <32 x i32> %750) #12
  %817 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %661, <32 x i32> %752) #12
  %818 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %816, <32 x i32> %817) #12
  %819 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %663, <32 x i32> %744) #12
  %820 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %746, <32 x i32> %664) #12
  %821 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %819, <32 x i32> %820) #12
  %822 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %666, <32 x i32> %756) #12
  %823 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %667, <32 x i32> %758) #12
  %824 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %822, <32 x i32> %823) #12
  %825 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %669, <32 x i32> %762) #12
  %826 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %670, <32 x i32> %764) #12
  %827 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %825, <32 x i32> %826) #12
  %828 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %672, <32 x i32> %774) #12
  %829 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %776, <32 x i32> %673) #12
  %830 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %828, <32 x i32> %829) #12
  %831 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %675, <32 x i32> %768) #12
  %832 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %676, <32 x i32> %770) #12
  %833 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %831, <32 x i32> %832) #12
  %834 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t26030) #12
  %835 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %834) #12
  %836 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %678, <32 x i32> %835) #12
  %837 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %834) #12
  %838 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %679, <32 x i32> %837) #12
  %839 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %836, <32 x i32> %838) #12
  %840 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %814) #12
  %841 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %840) #12
  %842 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %681, <32 x i32> %841) #12
  %843 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %840) #12
  %844 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %843, <32 x i32> %682) #12
  %845 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %842, <32 x i32> %844) #12
  %846 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %815) #12
  %847 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %846) #12
  %848 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %684, <32 x i32> %847) #12
  %849 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %846) #12
  %850 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %849, <32 x i32> %685) #12
  %851 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %848, <32 x i32> %850) #12
  %852 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %845, <64 x i32> %851) #12
  %853 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %839, <64 x i32> %852) #12
  %854 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %833, <64 x i32> %853) #12
  %855 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %830, <64 x i32> %854) #12
  %856 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %827, <64 x i32> %855) #12
  %857 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %824, <64 x i32> %856) #12
  %858 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %821, <64 x i32> %857) #12
  %859 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %818, <64 x i32> %858) #12
  %860 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %859) #12
  %861 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %860, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #12
  %862 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %858, <64 x i32> %818) #12
  %863 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %862) #12
  %864 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %863, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #12
  %865 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %861, <32 x i32> %864) #12
  %866 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %865) #12
  %867 = tail call <32 x i32> @llvm.hexagon.V6.vminh.128B(<32 x i32> %866, <32 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>) #12
  %868 = tail call <32 x i32> @llvm.hexagon.V6.vmaxh.128B(<32 x i32> %867, <32 x i32> zeroinitializer) #12
  %869 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %865) #12
  %870 = tail call <32 x i32> @llvm.hexagon.V6.vminh.128B(<32 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>, <32 x i32> %869) #12
  %871 = tail call <32 x i32> @llvm.hexagon.V6.vmaxh.128B(<32 x i32> zeroinitializer, <32 x i32> %870) #12
  %872 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %868, <32 x i32> %871) #12
  %873 = add nsw i32 %693, %688
  %874 = getelementptr inbounds i8, i8* %output, i32 %873
  %875 = bitcast i8* %874 to <32 x i32>*
  store <32 x i32> %872, <32 x i32>* %875, align 1, !tbaa !140
  %876 = add nsw i32 %output.s0.x.x, %53
  %877 = shl nsw i32 %876, 7
  %878 = getelementptr inbounds i8, i8* %input_bounded, i32 %877
  %879 = bitcast i8* %878 to <32 x i32>*
  %t26636 = load <32 x i32>, <32 x i32>* %879, align 128, !tbaa !99
  %880 = getelementptr inbounds i8, i8* %878, i32 128
  %881 = bitcast i8* %880 to <32 x i32>*
  %t267.s37 = load <32 x i32>, <32 x i32>* %881, align 128, !tbaa !99
  %882 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %t26636, <32 x i32> %t267.s37) #12
  %883 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %882)
  %884 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %882)
  %885 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %883, <32 x i32> %884, i32 2)
  %886 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %883, <32 x i32> %884, i32 1)
  %887 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %660, <32 x i32> %774) #12
  %888 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %661, <32 x i32> %776) #12
  %889 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %887, <32 x i32> %888) #12
  %890 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %663, <32 x i32> %762) #12
  %891 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %764, <32 x i32> %664) #12
  %892 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %890, <32 x i32> %891) #12
  %893 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %666, <32 x i32> %768) #12
  %894 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %667, <32 x i32> %770) #12
  %895 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %893, <32 x i32> %894) #12
  %896 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %669, <32 x i32> %835) #12
  %897 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %670, <32 x i32> %837) #12
  %898 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %896, <32 x i32> %897) #12
  %899 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %672, <32 x i32> %847) #12
  %900 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %849, <32 x i32> %673) #12
  %901 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %899, <32 x i32> %900) #12
  %902 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %675, <32 x i32> %841) #12
  %903 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %676, <32 x i32> %843) #12
  %904 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %902, <32 x i32> %903) #12
  %905 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t26636) #12
  %906 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %905) #12
  %907 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %678, <32 x i32> %906) #12
  %908 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %905) #12
  %909 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %679, <32 x i32> %908) #12
  %910 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %907, <32 x i32> %909) #12
  %911 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %885) #12
  %912 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %911) #12
  %913 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %681, <32 x i32> %912) #12
  %914 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %911) #12
  %915 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %914, <32 x i32> %682) #12
  %916 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %913, <32 x i32> %915) #12
  %917 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %886) #12
  %918 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %917) #12
  %919 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %684, <32 x i32> %918) #12
  %920 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %917) #12
  %921 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %920, <32 x i32> %685) #12
  %922 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %919, <32 x i32> %921) #12
  %923 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %916, <64 x i32> %922) #12
  %924 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %910, <64 x i32> %923) #12
  %925 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %904, <64 x i32> %924) #12
  %926 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %901, <64 x i32> %925) #12
  %927 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %898, <64 x i32> %926) #12
  %928 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %895, <64 x i32> %927) #12
  %929 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %892, <64 x i32> %928) #12
  %930 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %889, <64 x i32> %929) #12
  %931 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %930) #12
  %932 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %931, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #12
  %933 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %929, <64 x i32> %889) #12
  %934 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %933) #12
  %935 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %934, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #12
  %936 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %932, <32 x i32> %935) #12
  %937 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %936) #12
  %938 = tail call <32 x i32> @llvm.hexagon.V6.vminh.128B(<32 x i32> %937, <32 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>) #12
  %939 = tail call <32 x i32> @llvm.hexagon.V6.vmaxh.128B(<32 x i32> %938, <32 x i32> zeroinitializer) #12
  %940 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %936) #12
  %941 = tail call <32 x i32> @llvm.hexagon.V6.vminh.128B(<32 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>, <32 x i32> %940) #12
  %942 = tail call <32 x i32> @llvm.hexagon.V6.vmaxh.128B(<32 x i32> zeroinitializer, <32 x i32> %941) #12
  %943 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %939, <32 x i32> %942) #12
  %944 = add nsw i32 %693, %690
  %945 = getelementptr inbounds i8, i8* %output, i32 %944
  %946 = bitcast i8* %945 to <32 x i32>*
  store <32 x i32> %943, <32 x i32>* %946, align 1, !tbaa !140
  %947 = add nsw i32 %output.s0.x.x, %54
  %948 = shl nsw i32 %947, 7
  %949 = getelementptr inbounds i8, i8* %input_bounded, i32 %948
  %950 = bitcast i8* %949 to <32 x i32>*
  %t27242 = load <32 x i32>, <32 x i32>* %950, align 128, !tbaa !99
  %951 = getelementptr inbounds i8, i8* %949, i32 128
  %952 = bitcast i8* %951 to <32 x i32>*
  %t273.s43 = load <32 x i32>, <32 x i32>* %952, align 128, !tbaa !99
  %953 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %t27242, <32 x i32> %t273.s43) #12
  %954 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %953)
  %955 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %953)
  %956 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %954, <32 x i32> %955, i32 2)
  %957 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %954, <32 x i32> %955, i32 1)
  %958 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %660, <32 x i32> %847) #12
  %959 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %661, <32 x i32> %849) #12
  %960 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %958, <32 x i32> %959) #12
  %961 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %663, <32 x i32> %835) #12
  %962 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %837, <32 x i32> %664) #12
  %963 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %961, <32 x i32> %962) #12
  %964 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %666, <32 x i32> %841) #12
  %965 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %667, <32 x i32> %843) #12
  %966 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %964, <32 x i32> %965) #12
  %967 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %669, <32 x i32> %906) #12
  %968 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %670, <32 x i32> %908) #12
  %969 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %967, <32 x i32> %968) #12
  %970 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %672, <32 x i32> %918) #12
  %971 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %920, <32 x i32> %673) #12
  %972 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %970, <32 x i32> %971) #12
  %973 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %675, <32 x i32> %912) #12
  %974 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %676, <32 x i32> %914) #12
  %975 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %973, <32 x i32> %974) #12
  %976 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t27242) #12
  %977 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %976) #12
  %978 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %678, <32 x i32> %977) #12
  %979 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %976) #12
  %980 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %679, <32 x i32> %979) #12
  %981 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %978, <32 x i32> %980) #12
  %982 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %956) #12
  %983 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %982) #12
  %984 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %681, <32 x i32> %983) #12
  %985 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %982) #12
  %986 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %985, <32 x i32> %682) #12
  %987 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %984, <32 x i32> %986) #12
  %988 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %957) #12
  %989 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %988) #12
  %990 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %684, <32 x i32> %989) #12
  %991 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %988) #12
  %992 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %991, <32 x i32> %685) #12
  %993 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %990, <32 x i32> %992) #12
  %994 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %987, <64 x i32> %993) #12
  %995 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %981, <64 x i32> %994) #12
  %996 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %975, <64 x i32> %995) #12
  %997 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %972, <64 x i32> %996) #12
  %998 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %969, <64 x i32> %997) #12
  %999 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %966, <64 x i32> %998) #12
  %1000 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %963, <64 x i32> %999) #12
  %1001 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %960, <64 x i32> %1000) #12
  %1002 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1001) #12
  %1003 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %1002, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #12
  %1004 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %1000, <64 x i32> %960) #12
  %1005 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1004) #12
  %1006 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %1005, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>) #12
  %1007 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1003, <32 x i32> %1006) #12
  %1008 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1007) #12
  %1009 = tail call <32 x i32> @llvm.hexagon.V6.vminh.128B(<32 x i32> %1008, <32 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>) #12
  %1010 = tail call <32 x i32> @llvm.hexagon.V6.vmaxh.128B(<32 x i32> %1009, <32 x i32> zeroinitializer) #12
  %1011 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1007) #12
  %1012 = tail call <32 x i32> @llvm.hexagon.V6.vminh.128B(<32 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>, <32 x i32> %1011) #12
  %1013 = tail call <32 x i32> @llvm.hexagon.V6.vmaxh.128B(<32 x i32> zeroinitializer, <32 x i32> %1012) #12
  %1014 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %1010, <32 x i32> %1013) #12
  %1015 = add nsw i32 %693, %692
  %1016 = getelementptr inbounds i8, i8* %output, i32 %1015
  %1017 = bitcast i8* %1016 to <32 x i32>*
  store <32 x i32> %1014, <32 x i32>* %1017, align 1, !tbaa !140
  %1018 = add nuw nsw i32 %output.s0.x.x, 1
  %.not44 = icmp eq i32 %1018, %t172
  br i1 %.not44, label %if.then.i55, label %"for output.s0.x.x"

"end for output.s0.x.x":                          ; preds = %"consume input_bounded"
  %tobool.not.i54.not = icmp eq i8* %input_bounded, null
  br i1 %tobool.not.i54.not, label %call_destructor.exit56, label %if.then.i55

if.then.i55:                                      ; preds = %"for output.s0.x.x", %"end for output.s0.x.x"
  tail call void @halide_free(i8* %__user_context, i8* nonnull %input_bounded) #15
  br label %call_destructor.exit56

call_destructor.exit56:                           ; preds = %"end for output.s0.x.x", %if.then.i55
  %1019 = add nuw nsw i32 %output.s0.y.y.y, 1
  %.not19 = icmp eq i32 %1019, 128
...
entry:
  ...
  %call4.i = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @conv3x3a16_hvx128_par_for_output_s0_y_y_v1, i32 0, i32 %47, i8* nonnull %48) #15
  ret i32 0
}
...
entry:
  ...
  %9 = tail call i32 @conv3x3a16_hvx128(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5, %struct.halide_buffer_t* %8) #17
  ret i32 0
}
...
define <128 x i8> @hydride.node.conv3x3a16_hvx_depth3.0(<128 x i8> %arg, <128 x i16> %arg.1, <128 x i8> %arg.2, <128 x i16> %arg.3, <128 x i8> %arg.4, <128 x i16> %arg.5, <128 x i8> %arg.6, <128 x i16> %arg.7, <128 x i8> %arg.8, <128 x i16> %arg.9, <128 x i8> %arg.10, <128 x i16> %arg.11, <128 x i8> %arg.12, <128 x i16> %arg.13, <128 x i8> %arg.14, <128 x i16> %arg.15, <128 x i8> %arg.16, <128 x i16> %arg.17) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i16> %arg.1 to <64 x i32>
  %1 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %0)
  %2 = bitcast <128 x i8> %arg to <32 x i32>
  %3 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %2)
  %4 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %3)
  %5 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %1, <32 x i32> %4)
  %6 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %0)
  %7 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %3)
  %8 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %6, <32 x i32> %7)
  %9 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %5, <32 x i32> %8)
  %10 = bitcast <128 x i16> %arg.3 to <64 x i32>
  %11 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %10)
  %12 = bitcast <128 x i8> %arg.2 to <32 x i32>
  %13 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %12)
  %14 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %13)
  %15 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %11, <32 x i32> %14)
  %16 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %13)
  %17 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %10)
  %18 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %16, <32 x i32> %17)
  %19 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %15, <32 x i32> %18)
  %20 = bitcast <128 x i16> %arg.5 to <64 x i32>
  %21 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %20)
  %22 = bitcast <128 x i8> %arg.4 to <32 x i32>
  ...
  %25 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %21, <32 x i32> %24)
  %26 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %20)
  %27 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %23)
  %28 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %26, <32 x i32> %27)
  %29 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %25, <32 x i32> %28)
  %30 = bitcast <128 x i16> %arg.7 to <64 x i32>
  %31 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %30)
  %32 = bitcast <128 x i8> %arg.6 to <32 x i32>
  ...
  %35 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %31, <32 x i32> %34)
  %36 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %30)
  %37 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %33)
  %38 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %36, <32 x i32> %37)
  %39 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %35, <32 x i32> %38)
  %40 = bitcast <128 x i16> %arg.9 to <64 x i32>
  %41 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %40)
  %42 = bitcast <128 x i8> %arg.8 to <32 x i32>
  %43 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %42)
  %44 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %43)
  %45 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %41, <32 x i32> %44)
  %46 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %43)
  %47 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %40)
  %48 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %46, <32 x i32> %47)
  %49 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %45, <32 x i32> %48)
  %50 = bitcast <128 x i16> %arg.11 to <64 x i32>
  %51 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %50)
  %52 = bitcast <128 x i8> %arg.10 to <32 x i32>
  %53 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %52)
  %54 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %53)
  %55 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %51, <32 x i32> %54)
  %56 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %50)
  %57 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %53)
  %58 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %56, <32 x i32> %57)
  %59 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %55, <32 x i32> %58)
  %60 = bitcast <128 x i16> %arg.13 to <64 x i32>
  %61 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %60)
  %62 = bitcast <128 x i8> %arg.12 to <32 x i32>
  %63 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %62)
  %64 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %63)
  %65 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %61, <32 x i32> %64)
  %66 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %60)
  %67 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %63)
  %68 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %66, <32 x i32> %67)
  %69 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %65, <32 x i32> %68)
  %70 = bitcast <128 x i16> %arg.15 to <64 x i32>
  %71 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %70)
  %72 = bitcast <128 x i8> %arg.14 to <32 x i32>
  %73 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %72)
  %74 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %73)
  %75 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %71, <32 x i32> %74)
  %76 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %73)
  %77 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %70)
  %78 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %76, <32 x i32> %77)
  %79 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %75, <32 x i32> %78)
  %80 = bitcast <128 x i16> %arg.17 to <64 x i32>
  %81 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %80)
  %82 = bitcast <128 x i8> %arg.16 to <32 x i32>
  %83 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %82)
  %84 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %83)
  %85 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %81, <32 x i32> %84)
  %86 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %83)
  %87 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %80)
  %88 = tail call <32 x i32> @llvm.hexagon.V6.vmpyih.acc.128B(<32 x i32> zeroinitializer, <32 x i32> %86, <32 x i32> %87)
  %89 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %85, <32 x i32> %88)
  %90 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %79, <64 x i32> %89)
  %91 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %69, <64 x i32> %90)
  %92 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %59, <64 x i32> %91)
  %93 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %49, <64 x i32> %92)
  %94 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %39, <64 x i32> %93)
  %95 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %29, <64 x i32> %94)
  %96 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %19, <64 x i32> %95)
  %97 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %9, <64 x i32> %96)
  %98 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %97)
  %99 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %98, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>)
  %100 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %96, <64 x i32> %9)
  %101 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %100)
  %102 = tail call <32 x i32> @llvm.hexagon.V6.vasrhv.128B(<32 x i32> %101, <32 x i32> <i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148, i32 262148>)
  %103 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %99, <32 x i32> %102)
  %104 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %103)
  %105 = tail call <32 x i32> @llvm.hexagon.V6.vminh.128B(<32 x i32> %104, <32 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>)
  %106 = tail call <32 x i32> @llvm.hexagon.V6.vmaxh.128B(<32 x i32> %105, <32 x i32> zeroinitializer)
  %107 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %103)
  %108 = tail call <32 x i32> @llvm.hexagon.V6.vminh.128B(<32 x i32> <i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935, i32 16711935>, <32 x i32> %107)
  %109 = tail call <32 x i32> @llvm.hexagon.V6.vmaxh.128B(<32 x i32> zeroinitializer, <32 x i32> %108)
  %110 = tail call <32 x i32> @llvm.hexagon.V6.vpackeb.128B(<32 x i32> %106, <32 x i32> %109)
  %111 = bitcast <32 x i32> %110 to <128 x i8>
  ret <128 x i8> %111
}
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.1(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.2(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.3(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.4(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.5(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.6(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.conv3x3a16_hvx_depth3.7(<128 x i8> %arg, <128 x i16> %arg.1, <128 x i8> %arg.2, <128 x i16> %arg.3, <128 x i8> %arg.4, <128 x i16> %arg.5, <128 x i8> %arg.6, <128 x i16> %arg.7, <128 x i8> %arg.8, <128 x i16> %arg.9, <128 x i8> %arg.10, <128 x i16> %arg.11, <128 x i8> %arg.12, <128 x i16> %arg.13, <128 x i8> %arg.14, <128 x i16> %arg.15, <128 x i8> %arg.16, <128 x i16> %arg.17) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i16> %arg.1 to <64 x i32>
  %1 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %0)
  %2 = bitcast <128 x i8> %arg to <32 x i32>
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.8(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.9(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.10(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.11(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.12(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.13(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.conv3x3a16_hvx_depth3.14(<128 x i8> %arg, <128 x i16> %arg.1, <128 x i8> %arg.2, <128 x i16> %arg.3, <128 x i8> %arg.4, <128 x i16> %arg.5, <128 x i8> %arg.6, <128 x i16> %arg.7, <128 x i8> %arg.8, <128 x i16> %arg.9, <128 x i8> %arg.10, <128 x i16> %arg.11, <128 x i8> %arg.12, <128 x i16> %arg.13, <128 x i8> %arg.14, <128 x i16> %arg.15, <128 x i8> %arg.16, <128 x i16> %arg.17) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i16> %arg.1 to <64 x i32>
  %1 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %0)
  %2 = bitcast <128 x i8> %arg to <32 x i32>
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.15(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.16(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.17(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.18(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.19(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.20(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <128 x i8> @hydride.node.conv3x3a16_hvx_depth3.21(<128 x i8> %arg, <128 x i16> %arg.1, <128 x i8> %arg.2, <128 x i16> %arg.3, <128 x i8> %arg.4, <128 x i16> %arg.5, <128 x i8> %arg.6, <128 x i16> %arg.7, <128 x i8> %arg.8, <128 x i16> %arg.9, <128 x i8> %arg.10, <128 x i16> %arg.11, <128 x i8> %arg.12, <128 x i16> %arg.13, <128 x i8> %arg.14, <128 x i16> %arg.15, <128 x i8> %arg.16, <128 x i16> %arg.17) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i16> %arg.1 to <64 x i32>
  %1 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %0)
  %2 = bitcast <128 x i8> %arg to <32 x i32>
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.22(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.23(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.24(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.25(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.26(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
...
; Function Attrs: nounwind readnone willreturn
define <256 x i8> @hydride.node.conv3x3a16_hvx_depth3.27(<128 x i8> %arg, <128 x i8> %arg.1) local_unnamed_addr #14 {
entry:
  %0 = bitcast <128 x i8> %arg to <32 x i32>
  %1 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %2 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %0, <32 x i32> %1)
