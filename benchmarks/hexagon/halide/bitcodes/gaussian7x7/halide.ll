...
; Function Attrs: nounwind readnone
declare <64 x i32> @llvm.hexagon.V6.vmpyub.128B(<32 x i32>, i32) #9

; Function Attrs: nounwind readnone
declare <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32>, <32 x i32>, i32) #9

; Function Attrs: nounwind readnone
declare <32 x i32> @llvm.hexagon.V6.vrmpybus.128B(<32 x i32>, i32) #9
...
"for output.s0.y.v1":                             ; preds = %entry, %"end for output.s0.x.x2"
  %output.s0.y.v1 = phi i32 [ 0, %entry ], [ %809, %"end for output.s0.x.x2" ]
...
"for output.s0.x.x.preheader":                    ; preds = %"for output.s0.y.v1"
  %dup4.i.i = tail call i32 @llvm.hexagon.S2.vsplatrb(i32 225) #11
...
"for output.s0.x.x":                              ; preds = %"for output.s0.x.x.preheader", %"for output.s0.x.x"
  %output.s0.x.x = phi i32 [ %418, %"for output.s0.x.x" ], [ 0, %"for output.s0.x.x.preheader" ]
  %30 = shl nsw i32 %output.s0.x.x, 7
  %t3 = add nsw i32 %30, %28
  %31 = sub nsw i32 %t3, %input.stride.1
  ...
  %36 = tail call <64 x i32> @llvm.hexagon.V6.vmpyub.128B(<32 x i32> %35, i32 %dup4.i.i) #11
  %e.i = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %36) #11
  %o.i = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %36) #11
  %r_32.i = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i, <32 x i32> %e.i, i32 -2) #11
  %37 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r_32.i)
  %38 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r_32.i)
  %39 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %38) #11
  %40 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %37) #11
  %41 = getelementptr inbounds i8, i8* %32, i32 -1
  %42 = bitcast i8* %41 to <32 x i32>*
  %43 = load <32 x i32>, <32 x i32>* %42, align 1, !tbaa !96
  %44 = tail call <64 x i32> @llvm.hexagon.V6.vmpyub.128B(<32 x i32> %43, i32 %dup4.i.i) #11
  %e.i7 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %44) #11
  %o.i8 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %44) #11
  %r_32.i9 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i8, <32 x i32> %e.i7, i32 -2) #11
  %45 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r_32.i9)
  %46 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r_32.i9)
  %47 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %46) #11
  %48 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %45) #11
  %49 = add nsw i32 %t3, %t45
  %50 = getelementptr inbounds i8, i8* %input, i32 %49
  %51 = getelementptr inbounds i8, i8* %50, i32 -3
  %52 = bitcast i8* %51 to <32 x i32>*
  %53 = load <32 x i32>, <32 x i32>* %52, align 1, !tbaa !96
  %54 = add nsw i32 %t3, %t44
  %55 = getelementptr inbounds i8, i8* %input, i32 %54
  %56 = getelementptr inbounds i8, i8* %55, i32 3
  %57 = bitcast i8* %56 to <32 x i32>*
  %58 = load <32 x i32>, <32 x i32>* %57, align 1, !tbaa !96
  %59 = add nsw i32 %t3, %input.stride.1
  %60 = getelementptr inbounds i8, i8* %input, i32 %59
  %61 = getelementptr inbounds i8, i8* %60, i32 3
  %62 = bitcast i8* %61 to <32 x i32>*
  %63 = load <32 x i32>, <32 x i32>* %62, align 1, !tbaa !96
  %64 = getelementptr inbounds i8, i8* %input, i32 %t3
  %65 = getelementptr inbounds i8, i8* %64, i32 3
  %66 = bitcast i8* %65 to <32 x i32>*
  %67 = load <32 x i32>, <32 x i32>* %66, align 1, !tbaa !96
  %68 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %63, <32 x i32> %53, i32 -1)
  %69 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %67, <32 x i32> %58, i32 -1)
  %70 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %68)
  %71 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %68)
  %72 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %69)
  %73 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %69)
  %74 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %73, <32 x i32> %71, i32 -1)
  %75 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %72, <32 x i32> %70, i32 -1)
  %76 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %74)
  %77 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %74)
  %78 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.128B(<32 x i32> %77, i32 336528897) #11
  %79 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.128B(<32 x i32> %76, i32 336528897) #11
  %80 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %75)
  %81 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %75)
  %82 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.128B(<32 x i32> %81, i32 336528897) #11
  %83 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.128B(<32 x i32> %80, i32 336528897) #11
  %84 = getelementptr inbounds i8, i8* %64, i32 -3
  %85 = bitcast i8* %84 to <32 x i32>*
  %86 = load <32 x i32>, <32 x i32>* %85, align 1, !tbaa !96
  %87 = getelementptr inbounds i8, i8* %32, i32 -3
  %88 = bitcast i8* %87 to <32 x i32>*
  %89 = load <32 x i32>, <32 x i32>* %88, align 1, !tbaa !96
  %90 = add nsw i32 %t3, %t43
  %91 = getelementptr inbounds i8, i8* %input, i32 %90
  %92 = getelementptr inbounds i8, i8* %91, i32 -3
  %93 = bitcast i8* %92 to <32 x i32>*
  %94 = load <32 x i32>, <32 x i32>* %93, align 1, !tbaa !96
  %95 = add nsw i32 %t3, %t42
  %96 = getelementptr inbounds i8, i8* %input, i32 %95
  %97 = getelementptr inbounds i8, i8* %96, i32 -3
  %98 = bitcast i8* %97 to <32 x i32>*
  %99 = load <32 x i32>, <32 x i32>* %98, align 1, !tbaa !96
  %100 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %94, <32 x i32> %86, i32 -1)
  %101 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %99, <32 x i32> %89, i32 -1)
  %102 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %100)
  %103 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %100)
  %104 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %101)
  %105 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %101)
  %106 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %105, <32 x i32> %103, i32 -1)
  %107 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %104, <32 x i32> %102, i32 -1)
  %108 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %106)
  %109 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %106)
  %110 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %78, <32 x i32> %109, i32 17174292) #11
  %111 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %79, <32 x i32> %108, i32 17174292) #11
  %112 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %107)
  %113 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %107)
  %114 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %82, <32 x i32> %113, i32 17174292) #11
  %115 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %83, <32 x i32> %112, i32 17174292) #11
  %116 = getelementptr inbounds i8, i8* %96, i32 1
  %117 = bitcast i8* %116 to <32 x i32>*
  %118 = load <32 x i32>, <32 x i32>* %117, align 1, !tbaa !96
  %119 = getelementptr inbounds i8, i8* %50, i32 1
  %120 = bitcast i8* %119 to <32 x i32>*
  %121 = load <32 x i32>, <32 x i32>* %120, align 1, !tbaa !96
  %122 = getelementptr inbounds i8, i8* %55, i32 -3
  %123 = bitcast i8* %122 to <32 x i32>*
  %124 = load <32 x i32>, <32 x i32>* %123, align 1, !tbaa !96
  %125 = getelementptr inbounds i8, i8* %60, i32 -3
  %126 = bitcast i8* %125 to <32 x i32>*
  %127 = load <32 x i32>, <32 x i32>* %126, align 1, !tbaa !96
  %128 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %124, <32 x i32> %118, i32 -1)
  %129 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %127, <32 x i32> %121, i32 -1)
  %130 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %128)
  %131 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %128)
  %132 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %129)
  %133 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %129)
  %134 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %133, <32 x i32> %131, i32 -1)
  %135 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %132, <32 x i32> %130, i32 -1)
  %136 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %134)
  %137 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %134)
  %138 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %110, <32 x i32> %137, i32 252055311) #11
  %139 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %111, <32 x i32> %136, i32 252055311) #11
  %140 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %135)
  %141 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %135)
  %142 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %114, <32 x i32> %141, i32 252055311) #11
  %143 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %115, <32 x i32> %140, i32 252055311) #11
  %144 = getelementptr inbounds i8, i8* %96, i32 2
  %145 = bitcast i8* %144 to <32 x i32>*
  %146 = load <32 x i32>, <32 x i32>* %145, align 1, !tbaa !96
  %147 = getelementptr inbounds i8, i8* %50, i32 2
  %148 = bitcast i8* %147 to <32 x i32>*
  %149 = load <32 x i32>, <32 x i32>* %148, align 1, !tbaa !96
  %150 = getelementptr inbounds i8, i8* %55, i32 1
  %151 = bitcast i8* %150 to <32 x i32>*
  %152 = load <32 x i32>, <32 x i32>* %151, align 1, !tbaa !96
  %153 = getelementptr inbounds i8, i8* %91, i32 1
  %154 = bitcast i8* %153 to <32 x i32>*
  %155 = load <32 x i32>, <32 x i32>* %154, align 1, !tbaa !96
  %156 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %152, <32 x i32> %146, i32 -1)
  %157 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %155, <32 x i32> %149, i32 -1)
  %158 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %156)
  %159 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %156)
  %160 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %157)
  %161 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %157)
  %162 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %161, <32 x i32> %159, i32 -1)
  %163 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %160, <32 x i32> %158, i32 -1)
  %164 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %162)
  %165 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %162)
  %166 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %138, <32 x i32> %165, i32 1515849222) #11
  %167 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %139, <32 x i32> %164, i32 1515849222) #11
  %168 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %163)
  %169 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %163)
  %170 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %142, <32 x i32> %169, i32 1515849222) #11
  %171 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %143, <32 x i32> %168, i32 1515849222) #11
  %172 = getelementptr inbounds i8, i8* %60, i32 2
  %173 = bitcast i8* %172 to <32 x i32>*
  %174 = load <32 x i32>, <32 x i32>* %173, align 1, !tbaa !96
  %175 = getelementptr inbounds i8, i8* %64, i32 2
  %176 = bitcast i8* %175 to <32 x i32>*
  %177 = load <32 x i32>, <32 x i32>* %176, align 1, !tbaa !96
  %178 = getelementptr inbounds i8, i8* %32, i32 2
  %179 = bitcast i8* %178 to <32 x i32>*
  %180 = load <32 x i32>, <32 x i32>* %179, align 1, !tbaa !96
  %181 = getelementptr inbounds i8, i8* %91, i32 2
  %182 = bitcast i8* %181 to <32 x i32>*
  %183 = load <32 x i32>, <32 x i32>* %182, align 1, !tbaa !96
  %184 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %180, <32 x i32> %174, i32 -1)
  %185 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %183, <32 x i32> %177, i32 -1)
  %186 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %184)
  %187 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %184)
  %188 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %185)
  %189 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %185)
  %190 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %189, <32 x i32> %187, i32 -1)
  %191 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %188, <32 x i32> %186, i32 -1)
  %192 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %190)
  %193 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %190)
  %194 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %166, <32 x i32> %193, i32 609908826) #11
  %195 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %167, <32 x i32> %192, i32 609908826) #11
  %196 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %191)
  %197 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %191)
  %198 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %170, <32 x i32> %197, i32 609908826) #11
  %199 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %171, <32 x i32> %196, i32 609908826) #11
  %200 = bitcast i8* %91 to <32 x i32>*
  %201 = load <32 x i32>, <32 x i32>* %200, align 1, !tbaa !96
  %202 = bitcast i8* %96 to <32 x i32>*
  %203 = load <32 x i32>, <32 x i32>* %202, align 1, !tbaa !96
  %204 = bitcast i8* %50 to <32 x i32>*
  %205 = load <32 x i32>, <32 x i32>* %204, align 1, !tbaa !96
  %206 = getelementptr inbounds i8, i8* %55, i32 2
  %207 = bitcast i8* %206 to <32 x i32>*
  %208 = load <32 x i32>, <32 x i32>* %207, align 1, !tbaa !96
  %209 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %205, <32 x i32> %201, i32 -1)
  %210 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %208, <32 x i32> %203, i32 -1)
  %211 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %209)
  %212 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %209)
  %213 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %210)
  %214 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %210)
  %215 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %214, <32 x i32> %212, i32 -1)
  %216 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %213, <32 x i32> %211, i32 -1)
  %217 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %215)
  %218 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %215)
  %219 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %194, <32 x i32> %218, i32 605295736) #11
  %220 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %195, <32 x i32> %217, i32 605295736) #11
  %221 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %216)
  %222 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %216)
  %223 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %198, <32 x i32> %222, i32 605295736) #11
  %224 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %199, <32 x i32> %221, i32 605295736) #11
  %225 = getelementptr inbounds i8, i8* %91, i32 -1
  %226 = bitcast i8* %225 to <32 x i32>*
  %227 = load <32 x i32>, <32 x i32>* %226, align 1, !tbaa !96
  %228 = getelementptr inbounds i8, i8* %96, i32 -1
  %229 = bitcast i8* %228 to <32 x i32>*
  %230 = load <32 x i32>, <32 x i32>* %229, align 1, !tbaa !96
  %231 = getelementptr inbounds i8, i8* %50, i32 -1
  %232 = bitcast i8* %231 to <32 x i32>*
  %233 = load <32 x i32>, <32 x i32>* %232, align 1, !tbaa !96
  %234 = bitcast i8* %55 to <32 x i32>*
  %235 = load <32 x i32>, <32 x i32>* %234, align 1, !tbaa !96
  %236 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %233, <32 x i32> %227, i32 -1)
  %237 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %235, <32 x i32> %230, i32 -1)
  %238 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %236)
  %239 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %236)
  %240 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %237)
  %241 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %237)
  %242 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %241, <32 x i32> %239, i32 -1)
  %243 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %240, <32 x i32> %238, i32 -1)
  %244 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %242)
  %245 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %242)
  %246 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %219, <32 x i32> %245, i32 2014252890) #11
  %247 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %220, <32 x i32> %244, i32 2014252890) #11
  %248 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %243)
  %249 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %243)
  %250 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %223, <32 x i32> %249, i32 2014252890) #11
  %251 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %224, <32 x i32> %248, i32 2014252890) #11
  %252 = getelementptr inbounds i8, i8* %91, i32 -2
  %253 = bitcast i8* %252 to <32 x i32>*
  %254 = load <32 x i32>, <32 x i32>* %253, align 1, !tbaa !96
  %255 = getelementptr inbounds i8, i8* %96, i32 -2
  %256 = bitcast i8* %255 to <32 x i32>*
  %257 = load <32 x i32>, <32 x i32>* %256, align 1, !tbaa !96
  %258 = getelementptr inbounds i8, i8* %50, i32 -2
  %259 = bitcast i8* %258 to <32 x i32>*
  %260 = load <32 x i32>, <32 x i32>* %259, align 1, !tbaa !96
  %261 = getelementptr inbounds i8, i8* %55, i32 -1
  %262 = bitcast i8* %261 to <32 x i32>*
  %263 = load <32 x i32>, <32 x i32>* %262, align 1, !tbaa !96
  %264 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %260, <32 x i32> %254, i32 -1)
  %265 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %263, <32 x i32> %257, i32 -1)
  %266 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %264)
  %267 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %264)
  %268 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %265)
  %269 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %265)
  %270 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %269, <32 x i32> %267, i32 -1)
  %271 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %268, <32 x i32> %266, i32 -1)
  %272 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %270)
  %273 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %270)
  %274 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %246, <32 x i32> %273, i32 1510344228) #11
  %275 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %247, <32 x i32> %272, i32 1510344228) #11
  %276 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %271)
  %277 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %271)
  %278 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %250, <32 x i32> %277, i32 1510344228) #11
  %279 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %251, <32 x i32> %276, i32 1510344228) #11
  %280 = getelementptr inbounds i8, i8* %55, i32 -2
  %281 = bitcast i8* %280 to <32 x i32>*
  %282 = load <32 x i32>, <32 x i32>* %281, align 1, !tbaa !96
  %283 = getelementptr inbounds i8, i8* %60, i32 -2
  %284 = bitcast i8* %283 to <32 x i32>*
  %285 = load <32 x i32>, <32 x i32>* %284, align 1, !tbaa !96
  %286 = getelementptr inbounds i8, i8* %64, i32 -2
  %287 = bitcast i8* %286 to <32 x i32>*
  %288 = load <32 x i32>, <32 x i32>* %287, align 1, !tbaa !96
  %289 = getelementptr inbounds i8, i8* %32, i32 -2
  %290 = bitcast i8* %289 to <32 x i32>*
  %291 = load <32 x i32>, <32 x i32>* %290, align 1, !tbaa !96
  %292 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %288, <32 x i32> %282, i32 -1)
  %293 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %291, <32 x i32> %285, i32 -1)
  %294 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %292)
  %295 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %292)
  %296 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %293)
  %297 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %293)
  %298 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %297, <32 x i32> %295, i32 -1)
  %299 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %296, <32 x i32> %294, i32 -1)
  %300 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %298)
  %301 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %298)
  %302 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %274, <32 x i32> %301, i32 1517836836) #11
  %303 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %275, <32 x i32> %300, i32 1517836836) #11
  %304 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %299)
  %305 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %299)
  %306 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %278, <32 x i32> %305, i32 1517836836) #11
  %307 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %279, <32 x i32> %304, i32 1517836836) #11
  %308 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %303, <32 x i32> %302)
  %309 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %307, <32 x i32> %306)
  %e.i11 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %308) #11
  %o.i12 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %308) #11
  %r.i13 = tail call <64 x i32> @llvm.hexagon.V6.vdealvdd.128B(<32 x i32> %o.i12, <32 x i32> %e.i11, i32 -4) #11
  %e.i14 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %309) #11
  %o.i15 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %309) #11
  %r.i16 = tail call <64 x i32> @llvm.hexagon.V6.vdealvdd.128B(<32 x i32> %o.i15, <32 x i32> %e.i14, i32 -4) #11
  %310 = getelementptr inbounds i8, i8* %64, i32 -1
  ...
  %316 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %r.i13, <32 x i32> %315, i32 19661100) #11
  %317 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %r.i16, <32 x i32> %314, i32 19661100) #11
  %318 = getelementptr inbounds i8, i8* %60, i32 -1
  %319 = bitcast i8* %318 to <32 x i32>*
  %320 = load <32 x i32>, <32 x i32>* %319, align 1, !tbaa !96
  %321 = tail call <64 x i32> @llvm.hexagon.V6.vmpyub.128B(<32 x i32> %320, i32 %dup4.i.i) #11
  %e.i18 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %321) #11
  %o.i19 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %321) #11
  %r_32.i20 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i19, <32 x i32> %e.i18, i32 -2) #11
  %322 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r_32.i20)
  %323 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r_32.i20)
  %324 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %323) #11
  %325 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %322) #11
  %326 = add <64 x i32> %316, %47
  %327 = add <64 x i32> %326, %324
  %328 = add <64 x i32> %317, %48
  %329 = add <64 x i32> %328, %325
  %330 = bitcast i8* %32 to <32 x i32>*
  %331 = load <32 x i32>, <32 x i32>* %330, align 1, !tbaa !96
  %332 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %331) #11
  %333 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %332)
  %334 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %332)
  %335 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %327, <32 x i32> %334, i32 19661100) #11
  %336 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %329, <32 x i32> %333, i32 19661100) #11
  %337 = bitcast i8* %64 to <32 x i32>*
  %338 = load <32 x i32>, <32 x i32>* %337, align 1, !tbaa !96
  %339 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %338) #11
  %340 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %339)
  %341 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %339)
  %342 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %335, <32 x i32> %341, i32 26214800) #11
  %343 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %336, <32 x i32> %340, i32 26214800) #11
  %344 = bitcast i8* %60 to <32 x i32>*
  %345 = load <32 x i32>, <32 x i32>* %344, align 1, !tbaa !96
  %346 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %345) #11
  %347 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %346)
  %348 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %346)
  %349 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %342, <32 x i32> %348, i32 19661100) #11
  %350 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %343, <32 x i32> %347, i32 19661100) #11
  %351 = getelementptr inbounds i8, i8* %64, i32 1
  %352 = bitcast i8* %351 to <32 x i32>*
  %353 = load <32 x i32>, <32 x i32>* %352, align 1, !tbaa !96
  %354 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %353) #11
  %355 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %354)
  %356 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %354)
  %357 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %349, <32 x i32> %356, i32 19661100) #11
  %358 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %350, <32 x i32> %355, i32 19661100) #11
  %359 = getelementptr inbounds i8, i8* %60, i32 1
  %360 = bitcast i8* %359 to <32 x i32>*
  %361 = load <32 x i32>, <32 x i32>* %360, align 1, !tbaa !96
  %362 = tail call <64 x i32> @llvm.hexagon.V6.vmpyub.128B(<32 x i32> %361, i32 %dup4.i.i) #11
  %e.i23 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %362) #11
  %o.i24 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %362) #11
  %r_32.i25 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i24, <32 x i32> %e.i23, i32 -2) #11
  %363 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r_32.i25)
  %364 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r_32.i25)
  %365 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %364) #11
  %366 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %363) #11
  %367 = add <64 x i32> %357, %39
  %368 = add <64 x i32> %367, %365
  %369 = add <64 x i32> %358, %40
  %370 = add <64 x i32> %369, %366
  %e.i27 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %368) #11
  %o.i28 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %368) #11
  %r.i29 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i28, <32 x i32> %e.i27, i32 -4) #11
  %e.i30 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %370) #11
  %o.i31 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %370) #11
  %r.i32 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i31, <32 x i32> %e.i30, i32 -4) #11
  %371 = getelementptr inbounds i8, i8* %32, i32 3
  %372 = bitcast i8* %371 to <32 x i32>*
  %373 = load <32 x i32>, <32 x i32>* %372, align 1, !tbaa !96
  %374 = getelementptr inbounds i8, i8* %91, i32 3
  %375 = bitcast i8* %374 to <32 x i32>*
  %376 = load <32 x i32>, <32 x i32>* %375, align 1, !tbaa !96
  %377 = getelementptr inbounds i8, i8* %96, i32 3
  %378 = bitcast i8* %377 to <32 x i32>*
  %379 = load <32 x i32>, <32 x i32>* %378, align 1, !tbaa !96
  %380 = getelementptr inbounds i8, i8* %50, i32 3
  %381 = bitcast i8* %380 to <32 x i32>*
  %382 = load <32 x i32>, <32 x i32>* %381, align 1, !tbaa !96
  %383 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %379, <32 x i32> %373, i32 -1)
  %384 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %382, <32 x i32> %376, i32 -1)
  %385 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %383)
  %386 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %383)
  %387 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %384)
  %388 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %384)
  %389 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %388, <32 x i32> %386, i32 -1)
  %390 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %387, <32 x i32> %385, i32 -1)
  %391 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r.i29)
  %392 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %389)
  %393 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %389)
  %394 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %391, <32 x i32> %393, i32 16844303) #11
  %395 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r.i29)
  %396 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %395, <32 x i32> %392, i32 16844303) #11
  %397 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r.i32)
  %398 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %390)
  %399 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %390)
  %400 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %397, <32 x i32> %399, i32 16844303) #11
  %401 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r.i32)
  %402 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %401, <32 x i32> %398, i32 16844303) #11
  %403 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %396, <32 x i32> %394)
  %404 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %402, <32 x i32> %400)
  %e.i33 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %403) #11
  %o.i34 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %403) #11
  %r.i35 = tail call <64 x i32> @llvm.hexagon.V6.vdealvdd.128B(<32 x i32> %o.i34, <32 x i32> %e.i33, i32 -4) #11
  %e.i36 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %404) #11
  %o.i37 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %404) #11
  %r.i38 = tail call <64 x i32> @llvm.hexagon.V6.vdealvdd.128B(<32 x i32> %o.i37, <32 x i32> %e.i36, i32 -4) #11
  %405 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r.i35) #11
  %406 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r.i35) #11
  %407 = tail call <32 x i32> @llvm.hexagon.V6.vasrwhsat.128B(<32 x i32> %406, <32 x i32> %405, i32 12) #11
  %408 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r.i38) #11
  %409 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r.i38) #11
  %410 = tail call <32 x i32> @llvm.hexagon.V6.vasrwhsat.128B(<32 x i32> %409, <32 x i32> %408, i32 12) #11
  %411 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %410, <32 x i32> %407)
  ...
  %415 = add nsw i32 %30, %29
  %416 = getelementptr inbounds i8, i8* %output, i32 %415
  %417 = bitcast i8* %416 to <32 x i32>*
  store <32 x i32> %414, <32 x i32>* %417, align 1, !tbaa !99
  %418 = add nuw nsw i32 %output.s0.x.x, 1
  %.not5 = icmp eq i32 %418, %t46
...
"for output.s0.x.x1.preheader":                   ; preds = %"end for output.s0.x.x"
  %419 = add i32 %28, %output.extent.0
  %t58 = add i32 %419, %t42
  %t57 = add i32 %419, %t43
  %t56 = add i32 %419, %t44
  %t59 = add i32 %419, %t45
  %t26 = add i32 %419, %input.stride.1
  %t28 = sub i32 %419, %input.stride.1
  %420 = getelementptr inbounds i8, i8* %input, i32 %t28
  %421 = getelementptr inbounds i8, i8* %420, i32 -127
  %422 = bitcast i8* %421 to <32 x i32>*
  %423 = load <32 x i32>, <32 x i32>* %422, align 1, !tbaa !96
  %dup4.i.i39 = tail call i32 @llvm.hexagon.S2.vsplatrb(i32 225) #11
  %424 = tail call <64 x i32> @llvm.hexagon.V6.vmpyub.128B(<32 x i32> %423, i32 %dup4.i.i39) #11
  %e.i40 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %424) #11
  %o.i41 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %424) #11
  %r_32.i42 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i41, <32 x i32> %e.i40, i32 -2) #11
  %425 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r_32.i42)
  %426 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r_32.i42)
  %427 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %426) #11
  %428 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %425) #11
  %429 = getelementptr inbounds i8, i8* %420, i32 -129
  %430 = bitcast i8* %429 to <32 x i32>*
  %431 = load <32 x i32>, <32 x i32>* %430, align 1, !tbaa !96
  %432 = tail call <64 x i32> @llvm.hexagon.V6.vmpyub.128B(<32 x i32> %431, i32 %dup4.i.i39) #11
  %e.i45 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %432) #11
  %o.i46 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %432) #11
  %r_32.i47 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i46, <32 x i32> %e.i45, i32 -2) #11
  %433 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r_32.i47)
  %434 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r_32.i47)
  %435 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %434) #11
  %436 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %433) #11
  %437 = getelementptr inbounds i8, i8* %input, i32 %t59
  %438 = getelementptr inbounds i8, i8* %437, i32 -131
  %439 = bitcast i8* %438 to <32 x i32>*
  %440 = load <32 x i32>, <32 x i32>* %439, align 1, !tbaa !96
  %441 = getelementptr inbounds i8, i8* %input, i32 %t56
  %442 = getelementptr inbounds i8, i8* %441, i32 -125
  %443 = bitcast i8* %442 to <32 x i32>*
  %444 = load <32 x i32>, <32 x i32>* %443, align 1, !tbaa !96
  %445 = getelementptr inbounds i8, i8* %input, i32 %t26
  %446 = getelementptr inbounds i8, i8* %445, i32 -125
  %447 = bitcast i8* %446 to <32 x i32>*
  %448 = load <32 x i32>, <32 x i32>* %447, align 1, !tbaa !96
  %449 = getelementptr inbounds i8, i8* %input, i32 %419
  %450 = getelementptr inbounds i8, i8* %449, i32 -125
  %451 = bitcast i8* %450 to <32 x i32>*
  %452 = load <32 x i32>, <32 x i32>* %451, align 1, !tbaa !96
  %453 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %448, <32 x i32> %440, i32 -1)
  %454 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %452, <32 x i32> %444, i32 -1)
  %455 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %453)
  %456 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %453)
  %457 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %454)
  %458 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %454)
  %459 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %458, <32 x i32> %456, i32 -1)
  %460 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %457, <32 x i32> %455, i32 -1)
  %461 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %459)
  %462 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %459)
  %463 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.128B(<32 x i32> %462, i32 336528897) #11
  %464 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.128B(<32 x i32> %461, i32 336528897) #11
  %465 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %460)
  %466 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %460)
  %467 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.128B(<32 x i32> %466, i32 336528897) #11
  %468 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.128B(<32 x i32> %465, i32 336528897) #11
  %469 = getelementptr inbounds i8, i8* %449, i32 -131
  %470 = bitcast i8* %469 to <32 x i32>*
  %471 = load <32 x i32>, <32 x i32>* %470, align 1, !tbaa !96
  %472 = getelementptr inbounds i8, i8* %420, i32 -131
  %473 = bitcast i8* %472 to <32 x i32>*
  %474 = load <32 x i32>, <32 x i32>* %473, align 1, !tbaa !96
  %475 = getelementptr inbounds i8, i8* %input, i32 %t57
  %476 = getelementptr inbounds i8, i8* %475, i32 -131
  %477 = bitcast i8* %476 to <32 x i32>*
  %478 = load <32 x i32>, <32 x i32>* %477, align 1, !tbaa !96
  %479 = getelementptr inbounds i8, i8* %input, i32 %t58
  %480 = getelementptr inbounds i8, i8* %479, i32 -131
  %481 = bitcast i8* %480 to <32 x i32>*
  %482 = load <32 x i32>, <32 x i32>* %481, align 1, !tbaa !96
  %483 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %478, <32 x i32> %471, i32 -1)
  %484 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %482, <32 x i32> %474, i32 -1)
  %485 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %483)
  %486 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %483)
  %487 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %484)
  %488 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %484)
  %489 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %488, <32 x i32> %486, i32 -1)
  %490 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %487, <32 x i32> %485, i32 -1)
  %491 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %489)
  %492 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %489)
  %493 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %463, <32 x i32> %492, i32 17174292) #11
  %494 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %464, <32 x i32> %491, i32 17174292) #11
  %495 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %490)
  %496 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %490)
  %497 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %467, <32 x i32> %496, i32 17174292) #11
  %498 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %468, <32 x i32> %495, i32 17174292) #11
  %499 = getelementptr inbounds i8, i8* %479, i32 -127
  %500 = bitcast i8* %499 to <32 x i32>*
  %501 = load <32 x i32>, <32 x i32>* %500, align 1, !tbaa !96
  %502 = getelementptr inbounds i8, i8* %437, i32 -127
  %503 = bitcast i8* %502 to <32 x i32>*
  %504 = load <32 x i32>, <32 x i32>* %503, align 1, !tbaa !96
  %505 = getelementptr inbounds i8, i8* %441, i32 -131
  %506 = bitcast i8* %505 to <32 x i32>*
  %507 = load <32 x i32>, <32 x i32>* %506, align 1, !tbaa !96
  %508 = getelementptr inbounds i8, i8* %445, i32 -131
  %509 = bitcast i8* %508 to <32 x i32>*
  %510 = load <32 x i32>, <32 x i32>* %509, align 1, !tbaa !96
  %511 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %507, <32 x i32> %501, i32 -1)
  %512 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %510, <32 x i32> %504, i32 -1)
  %513 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %511)
  %514 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %511)
  %515 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %512)
  %516 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %512)
  %517 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %516, <32 x i32> %514, i32 -1)
  %518 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %515, <32 x i32> %513, i32 -1)
  %519 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %517)
  %520 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %517)
  %521 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %493, <32 x i32> %520, i32 252055311) #11
  %522 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %494, <32 x i32> %519, i32 252055311) #11
  %523 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %518)
  %524 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %518)
  %525 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %497, <32 x i32> %524, i32 252055311) #11
  %526 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %498, <32 x i32> %523, i32 252055311) #11
  %527 = getelementptr inbounds i8, i8* %479, i32 -126
  %528 = bitcast i8* %527 to <32 x i32>*
  %529 = load <32 x i32>, <32 x i32>* %528, align 1, !tbaa !96
  %530 = getelementptr inbounds i8, i8* %437, i32 -126
  %531 = bitcast i8* %530 to <32 x i32>*
  %532 = load <32 x i32>, <32 x i32>* %531, align 1, !tbaa !96
  %533 = getelementptr inbounds i8, i8* %441, i32 -127
  %534 = bitcast i8* %533 to <32 x i32>*
  %535 = load <32 x i32>, <32 x i32>* %534, align 1, !tbaa !96
  %536 = getelementptr inbounds i8, i8* %475, i32 -127
  %537 = bitcast i8* %536 to <32 x i32>*
  %538 = load <32 x i32>, <32 x i32>* %537, align 1, !tbaa !96
  %539 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %535, <32 x i32> %529, i32 -1)
  %540 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %538, <32 x i32> %532, i32 -1)
  %541 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %539)
  %542 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %539)
  %543 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %540)
  %544 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %540)
  %545 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %544, <32 x i32> %542, i32 -1)
  %546 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %543, <32 x i32> %541, i32 -1)
  %547 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %545)
  %548 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %545)
  %549 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %521, <32 x i32> %548, i32 1515849222) #11
  %550 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %522, <32 x i32> %547, i32 1515849222) #11
  %551 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %546)
  %552 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %546)
  %553 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %525, <32 x i32> %552, i32 1515849222) #11
  %554 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %526, <32 x i32> %551, i32 1515849222) #11
  %555 = getelementptr inbounds i8, i8* %445, i32 -126
  %556 = bitcast i8* %555 to <32 x i32>*
  %557 = load <32 x i32>, <32 x i32>* %556, align 1, !tbaa !96
  %558 = getelementptr inbounds i8, i8* %449, i32 -126
  %559 = bitcast i8* %558 to <32 x i32>*
  %560 = load <32 x i32>, <32 x i32>* %559, align 1, !tbaa !96
  %561 = getelementptr inbounds i8, i8* %420, i32 -126
  %562 = bitcast i8* %561 to <32 x i32>*
  %563 = load <32 x i32>, <32 x i32>* %562, align 1, !tbaa !96
  %564 = getelementptr inbounds i8, i8* %475, i32 -126
  %565 = bitcast i8* %564 to <32 x i32>*
  %566 = load <32 x i32>, <32 x i32>* %565, align 1, !tbaa !96
  %567 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %563, <32 x i32> %557, i32 -1)
  %568 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %566, <32 x i32> %560, i32 -1)
  %569 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %567)
  %570 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %567)
  %571 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %568)
  %572 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %568)
  %573 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %572, <32 x i32> %570, i32 -1)
  %574 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %571, <32 x i32> %569, i32 -1)
  %575 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %573)
  %576 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %573)
  %577 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %549, <32 x i32> %576, i32 609908826) #11
  %578 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %550, <32 x i32> %575, i32 609908826) #11
  %579 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %574)
  %580 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %574)
  %581 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %553, <32 x i32> %580, i32 609908826) #11
  %582 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %554, <32 x i32> %579, i32 609908826) #11
  %583 = getelementptr inbounds i8, i8* %475, i32 -128
  %584 = bitcast i8* %583 to <32 x i32>*
  %585 = load <32 x i32>, <32 x i32>* %584, align 1, !tbaa !96
  %586 = getelementptr inbounds i8, i8* %479, i32 -128
  %587 = bitcast i8* %586 to <32 x i32>*
  %588 = load <32 x i32>, <32 x i32>* %587, align 1, !tbaa !96
  %589 = getelementptr inbounds i8, i8* %437, i32 -128
  %590 = bitcast i8* %589 to <32 x i32>*
  %591 = load <32 x i32>, <32 x i32>* %590, align 1, !tbaa !96
  %592 = getelementptr inbounds i8, i8* %441, i32 -126
  %593 = bitcast i8* %592 to <32 x i32>*
  %594 = load <32 x i32>, <32 x i32>* %593, align 1, !tbaa !96
  %595 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %591, <32 x i32> %585, i32 -1)
  %596 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %594, <32 x i32> %588, i32 -1)
  %597 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %595)
  %598 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %595)
  %599 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %596)
  %600 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %596)
  %601 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %600, <32 x i32> %598, i32 -1)
  %602 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %599, <32 x i32> %597, i32 -1)
  %603 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %601)
  %604 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %601)
  %605 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %577, <32 x i32> %604, i32 605295736) #11
  %606 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %578, <32 x i32> %603, i32 605295736) #11
  %607 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %602)
  %608 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %602)
  %609 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %581, <32 x i32> %608, i32 605295736) #11
  %610 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %582, <32 x i32> %607, i32 605295736) #11
  %611 = getelementptr inbounds i8, i8* %475, i32 -129
  %612 = bitcast i8* %611 to <32 x i32>*
  %613 = load <32 x i32>, <32 x i32>* %612, align 1, !tbaa !96
  %614 = getelementptr inbounds i8, i8* %479, i32 -129
  %615 = bitcast i8* %614 to <32 x i32>*
  %616 = load <32 x i32>, <32 x i32>* %615, align 1, !tbaa !96
  %617 = getelementptr inbounds i8, i8* %437, i32 -129
  %618 = bitcast i8* %617 to <32 x i32>*
  %619 = load <32 x i32>, <32 x i32>* %618, align 1, !tbaa !96
  %620 = getelementptr inbounds i8, i8* %441, i32 -128
  %621 = bitcast i8* %620 to <32 x i32>*
  %622 = load <32 x i32>, <32 x i32>* %621, align 1, !tbaa !96
  %623 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %619, <32 x i32> %613, i32 -1)
  %624 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %622, <32 x i32> %616, i32 -1)
  %625 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %623)
  %626 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %623)
  %627 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %624)
  %628 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %624)
  %629 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %628, <32 x i32> %626, i32 -1)
  %630 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %627, <32 x i32> %625, i32 -1)
  %631 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %629)
  %632 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %629)
  %633 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %605, <32 x i32> %632, i32 2014252890) #11
  %634 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %606, <32 x i32> %631, i32 2014252890) #11
  %635 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %630)
  %636 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %630)
  %637 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %609, <32 x i32> %636, i32 2014252890) #11
  %638 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %610, <32 x i32> %635, i32 2014252890) #11
  %639 = getelementptr inbounds i8, i8* %475, i32 -130
  %640 = bitcast i8* %639 to <32 x i32>*
  %641 = load <32 x i32>, <32 x i32>* %640, align 1, !tbaa !96
  %642 = getelementptr inbounds i8, i8* %479, i32 -130
  %643 = bitcast i8* %642 to <32 x i32>*
  %644 = load <32 x i32>, <32 x i32>* %643, align 1, !tbaa !96
  %645 = getelementptr inbounds i8, i8* %437, i32 -130
  %646 = bitcast i8* %645 to <32 x i32>*
  %647 = load <32 x i32>, <32 x i32>* %646, align 1, !tbaa !96
  %648 = getelementptr inbounds i8, i8* %441, i32 -129
  %649 = bitcast i8* %648 to <32 x i32>*
  %650 = load <32 x i32>, <32 x i32>* %649, align 1, !tbaa !96
  %651 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %647, <32 x i32> %641, i32 -1)
  %652 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %650, <32 x i32> %644, i32 -1)
  %653 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %651)
  %654 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %651)
  %655 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %652)
  %656 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %652)
  %657 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %656, <32 x i32> %654, i32 -1)
  %658 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %655, <32 x i32> %653, i32 -1)
  %659 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %657)
  %660 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %657)
  %661 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %633, <32 x i32> %660, i32 1510344228) #11
  %662 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %634, <32 x i32> %659, i32 1510344228) #11
  %663 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %658)
  %664 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %658)
  %665 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %637, <32 x i32> %664, i32 1510344228) #11
  %666 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %638, <32 x i32> %663, i32 1510344228) #11
  %667 = getelementptr inbounds i8, i8* %441, i32 -130
  %668 = bitcast i8* %667 to <32 x i32>*
  %669 = load <32 x i32>, <32 x i32>* %668, align 1, !tbaa !96
  %670 = getelementptr inbounds i8, i8* %445, i32 -130
  %671 = bitcast i8* %670 to <32 x i32>*
  %672 = load <32 x i32>, <32 x i32>* %671, align 1, !tbaa !96
  %673 = getelementptr inbounds i8, i8* %449, i32 -130
  %674 = bitcast i8* %673 to <32 x i32>*
  %675 = load <32 x i32>, <32 x i32>* %674, align 1, !tbaa !96
  %676 = getelementptr inbounds i8, i8* %420, i32 -130
  %677 = bitcast i8* %676 to <32 x i32>*
  %678 = load <32 x i32>, <32 x i32>* %677, align 1, !tbaa !96
  %679 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %675, <32 x i32> %669, i32 -1)
  %680 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %678, <32 x i32> %672, i32 -1)
  %681 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %679)
  %682 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %679)
  %683 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %680)
  %684 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %680)
  %685 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %684, <32 x i32> %682, i32 -1)
  %686 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %683, <32 x i32> %681, i32 -1)
  %687 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %685)
  %688 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %685)
  %689 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %661, <32 x i32> %688, i32 1517836836) #11
  %690 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %662, <32 x i32> %687, i32 1517836836) #11
  %691 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %686)
  %692 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %686)
  %693 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %665, <32 x i32> %692, i32 1517836836) #11
  %694 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %666, <32 x i32> %691, i32 1517836836) #11
  %695 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %690, <32 x i32> %689)
  %696 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %694, <32 x i32> %693)
  %e.i49 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %695) #11
  %o.i50 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %695) #11
  %r.i51 = tail call <64 x i32> @llvm.hexagon.V6.vdealvdd.128B(<32 x i32> %o.i50, <32 x i32> %e.i49, i32 -4) #11
  %e.i52 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %696) #11
  %o.i53 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %696) #11
  %r.i54 = tail call <64 x i32> @llvm.hexagon.V6.vdealvdd.128B(<32 x i32> %o.i53, <32 x i32> %e.i52, i32 -4) #11
  %697 = getelementptr inbounds i8, i8* %449, i32 -129
  %698 = bitcast i8* %697 to <32 x i32>*
  %699 = load <32 x i32>, <32 x i32>* %698, align 1, !tbaa !96
  %700 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %699) #11
  %701 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %700)
  %702 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %700)
  %703 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %r.i51, <32 x i32> %702, i32 19661100) #11
  %704 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %r.i54, <32 x i32> %701, i32 19661100) #11
  %705 = getelementptr inbounds i8, i8* %445, i32 -129
  %706 = bitcast i8* %705 to <32 x i32>*
  %707 = load <32 x i32>, <32 x i32>* %706, align 1, !tbaa !96
  %708 = tail call <64 x i32> @llvm.hexagon.V6.vmpyub.128B(<32 x i32> %707, i32 %dup4.i.i39) #11
  %e.i56 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %708) #11
  %o.i57 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %708) #11
  %r_32.i58 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i57, <32 x i32> %e.i56, i32 -2) #11
  %709 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r_32.i58)
  %710 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r_32.i58)
  %711 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %710) #11
  %712 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %709) #11
  %713 = add <64 x i32> %703, %435
  %714 = add <64 x i32> %713, %711
  %715 = add <64 x i32> %704, %436
  %716 = add <64 x i32> %715, %712
  %717 = getelementptr inbounds i8, i8* %420, i32 -128
  %718 = bitcast i8* %717 to <32 x i32>*
  %719 = load <32 x i32>, <32 x i32>* %718, align 1, !tbaa !96
  %720 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %719) #11
  %721 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %720)
  %722 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %720)
  %723 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %714, <32 x i32> %722, i32 19661100) #11
  %724 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %716, <32 x i32> %721, i32 19661100) #11
  %725 = getelementptr inbounds i8, i8* %449, i32 -128
  %726 = bitcast i8* %725 to <32 x i32>*
  %727 = load <32 x i32>, <32 x i32>* %726, align 1, !tbaa !96
  %728 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %727) #11
  %729 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %728)
  %730 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %728)
  %731 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %723, <32 x i32> %730, i32 26214800) #11
  %732 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %724, <32 x i32> %729, i32 26214800) #11
  %733 = getelementptr inbounds i8, i8* %445, i32 -128
  %734 = bitcast i8* %733 to <32 x i32>*
  %735 = load <32 x i32>, <32 x i32>* %734, align 1, !tbaa !96
  %736 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %735) #11
  %737 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %736)
  %738 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %736)
  %739 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %731, <32 x i32> %738, i32 19661100) #11
  %740 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %732, <32 x i32> %737, i32 19661100) #11
  %741 = getelementptr inbounds i8, i8* %449, i32 -127
  %742 = bitcast i8* %741 to <32 x i32>*
  %743 = load <32 x i32>, <32 x i32>* %742, align 1, !tbaa !96
  %744 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %743) #11
  %745 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %744)
  %746 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %744)
  %747 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %739, <32 x i32> %746, i32 19661100) #11
  %748 = tail call <64 x i32> @llvm.hexagon.V6.vmpyhsat.acc.128B(<64 x i32> %740, <32 x i32> %745, i32 19661100) #11
  %749 = getelementptr inbounds i8, i8* %445, i32 -127
  %750 = bitcast i8* %749 to <32 x i32>*
  %751 = load <32 x i32>, <32 x i32>* %750, align 1, !tbaa !96
  %752 = tail call <64 x i32> @llvm.hexagon.V6.vmpyub.128B(<32 x i32> %751, i32 %dup4.i.i39) #11
  %e.i61 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %752) #11
  %o.i62 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %752) #11
  %r_32.i63 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i62, <32 x i32> %e.i61, i32 -2) #11
  %753 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r_32.i63)
  %754 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r_32.i63)
  %755 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %754) #11
  %756 = tail call <64 x i32> @llvm.hexagon.V6.vzh.128B(<32 x i32> %753) #11
  %757 = add <64 x i32> %747, %427
  %758 = add <64 x i32> %757, %755
  %759 = add <64 x i32> %748, %428
  %760 = add <64 x i32> %759, %756
  %e.i65 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %758) #11
  %o.i66 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %758) #11
  %r.i67 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i66, <32 x i32> %e.i65, i32 -4) #11
  %e.i68 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %760) #11
  %o.i69 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %760) #11
  %r.i70 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %o.i69, <32 x i32> %e.i68, i32 -4) #11
  %761 = getelementptr inbounds i8, i8* %420, i32 -125
  %762 = bitcast i8* %761 to <32 x i32>*
  %763 = load <32 x i32>, <32 x i32>* %762, align 1, !tbaa !96
  %764 = getelementptr inbounds i8, i8* %475, i32 -125
  %765 = bitcast i8* %764 to <32 x i32>*
  %766 = load <32 x i32>, <32 x i32>* %765, align 1, !tbaa !96
  %767 = getelementptr inbounds i8, i8* %479, i32 -125
  %768 = bitcast i8* %767 to <32 x i32>*
  %769 = load <32 x i32>, <32 x i32>* %768, align 1, !tbaa !96
  %770 = getelementptr inbounds i8, i8* %437, i32 -125
  %771 = bitcast i8* %770 to <32 x i32>*
  %772 = load <32 x i32>, <32 x i32>* %771, align 1, !tbaa !96
  %773 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %769, <32 x i32> %763, i32 -1)
  %774 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %772, <32 x i32> %766, i32 -1)
  %775 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %773)
  %776 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %773)
  %777 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %774)
  %778 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %774)
  %779 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %778, <32 x i32> %776, i32 -1)
  %780 = tail call <64 x i32> @llvm.hexagon.V6.vshuffvdd.128B(<32 x i32> %777, <32 x i32> %775, i32 -1)
  %781 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r.i67)
  %782 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %779)
  %783 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %779)
  %784 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %781, <32 x i32> %783, i32 16844303) #11
  %785 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r.i67)
  %786 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %785, <32 x i32> %782, i32 16844303) #11
  %787 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r.i70)
  %788 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %780)
  %789 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %780)
  %790 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %787, <32 x i32> %789, i32 16844303) #11
  %791 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r.i70)
  %792 = tail call <32 x i32> @llvm.hexagon.V6.vrmpybus.acc.128B(<32 x i32> %791, <32 x i32> %788, i32 16844303) #11
  %793 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %786, <32 x i32> %784)
  %794 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %792, <32 x i32> %790)
  %e.i71 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %793) #11
  %o.i72 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %793) #11
  %r.i73 = tail call <64 x i32> @llvm.hexagon.V6.vdealvdd.128B(<32 x i32> %o.i72, <32 x i32> %e.i71, i32 -4) #11
  %e.i74 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %794) #11
  %o.i75 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %794) #11
  %r.i76 = tail call <64 x i32> @llvm.hexagon.V6.vdealvdd.128B(<32 x i32> %o.i75, <32 x i32> %e.i74, i32 -4) #11
  %795 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r.i73) #11
  %796 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r.i73) #11
  %797 = tail call <32 x i32> @llvm.hexagon.V6.vasrwhsat.128B(<32 x i32> %796, <32 x i32> %795, i32 12) #11
  %798 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %r.i76) #11
  %799 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %r.i76) #11
  %800 = tail call <32 x i32> @llvm.hexagon.V6.vasrwhsat.128B(<32 x i32> %799, <32 x i32> %798, i32 12) #11
  %801 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %800, <32 x i32> %797)
  %802 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %801) #11
  %803 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %801) #11
  %804 = tail call <32 x i32> @llvm.hexagon.V6.vpackhub.sat.128B(<32 x i32> %802, <32 x i32> %803) #11
  %805 = mul nsw i32 %27, %output.stride.1
  %806 = add nsw i32 %805, %output.extent.0
  %807 = getelementptr inbounds i8, i8* %26, i32 %806
  %808 = bitcast i8* %807 to <32 x i32>*
  store <32 x i32> %804, <32 x i32>* %808, align 1, !tbaa !99
  br label %"end for output.s0.x.x2"

"end for output.s0.x.x2":                         ; preds = %"for output.s0.x.x1.preheader", %"end for output.s0.x.x"
  %809 = add nuw nsw i32 %output.s0.y.v1, 1
  %.not = icmp eq i32 %809, 16
...
entry:
  ...
  %call4.i = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @gaussian7x7_hvx128_par_for_output_s0_y_y, i32 0, i32 %29, i8* nonnull %30) #13
  ret i32 0
}
...
entry:
  ...
  %6 = tail call i32 @gaussian7x7_hvx128(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #15
  ret i32 0
}
