...
"for output.s0.y.y.y":                            ; preds = %entry, %call_destructor.exit41
  %output.s0.y.y.y = phi i32 [ 0, %entry ], [ %1035, %call_destructor.exit41 ]
...
"for output.s0.x.x":                              ; preds = %"for output.s0.x.x.preheader", %"for output.s0.x.x"
  %output.s0.x.x = phi i32 [ %1034, %"for output.s0.x.x" ], [ 0, %"for output.s0.x.x.preheader" ]
  ...
  %791 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %781) #12
  %792 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %791, i32 33686018) #12
  ...
  %796 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t187.s23) #12
  %797 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t186.s22) #12
  %798 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %778) #12
  %799 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %798, i32 33686018) #12
  %800 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %797, <64 x i32> %799) #12
  %801 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %796, <64 x i32> %800) #12
  ...
  %808 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %788) #12
  %809 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %808, i32 33686018) #12
  %810 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %796, <64 x i32> %809) #12
  %811 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %789, <64 x i32> %810) #12
  %812 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %811) #12
  %813 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %t31926) #12
  %814 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %813, i32 33686018) #12
  %815 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %797, <64 x i32> %814) #12
  %816 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %790, <64 x i32> %815) #12
  %817 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %816) #12
  %818 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %812, <32 x i32> %817) #12
  %819 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %816) #12
  %820 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %811) #12
  %821 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %819, <32 x i32> %820) #12
  %822 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %818, <32 x i32> %821) #12
  %823 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %807, <64 x i32> %822) #12
  %824 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %823) #12
  %825 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %823) #12
  %826 = tail call <32 x i32> @llvm.hexagon.V6.vpackhub.sat.128B(<32 x i32> %824, <32 x i32> %825) #12
  %827 = add nsw i32 %762, %754
  %828 = getelementptr inbounds i8, i8* %output, i32 %827
  %829 = bitcast i8* %828 to <32 x i32>*
  store <32 x i32> %826, <32 x i32>* %829, align 1, !tbaa !104
  %830 = add nsw i32 %58, %output.s0.x.x
  %t185.1 = sub i32 %830, %a11
  %831 = shl nsw i32 %t185.1, 7
  %832 = getelementptr inbounds i8, i8* %bounded_input, i32 %831
  %833 = bitcast i8* %832 to <32 x i32>*
  %t186.s22.1 = load <32 x i32>, <32 x i32>* %833, align 128, !tbaa !99
  %834 = getelementptr inbounds i8, i8* %832, i32 2
  %835 = bitcast i8* %834 to <32 x i32>*
  %t187.s23.1 = load <32 x i32>, <32 x i32>* %835, align 2, !tbaa !99
  %t188.1 = add i32 %830, %a11
  %836 = shl nsw i32 %t188.1, 7
  %837 = getelementptr inbounds i8, i8* %bounded_input, i32 %836
  %838 = bitcast i8* %837 to <32 x i32>*
  %t189.s24.1 = load <32 x i32>, <32 x i32>* %838, align 128, !tbaa !99
  %839 = getelementptr inbounds i8, i8* %837, i32 2
  %840 = bitcast i8* %839 to <32 x i32>*
  %t190.s25.1 = load <32 x i32>, <32 x i32>* %840, align 2, !tbaa !99
  %841 = shl nsw i32 %830, 7
  %842 = getelementptr inbounds i8, i8* %bounded_input, i32 %841
  %843 = bitcast i8* %842 to <32 x i32>*
  %t31926.1 = load <32 x i32>, <32 x i32>* %843, align 128, !tbaa !99
  %844 = getelementptr inbounds i8, i8* %832, i32 1
  %845 = bitcast i8* %844 to <32 x i32>*
  %846 = load <32 x i32>, <32 x i32>* %845, align 1, !tbaa !99
  %847 = getelementptr inbounds i8, i8* %837, i32 1
  %848 = bitcast i8* %847 to <32 x i32>*
  %849 = load <32 x i32>, <32 x i32>* %848, align 1, !tbaa !99
  %850 = getelementptr inbounds i8, i8* %842, i32 128
  %851 = bitcast i8* %850 to <32 x i32>*
  %852 = load <32 x i32>, <32 x i32>* %851, align 128, !tbaa !99
  %853 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %t31926.1, <32 x i32> %852) #12
  %854 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %853)
  %855 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %853)
  %856 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %854, <32 x i32> %855, i32 2)
  %857 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t190.s25.1) #12
  %858 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t189.s24.1) #12
  %859 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %849) #12
  %860 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %859, i32 33686018) #12
  %861 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %858, <64 x i32> %860) #12
  %862 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %857, <64 x i32> %861) #12
  %863 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %862) #12
  %864 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t187.s23.1) #12
  %865 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t186.s22.1) #12
  %866 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %846) #12
  %867 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %866, i32 33686018) #12
  %868 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %865, <64 x i32> %867) #12
  %869 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %864, <64 x i32> %868) #12
  %870 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %869) #12
  %871 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %863, <32 x i32> %870) #12
  %872 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %869) #12
  %873 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %862) #12
  %874 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %872, <32 x i32> %873) #12
  %875 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %871, <32 x i32> %874) #12
  %876 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %856) #12
  %877 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %876, i32 33686018) #12
  %878 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %864, <64 x i32> %877) #12
  %879 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %857, <64 x i32> %878) #12
  %880 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %879) #12
  %881 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %t31926.1) #12
  %882 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %881, i32 33686018) #12
  %883 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %865, <64 x i32> %882) #12
  %884 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %858, <64 x i32> %883) #12
  %885 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %884) #12
  %886 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %880, <32 x i32> %885) #12
  %887 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %884) #12
  %888 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %879) #12
  %889 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %887, <32 x i32> %888) #12
  %890 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %886, <32 x i32> %889) #12
  %891 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %875, <64 x i32> %890) #12
  %892 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %891) #12
  %893 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %891) #12
  %894 = tail call <32 x i32> @llvm.hexagon.V6.vpackhub.sat.128B(<32 x i32> %892, <32 x i32> %893) #12
  %895 = add nsw i32 %762, %756
  %896 = getelementptr inbounds i8, i8* %output, i32 %895
  %897 = bitcast i8* %896 to <32 x i32>*
  store <32 x i32> %894, <32 x i32>* %897, align 1, !tbaa !104
  %898 = add nsw i32 %59, %output.s0.x.x
  %t185.2 = sub i32 %898, %a11
  %899 = shl nsw i32 %t185.2, 7
  %900 = getelementptr inbounds i8, i8* %bounded_input, i32 %899
  %901 = bitcast i8* %900 to <32 x i32>*
  %t186.s22.2 = load <32 x i32>, <32 x i32>* %901, align 128, !tbaa !99
  %902 = getelementptr inbounds i8, i8* %900, i32 2
  %903 = bitcast i8* %902 to <32 x i32>*
  %t187.s23.2 = load <32 x i32>, <32 x i32>* %903, align 2, !tbaa !99
  %t188.2 = add i32 %898, %a11
  %904 = shl nsw i32 %t188.2, 7
  %905 = getelementptr inbounds i8, i8* %bounded_input, i32 %904
  %906 = bitcast i8* %905 to <32 x i32>*
  %t189.s24.2 = load <32 x i32>, <32 x i32>* %906, align 128, !tbaa !99
  %907 = getelementptr inbounds i8, i8* %905, i32 2
  %908 = bitcast i8* %907 to <32 x i32>*
  %t190.s25.2 = load <32 x i32>, <32 x i32>* %908, align 2, !tbaa !99
  %909 = shl nsw i32 %898, 7
  %910 = getelementptr inbounds i8, i8* %bounded_input, i32 %909
  %911 = bitcast i8* %910 to <32 x i32>*
  %t31926.2 = load <32 x i32>, <32 x i32>* %911, align 128, !tbaa !99
  %912 = getelementptr inbounds i8, i8* %900, i32 1
  %913 = bitcast i8* %912 to <32 x i32>*
  %914 = load <32 x i32>, <32 x i32>* %913, align 1, !tbaa !99
  %915 = getelementptr inbounds i8, i8* %905, i32 1
  %916 = bitcast i8* %915 to <32 x i32>*
  %917 = load <32 x i32>, <32 x i32>* %916, align 1, !tbaa !99
  %918 = getelementptr inbounds i8, i8* %910, i32 128
  %919 = bitcast i8* %918 to <32 x i32>*
  %920 = load <32 x i32>, <32 x i32>* %919, align 128, !tbaa !99
  %921 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %t31926.2, <32 x i32> %920) #12
  %922 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %921)
  %923 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %921)
  %924 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %922, <32 x i32> %923, i32 2)
  %925 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t190.s25.2) #12
  %926 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t189.s24.2) #12
  %927 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %917) #12
  %928 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %927, i32 33686018) #12
  %929 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %926, <64 x i32> %928) #12
  ...
  %932 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t187.s23.2) #12
  %933 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t186.s22.2) #12
  %934 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %914) #12
  %935 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %934, i32 33686018) #12
  %936 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %933, <64 x i32> %935) #12
  %937 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %932, <64 x i32> %936) #12
  %938 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %937) #12
  %939 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %931, <32 x i32> %938) #12
  %940 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %937) #12
  %941 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %930) #12
  %942 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %940, <32 x i32> %941) #12
  %943 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %939, <32 x i32> %942) #12
  %944 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %924) #12
  %945 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %944, i32 33686018) #12
  %946 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %932, <64 x i32> %945) #12
  %947 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %925, <64 x i32> %946) #12
  %948 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %947) #12
  %949 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %t31926.2) #12
  %950 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %949, i32 33686018) #12
  %951 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %933, <64 x i32> %950) #12
  %952 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %926, <64 x i32> %951) #12
  %953 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %952) #12
  %954 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %948, <32 x i32> %953) #12
  %955 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %952) #12
  %956 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %947) #12
  %957 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %955, <32 x i32> %956) #12
  %958 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %954, <32 x i32> %957) #12
  %959 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %943, <64 x i32> %958) #12
  %960 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %959) #12
  %961 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %959) #12
  %962 = tail call <32 x i32> @llvm.hexagon.V6.vpackhub.sat.128B(<32 x i32> %960, <32 x i32> %961) #12
  %963 = add nsw i32 %762, %758
  %964 = getelementptr inbounds i8, i8* %output, i32 %963
  %965 = bitcast i8* %964 to <32 x i32>*
  store <32 x i32> %962, <32 x i32>* %965, align 1, !tbaa !104
  %966 = add nsw i32 %60, %output.s0.x.x
  %t185.3 = sub i32 %966, %a11
  %967 = shl nsw i32 %t185.3, 7
  %968 = getelementptr inbounds i8, i8* %bounded_input, i32 %967
  %969 = bitcast i8* %968 to <32 x i32>*
  %t186.s22.3 = load <32 x i32>, <32 x i32>* %969, align 128, !tbaa !99
  %970 = getelementptr inbounds i8, i8* %968, i32 2
  %971 = bitcast i8* %970 to <32 x i32>*
  %t187.s23.3 = load <32 x i32>, <32 x i32>* %971, align 2, !tbaa !99
  %t188.3 = add i32 %966, %a11
  %972 = shl nsw i32 %t188.3, 7
  %973 = getelementptr inbounds i8, i8* %bounded_input, i32 %972
  %974 = bitcast i8* %973 to <32 x i32>*
  %t189.s24.3 = load <32 x i32>, <32 x i32>* %974, align 128, !tbaa !99
  %975 = getelementptr inbounds i8, i8* %973, i32 2
  %976 = bitcast i8* %975 to <32 x i32>*
  %t190.s25.3 = load <32 x i32>, <32 x i32>* %976, align 2, !tbaa !99
  %977 = shl nsw i32 %966, 7
  %978 = getelementptr inbounds i8, i8* %bounded_input, i32 %977
  %979 = bitcast i8* %978 to <32 x i32>*
  %t31926.3 = load <32 x i32>, <32 x i32>* %979, align 128, !tbaa !99
  %980 = getelementptr inbounds i8, i8* %968, i32 1
  %981 = bitcast i8* %980 to <32 x i32>*
  %982 = load <32 x i32>, <32 x i32>* %981, align 1, !tbaa !99
  %983 = getelementptr inbounds i8, i8* %973, i32 1
  %984 = bitcast i8* %983 to <32 x i32>*
  %985 = load <32 x i32>, <32 x i32>* %984, align 1, !tbaa !99
  %986 = getelementptr inbounds i8, i8* %978, i32 128
  %987 = bitcast i8* %986 to <32 x i32>*
  %988 = load <32 x i32>, <32 x i32>* %987, align 128, !tbaa !99
  %989 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %t31926.3, <32 x i32> %988) #12
  %990 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %989)
  %991 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %989)
  %992 = tail call <32 x i32> @llvm.hexagon.V6.valignbi.128B(<32 x i32> %990, <32 x i32> %991, i32 2)
  %993 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t190.s25.3) #12
  %994 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t189.s24.3) #12
  %995 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %985) #12
  %996 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %995, i32 33686018) #12
  %997 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %994, <64 x i32> %996) #12
  %998 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %993, <64 x i32> %997) #12
  %999 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %998) #12
  %1000 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t187.s23.3) #12
  %1001 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %t186.s22.3) #12
  %1002 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %982) #12
  %1003 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %1002, i32 33686018) #12
  %1004 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %1001, <64 x i32> %1003) #12
  %1005 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %1000, <64 x i32> %1004) #12
  %1006 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1005) #12
  %1007 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %999, <32 x i32> %1006) #12
  %1008 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1005) #12
  %1009 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %998) #12
  %1010 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %1008, <32 x i32> %1009) #12
  %1011 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1007, <32 x i32> %1010) #12
  %1012 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %992) #12
  %1013 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %1012, i32 33686018) #12
  %1014 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %1000, <64 x i32> %1013) #12
  %1015 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %993, <64 x i32> %1014) #12
  %1016 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1015) #12
  %1017 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %t31926.3) #12
  %1018 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %1017, i32 33686018) #12
  %1019 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %1001, <64 x i32> %1018) #12
  %1020 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %994, <64 x i32> %1019) #12
  %1021 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1020) #12
  %1022 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %1016, <32 x i32> %1021) #12
  %1023 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1020) #12
  %1024 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1015) #12
  %1025 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %1023, <32 x i32> %1024) #12
  %1026 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %1022, <32 x i32> %1025) #12
  %1027 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %1011, <64 x i32> %1026) #12
  %1028 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %1027) #12
  %1029 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %1027) #12
  %1030 = tail call <32 x i32> @llvm.hexagon.V6.vpackhub.sat.128B(<32 x i32> %1028, <32 x i32> %1029) #12
  %1031 = add nsw i32 %762, %760
  %1032 = getelementptr inbounds i8, i8* %output, i32 %1031
  %1033 = bitcast i8* %1032 to <32 x i32>*
  store <32 x i32> %1030, <32 x i32>* %1033, align 1, !tbaa !104
  %1034 = add nuw nsw i32 %output.s0.x.x, 1
  %.not28 = icmp eq i32 %1034, %t229
...
call_destructor.exit41:                           ; preds = %"end for output.s0.x.x", %if.then.i40
  %1035 = add nuw nsw i32 %output.s0.y.y.y, 1
  %.not21 = icmp eq i32 %1035, 128
...
entry:
  ...
  %6 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %5, i32 33686018)
  ...
  %12 = bitcast <128 x i8> %arg.1 to <32 x i32>
  %13 = tail call <64 x i32> @llvm.hexagon.V6.vunpackub.128B(<32 x i32> %12)
  %14 = bitcast <128 x i8> %arg to <32 x i32>
  %15 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %14)
  %16 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %15, i32 33686018)
  ...
  %25 = bitcast <128 x i8> %arg.7 to <32 x i32>
  %26 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %25)
  %27 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %26, i32 33686018)
  %28 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %11, <64 x i32> %27)
  %29 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %1, <64 x i32> %28)
  %30 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %29)
  %31 = bitcast <128 x i8> %arg.6 to <32 x i32>
  %32 = tail call <32 x i32> @llvm.hexagon.V6.vshuffb.128B(<32 x i32> %31)
  %33 = tail call <64 x i32> @llvm.hexagon.V6.vmpybus.128B(<32 x i32> %32, i32 33686018)
  %34 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %13, <64 x i32> %33)
  %35 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %3, <64 x i32> %34)
  %36 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %35)
  %37 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %30, <32 x i32> %36)
  %38 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %35)
  %39 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %29)
  %40 = tail call <32 x i32> @llvm.hexagon.V6.vabsdiffuh.128B(<32 x i32> %38, <32 x i32> %39)
  %41 = tail call <64 x i32> @llvm.hexagon.V6.vcombine.128B(<32 x i32> %37, <32 x i32> %40)
  %42 = tail call <64 x i32> @llvm.hexagon.V6.vaddh.dv.128B(<64 x i32> %24, <64 x i32> %41)
  %43 = tail call <32 x i32> @llvm.hexagon.V6.lo.128B(<64 x i32> %42)
  %44 = tail call <32 x i32> @llvm.hexagon.V6.hi.128B(<64 x i32> %42)
  %45 = tail call <32 x i32> @llvm.hexagon.V6.vpackhub.sat.128B(<32 x i32> %43, <32 x i32> %44)
  %46 = bitcast <32 x i32> %45 to <128 x i8>
  ret <128 x i8> %46
}
