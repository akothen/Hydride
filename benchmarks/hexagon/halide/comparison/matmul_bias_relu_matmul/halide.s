...
.Lfunc_end130:
	...
	.globl	matmul_bias_relu_matmul_hvx128  // -- Begin function matmul_bias_relu_matmul_hvx128
	.p2align	4
	.type	matmul_bias_relu_matmul_hvx128,@function
matmul_bias_relu_matmul_hvx128:         // @matmul_bias_relu_matmul_hvx128
// %bb.0:                               // %entry
	{
		allocframe(r29,#5888):raw
	}
	{
		r20 = r0
		r29 = and(r29,#-256)
	...
	{
		p0 = cmp.gt(r1,#0); if (!p0.new) jump:nt .LBB131_14
	}
// %bb.1:                               // %"for output.s0.c.rebased.preheader"
	{
		r2 = memw(r0+#36)
		if (!cmp.gt(r2.new,#0)) jump:nt ##.LBB131_14
	}
// %bb.2:                               // %"for output.s0.c.rebased.preheader"
	{
		r1 = memw(r0+#20)
		if (!cmp.gt(r1.new,#0)) jump:nt ##.LBB131_14
	}
...
.LBB131_7:                              // %"for matrix_mul1.s1.r14$x.us.us.us"
	...
	{
		r0 = r8
		v17:16 = vcombine(v2,v2)
		r2 = memw(r29+#392)
		r4 = memw(r29+#400)
	}                                       // 4-byte Folded Reload
	{
		v13:12 = vcombine(v2,v2)
		v7 = v2
		r5 = memw(r29+#396)
		r22 = memw(r29+#416)
	}                                       // 4-byte Folded Reload
	...
	}
	{
		r10 = addasl(r2,r7,#1)
		r12 = addasl(r16,r7,#1)
		r3 = combine(r3.l,r9.l)
		r28 = memuh(r28+r7<<#1)
	}
	{
		r28 = addasl(r10,r7,#1)
		v17.w = vinsert(r3)
		r6 = combine(r6.l,r28.l)
		v16 = valign(v16,v16,#4)
	}
	{
		r10 = addasl(r28,r7,#1)
	...
	}
	{
		r20 = addasl(r6,r7,#1)
		r23 = addasl(r21,r7,#1)
		r28 = combine(r23.l,r28.l)
		r3 = combine(r10.l,r3.l)
	}
	{
		r10 = addasl(r20,r7,#1)
		v16 = valign(v16,v16,#4)
	...
	}
	{
		r20 = addasl(r18,r7,#1)
		v16.w = vinsert(r3)
		r8 = combine(r16.l,r8.l)
		r9 = memuh(r20+r7<<#1)
	}
	{
		r16 = combine(r23.l,r17.l)
		r6 = combine(r6.l,r2.l)
		v17 = valign(v17,v17,#4)
		r17 = memuh(r21+r7<<#1)
	}
	{
	...
	}
	{
		r2 = addasl(r18,r7,#1)
		v16.w = vinsert(r16)
		r8 = combine(r21.l,r9.l)
		r10 = memuh(r10+r7<<#1)
	}
	{
		r21 = addasl(r2,r7,#1)
		r28 = addasl(r28,r7,#1)
		r10 = combine(r17.l,r10.l)
		v17 = valign(v17,v17,#4)
	}
	{
		r23 = addasl(r28,r7,#1)
	...
	{
		r3 = addasl(r23,r7,#1)
		r18 = combine(r18.l,r3.l)
		r21 = memuh(r21+r7<<#1)
		r9 = memuh(r23+r7<<#1)
	}
	{
		r21 = addasl(r12,r7,#1)
		r17 = combine(r21.l,r17.l)
		v16 = valign(v16,v16,#4)
		r28 = memuh(r28+r7<<#1)
	}
	{
		r28 = addasl(r3,r7,#1)
		r9 = combine(r9.l,r28.l)
		r16 = memuh(r5+r7<<#1)
		r23 = memuh(r3+r7<<#1)
	}
	{
	...
	}
	{
		r12 = addasl(r20,r7,#1)
		v17.w = vinsert(r16)
		r23 = combine(r9.l,r17.l)
		r10 = memuh(r23+r7<<#1)
	}
	{
		r28 = addasl(r12,r7,#1)
		r9 = combine(r28.l,r21.l)
		r15 = combine(r2.l,r10.l)
	...
	}
	{
		r10 = addasl(r28,r7,#1)
		v17.w = vinsert(r8)
		r12 = combine(r12.l,r10.l)
		r20 = memuh(r23+r7<<#1)
	}
	{
		r23 = addasl(r10,r7,#1)
		r21 = addasl(r5,r7,#1)
		r15 = combine(r21.l,r15.l)
		v18 = valign(v13,v13,#4)
	}
	{
		v18.w = vinsert(r12)
		r9 = combine(r20.l,r2.l)
	...
	}
	{
		r15 = addasl(r28,r7,#1)
		r18 = addasl(r21,r7,#1)
		r5 = combine(r15.l,r5.l)
		r10 = memuh(r10+r7<<#1)
	}
	{
		r10 = addasl(r18,r7,#1)
		v17.w = vinsert(r9)
		r9 = combine(r10.l,r12.l)
	...
	{
		r3 = addasl(r20,r7,#1)
		r15 = combine(r2.l,r3.l)
		r28 = combine(r28.l,r6.l)
		v17 = valign(v17,v17,#4)
	}
	{
		r6 = addasl(r3,r7,#1)
	...
	}
	{
		r16 = addasl(r18,r7,#1)
		r4 = addasl(r4,r7,#1)
		r23 = combine(r23.l,r17.l)
		v17 = valign(v17,v17,#4)
	}
	{
		r15 = addasl(r4,r7,#1)
		r17 = combine(r20.l,r15.l)
		v16 = valign(v16,v16,#4)
		r9 = memuh(r2+r7<<#1)
	}
	{
	...
	}
	{
		r28 = addasl(r20,r7,#1)
		v17.w = vinsert(r6)
		r4 = combine(r2.l,r4.l)
		r6 = memuh(r15+r7<<#1)
	}
	{
		r6 = addasl(r28,r7,#1)
		r15 = combine(r6.l,r12.l)
		v16 = valign(v16,v16,#4)
		r16 = memuh(r20+r7<<#1)
	}
	{
	...
	}
	{
		r18 = addasl(r20,r7,#1)
		v17.w = vinsert(r5)
		r6 = combine(r16.l,r6.l)
		r8 = memuh(r8+r7<<#1)
	}
	{
		r21 = addasl(r18,r7,#1)
		r17 = addasl(r10,r7,#1)
		r9 = combine(r28.l,r9.l)
		r0 = memuh(r20+r7<<#1)
	}
	{
		r20 = addasl(r21,r7,#1)
		r10 = addasl(r17,r7,#1)
		v18 = valign(v17,v17,#4)
		r2 = memuh(r2+r7<<#1)
	}
	{
		r18 = addasl(r20,r7,#1)
	...
	{
		r21 = addasl(r17,r7,#1)
		r8 = combine(r2.l,r8.l)
		r18 = memuh(r18+r7<<#1)
		r2 = memuh(r20+r7<<#1)
	}
	{
		r16 = combine(r2.l,r16.l)
	...
	{
		v17.w = vinsert(r6)
		r12 = combine(r12.l,r2.l)
		v16 = valign(v18,v18,#4)
		r28 = memuh(r28+r7<<#1)
	}
	{
		r18 = addasl(r20,r7,#1)
		r6 = combine(r28.l,r18.l)
		v14 = valign(v14,v14,#4)
		r17 = memuh(r20+r7<<#1)
	}
	{
	...
	{
		r6 = addasl(r4,r7,#1)
		r12 = combine(r12.l,r6.l)
		r18 = combine(r21.l,r3.l)
		r9 = memuh(r18+r7<<#1)
	}
	{
		r2 = addasl(r16,r7,#1)
		v17.w = vinsert(r8)
		r0 = combine(r15.l,r28.l)
		r3 = memuh(r2+r7<<#1)
	}
	{
		r28 = addasl(r2,r7,#1)
	...
	}
	{
		r16 = addasl(r15,r7,#1)
		r8 = addasl(r21,r7,#1)
		r17 = combine(r17.l,r20.l)
		v17 = valign(v17,v17,#4)
	}
	{
		r2 = addasl(r16,r7,#1)
		v17.w = vinsert(r17)
		r5 = combine(r4.l,r28.l)
		v15 = valign(v15,v15,#4)
	}
	{
		r4 = addasl(r2,r7,#1)
	...
	}
	{
		r10 = addasl(r28,r7,#1)
		v17.w = vinsert(r6)
		r15 = combine(r10.l,r23.l)
		r18 = memuh(r4+r7<<#1)
	}
	{
		r17 = combine(r27.l,r25.l)
		v15 = valign(v15,v15,#4)
		r23 = memuh(r2+r7<<#1)
		r12 = memuh(r8+r7<<#1)
	}
	...
	}
	{
		r25 = addasl(r23,r7,#1)
		v15.w = vinsert(r0)
		r8 = combine(r20.l,r21.l)
		r20 = combine(r12.l,r9.l)
	}
	{
		r12 = addasl(r25,r7,#1)
		v17.w = vinsert(r3)
	...
	{
		r3 = addasl(r2,r7,#1)
		r0 = combine(r0.l,r3.l)
		r9 = combine(r12.l,r21.l)
		r2 = memuh(r2+r7<<#1)
	}
	{
		r0 = addasl(r3,r7,#1)
	...
	{
		v11:10.w += vmpy(v14.h,r0.h):sat
		r20 = memw(r29+#472)
	}                                       // 4-byte Folded Reload
	{
		v9:8.w += vmpy(v13.h,r0.h):sat
	}
	{
		v5:4.w += vmpy(v12.h,r0.h):sat
		v11:10 = vshuff(v11,v10,r5)
	}
	{
		v7:6.w += vmpy(v3.h,r0.h):sat
		v9:8 = vshuff(v9,v8,r5)
		r0 = memw(r29+#420)
	}                                       // 4-byte Folded Reload
	{
		r0 = add(r22,r0)
		v5:4 = vshuff(v5,v4,r5)
		v8 = vmem(r2+#0)
		vmem(r6+#2) = v8
	}
	{
		v7:6 = vshuff(v7,v6,r5)
		r0 = memuh(r3+r0<<#1)
		vmem(r6+#3) = v9
	}
	{
	...
	{
		v7:6.w += vmpy(v12.h,r0.h):sat
		v9 = vmem(r17+#0)
		vmem(r16+#0) = v5
	}
	{
		v9:8.w += vmpy(v3.h,r0.h):sat
		r0 = memw(r29+#424)
		vmem(r6+#0) = v10
	}                                       // 4-byte Folded Reload
	{
...
.LBB131_8:                              // %"for matrix_mul1.s1.r14$x.us.us.us.for matrix_mul1.s1.r14$x.us.us.us_crit_edge"
	...
	.p2align	4
.LBB131_9:                              // %"produce matrix_mul2.us.us.us"
...
.LBB131_10:                             // %"for matrix_mul2.s1.r14$x.us.us.us"
                                        //   Parent Loop BB131_4 Depth=1
                                        //     Parent Loop BB131_5 Depth=2
                                        //       Parent Loop BB131_6 Depth=3
                                        // =>      This Inner Loop Header: Depth=4
	...
	{
		v13.w = vmpyio(v16.w,v15.h)
		r2 = add(r2,#4)
		r1 = add(r1,r0)
	}
	{
		v12.w = vmpyio(v16.w,v18.h)
	}
	{
		v22.w = vmpyio(v17.w,v18.h)
		v11:10.w = vadd(v11:10.w,v13:12.w)
	}
	{
		v23.w = vmpyio(v17.w,v15.h)
	}
	{
		v17.w = vmpyio(v19.w,v15.h)
		v9:8.w = vadd(v9:8.w,v23:22.w)
	}
	{
		v16.w = vmpyio(v19.w,v18.h)
	}
	{
		v14.w = vmpyio(v20.w,v18.h)
		v7:6.w = vadd(v7:6.w,v17:16.w)
	}
	{
		v15.w = vmpyio(v20.w,v15.h)
		v13:12 = vcombine(v9,v7)
	}
	{
...
// %bb.11:                              // %"consume matrix_mul2.us.us.us"
                                        //   in Loop: Header=BB131_6 Depth=3
	{
		r5 = #-4
		r1 = add(r29,#512)
	...
	}
	{
		r24 = addasl(r2,r6,#2)
		r23 = memw(r29+#636)
		memw(r29+#284) = r23.new
	}
	{
		r18 = memw(r29+#568)
		memw(r29+#188) = r18.new
	}
	{
		r18 = memw(r29+#572)
		memw(r29+#164) = r18.new
	}
	{
		r18 = addasl(r24,r6,#2)
		memw(r29+#208) = r18.new
	}                                       // 4-byte Folded Spill
	{
		r22 = addasl(r18,r6,#2)
		r18 = memw(r29+#584)
	...
	{
		r21 = memw(r29+#196)
		memw(r17+r6<<#2) = r21.new
	}                                       // 4-byte Folded Reload
	{
		r17 = addasl(r0,r6,#2)
		r21 = memw(r29+#228)
		memw(r20+r6<<#2) = r21.new
	}                                       // 4-byte Folded Reload
	{
		r20 = memw(r29+#192)
		memw(r11+r6<<#2) = r20.new
	}                                       // 4-byte Folded Reload
	{
		r11 = addasl(r17,r6,#2)
		r20 = memw(r29+#224)
		memw(r18+r6<<#2) = r20.new
	}                                       // 4-byte Folded Reload
	{
		r18 = memw(r29+#188)
		memw(r8+r6<<#2) = r18.new
	}                                       // 4-byte Folded Reload
	{
		r8 = addasl(r11,r6,#2)
		r18 = memw(r29+#220)
	...
	}                                       // 4-byte Folded Reload
	{
		r2 = addasl(r3,r6,#2)
		r4 = memw(r29+#176)
		memw(r22+r6<<#2) = r4.new
	}                                       // 4-byte Folded Reload
	{
		r4 = memw(r29+#208)
		memw(r23+r6<<#2) = r4.new
	}                                       // 4-byte Folded Reload
	{
		r4 = memw(r29+#168)
		r22 = memw(r29+#160)
	...
	}
	{
		r28 = r14
		r26 = memw(r29+#1280)
		memw(r28+r24<<#2) = r26.new
	}
	{
		r28 = r15
		r27 = memw(r29+#1284)
		memw(r25+r6<<#2) = r27.new
	}
	{
		r1 = addasl(r1,r6,#2)
		r25 = memw(r29+#1288)
	...
	}                                       // 4-byte Folded Reload
	{
		r25 = addasl(r27,r6,#2)
		r28 = memw(r29+#1332)
		memw(r12+r6<<#2) = r28.new
	}
	{
		r24 = addasl(r25,r6,#2)
		r12 = memw(r29+#244)
		memw(r14+r6<<#2) = r12.new
	}                                       // 4-byte Folded Reload
	{
		r23 = addasl(r24,r6,#2)
		r14 = memw(r29+#252)
...
// %bb.12:                              // %"end for output.s0.x.x.loopexit.us.us.us"
	...
	{
		r2 = add(r2,#1)
		if (!cmp.eq(r2.new,r0)) jump:t ##.LBB131_5
	}
// %bb.13:                              // %"end for output.s0.y.y.loopexit.split.us.us.us"
	...
	}                                       // 4-byte Folded Reload
	{
		p0 = cmp.eq(r8,r0)
		r0 = add(r2,#2)
		if (!p0.new) jump:t .LBB131_4
		memw(r29+#124) = r0.new
	}                                       // 4-byte Folded Spill
.LBB131_14:                             // %call_destructor.exit
	{
