; ModuleID = '/home/sb54/Hydride/hexagon-benchmarks/rake/benchmarks/hexagon/halide/blur3x3/samples/batch_79_0/17/blur3x3_batch_0079_sample_0017.bc'
...
%closure_t = type { i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i1, i32, i32, i32, i32, i32, i32, i16*, %struct.halide_buffer_t*, i16*, %struct.halide_buffer_t* }
...
@str.210 = private constant [7 x i8] c"blur_x\00", align 32
...
@str.212 = private constant [31 x i8] c"blur3x3_batch_0079_sample_0017\00", align 32
@blur3x3_batch_0079_sample_0017_metadata_storage = private constant %struct.halide_filter_metadata_t { i32 1, i32 2, %struct.halide_filter_argument_t* getelementptr inbounds ([2 x %struct.halide_filter_argument_t], [2 x %struct.halide_filter_argument_t]* @10, i32 0, i32 0), i8* getelementptr inbounds ([59 x i8], [59 x i8]* @str.211, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @str.212, i32 0, i32 0) }
...
; Function Attrs: nounwind
define i32 @blur3x3_batch_0079_sample_0017(%struct.halide_buffer_t* noalias %input.buffer, %struct.halide_buffer_t* noalias %blur_y.buffer) local_unnamed_addr #10 {
entry:
...
destructor_block:                                 ; preds = %_halide_buffer_is_bounds_query.exit41, %destructor_block.sink.split
  %6 = phi i32 [ 0, %_halide_buffer_is_bounds_query.exit41 ], [ %5, %destructor_block.sink.split ]
  ret i32 %6
...
"assert succeeded2":                              ; preds = %"assert succeeded"
  ...
  %a2 = add nsw i32 %22, 2
  %55 = icmp slt i32 %22, 16
  %56 = select i1 %55, i32 %22, i32 16
  %57 = icmp sgt i32 %22, 16
  %58 = select i1 %57, i32 %22, i32 16
  %59 = add nuw nsw i32 %58, 1
  %60 = and i32 %59, 2147483632
  %b4 = add nsw i32 %60, %56
  %61 = icmp sgt i32 %b4, %a2
  %62 = select i1 %61, i32 %a2, i32 %b4
  %a1 = add nsw i32 %62, %20
  %b3 = add nsw i32 %46, %44
  %63 = icmp sgt i32 %b3, %a1
  %a0 = select i1 %63, i32 %a1, i32 %b3
  %b2 = add nsw i32 %44, 1
  %64 = icmp sgt i32 %a0, %b2
  %65 = select i1 %64, i32 %a0, i32 %b2
  %a6 = add nsw i32 %56, %20
  %b8 = add nsw i32 %b3, 15
  %66 = icmp sgt i32 %b8, %a6
  %67 = select i1 %66, i32 %a6, i32 %b8
  %a5 = add nsw i32 %67, -16
  %68 = icmp sgt i32 %a5, %44
  %69 = select i1 %68, i32 %a5, i32 %44
  %input.extent.0.required = sub nsw i32 %65, %69
  %70 = add nsw i32 %28, %26
  %a12 = add nsw i32 %70, 2
  %b14 = add nsw i32 %52, %50
  %71 = icmp sgt i32 %b14, %a12
  %a11 = select i1 %71, i32 %a12, i32 %b14
  %b13 = add nsw i32 %50, 1
  %72 = icmp sgt i32 %a11, %b13
  %73 = select i1 %72, i32 %a11, i32 %b13
  %74 = icmp slt i32 %28, 34
  %75 = select i1 %74, i32 %28, i32 34
  %a14 = add nsw i32 %75, %26
  %b16 = add nsw i32 %b14, 33
  %76 = icmp sgt i32 %b16, %a14
  %77 = select i1 %76, i32 %a14, i32 %b16
  %a13 = add nsw i32 %77, -34
  %78 = icmp sgt i32 %a13, %50
  %79 = select i1 %78, i32 %a13, i32 %50
  %input.extent.1.required = sub nsw i32 %73, %79
  %80 = load i8*, i8** %7, align 8, !tbaa !181
...
_halide_buffer_is_bounds_query.exit:              ; preds = %"assert succeeded2"
  %82 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %blur_y.buffer, i64 0, i32 0
  %83 = load i64, i64* %82, align 8, !tbaa !183
  %84 = icmp eq i64 %83, 0
...
after_bb:                                         ; preds = %_halide_buffer_init.exit, %_halide_buffer_is_bounds_query.exit, %"assert succeeded2"
  %85 = load i8*, i8** %31, align 8, !tbaa !181
  %86 = icmp eq i8* %85, null
  br i1 %86, label %_halide_buffer_is_bounds_query.exit39, label %after_bb3

_halide_buffer_is_bounds_query.exit39:            ; preds = %after_bb
  %87 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 0
  %88 = load i64, i64* %87, align 8, !tbaa !183
  %89 = icmp eq i64 %88, 0
  br i1 %89, label %_halide_buffer_init.exit43, label %after_bb3

_halide_buffer_init.exit:                         ; preds = %_halide_buffer_is_bounds_query.exit
  %90 = bitcast %struct.halide_dimension_t** %17 to i8**
  %91 = load i8*, i8** %90, align 8, !tbaa !185
  %92 = add nsw i32 %a6, -16
  %93 = add nsw i32 %a14, -34
  %94 = icmp sgt i32 %28, 34
  %95 = select i1 %94, i32 %28, i32 34
  ...
  store i32 %58, i32* %102, align 4
  %103 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 7
  store i32 0, i32* %103, align 4
  %104 = bitcast %struct.halide_buffer_t* %blur_y.buffer to i8*
  ...
  %105 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %blur_y.buffer, i64 0, i32 4, i32 1
  store i8 16, i8* %105, align 1, !tbaa !369
  %106 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %blur_y.buffer, i64 0, i32 4, i32 2
  store i16 1, i16* %106, align 2, !tbaa !370
  store i32 2, i32* %15, align 4, !tbaa !184
  %107 = bitcast [8 x i32]* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %91, i8* nonnull align 4 dereferenceable(16) %107, i64 16, i1 false) #11, !tbaa.struct !186
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %111, i8* nonnull align 4 dereferenceable(16) %112, i64 16, i1 false) #11, !tbaa.struct !186
  store i64 0, i64* %13, align 8, !tbaa !285
  br label %after_bb

after_bb3:                                        ; preds = %_halide_buffer_init.exit43, %_halide_buffer_is_bounds_query.exit39, %after_bb
  %113 = load i8*, i8** %7, align 8, !tbaa !181
  %114 = icmp eq i8* %113, null
  br i1 %114, label %115, label %_halide_buffer_is_bounds_query.exit40

115:                                              ; preds = %after_bb3
  %116 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %blur_y.buffer, i64 0, i32 0
  %117 = load i64, i64* %116, align 8, !tbaa !183
  %118 = icmp eq i64 %117, 0
  br label %_halide_buffer_is_bounds_query.exit40

_halide_buffer_is_bounds_query.exit40:            ; preds = %115, %after_bb3
  %119 = phi i1 [ false, %after_bb3 ], [ %118, %115 ]
  %120 = load i8*, i8** %31, align 8, !tbaa !181
  %121 = icmp eq i8* %120, null
  br i1 %121, label %122, label %_halide_buffer_is_bounds_query.exit41

122:                                              ; preds = %_halide_buffer_is_bounds_query.exit40
...
_halide_buffer_is_bounds_query.exit41:            ; preds = %122, %_halide_buffer_is_bounds_query.exit40
  %126 = phi i1 [ false, %_halide_buffer_is_bounds_query.exit40 ], [ %125, %122 ]
  %127 = or i1 %119, %126
  br i1 %127, label %destructor_block, label %then_bb7

_halide_buffer_init.exit43:                       ; preds = %_halide_buffer_is_bounds_query.exit39
  %128 = bitcast %struct.halide_dimension_t** %41 to i8**
  %129 = load i8*, i8** %128, align 8, !tbaa !185
  %130 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 0
  store i32 %69, i32* %130, align 4
  %131 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 1
  store i32 %input.extent.0.required, i32* %131, align 4
  %132 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 2
  store i32 1, i32* %132, align 4
  %133 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 3
  store i32 0, i32* %133, align 4
  %134 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 4
  store i32 %79, i32* %134, align 4
  %135 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 5
  store i32 %input.extent.1.required, i32* %135, align 4
  %136 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 6
  store i32 %input.extent.0.required, i32* %136, align 4
  %137 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 7
  store i32 0, i32* %137, align 4
  %138 = bitcast %struct.halide_buffer_t* %input.buffer to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(24) %138, i8 0, i64 24, i1 false)
  store i8 1, i8* %34, align 8, !tbaa !368
  %139 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 4, i32 1
  store i8 16, i8* %139, align 1, !tbaa !369
  %140 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 4, i32 2
  store i16 1, i16* %140, align 2, !tbaa !370
  store i32 2, i32* %39, align 4, !tbaa !184
  %141 = bitcast [8 x i32]* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %129, i8* nonnull align 4 dereferenceable(16) %141, i64 16, i1 false) #11, !tbaa.struct !186
  %142 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %41, align 8, !tbaa !185
  %143 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 4
  %144 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %142, i64 1
  %145 = bitcast %struct.halide_dimension_t* %144 to i8*
  %146 = bitcast i32* %143 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %145, i8* nonnull align 4 dereferenceable(16) %146, i64 16, i1 false) #11, !tbaa.struct !186
  store i64 0, i64* %37, align 8, !tbaa !285
  br label %after_bb3

then_bb7:                                         ; preds = %_halide_buffer_is_bounds_query.exit41
  %147 = icmp ne i32 %12, 69633
  %148 = zext i1 %147 to i64
  %.not34 = icmp eq i32 %16, 2
  %149 = select i1 %.not34, i64 0, i64 2
  %.not35 = icmp eq i32 %36, 69633
  %150 = select i1 %.not35, i64 0, i64 4
  %.not36 = icmp eq i32 %40, 2
  %151 = select i1 %.not36, i64 0, i64 8
  %152 = select i1 %55, i64 16, i64 0
  %153 = select i1 %74, i64 32, i64 0
  %154 = icmp sgt i32 %65, %b3
  %155 = select i1 %154, i64 64, i64 0
  %156 = lshr i32 %46, 24
  %157 = and i32 %156, 128
  %158 = zext i32 %157 to i64
  %159 = icmp sgt i32 %73, %b14
  %160 = select i1 %159, i64 256, i64 0
  %161 = lshr i32 %52, 22
  %162 = and i32 %161, 512
  %163 = zext i32 %162 to i64
  %.not37 = icmp eq i32 %24, 1
  %164 = select i1 %.not37, i64 0, i64 1024
  %.not38 = icmp eq i32 %48, 1
  %165 = select i1 %.not38, i64 0, i64 2048
  %166 = or i64 %149, %148
  %167 = or i64 %166, %152
  %168 = or i64 %167, %164
  %169 = or i64 %168, %153
  ...
  %178 = call i64 @llvm.cttz.i64(i64 %177, i1 true), !range !371
  %179 = trunc i64 %178 to i32
  switch i32 %179, label %no_errors_bb [
...
no_errors_bb:                                     ; preds = %then_bb7
  ...
  %181 = sext i32 %22 to i64
  %blur_y.total_extent.1 = mul nsw i64 %180, %181
  %182 = sext i32 %52 to i64
  %183 = sext i32 %46 to i64
  %input.total_extent.1 = mul nsw i64 %182, %183
  %b33.lobit = lshr i32 %22, 31
  %184 = zext i32 %b33.lobit to i64
  %185 = sext i32 %30 to i64
  %x1 = mul nsw i64 %185, %180
  %186 = call i64 @llvm.abs.i64(i64 %x1, i1 true)
  %187 = icmp ugt i64 %186, 2147483647
  %188 = select i1 %187, i64 2, i64 0
  %189 = icmp sgt i64 %blur_y.total_extent.1, 2147483647
  %190 = select i1 %189, i64 4, i64 0
  %191 = lshr i32 %46, 28
  %192 = and i32 %191, 8
  %193 = zext i32 %192 to i64
  %194 = sext i32 %54 to i64
  %x2 = mul nsw i64 %194, %182
  %195 = call i64 @llvm.abs.i64(i64 %x2, i1 true)
  %196 = icmp ugt i64 %195, 2147483647
  %197 = select i1 %196, i64 16, i64 0
  %198 = icmp sgt i64 %input.total_extent.1, 2147483647
  %199 = select i1 %198, i64 32, i64 0
  %200 = shl i64 %14, 5
  %201 = and i64 %200, 64
  %202 = shl i64 %38, 6
  %203 = and i64 %202, 128
  %204 = icmp eq i8* %8, null
  %205 = icmp eq i8* %32, null
  %206 = select i1 %205, i64 512, i64 0
  %207 = select i1 %204, i64 -9223372036854775552, i64 -9223372036854775808
  %208 = or i64 %207, %201
  %209 = or i64 %208, %184
  %210 = or i64 %209, %190
  %211 = or i64 %210, %206
  ...
  %215 = or i64 %214, %199
  %216 = or i64 %215, %197
  %217 = call i64 @llvm.cttz.i64(i64 %216, i1 true), !range !371
  %218 = trunc i64 %217 to i32
  switch i32 %218, label %"produce blur_y" [
...
assert_failed:                                    ; preds = %then_bb7
  %219 = call i32 @halide_error_bad_type(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.204, i64 0, i64 0), i32 %12, i32 69633) #11
  ret i32 %219

assert_failed9:                                   ; preds = %then_bb7
  %220 = call i32 @halide_error_bad_dimensions(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.204, i64 0, i64 0), i32 %16, i32 2) #11
  ret i32 %220

assert_failed10:                                  ; preds = %then_bb7
  %221 = call i32 @halide_error_bad_type(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0), i32 %36, i32 69633) #11
  ret i32 %221

assert_failed11:                                  ; preds = %then_bb7
  %222 = call i32 @halide_error_bad_dimensions(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0), i32 %40, i32 2) #11
  ret i32 %222

assert_failed12:                                  ; preds = %then_bb7
  %223 = add nsw i32 %a6, -16
  %224 = add i32 %22, -1
  %225 = add i32 %224, %20
  %226 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.204, i64 0, i64 0), i32 0, i32 %223, i32 %225, i32 %20, i32 %225) #11
  ret i32 %226

assert_failed13:                                  ; preds = %then_bb7
  %227 = add nsw i32 %a14, -34
  %228 = add nsw i32 %70, -1
  %229 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.204, i64 0, i64 0), i32 1, i32 %227, i32 %228, i32 %26, i32 %228) #11
  ret i32 %229

assert_failed14:                                  ; preds = %then_bb7
  %230 = add nsw i32 %65, -1
  %231 = add nsw i32 %b3, -1
  %232 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0), i32 0, i32 %69, i32 %230, i32 %44, i32 %231) #11
  ret i32 %232

assert_failed15:                                  ; preds = %then_bb7
  %233 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0), i32 0, i32 %46) #11
  ret i32 %233

assert_failed16:                                  ; preds = %then_bb7
  %234 = add nsw i32 %73, -1
  %235 = add nsw i32 %b14, -1
  %236 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0), i32 1, i32 %79, i32 %234, i32 %50, i32 %235) #11
  ret i32 %236

assert_failed17:                                  ; preds = %then_bb7
  %237 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0), i32 1, i32 %52) #11
  ret i32 %237

assert_failed18:                                  ; preds = %then_bb7
  %238 = call i32 @halide_error_constraint_violated(i8* null, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @str.206, i64 0, i64 0), i32 %24, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.207, i64 0, i64 0), i32 1) #11
  ret i32 %238

assert_failed19:                                  ; preds = %then_bb7
  %239 = call i32 @halide_error_constraint_violated(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.208, i64 0, i64 0), i32 %48, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.207, i64 0, i64 0), i32 1) #11
  ret i32 %239

assert_failed21:                                  ; preds = %no_errors_bb
  %240 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str.203, i64 0, i64 0), i64 %181, i64 2147483647) #11
  ret i32 %240

assert_failed22:                                  ; preds = %no_errors_bb
  %241 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str.203, i64 0, i64 0), i64 %186, i64 2147483647) #11
  ret i32 %241

assert_failed23:                                  ; preds = %no_errors_bb
  %242 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str.203, i64 0, i64 0), i64 %blur_y.total_extent.1, i64 2147483647) #11
  ret i32 %242

assert_failed24:                                  ; preds = %no_errors_bb
  %243 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str, i64 0, i64 0), i64 %183, i64 2147483647) #11
  ret i32 %243

assert_failed25:                                  ; preds = %no_errors_bb
  %244 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str, i64 0, i64 0), i64 %195, i64 2147483647) #11
  ret i32 %244

assert_failed26:                                  ; preds = %no_errors_bb
  %245 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str, i64 0, i64 0), i64 %input.total_extent.1, i64 2147483647) #11
  ret i32 %245

assert_failed27:                                  ; preds = %no_errors_bb
  %246 = call i32 @halide_error_device_dirty_with_no_device_support(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.204, i64 0, i64 0)) #11
  ret i32 %246

assert_failed28:                                  ; preds = %no_errors_bb
  %247 = call i32 @halide_error_device_dirty_with_no_device_support(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0)) #11
  ret i32 %247

assert_failed29:                                  ; preds = %no_errors_bb
  %248 = call i32 @halide_error_host_is_null(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.204, i64 0, i64 0)) #11
  ret i32 %248

assert_failed30:                                  ; preds = %no_errors_bb
  %249 = call i32 @halide_error_host_is_null(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0)) #11
  ret i32 %249
...
"produce blur_y":                                 ; preds = %no_errors_bb
  ...
  %t312 = and i32 %251, -32
  %t313 = mul nsw i32 %30, %26
  %b31 = add nsw i32 %22, 17
  %b28 = ashr i32 %b31, 4
  %252 = sub i32 15, %20
  %253 = add i32 %252, %44
  %a27 = ashr i32 %253, 4
  ...
  %b32 = sub nsw i32 %b3, %20
  %256 = and i32 %22, 15
  %257 = icmp ne i32 %256, 0
  %a31 = add nsw i32 %b32, 13
  %258 = icmp sgt i32 %22, %a31
  %259 = select i1 %258, i32 %a31, i32 %22
  %a30 = add nsw i32 %259, 2
  %260 = icmp sgt i32 %b32, %a30
  %a29 = select i1 %260, i32 %a30, i32 %b32
  %261 = icmp sgt i32 %b31, %a29
  %262 = select i1 %261, i32 %a29, i32 %b31
  %a28 = ashr i32 %262, 4
  %263 = icmp sgt i32 %a28, %b30
  %t299 = select i1 %263, i32 %a28, i32 %b30
  %264 = add nsw i32 %28, 33
  %265 = ashr i32 %264, 31
  %266 = xor i32 %265, %264
  %267 = zext i32 %266 to i64
  %268 = mul nuw nsw i64 %267, 2021161081
  %269 = lshr i64 %268, 36
  %270 = trunc i64 %269 to i32
  %t292 = xor i32 %265, %270
  %271 = add nsw i32 %22, 15
  %t301 = ashr i32 %271, 4
  %t302 = ashr i32 %22, 4
  %t308 = sub nsw i32 %22, %t313
  %t304 = sub nsw i32 0, %t313
  ...
  store i32 %t299, i32* %281, align 4
  %282 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 10
  store i32 %t301, i32* %282, align 8
  %283 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 11
  store i32 %t302, i32* %283, align 4
  %284 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 12
  store i32 %t304, i32* %284, align 8
  %285 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 13
  store i1 %257, i1* %285, align 4
  %286 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 14
  store i32 %t308, i32* %286, align 8
  %287 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 15
  store i32 %b3, i32* %287, align 4
  %288 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 16
  store i32 %t311, i32* %288, align 8
  %289 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 17
  store i32 %t312, i32* %289, align 4
  %290 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 18
  store i32 %b28, i32* %290, align 8
  %291 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 19
  store i32 %b30, i32* %291, align 4
  %292 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 20
  %293 = bitcast i16** %292 to i8**
  store i8* %8, i8** %293, align 8
  %294 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 21
  store %struct.halide_buffer_t* %blur_y.buffer, %struct.halide_buffer_t** %294, align 8
  %295 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 22
  %296 = bitcast i16** %295 to i8**
  store i8* %32, i8** %296, align 8
  %297 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 23
  store %struct.halide_buffer_t* %input.buffer, %struct.halide_buffer_t** %297, align 8
  %298 = bitcast %closure_t* %2 to i8*
  %299 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @blur3x3_batch_0079_sample_0017.par_for.blur_y.s0.y.y, i32 0, i32 %t292, i8* nonnull %298)
  ret i32 %299
}
...
; Function Attrs: nounwind
define internal i32 @blur3x3_batch_0079_sample_0017.par_for.blur_y.s0.y.y(i8* %__user_context, i32 %blur_y.s0.y.y, i8* noalias readonly %closure) #10 {
entry:
  %blur_x.pseudostack_slot = alloca %struct.halide_pseudostack_slot_t, align 8
  %.fca.0.gep21 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot, i64 0, i32 0
  %.fca.1.gep22 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot, i64 0, i32 1
  ...
  %blur_y.extent.0 = load i32, i32* %1, align 4
  ...
  %blur_y.min.0 = load i32, i32* %6, align 4
  %7 = getelementptr inbounds i8, i8* %closure, i64 12
  %8 = bitcast i8* %7 to i32*
  ...
  %t299 = load i32, i32* %18, align 4
  %19 = getelementptr inbounds i8, i8* %closure, i64 40
  %20 = bitcast i8* %19 to i32*
  %t301 = load i32, i32* %20, align 4
  ...
  %t305 = load i1, i1* %24, align 1
  %25 = getelementptr inbounds i8, i8* %closure, i64 64
  %26 = bitcast i8* %25 to i32*
  %a77 = load i32, i32* %26, align 4
  %27 = getelementptr inbounds i8, i8* %closure, i64 72
  %28 = bitcast i8* %27 to i32*
  %t315 = load i32, i32* %28, align 4
  %29 = getelementptr inbounds i8, i8* %closure, i64 76
  %30 = bitcast i8* %29 to i32*
  %t316 = load i32, i32* %30, align 4
  %31 = getelementptr inbounds i8, i8* %closure, i64 80
  %32 = bitcast i8* %31 to i16**
  %blur_y = load i16*, i16** %32, align 8
  %33 = getelementptr inbounds i8, i8* %closure, i64 96
  %34 = bitcast i8* %33 to i16**
  %input = load i16*, i16** %34, align 8
  %a32 = mul nsw i32 %blur_y.s0.y.y, 34
  %b34 = add nsw i32 %blur_y.extent.1, -34
  %35 = icmp sgt i32 %b34, %a32
  %blur_y.s0.y.yi.base.s = select i1 %35, i32 %a32, i32 %b34
  %a56 = add nsw i32 %a58, %input.extent.1
  %t325 = sub i32 %a56, %blur_y.s0.y.yi.base.s
  %t321 = add i32 %blur_y.s0.y.yi.base.s, %b69
  %36 = icmp sgt i32 %a77, -18
  %t376 = select i1 %36, i32 %a77, i32 -18
  %37 = add nsw i32 %t376, 18
  %38 = icmp ult i32 %37, 134217728
  br i1 %38, label %"assert succeeded.lr.ph", label %call_destructor.exit, !prof !374

"assert succeeded.lr.ph":                         ; preds = %entry
  %39 = getelementptr inbounds i8, i8* %closure, i64 68
  %40 = bitcast i8* %39 to i32*
  %t312 = load i32, i32* %40, align 4
  %41 = getelementptr inbounds i8, i8* %closure, i64 60
  %42 = bitcast i8* %41 to i32*
  %t309 = load i32, i32* %42, align 4
  %43 = getelementptr inbounds i8, i8* %closure, i64 48
  %44 = bitcast i8* %43 to i32*
  %t304 = load i32, i32* %44, align 4
  %45 = getelementptr inbounds i8, i8* %closure, i64 16
  %46 = bitcast i8* %45 to i32*
  %blur_y.stride.1 = load i32, i32* %46, align 4
  %47 = getelementptr inbounds i8, i8* %closure, i64 56
  %48 = bitcast i8* %47 to i32*
  %t308 = load i32, i32* %48, align 4
  %49 = zext i32 %37 to i64
  %50 = shl nuw nsw i64 %49, 4
  %51 = or i64 %50, 6
  %t320 = sub i32 %a58, %t321
  %52 = add nsw i32 %a77, 18
  %b52 = add nsw i32 %input.extent.1, -1
  %53 = icmp sgt i32 %t315, 0
  %b53 = add nsw i32 %blur_y.extent.0, -14
  %54 = add nsw i32 %t309, -1
  %55 = insertelement <16 x i32> undef, i32 %54, i32 0
  %56 = shufflevector <16 x i32> %55, <16 x i32> undef, <8 x i32> zeroinitializer
  %57 = insertelement <16 x i32> undef, i32 %input.min.0, i32 0
  %58 = shufflevector <16 x i32> %57, <16 x i32> undef, <8 x i32> zeroinitializer
  %t350 = sub nsw i32 %t315, %t299
  %59 = icmp sgt i32 %t316, 0
  %t357 = sub nsw i32 %t299, %t316
  %60 = sub i32 %blur_y.min.0, %input.min.0
  %61 = icmp sgt i32 %t357, 0
  %62 = icmp sgt i32 %t350, 0
  %63 = icmp sgt i32 %a77, -16
  %t377 = select i1 %63, i32 %a77, i32 -16
  %64 = add nsw i32 %t377, 16
  %65 = zext i32 %64 to i64
  %66 = mul nuw nsw i64 %65, 12
  %67 = icmp ult i64 %66, 2147483648
  %68 = add nuw nsw i64 %66, 6
  %69 = add nsw i32 %a77, 16
  %70 = icmp sgt i32 %t301, 0
  %71 = icmp sgt i32 %t302, 0
  %72 = sext i32 %a77 to i64
  %73 = sext i32 %t312 to i64
  %74 = sext i32 %blur_y.extent.0 to i64
  %75 = sext i32 %t321 to i64
  %76 = sext i32 %blur_y.stride.1 to i64
  %77 = sext i32 %t308 to i64
  %78 = sext i32 %t316 to i64
  %79 = zext i32 %t357 to i64
  %80 = sext i32 %input.stride.1 to i64
  %81 = zext i32 %input.min.0 to i64
  %82 = sext i32 %60 to i64
  %83 = zext i32 %t301 to i64
  %84 = sext i32 %69 to i64
  %85 = zext i32 %t302 to i64
  %86 = sext i32 %t304 to i64
  %87 = getelementptr inbounds i16, i16* %blur_y, i64 -16
  %.fca.0.gep.promoted = load i8*, i8** %.fca.0.gep, align 8, !tbaa !375
  %.fca.1.gep.promoted = load i64, i64* %.fca.1.gep, align 8, !tbaa !377
  %.fca.1.gep22.promoted114 = load i64, i64* %.fca.1.gep22, align 8, !tbaa !377
  %.fca.0.gep21.promoted116 = load i8*, i8** %.fca.0.gep21, align 8, !tbaa !375
  br label %"assert succeeded"

"assert succeeded":                               ; preds = %"end for blur_y.s0.y.yi.yii.yii", %"assert succeeded.lr.ph"
  %.lcssa107117 = phi i8* [ %.fca.0.gep21.promoted116, %"assert succeeded.lr.ph" ], [ %600, %"end for blur_y.s0.y.yi.yii.yii" ]
  %.lcssa105115 = phi i64 [ %.fca.1.gep22.promoted114, %"assert succeeded.lr.ph" ], [ %601, %"end for blur_y.s0.y.yi.yii.yii" ]
  %.pre111 = phi i64 [ %.fca.1.gep.promoted, %"assert succeeded.lr.ph" ], [ %.pre112, %"end for blur_y.s0.y.yi.yii.yii" ]
  %.pre98108 = phi i8* [ %.fca.0.gep.promoted, %"assert succeeded.lr.ph" ], [ %.pre98109, %"end for blur_y.s0.y.yi.yii.yii" ]
  %88 = phi i8* [ null, %"assert succeeded.lr.ph" ], [ %.pre98109, %"end for blur_y.s0.y.yi.yii.yii" ]
  %89 = phi i64 [ 0, %"assert succeeded.lr.ph" ], [ %.pre112, %"end for blur_y.s0.y.yi.yii.yii" ]
  %blur_y.s0.y.yi.yi73 = phi i32 [ 0, %"assert succeeded.lr.ph" ], [ 17, %"end for blur_y.s0.y.yi.yii.yii" ]
  %.not3272 = phi i1 [ false, %"assert succeeded.lr.ph" ], [ true, %"end for blur_y.s0.y.yi.yii.yii" ]
  %90 = icmp ult i64 %89, %51
  br i1 %90, label %91, label %pseudostack_alloc.exit, !prof !378

91:                                               ; preds = %"assert succeeded"
  %92 = icmp eq i8* %88, null
  br i1 %92, label %94, label %93

93:                                               ; preds = %91
  tail call void @halide_free(i8* %__user_context, i8* nonnull %88) #13
  br label %94

94:                                               ; preds = %93, %91
  %95 = tail call i8* @halide_malloc(i8* %__user_context, i64 %51) #13
  br label %pseudostack_alloc.exit

pseudostack_alloc.exit:                           ; preds = %94, %"assert succeeded"
  %.pre112 = phi i64 [ %51, %94 ], [ %.pre111, %"assert succeeded" ]
  %.pre98109 = phi i8* [ %95, %94 ], [ %.pre98108, %"assert succeeded" ]
  %96 = phi i8* [ %95, %94 ], [ %88, %"assert succeeded" ]
  %repeat_edge = bitcast i8* %96 to i16*
  %t336 = sub i32 %t325, %blur_y.s0.y.yi.yi73
  %t332 = add nsw i32 %blur_y.s0.y.yi.yi73, %t321
  %97 = add i32 %t332, 6
  br label %"for blur_y.s0.y.yi.yii.yii"

destructor_block.thread:                          ; preds = %"end for blur_y.s0.y.yi.yii.yii"
  store i8* %.pre98109, i8** %.fca.0.gep, align 8, !tbaa !375
  store i64 %.pre112, i64* %.fca.1.gep, align 8, !tbaa !377
  store i64 %601, i64* %.fca.1.gep22, align 8, !tbaa !377
  store i8* %600, i8** %.fca.0.gep21, align 8, !tbaa !375
  %98 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot, i64 0, i32 1
  store i64 0, i64* %98, align 8, !tbaa !377
  %99 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot, i64 0, i32 0
  %100 = icmp eq i8* %600, null
  br i1 %100, label %pseudostack_free.exit, label %101

101:                                              ; preds = %destructor_block.thread
  call void @halide_free(i8* %__user_context, i8* nonnull %600) #13
  br label %pseudostack_free.exit

pseudostack_free.exit:                            ; preds = %101, %destructor_block.thread
  store i8* null, i8** %99, align 8, !tbaa !375
  br label %103

call_destructor.exit:                             ; preds = %entry
  %.pre99 = zext i32 %37 to i64
  %.pre100 = shl nuw nsw i64 %.pre99, 4
  %102 = tail call i32 @halide_error_buffer_allocation_too_large(i8* %__user_context, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @str.209, i64 0, i64 0), i64 %.pre100, i64 2147483647) #11
  br label %call_destructor.exit43

103:                                              ; preds = %"assert failed19", %pseudostack_free.exit
  %.ph = phi i32 [ %593, %"assert failed19" ], [ 0, %pseudostack_free.exit ]
  %104 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %repeat_edge.pseudostack_slot, i64 0, i32 1
  store i64 0, i64* %104, align 8, !tbaa !377
  %105 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %repeat_edge.pseudostack_slot, i64 0, i32 0
  %106 = load i8*, i8** %105, align 8, !tbaa !375
  %107 = icmp eq i8* %106, null
  br i1 %107, label %pseudostack_free.exit45, label %108

108:                                              ; preds = %103
  call void @halide_free(i8* %__user_context, i8* nonnull %106) #13
  br label %pseudostack_free.exit45

pseudostack_free.exit45:                          ; preds = %108, %103
  store i8* null, i8** %105, align 8, !tbaa !375
  br label %call_destructor.exit43

call_destructor.exit43:                           ; preds = %pseudostack_free.exit45, %call_destructor.exit
  %109 = phi i32 [ %102, %call_destructor.exit ], [ %.ph, %pseudostack_free.exit45 ]
  ret i32 %109

"for blur_y.s0.y.yi.yii.yii":                     ; preds = %"end for blur_y.s0.y.yi.yii.yiii", %pseudostack_alloc.exit
  %110 = phi i8* [ %.lcssa107117, %pseudostack_alloc.exit ], [ %600, %"end for blur_y.s0.y.yi.yii.yiii" ]
  %111 = phi i64 [ %.lcssa105115, %pseudostack_alloc.exit ], [ %601, %"end for blur_y.s0.y.yi.yii.yiii" ]
  %blur_y.s0.y.yi.yii.yii = phi i32 [ 0, %pseudostack_alloc.exit ], [ %639, %"end for blur_y.s0.y.yi.yii.yiii" ]
  %a38 = shl nsw i32 %blur_y.s0.y.yi.yii.yii, 2
  %112 = icmp ult i32 %a38, 13
  %113 = select i1 %112, i32 %a38, i32 13
  %blur_y.s0.y.min_2.s = add nuw nsw i32 %113, %blur_y.s0.y.yi.yi73
  %.not = icmp eq i32 %blur_y.s0.y.yi.yii.yii, 0
  %114 = add nuw nsw i32 %a38, %blur_y.s0.y.yi.yi73
  %115 = or i32 %114, 2
  %116 = select i1 %.not, i32 %blur_y.s0.y.min_2.s, i32 %115
  %b46 = add nsw i32 %116, %t321
  %117 = icmp slt i32 %b46, %a58
  %a39 = select i1 %117, i32 %a58, i32 %b46
  %b41 = add i32 %97, %113
  %118 = icmp sgt i32 %b41, %a39
  %repeat_edge.s0._1.prologue = select i1 %118, i32 %a39, i32 %b41
  %119 = icmp sgt i32 %a39, %a56
  %a42 = select i1 %119, i32 %a39, i32 %a56
  %120 = icmp sgt i32 %b41, %a42
  %repeat_edge.s0._1.epilogue = select i1 %120, i32 %a42, i32 %b41
  %a47 = sub i32 %t320, %116
  %121 = icmp sgt i32 %a47, 0
  %a46 = select i1 %121, i32 %a47, i32 0
  %122 = icmp ugt i32 %a38, 13
  %123 = select i1 %122, i32 %a38, i32 13
  %124 = sub nsw i32 11, %123
  %125 = select i1 %.not, i32 0, i32 %124
  %b48 = add nsw i32 %125, 6
  %126 = icmp sgt i32 %b48, %a46
  %t340 = select i1 %126, i32 %a46, i32 %b48
  %t341 = sub nsw i32 %b46, %a58
  %127 = icmp sgt i32 %t340, 0
  br i1 %127, label %"for repeat_edge.s0._1.rebased", label %"end for repeat_edge.s0._1.rebased", !prof !374

"end for blur_y.s0.y.yi.yii.yii":                 ; preds = %"end for blur_y.s0.y.yi.yii.yiii"
  br i1 %.not3272, label %destructor_block.thread, label %"assert succeeded"

"for repeat_edge.s0._1.rebased":                  ; preds = %"end for repeat_edge.s0._0._0", %"for blur_y.s0.y.yi.yii.yii"
  %repeat_edge.s0._1.rebased = phi i32 [ %249, %"end for repeat_edge.s0._0._0" ], [ 0, %"for blur_y.s0.y.yi.yii.yii" ]
  %a50 = add nsw i32 %repeat_edge.s0._1.rebased, %t341
  %128 = icmp sgt i32 %b52, %a50
  %a49 = select i1 %128, i32 %a50, i32 %b52
  br i1 %53, label %"for repeat_edge.s0._0._0.preheader", label %"end for repeat_edge.s0._0._0", !prof !374

"for repeat_edge.s0._0._0.preheader":             ; preds = %"for repeat_edge.s0._1.rebased"
  %129 = icmp sgt i32 %a49, 0
  %130 = select i1 %129, i32 %a49, i32 0
  %131 = mul nsw i32 %130, %input.stride.1
  %t344 = sub nsw i32 %131, %input.min.0
  %132 = add nsw i32 %repeat_edge.s0._1.rebased, %b46
  %133 = and i32 %132, 7
  %t345 = mul nsw i32 %133, %52
  %134 = insertelement <16 x i32> undef, i32 %t344, i32 0
  %135 = shufflevector <16 x i32> %134, <16 x i32> undef, <16 x i32> zeroinitializer
  %136 = sext i32 %t345 to i64
  br label %"for repeat_edge.s0._0._0"

"end for repeat_edge.s0._1.rebased":              ; preds = %"end for repeat_edge.s0._0._0", %"for blur_y.s0.y.yi.yii.yii"
  %137 = or i32 %a38, 2
  %138 = select i1 %.not, i32 %113, i32 %137
  %b60 = add nsw i32 %138, %t332
  %139 = icmp sgt i32 %a56, %b60
  %a55 = select i1 %139, i32 %a56, i32 %b60
  %140 = icmp sgt i32 %b41, %a55
  %141 = select i1 %140, i32 %a55, i32 %b41
  %142 = icmp sgt i32 %a58, %b60
  %a57 = select i1 %142, i32 %a58, i32 %b60
  %143 = icmp sgt i32 %b41, %a57
  %144 = select i1 %143, i32 %a57, i32 %b41
  %t346 = sub nsw i32 %141, %144
  %145 = icmp sgt i32 %t346, 0
  br i1 %145, label %"for repeat_edge.s0._1.rebased1.preheader", label %"end for repeat_edge.s0._1.rebased2", !prof !374

"for repeat_edge.s0._1.rebased1.preheader":       ; preds = %"end for repeat_edge.s0._1.rebased"
  %t347 = sub i32 %repeat_edge.s0._1.prologue, %a58
  %146 = sext i32 %t347 to i64
  %147 = zext i32 %t346 to i64
...
"for repeat_edge.s0._0._0":                       ; preds = %"for repeat_edge.s0._0._0", %"for repeat_edge.s0._0._0.preheader"
  %repeat_edge.s0._0._0 = phi i32 [ %248, %"for repeat_edge.s0._0._0" ], [ 0, %"for repeat_edge.s0._0._0.preheader" ]
  %a51 = shl nsw i32 %repeat_edge.s0._0._0, 4
  %148 = icmp sgt i32 %b53, %a51
  %repeat_edge.s0._0._0i.base.s = select i1 %148, i32 %a51, i32 %b53
  %149 = add nsw i32 %repeat_edge.s0._0._0i.base.s, %blur_y.min.0
  %150 = insertelement <16 x i32> undef, i32 %149, i32 0
  %151 = shufflevector <16 x i32> %150, <16 x i32> undef, <16 x i32> zeroinitializer
  %a53 = add nsw <16 x i32> %151, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %152 = shufflevector <16 x i32> %a53, <16 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %153 = icmp sgt <8 x i32> %56, %152
  %154 = shufflevector <16 x i32> %a53, <16 x i32> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %155 = icmp sgt <8 x i32> %56, %154
  %156 = select <8 x i1> %153, <8 x i32> %152, <8 x i32> %56
  %157 = select <8 x i1> %155, <8 x i32> %154, <8 x i32> %56
  %158 = icmp sgt <8 x i32> %156, %58
  %159 = icmp sgt <8 x i32> %157, %58
  %160 = select <8 x i1> %158, <8 x i32> %156, <8 x i32> %58
  %161 = select <8 x i1> %159, <8 x i32> %157, <8 x i32> %58
  %162 = shufflevector <8 x i32> %160, <8 x i32> %161, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %163 = add nsw <16 x i32> %162, %135
  %164 = extractelement <16 x i32> %163, i32 0
  %165 = sext i32 %164 to i64
  %166 = getelementptr inbounds i16, i16* %input, i64 %165
  %167 = load i16, i16* %166, align 2, !tbaa !379
  %168 = insertelement <16 x i16> undef, i16 %167, i32 0
  %169 = extractelement <16 x i32> %163, i32 1
  %170 = sext i32 %169 to i64
  %171 = getelementptr inbounds i16, i16* %input, i64 %170
  %172 = load i16, i16* %171, align 2, !tbaa !379
  %173 = insertelement <16 x i16> %168, i16 %172, i32 1
  %174 = extractelement <16 x i32> %163, i32 2
  %175 = sext i32 %174 to i64
  %176 = getelementptr inbounds i16, i16* %input, i64 %175
  %177 = load i16, i16* %176, align 2, !tbaa !379
  %178 = insertelement <16 x i16> %173, i16 %177, i32 2
  %179 = extractelement <16 x i32> %163, i32 3
  %180 = sext i32 %179 to i64
  %181 = getelementptr inbounds i16, i16* %input, i64 %180
  %182 = load i16, i16* %181, align 2, !tbaa !379
  %183 = insertelement <16 x i16> %178, i16 %182, i32 3
  %184 = extractelement <16 x i32> %163, i32 4
  %185 = sext i32 %184 to i64
  %186 = getelementptr inbounds i16, i16* %input, i64 %185
  %187 = load i16, i16* %186, align 2, !tbaa !379
  %188 = insertelement <16 x i16> %183, i16 %187, i32 4
  %189 = extractelement <16 x i32> %163, i32 5
  %190 = sext i32 %189 to i64
  %191 = getelementptr inbounds i16, i16* %input, i64 %190
  %192 = load i16, i16* %191, align 2, !tbaa !379
  %193 = insertelement <16 x i16> %188, i16 %192, i32 5
  %194 = extractelement <16 x i32> %163, i32 6
  %195 = sext i32 %194 to i64
  %196 = getelementptr inbounds i16, i16* %input, i64 %195
  %197 = load i16, i16* %196, align 2, !tbaa !379
  %198 = insertelement <16 x i16> %193, i16 %197, i32 6
  %199 = extractelement <16 x i32> %163, i32 7
  %200 = sext i32 %199 to i64
  %201 = getelementptr inbounds i16, i16* %input, i64 %200
  %202 = load i16, i16* %201, align 2, !tbaa !379
  %203 = insertelement <16 x i16> %198, i16 %202, i32 7
  %204 = extractelement <16 x i32> %163, i32 8
  %205 = sext i32 %204 to i64
  %206 = getelementptr inbounds i16, i16* %input, i64 %205
  %207 = load i16, i16* %206, align 2, !tbaa !379
  %208 = insertelement <16 x i16> %203, i16 %207, i32 8
  %209 = extractelement <16 x i32> %163, i32 9
  %210 = sext i32 %209 to i64
  %211 = getelementptr inbounds i16, i16* %input, i64 %210
  %212 = load i16, i16* %211, align 2, !tbaa !379
  %213 = insertelement <16 x i16> %208, i16 %212, i32 9
  %214 = extractelement <16 x i32> %163, i32 10
  %215 = sext i32 %214 to i64
  %216 = getelementptr inbounds i16, i16* %input, i64 %215
  %217 = load i16, i16* %216, align 2, !tbaa !379
  %218 = insertelement <16 x i16> %213, i16 %217, i32 10
  %219 = extractelement <16 x i32> %163, i32 11
  %220 = sext i32 %219 to i64
  %221 = getelementptr inbounds i16, i16* %input, i64 %220
  %222 = load i16, i16* %221, align 2, !tbaa !379
  %223 = insertelement <16 x i16> %218, i16 %222, i32 11
  %224 = extractelement <16 x i32> %163, i32 12
  %225 = sext i32 %224 to i64
  %226 = getelementptr inbounds i16, i16* %input, i64 %225
  %227 = load i16, i16* %226, align 2, !tbaa !379
  %228 = insertelement <16 x i16> %223, i16 %227, i32 12
  %229 = extractelement <16 x i32> %163, i32 13
  %230 = sext i32 %229 to i64
  %231 = getelementptr inbounds i16, i16* %input, i64 %230
  %232 = load i16, i16* %231, align 2, !tbaa !379
  %233 = insertelement <16 x i16> %228, i16 %232, i32 13
  %234 = extractelement <16 x i32> %163, i32 14
  %235 = sext i32 %234 to i64
  %236 = getelementptr inbounds i16, i16* %input, i64 %235
  %237 = load i16, i16* %236, align 2, !tbaa !379
  %238 = insertelement <16 x i16> %233, i16 %237, i32 14
  %239 = extractelement <16 x i32> %163, i32 15
  %240 = sext i32 %239 to i64
  %241 = getelementptr inbounds i16, i16* %input, i64 %240
  %242 = load i16, i16* %241, align 2, !tbaa !379
  %243 = insertelement <16 x i16> %238, i16 %242, i32 15
  %244 = sext i32 %repeat_edge.s0._0._0i.base.s to i64
  %245 = add nsw i64 %244, %136
  %246 = getelementptr inbounds i16, i16* %repeat_edge, i64 %245
  %247 = bitcast i16* %246 to <16 x i16>*
  store <16 x i16> %243, <16 x i16>* %247, align 2, !tbaa !382
  %248 = add nuw nsw i32 %repeat_edge.s0._0._0, 1
  %.not42 = icmp eq i32 %248, %t315
  br i1 %.not42, label %"end for repeat_edge.s0._0._0", label %"for repeat_edge.s0._0._0"

"end for repeat_edge.s0._0._0":                   ; preds = %"for repeat_edge.s0._0._0", %"for repeat_edge.s0._1.rebased"
  %249 = add nuw nsw i32 %repeat_edge.s0._1.rebased, 1
  %.not41 = icmp eq i32 %249, %t340
  br i1 %.not41, label %"end for repeat_edge.s0._1.rebased", label %"for repeat_edge.s0._1.rebased"

"for repeat_edge.s0._1.rebased1":                 ; preds = %"end for repeat_edge.s0._0._0.rebased9", %"for repeat_edge.s0._1.rebased1.preheader"
  %indvars.iv80 = phi i64 [ 0, %"for repeat_edge.s0._1.rebased1.preheader" ], [ %indvars.iv.next81, %"end for repeat_edge.s0._0._0.rebased9" ]
  %250 = trunc i64 %indvars.iv80 to i32
  %251 = add i32 %repeat_edge.s0._1.prologue, %250
  %252 = and i32 %251, 7
  %t356 = mul nsw i32 %252, %52
  %253 = add nsw i64 %indvars.iv80, %146
  %254 = mul nsw i64 %253, %80
  %255 = sub i64 %254, %81
  br i1 %59, label %"for repeat_edge.s0._0._04.preheader", label %"end for repeat_edge.s0._0._05", !prof !374

"for repeat_edge.s0._0._04.preheader":            ; preds = %"for repeat_edge.s0._1.rebased1"
  %256 = trunc i64 %255 to i32
  %257 = insertelement <16 x i32> undef, i32 %256, i32 0
  %258 = shufflevector <16 x i32> %257, <16 x i32> undef, <16 x i32> zeroinitializer
  %259 = sext i32 %t356 to i64
...
"end for repeat_edge.s0._1.rebased2":             ; preds = %"end for repeat_edge.s0._0._0.rebased9", %"end for repeat_edge.s0._1.rebased"
  %260 = add nsw i32 %125, %b69
  %a67 = sub i32 %t336, %138
  %261 = icmp sgt i32 %a67, %b69
  %262 = select i1 %261, i32 %a67, i32 %b69
  %a65 = sub i32 %260, %262
  %263 = icmp sgt i32 %a65, -6
  %t363 = sub nsw i32 %repeat_edge.s0._1.epilogue, %a58
  br i1 %263, label %"for repeat_edge.s0._1.rebased12.preheader", label %"end for repeat_edge.s0._1.rebased13", !prof !374

"for repeat_edge.s0._1.rebased12.preheader":      ; preds = %"end for repeat_edge.s0._1.rebased2"
  %a65.op = add i32 %a65, 5
...
"for repeat_edge.s0._0._04":                      ; preds = %"for repeat_edge.s0._0._04", %"for repeat_edge.s0._0._04.preheader"
  %repeat_edge.s0._0._06 = phi i32 [ %364, %"for repeat_edge.s0._0._04" ], [ 0, %"for repeat_edge.s0._0._04.preheader" ]
  %a59 = shl nsw i32 %repeat_edge.s0._0._06, 4
  %264 = icmp sgt i32 %b53, %a59
  %repeat_edge.s0._0._0i.base.s7 = select i1 %264, i32 %a59, i32 %b53
  %265 = add nsw i32 %repeat_edge.s0._0._0i.base.s7, %blur_y.min.0
  %266 = insertelement <16 x i32> undef, i32 %265, i32 0
  %267 = shufflevector <16 x i32> %266, <16 x i32> undef, <16 x i32> zeroinitializer
  %a61 = add nsw <16 x i32> %267, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %268 = shufflevector <16 x i32> %a61, <16 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %269 = icmp sgt <8 x i32> %56, %268
  %270 = shufflevector <16 x i32> %a61, <16 x i32> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %271 = icmp sgt <8 x i32> %56, %270
  %272 = select <8 x i1> %269, <8 x i32> %268, <8 x i32> %56
  %273 = select <8 x i1> %271, <8 x i32> %270, <8 x i32> %56
  %274 = icmp sgt <8 x i32> %272, %58
  %275 = icmp sgt <8 x i32> %273, %58
  %276 = select <8 x i1> %274, <8 x i32> %272, <8 x i32> %58
  %277 = select <8 x i1> %275, <8 x i32> %273, <8 x i32> %58
  %278 = shufflevector <8 x i32> %276, <8 x i32> %277, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %279 = add nsw <16 x i32> %278, %258
  %280 = extractelement <16 x i32> %279, i32 0
  %281 = sext i32 %280 to i64
  %282 = getelementptr inbounds i16, i16* %input, i64 %281
  %283 = load i16, i16* %282, align 2, !tbaa !379
  %284 = insertelement <16 x i16> undef, i16 %283, i32 0
  %285 = extractelement <16 x i32> %279, i32 1
  %286 = sext i32 %285 to i64
  %287 = getelementptr inbounds i16, i16* %input, i64 %286
  %288 = load i16, i16* %287, align 2, !tbaa !379
  %289 = insertelement <16 x i16> %284, i16 %288, i32 1
  %290 = extractelement <16 x i32> %279, i32 2
  %291 = sext i32 %290 to i64
  %292 = getelementptr inbounds i16, i16* %input, i64 %291
  %293 = load i16, i16* %292, align 2, !tbaa !379
  %294 = insertelement <16 x i16> %289, i16 %293, i32 2
  %295 = extractelement <16 x i32> %279, i32 3
  %296 = sext i32 %295 to i64
  %297 = getelementptr inbounds i16, i16* %input, i64 %296
  %298 = load i16, i16* %297, align 2, !tbaa !379
  %299 = insertelement <16 x i16> %294, i16 %298, i32 3
  %300 = extractelement <16 x i32> %279, i32 4
  %301 = sext i32 %300 to i64
  %302 = getelementptr inbounds i16, i16* %input, i64 %301
  %303 = load i16, i16* %302, align 2, !tbaa !379
  %304 = insertelement <16 x i16> %299, i16 %303, i32 4
  %305 = extractelement <16 x i32> %279, i32 5
  %306 = sext i32 %305 to i64
  %307 = getelementptr inbounds i16, i16* %input, i64 %306
  %308 = load i16, i16* %307, align 2, !tbaa !379
  %309 = insertelement <16 x i16> %304, i16 %308, i32 5
  %310 = extractelement <16 x i32> %279, i32 6
  %311 = sext i32 %310 to i64
  %312 = getelementptr inbounds i16, i16* %input, i64 %311
  %313 = load i16, i16* %312, align 2, !tbaa !379
  %314 = insertelement <16 x i16> %309, i16 %313, i32 6
  %315 = extractelement <16 x i32> %279, i32 7
  %316 = sext i32 %315 to i64
  %317 = getelementptr inbounds i16, i16* %input, i64 %316
  %318 = load i16, i16* %317, align 2, !tbaa !379
  %319 = insertelement <16 x i16> %314, i16 %318, i32 7
  %320 = extractelement <16 x i32> %279, i32 8
  %321 = sext i32 %320 to i64
  %322 = getelementptr inbounds i16, i16* %input, i64 %321
  %323 = load i16, i16* %322, align 2, !tbaa !379
  %324 = insertelement <16 x i16> %319, i16 %323, i32 8
  %325 = extractelement <16 x i32> %279, i32 9
  %326 = sext i32 %325 to i64
  %327 = getelementptr inbounds i16, i16* %input, i64 %326
  %328 = load i16, i16* %327, align 2, !tbaa !379
  %329 = insertelement <16 x i16> %324, i16 %328, i32 9
  %330 = extractelement <16 x i32> %279, i32 10
  %331 = sext i32 %330 to i64
  %332 = getelementptr inbounds i16, i16* %input, i64 %331
  %333 = load i16, i16* %332, align 2, !tbaa !379
  %334 = insertelement <16 x i16> %329, i16 %333, i32 10
  %335 = extractelement <16 x i32> %279, i32 11
  %336 = sext i32 %335 to i64
  %337 = getelementptr inbounds i16, i16* %input, i64 %336
  %338 = load i16, i16* %337, align 2, !tbaa !379
  %339 = insertelement <16 x i16> %334, i16 %338, i32 11
  %340 = extractelement <16 x i32> %279, i32 12
  %341 = sext i32 %340 to i64
  %342 = getelementptr inbounds i16, i16* %input, i64 %341
  %343 = load i16, i16* %342, align 2, !tbaa !379
  %344 = insertelement <16 x i16> %339, i16 %343, i32 12
  %345 = extractelement <16 x i32> %279, i32 13
  %346 = sext i32 %345 to i64
  %347 = getelementptr inbounds i16, i16* %input, i64 %346
  %348 = load i16, i16* %347, align 2, !tbaa !379
  %349 = insertelement <16 x i16> %344, i16 %348, i32 13
  %350 = extractelement <16 x i32> %279, i32 14
  %351 = sext i32 %350 to i64
  %352 = getelementptr inbounds i16, i16* %input, i64 %351
  %353 = load i16, i16* %352, align 2, !tbaa !379
  %354 = insertelement <16 x i16> %349, i16 %353, i32 14
  %355 = extractelement <16 x i32> %279, i32 15
  %356 = sext i32 %355 to i64
  %357 = getelementptr inbounds i16, i16* %input, i64 %356
  %358 = load i16, i16* %357, align 2, !tbaa !379
  %359 = insertelement <16 x i16> %354, i16 %358, i32 15
  %360 = sext i32 %repeat_edge.s0._0._0i.base.s7 to i64
  %361 = add nsw i64 %360, %259
  %362 = getelementptr inbounds i16, i16* %repeat_edge, i64 %361
  %363 = bitcast i16* %362 to <16 x i16>*
  store <16 x i16> %359, <16 x i16>* %363, align 2, !tbaa !382
  %364 = add nuw nsw i32 %repeat_edge.s0._0._06, 1
  %.not40 = icmp eq i32 %364, %t316
  br i1 %.not40, label %"end for repeat_edge.s0._0._05", label %"for repeat_edge.s0._0._04"

"end for repeat_edge.s0._0._05":                  ; preds = %"for repeat_edge.s0._0._04", %"for repeat_edge.s0._1.rebased1"
  br i1 %61, label %"for repeat_edge.s0._0._0.rebased.preheader", label %"end for repeat_edge.s0._0._0.rebased", !prof !374

"for repeat_edge.s0._0._0.rebased.preheader":     ; preds = %"end for repeat_edge.s0._0._05"
  %365 = add nsw i64 %254, %82
  %366 = sext i32 %t356 to i64
...
"for repeat_edge.s0._0._0.rebased":               ; preds = %"for repeat_edge.s0._0._0.rebased", %"for repeat_edge.s0._0._0.rebased.preheader"
  ...
  %367 = add nsw i64 %indvars.iv, %78
  %368 = shl nsw i64 %367, 4
  %369 = add nsw i64 %368, %365
  %370 = getelementptr inbounds i16, i16* %input, i64 %369
  %371 = bitcast i16* %370 to <16 x i16>*
  %372 = load <16 x i16>, <16 x i16>* %371, align 2, !tbaa !379
  %373 = add nsw i64 %368, %366
  %374 = getelementptr inbounds i16, i16* %repeat_edge, i64 %373
  %375 = bitcast i16* %374 to <16 x i16>*
  store <16 x i16> %372, <16 x i16>* %375, align 4, !tbaa !382
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.not39 = icmp eq i64 %indvars.iv.next, %79
...
"end for repeat_edge.s0._0._0.rebased":           ; preds = %"for repeat_edge.s0._0._0.rebased", %"end for repeat_edge.s0._0._05"
  br i1 %62, label %"for repeat_edge.s0._0._0.rebased8.preheader", label %"end for repeat_edge.s0._0._0.rebased9", !prof !374

"for repeat_edge.s0._0._0.rebased8.preheader":    ; preds = %"end for repeat_edge.s0._0._0.rebased"
  %376 = trunc i64 %255 to i32
  %377 = insertelement <16 x i32> undef, i32 %376, i32 0
  %378 = shufflevector <16 x i32> %377, <16 x i32> undef, <16 x i32> zeroinitializer
  %379 = sext i32 %t356 to i64
...
"for repeat_edge.s0._0._0.rebased8":              ; preds = %"for repeat_edge.s0._0._0.rebased8", %"for repeat_edge.s0._0._0.rebased8.preheader"
  %repeat_edge.s0._0._0.rebased10 = phi i32 [ %481, %"for repeat_edge.s0._0._0.rebased8" ], [ 0, %"for repeat_edge.s0._0._0.rebased8.preheader" ]
  %380 = add nsw i32 %repeat_edge.s0._0._0.rebased10, %t299
  %a62 = shl nsw i32 %380, 4
  %381 = icmp sgt i32 %b53, %a62
  %repeat_edge.s0._0._0i.base.s11 = select i1 %381, i32 %a62, i32 %b53
  %382 = add nsw i32 %repeat_edge.s0._0._0i.base.s11, %blur_y.min.0
  %383 = insertelement <16 x i32> undef, i32 %382, i32 0
  %384 = shufflevector <16 x i32> %383, <16 x i32> undef, <16 x i32> zeroinitializer
  %a64 = add nsw <16 x i32> %384, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %385 = shufflevector <16 x i32> %a64, <16 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %386 = icmp sgt <8 x i32> %56, %385
  %387 = shufflevector <16 x i32> %a64, <16 x i32> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %388 = icmp sgt <8 x i32> %56, %387
  %389 = select <8 x i1> %386, <8 x i32> %385, <8 x i32> %56
  %390 = select <8 x i1> %388, <8 x i32> %387, <8 x i32> %56
  %391 = icmp sgt <8 x i32> %389, %58
  %392 = icmp sgt <8 x i32> %390, %58
  %393 = select <8 x i1> %391, <8 x i32> %389, <8 x i32> %58
  %394 = select <8 x i1> %392, <8 x i32> %390, <8 x i32> %58
  %395 = shufflevector <8 x i32> %393, <8 x i32> %394, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %396 = add nsw <16 x i32> %395, %378
  %397 = extractelement <16 x i32> %396, i32 0
  %398 = sext i32 %397 to i64
  %399 = getelementptr inbounds i16, i16* %input, i64 %398
  %400 = load i16, i16* %399, align 2, !tbaa !379
  %401 = insertelement <16 x i16> undef, i16 %400, i32 0
  %402 = extractelement <16 x i32> %396, i32 1
  %403 = sext i32 %402 to i64
  %404 = getelementptr inbounds i16, i16* %input, i64 %403
  %405 = load i16, i16* %404, align 2, !tbaa !379
  %406 = insertelement <16 x i16> %401, i16 %405, i32 1
  %407 = extractelement <16 x i32> %396, i32 2
  %408 = sext i32 %407 to i64
  %409 = getelementptr inbounds i16, i16* %input, i64 %408
  %410 = load i16, i16* %409, align 2, !tbaa !379
  %411 = insertelement <16 x i16> %406, i16 %410, i32 2
  %412 = extractelement <16 x i32> %396, i32 3
  %413 = sext i32 %412 to i64
  %414 = getelementptr inbounds i16, i16* %input, i64 %413
  %415 = load i16, i16* %414, align 2, !tbaa !379
  %416 = insertelement <16 x i16> %411, i16 %415, i32 3
  %417 = extractelement <16 x i32> %396, i32 4
  %418 = sext i32 %417 to i64
  %419 = getelementptr inbounds i16, i16* %input, i64 %418
  %420 = load i16, i16* %419, align 2, !tbaa !379
  %421 = insertelement <16 x i16> %416, i16 %420, i32 4
  %422 = extractelement <16 x i32> %396, i32 5
  %423 = sext i32 %422 to i64
  %424 = getelementptr inbounds i16, i16* %input, i64 %423
  %425 = load i16, i16* %424, align 2, !tbaa !379
  %426 = insertelement <16 x i16> %421, i16 %425, i32 5
  %427 = extractelement <16 x i32> %396, i32 6
  %428 = sext i32 %427 to i64
  %429 = getelementptr inbounds i16, i16* %input, i64 %428
  %430 = load i16, i16* %429, align 2, !tbaa !379
  %431 = insertelement <16 x i16> %426, i16 %430, i32 6
  %432 = extractelement <16 x i32> %396, i32 7
  %433 = sext i32 %432 to i64
  %434 = getelementptr inbounds i16, i16* %input, i64 %433
  %435 = load i16, i16* %434, align 2, !tbaa !379
  %436 = insertelement <16 x i16> %431, i16 %435, i32 7
  %437 = extractelement <16 x i32> %396, i32 8
  %438 = sext i32 %437 to i64
  %439 = getelementptr inbounds i16, i16* %input, i64 %438
  %440 = load i16, i16* %439, align 2, !tbaa !379
  %441 = insertelement <16 x i16> %436, i16 %440, i32 8
  %442 = extractelement <16 x i32> %396, i32 9
  %443 = sext i32 %442 to i64
  %444 = getelementptr inbounds i16, i16* %input, i64 %443
  %445 = load i16, i16* %444, align 2, !tbaa !379
  %446 = insertelement <16 x i16> %441, i16 %445, i32 9
  %447 = extractelement <16 x i32> %396, i32 10
  %448 = sext i32 %447 to i64
  %449 = getelementptr inbounds i16, i16* %input, i64 %448
  %450 = load i16, i16* %449, align 2, !tbaa !379
  %451 = insertelement <16 x i16> %446, i16 %450, i32 10
  %452 = extractelement <16 x i32> %396, i32 11
  %453 = sext i32 %452 to i64
  %454 = getelementptr inbounds i16, i16* %input, i64 %453
  %455 = load i16, i16* %454, align 2, !tbaa !379
  %456 = insertelement <16 x i16> %451, i16 %455, i32 11
  %457 = extractelement <16 x i32> %396, i32 12
  %458 = sext i32 %457 to i64
  %459 = getelementptr inbounds i16, i16* %input, i64 %458
  %460 = load i16, i16* %459, align 2, !tbaa !379
  %461 = insertelement <16 x i16> %456, i16 %460, i32 12
  %462 = extractelement <16 x i32> %396, i32 13
  %463 = sext i32 %462 to i64
  %464 = getelementptr inbounds i16, i16* %input, i64 %463
  %465 = load i16, i16* %464, align 2, !tbaa !379
  %466 = insertelement <16 x i16> %461, i16 %465, i32 13
  %467 = extractelement <16 x i32> %396, i32 14
  %468 = sext i32 %467 to i64
  %469 = getelementptr inbounds i16, i16* %input, i64 %468
  %470 = load i16, i16* %469, align 2, !tbaa !379
  %471 = insertelement <16 x i16> %466, i16 %470, i32 14
  %472 = extractelement <16 x i32> %396, i32 15
  %473 = sext i32 %472 to i64
  %474 = getelementptr inbounds i16, i16* %input, i64 %473
  %475 = load i16, i16* %474, align 2, !tbaa !379
  %476 = insertelement <16 x i16> %471, i16 %475, i32 15
  %477 = sext i32 %repeat_edge.s0._0._0i.base.s11 to i64
  %478 = add nsw i64 %477, %379
  %479 = getelementptr inbounds i16, i16* %repeat_edge, i64 %478
  %480 = bitcast i16* %479 to <16 x i16>*
  store <16 x i16> %476, <16 x i16>* %480, align 2, !tbaa !382
  %481 = add nuw nsw i32 %repeat_edge.s0._0._0.rebased10, 1
  %.not38 = icmp eq i32 %481, %t350
  br i1 %.not38, label %"end for repeat_edge.s0._0._0.rebased9", label %"for repeat_edge.s0._0._0.rebased8"
...
"end for repeat_edge.s0._0._0.rebased9":          ; preds = %"for repeat_edge.s0._0._0.rebased8", %"end for repeat_edge.s0._0._0.rebased"
  ...
  %.not37 = icmp eq i64 %indvars.iv.next81, %147
  br i1 %.not37, label %"end for repeat_edge.s0._1.rebased2", label %"for repeat_edge.s0._1.rebased1"

"for repeat_edge.s0._1.rebased12":                ; preds = %"end for repeat_edge.s0._0._016", %"for repeat_edge.s0._1.rebased12.preheader"
  %repeat_edge.s0._1.rebased14 = phi i32 [ %592, %"end for repeat_edge.s0._0._016" ], [ 0, %"for repeat_edge.s0._1.rebased12.preheader" ]
  %a70 = add nsw i32 %repeat_edge.s0._1.rebased14, %t363
  %482 = icmp sgt i32 %b52, %a70
  %a69 = select i1 %482, i32 %a70, i32 %b52
  br i1 %53, label %"for repeat_edge.s0._0._015.preheader", label %"end for repeat_edge.s0._0._016", !prof !374

"for repeat_edge.s0._0._015.preheader":           ; preds = %"for repeat_edge.s0._1.rebased12"
  %483 = icmp sgt i32 %a69, 0
  %484 = select i1 %483, i32 %a69, i32 0
  %485 = mul nsw i32 %484, %input.stride.1
  %t366 = sub nsw i32 %485, %input.min.0
  %486 = add nsw i32 %repeat_edge.s0._1.rebased14, %repeat_edge.s0._1.epilogue
  %487 = and i32 %486, 7
  %t367 = mul nsw i32 %487, %52
  %488 = insertelement <16 x i32> undef, i32 %t366, i32 0
  %489 = shufflevector <16 x i32> %488, <16 x i32> undef, <16 x i32> zeroinitializer
  %490 = sext i32 %t367 to i64
...
"end for repeat_edge.s0._1.rebased13":            ; preds = %"end for repeat_edge.s0._0._016", %"end for repeat_edge.s0._1.rebased2"
  br i1 %67, label %"assert succeeded20", label %"assert failed19", !prof !374

"for repeat_edge.s0._0._015":                     ; preds = %"for repeat_edge.s0._0._015", %"for repeat_edge.s0._0._015.preheader"
  %repeat_edge.s0._0._017 = phi i32 [ %591, %"for repeat_edge.s0._0._015" ], [ 0, %"for repeat_edge.s0._0._015.preheader" ]
  %a71 = shl nsw i32 %repeat_edge.s0._0._017, 4
  %491 = icmp sgt i32 %b53, %a71
  %repeat_edge.s0._0._0i.base.s18 = select i1 %491, i32 %a71, i32 %b53
  %492 = add nsw i32 %repeat_edge.s0._0._0i.base.s18, %blur_y.min.0
  %493 = insertelement <16 x i32> undef, i32 %492, i32 0
  %494 = shufflevector <16 x i32> %493, <16 x i32> undef, <16 x i32> zeroinitializer
  %a73 = add nsw <16 x i32> %494, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %495 = shufflevector <16 x i32> %a73, <16 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %496 = icmp sgt <8 x i32> %56, %495
  %497 = shufflevector <16 x i32> %a73, <16 x i32> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %498 = icmp sgt <8 x i32> %56, %497
  %499 = select <8 x i1> %496, <8 x i32> %495, <8 x i32> %56
  %500 = select <8 x i1> %498, <8 x i32> %497, <8 x i32> %56
  %501 = icmp sgt <8 x i32> %499, %58
  %502 = icmp sgt <8 x i32> %500, %58
  %503 = select <8 x i1> %501, <8 x i32> %499, <8 x i32> %58
  %504 = select <8 x i1> %502, <8 x i32> %500, <8 x i32> %58
  %505 = shufflevector <8 x i32> %503, <8 x i32> %504, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %506 = add nsw <16 x i32> %505, %489
  %507 = extractelement <16 x i32> %506, i32 0
  %508 = sext i32 %507 to i64
  %509 = getelementptr inbounds i16, i16* %input, i64 %508
  %510 = load i16, i16* %509, align 2, !tbaa !379
  %511 = insertelement <16 x i16> undef, i16 %510, i32 0
  %512 = extractelement <16 x i32> %506, i32 1
  %513 = sext i32 %512 to i64
  %514 = getelementptr inbounds i16, i16* %input, i64 %513
  %515 = load i16, i16* %514, align 2, !tbaa !379
  %516 = insertelement <16 x i16> %511, i16 %515, i32 1
  %517 = extractelement <16 x i32> %506, i32 2
  %518 = sext i32 %517 to i64
  %519 = getelementptr inbounds i16, i16* %input, i64 %518
  %520 = load i16, i16* %519, align 2, !tbaa !379
  %521 = insertelement <16 x i16> %516, i16 %520, i32 2
  %522 = extractelement <16 x i32> %506, i32 3
  %523 = sext i32 %522 to i64
  %524 = getelementptr inbounds i16, i16* %input, i64 %523
  %525 = load i16, i16* %524, align 2, !tbaa !379
  %526 = insertelement <16 x i16> %521, i16 %525, i32 3
  %527 = extractelement <16 x i32> %506, i32 4
  %528 = sext i32 %527 to i64
  %529 = getelementptr inbounds i16, i16* %input, i64 %528
  %530 = load i16, i16* %529, align 2, !tbaa !379
  %531 = insertelement <16 x i16> %526, i16 %530, i32 4
  %532 = extractelement <16 x i32> %506, i32 5
  %533 = sext i32 %532 to i64
  %534 = getelementptr inbounds i16, i16* %input, i64 %533
  %535 = load i16, i16* %534, align 2, !tbaa !379
  %536 = insertelement <16 x i16> %531, i16 %535, i32 5
  %537 = extractelement <16 x i32> %506, i32 6
  %538 = sext i32 %537 to i64
  %539 = getelementptr inbounds i16, i16* %input, i64 %538
  %540 = load i16, i16* %539, align 2, !tbaa !379
  %541 = insertelement <16 x i16> %536, i16 %540, i32 6
  %542 = extractelement <16 x i32> %506, i32 7
  %543 = sext i32 %542 to i64
  %544 = getelementptr inbounds i16, i16* %input, i64 %543
  %545 = load i16, i16* %544, align 2, !tbaa !379
  %546 = insertelement <16 x i16> %541, i16 %545, i32 7
  %547 = extractelement <16 x i32> %506, i32 8
  %548 = sext i32 %547 to i64
  %549 = getelementptr inbounds i16, i16* %input, i64 %548
  %550 = load i16, i16* %549, align 2, !tbaa !379
  %551 = insertelement <16 x i16> %546, i16 %550, i32 8
  %552 = extractelement <16 x i32> %506, i32 9
  %553 = sext i32 %552 to i64
  %554 = getelementptr inbounds i16, i16* %input, i64 %553
  %555 = load i16, i16* %554, align 2, !tbaa !379
  %556 = insertelement <16 x i16> %551, i16 %555, i32 9
  %557 = extractelement <16 x i32> %506, i32 10
  %558 = sext i32 %557 to i64
  %559 = getelementptr inbounds i16, i16* %input, i64 %558
  %560 = load i16, i16* %559, align 2, !tbaa !379
  %561 = insertelement <16 x i16> %556, i16 %560, i32 10
  %562 = extractelement <16 x i32> %506, i32 11
  %563 = sext i32 %562 to i64
  %564 = getelementptr inbounds i16, i16* %input, i64 %563
  %565 = load i16, i16* %564, align 2, !tbaa !379
  %566 = insertelement <16 x i16> %561, i16 %565, i32 11
  %567 = extractelement <16 x i32> %506, i32 12
  %568 = sext i32 %567 to i64
  %569 = getelementptr inbounds i16, i16* %input, i64 %568
  %570 = load i16, i16* %569, align 2, !tbaa !379
  %571 = insertelement <16 x i16> %566, i16 %570, i32 12
  %572 = extractelement <16 x i32> %506, i32 13
  %573 = sext i32 %572 to i64
  %574 = getelementptr inbounds i16, i16* %input, i64 %573
  %575 = load i16, i16* %574, align 2, !tbaa !379
  %576 = insertelement <16 x i16> %571, i16 %575, i32 13
  %577 = extractelement <16 x i32> %506, i32 14
  %578 = sext i32 %577 to i64
  %579 = getelementptr inbounds i16, i16* %input, i64 %578
  %580 = load i16, i16* %579, align 2, !tbaa !379
  %581 = insertelement <16 x i16> %576, i16 %580, i32 14
  %582 = extractelement <16 x i32> %506, i32 15
  %583 = sext i32 %582 to i64
  %584 = getelementptr inbounds i16, i16* %input, i64 %583
  %585 = load i16, i16* %584, align 2, !tbaa !379
  %586 = insertelement <16 x i16> %581, i16 %585, i32 15
  %587 = sext i32 %repeat_edge.s0._0._0i.base.s18 to i64
  %588 = add nsw i64 %587, %490
  %589 = getelementptr inbounds i16, i16* %repeat_edge, i64 %588
  %590 = bitcast i16* %589 to <16 x i16>*
  store <16 x i16> %586, <16 x i16>* %590, align 2, !tbaa !382
  %591 = add nuw nsw i32 %repeat_edge.s0._0._017, 1
  %.not36 = icmp eq i32 %591, %t315
  br i1 %.not36, label %"end for repeat_edge.s0._0._016", label %"for repeat_edge.s0._0._015"

"end for repeat_edge.s0._0._016":                 ; preds = %"for repeat_edge.s0._0._015", %"for repeat_edge.s0._1.rebased12"
  %592 = add nuw nsw i32 %repeat_edge.s0._1.rebased14, 1
  %.not35 = icmp eq i32 %repeat_edge.s0._1.rebased14, %a65.op
  br i1 %.not35, label %"end for repeat_edge.s0._1.rebased13", label %"for repeat_edge.s0._1.rebased12"

"assert failed19":                                ; preds = %"end for repeat_edge.s0._1.rebased13"
  store i8* %.pre98109, i8** %.fca.0.gep, align 8, !tbaa !375
  store i64 %.pre112, i64* %.fca.1.gep, align 8, !tbaa !377
  store i64 %.lcssa105115, i64* %.fca.1.gep22, align 8, !tbaa !377
  store i8* %.lcssa107117, i8** %.fca.0.gep21, align 8, !tbaa !375
  store i64 %111, i64* %.fca.1.gep22, align 8, !tbaa !377
  store i8* %110, i8** %.fca.0.gep21, align 8, !tbaa !375
  %593 = tail call i32 @halide_error_buffer_allocation_too_large(i8* %__user_context, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str.210, i64 0, i64 0), i64 %66, i64 2147483647) #11
  br label %103

"assert succeeded20":                             ; preds = %"end for repeat_edge.s0._1.rebased13"
  %594 = icmp ult i64 %111, %68
  br i1 %594, label %595, label %pseudostack_alloc.exit44, !prof !378

595:                                              ; preds = %"assert succeeded20"
  %596 = icmp eq i8* %110, null
  br i1 %596, label %598, label %597

597:                                              ; preds = %595
  tail call void @halide_free(i8* %__user_context, i8* nonnull %110) #13
  br label %598

598:                                              ; preds = %597, %595
  %599 = tail call i8* @halide_malloc(i8* %__user_context, i64 %68) #13
  br label %pseudostack_alloc.exit44

pseudostack_alloc.exit44:                         ; preds = %598, %"assert succeeded20"
  %600 = phi i8* [ %599, %598 ], [ %110, %"assert succeeded20" ]
  %601 = phi i64 [ %68, %598 ], [ %111, %"assert succeeded20" ]
  %blur_x = bitcast i8* %600 to i16*
  br i1 %70, label %"for blur_x.s0.y.rebased.us.preheader", label %"for blur_y.s0.y.yi.yii.yiii.preheader", !prof !374

"for blur_x.s0.y.rebased.us.preheader":           ; preds = %pseudostack_alloc.exit44
  %t368 = add nsw i32 %blur_y.s0.y.min_2.s, %t321
  br label %"for blur_x.s0.y.rebased.us"

"for blur_x.s0.y.rebased.us":                     ; preds = %"end for blur_x.s0.x.x.loopexit.us", %"for blur_x.s0.y.rebased.us.preheader"
  %indvars.iv87 = phi i64 [ 0, %"for blur_x.s0.y.rebased.us.preheader" ], [ %indvars.iv.next88, %"end for blur_x.s0.x.x.loopexit.us" ]
  %602 = trunc i64 %indvars.iv87 to i32
  %603 = add i32 %t368, %602
  %604 = and i32 %603, 7
  %t369.us = mul nsw i32 %604, %52
  %605 = mul nsw i64 %indvars.iv87, %84
  %606 = sext i32 %t369.us to i64
  br label %"for blur_x.s0.x.x.us"

"for blur_x.s0.x.x.us":                           ; preds = %"for blur_x.s0.x.x.us", %"for blur_x.s0.y.rebased.us"
  %indvars.iv84 = phi i64 [ 0, %"for blur_x.s0.y.rebased.us" ], [ %indvars.iv.next85, %"for blur_x.s0.x.x.us" ]
  %607 = shl nsw i64 %indvars.iv84, 4
  %608 = add nsw i64 %607, %606
  %609 = getelementptr inbounds i16, i16* %repeat_edge, i64 %608
  %610 = getelementptr inbounds i16, i16* %609, i64 1
  %611 = bitcast i16* %610 to <16 x i16>*
  %612 = load <16 x i16>, <16 x i16>* %611, align 2, !tbaa !382
  %613 = getelementptr inbounds i16, i16* %609, i64 2
  %614 = bitcast i16* %613 to <16 x i16>*
  %615 = load <16 x i16>, <16 x i16>* %614, align 4, !tbaa !382
  %616 = bitcast i16* %609 to <16 x i16>*
  %617 = load <16 x i16>, <16 x i16>* %616, align 4, !tbaa !382
  %618 = add <16 x i16> %615, %612
  %619 = add <16 x i16> %618, %617
  %620 = tail call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %619, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %621 = lshr <16 x i16> %620, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %622 = add nsw i64 %607, %605
  %623 = getelementptr inbounds i16, i16* %blur_x, i64 %622
  %624 = bitcast i16* %623 to <16 x i16>*
  store <16 x i16> %621, <16 x i16>* %624, align 32, !tbaa !384
  %indvars.iv.next85 = add nuw nsw i64 %indvars.iv84, 1
  %.not34.us = icmp eq i64 %indvars.iv.next85, %83
  br i1 %.not34.us, label %"end for blur_x.s0.x.x.loopexit.us", label %"for blur_x.s0.x.x.us"

"end for blur_x.s0.x.x.loopexit.us":              ; preds = %"for blur_x.s0.x.x.us"
  %indvars.iv.next88 = add nuw nsw i64 %indvars.iv87, 1
  %.not29.us = icmp eq i64 %indvars.iv.next88, 6
  br i1 %.not29.us, label %"for blur_y.s0.y.yi.yii.yiii.preheader", label %"for blur_x.s0.y.rebased.us"

"for blur_y.s0.y.yi.yii.yiii.preheader":          ; preds = %"end for blur_x.s0.x.x.loopexit.us", %pseudostack_alloc.exit44
  %625 = zext i32 %blur_y.s0.y.min_2.s to i64
  %626 = getelementptr inbounds i8, i8* %600, i64 32
  %627 = bitcast i8* %626 to i16*
  %628 = getelementptr inbounds i8, i8* %600, i64 64
  %629 = bitcast i8* %628 to i16*
  %630 = getelementptr inbounds i8, i8* %600, i64 32
  %631 = bitcast i8* %630 to i16*
  %632 = getelementptr inbounds i8, i8* %600, i64 -32
  %633 = bitcast i8* %632 to i16*
  br label %"for blur_y.s0.y.yi.yii.yiii"

"for blur_y.s0.y.yi.yii.yiii":                    ; preds = %after_bb, %"for blur_y.s0.y.yi.yii.yiii.preheader"
  %indvars.iv93 = phi i64 [ 0, %"for blur_y.s0.y.yi.yii.yiii.preheader" ], [ %indvars.iv.next94, %after_bb ]
  %634 = add nuw nsw i64 %indvars.iv93, %625
  %635 = mul nsw i64 %indvars.iv93, %84
  br i1 %71, label %"for blur_y.s0.x.x.preheader", label %"end for blur_y.s0.x.x", !prof !374

"for blur_y.s0.x.x.preheader":                    ; preds = %"for blur_y.s0.y.yi.yii.yiii"
  %636 = add nsw i64 %634, %75
  %637 = mul nsw i64 %636, %76
  %638 = add nsw i64 %637, %86
  br label %"for blur_y.s0.x.x"

"end for blur_y.s0.y.yi.yii.yiii":                ; preds = %after_bb
  %639 = add nuw nsw i32 %blur_y.s0.y.yi.yii.yii, 1
  %.not31 = icmp eq i32 %639, 5
  br i1 %.not31, label %"end for blur_y.s0.y.yi.yii.yii", label %"for blur_y.s0.y.yi.yii.yii"

"for blur_y.s0.x.x":                              ; preds = %"for blur_y.s0.x.x", %"for blur_y.s0.x.x.preheader"
  %indvars.iv90 = phi i64 [ 0, %"for blur_y.s0.x.x.preheader" ], [ %indvars.iv.next91, %"for blur_y.s0.x.x" ]
  %640 = shl nsw i64 %indvars.iv90, 4
  %641 = add nsw i64 %640, %635
  %642 = add nsw i64 %641, %72
  %643 = getelementptr inbounds i16, i16* %627, i64 %642
  %644 = bitcast i16* %643 to <16 x i16>*
  %645 = load <16 x i16>, <16 x i16>* %644, align 32, !tbaa !384
  %646 = add nsw i64 %641, %73
  %647 = getelementptr inbounds i16, i16* %629, i64 %646
  %648 = bitcast i16* %647 to <16 x i16>*
  %649 = load <16 x i16>, <16 x i16>* %648, align 32, !tbaa !384
  %650 = getelementptr inbounds i16, i16* %blur_x, i64 %641
  %651 = bitcast i16* %650 to <16 x i16>*
  %652 = load <16 x i16>, <16 x i16>* %651, align 32, !tbaa !384
  %653 = add <16 x i16> %649, %645
  %654 = add <16 x i16> %653, %652
  %655 = tail call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %654, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %656 = lshr <16 x i16> %655, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %657 = add nsw i64 %640, %638
  %658 = getelementptr inbounds i16, i16* %blur_y, i64 %657
  %659 = bitcast i16* %658 to <16 x i16>*
  store <16 x i16> %656, <16 x i16>* %659, align 2, !tbaa !386
  %indvars.iv.next91 = add nuw nsw i64 %indvars.iv90, 1
  %.not33 = icmp eq i64 %indvars.iv.next91, %85
  br i1 %.not33, label %"end for blur_y.s0.x.x", label %"for blur_y.s0.x.x"

"end for blur_y.s0.x.x":                          ; preds = %"for blur_y.s0.x.x", %"for blur_y.s0.y.yi.yii.yiii"
  br i1 %t305, label %then_bb, label %after_bb

after_bb:                                         ; preds = %then_bb, %"end for blur_y.s0.x.x"
  %indvars.iv.next94 = add nuw nsw i64 %indvars.iv93, 1
  %.not30 = icmp eq i64 %indvars.iv.next94, 4
  br i1 %.not30, label %"end for blur_y.s0.y.yi.yii.yiii", label %"for blur_y.s0.y.yi.yii.yiii"

then_bb:                                          ; preds = %"end for blur_y.s0.x.x"
  %660 = add nsw i64 %635, %74
  %661 = add nsw i64 %660, %72
  %662 = getelementptr inbounds i16, i16* %blur_x, i64 %661
  %663 = bitcast i16* %662 to <16 x i16>*
  %664 = load <16 x i16>, <16 x i16>* %663, align 2, !tbaa !384
  %665 = add nsw i64 %660, %73
  %666 = getelementptr inbounds i16, i16* %631, i64 %665
  %667 = bitcast i16* %666 to <16 x i16>*
  %668 = load <16 x i16>, <16 x i16>* %667, align 2, !tbaa !384
  %669 = getelementptr inbounds i16, i16* %633, i64 %660
  %670 = bitcast i16* %669 to <16 x i16>*
  %671 = load <16 x i16>, <16 x i16>* %670, align 2, !tbaa !384
  %672 = add <16 x i16> %668, %664
  %673 = add <16 x i16> %672, %671
  %674 = tail call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %673, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %675 = lshr <16 x i16> %674, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %676 = add nsw i64 %634, %75
  %677 = mul nsw i64 %676, %76
  %678 = add nsw i64 %677, %77
  %679 = getelementptr inbounds i16, i16* %87, i64 %678
  %680 = bitcast i16* %679 to <16 x i16>*
  store <16 x i16> %675, <16 x i16>* %680, align 2, !tbaa !386
  br label %after_bb
}

; Function Attrs: nounwind
define i32 @blur3x3_batch_0079_sample_0017_argv(i8** nocapture readonly %0) local_unnamed_addr #11 {
entry:
  ...
  %6 = tail call i32 @blur3x3_batch_0079_sample_0017(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #15
  ret i32 %6
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @blur3x3_batch_0079_sample_0017_metadata() local_unnamed_addr #12 {
entry:
  ret %struct.halide_filter_metadata_t* @blur3x3_batch_0079_sample_0017_metadata_storage
}
...
!381 = !{!"Halide buffer"}
!382 = !{!383, !383, i64 0}
!383 = !{!"repeat_edge", !381, i64 0}
!384 = !{!385, !385, i64 0}
!385 = !{!"blur_x", !381, i64 0}
!386 = !{!387, !387, i64 0}
!387 = !{!"blur_y", !381, i64 0}
