; ModuleID = '/home/sb54/Hydride/hexagon-benchmarks/rake/benchmarks/hexagon/halide/matmul_256_32bit/samples/batch_25_0/2/matmul_256_32bit_batch_0025_sample_0002.bc'
...
%closure_t = type { i32, i32, i32, i32, i32, i16*, %struct.halide_buffer_t*, i16*, %struct.halide_buffer_t*, i32*, %struct.halide_buffer_t* }
...
; Function Attrs: nounwind
define i32 @matmul_256_32bit_batch_0025_sample_0002(%struct.halide_buffer_t* noalias %A.buffer, %struct.halide_buffer_t* noalias %B.buffer, %struct.halide_buffer_t* noalias %res.buffer) local_unnamed_addr #9 {
entry:
...
after_bb8:                                        ; preds = %_halide_buffer_is_bounds_query.exit65
  ...
  store i8 32, i8* %120, align 1, !tbaa !369
...
assert_failed17:                                  ; preds = %then_bb12
  %305 = call i32 @halide_error_bad_type(i8* null, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @str.207, i64 0, i64 0), i32 %62, i32 73728) #11
  ret i32 %305
...
"produce res":                                    ; preds = %no_errors_bb
  ...
  %t36 = add nsw i32 %347, %46
  %348 = mul nsw i32 %32, %28
  %t37 = add nsw i32 %348, %22
  ...
  %364 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @matmul_256_32bit_batch_0025_sample_0002.par_for.res.s0.y.y, i32 0, i32 64, i8* nonnull %363)
  ret i32 %364
}
...
define internal i32 @matmul_256_32bit_batch_0025_sample_0002.par_for.res.s0.y.y(i8* nocapture readnone %__user_context, i32 %res.s0.y.y, i8* noalias nocapture readonly %closure) #10 {
entry:
  ...
  %t36 = load i32, i32* %6, align 4
  %7 = getelementptr inbounds i8, i8* %closure, i64 16
  %8 = bitcast i8* %7 to i32*
  %t37 = load i32, i32* %8, align 4
  ...
  %14 = bitcast i8* %13 to i32**
  %res = load i32*, i32** %14, align 8
  %t46 = shl i32 %res.s0.y.y, 2
  %t47 = or i32 %t46, 1
  %t48 = or i32 %t46, 2
  %t49 = or i32 %t46, 3
  %t45 = mul nsw i32 %res.stride.1, %t49
  %t44 = mul nsw i32 %res.stride.1, %t48
  %t43 = mul nsw i32 %res.stride.1, %t47
  %t42 = mul nsw i32 %res.stride.1, %res.s0.y.y
  %15 = mul i32 %t46, %A.stride.1
  %t38 = sub nsw i32 %15, %t37
  %16 = mul nsw i32 %A.stride.1, %t49
  %t41 = sub nsw i32 %16, %t37
  %17 = mul nsw i32 %A.stride.1, %t48
  %t40 = sub nsw i32 %17, %t37
  %18 = mul nsw i32 %A.stride.1, %t47
  %t39 = sub nsw i32 %18, %t37
  %19 = sext i32 %B.stride.1 to i64
  %20 = sext i32 %t38 to i64
  %21 = sext i32 %t39 to i64
  %22 = sext i32 %t40 to i64
  %23 = sext i32 %t41 to i64
  %24 = sext i32 %t42 to i64
  %25 = sext i32 %t43 to i64
  %26 = sext i32 %t44 to i64
  %27 = sext i32 %t45 to i64
  %28 = sext i32 %t36 to i64
  br label %"for res.s0.x.x"

"for res.s0.x.x":                                 ; preds = %"consume matrix_mul", %entry
  %indvars.iv25 = phi i64 [ 0, %entry ], [ %indvars.iv.next26, %"consume matrix_mul" ]
  %29 = shl nsw i64 %indvars.iv25, 6
  %30 = sub nsw i64 %29, %28
  br label %"for matrix_mul.s1.r8$x"

"for matrix_mul.s1.r8$x":                         ; preds = %"for matrix_mul.s1.r8$x", %"for res.s0.x.x"
  %indvars.iv = phi i64 [ 0, %"for res.s0.x.x" ], [ %indvars.iv.next, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul1.sroa.28.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %74, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul1.sroa.24.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %72, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul1.sroa.20.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %65, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul1.sroa.16.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %63, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul1.sroa.12.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %56, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul1.sroa.8.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %54, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul1.sroa.4.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %47, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul1.sroa.0.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %42, %"for matrix_mul.s1.r8$x" ]
  %31 = mul nsw i64 %indvars.iv, %19
  %32 = add nsw i64 %31, %30
  %33 = getelementptr inbounds i16, i16* %B, i64 %32
  %34 = bitcast i16* %33 to <32 x i16>*
  %35 = load <32 x i16>, <32 x i16>* %34, align 2, !tbaa !374
  %36 = add nsw i64 %indvars.iv, %20
  %37 = getelementptr inbounds i16, i16* %A, i64 %36
  %38 = load i16, i16* %37, align 2, !tbaa !377
  %39 = insertelement <32 x i16> undef, i16 %38, i32 0
  %40 = shufflevector <32 x i16> %39, <32 x i16> undef, <32 x i32> zeroinitializer
  %41 = mul <32 x i16> %40, %35
  %42 = add <32 x i16> %41, %matrix_mul1.sroa.0.0
  %43 = getelementptr inbounds i16, i16* %33, i64 32
  %44 = bitcast i16* %43 to <32 x i16>*
  %45 = load <32 x i16>, <32 x i16>* %44, align 2, !tbaa !374
  %46 = mul <32 x i16> %40, %45
  %47 = add <32 x i16> %46, %matrix_mul1.sroa.4.0
  %48 = add nsw i64 %indvars.iv, %21
  %49 = getelementptr inbounds i16, i16* %A, i64 %48
  %50 = load i16, i16* %49, align 2, !tbaa !377
  %51 = insertelement <32 x i16> undef, i16 %50, i32 0
  %52 = shufflevector <32 x i16> %51, <32 x i16> undef, <32 x i32> zeroinitializer
  %53 = mul <32 x i16> %52, %35
  %54 = add <32 x i16> %53, %matrix_mul1.sroa.8.0
  %55 = mul <32 x i16> %52, %45
  %56 = add <32 x i16> %55, %matrix_mul1.sroa.12.0
  %57 = add nsw i64 %indvars.iv, %22
  %58 = getelementptr inbounds i16, i16* %A, i64 %57
  %59 = load i16, i16* %58, align 2, !tbaa !377
  %60 = insertelement <32 x i16> undef, i16 %59, i32 0
  %61 = shufflevector <32 x i16> %60, <32 x i16> undef, <32 x i32> zeroinitializer
  %62 = mul <32 x i16> %61, %35
  %63 = add <32 x i16> %62, %matrix_mul1.sroa.16.0
  %64 = mul <32 x i16> %61, %45
  %65 = add <32 x i16> %64, %matrix_mul1.sroa.20.0
  %66 = add nsw i64 %indvars.iv, %23
  %67 = getelementptr inbounds i16, i16* %A, i64 %66
  %68 = load i16, i16* %67, align 2, !tbaa !377
  %69 = insertelement <32 x i16> undef, i16 %68, i32 0
  %70 = shufflevector <32 x i16> %69, <32 x i16> undef, <32 x i32> zeroinitializer
  %71 = mul <32 x i16> %70, %35
  %72 = add <32 x i16> %71, %matrix_mul1.sroa.24.0
  %73 = mul <32 x i16> %70, %45
  %74 = add <32 x i16> %73, %matrix_mul1.sroa.28.0
...
"consume matrix_mul":                             ; preds = %"for matrix_mul.s1.r8$x"
  %75 = sext <32 x i16> %42 to <32 x i32>
  %76 = shufflevector <32 x i32> %75, <32 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %77 = shl nuw nsw i64 %indvars.iv25, 4
  %78 = add nsw i64 %77, %24
  %79 = shl nsw i64 %78, 2
  %80 = getelementptr inbounds i32, i32* %res, i64 %79
  %81 = bitcast i32* %80 to <16 x i32>*
  store <16 x i32> %76, <16 x i32>* %81, align 4, !tbaa !379
  %82 = shufflevector <32 x i32> %75, <32 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %83 = getelementptr inbounds i32, i32* %80, i64 16
  %84 = bitcast i32* %83 to <16 x i32>*
  store <16 x i32> %82, <16 x i32>* %84, align 4, !tbaa !379
  %85 = sext <32 x i16> %47 to <32 x i32>
  %86 = shufflevector <32 x i32> %85, <32 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %87 = getelementptr inbounds i32, i32* %80, i64 32
  %88 = bitcast i32* %87 to <16 x i32>*
  store <16 x i32> %86, <16 x i32>* %88, align 4, !tbaa !379
  %89 = shufflevector <32 x i32> %85, <32 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %90 = getelementptr inbounds i32, i32* %80, i64 48
  %91 = bitcast i32* %90 to <16 x i32>*
  store <16 x i32> %89, <16 x i32>* %91, align 4, !tbaa !379
  %92 = sext <32 x i16> %54 to <32 x i32>
  %93 = shufflevector <32 x i32> %92, <32 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %94 = add nsw i64 %29, %25
  %95 = getelementptr inbounds i32, i32* %res, i64 %94
  %96 = bitcast i32* %95 to <16 x i32>*
  store <16 x i32> %93, <16 x i32>* %96, align 4, !tbaa !379
  %97 = shufflevector <32 x i32> %92, <32 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %98 = getelementptr inbounds i32, i32* %95, i64 16
  %99 = bitcast i32* %98 to <16 x i32>*
  store <16 x i32> %97, <16 x i32>* %99, align 4, !tbaa !379
  %100 = sext <32 x i16> %56 to <32 x i32>
  %101 = shufflevector <32 x i32> %100, <32 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %102 = getelementptr inbounds i32, i32* %95, i64 32
  %103 = bitcast i32* %102 to <16 x i32>*
  store <16 x i32> %101, <16 x i32>* %103, align 4, !tbaa !379
  %104 = shufflevector <32 x i32> %100, <32 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %105 = getelementptr inbounds i32, i32* %95, i64 48
  %106 = bitcast i32* %105 to <16 x i32>*
  store <16 x i32> %104, <16 x i32>* %106, align 4, !tbaa !379
  %107 = sext <32 x i16> %63 to <32 x i32>
  %108 = shufflevector <32 x i32> %107, <32 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %109 = add nsw i64 %29, %26
  %110 = getelementptr inbounds i32, i32* %res, i64 %109
  %111 = bitcast i32* %110 to <16 x i32>*
  store <16 x i32> %108, <16 x i32>* %111, align 4, !tbaa !379
  %112 = shufflevector <32 x i32> %107, <32 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %113 = getelementptr inbounds i32, i32* %110, i64 16
  %114 = bitcast i32* %113 to <16 x i32>*
  store <16 x i32> %112, <16 x i32>* %114, align 4, !tbaa !379
  %115 = sext <32 x i16> %65 to <32 x i32>
  %116 = shufflevector <32 x i32> %115, <32 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %117 = getelementptr inbounds i32, i32* %110, i64 32
  %118 = bitcast i32* %117 to <16 x i32>*
  store <16 x i32> %116, <16 x i32>* %118, align 4, !tbaa !379
  %119 = shufflevector <32 x i32> %115, <32 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %120 = getelementptr inbounds i32, i32* %110, i64 48
  %121 = bitcast i32* %120 to <16 x i32>*
  store <16 x i32> %119, <16 x i32>* %121, align 4, !tbaa !379
  %122 = sext <32 x i16> %72 to <32 x i32>
  %123 = shufflevector <32 x i32> %122, <32 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %124 = add nsw i64 %29, %27
  %125 = getelementptr inbounds i32, i32* %res, i64 %124
  %126 = bitcast i32* %125 to <16 x i32>*
  store <16 x i32> %123, <16 x i32>* %126, align 4, !tbaa !379
  %127 = shufflevector <32 x i32> %122, <32 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %128 = getelementptr inbounds i32, i32* %125, i64 16
  %129 = bitcast i32* %128 to <16 x i32>*
  store <16 x i32> %127, <16 x i32>* %129, align 4, !tbaa !379
  %130 = sext <32 x i16> %74 to <32 x i32>
  %131 = shufflevector <32 x i32> %130, <32 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %132 = getelementptr inbounds i32, i32* %125, i64 32
  %133 = bitcast i32* %132 to <16 x i32>*
  store <16 x i32> %131, <16 x i32>* %133, align 4, !tbaa !379
  %134 = shufflevector <32 x i32> %130, <32 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %135 = getelementptr inbounds i32, i32* %125, i64 48
  %136 = bitcast i32* %135 to <16 x i32>*
  store <16 x i32> %134, <16 x i32>* %136, align 4, !tbaa !379
  %indvars.iv.next26 = add nuw nsw i64 %indvars.iv25, 1
  %.not2 = icmp eq i64 %indvars.iv.next26, 4
  br i1 %.not2, label %destructor_block, label %"for res.s0.x.x"
...
; Function Attrs: nounwind
define i32 @matmul_256_32bit_batch_0025_sample_0002_argv(i8** nocapture readonly %0) local_unnamed_addr #11 {
entry:
  ...
  %9 = tail call i32 @matmul_256_32bit_batch_0025_sample_0002(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5, %struct.halide_buffer_t* %8) #15
  ret i32 %9
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @matmul_256_32bit_batch_0025_sample_0002_metadata() local_unnamed_addr #12 {
entry:
  ret %struct.halide_filter_metadata_t* @matmul_256_32bit_batch_0025_sample_0002_metadata_storage
}
