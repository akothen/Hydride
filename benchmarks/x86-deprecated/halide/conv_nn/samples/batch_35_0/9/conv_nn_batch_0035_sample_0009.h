#ifndef HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___conv_nn___samples___batch_35_0___9___conv_nn_batch_0035_sample_0009_h
#define HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___conv_nn___samples___batch_35_0___9___conv_nn_batch_0035_sample_0009_h
#include <stdint.h>
...
int conv_nn_batch_0035_sample_0009(struct halide_buffer_t *_input_buffer, uint8_t _input_zero, struct halide_buffer_t *_filter_buffer, uint8_t _filter_zero, struct halide_buffer_t *_bias_buffer, int32_t _stride_x, int32_t _stride_y, int32_t _dilation_x, int32_t _dilation_y, int32_t _output_multiplier, int32_t _output_shift, uint8_t _output_zero, uint8_t _output_min, uint8_t _output_max, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int conv_nn_batch_0035_sample_0009_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *conv_nn_batch_0035_sample_0009_metadata();
