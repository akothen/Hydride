; ModuleID = '/home/sb54/Hydride/hexagon-benchmarks/rake/benchmarks/hexagon/halide/matmul_1024/samples/batch_48_0/7/matmul_1024_batch_0048_sample_0007.bc'
...
@11 = private constant i64 1024
@12 = private constant i64 0
@13 = private constant i64 1024
...
@str.215 = private constant [35 x i8] c"matmul_1024_batch_0048_sample_0007\00", align 64
@matmul_1024_batch_0048_sample_0007_metadata_storage = private constant %struct.halide_filter_metadata_t { i32 1, i32 3, %struct.halide_filter_argument_t* getelementptr inbounds ([3 x %struct.halide_filter_argument_t], [3 x %struct.halide_filter_argument_t]* @15, i32 0, i32 0), i8* getelementptr inbounds ([121 x i8], [121 x i8]* @str.214, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @str.215, i32 0, i32 0) }
...
; Function Attrs: nounwind
define i32 @matmul_1024_batch_0048_sample_0007(%struct.halide_buffer_t* noalias %A.buffer, %struct.halide_buffer_t* noalias %B.buffer, %struct.halide_buffer_t* noalias %res.buffer) local_unnamed_addr #9 {
entry:
...
_halide_buffer_init.exit:                         ; preds = %_halide_buffer_is_bounds_query.exit
  ...
  store <8 x i32> <i32 0, i32 1024, i32 1, i32 0, i32 0, i32 1024, i32 1024, i32 0>, <8 x i32>* %6, align 4
...
_halide_buffer_init.exit67:                       ; preds = %_halide_buffer_is_bounds_query.exit64
  ...
  store <8 x i32> <i32 0, i32 1024, i32 1, i32 0, i32 0, i32 1024, i32 1024, i32 0>, <8 x i32>* %5, align 4
...
after_bb8:                                        ; preds = %_halide_buffer_is_bounds_query.exit65
  ...
  store <8 x i32> <i32 0, i32 1024, i32 1, i32 0, i32 0, i32 1024, i32 1024, i32 0>, <8 x i32>* %4, align 4
...
assert_failed19:                                  ; preds = %then_bb12
  ...
  %308 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.205, i64 0, i64 0), i32 0, i32 0, i32 1023, i32 %22, i32 %307) #11
  ret i32 %308
...
assert_failed21:                                  ; preds = %then_bb12
  ...
  %311 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.205, i64 0, i64 0), i32 1, i32 0, i32 1023, i32 %28, i32 %310) #11
  ret i32 %311
...
assert_failed23:                                  ; preds = %then_bb12
  ...
  %314 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.206, i64 0, i64 0), i32 0, i32 0, i32 1023, i32 %46, i32 %313) #11
  ret i32 %314
...
assert_failed25:                                  ; preds = %then_bb12
  ...
  %317 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.206, i64 0, i64 0), i32 1, i32 0, i32 1023, i32 %52, i32 %316) #11
  ret i32 %317
...
assert_failed27:                                  ; preds = %then_bb12
  ...
  %320 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @str.207, i64 0, i64 0), i32 0, i32 0, i32 1023, i32 %70, i32 %319) #11
  ret i32 %320
...
assert_failed29:                                  ; preds = %then_bb12
  ...
  %323 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @str.207, i64 0, i64 0), i32 1, i32 0, i32 1023, i32 %76, i32 %322) #11
  ret i32 %323
...
assert_failed50:                                  ; preds = %no_errors_bb
  ...
  %344 = call i32 @halide_error_explicit_bounds_too_small(i8* null, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.212, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str, i64 0, i64 0), i32 0, i32 1023, i32 %76, i32 %343) #11
  ret i32 %344

assert_failed51:                                  ; preds = %no_errors_bb
  %345 = add nsw i32 %189, -1
  %346 = call i32 @halide_error_explicit_bounds_too_small(i8* null, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.18.77, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str, i64 0, i64 0), i32 0, i32 1023, i32 %70, i32 %345) #11
  ret i32 %346
...
"produce res":                                    ; preds = %no_errors_bb
  ...
  %364 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @matmul_1024_batch_0048_sample_0007.par_for.res.s0.y.y, i32 0, i32 128, i8* nonnull %363)
  ret i32 %364
}
...
define internal i32 @matmul_1024_batch_0048_sample_0007.par_for.res.s0.y.y(i8* nocapture readnone %__user_context, i32 %res.s0.y.y, i8* noalias nocapture readonly %closure) #10 {
entry:
  ...
  %t38 = shl nsw i32 %res.s0.y.y, 1
  %15 = shl i32 %A.stride.1, 2
  %16 = sext i32 %B.stride.1 to i64
  %17 = sext i32 %t36 to i64
  %t47.0 = or i32 %t38, 0
  br label %"for res.s0.y.yi.yi"

"for res.s0.y.yi.yi":                             ; preds = %"end for res.s0.x.x.for res.s0.y.yi.yi_crit_edge", %entry
  %.not4 = phi i1 [ false, %entry ], [ true, %"end for res.s0.x.x.for res.s0.y.yi.yi_crit_edge" ]
  %t47.phi = phi i32 [ %t47.0, %entry ], [ %t47.1, %"end for res.s0.x.x.for res.s0.y.yi.yi_crit_edge" ]
  %t48 = shl nsw i32 %t47.phi, 2
  %t49 = or i32 %t48, 1
  %t50 = or i32 %t48, 2
  %t51 = or i32 %t48, 3
  %t46 = mul nsw i32 %t51, %res.stride.1
  %t45 = mul nsw i32 %t50, %res.stride.1
  %t44 = mul nsw i32 %t49, %res.stride.1
  %t43 = mul nsw i32 %t47.phi, %res.stride.1
  %18 = mul i32 %15, %t47.phi
  %t39 = sub nsw i32 %18, %t37
  %19 = mul nsw i32 %t51, %A.stride.1
  %t42 = sub nsw i32 %19, %t37
  %20 = mul nsw i32 %t50, %A.stride.1
  %t41 = sub nsw i32 %20, %t37
  %21 = mul nsw i32 %t49, %A.stride.1
  %t40 = sub nsw i32 %21, %t37
  %22 = sext i32 %t39 to i64
  %23 = sext i32 %t40 to i64
  %24 = sext i32 %t41 to i64
  %25 = sext i32 %t42 to i64
  %26 = sext i32 %t43 to i64
  %27 = sext i32 %t44 to i64
  %28 = sext i32 %t45 to i64
  %29 = sext i32 %t46 to i64
  br label %"for res.s0.x.x"

"for res.s0.x.x":                                 ; preds = %"consume matrix_mul", %"for res.s0.y.yi.yi"
  %indvars.iv27 = phi i64 [ 0, %"for res.s0.y.yi.yi" ], [ %indvars.iv.next28, %"consume matrix_mul" ]
  %30 = shl nsw i64 %indvars.iv27, 6
  %31 = sub nsw i64 %30, %17
  br label %"for matrix_mul.s1.r8$x"

"end for res.s0.x.x":                             ; preds = %"consume matrix_mul"
  br i1 %.not4, label %destructor_block, label %"end for res.s0.x.x.for res.s0.y.yi.yi_crit_edge"

"end for res.s0.x.x.for res.s0.y.yi.yi_crit_edge": ; preds = %"end for res.s0.x.x"
  %t47.1 = or i32 %t38, 1
  br label %"for res.s0.y.yi.yi"
...
"for matrix_mul.s1.r8$x":                         ; preds = %"for matrix_mul.s1.r8$x", %"for res.s0.x.x"
  ...
  %matrix_mul2.sroa.28.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %75, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul2.sroa.24.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %73, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul2.sroa.20.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %66, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul2.sroa.16.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %64, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul2.sroa.12.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %57, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul2.sroa.8.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %55, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul2.sroa.4.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %48, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul2.sroa.0.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.x" ], [ %43, %"for matrix_mul.s1.r8$x" ]
  %32 = mul nsw i64 %indvars.iv, %16
  %33 = add nsw i64 %32, %31
  %34 = getelementptr inbounds i16, i16* %B, i64 %33
  %35 = bitcast i16* %34 to <32 x i16>*
  %36 = load <32 x i16>, <32 x i16>* %35, align 2, !tbaa !374
  %37 = add nsw i64 %indvars.iv, %22
  %38 = getelementptr inbounds i16, i16* %A, i64 %37
  %39 = load i16, i16* %38, align 2, !tbaa !377
  %40 = insertelement <32 x i16> undef, i16 %39, i32 0
  %41 = shufflevector <32 x i16> %40, <32 x i16> undef, <32 x i32> zeroinitializer
  %42 = mul <32 x i16> %41, %36
  %43 = add <32 x i16> %42, %matrix_mul2.sroa.0.0
  %44 = getelementptr inbounds i16, i16* %34, i64 32
  %45 = bitcast i16* %44 to <32 x i16>*
  %46 = load <32 x i16>, <32 x i16>* %45, align 2, !tbaa !374
  %47 = mul <32 x i16> %41, %46
  %48 = add <32 x i16> %47, %matrix_mul2.sroa.4.0
  %49 = add nsw i64 %indvars.iv, %23
  %50 = getelementptr inbounds i16, i16* %A, i64 %49
  %51 = load i16, i16* %50, align 2, !tbaa !377
  %52 = insertelement <32 x i16> undef, i16 %51, i32 0
  %53 = shufflevector <32 x i16> %52, <32 x i16> undef, <32 x i32> zeroinitializer
  %54 = mul <32 x i16> %53, %36
  %55 = add <32 x i16> %54, %matrix_mul2.sroa.8.0
  %56 = mul <32 x i16> %53, %46
  %57 = add <32 x i16> %56, %matrix_mul2.sroa.12.0
  %58 = add nsw i64 %indvars.iv, %24
  %59 = getelementptr inbounds i16, i16* %A, i64 %58
  %60 = load i16, i16* %59, align 2, !tbaa !377
  %61 = insertelement <32 x i16> undef, i16 %60, i32 0
  %62 = shufflevector <32 x i16> %61, <32 x i16> undef, <32 x i32> zeroinitializer
  %63 = mul <32 x i16> %62, %36
  %64 = add <32 x i16> %63, %matrix_mul2.sroa.16.0
  %65 = mul <32 x i16> %62, %46
  %66 = add <32 x i16> %65, %matrix_mul2.sroa.20.0
  %67 = add nsw i64 %indvars.iv, %25
  %68 = getelementptr inbounds i16, i16* %A, i64 %67
  %69 = load i16, i16* %68, align 2, !tbaa !377
  %70 = insertelement <32 x i16> undef, i16 %69, i32 0
  %71 = shufflevector <32 x i16> %70, <32 x i16> undef, <32 x i32> zeroinitializer
  %72 = mul <32 x i16> %71, %36
  %73 = add <32 x i16> %72, %matrix_mul2.sroa.24.0
  %74 = mul <32 x i16> %71, %46
  %75 = add <32 x i16> %74, %matrix_mul2.sroa.28.0
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.not = icmp eq i64 %indvars.iv.next, 1024
  br i1 %.not, label %"consume matrix_mul", label %"for matrix_mul.s1.r8$x"

"consume matrix_mul":                             ; preds = %"for matrix_mul.s1.r8$x"
  %76 = shl nuw nsw i64 %indvars.iv27, 4
  %77 = add nsw i64 %76, %26
  %78 = shl nsw i64 %77, 2
  %79 = getelementptr inbounds i16, i16* %res, i64 %78
  %80 = bitcast i16* %79 to <32 x i16>*
  store <32 x i16> %43, <32 x i16>* %80, align 2, !tbaa !379
  %81 = getelementptr inbounds i16, i16* %79, i64 32
  %82 = bitcast i16* %81 to <32 x i16>*
  store <32 x i16> %48, <32 x i16>* %82, align 2, !tbaa !379
  %83 = add nsw i64 %30, %27
  %84 = getelementptr inbounds i16, i16* %res, i64 %83
  %85 = bitcast i16* %84 to <32 x i16>*
  store <32 x i16> %55, <32 x i16>* %85, align 2, !tbaa !379
  %86 = getelementptr inbounds i16, i16* %84, i64 32
  %87 = bitcast i16* %86 to <32 x i16>*
  store <32 x i16> %57, <32 x i16>* %87, align 2, !tbaa !379
  %88 = add nsw i64 %30, %28
  %89 = getelementptr inbounds i16, i16* %res, i64 %88
  %90 = bitcast i16* %89 to <32 x i16>*
  store <32 x i16> %64, <32 x i16>* %90, align 2, !tbaa !379
  %91 = getelementptr inbounds i16, i16* %89, i64 32
  %92 = bitcast i16* %91 to <32 x i16>*
  store <32 x i16> %66, <32 x i16>* %92, align 2, !tbaa !379
  %93 = add nsw i64 %30, %29
  %94 = getelementptr inbounds i16, i16* %res, i64 %93
  %95 = bitcast i16* %94 to <32 x i16>*
  store <32 x i16> %73, <32 x i16>* %95, align 2, !tbaa !379
  %96 = getelementptr inbounds i16, i16* %94, i64 32
  %97 = bitcast i16* %96 to <32 x i16>*
  store <32 x i16> %75, <32 x i16>* %97, align 2, !tbaa !379
  %indvars.iv.next28 = add nuw nsw i64 %indvars.iv27, 1
  %.not3 = icmp eq i64 %indvars.iv.next28, 16
  br i1 %.not3, label %"end for res.s0.x.x", label %"for res.s0.x.x"

destructor_block:                                 ; preds = %"end for res.s0.x.x"
  ret i32 0
}

; Function Attrs: nounwind
define i32 @matmul_1024_batch_0048_sample_0007_argv(i8** nocapture readonly %0) local_unnamed_addr #11 {
entry:
  ...
  %9 = tail call i32 @matmul_1024_batch_0048_sample_0007(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5, %struct.halide_buffer_t* %8) #15
  ret i32 %9
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @matmul_1024_batch_0048_sample_0007_metadata() local_unnamed_addr #12 {
entry:
  ret %struct.halide_filter_metadata_t* @matmul_1024_batch_0048_sample_0007_metadata_storage
}
