#ifndef HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___matmul___samples___batch_63_0___19___matmul_batch_0063_sample_0019_h
#define HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___matmul___samples___batch_63_0___19___matmul_batch_0063_sample_0019_h
#include <stdint.h>
...
int matmul_batch_0063_sample_0019(struct halide_buffer_t *_mat_a_buffer, struct halide_buffer_t *_mat_b_buffer, struct halide_buffer_t *_bias_buffer, int16_t _mat_a_offset, int16_t _mat_b_offset, int32_t _output_multiplier, int32_t _output_shift, int32_t _output_offset, uint8_t _output_min, uint8_t _output_max, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int matmul_batch_0063_sample_0019_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *matmul_batch_0063_sample_0019_metadata();
