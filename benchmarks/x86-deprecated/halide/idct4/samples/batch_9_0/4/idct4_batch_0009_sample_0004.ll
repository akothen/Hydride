; ModuleID = '/home/sb54/Hydride/hexagon-benchmarks/rake/benchmarks/hexagon/halide/idct4/samples/batch_9_0/4/idct4_batch_0009_sample_0004.bc'
...
%closure_t.40 = type { i32, i32, i32, i32, i1, i32, i32, i32, i32, i32, i32, i16*, %struct.halide_buffer_t*, i32*, %struct.halide_buffer_t* }
...
; Function Attrs: nounwind
define i32 @idct4_batch_0009_sample_0004(%struct.halide_buffer_t* noalias %input.buffer, %struct.halide_buffer_t* noalias %output.buffer) local_unnamed_addr #10 {
entry:
...
destructor_block:                                 ; preds = %"consume src", %"assert succeeded35"
  %7 = phi i32 [ %262, %"assert succeeded35" ], [ %284, %"consume src" ]
...
_halide_buffer_init.exit:                         ; preds = %_halide_buffer_is_bounds_query.exit
  ...
  store <4 x i32> <i32 1, i32 0, i32 0, i32 4>, <4 x i32>* %78, align 4
...
assert_failed14:                                  ; preds = %then_bb7
  ...
  %216 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 1, i32 0, i32 3, i32 %29, i32 %215) #13
  ret i32 %216
...
no_errors_bb21:                                   ; preds = %no_errors_bb
  ...
  %t153 = zext i32 %226 to i64
  %227 = icmp ult i32 %226, 134217728
  %228 = shl nuw nsw i64 %t153, 4
...
"assert succeeded35":                             ; preds = %"assert succeeded33"
  ...
  %t128 = and i32 %49, -32
  %t129 = and i32 %49, 31
  %244 = icmp ne i32 %t129, 0
  %245 = add i32 %243, %23
  %246 = sub i32 %47, %245
  %t124 = add i32 %246, %t128
  ...
  %262 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @idct4_batch_0009_sample_0004.par_for.src.s0.y, i32 0, i32 4, i8* nonnull %261)
  %263 = icmp eq i32 %262, 0
  br i1 %263, label %"consume src", label %destructor_block, !prof !374

"consume src":                                    ; preds = %"assert succeeded35"
  %t144 = mul nsw i32 %a5, 3
  %t147 = mul nsw i32 %57, %53
  %264 = shl nsw i32 %t127, 4
  %265 = add nsw i32 %a5, %264
  %t140 = shl nsw i32 %265, 1
  %t143 = sub nsw i32 %t128, %t147
  %t136 = sub nsw i32 0, %t147
  %266 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 0
  store i32 %a5, i32* %266, align 8
  %267 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 1
  store i32 %53, i32* %267, align 4
  %268 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 2
  store i32 %57, i32* %268, align 8
  %269 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 3
  store i32 %t136, i32* %269, align 4
  %270 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 4
  store i1 %244, i1* %270, align 8
  %271 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 5
  store i32 %t140, i32* %271, align 4
  %272 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 6
  store i32 %t143, i32* %272, align 8
  %273 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 7
  store i32 %t144, i32* %273, align 4
  %274 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 8
  store i32 %t127, i32* %274, align 8
  %275 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 9
  store i32 %t128, i32* %275, align 4
  %276 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 10
  store i32 %t129, i32* %276, align 8
  %277 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 11
  %278 = bitcast i16** %277 to i8**
  store i8* %35, i8** %278, align 8
  %279 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 12
  store %struct.halide_buffer_t* %output.buffer, %struct.halide_buffer_t** %279, align 8
  %280 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 13
  %281 = bitcast i32** %280 to i8**
  store i8* %241, i8** %281, align 8
  %282 = getelementptr inbounds %closure_t.40, %closure_t.40* %2, i64 0, i32 14
  store %struct.halide_buffer_t* null, %struct.halide_buffer_t** %282, align 8
  %283 = bitcast %closure_t.40* %2 to i8*
  %284 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @idct4_batch_0009_sample_0004.par_for.output.s0.y.rebased, i32 0, i32 %55, i8* nonnull %283)
  %285 = icmp eq i32 %284, 0
  br i1 %285, label %call_destructor.exit53, label %destructor_block, !prof !374
...
define internal i32 @idct4_batch_0009_sample_0004.par_for.src.s0.y(i8* nocapture readnone %__user_context, i32 %src.s0.y, i8* noalias nocapture readonly %closure) #11 {
entry:
  ...
  %t131 = mul nsw i32 %input.extent.0.required, %src.s0.y
  %17 = mul nsw i32 %input.stride.1, %src.s0.y
  %18 = icmp sgt i32 %t127, 0
...
"for src.s0.x.x.preheader":                       ; preds = %entry
  ...
  %t121 = load i32, i32* %20, align 4
  %t130 = add nsw i32 %17, %t121
  %21 = sext i32 %t130 to i64
  %22 = sext i32 %t131 to i64
  %23 = zext i32 %t127 to i64
...
"end for src.s0.x.x":                             ; preds = %"for src.s0.x.x", %entry
  %37 = icmp sgt i32 %t129, 0
  %or.cond = and i1 %t122, %37
...
"for src.s0.x.xi.preheader":                      ; preds = %"end for src.s0.x.x"
  %t133 = add nsw i32 %t128, %t131
  %t132 = add nsw i32 %t124, %17
  %38 = sext i32 %t132 to i64
  %39 = sext i32 %t133 to i64
  %40 = zext i32 %t129 to i64
...
define internal i32 @idct4_batch_0009_sample_0004.par_for.output.s0.y.rebased(i8* nocapture readnone %__user_context, i32 %output.s0.y.rebased, i8* noalias nocapture readonly %closure) #12 {
entry:
  %0 = bitcast i8* %closure to i32*
  %input.extent.0.required = load i32, i32* %0, align 4
  %1 = getelementptr inbounds i8, i8* %closure, i64 4
  ...
  %t137 = load i1, i1* %6, align 1
  %7 = getelementptr inbounds i8, i8* %closure, i64 20
  %8 = bitcast i8* %7 to i32*
  %t140 = load i32, i32* %8, align 4
  %9 = getelementptr inbounds i8, i8* %closure, i64 24
  %10 = bitcast i8* %9 to i32*
  %t143 = load i32, i32* %10, align 4
  %11 = getelementptr inbounds i8, i8* %closure, i64 28
  %12 = bitcast i8* %11 to i32*
  %t144 = load i32, i32* %12, align 4
  %13 = getelementptr inbounds i8, i8* %closure, i64 32
  %14 = bitcast i8* %13 to i32*
  %t145 = load i32, i32* %14, align 4
  %15 = getelementptr inbounds i8, i8* %closure, i64 36
  %16 = bitcast i8* %15 to i32*
  %t146 = load i32, i32* %16, align 4
  %17 = getelementptr inbounds i8, i8* %closure, i64 40
  %18 = bitcast i8* %17 to i32*
  %t148 = load i32, i32* %18, align 4
  %19 = getelementptr inbounds i8, i8* %closure, i64 48
  %20 = bitcast i8* %19 to i16**
  %output = load i16*, i16** %20, align 8
  %21 = getelementptr inbounds i8, i8* %closure, i64 64
  %22 = bitcast i8* %21 to i32**
  %src = load i32*, i32** %22, align 8
  %t149 = add nsw i32 %output.min.1, %output.s0.y.rebased
  %23 = icmp sgt i32 %t145, 0
  br i1 %23, label %"for output.s0.x.x.preheader", label %"end for output.s0.x.x", !prof !374

"for output.s0.x.x.preheader":                    ; preds = %entry
  %24 = getelementptr inbounds i8, i8* %closure, i64 12
  %25 = bitcast i8* %24 to i32*
  %t136 = load i32, i32* %25, align 4
  %26 = sext i32 %input.extent.0.required to i64
  %27 = sext i32 %t144 to i64
  %28 = icmp eq i32 %t149, 0
  %29 = icmp eq i32 %t149, 1
  %30 = icmp eq i32 %t149, 2
  %31 = sext i32 %output.stride.1 to i64
  %32 = sext i32 %t149 to i64
  %33 = mul nsw i64 %31, %32
  %34 = sext i32 %t136 to i64
  %35 = add nsw i64 %33, %34
  %36 = zext i32 %t145 to i64
...
"for output.s0.x.x":                              ; preds = %"for output.s0.x.x", %"for output.s0.x.x.preheader"
  ...
  %37 = shl nuw nsw i64 %indvars.iv, 5
  %38 = getelementptr inbounds i32, i32* %src, i64 %37
  %39 = bitcast i32* %38 to <16 x i32>*
  %40 = load <16 x i32>, <16 x i32>* %39, align 64, !tbaa !378
  %41 = getelementptr inbounds i32, i32* %38, i64 16
  %42 = bitcast i32* %41 to <16 x i32>*
  %43 = load <16 x i32>, <16 x i32>* %42, align 64, !tbaa !378
  %t97 = shufflevector <16 x i32> %40, <16 x i32> %43, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %44 = shl nuw nsw i64 %indvars.iv, 4
  %45 = add nsw i64 %44, %26
  %46 = shl nsw i64 %45, 1
  %47 = getelementptr inbounds i32, i32* %src, i64 %46
  %48 = bitcast i32* %47 to <16 x i32>*
  %49 = load <16 x i32>, <16 x i32>* %48, align 8, !tbaa !378
  %50 = getelementptr inbounds i32, i32* %47, i64 16
  %51 = bitcast i32* %50 to <16 x i32>*
  %52 = load <16 x i32>, <16 x i32>* %51, align 8, !tbaa !378
  %t98 = shufflevector <16 x i32> %49, <16 x i32> %52, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %53 = add nsw i64 %37, %26
  %54 = getelementptr inbounds i32, i32* %src, i64 %53
  %55 = bitcast i32* %54 to <16 x i32>*
  %56 = load <16 x i32>, <16 x i32>* %55, align 4, !tbaa !378
  %57 = getelementptr inbounds i32, i32* %54, i64 16
  %58 = bitcast i32* %57 to <16 x i32>*
  %59 = load <16 x i32>, <16 x i32>* %58, align 4, !tbaa !378
  %t100 = shufflevector <16 x i32> %56, <16 x i32> %59, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %60 = add nsw i64 %37, %27
  %61 = getelementptr inbounds i32, i32* %src, i64 %60
  %62 = bitcast i32* %61 to <16 x i32>*
  %63 = load <16 x i32>, <16 x i32>* %62, align 4, !tbaa !378
  %64 = getelementptr inbounds i32, i32* %61, i64 16
  %65 = bitcast i32* %64 to <16 x i32>*
  %66 = load <16 x i32>, <16 x i32>* %65, align 4, !tbaa !378
  %t101 = shufflevector <16 x i32> %63, <16 x i32> %66, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %67 = mul nsw <32 x i32> %t100, <i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83, i32 83>
  %68 = mul nsw <32 x i32> %t101, <i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36>
  %t102 = add nsw <32 x i32> %68, %67
  %69 = mul nsw <32 x i32> %t100, <i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36, i32 36>
  %70 = mul nsw <32 x i32> %t101, <i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83, i32 -83>
  %t104 = add nsw <32 x i32> %70, %69
  %t115 = add nsw <32 x i32> %t98, %t97
  %t116 = sub nsw <32 x i32> %t97, %t98
  %71 = mul nsw <32 x i32> %t115, <i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65>
  %72 = add nsw <32 x i32> %t102, %71
  %73 = lshr <32 x i32> %72, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %74 = and <32 x i32> %73, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %75 = ashr <32 x i32> %72, <i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7>
  %76 = add nsw <32 x i32> %74, %75
  %77 = shufflevector <32 x i32> %76, <32 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %78 = shufflevector <32 x i32> %76, <32 x i32> undef, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15>
  %79 = tail call <16 x i16> @llvm.x86.avx2.packssdw(<8 x i32> %77, <8 x i32> %78) #13
  %80 = shufflevector <32 x i32> %76, <32 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %81 = shufflevector <16 x i32> %80, <16 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %82 = shufflevector <16 x i32> %80, <16 x i32> undef, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15>
  %83 = tail call <16 x i16> @llvm.x86.avx2.packssdw(<8 x i32> %81, <8 x i32> %82) #13
  %84 = shufflevector <16 x i16> %79, <16 x i16> %83, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %85 = mul nsw <32 x i32> %t116, <i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65, i32 65>
  %86 = add nsw <32 x i32> %t104, %85
  %87 = lshr <32 x i32> %86, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %88 = and <32 x i32> %87, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %89 = ashr <32 x i32> %86, <i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7>
  %90 = add nsw <32 x i32> %88, %89
  %91 = shufflevector <32 x i32> %90, <32 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %92 = shufflevector <32 x i32> %90, <32 x i32> undef, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15>
  %93 = tail call <16 x i16> @llvm.x86.avx2.packssdw(<8 x i32> %91, <8 x i32> %92) #13
  %94 = shufflevector <32 x i32> %90, <32 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %95 = shufflevector <16 x i32> %94, <16 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %96 = shufflevector <16 x i32> %94, <16 x i32> undef, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15>
  %97 = tail call <16 x i16> @llvm.x86.avx2.packssdw(<8 x i32> %95, <8 x i32> %96) #13
  %98 = shufflevector <16 x i16> %93, <16 x i16> %97, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %99 = sub nsw <32 x i32> %85, %t104
  %100 = lshr <32 x i32> %99, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %101 = and <32 x i32> %100, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %102 = ashr <32 x i32> %99, <i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7>
  %103 = add nsw <32 x i32> %101, %102
  %104 = shufflevector <32 x i32> %103, <32 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %105 = shufflevector <32 x i32> %103, <32 x i32> undef, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15>
  %106 = tail call <16 x i16> @llvm.x86.avx2.packssdw(<8 x i32> %104, <8 x i32> %105) #13
  %107 = shufflevector <32 x i32> %103, <32 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %108 = shufflevector <16 x i32> %107, <16 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %109 = shufflevector <16 x i32> %107, <16 x i32> undef, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15>
  %110 = tail call <16 x i16> @llvm.x86.avx2.packssdw(<8 x i32> %108, <8 x i32> %109) #13
  %111 = shufflevector <16 x i16> %106, <16 x i16> %110, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %112 = sub nsw <32 x i32> %71, %t102
  %113 = lshr <32 x i32> %112, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %114 = and <32 x i32> %113, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %115 = ashr <32 x i32> %112, <i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7, i32 7>
  %116 = add nsw <32 x i32> %114, %115
  %117 = shufflevector <32 x i32> %116, <32 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %118 = shufflevector <32 x i32> %116, <32 x i32> undef, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15>
  %119 = tail call <16 x i16> @llvm.x86.avx2.packssdw(<8 x i32> %117, <8 x i32> %118) #13
  %120 = shufflevector <32 x i32> %116, <32 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %121 = shufflevector <16 x i32> %120, <16 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %122 = shufflevector <16 x i32> %120, <16 x i32> undef, <8 x i32> <i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15>
  %123 = tail call <16 x i16> @llvm.x86.avx2.packssdw(<8 x i32> %121, <8 x i32> %122) #13
  %124 = shufflevector <16 x i16> %119, <16 x i16> %123, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %125 = select i1 %30, <32 x i16> %111, <32 x i16> %124
  %126 = select i1 %29, <32 x i16> %98, <32 x i16> %125
  %127 = select i1 %28, <32 x i16> %84, <32 x i16> %126
  %128 = add nsw i64 %35, %37
  %129 = getelementptr inbounds i16, i16* %output, i64 %128
  %130 = bitcast i16* %129 to <32 x i16>*
  store <32 x i16> %127, <32 x i16>* %130, align 2, !tbaa !381
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.not3 = icmp eq i64 %indvars.iv.next, %36
  br i1 %.not3, label %"end for output.s0.x.x", label %"for output.s0.x.x"

"end for output.s0.x.x":                          ; preds = %"for output.s0.x.x", %entry
  %131 = icmp sgt i32 %t148, 0
  %or.cond = and i1 %t137, %131
...
"for output.s0.x.xi.preheader":                   ; preds = %"end for output.s0.x.x"
  %t150 = add nsw i32 %t146, %input.extent.0.required
  %t151 = add nsw i32 %t146, %t144
  %132 = sext i32 %t146 to i64
  %133 = sext i32 %t140 to i64
  %134 = sext i32 %t150 to i64
  %135 = sext i32 %t151 to i64
  %136 = icmp eq i32 %t149, 0
  %137 = icmp eq i32 %t149, 1
  %138 = icmp eq i32 %t149, 2
  %139 = sext i32 %output.stride.1 to i64
  %140 = sext i32 %t149 to i64
  %141 = mul nsw i64 %139, %140
  %142 = sext i32 %t143 to i64
  %143 = add nsw i64 %141, %142
  %144 = zext i32 %t148 to i64
  br label %"for output.s0.x.xi"

"for output.s0.x.xi":                             ; preds = %"for output.s0.x.xi", %"for output.s0.x.xi.preheader"
  %indvars.iv4 = phi i64 [ 0, %"for output.s0.x.xi.preheader" ], [ %indvars.iv.next5, %"for output.s0.x.xi" ]
  %145 = add nsw i64 %indvars.iv4, %132
  %146 = getelementptr inbounds i32, i32* %src, i64 %145
  %t106 = load i32, i32* %146, align 4, !tbaa !378
  %147 = add nsw i64 %indvars.iv4, %133
  %148 = getelementptr inbounds i32, i32* %src, i64 %147
  %t107 = load i32, i32* %148, align 4, !tbaa !378
  %149 = add nsw i64 %indvars.iv4, %134
  %150 = getelementptr inbounds i32, i32* %src, i64 %149
  %t109 = load i32, i32* %150, align 4, !tbaa !378
  %151 = add nsw i64 %indvars.iv4, %135
  %152 = getelementptr inbounds i32, i32* %src, i64 %151
  %t110 = load i32, i32* %152, align 4, !tbaa !378
  %153 = mul nsw i32 %t109, 83
  %154 = mul nsw i32 %t110, 36
  %t111 = add nsw i32 %154, %153
  %155 = mul nsw i32 %t109, 36
  %156 = mul nsw i32 %t110, -83
  %t113 = add nsw i32 %156, %155
  %t118 = add nsw i32 %t107, %t106
  %t119 = sub nsw i32 %t106, %t107
  %157 = mul nsw i32 %t118, 65
  %158 = add i32 %157, 64
  %159 = add i32 %158, %t111
  %a7 = ashr i32 %159, 7
  %160 = icmp slt i32 %a7, 32767
  %a6 = select i1 %160, i32 %a7, i32 32767
  %161 = icmp sgt i32 %a6, -32768
  %162 = select i1 %161, i32 %a6, i32 -32768
  %163 = mul nsw i32 %t119, 65
  %164 = add i32 %163, 64
  %165 = add i32 %164, %t113
  %a9 = ashr i32 %165, 7
  %166 = icmp slt i32 %a9, 32767
  %a8 = select i1 %166, i32 %a9, i32 32767
  %167 = icmp sgt i32 %a8, -32768
  %168 = select i1 %167, i32 %a8, i32 -32768
  %169 = sub i32 %164, %t113
  %a11 = ashr i32 %169, 7
  %170 = icmp slt i32 %a11, 32767
  %a10 = select i1 %170, i32 %a11, i32 32767
  %171 = icmp sgt i32 %a10, -32768
  %172 = select i1 %171, i32 %a10, i32 -32768
  %173 = sub i32 %158, %t111
  %a13 = ashr i32 %173, 7
  %174 = icmp slt i32 %a13, 32767
  %a12 = select i1 %174, i32 %a13, i32 32767
  %175 = icmp sgt i32 %a12, -32768
  %176 = select i1 %175, i32 %a12, i32 -32768
  %.v = select i1 %138, i32 %172, i32 %176
  %.v1 = select i1 %137, i32 %168, i32 %.v
  %.v2 = select i1 %136, i32 %162, i32 %.v1
  %177 = trunc i32 %.v2 to i16
  %178 = add nsw i64 %143, %indvars.iv4
  %179 = getelementptr inbounds i16, i16* %output, i64 %178
  store i16 %177, i16* %179, align 2, !tbaa !381
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %.not = icmp eq i64 %indvars.iv.next5, %144
...
; Function Attrs: nounwind
define i32 @idct4_batch_0009_sample_0004_argv(i8** nocapture readonly %0) local_unnamed_addr #13 {
entry:
  ...
  %6 = tail call i32 @idct4_batch_0009_sample_0004(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #17
  ret i32 %6
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @idct4_batch_0009_sample_0004_metadata() local_unnamed_addr #14 {
entry:
  ret %struct.halide_filter_metadata_t* @idct4_batch_0009_sample_0004_metadata_storage
}
