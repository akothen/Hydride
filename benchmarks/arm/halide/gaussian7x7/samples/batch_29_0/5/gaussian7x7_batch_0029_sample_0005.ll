; ModuleID = '/home/sb54/Hydride/hexagon-benchmarks/rake/benchmarks/hexagon/halide/gaussian7x7/samples/batch_29_0/5/gaussian7x7_batch_0029_sample_0005.bc'
...
%closure_t = type { i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8*, %struct.halide_buffer_t*, i8*, %struct.halide_buffer_t* }
...
@str.209 = private constant [121 x i8] c"x86-64-linux-avx-avx2-avx512-avx512_cannonlake-avx512_sapphirerapids-avx512_skylake-disable_llvm_loop_opt-f16c-fma-sse41\00", align 64
@str.210 = private constant [35 x i8] c"gaussian7x7_batch_0029_sample_0005\00", align 64
@gaussian7x7_batch_0029_sample_0005_metadata_storage = private constant %struct.halide_filter_metadata_t { i32 1, i32 2, %struct.halide_filter_argument_t* getelementptr inbounds ([2 x %struct.halide_filter_argument_t], [2 x %struct.halide_filter_argument_t]* @10, i32 0, i32 0), i8* getelementptr inbounds ([121 x i8], [121 x i8]* @str.209, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @str.210, i32 0, i32 0) }
...
; Function Attrs: nounwind
define i32 @gaussian7x7_batch_0029_sample_0005(%struct.halide_buffer_t* noalias %input.buffer, %struct.halide_buffer_t* noalias %output.buffer) local_unnamed_addr #9 {
entry:
...
"assert succeeded":                               ; preds = %entry
  %.not34 = icmp eq %struct.halide_buffer_t* %input.buffer, null
  br i1 %.not34, label %destructor_block.sink.split, label %"assert succeeded2", !prof !367
...
"assert succeeded2":                              ; preds = %"assert succeeded"
  ...
  %a2 = sub nsw i32 -960, %46
  %b3 = add i32 %46, -1
  %.not35 = icmp slt i32 %a2, %46
  %t56 = select i1 %.not35, i32 %b3, i32 %a2
  %t56.lobit = ashr i32 %t56, 31
  %55 = sub nsw i32 %t56, %t56.lobit
  %56 = sdiv i32 %55, 960
  %a1 = add nsw i32 %56, %t56.lobit
  %57 = icmp sgt i32 %a1, 0
  %58 = select i1 %57, i32 %a1, i32 0
  %a0 = mul nuw nsw i32 %58, 960
  %b1 = add nsw i32 %46, -960
  %59 = icmp sgt i32 %b1, %a0
  %a22 = select i1 %59, i32 %a0, i32 %b1
  %t18 = icmp sgt i32 %46, 0
  %60 = icmp slt i32 %46, -959
  %t63.neg51 = zext i1 %60 to i32
  %t63 = sext i1 %60 to i32
  %61 = add i32 %46, 959
  %62 = add i32 %61, %t63.neg51
  %63 = sdiv i32 %62, 960
  %64 = add nsw i32 %63, %t63
  %65 = add nsw i32 %52, 33
  %66 = ashr i32 %65, 31
  %67 = xor i32 %66, %65
  %68 = zext i32 %67 to i64
  %69 = mul nuw nsw i64 %68, 2021161081
  %70 = lshr i64 %69, 36
  %71 = trunc i64 %70 to i32
  %72 = xor i32 %66, %71
  %t59 = mul nsw i32 %72, %64
  %73 = icmp slt i32 %t59, 1
  %t60 = sext i1 %73 to i32
  %74 = icmp eq i32 %64, 0
  %t61 = sext i1 %74 to i32
  %75 = xor i32 %t60, -1
  %76 = add i32 %t59, %75
  %77 = sub nsw i32 %64, %t61
  %78 = sdiv i32 %76, %77
  %79 = xor i32 %t63, -1
  %80 = sub nsw i32 %79, %t63
  %81 = and i32 %80, %t60
  %82 = add nsw i32 %81, %78
  %83 = xor i32 %t61, -1
  %t19 = and i32 %82, %83
  %t19.op = mul i32 %t19, 34
  %a3 = select i1 %t18, i32 %t19.op, i32 0
  %b4 = add nsw i32 %52, -34
  %84 = icmp sgt i32 %b4, %a3
  %85 = select i1 %84, i32 %a3, i32 %b4
  %a4 = select i1 %t18, i32 0, i32 %t19.op
  %86 = icmp sgt i32 %b4, %a4
  %87 = select i1 %86, i32 %a4, i32 %b4
  %input.extent.1.required.s = sub nsw i32 %85, %87
  %88 = load i8*, i8** %7, align 8, !tbaa !181
  %89 = icmp eq i8* %88, null
  br i1 %89, label %_halide_buffer_is_bounds_query.exit, label %after_bb

_halide_buffer_is_bounds_query.exit:              ; preds = %"assert succeeded2"
  %90 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 0
  %91 = load i64, i64* %90, align 8, !tbaa !183
  %92 = icmp eq i64 %91, 0
  br i1 %92, label %_halide_buffer_init.exit, label %after_bb

after_bb:                                         ; preds = %_halide_buffer_init.exit, %_halide_buffer_is_bounds_query.exit, %"assert succeeded2"
  %93 = load i8*, i8** %31, align 8, !tbaa !181
  %94 = icmp eq i8* %93, null
  br i1 %94, label %_halide_buffer_is_bounds_query.exit42, label %after_bb3

_halide_buffer_is_bounds_query.exit42:            ; preds = %after_bb
  %95 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 0
  %96 = load i64, i64* %95, align 8, !tbaa !183
  %97 = icmp eq i64 %96, 0
  br i1 %97, label %_halide_buffer_init.exit46, label %after_bb3

_halide_buffer_init.exit:                         ; preds = %_halide_buffer_is_bounds_query.exit
  %98 = bitcast %struct.halide_dimension_t** %17 to i8**
  %99 = load i8*, i8** %98, align 8, !tbaa !185
  %100 = icmp slt i32 %46, 960
  %101 = select i1 %100, i32 %46, i32 960
  %102 = add i32 %44, -963
  %103 = add i32 %102, %101
  %104 = icmp sgt i32 %a22, 0
  %105 = select i1 %104, i32 %a22, i32 0
  %106 = add nuw nsw i32 %105, 966
  %107 = add nsw i32 %87, %50
  %108 = add nsw i32 %107, -3
  %109 = add nsw i32 %input.extent.1.required.s, 40
  %110 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 0
  store i32 %103, i32* %110, align 4
  %111 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 1
  store i32 %106, i32* %111, align 4
  %112 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 2
  store i32 1, i32* %112, align 4
  %113 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 3
  store i32 0, i32* %113, align 4
  %114 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 4
  store i32 %108, i32* %114, align 4
  %115 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 5
  store i32 %109, i32* %115, align 4
  %116 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 6
  store i32 %106, i32* %116, align 4
  %117 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 7
  store i32 0, i32* %117, align 4
  %118 = bitcast %struct.halide_buffer_t* %input.buffer to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(24) %118, i8 0, i64 24, i1 false)
  store i8 1, i8* %10, align 8, !tbaa !368
  %119 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 4, i32 1
  store i8 8, i8* %119, align 1, !tbaa !369
  %120 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 4, i32 2
  store i16 1, i16* %120, align 2, !tbaa !370
  store i32 2, i32* %15, align 4, !tbaa !184
  %121 = bitcast [8 x i32]* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %99, i8* nonnull align 4 dereferenceable(16) %121, i64 16, i1 false) #11, !tbaa.struct !186
  %122 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %17, align 8, !tbaa !185
  %123 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 4
  %124 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %122, i64 1
  %125 = bitcast %struct.halide_dimension_t* %124 to i8*
  %126 = bitcast i32* %123 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %125, i8* nonnull align 4 dereferenceable(16) %126, i64 16, i1 false) #11, !tbaa.struct !186
...
after_bb3:                                        ; preds = %_halide_buffer_init.exit46, %_halide_buffer_is_bounds_query.exit42, %after_bb
  %127 = load i8*, i8** %7, align 8, !tbaa !181
  %128 = icmp eq i8* %127, null
  br i1 %128, label %129, label %_halide_buffer_is_bounds_query.exit43

129:                                              ; preds = %after_bb3
  %130 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 0
  %131 = load i64, i64* %130, align 8, !tbaa !183
  %132 = icmp eq i64 %131, 0
  br label %_halide_buffer_is_bounds_query.exit43

_halide_buffer_is_bounds_query.exit43:            ; preds = %129, %after_bb3
  %133 = phi i1 [ false, %after_bb3 ], [ %132, %129 ]
  %134 = load i8*, i8** %31, align 8, !tbaa !181
  %135 = icmp eq i8* %134, null
  br i1 %135, label %136, label %_halide_buffer_is_bounds_query.exit44

136:                                              ; preds = %_halide_buffer_is_bounds_query.exit43
  %137 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 0
  %138 = load i64, i64* %137, align 8, !tbaa !183
  %139 = icmp eq i64 %138, 0
  br label %_halide_buffer_is_bounds_query.exit44

_halide_buffer_is_bounds_query.exit44:            ; preds = %136, %_halide_buffer_is_bounds_query.exit43
  %140 = phi i1 [ false, %_halide_buffer_is_bounds_query.exit43 ], [ %139, %136 ]
  %141 = or i1 %133, %140
  br i1 %141, label %destructor_block, label %then_bb7

_halide_buffer_init.exit46:                       ; preds = %_halide_buffer_is_bounds_query.exit42
  %142 = bitcast %struct.halide_dimension_t** %41 to i8**
  %143 = load i8*, i8** %142, align 8, !tbaa !185
  %144 = icmp slt i32 %46, 960
  %145 = select i1 %144, i32 %46, i32 960
  %146 = add i32 %44, -960
  %147 = add i32 %146, %145
  %148 = icmp sgt i32 %a22, 0
  %149 = select i1 %148, i32 %a22, i32 0
  %150 = add nuw nsw i32 %149, 960
  %151 = add nsw i32 %87, %50
  %152 = add nsw i32 %input.extent.1.required.s, 34
  %153 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 0
  store i32 %147, i32* %153, align 4
  %154 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 1
  store i32 %150, i32* %154, align 4
  %155 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 2
  store i32 1, i32* %155, align 4
  %156 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 3
  store i32 0, i32* %156, align 4
  %157 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 4
  store i32 %151, i32* %157, align 4
  %158 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 5
  store i32 %152, i32* %158, align 4
  %159 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 6
  store i32 %150, i32* %159, align 4
  %160 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 7
  store i32 0, i32* %160, align 4
  %161 = bitcast %struct.halide_buffer_t* %output.buffer to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(24) %161, i8 0, i64 24, i1 false)
  store i8 1, i8* %34, align 8, !tbaa !368
  %162 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 4, i32 1
  store i8 8, i8* %162, align 1, !tbaa !369
  %163 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 4, i32 2
  store i16 1, i16* %163, align 2, !tbaa !370
  store i32 2, i32* %39, align 4, !tbaa !184
  %164 = bitcast [8 x i32]* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %143, i8* nonnull align 4 dereferenceable(16) %164, i64 16, i1 false) #11, !tbaa.struct !186
  %165 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %41, align 8, !tbaa !185
  %166 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 4
  %167 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %165, i64 1
  %168 = bitcast %struct.halide_dimension_t* %167 to i8*
  %169 = bitcast i32* %166 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %168, i8* nonnull align 4 dereferenceable(16) %169, i64 16, i1 false) #11, !tbaa.struct !186
  store i64 0, i64* %37, align 8, !tbaa !285
  br label %after_bb3

then_bb7:                                         ; preds = %_halide_buffer_is_bounds_query.exit44
  %170 = icmp ne i32 %12, 67585
  %171 = zext i1 %170 to i64
  %.not37 = icmp eq i32 %16, 2
  %172 = select i1 %.not37, i64 0, i64 2
  %.not38 = icmp eq i32 %36, 67585
  %173 = select i1 %.not38, i64 0, i64 4
  %.not39 = icmp eq i32 %40, 2
  %174 = select i1 %.not39, i64 0, i64 8
  %175 = add nsw i32 %20, 963
  %176 = icmp slt i32 %46, 960
  %177 = select i1 %176, i32 %46, i32 960
  %178 = add nsw i32 %177, %44
  %179 = icmp sgt i32 %175, %178
  %180 = icmp sgt i32 %a22, 0
  %181 = select i1 %180, i32 %a22, i32 0
  %182 = add nsw i32 %181, %177
  %183 = add nsw i32 %182, %44
  %184 = add nsw i32 %183, 3
  %185 = add nsw i32 %22, %20
  ...
  %192 = add nsw i32 %26, 3
  %193 = add nsw i32 %87, %50
  %194 = icmp sgt i32 %192, %193
  %195 = add i32 %85, %50
  %196 = add nsw i32 %195, 37
  %197 = add nsw i32 %28, %26
  %198 = icmp sgt i32 %196, %197
  %199 = or i1 %194, %198
  %200 = select i1 %199, i64 64, i64 0
  %201 = lshr i32 %28, 24
  %202 = and i32 %201, 128
  %203 = zext i32 %202 to i64
  %204 = icmp sgt i32 %182, 960
  %205 = select i1 %204, i32 %182, i32 960
  %206 = icmp sgt i32 %205, %46
  %207 = select i1 %206, i64 256, i64 0
  %208 = add nsw i32 %195, 34
  %209 = add nsw i32 %52, %50
  %210 = icmp sgt i32 %208, %209
  %211 = zext i1 %210 to i64
  %.lobit = lshr i32 %87, 31
  %212 = zext i32 %.lobit to i64
  %213 = or i64 %211, %212
  %214 = shl nuw nsw i64 %213, 9
  %215 = lshr i32 %52, 21
  %216 = and i32 %215, 1024
  %217 = zext i32 %216 to i64
  %.not40 = icmp eq i32 %24, 1
  %218 = select i1 %.not40, i64 0, i64 2048
  %.not41 = icmp eq i32 %48, 1
  %219 = select i1 %.not41, i64 0, i64 4096
  %220 = or i64 %172, %171
  %221 = or i64 %220, %191
  %222 = or i64 %221, %218
  %223 = or i64 %222, %203
  ...
  %230 = or i64 %229, %200
  %231 = or i64 %230, %214
  %232 = or i64 %231, -9223372036854775808
  %233 = call i64 @llvm.cttz.i64(i64 %232, i1 true), !range !371
  %234 = trunc i64 %233 to i32
  switch i32 %234, label %no_errors_bb [
...
no_errors_bb:                                     ; preds = %then_bb7
  ...
  %236 = sext i32 %22 to i64
  %input.total_extent.1 = mul nsw i64 %235, %236
  %237 = sext i32 %52 to i64
  %238 = sext i32 %46 to i64
  %output.total_extent.1 = mul nsw i64 %237, %238
  %input.extent.0.lobit = lshr i32 %22, 31
  %239 = zext i32 %input.extent.0.lobit to i64
  %240 = sext i32 %30 to i64
  %x0 = mul nsw i64 %240, %235
  %241 = call i64 @llvm.abs.i64(i64 %x0, i1 true)
  %242 = icmp ugt i64 %241, 2147483647
  %243 = select i1 %242, i64 2, i64 0
  %244 = icmp sgt i64 %input.total_extent.1, 2147483647
  %245 = select i1 %244, i64 4, i64 0
  %246 = lshr i32 %46, 28
  %247 = and i32 %246, 8
  %248 = zext i32 %247 to i64
  %249 = sext i32 %54 to i64
  %x1 = mul nsw i64 %249, %237
  %250 = call i64 @llvm.abs.i64(i64 %x1, i1 true)
  %251 = icmp ugt i64 %250, 2147483647
  %252 = select i1 %251, i64 16, i64 0
  %253 = icmp sgt i64 %output.total_extent.1, 2147483647
  %254 = select i1 %253, i64 32, i64 0
  %255 = shl i64 %14, 5
  %256 = and i64 %255, 64
  %257 = shl i64 %38, 6
  %258 = and i64 %257, 128
  %259 = icmp eq i8* %8, null
  %260 = icmp eq i8* %32, null
  %261 = select i1 %260, i64 512, i64 0
  %262 = select i1 %259, i64 -9223372036854775552, i64 -9223372036854775808
  %263 = or i64 %262, %256
  %264 = or i64 %263, %239
  %265 = or i64 %264, %245
  %266 = or i64 %265, %261
  ...
  %270 = or i64 %269, %254
  %271 = or i64 %270, %252
  %272 = call i64 @llvm.cttz.i64(i64 %271, i1 true), !range !371
  %273 = trunc i64 %272 to i32
  switch i32 %273, label %no_errors_bb21 [
...
assert_failed:                                    ; preds = %then_bb7
  %274 = call i32 @halide_error_bad_type(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 %12, i32 67585) #11
  ret i32 %274

assert_failed9:                                   ; preds = %then_bb7
  %275 = call i32 @halide_error_bad_dimensions(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 %16, i32 2) #11
  ret i32 %275

assert_failed10:                                  ; preds = %then_bb7
  %276 = call i32 @halide_error_bad_type(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 %36, i32 67585) #11
  ret i32 %276

assert_failed11:                                  ; preds = %then_bb7
  %277 = call i32 @halide_error_bad_dimensions(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 %40, i32 2) #11
  ret i32 %277

assert_failed12:                                  ; preds = %then_bb7
  %278 = add nsw i32 %178, -963
  %279 = add nsw i32 %183, 2
  %280 = add nsw i32 %185, -1
  %281 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 0, i32 %278, i32 %279, i32 %20, i32 %280) #11
  ret i32 %281

assert_failed13:                                  ; preds = %then_bb7
  %282 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 0, i32 %22) #11
  ret i32 %282

assert_failed14:                                  ; preds = %then_bb7
  %283 = add nsw i32 %193, -3
  %284 = add nsw i32 %195, 36
  %285 = add nsw i32 %197, -1
  %286 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 1, i32 %283, i32 %284, i32 %26, i32 %285) #11
  ret i32 %286

assert_failed15:                                  ; preds = %then_bb7
  %287 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 1, i32 %28) #11
  ret i32 %287

assert_failed16:                                  ; preds = %then_bb7
  %288 = add nsw i32 %178, -960
  %289 = add nsw i32 %183, -1
  %290 = add i32 %b3, %44
  %291 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 0, i32 %288, i32 %289, i32 %44, i32 %290) #11
  ret i32 %291

assert_failed17:                                  ; preds = %then_bb7
  %292 = add nsw i32 %195, 33
  %293 = add nsw i32 %209, -1
  %294 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 1, i32 %193, i32 %292, i32 %50, i32 %293) #11
  ret i32 %294

assert_failed18:                                  ; preds = %then_bb7
  %295 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 1, i32 %52) #11
  ret i32 %295

assert_failed19:                                  ; preds = %then_bb7
  %296 = call i32 @halide_error_constraint_violated(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.206, i64 0, i64 0), i32 %24, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.207, i64 0, i64 0), i32 1) #11
  ret i32 %296

assert_failed20:                                  ; preds = %then_bb7
  %297 = call i32 @halide_error_constraint_violated(i8* null, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @str.208, i64 0, i64 0), i32 %48, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.207, i64 0, i64 0), i32 1) #11
  ret i32 %297

no_errors_bb21:                                   ; preds = %no_errors_bb
  %t36 = mul nsw i32 %30, %26
  %298 = add i32 %t36, %20
  %t34 = sub i32 %44, %298
  %299 = mul i32 %50, %54
  %t35 = sub i32 0, %299
  %300 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 0
  store i32 %30, i32* %300, align 8
  %301 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 1
  store i32 %46, i32* %301, align 4
  %302 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 2
  store i32 %52, i32* %302, align 8
  %303 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 3
  store i32 %44, i32* %303, align 4
  %304 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 4
  store i32 %50, i32* %304, align 8
  %305 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 5
  store i32 %54, i32* %305, align 4
  %306 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 6
  store i32 %64, i32* %306, align 8
  %307 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 7
  store i32 %298, i32* %307, align 4
  %308 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 8
  store i32 %t34, i32* %308, align 8
  %309 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 9
  store i32 %t35, i32* %309, align 4
  %310 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 10
  store i8* %8, i8** %310, align 8
  %311 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 11
  store %struct.halide_buffer_t* %input.buffer, %struct.halide_buffer_t** %311, align 8
  %312 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 12
  store i8* %32, i8** %312, align 8
  %313 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 13
  store %struct.halide_buffer_t* %output.buffer, %struct.halide_buffer_t** %313, align 8
  %314 = bitcast %closure_t* %2 to i8*
  %315 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @gaussian7x7_batch_0029_sample_0005.par_for.output.s0.x.x.x, i32 0, i32 %t59, i8* nonnull %314)
  ret i32 %315

assert_failed22:                                  ; preds = %no_errors_bb
  %316 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %236, i64 2147483647) #11
  ret i32 %316

assert_failed23:                                  ; preds = %no_errors_bb
  %317 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %241, i64 2147483647) #11
  ret i32 %317

assert_failed24:                                  ; preds = %no_errors_bb
  %318 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %input.total_extent.1, i64 2147483647) #11
  ret i32 %318

assert_failed25:                                  ; preds = %no_errors_bb
  %319 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %238, i64 2147483647) #11
  ret i32 %319

assert_failed26:                                  ; preds = %no_errors_bb
  %320 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %250, i64 2147483647) #11
  ret i32 %320

assert_failed27:                                  ; preds = %no_errors_bb
  %321 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %output.total_extent.1, i64 2147483647) #11
  ret i32 %321

assert_failed28:                                  ; preds = %no_errors_bb
  %322 = call i32 @halide_error_device_dirty_with_no_device_support(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0)) #11
  ret i32 %322

assert_failed29:                                  ; preds = %no_errors_bb
  %323 = call i32 @halide_error_device_dirty_with_no_device_support(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0)) #11
  ret i32 %323

assert_failed30:                                  ; preds = %no_errors_bb
  %324 = call i32 @halide_error_host_is_null(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0)) #11
  ret i32 %324

assert_failed31:                                  ; preds = %no_errors_bb
  %325 = call i32 @halide_error_host_is_null(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0)) #11
  ret i32 %325
}
...
define internal i32 @gaussian7x7_batch_0029_sample_0005.par_for.output.s0.x.x.x(i8* nocapture readnone %__user_context, i32 %output.s0.x.x.x, i8* noalias nocapture readonly %closure) #10 {
entry:
  %rows3 = alloca [966 x i32], align 64
  %0 = bitcast i8* %closure to i32*
  %input.stride.1 = load i32, i32* %0, align 4
  %1 = getelementptr inbounds i8, i8* %closure, i64 4
  %2 = bitcast i8* %1 to i32*
  %output.extent.0 = load i32, i32* %2, align 4
  %3 = getelementptr inbounds i8, i8* %closure, i64 8
  %4 = bitcast i8* %3 to i32*
  %output.extent.1 = load i32, i32* %4, align 4
  %5 = getelementptr inbounds i8, i8* %closure, i64 12
  %6 = bitcast i8* %5 to i32*
  %output.min.0 = load i32, i32* %6, align 4
  ...
  %t28 = load i32, i32* %12, align 4
  %13 = getelementptr inbounds i8, i8* %closure, i64 28
  %14 = bitcast i8* %13 to i32*
  %t29 = load i32, i32* %14, align 4
  %15 = getelementptr inbounds i8, i8* %closure, i64 32
  %16 = bitcast i8* %15 to i32*
  %t34 = load i32, i32* %16, align 4
  %17 = getelementptr inbounds i8, i8* %closure, i64 36
  %18 = bitcast i8* %17 to i32*
  %t35 = load i32, i32* %18, align 4
  %19 = getelementptr inbounds i8, i8* %closure, i64 40
  %20 = bitcast i8* %19 to i8**
  %input = load i8*, i8** %20, align 8
  %21 = getelementptr inbounds i8, i8* %closure, i64 56
  %22 = bitcast i8* %21 to i8**
  %output = load i8*, i8** %22, align 8
  %output.s0.x.x.x.lobit = ashr i32 %output.s0.x.x.x, 31
  %23 = icmp eq i32 %t28, 0
  %t84 = sext i1 %23 to i32
  %t28.lobit = ashr i32 %t28, 31
  %24 = sub nsw i32 %output.s0.x.x.x, %output.s0.x.x.x.lobit
  %25 = or i32 %t28, %t84
  %26 = srem i32 %24, %25
  %27 = xor i32 %t28.lobit, %t28
  %28 = xor i32 %t28.lobit, -1
  %29 = add nsw i32 %27, %28
  %30 = and i32 %29, %output.s0.x.x.x.lobit
  %31 = add nsw i32 %26, %30
  %32 = xor i32 %t84, -1
  %33 = and i32 %31, %32
  %a24 = mul nsw i32 %33, 960
  %b25 = add nsw i32 %output.extent.0, -960
  %34 = icmp sgt i32 %b25, %a24
  %output.s0.x.xi.base.s = select i1 %34, i32 %a24, i32 %b25
  %35 = sub nsw i32 %t28, %t84
  %36 = sdiv i32 %24, %35
  %37 = sub nsw i32 %28, %t28.lobit
  %38 = and i32 %37, %output.s0.x.x.x.lobit
  %39 = add nsw i32 %36, %38
  %40 = and i32 %39, %32
  %a25 = mul nsw i32 %40, 34
  %b26 = add nsw i32 %output.extent.1, -34
  %41 = icmp sgt i32 %b26, %a25
  %output.s0.y.yi.base.s = select i1 %41, i32 %a25, i32 %b26
  %t44 = add nsw i32 %output.s0.x.xi.base.s, %t35
  %t43 = add nsw i32 %output.s0.x.xi.base.s, %t34
  %t38 = add nsw i32 %output.s0.y.yi.base.s, %output.min.1
  %t37 = add nsw i32 %output.s0.x.xi.base.s, %output.min.0
  %42 = sext i32 %input.stride.1 to i64
  %43 = mul nsw i64 %42, -2
  %44 = shl nsw i64 %42, 1
  %45 = mul nsw i64 %42, -3
  %46 = mul nsw i64 %42, 3
  %47 = sext i32 %t37 to i64
  %48 = getelementptr inbounds [966 x i32], [966 x i32]* %rows3, i64 0, i64 950
  %49 = bitcast i32* %48 to <16 x i32>*
  %50 = sext i32 %t43 to i64
  %51 = sext i32 %output.stride.1 to i64
  %52 = sext i32 %t44 to i64
  %53 = getelementptr inbounds i8, i8* %input, i64 -3
  %54 = getelementptr inbounds i8, i8* %input, i64 947
  %t45.0 = add nsw i32 %t38, 0
  br label %"for output.s0.y.yi.yi"

"for output.s0.y.yi.yi":                          ; preds = %"end for output.s0.y.yi.yii.for output.s0.y.yi.yi_crit_edge", %entry
  %.not6 = phi i1 [ false, %entry ], [ true, %"end for output.s0.y.yi.yii.for output.s0.y.yi.yi_crit_edge" ]
  %t45.phi = phi i32 [ %t45.0, %entry ], [ %t45.1, %"end for output.s0.y.yi.yii.for output.s0.y.yi.yi_crit_edge" ]
  %55 = sext i32 %t45.phi to i64
  br label %"for output.s0.y.yi.yii"

"for output.s0.y.yi.yii":                         ; preds = %"end for output.s0.x.xi.xi", %"for output.s0.y.yi.yi"
  %indvars.iv69 = phi i64 [ 0, %"for output.s0.y.yi.yi" ], [ %indvars.iv.next70, %"end for output.s0.x.xi.xi" ]
  %56 = add nsw i64 %indvars.iv69, %55
  %57 = mul nsw i64 %56, %42
  %58 = trunc i64 %57 to i32
  %t50 = sub i32 %58, %t29
  %59 = sext i32 %t50 to i64
  br label %"for rows.s0.x.x"

"end for output.s0.y.yi.yii":                     ; preds = %"end for output.s0.x.xi.xi"
  br i1 %.not6, label %destructor_block, label %"end for output.s0.y.yi.yii.for output.s0.y.yi.yi_crit_edge"

"end for output.s0.y.yi.yii.for output.s0.y.yi.yi_crit_edge": ; preds = %"end for output.s0.y.yi.yii"
  %t45.1 = add nsw i32 %t38, 17
  br label %"for output.s0.y.yi.yi"

"for rows.s0.x.x":                                ; preds = %"for rows.s0.x.x", %"for output.s0.y.yi.yii"
  %indvars.iv = phi i64 [ 0, %"for output.s0.y.yi.yii" ], [ %indvars.iv.next, %"for rows.s0.x.x" ]
  %60 = shl nsw i64 %indvars.iv, 4
  %61 = add nsw i64 %60, %47
  %62 = add nsw i64 %61, %59
  %63 = add nsw i64 %43, %62
  %64 = getelementptr inbounds i8, i8* %53, i64 %63
  %65 = bitcast i8* %64 to <16 x i8>*
  %66 = load <16 x i8>, <16 x i8>* %65, align 1, !tbaa !374
  %67 = zext <16 x i8> %66 to <16 x i32>
  %68 = sub nsw i64 %62, %42
  %69 = getelementptr inbounds i8, i8* %53, i64 %68
  %70 = bitcast i8* %69 to <16 x i8>*
  %71 = load <16 x i8>, <16 x i8>* %70, align 1, !tbaa !374
  %72 = zext <16 x i8> %71 to <16 x i32>
  %73 = getelementptr inbounds i8, i8* %53, i64 %62
  %74 = bitcast i8* %73 to <16 x i8>*
  %75 = load <16 x i8>, <16 x i8>* %74, align 1, !tbaa !374
  %76 = zext <16 x i8> %75 to <16 x i32>
  %77 = mul nuw nsw <16 x i32> %76, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %78 = add nsw i64 %44, %62
  %79 = getelementptr inbounds i8, i8* %53, i64 %78
  %80 = bitcast i8* %79 to <16 x i8>*
  %81 = load <16 x i8>, <16 x i8>* %80, align 1, !tbaa !374
  %82 = zext <16 x i8> %81 to <16 x i32>
  %83 = add nsw i64 %62, %42
  %84 = getelementptr inbounds i8, i8* %53, i64 %83
  %85 = bitcast i8* %84 to <16 x i8>*
  %86 = load <16 x i8>, <16 x i8>* %85, align 1, !tbaa !374
  %87 = zext <16 x i8> %86 to <16 x i32>
  %88 = add nsw i64 %45, %62
  %89 = getelementptr inbounds i8, i8* %53, i64 %88
  %90 = bitcast i8* %89 to <16 x i8>*
  %91 = load <16 x i8>, <16 x i8>* %90, align 1, !tbaa !374
  %92 = zext <16 x i8> %91 to <16 x i32>
  %93 = add nsw i64 %46, %62
  %94 = getelementptr inbounds i8, i8* %53, i64 %93
  %95 = bitcast i8* %94 to <16 x i8>*
  %96 = load <16 x i8>, <16 x i8>* %95, align 1, !tbaa !374
  %97 = zext <16 x i8> %96 to <16 x i32>
  %reass.add = add nuw nsw <16 x i32> %87, %72
  %reass.mul = mul nuw nsw <16 x i32> %reass.add, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add7 = add nuw nsw <16 x i32> %82, %67
  %reass.mul8 = mul nuw nsw <16 x i32> %reass.add7, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %98 = add nuw nsw <16 x i32> %77, %92
  %99 = add nuw nsw <16 x i32> %98, %reass.mul8
  %100 = add nuw nsw <16 x i32> %99, %97
  %101 = add nuw nsw <16 x i32> %100, %reass.mul
  %102 = getelementptr inbounds [966 x i32], [966 x i32]* %rows3, i64 0, i64 %60
  %103 = bitcast i32* %102 to <16 x i32>*
  store <16 x i32> %101, <16 x i32>* %103, align 64, !tbaa !377
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.not = icmp eq i64 %indvars.iv.next, 60
  br i1 %.not, label %"end for rows.s0.x.x", label %"for rows.s0.x.x"

"end for rows.s0.x.x":                            ; preds = %"for rows.s0.x.x"
  %104 = add nsw i64 %57, %50
  %105 = add nsw i64 %43, %104
  %106 = getelementptr inbounds i8, i8* %54, i64 %105
  %107 = bitcast i8* %106 to <16 x i8>*
  %108 = load <16 x i8>, <16 x i8>* %107, align 1, !tbaa !374
  %109 = zext <16 x i8> %108 to <16 x i32>
  %110 = sub nsw i64 %104, %42
  %111 = getelementptr inbounds i8, i8* %54, i64 %110
  %112 = bitcast i8* %111 to <16 x i8>*
  %113 = load <16 x i8>, <16 x i8>* %112, align 1, !tbaa !374
  %114 = zext <16 x i8> %113 to <16 x i32>
  %115 = getelementptr inbounds i8, i8* %54, i64 %104
  %116 = bitcast i8* %115 to <16 x i8>*
  %117 = load <16 x i8>, <16 x i8>* %116, align 1, !tbaa !374
  %118 = zext <16 x i8> %117 to <16 x i32>
  %119 = mul nuw nsw <16 x i32> %118, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %120 = add nsw i64 %44, %104
  %121 = getelementptr inbounds i8, i8* %54, i64 %120
  %122 = bitcast i8* %121 to <16 x i8>*
  %123 = load <16 x i8>, <16 x i8>* %122, align 1, !tbaa !374
  %124 = zext <16 x i8> %123 to <16 x i32>
  %125 = add nsw i64 %104, %42
  %126 = getelementptr inbounds i8, i8* %54, i64 %125
  %127 = bitcast i8* %126 to <16 x i8>*
  %128 = load <16 x i8>, <16 x i8>* %127, align 1, !tbaa !374
  %129 = zext <16 x i8> %128 to <16 x i32>
  %130 = add nsw i64 %45, %104
  %131 = getelementptr inbounds i8, i8* %54, i64 %130
  %132 = bitcast i8* %131 to <16 x i8>*
  %133 = load <16 x i8>, <16 x i8>* %132, align 1, !tbaa !374
  %134 = zext <16 x i8> %133 to <16 x i32>
  %135 = add nsw i64 %46, %104
  %136 = getelementptr inbounds i8, i8* %54, i64 %135
  %137 = bitcast i8* %136 to <16 x i8>*
  %138 = load <16 x i8>, <16 x i8>* %137, align 1, !tbaa !374
  %139 = zext <16 x i8> %138 to <16 x i32>
  %reass.add9 = add nuw nsw <16 x i32> %129, %114
  %reass.mul10 = mul nuw nsw <16 x i32> %reass.add9, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add11 = add nuw nsw <16 x i32> %124, %109
  %reass.mul12 = mul nuw nsw <16 x i32> %reass.add11, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %140 = add nuw nsw <16 x i32> %119, %134
  %141 = add nuw nsw <16 x i32> %140, %reass.mul12
  %142 = add nuw nsw <16 x i32> %141, %139
  %143 = add nuw nsw <16 x i32> %142, %reass.mul10
  store <16 x i32> %143, <16 x i32>* %49, align 8, !tbaa !379
  %144 = mul nsw i64 %56, %51
  %145 = add nsw i64 %144, %52
  br label %"for output.s0.x.xi.xi"

"for output.s0.x.xi.xi":                          ; preds = %"for output.s0.x.xi.xi", %"end for rows.s0.x.x"
  %indvars.iv67 = phi i64 [ 0, %"end for rows.s0.x.x" ], [ %indvars.iv.next68, %"for output.s0.x.xi.xi" ]
  %146 = mul nuw nsw i64 %indvars.iv67, 192
  %147 = getelementptr inbounds [966 x i32], [966 x i32]* %rows3, i64 0, i64 %146
  %148 = getelementptr inbounds i32, i32* %147, i64 1
  %149 = bitcast i32* %148 to <16 x i32>*
  %150 = load <16 x i32>, <16 x i32>* %149, align 4, !tbaa !377
  %151 = bitcast i32* %147 to <16 x i32>*
  %152 = load <16 x i32>, <16 x i32>* %151, align 64, !tbaa !377
  %153 = getelementptr inbounds i32, i32* %147, i64 2
  %154 = bitcast i32* %153 to <16 x i32>*
  %155 = load <16 x i32>, <16 x i32>* %154, align 8, !tbaa !377
  %156 = getelementptr inbounds i32, i32* %147, i64 3
  %157 = bitcast i32* %156 to <16 x i32>*
  %158 = load <16 x i32>, <16 x i32>* %157, align 4, !tbaa !377
  %159 = mul nsw <16 x i32> %158, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %160 = getelementptr inbounds i32, i32* %147, i64 4
  %161 = bitcast i32* %160 to <16 x i32>*
  %162 = load <16 x i32>, <16 x i32>* %161, align 16, !tbaa !377
  %163 = getelementptr inbounds i32, i32* %147, i64 6
  %164 = bitcast i32* %163 to <16 x i32>*
  %165 = load <16 x i32>, <16 x i32>* %164, align 8, !tbaa !377
  %166 = getelementptr inbounds i32, i32* %147, i64 5
  %167 = bitcast i32* %166 to <16 x i32>*
  %168 = load <16 x i32>, <16 x i32>* %167, align 4, !tbaa !377
  %reass.add13 = add <16 x i32> %162, %155
  %reass.mul14 = mul <16 x i32> %reass.add13, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add15 = add <16 x i32> %168, %150
  %reass.mul16 = mul <16 x i32> %reass.add15, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %169 = add <16 x i32> %159, %152
  %170 = add <16 x i32> %169, %165
  %171 = add <16 x i32> %170, %reass.mul14
  %172 = add <16 x i32> %171, %reass.mul16
  %173 = getelementptr inbounds i32, i32* %147, i64 17
  %174 = bitcast i32* %173 to <16 x i32>*
  %175 = load <16 x i32>, <16 x i32>* %174, align 4, !tbaa !377
  %176 = getelementptr inbounds i32, i32* %147, i64 16
  %177 = bitcast i32* %176 to <16 x i32>*
  %178 = load <16 x i32>, <16 x i32>* %177, align 64, !tbaa !377
  %179 = getelementptr inbounds i32, i32* %147, i64 18
  %180 = bitcast i32* %179 to <16 x i32>*
  %181 = load <16 x i32>, <16 x i32>* %180, align 8, !tbaa !377
  %182 = getelementptr inbounds i32, i32* %147, i64 19
  %183 = bitcast i32* %182 to <16 x i32>*
  %184 = load <16 x i32>, <16 x i32>* %183, align 4, !tbaa !377
  %185 = mul nsw <16 x i32> %184, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %186 = getelementptr inbounds i32, i32* %147, i64 20
  %187 = bitcast i32* %186 to <16 x i32>*
  %188 = load <16 x i32>, <16 x i32>* %187, align 16, !tbaa !377
  %189 = getelementptr inbounds i32, i32* %147, i64 22
  %190 = bitcast i32* %189 to <16 x i32>*
  %191 = load <16 x i32>, <16 x i32>* %190, align 8, !tbaa !377
  %192 = getelementptr inbounds i32, i32* %147, i64 21
  %193 = bitcast i32* %192 to <16 x i32>*
  %194 = load <16 x i32>, <16 x i32>* %193, align 4, !tbaa !377
  %reass.add17 = add <16 x i32> %188, %181
  %reass.mul18 = mul <16 x i32> %reass.add17, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add19 = add <16 x i32> %194, %175
  %reass.mul20 = mul <16 x i32> %reass.add19, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %195 = add <16 x i32> %185, %178
  %196 = add <16 x i32> %195, %191
  %197 = add <16 x i32> %196, %reass.mul18
  %198 = add <16 x i32> %197, %reass.mul20
  %199 = getelementptr inbounds i32, i32* %147, i64 33
  %200 = bitcast i32* %199 to <16 x i32>*
  %201 = load <16 x i32>, <16 x i32>* %200, align 4, !tbaa !377
  %202 = getelementptr inbounds i32, i32* %147, i64 32
  %203 = bitcast i32* %202 to <16 x i32>*
  %204 = load <16 x i32>, <16 x i32>* %203, align 64, !tbaa !377
  %205 = getelementptr inbounds i32, i32* %147, i64 34
  %206 = bitcast i32* %205 to <16 x i32>*
  %207 = load <16 x i32>, <16 x i32>* %206, align 8, !tbaa !377
  %208 = getelementptr inbounds i32, i32* %147, i64 35
  %209 = bitcast i32* %208 to <16 x i32>*
  %210 = load <16 x i32>, <16 x i32>* %209, align 4, !tbaa !377
  %211 = mul nsw <16 x i32> %210, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %212 = getelementptr inbounds i32, i32* %147, i64 36
  %213 = bitcast i32* %212 to <16 x i32>*
  %214 = load <16 x i32>, <16 x i32>* %213, align 16, !tbaa !377
  %215 = getelementptr inbounds i32, i32* %147, i64 38
  %216 = bitcast i32* %215 to <16 x i32>*
  %217 = load <16 x i32>, <16 x i32>* %216, align 8, !tbaa !377
  %218 = getelementptr inbounds i32, i32* %147, i64 37
  %219 = bitcast i32* %218 to <16 x i32>*
  %220 = load <16 x i32>, <16 x i32>* %219, align 4, !tbaa !377
  %reass.add21 = add <16 x i32> %214, %207
  %reass.mul22 = mul <16 x i32> %reass.add21, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add23 = add <16 x i32> %220, %201
  %reass.mul24 = mul <16 x i32> %reass.add23, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %221 = add <16 x i32> %211, %204
  %222 = add <16 x i32> %221, %217
  %223 = add <16 x i32> %222, %reass.mul22
  %224 = add <16 x i32> %223, %reass.mul24
  %225 = getelementptr inbounds i32, i32* %147, i64 49
  %226 = bitcast i32* %225 to <16 x i32>*
  %227 = load <16 x i32>, <16 x i32>* %226, align 4, !tbaa !377
  %228 = getelementptr inbounds i32, i32* %147, i64 48
  %229 = bitcast i32* %228 to <16 x i32>*
  %230 = load <16 x i32>, <16 x i32>* %229, align 64, !tbaa !377
  %231 = getelementptr inbounds i32, i32* %147, i64 50
  %232 = bitcast i32* %231 to <16 x i32>*
  %233 = load <16 x i32>, <16 x i32>* %232, align 8, !tbaa !377
  %234 = getelementptr inbounds i32, i32* %147, i64 51
  %235 = bitcast i32* %234 to <16 x i32>*
  %236 = load <16 x i32>, <16 x i32>* %235, align 4, !tbaa !377
  %237 = mul nsw <16 x i32> %236, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %238 = getelementptr inbounds i32, i32* %147, i64 52
  %239 = bitcast i32* %238 to <16 x i32>*
  %240 = load <16 x i32>, <16 x i32>* %239, align 16, !tbaa !377
  %241 = getelementptr inbounds i32, i32* %147, i64 54
  %242 = bitcast i32* %241 to <16 x i32>*
  %243 = load <16 x i32>, <16 x i32>* %242, align 8, !tbaa !377
  %244 = getelementptr inbounds i32, i32* %147, i64 53
  %245 = bitcast i32* %244 to <16 x i32>*
  %246 = load <16 x i32>, <16 x i32>* %245, align 4, !tbaa !377
  %reass.add25 = add <16 x i32> %240, %233
  %reass.mul26 = mul <16 x i32> %reass.add25, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add27 = add <16 x i32> %246, %227
  %reass.mul28 = mul <16 x i32> %reass.add27, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %247 = add <16 x i32> %237, %230
  %248 = add <16 x i32> %247, %243
  %249 = add <16 x i32> %248, %reass.mul26
  %250 = add <16 x i32> %249, %reass.mul28
  %251 = getelementptr inbounds i32, i32* %147, i64 65
  %252 = bitcast i32* %251 to <16 x i32>*
  %253 = load <16 x i32>, <16 x i32>* %252, align 4, !tbaa !377
  %254 = getelementptr inbounds i32, i32* %147, i64 64
  %255 = bitcast i32* %254 to <16 x i32>*
  %256 = load <16 x i32>, <16 x i32>* %255, align 64, !tbaa !377
  %257 = getelementptr inbounds i32, i32* %147, i64 66
  %258 = bitcast i32* %257 to <16 x i32>*
  %259 = load <16 x i32>, <16 x i32>* %258, align 8, !tbaa !377
  %260 = getelementptr inbounds i32, i32* %147, i64 67
  %261 = bitcast i32* %260 to <16 x i32>*
  %262 = load <16 x i32>, <16 x i32>* %261, align 4, !tbaa !377
  %263 = mul nsw <16 x i32> %262, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %264 = getelementptr inbounds i32, i32* %147, i64 68
  %265 = bitcast i32* %264 to <16 x i32>*
  %266 = load <16 x i32>, <16 x i32>* %265, align 16, !tbaa !377
  %267 = getelementptr inbounds i32, i32* %147, i64 70
  %268 = bitcast i32* %267 to <16 x i32>*
  %269 = load <16 x i32>, <16 x i32>* %268, align 8, !tbaa !377
  %270 = getelementptr inbounds i32, i32* %147, i64 69
  %271 = bitcast i32* %270 to <16 x i32>*
  %272 = load <16 x i32>, <16 x i32>* %271, align 4, !tbaa !377
  %reass.add29 = add <16 x i32> %266, %259
  %reass.mul30 = mul <16 x i32> %reass.add29, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add31 = add <16 x i32> %272, %253
  %reass.mul32 = mul <16 x i32> %reass.add31, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %273 = add <16 x i32> %263, %256
  %274 = add <16 x i32> %273, %269
  %275 = add <16 x i32> %274, %reass.mul30
  %276 = add <16 x i32> %275, %reass.mul32
  %277 = getelementptr inbounds i32, i32* %147, i64 81
  %278 = bitcast i32* %277 to <16 x i32>*
  %279 = load <16 x i32>, <16 x i32>* %278, align 4, !tbaa !377
  %280 = getelementptr inbounds i32, i32* %147, i64 80
  %281 = bitcast i32* %280 to <16 x i32>*
  %282 = load <16 x i32>, <16 x i32>* %281, align 64, !tbaa !377
  %283 = getelementptr inbounds i32, i32* %147, i64 82
  %284 = bitcast i32* %283 to <16 x i32>*
  %285 = load <16 x i32>, <16 x i32>* %284, align 8, !tbaa !377
  %286 = getelementptr inbounds i32, i32* %147, i64 83
  %287 = bitcast i32* %286 to <16 x i32>*
  %288 = load <16 x i32>, <16 x i32>* %287, align 4, !tbaa !377
  %289 = mul nsw <16 x i32> %288, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %290 = getelementptr inbounds i32, i32* %147, i64 84
  %291 = bitcast i32* %290 to <16 x i32>*
  %292 = load <16 x i32>, <16 x i32>* %291, align 16, !tbaa !377
  %293 = getelementptr inbounds i32, i32* %147, i64 86
  %294 = bitcast i32* %293 to <16 x i32>*
  %295 = load <16 x i32>, <16 x i32>* %294, align 8, !tbaa !377
  %296 = getelementptr inbounds i32, i32* %147, i64 85
  %297 = bitcast i32* %296 to <16 x i32>*
  %298 = load <16 x i32>, <16 x i32>* %297, align 4, !tbaa !377
  %reass.add33 = add <16 x i32> %292, %285
  %reass.mul34 = mul <16 x i32> %reass.add33, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add35 = add <16 x i32> %298, %279
  %reass.mul36 = mul <16 x i32> %reass.add35, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %299 = add <16 x i32> %289, %282
  %300 = add <16 x i32> %299, %295
  %301 = add <16 x i32> %300, %reass.mul34
  %302 = add <16 x i32> %301, %reass.mul36
  %303 = getelementptr inbounds i32, i32* %147, i64 97
  %304 = bitcast i32* %303 to <16 x i32>*
  %305 = load <16 x i32>, <16 x i32>* %304, align 4, !tbaa !377
  %306 = getelementptr inbounds i32, i32* %147, i64 96
  %307 = bitcast i32* %306 to <16 x i32>*
  %308 = load <16 x i32>, <16 x i32>* %307, align 64, !tbaa !377
  %309 = getelementptr inbounds i32, i32* %147, i64 98
  %310 = bitcast i32* %309 to <16 x i32>*
  %311 = load <16 x i32>, <16 x i32>* %310, align 8, !tbaa !377
  %312 = getelementptr inbounds i32, i32* %147, i64 99
  %313 = bitcast i32* %312 to <16 x i32>*
  %314 = load <16 x i32>, <16 x i32>* %313, align 4, !tbaa !377
  %315 = mul nsw <16 x i32> %314, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %316 = getelementptr inbounds i32, i32* %147, i64 100
  %317 = bitcast i32* %316 to <16 x i32>*
  %318 = load <16 x i32>, <16 x i32>* %317, align 16, !tbaa !377
  %319 = getelementptr inbounds i32, i32* %147, i64 102
  %320 = bitcast i32* %319 to <16 x i32>*
  %321 = load <16 x i32>, <16 x i32>* %320, align 8, !tbaa !377
  %322 = getelementptr inbounds i32, i32* %147, i64 101
  %323 = bitcast i32* %322 to <16 x i32>*
  %324 = load <16 x i32>, <16 x i32>* %323, align 4, !tbaa !377
  %reass.add37 = add <16 x i32> %318, %311
  %reass.mul38 = mul <16 x i32> %reass.add37, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add39 = add <16 x i32> %324, %305
  %reass.mul40 = mul <16 x i32> %reass.add39, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %325 = add <16 x i32> %315, %308
  %326 = add <16 x i32> %325, %321
  %327 = add <16 x i32> %326, %reass.mul38
  %328 = add <16 x i32> %327, %reass.mul40
  %329 = getelementptr inbounds i32, i32* %147, i64 113
  %330 = bitcast i32* %329 to <16 x i32>*
  %331 = load <16 x i32>, <16 x i32>* %330, align 4, !tbaa !377
  %332 = getelementptr inbounds i32, i32* %147, i64 112
  %333 = bitcast i32* %332 to <16 x i32>*
  %334 = load <16 x i32>, <16 x i32>* %333, align 64, !tbaa !377
  %335 = getelementptr inbounds i32, i32* %147, i64 114
  %336 = bitcast i32* %335 to <16 x i32>*
  %337 = load <16 x i32>, <16 x i32>* %336, align 8, !tbaa !377
  %338 = getelementptr inbounds i32, i32* %147, i64 115
  %339 = bitcast i32* %338 to <16 x i32>*
  %340 = load <16 x i32>, <16 x i32>* %339, align 4, !tbaa !377
  %341 = mul nsw <16 x i32> %340, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %342 = getelementptr inbounds i32, i32* %147, i64 116
  %343 = bitcast i32* %342 to <16 x i32>*
  %344 = load <16 x i32>, <16 x i32>* %343, align 16, !tbaa !377
  %345 = getelementptr inbounds i32, i32* %147, i64 118
  %346 = bitcast i32* %345 to <16 x i32>*
  %347 = load <16 x i32>, <16 x i32>* %346, align 8, !tbaa !377
  %348 = getelementptr inbounds i32, i32* %147, i64 117
  %349 = bitcast i32* %348 to <16 x i32>*
  %350 = load <16 x i32>, <16 x i32>* %349, align 4, !tbaa !377
  %reass.add41 = add <16 x i32> %344, %337
  %reass.mul42 = mul <16 x i32> %reass.add41, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add43 = add <16 x i32> %350, %331
  %reass.mul44 = mul <16 x i32> %reass.add43, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %351 = add <16 x i32> %341, %334
  %352 = add <16 x i32> %351, %347
  %353 = add <16 x i32> %352, %reass.mul42
  %354 = add <16 x i32> %353, %reass.mul44
  %355 = getelementptr inbounds i32, i32* %147, i64 129
  %356 = bitcast i32* %355 to <16 x i32>*
  %357 = load <16 x i32>, <16 x i32>* %356, align 4, !tbaa !377
  %358 = getelementptr inbounds i32, i32* %147, i64 128
  %359 = bitcast i32* %358 to <16 x i32>*
  %360 = load <16 x i32>, <16 x i32>* %359, align 64, !tbaa !377
  %361 = getelementptr inbounds i32, i32* %147, i64 130
  %362 = bitcast i32* %361 to <16 x i32>*
  %363 = load <16 x i32>, <16 x i32>* %362, align 8, !tbaa !377
  %364 = getelementptr inbounds i32, i32* %147, i64 131
  %365 = bitcast i32* %364 to <16 x i32>*
  %366 = load <16 x i32>, <16 x i32>* %365, align 4, !tbaa !377
  %367 = mul nsw <16 x i32> %366, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %368 = getelementptr inbounds i32, i32* %147, i64 132
  %369 = bitcast i32* %368 to <16 x i32>*
  %370 = load <16 x i32>, <16 x i32>* %369, align 16, !tbaa !377
  %371 = getelementptr inbounds i32, i32* %147, i64 134
  %372 = bitcast i32* %371 to <16 x i32>*
  %373 = load <16 x i32>, <16 x i32>* %372, align 8, !tbaa !377
  %374 = getelementptr inbounds i32, i32* %147, i64 133
  %375 = bitcast i32* %374 to <16 x i32>*
  %376 = load <16 x i32>, <16 x i32>* %375, align 4, !tbaa !377
  %reass.add45 = add <16 x i32> %370, %363
  %reass.mul46 = mul <16 x i32> %reass.add45, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add47 = add <16 x i32> %376, %357
  %reass.mul48 = mul <16 x i32> %reass.add47, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %377 = add <16 x i32> %367, %360
  %378 = add <16 x i32> %377, %373
  %379 = add <16 x i32> %378, %reass.mul46
  %380 = add <16 x i32> %379, %reass.mul48
  %381 = getelementptr inbounds i32, i32* %147, i64 145
  %382 = bitcast i32* %381 to <16 x i32>*
  %383 = load <16 x i32>, <16 x i32>* %382, align 4, !tbaa !377
  %384 = getelementptr inbounds i32, i32* %147, i64 144
  %385 = bitcast i32* %384 to <16 x i32>*
  %386 = load <16 x i32>, <16 x i32>* %385, align 64, !tbaa !377
  %387 = getelementptr inbounds i32, i32* %147, i64 146
  %388 = bitcast i32* %387 to <16 x i32>*
  %389 = load <16 x i32>, <16 x i32>* %388, align 8, !tbaa !377
  %390 = getelementptr inbounds i32, i32* %147, i64 147
  %391 = bitcast i32* %390 to <16 x i32>*
  %392 = load <16 x i32>, <16 x i32>* %391, align 4, !tbaa !377
  %393 = mul nsw <16 x i32> %392, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %394 = getelementptr inbounds i32, i32* %147, i64 148
  %395 = bitcast i32* %394 to <16 x i32>*
  %396 = load <16 x i32>, <16 x i32>* %395, align 16, !tbaa !377
  %397 = getelementptr inbounds i32, i32* %147, i64 150
  %398 = bitcast i32* %397 to <16 x i32>*
  %399 = load <16 x i32>, <16 x i32>* %398, align 8, !tbaa !377
  %400 = getelementptr inbounds i32, i32* %147, i64 149
  %401 = bitcast i32* %400 to <16 x i32>*
  %402 = load <16 x i32>, <16 x i32>* %401, align 4, !tbaa !377
  %reass.add49 = add <16 x i32> %396, %389
  %reass.mul50 = mul <16 x i32> %reass.add49, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add51 = add <16 x i32> %402, %383
  %reass.mul52 = mul <16 x i32> %reass.add51, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %403 = add <16 x i32> %393, %386
  %404 = add <16 x i32> %403, %399
  %405 = add <16 x i32> %404, %reass.mul50
  %406 = add <16 x i32> %405, %reass.mul52
  %407 = getelementptr inbounds i32, i32* %147, i64 161
  %408 = bitcast i32* %407 to <16 x i32>*
  %409 = load <16 x i32>, <16 x i32>* %408, align 4, !tbaa !377
  %410 = getelementptr inbounds i32, i32* %147, i64 160
  %411 = bitcast i32* %410 to <16 x i32>*
  %412 = load <16 x i32>, <16 x i32>* %411, align 64, !tbaa !377
  %413 = getelementptr inbounds i32, i32* %147, i64 162
  %414 = bitcast i32* %413 to <16 x i32>*
  %415 = load <16 x i32>, <16 x i32>* %414, align 8, !tbaa !377
  %416 = getelementptr inbounds i32, i32* %147, i64 163
  %417 = bitcast i32* %416 to <16 x i32>*
  %418 = load <16 x i32>, <16 x i32>* %417, align 4, !tbaa !377
  %419 = mul nsw <16 x i32> %418, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %420 = getelementptr inbounds i32, i32* %147, i64 164
  %421 = bitcast i32* %420 to <16 x i32>*
  %422 = load <16 x i32>, <16 x i32>* %421, align 16, !tbaa !377
  %423 = getelementptr inbounds i32, i32* %147, i64 166
  %424 = bitcast i32* %423 to <16 x i32>*
  %425 = load <16 x i32>, <16 x i32>* %424, align 8, !tbaa !377
  %426 = getelementptr inbounds i32, i32* %147, i64 165
  %427 = bitcast i32* %426 to <16 x i32>*
  %428 = load <16 x i32>, <16 x i32>* %427, align 4, !tbaa !377
  %reass.add53 = add <16 x i32> %422, %415
  %reass.mul54 = mul <16 x i32> %reass.add53, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add55 = add <16 x i32> %428, %409
  %reass.mul56 = mul <16 x i32> %reass.add55, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %429 = add <16 x i32> %419, %412
  %430 = add <16 x i32> %429, %425
  %431 = add <16 x i32> %430, %reass.mul54
  %432 = add <16 x i32> %431, %reass.mul56
  %433 = getelementptr inbounds i32, i32* %147, i64 177
  %434 = bitcast i32* %433 to <16 x i32>*
  %435 = load <16 x i32>, <16 x i32>* %434, align 4, !tbaa !377
  %436 = getelementptr inbounds i32, i32* %147, i64 176
  %437 = bitcast i32* %436 to <16 x i32>*
  %438 = load <16 x i32>, <16 x i32>* %437, align 64, !tbaa !377
  %439 = getelementptr inbounds i32, i32* %147, i64 178
  %440 = bitcast i32* %439 to <16 x i32>*
  %441 = load <16 x i32>, <16 x i32>* %440, align 8, !tbaa !377
  %442 = getelementptr inbounds i32, i32* %147, i64 179
  %443 = bitcast i32* %442 to <16 x i32>*
  %444 = load <16 x i32>, <16 x i32>* %443, align 4, !tbaa !377
  %445 = mul nsw <16 x i32> %444, <i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20, i32 20>
  %446 = getelementptr inbounds i32, i32* %147, i64 180
  %447 = bitcast i32* %446 to <16 x i32>*
  %448 = load <16 x i32>, <16 x i32>* %447, align 16, !tbaa !377
  %449 = getelementptr inbounds i32, i32* %147, i64 182
  %450 = bitcast i32* %449 to <16 x i32>*
  %451 = load <16 x i32>, <16 x i32>* %450, align 8, !tbaa !377
  %452 = getelementptr inbounds i32, i32* %147, i64 181
  %453 = bitcast i32* %452 to <16 x i32>*
  %454 = load <16 x i32>, <16 x i32>* %453, align 4, !tbaa !377
  %reass.add57 = add <16 x i32> %448, %441
  %reass.mul58 = mul <16 x i32> %reass.add57, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %reass.add59 = add <16 x i32> %454, %435
  %reass.mul60 = mul <16 x i32> %reass.add59, <i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6, i32 6>
  %455 = add <16 x i32> %445, %438
  %456 = add <16 x i32> %455, %451
  %457 = add <16 x i32> %456, %reass.mul58
  %458 = add <16 x i32> %457, %reass.mul60
  %459 = shufflevector <16 x i32> %172, <16 x i32> %198, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %460 = shufflevector <16 x i32> %224, <16 x i32> %250, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %461 = shufflevector <32 x i32> %459, <32 x i32> %460, <64 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %a27 = ashr <64 x i32> %461, <i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12>
  %462 = shufflevector <64 x i32> %a27, <64 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %463 = icmp slt <16 x i32> %462, <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %464 = shufflevector <64 x i32> %a27, <64 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %465 = icmp slt <16 x i32> %464, <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %466 = shufflevector <64 x i32> %a27, <64 x i32> undef, <16 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47>
  %467 = icmp slt <16 x i32> %466, <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %468 = shufflevector <64 x i32> %a27, <64 x i32> undef, <16 x i32> <i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %469 = icmp slt <16 x i32> %468, <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %470 = select <16 x i1> %463, <16 x i32> %462, <16 x i32> <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %471 = select <16 x i1> %465, <16 x i32> %464, <16 x i32> <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %472 = select <16 x i1> %467, <16 x i32> %466, <16 x i32> <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %473 = select <16 x i1> %469, <16 x i32> %468, <16 x i32> <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  ...
  %485 = trunc <64 x i32> %484 to <64 x i8>
  %486 = add nsw i64 %146, %145
  %487 = getelementptr inbounds i8, i8* %output, i64 %486
  %488 = bitcast i8* %487 to <64 x i8>*
  store <64 x i8> %485, <64 x i8>* %488, align 1, !tbaa !384
  %489 = shufflevector <16 x i32> %276, <16 x i32> %302, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %490 = shufflevector <16 x i32> %328, <16 x i32> %354, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %491 = shufflevector <32 x i32> %489, <32 x i32> %490, <64 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %a29 = ashr <64 x i32> %491, <i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12>
  %492 = shufflevector <64 x i32> %a29, <64 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %493 = icmp slt <16 x i32> %492, <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %494 = shufflevector <64 x i32> %a29, <64 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %495 = icmp slt <16 x i32> %494, <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %496 = shufflevector <64 x i32> %a29, <64 x i32> undef, <16 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47>
  %497 = icmp slt <16 x i32> %496, <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %498 = shufflevector <64 x i32> %a29, <64 x i32> undef, <16 x i32> <i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  ...
  %500 = select <16 x i1> %493, <16 x i32> %492, <16 x i32> <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %501 = select <16 x i1> %495, <16 x i32> %494, <16 x i32> <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %502 = select <16 x i1> %497, <16 x i32> %496, <16 x i32> <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %503 = select <16 x i1> %499, <16 x i32> %498, <16 x i32> <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  ...
  %515 = trunc <64 x i32> %514 to <64 x i8>
  %516 = getelementptr inbounds i8, i8* %487, i64 64
  %517 = bitcast i8* %516 to <64 x i8>*
  store <64 x i8> %515, <64 x i8>* %517, align 1, !tbaa !384
  %518 = shufflevector <16 x i32> %380, <16 x i32> %406, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %519 = shufflevector <16 x i32> %432, <16 x i32> %458, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %520 = shufflevector <32 x i32> %518, <32 x i32> %519, <64 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31, i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47, i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %a31 = ashr <64 x i32> %520, <i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12, i32 12>
  %521 = shufflevector <64 x i32> %a31, <64 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %522 = icmp slt <16 x i32> %521, <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %523 = shufflevector <64 x i32> %a31, <64 x i32> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %524 = icmp slt <16 x i32> %523, <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %525 = shufflevector <64 x i32> %a31, <64 x i32> undef, <16 x i32> <i32 32, i32 33, i32 34, i32 35, i32 36, i32 37, i32 38, i32 39, i32 40, i32 41, i32 42, i32 43, i32 44, i32 45, i32 46, i32 47>
  %526 = icmp slt <16 x i32> %525, <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %527 = shufflevector <64 x i32> %a31, <64 x i32> undef, <16 x i32> <i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %528 = icmp slt <16 x i32> %527, <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %529 = select <16 x i1> %522, <16 x i32> %521, <16 x i32> <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %530 = select <16 x i1> %524, <16 x i32> %523, <16 x i32> <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %531 = select <16 x i1> %526, <16 x i32> %525, <16 x i32> <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  %532 = select <16 x i1> %528, <16 x i32> %527, <16 x i32> <i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255, i32 255>
  ...
  %544 = trunc <64 x i32> %543 to <64 x i8>
  %545 = getelementptr inbounds i8, i8* %487, i64 128
  %546 = bitcast i8* %545 to <64 x i8>*
  store <64 x i8> %544, <64 x i8>* %546, align 1, !tbaa !384
  %indvars.iv.next68 = add nuw nsw i64 %indvars.iv67, 1
  %.not4 = icmp eq i64 %indvars.iv.next68, 5
  br i1 %.not4, label %"end for output.s0.x.xi.xi", label %"for output.s0.x.xi.xi"

"end for output.s0.x.xi.xi":                      ; preds = %"for output.s0.x.xi.xi"
  %indvars.iv.next70 = add nuw nsw i64 %indvars.iv69, 1
  %.not5 = icmp eq i64 %indvars.iv.next70, 17
  br i1 %.not5, label %"end for output.s0.y.yi.yii", label %"for output.s0.y.yi.yii"

destructor_block:                                 ; preds = %"end for output.s0.y.yi.yii"
  ret i32 0
}

; Function Attrs: nounwind
define i32 @gaussian7x7_batch_0029_sample_0005_argv(i8** nocapture readonly %0) local_unnamed_addr #11 {
entry:
  ...
  %6 = tail call i32 @gaussian7x7_batch_0029_sample_0005(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #15
  ret i32 %6
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @gaussian7x7_batch_0029_sample_0005_metadata() local_unnamed_addr #12 {
entry:
  ret %struct.halide_filter_metadata_t* @gaussian7x7_batch_0029_sample_0005_metadata_storage
}
...
!378 = !{!"rows", !376, i64 0}
!379 = !{!380, !380, i64 0}
!380 = !{!"rows.width128.base896", !381, i64 0}
!381 = !{!"rows.width256.base768", !382, i64 0}
!382 = !{!"rows.width512.base512", !383, i64 0}
!383 = !{!"rows.width1024.base0", !378, i64 0}
!384 = !{!385, !385, i64 0}
!385 = !{!"output", !376, i64 0}
