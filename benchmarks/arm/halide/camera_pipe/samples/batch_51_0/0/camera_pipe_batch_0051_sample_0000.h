#ifndef HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___camera_pipe___samples___batch_51_0___0___camera_pipe_batch_0051_sample_0000_h
#define HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___camera_pipe___samples___batch_51_0___0___camera_pipe_batch_0051_sample_0000_h
#include <stdint.h>
...
int camera_pipe_batch_0051_sample_0000(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_matrix_3200_buffer, struct halide_buffer_t *_matrix_7000_buffer, float _color_temp, float _gamma, float _contrast, float _sharpen_strength, int32_t _blackLevel, int32_t _whiteLevel, struct halide_buffer_t *_processed_buffer);

HALIDE_FUNCTION_ATTRS
int camera_pipe_batch_0051_sample_0000_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *camera_pipe_batch_0051_sample_0000_metadata();
