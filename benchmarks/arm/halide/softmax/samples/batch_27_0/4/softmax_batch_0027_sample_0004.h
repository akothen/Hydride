#ifndef HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___softmax___samples___batch_27_0___4___softmax_batch_0027_sample_0004_h
#define HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___softmax___samples___batch_27_0___4___softmax_batch_0027_sample_0004_h
#include <stdint.h>
...
int softmax_batch_0027_sample_0004(struct halide_buffer_t *_input_buffer, int16_t _beta_multiplier, uint16_t _beta_shift, uint8_t _output_zero, int16_t _output_multiplier, uint16_t _output_shift, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int softmax_batch_0027_sample_0004_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *softmax_batch_0027_sample_0004_metadata();
