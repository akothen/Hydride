; ModuleID = '/home/sb54/Hydride/hexagon-benchmarks/rake/benchmarks/hexagon/halide/average_pool/samples/batch_9_0/25/average_pool_batch_0009_sample_0025.bc'
...
%closure_t = type { i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i8, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8*, %struct.halide_buffer_t*, i8*, %struct.halide_buffer_t* }
...
@str.210 = private constant [9 x i8] c"stride_x\00", align 32
@9 = private constant [2 x i32] [i32 2, i32 0], align 8
@str.211 = private constant [9 x i8] c"stride_y\00", align 32
@10 = private constant [2 x i32] [i32 2, i32 0], align 8
@str.212 = private constant [13 x i8] c"filter_width\00", align 32
@11 = private constant [2 x i32] [i32 8, i32 0], align 8
@str.213 = private constant [14 x i8] c"filter_height\00", align 32
@12 = private constant [2 x i32] [i32 8, i32 0], align 8
@str.214 = private constant [11 x i8] c"output_min\00", align 32
@13 = private constant [8 x i8] c"\05\00\00\00\00\00\00\00", align 8
@str.215 = private constant [11 x i8] c"output_max\00", align 32
...
@24 = private constant [8 x %struct.halide_filter_argument_t] [%struct.halide_filter_argument_t { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i32 0, i32 0), i32 1, i32 4, %struct.halide_type_t { i8 1, i8 8, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** getelementptr inbounds ([8 x i64*], [8 x i64*]* @8, i32 0, i32 0) }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([9 x i8], [9 x i8]* @str.210, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 0, i8 32, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* bitcast ([2 x i32]* @9 to %struct.halide_scalar_value_t*), i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([9 x i8], [9 x i8]* @str.211, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 0, i8 32, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* bitcast ([2 x i32]* @10 to %struct.halide_scalar_value_t*), i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([13 x i8], [13 x i8]* @str.212, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 0, i8 32, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* bitcast ([2 x i32]* @11 to %struct.halide_scalar_value_t*), i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.213, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 0, i8 32, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* bitcast ([2 x i32]* @12 to %struct.halide_scalar_value_t*), i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @str.214, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 1, i8 8, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* bitcast ([8 x i8]* @13 to %struct.halide_scalar_value_t*), i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @str.215, i32 0, i32 0), i32 0, i32 0, %struct.halide_type_t { i8 1, i8 8, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* bitcast ([8 x i8]* @14 to %struct.halide_scalar_value_t*), i64** null }, %struct.halide_filter_argument_t { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i32 0, i32 0), i32 2, i32 4, %struct.halide_type_t { i8 1, i8 8, i16 1 }, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, %struct.halide_scalar_value_t* null, i64** getelementptr inbounds ([8 x i64*], [8 x i64*]* @23, i32 0, i32 0) }]
@str.216 = private constant [59 x i8] c"x86-64-linux-avx-avx2-disable_llvm_loop_opt-f16c-fma-sse41\00", align 32
@str.217 = private constant [36 x i8] c"average_pool_batch_0009_sample_0025\00", align 32
@average_pool_batch_0009_sample_0025_metadata_storage = private constant %struct.halide_filter_metadata_t { i32 1, i32 8, %struct.halide_filter_argument_t* getelementptr inbounds ([8 x %struct.halide_filter_argument_t], [8 x %struct.halide_filter_argument_t]* @24, i32 0, i32 0), i8* getelementptr inbounds ([59 x i8], [59 x i8]* @str.216, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @str.217, i32 0, i32 0) }
...
; Function Attrs: nounwind
define i32 @average_pool_batch_0009_sample_0025(%struct.halide_buffer_t* noalias %input.buffer, i32 %stride_x, i32 %stride_y, i32 %b9, i32 %b58, i8 %output_min, i8 %output_max, %struct.halide_buffer_t* noalias %output.buffer) local_unnamed_addr #9 {
entry:
...
destructor_block:                                 ; preds = %"assert succeeded47", %"for output.s0.b.rebased", %no_errors_bb27, %_halide_buffer_is_bounds_query.exit63, %"assert failed1", %"assert failed"
  %6 = phi i32 [ %5, %"assert failed" ], [ %7, %"assert failed1" ], [ 0, %_halide_buffer_is_bounds_query.exit63 ], [ 0, %no_errors_bb27 ], [ %517, %"for output.s0.b.rebased" ], [ 0, %"assert succeeded47" ]
  ret i32 %6
...
"assert succeeded2":                              ; preds = %"assert succeeded"
  ...
  %a2 = sub nsw i32 -512, %59
  %b4 = add i32 %59, -1
  %.not50 = icmp slt i32 %a2, %59
  %80 = select i1 %.not50, i32 %b4, i32 %a2
  %a1 = ashr i32 %80, 9
  %81 = icmp sgt i32 %a1, 0
  %82 = select i1 %81, i32 %a1, i32 0
  %a0 = shl nuw nsw i32 %82, 9
  %b2 = add nsw i32 %59, -512
  %83 = icmp sgt i32 %b2, %a0
  %a51 = select i1 %83, i32 %a0, i32 %b2
  %t656 = icmp slt i32 %stride_x, 0
  %t657 = icmp sgt i32 %59, 0
  %84 = add nsw i32 %59, 511
  %85 = ashr i32 %84, 9
  %86 = add nsw i32 %65, 3
  %87 = ashr i32 %86, 2
  %t757 = mul nsw i32 %87, %85
  %88 = icmp slt i32 %t757, 1
  %t758 = sext i1 %88 to i32
  %89 = icmp eq i32 %85, 0
  %t759 = sext i1 %89 to i32
  %90 = icmp slt i32 %59, -511
  %t760 = sext i1 %90 to i32
  %91 = xor i32 %t758, -1
  %92 = add i32 %t757, %91
  %93 = sub nsw i32 %85, %t759
  %94 = sdiv i32 %92, %93
  %95 = xor i32 %t760, -1
  %96 = sub nsw i32 %95, %t760
  %97 = and i32 %96, %t758
  %98 = add nsw i32 %94, %97
  %99 = xor i32 %t759, -1
  %t658 = and i32 %98, %99
  %t658.op = shl i32 %t658, 2
  %a3 = select i1 %t657, i32 %t658.op, i32 0
  %b5 = add nsw i32 %65, -4
  %100 = icmp sgt i32 %b5, %a3
  %t659 = select i1 %100, i32 %a3, i32 %b5
  %a4 = select i1 %t657, i32 0, i32 %t658.op
  %101 = icmp sgt i32 %b5, %a4
  %t660 = select i1 %101, i32 %a4, i32 %b5
  %102 = add nsw i32 %t659, 3
  %t661.s = select i1 %t656, i32 %102, i32 %t660
  %a6 = add nsw i32 %29, %27
  %103 = add nsw i32 %t661.s, %63
  %104 = mul nsw i32 %103, %stride_x
  %a7 = sub nsw i32 %a6, %104
  %105 = icmp slt i32 %a7, %b9
  %106 = select i1 %105, i32 %a7, i32 %b9
  %107 = select i1 %t656, i32 %t660, i32 %102
  %108 = add nsw i32 %107, %63
  %109 = mul nsw i32 %108, %stride_x
  %b8 = add nsw i32 %106, %109
  %110 = icmp sgt i32 %b8, %a6
  %111 = select i1 %110, i32 %a6, i32 %b8
  %a5 = add nsw i32 %111, -1
  %112 = icmp sgt i32 %a5, %27
  %113 = select i1 %112, i32 %a5, i32 %27
  %b11 = add nsw i32 %a6, -1
  %114 = icmp sgt i32 %b11, %104
  %a8 = select i1 %114, i32 %104, i32 %b11
  %115 = icmp sgt i32 %a8, %27
  %116 = select i1 %115, i32 %a8, i32 %27
  %input.extent.1.required.s = sub nsw i32 %113, %116
  %t665 = icmp slt i32 %stride_y, 0
  %117 = add nsw i32 %71, 8
  %118 = icmp slt i32 %71, 9
  %119 = select i1 %118, i32 %71, i32 9
  %t667.s = select i1 %t665, i32 %117, i32 %119
  %t668.s = select i1 %t665, i32 %119, i32 %117
  %a17 = add nsw i32 %35, %33
  %120 = add i32 %69, -9
  %121 = add i32 %120, %t667.s
  %122 = mul nsw i32 %121, %stride_y
  %a18 = sub nsw i32 %a17, %122
  %123 = icmp slt i32 %a18, %b58
  %124 = select i1 %123, i32 %a18, i32 %b58
  %125 = add i32 %120, %t668.s
  %126 = mul nsw i32 %125, %stride_y
  %b19 = add nsw i32 %124, %126
  %127 = icmp sgt i32 %b19, %a17
  %128 = select i1 %127, i32 %a17, i32 %b19
  %a16 = add nsw i32 %128, -1
  %129 = icmp sgt i32 %a16, %33
  %130 = select i1 %129, i32 %a16, i32 %33
  %a20 = add nsw i32 %a17, -1
  %a21 = sub nsw i32 %33, %126
  %131 = icmp sgt i32 %a21, 0
  %132 = select i1 %131, i32 %a21, i32 0
  %b22 = add nsw i32 %132, %122
  %.not52 = icmp slt i32 %b22, %a17
  %a19 = select i1 %.not52, i32 %b22, i32 %a20
  %133 = icmp sgt i32 %a19, %33
  %134 = select i1 %133, i32 %a19, i32 %33
  %135 = icmp sgt i32 %a51, 0
  %136 = select i1 %135, i32 %a51, i32 0
  %137 = add nuw nsw i32 %136, 512
  %138 = add nsw i32 %input.extent.1.required.s, 1
  %input.stride.2.required = mul nsw i32 %138, %137
  %output.extent.1.required.s = sub nsw i32 %t659, %t660
  %139 = add nsw i32 %output.extent.1.required.s, 4
  %output.stride.2.required = mul nsw i32 %139, %137
  %140 = load i8*, i8** %8, align 8, !tbaa !181
  %141 = icmp eq i8* %140, null
  br i1 %141, label %_halide_buffer_is_bounds_query.exit, label %after_bb

_halide_buffer_is_bounds_query.exit:              ; preds = %"assert succeeded2"
  %142 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 0
  %143 = load i64, i64* %142, align 8, !tbaa !183
  %144 = icmp eq i64 %143, 0
  br i1 %144, label %then_bb, label %after_bb

after_bb:                                         ; preds = %_halide_buffer_init.exit, %_halide_buffer_is_bounds_query.exit, %"assert succeeded2"
  %145 = load i8*, i8** %44, align 8, !tbaa !181
  %146 = icmp eq i8* %145, null
  br i1 %146, label %_halide_buffer_is_bounds_query.exit61, label %after_bb3

_halide_buffer_is_bounds_query.exit61:            ; preds = %after_bb
  %147 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 0
  %148 = load i64, i64* %147, align 8, !tbaa !183
  %149 = icmp eq i64 %148, 0
  br i1 %149, label %then_bb4, label %after_bb3

then_bb:                                          ; preds = %_halide_buffer_is_bounds_query.exit
  %input.extent.2.required.s = sub nsw i32 %130, %134
  %150 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %18, align 8, !tbaa !185
  %151 = icmp slt i32 %59, 512
  %152 = select i1 %151, i32 %59, i32 512
  %153 = add i32 %57, -512
  %154 = add i32 %153, %152
  %155 = add nsw i32 %input.extent.2.required.s, 1
  %156 = mul nsw i32 %input.stride.2.required, %155
  %157 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 0
  store i32 %154, i32* %157, align 4
  %158 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 1
  store i32 %137, i32* %158, align 4
  %159 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 2
  store i32 1, i32* %159, align 4
  %160 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 3
  store i32 0, i32* %160, align 4
  %161 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 4
  store i32 %116, i32* %161, align 4
  %162 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 5
  store i32 %138, i32* %162, align 4
  %163 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 6
  store i32 %137, i32* %163, align 4
  %164 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 7
  store i32 0, i32* %164, align 4
  %165 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 8
  store i32 %134, i32* %165, align 4
  %166 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 9
  store i32 %155, i32* %166, align 4
  %167 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 10
  store i32 %input.stride.2.required, i32* %167, align 4
  %168 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 11
  store i32 0, i32* %168, align 4
  %169 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 12
  store i32 %75, i32* %169, align 4
  %170 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 13
  store i32 %77, i32* %170, align 4
  %171 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 14
  store i32 %156, i32* %171, align 4
  %172 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 15
  store i32 0, i32* %172, align 4
  %173 = bitcast [16 x i32]* %4 to %struct.halide_dimension_t*
  %174 = bitcast %struct.halide_buffer_t* %input.buffer to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(24) %174, i8 0, i64 24, i1 false)
  store i8 1, i8* %11, align 8, !tbaa !368
  %175 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 4, i32 1
  store i8 8, i8* %175, align 1, !tbaa !369
  %176 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 4, i32 2
  store i16 1, i16* %176, align 2, !tbaa !370
  store i32 4, i32* %16, align 4, !tbaa !184
  %.not69 = icmp eq %struct.halide_dimension_t* %150, %173
  br i1 %.not69, label %_halide_buffer_init.exit, label %177

177:                                              ; preds = %then_bb
  %178 = bitcast %struct.halide_dimension_t* %150 to i8*
  %179 = bitcast [16 x i32]* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %178, i8* nonnull align 4 dereferenceable(16) %179, i64 16, i1 false) #10, !tbaa.struct !186
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.i, %177
  %180 = phi i64 [ %186, %.preheader.i ], [ 1, %177 ]
  %181 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %18, align 8, !tbaa !185
  %182 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %173, i64 %180
  %183 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %181, i64 %180
  %184 = bitcast %struct.halide_dimension_t* %183 to i8*
  %185 = bitcast %struct.halide_dimension_t* %182 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %184, i8* nonnull align 4 dereferenceable(16) %185, i64 16, i1 false) #10, !tbaa.struct !186
  %186 = add nuw nsw i64 %180, 1
  %187 = icmp eq i64 %186, 4
  br i1 %187, label %_halide_buffer_init.exit, label %.preheader.i, !llvm.loop !371
...
after_bb3:                                        ; preds = %_halide_buffer_init.exit65, %_halide_buffer_is_bounds_query.exit61, %after_bb
  %188 = load i8*, i8** %8, align 8, !tbaa !181
  %189 = icmp eq i8* %188, null
  br i1 %189, label %190, label %_halide_buffer_is_bounds_query.exit62

190:                                              ; preds = %after_bb3
  %191 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 0
  %192 = load i64, i64* %191, align 8, !tbaa !183
  %193 = icmp eq i64 %192, 0
  br label %_halide_buffer_is_bounds_query.exit62

_halide_buffer_is_bounds_query.exit62:            ; preds = %190, %after_bb3
  %194 = phi i1 [ false, %after_bb3 ], [ %193, %190 ]
  %195 = load i8*, i8** %44, align 8, !tbaa !181
  %196 = icmp eq i8* %195, null
  br i1 %196, label %197, label %_halide_buffer_is_bounds_query.exit63

197:                                              ; preds = %_halide_buffer_is_bounds_query.exit62
  %198 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 0
  %199 = load i64, i64* %198, align 8, !tbaa !183
  %200 = icmp eq i64 %199, 0
  br label %_halide_buffer_is_bounds_query.exit63

_halide_buffer_is_bounds_query.exit63:            ; preds = %197, %_halide_buffer_is_bounds_query.exit62
  %201 = phi i1 [ false, %_halide_buffer_is_bounds_query.exit62 ], [ %200, %197 ]
  %202 = or i1 %194, %201
  br i1 %202, label %destructor_block, label %then_bb7

then_bb4:                                         ; preds = %_halide_buffer_is_bounds_query.exit61
  %203 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %54, align 8, !tbaa !185
  %204 = icmp slt i32 %59, 512
  %205 = select i1 %204, i32 %59, i32 512
  %206 = add i32 %57, -512
  %207 = add i32 %206, %205
  %208 = add nsw i32 %t660, %63
  %209 = add i32 %120, %119
  %210 = icmp sgt i32 %71, 9
  %211 = select i1 %210, i32 %71, i32 9
  %212 = mul nsw i32 %output.stride.2.required, %211
  %213 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 0
  store i32 %207, i32* %213, align 4
  %214 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 1
  store i32 %137, i32* %214, align 4
  %215 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 2
  store i32 1, i32* %215, align 4
  %216 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 3
  store i32 0, i32* %216, align 4
  %217 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 4
  store i32 %208, i32* %217, align 4
  %218 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 5
  store i32 %139, i32* %218, align 4
  %219 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 6
  store i32 %137, i32* %219, align 4
  %220 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 7
  store i32 0, i32* %220, align 4
  %221 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 8
  store i32 %209, i32* %221, align 4
  %222 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 9
  store i32 %211, i32* %222, align 4
  %223 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 10
  store i32 %output.stride.2.required, i32* %223, align 4
  %224 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 11
  store i32 0, i32* %224, align 4
  %225 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 12
  store i32 %75, i32* %225, align 4
  %226 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 13
  store i32 %77, i32* %226, align 4
  %227 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 14
  store i32 %212, i32* %227, align 4
  %228 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 15
  store i32 0, i32* %228, align 4
  %229 = bitcast [16 x i32]* %3 to %struct.halide_dimension_t*
  %230 = bitcast %struct.halide_buffer_t* %output.buffer to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(24) %230, i8 0, i64 24, i1 false)
  store i8 1, i8* %47, align 8, !tbaa !368
  %231 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 4, i32 1
  store i8 8, i8* %231, align 1, !tbaa !369
  %232 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 4, i32 2
  store i16 1, i16* %232, align 2, !tbaa !370
  store i32 4, i32* %52, align 4, !tbaa !184
  %.not68 = icmp eq %struct.halide_dimension_t* %203, %229
  br i1 %.not68, label %_halide_buffer_init.exit65, label %233

233:                                              ; preds = %then_bb4
  %234 = bitcast %struct.halide_dimension_t* %203 to i8*
  %235 = bitcast [16 x i32]* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %234, i8* nonnull align 4 dereferenceable(16) %235, i64 16, i1 false) #10, !tbaa.struct !186
  br label %.preheader.i64

.preheader.i64:                                   ; preds = %.preheader.i64, %233
  %236 = phi i64 [ %242, %.preheader.i64 ], [ 1, %233 ]
  %237 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %54, align 8, !tbaa !185
  %238 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %229, i64 %236
  %239 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %237, i64 %236
  %240 = bitcast %struct.halide_dimension_t* %239 to i8*
  %241 = bitcast %struct.halide_dimension_t* %238 to i8*
  ...
  br i1 %243, label %_halide_buffer_init.exit65, label %.preheader.i64, !llvm.loop !371
...
then_bb7:                                         ; preds = %_halide_buffer_is_bounds_query.exit63
  %244 = icmp ne i32 %13, 67585
  %245 = zext i1 %244 to i64
  %.not53 = icmp eq i32 %17, 4
  %246 = select i1 %.not53, i64 0, i64 2
  %.not54 = icmp eq i32 %49, 67585
  %247 = select i1 %.not54, i64 0, i64 4
  %.not55 = icmp eq i32 %53, 4
  %248 = select i1 %.not55, i64 0, i64 8
  %249 = add nsw i32 %21, 512
  %250 = icmp slt i32 %59, 512
  %251 = select i1 %250, i32 %59, i32 512
  %252 = add nsw i32 %251, %57
  %253 = icmp sgt i32 %249, %252
  %254 = add nsw i32 %136, %251
  %255 = add nsw i32 %254, %57
  %256 = add nsw i32 %23, %21
  ...
  %.not56 = icmp slt i32 %113, %a6
  %263 = select i1 %.not56, i64 0, i64 64
  %264 = lshr i32 %29, 24
  %265 = and i32 %264, 128
  %266 = zext i32 %265 to i64
  %.not57 = icmp slt i32 %130, %a17
  %267 = select i1 %.not57, i64 0, i64 256
  %268 = lshr i32 %35, 22
  %269 = and i32 %268, 512
  %270 = zext i32 %269 to i64
  %271 = icmp sgt i32 %39, %75
  %272 = add nsw i32 %77, %75
  %273 = add nsw i32 %41, %39
  %274 = icmp sgt i32 %272, %273
  %275 = or i1 %271, %274
  %276 = select i1 %275, i64 1024, i64 0
  %277 = lshr i32 %41, 20
  %278 = and i32 %277, 2048
  %279 = zext i32 %278 to i64
  %280 = icmp sgt i32 %254, 512
  %281 = select i1 %280, i32 %254, i32 512
  %282 = icmp sgt i32 %281, %59
  %283 = select i1 %282, i64 4096, i64 0
  %284 = add i32 %t659, %63
  %285 = add nsw i32 %284, 4
  %286 = add nsw i32 %65, %63
  %287 = icmp sgt i32 %285, %286
  %288 = zext i1 %287 to i64
  %t660.lobit = lshr i32 %t660, 31
  %289 = zext i32 %t660.lobit to i64
  %290 = or i64 %288, %289
  %291 = shl nuw nsw i64 %290, 13
  %292 = lshr i32 %65, 17
  %293 = and i32 %292, 16384
  %294 = zext i32 %293 to i64
  %295 = select i1 %118, i64 32768, i64 0
  %296 = lshr i32 %77, 15
  %297 = and i32 %296, 65536
  %298 = zext i32 %297 to i64
  %.not58 = icmp eq i32 %25, 1
  %299 = select i1 %.not58, i64 0, i64 131072
  %.not59 = icmp eq i32 %61, 1
  %300 = select i1 %.not59, i64 0, i64 262144
  %301 = or i64 %246, %245
  %302 = or i64 %301, %262
  %303 = or i64 %302, %299
  %304 = or i64 %303, %266
  ...
  %317 = or i64 %316, %291
  %318 = or i64 %317, %263
  %319 = or i64 %318, -9223372036854775808
  %320 = call i64 @llvm.cttz.i64(i64 %319, i1 true), !range !372
  %321 = trunc i64 %320 to i32
  switch i32 %321, label %no_errors_bb [
...
no_errors_bb:                                     ; preds = %then_bb7
  %322 = sext i32 %29 to i64
  %323 = sext i32 %23 to i64
  %input.total_extent.1 = mul nsw i64 %322, %323
  %324 = sext i32 %35 to i64
  %input.total_extent.2 = mul nsw i64 %input.total_extent.1, %324
  %325 = sext i32 %41 to i64
  %input.total_extent.3 = mul nsw i64 %input.total_extent.2, %325
  %326 = sext i32 %65 to i64
  %327 = sext i32 %59 to i64
  %output.total_extent.1 = mul nsw i64 %326, %327
  %328 = sext i32 %71 to i64
  %output.total_extent.2 = mul nsw i64 %output.total_extent.1, %328
  %329 = sext i32 %77 to i64
  %output.total_extent.3 = mul nsw i64 %output.total_extent.2, %329
  %input.extent.0.lobit = lshr i32 %23, 31
  %330 = zext i32 %input.extent.0.lobit to i64
  %331 = sext i32 %31 to i64
  %x0 = mul nsw i64 %331, %322
  %332 = call i64 @llvm.abs.i64(i64 %x0, i1 true)
  %333 = icmp ugt i64 %332, 2147483647
  %334 = select i1 %333, i64 2, i64 0
  %335 = icmp sgt i64 %input.total_extent.1, 2147483647
  %336 = select i1 %335, i64 4, i64 0
  %337 = sext i32 %37 to i64
  %x1 = mul nsw i64 %337, %324
  %338 = call i64 @llvm.abs.i64(i64 %x1, i1 true)
  %339 = icmp ugt i64 %338, 2147483647
  %340 = select i1 %339, i64 8, i64 0
  %341 = icmp sgt i64 %input.total_extent.2, 2147483647
  %342 = select i1 %341, i64 16, i64 0
  %343 = sext i32 %43 to i64
  %x2 = mul nsw i64 %343, %325
  %344 = call i64 @llvm.abs.i64(i64 %x2, i1 true)
  %345 = icmp ugt i64 %344, 2147483647
  %346 = select i1 %345, i64 32, i64 0
  %347 = icmp sgt i64 %input.total_extent.3, 2147483647
  %348 = select i1 %347, i64 64, i64 0
  %349 = lshr i32 %59, 24
  %350 = and i32 %349, 128
  %351 = zext i32 %350 to i64
  %352 = sext i32 %67 to i64
  %x3 = mul nsw i64 %352, %326
  %353 = call i64 @llvm.abs.i64(i64 %x3, i1 true)
  %354 = icmp ugt i64 %353, 2147483647
  %355 = select i1 %354, i64 256, i64 0
  %356 = icmp sgt i64 %output.total_extent.1, 2147483647
  %357 = select i1 %356, i64 512, i64 0
  %358 = sext i32 %73 to i64
  %x4 = mul nsw i64 %358, %328
  %359 = call i64 @llvm.abs.i64(i64 %x4, i1 true)
  %360 = icmp ugt i64 %359, 2147483647
  %361 = select i1 %360, i64 1024, i64 0
  %362 = icmp sgt i64 %output.total_extent.2, 2147483647
  %363 = select i1 %362, i64 2048, i64 0
  %364 = sext i32 %79 to i64
  %x5 = mul nsw i64 %364, %329
  %365 = call i64 @llvm.abs.i64(i64 %x5, i1 true)
  %366 = icmp ugt i64 %365, 2147483647
  %367 = select i1 %366, i64 4096, i64 0
  %368 = icmp sgt i64 %output.total_extent.3, 2147483647
  %369 = select i1 %368, i64 8192, i64 0
  %370 = shl i64 %15, 13
  %371 = and i64 %370, 16384
  %372 = shl i64 %51, 14
  %373 = and i64 %372, 32768
  %374 = icmp eq i8* %9, null
  %375 = icmp eq i8* %45, null
  %376 = select i1 %375, i64 131072, i64 0
  %377 = select i1 %374, i64 -9223372036854710272, i64 -9223372036854775808
  %378 = or i64 %377, %371
  %379 = or i64 %378, %330
  %380 = or i64 %379, %336
  %381 = or i64 %380, %334
  ...
  %393 = or i64 %392, %369
  %394 = or i64 %393, %367
  %395 = call i64 @llvm.cttz.i64(i64 %394, i1 true), !range !372
  %396 = trunc i64 %395 to i32
  switch i32 %396, label %no_errors_bb27 [
...
assert_failed:                                    ; preds = %then_bb7
  %397 = call i32 @halide_error_bad_type(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 %13, i32 67585) #10
  ret i32 %397

assert_failed9:                                   ; preds = %then_bb7
  %398 = call i32 @halide_error_bad_dimensions(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 %17, i32 4) #10
  ret i32 %398

assert_failed10:                                  ; preds = %then_bb7
  %399 = call i32 @halide_error_bad_type(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 %49, i32 67585) #10
  ret i32 %399

assert_failed11:                                  ; preds = %then_bb7
  %400 = call i32 @halide_error_bad_dimensions(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 %53, i32 4) #10
  ret i32 %400

assert_failed12:                                  ; preds = %then_bb7
  %401 = add nsw i32 %252, -512
  %402 = add nsw i32 %255, -1
  %403 = add nsw i32 %256, -1
  %404 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 0, i32 %401, i32 %402, i32 %21, i32 %403) #10
  ret i32 %404

assert_failed13:                                  ; preds = %then_bb7
  %405 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 0, i32 %23) #10
  ret i32 %405

assert_failed14:                                  ; preds = %then_bb7
  %406 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 1, i32 %116, i32 %113, i32 %27, i32 %b11) #10
  ret i32 %406

assert_failed15:                                  ; preds = %then_bb7
  %407 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 1, i32 %29) #10
  ret i32 %407

assert_failed16:                                  ; preds = %then_bb7
  %408 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 2, i32 %134, i32 %130, i32 %33, i32 %a20) #10
  ret i32 %408

assert_failed17:                                  ; preds = %then_bb7
  %409 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 2, i32 %35) #10
  ret i32 %409

assert_failed18:                                  ; preds = %then_bb7
  %410 = add nsw i32 %272, -1
  %411 = add nsw i32 %273, -1
  %412 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 3, i32 %75, i32 %410, i32 %39, i32 %411) #10
  ret i32 %412

assert_failed19:                                  ; preds = %then_bb7
  %413 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 3, i32 %41) #10
  ret i32 %413

assert_failed20:                                  ; preds = %then_bb7
  %414 = add nsw i32 %252, -512
  %415 = add nsw i32 %255, -1
  %416 = add i32 %b4, %57
  %417 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 0, i32 %414, i32 %415, i32 %57, i32 %416) #10
  ret i32 %417

assert_failed21:                                  ; preds = %then_bb7
  %418 = add nsw i32 %t660, %63
  %419 = add nsw i32 %284, 3
  %420 = add nsw i32 %286, -1
  %421 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 1, i32 %418, i32 %419, i32 %63, i32 %420) #10
  ret i32 %421

assert_failed22:                                  ; preds = %then_bb7
  %422 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 1, i32 %65) #10
  ret i32 %422
...
assert_failed23:                                  ; preds = %then_bb7
  ...
  %424 = add i32 %71, -1
  %425 = add i32 %424, %69
  %426 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 2, i32 %423, i32 %425, i32 %69, i32 %425) #10
  ret i32 %426

assert_failed24:                                  ; preds = %then_bb7
  %427 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 3, i32 %77) #10
  ret i32 %427

assert_failed25:                                  ; preds = %then_bb7
  %428 = call i32 @halide_error_constraint_violated(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.206, i64 0, i64 0), i32 %25, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.207, i64 0, i64 0), i32 1) #10
  ret i32 %428

assert_failed26:                                  ; preds = %then_bb7
  %429 = call i32 @halide_error_constraint_violated(i8* null, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @str.208, i64 0, i64 0), i32 %61, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.207, i64 0, i64 0), i32 1) #10
  ret i32 %429

no_errors_bb27:                                   ; preds = %no_errors_bb
  %430 = select i1 %t665, i32 9, i32 %117
  %431 = add i32 %120, %430
  %t704 = mul nsw i32 %431, %stride_y
  %432 = select i1 %t665, i32 %117, i32 9
  %433 = add i32 %120, %432
  %t705 = mul nsw i32 %433, %stride_y
  %t706 = add nsw i32 %71, -1
  %434 = select i1 %t665, i32 0, i32 %t706
  %435 = add nsw i32 %434, %69
  %t707 = mul nsw i32 %435, %stride_y
  %436 = select i1 %t665, i32 %t706, i32 0
  %437 = add nsw i32 %436, %69
  %t708 = mul nsw i32 %437, %stride_y
  %a55 = sub nsw i32 %a17, %t705
  %438 = icmp slt i32 %a55, %b58
  %439 = select i1 %438, i32 %a55, i32 %b58
  %a54 = add nsw i32 %439, %t704
  %a56 = sub nsw i32 %a17, %t708
  %440 = icmp slt i32 %a56, %b58
  %441 = select i1 %440, i32 %a56, i32 %b58
  %b56 = add nsw i32 %441, %t707
  %a58 = sub nsw i32 %33, %t704
  %442 = icmp sgt i32 %a58, 0
  %443 = select i1 %442, i32 %a58, i32 0
  %a57 = add nsw i32 %443, %t705
  %a59 = sub nsw i32 %33, %t707
  %444 = icmp sgt i32 %a59, 0
  %445 = select i1 %444, i32 %a59, i32 0
  %b59 = add nsw i32 %445, %t708
  %446 = icmp sgt i32 %b59, %a57
  %t692 = select i1 %446, i32 %a57, i32 %b59
  %447 = ashr i32 %117, 31
  %448 = xor i32 %447, %117
  %449 = zext i32 %448 to i64
  %450 = mul nuw nsw i64 %449, 954437177
  %451 = lshr i64 %450, 33
  %452 = trunc i64 %451 to i32
  %t696 = xor i32 %447, %452
  %453 = icmp sgt i32 %77, 0
  br i1 %453, label %"for output.s0.b.rebased.preheader", label %destructor_block, !prof !375

"for output.s0.b.rebased.preheader":              ; preds = %no_errors_bb27
  %.neg71 = mul i32 %67, %63
  %.neg70 = mul i32 %73, %69
  %.neg = mul i32 %79, %75
  %454 = icmp sgt i32 %a54, %b56
  %455 = select i1 %454, i32 %a54, i32 %b56
  %.neg74 = mul i32 %31, %27
  %.neg75 = mul i32 %37, %33
  %.neg76 = mul i32 %43, %39
  %reass.add80 = add i32 %.neg75, %.neg74
  %reass.add81 = add i32 %reass.add80, %.neg76
  %456 = xor i32 %t692, -1
  %t711 = add i32 %455, %456
  %457 = lshr i32 %stride_y, 28
  %458 = and i32 %457, 8
  %t712 = add nsw i32 %69, %458
  %459 = xor i32 %458, 8
  %t713 = add nsw i32 %69, %459
  %460 = select i1 %t656, i32 3, i32 0
  %t709 = add nsw i32 %63, %460
  %461 = select i1 %t656, i32 0, i32 3
  %t710 = add nsw i32 %63, %461
  %reass.add = add i32 %.neg70, %.neg71
  %reass.add79 = add i32 %reass.add, %.neg
  %462 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 0
  %463 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 1
  %464 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 2
  %465 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 3
  %466 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 4
  %467 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 5
  %468 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 6
  %469 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 7
  %470 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 8
  %471 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 9
  %472 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 10
  %473 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 11
  %474 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 12
  %475 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 13
  %476 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 14
  %477 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 15
  %478 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 16
  %479 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 17
  %480 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 18
  %481 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 19
  %482 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 20
  %483 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 21
  %484 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 22
  %485 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 23
  %486 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 24
  %487 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 25
  %488 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 26
  %489 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 27
  %490 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 28
  %491 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 29
  %492 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 30
  %493 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 31
  %494 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 32
  %495 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 33
  %496 = bitcast %closure_t* %2 to i8*
  br label %"for output.s0.b.rebased"

assert_failed28:                                  ; preds = %no_errors_bb
  %497 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %323, i64 2147483647) #10
  ret i32 %497

assert_failed29:                                  ; preds = %no_errors_bb
  %498 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %332, i64 2147483647) #10
  ret i32 %498

assert_failed30:                                  ; preds = %no_errors_bb
  %499 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %input.total_extent.1, i64 2147483647) #10
  ret i32 %499

assert_failed31:                                  ; preds = %no_errors_bb
  %500 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %338, i64 2147483647) #10
  ret i32 %500

assert_failed32:                                  ; preds = %no_errors_bb
  %501 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %input.total_extent.2, i64 2147483647) #10
  ret i32 %501

assert_failed33:                                  ; preds = %no_errors_bb
  %502 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %344, i64 2147483647) #10
  ret i32 %502

assert_failed34:                                  ; preds = %no_errors_bb
  %503 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %input.total_extent.3, i64 2147483647) #10
  ret i32 %503

assert_failed35:                                  ; preds = %no_errors_bb
  %504 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %327, i64 2147483647) #10
  ret i32 %504

assert_failed36:                                  ; preds = %no_errors_bb
  %505 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %353, i64 2147483647) #10
  ret i32 %505

assert_failed37:                                  ; preds = %no_errors_bb
  %506 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %output.total_extent.1, i64 2147483647) #10
  ret i32 %506

assert_failed38:                                  ; preds = %no_errors_bb
  %507 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %359, i64 2147483647) #10
  ret i32 %507

assert_failed39:                                  ; preds = %no_errors_bb
  %508 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %output.total_extent.2, i64 2147483647) #10
  ret i32 %508

assert_failed40:                                  ; preds = %no_errors_bb
  %509 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %365, i64 2147483647) #10
  ret i32 %509

assert_failed41:                                  ; preds = %no_errors_bb
  %510 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %output.total_extent.3, i64 2147483647) #10
  ret i32 %510

assert_failed42:                                  ; preds = %no_errors_bb
  %511 = call i32 @halide_error_device_dirty_with_no_device_support(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0)) #10
  ret i32 %511

assert_failed43:                                  ; preds = %no_errors_bb
  %512 = call i32 @halide_error_device_dirty_with_no_device_support(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0)) #10
  ret i32 %512

assert_failed44:                                  ; preds = %no_errors_bb
  %513 = call i32 @halide_error_host_is_null(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0)) #10
  ret i32 %513

assert_failed45:                                  ; preds = %no_errors_bb
  %514 = call i32 @halide_error_host_is_null(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0)) #10
  ret i32 %514

"for output.s0.b.rebased":                        ; preds = %"assert succeeded47", %"for output.s0.b.rebased.preheader"
  %output.s0.b.rebased = phi i32 [ %519, %"assert succeeded47" ], [ 0, %"for output.s0.b.rebased.preheader" ]
  %t716 = add nsw i32 %output.s0.b.rebased, %75
  %515 = mul nsw i32 %t716, %43
  %t699.neg = sub i32 %515, %21
  %t714 = sub i32 %t699.neg, %reass.add81
  %516 = mul nsw i32 %t716, %79
  %t715 = sub i32 %516, %reass.add79
  store i32 %b58, i32* %462, align 8
  store i32 %b9, i32* %463, align 4
  store i32 %27, i32* %464, align 8
  store i32 %33, i32* %465, align 4
  store i32 %31, i32* %466, align 8
  store i32 %37, i32* %467, align 4
  store i32 %59, i32* %468, align 8
  store i32 %65, i32* %469, align 4
  store i32 %71, i32* %470, align 8
  store i32 %57, i32* %471, align 4
  store i32 %63, i32* %472, align 8
  store i32 %69, i32* %473, align 4
  store i32 %67, i32* %474, align 8
  store i32 %73, i32* %475, align 4
  store i8 %output_max, i8* %476, align 8
  store i8 %output_min, i8* %477, align 1
  store i32 %stride_x, i32* %478, align 4
  store i32 %stride_y, i32* %479, align 8
  store i32 %85, i32* %480, align 4
  store i32 %t692, i32* %481, align 8
  store i32 %a6, i32* %482, align 4
  store i32 %t696, i32* %483, align 8
  store i32 %a17, i32* %484, align 4
  store i32 %t709, i32* %485, align 8
  store i32 %t710, i32* %486, align 4
  store i32 %t711, i32* %487, align 8
  store i32 %t712, i32* %488, align 4
  store i32 %t713, i32* %489, align 8
  store i32 %t714, i32* %490, align 4
  store i32 %t715, i32* %491, align 8
  store i8* %9, i8** %492, align 8
  store %struct.halide_buffer_t* %input.buffer, %struct.halide_buffer_t** %493, align 8
  store i8* %45, i8** %494, align 8
  store %struct.halide_buffer_t* %output.buffer, %struct.halide_buffer_t** %495, align 8
  %517 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @average_pool_batch_0009_sample_0025.par_for.output.s0.c.c.c, i32 0, i32 %t757, i8* nonnull %496)
  %518 = icmp eq i32 %517, 0
  br i1 %518, label %"assert succeeded47", label %destructor_block, !prof !375

"assert succeeded47":                             ; preds = %"for output.s0.b.rebased"
  %519 = add nuw nsw i32 %output.s0.b.rebased, 1
  %.not60 = icmp eq i32 %519, %77
...
; Function Attrs: nounwind
define internal i32 @average_pool_batch_0009_sample_0025.par_for.output.s0.c.c.c(i8* %__user_context, i32 %output.s0.c.c.c, i8* noalias readonly %closure) #9 {
entry:
  %0 = bitcast i8* %closure to i32*
  %b90 = load i32, i32* %0, align 4
  %1 = getelementptr inbounds i8, i8* %closure, i64 4
  %2 = bitcast i8* %1 to i32*
  %b86 = load i32, i32* %2, align 4
  %3 = getelementptr inbounds i8, i8* %closure, i64 8
  %4 = bitcast i8* %3 to i32*
  %a90 = load i32, i32* %4, align 4
  %5 = getelementptr inbounds i8, i8* %closure, i64 12
  %6 = bitcast i8* %5 to i32*
  %a92 = load i32, i32* %6, align 4
  ...
  %input.stride.2 = load i32, i32* %10, align 4
  ...
  %output.extent.2 = load i32, i32* %16, align 4
  %17 = getelementptr inbounds i8, i8* %closure, i64 36
  %18 = bitcast i8* %17 to i32*
  %output.min.0 = load i32, i32* %18, align 4
  ...
  %output_max = load i8, i8* %27, align 1
  %28 = getelementptr inbounds i8, i8* %closure, i64 57
  %output_min = load i8, i8* %28, align 1
  %29 = getelementptr inbounds i8, i8* %closure, i64 60
  %30 = bitcast i8* %29 to i32*
  %stride_x = load i32, i32* %30, align 4
  %31 = getelementptr inbounds i8, i8* %closure, i64 64
  %32 = bitcast i8* %31 to i32*
  %stride_y = load i32, i32* %32, align 4
  %33 = getelementptr inbounds i8, i8* %closure, i64 68
  %34 = bitcast i8* %33 to i32*
  %t691 = load i32, i32* %34, align 4
  %35 = getelementptr inbounds i8, i8* %closure, i64 72
  %36 = bitcast i8* %35 to i32*
  %t692 = load i32, i32* %36, align 4
  %37 = getelementptr inbounds i8, i8* %closure, i64 76
  %38 = bitcast i8* %37 to i32*
  %b91 = load i32, i32* %38, align 4
  %39 = getelementptr inbounds i8, i8* %closure, i64 80
  %40 = bitcast i8* %39 to i32*
  %t696 = load i32, i32* %40, align 4
  %41 = getelementptr inbounds i8, i8* %closure, i64 84
  %42 = bitcast i8* %41 to i32*
  %b93 = load i32, i32* %42, align 4
  %43 = getelementptr inbounds i8, i8* %closure, i64 88
  %44 = bitcast i8* %43 to i32*
  %t709 = load i32, i32* %44, align 4
  %45 = getelementptr inbounds i8, i8* %closure, i64 92
  %46 = bitcast i8* %45 to i32*
  %t710 = load i32, i32* %46, align 4
  %47 = getelementptr inbounds i8, i8* %closure, i64 96
  %48 = bitcast i8* %47 to i32*
  %a73 = load i32, i32* %48, align 4
  %49 = getelementptr inbounds i8, i8* %closure, i64 100
  %50 = bitcast i8* %49 to i32*
  %t712 = load i32, i32* %50, align 4
  %51 = getelementptr inbounds i8, i8* %closure, i64 104
  %52 = bitcast i8* %51 to i32*
  %t713 = load i32, i32* %52, align 4
  %53 = getelementptr inbounds i8, i8* %closure, i64 108
  %54 = bitcast i8* %53 to i32*
  %t714 = load i32, i32* %54, align 4
  %55 = getelementptr inbounds i8, i8* %closure, i64 112
  %56 = bitcast i8* %55 to i32*
  %t715 = load i32, i32* %56, align 4
  %57 = getelementptr inbounds i8, i8* %closure, i64 120
  %58 = bitcast i8* %57 to i8**
  %input = load i8*, i8** %58, align 8
  %59 = getelementptr inbounds i8, i8* %closure, i64 136
  %60 = bitcast i8* %59 to i8**
  %output = load i8*, i8** %60, align 8
  %output.s0.c.c.c.lobit = ashr i32 %output.s0.c.c.c, 31
  %61 = icmp eq i32 %t691, 0
  %t774 = sext i1 %61 to i32
  %t691.lobit = ashr i32 %t691, 31
  %62 = sub nsw i32 %output.s0.c.c.c, %output.s0.c.c.c.lobit
  %63 = or i32 %t691, %t774
  %64 = srem i32 %62, %63
  %65 = xor i32 %t691.lobit, %t691
  %66 = xor i32 %t691.lobit, -1
  %67 = add nsw i32 %65, %66
  %68 = and i32 %67, %output.s0.c.c.c.lobit
  %69 = add nsw i32 %64, %68
  %70 = xor i32 %t774, -1
  %71 = and i32 %69, %70
  %a60 = shl nsw i32 %71, 9
  %b62 = add nsw i32 %output.extent.0, -512
  %72 = icmp sgt i32 %b62, %a60
  %output.s0.c.ci.base.s = select i1 %72, i32 %a60, i32 %b62
  %73 = sub nsw i32 %t691, %t774
  %74 = sdiv i32 %62, %73
  %75 = sub nsw i32 %66, %t691.lobit
  %76 = and i32 %75, %output.s0.c.c.c.lobit
  %77 = add nsw i32 %74, %76
  %78 = and i32 %77, %70
  %a61 = shl nsw i32 %78, 2
  %b63 = add nsw i32 %output.extent.1, -4
  %79 = icmp sgt i32 %b63, %a61
  %output.s0.x.xi.base.s = select i1 %79, i32 %a61, i32 %b63
  %80 = add nsw i32 %output.s0.x.xi.base.s, %t709
  %a63 = mul nsw i32 %80, %stride_x
  %81 = icmp sgt i32 %a63, %a90
  %a62 = select i1 %81, i32 %a63, i32 %a90
  %82 = add nsw i32 %output.s0.x.xi.base.s, %t710
  %83 = mul nsw i32 %82, %stride_x
  %a64 = sub nsw i32 %a90, %83
  %84 = icmp sgt i32 %a64, 0
  %85 = select i1 %84, i32 %a64, i32 0
  %b64 = add nsw i32 %85, %a63
  %86 = icmp sgt i32 %b64, %a62
  %input_bounded.x.min_realized = select i1 %86, i32 %a62, i32 %b64
  %a65 = sub nsw i32 %b91, %a63
  %87 = icmp sgt i32 %b86, %a65
  %88 = select i1 %87, i32 %a65, i32 %b86
  %input_bounded.x.extent_realized.s = add nsw i32 %88, %83
  %a66 = sub i32 %input_bounded.x.extent_realized.s, %input_bounded.x.min_realized
  %89 = icmp sgt i32 %a66, 0
  %90 = select i1 %89, i32 %a66, i32 0
  %t779 = zext i32 %90 to i64
  %91 = icmp sgt i32 %a73, -1
  %t780 = select i1 %91, i32 %a73, i32 -1
  %92 = add nsw i32 %t780, 1
  %93 = zext i32 %92 to i64
  %94 = shl nuw nsw i64 %t779, 9
  %95 = and i64 %94, 4294966784
  %96 = mul nuw i64 %95, %93
  %97 = lshr i64 %96, 32
  %98 = lshr i64 %t779, 23
  %99 = mul nuw nsw i64 %98, %93
  %t782 = add nuw nsw i64 %97, %99
  %t781 = shl nuw nsw i64 %93, 9
  %100 = mul i64 %t781, %t779
  %101 = icmp ult i64 %100, 2147483648
  %.mask = and i64 %t782, 2194728288256
  %102 = icmp eq i64 %.mask, 0
  %103 = and i1 %101, %102
  br i1 %103, label %"assert succeeded", label %"assert failed", !prof !375

"assert failed":                                  ; preds = %entry
  %b72 = add nsw i32 %a73, 1
  %.inv = icmp slt i32 %a73, 0
  %104 = select i1 %.inv, i32 0, i32 %b72
  %105 = zext i32 %104 to i64
  %106 = mul i64 %94, %105
  %107 = tail call i32 @halide_error_buffer_allocation_too_large(i8* %__user_context, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.209, i64 0, i64 0), i64 %106, i64 2147483647) #10
  br label %call_destructor.exit

"assert succeeded":                               ; preds = %entry
  %108 = or i64 %100, 3
  %input_bounded = tail call i8* @halide_malloc(i8* %__user_context, i64 %108)
  %.not = icmp eq i8* %input_bounded, null
  br i1 %.not, label %"assert failed1", label %"assert succeeded2", !prof !367

call_destructor.exit:                             ; preds = %call_destructor.exit21, %"assert failed1", %"assert failed"
  %109 = phi i32 [ %107, %"assert failed" ], [ %110, %"assert failed1" ], [ 0, %call_destructor.exit21 ]
  ret i32 %109

"assert failed1":                                 ; preds = %"assert succeeded"
  %110 = tail call i32 @halide_error_out_of_memory(i8* %__user_context) #10
  br label %call_destructor.exit

"assert succeeded2":                              ; preds = %"assert succeeded"
  %t718 = add nsw i32 %output.s0.c.ci.base.s, %output.min.0
  %111 = icmp sgt i32 %t696, 0
  br i1 %111, label %"for output.s0.y.y.preheader", label %call_destructor.exit21, !prof !375

"for output.s0.y.y.preheader":                    ; preds = %"assert succeeded2"
  %t717 = add nsw i32 %output.s0.x.xi.base.s, %output.min.1
  %t720 = add nsw i32 %output.s0.c.ci.base.s, %t715
  %b76 = add nsw i32 %output.extent.2, -9
  %a80 = add nsw i32 %b93, -1
  %a82 = add nsw i32 %b91, -1
  %112 = shl i32 %a66, 4
  %113 = insertelement <32 x i8> undef, i8 %output_max, i32 0
  %b100 = shufflevector <32 x i8> %113, <32 x i8> undef, <32 x i32> zeroinitializer
  %114 = insertelement <32 x i8> undef, i8 %output_min, i32 0
  %b99 = shufflevector <32 x i8> %114, <32 x i8> undef, <32 x i32> zeroinitializer
  %115 = sext i32 %t718 to i64
  %116 = sext i32 %b91 to i64
  %117 = sext i32 %stride_y to i64
  %118 = sext i32 %b93 to i64
  %119 = sext i32 %b90 to i64
  %120 = sext i32 %a92 to i64
  %121 = sext i32 %output.stride.2 to i64
  %122 = sext i32 %t717 to i64
  %123 = sext i32 %stride_x to i64
  %124 = sext i32 %b86 to i64
  %125 = sext i32 %a90 to i64
  %126 = sext i32 %output.stride.1 to i64
  %127 = sext i32 %t720 to i64
  br label %"for output.s0.y.y"

"for output.s0.y.y":                              ; preds = %"end for output.s0.x.xi", %"for output.s0.y.y.preheader"
  %output.s0.y.y = phi i32 [ %171, %"end for output.s0.x.xi" ], [ 0, %"for output.s0.y.y.preheader" ]
  %a74 = mul nsw i32 %output.s0.y.y, 9
  %128 = icmp sgt i32 %b76, %a74
  %output.s0.y.yi.base.s = select i1 %128, i32 %a74, i32 %b76
  %129 = add nsw i32 %output.s0.y.yi.base.s, %t712
  %t724 = mul nsw i32 %129, %stride_y
  %130 = add nsw i32 %output.s0.y.yi.base.s, %t713
  %t725 = mul nsw i32 %130, %stride_y
  %a75 = sub nsw i32 %a92, %t725
  %131 = icmp sgt i32 %a75, 0
  %132 = select i1 %131, i32 %a75, i32 0
  %t722 = add nsw i32 %132, %t724
  %a76 = sub nsw i32 %b93, %t724
  %133 = icmp sgt i32 %b90, %a76
  %134 = select i1 %133, i32 %a76, i32 %b90
  %t721 = add nsw i32 %134, %t725
  %t723 = add nsw i32 %output.s0.y.yi.base.s, %output.min.2
  %t728 = sub i32 %t722, %t692
  %t726 = sub i32 %t721, %t722
  %135 = icmp sgt i32 %t726, 0
  %136 = sext i32 %t723 to i64
  br label %"for output.s0.x.xi"

call_destructor.exit21:                           ; preds = %"end for output.s0.x.xi", %"assert succeeded2"
  tail call void @halide_free(i8* %__user_context, i8* nonnull %input_bounded) #12
  br label %call_destructor.exit

"for output.s0.x.xi":                             ; preds = %"end for output.s0.y.yi", %"for output.s0.y.y"
  %indvars.iv58 = phi i64 [ 0, %"for output.s0.y.y" ], [ %indvars.iv.next59, %"end for output.s0.y.yi" ]
  %137 = add nsw i64 %indvars.iv58, %122
  %138 = mul nsw i64 %137, %123
  %139 = add nsw i64 %138, %124
  %140 = icmp slt i64 %139, %116
  %141 = trunc i64 %139 to i32
  %input_bounded.s0.x.max_2.s = select i1 %140, i32 %141, i32 %b91
  %142 = icmp sgt i64 %138, %125
  %143 = trunc i64 %138 to i32
  %input_bounded.s0.x.min_2 = select i1 %142, i32 %143, i32 %a90
  %t729 = sub i32 %input_bounded.s0.x.min_2, %input_bounded.x.min_realized
  %t727 = sub nsw i32 %input_bounded.s0.x.max_2.s, %input_bounded.s0.x.min_2
  %144 = icmp sgt i32 %t727, 0
  %or.cond = and i1 %135, %144
  br i1 %or.cond, label %"for input_bounded.s0.y.rebased.us.preheader", label %"consume input_bounded", !prof !376

"for input_bounded.s0.y.rebased.us.preheader":    ; preds = %"for output.s0.x.xi"
  %145 = sext i32 %input_bounded.s0.x.min_2 to i64
  %146 = zext i32 %t727 to i64
  br label %"for input_bounded.s0.y.rebased.us"

"for input_bounded.s0.y.rebased.us":              ; preds = %"end for input_bounded.s0.x.rebased.loopexit.us", %"for input_bounded.s0.y.rebased.us.preheader"
  %input_bounded.s0.y.rebased.us = phi i32 [ %170, %"end for input_bounded.s0.x.rebased.loopexit.us" ], [ 0, %"for input_bounded.s0.y.rebased.us.preheader" ]
  %147 = add nsw i32 %t728, %input_bounded.s0.y.rebased.us
  %148 = mul i32 %147, %a66
  %b82.us = add nsw i32 %input_bounded.s0.y.rebased.us, %t722
  %.not16.us = icmp slt i32 %b82.us, %b93
  %a79.us = select i1 %.not16.us, i32 %b82.us, i32 %a80
  %149 = icmp sgt i32 %a79.us, %a92
  %150 = select i1 %149, i32 %a79.us, i32 %a92
  %151 = mul nsw i32 %150, %input.stride.2
  %t730.us = add nsw i32 %151, %t714
  %152 = add i32 %t729, %148
  br label %"for input_bounded.s0.x.rebased.us"

"for input_bounded.s0.x.rebased.us":              ; preds = %"end for input_bounded.s0.c.c.us", %"for input_bounded.s0.y.rebased.us"
  %indvars.iv39 = phi i64 [ 0, %"for input_bounded.s0.y.rebased.us" ], [ %indvars.iv.next40, %"end for input_bounded.s0.c.c.us" ]
  %153 = add nsw i64 %indvars.iv39, %145
  %.not18.us = icmp slt i64 %153, %116
  %154 = trunc i64 %153 to i32
  %a81.us = select i1 %.not18.us, i32 %154, i32 %a82
  %155 = icmp sgt i32 %a81.us, %a90
  %156 = select i1 %155, i32 %a81.us, i32 %a90
  %157 = mul nsw i32 %156, %input.stride.1
  %t732.us = add nsw i32 %t730.us, %157
  %158 = trunc i64 %indvars.iv39 to i32
  %reass.add.us = add i32 %152, %158
  %reass.mul.us = shl i32 %reass.add.us, 9
  %t733.us = sub i32 %reass.mul.us, %t718
  %159 = sext i32 %t732.us to i64
  %160 = sext i32 %t733.us to i64
...
"for input_bounded.s0.c.c.us":                    ; preds = %"for input_bounded.s0.c.c.us", %"for input_bounded.s0.x.rebased.us"
  %indvars.iv = phi i64 [ %indvars.iv.next, %"for input_bounded.s0.c.c.us" ], [ 0, %"for input_bounded.s0.x.rebased.us" ]
  %161 = shl nsw i64 %indvars.iv, 5
  ...
  %166 = load <32 x i8>, <32 x i8>* %165, align 1, !tbaa !377
  %167 = add nsw i64 %162, %160
  %168 = getelementptr inbounds i8, i8* %input_bounded, i64 %167
  %169 = bitcast i8* %168 to <32 x i8>*
  store <32 x i8> %166, <32 x i8>* %169, align 1, !tbaa !380
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.not19.us = icmp eq i64 %indvars.iv.next, 16
  br i1 %.not19.us, label %"end for input_bounded.s0.c.c.us", label %"for input_bounded.s0.c.c.us"

"end for input_bounded.s0.c.c.us":                ; preds = %"for input_bounded.s0.c.c.us"
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %.not20.us = icmp eq i64 %indvars.iv.next40, %146
  br i1 %.not20.us, label %"end for input_bounded.s0.x.rebased.loopexit.us", label %"for input_bounded.s0.x.rebased.us"

"end for input_bounded.s0.x.rebased.loopexit.us": ; preds = %"end for input_bounded.s0.c.c.us"
  %170 = add nuw nsw i32 %input_bounded.s0.y.rebased.us, 1
  %.not17.us = icmp eq i32 %170, %t726
  br i1 %.not17.us, label %"consume input_bounded", label %"for input_bounded.s0.y.rebased.us"

"end for output.s0.x.xi":                         ; preds = %"end for output.s0.y.yi"
  %171 = add nuw nsw i32 %output.s0.y.y, 1
  %.not13 = icmp eq i32 %171, %t696
  br i1 %.not13, label %call_destructor.exit21, label %"for output.s0.y.y"

"consume input_bounded":                          ; preds = %"end for input_bounded.s0.x.rebased.loopexit.us", %"for output.s0.x.xi"
  %172 = sub nsw i64 %116, %138
  %173 = icmp slt i64 %172, %124
  %174 = trunc i64 %172 to i32
  %b88 = select i1 %173, i32 %174, i32 %b86
  %175 = sub nsw i64 %125, %138
  %176 = icmp slt i64 %175, %124
  %177 = trunc i64 %175 to i32
  %a86 = select i1 %176, i32 %177, i32 %b86
  %t736 = sub i32 %143, %input_bounded.x.min_realized
  %178 = mul nsw i64 %137, %126
  %179 = add nsw i64 %178, %127
  %180 = icmp sgt i32 %a86, 0
  %t750 = select i1 %180, i32 %a86, i32 0
  %181 = icmp sgt i32 %a86, %b88
  %a95 = select i1 %181, i32 %a86, i32 %b88
  %t746 = add nsw i32 %t736, %t750
  %182 = icmp sgt i32 %a95, 0
  %183 = select i1 %182, i32 %a95, i32 0
  %t753 = sub nsw i32 %183, %t750
  %184 = icmp sgt i32 %t753, 0
  %185 = sext i32 %t746 to i64
  %186 = zext i32 %t753 to i64
  br label %"for output.s0.y.yi"

"for output.s0.y.yi":                             ; preds = %"end for output.s0.c.ci.ci", %"consume input_bounded"
  %indvars.iv50 = phi i64 [ 0, %"consume input_bounded" ], [ %indvars.iv.next51, %"end for output.s0.c.ci.ci" ]
  %187 = add nsw i64 %indvars.iv50, %136
  %188 = mul nsw i64 %187, %117
  %189 = sub nsw i64 %118, %188
  %190 = icmp slt i64 %189, %119
  %191 = trunc i64 %189 to i32
  %b95 = select i1 %190, i32 %191, i32 %b90
  %192 = sub nsw i64 %120, %188
  %193 = icmp slt i64 %192, %119
  %194 = trunc i64 %192 to i32
  %a94 = select i1 %193, i32 %194, i32 %b90
  %195 = add nsw i64 %188, %119
  %196 = icmp slt i64 %195, %118
  %197 = trunc i64 %195 to i32
  %198 = select i1 %196, i32 %197, i32 %b93
  %199 = icmp slt i64 %188, %120
  %200 = trunc i64 %188 to i32
  %201 = select i1 %199, i32 %a92, i32 %200
  %202 = sub nsw i32 %198, %201
  %t747 = mul nsw i32 %202, %t727
  %203 = mul nsw i64 %187, %121
  %204 = add nsw i64 %179, %203
  %205 = icmp sgt i32 %a94, %b95
  %a96 = select i1 %205, i32 %a94, i32 %b95
  %206 = icmp sgt i32 %a94, 0
  %t755 = select i1 %206, i32 %a94, i32 0
  %207 = icmp sgt i32 %a96, 0
  %208 = select i1 %207, i32 %a96, i32 0
  %t752 = sub nsw i32 %208, %t755
  %209 = icmp sgt i32 %t752, 0
  %210 = icmp slt i32 %t747, -131072
  %t783.neg34 = zext i1 %210 to i32
  %211 = icmp eq i32 %t747, 0
  %t784 = sext i1 %211 to i32
  %t747.lobit = ashr i32 %t747, 31
  %212 = add i32 %t747, 131072
  %213 = add i32 %212, %t783.neg34
  %214 = shl nsw i32 %t747, 1
  %215 = sub nsw i32 %214, %t784
  %216 = sdiv i32 %213, %215
  %217 = xor i32 %t747.lobit, -1
  %218 = sub nsw i32 %217, %t747.lobit
  %219 = select i1 %210, i32 %218, i32 0
  %220 = add nsw i32 %216, %219
  %221 = xor i32 %t784, -1
  %a101 = and i32 %220, %221
  %222 = icmp slt i32 %a101, 65535
  %a100 = select i1 %222, i32 %a101, i32 65535
  %223 = icmp sgt i32 %a100, 0
  %224 = select i1 %223, i32 %a100, i32 0
  %225 = trunc i32 %224 to i16
  %226 = insertelement <32 x i16> undef, i16 %225, i32 0
  %227 = shufflevector <32 x i16> %226, <32 x i16> undef, <32 x i32> zeroinitializer
  %228 = zext <32 x i16> %227 to <32 x i32>
  br i1 %209, label %"for output.s0.c.ci.ci.us.preheader", label %"for output.s0.c.ci.ci", !prof !375

"for output.s0.c.ci.ci.us.preheader":             ; preds = %"for output.s0.y.yi"
  %t745 = sub i32 %200, %t692
  %t754 = add nsw i32 %t745, %t755
  %229 = zext i32 %t752 to i64
  br label %"for output.s0.c.ci.ci.us"

"for output.s0.c.ci.ci.us":                       ; preds = %"consume sum.loopexit.us", %"for output.s0.c.ci.ci.us.preheader"
  %indvars.iv48 = phi i64 [ 0, %"for output.s0.c.ci.ci.us.preheader" ], [ %indvars.iv.next49, %"consume sum.loopexit.us" ]
  br i1 %184, label %"for sum.s1.r12$y.rebased.us.us.preheader", label %"consume sum.loopexit.us", !prof !375

"for sum.s1.r12$y.rebased.us.us.preheader":       ; preds = %"for output.s0.c.ci.ci.us"
  %230 = trunc i64 %indvars.iv48 to i32
  br label %"for sum.s1.r12$y.rebased.us.us"

"consume sum.loopexit.us.loopexit":               ; preds = %"end for sum.s1.r12$x.rebased.loopexit.us.us"
  %231 = shufflevector <32 x i16> %267, <32 x i16> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %232 = shufflevector <32 x i16> %267, <32 x i16> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  br label %"consume sum.loopexit.us"

"consume sum.loopexit.us":                        ; preds = %"consume sum.loopexit.us.loopexit", %"for output.s0.c.ci.ci.us"
  %.us-phi.us = phi <16 x i16> [ zeroinitializer, %"for output.s0.c.ci.ci.us" ], [ %232, %"consume sum.loopexit.us.loopexit" ]
  %.us-phi27.us = phi <16 x i16> [ zeroinitializer, %"for output.s0.c.ci.ci.us" ], [ %231, %"consume sum.loopexit.us.loopexit" ]
  %233 = shufflevector <16 x i16> %.us-phi27.us, <16 x i16> %.us-phi.us, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %234 = zext <32 x i16> %233 to <32 x i32>
  %235 = mul nuw <32 x i32> %228, %234
  %236 = lshr <32 x i32> %235, <i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15, i32 15>
  %237 = and <32 x i32> %236, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %238 = lshr <32 x i32> %235, <i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16>
  %239 = add nuw nsw <32 x i32> %237, %238
  %a99.us = trunc <32 x i32> %239 to <32 x i16>
  %240 = shufflevector <32 x i16> %a99.us, <32 x i16> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %241 = icmp ult <16 x i16> %240, <i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255>
  %242 = shufflevector <32 x i16> %a99.us, <32 x i16> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %243 = icmp ult <16 x i16> %242, <i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255>
  %244 = select <16 x i1> %241, <16 x i16> %240, <16 x i16> <i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255>
  %245 = select <16 x i1> %243, <16 x i16> %242, <16 x i16> <i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255>
  %246 = shufflevector <16 x i16> %244, <16 x i16> %245, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %a98.us = trunc <32 x i16> %246 to <32 x i8>
  %247 = icmp ugt <32 x i8> %b100, %a98.us
  %a97.us = select <32 x i1> %247, <32 x i8> %a98.us, <32 x i8> %b100
  %248 = icmp ugt <32 x i8> %a97.us, %b99
  %249 = select <32 x i1> %248, <32 x i8> %a97.us, <32 x i8> %b99
  %250 = shl nuw nsw i64 %indvars.iv48, 5
  %251 = add nsw i64 %250, %204
  %252 = getelementptr inbounds i8, i8* %output, i64 %251
  %253 = bitcast i8* %252 to <32 x i8>*
  store <32 x i8> %249, <32 x i8>* %253, align 1, !tbaa !382
  %indvars.iv.next49 = add nuw nsw i64 %indvars.iv48, 1
  %.not10.us = icmp eq i64 %indvars.iv.next49, 16
  br i1 %.not10.us, label %"end for output.s0.c.ci.ci", label %"for output.s0.c.ci.ci.us"

"for sum.s1.r12$y.rebased.us.us":                 ; preds = %"end for sum.s1.r12$x.rebased.loopexit.us.us", %"for sum.s1.r12$y.rebased.us.us.preheader"
  %indvars.iv46 = phi i64 [ 0, %"for sum.s1.r12$y.rebased.us.us.preheader" ], [ %indvars.iv.next47, %"end for sum.s1.r12$x.rebased.loopexit.us.us" ]
  %sum9.sroa.4.0.us.us = phi <16 x i16> [ zeroinitializer, %"for sum.s1.r12$y.rebased.us.us.preheader" ], [ %271, %"end for sum.s1.r12$x.rebased.loopexit.us.us" ]
  %sum9.sroa.0.0.us.us = phi <16 x i16> [ zeroinitializer, %"for sum.s1.r12$y.rebased.us.us.preheader" ], [ %270, %"end for sum.s1.r12$x.rebased.loopexit.us.us" ]
  %254 = trunc i64 %indvars.iv46 to i32
  %255 = add i32 %t754, %254
  %256 = mul i32 %112, %255
  %t756.us.us = add nsw i32 %256, %230
  %257 = sext i32 %t756.us.us to i64
  br label %"for sum.s1.r12$x.rebased.us.us"

"for sum.s1.r12$x.rebased.us.us":                 ; preds = %"for sum.s1.r12$x.rebased.us.us", %"for sum.s1.r12$y.rebased.us.us"
  %indvars.iv44 = phi i64 [ %indvars.iv.next45, %"for sum.s1.r12$x.rebased.us.us" ], [ 0, %"for sum.s1.r12$y.rebased.us.us" ]
  %sum9.sroa.4.1.us.us = phi <16 x i16> [ %269, %"for sum.s1.r12$x.rebased.us.us" ], [ %sum9.sroa.4.0.us.us, %"for sum.s1.r12$y.rebased.us.us" ]
  %sum9.sroa.0.1.us.us = phi <16 x i16> [ %268, %"for sum.s1.r12$x.rebased.us.us" ], [ %sum9.sroa.0.0.us.us, %"for sum.s1.r12$y.rebased.us.us" ]
  %258 = shufflevector <16 x i16> %sum9.sroa.0.1.us.us, <16 x i16> %sum9.sroa.4.1.us.us, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %259 = add nsw i64 %indvars.iv44, %185
  %260 = shl nsw i64 %259, 4
  %261 = add nsw i64 %260, %257
  %262 = shl nsw i64 %261, 5
  %263 = getelementptr inbounds i8, i8* %input_bounded, i64 %262
  %264 = bitcast i8* %263 to <32 x i8>*
  %265 = load <32 x i8>, <32 x i8>* %264, align 32, !tbaa !380
  %266 = zext <32 x i8> %265 to <32 x i16>
  %267 = add <32 x i16> %258, %266
  %268 = shufflevector <32 x i16> %267, <32 x i16> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %269 = shufflevector <32 x i16> %267, <32 x i16> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %.not15.us.us = icmp eq i64 %indvars.iv.next45, %186
  br i1 %.not15.us.us, label %"end for sum.s1.r12$x.rebased.loopexit.us.us", label %"for sum.s1.r12$x.rebased.us.us"

"end for sum.s1.r12$x.rebased.loopexit.us.us":    ; preds = %"for sum.s1.r12$x.rebased.us.us"
  %270 = shufflevector <32 x i16> %267, <32 x i16> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %271 = shufflevector <32 x i16> %267, <32 x i16> undef, <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %indvars.iv.next47 = add nuw nsw i64 %indvars.iv46, 1
  %.not14.us.us = icmp eq i64 %indvars.iv.next47, %229
  br i1 %.not14.us.us, label %"consume sum.loopexit.us.loopexit", label %"for sum.s1.r12$y.rebased.us.us"

"end for output.s0.y.yi":                         ; preds = %"end for output.s0.c.ci.ci"
  %indvars.iv.next59 = add nuw nsw i64 %indvars.iv58, 1
  %.not12 = icmp eq i64 %indvars.iv.next59, 4
  br i1 %.not12, label %"end for output.s0.x.xi", label %"for output.s0.x.xi"

"for output.s0.c.ci.ci":                          ; preds = %"for output.s0.c.ci.ci", %"for output.s0.y.yi"
  %indvars.iv42 = phi i64 [ %indvars.iv.next43, %"for output.s0.c.ci.ci" ], [ 0, %"for output.s0.y.yi" ]
  %272 = shl nuw nsw i64 %indvars.iv42, 5
  %273 = add nsw i64 %272, %204
  %274 = getelementptr inbounds i8, i8* %output, i64 %273
  %275 = bitcast i8* %274 to <32 x i8>*
  store <32 x i8> %b99, <32 x i8>* %275, align 1, !tbaa !382
  %indvars.iv.next43 = add nuw nsw i64 %indvars.iv42, 1
  %.not10 = icmp eq i64 %indvars.iv.next43, 16
  br i1 %.not10, label %"end for output.s0.c.ci.ci", label %"for output.s0.c.ci.ci"

"end for output.s0.c.ci.ci":                      ; preds = %"for output.s0.c.ci.ci", %"consume sum.loopexit.us"
  %indvars.iv.next51 = add nuw nsw i64 %indvars.iv50, 1
  %.not11 = icmp eq i64 %indvars.iv.next51, 9
  br i1 %.not11, label %"end for output.s0.y.yi", label %"for output.s0.y.yi"
}

; Function Attrs: nounwind
define i32 @average_pool_batch_0009_sample_0025_argv(i8** nocapture readonly %0) local_unnamed_addr #10 {
entry:
  ...
  %28 = tail call i32 @average_pool_batch_0009_sample_0025(%struct.halide_buffer_t* %2, i32 %6, i32 %10, i32 %14, i32 %18, i8 %21, i8 %24, %struct.halide_buffer_t* %27) #14
  ret i32 %28
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @average_pool_batch_0009_sample_0025_metadata() local_unnamed_addr #11 {
entry:
  ret %struct.halide_filter_metadata_t* @average_pool_batch_0009_sample_0025_metadata_storage
}
...
!376 = !{!"branch_weights", i32 -2147483648, i32 0}
!377 = !{!378, !378, i64 0}
!378 = !{!"input", !379, i64 0}
!379 = !{!"Halide buffer"}
!380 = !{!381, !381, i64 0}
!381 = !{!"input_bounded", !379, i64 0}
!382 = !{!383, !383, i64 0}
!383 = !{!"output", !379, i64 0}
