; ModuleID = '/home/sb54/Hydride/hexagon-benchmarks/rake/benchmarks/hexagon/halide/matmul_128/samples/batch_11_0/7/matmul_128_batch_0011_sample_0007.bc'
...
@str.215 = private constant [34 x i8] c"matmul_128_batch_0011_sample_0007\00", align 64
@matmul_128_batch_0011_sample_0007_metadata_storage = private constant %struct.halide_filter_metadata_t { i32 1, i32 3, %struct.halide_filter_argument_t* getelementptr inbounds ([3 x %struct.halide_filter_argument_t], [3 x %struct.halide_filter_argument_t]* @15, i32 0, i32 0), i8* getelementptr inbounds ([121 x i8], [121 x i8]* @str.214, i32 0, i32 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @str.215, i32 0, i32 0) }
...
; Function Attrs: nounwind
define i32 @matmul_128_batch_0011_sample_0007(%struct.halide_buffer_t* noalias %A.buffer, %struct.halide_buffer_t* noalias %B.buffer, %struct.halide_buffer_t* noalias %res.buffer) local_unnamed_addr #9 {
entry:
...
_halide_buffer_init.exit:                         ; preds = %_halide_buffer_is_bounds_query.exit
  ...
  store <8 x i32> <i32 0, i32 128, i32 1, i32 0, i32 0, i32 128, i32 128, i32 0>, <8 x i32>* %6, align 4
...
_halide_buffer_init.exit67:                       ; preds = %_halide_buffer_is_bounds_query.exit64
  ...
  store <8 x i32> <i32 0, i32 128, i32 1, i32 0, i32 0, i32 128, i32 128, i32 0>, <8 x i32>* %5, align 4
...
after_bb8:                                        ; preds = %_halide_buffer_is_bounds_query.exit65
  ...
  store <8 x i32> <i32 0, i32 128, i32 1, i32 0, i32 0, i32 128, i32 128, i32 0>, <8 x i32>* %4, align 4
...
assert_failed19:                                  ; preds = %then_bb12
  ...
  %308 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.205, i64 0, i64 0), i32 0, i32 0, i32 127, i32 %22, i32 %307) #11
  ret i32 %308
...
assert_failed21:                                  ; preds = %then_bb12
  ...
  %311 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.205, i64 0, i64 0), i32 1, i32 0, i32 127, i32 %28, i32 %310) #11
  ret i32 %311
...
assert_failed23:                                  ; preds = %then_bb12
  ...
  %314 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.206, i64 0, i64 0), i32 0, i32 0, i32 127, i32 %46, i32 %313) #11
  ret i32 %314
...
assert_failed25:                                  ; preds = %then_bb12
  ...
  %317 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.206, i64 0, i64 0), i32 1, i32 0, i32 127, i32 %52, i32 %316) #11
  ret i32 %317
...
assert_failed27:                                  ; preds = %then_bb12
  ...
  %320 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @str.207, i64 0, i64 0), i32 0, i32 0, i32 127, i32 %70, i32 %319) #11
  ret i32 %320
...
assert_failed29:                                  ; preds = %then_bb12
  ...
  %323 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @str.207, i64 0, i64 0), i32 1, i32 0, i32 127, i32 %76, i32 %322) #11
  ret i32 %323
...
assert_failed50:                                  ; preds = %no_errors_bb
  ...
  %344 = call i32 @halide_error_explicit_bounds_too_small(i8* null, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.212, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str, i64 0, i64 0), i32 0, i32 127, i32 %76, i32 %343) #11
  ret i32 %344

assert_failed51:                                  ; preds = %no_errors_bb
  %345 = add nsw i32 %189, -1
  %346 = call i32 @halide_error_explicit_bounds_too_small(i8* null, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.18.77, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str, i64 0, i64 0), i32 0, i32 127, i32 %70, i32 %345) #11
  ret i32 %346
...
"produce res":                                    ; preds = %no_errors_bb
  ...
  %364 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @matmul_128_batch_0011_sample_0007.par_for.res.s0.x.x.x, i32 0, i32 64, i8* nonnull %363)
  ret i32 %364
}
...
define internal i32 @matmul_128_batch_0011_sample_0007.par_for.res.s0.x.x.x(i8* nocapture readnone %__user_context, i32 %res.s0.x.x.x, i8* noalias nocapture readonly %closure) #10 {
entry:
...
"for res.s0.x.xi.xi":                             ; preds = %"consume matrix_mul.for res.s0.x.xi.xi_crit_edge", %entry
  %.not2 = phi i1 [ false, %entry ], [ true, %"consume matrix_mul.for res.s0.x.xi.xi_crit_edge" ]
  %.phi = phi i32 [ %.0, %entry ], [ %.1, %"consume matrix_mul.for res.s0.x.xi.xi_crit_edge" ]
  %29 = shl nuw nsw i32 %.phi, 5
  %t28 = sub nsw i32 %29, %t12
  %30 = sext i32 %t28 to i64
...
"for matrix_mul.s1.r8$x":                         ; preds = %"for matrix_mul.s1.r8$x", %"for res.s0.x.xi.xi"
  ...
  %matrix_mul1.sroa.12.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.xi.xi" ], [ %63, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul1.sroa.8.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.xi.xi" ], [ %56, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul1.sroa.4.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.xi.xi" ], [ %49, %"for matrix_mul.s1.r8$x" ]
  %matrix_mul1.sroa.0.0 = phi <32 x i16> [ zeroinitializer, %"for res.s0.x.xi.xi" ], [ %42, %"for matrix_mul.s1.r8$x" ]
  ...
  %43 = add nsw i64 %indvars.iv, %22
  %44 = getelementptr inbounds i16, i16* %A, i64 %43
  %45 = load i16, i16* %44, align 2, !tbaa !377
  %46 = insertelement <32 x i16> undef, i16 %45, i32 0
  %47 = shufflevector <32 x i16> %46, <32 x i16> undef, <32 x i32> zeroinitializer
  %48 = mul <32 x i16> %47, %35
  %49 = add <32 x i16> %48, %matrix_mul1.sroa.4.0
  %50 = add nsw i64 %indvars.iv, %23
  %51 = getelementptr inbounds i16, i16* %A, i64 %50
  %52 = load i16, i16* %51, align 2, !tbaa !377
  %53 = insertelement <32 x i16> undef, i16 %52, i32 0
  %54 = shufflevector <32 x i16> %53, <32 x i16> undef, <32 x i32> zeroinitializer
  %55 = mul <32 x i16> %54, %35
  %56 = add <32 x i16> %55, %matrix_mul1.sroa.8.0
  %57 = add nsw i64 %indvars.iv, %24
  ...
  %63 = add <32 x i16> %62, %matrix_mul1.sroa.12.0
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.not = icmp eq i64 %indvars.iv.next, 128
  br i1 %.not, label %"consume matrix_mul", label %"for matrix_mul.s1.r8$x"

"consume matrix_mul":                             ; preds = %"for matrix_mul.s1.r8$x"
  %64 = zext i32 %.phi to i64
  %65 = shl nuw nsw i64 %64, 3
  %66 = add nsw i64 %65, %25
  %67 = shl nsw i64 %66, 2
  %68 = getelementptr inbounds i16, i16* %res, i64 %67
  %69 = bitcast i16* %68 to <32 x i16>*
  store <32 x i16> %42, <32 x i16>* %69, align 2, !tbaa !379
  %70 = shl nuw nsw i64 %64, 5
  %71 = add nsw i64 %70, %26
  %72 = getelementptr inbounds i16, i16* %res, i64 %71
  %73 = bitcast i16* %72 to <32 x i16>*
  store <32 x i16> %49, <32 x i16>* %73, align 2, !tbaa !379
  %74 = add nsw i64 %70, %27
  %75 = getelementptr inbounds i16, i16* %res, i64 %74
  %76 = bitcast i16* %75 to <32 x i16>*
  store <32 x i16> %56, <32 x i16>* %76, align 2, !tbaa !379
  %77 = add nsw i64 %70, %28
  %78 = getelementptr inbounds i16, i16* %res, i64 %77
  %79 = bitcast i16* %78 to <32 x i16>*
  store <32 x i16> %63, <32 x i16>* %79, align 2, !tbaa !379
  br i1 %.not2, label %destructor_block, label %"consume matrix_mul.for res.s0.x.xi.xi_crit_edge"

"consume matrix_mul.for res.s0.x.xi.xi_crit_edge": ; preds = %"consume matrix_mul"
  %.1 = or i32 %t14, 1
  br label %"for res.s0.x.xi.xi"
...
; Function Attrs: nounwind
define i32 @matmul_128_batch_0011_sample_0007_argv(i8** nocapture readonly %0) local_unnamed_addr #11 {
entry:
  ...
  %9 = tail call i32 @matmul_128_batch_0011_sample_0007(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5, %struct.halide_buffer_t* %8) #15
  ret i32 %9
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @matmul_128_batch_0011_sample_0007_metadata() local_unnamed_addr #12 {
entry:
  ret %struct.halide_filter_metadata_t* @matmul_128_batch_0011_sample_0007_metadata_storage
}
