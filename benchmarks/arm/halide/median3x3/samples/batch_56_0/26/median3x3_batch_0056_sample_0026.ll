; ModuleID = '/home/sb54/Hydride/hexagon-benchmarks/rake/benchmarks/hexagon/halide/median3x3/samples/batch_56_0/26/median3x3_batch_0056_sample_0026.bc'
...
@str.209 = private constant [14 x i8] c"bounded_input\00", align 32
@str.210 = private constant [6 x i8] c"max_y\00", align 32
@str.211 = private constant [6 x i8] c"min_y\00", align 32
...
@str.213 = private constant [33 x i8] c"median3x3_batch_0056_sample_0026\00", align 32
@median3x3_batch_0056_sample_0026_metadata_storage = private constant %struct.halide_filter_metadata_t { i32 1, i32 2, %struct.halide_filter_argument_t* getelementptr inbounds ([2 x %struct.halide_filter_argument_t], [2 x %struct.halide_filter_argument_t]* @10, i32 0, i32 0), i8* getelementptr inbounds ([59 x i8], [59 x i8]* @str.212, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @str.213, i32 0, i32 0) }
...
; Function Attrs: nounwind
define i32 @median3x3_batch_0056_sample_0026(%struct.halide_buffer_t* noalias %input.buffer, %struct.halide_buffer_t* noalias %output.buffer) local_unnamed_addr #9 {
entry:
...
destructor_block:                                 ; preds = %_halide_buffer_is_bounds_query.exit44, %destructor_block.sink.split
  %6 = phi i32 [ 0, %_halide_buffer_is_bounds_query.exit44 ], [ %5, %destructor_block.sink.split ]
  ret i32 %6
...
"assert succeeded2":                              ; preds = %"assert succeeded"
  ...
  %a12 = add nsw i32 %72, 1
  %73 = icmp sgt i32 %28, %a12
  %a11 = select i1 %73, i32 %a12, i32 %28
  %74 = icmp sgt i32 %a11, 1
  %75 = select i1 %74, i32 %a11, i32 1
  %76 = icmp slt i32 %52, 34
  %77 = select i1 %76, i32 %52, i32 34
  %78 = add nsw i32 %77, %50
  %a15 = add nsw i32 %78, -33
  %79 = icmp sgt i32 %28, %a15
  %a14 = select i1 %79, i32 %a15, i32 %28
  %80 = icmp sgt i32 %a14, 1
  %a13 = select i1 %80, i32 %a14, i32 1
  %a19 = add nsw i32 %28, 33
  %81 = icmp sgt i32 %78, %a19
  %a18 = select i1 %81, i32 %a19, i32 %78
  %82 = icmp sgt i32 %a18, 34
  %a17 = select i1 %82, i32 %a18, i32 34
  %a22 = add nsw i32 %78, -34
  %83 = icmp sgt i32 %28, %a22
  %a21 = select i1 %83, i32 %a22, i32 %28
  %84 = icmp sgt i32 %a21, 1
  %85 = select i1 %84, i32 %a21, i32 1
  %b19 = add nuw nsw i32 %85, 33
  %86 = icmp sgt i32 %b19, %a17
  %87 = select i1 %86, i32 %a17, i32 %b19
  %b15 = add nsw i32 %87, -34
  %88 = icmp sgt i32 %b15, %a13
  %89 = select i1 %88, i32 %a13, i32 %b15
  %90 = load i8*, i8** %7, align 8, !tbaa !181
...
_halide_buffer_is_bounds_query.exit:              ; preds = %"assert succeeded2"
  %92 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 0
  %93 = load i64, i64* %92, align 8, !tbaa !183
  %94 = icmp eq i64 %93, 0
  br i1 %94, label %_halide_buffer_init.exit, label %after_bb

after_bb:                                         ; preds = %_halide_buffer_init.exit, %_halide_buffer_is_bounds_query.exit, %"assert succeeded2"
  %95 = load i8*, i8** %31, align 8, !tbaa !181
  %96 = icmp eq i8* %95, null
  br i1 %96, label %_halide_buffer_is_bounds_query.exit42, label %after_bb3

_halide_buffer_is_bounds_query.exit42:            ; preds = %after_bb
  %97 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 0
  %98 = load i64, i64* %97, align 8, !tbaa !183
  %99 = icmp eq i64 %98, 0
  br i1 %99, label %_halide_buffer_init.exit46, label %after_bb3

_halide_buffer_init.exit:                         ; preds = %_halide_buffer_is_bounds_query.exit
  %input.extent.1.required = sub nsw i32 %75, %89
  %input.extent.0.required.s = sub nsw i32 %67, %71
  %100 = bitcast %struct.halide_dimension_t** %17 to i8**
  %101 = load i8*, i8** %100, align 8, !tbaa !185
  %102 = add nsw i32 %input.extent.0.required.s, 1
  %103 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 0
  store i32 %71, i32* %103, align 4
  %104 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 1
  store i32 %102, i32* %104, align 4
  %105 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 2
  store i32 1, i32* %105, align 4
  %106 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 3
  ...
  store i32 %input.extent.1.required, i32* %108, align 4
  %109 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 6
  store i32 %102, i32* %109, align 4
  %110 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 7
  store i32 0, i32* %110, align 4
  %111 = bitcast %struct.halide_buffer_t* %input.buffer to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(24) %111, i8 0, i64 24, i1 false)
  store i8 1, i8* %10, align 8, !tbaa !368
  %112 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 4, i32 1
  store i8 8, i8* %112, align 1, !tbaa !369
  %113 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 4, i32 2
  store i16 1, i16* %113, align 2, !tbaa !370
  store i32 2, i32* %15, align 4, !tbaa !184
  %114 = bitcast [8 x i32]* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %101, i8* nonnull align 4 dereferenceable(16) %114, i64 16, i1 false) #10, !tbaa.struct !186
  %115 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %17, align 8, !tbaa !185
  %116 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 4
  %117 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %115, i64 1
  %118 = bitcast %struct.halide_dimension_t* %117 to i8*
  %119 = bitcast i32* %116 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %118, i8* nonnull align 4 dereferenceable(16) %119, i64 16, i1 false) #10, !tbaa.struct !186
  store i64 0, i64* %13, align 8, !tbaa !285
  br label %after_bb

after_bb3:                                        ; preds = %_halide_buffer_init.exit46, %_halide_buffer_is_bounds_query.exit42, %after_bb
  %120 = load i8*, i8** %7, align 8, !tbaa !181
  %121 = icmp eq i8* %120, null
  br i1 %121, label %122, label %_halide_buffer_is_bounds_query.exit43
...
_halide_buffer_is_bounds_query.exit43:            ; preds = %122, %after_bb3
  %126 = phi i1 [ false, %after_bb3 ], [ %125, %122 ]
  %127 = load i8*, i8** %31, align 8, !tbaa !181
  %128 = icmp eq i8* %127, null
  br i1 %128, label %129, label %_halide_buffer_is_bounds_query.exit44

129:                                              ; preds = %_halide_buffer_is_bounds_query.exit43
  %130 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 0
  %131 = load i64, i64* %130, align 8, !tbaa !183
  %132 = icmp eq i64 %131, 0
  br label %_halide_buffer_is_bounds_query.exit44

_halide_buffer_is_bounds_query.exit44:            ; preds = %129, %_halide_buffer_is_bounds_query.exit43
  %133 = phi i1 [ false, %_halide_buffer_is_bounds_query.exit43 ], [ %132, %129 ]
  %134 = or i1 %126, %133
  br i1 %134, label %destructor_block, label %then_bb7

_halide_buffer_init.exit46:                       ; preds = %_halide_buffer_is_bounds_query.exit42
  %135 = bitcast %struct.halide_dimension_t** %41 to i8**
  %136 = load i8*, i8** %135, align 8, !tbaa !185
  %137 = add nsw i32 %a6, -32
  %138 = icmp sgt i32 %52, 34
  %139 = select i1 %138, i32 %52, i32 34
  %140 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 0
  store i32 %137, i32* %140, align 4
  %141 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 1
  store i32 %58, i32* %141, align 4
  %142 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 2
  store i32 1, i32* %142, align 4
  %143 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 3
  store i32 0, i32* %143, align 4
  %144 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 4
  store i32 %a22, i32* %144, align 4
  %145 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 5
  store i32 %139, i32* %145, align 4
  %146 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 6
  store i32 %58, i32* %146, align 4
  %147 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 7
  store i32 0, i32* %147, align 4
  %148 = bitcast %struct.halide_buffer_t* %output.buffer to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(24) %148, i8 0, i64 24, i1 false)
  store i8 1, i8* %34, align 8, !tbaa !368
  %149 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 4, i32 1
  store i8 8, i8* %149, align 1, !tbaa !369
  %150 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %output.buffer, i64 0, i32 4, i32 2
  store i16 1, i16* %150, align 2, !tbaa !370
  store i32 2, i32* %39, align 4, !tbaa !184
  %151 = bitcast [8 x i32]* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %136, i8* nonnull align 4 dereferenceable(16) %151, i64 16, i1 false) #10, !tbaa.struct !186
  %152 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %41, align 8, !tbaa !185
  %153 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 4
  %154 = getelementptr inbounds %struct.halide_dimension_t, %struct.halide_dimension_t* %152, i64 1
  %155 = bitcast %struct.halide_dimension_t* %154 to i8*
  %156 = bitcast i32* %153 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %155, i8* nonnull align 4 dereferenceable(16) %156, i64 16, i1 false) #10, !tbaa.struct !186
  store i64 0, i64* %37, align 8, !tbaa !285
  br label %after_bb3

then_bb7:                                         ; preds = %_halide_buffer_is_bounds_query.exit44
  %157 = icmp ne i32 %12, 67585
  %158 = zext i1 %157 to i64
  %.not34 = icmp eq i32 %16, 2
  %159 = select i1 %.not34, i64 0, i64 2
  %.not35 = icmp eq i32 %36, 67585
  %160 = select i1 %.not35, i64 0, i64 4
  %.not36 = icmp eq i32 %40, 2
  %161 = select i1 %.not36, i64 0, i64 8
  %.not37 = icmp slt i32 %67, %64
  %162 = select i1 %.not37, i64 0, i64 16
  %163 = lshr i32 %22, 26
  %164 = and i32 %163, 32
  %165 = zext i32 %164 to i64
  %166 = icmp sgt i32 %26, %89
  %167 = add nsw i32 %28, %26
  %168 = icmp sgt i32 %75, %167
  %169 = or i1 %168, %166
  %170 = select i1 %169, i64 64, i64 0
  %171 = lshr i32 %28, 24
  %172 = and i32 %171, 128
  %173 = zext i32 %172 to i64
  %174 = select i1 %55, i64 256, i64 0
  %175 = select i1 %76, i64 512, i64 0
  %.not38 = icmp eq i32 %24, 1
  %176 = select i1 %.not38, i64 0, i64 1024
  %.not39 = icmp eq i32 %48, 1
  %177 = select i1 %.not39, i64 0, i64 2048
  %178 = or i64 %159, %158
  %179 = or i64 %178, %165
  %180 = or i64 %179, %176
  %181 = or i64 %180, %173
  ...
  %190 = call i64 @llvm.cttz.i64(i64 %189, i1 true), !range !371
  %191 = trunc i64 %190 to i32
  switch i32 %191, label %no_errors_bb [
...
no_errors_bb:                                     ; preds = %then_bb7
  ...
  %193 = sext i32 %22 to i64
  %input.total_extent.1 = mul nsw i64 %192, %193
  %194 = sext i32 %52 to i64
  %195 = sext i32 %46 to i64
  %output.total_extent.1 = mul nsw i64 %194, %195
  %input.extent.0.lobit = lshr i32 %22, 31
  %196 = zext i32 %input.extent.0.lobit to i64
  %197 = sext i32 %30 to i64
  %x1 = mul nsw i64 %197, %192
  %198 = call i64 @llvm.abs.i64(i64 %x1, i1 true)
  %199 = icmp ugt i64 %198, 2147483647
  %200 = select i1 %199, i64 2, i64 0
  %201 = icmp sgt i64 %input.total_extent.1, 2147483647
  %202 = select i1 %201, i64 4, i64 0
  %203 = lshr i32 %46, 28
  %204 = and i32 %203, 8
  %205 = zext i32 %204 to i64
  %206 = sext i32 %54 to i64
  %x2 = mul nsw i64 %206, %194
  %207 = call i64 @llvm.abs.i64(i64 %x2, i1 true)
  %208 = icmp ugt i64 %207, 2147483647
  %209 = select i1 %208, i64 16, i64 0
  %210 = icmp sgt i64 %output.total_extent.1, 2147483647
  %211 = select i1 %210, i64 32, i64 0
  %212 = shl i64 %14, 5
  %213 = and i64 %212, 64
  %214 = shl i64 %38, 6
  %215 = and i64 %214, 128
  %216 = icmp eq i8* %8, null
  %217 = icmp eq i8* %32, null
  %218 = select i1 %217, i64 512, i64 0
  %219 = select i1 %216, i64 -9223372036854775552, i64 -9223372036854775808
  %220 = or i64 %219, %213
  %221 = or i64 %220, %196
  %222 = or i64 %221, %202
  %223 = or i64 %222, %218
  ...
  %227 = or i64 %226, %211
  %228 = or i64 %227, %209
  %229 = call i64 @llvm.cttz.i64(i64 %228, i1 true), !range !371
  %230 = trunc i64 %229 to i32
  switch i32 %230, label %"produce output" [
...
assert_failed:                                    ; preds = %then_bb7
  %231 = call i32 @halide_error_bad_type(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 %12, i32 67585) #10
  ret i32 %231

assert_failed9:                                   ; preds = %then_bb7
  %232 = call i32 @halide_error_bad_dimensions(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 %16, i32 2) #10
  ret i32 %232

assert_failed10:                                  ; preds = %then_bb7
  %233 = call i32 @halide_error_bad_type(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 %36, i32 67585) #10
  ret i32 %233

assert_failed11:                                  ; preds = %then_bb7
  %234 = call i32 @halide_error_bad_dimensions(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 %40, i32 2) #10
  ret i32 %234

assert_failed12:                                  ; preds = %then_bb7
  %235 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 0, i32 %71, i32 %67, i32 %20, i32 %b3) #10
  ret i32 %235

assert_failed13:                                  ; preds = %then_bb7
  %236 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 0, i32 %22) #10
  ret i32 %236

assert_failed14:                                  ; preds = %then_bb7
  %237 = add nsw i32 %75, -1
  %238 = add nsw i32 %167, -1
  %239 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 1, i32 %89, i32 %237, i32 %26, i32 %238) #10
  ret i32 %239

assert_failed15:                                  ; preds = %then_bb7
  %240 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0), i32 1, i32 %28) #10
  ret i32 %240

assert_failed16:                                  ; preds = %then_bb7
  %241 = add nsw i32 %a6, -32
  %242 = add i32 %44, -1
  %243 = add i32 %242, %46
  %244 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 0, i32 %241, i32 %243, i32 %44, i32 %243) #10
  ret i32 %244

assert_failed17:                                  ; preds = %then_bb7
  %245 = add nsw i32 %72, -1
  %246 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0), i32 1, i32 %a22, i32 %245, i32 %50, i32 %245) #10
  ret i32 %246

assert_failed18:                                  ; preds = %then_bb7
  %247 = call i32 @halide_error_constraint_violated(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.206, i64 0, i64 0), i32 %24, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.207, i64 0, i64 0), i32 1) #10
  ret i32 %247

assert_failed19:                                  ; preds = %then_bb7
  %248 = call i32 @halide_error_constraint_violated(i8* null, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @str.208, i64 0, i64 0), i32 %48, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.207, i64 0, i64 0), i32 1) #10
  ret i32 %248

assert_failed21:                                  ; preds = %no_errors_bb
  %249 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %193, i64 2147483647) #10
  ret i32 %249

assert_failed22:                                  ; preds = %no_errors_bb
  %250 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %198, i64 2147483647) #10
  ret i32 %250

assert_failed23:                                  ; preds = %no_errors_bb
  %251 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.203, i64 0, i64 0), i64 %input.total_extent.1, i64 2147483647) #10
  ret i32 %251

assert_failed24:                                  ; preds = %no_errors_bb
  %252 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %195, i64 2147483647) #10
  ret i32 %252

assert_failed25:                                  ; preds = %no_errors_bb
  %253 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %207, i64 2147483647) #10
  ret i32 %253

assert_failed26:                                  ; preds = %no_errors_bb
  %254 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str, i64 0, i64 0), i64 %output.total_extent.1, i64 2147483647) #10
  ret i32 %254

assert_failed27:                                  ; preds = %no_errors_bb
  %255 = call i32 @halide_error_device_dirty_with_no_device_support(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0)) #10
  ret i32 %255

assert_failed28:                                  ; preds = %no_errors_bb
  %256 = call i32 @halide_error_device_dirty_with_no_device_support(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0)) #10
  ret i32 %256

assert_failed29:                                  ; preds = %no_errors_bb
  %257 = call i32 @halide_error_host_is_null(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.204, i64 0, i64 0)) #10
  ret i32 %257

assert_failed30:                                  ; preds = %no_errors_bb
  %258 = call i32 @halide_error_host_is_null(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.205, i64 0, i64 0)) #10
  ret i32 %258

"produce output":                                 ; preds = %no_errors_bb
  %b47 = add nsw i32 %46, 1
  %t698 = ashr i32 %b47, 5
  %t699 = mul nsw i32 %t698, -32
  %t700 = mul nsw i32 %54, %50
  %259 = add nsw i32 %46, 33
  %b44 = ashr i32 %259, 5
  %260 = sub nsw i32 %20, %44
  %a43 = ashr i32 %260, 5
  %261 = icmp sgt i32 %a43, -1
  %262 = select i1 %261, i32 %a43, i32 -1
  %a42 = add nsw i32 %262, 1
  %263 = icmp sgt i32 %b44, %a42
  %b46 = select i1 %263, i32 %a42, i32 %b44
  %b50 = sub nsw i32 %64, %44
  %264 = and i32 %46, 31
  %265 = icmp ne i32 %264, 0
  %a47 = add nsw i32 %46, -30
  %266 = icmp sgt i32 %b50, %a47
  %a46 = select i1 %266, i32 %a47, i32 %b50
  %267 = icmp sgt i32 %b50, %b47
  %268 = select i1 %267, i32 %b47, i32 %b50
  %b48 = add nsw i32 %268, -31
  %269 = icmp sgt i32 %b48, %a46
  %a45 = select i1 %269, i32 %a46, i32 %b48
  %.not40 = icmp slt i32 %46, %a45
  %270 = select i1 %.not40, i32 %b47, i32 %a45
  %271 = ashr i32 %270, 5
  %a44 = add nsw i32 %271, 1
  %.not41 = icmp slt i32 %271, %b46
  %t686 = select i1 %.not41, i32 %b46, i32 %a44
  %272 = add nsw i32 %52, 33
  %273 = ashr i32 %272, 31
  %274 = xor i32 %273, %272
  %275 = zext i32 %274 to i64
  %276 = mul nuw nsw i64 %275, 2021161081
  %277 = lshr i64 %276, 36
  %278 = trunc i64 %277 to i32
  %t682 = xor i32 %273, %278
  %t691 = ashr i32 %46, 5
  %t684 = and i32 %b47, -32
  %t695 = sub nsw i32 %46, %t700
  %t692 = sub nsw i32 0, %t700
  %279 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 0
  store i32 %28, i32* %279, align 8
  %280 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 1
  store i32 %20, i32* %280, align 4
  %281 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 2
  store i32 %26, i32* %281, align 8
  %282 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 3
  store i32 %30, i32* %282, align 4
  %283 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 4
  store i32 %46, i32* %283, align 8
  %284 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 5
  store i32 %52, i32* %284, align 4
  %285 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 6
  store i32 %44, i32* %285, align 8
  %286 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 7
  store i32 %50, i32* %286, align 4
  %287 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 8
  store i32 %54, i32* %287, align 8
  %288 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 9
  store i32 %t684, i32* %288, align 4
  %289 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 10
  store i32 %t686, i32* %289, align 8
  %290 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 11
  store i32 %t691, i32* %290, align 4
  %291 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 12
  store i32 %t692, i32* %291, align 8
  %292 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 13
  store i1 %265, i1* %292, align 4
  %293 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 14
  store i32 %t695, i32* %293, align 8
  %294 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 15
  store i32 %64, i32* %294, align 4
  %295 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 16
  store i32 %t699, i32* %295, align 8
  %296 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 17
  store i32 %b44, i32* %296, align 4
  %297 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 18
  store i32 %b46, i32* %297, align 8
  %298 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 19
  store i8* %8, i8** %298, align 8
  %299 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 20
  store %struct.halide_buffer_t* %input.buffer, %struct.halide_buffer_t** %299, align 8
  %300 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 21
  store i8* %32, i8** %300, align 8
  %301 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 22
  store %struct.halide_buffer_t* %output.buffer, %struct.halide_buffer_t** %301, align 8
  %302 = bitcast %closure_t* %2 to i8*
  %303 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @median3x3_batch_0056_sample_0026.par_for.output.s0.y.y, i32 0, i32 %t682, i8* nonnull %302)
  ret i32 %303
}
...
; Function Attrs: nounwind
define internal i32 @median3x3_batch_0056_sample_0026.par_for.output.s0.y.y(i8* %__user_context, i32 %output.s0.y.y, i8* noalias readonly %closure) #9 {
entry:
  %min_y.pseudostack_slot = alloca %struct.halide_pseudostack_slot_t, align 8
  %.fca.0.gep14 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %min_y.pseudostack_slot, i64 0, i32 0
  %.fca.1.gep15 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %min_y.pseudostack_slot, i64 0, i32 1
  %max_y.pseudostack_slot = alloca %struct.halide_pseudostack_slot_t, align 8
  %.fca.0.gep12 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %max_y.pseudostack_slot, i64 0, i32 0
  %0 = bitcast %struct.halide_pseudostack_slot_t* %min_y.pseudostack_slot to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(16) %0, i8 0, i64 16, i1 false)
  %.fca.1.gep13 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %max_y.pseudostack_slot, i64 0, i32 1
  %1 = bitcast i8* %closure to i32*
  %2 = bitcast %struct.halide_pseudostack_slot_t* %max_y.pseudostack_slot to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(16) %2, i8 0, i64 16, i1 false)
  %b250 = load i32, i32* %1, align 4
  %3 = getelementptr inbounds i8, i8* %closure, i64 4
  %4 = bitcast i8* %3 to i32*
  %input.min.0 = load i32, i32* %4, align 4
  %5 = getelementptr inbounds i8, i8* %closure, i64 16
  %6 = bitcast i8* %5 to i32*
  %b139 = load i32, i32* %6, align 4
  ...
  %a185 = load i32, i32* %16, align 4
  %17 = getelementptr inbounds i8, i8* %closure, i64 40
  %18 = bitcast i8* %17 to i32*
  %t686 = load i32, i32* %18, align 4
  %19 = getelementptr inbounds i8, i8* %closure, i64 44
  %20 = bitcast i8* %19 to i32*
  %t691 = load i32, i32* %20, align 4
  %21 = getelementptr inbounds i8, i8* %closure, i64 48
  %22 = bitcast i8* %21 to i32*
  %t692 = load i32, i32* %22, align 4
  %23 = getelementptr inbounds i8, i8* %closure, i64 52
  %24 = bitcast i8* %23 to i1*
  %t693 = load i1, i1* %24, align 1
  %25 = getelementptr inbounds i8, i8* %closure, i64 64
  %26 = bitcast i8* %25 to i32*
  %t699 = load i32, i32* %26, align 4
  %27 = getelementptr inbounds i8, i8* %closure, i64 68
  %28 = bitcast i8* %27 to i32*
  %t701 = load i32, i32* %28, align 4
  %29 = getelementptr inbounds i8, i8* %closure, i64 72
  %30 = bitcast i8* %29 to i32*
  %t702 = load i32, i32* %30, align 4
  %31 = getelementptr inbounds i8, i8* %closure, i64 80
  %32 = bitcast i8* %31 to i8**
  %input = load i8*, i8** %32, align 8
  %33 = getelementptr inbounds i8, i8* %closure, i64 96
  %34 = bitcast i8* %33 to i8**
  %output = load i8*, i8** %34, align 8
  %a49 = mul nsw i32 %output.s0.y.y, 34
  %b51 = add nsw i32 %output.extent.1, -34
  %35 = icmp sgt i32 %b51, %a49
  %output.s0.y.yi.base.s = select i1 %35, i32 %a49, i32 %b51
  %36 = add nsw i32 %output.s0.y.yi.base.s, %output.min.1
  %a52 = add nsw i32 %36, 1
  %37 = icmp sgt i32 %b250, %a52
  %a51 = select i1 %37, i32 %a52, i32 %b250
  %38 = icmp sgt i32 %a51, 1
  %a50 = select i1 %38, i32 %a51, i32 1
  %a55 = add nsw i32 %b250, -1
  %.not = icmp slt i32 %36, %b250
  %a54 = select i1 %.not, i32 %36, i32 %a55
  %39 = icmp sgt i32 %a54, 0
  %a53 = select i1 %39, i32 %a54, i32 0
  %a56 = select i1 %.not, i32 %36, i32 %b250
  %40 = icmp sgt i32 %a56, 1
  %41 = select i1 %40, i32 %a56, i32 1
  %b55 = add nsw i32 %41, -1
  %42 = icmp sgt i32 %b55, %a53
  %b52 = select i1 %42, i32 %a53, i32 %b55
  %43 = icmp sgt i32 %b52, %a50
  %bounded_input.y.min_realized = select i1 %43, i32 %a50, i32 %b52
  %a60 = add nsw i32 %36, 35
  %44 = icmp sgt i32 %b250, %a60
  %a59 = select i1 %44, i32 %a60, i32 %b250
  %45 = icmp sgt i32 %a59, 1
  %46 = select i1 %45, i32 %a59, i32 1
  %a66 = add nsw i32 %output.min.1, %a49
  %a67 = add nsw i32 %output.min.1, %output.extent.1
  %b69 = add nsw i32 %b250, 33
  %47 = icmp sgt i32 %b69, %a67
  %48 = select i1 %47, i32 %a67, i32 %b69
  %b68 = add nsw i32 %48, -34
  %49 = icmp sgt i32 %b68, %a66
  %a65 = select i1 %49, i32 %a66, i32 %b68
  %50 = icmp sgt i32 %a65, 0
  %b64 = select i1 %50, i32 %a65, i32 0
  %51 = icmp sgt i32 %b64, %a50
  %a61 = select i1 %51, i32 %a50, i32 %b64
  %a70 = add nsw i32 %a67, -34
  %52 = icmp sgt i32 %b250, %a70
  %a69 = select i1 %52, i32 %a70, i32 %b250
  %53 = icmp sgt i32 %a66, %a69
  %a68 = select i1 %53, i32 %a69, i32 %a66
  %54 = icmp sgt i32 %a68, 1
  %55 = select i1 %54, i32 %a68, i32 1
  %b63 = add nsw i32 %55, -1
  %56 = icmp sgt i32 %b63, %a61
  %57 = select i1 %56, i32 %a61, i32 %b63
  %a76 = sub nsw i32 %46, %57
  %58 = icmp sgt i32 %a185, -32
  %t771 = select i1 %58, i32 %a185, i32 -32
  %59 = icmp sgt i32 %a76, 0
  %60 = select i1 %59, i32 %a76, i32 0
  %t772 = zext i32 %60 to i64
  %61 = add nsw i32 %t771, 32
  %62 = zext i32 %61 to i64
  %63 = mul nuw nsw i64 %t772, %62
  %64 = icmp ult i64 %63, 2147483648
  br i1 %64, label %pseudostack_alloc.exit, label %call_destructor.exit37, !prof !374

pseudostack_alloc.exit:                           ; preds = %entry
  %65 = getelementptr inbounds i8, i8* %closure, i64 60
  %66 = bitcast i8* %65 to i32*
  %t696 = load i32, i32* %66, align 4
  %67 = getelementptr inbounds i8, i8* %closure, i64 12
  %68 = bitcast i8* %67 to i32*
  %input.stride.1 = load i32, i32* %68, align 4
  %69 = getelementptr inbounds i8, i8* %closure, i64 56
  %70 = bitcast i8* %69 to i32*
  %t695 = load i32, i32* %70, align 4
  %71 = getelementptr inbounds i8, i8* %closure, i64 8
  %72 = bitcast i8* %71 to i32*
  %input.min.1 = load i32, i32* %72, align 4
  %73 = add nuw nsw i64 %63, 3
  %74 = tail call i8* @halide_malloc(i8* %__user_context, i64 %73) #12
  %t724 = sub nsw i32 %t701, %t686
  %75 = icmp sgt i32 %a53, %a50
  %a96 = select i1 %75, i32 %a50, i32 %a53
  %76 = icmp sgt i32 %b55, %a96
  %t731 = select i1 %76, i32 %a96, i32 %b55
  %77 = icmp sgt i32 %t702, 0
  %78 = add i32 %output.min.0, -31
  %79 = add nsw i32 %t696, -1
  %80 = insertelement <32 x i32> undef, i32 %79, i32 0
  %81 = shufflevector <32 x i32> %80, <32 x i32> undef, <8 x i32> zeroinitializer
  %82 = insertelement <32 x i32> undef, i32 %input.min.0, i32 0
  %83 = shufflevector <32 x i32> %82, <32 x i32> undef, <8 x i32> zeroinitializer
  %84 = sext i32 %t731 to i64
  %85 = sext i32 %a185 to i64
  %86 = add nsw i64 %85, 32
  %t732 = sub nsw i32 %t686, %t702
  %87 = sub i32 %output.min.0, %input.min.0
  %88 = icmp sgt i32 %t732, 0
  %89 = icmp sgt i32 %t724, 0
  %90 = mul nuw nsw i64 %62, 17
  %91 = icmp ult i64 %90, 2147483648
  %92 = add nuw nsw i64 %90, 3
  %93 = add nsw i32 %a185, 32
  %94 = icmp sgt i32 %t701, 0
  %a161 = sext i32 %b250 to i64
  %95 = sext i32 %t699 to i64
  %a164 = add nsw i64 %a161, -1
  %96 = icmp ult i32 %61, 1073741824
  %97 = shl nuw nsw i64 %62, 1
  %98 = add nuw nsw i64 %97, 3
  %99 = icmp sgt i32 %t691, 0
  %100 = sext i32 %b139 to i64
  %101 = sext i32 %36 to i64
  %102 = sext i32 %57 to i64
  %103 = add nsw i64 %95, %100
  %104 = add nsw i32 %t699, %b139
  %105 = sext i32 %output.stride.1 to i64
  %106 = sext i32 %t695 to i64
  %107 = sext i32 %t702 to i64
  %108 = zext i32 %t732 to i64
  %109 = sext i32 %input.stride.1 to i64
  %110 = zext i32 %input.min.0 to i64
  %111 = sext i32 %87 to i64
  %112 = zext i32 %t701 to i64
  %113 = sext i32 %93 to i64
  %114 = zext i32 %t691 to i64
  %115 = getelementptr inbounds i8, i8* %74, i64 -30
  %116 = getelementptr inbounds i8, i8* %input, i64 -1
  %117 = getelementptr inbounds i8, i8* %74, i64 -30
  %118 = getelementptr inbounds i8, i8* %74, i64 -32
  %119 = getelementptr inbounds i8, i8* %74, i64 -32
  %120 = getelementptr inbounds i8, i8* %74, i64 -32
  %121 = getelementptr inbounds i8, i8* %74, i64 -32
  %122 = getelementptr inbounds i8, i8* %74, i64 -32
  %123 = getelementptr inbounds i8, i8* %74, i64 -32
  %124 = getelementptr inbounds i8, i8* %74, i64 -64
  %125 = getelementptr inbounds i8, i8* %74, i64 -32
  %126 = getelementptr inbounds i8, i8* %74, i64 -64
  %127 = getelementptr inbounds i8, i8* %output, i64 -32
  %.fca.1.gep13.promoted = load i64, i64* %.fca.1.gep13, align 8, !tbaa !375
  %.fca.0.gep12.promoted = load i8*, i8** %.fca.0.gep12, align 8, !tbaa !377
  %.fca.1.gep15.promoted126 = load i64, i64* %.fca.1.gep15, align 8, !tbaa !375
  %.fca.0.gep14.promoted129 = load i8*, i8** %.fca.0.gep14, align 8, !tbaa !377
  br label %"for output.s0.y.yi.yi"

destructor_block.thread:                          ; preds = %"end for output.s0.y.yi.yii.yii"
  store i64 %586, i64* %.fca.1.gep13, align 8, !tbaa !375
  store i8* %585, i8** %.fca.0.gep12, align 8, !tbaa !377
  store i64 %638, i64* %.fca.1.gep15, align 8, !tbaa !375
  store i8* %637, i8** %.fca.0.gep14, align 8, !tbaa !377
  %128 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %min_y.pseudostack_slot, i64 0, i32 1
  store i64 0, i64* %128, align 8, !tbaa !375
  %129 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %min_y.pseudostack_slot, i64 0, i32 0
  %130 = icmp eq i8* %637, null
  br i1 %130, label %pseudostack_free.exit, label %131

131:                                              ; preds = %destructor_block.thread
  call void @halide_free(i8* %__user_context, i8* nonnull %637) #12
  br label %pseudostack_free.exit

pseudostack_free.exit:                            ; preds = %131, %destructor_block.thread
  store i8* null, i8** %129, align 8, !tbaa !377
  br label %133

call_destructor.exit:                             ; preds = %"end for bounded_input.s0.y.rebased"
  store i64 %146, i64* %.fca.1.gep13, align 8, !tbaa !375
  store i8* %145, i8** %.fca.0.gep12, align 8, !tbaa !377
  store i64 %.lcssa127, i64* %.fca.1.gep15, align 8, !tbaa !375
  store i8* %.lcssa119130, i8** %.fca.0.gep14, align 8, !tbaa !377
  %132 = tail call i32 @halide_error_buffer_allocation_too_large(i8* %__user_context, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.210, i64 0, i64 0), i64 %90, i64 2147483647) #10
  br label %140

133:                                              ; preds = %"assert failed8", %pseudostack_free.exit
  %.ph = phi i32 [ %627, %"assert failed8" ], [ 0, %pseudostack_free.exit ]
  %134 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %max_y.pseudostack_slot, i64 0, i32 1
  store i64 0, i64* %134, align 8, !tbaa !375
  %135 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %max_y.pseudostack_slot, i64 0, i32 0
  %136 = load i8*, i8** %135, align 8, !tbaa !377
  %137 = icmp eq i8* %136, null
  br i1 %137, label %pseudostack_free.exit41, label %138

138:                                              ; preds = %133
  call void @halide_free(i8* %__user_context, i8* nonnull %136) #12
  br label %pseudostack_free.exit41

pseudostack_free.exit41:                          ; preds = %138, %133
  store i8* null, i8** %135, align 8, !tbaa !377
  br label %140

call_destructor.exit37:                           ; preds = %entry
  %139 = tail call i32 @halide_error_buffer_allocation_too_large(i8* %__user_context, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.209, i64 0, i64 0), i64 %63, i64 2147483647) #10
  br label %call_destructor.exit38

140:                                              ; preds = %pseudostack_free.exit41, %call_destructor.exit
  %141 = phi i32 [ %132, %call_destructor.exit ], [ %.ph, %pseudostack_free.exit41 ]
  %142 = icmp eq i8* %74, null
  br i1 %142, label %call_destructor.exit38, label %143

143:                                              ; preds = %140
  call void @halide_free(i8* %__user_context, i8* nonnull %74) #12
  br label %call_destructor.exit38

call_destructor.exit38:                           ; preds = %143, %140, %call_destructor.exit37
  %144 = phi i32 [ %139, %call_destructor.exit37 ], [ %141, %140 ], [ %141, %143 ]
  ret i32 %144

"for output.s0.y.yi.yi":                          ; preds = %"end for output.s0.y.yi.yii.yii", %pseudostack_alloc.exit
  %.lcssa119130 = phi i8* [ %.fca.0.gep14.promoted129, %pseudostack_alloc.exit ], [ %637, %"end for output.s0.y.yi.yii.yii" ]
  %.lcssa127 = phi i64 [ %.fca.1.gep15.promoted126, %pseudostack_alloc.exit ], [ %638, %"end for output.s0.y.yi.yii.yii" ]
  %145 = phi i8* [ %.fca.0.gep12.promoted, %pseudostack_alloc.exit ], [ %585, %"end for output.s0.y.yi.yii.yii" ]
  %146 = phi i64 [ %.fca.1.gep13.promoted, %pseudostack_alloc.exit ], [ %586, %"end for output.s0.y.yi.yii.yii" ]
  %147 = phi i1 [ false, %pseudostack_alloc.exit ], [ true, %"end for output.s0.y.yi.yii.yii" ]
  %output.s0.y.yi.yi = phi i32 [ 0, %pseudostack_alloc.exit ], [ 17, %"end for output.s0.y.yi.yii.yii" ]
  %148 = add nsw i32 %output.s0.y.yi.yi, %36
  %a81 = add nsw i32 %148, 1
  %149 = icmp sgt i32 %b250, %a81
  %a80 = select i1 %149, i32 %a81, i32 %b250
  %150 = icmp sgt i32 %a80, 1
  %151 = select i1 %150, i32 %a80, i32 1
  %.not22 = icmp slt i32 %148, %b250
  %a83 = select i1 %.not22, i32 %148, i32 %a55
  %152 = icmp sgt i32 %a83, 0
  %a82 = select i1 %152, i32 %a83, i32 0
  %a85 = select i1 %.not22, i32 %148, i32 %b250
  %153 = icmp sgt i32 %a85, 1
  %154 = select i1 %153, i32 %a85, i32 1
  %b84 = add nsw i32 %154, -1
  %155 = icmp sgt i32 %b84, %a82
  %156 = select i1 %155, i32 %a82, i32 %b84
  %bounded_input.s0.y.min_2 = select i1 %147, i32 %151, i32 %156
  %a88 = add nsw i32 %148, 18
  %157 = icmp sgt i32 %b250, %a88
  %a87 = select i1 %157, i32 %a88, i32 %b250
  %158 = icmp sgt i32 %a87, 1
  %159 = select i1 %158, i32 %a87, i32 1
  %t717 = sub nsw i32 %159, %bounded_input.s0.y.min_2
  %160 = icmp sgt i32 %t717, 0
  br i1 %160, label %"for bounded_input.s0.y.rebased.preheader", label %"end for bounded_input.s0.y.rebased", !prof !374

"for bounded_input.s0.y.rebased.preheader":       ; preds = %"for output.s0.y.yi.yi"
  %t720 = sub i32 %bounded_input.s0.y.min_2, %input.min.1
  %161 = sext i32 %bounded_input.s0.y.min_2 to i64
  %162 = sub nsw i64 %161, %84
  %163 = sext i32 %t720 to i64
  %164 = zext i32 %t717 to i64
  br label %"for bounded_input.s0.y.rebased"

"for bounded_input.s0.y.rebased":                 ; preds = %"end for bounded_input.s0.x.x.rebased2", %"for bounded_input.s0.y.rebased.preheader"
  %indvars.iv99 = phi i64 [ 0, %"for bounded_input.s0.y.rebased.preheader" ], [ %indvars.iv.next100, %"end for bounded_input.s0.x.x.rebased2" ]
  %165 = add nsw i64 %indvars.iv99, %163
  %166 = mul nsw i64 %165, %109
  %167 = sub i64 %166, %110
  br i1 %77, label %"for bounded_input.s0.x.x.preheader", label %"end for bounded_input.s0.x.x", !prof !374

"for bounded_input.s0.x.x.preheader":             ; preds = %"for bounded_input.s0.y.rebased"
  %168 = trunc i64 %167 to i32
  %169 = insertelement <32 x i32> undef, i32 %168, i32 0
  %170 = shufflevector <32 x i32> %169, <32 x i32> undef, <32 x i32> zeroinitializer
  %171 = add nsw i64 %162, %indvars.iv99
  %172 = mul nsw i64 %171, %86
  br label %"for bounded_input.s0.x.x"

"end for bounded_input.s0.y.rebased":             ; preds = %"end for bounded_input.s0.x.x.rebased2", %"for output.s0.y.yi.yi"
  br i1 %91, label %"assert succeeded6", label %call_destructor.exit, !prof !374

"for bounded_input.s0.x.x":                       ; preds = %"for bounded_input.s0.x.x", %"for bounded_input.s0.x.x.preheader"
  %bounded_input.s0.x.x = phi i32 [ %366, %"for bounded_input.s0.x.x" ], [ 0, %"for bounded_input.s0.x.x.preheader" ]
  %173 = shl nsw i32 %bounded_input.s0.x.x, 5
  %a104 = or i32 %173, 30
  %174 = icmp sgt i32 %b139, %a104
  %bounded_input.s0.x.xi.base.s = select i1 %174, i32 %a104, i32 %b139
  %175 = add i32 %78, %bounded_input.s0.x.xi.base.s
  %176 = insertelement <32 x i32> undef, i32 %175, i32 0
  %177 = shufflevector <32 x i32> %176, <32 x i32> undef, <32 x i32> zeroinitializer
  %a106 = add nsw <32 x i32> %177, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %178 = shufflevector <32 x i32> %a106, <32 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %179 = icmp sgt <8 x i32> %81, %178
  %180 = shufflevector <32 x i32> %a106, <32 x i32> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %181 = icmp sgt <8 x i32> %81, %180
  %182 = shufflevector <32 x i32> %a106, <32 x i32> undef, <8 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23>
  %183 = icmp sgt <8 x i32> %81, %182
  %184 = shufflevector <32 x i32> %a106, <32 x i32> undef, <8 x i32> <i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %185 = icmp sgt <8 x i32> %81, %184
  %186 = select <8 x i1> %179, <8 x i32> %178, <8 x i32> %81
  %187 = select <8 x i1> %181, <8 x i32> %180, <8 x i32> %81
  %188 = select <8 x i1> %183, <8 x i32> %182, <8 x i32> %81
  %189 = select <8 x i1> %185, <8 x i32> %184, <8 x i32> %81
  %190 = icmp sgt <8 x i32> %186, %83
  %191 = icmp sgt <8 x i32> %187, %83
  %192 = icmp sgt <8 x i32> %188, %83
  %193 = icmp sgt <8 x i32> %189, %83
  %194 = select <8 x i1> %190, <8 x i32> %186, <8 x i32> %83
  %195 = select <8 x i1> %191, <8 x i32> %187, <8 x i32> %83
  %196 = select <8 x i1> %192, <8 x i32> %188, <8 x i32> %83
  %197 = select <8 x i1> %193, <8 x i32> %189, <8 x i32> %83
  %198 = shufflevector <8 x i32> %194, <8 x i32> %195, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %199 = shufflevector <8 x i32> %196, <8 x i32> %197, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %200 = shufflevector <16 x i32> %198, <16 x i32> %199, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %201 = add nsw <32 x i32> %200, %170
  %202 = extractelement <32 x i32> %201, i32 0
  %203 = sext i32 %202 to i64
  %204 = getelementptr inbounds i8, i8* %input, i64 %203
  %205 = load i8, i8* %204, align 1, !tbaa !378
  %206 = insertelement <32 x i8> undef, i8 %205, i32 0
  %207 = extractelement <32 x i32> %201, i32 1
  %208 = sext i32 %207 to i64
  %209 = getelementptr inbounds i8, i8* %input, i64 %208
  %210 = load i8, i8* %209, align 1, !tbaa !378
  %211 = insertelement <32 x i8> %206, i8 %210, i32 1
  %212 = extractelement <32 x i32> %201, i32 2
  %213 = sext i32 %212 to i64
  %214 = getelementptr inbounds i8, i8* %input, i64 %213
  %215 = load i8, i8* %214, align 1, !tbaa !378
  %216 = insertelement <32 x i8> %211, i8 %215, i32 2
  %217 = extractelement <32 x i32> %201, i32 3
  %218 = sext i32 %217 to i64
  %219 = getelementptr inbounds i8, i8* %input, i64 %218
  %220 = load i8, i8* %219, align 1, !tbaa !378
  %221 = insertelement <32 x i8> %216, i8 %220, i32 3
  %222 = extractelement <32 x i32> %201, i32 4
  %223 = sext i32 %222 to i64
  %224 = getelementptr inbounds i8, i8* %input, i64 %223
  %225 = load i8, i8* %224, align 1, !tbaa !378
  %226 = insertelement <32 x i8> %221, i8 %225, i32 4
  %227 = extractelement <32 x i32> %201, i32 5
  %228 = sext i32 %227 to i64
  %229 = getelementptr inbounds i8, i8* %input, i64 %228
  %230 = load i8, i8* %229, align 1, !tbaa !378
  %231 = insertelement <32 x i8> %226, i8 %230, i32 5
  %232 = extractelement <32 x i32> %201, i32 6
  %233 = sext i32 %232 to i64
  %234 = getelementptr inbounds i8, i8* %input, i64 %233
  %235 = load i8, i8* %234, align 1, !tbaa !378
  %236 = insertelement <32 x i8> %231, i8 %235, i32 6
  %237 = extractelement <32 x i32> %201, i32 7
  %238 = sext i32 %237 to i64
  %239 = getelementptr inbounds i8, i8* %input, i64 %238
  %240 = load i8, i8* %239, align 1, !tbaa !378
  %241 = insertelement <32 x i8> %236, i8 %240, i32 7
  %242 = extractelement <32 x i32> %201, i32 8
  %243 = sext i32 %242 to i64
  %244 = getelementptr inbounds i8, i8* %input, i64 %243
  %245 = load i8, i8* %244, align 1, !tbaa !378
  %246 = insertelement <32 x i8> %241, i8 %245, i32 8
  %247 = extractelement <32 x i32> %201, i32 9
  %248 = sext i32 %247 to i64
  %249 = getelementptr inbounds i8, i8* %input, i64 %248
  %250 = load i8, i8* %249, align 1, !tbaa !378
  %251 = insertelement <32 x i8> %246, i8 %250, i32 9
  %252 = extractelement <32 x i32> %201, i32 10
  %253 = sext i32 %252 to i64
  %254 = getelementptr inbounds i8, i8* %input, i64 %253
  %255 = load i8, i8* %254, align 1, !tbaa !378
  %256 = insertelement <32 x i8> %251, i8 %255, i32 10
  %257 = extractelement <32 x i32> %201, i32 11
  %258 = sext i32 %257 to i64
  %259 = getelementptr inbounds i8, i8* %input, i64 %258
  %260 = load i8, i8* %259, align 1, !tbaa !378
  %261 = insertelement <32 x i8> %256, i8 %260, i32 11
  %262 = extractelement <32 x i32> %201, i32 12
  %263 = sext i32 %262 to i64
  %264 = getelementptr inbounds i8, i8* %input, i64 %263
  %265 = load i8, i8* %264, align 1, !tbaa !378
  %266 = insertelement <32 x i8> %261, i8 %265, i32 12
  %267 = extractelement <32 x i32> %201, i32 13
  %268 = sext i32 %267 to i64
  %269 = getelementptr inbounds i8, i8* %input, i64 %268
  %270 = load i8, i8* %269, align 1, !tbaa !378
  %271 = insertelement <32 x i8> %266, i8 %270, i32 13
  %272 = extractelement <32 x i32> %201, i32 14
  %273 = sext i32 %272 to i64
  %274 = getelementptr inbounds i8, i8* %input, i64 %273
  %275 = load i8, i8* %274, align 1, !tbaa !378
  %276 = insertelement <32 x i8> %271, i8 %275, i32 14
  %277 = extractelement <32 x i32> %201, i32 15
  %278 = sext i32 %277 to i64
  %279 = getelementptr inbounds i8, i8* %input, i64 %278
  %280 = load i8, i8* %279, align 1, !tbaa !378
  %281 = insertelement <32 x i8> %276, i8 %280, i32 15
  %282 = extractelement <32 x i32> %201, i32 16
  %283 = sext i32 %282 to i64
  %284 = getelementptr inbounds i8, i8* %input, i64 %283
  %285 = load i8, i8* %284, align 1, !tbaa !378
  %286 = insertelement <32 x i8> %281, i8 %285, i32 16
  %287 = extractelement <32 x i32> %201, i32 17
  %288 = sext i32 %287 to i64
  %289 = getelementptr inbounds i8, i8* %input, i64 %288
  %290 = load i8, i8* %289, align 1, !tbaa !378
  %291 = insertelement <32 x i8> %286, i8 %290, i32 17
  %292 = extractelement <32 x i32> %201, i32 18
  %293 = sext i32 %292 to i64
  %294 = getelementptr inbounds i8, i8* %input, i64 %293
  %295 = load i8, i8* %294, align 1, !tbaa !378
  %296 = insertelement <32 x i8> %291, i8 %295, i32 18
  %297 = extractelement <32 x i32> %201, i32 19
  %298 = sext i32 %297 to i64
  %299 = getelementptr inbounds i8, i8* %input, i64 %298
  %300 = load i8, i8* %299, align 1, !tbaa !378
  %301 = insertelement <32 x i8> %296, i8 %300, i32 19
  %302 = extractelement <32 x i32> %201, i32 20
  %303 = sext i32 %302 to i64
  %304 = getelementptr inbounds i8, i8* %input, i64 %303
  %305 = load i8, i8* %304, align 1, !tbaa !378
  %306 = insertelement <32 x i8> %301, i8 %305, i32 20
  %307 = extractelement <32 x i32> %201, i32 21
  %308 = sext i32 %307 to i64
  %309 = getelementptr inbounds i8, i8* %input, i64 %308
  %310 = load i8, i8* %309, align 1, !tbaa !378
  %311 = insertelement <32 x i8> %306, i8 %310, i32 21
  %312 = extractelement <32 x i32> %201, i32 22
  %313 = sext i32 %312 to i64
  %314 = getelementptr inbounds i8, i8* %input, i64 %313
  %315 = load i8, i8* %314, align 1, !tbaa !378
  %316 = insertelement <32 x i8> %311, i8 %315, i32 22
  %317 = extractelement <32 x i32> %201, i32 23
  %318 = sext i32 %317 to i64
  %319 = getelementptr inbounds i8, i8* %input, i64 %318
  %320 = load i8, i8* %319, align 1, !tbaa !378
  %321 = insertelement <32 x i8> %316, i8 %320, i32 23
  %322 = extractelement <32 x i32> %201, i32 24
  %323 = sext i32 %322 to i64
  %324 = getelementptr inbounds i8, i8* %input, i64 %323
  %325 = load i8, i8* %324, align 1, !tbaa !378
  %326 = insertelement <32 x i8> %321, i8 %325, i32 24
  %327 = extractelement <32 x i32> %201, i32 25
  %328 = sext i32 %327 to i64
  %329 = getelementptr inbounds i8, i8* %input, i64 %328
  %330 = load i8, i8* %329, align 1, !tbaa !378
  %331 = insertelement <32 x i8> %326, i8 %330, i32 25
  %332 = extractelement <32 x i32> %201, i32 26
  %333 = sext i32 %332 to i64
  %334 = getelementptr inbounds i8, i8* %input, i64 %333
  %335 = load i8, i8* %334, align 1, !tbaa !378
  %336 = insertelement <32 x i8> %331, i8 %335, i32 26
  %337 = extractelement <32 x i32> %201, i32 27
  %338 = sext i32 %337 to i64
  %339 = getelementptr inbounds i8, i8* %input, i64 %338
  %340 = load i8, i8* %339, align 1, !tbaa !378
  %341 = insertelement <32 x i8> %336, i8 %340, i32 27
  %342 = extractelement <32 x i32> %201, i32 28
  %343 = sext i32 %342 to i64
  %344 = getelementptr inbounds i8, i8* %input, i64 %343
  %345 = load i8, i8* %344, align 1, !tbaa !378
  %346 = insertelement <32 x i8> %341, i8 %345, i32 28
  %347 = extractelement <32 x i32> %201, i32 29
  %348 = sext i32 %347 to i64
  %349 = getelementptr inbounds i8, i8* %input, i64 %348
  %350 = load i8, i8* %349, align 1, !tbaa !378
  %351 = insertelement <32 x i8> %346, i8 %350, i32 29
  %352 = extractelement <32 x i32> %201, i32 30
  %353 = sext i32 %352 to i64
  %354 = getelementptr inbounds i8, i8* %input, i64 %353
  %355 = load i8, i8* %354, align 1, !tbaa !378
  %356 = insertelement <32 x i8> %351, i8 %355, i32 30
  %357 = extractelement <32 x i32> %201, i32 31
  %358 = sext i32 %357 to i64
  %359 = getelementptr inbounds i8, i8* %input, i64 %358
  %360 = load i8, i8* %359, align 1, !tbaa !378
  %361 = insertelement <32 x i8> %356, i8 %360, i32 31
  %362 = sext i32 %bounded_input.s0.x.xi.base.s to i64
  %363 = add nsw i64 %172, %362
  %364 = getelementptr inbounds i8, i8* %115, i64 %363
  %365 = bitcast i8* %364 to <32 x i8>*
  store <32 x i8> %361, <32 x i8>* %365, align 1, !tbaa !381
  %366 = add nuw nsw i32 %bounded_input.s0.x.x, 1
  %.not36 = icmp eq i32 %366, %t702
  br i1 %.not36, label %"end for bounded_input.s0.x.x", label %"for bounded_input.s0.x.x"

"end for bounded_input.s0.x.x":                   ; preds = %"for bounded_input.s0.x.x", %"for bounded_input.s0.y.rebased"
  br i1 %88, label %"for bounded_input.s0.x.x.rebased.preheader", label %"end for bounded_input.s0.x.x.rebased", !prof !374

"for bounded_input.s0.x.x.rebased.preheader":     ; preds = %"end for bounded_input.s0.x.x"
  %367 = add nsw i64 %166, %111
  %368 = add nsw i64 %162, %indvars.iv99
  %369 = mul nsw i64 %368, %86
  br label %"for bounded_input.s0.x.x.rebased"

"for bounded_input.s0.x.x.rebased":               ; preds = %"for bounded_input.s0.x.x.rebased", %"for bounded_input.s0.x.x.rebased.preheader"
  %indvars.iv = phi i64 [ 0, %"for bounded_input.s0.x.x.rebased.preheader" ], [ %indvars.iv.next, %"for bounded_input.s0.x.x.rebased" ]
  %370 = add nsw i64 %indvars.iv, %107
  %371 = shl nsw i64 %370, 5
  %372 = add nsw i64 %371, %367
  %373 = getelementptr inbounds i8, i8* %116, i64 %372
  %374 = bitcast i8* %373 to <32 x i8>*
  %375 = load <32 x i8>, <32 x i8>* %374, align 1, !tbaa !378
  %376 = add nsw i64 %371, %369
  %377 = getelementptr inbounds i8, i8* %74, i64 %376
  %378 = bitcast i8* %377 to <32 x i8>*
  store <32 x i8> %375, <32 x i8>* %378, align 32, !tbaa !381
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.not35 = icmp eq i64 %indvars.iv.next, %108
  br i1 %.not35, label %"end for bounded_input.s0.x.x.rebased", label %"for bounded_input.s0.x.x.rebased"

"end for bounded_input.s0.x.x.rebased":           ; preds = %"for bounded_input.s0.x.x.rebased", %"end for bounded_input.s0.x.x"
  br i1 %89, label %"for bounded_input.s0.x.x.rebased1.preheader", label %"end for bounded_input.s0.x.x.rebased2", !prof !374

"for bounded_input.s0.x.x.rebased1.preheader":    ; preds = %"end for bounded_input.s0.x.x.rebased"
  %379 = trunc i64 %167 to i32
  %380 = insertelement <32 x i32> undef, i32 %379, i32 0
  %381 = shufflevector <32 x i32> %380, <32 x i32> undef, <32 x i32> zeroinitializer
  %382 = add nsw i64 %162, %indvars.iv99
  %383 = mul nsw i64 %382, %86
  br label %"for bounded_input.s0.x.x.rebased1"

"for bounded_input.s0.x.x.rebased1":              ; preds = %"for bounded_input.s0.x.x.rebased1", %"for bounded_input.s0.x.x.rebased1.preheader"
  %bounded_input.s0.x.x.rebased3 = phi i32 [ %578, %"for bounded_input.s0.x.x.rebased1" ], [ 0, %"for bounded_input.s0.x.x.rebased1.preheader" ]
  %384 = add nsw i32 %bounded_input.s0.x.x.rebased3, %t686
  %385 = shl nsw i32 %384, 5
  %a137 = or i32 %385, 30
  %386 = icmp sgt i32 %b139, %a137
  %bounded_input.s0.x.xi.base.s4 = select i1 %386, i32 %a137, i32 %b139
  %387 = add i32 %78, %bounded_input.s0.x.xi.base.s4
  %388 = insertelement <32 x i32> undef, i32 %387, i32 0
  %389 = shufflevector <32 x i32> %388, <32 x i32> undef, <32 x i32> zeroinitializer
  %a139 = add nsw <32 x i32> %389, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %390 = shufflevector <32 x i32> %a139, <32 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %391 = icmp sgt <8 x i32> %81, %390
  %392 = shufflevector <32 x i32> %a139, <32 x i32> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %393 = icmp sgt <8 x i32> %81, %392
  %394 = shufflevector <32 x i32> %a139, <32 x i32> undef, <8 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23>
  %395 = icmp sgt <8 x i32> %81, %394
  %396 = shufflevector <32 x i32> %a139, <32 x i32> undef, <8 x i32> <i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %397 = icmp sgt <8 x i32> %81, %396
  %398 = select <8 x i1> %391, <8 x i32> %390, <8 x i32> %81
  %399 = select <8 x i1> %393, <8 x i32> %392, <8 x i32> %81
  %400 = select <8 x i1> %395, <8 x i32> %394, <8 x i32> %81
  %401 = select <8 x i1> %397, <8 x i32> %396, <8 x i32> %81
  %402 = icmp sgt <8 x i32> %398, %83
  %403 = icmp sgt <8 x i32> %399, %83
  %404 = icmp sgt <8 x i32> %400, %83
  %405 = icmp sgt <8 x i32> %401, %83
  %406 = select <8 x i1> %402, <8 x i32> %398, <8 x i32> %83
  %407 = select <8 x i1> %403, <8 x i32> %399, <8 x i32> %83
  %408 = select <8 x i1> %404, <8 x i32> %400, <8 x i32> %83
  %409 = select <8 x i1> %405, <8 x i32> %401, <8 x i32> %83
  %410 = shufflevector <8 x i32> %406, <8 x i32> %407, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %411 = shufflevector <8 x i32> %408, <8 x i32> %409, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %412 = shufflevector <16 x i32> %410, <16 x i32> %411, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %413 = add nsw <32 x i32> %412, %381
  %414 = extractelement <32 x i32> %413, i32 0
  %415 = sext i32 %414 to i64
  %416 = getelementptr inbounds i8, i8* %input, i64 %415
  %417 = load i8, i8* %416, align 1, !tbaa !378
  %418 = insertelement <32 x i8> undef, i8 %417, i32 0
  %419 = extractelement <32 x i32> %413, i32 1
  %420 = sext i32 %419 to i64
  %421 = getelementptr inbounds i8, i8* %input, i64 %420
  %422 = load i8, i8* %421, align 1, !tbaa !378
  %423 = insertelement <32 x i8> %418, i8 %422, i32 1
  %424 = extractelement <32 x i32> %413, i32 2
  %425 = sext i32 %424 to i64
  %426 = getelementptr inbounds i8, i8* %input, i64 %425
  %427 = load i8, i8* %426, align 1, !tbaa !378
  %428 = insertelement <32 x i8> %423, i8 %427, i32 2
  %429 = extractelement <32 x i32> %413, i32 3
  %430 = sext i32 %429 to i64
  %431 = getelementptr inbounds i8, i8* %input, i64 %430
  %432 = load i8, i8* %431, align 1, !tbaa !378
  %433 = insertelement <32 x i8> %428, i8 %432, i32 3
  %434 = extractelement <32 x i32> %413, i32 4
  %435 = sext i32 %434 to i64
  %436 = getelementptr inbounds i8, i8* %input, i64 %435
  %437 = load i8, i8* %436, align 1, !tbaa !378
  %438 = insertelement <32 x i8> %433, i8 %437, i32 4
  %439 = extractelement <32 x i32> %413, i32 5
  %440 = sext i32 %439 to i64
  %441 = getelementptr inbounds i8, i8* %input, i64 %440
  %442 = load i8, i8* %441, align 1, !tbaa !378
  %443 = insertelement <32 x i8> %438, i8 %442, i32 5
  %444 = extractelement <32 x i32> %413, i32 6
  %445 = sext i32 %444 to i64
  %446 = getelementptr inbounds i8, i8* %input, i64 %445
  %447 = load i8, i8* %446, align 1, !tbaa !378
  %448 = insertelement <32 x i8> %443, i8 %447, i32 6
  %449 = extractelement <32 x i32> %413, i32 7
  %450 = sext i32 %449 to i64
  %451 = getelementptr inbounds i8, i8* %input, i64 %450
  %452 = load i8, i8* %451, align 1, !tbaa !378
  %453 = insertelement <32 x i8> %448, i8 %452, i32 7
  %454 = extractelement <32 x i32> %413, i32 8
  %455 = sext i32 %454 to i64
  %456 = getelementptr inbounds i8, i8* %input, i64 %455
  %457 = load i8, i8* %456, align 1, !tbaa !378
  %458 = insertelement <32 x i8> %453, i8 %457, i32 8
  %459 = extractelement <32 x i32> %413, i32 9
  %460 = sext i32 %459 to i64
  %461 = getelementptr inbounds i8, i8* %input, i64 %460
  %462 = load i8, i8* %461, align 1, !tbaa !378
  %463 = insertelement <32 x i8> %458, i8 %462, i32 9
  %464 = extractelement <32 x i32> %413, i32 10
  %465 = sext i32 %464 to i64
  %466 = getelementptr inbounds i8, i8* %input, i64 %465
  %467 = load i8, i8* %466, align 1, !tbaa !378
  %468 = insertelement <32 x i8> %463, i8 %467, i32 10
  %469 = extractelement <32 x i32> %413, i32 11
  %470 = sext i32 %469 to i64
  %471 = getelementptr inbounds i8, i8* %input, i64 %470
  %472 = load i8, i8* %471, align 1, !tbaa !378
  %473 = insertelement <32 x i8> %468, i8 %472, i32 11
  %474 = extractelement <32 x i32> %413, i32 12
  %475 = sext i32 %474 to i64
  %476 = getelementptr inbounds i8, i8* %input, i64 %475
  %477 = load i8, i8* %476, align 1, !tbaa !378
  %478 = insertelement <32 x i8> %473, i8 %477, i32 12
  %479 = extractelement <32 x i32> %413, i32 13
  %480 = sext i32 %479 to i64
  %481 = getelementptr inbounds i8, i8* %input, i64 %480
  %482 = load i8, i8* %481, align 1, !tbaa !378
  %483 = insertelement <32 x i8> %478, i8 %482, i32 13
  %484 = extractelement <32 x i32> %413, i32 14
  %485 = sext i32 %484 to i64
  %486 = getelementptr inbounds i8, i8* %input, i64 %485
  %487 = load i8, i8* %486, align 1, !tbaa !378
  %488 = insertelement <32 x i8> %483, i8 %487, i32 14
  %489 = extractelement <32 x i32> %413, i32 15
  %490 = sext i32 %489 to i64
  %491 = getelementptr inbounds i8, i8* %input, i64 %490
  %492 = load i8, i8* %491, align 1, !tbaa !378
  %493 = insertelement <32 x i8> %488, i8 %492, i32 15
  %494 = extractelement <32 x i32> %413, i32 16
  %495 = sext i32 %494 to i64
  %496 = getelementptr inbounds i8, i8* %input, i64 %495
  %497 = load i8, i8* %496, align 1, !tbaa !378
  %498 = insertelement <32 x i8> %493, i8 %497, i32 16
  %499 = extractelement <32 x i32> %413, i32 17
  %500 = sext i32 %499 to i64
  %501 = getelementptr inbounds i8, i8* %input, i64 %500
  %502 = load i8, i8* %501, align 1, !tbaa !378
  %503 = insertelement <32 x i8> %498, i8 %502, i32 17
  %504 = extractelement <32 x i32> %413, i32 18
  %505 = sext i32 %504 to i64
  %506 = getelementptr inbounds i8, i8* %input, i64 %505
  %507 = load i8, i8* %506, align 1, !tbaa !378
  %508 = insertelement <32 x i8> %503, i8 %507, i32 18
  %509 = extractelement <32 x i32> %413, i32 19
  %510 = sext i32 %509 to i64
  %511 = getelementptr inbounds i8, i8* %input, i64 %510
  %512 = load i8, i8* %511, align 1, !tbaa !378
  %513 = insertelement <32 x i8> %508, i8 %512, i32 19
  %514 = extractelement <32 x i32> %413, i32 20
  %515 = sext i32 %514 to i64
  %516 = getelementptr inbounds i8, i8* %input, i64 %515
  %517 = load i8, i8* %516, align 1, !tbaa !378
  %518 = insertelement <32 x i8> %513, i8 %517, i32 20
  %519 = extractelement <32 x i32> %413, i32 21
  %520 = sext i32 %519 to i64
  %521 = getelementptr inbounds i8, i8* %input, i64 %520
  %522 = load i8, i8* %521, align 1, !tbaa !378
  %523 = insertelement <32 x i8> %518, i8 %522, i32 21
  %524 = extractelement <32 x i32> %413, i32 22
  %525 = sext i32 %524 to i64
  %526 = getelementptr inbounds i8, i8* %input, i64 %525
  %527 = load i8, i8* %526, align 1, !tbaa !378
  %528 = insertelement <32 x i8> %523, i8 %527, i32 22
  %529 = extractelement <32 x i32> %413, i32 23
  %530 = sext i32 %529 to i64
  %531 = getelementptr inbounds i8, i8* %input, i64 %530
  %532 = load i8, i8* %531, align 1, !tbaa !378
  %533 = insertelement <32 x i8> %528, i8 %532, i32 23
  %534 = extractelement <32 x i32> %413, i32 24
  %535 = sext i32 %534 to i64
  %536 = getelementptr inbounds i8, i8* %input, i64 %535
  %537 = load i8, i8* %536, align 1, !tbaa !378
  %538 = insertelement <32 x i8> %533, i8 %537, i32 24
  %539 = extractelement <32 x i32> %413, i32 25
  %540 = sext i32 %539 to i64
  %541 = getelementptr inbounds i8, i8* %input, i64 %540
  %542 = load i8, i8* %541, align 1, !tbaa !378
  %543 = insertelement <32 x i8> %538, i8 %542, i32 25
  %544 = extractelement <32 x i32> %413, i32 26
  %545 = sext i32 %544 to i64
  %546 = getelementptr inbounds i8, i8* %input, i64 %545
  %547 = load i8, i8* %546, align 1, !tbaa !378
  %548 = insertelement <32 x i8> %543, i8 %547, i32 26
  %549 = extractelement <32 x i32> %413, i32 27
  %550 = sext i32 %549 to i64
  %551 = getelementptr inbounds i8, i8* %input, i64 %550
  %552 = load i8, i8* %551, align 1, !tbaa !378
  %553 = insertelement <32 x i8> %548, i8 %552, i32 27
  %554 = extractelement <32 x i32> %413, i32 28
  %555 = sext i32 %554 to i64
  %556 = getelementptr inbounds i8, i8* %input, i64 %555
  %557 = load i8, i8* %556, align 1, !tbaa !378
  %558 = insertelement <32 x i8> %553, i8 %557, i32 28
  %559 = extractelement <32 x i32> %413, i32 29
  %560 = sext i32 %559 to i64
  %561 = getelementptr inbounds i8, i8* %input, i64 %560
  %562 = load i8, i8* %561, align 1, !tbaa !378
  %563 = insertelement <32 x i8> %558, i8 %562, i32 29
  %564 = extractelement <32 x i32> %413, i32 30
  %565 = sext i32 %564 to i64
  %566 = getelementptr inbounds i8, i8* %input, i64 %565
  %567 = load i8, i8* %566, align 1, !tbaa !378
  %568 = insertelement <32 x i8> %563, i8 %567, i32 30
  %569 = extractelement <32 x i32> %413, i32 31
  %570 = sext i32 %569 to i64
  %571 = getelementptr inbounds i8, i8* %input, i64 %570
  %572 = load i8, i8* %571, align 1, !tbaa !378
  %573 = insertelement <32 x i8> %568, i8 %572, i32 31
  %574 = sext i32 %bounded_input.s0.x.xi.base.s4 to i64
  %575 = add nsw i64 %383, %574
  %576 = getelementptr inbounds i8, i8* %117, i64 %575
  %577 = bitcast i8* %576 to <32 x i8>*
  store <32 x i8> %573, <32 x i8>* %577, align 1, !tbaa !381
  %578 = add nuw nsw i32 %bounded_input.s0.x.x.rebased3, 1
  %.not34 = icmp eq i32 %578, %t724
  br i1 %.not34, label %"end for bounded_input.s0.x.x.rebased2", label %"for bounded_input.s0.x.x.rebased1"
...
"end for bounded_input.s0.x.x.rebased2":          ; preds = %"for bounded_input.s0.x.x.rebased1", %"end for bounded_input.s0.x.x.rebased"
  ...
  %.not33 = icmp eq i64 %indvars.iv.next100, %164
  br i1 %.not33, label %"end for bounded_input.s0.y.rebased", label %"for bounded_input.s0.y.rebased"

"assert succeeded6":                              ; preds = %"end for bounded_input.s0.y.rebased"
  %579 = icmp ult i64 %146, %92
  br i1 %579, label %580, label %pseudostack_alloc.exit39, !prof !383

580:                                              ; preds = %"assert succeeded6"
  %581 = icmp eq i8* %145, null
  br i1 %581, label %583, label %582

582:                                              ; preds = %580
  tail call void @halide_free(i8* %__user_context, i8* nonnull %145) #12
  br label %583

583:                                              ; preds = %582, %580
  %584 = tail call i8* @halide_malloc(i8* %__user_context, i64 %92) #12
  br label %pseudostack_alloc.exit39

pseudostack_alloc.exit39:                         ; preds = %583, %"assert succeeded6"
  %585 = phi i8* [ %584, %583 ], [ %145, %"assert succeeded6" ]
  %586 = phi i64 [ %92, %583 ], [ %146, %"assert succeeded6" ]
  br i1 %94, label %"for max_y.s0.y.rebased.us.preheader", label %"for output.s0.y.yi.yii.yii.preheader", !prof !374

"for max_y.s0.y.rebased.us.preheader":            ; preds = %pseudostack_alloc.exit39
  %587 = sext i32 %148 to i64
  br label %"for max_y.s0.y.rebased.us"

"for max_y.s0.y.rebased.us":                      ; preds = %"end for max_y.s0.x.x.loopexit.us", %"for max_y.s0.y.rebased.us.preheader"
  %indvars.iv105 = phi i64 [ 0, %"for max_y.s0.y.rebased.us.preheader" ], [ %indvars.iv.next106, %"end for max_y.s0.x.x.loopexit.us" ]
  %588 = mul nsw i64 %indvars.iv105, %113
  %589 = add nsw i64 %indvars.iv105, %587
  %590 = icmp sgt i64 %589, %a161
  %a160.us = select i1 %590, i64 %a161, i64 %589
  %591 = icmp sgt i64 %a160.us, 1
  %592 = select i1 %591, i64 %a160.us, i64 1
  %593 = sub nsw i64 %592, %84
  %594 = mul nsw i64 %593, %86
  %.not31.us = icmp slt i64 %589, %a161
  %a163.us = select i1 %.not31.us, i64 %589, i64 %a164
  %595 = icmp sgt i64 %a163.us, 0
  %596 = select i1 %595, i64 %a163.us, i64 0
  %597 = sub nsw i64 %596, %84
  %598 = mul nsw i64 %597, %86
  %a166.us = add nsw i64 %589, 2
  %599 = icmp slt i64 %a166.us, %a161
  %a165.us = select i1 %599, i64 %a166.us, i64 %a161
  %600 = icmp sgt i64 %a165.us, 1
  %601 = select i1 %600, i64 %a165.us, i64 1
  %602 = sub nsw i64 %601, %84
  %603 = mul nsw i64 %602, %86
  br label %"for max_y.s0.x.x.us"

"for max_y.s0.x.x.us":                            ; preds = %"for max_y.s0.x.x.us", %"for max_y.s0.y.rebased.us"
  %indvars.iv103 = phi i64 [ 0, %"for max_y.s0.y.rebased.us" ], [ %indvars.iv.next104, %"for max_y.s0.x.x.us" ]
  %604 = shl nuw nsw i64 %indvars.iv103, 5
  %605 = add nsw i64 %604, %95
  %606 = add i64 %605, %594
  %607 = getelementptr inbounds i8, i8* %118, i64 %606
  %608 = bitcast i8* %607 to <32 x i8>*
  %a159.us = load <32 x i8>, <32 x i8>* %608, align 1, !tbaa !381
  %609 = add nsw i64 %604, %598
  %610 = getelementptr inbounds i8, i8* %74, i64 %609
  %611 = bitcast i8* %610 to <32 x i8>*
  %a162.us = load <32 x i8>, <32 x i8>* %611, align 32, !tbaa !381
  %612 = add i64 %605, %603
  %613 = getelementptr inbounds i8, i8* %119, i64 %612
  %614 = bitcast i8* %613 to <32 x i8>*
  %b164.us = load <32 x i8>, <32 x i8>* %614, align 1, !tbaa !381
  %615 = icmp ugt <32 x i8> %a162.us, %b164.us
  %b161.us = select <32 x i1> %615, <32 x i8> %a162.us, <32 x i8> %b164.us
  %616 = icmp ugt <32 x i8> %a159.us, %b161.us
  %617 = select <32 x i1> %616, <32 x i8> %a159.us, <32 x i8> %b161.us
  %618 = add nsw i64 %604, %588
  %619 = getelementptr inbounds i8, i8* %585, i64 %618
  %620 = bitcast i8* %619 to <32 x i8>*
  store <32 x i8> %617, <32 x i8>* %620, align 32, !tbaa !384
  %indvars.iv.next104 = add nuw nsw i64 %indvars.iv103, 1
  %.not32.us = icmp eq i64 %indvars.iv.next104, %112
  br i1 %.not32.us, label %"end for max_y.s0.x.x.loopexit.us", label %"for max_y.s0.x.x.us"

"end for max_y.s0.x.x.loopexit.us":               ; preds = %"for max_y.s0.x.x.us"
  %indvars.iv.next106 = add nuw nsw i64 %indvars.iv105, 1
  %.not23.us = icmp eq i64 %indvars.iv.next106, 17
  br i1 %.not23.us, label %"for output.s0.y.yi.yii.yii.preheader", label %"for max_y.s0.y.rebased.us"

"for output.s0.y.yi.yii.yii.preheader":           ; preds = %"end for max_y.s0.x.x.loopexit.us", %pseudostack_alloc.exit39
  br i1 %96, label %"assert succeeded9", label %"assert failed8", !prof !374

"for output.s0.y.yi.yii.yii":                     ; preds = %"end for output.s0.y.yi.yii.yiii"
  %a181 = shl nuw nsw i32 %699, 1
  %621 = icmp ult i32 %a181, 15
  %622 = select i1 %621, i32 %a181, i32 15
  %output.s0.y.min_3.s = add nuw nsw i32 %622, %output.s0.y.yi.yi
  br label %"assert succeeded9"

"end for output.s0.y.yi.yii.yii":                 ; preds = %"end for output.s0.y.yi.yii.yiii"
  br i1 %147, label %destructor_block.thread, label %"for output.s0.y.yi.yi"

"assert failed8":                                 ; preds = %"for output.s0.y.yi.yii.yii.preheader"
  store i64 %586, i64* %.fca.1.gep13, align 8, !tbaa !375
  store i8* %585, i8** %.fca.0.gep12, align 8, !tbaa !377
  store i64 %.lcssa127, i64* %.fca.1.gep15, align 8, !tbaa !375
  store i8* %.lcssa119130, i8** %.fca.0.gep14, align 8, !tbaa !377
  %623 = icmp sgt i32 %93, 0
  %624 = select i1 %623, i32 %93, i32 0
  %625 = shl nuw i32 %624, 1
  %626 = zext i32 %625 to i64
  %627 = tail call i32 @halide_error_buffer_allocation_too_large(i8* %__user_context, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.211, i64 0, i64 0), i64 %626, i64 2147483647) #10
  br label %133

"assert succeeded9":                              ; preds = %"for output.s0.y.yi.yii.yii", %"for output.s0.y.yi.yii.yii.preheader"
  %628 = phi i8* [ %637, %"for output.s0.y.yi.yii.yii" ], [ %.lcssa119130, %"for output.s0.y.yi.yii.yii.preheader" ]
  %629 = phi i64 [ %638, %"for output.s0.y.yi.yii.yii" ], [ %.lcssa127, %"for output.s0.y.yi.yii.yii.preheader" ]
  %output.s0.y.min_3.s85 = phi i32 [ %output.s0.y.min_3.s, %"for output.s0.y.yi.yii.yii" ], [ %output.s0.y.yi.yi, %"for output.s0.y.yi.yii.yii.preheader" ]
  %630 = phi i32 [ %622, %"for output.s0.y.yi.yii.yii" ], [ 0, %"for output.s0.y.yi.yii.yii.preheader" ]
  %output.s0.y.yi.yii.yii84 = phi i32 [ %699, %"for output.s0.y.yi.yii.yii" ], [ 0, %"for output.s0.y.yi.yii.yii.preheader" ]
  %631 = icmp ult i64 %629, %98
  br i1 %631, label %632, label %pseudostack_alloc.exit40, !prof !383

632:                                              ; preds = %"assert succeeded9"
  %633 = icmp eq i8* %628, null
  br i1 %633, label %635, label %634

634:                                              ; preds = %632
  tail call void @halide_free(i8* %__user_context, i8* nonnull %628) #12
  br label %635

635:                                              ; preds = %634, %632
  %636 = tail call i8* @halide_malloc(i8* %__user_context, i64 %98) #12
  br label %pseudostack_alloc.exit40

pseudostack_alloc.exit40:                         ; preds = %635, %"assert succeeded9"
  %637 = phi i8* [ %636, %635 ], [ %628, %"assert succeeded9" ]
  %638 = phi i64 [ %98, %635 ], [ %629, %"assert succeeded9" ]
  %t751 = add nsw i32 %output.s0.y.min_3.s85, %36
  br i1 %94, label %"for min_y.s0.y.rebased.us", label %"for output.s0.y.yi.yii.yiii.preheader", !prof !374

"for min_y.s0.y.rebased.us":                      ; preds = %"end for min_y.s0.x.x.loopexit.us", %pseudostack_alloc.exit40
  %.not24.us = phi i1 [ true, %"end for min_y.s0.x.x.loopexit.us" ], [ false, %pseudostack_alloc.exit40 ]
  %min_y.s0.y.rebased.us = phi i32 [ 1, %"end for min_y.s0.x.x.loopexit.us" ], [ 0, %pseudostack_alloc.exit40 ]
  %t753.us = mul nuw nsw i32 %min_y.s0.y.rebased.us, %93
  %t752.us = add nsw i32 %t751, %min_y.s0.y.rebased.us
  %b190.us = sext i32 %t752.us to i64
  %639 = icmp sgt i64 %b190.us, %a161
  %a187.us = select i1 %639, i64 %a161, i64 %b190.us
  %640 = icmp sgt i64 %a187.us, 1
  %641 = select i1 %640, i64 %a187.us, i64 1
  %642 = sub nsw i64 %641, %84
  %643 = mul nsw i64 %642, %86
  %.not29.us = icmp sgt i32 %b250, %t752.us
  %a190.us = select i1 %.not29.us, i64 %b190.us, i64 %a164
  %644 = icmp sgt i64 %a190.us, 0
  %645 = select i1 %644, i64 %a190.us, i64 0
  %646 = sub nsw i64 %645, %84
  %647 = mul nsw i64 %646, %86
  %a193.us = add nsw i64 %b190.us, 2
  %648 = icmp slt i64 %a193.us, %a161
  %a192.us = select i1 %648, i64 %a193.us, i64 %a161
  %649 = icmp sgt i64 %a192.us, 1
  %650 = select i1 %649, i64 %a192.us, i64 1
  %651 = sub nsw i64 %650, %84
  %652 = mul nsw i64 %651, %86
  %653 = sext i32 %t753.us to i64
  br label %"for min_y.s0.x.x.us"

"for min_y.s0.x.x.us":                            ; preds = %"for min_y.s0.x.x.us", %"for min_y.s0.y.rebased.us"
  %indvars.iv109 = phi i64 [ 0, %"for min_y.s0.y.rebased.us" ], [ %indvars.iv.next110, %"for min_y.s0.x.x.us" ]
  %654 = shl nuw nsw i64 %indvars.iv109, 5
  %655 = add nsw i64 %654, %95
  %656 = add i64 %655, %643
  %657 = getelementptr inbounds i8, i8* %120, i64 %656
  %658 = bitcast i8* %657 to <32 x i8>*
  %a186.us = load <32 x i8>, <32 x i8>* %658, align 1, !tbaa !381
  %659 = add nsw i64 %654, %647
  %660 = getelementptr inbounds i8, i8* %74, i64 %659
  %661 = bitcast i8* %660 to <32 x i8>*
  %a189.us = load <32 x i8>, <32 x i8>* %661, align 32, !tbaa !381
  %662 = add i64 %655, %652
  %663 = getelementptr inbounds i8, i8* %121, i64 %662
  %664 = bitcast i8* %663 to <32 x i8>*
  %b191.us = load <32 x i8>, <32 x i8>* %664, align 1, !tbaa !381
  %665 = icmp ugt <32 x i8> %b191.us, %a189.us
  %b188.us = select <32 x i1> %665, <32 x i8> %a189.us, <32 x i8> %b191.us
  %666 = icmp ugt <32 x i8> %b188.us, %a186.us
  %667 = select <32 x i1> %666, <32 x i8> %a186.us, <32 x i8> %b188.us
  %668 = add nsw i64 %654, %653
  %669 = getelementptr inbounds i8, i8* %637, i64 %668
  %670 = bitcast i8* %669 to <32 x i8>*
  store <32 x i8> %667, <32 x i8>* %670, align 32, !tbaa !386
  %indvars.iv.next110 = add nuw nsw i64 %indvars.iv109, 1
  %.not30.us = icmp eq i64 %indvars.iv.next110, %112
  br i1 %.not30.us, label %"end for min_y.s0.x.x.loopexit.us", label %"for min_y.s0.x.x.us"

"end for min_y.s0.x.x.loopexit.us":               ; preds = %"for min_y.s0.x.x.us"
  br i1 %.not24.us, label %"for output.s0.y.yi.yii.yiii.preheader", label %"for min_y.s0.y.rebased.us"

"for output.s0.y.yi.yii.yiii.preheader":          ; preds = %"end for min_y.s0.x.x.loopexit.us", %pseudostack_alloc.exit40
  br label %"for output.s0.y.yi.yii.yiii"

"for output.s0.y.yi.yii.yiii":                    ; preds = %after_bb, %"for output.s0.y.yi.yii.yiii.preheader"
  %.not25 = phi i1 [ true, %after_bb ], [ false, %"for output.s0.y.yi.yii.yiii.preheader" ]
  %output.s0.y.yi.yii.yiii = phi i32 [ 1, %after_bb ], [ 0, %"for output.s0.y.yi.yii.yiii.preheader" ]
  %output.s0.y.yi = add nuw nsw i32 %output.s0.y.yi.yii.yiii, %output.s0.y.min_3.s85
  %b208 = add nsw i32 %output.s0.y.yi, %36
  %671 = icmp sgt i32 %a55, %b208
  %a195 = select i1 %671, i32 %b208, i32 %a55
  %672 = icmp sgt i32 %a195, 0
  %673 = select i1 %672, i32 %a195, i32 0
  %674 = sub nsw i32 %673, %bounded_input.y.min_realized
  %t765 = mul nsw i32 %674, %93
  %675 = add nuw nsw i32 %output.s0.y.yi.yii.yiii, %630
  %t758 = mul nsw i32 %675, %93
  %a200 = add nsw i32 %b208, 2
  %676 = icmp sgt i32 %b250, %a200
  %a199 = select i1 %676, i32 %a200, i32 %b250
  %677 = icmp sgt i32 %a199, 1
  %678 = select i1 %677, i32 %a199, i32 1
  %679 = sub nsw i32 %678, %bounded_input.y.min_realized
  %680 = mul nsw i32 %679, %93
  %681 = icmp sgt i32 %b208, %b250
  %a203 = select i1 %681, i32 %b250, i32 %b208
  %682 = icmp sgt i32 %a203, 1
  %683 = select i1 %682, i32 %a203, i32 1
  %684 = sub nsw i32 %683, %bounded_input.y.min_realized
  %685 = mul nsw i32 %684, %93
  br i1 %99, label %"for output.s0.x.x.preheader", label %"end for output.s0.x.x", !prof !374

"for output.s0.x.x.preheader":                    ; preds = %"for output.s0.y.yi.yii.yiii"
  %t759 = mul nuw nsw i32 %output.s0.y.yi.yii.yiii, %93
  %686 = mul nsw i32 %b208, %output.stride.1
  %t766 = add nsw i32 %686, %t692
  %687 = sub nsw i32 %683, %57
  %688 = mul nsw i32 %687, %93
  %t760 = add nsw i32 %688, %t699
  %689 = sub nsw i32 %678, %57
  %690 = mul nsw i32 %689, %93
  %t762 = add nsw i32 %690, %t699
  %691 = sub nsw i32 %673, %57
  %t761 = mul nsw i32 %691, %93
  %692 = sext i32 %t760 to i64
  %693 = sext i32 %t761 to i64
  %694 = sext i32 %t762 to i64
  %695 = sext i32 %t766 to i64
  %696 = sext i32 %t765 to i64
  %697 = sext i32 %t759 to i64
  %698 = sext i32 %t758 to i64
  br label %"for output.s0.x.x"

"end for output.s0.y.yi.yii.yiii":                ; preds = %after_bb
  %699 = add nuw nsw i32 %output.s0.y.yi.yii.yii84, 1
  %.not26 = icmp eq i32 %699, 9
  br i1 %.not26, label %"end for output.s0.y.yi.yii.yii", label %"for output.s0.y.yi.yii.yii"

"for output.s0.x.x":                              ; preds = %"for output.s0.x.x", %"for output.s0.x.x.preheader"
  %indvars.iv111 = phi i64 [ 0, %"for output.s0.x.x.preheader" ], [ %indvars.iv.next112, %"for output.s0.x.x" ]
  %700 = shl nsw i64 %indvars.iv111, 5
  %701 = add nsw i64 %700, %698
  %702 = getelementptr inbounds i8, i8* %585, i64 %701
  %703 = bitcast i8* %702 to <32 x i8>*
  %a207 = load <32 x i8>, <32 x i8>* %703, align 32, !tbaa !384
  %704 = getelementptr inbounds i8, i8* %702, i64 1
  %705 = bitcast i8* %704 to <32 x i8>*
  %a208 = load <32 x i8>, <32 x i8>* %705, align 1, !tbaa !384
  %706 = getelementptr inbounds i8, i8* %702, i64 2
  %707 = bitcast i8* %706 to <32 x i8>*
  %b210 = load <32 x i8>, <32 x i8>* %707, align 2, !tbaa !384
  %708 = icmp ugt <32 x i8> %b210, %a208
  %b209 = select <32 x i1> %708, <32 x i8> %a208, <32 x i8> %b210
  %709 = icmp ugt <32 x i8> %b209, %a207
  %710 = select <32 x i1> %709, <32 x i8> %a207, <32 x i8> %b209
  %711 = add nsw i64 %700, %697
  %712 = getelementptr inbounds i8, i8* %637, i64 %711
  %713 = bitcast i8* %712 to <32 x i8>*
  %a209 = load <32 x i8>, <32 x i8>* %713, align 32, !tbaa !386
  %714 = getelementptr inbounds i8, i8* %712, i64 1
  %715 = bitcast i8* %714 to <32 x i8>*
  %a210 = load <32 x i8>, <32 x i8>* %715, align 1, !tbaa !386
  %716 = getelementptr inbounds i8, i8* %712, i64 2
  %717 = bitcast i8* %716 to <32 x i8>*
  %b212 = load <32 x i8>, <32 x i8>* %717, align 2, !tbaa !386
  %718 = icmp ugt <32 x i8> %a210, %b212
  %b211 = select <32 x i1> %718, <32 x i8> %a210, <32 x i8> %b212
  %719 = icmp ugt <32 x i8> %a209, %b211
  %b232 = select <32 x i1> %719, <32 x i8> %a209, <32 x i8> %b211
  %720 = add nsw i64 %700, %692
  %721 = getelementptr inbounds i8, i8* %122, i64 %720
  %722 = bitcast i8* %721 to <32 x i8>*
  %a214 = load <32 x i8>, <32 x i8>* %722, align 1, !tbaa !381
  %723 = add nsw i64 %700, %693
  %724 = getelementptr inbounds i8, i8* %74, i64 %723
  %725 = bitcast i8* %724 to <32 x i8>*
  %b216 = load <32 x i8>, <32 x i8>* %725, align 32, !tbaa !381
  %726 = add nsw i64 %700, %694
  %727 = getelementptr inbounds i8, i8* %123, i64 %726
  %728 = bitcast i8* %727 to <32 x i8>*
  %a212 = load <32 x i8>, <32 x i8>* %728, align 1, !tbaa !381
  %729 = icmp ugt <32 x i8> %a214, %b216
  %b214 = select <32 x i1> %729, <32 x i8> %a214, <32 x i8> %b216
  %730 = icmp ugt <32 x i8> %b214, %a212
  %a211 = select <32 x i1> %730, <32 x i8> %a212, <32 x i8> %b214
  %731 = icmp ugt <32 x i8> %b216, %a214
  %b213 = select <32 x i1> %731, <32 x i8> %a214, <32 x i8> %b216
  %732 = icmp ugt <32 x i8> %a211, %b213
  %a229 = select <32 x i1> %732, <32 x i8> %a211, <32 x i8> %b213
  %733 = trunc i64 %700 to i32
  %t763 = add i32 %t699, %733
  %t608 = add i32 %t763, %680
  %t609 = add i32 %t763, %685
  %734 = sext i32 %t609 to i64
  %735 = getelementptr inbounds i8, i8* %74, i64 %734
  %736 = getelementptr inbounds i8, i8* %735, i64 -31
  %737 = bitcast i8* %736 to <32 x i8>*
  %a218 = load <32 x i8>, <32 x i8>* %737, align 1, !tbaa !381
  %738 = add nsw i64 %700, %696
  %739 = getelementptr inbounds i8, i8* %74, i64 %738
  %740 = getelementptr inbounds i8, i8* %739, i64 1
  %741 = bitcast i8* %740 to <32 x i8>*
  %b220 = load <32 x i8>, <32 x i8>* %741, align 1, !tbaa !381
  %742 = sext i32 %t608 to i64
  %743 = getelementptr inbounds i8, i8* %74, i64 %742
  %744 = getelementptr inbounds i8, i8* %743, i64 -31
  %745 = bitcast i8* %744 to <32 x i8>*
  %a216 = load <32 x i8>, <32 x i8>* %745, align 1, !tbaa !381
  %746 = icmp ugt <32 x i8> %a218, %b220
  %b218 = select <32 x i1> %746, <32 x i8> %a218, <32 x i8> %b220
  %747 = icmp ugt <32 x i8> %b218, %a216
  %a215 = select <32 x i1> %747, <32 x i8> %a216, <32 x i8> %b218
  %748 = icmp ugt <32 x i8> %b220, %a218
  %b217 = select <32 x i1> %748, <32 x i8> %a218, <32 x i8> %b220
  %749 = icmp ugt <32 x i8> %a215, %b217
  %b231 = select <32 x i1> %749, <32 x i8> %a215, <32 x i8> %b217
  %750 = getelementptr inbounds i8, i8* %735, i64 -30
  %751 = bitcast i8* %750 to <32 x i8>*
  %a228 = load <32 x i8>, <32 x i8>* %751, align 1, !tbaa !381
  %752 = getelementptr inbounds i8, i8* %739, i64 2
  %753 = bitcast i8* %752 to <32 x i8>*
  %b230 = load <32 x i8>, <32 x i8>* %753, align 2, !tbaa !381
  %754 = icmp ugt <32 x i8> %710, %b232
  %a220 = select <32 x i1> %754, <32 x i8> %710, <32 x i8> %b232
  %755 = icmp ugt <32 x i8> %a229, %b231
  %a223 = select <32 x i1> %755, <32 x i8> %a229, <32 x i8> %b231
  %756 = getelementptr inbounds i8, i8* %743, i64 -30
  %757 = bitcast i8* %756 to <32 x i8>*
  %a226 = load <32 x i8>, <32 x i8>* %757, align 1, !tbaa !381
  %758 = icmp ugt <32 x i8> %a228, %b230
  %b228 = select <32 x i1> %758, <32 x i8> %a228, <32 x i8> %b230
  %759 = icmp ugt <32 x i8> %b228, %a226
  %a225 = select <32 x i1> %759, <32 x i8> %a226, <32 x i8> %b228
  %760 = icmp ugt <32 x i8> %b230, %a228
  %b227 = select <32 x i1> %760, <32 x i8> %a228, <32 x i8> %b230
  %761 = icmp ugt <32 x i8> %a225, %b227
  %b225 = select <32 x i1> %761, <32 x i8> %a225, <32 x i8> %b227
  %762 = icmp ugt <32 x i8> %b225, %a223
  %a222 = select <32 x i1> %762, <32 x i8> %a223, <32 x i8> %b225
  %763 = icmp ugt <32 x i8> %b231, %a229
  %b224 = select <32 x i1> %763, <32 x i8> %a229, <32 x i8> %b231
  %764 = icmp ugt <32 x i8> %a222, %b224
  %b222 = select <32 x i1> %764, <32 x i8> %a222, <32 x i8> %b224
  %765 = icmp ugt <32 x i8> %b222, %a220
  %a219 = select <32 x i1> %765, <32 x i8> %a220, <32 x i8> %b222
  %766 = icmp ugt <32 x i8> %b232, %710
  %b221 = select <32 x i1> %766, <32 x i8> %710, <32 x i8> %b232
  %767 = icmp ugt <32 x i8> %a219, %b221
  %768 = select <32 x i1> %767, <32 x i8> %a219, <32 x i8> %b221
  %769 = add nsw i64 %700, %695
  %770 = getelementptr inbounds i8, i8* %output, i64 %769
  %771 = bitcast i8* %770 to <32 x i8>*
  store <32 x i8> %768, <32 x i8>* %771, align 1, !tbaa !388
  %indvars.iv.next112 = add nuw nsw i64 %indvars.iv111, 1
  %.not28 = icmp eq i64 %indvars.iv.next112, %114
  br i1 %.not28, label %"end for output.s0.x.x", label %"for output.s0.x.x"

"end for output.s0.x.x":                          ; preds = %"for output.s0.x.x", %"for output.s0.y.yi.yii.yiii"
  br i1 %t693, label %"produce minmax_x10", label %after_bb

after_bb:                                         ; preds = %"produce minmax_x10", %"end for output.s0.x.x"
  br i1 %.not25, label %"end for output.s0.y.yi.yii.yiii", label %"for output.s0.y.yi.yii.yiii"

"produce minmax_x10":                             ; preds = %"end for output.s0.x.x"
  %t678 = add nsw i32 %t758, %b139
  %772 = sext i32 %t678 to i64
  %773 = getelementptr inbounds i8, i8* %585, i64 %772
  %774 = getelementptr inbounds i8, i8* %773, i64 -32
  %775 = bitcast i8* %774 to <32 x i8>*
  %a231 = load <32 x i8>, <32 x i8>* %775, align 1, !tbaa !384
  %776 = getelementptr inbounds i8, i8* %773, i64 -31
  %777 = bitcast i8* %776 to <32 x i8>*
  %a232 = load <32 x i8>, <32 x i8>* %777, align 1, !tbaa !384
  %778 = getelementptr inbounds i8, i8* %773, i64 -30
  %779 = bitcast i8* %778 to <32 x i8>*
  %b234 = load <32 x i8>, <32 x i8>* %779, align 1, !tbaa !384
  %780 = icmp ugt <32 x i8> %b234, %a232
  %b233 = select <32 x i1> %780, <32 x i8> %a232, <32 x i8> %b234
  %781 = icmp ugt <32 x i8> %b233, %a231
  %782 = select <32 x i1> %781, <32 x i8> %a231, <32 x i8> %b233
  %783 = zext i32 %output.s0.y.yi.yii.yiii to i64
  %784 = mul nuw nsw i64 %86, %783
  %785 = add nsw i64 %784, %100
  %786 = getelementptr inbounds i8, i8* %637, i64 %785
  %787 = getelementptr inbounds i8, i8* %786, i64 -32
  %788 = bitcast i8* %787 to <32 x i8>*
  %a233 = load <32 x i8>, <32 x i8>* %788, align 1, !tbaa !386
  %789 = getelementptr inbounds i8, i8* %786, i64 -31
  %790 = bitcast i8* %789 to <32 x i8>*
  %a234 = load <32 x i8>, <32 x i8>* %790, align 1, !tbaa !386
  %791 = getelementptr inbounds i8, i8* %786, i64 -30
  %792 = bitcast i8* %791 to <32 x i8>*
  %b236 = load <32 x i8>, <32 x i8>* %792, align 1, !tbaa !386
  %793 = icmp ugt <32 x i8> %a234, %b236
  %b235 = select <32 x i1> %793, <32 x i8> %a234, <32 x i8> %b236
  %794 = icmp ugt <32 x i8> %a233, %b235
  %b268 = select <32 x i1> %794, <32 x i8> %a233, <32 x i8> %b235
  %795 = zext i32 %output.s0.y.yi to i64
  %a236 = add nsw i64 %795, %101
  %796 = icmp slt i64 %a236, %a161
  %a235 = select i1 %796, i64 %a236, i64 %a161
  %797 = icmp sgt i64 %a235, 1
  %798 = select i1 %797, i64 %a235, i64 1
  %799 = sub nsw i64 %798, %102
  %800 = mul nsw i64 %799, %86
  %801 = add nsw i64 %800, %103
  %802 = getelementptr inbounds i8, i8* %124, i64 %801
  %803 = bitcast i8* %802 to <32 x i8>*
  %a244 = load <32 x i8>, <32 x i8>* %803, align 1, !tbaa !381
  %804 = icmp sgt i64 %a164, %a236
  %a237 = select i1 %804, i64 %a236, i64 %a164
  %805 = icmp sgt i64 %a237, 0
  %806 = select i1 %805, i64 %a237, i64 0
  %807 = sub nsw i64 %806, %102
  %808 = mul nsw i64 %807, %86
  %809 = add nsw i64 %808, %100
  %810 = getelementptr inbounds i8, i8* %125, i64 %809
  %811 = bitcast i8* %810 to <32 x i8>*
  %b246 = load <32 x i8>, <32 x i8>* %811, align 1, !tbaa !381
  %a242 = add nsw i64 %a236, 2
  %812 = icmp slt i64 %a242, %a161
  %a241 = select i1 %812, i64 %a242, i64 %a161
  %813 = icmp sgt i64 %a241, 1
  %814 = select i1 %813, i64 %a241, i64 1
  %815 = sub nsw i64 %814, %102
  %816 = mul nsw i64 %815, %86
  %817 = add nsw i64 %816, %103
  %818 = getelementptr inbounds i8, i8* %126, i64 %817
  %819 = bitcast i8* %818 to <32 x i8>*
  %a240 = load <32 x i8>, <32 x i8>* %819, align 1, !tbaa !381
  %820 = icmp ugt <32 x i8> %a244, %b246
  %b242 = select <32 x i1> %820, <32 x i8> %a244, <32 x i8> %b246
  %821 = icmp ugt <32 x i8> %b242, %a240
  %a239 = select <32 x i1> %821, <32 x i8> %a240, <32 x i8> %b242
  %822 = icmp ugt <32 x i8> %b246, %a244
  %b241 = select <32 x i1> %822, <32 x i8> %a244, <32 x i8> %b246
  %823 = icmp ugt <32 x i8> %a239, %b241
  %a265 = select <32 x i1> %823, <32 x i8> %a239, <32 x i8> %b241
  %t629 = add nsw i32 %680, %104
  %t630 = add nsw i32 %685, %104
  %824 = sext i32 %t630 to i64
  %825 = getelementptr inbounds i8, i8* %74, i64 %824
  %826 = getelementptr inbounds i8, i8* %825, i64 -63
  %827 = bitcast i8* %826 to <32 x i8>*
  %a254 = load <32 x i8>, <32 x i8>* %827, align 1, !tbaa !381
  %828 = sext i32 %t765 to i64
  %829 = add nsw i64 %828, %100
  %830 = getelementptr inbounds i8, i8* %74, i64 %829
  %831 = getelementptr inbounds i8, i8* %830, i64 -31
  %832 = bitcast i8* %831 to <32 x i8>*
  %b256 = load <32 x i8>, <32 x i8>* %832, align 1, !tbaa !381
  %833 = sext i32 %t629 to i64
  %834 = getelementptr inbounds i8, i8* %74, i64 %833
  %835 = getelementptr inbounds i8, i8* %834, i64 -63
  %836 = bitcast i8* %835 to <32 x i8>*
  %a252 = load <32 x i8>, <32 x i8>* %836, align 1, !tbaa !381
  %837 = icmp ugt <32 x i8> %a254, %b256
  %b254 = select <32 x i1> %837, <32 x i8> %a254, <32 x i8> %b256
  %838 = icmp ugt <32 x i8> %b254, %a252
  %a251 = select <32 x i1> %838, <32 x i8> %a252, <32 x i8> %b254
  %839 = icmp ugt <32 x i8> %b256, %a254
  %b253 = select <32 x i1> %839, <32 x i8> %a254, <32 x i8> %b256
  %840 = icmp ugt <32 x i8> %a251, %b253
  %b267 = select <32 x i1> %840, <32 x i8> %a251, <32 x i8> %b253
  %841 = getelementptr inbounds i8, i8* %825, i64 -62
  %842 = bitcast i8* %841 to <32 x i8>*
  %a264 = load <32 x i8>, <32 x i8>* %842, align 1, !tbaa !381
  %843 = getelementptr inbounds i8, i8* %830, i64 -30
  %844 = bitcast i8* %843 to <32 x i8>*
  %b266 = load <32 x i8>, <32 x i8>* %844, align 1, !tbaa !381
  %845 = icmp ugt <32 x i8> %782, %b268
  %a256 = select <32 x i1> %845, <32 x i8> %782, <32 x i8> %b268
  %846 = icmp ugt <32 x i8> %a265, %b267
  %a259 = select <32 x i1> %846, <32 x i8> %a265, <32 x i8> %b267
  %847 = getelementptr inbounds i8, i8* %834, i64 -62
  %848 = bitcast i8* %847 to <32 x i8>*
  %a262 = load <32 x i8>, <32 x i8>* %848, align 1, !tbaa !381
  %849 = icmp ugt <32 x i8> %a264, %b266
  %b264 = select <32 x i1> %849, <32 x i8> %a264, <32 x i8> %b266
  %850 = icmp ugt <32 x i8> %b264, %a262
  %a261 = select <32 x i1> %850, <32 x i8> %a262, <32 x i8> %b264
  %851 = icmp ugt <32 x i8> %b266, %a264
  %b263 = select <32 x i1> %851, <32 x i8> %a264, <32 x i8> %b266
  %852 = icmp ugt <32 x i8> %a261, %b263
  %b261 = select <32 x i1> %852, <32 x i8> %a261, <32 x i8> %b263
  %853 = icmp ugt <32 x i8> %b261, %a259
  %a258 = select <32 x i1> %853, <32 x i8> %a259, <32 x i8> %b261
  %854 = icmp ugt <32 x i8> %b267, %a265
  %b260 = select <32 x i1> %854, <32 x i8> %a265, <32 x i8> %b267
  %855 = icmp ugt <32 x i8> %a258, %b260
  %b258 = select <32 x i1> %855, <32 x i8> %a258, <32 x i8> %b260
  %856 = icmp ugt <32 x i8> %b258, %a256
  %a255 = select <32 x i1> %856, <32 x i8> %a256, <32 x i8> %b258
  %857 = icmp ugt <32 x i8> %b268, %782
  %b257 = select <32 x i1> %857, <32 x i8> %782, <32 x i8> %b268
  %858 = icmp ugt <32 x i8> %a255, %b257
  %859 = select <32 x i1> %858, <32 x i8> %a255, <32 x i8> %b257
  %860 = mul nsw i64 %a236, %105
  %861 = add nsw i64 %860, %106
  %862 = getelementptr inbounds i8, i8* %127, i64 %861
  %863 = bitcast i8* %862 to <32 x i8>*
  store <32 x i8> %859, <32 x i8>* %863, align 1, !tbaa !388
  br label %after_bb
}

; Function Attrs: nounwind
define i32 @median3x3_batch_0056_sample_0026_argv(i8** nocapture readonly %0) local_unnamed_addr #10 {
entry:
  ...
  %6 = tail call i32 @median3x3_batch_0056_sample_0026(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #14
  ret i32 %6
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @median3x3_batch_0056_sample_0026_metadata() local_unnamed_addr #11 {
entry:
  ret %struct.halide_filter_metadata_t* @median3x3_batch_0056_sample_0026_metadata_storage
}
