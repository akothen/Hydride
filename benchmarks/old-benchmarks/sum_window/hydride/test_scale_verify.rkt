...
(define test-scale-row 9)
(define test-scale-col 7)
...
(displayln "Sum Window on Large inputs")
(print-mat (sum large-image test-scale-row test-scale-col 3 3 8) (- test-scale-row 2) (- test-scale-col 2) 8)
...
(define spec-res (sum sym_arg0 test-scale-row test-scale-col 3 3 8))
