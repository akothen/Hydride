...
(define slide_slice_0 (vec-shuffle-ext-special row_0 (lit (bv 0 (bitvector 48))) 6 1 3 ))
(define slide_slice_1 (vec-shuffle-ext-special row_1 (lit (bv 0 (bitvector 48))) 6 1 3 ))
(define slide_slice_2 (vec-shuffle-ext-special row_2 (lit (bv 0 (bitvector 48))) 6 1 3 ))
(define slide_slice_3 (vec-shuffle-ext-special row_3 (lit (bv 0 (bitvector 48))) 6 1 3 ))
(define slide_slice_4 (vec-shuffle-ext-special row_4 (lit (bv 0 (bitvector 48))) 6 1 3 ))
(define slide_slice_5 (vec-shuffle-ext-special row_5 (lit (bv 0 (bitvector 48))) 6 1 3 ))
...
(define avg_slide_red_0 (vec-div slide_red_0 (lit (bv 3 (bitvector 8)) )))
(define avg_slide_red_1 (vec-div slide_red_1 (lit (bv 3 (bitvector 8)) )))
(define avg_slide_red_2 (vec-div slide_red_2 (lit (bv 3 (bitvector 8)) )))
(define avg_slide_red_3 (vec-div slide_red_3 (lit (bv 3 (bitvector 8)) )))
(define avg_slide_red_4 (vec-div slide_red_4 (lit (bv 3 (bitvector 8)) )))
(define avg_slide_red_5 (vec-div slide_red_5 (lit (bv 3 (bitvector 8)) )))
...
(define final_val_0_1 (vec-div s1_comb_0_red (lit (bv 3 (bitvector 8)))))
...
(define final_val_1_1 (vec-div s1_comb_1_red (lit (bv 3 (bitvector 8)))))
...
(define final_val_2_1 (vec-div s1_comb_2_red (lit (bv 3 (bitvector 8)))))
...
(define final_val_3_1 (vec-div s1_comb_3_red (lit (bv 3 (bitvector 8)))))



(define slide2_slice_0 (vec-shuffle-ext-special row_0 (lit (bv 0 (bitvector 48))) 6 2 3 ))
(define slide2_slice_1 (vec-shuffle-ext-special row_1 (lit (bv 0 (bitvector 48))) 6 2 3 ))
(define slide2_slice_2 (vec-shuffle-ext-special row_2 (lit (bv 0 (bitvector 48))) 6 2 3 ))
(define slide2_slice_3 (vec-shuffle-ext-special row_3 (lit (bv 0 (bitvector 48))) 6 2 3 ))
(define slide2_slice_4 (vec-shuffle-ext-special row_4 (lit (bv 0 (bitvector 48))) 6 2 3 ))
(define slide2_slice_5 (vec-shuffle-ext-special row_5 (lit (bv 0 (bitvector 48))) 6 2 3 ))
...
(define avg_slide2_red_0 (vec-div slide2_red_0 (lit (bv 3 (bitvector 8)) )))
(define avg_slide2_red_1 (vec-div slide2_red_1 (lit (bv 3 (bitvector 8)) )))
(define avg_slide2_red_2 (vec-div slide2_red_2 (lit (bv 3 (bitvector 8)) )))
(define avg_slide2_red_3 (vec-div slide2_red_3 (lit (bv 3 (bitvector 8)) )))
(define avg_slide2_red_4 (vec-div slide2_red_4 (lit (bv 3 (bitvector 8)) )))
(define avg_slide2_red_5 (vec-div slide2_red_5 (lit (bv 3 (bitvector 8)) )))
...
(define final_val_0_2 (vec-div s2_comb_0_red (lit (bv 3 (bitvector 8)))))
...
(define final_val_1_2 (vec-div s2_comb_1_red (lit (bv 3 (bitvector 8)))))
...
(define final_val_2_2 (vec-div s2_comb_2_red (lit (bv 3 (bitvector 8)))))
...
(define final_val_3_2 (vec-div s2_comb_3_red (lit (bv 3 (bitvector 8)))))

;;3rd  idx column

(define slide3_slice_0 (vec-shuffle-ext-special row_0 (lit (bv 0 (bitvector 48))) 6 3 3 ))
(define slide3_slice_1 (vec-shuffle-ext-special row_1 (lit (bv 0 (bitvector 48))) 6 3 3 ))
(define slide3_slice_2 (vec-shuffle-ext-special row_2 (lit (bv 0 (bitvector 48))) 6 3 3 ))
(define slide3_slice_3 (vec-shuffle-ext-special row_3 (lit (bv 0 (bitvector 48))) 6 3 3 ))
(define slide3_slice_4 (vec-shuffle-ext-special row_4 (lit (bv 0 (bitvector 48))) 6 3 3 ))
(define slide3_slice_5 (vec-shuffle-ext-special row_5 (lit (bv 0 (bitvector 48))) 6 3 3 ))
...
(define avg_slide3_red_0 (vec-div slide3_red_0 (lit (bv 3 (bitvector 8)) )))
(define avg_slide3_red_1 (vec-div slide3_red_1 (lit (bv 3 (bitvector 8)) )))
(define avg_slide3_red_2 (vec-div slide3_red_2 (lit (bv 3 (bitvector 8)) )))
(define avg_slide3_red_3 (vec-div slide3_red_3 (lit (bv 3 (bitvector 8)) )))
(define avg_slide3_red_4 (vec-div slide3_red_4 (lit (bv 3 (bitvector 8)) )))
(define avg_slide3_red_5 (vec-div slide3_red_5 (lit (bv 3 (bitvector 8)) )))
...
(define final_val_0_3 (vec-div s3_comb_0_red (lit (bv 3 (bitvector 8)))))
...
(define final_val_1_3 (vec-div s3_comb_1_red (lit (bv 3 (bitvector 8)))))
...
(define final_val_2_3 (vec-div s3_comb_2_red (lit (bv 3 (bitvector 8)))))
...
(define final_val_3_3 (vec-div s3_comb_3_red (lit (bv 3 (bitvector 8)))))
...
(define slice_6 (vec-load (reg 0) 288 18 6 8)) ; Row 3
...
(define extended_slice_0 (vec-shuffle-special slice_0 (lit (bv 0 (bitvector 24)))))
(define extended_slice_1 (vec-shuffle-special slice_1 (lit (bv 0 (bitvector 24)))))
(define extended_slice_2 (vec-shuffle-special slice_2 (lit (bv 0 (bitvector 24)))))
(define extended_slice_3 (vec-shuffle-special slice_3 (lit (bv 0 (bitvector 24)))))

(define extended_slice_4 (vec-shuffle-special slice_4 (lit (bv 0 (bitvector 24)))))
(define extended_slice_5 (vec-shuffle-special slice_5 (lit (bv 0 (bitvector 24)))))
(define extended_slice_6 (vec-shuffle-special slice_6 (lit (bv 0 (bitvector 24)))))
(define extended_slice_7 (vec-shuffle-special slice_7 (lit (bv 0 (bitvector 24)))))

(define extended_slice_8 (vec-shuffle-special slice_8 (lit (bv 0 (bitvector 24)))))
(define extended_slice_9 (vec-shuffle-special slice_9 (lit (bv 0 (bitvector 24)))))
(define extended_slice_10 (vec-shuffle-special slice_10 (lit (bv 0 (bitvector 24)))))
(define extended_slice_11 (vec-shuffle-special slice_11 (lit (bv 0 (bitvector 24)))))
