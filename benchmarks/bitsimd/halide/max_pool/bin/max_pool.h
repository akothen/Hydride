#ifndef HALIDE__max_pool___bin___max_pool_h
#define HALIDE__max_pool___bin___max_pool_h
#include <stdint.h>
...
int max_pool(struct halide_buffer_t *_input_buffer, int32_t _stride_x, int32_t _stride_y, int32_t _filter_width, int32_t _filter_height, int32_t _output_min, int32_t _output_max, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int max_pool_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *max_pool_metadata();
