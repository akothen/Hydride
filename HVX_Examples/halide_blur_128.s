...
.Lfunc_end119:
	.size	_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv, .Lfunc_end119-_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv
                                        // -- End function
	.section	.text.halide_blur_128,"ax",@progbits
	.globl	halide_blur_128         // -- Begin function halide_blur_128
	.balign 32
	.type	halide_blur_128,@function
halide_blur_128:                        // @halide_blur_128
// %bb.0:                               // %entry
	{
		r7 = #0
		r3 = #256
	...
	{
		r1 = add(pc,##halide_blur_128.par_for.blur_y.s0.y.y@PCREL)
		r0 = #0
		r2 = #0
	}
	{
...
.Lfunc_end120:
	.size	halide_blur_128, .Lfunc_end120-halide_blur_128
                                        // -- End function
	.section	.text.halide_blur_128.par_for.blur_y.s0.y.y,"ax",@progbits
	.balign 32                      // -- Begin function halide_blur_128.par_for.blur_y.s0.y.y
	.type	halide_blur_128.par_for.blur_y.s0.y.y,@function
halide_blur_128.par_for.blur_y.s0.y.y:  // @halide_blur_128.par_for.blur_y.s0.y.y
// %bb.0:                               // %entry
	{
		memd(r29+#-16) = r17:16
		allocframe(#136)
...
// %bb.1:                               // %entry
	...
	{
		r2 = asl(r20,#7)
		p0 = cmp.gt(r2,r4); if (p0.new) jump:nt .LBB121_6
	}
// %bb.2:                               // %entry
	{
		r4 = add(r19,#128)
		if (cmp.gt(r4.new,r3)) jump:nt .LBB121_6
	}
// %bb.3:                               // %entry
	{
		r4 = memw(r29+#64)
	}                               // 4-byte Folded Reload
	{
		...
		if (p2.new) r5 = add(r23,#-128)
		if (p2.new) r0 = memw(r29+#56)
	}                               // 4-byte Folded Reload
// %bb.4:                               // %entry
	{
		r4 = add(r24,#128)
	...
	{
		r5 = add(r21,r0)
		if (!cmp.gt(r5.new,r4)) jump:nt .LBB121_6
	}
// %bb.5:                               // %true_bb
	{
		r4 = #256
	...
	{
		r27 = add(##514,asl(r27,#1))
		r4 = min(r5,r4)
	}
	{
		r3 = add(r3,sub(##-128,r19))
		r1:0 = asl(r1:0,#33)
		r4 = add(r16,r4)
	}
	{
		r4 = add(r4,sub(##-256,r21))
		r7:6 = sxtw(r27)
	}
	{
		r1:0 |= asl(r7:6,#16)
...
// %bb.7:                               // %after_bb
	...
	{
		r3 = max(r8,r3)
		r13 = add(r16,sub(##-257,r2))
		r12 = sub(r24,r21)
	}
	{
		r1 = add(r16,sub(##-191,r2))
		p1 = cmp.eq(r4,#0)
		memd(r29+#56) = r11:10
	}                               // 8-byte Folded Spill
	{
		r8 = add(r16,sub(##-255,r2))
		r2 = sub(r16,r2)
		r28 = sub(r18,r3)
	}
	{
		r2 = addasl(r25,r2,#1)
		r14 = add(r18,sub(#1,r3))
		memw(r29+#48) = r2.new
	}                               // 4-byte Folded Spill
	{
		r2 = addasl(r25,r13,#1)
		r15 = add(r18,sub(#3,r3))
		r3 = memw(r29+#16)
		memw(r29+#44) = r2.new
	}                               // 4-byte Folded Reload
	{
		r2 = addasl(r25,r1,#1)
		r9 = add(r3,add(r11,##256))
		memw(r29+#40) = r2.new
	}                               // 4-byte Folded Spill
	{
		r11 = #0
...
.LBB121_8:                              // %"for blur_y.s0.y.yi"
	...
	{
		if (!p2.new) jump:nt .LBB121_17
		r20 = r26
		p2 = cmp.gt(r2,r26)
		if (p2.new) r3 = memw(r29+#52)
	}                               // 4-byte Folded Reload
// %bb.9:                               // %"for blur_x.s0.y.preheader"
...
.LBB121_10:                             // %"for blur_x.s0.y"
                                        //   Parent Loop BB121_8 Depth=1
                                        // =>  This Loop Header: Depth=2
                                        //       Child Loop BB121_12 Depth 3
	{
		if (p1) jump:nt .LBB121_14
		if (!p1) r10 = add(r2,#0)
		if (!p1) r17 = add(r8,#0)
		if (!p1) r13 = add(r0,#0)
	}
// %bb.11:                              // %"for blur_x.s0.x.x.preheader"
	...
	{
		v29:28.h = vadd(v25:24.h,v23:22.h)
		v26 = vmemu(r17++#2)
	}
	{
		v27 = vmemu(r10++#2)
	...
	{
		if (!p2) jump:nt .LBB121_13
		v21:20.h = vadd(v27:26.h,v29:28.h)
	}
	.falign
.LBB121_12:                             // %"for blur_x.s0.x.x"
                                        //   Parent Loop BB121_8 Depth=1
                                        //     Parent Loop BB121_10 Depth=2
                                        // =>    This Inner Loop Header: Depth=3
	{
		v31:30.uw = vmpy(v21.uh,v0.uh)
		v4 = vmemu(r13++#1)
	}
	{
		v7:6.uw = vmpy(v20.uh,v0.uh)
		v8.h = vshuffo(v31.h,v30.h)
		v2 = vmemu(r3+#-4)
	}
	{
		r3 = add(r3,#256)
	...
	{
		v31.uh = vlsr(v8.uh,r27)
		v5 = vmemu(r13++#1)
	}
	{
		v9.uh = vlsr(v6.uh,r27)
		v13:12.h = vadd(v5:4.h,v3:2.h)
		v11 = vmemu(r10++#2)
	}
	{
		v10 = vmemu(r17++#2)
	...
	{
		v21:20.h = vadd(v11:10.h,v13:12.h)
		vmemu(r21++#-1) = v31
	}
	{
		nop
	...
	.falign
.LBB121_13:                             //   in Loop: Header=BB121_10 Depth=2
	{
		v9:8.uw = vmpy(v21.uh,v0.uh)
	}
	{
		v15:14.uw = vmpy(v20.uh,v0.uh)
		v4.h = vshuffo(v9.h,v8.h)
	}
	{
		v10.h = vshuffo(v15.h,v14.h)
	}
	{
		v11.uh = vlsr(v4.uh,r27)
	}
	{
		v12.uh = vlsr(v10.uh,r27)
	}
	{
		vmemu(r21++#-1) = v11
	}
	...
	.falign
.LBB121_14:                             // %"end for blur_x.s0.x.x"
                                        //   in Loop: Header=BB121_10 Depth=2
	{
		if (!p3) jump:nt .LBB121_16
		if (p3) r5 = sub(r20,r19)
		if (p3) r3 = add(r12,#0)
	}
// %bb.15:                              // %true_bb2
                                        //   in Loop: Header=BB121_10 Depth=2
	...
	{
		v23:22.h = vadd(v17:16.h,v19:18.h)
		v20 = vmemu(r10+#0)
	}
	{
		v21 = vmemu(r21+#0)
	...
	{
		v25:24.h = vadd(v21:20.h,v23:22.h)
	}
	{
		v27:26.uw = vmpy(v24.uh,v0.uh)
	}
	{
		v29:28.uw = vmpy(v25.uh,v0.uh)
		v13.h = vshuffo(v27.h,v26.h)
	}
	{
		v15.uh = vlsr(v13.uh,r27)
		v14.h = vshuffo(v29.h,v28.h)
	}
	{
		v31.uh = vlsr(v14.uh,r27)
		vmemu(r3+#-2) = v15
	}
	{
		vmemu(r3+#-1) = v31
...
.LBB121_16:                             // %after_bb4
	...
	.falign
.LBB121_17:                             // %"consume blur_x"
                                        //   in Loop: Header=BB121_8 Depth=1
	{
		if (!p0) jump:nt .LBB121_21
		if (p0) r18 = add(r9,#0)
		if (p0) r0 = memw(r29+#64)
	}                               // 4-byte Folded Reload
// %bb.18:                              // %"for blur_y.s0.x.x.preheader"
                                        //   in Loop: Header=BB121_8 Depth=1
	{
		r2 = r0
		r3 = and(r14,#3)
	...
	{
		v31:30.h = vadd(v17:16.h,v19:18.h)
		v14 = vmemu(r13++#1)
	}
	{
		v15 = vmemu(r13++#2)
	...
	{
		v7:6.h = vadd(v3:2.h,v11:10.h)
		v9 = vmemu(r13++#3)
	}
	{
		v3:2.uw = vmpy(v4.uh,v0.uh)
		v11:10.h = vadd(v9:8.h,v7:6.h)
	}
	{
		v13:12.uw = vmpy(v5.uh,v0.uh)
		v27.h = vshuffo(v3.h,v2.h)
	}
	{
		v9:8.uw = vmpy(v10.uh,v0.uh)
		v28.h = vshuffo(v13.h,v12.h)
	}
	{
		loop0(.LBB121_19,r2)
		v31:30.uw = vmpy(v11.uh,v0.uh)
		v2.uh = vlsr(v27.uh,r27)
		v29.h = vshuffo(v9.h,v8.h)
	}
	{
		v1.uh = vlsr(v28.uh,r27)
		v5.h = vshuffo(v31.h,v30.h)
	}
	{
		if (!p2) jump:nt .LBB121_20
		v3.uh = vlsr(v29.uh,r27)
	}
	.falign
.LBB121_19:                             // %"for blur_y.s0.x.x"
                                        //   Parent Loop BB121_8 Depth=1
                                        // =>  This Inner Loop Header: Depth=2
	{
		v20.uh = vlsr(v5.uh,r27)
		v4 = vmemu(r10++#-2)
	}
	{
		v12 = vmemu(r17++#-2)
	...
	{
		v25:24.h = vadd(v17:16.h,v19:18.h)
		v22 = vmemu(r13++#1)
	}
	{
		v23 = vmemu(r13++#2)
	...
	{
		v27:26.h = vadd(v23:22.h,v25:24.h)
		v13 = vmemu(r17++#3)
	}
	{
		v5 = vmemu(r10++#3)
	...
	{
		v29:28.h = vadd(v5:4.h,v13:12.h)
		v7 = vmemu(r13++#3)
	}
	{
		v31:30.uw = vmpy(v26.uh,v0.uh)
		v5:4.h = vadd(v7:6.h,v29:28.h)
	}
	{
		v7:6.uw = vmpy(v27.uh,v0.uh)
		v21.h = vshuffo(v31.h,v30.h)
		vmemu(r18++#-2) = v3
	}
	{
		v11:10.uw = vmpy(v4.uh,v0.uh)
		v22.h = vshuffo(v7.h,v6.h)
		vmemu(r18++#1) = v2
	}
	{
		v31:30.uw = vmpy(v5.uh,v0.uh)
		v23.h = vshuffo(v11.h,v10.h)
		vmemu(r18++#2) = v1
	}
	{
		v2.uh = vlsr(v21.uh,r27)
		v5.h = vshuffo(v31.h,v30.h)
		vmemu(r18++#3) = v20
	}
	{
		v1.uh = vlsr(v22.uh,r27)
	}
	{
		nop
		v3.uh = vlsr(v23.uh,r27)
	} :endloop0
	.falign
.LBB121_20:                             //   in Loop: Header=BB121_8 Depth=1
	{
		v24.uh = vlsr(v5.uh,r27)
		vmemu(r18++#-2) = v3
	}
	{
		vmemu(r18++#1) = v2
	...
	.falign
.LBB121_21:                             // %"end for blur_y.s0.x.x"
                                        //   in Loop: Header=BB121_8 Depth=1
	{
		r2 = memw(r29+#76)
	}                               // 4-byte Folded Reload
	{
		p2 = r2
		if (!p2.new) jump:t .LBB121_23
		if (p2.new) r2 = add(r16,#1)
		if (p2.new) r21:20 = memd(r29+#24)
	}                               // 8-byte Folded Reload
// %bb.22:                              // %true_bb5
                                        //   in Loop: Header=BB121_8 Depth=1
	{
	...
	{
		v25:24.h = vadd(v17:16.h,v23:22.h)
		v18 = vmemu(r5+#-2)
	}
	{
		v19 = vmemu(r5+#-1)
	...
	{
		v31:30.uw = vmpy(v24.uh,v0.uh)
		v29:28.h = vadd(v19:18.h,v27:26.h)
		r2 = memw(r29+#12)
		r3 = memw(r29+#20)
	}                               // 4-byte Folded Reload
	{
		v5:4.uw = vmpy(v25.uh,v0.uh)
		r2 = add(r11,r2)
		v17.h = vshuffo(v31.h,v30.h)
	}
	{
		r3 += mpyi(r2,r20)
		v11:10.uw = vmpy(v29.uh,v0.uh)
		v18.h = vshuffo(v5.h,v4.h)
		r2 = memw(r29+#16)
	}                               // 4-byte Folded Reload
	{
		r2 = addasl(r2,r3,#1)
		v7:6.uw = vmpy(v28.uh,v0.uh)
		v25.uh = vlsr(v17.uh,r27)
		v29.h = vshuffo(v11.h,v10.h)
	}
	{
		v26.uh = vlsr(v18.uh,r27)
		v19.h = vshuffo(v7.h,v6.h)
	}
	{
		v1.uh = vlsr(v29.uh,r27)
		vmemu(r2+#-4) = v25
	}
	{
		v27.uh = vlsr(v19.uh,r27)
		vmemu(r2+#-3) = v26
	}
	{
		vmemu(r2+#-1) = v1
...
.LBB121_23:                             // %after_bb7
	...
	{
		if (!p2.new) jump:t .LBB121_8
		p2 = cmp.eq(r11,#128)
		r28 = add(r28,#1)
		r9 = add(r9,r2)
	}
// %bb.24:                              // %"end for blur_y.s0.y.yi"
	{
		p1 = cmp.eq(r1,#0); if (p1.new) jump:nt .LBB121_26
		r16 = memw(r29+#8)
	}                               // 4-byte Folded Reload
// %bb.25:                              // %if.then.i
	{
	...
	.falign
.LBB121_26:                             // %call_destructor.exit17
	{
		call ##halide_qurt_hvx_unlock_as_destructor
		r1:0 = combine(#1,r16)
	}
	.falign
// %bb.27:                              // %call_destructor.exit17
	{
		r0 = #0
		r17:16 = memd(r29+#128)
		r19:18 = memd(r29+#120)
...
.Lfunc_end121:
	.size	halide_blur_128.par_for.blur_y.s0.y.y, .Lfunc_end121-halide_blur_128.par_for.blur_y.s0.y.y
                                        // -- End function
	.section	.text.halide_blur_128_argv,"ax",@progbits
	.globl	halide_blur_128_argv    // -- Begin function halide_blur_128_argv
	.balign 32
	.type	halide_blur_128_argv,@function
halide_blur_128_argv:                   // @halide_blur_128_argv
// %bb.0:                               // %entry
	{
		allocframe(r29,#0):raw
	}
	{
		call ##halide_blur_128
		r1 = memw(r0+#4)
		r0 = memw(r0+#0)
	}
	{
...
.Lfunc_end122:
	.size	halide_blur_128_argv, .Lfunc_end122-halide_blur_128_argv
                                        // -- End function
	.section	.text.halide_blur_128_metadata,"ax",@progbits
	.globl	halide_blur_128_metadata // -- Begin function halide_blur_128_metadata
	.balign 32
	.type	halide_blur_128_metadata,@function
halide_blur_128_metadata:               // @halide_blur_128_metadata
// %bb.0:                               // %entry
	{
		r0 = add(pc,##.Lhalide_blur_128_metadata_storage@PCREL)
	}
	{
		jumpr r31
	}
.Lfunc_end123:
	.size	halide_blur_128_metadata, .Lfunc_end123-halide_blur_128_metadata
                                        // -- End function
...
.Lstr.111:
	...
	.p2align	5
.Lstr.112:
	.string	"halide_blur_128"
	.size	.Lstr.112, 16

	.type	.Lhalide_blur_128_metadata_storage,@object // @halide_blur_128_metadata_storage
	.section	.data.rel.ro,"aw",@progbits
	.p2align	4
.Lhalide_blur_128_metadata_storage:
	.word	0                       // 0x0
	.word	2                       // 0x2
	.word	.L__unnamed_1
	.word	.Lstr.111
	.word	.Lstr.112
	.size	.Lhalide_blur_128_metadata_storage, 20
