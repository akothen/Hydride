...
g++ $CXXFLAGS proc_common.cpp $BENCH_DIR/proc.cpp $BENCH_DIR/$BENCH_DIR.a -I $HALIDE_INCLUDE -I $HALIDE_TOOLS -I $HALIDE_ROOT/apps/support -lpthread -ldl -ljpeg -lpng -fopenmp -o proc
