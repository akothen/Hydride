; ModuleID = 'gaussian5x5/samples/batch_1_0/1/gaussian5x5_batch_01_sample_01.bc'
...
@str.227 = private constant [31 x i8] c"gaussian5x5_batch_01_sample_01\00", align 32
@gaussian5x5_batch_01_sample_01_metadata_storage = private constant %struct.halide_filter_metadata_t { i32 1, i32 2, %struct.halide_filter_argument_t* getelementptr inbounds ([2 x %struct.halide_filter_argument_t], [2 x %struct.halide_filter_argument_t]* @10, i32 0, i32 0), i8* getelementptr inbounds ([112 x i8], [112 x i8]* @str.226, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @str.227, i32 0, i32 0) }
...
; Function Attrs: nounwind
define i32 @gaussian5x5_batch_01_sample_01(%struct.halide_buffer_t* noalias %input.buffer, %struct.halide_buffer_t* noalias %output.buffer) local_unnamed_addr #8 {
entry:
...
"produce output":                                 ; preds = %no_errors_bb
  ...
  %380 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @gaussian5x5_batch_01_sample_01.par_for.output.s0.y.y, i32 0, i32 %t615, i8* nonnull %379)
  br label %destructor_block
}
...
; Function Attrs: nounwind
define internal i32 @gaussian5x5_batch_01_sample_01.par_for.output.s0.y.y(i8* %__user_context, i32 %output.s0.y.y, i8* noalias nocapture readonly %closure) #8 {
entry:
...
; Function Attrs: nounwind
define i32 @gaussian5x5_batch_01_sample_01_argv(i8** nocapture readonly) local_unnamed_addr #9 {
entry:
  ...
  %6 = tail call i32 @gaussian5x5_batch_01_sample_01(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #13
  ret i32 %6
}

; Function Attrs: norecurse nounwind readnone
define nonnull %struct.halide_filter_metadata_t* @gaussian5x5_batch_01_sample_01_metadata() local_unnamed_addr #10 {
entry:
  ret %struct.halide_filter_metadata_t* @gaussian5x5_batch_01_sample_01_metadata_storage
}
