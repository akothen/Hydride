#ifndef HALIDE__matmul_simple___bin___matmul_simple_h
#define HALIDE__matmul_simple___bin___matmul_simple_h
#include <stdint.h>
...
int matmul_simple(struct halide_buffer_t *_A_buffer, struct halide_buffer_t *_B_buffer, struct halide_buffer_t *_res_buffer);

HALIDE_FUNCTION_ATTRS
int matmul_simple_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *matmul_simple_metadata();
