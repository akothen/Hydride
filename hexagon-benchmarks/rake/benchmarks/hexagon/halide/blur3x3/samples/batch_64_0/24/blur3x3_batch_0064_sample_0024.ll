; ModuleID = '/home/sb54/Hydride/hexagon-benchmarks/rake/benchmarks/hexagon/halide/blur3x3/samples/batch_64_0/24/blur3x3_batch_0064_sample_0024.bc'
...
%closure_t = type { i32, i32, i32, i32, i32, i32, i32, i32, i32, i16*, %struct.halide_buffer_t*, i16*, %struct.halide_buffer_t* }
...
@str.209 = private constant [59 x i8] c"x86-64-linux-avx-avx2-disable_llvm_loop_opt-f16c-fma-sse41\00", align 32
@str.210 = private constant [31 x i8] c"blur3x3_batch_0064_sample_0024\00", align 32
@blur3x3_batch_0064_sample_0024_metadata_storage = private constant %struct.halide_filter_metadata_t { i32 1, i32 2, %struct.halide_filter_argument_t* getelementptr inbounds ([2 x %struct.halide_filter_argument_t], [2 x %struct.halide_filter_argument_t]* @10, i32 0, i32 0), i8* getelementptr inbounds ([59 x i8], [59 x i8]* @str.209, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @str.210, i32 0, i32 0) }
...
; Function Attrs: nounwind
define i32 @blur3x3_batch_0064_sample_0024(%struct.halide_buffer_t* noalias %input.buffer, %struct.halide_buffer_t* noalias %blur_y.buffer) local_unnamed_addr #10 {
entry:
...
_halide_buffer_is_bounds_query.exit:              ; preds = %"assert succeeded2"
  %57 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %blur_y.buffer, i64 0, i32 0
...
after_bb:                                         ; preds = %_halide_buffer_init.exit, %_halide_buffer_is_bounds_query.exit, %"assert succeeded2"
  ...
  br i1 %61, label %_halide_buffer_is_bounds_query.exit39, label %after_bb3

_halide_buffer_is_bounds_query.exit39:            ; preds = %after_bb
  %62 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 0
  %63 = load i64, i64* %62, align 8, !tbaa !183
  %64 = icmp eq i64 %63, 0
  br i1 %64, label %_halide_buffer_init.exit43, label %after_bb3
...
_halide_buffer_init.exit:                         ; preds = %_halide_buffer_is_bounds_query.exit
  ...
  %67 = icmp slt i32 %22, 480
  %68 = select i1 %67, i32 %22, i32 480
  %69 = add i32 %20, -480
  %70 = add i32 %69, %68
  %71 = icmp sgt i32 %22, 480
  %72 = select i1 %71, i32 %22, i32 480
  %73 = icmp slt i32 %28, 34
  %74 = select i1 %73, i32 %28, i32 34
  %75 = add i32 %26, -34
  %76 = add i32 %75, %74
  %77 = icmp sgt i32 %28, 34
  %78 = select i1 %77, i32 %28, i32 34
  %79 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 0
  store i32 %70, i32* %79, align 4
  %80 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 1
  store i32 %72, i32* %80, align 4
  %81 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 2
  store i32 1, i32* %81, align 4
  %82 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 3
  store i32 0, i32* %82, align 4
  %83 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 4
  store i32 %76, i32* %83, align 4
  %84 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 5
  store i32 %78, i32* %84, align 4
  %85 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 6
  store i32 %72, i32* %85, align 4
  %86 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 7
  store i32 0, i32* %86, align 4
  %87 = bitcast %struct.halide_buffer_t* %blur_y.buffer to i8*
  ...
  %88 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %blur_y.buffer, i64 0, i32 4, i32 1
  store i8 16, i8* %88, align 1, !tbaa !369
  %89 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %blur_y.buffer, i64 0, i32 4, i32 2
  store i16 1, i16* %89, align 2, !tbaa !370
  store i32 2, i32* %15, align 4, !tbaa !184
  %90 = bitcast [8 x i32]* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %66, i8* nonnull align 4 dereferenceable(16) %90, i64 16, i1 false) #11, !tbaa.struct !186
  %91 = load %struct.halide_dimension_t*, %struct.halide_dimension_t** %17, align 8, !tbaa !185
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %94, i8* nonnull align 4 dereferenceable(16) %95, i64 16, i1 false) #11, !tbaa.struct !186
...
after_bb3:                                        ; preds = %_halide_buffer_init.exit43, %_halide_buffer_is_bounds_query.exit39, %after_bb
  %96 = load i8*, i8** %7, align 8, !tbaa !181
  %97 = icmp eq i8* %96, null
  br i1 %97, label %98, label %_halide_buffer_is_bounds_query.exit40

98:                                               ; preds = %after_bb3
  %99 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %blur_y.buffer, i64 0, i32 0
  %100 = load i64, i64* %99, align 8, !tbaa !183
  %101 = icmp eq i64 %100, 0
  br label %_halide_buffer_is_bounds_query.exit40

_halide_buffer_is_bounds_query.exit40:            ; preds = %98, %after_bb3
  %102 = phi i1 [ false, %after_bb3 ], [ %101, %98 ]
  %103 = load i8*, i8** %31, align 8, !tbaa !181
  %104 = icmp eq i8* %103, null
  br i1 %104, label %105, label %_halide_buffer_is_bounds_query.exit41

105:                                              ; preds = %_halide_buffer_is_bounds_query.exit40
  %106 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 0
  %107 = load i64, i64* %106, align 8, !tbaa !183
  %108 = icmp eq i64 %107, 0
  br label %_halide_buffer_is_bounds_query.exit41

_halide_buffer_is_bounds_query.exit41:            ; preds = %105, %_halide_buffer_is_bounds_query.exit40
  %109 = phi i1 [ false, %_halide_buffer_is_bounds_query.exit40 ], [ %108, %105 ]
  %110 = or i1 %102, %109
  br i1 %110, label %destructor_block, label %then_bb7

_halide_buffer_init.exit43:                       ; preds = %_halide_buffer_is_bounds_query.exit39
  %111 = bitcast %struct.halide_dimension_t** %41 to i8**
  %112 = load i8*, i8** %111, align 8, !tbaa !185
  %113 = icmp slt i32 %22, 480
  %114 = select i1 %113, i32 %22, i32 480
  %115 = add i32 %20, -480
  %116 = add i32 %115, %114
  %117 = icmp sgt i32 %22, 480
  %118 = select i1 %117, i32 %22, i32 480
  %119 = add nuw nsw i32 %118, 2
  %120 = icmp slt i32 %28, 34
  %121 = select i1 %120, i32 %28, i32 34
  %122 = add i32 %26, -34
  %123 = add i32 %122, %121
  %124 = icmp sgt i32 %28, 34
  %125 = select i1 %124, i32 %28, i32 34
  ...
  %135 = bitcast %struct.halide_buffer_t* %input.buffer to i8*
  ...
  %136 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 4, i32 1
  store i8 16, i8* %136, align 1, !tbaa !369
  %137 = getelementptr inbounds %struct.halide_buffer_t, %struct.halide_buffer_t* %input.buffer, i64 0, i32 4, i32 2
  store i16 1, i16* %137, align 2, !tbaa !370
  store i32 2, i32* %39, align 4, !tbaa !184
  %138 = bitcast [8 x i32]* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %112, i8* nonnull align 4 dereferenceable(16) %138, i64 16, i1 false) #11, !tbaa.struct !186
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(16) %142, i8* nonnull align 4 dereferenceable(16) %143, i64 16, i1 false) #11, !tbaa.struct !186
  store i64 0, i64* %37, align 8, !tbaa !285
  br label %after_bb3

then_bb7:                                         ; preds = %_halide_buffer_is_bounds_query.exit41
  %144 = icmp ne i32 %12, 69633
  ...
  %149 = icmp slt i32 %22, 480
  %150 = select i1 %149, i64 16, i64 0
  %151 = icmp slt i32 %28, 34
  %152 = select i1 %151, i64 32, i64 0
  %153 = icmp sgt i32 %44, %20
  %154 = add nsw i32 %22, %20
  %155 = add nsw i32 %154, 2
  %156 = add nsw i32 %46, %44
  ...
  %163 = icmp sgt i32 %50, %26
  %164 = add nsw i32 %28, %26
  %165 = add nsw i32 %164, 2
  %166 = add nsw i32 %52, %50
  %167 = icmp sgt i32 %165, %166
  %168 = or i1 %163, %167
  %169 = select i1 %168, i64 256, i64 0
  %170 = lshr i32 %52, 22
  %171 = and i32 %170, 512
  %172 = zext i32 %171 to i64
  %.not37 = icmp eq i32 %24, 1
  %173 = select i1 %.not37, i64 0, i64 1024
  %.not38 = icmp eq i32 %48, 1
  %174 = select i1 %.not38, i64 0, i64 2048
  %175 = or i64 %146, %145
  %176 = or i64 %175, %150
  %177 = or i64 %176, %173
  %178 = or i64 %177, %152
  ...
  %187 = call i64 @llvm.cttz.i64(i64 %186, i1 true), !range !371
...
no_errors_bb:                                     ; preds = %then_bb7
  ...
  %blur_y.total_extent.1 = mul nsw i64 %189, %190
  %191 = sext i32 %52 to i64
  %192 = sext i32 %46 to i64
  %input.total_extent.1 = mul nsw i64 %191, %192
  %a10.lobit = lshr i32 %22, 31
  %193 = zext i32 %a10.lobit to i64
  %194 = sext i32 %30 to i64
  %x0 = mul nsw i64 %194, %189
  %195 = call i64 @llvm.abs.i64(i64 %x0, i1 true)
  %196 = icmp ugt i64 %195, 2147483647
  %197 = select i1 %196, i64 2, i64 0
  %198 = icmp sgt i64 %blur_y.total_extent.1, 2147483647
  %199 = select i1 %198, i64 4, i64 0
  %200 = lshr i32 %46, 28
  %201 = and i32 %200, 8
  %202 = zext i32 %201 to i64
  %203 = sext i32 %54 to i64
  %x1 = mul nsw i64 %203, %191
  %204 = call i64 @llvm.abs.i64(i64 %x1, i1 true)
  %205 = icmp ugt i64 %204, 2147483647
  %206 = select i1 %205, i64 16, i64 0
  %207 = icmp sgt i64 %input.total_extent.1, 2147483647
  %208 = select i1 %207, i64 32, i64 0
  %209 = shl i64 %14, 5
  %210 = and i64 %209, 64
  %211 = shl i64 %38, 6
  %212 = and i64 %211, 128
  %213 = icmp eq i8* %8, null
  %214 = icmp eq i8* %32, null
  %215 = select i1 %214, i64 512, i64 0
  %216 = select i1 %213, i64 -9223372036854775552, i64 -9223372036854775808
  %217 = or i64 %216, %210
  %218 = or i64 %217, %193
  %219 = or i64 %218, %199
  %220 = or i64 %219, %215
  ...
  %224 = or i64 %223, %208
  %225 = or i64 %224, %206
  %226 = call i64 @llvm.cttz.i64(i64 %225, i1 true), !range !371
  %227 = trunc i64 %226 to i32
  switch i32 %227, label %"produce blur_y" [
...
assert_failed:                                    ; preds = %then_bb7
  %228 = call i32 @halide_error_bad_type(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.204, i64 0, i64 0), i32 %12, i32 69633) #11
  ret i32 %228

assert_failed9:                                   ; preds = %then_bb7
  %229 = call i32 @halide_error_bad_dimensions(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.204, i64 0, i64 0), i32 %16, i32 2) #11
  ret i32 %229

assert_failed10:                                  ; preds = %then_bb7
  %230 = call i32 @halide_error_bad_type(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0), i32 %36, i32 69633) #11
  ret i32 %230

assert_failed11:                                  ; preds = %then_bb7
  %231 = call i32 @halide_error_bad_dimensions(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0), i32 %40, i32 2) #11
  ret i32 %231

assert_failed12:                                  ; preds = %then_bb7
  %232 = select i1 %149, i32 %22, i32 480
  %233 = add i32 %20, -480
  %234 = add i32 %233, %232
  %235 = add nsw i32 %154, -1
  %236 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.204, i64 0, i64 0), i32 0, i32 %234, i32 %235, i32 %20, i32 %235) #11
  ret i32 %236

assert_failed13:                                  ; preds = %then_bb7
  %237 = select i1 %151, i32 %28, i32 34
  %238 = add i32 %26, -34
  %239 = add i32 %238, %237
  %240 = add nsw i32 %164, -1
  %241 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.204, i64 0, i64 0), i32 1, i32 %239, i32 %240, i32 %26, i32 %240) #11
  ret i32 %241

assert_failed14:                                  ; preds = %then_bb7
  %242 = add nsw i32 %154, 1
  %243 = add nsw i32 %156, -1
  %244 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0), i32 0, i32 %20, i32 %242, i32 %44, i32 %243) #11
  ret i32 %244

assert_failed15:                                  ; preds = %then_bb7
  %245 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0), i32 0, i32 %46) #11
  ret i32 %245

assert_failed16:                                  ; preds = %then_bb7
  %246 = add nsw i32 %164, 1
  %247 = add nsw i32 %166, -1
  %248 = call i32 @halide_error_access_out_of_bounds(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0), i32 1, i32 %26, i32 %246, i32 %50, i32 %247) #11
  ret i32 %248

assert_failed17:                                  ; preds = %then_bb7
  %249 = call i32 @halide_error_buffer_extents_negative(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0), i32 1, i32 %52) #11
  ret i32 %249

assert_failed18:                                  ; preds = %then_bb7
  %250 = call i32 @halide_error_constraint_violated(i8* null, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @str.206, i64 0, i64 0), i32 %24, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.207, i64 0, i64 0), i32 1) #11
  ret i32 %250

assert_failed19:                                  ; preds = %then_bb7
  %251 = call i32 @halide_error_constraint_violated(i8* null, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.208, i64 0, i64 0), i32 %48, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.207, i64 0, i64 0), i32 1) #11
  ret i32 %251

assert_failed21:                                  ; preds = %no_errors_bb
  %252 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str.203, i64 0, i64 0), i64 %190, i64 2147483647) #11
  ret i32 %252

assert_failed22:                                  ; preds = %no_errors_bb
  %253 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str.203, i64 0, i64 0), i64 %195, i64 2147483647) #11
  ret i32 %253

assert_failed23:                                  ; preds = %no_errors_bb
  %254 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str.203, i64 0, i64 0), i64 %blur_y.total_extent.1, i64 2147483647) #11
  ret i32 %254

assert_failed24:                                  ; preds = %no_errors_bb
  %255 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str, i64 0, i64 0), i64 %192, i64 2147483647) #11
  ret i32 %255

assert_failed25:                                  ; preds = %no_errors_bb
  %256 = call i32 @halide_error_buffer_allocation_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str, i64 0, i64 0), i64 %204, i64 2147483647) #11
  ret i32 %256

assert_failed26:                                  ; preds = %no_errors_bb
  %257 = call i32 @halide_error_buffer_extents_too_large(i8* null, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str, i64 0, i64 0), i64 %input.total_extent.1, i64 2147483647) #11
  ret i32 %257

assert_failed27:                                  ; preds = %no_errors_bb
  %258 = call i32 @halide_error_device_dirty_with_no_device_support(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.204, i64 0, i64 0)) #11
  ret i32 %258

assert_failed28:                                  ; preds = %no_errors_bb
  %259 = call i32 @halide_error_device_dirty_with_no_device_support(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0)) #11
  ret i32 %259

assert_failed29:                                  ; preds = %no_errors_bb
  %260 = call i32 @halide_error_host_is_null(i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @str.204, i64 0, i64 0)) #11
  ret i32 %260

assert_failed30:                                  ; preds = %no_errors_bb
  %261 = call i32 @halide_error_host_is_null(i8* null, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @str.205, i64 0, i64 0)) #11
  ret i32 %261

"produce blur_y":                                 ; preds = %no_errors_bb
  %262 = add nsw i32 %28, 33
  %263 = ashr i32 %262, 31
  %264 = xor i32 %263, %262
  %265 = zext i32 %264 to i64
  %266 = mul nuw nsw i64 %265, 2021161081
  %267 = lshr i64 %266, 36
  %268 = trunc i64 %267 to i32
  %t19 = xor i32 %263, %268
  %269 = icmp slt i32 %22, -479
  %t31.neg48 = zext i1 %269 to i32
  %t31 = sext i1 %269 to i32
  %270 = add i32 %22, 479
  %271 = add i32 %270, %t31.neg48
  %272 = sdiv i32 %271, 480
  %t20 = add nsw i32 %272, %t31
  %273 = mul i32 %26, %30
  %t22 = sub i32 0, %273
  %274 = mul nsw i32 %54, %50
  %t21 = add nsw i32 %274, %44
  %275 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 0
  store i32 %22, i32* %275, align 8
  ...
  store i32 %20, i32* %277, align 8
  %278 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 3
  store i32 %26, i32* %278, align 4
  %279 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 4
  store i32 %30, i32* %279, align 8
  %280 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 5
  store i32 %54, i32* %280, align 4
  %281 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 6
  store i32 %t20, i32* %281, align 8
  %282 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 7
  store i32 %t21, i32* %282, align 4
  %283 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 8
  store i32 %t22, i32* %283, align 8
  %284 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 9
  %285 = bitcast i16** %284 to i8**
  store i8* %8, i8** %285, align 8
  %286 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 10
  store %struct.halide_buffer_t* %blur_y.buffer, %struct.halide_buffer_t** %286, align 8
  %287 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 11
  %288 = bitcast i16** %287 to i8**
  store i8* %32, i8** %288, align 8
  %289 = getelementptr inbounds %closure_t, %closure_t* %2, i64 0, i32 12
  store %struct.halide_buffer_t* %input.buffer, %struct.halide_buffer_t** %289, align 8
  %290 = bitcast %closure_t* %2 to i8*
  %291 = call i32 @halide_do_par_for(i8* null, i32 (i8*, i32, i8*)* nonnull @blur3x3_batch_0064_sample_0024.par_for.blur_y.s0.y.y, i32 0, i32 %t19, i8* nonnull %290)
  ret i32 %291
}
...
; Function Attrs: nounwind
define internal i32 @blur3x3_batch_0064_sample_0024.par_for.blur_y.s0.y.y(i8* %__user_context, i32 %blur_y.s0.y.y, i8* noalias nocapture readonly %closure) #10 {
entry:
  ...
  %1 = bitcast %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot to i64*
  store i64 0, i64* %1, align 8
  %blur_y.extent.0 = load i32, i32* %0, align 4
  %2 = getelementptr inbounds i8, i8* %closure, i64 4
  %3 = bitcast i8* %2 to i32*
  %blur_y.extent.1 = load i32, i32* %3, align 4
  %4 = getelementptr inbounds i8, i8* %closure, i64 8
  %5 = bitcast i8* %4 to i32*
  %blur_y.min.0 = load i32, i32* %5, align 4
  %6 = getelementptr inbounds i8, i8* %closure, i64 12
  %7 = bitcast i8* %6 to i32*
  %blur_y.min.1 = load i32, i32* %7, align 4
  %8 = getelementptr inbounds i8, i8* %closure, i64 16
  %9 = bitcast i8* %8 to i32*
  %blur_y.stride.1 = load i32, i32* %9, align 4
  %10 = getelementptr inbounds i8, i8* %closure, i64 20
  %11 = bitcast i8* %10 to i32*
  %input.stride.1 = load i32, i32* %11, align 4
  %12 = getelementptr inbounds i8, i8* %closure, i64 24
  %13 = bitcast i8* %12 to i32*
  %t20 = load i32, i32* %13, align 4
  %14 = getelementptr inbounds i8, i8* %closure, i64 28
  %15 = bitcast i8* %14 to i32*
  %t21 = load i32, i32* %15, align 4
  %16 = getelementptr inbounds i8, i8* %closure, i64 32
  %17 = bitcast i8* %16 to i32*
  %t22 = load i32, i32* %17, align 4
  %18 = getelementptr inbounds i8, i8* %closure, i64 40
  %19 = bitcast i8* %18 to i16**
  %blur_y = load i16*, i16** %19, align 8
  %20 = getelementptr inbounds i8, i8* %closure, i64 56
  %21 = bitcast i8* %20 to i16**
  %input = load i16*, i16** %21, align 8
  %a12 = mul nsw i32 %blur_y.s0.y.y, 34
  %b13 = add nsw i32 %blur_y.extent.1, -34
  %22 = icmp sgt i32 %b13, %a12
  %blur_y.s0.y.yi.base.s = select i1 %22, i32 %a12, i32 %b13
  %t23 = add nsw i32 %blur_y.s0.y.yi.base.s, %blur_y.min.1
  %23 = icmp sgt i32 %t20, 0
  %b14 = add nsw i32 %blur_y.extent.0, -480
  %t25 = sub i32 %blur_y.min.0, %t21
  br i1 %23, label %"for blur_y.s0.y.yi.yi.us.preheader", label %call_destructor.exit, !prof !374

"for blur_y.s0.y.yi.yi.us.preheader":             ; preds = %entry
  %.fca.0.gep.promoted24 = load i8*, i8** %.fca.0.gep, align 8, !tbaa !375
  %t24.us.1 = add nsw i32 %t23, 0
  br label %"for blur_y.s0.y.yi.yi.us"

"for blur_y.s0.y.yi.yi.us":                       ; preds = %"end for blur_y.s0.x.x.loopexit.us.for blur_y.s0.y.yi.yi.us_crit_edge", %"for blur_y.s0.y.yi.yi.us.preheader"
  %.lcssa2325 = phi i8* [ %36, %"end for blur_y.s0.x.x.loopexit.us.for blur_y.s0.y.yi.yi.us_crit_edge" ], [ %.fca.0.gep.promoted24, %"for blur_y.s0.y.yi.yi.us.preheader" ]
  %24 = phi i8* [ %38, %"end for blur_y.s0.x.x.loopexit.us.for blur_y.s0.y.yi.yi.us_crit_edge" ], [ null, %"for blur_y.s0.y.yi.yi.us.preheader" ]
  %25 = phi i64 [ %37, %"end for blur_y.s0.x.x.loopexit.us.for blur_y.s0.y.yi.yi.us_crit_edge" ], [ 0, %"for blur_y.s0.y.yi.yi.us.preheader" ]
  %.not.us = phi i1 [ true, %"end for blur_y.s0.x.x.loopexit.us.for blur_y.s0.y.yi.yi.us_crit_edge" ], [ false, %"for blur_y.s0.y.yi.yi.us.preheader" ]
  %t24.us.phi = phi i32 [ %t24.us.0, %"end for blur_y.s0.x.x.loopexit.us.for blur_y.s0.y.yi.yi.us_crit_edge" ], [ %t24.us.1, %"for blur_y.s0.y.yi.yi.us.preheader" ]
  br label %"for blur_y.s0.x.x.us"

"for blur_y.s0.x.x.us":                           ; preds = %"end for blur_y.s0.y.yi.yii.us", %"for blur_y.s0.y.yi.yi.us"
  %26 = phi i8* [ %36, %"end for blur_y.s0.y.yi.yii.us" ], [ %.lcssa2325, %"for blur_y.s0.y.yi.yi.us" ]
  %27 = phi i8* [ %38, %"end for blur_y.s0.y.yi.yii.us" ], [ %24, %"for blur_y.s0.y.yi.yi.us" ]
  %28 = phi i64 [ %37, %"end for blur_y.s0.y.yi.yii.us" ], [ %25, %"for blur_y.s0.y.yi.yi.us" ]
  %blur_y.s0.x.x.us = phi i32 [ %86, %"end for blur_y.s0.y.yi.yii.us" ], [ 0, %"for blur_y.s0.y.yi.yi.us" ]
  %a13.us = mul nsw i32 %blur_y.s0.x.x.us, 480
  %29 = icmp sgt i32 %b14, %a13.us
  %blur_y.s0.x.xi.base.s.us = select i1 %29, i32 %a13.us, i32 %b14
  %30 = icmp ult i64 %28, 18246
  br i1 %30, label %31, label %pseudostack_alloc.exit.us, !prof !377

31:                                               ; preds = %"for blur_y.s0.x.x.us"
  %32 = icmp eq i8* %27, null
  br i1 %32, label %34, label %33

33:                                               ; preds = %31
  tail call void @halide_free(i8* %__user_context, i8* nonnull %27) #13
  br label %34

34:                                               ; preds = %33, %31
  %35 = tail call i8* @halide_malloc(i8* %__user_context, i64 18246) #13
  br label %pseudostack_alloc.exit.us

pseudostack_alloc.exit.us:                        ; preds = %34, %"for blur_y.s0.x.x.us"
  %36 = phi i8* [ %35, %34 ], [ %26, %"for blur_y.s0.x.x.us" ]
  %37 = phi i64 [ 18246, %34 ], [ %28, %"for blur_y.s0.x.x.us" ]
  %38 = phi i8* [ %35, %34 ], [ %27, %"for blur_y.s0.x.x.us" ]
  %blur_x.us = bitcast i8* %38 to i16*
  %blur_x.s0.x.xi.base.us = add i32 %t25, %blur_y.s0.x.xi.base.s.us
  br label %"for blur_x.s0.y.rebased.us"

"for blur_x.s0.y.rebased.us":                     ; preds = %"end for blur_x.s0.x.x.us", %pseudostack_alloc.exit.us
  %indvars.iv11 = phi i64 [ %indvars.iv.next12, %"end for blur_x.s0.x.x.us" ], [ 0, %pseudostack_alloc.exit.us ]
  %39 = mul nuw nsw i64 %indvars.iv11, 30
  %40 = trunc i64 %indvars.iv11 to i32
  %41 = add nsw i32 %t24.us.phi, %40
  %42 = mul nsw i32 %41, %input.stride.1
  %t26.us = add i32 %blur_x.s0.x.xi.base.us, %42
  br label %"for blur_x.s0.x.x.us"

"for blur_x.s0.x.x.us":                           ; preds = %"for blur_x.s0.x.x.us", %"for blur_x.s0.y.rebased.us"
  %indvars.iv = phi i64 [ %indvars.iv.next, %"for blur_x.s0.x.x.us" ], [ 0, %"for blur_x.s0.y.rebased.us" ]
  %indvars.iv.tr = trunc i64 %indvars.iv to i32
  %43 = shl i32 %indvars.iv.tr, 4
  %t12.us = add i32 %t26.us, %43
  %44 = sext i32 %t12.us to i64
  %45 = getelementptr inbounds i16, i16* %input, i64 %44
  %46 = getelementptr inbounds i16, i16* %45, i64 1
  %47 = bitcast i16* %46 to <16 x i16>*
  %48 = load <16 x i16>, <16 x i16>* %47, align 2, !tbaa !378
  %49 = getelementptr inbounds i16, i16* %45, i64 2
  %50 = bitcast i16* %49 to <16 x i16>*
  %51 = load <16 x i16>, <16 x i16>* %50, align 2, !tbaa !378
  %52 = bitcast i16* %45 to <16 x i16>*
  %53 = load <16 x i16>, <16 x i16>* %52, align 2, !tbaa !378
  %54 = add <16 x i16> %51, %48
  %55 = add <16 x i16> %54, %53
  %56 = tail call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %55, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %57 = lshr <16 x i16> %56, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %58 = add nuw nsw i64 %indvars.iv, %39
  %59 = shl nuw nsw i64 %58, 4
  %60 = getelementptr inbounds i16, i16* %blur_x.us, i64 %59
  %61 = bitcast i16* %60 to <16 x i16>*
  store <16 x i16> %57, <16 x i16>* %61, align 32, !tbaa !381
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.not4.us = icmp eq i64 %indvars.iv.next, 30
  br i1 %.not4.us, label %"end for blur_x.s0.x.x.us", label %"for blur_x.s0.x.x.us"

"end for blur_x.s0.x.x.us":                       ; preds = %"for blur_x.s0.x.x.us"
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %.not5.us = icmp eq i64 %indvars.iv.next12, 19
  br i1 %.not5.us, label %"consume blur_x.us", label %"for blur_x.s0.y.rebased.us"

"consume blur_x.us":                              ; preds = %"end for blur_x.s0.x.x.us"
  %t28.us = add nsw i32 %blur_y.s0.x.xi.base.s.us, %t22
  br label %"for blur_y.s0.y.yi.yii.us"

"for blur_y.s0.y.yi.yii.us":                      ; preds = %"end for blur_y.s0.x.xi.xi.us", %"consume blur_x.us"
  %indvars.iv17 = phi i64 [ %indvars.iv.next18, %"end for blur_y.s0.x.xi.xi.us" ], [ 0, %"consume blur_x.us" ]
  %62 = mul nuw nsw i64 %indvars.iv17, 30
  %63 = trunc i64 %indvars.iv17 to i32
  %64 = add nsw i32 %t24.us.phi, %63
  %65 = mul nsw i32 %64, %blur_y.stride.1
  %t30.us = add nsw i32 %t28.us, %65
  %66 = sext i32 %t30.us to i64
  br label %"for blur_y.s0.x.xi.xi.us"

"for blur_y.s0.x.xi.xi.us":                       ; preds = %"for blur_y.s0.x.xi.xi.us", %"for blur_y.s0.y.yi.yii.us"
  %indvars.iv14 = phi i64 [ %indvars.iv.next15, %"for blur_y.s0.x.xi.xi.us" ], [ 0, %"for blur_y.s0.y.yi.yii.us" ]
  %67 = add nuw nsw i64 %indvars.iv14, %62
  %68 = shl nuw nsw i64 %67, 4
  %69 = getelementptr inbounds i16, i16* %blur_x.us, i64 %68
  %70 = getelementptr inbounds i16, i16* %69, i64 480
  %71 = bitcast i16* %70 to <16 x i16>*
  %72 = load <16 x i16>, <16 x i16>* %71, align 32, !tbaa !381
  %73 = getelementptr inbounds i16, i16* %69, i64 960
  %74 = bitcast i16* %73 to <16 x i16>*
  %75 = load <16 x i16>, <16 x i16>* %74, align 32, !tbaa !381
  %76 = bitcast i16* %69 to <16 x i16>*
  %77 = load <16 x i16>, <16 x i16>* %76, align 32, !tbaa !381
  %78 = add <16 x i16> %75, %72
  %79 = add <16 x i16> %78, %77
  %80 = tail call <16 x i16> @llvm.x86.avx2.pmulhu.w(<16 x i16> %79, <16 x i16> <i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845, i16 -21845>)
  %81 = lshr <16 x i16> %80, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %82 = shl nuw nsw i64 %indvars.iv14, 4
  %83 = add nsw i64 %82, %66
  %84 = getelementptr inbounds i16, i16* %blur_y, i64 %83
  %85 = bitcast i16* %84 to <16 x i16>*
  store <16 x i16> %81, <16 x i16>* %85, align 2, !tbaa !383
  %indvars.iv.next15 = add nuw nsw i64 %indvars.iv14, 1
  %.not6.us = icmp eq i64 %indvars.iv.next15, 30
  br i1 %.not6.us, label %"end for blur_y.s0.x.xi.xi.us", label %"for blur_y.s0.x.xi.xi.us"

"end for blur_y.s0.x.xi.xi.us":                   ; preds = %"for blur_y.s0.x.xi.xi.us"
  %indvars.iv.next18 = add nuw nsw i64 %indvars.iv17, 1
  %.not7.us = icmp eq i64 %indvars.iv.next18, 17
  br i1 %.not7.us, label %"end for blur_y.s0.y.yi.yii.us", label %"for blur_y.s0.y.yi.yii.us"

"end for blur_y.s0.y.yi.yii.us":                  ; preds = %"end for blur_y.s0.x.xi.xi.us"
  %86 = add nuw nsw i32 %blur_y.s0.x.x.us, 1
  %.not8.us = icmp eq i32 %86, %t20
  br i1 %.not8.us, label %"end for blur_y.s0.x.x.loopexit.us", label %"for blur_y.s0.x.x.us"

"end for blur_y.s0.x.x.loopexit.us":              ; preds = %"end for blur_y.s0.y.yi.yii.us"
  br i1 %.not.us, label %destructor_block, label %"end for blur_y.s0.x.x.loopexit.us.for blur_y.s0.y.yi.yi.us_crit_edge"

"end for blur_y.s0.x.x.loopexit.us.for blur_y.s0.y.yi.yi.us_crit_edge": ; preds = %"end for blur_y.s0.x.x.loopexit.us"
  %t24.us.0 = add nsw i32 %t23, 17
  br label %"for blur_y.s0.y.yi.yi.us"

destructor_block:                                 ; preds = %"end for blur_y.s0.x.x.loopexit.us"
  store i8* %36, i8** %.fca.0.gep, align 8, !tbaa !375
  %87 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot, i64 0, i32 1
  store i64 0, i64* %87, align 8, !tbaa !385
  %88 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %blur_x.pseudostack_slot, i64 0, i32 0
  %89 = icmp eq i8* %36, null
  br i1 %89, label %pseudostack_free.exit, label %90

90:                                               ; preds = %destructor_block
  call void @halide_free(i8* %__user_context, i8* nonnull %36) #13
  br label %pseudostack_free.exit

pseudostack_free.exit:                            ; preds = %90, %destructor_block
  store i8* null, i8** %88, align 8, !tbaa !375
  br label %call_destructor.exit

call_destructor.exit:                             ; preds = %pseudostack_free.exit, %entry
  ret i32 0
}

; Function Attrs: nounwind
define i32 @blur3x3_batch_0064_sample_0024_argv(i8** nocapture readonly %0) local_unnamed_addr #11 {
entry:
  ...
  %6 = tail call i32 @blur3x3_batch_0064_sample_0024(%struct.halide_buffer_t* %2, %struct.halide_buffer_t* %5) #15
  ret i32 %6
}

; Function Attrs: norecurse nounwind readnone willreturn
define nonnull %struct.halide_filter_metadata_t* @blur3x3_batch_0064_sample_0024_metadata() local_unnamed_addr #12 {
entry:
  ret %struct.halide_filter_metadata_t* @blur3x3_batch_0064_sample_0024_metadata_storage
}
...
!380 = !{!"Halide buffer"}
!381 = !{!382, !382, i64 0}
!382 = !{!"blur_x", !380, i64 0}
!383 = !{!384, !384, i64 0}
!384 = !{!"blur_y", !380, i64 0}
!385 = !{!376, !19, i64 8}
