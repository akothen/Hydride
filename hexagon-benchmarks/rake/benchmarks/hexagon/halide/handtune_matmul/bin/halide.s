...
.Lfunc_end213:
	...
	.globl	handtune_matmul_par_for_res_s0_x_x_xy # -- Begin function handtune_matmul_par_for_res_s0_x_x_xy
	.p2align	4, 0x90
...
# %bb.3:                                # %"consume matrix_mul"
	...
	shlq	$4, %rcx
	vmovdqu64	%zmm7, (%r12,%rcx)
	vmovdqu64	%zmm6, 64(%r12,%rcx)
	leaq	1(,%rsi,4), %rcx
	imulq	%rax, %rcx
	movq	-48(%rsp), %rdx                 # 8-byte Reload
	addq	%rdx, %rcx
	vmovdqu64	%zmm5, (%r12,%rcx,4)
	vmovdqu64	%zmm4, 64(%r12,%rcx,4)
	leaq	2(,%rsi,4), %rcx
	imulq	%rax, %rcx
	addq	%rdx, %rcx
	vmovdqu64	%zmm3, (%r12,%rcx,4)
	vmovdqu64	%zmm2, 64(%r12,%rcx,4)
	leaq	3(,%rsi,4), %rcx
	imulq	%rax, %rcx
	addq	%rdx, %rcx
	vmovdqu64	%zmm1, (%r12,%rcx,4)
	vmovdqu64	%zmm0, 64(%r12,%rcx,4)
	incq	%r9
...
.LBB214_6:                              # %"for matrix_mul.s1.r8$x.r8$x47"
                                        ...
                                        # =>  This Inner Loop Header: Depth=2
	vpmovsxwd	-32(%rcx,%rbx), %zmm8
	vpbroadcastw	-2(%rsi,%r12), %ymm9
	vpmovsxwd	%ymm9, %zmm9
	vpmulld	%zmm8, %zmm9, %zmm10
	vpmovsxwd	(%rcx,%rbx), %zmm11
	vpmulld	%zmm9, %zmm11, %zmm9
	vpaddd	%zmm7, %zmm10, %zmm7
	vpbroadcastw	-2(%rdx,%r12), %ymm10
	vpmovsxwd	%ymm10, %zmm10
	vpmulld	%zmm8, %zmm10, %zmm12
	vpaddd	%zmm6, %zmm9, %zmm6
	vpaddd	%zmm5, %zmm12, %zmm5
	vpmulld	%zmm11, %zmm10, %zmm9
	vpbroadcastw	-2(%rdi,%r12), %ymm10
	vpaddd	%zmm4, %zmm9, %zmm4
	vpmovsxwd	%ymm10, %zmm9
	vpmulld	%zmm8, %zmm9, %zmm10
	vpmulld	%zmm11, %zmm9, %zmm9
	vpaddd	%zmm3, %zmm10, %zmm3
	vpbroadcastw	-2(%rbp,%r12), %ymm10
	vpmovsxwd	%ymm10, %zmm10
	vpmulld	%zmm8, %zmm10, %zmm8
	vpaddd	%zmm2, %zmm9, %zmm2
	vpaddd	%zmm1, %zmm8, %zmm1
	vpmulld	%zmm11, %zmm10, %zmm8
	vpmovsxwd	-32(%rax,%rbx), %zmm9
	vpaddd	%zmm0, %zmm8, %zmm0
	vpbroadcastw	(%rsi,%r12), %ymm8
	vpmovsxwd	%ymm8, %zmm8
	vpmulld	%zmm9, %zmm8, %zmm10
	vpaddd	%zmm7, %zmm10, %zmm7
	vpmovsxwd	(%rax,%rbx), %zmm10
	vpmulld	%zmm8, %zmm10, %zmm8
	vpaddd	%zmm6, %zmm8, %zmm6
	vpbroadcastw	(%rdx,%r12), %ymm8
	vpmovsxwd	%ymm8, %zmm8
	vpmulld	%zmm9, %zmm8, %zmm11
	vpaddd	%zmm5, %zmm11, %zmm5
	vpmulld	%zmm10, %zmm8, %zmm8
	vpaddd	%zmm4, %zmm8, %zmm4
	vpbroadcastw	(%rdi,%r12), %ymm8
	vpmovsxwd	%ymm8, %zmm8
	vpmulld	%zmm9, %zmm8, %zmm11
	vpaddd	%zmm3, %zmm11, %zmm3
	vpmulld	%zmm10, %zmm8, %zmm8
	vpaddd	%zmm2, %zmm8, %zmm2
	vpbroadcastw	(%rbp,%r12), %ymm8
	vpmovsxwd	%ymm8, %zmm8
	vpmulld	%zmm9, %zmm8, %zmm9
	vpaddd	%zmm1, %zmm9, %zmm1
	vpmulld	%zmm10, %zmm8, %zmm8
...
# %bb.7:                                # %"consume matrix_mul50"
	...
	shlq	$4, %rdx
	vmovdqu64	%zmm7, (%r11,%rdx)
	vmovdqu64	%zmm6, 64(%r11,%rdx)
	leaq	1(,%r14,4), %rdx
	imulq	%r10, %rdx
	movq	-48(%rsp), %rsi                 # 8-byte Reload
	addq	%rsi, %rdx
	vmovdqu64	%zmm5, (%r11,%rdx,4)
	vmovdqu64	%zmm4, 64(%r11,%rdx,4)
	leaq	2(,%r14,4), %rdx
	imulq	%r10, %rdx
	addq	%rsi, %rdx
	vmovdqu64	%zmm3, (%r11,%rdx,4)
	vmovdqu64	%zmm2, 64(%r11,%rdx,4)
	leaq	3(,%r14,4), %rdx
	imulq	%r10, %rdx
	addq	%rsi, %rdx
	vmovdqu64	%zmm1, (%r11,%rdx,4)
	vmovdqu64	%zmm0, 64(%r11,%rdx,4)
	incq	%r15
	movl	-104(%rsp), %ebp                # 4-byte Reload
	addl	%r9d, %ebp
	movl	-108(%rsp), %edi                # 4-byte Reload
