#ifndef HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___depthwise_conv___samples___batch_58_0___0___depthwise_conv_batch_0058_sample_0000_h
#define HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___depthwise_conv___samples___batch_58_0___0___depthwise_conv_batch_0058_sample_0000_h
#include <stdint.h>
...
int depthwise_conv_batch_0058_sample_0000(struct halide_buffer_t *_input_buffer, uint8_t _input_zero, struct halide_buffer_t *_filter_buffer, uint8_t _filter_zero, struct halide_buffer_t *_bias_buffer, int32_t _depth_multiplier, int32_t _stride_x, int32_t _stride_y, int32_t _dilation_x, int32_t _dilation_y, int32_t _output_multiplier, uint32_t _output_shift, uint8_t _output_zero, uint8_t _output_min, uint8_t _output_max, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int depthwise_conv_batch_0058_sample_0000_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *depthwise_conv_batch_0058_sample_0000_metadata();
