#ifndef HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___fully_connected___samples___batch_29_0___31___fully_connected_batch_0029_sample_0031_h
#define HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___fully_connected___samples___batch_29_0___31___fully_connected_batch_0029_sample_0031_h
#include <stdint.h>
...
int fully_connected_batch_0029_sample_0031(struct halide_buffer_t *_input_buffer, uint8_t _input_zero, struct halide_buffer_t *_filter_buffer, uint8_t _filter_zero, struct halide_buffer_t *_bias_buffer, uint8_t _output_zero, int32_t _output_multiplier, int32_t _output_shift, uint8_t _output_min, uint8_t _output_max, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int fully_connected_batch_0029_sample_0031_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *fully_connected_batch_0029_sample_0031_metadata();
