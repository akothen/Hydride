#ifndef HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___mul___samples___batch_94_0___19___mul_batch_0094_sample_0019_h
#define HALIDE____home___sb54___Hydride___hexagon___benchmarks___rake___benchmarks___hexagon___halide___mul___samples___batch_94_0___19___mul_batch_0094_sample_0019_h
#include <stdint.h>
...
int mul_batch_0094_sample_0019(struct halide_buffer_t *_input1_buffer, uint8_t _input1_zero, struct halide_buffer_t *_input2_buffer, uint8_t _input2_zero, uint8_t _output_zero, int32_t _output_multiplier, uint32_t _output_shift, uint8_t _output_min, uint8_t _output_max, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int mul_batch_0094_sample_0019_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *mul_batch_0094_sample_0019_metadata();
