...
(define cex_set4_arg0 (bv #x00002aa00000000000000000001dd500 128))
(define cex_set4_arg1 (bv #x000000002aaa080008aa080000000000 128))

(define sol
(synthesize
#:forall (list cex_set0_arg0 cex_set0_arg1 cex_set1_arg0 cex_set1_arg1 cex_set2_arg0 cex_set2_arg1 cex_set3_arg0 cex_set3_arg1 cex_set4_arg0 cex_set4_arg1)
...
(assert 
 (equal? (synth_grammar cex_set4_arg0 cex_set4_arg1) (tensor-matmul cex_set4_arg0 cex_set4_arg1)))))
))
(assert (sat? sol) "Unsatisfiable")

(define gen_impl (generate-forms sol))

(with-output-to-file "./tmp/check_4.txt" (lambda () (print-forms sol)))
