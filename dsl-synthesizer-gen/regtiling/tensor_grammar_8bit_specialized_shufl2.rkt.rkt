...
[shufl (choose
        (vector-shuffle-ext-special (shufl_top) (shufl_top) 12 8 0 2)
        (vector-shuffle-ext-special (shufl_top) (shufl_top) 12 8 2 2)
        (vector-shuffle-ext-special (shufl_top) (shufl_top) 12 8 4 2)
        (vector-shuffle-ext-special (shufl_top) (shufl_top) 12 8 6 2)
        (vector-shuffle-ext-special (shufl_top) (shufl_top) 12 8 8 2)
        (vector-shuffle-ext-special (shufl_top) (shufl_top) 12 8 10 2)
)]
