...
;(println "OrigCost")
;(println (cost struct-sketch-special))



(define v0_0 (bv #x049585ebb57f5a8c 64))
(define v1_0 (bv #xc98e748772933c2307cd5de4017366b2cfd00cd0004f99d0 192))
(define env_0 (vector v0_0 v1_0))
(define v0_1 (bv #x7e54c9cf23ab0000 64))
(define v1_1 (bv #x00006f7f400800001b2923148bfd87051e600957352f1d0f 192))
(define env_1 (vector v0_1 v1_1))
(define v0_2 (bv #x1a7a87f700000000 64))
(define v1_2 (bv #x00003c0000000000040000000000430061ef0000ed000000 192))
(define env_2 (vector v0_2 v1_2))
    ...
    (optimize
      ...
      #:guarantee ;(forall (list cex_arg0 cex_arg1 env) 
                                                     (begin 
                                                       ...
                                                       (assume (equal? (interpret sketch-grammar env_0) (tensor-matmul v0_0 v1_0)))
(assume (equal? (interpret sketch-grammar env_1) (tensor-matmul v0_1 v1_1)))
(assume (equal? (interpret sketch-grammar env_2) (tensor-matmul v0_2 v1_2)))
                                                       )
      )
    )
  )
...
(with-output-to-file "./body_4.txt" (lambda() (print-prog synth_res)))
